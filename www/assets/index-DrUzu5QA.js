...
- Keep responses to 3-5 sentences unless a list is genuinely helpful`}function yr(e,t){let n=document.getElementById(`toto-messages`),r=document.createElement(`div`);r.className=`toto-msg ${e}`;let i=t.replace(/\n/g,`<br>`);e===`toto`?r.innerHTML=`<div class="toto-msg-avatar">🐕</div><div class="toto-msg-bubble">${i}</div>`:r.innerHTML=`<div class="toto-msg-bubble">${i}</div>`,n.appendChild(r),n.scrollTop=n.scrollHeight}function br(){let e=document.getElementById(`toto-messages`),t=`toto-typing-`+Date.now(),n=document.createElement(`div`);return n.className=`toto-msg toto`,n.id=t,n.innerHTML=`<div class="toto-msg-avatar">🐕</div><div class="toto-msg-bubble"><div class="toto-typing"><span></span><span></span><span></span></div></div>`,e.appendChild(n),e.scrollTop=e.scrollHeight,t}function xr(e){document.getElementById(e)?.remove()}`serviceWorker`in navigator&&navigator.serviceWorker.register(`/home-budget/sw.js`,{scope:`/home-budget/`}).catch(e=>console.warn(`SW registration failed:`,e));var Sr=[`Produce`,`Meat & Seafood`,`Dairy & Eggs`,`Pantry`,`Bakery`,`Frozen`,`Household`,`Other`],Cr={Produce:`🥦`,"Meat & Seafood":`🥩`,"Dairy & Eggs":`🥛`,Pantry:`🥫`,Bakery:`🍞`,Frozen:`🧊`,Household:`🏠`,Other:`🛒`},wr={food:{label:`Food`,emoji:`🛒`,color:`#dcfce7`,text:`#166534`,aisles:!0,priceEst:!0},clothes:{label:`Clothes`,emoji:`👕`,color:`#dbeafe`,text:`#1e40af`,aisles:!1,priceEst:!1},wishlist:{label:`Wishlist`,emoji:`🎁`,color:`#fce7f3`,text:`#9d174d`,aisles:!1,priceEst:!1},home:{label:`Home & Garden`,emoji:`🛠`,color:`#fef3c7`,text:`#92400e`,aisles:!0,priceEst:!1},pharmacy:{label:`Pharmacy`,emoji:`💊`,color:`#ede9fe`,text:`#5b21b6`,aisles:!0,priceEst:!1}},Tr={food:[{key:`produce`,emoji:`🥦`,label:`Produce`},{key:`dairy`,emoji:`🥛`,label:`Dairy & Eggs`},{key:`bakery`,emoji:`🍞`,label:`Bakery`},{key:`meat`,emoji:`🥩`,label:`Meat & Seafood`},{key:`pantry`,emoji:`🥫`,label:`Pantry`},{key:`frozen`,emoji:`🧊`,label:`Frozen`},{key:`health`,emoji:`🧴`,label:`Health & Beauty`},{key:`bathroom`,emoji:`🚿`,label:`Bathroom`},{key:`cleaning`,emoji:`🧹`,label:`Cleaning`},{key:`drinks`,emoji:`🍷`,label:`Drinks & Alcohol`},{key:`other`,emoji:`🛒`,label:`Uncategorised`}],home:[{key:`tools`,emoji:`🔨`,label:`Tools & Hardware`},{key:`garden`,emoji:`🌱`,label:`Garden`},{key:`cleaning`,emoji:`🧹`,label:`Cleaning`},{key:`other`,emoji:`🛒`,label:`Other`}],pharmacy:[{key:`medicine`,emoji:`💊`,label:`Medicine`},{key:`skincare`,emoji:`🧴`,label:`Skincare`},{key:`vitamins`,emoji:`💪`,label:`Vitamins`},{key:`other`,emoji:`🛒`,label:`Other`}]},Er={milk:`dairy`,cheese:`dairy`,butter:`dairy`,eggs:`dairy`,yoghurt:`dairy`,cream:`dairy`,bread:`bakery`,rolls:`bakery`,muffin:`bakery`,croissant:`bakery`,baguette:`bakery`,apple:`produce`,banana:`produce`,orange:`produce`,strawberry:`produce`,tomato:`produce`,lettuce:`produce`,spinach:`produce`,carrot:`produce`,broccoli:`produce`,potato:`produce`,onion:`produce`,garlic:`produce`,cucumber:`produce`,capsicum:`produce`,avocado:`produce`,lemon:`produce`,lime:`produce`,grapes:`produce`,mango:`produce`,pineapple:`produce`,watermelon:`produce`,chicken:`meat`,beef:`meat`,mince:`meat`,steak:`meat`,pork:`meat`,lamb:`meat`,salmon:`meat`,fish:`meat`,tuna:`meat`,prawn:`meat`,sausage:`meat`,bacon:`meat`,rice:`pantry`,pasta:`pantry`,flour:`pantry`,sugar:`pantry`,oil:`pantry`,vinegar:`pantry`,salt:`pantry`,pepper:`pantry`,sauce:`pantry`,stock:`pantry`,beans:`pantry`,lentils:`pantry`,chickpeas:`pantry`,cereal:`pantry`,oats:`pantry`,honey:`pantry`,jam:`pantry`,peanut:`pantry`,coffee:`pantry`,tea:`pantry`,biscuit:`pantry`,cracker:`pantry`,chocolate:`pantry`,chips:`pantry`,nuts:`pantry`,icecream:`frozen`,peas:`frozen`,corn:`frozen`,pizza:`frozen`,shampoo:`health`,conditioner:`health`,deodorant:`health`,sunscreen:`health`,moisturiser:`health`,makeup:`health`,lipstick:`health`,mascara:`health`,toothpaste:`bathroom`,toothbrush:`bathroom`,soap:`bathroom`,toilet:`bathroom`,razors:`bathroom`,tampons:`bathroom`,pads:`bathroom`,detergent:`cleaning`,bleach:`cleaning`,sponge:`cleaning`,dishwashing:`cleaning`,bins:`cleaning`,mop:`cleaning`,water:`drinks`,juice:`drinks`,beer:`drinks`,wine:`drinks`,spirits:`drinks`,softdrink:`drinks`,soda:`drinks`,kombucha:`drinks`};function Dr(e){for(var t=e.toLowerCase(),n=Object.keys(Er),r=0;r<n.length;r++)if(t.indexOf(n[r])!==-1)return Er[n[r]];return`other`}function Or(e){var t=e.trim(),n=1,r=`units`,i=t,a=t.match(/^(\d+(?:\.\d+)?)\s*(kg|g|L|l|ml|dozen|doz)\s+(.+)$/i);if(a)n=parseFloat(a[1]),r=a[2].toLowerCase()===`l`?`L`:a[2].toLowerCase()===`doz`?`dozen`:a[2],i=a[3];else{var o=t.match(/^(\d+(?:\.\d+)?)\s+(.+)$/);o?(n=parseFloat(o[1]),i=o[2]):/^dozen\s+/i.test(t)&&(n=1,r=`dozen`,i=t.replace(/^dozen\s+/i,``))}return i=i.charAt(0).toUpperCase()+i.slice(1),{qty:n,unit:r,name:i}}var kr=`food`,Ar=`selector`;Object.defineProperty(window,`_listsActiveType`,{get(){return kr},set(e){kr=e},configurable:!0}),Object.defineProperty(window,`_listsView`,{get(){return Ar},set(e){Ar=e},configurable:!0});function L(e){let t=new Date,n=t.getDay()===0?-6:1-t.getDay(),r=new Date(t);return r.setDate(t.getDate()+n+(e||0)*7),r.toISOString().slice(0,10)}function jr(e){let t=new Date(e+`T00:00:00`);return Array.from({length:7},(e,n)=>{let r=new Date(t);return r.setDate(t.getDate()+n),r})}function Mr(){_mealView===`shopping`?Wr():Nr()}function Nr(){let e=L(0),t=jr(e),n=m.meals.plan[e]||{},r=new Date().toISOString().slice(0,10),i=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`,`Sun`],a=[{key:`b`,label:`Breakfast`},{key:`l`,label:`Lunch`},{key:`d`,label:`Dinner`}];t[0].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`}),t[6].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`});let o=[];for(let e=0;e<7;e++){let t=n[e]||{};[`b`,`l`,`d`].forEach(e=>{t[e]&&o.push(t[e])})}let s=``;a.forEach(i=>{s+=`<div class="meal-grid-label">${i.label}</div>`,t.forEach((t,a)=>{let o=(n[a]||{})[i.key]||``,c=t.toISOString().slice(0,10)===r;s+=`<div class="meal-cell${c?` today`:``}" onclick="openMealEdit('${e}',${a},'${i.key}')">
    ...
    <div style="border:1px solid var(--border);border-radius:10px;padding:14px;margin-bottom:16px;background:var(--surface2)">
      ...
      <div style="margin-bottom:12px">
        <div class="form-label" style="display:flex;justify-content:space-between;margin-bottom:5px">
          ...
          <span id="meal-price-lbl" style="color:#0891b2;font-weight:700">${Pr.price>0?`$`+Pr.price:`Any`}</span>
        </div>
        <input type="range" min="0" max="200" step="5" value="${Pr.price}"
    ...
    style="padding:4px 10px;border-radius:99px;font-size:12px;cursor:pointer;white-space:nowrap;
      ...
      color:${n?`#0891b2`:`var(--text)`}">${t}</button>`}function zr(e,t){Pr[e]=t,document.querySelectorAll(`[data-filter="${e}"]`).forEach(e=>{let n=e.dataset.val===t;e.style.borderColor=n?`#0891b2`:`var(--border)`,e.style.background=n?`#ecfeff`:`var(--surface)`,e.style.color=n?`#0891b2`:`var(--text)`})}function Br(e){Pr.price=e;let t=document.getElementById(`meal-price-lbl`);t&&(t.textContent=e>0?`$${e}`:`Any`)}async function Vr(e){let t=localStorage.getItem(`toto_ai_key`);if(!t)return;let n=document.getElementById(`meal-suggest-btn`),r=document.getElementById(`meal-suggest-out`);n&&(n.textContent=`⏳ Thinking…`,n.disabled=!0),r&&(r.innerHTML=``);let i={b:`Breakfast`,l:`Lunch`,d:`Dinner`},a=[Pr.cuisine===`Any`?``:`Cuisine: ${Pr.cuisine}`,Pr.price>0?`Budget: up to $${Pr.price} per serve`:``,Pr.dietary===`Any`?``:`Style: ${Pr.dietary}`].filter(Boolean).join(`, `)||`No specific filters`,o=`Suggest 8 ${i[e]} meal ideas. Filters: ${a}.
Return ONLY a JSON array of meal names, no other text: ["Meal 1","Meal 2",...]`;try{let e=(await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:256,messages:[{role:`user`,content:o}]})})).json()).content[0].text.match(/\[[\s\S]*\]/);if(!e)throw Error(`No JSON`);let n=JSON.parse(e[0]);r&&(r.innerHTML=`<div style="display:flex;flex-wrap:wrap;gap:6px">
      ${n.map(e=>`<button style="padding:6px 12px;border-radius:99px;border:1px solid #0891b2;background:#ecfeff;color:#0891b2;font-size:12px;font-weight:500;cursor:pointer"
        onclick="document.getElementById('meal-input').value='${e.replace(/'/g,`\\'`)}'">${e}</button>`).join(``)}
    </div>`)}catch(e){r&&(r.innerHTML=`<span style="font-size:12px;color:var(--danger)">⚠ ${e.message}</span>`)}finally{n&&(n.textContent=`Get suggestions`,n.disabled=!1)}}function Hr(e,t,n,r){m.meals.plan[e]||(m.meals.plan[e]={}),m.meals.plan[e][t]||(m.meals.plan[e][t]={b:``,l:``,d:``}),m.meals.plan[e][t][n]=r,delete m.meals.plan[e][t][`cal_`+n],saveData(m),closeModal(),Nr(),r&&m.settings?.showCalories&&Ur(e,t,n,r)}async function Ur(e,t,n,r){let i=localStorage.getItem(`toto_ai_key`);if(!(!i||!r))try{let a=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":i,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:50,messages:[{role:`user`,content:`Estimate the calories in this meal: "${r}". Return ONLY a number, nothing else. For example: 450`}]})});if(!a.ok)return;let o=await a.json(),s=parseInt(o.content[0].text.trim().replace(/[^0-9]/g,``));s>0&&s<5e3&&m.meals.plan[e]?.[t]&&(m.meals.plan[e][t][`cal_`+n]=s,saveData(m),Nr())}catch{}}function Wr(){let e=m.meals.shopping||[],t=e.filter(e=>e.checked).length,n=e.length-t,r={};Sr.forEach(e=>r[e]=[]),e.forEach(e=>{r[Sr.includes(e.cat)?e.cat:`Other`].push(e)});let i=``;Sr.forEach(e=>{let t=r[e];t.length&&(i+=`
    ...
    </div>`}function Gr(){let e=document.getElementById(`shop-name`)?.value.trim();if(!e)return;let t=document.getElementById(`shop-qty`)?.value.trim()||``,n=document.getElementById(`shop-cat`)?.value||`Other`,r=m.meals.shopping;r.push({id:r.length?Math.max(...r.map(e=>e.id))+1:1,name:e,qty:t,cat:n,checked:!1}),saveData(m),Wr()}function Kr(e,t){let n=m.meals.shopping.find(t=>t.id===e);n&&(n.checked=t,saveData(m))}function qr(e){m.meals.shopping=m.meals.shopping.filter(t=>t.id!==e),saveData(m),Wr()}function Jr(){m.meals.shopping=m.meals.shopping.filter(e=>!e.checked),saveData(m),Wr()}function Yr(e){var t=document.getElementById(`ls-toast`);t&&t.remove();var n=document.createElement(`div`);n.id=`ls-toast`,n.textContent=e,n.style.cssText=`position:fixed;bottom:96px;left:50%;transform:translateX(-50%) translateY(20px);background:#1a1814;color:#fff;padding:10px 18px;border-radius:99px;font-size:13px;font-weight:600;z-index:9999;opacity:0;transition:opacity .2s,transform .2s;pointer-events:none;white-space:nowrap;max-width:80vw;text-align:center;font-family:var(--sans,system-ui,sans-serif)`,document.body.appendChild(n),requestAnimationFrame(function(){n.style.opacity=`1`,n.style.transform=`translateX(-50%) translateY(0)`}),setTimeout(function(){n.style.opacity=`0`,n.style.transform=`translateX(-50%) translateY(10px)`,setTimeout(function(){n.parentNode&&n.remove()},300)},2400)}function Xr(e,t,n,r,i,a,o){m.lists||_applyMigrations(m);var s=m.lists[e];if(s){if(s.items.find(function(e){return e.state===`active`&&e.name.toLowerCase()===t.toLowerCase()}))return Yr(x(t)+` is already on your list`),!1;var c={id:`li-`+Date.now()+`-`+Math.random().toString(36).slice(2,6),name:t,quantity:n||1,unit:r||`units`,notes:a||``,aisle:i||(e===`food`?Dr(t):`other`),state:`active`,addedBy:`user`,addedAt:new Date().toISOString(),stateChangedAt:null,mealTag:o||null,manualPrice:null,barcodeId:null};return s.items.push(c),ai(e,t),saveData(m),!0}}function Zr(e,t,n){if(!(!m.lists||!m.lists[e])){var r=m.lists[e].items.find(function(e){return e.id===t});r&&(r.state=n,r.stateChangedAt=new Date().toISOString(),saveData(m),ci())}}function Qr(e,t){!m.lists||!m.lists[e]||(m.lists[e].items=m.lists[e].items.filter(function(e){return e.id!==t}),saveData(m),ci())}function $r(e){var t=document.getElementById(`ls-quick-input`);if(t){var n=t.value.trim();if(n){var r=Or(n),i=e===`food`?Dr(r.name):`other`;if(Xr(e,r.name,r.qty,r.unit,i,``,null)!==!1){t.value=``;var a=document.getElementById(`ls-parse-preview`);a&&(a.innerHTML=``),ci()}}}}function ei(e,t){let n=e===`food`,r=m.lists?.[e]?.items||[],i=t?r.find(e=>e.id===t):null,a=n?PANTRY_CATS:[`Other`],o=[`units`,`kg`,`g`,`L`,`ml`,`dozen`];document.getElementById(`modal-title`).textContent=i?`Edit Item`:`Add Item`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
      <label class="form-label">Item Name</label>
    ...
    <button class="btn" onclick="closeModal()">Cancel</button>
    <button class="btn btn-primary" onclick="_listsSaveForm('${e}','${t||``}')">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function ti(e){return{Fridge:`dairy`,Freezer:`frozen`,Pantry:`pantry`,"Fruit & Veg":`produce`,Spices:`pantry`,Drinks:`drinks`,Cleaning:`cleaning`,Other:`other`}[e]||`other`}function ni(e,t){let n=document.getElementById(`lf-name`)?.value.trim();if(!n)return;let r=document.getElementById(`lf-cat`)?.value||`Other`,i=document.getElementById(`lf-qty`)?.value.trim()||`1`,a=document.getElementById(`lf-unit`)?.value||`units`,o=document.getElementById(`lf-notes`)?.value.trim()||``,s=document.querySelector(`input[name="lf-state"]:checked`)?.value||`active`,c=parseFloat(i)||1,l=e===`food`?ti(r):`other`;m.lists||(m.lists={}),m.lists[e]||(m.lists[e]={items:[],weeklyBudget:0,budget:0,stores:[],favourites:[],history:[]});let u=m.lists[e].items;if(t){let e=u.find(e=>e.id===t);e&&(e.name=n,e.quantity=c,e.unit=a,e.notes=o,e.aisle=l,e.state=s)}else{if(u.find(e=>e.name.toLowerCase()===n.toLowerCase()&&e.state===`active`)&&!confirm(`"${n}" is already on your list. Add another?`))return;u.push({id:`si-`+Date.now(),name:n,quantity:c,unit:a,notes:o,aisle:l,state:s,addedBy:_currentUser?.uid||`guest`,addedAt:new Date().toISOString(),mealTag:null,manualPrice:null,barcodeId:null}),ai(e,n)}saveData(m),closeModal(),ci()}function ri(e){if(!(!m.lists||!m.lists[e])){var t=m.lists[e].items.filter(function(e){return e.state===`got_it`});t.length&&confirm(`Remove `+t.length+` trolley item`+(t.length===1?``:`s`)+`?`)&&(m.lists[e].items=m.lists[e].items.filter(function(e){return e.state!==`got_it`}),saveData(m),ci())}}function ii(e){if(!(!m.lists||!m.lists[e])){var t=m.lists[e];t.history||(t.history=[]),t.history.push({archivedAt:new Date().toISOString(),items:JSON.parse(JSON.stringify(t.items))}),t.items=[],saveData(m),Yr(`Shop archived!`),ci()}}function ai(e,t){if(!(!m.lists||!m.lists[e])){var n=m.lists[e].favourites,r=n.find(function(e){return e.name.toLowerCase()===t.toLowerCase()});r?r.addedCount=(r.addedCount||0)+1:n.push({name:t,addedCount:1,pinned:!1})}}function oi(e){if(!(!m.lists||!m.lists[e])){var t=m.lists[e].favourites,n=t.filter(function(e){return e.pinned}),r=n.length?n:t.sort(function(e,t){return(t.addedCount||0)-(e.addedCount||0)}).slice(0,5),i=0;r.forEach(function(t){m.lists[e].items.find(function(e){return e.state===`active`&&e.name.toLowerCase()===t.name.toLowerCase()})||(Xr(e,t.name,1,`units`,e===`food`?Dr(t.name):`other`,``,null),i++)}),i?ci():Yr(`All usual items are already on the list`)}}function si(){var e=document.getElementById(`ls-quick-input`),t=document.getElementById(`ls-parse-preview`);if(!(!e||!t)){var n=e.value.trim();if(!n){t.innerHTML=``;return}var r=Or(n),i=``;(r.qty!==1||r.unit!==`units`)&&(i+=`<span class="ls-parse-chip">`+x(String(r.qty))+` `+x(r.unit)+`</span>`),i+=`<span class="ls-parse-chip">`+x(r.name)+`</span>`,t.innerHTML=i}}function ci(){var e=document.getElementById(`lists-content`);e&&(m.lists||_applyMigrations(m),Ar===`selector`?li(e):ui(e,kr))}function li(e){var t=`<div class="ls-screen">`;t+=`<div style="font-size:22px;font-weight:800;color:var(--ink,#1a1814);margin-bottom:4px">My Lists</div>`,t+=`<div style="font-size:13px;color:var(--muted,#8c8880);margin-bottom:20px">Tap a list to open it</div>`,t+=`<div class="ls-type-grid">`,Object.keys(wr).forEach(function(e){var n=wr[e],r=(m.lists&&m.lists[e]?m.lists[e]:{items:[]}).items.filter(function(e){return e.state===`active`}).length;t+=`<div class="ls-type-card" onclick="_listsActiveType='`+e+`';_listsView='list';renderLists()">`,t+=`<div class="ls-type-icon" style="background:`+n.color+`;color:`+n.text+`">`+n.emoji+`</div>`,t+=`<div class="ls-type-label">`+x(n.label)+`</div>`,t+=`<div class="ls-type-count">`+(r>0?r+` item`+(r===1?``:`s`):`Empty`)+`</div>`,t+=`</div>`}),t+=`</div>`,t+=`</div>`,e.innerHTML=t}function ui(e,t){var n=wr[t],r=m.lists&&m.lists[t]?m.lists[t]:{items:[],weeklyBudget:0,favourites:[]},i=r.items||[],a=i.filter(function(e){return e.state===`active`}),o=i.filter(function(e){return e.state===`got_it`}),s=i.filter(function(e){return e.state===`not_found`}),c=`<div class="ls-screen">`;if(c+=`<button class="ls-back-btn" onclick="_listsView='selector';renderLists()">← Lists</button>`,c+=`<div class="ls-header">`,c+=`<div style="font-size:22px;margin-right:6px">`+n.emoji+`</div>`,c+=`<div class="ls-header-title">`+x(n.label)+`</div>`,c+=`<div class="ls-sync-dot"></div>`,c+=`<div class="ls-header-count">`+a.length+` to get</div>`,c+=`</div>`,r.weeklyBudget>0){var l=i.filter(function(e){return e.state===`got_it`&&e.manualPrice}).reduce(function(e,t){return e+(t.manualPrice||0)},0),u=Math.min(100,Math.round(l/r.weeklyBudget*100)),d=u>100?`over`:u>80?`warn`:``;c+=`<div class="ls-budget-bar-wrap">`,c+=`<div class="ls-budget-bar-meta"><span>$`+l.toFixed(0)+` spent</span><span>$`+r.weeklyBudget+` budget</span></div>`,c+=`<div class="ls-budget-bar"><div class="ls-budget-fill `+d+`" style="width:`+u+`%"></div></div>`,c+=`</div>`}var f=(r.favourites||[]).filter(function(e){return!a.find(function(t){return t.name.toLowerCase()===e.name.toLowerCase()})}).sort(function(e,t){return(t.addedCount||0)-(e.addedCount||0)}).slice(0,5);if(f.length>0&&(c+=`<div class="ls-fav-chips">`,f.forEach(function(e){c+=`<button class="ls-fav-chip" onclick="_listsAddItem('`+t+`','`+x(e.name).replace(/'/g,`\\'`)+`',1,'units','`+(t===`food`?Dr(e.name):`other`)+`','',null);renderLists()">+ `+x(e.name)+`</button>`}),c+=`</div>`),(r.favourites||[]).length>0&&(c+=`<button class="ls-usual-btn" onclick="_listsAddUsual('`+t+`')">The usual →</button>`),c+=`<div class="ls-quick-add">`,c+=`<div class="ls-quick-add-row">`,c+=`<input class="ls-quick-input" id="ls-quick-input" type="text" placeholder="Add item…" autocomplete="off" oninput="_listsUpdateParsePreview()" onkeydown="if(event.key==='Enter')_listsQuickAdd('`+t+`')">`,c+=`<button class="ls-quick-add-btn" onclick="_listsQuickAdd('`+t+`')">Add</button>`,c+=`<button class="ls-quick-add-btn" style="background:var(--purple-soft);color:var(--iris-1);min-width:36px;padding:0 10px" onclick="_listsOpenAddForm('`+t+`')">⋯</button>`,c+=`</div>`,c+=`<div class="ls-parse-preview" id="ls-parse-preview"></div>`,c+=`</div>`,a.length>0)if(n.aisles){var p=Tr[t]||[{key:`other`,emoji:`🛒`,label:`Other`}],h={};p.forEach(function(e){h[e.key]=[]}),a.forEach(function(e){var t=e.aisle&&h[e.aisle]!==void 0?e.aisle:`other`;h[t]||(h[t]=[]),h[t].push(e)}),p.forEach(function(e){!h[e.key]||!h[e.key].length||(c+=`<div class="ls-aisle-header">`+e.emoji+` `+x(e.label)+`</div>`,h[e.key].forEach(function(e){c+=di(t,e)}))})}else a.forEach(function(e){c+=di(t,e)});else c+=`<div style="text-align:center;padding:32px 0;color:var(--muted,#8c8880);font-size:14px">Nothing to get yet — add something above</div>`;o.length>0&&(c+=`<div class="ls-aisle-header">🛒 In the trolley</div>`,o.forEach(function(e){c+=di(t,e)})),s.length>0&&(c+=`<div class="ls-aisle-header">🚫 Not found</div>`,s.forEach(function(e){c+=di(t,e)})),c+=`<div class="ls-footer-row">`,o.length>0&&(c+=`<button class="ls-footer-btn" onclick="_listsClearTrolley('`+t+`')">Clear trolley (`+o.length+`)</button>`),a.length===0&&i.length>0&&(c+=`<button class="ls-footer-btn" style="background:var(--iris-2,#6366f1);color:#fff;border-color:var(--iris-2,#6366f1)" onclick="_listsArchive('`+t+`')">Archive this shop</button>`),c+=`</div>`,c+=`</div>`,e.innerHTML=c}function di(e,t){var n=t.state===`got_it`?`got-it`:t.state===`not_found`?`not-found`:``,r=t.state===`got_it`?`✓`:``,i=t.state===`active`?`got_it`:`active`,a=t.quantity&&t.unit&&t.unit!==`units`?t.quantity+` `+t.unit:t.quantity&&t.quantity!==1?`x`+t.quantity:``;x(t.id);var o=x(t.name),s=`<div class="ls-item `+n+`">`;return s+=`<button class="ls-item-check" onclick="_listsSetState('`+e+`','`+t.id+`','`+i+`')">`+r+`</button>`,s+=`<div class="ls-item-body">`,s+=`<div class="ls-item-name">`+o+`</div>`,a&&(s+=`<div class="ls-item-qty">`+x(a)+`</div>`),t.notes&&(s+=`<div class="ls-item-notes">`+x(t.notes)+`</div>`),s+=`</div>`,t.state===`active`?s+=`<button class="ls-item-notfound-btn" title="Not found" onclick="_listsSetState('`+e+`','`+t.id+`','not_found')">🚫</button>`:t.state===`not_found`&&(s+=`<button class="ls-item-notfound-btn" title="Mark active again" onclick="_listsSetState('`+e+`','`+t.id+`','active')">↩</button>`),s+=`<button class="ls-item-notfound-btn" title="Edit" onclick="_listsOpenAddForm('`+e+`','`+t.id+`')">✏️</button>`,s+=`<button class="ls-item-del" onclick="_listsDeleteItem('`+e+`','`+t.id+`')">×</button>`,s+=`</div>`,s}async function fi(e){let t=m.meals.plan[e]||{},n=[];for(let e=0;e<7;e++){let r=t[e]||{};[`b`,`l`,`d`].forEach(e=>{r[e]&&n.push(r[e])})}if(!n.length)return;let r=localStorage.getItem(`toto_ai_key`);if(!r){kr=`food`,Ar=`list`,activateTab(`lists`);return}let i=document.getElementById(`gen-shop-btn`);i&&(i.textContent=`⏳ Generating…`,i.disabled=!0);let a=`Generate a grocery shopping list for these meals: ${n.join(`, `)}.
...
Combine quantities where sensible. No duplicates. No other text.`,o={Produce:`produce`,"Meat & Seafood":`meat`,"Dairy & Eggs":`dairy`,Pantry:`pantry`,Bakery:`bakery`,Frozen:`frozen`,Household:`cleaning`,Other:`other`};try{let e=(await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":r,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:a}]})})).json()).content[0].text.match(/\[[\s\S]*\]/);if(!e)throw Error(`No JSON`);let t=JSON.parse(e[0]);m.lists||(m.lists={}),m.lists.food||(m.lists.food={items:[],weeklyBudget:200,budget:0,stores:[],favourites:[],history:[]});let n=m.lists.food.items,i=0;t.forEach(e=>{n.some(t=>t.name.toLowerCase()===e.name.toLowerCase()&&t.state===`active`)||n.push({id:`si-meal-`+Date.now()+`-`+ i++,name:e.name,quantity:1,unit:`units`,notes:e.qty||``,aisle:o[e.cat]||(Dr?Dr(e.name):`other`),state:`active`,addedBy:`meals`,addedAt:new Date().toISOString(),mealTag:`Meal plan`,manualPrice:null,barcodeId:null})}),saveData(m),kr=`food`,Ar=`list`,activateTab(`lists`)}catch{i&&(i.textContent=`🛒 Generate shopping list`,i.disabled=!1)}}var pi=[`Living Room`,`Dining Room`,`Kitchen`,`Master Bedroom`,`Bedroom 2`,`Bedroom 3`,`Study / Office`,`Bathroom`,`Laundry`,`Outdoor / Alfresco`,`Other`];function mi(e={}){let t=e.deliveryDate?(()=>{let[t,n,r]=e.deliveryDate.split(`-`);return`${r}/${n}/${t}`})():``;return`
  ...
  `}function hi(e){return{id:e,name:document.getElementById(`f-furn-name`).value.trim(),room:document.getElementById(`f-furn-room`).value,vendor:document.getElementById(`f-furn-vendor`).value.trim(),price:parseFloat(document.getElementById(`f-furn-price`).value)||0,status:document.getElementById(`f-furn-status`).value,funding:document.getElementById(`f-furn-funding`).value,deliveryDate:document.getElementById(`f-exp-duedate`).value||null,notes:document.getElementById(`f-furn-notes`).value.trim()}}function gi(){openModal(`Add Furniture Item`,mi(),()=>{let e=hi(M(m.furniture));e.name&&(logActivity(`Added furniture`,e.name),m.furniture.push(e),saveData(m),closeModal(),renderAll())})}function _i(e){let t=m.furniture.find(t=>t.id===e);openModal(`Edit Furniture Item`,mi(t),()=>{let n=hi(e);logActivity(`Edited furniture`,n.name||t.name),Object.assign(t,n),saveData(m),closeModal(),renderAll()})}function vi(e){if(!confirm(`Delete this item?`))return;let t=m.furniture.find(t=>t.id===e);logActivity(`Deleted furniture`,t?t.name:``),m.furniture=m.furniture.filter(t=>t.id!==e),saveData(m),renderAll()}function yi(e={}){let t=e.deliveryDate?(()=>{let[t,n,r]=e.deliveryDate.split(`-`);return`${r}/${n}/${t}`})():``;return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Item Name</label>
  ...
  `}function bi(e){return{id:e,name:document.getElementById(`f-appl-name`).value.trim(),room:document.getElementById(`f-appl-room`).value,vendor:document.getElementById(`f-appl-vendor`).value.trim(),price:parseFloat(document.getElementById(`f-appl-price`).value)||0,status:document.getElementById(`f-appl-status`).value,funding:document.getElementById(`f-appl-funding`).value,deliveryDate:document.getElementById(`f-exp-duedate`).value||null,notes:document.getElementById(`f-appl-notes`).value.trim()}}function xi(){openModal(`Add Appliance`,yi(),()=>{let e=bi(M(m.appliances));e.name&&(logActivity(`Added appliance`,e.name),m.appliances.push(e),saveData(m),closeModal(),renderAll())})}function Si(e){let t=m.appliances.find(t=>t.id===e);openModal(`Edit Appliance`,yi(t),()=>{let n=bi(e);logActivity(`Edited appliance`,n.name||t.name),Object.assign(t,n),saveData(m),closeModal(),renderAll()})}function Ci(e){if(!confirm(`Delete this item?`))return;let t=m.appliances.find(t=>t.id===e);logActivity(`Deleted appliance`,t?t.name:``),m.appliances=m.appliances.filter(t=>t.id!==e),saveData(m),renderAll()}document.getElementById(`btn-guest-mode`)?.addEventListener(`click`,()=>Li()),document.getElementById(`btn-google-signin`)?.addEventListener(`click`,()=>Ii());function wi(){document.getElementById(`sidebar`).classList.toggle(`collapsed`)}var Ti={};function Ei(e){let t=document.getElementById(`icon-group-${e}`),n=document.getElementById(`icon-group-${e}-children`),r=document.getElementById(`text-group-${e}`),i=document.getElementById(`text-group-${e}-children`),a=n&&n.classList.contains(`open`);t&&t.classList.toggle(`open`,!a),n&&n.classList.toggle(`open`,!a),r&&r.classList.toggle(`open`,!a),i&&i.classList.toggle(`open`,!a)}function Di(e){for(let[t,n]of Object.entries(Ti))if(n.includes(e)){let e=document.getElementById(`icon-group-${t}-children`);e&&!e.classList.contains(`open`)&&Ei(t);return}}window.addEventListener(`unhandledrejection`,e=>{console.error(`[unhandledrejection]`,e.reason)}),window.addEventListener(`error`,e=>{console.error(`[uncaughtError]`,e.message,e.filename,e.lineno)});var Oi=`toto_household_owner`,ki=`toto_pending_household`;function Ai(){return sessionStorage.getItem(ki)||aa(Oi)||R?.uid||null}function ji(){let e=Ai();return e?fbStore.collection(`families`).doc(e):null}function Mi(e){oa(Oi,e),sessionStorage.removeItem(ki)}var R=null,Ni=!1,Pi=null,Fi=null;function z(e,t){Fi={ts:new Date().toISOString(),name:R&&(R.displayName||R.email)||`Unknown`,photo:R&&R.photoURL||``,action:e,detail:t||``}}function Ii(){let e=new fbAuth.GoogleAuthProvider;fbAuth.signInWithPopup(e).catch(e=>{let t=document.getElementById(`login-error`);t&&(t.textContent=e.message,t.style.display=``)})}function Li(){Ni=!0;let e=document.getElementById(`login-overlay`);if(e&&e.classList.add(`hidden`),!m.onboarded)showOnboarding();else{let e=location.hash.slice(1);e&&document.getElementById(`tab-`+e)?(history.replaceState({tab:e},``,`#`+e),y(e)):renderAll(),ha()}}function Ri(){Pi&&(Pi(),Pi=null),$i=!1,V=null,pa(),fbAuth.signOut()}function zi(e){return e.budget||(e.budget={income:[],expenses:[],actuals:{},months:{}}),e.budget.actuals||(e.budget.actuals={}),e.budget.months||(e.budget.months={}),e.budget.suggestions||(e.budget.suggestions=[]),e.goals||(e.goals=[]),e.scenarios||(e.scenarios=[]),e.furniture||(e.furniture=[]),e.appliances||(e.appliances=[]),e.planner||(e.planner={events:[]}),e.lists||(e.lists={food:{items:[],budget:0,weeklyBudget:200,stores:[],favourites:[],history:[]},clothes:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},wishlist:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},home:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},pharmacy:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]}},e.meals&&e.meals.shopping&&e.meals.shopping.length&&(e.lists.food.items=e.meals.shopping.map(function(e,t){return{id:`si-`+t,name:e.name,quantity:1,unit:`units`,notes:``,aisle:e.cat||`other`,state:e.checked?`got_it`:`active`,addedBy:`migration`,addedAt:new Date().toISOString(),mealTag:null,manualPrice:null,barcodeId:null}}))),[`food`,`clothes`,`wishlist`,`home`,`pharmacy`].forEach(function(t){e.lists[t]||(e.lists[t]={items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]}),e.lists[t].items||(e.lists[t].items=[]),e.lists[t].stores||(e.lists[t].stores=[]),e.lists[t].favourites||(e.lists[t].favourites=[]),e.lists[t].history||(e.lists[t].history=[])}),e}function Bi(){Pi&&Pi(),!aa(Oi)&&!sessionStorage.getItem(ki)&&Mi(R.uid);let e=ji();if(!e){console.error(`No household doc ref`);return}Pi=e.onSnapshot(async t=>{if(t.exists){let e=zi(t.data());Object.assign(m,e),localStorage.setItem(Hi,JSON.stringify(m))}else{let t=await fbStore.collection(`family`).doc(`shared`).get().catch(()=>null);if(t&&t.exists){let n=zi(t.data());Object.assign(m,n),e.set(m).catch(()=>{}),localStorage.setItem(Hi,JSON.stringify(m))}else e.set(m).catch(()=>{})}refreshReceiptCounts().then(()=>{or();let e=location.hash.slice(1);if(e&&document.getElementById(`tab-`+e)?(history.replaceState({tab:e},``,`#`+e),y(e)):renderAll(),!m.onboarded)showOnboarding();else{let e=sessionStorage.getItem(Mo),t=sessionStorage.getItem(`toto_post_invite_action`);e||t?(sessionStorage.removeItem(`toto_post_invite_action`),Po()):ha()}})},e=>{console.error(`Firestore sync error:`,e),renderAll(),m.onboarded||showOnboarding()})}function Vi(){fbAuth.onAuthStateChanged(e=>{if(Ni&&!e)return;R=e;let t=document.getElementById(`login-overlay`),n=document.getElementById(`header-avatar`),r=document.getElementById(`header-sign-out`);if(e)t&&t.classList.add(`hidden`),n&&(n.src=e.photoURL||``,n.style.display=`block`),r&&(r.style.display=`block`),Bi();else{t&&t.classList.remove(`hidden`),n&&(n.style.display=`none`),r&&(r.style.display=`none`),Pi&&(Pi(),Pi=null);let e=sessionStorage.getItem(Mo),i=document.getElementById(`login-invite-banner`),a=document.getElementById(`login-tagline`);e&&i&&(i.style.display=`block`,a&&(a.style.display=`none`))}})}Vi();var Hi=`home_finance_v1`,Ui=null,Wi={};function Gi(e,t,n,r){Wi[e]={options:t,value:n,onChange:r};let i=t.find(e=>(e.value??e)===n)||t[0],a=i?.label??i?.value??i??``;return`<div class="cs-wrap">
  ...
  </div>`,document.getElementById(`profile-list`).innerHTML=n,document.getElementById(`profile-overlay-title`).textContent=`Who uses this device?`,document.getElementById(`profile-overlay-sub`).textContent=`Set it once — the app will open straight to the right view. You can change this any time in Settings.`,document.getElementById(`profile-overlay`).classList.remove(`hidden`)}function _a(e){if(la(e),$i=!0,document.getElementById(`profile-overlay`).classList.add(`hidden`),e===`adult`)V=null,Ta(),renderAll();else if(e===`shared`)va();else{let t=(m.kids?.profiles||[]).find(t=>t.id===e);if(!t){V=null,Da(),renderAll();return}t.pinHash?(ta=t.id,U=``,H=0,xa(t)):(V={id:t.id,name:t.name,emoji:t.emoji,role:`child`},fa(t.id),Ea())}}function va(){document.getElementById(`pin-overlay`).classList.add(`hidden`);let e=(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name),t=m.kids?.profiles||[],n=``;e.forEach((e,t)=>{let r=!!e.pinHash;n+=`<div class="profile-card" onclick="_pickAdult(${t})">
      <div class="profile-avatar">🧑</div>
      <div style="flex:1">
        <div style="font-size:15px;font-weight:700;color:#1e293b">${x(e.name)}</div>
    ...
    </div>`}),document.getElementById(`profile-list`).innerHTML=n,document.getElementById(`profile-overlay-title`).textContent=`Who's using Toto?`,document.getElementById(`profile-overlay-sub`).textContent=`Tap your name to continue`,document.getElementById(`profile-overlay`).classList.remove(`hidden`)}function ya(e){let t=(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[e??0];if(t?.pinHash){ta=`adult:`+(e??0),U=``,H=0,ea=0,xa({emoji:`🧑`,name:t.name,_isAdult:!0,_memberIndex:e??0});return}V=null,pa(),document.getElementById(`profile-overlay`).classList.add(`hidden`),Ea()}function ba(e){let t=(m.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(t.pinHash?(ta=e,U=``,H=0,xa(t)):(V={id:t.id,name:t.name,emoji:t.emoji,role:`child`},fa(t.id),document.getElementById(`profile-overlay`).classList.add(`hidden`),Ea()))}function xa(e){document.getElementById(`profile-overlay`).classList.add(`hidden`),document.getElementById(`pin-avatar`).textContent=e.emoji||(e._isAdult?`🧑`:`😊`),document.getElementById(`pin-greeting`).textContent=`Hi ${e.name}! 👋`,document.getElementById(`pin-sub`).textContent=`Enter your PIN to continue`,document.getElementById(`pin-error`).textContent=``,Sa(),Ca(),document.getElementById(`pin-overlay`).classList.remove(`hidden`)}function Sa(){let e=document.getElementById(`pin-dots`);e&&(e.innerHTML=[0,1,2,3].map(e=>`<div class="pin-dot ${e<U.length?`filled`:``}">${e<U.length?`●`:``}</div>`).join(``))}function Ca(){let e=document.getElementById(`pin-pad`);if(!e)return;let t=Date.now();if(t<ea){let n=Math.ceil((ea-t)/1e3);document.getElementById(`pin-error`).textContent=`Too many attempts — try again in ${n}s`,e.innerHTML=``,setTimeout(Ca,1e3);return}e.innerHTML=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div class="pin-key empty"></div>`:`<div class="pin-key" onclick="_pinKey('${e}')">${e}</div>`).join(``)}function wa(e){if(!(Date.now()<ea)){if(e===`⌫`){U=U.slice(0,-1),Sa();return}U.length>=4||(U+=e,Sa(),U.length===4&&hs())}}function Ta(){let e=document.getElementById(`header-switch-profile`);if(!e)return;let t=ca();e.style.display=t&&t!==`adult`?``:`none`}function Ea(){Ta(),Da(),V?.role===`child`?(window.kidsView=V.id,b(`kids`),Ga(V.id)):document.querySelectorAll(`.nav-item, .nav-text-item`).forEach(e=>e.style.display=``),renderAll()}function Da(){let e=V?.role===`child`;document.body.classList.toggle(`kid-mode`,e);let t=document.getElementById(`kid-banner-label`);t&&e&&(t.textContent=`${V.emoji||`😊`} ${V.name}'s view`);let n=ca(),r=document.getElementById(`header-switch-profile`);if(r){let t=n&&n!==`adult`;if(r.style.display=t?``:`none`,t)if(e)r.textContent=`👨‍👩‍👧 Parent`;else{let e=(m.kids?.profiles||[]).find(e=>e.id===n);r.textContent=e?`Back to ${e.name}`:`Switch`}}}function Oa(){let e=ca();if(V?.role===`child`)pa(),V=null,Da(),renderAll();else if(e===`shared`)va();else if(e&&e!==`adult`){let t=(m.kids?.profiles||[]).find(t=>t.id===e);t&&(t.pinHash?(ta=t.id,U=``,H=0,xa(t)):(V={id:t.id,name:t.name,emoji:t.emoji,role:`child`},fa(t.id),Ea()))}}async function ka(e,t){let n=(m.kids?.profiles||[]).find(t=>String(t.id)===String(e));!n||t.length!==4||(n.pinHash=await ma(t,Ai()),B(m))}function Aa(e){let t=(m.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(delete t.pinHash,B(m))}function ja(e){(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[e]&&(Na=e,Fa=``,Ia=``,Pa=`enter`,La(),document.getElementById(`adult-pin-modal`).classList.remove(`hidden`))}function Ma(e){let t=(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name);t[e]&&(delete t[e].pinHash,B(m),Z())}var Na=0,Pa=`enter`,Fa=``,Ia=``;function La(){let e=(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[Na];if(!e)return;let t=Pa===`enter`,n=t?e.pinHash?`Change your PIN 🔢`:`Set your PIN 🔢`:`Confirm your PIN ✅`,r=t?`Pick 4 numbers — used on shared devices`:`Enter it again to confirm`,i=[0,1,2,3].map(e=>{let t=e<Ia.length;return`<div style="width:52px;height:60px;border:2px solid ${t?`#0891b2`:`#e2e8f0`};border-radius:10px;background:${t?`#ecfeff`:`#f8fafc`};display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:700;color:#0891b2">${t?`●`:``}</div>`}).join(``),a=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div></div>`:`<div onclick="_adultPinKey('${e}')" style="height:52px;border:1.5px solid #e2e8f0;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:600;color:#374151;cursor:pointer;background:#fff;-webkit-tap-highlight-color:transparent;user-select:none">${e}</div>`).join(``);document.getElementById(`adult-pin-modal-body`).innerHTML=`
    ...
    <button onclick="document.getElementById('adult-pin-modal').classList.add('hidden')" style="font-size:13px;color:#94a3b8;background:none;border:none;cursor:pointer">Cancel</button>`}function Ra(e){if(e===`⌫`){Ia=Ia.slice(0,-1),La();return}Ia.length>=4||(Ia+=e,La(),Ia.length===4&&za())}async function za(){if(Pa===`enter`)Fa=Ia,Ia=``,Pa=`confirm`,La();else{if(Ia!==Fa){Ia=``,Fa=``,Pa=`enter`,La();let e=document.getElementById(`adult-pin-error`);e&&(e.textContent=`Those didn't match — try again`);return}let e=(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name);e[Na].pinHash=await ma(Ia,Ai()),B(m),document.getElementById(`adult-pin-modal`).classList.add(`hidden`),Z()}}function Ba(e){let t=Number(e.age||0);return t<5?`tiny-tots`:t<8?`early-reader`:t<12?`independent`:`tween`}function Va(){let e=new Date().getHours();return e<12?`Good morning`:e<17?`Good afternoon`:`Good evening`}function Ha(e){if(!e.triggerTime)return!0;let[t,n]=e.triggerTime.split(`:`).map(Number),r=new Date,i=r.getHours()*60+r.getMinutes(),a=t*60+(n||0),o=a+360;return i>=a&&i<o}function Ua(e){if(!e.triggerTime)return``;let[t]=e.triggerTime.split(`:`).map(Number);return t<12?`Available this morning`:t<17?`Available this afternoon`:`Available tonight`}function Wa(){let e=document.getElementById(`child-view-overlay`);if(!e)return;let t=document.getElementById(`cv-confetti-wrap`);t&&t.remove(),t=document.createElement(`div`),t.id=`cv-confetti-wrap`,t.className=`cv2-confetti-wrap`,e.appendChild(t);let n=[`#5B4CF5`,`#7C3AED`,`#F59E0B`,`#10B981`,`#F43F5E`,`#FBBF24`];for(let e=0;e<60;e++){let r=document.createElement(`div`);r.className=`cv2-confetti-particle`,r.style.cssText=`
    ...
    `,t.appendChild(r)}setTimeout(()=>{t.parentNode&&t.remove()},3500)}function Ga(e){let t=(m.kids?.profiles||[]).find(t=>String(t.id)===String(e));if(!t)return;Ja=e,Ya=`today`;let n=m.kids,r=kidBalance(n,t.id),i=Ba(t),a=i===`tiny-tots`,o=i===`tween`,s=_cvReadOnly,c=document.getElementById(`child-view-overlay`);document.getElementById(`cv-avatar`).textContent=t.emoji||`😊`,document.getElementById(`cv-name`).innerHTML=`<span class="ember-text">${x(t.name)}</span>`,document.getElementById(`cv-greeting`).textContent=Va()+`!`;let l=(n.completions||[]).filter(e=>e.kidId===t.id&&e.status===`approved`&&new Date(e.completedAt||e.ts).toDateString()===new Date().toDateString()).reduce((e,t)=>e+((n.chores||[]).find(e=>e.id===t.choreId)?.points||0),0),u=document.getElementById(`cv-nudge`);l>0&&!a&&!s?(u.textContent=`You've earned ⭐ ${l} points today — keep going!`,u.style.display=``):u.style.display=`none`,c.className=c.className.replace(/cv2-age-\S+/g,``).trim(),i===`early-reader`&&c.classList.add(`cv2-age-early`),a&&c.classList.add(`cv2-age-tiny`),o&&c.classList.add(`cv2-age-tween`);let d=document.getElementById(`cv-nav`);d&&(d.style.display=a?`none`:``),document.getElementById(`cv-nav-today`)?.classList.add(`active`),document.getElementById(`cv-nav-calendar`)?.classList.remove(`active`),document.getElementById(`cv-nav-prizes`)?.classList.remove(`active`),Ka(t);let f=new Date().toISOString().slice(0,10),p=(m.routineAssignments||[]).filter(e=>{if(e.childId!==t.id)return!1;let n=(m.routines||[]).find(t=>t.id===e.routineId);return n&&_routineMatchesDate(n,f)}),h=_routineTodayKey(),g=``,_=0,v=0;p.length&&p.forEach(e=>{let n=(m.routines||[]).find(t=>t.id===e.routineId);if(!n)return;let r=e.completionState?.[h]||[],i=n.steps.length,o=i>0?Math.round(r.length/i*100):0,c=r.length===i&&i>0,l=Ha(n);v+=i,_+=r.length;let u=l?``:Ua(n),d=_assignmentStreak(e,i),f=_assignmentHistory(e,i,7).filter(e=>e.done===e.total&&e.total>0).length;if(g+=`<div class="cv2-card${l?``:` cv2-card--locked`}" style="margin-bottom:10px">
      ...
      </div>`});let C=L(0),ee=new Date().getDay()===0?6:new Date().getDay()-1,w=m.meals?.lunchbox?.plans?.[C]||{},T=w[w[t.id]===void 0?(m.meals?.lunchbox?.profiles||[]).find(e=>e.name?.toLowerCase()===t.name?.toLowerCase())?.id??t.id:t.id]?.[ee]||{},E=[`main`,`snack`,`fruit`,`drink`],D=E.map(e=>T[e]).filter(Boolean),te={main:`🥪`,snack:`🍪`,fruit:`🍎`,drink:`🥤`},O=``;if(D.length){let e=``;E.forEach(t=>{T[t]&&(e+=`<div class="cv2-lb-chip">${te[t]}${a?``:` `+x(T[t])}</div>`)}),O=`<div class="cv2-group">
      <div class="cv2-group-heading">🥪 Lunchbox</div>
      <div class="cv2-card cv2-card--warm">
        <div class="cv2-lb-chips">${e}</div>
      </div>
    </div>`}let{events:ne}=eo(t,f),k=[...ne].sort((e,t)=>(e.time||`99:99`).localeCompare(t.time||`99:99`)),re=``;k.length&&!a&&(re=`<div class="cv2-group">
      <div class="cv2-group-heading">📅 Today's Events</div>
      <div class="cv2-card">${k.map(e=>`
      <div class="cv2-event-row">
        <span class="cv2-event-time">${e.time?to(e.time):``}</span>
    ...
    ${re}${O}${j}`:(N=ie,i!==`tiny-tots`&&!s&&(N+=`<button class="cv2-week-shortcut" onclick="_cvSwitchTab('calendar','${t.id}')">📅 See my week →</button>`),p.length&&(N+=`<div class="cv2-group">
      ...
      </div>`),N+=re,N+=O,N+=j),document.getElementById(`cv-content`).innerHTML=N,c.classList.remove(`hidden`),c.style.display=`flex`,ae&&!s&&Wa()}function Ka(e){let t=document.getElementById(`cv-prizes-badge`);if(!t)return;let n=m.kids,r=kidBalance(n,e.id),i=(n.notifications||[]).filter(t=>t.kidId===e.id&&!t.read).length,a=(n.prizes||[]).filter(e=>r>=e.pointCost).length,o=i+(a>0&&i===0?a:0);o>0?(t.textContent=o>9?`9+`:String(o),t.style.display=``):t.style.display=`none`}function qa(e){let t=m.kids,n=kidBalance(t,e.id),r=Ba(e)===`tiny-tots`,i=_cvReadOnly,a=t.prizes||[],o=!1;(t.notifications||[]).filter(t=>t.kidId===e.id&&!t.read).forEach(e=>{e.read=!0,o=!0}),o&&B(m),Ka(e);let s=r?`${`⭐`.repeat(Math.min(n,10))}${n>10?`+`:``}`:`${n}`,c=`<div class="cv2-prizes-balance">
    ...
    <span class="cv2-prizes-balance-emoji">🏆</span>
      ...
      </div>`}),c+=`</div>`);let u=document.getElementById(`cv-content`);u&&(u.innerHTML=c)}var Ja=null,Ya=`today`,Xa=`7day`,Za=null,Qa=new Set;function $a(e,t){t&&(Ja=t);let n=(m.kids?.profiles||[]).find(e=>String(e.id)===String(Ja));if(!n)return;let r=Ba(n),i=document.getElementById(`cv-nav`);i&&(i.style.display=r===`tiny-tots`?`none`:``),document.getElementById(`cv-nav-today`)?.classList.toggle(`active`,e===`today`),document.getElementById(`cv-nav-calendar`)?.classList.toggle(`active`,e===`calendar`),document.getElementById(`cv-nav-prizes`)?.classList.toggle(`active`,e===`prizes`),e===`today`?Ga(Ja):e===`prizes`?qa(n):(Za=null,so(n))}function eo(e,t){let n=(m.routineAssignments||[]).filter(t=>t.childId===e.id).map(e=>{let n=(m.routines||[]).find(t=>t.id===e.routineId);return n&&_routineMatchesDate(n,t)?{type:`routine`,routine:n,assignment:e,label:n.name,emoji:n.emoji,color:`#7C3AED`,tag:`Routine`,time:n.triggerTime||null}:null}).filter(Boolean),r=(m.childEvents||[]).filter(n=>{let r=Array.isArray(n.assignedTo)?n.assignedTo:[n.assignedTo];return r.includes(e.id)||r.includes(`all`)||n.isHouseholdWide?n.recurrence?_recurrenceMatchesDate(n.recurrence,t):n.date===t:!1}).map(e=>({type:`event`,label:e.title,emoji:e.emoji||`📅`,color:`#10b981`,tag:`Event`,notes:e.notes,time:e.time||null})),i=(m.planner?.events||[]).filter(e=>Lt(e).includes(`everyone`)?e.recurrence&&e.recurrence.type!==`one_time`?_recurrenceMatchesDate(e.recurrence,t):e.endDate&&e.endDate>e.date?t>=e.date&&t<=e.endDate:e.date===t:!1).map(e=>({type:`event`,label:e.title,emoji:P[e.category]?.emoji||`📅`,color:`#10b981`,tag:`Event`,notes:e.notes||``,time:e.time||null}));return{routines:n,events:[...r,...i],chores:(m.kids?.chores||[]).filter(t=>(t.assignedTo===e.id||t.assignedTo===`all`)&&!t._isRoutine).map(e=>({type:`chore`,label:e.name,emoji:e.emoji||`📋`,color:`#ec4899`,tag:`Chore`,time:null}))}}function to(e){if(!e)return``;let[t,n]=e.split(`:`).map(Number);return`${t%12||12}:${String(n).padStart(2,`0`)} ${t>=12?`pm`:`am`}`}function no(e){Qa.has(e)?Qa.delete(e):Qa.add(e);let t=(m.kids?.profiles||[]).find(e=>String(e.id)===String(Ja));t&&(Xa===`7day`||Ba(t)===`early-reader`?io(t,new Date().toISOString().slice(0,10)):io(t,Za))}function ro(e,t,n){if(_cvReadOnly)return;let r=_routineGetAssignment(e,Ja);if(!r)return;r.completionState||(r.completionState={});let i=n;r.completionState[i]||(r.completionState[i]=[]);let a=r.completionState[i].indexOf(t),o=a===-1;o?r.completionState[i].push(t):r.completionState[i].splice(a,1);let s=new Date().toISOString().slice(0,10);if(o&&n===s){let n=(m.routines||[]).find(t=>String(t.id)===String(e));if(n){let e=n.steps.find(e=>e.id===t);(e?.points||0)>0&&_routineAwardStepPoints(n,e,Ja);let a=n.steps.length;r.completionState[i].length===a&&a>0&&(n.pointsPerCompletion||0)>0&&_routineAwardPoints(n,Ja)}}B(m);let c=(m.kids?.profiles||[]).find(e=>String(e.id)===String(Ja));c&&io(c,n)}function io(e,t){let n=Xa===`month`?`cv-day-panel`:`cv-schedule-panel`,r=document.getElementById(n);r&&(r.innerHTML=ao(e,t))}function ao(e,t){if(!t)return``;let{routines:n,events:r,chores:i}=eo(e,t),a=t;if(!n.length&&!r.length&&!i.length)return`<div style="text-align:center;padding:28px 0;color:#A1A1AA;font-size:13px">Nothing scheduled</div>`;let o=[...n.map(e=>({...e,sortKey:e.time||`23:59`})),...r.map(e=>({...e,sortKey:e.time||`23:59`}))].sort((e,t)=>e.sortKey.localeCompare(t.sortKey)),s=``;return o.length&&(s+=`<div class="cv-sched-section-hdr">Schedule</div>`,o.forEach(e=>{e.type===`routine`?s+=oo(e.routine,e.assignment,a):s+=`<div class="cv-sched-item">
          <div class="cv-sched-row">
            <span class="cv-sched-time">${e.time?to(e.time):``}</span>
      ...
      </div>`})),s}function oo(e,t,n){let r=t.completionState?.[n]||[],i=e.steps.length,a=i>0?Math.round(r.length/i*100):0,o=r.length===i&&i>0,s=Qa.has(e.id),c=i>0?`
    ...
    <div class="cv-sched-row" style="cursor:pointer" onclick="_cvToggleRoutineExpand(${JSON.stringify(e.id)})">
      <span class="cv-sched-time">${e.triggerTime?to(e.triggerTime):``}</span>
      <div class="cv-sched-color-bar" style="background:#7C3AED"></div>
      <span class="cv-sched-emoji">${e.emoji}</span>
      <div class="cv-sched-body">
        <div class="cv-sched-title">${x(e.name)}</div>
        ${o?`<div class="cv-sched-sub" style="color:#5B4CF5;font-weight:700">✓ Complete</div>`:e.triggerTime?`<div class="cv-sched-sub">${to(e.triggerTime)}</div>`:``}
      </div>
      ${c}
      <button class="cv-sched-expand-btn">${s?`▲`:`▼`}</button>
    </div>
    ${l}
  </div>`}function so(e){if(!e)return;let t=Ba(e)===`early-reader`,n=t?`7day`:Xa,r=new Date().toISOString().slice(0,10),i=document.getElementById(`cv-content`);if(!i)return;let a=``;t||(a+=`<div style="display:flex;gap:8px;margin-bottom:14px">
    ...
    </div>`),a+=n===`7day`?lo(e,r):fo(e,r),i.innerHTML=a}function co(e,t){Xa=e,Za=null;let n=(m.kids?.profiles||[]).find(e=>String(e.id)===String(t));n&&so(n)}function lo(e,t){let n=[`S`,`M`,`T`,`W`,`T`,`F`,`S`],r=new Date(t+`T12:00:00`),i=`<div class="cv-week-strip">`;for(let a=0;a<7;a++){let o=new Date(r);o.setDate(r.getDate()+a);let s=o.toISOString().slice(0,10),c=s===t,{routines:l,events:u,chores:d}=eo(e,s),f=[...l,...u,...d].slice(0,3).map(e=>`<div class="cv-cal-dot" style="background:${e.color}"></div>`).join(``);i+=`<div class="cv-week-cell ${c?`cv-today`:``}" onclick="_cvWeekDayTap('${s}','${e.id}')">
    ...
    </div>`}i+=`</div>`;let a=new Date(t+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`});return i+=`<div style="font-size:13px;font-weight:700;color:#1e293b;margin:10px 0 2px">${x(a)}</div>`,i+=`<div id="cv-schedule-panel">${ao(e,t)}</div>`,i}function uo(e,t){let n=(m.kids?.profiles||[]).find(e=>String(e.id)===String(t));if(!n)return;Qa.clear(),document.querySelectorAll(`.cv-week-cell`).forEach(t=>{t.classList.toggle(`cv-today`,t.getAttribute(`onclick`)?.includes(`'${e}'`))});let r=new Date(e+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`}),i=document.getElementById(`cv-schedule-panel`);i&&(i.previousElementSibling.textContent=r,i.innerHTML=ao(n,e))}function fo(e,t){let n=new Date(t+`T12:00:00`),r=n.getFullYear(),i=n.getMonth(),a=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`],o=[`S`,`M`,`T`,`W`,`T`,`F`,`S`],s=new Date(r,i,1).getDay(),c=new Date(r,i+1,0).getDate(),l=Za||t,u=`<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
    <span style="font-size:14px;font-weight:800;color:#18181B">${a[i]} ${r}</span>
  </div>`;u+=`<div class="cv-cal-grid">`,o.forEach(e=>{u+=`<div class="cv-cal-day-hdr">${e}</div>`});for(let e=0;e<s;e++)u+=`<div class="cv-cal-cell cv-other"></div>`;for(let n=1;n<=c;n++){let a=`${r}-${String(i+1).padStart(2,`0`)}-${String(n).padStart(2,`0`)}`,o=a===t,s=a===l,{routines:c,events:d,chores:f}=eo(e,a),p=[...c,...d,...f].slice(0,3).map(e=>`<div class="cv-cal-dot" style="background:${e.color}"></div>`).join(``);u+=`<div class="cv-cal-cell ${o?`cv-today`:``} ${s&&!o?`cv-cal-cell--sel`:``}" onclick="_cvMonthDayTap('${a}','${e.id}')">
    ...
    <div id="cv-day-panel">${ao(e,l)}</div>
  </div>`,u}function po(e,t){Za=e,Qa.clear();let n=(m.kids?.profiles||[]).find(e=>String(e.id)===String(t));n&&so(n)}function mo(e,t){po(e,t)}function ho(e,t){let n=(m.kids?.notifications||[]).find(t=>t.id===e);n&&(n.read=!0),B(m),Ga(t)}function go(e,t){let n=(m.kids?.prizes||[]).find(e=>String(e.id)===String(t));if(!n)return;let r=`<div class="cv2-confirm">
  ...
  </div>`;document.getElementById(`cv-content`).innerHTML=r}function _o(e,t){m.kids.completions.find(n=>n.kidId===e&&n.choreId===t&&n.status===`pending`)||(m.kids.completions.push({id:uid(),kidId:e,choreId:t,status:`pending`,ts:new Date().toISOString()}),B(m),Ga(e))}function vo(e,t){m.kids.redemptions.push({id:uid(),kidId:e,prizeId:t,status:`pending`,ts:new Date().toISOString()}),B(m),$a(`prizes`,e)}function yo(e){let t=(m.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(V={id:t.id,name:t.name,emoji:t.emoji,role:`child`},fa(t.id),Ga(e))}var bo=`member`,xo=null,So=null;function Co(e){bo=e;let t=document.getElementById(`inv-role-member`),n=document.getElementById(`inv-role-owner`);!t||!n||(e===`member`?(t.style.borderColor=`#0d9488`,t.style.background=`#f0fdfa`,t.style.color=`#0d9488`,n.style.borderColor=`var(--border)`,n.style.background=`var(--surface)`,n.style.color=`var(--text-muted)`):(n.style.borderColor=`#0d9488`,n.style.background=`#f0fdfa`,n.style.color=`#0d9488`,t.style.borderColor=`var(--border)`,t.style.background=`var(--surface)`,t.style.color=`var(--text-muted)`))}function wo(e,t){let n=document.getElementById(`inv-email`),r=n?n.value.trim():``,i=(m.householdProfile.members||[]).find(e=>e.role===`adult`)?.name||`Someone`,a=new Date(Date.now()+10080*60*1e3).toISOString(),o={id:uid(),email:r,role:bo,inviterName:i,memberName:t||null,memberIdx:e??null,createdAt:new Date().toISOString(),expiresAt:a,status:`pending`};m.householdProfile.invites||(m.householdProfile.invites=[]),m.householdProfile.invites.push(o),B(m),xo=o.id;let s=Oo(o.id),c=document.getElementById(`invite-link-wrap`),l=document.getElementById(`invite-form-wrap`),u=document.getElementById(`invite-link-display`);c&&(c.dataset.invEmail=r,c.dataset.invToken=o.id,c.style.display=`block`),l&&(l.style.display=`none`),u&&(u.textContent=s)}function To(e){let t=(m.householdProfile.members||[])[e];if(!t)return;let n=(m.householdProfile.members||[]).find((e,t)=>e.role===`adult`&&t===0)?.name||`Someone`,r=new Date(Date.now()+10080*60*1e3).toISOString(),i={id:uid(),email:``,role:`member`,inviterName:n,memberName:t.name||null,memberIdx:e,createdAt:new Date().toISOString(),expiresAt:r,status:`pending`};m.householdProfile.invites||(m.householdProfile.invites=[]),m.householdProfile.invites.push(i),B(m);let a=Oo(i.id),o=x(t.name||`this person`),s=document.createElement(`div`);s.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:24px`,s.innerHTML=`<div style="background:#fff;border-radius:16px;padding:24px;max-width:400px;width:100%">
  ...
  </div>`,document.body.appendChild(s),s.addEventListener(`click`,e=>{e.target===s&&(s.remove(),Z())})}function Eo(e){if(!e)return;let t=(m.kids?.profiles||[]).find(t=>t.name&&t.name.toLowerCase()===e.toLowerCase());if(!t){m.kids||(m.kids={profiles:[],chores:[],prizes:[],completions:[],redemptions:[]});let n=(m.householdProfile.members||[]).find(t=>t.name&&t.name.toLowerCase()===e.toLowerCase()),r=M(m.kids.profiles);t={id:r,name:e,age:n?.age||null,emoji:n?.emoji||`🧒`},m.kids.profiles.push(t),m.meals?.lunchbox?.profiles||(m.meals||(m.meals={}),m.meals.lunchbox||(m.meals.lunchbox={profiles:[]})),m.meals.lunchbox.profiles.push({id:r,name:e,emoji:t.emoji}),B(m)}ns(t.id)}function Do(e){navigator.clipboard.writeText(Oo(e)).then(()=>{let e=event.target,t=e.textContent;e.textContent=`✓ Copied!`,setTimeout(()=>{e.textContent=t},2e3)})}function Oo(e){let t=Ai()||``;return window.location.origin+window.location.pathname+`?invite=`+e+`&h=`+t}function ko(){let e=document.getElementById(`invite-link-wrap`)?.dataset.invToken||xo;e&&navigator.clipboard.writeText(Oo(e)).then(()=>{let e=event.target,t=e.textContent;e.textContent=`✓ Copied!`,setTimeout(()=>{e.textContent=t},2e3)})}function Ao(){let e=document.getElementById(`invite-link-wrap`),t=e?.dataset.invToken||xo,n=e?.dataset.invEmail||``;if(!t)return;let r=(m.householdProfile.invites||[]).find(e=>e.id===t)?.inviterName||`Your partner`,i=Oo(t),a=encodeURIComponent(`${r} invited you to join their Toto household`),o=encodeURIComponent(`Hi,\n\n${r} has invited you to join their Toto household — a shared family finance and planning app.\n\nClick the link below to accept the invite (expires in 7 days):\n\n${i}\n\nSee you there!`);window.open(`mailto:${n}?subject=${a}&body=${o}`,`_blank`)}function jo(e){if(!confirm(`Revoke this invite link?`))return;let t=(m.householdProfile.invites||[]).find(t=>t.id===e);t&&(t.status=`revoked`),B(m),Z()}var Mo=`toto_pending_invite`;function No(){let e=new URLSearchParams(window.location.search),t=e.get(`invite`),n=e.get(`h`);t&&(sessionStorage.setItem(Mo,t),n&&sessionStorage.setItem(ki,n),window.history.replaceState({},``,window.location.pathname+window.location.hash))}function Po(){let e=sessionStorage.getItem(Mo);if(!e)return;let t=(m.householdProfile.invites||[]).find(t=>t.id===e);if(!t){sessionStorage.removeItem(Mo);return}if(t.status!==`pending`||new Date(t.expiresAt)<new Date){sessionStorage.removeItem(Mo),Ko(t);return}sessionStorage.removeItem(Mo),So=t,Fo(t)}function Fo(t){let n=m.householdProfile.members||[],r=n.filter(e=>e.role===`adult`),i=n.filter(e=>e.role===`child`),a=(()=>{let t=new Date,n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}`,r=getOrCreateMonthData(n);return(r.income||[]).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)-(r.expenses||[]).filter(e=>!e.skipped).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)})(),o=[...r.map(e=>`
  ...
  `)}function Io(){let t=So,n=R?.displayName?.split(` `)[0]||`there`,r=m.householdProfile.members||[],i=r.filter(e=>e.role===`adult`),a=r.filter(e=>e.role===`child`),o=(()=>{let t=new Date,n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}`,r=getOrCreateMonthData(n);return(r.income||[]).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)-(r.expenses||[]).filter(e=>!e.skipped).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)})(),s=(m.goals||[]).length,c=[...i.map((e,t)=>`
      <div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid #f1f5f9">
        <div style="width:40px;height:40px;border-radius:50%;background:linear-gradient(135deg,#ecfeff,#ccfbf1);display:flex;align-items:center;justify-content:center;font-size:20px">👤</div>
        <div>
  ...
  `)}var Lo=0,Ro=[{emoji:`💰`,title:`The Kitty`,desc:`Budget, bills, goals & net worth. See where the money goes each month.`},{emoji:`📅`,title:`Plan`,desc:`Weekly planner, meal plans & the kids' lunchboxes. One place for the week ahead.`},{emoji:`🏠`,title:`Home`,desc:`Documents, vehicles & maintenance reminders. Never miss a rego or warranty renewal.`}];function zo(){Lo=0,Bo()}function Bo(){let e=Ro[Lo],t=Ro.map((e,t)=>`<div style="width:${t===Lo?20:8}px;height:8px;border-radius:99px;background:${t===Lo?`#0d9488`:`#e2e8f0`};transition:all .2s"></div>`).join(``),n=Lo===Ro.length-1;qo(`
  ...
  `)}function Ho(){let e=document.getElementById(`inv-inc-name`)?.value.trim()||``,t=parseFloat(document.getElementById(`inv-inc-amount`)?.value)||0,n=document.getElementById(`inv-inc-freq`)?.value||`Monthly`;(e||t)&&(m.budget.income||(m.budget.income=[]),m.budget.income.push({id:M(m.budget.income),name:e,amount:t,frequency:n}),B(m)),Go()}function Uo(){let e=So;if(!R){sessionStorage.setItem(`toto_post_invite_action`,e?.id||``),Ii();return}Wo(e),Io()}function Wo(e){if(!e)return;e.status=`accepted`;let t=R,n=Ai();n&&Mi(n),m.householdProfile.authorizedUsers||(m.householdProfile.authorizedUsers=[]),m.householdProfile.authorizedUsers.some(e=>e.uid===t.uid)||m.householdProfile.authorizedUsers.push({uid:t.uid,name:t.displayName||``,email:t.email||``,role:e.role||`member`,joinedAt:new Date().toISOString()});let r=m.householdProfile.members||[],i=(t.displayName||``).split(` `)[0];i&&!r.some(e=>e.name===i)&&m.householdProfile.members.push({role:`adult`,name:i,age:null}),B(m)}function Go(){So=null,Jo(),renderAll(),ha()}function Ko(e){qo(`
  ...
  `)}function qo(e){document.getElementById(`invite-flow-content`).innerHTML=e;let t=document.getElementById(`invite-flow-overlay`);t.classList.remove(`hidden`),t.style.display=`flex`,t.scrollTop=0}function Jo(){let e=document.getElementById(`invite-flow-overlay`);e.classList.add(`hidden`),e.style.display=``}var Yo=`toto_pin_hard_`,Xo=`toto_pin_att_`,Zo=null,W=`gate`,Qo=``,$o=``,es=0,ts=null;function ns(e){let t=(m.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(Zo=e,$o=``,Qo=``,W=t.pinHash?`enter`:`gate`,is(),document.getElementById(`pin-setup-overlay`).classList.remove(`hidden`))}function rs(){ts&&(clearInterval(ts),ts=null),document.getElementById(`pin-setup-overlay`).classList.add(`hidden`),Zo=null}function is(){let e=(m.kids?.profiles||[]).find(e=>String(e.id)===String(Zo));if(!e)return;let t=document.getElementById(`pso-screen`);if(!t)return;let n=e.emoji||`🧒`,r=x(e.name),i={gate:`#f8fafc`,hello:`linear-gradient(160deg,#f0fdfa,#ecfeff)`,enter:`#f8fafc`,confirm:`#f8fafc`,tour:`#f8fafc`};if(document.getElementById(`pin-setup-overlay`).style.background=i[W]||`#f8fafc`,W===`gate`)t.innerHTML=`
      ...
      <button onclick="closePinSetupOverlay()" style="font-size:13px;color:#94a3b8;background:none;border:none;cursor:pointer">Cancel</button>`;else if(W===`hello`)t.innerHTML=`
      ...
      <button onclick="_psoStep='enter';_psoRender()"
        ...
        Let's go! →
      </button>`;else if(W===`enter`||W===`confirm`){let n=W===`enter`,i=n?e.pinHash?`Change ${r}'s PIN`:`Choose your secret code 🔢`:`Type it again ✅`,a=n?`Pick 4 numbers only you know!`:`Just to make sure!`,o=[0,1,2,3].map(e=>{let t=e<$o.length;return`<div style="width:52px;height:60px;border:2px solid ${t?`#0d9488`:`#e2e8f0`};border-radius:10px;background:${t?`#f0fdfa`:`#f8fafc`};display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:700;color:#0d9488">${t?`●`:``}</div>`}).join(``),s=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div></div>`:`<div onclick="_psoKey('${e}')" style="height:52px;border:1.5px solid #e2e8f0;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:600;color:#374151;cursor:pointer;background:#fff;-webkit-tap-highlight-color:transparent;user-select:none">${e}</div>`).join(``);t.innerHTML=`
      ...
      ${r?``:`<button onclick="_psoTourDone()" style="font-size:13px;color:#94a3b8;background:none;border:none;cursor:pointer">Skip</button>`}`}}function as(){if(ts)return;let e=0,t=document.getElementById(`pso-hold-fill`);t&&(t.style.transition=`none`,t.style.transform=`scaleX(0)`),ts=setInterval(()=>{e+=50;let n=Math.min(e/2e3,1);t&&(t.style.transition=`none`,t.style.transform=`scaleX(${n})`),e>=2e3&&(clearInterval(ts),ts=null,W=`hello`,is())},50)}function os(){ts&&(clearInterval(ts),ts=null);let e=document.getElementById(`pso-hold-fill`);e&&(e.style.transition=`transform .3s`,e.style.transform=`scaleX(0)`)}function ss(e){if(e===`⌫`){$o=$o.slice(0,-1),is();return}$o.length>=4||($o+=e,is(),$o.length===4&&cs())}async function cs(){if(W===`enter`)Qo=$o,$o=``,W=`confirm`,is();else if(W===`confirm`){if($o!==Qo){$o=``,Qo=``,W=`enter`,is();let e=document.getElementById(`pso-error`);e&&(e.textContent=`Those didn't match — try again 🙈`);return}await ka(Zo,$o);let e=(m.kids?.profiles||[]).find(e=>String(e.id)===String(Zo));e&&!e._pinWasSet?(es=0,W=`tour`,is()):(rs(),renderKids(),Z()),e._pinWasSet=!0}}function ls(){let e=(m.kids?.profiles||[]).find(e=>String(e.id)===String(Zo));rs(),e&&Ga(e.id)}function us(e){return parseInt(aa(Xo+e)||`0`)}function ds(e){let t=us(e)+1;return oa(Xo+e,String(t)),t}function fs(e){sa(Xo+e),sa(Yo+e)}function ps(e){return aa(Yo+e)===`1`}function ms(e){oa(Yo+e,`1`)}async function hs(){let e=await ma(U,Ai());if(typeof ta==`string`&&ta.startsWith(`adult:`)){let t=parseInt(ta.split(`:`)[1]),n=(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[t];if(!n)return;e===n.pinHash?(H=0,V=null,pa(),document.getElementById(`pin-overlay`).classList.add(`hidden`),Ea()):(H++,U=``,Sa(),H>=3?(ea=Date.now()+3e4,H=0,Ca()):document.getElementById(`pin-error`).textContent=`Wrong PIN — ${3-H} tr${3-H==1?`y`:`ies`} left`);return}let t=(m.kids?.profiles||[]).find(e=>e.id===ta);if(t){if(ps(t.id)){document.getElementById(`pin-error`).textContent=`PIN locked — ask mum or dad to reset it 🔒`,document.getElementById(`pin-pad`).innerHTML=``,gs(t);return}if(e===t.pinHash)fs(t.id),H=0,V={id:t.id,name:t.name,emoji:t.emoji,role:`child`},fa(t.id),document.getElementById(`pin-overlay`).classList.add(`hidden`),Ea();else if(U=``,Sa(),H++,ds(t.id)>=10)ms(t.id),ea=0,document.getElementById(`pin-error`).textContent=`PIN locked — ask mum or dad to reset it 🔒`,document.getElementById(`pin-pad`).innerHTML=``,gs(t);else if(H>=3)ea=Date.now()+3e4,H=0,Ca();else{let e=3-H;document.getElementById(`pin-error`).textContent=`Wrong PIN — ${e} try${e===1?``:`s`} left`}}}function gs(e){m.notifications||(m.notifications=[]),m.notifications.some(t=>t.type===`pin-lock`&&t.kidId===e.id)||(m.notifications.unshift({id:uid(),type:`pin-lock`,kidId:e.id,msg:`${e.name}'s PIN has been locked after too many failed attempts. Reset it in Settings → Household.`,ts:new Date().toISOString(),read:!1}),B(m))}function _s(e){fs(e),H=0,ea=0,Z()}function G(e){return m.budget.months&&m.budget.months[e]||{income:m.budget.income,expenses:m.budget.expenses}}function vs(e){return!!(m.budget.months&&m.budget.months[e])}function ys(e){return m.budget.months||(m.budget.months={}),m.budget.months[e]||(m.budget.months[e]={income:JSON.parse(JSON.stringify(m.budget.income)),expenses:JSON.parse(JSON.stringify(m.budget.expenses))}),m.budget.months[e]}function bs(e){let[t,n]=e.split(`-`).map(Number),r=new Date(t,n-2,1);return`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}`}function xs(e){let t=bs(e),n=G(t);m.budget.months||(m.budget.months={}),m.budget.months[e]={income:JSON.parse(JSON.stringify(n.income.filter(e=>e.recurring!==!1))),expenses:JSON.parse(JSON.stringify(n.expenses.filter(e=>e.recurring!==!1)))},z(`Auto-filled`,`${q(e)} copied from ${q(t)}`),B(m),safeRender(Hu),safeRender(yc)}var Ss=null;function Cs(e,t){Ss={onThisMonth:e,onAllMonths:t};let n=q(K);document.getElementById(`modal-title`).textContent=`Apply changes`,document.getElementById(`modal-body`).innerHTML=`
    ...
    ${vs(K)?`<p style="font-size:12px;color:var(--primary);margin-top:10px;margin-bottom:0">
  ...
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function ws(){Ss&&(Ss.onThisMonth(),Ss=null),$()}function Ts(){Ss&&(Ss.onAllMonths(),Ss=null),$()}p(Xi()),No(),setTimeout(()=>{try{_routineCheckDailyReset()}catch{}},0);var K=new Date().toISOString().slice(0,7),Es=`grouped`,Ds=new Set([`ai`,`household`]),Os=new Date().getFullYear(),ks=new Date().getMonth()+1;function As(){return document.getElementById(`f-exp-duedate`)||document.getElementById(`f-inc-duedate`)}function js(e){e.stopPropagation();let t=document.getElementById(`dp-popup`);if(!t)return;let n=(As()||{}).value||``;if(n)[Os,ks]=n.split(`-`).map(Number);else{let e=new Date;Os=e.getFullYear(),ks=e.getMonth()+1}t.classList.remove(`hidden`),Ms();function r(e){let n=document.getElementById(`dp-wrap`);n&&!n.contains(e.target)?t.classList.add(`hidden`):document.addEventListener(`click`,r,{once:!0})}document.addEventListener(`click`,r,{once:!0})}function Ms(){let e=document.getElementById(`dp-popup`);if(!e)return;let t=Os,n=ks,r=new Date(t,n-1,1).getDay(),i=new Date(t,n,0).getDate(),a=new Date,o=(As()||{}).value||``,s=`
    <div class="dp-nav">
  ...
  `;for(let e=0;e<r;e++)s+=`<div class="dp-day dp-other"></div>`;for(let e=1;e<=i;e++){let r=`${t}-${String(n).padStart(2,`0`)}-${String(e).padStart(2,`0`)}`,i=[`dp-day`,a.getFullYear()===t&&a.getMonth()+1===n&&a.getDate()===e?`dp-today`:``,o===r?`dp-selected`:``].filter(Boolean).join(` `);s+=`<div class="${i}" onclick="dpSelectDate('${r}',event)">${e}</div>`}s+=`</div>`,o&&(s+=`<div class="dp-clear"><button class="dp-clear-btn" onclick="dpClearDate(event)">Clear date</button></div>`),e.innerHTML=s}function Ns(e){e.stopPropagation(),ks===1?(ks=12,Os--):ks--,Ms()}function Ps(e){e.stopPropagation(),ks===12?(ks=1,Os++):ks++,Ms()}function Fs(e,t){t&&t.stopPropagation();let n=As();n&&(n.value=e);let[r,i,a]=e.split(`-`);document.getElementById(`dp-display`).textContent=`${a}/${i}/${r}`,document.getElementById(`dp-trigger`).classList.add(`has-value`),document.getElementById(`dp-popup`).classList.add(`hidden`);let o=document.getElementById(`dp-repeats-wrap`);o&&(o.style.display=``)}function Is(e){e.stopPropagation();let t=As();t&&(t.value=``),document.getElementById(`dp-display`).textContent=`Select a date`,document.getElementById(`dp-trigger`).classList.remove(`has-value`),document.getElementById(`dp-popup`).classList.add(`hidden`);let n=document.getElementById(`dp-repeats-wrap`);n&&(n.style.display=`none`)}function Ls(){let[e,t]=K.split(`-`).map(Number),n=new Date(e,t-2,1);K=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,Hu()}function Rs(){let[e,t]=K.split(`-`).map(Number),n=new Date(e,t,1);if(K=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,m.settings&&m.settings.autoFillMonths&&!vs(K)){xs(K);return}Hu()}function q(e){let[t,n]=e.split(`-`).map(Number);return new Date(t,n-1,1).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`})}function zs(e){let[t,n]=e.split(`-`).map(Number);return new Date(t,n-1,1).toLocaleDateString(`en-AU`,{month:`short`,year:`2-digit`})}function Bs(){let e=[],t=new Date;for(let n=5;n>=0;n--){let r=new Date(t.getFullYear(),t.getMonth()-n,1);e.push(`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}`)}return e}function Vs(e,t){let n=(m.budget.actuals[t]||{})[e];return n?typeof n==`number`?[{id:1,amount:n,date:``,note:``}]:Array.isArray(n)?n:[]:[]}function J(e,t){return Vs(e,t).reduce((e,t)=>e+(t.amount||0),0)}function Hs(e,t,n){m.budget.actuals[t]||(m.budget.actuals[t]={});let r=Vs(e,t);r.length===1&&!r[0].date&&!r[0].note?m.budget.actuals[t][e]=[{...r[0],amount:n}]:m.budget.actuals[t][e]=[{id:1,amount:n,date:``,note:``}],B(m)}function Us(e){let t=G(K).expenses.find(t=>t.id===e);if(!t)return;let n=A(t);function r(){let t=Vs(e,K),r=t.reduce((e,t)=>e+(t.amount||0),0),i=n>0?Math.round(r/n*100):0,a=i>=100?`var(--danger)`:i>=80?`var(--warning)`:`var(--success)`;return`
      ...
      </div>`:`<p style="font-size:13px;color:var(--text-muted);margin-bottom:14px">No entries yet for ${q(K)}.</p>`}
    ...
    `}function i(){document.getElementById(`actual-editor-body`).innerHTML=r()}window._actualEditorRefresh=i,document.getElementById(`modal-title`).textContent=`Actuals — ${t.name}`,document.getElementById(`modal-body`).innerHTML=`<div id="actual-editor-body">${r()}</div>`,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-primary" onclick="closeModal();renderBudget()">Done</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Ws(e){let t=parseFloat(document.getElementById(`ae-amount`).value);if(!t||t<=0)return;let n=document.getElementById(`ae-date`).value||``,r=document.getElementById(`ae-note`).value.trim();m.budget.actuals[K]||(m.budget.actuals[K]={});let i=Vs(e,K);i.push({id:i.length?Math.max(...i.map(e=>e.id))+1:1,amount:t,date:n,note:r}),m.budget.actuals[K][e]=i,B(m),window._actualEditorRefresh&&window._actualEditorRefresh()}function Gs(e,t){if(!m.budget.actuals[K])return;let n=Vs(e,K);n.splice(t,1),m.budget.actuals[K][e]=n,B(m),window._actualEditorRefresh&&window._actualEditorRefresh()}function Ks(e){Us(e)}var qs=[],Js=[];function Ys(){document.getElementById(`modal-title`).textContent=`Import Bank Transactions`,document.getElementById(`modal-body`).innerHTML=`
    <div style="padding:4px 0">
      <p style="font-size:13px;color:var(--text-muted);margin-bottom:16px">
        Upload a CSV exported from your bank. Works with ANZ, CBA, Westpac, NAB and most Australian banks.
        Transactions will be matched to your <strong>${q(K)}</strong> budget categories.
      </p>
    ...
    <div>
      <div style="background:var(--success-light);border:1px solid #6ee7b7;border-radius:8px;padding:10px 14px;margin-bottom:16px;font-size:13px;color:#155e75">
        Found <strong>${qs.length} expense transactions</strong> in your CSV
      </div>
      <div class="table-wrap" style="margin-bottom:16px">
        <table>
          ...
          <tbody>
            ...
            ${qs.length>5?`<tr><td colspan="3" style="text-align:center;color:var(--text-muted);font-size:12px;padding:8px">+ ${qs.length-5} more rows…</td></tr>`:``}
          </tbody>
        </table>
      </div>
    ...
    <button class="btn" onclick="closeModal()">Cancel</button>
    ${e?`<button class="btn btn-primary" onclick="runCsvCategorise()">Categorise with AI →</button>`:`<button class="btn btn-primary" onclick="_renderCsvReview(null)">Assign Manually →</button>`}`}async function $s(){let e=localStorage.getItem(`toto_ai_key`);if(!e){ec(null);return}document.getElementById(`modal-body`).innerHTML=`
    <div style="text-align:center;padding:48px 16px">
      <div style="font-size:32px;margin-bottom:12px">🤖</div>
      <div style="font-weight:600;margin-bottom:6px">Categorising ${qs.length} transactions…</div>
      <div style="font-size:12px;color:var(--text-muted)">Matching to your ${q(K)} budget categories</div>
    </div>`,document.getElementById(`modal-footer`).innerHTML=``;let t=G(K).expenses.map(e=>`${e.id}: ${e.name}${e.category?` (`+e.category+`)`:``}`).join(`
`),n=qs.some(e=>e.bankCat),r,i;if(window._csvSuggestions={},n){let e={};qs.forEach((t,n)=>{let r=t.bankCat||`Other`;e[r]||(e[r]={bankCat:r,indices:[],sample:t.description}),e[r].indices.push(n)});let t=Object.values(e);r=t.map((e,t)=>({idx:t,bankCategory:e.bankCat,sample:e.sample})),i=e=>{let n={};return e.forEach(e=>{let r=t[e.idx];r&&r.indices.forEach(t=>{n[t]=e.expenseId,e.suggest&&(_csvSuggestions[t]=e.suggest)})}),n}}else{let e={};qs.forEach((t,n)=>{let r=t.description.toUpperCase().replace(/\s+/g,` `).trim();e[r]||(e[r]={desc:t.description,indices:[]}),e[r].indices.push(n)});let t=Object.values(e);r=t.map((e,t)=>({idx:t,description:e.desc})),i=e=>{let n={};return e.forEach(e=>{let r=t[e.idx];r&&r.indices.forEach(t=>{n[t]=e.expenseId,e.suggest&&(_csvSuggestions[t]=e.suggest)})}),n}}let a=n?`bank categories`:`unique transaction descriptions`,o=`You are categorising Australian bank transactions for a family budget app.

The user's EXISTING budget expense categories (id: name):
${t||`(none yet)`}

Here are ${r.length} ${a} from their bank statement (${qs.length} total transactions):
${JSON.stringify(r)}
...
[{"idx":0,"expenseId":3},{"idx":1,"expenseId":-1,"suggest":"Dining Out"},{"idx":2,"expenseId":-1}]`;try{let t=await fetch(Ji,{method:`POST`,headers:{"x-api-key":e,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:4096,messages:[{role:`user`,content:o}]})});if(!t.ok)throw Error(`API error ${t.status}`);let n=(await t.json()).content[0].text.replace(/```[\w]*\n?/g,``).trim().match(/\[[\s\S]*\]/);if(!n)throw Error(`No JSON in response`);let r=JSON.parse(n[0]);ec(i(r))}catch(e){document.getElementById(`modal-body`).innerHTML=`
    ...
    </tr>`}).join(``),u=e?`<div style="font-size:12px;color:var(--text-muted);margin-bottom:10px">🤖 Transactions grouped by category — review and adjust as needed.</div>`:``,d=Js.filter(e=>e.checked&&e.expenseId!==-1).length,f=Js.filter(e=>e.checked&&e.expenseId!==-1).reduce((e,t)=>e+t.count,0);document.getElementById(`modal-body`).innerHTML=`
    <div>
      ${u}
    ...
    </div>`;let p=Js.filter(e=>e.checked&&e.expenseId===-1).length;document.getElementById(`modal-footer`).innerHTML=`
    ...
    </div>`}function tc(e,t){Js[e].checked=t,ic()}function nc(e){Js.forEach((t,n)=>{t.checked=e;let r=document.getElementById(`csv-chk-${n}`);r&&(r.checked=e)}),ic()}function rc(e,t){Js[e].expenseId=t,Js[e].checked=!0;let n=document.getElementById(`csv-chk-${e}`);n&&(n.checked=!0),ic()}function ic(){let e=Js.filter(e=>e.checked&&e.expenseId!==-1),t=Js.filter(e=>e.checked&&e.expenseId===-1),n=e.length,r=e.reduce((e,t)=>e+t.count,0),i=document.getElementById(`csv-apply-btn`);i&&(i.textContent=`Apply ${n} group${n===1?``:`s`} (${r} txns)`,i.disabled=n===0);let a=document.getElementById(`csv-pending-note`);a&&(a.textContent=t.length>0?`${t.length} checked group${t.length===1?``:`s`} still need a category assigned`:``)}function ac(){let e=Js.filter(e=>e.checked&&e.expenseId!==-1);if(!e.length){$();return}m.budget.actuals[K]||(m.budget.actuals[K]={});let t=window._csvSuggestNames||{},n={};e.forEach(e=>{let r=e.expenseId;if(r<-1&&t[r]){if(!n[r]){let e={id:M(m.budget.expenses),name:t[r],amount:0,frequency:`monthly`,category:t[r],dueDate:``,vendor:null};if(m.budget.expenses.push(e),vs(K)){let t=m.budget.months[K];t.expenses.push({...e,id:M(t.expenses)}),n[r]=t.expenses[t.expenses.length-1].id}else n[r]=e.id}r=n[r]}let i=Vs(r,K),a=i.length?Math.max(...i.map(e=>e.id))+1:1,o=e.descs.join(`, `)+(e.count>e.descs.length?` +${e.count-e.descs.length} more`:``);i.push({id:a,amount:e.total,date:e.txns[0].date,note:`${e.count} transactions: ${o}`}),m.budget.actuals[K][r]=i}),B(m),$(),renderAll()}var Y=``,oc=null;function sc(){lc(),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>document.getElementById(`qa-sheet`).classList.add(`open`))}function cc(){document.getElementById(`qa-sheet`).classList.remove(`open`),document.getElementById(`qa-overlay`).classList.remove(`open`)}function lc(){document.getElementById(`qa-sheet`).innerHTML=`
    ...
    <div style="height:max(12px,env(safe-area-inset-bottom))"></div>`,requestAnimationFrame(()=>document.getElementById(`qah-text`)?.focus())}function uc(e){cc(),setTimeout(()=>{if(e===`event`)b(`planner`),setTimeout(()=>Rn(null,new Date().toISOString().slice(0,10)),300);else if(e===`expense`){let e=G(K).expenses,t=parseInt(localStorage.getItem(`toto_qa_last`)||`0`);oc=e.find(e=>e.id===t)?.id??e[0]?.id??null,Y=``,pc(e),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>document.getElementById(`qa-sheet`).classList.add(`open`))}else e===`income`?(b(`budget`),setTimeout(()=>dd(),300)):e===`bill`?(b(`bills`),setTimeout(()=>lt(),300)):e===`chore`?(b(`kids`),setTimeout(()=>{typeof renderChoreMgmt==`function`&&renderChoreMgmt()},300)):e===`shopping`?(window._listsActiveType=`food`,window._listsView=`list`,b(`lists`)):e===`ai`&&typeof dr==`function`&&dr()},320)}async function dc(){let e=document.getElementById(`qah-text`)?.value.trim();if(!e){uc(`ai`);return}let t=document.querySelector(`.qah-ai-send`);t&&(t.textContent=`…`,t.disabled=!0);let n=`Today is ${new Date().toISOString().slice(0,10)}. The user typed: "${e}"
...
- If genuinely unclear → unknown`;try{let t=m.settings?.claudeApiKey,r=(await(await fetch(Ji,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:150,messages:[{role:`user`,content:n}]})})).json()).content?.[0]?.text?.trim()||`{"type":"unknown"}`,i=JSON.parse(r.replace(/```[\w]*\n?/g,``).trim());cc(),await fc(i,e)}catch{cc(),setTimeout(()=>{typeof dr==`function`&&dr(),setTimeout(()=>{let t=document.getElementById(`toto-input`)||document.querySelector(`.toto-msg-input`);t&&(t.value=e,t.focus())},400)},320)}}async function fc(e,t){let n=e=>new Promise(t=>setTimeout(t,e));if(e.type===`event`){b(`planner`),await n(320),Rn(null,e.date||new Date().toISOString().slice(0,10)),await n(200);let r=document.getElementById(`pe-title`),i=document.getElementById(`pe-time`);if(r&&(r.value=e.title||t),i&&e.time&&(i.value=e.time),e.date){let t=document.getElementById(`pe-date`),n=document.getElementById(`pm-start-display`);t&&(t.value=e.date),n&&typeof Bn==`function`&&(n.textContent=Bn(e.date))}}else if(e.type===`expense`){let t=G(K).expenses,n=parseInt(localStorage.getItem(`toto_qa_last`)||`0`);oc=t.find(e=>e.id===n)?.id??t[0]?.id??null,Y=e.amount?String(e.amount):``,pc(t),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>{document.getElementById(`qa-sheet`).classList.add(`open`);let t=document.getElementById(`qa-note`);t&&e.note&&(t.value=e.note)})}else if(e.type===`income`){b(`budget`),await n(320),dd(),await n(200);let t=document.getElementById(`inc-name`)||document.querySelector(`#modal-body [id*="name"]`),r=document.getElementById(`inc-amount`)||document.querySelector(`#modal-body [id*="amount"]`);t&&e.name&&(t.value=e.name),r&&e.amount&&(r.value=e.amount)}else if(e.type===`bill`){b(`bills`),await n(320),lt(),await n(200);let t=document.getElementById(`bill-name`),r=document.getElementById(`bill-amount`),i=document.getElementById(`bill-due`);t&&e.name&&(t.value=e.name),r&&e.amount&&(r.value=e.amount),i&&e.dueDate&&(i.value=e.dueDate)}else if(e.type===`chore`)b(`kids`),await n(320);else if(e.type===`shopping`){window._listsActiveType=`food`,window._listsView=`list`,b(`lists`),await n(320);let t=document.getElementById(`ls-quick-input`);t&&e.name&&(t.value=e.name,t.focus())}else{typeof dr==`function`&&dr(),await n(400);let e=document.getElementById(`toto-input`)||document.querySelector(`.toto-msg-input`);e&&(e.value=t,e.focus())}}function pc(e){let t=e||G(K).expenses,n=Y?`$${Y}`:`$0`,r=!Y,i=t.length?t.map(e=>`<button class="qa-cat${e.id===oc?` selected`:``}" onclick="_qaSelectCat(${e.id})">${x(e.name)}</button>`).join(``):`<span style="color:var(--text-muted);font-size:13px;padding:6px 4px">Add budget expenses first</span>`,a=[`1`,`2`,`3`,`4`,`5`,`6`,`7`,`8`,`9`,`.`,`0`,`⌫`];document.getElementById(`qa-sheet`).innerHTML=`
    <div class="qa-handle"></div>
    ...
    </div>`}function mc(e){if(e===`⌫`)Y=Y.slice(0,-1);else if(e===`.`)Y.includes(`.`)||(Y+=(Y?``:`0`)+`.`);else{let t=Y.split(`.`);if(t[1]!==void 0&&t[1].length>=2||Y.replace(`.`,``).length>=6)return;Y===`0`&&e!==`.`?Y=e:Y+=e}let t=document.getElementById(`qa-display`);if(!t)return;let n=!Y;t.textContent=Y?`$${Y}`:`$0`,t.className=`qa-amount-display${n?` zero`:``}`}function hc(e){oc=e,document.querySelectorAll(`.qa-cat`).forEach(t=>{t.classList.toggle(`selected`,parseInt(t.getAttribute(`onclick`).match(/\d+/)[0])===e)})}function gc(){let e=parseFloat(Y);if(!e||e<=0){let e=document.getElementById(`qa-display`);e&&(e.style.color=`var(--danger)`,setTimeout(()=>e.style.color=``,600));return}if(!oc){let e=document.getElementById(`qa-cats`);e&&(e.style.outline=`2px solid var(--danger)`,e.style.borderRadius=`8px`,setTimeout(()=>{e.style.outline=``},600));return}let t=document.getElementById(`qa-note`)?.value.trim()||``,n=new Date().toISOString().slice(0,10);m.budget.actuals[K]||(m.budget.actuals[K]={});let r=Vs(oc,K),i=r.length?Math.max(...r.map(e=>e.id))+1:1;r.push({id:i,amount:e,date:n,note:t}),m.budget.actuals[K][oc]=r,localStorage.setItem(`toto_qa_last`,String(oc)),B(m),cc(),renderAll();let a=document.getElementById(`qa-fab`);a&&(a.textContent=`✓`,a.style.background=`#10b981`,setTimeout(()=>{a.textContent=`+`,a.style.background=``},1800))}window.addEventListener(`resize`,()=>{document.querySelectorAll(`.section-pills-wrap`).forEach(v)}),document.querySelectorAll(`.nav-item, .nav-text-item`).forEach(e=>{e.addEventListener(`click`,()=>b(e.dataset.tab))});function _c(){let[e,t]=K.split(`-`).map(Number),n=new Date(e,t-2,1);K=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,safeRender(yc),safeRender(Hu)}function vc(){let[e,t]=K.split(`-`).map(Number),n=new Date(e,t,1);K=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,safeRender(yc),safeRender(Hu)}function yc(){let e=G(K),t=e.income,n=e.expenses,r=j(t),i=j(n),a=r-i,o=r>0?Math.round(a/r*100):0,s={};n.forEach(e=>{let t=e.category||`Other`;s[t]=(s[t]||0)+A(e)});let c=Object.entries(s).sort((e,t)=>t[1]-e[1]),l=m.budget.actuals[K]||{},u=n.reduce((e,t)=>e+J(t.id,K),0),d=u>0,f=`
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px">
      <button class="btn btn-sm" onclick="prevMoneyMonth()" style="font-size:16px;padding:2px 10px">‹</button>
      <span style="font-size:16px;font-weight:600;min-width:140px;text-align:center">${q(K)}</span>
      <button class="btn btn-sm" onclick="nextMoneyMonth()" style="font-size:16px;padding:2px 10px">›</button>
      ${vs(K)?`<span style="margin-left:8px;font-size:12px;padding:2px 10px;background:#dbeafe;color:#1d4ed8;border-radius:99px">Custom month</span>`:``}
    </div>
        ...
        <table>
          ...
          <tbody>
            ${t.length===0?`<tr><td colspan="3" style="text-align:center;color:var(--text-muted);padding:20px">No income added yet</td></tr>`:t.map(e=>{let t=r>0?Math.round(A(e)/r*100):0;return`<tr>
                    ...
                    <td style="color:var(--text-muted);font-size:12px">${k(e)}</td>
  ...
  `,f+=`
    <div class="section">
      ...
      <div style="padding:16px 20px">
        ${c.length===0?`<div style="color:var(--text-muted);text-align:center;padding:20px">No expenses added yet</div>`:c.map(([e,t])=>{let r=X.expense[e]||`#94a3b8`,a=i>0?t/i*100:0,o=n.filter(t=>(t.category||`Other`)===e).reduce((e,t)=>e+(l[t.id]||0),0),s=n.some(t=>(t.category||`Other`)===e&&l[t.id]!==void 0);return`
  ...
  `,f+=`</div>`,d){let e=i-u;f+=`
      <div class="section" style="margin-bottom:20px">
        <div class="section-header">
          <div>
            <div class="section-title">Actuals — ${q(K)}</div>
        ...
        <div class="table-wrap">
          <table>
            ...
            <tbody>
              ${n.filter(e=>l[e.id]!==void 0).map(e=>{let t=A(e),n=l[e.id]||0,r=t-n,i=X.expense[e.category||`Other`]||`#94a3b8`;return`<tr>
    ...
    `}let p=Bs().map(e=>{let t=G(e);return{label:zs(e),income:j(t.income),expenses:j(t.expenses),actual:Object.values(m.budget.actuals[e]||{}).reduce((e,t)=>e+t,0)}}),h=Math.max(...p.flatMap(e=>[e.income,e.expenses,e.actual]),1),g=524/p.length,_=g*.22,v=[0,.25,.5,.75,1].map(e=>{let t=148-e*136;return`<line x1="64" y1="${t}" x2="588" y2="${t}" stroke="#e2e8f0" stroke-width="1"/>
  ...
  `,document.getElementById(`money-content`).innerHTML=f}function bc(){let e=G(K),t=j(e.income),n=j(e.expenses),r=t-n,i=t>0?r/t:null,a;a=t===0?10:i>=.2?20:i>=0?Math.round(i/.2*20):0;let o=Bs().slice(3),s=0,c=0;o.forEach(e=>{let t=G(e);t.expenses.some(t=>Vs(t.id,e).length>0)&&(s++,t.expenses.reduce((t,n)=>t+J(n.id,e),0)<=j(t.expenses)&&c++)});let l=s===0?5:Math.round(s/3*10+c/s*10),u=(m.netWorth.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),d=(m.netWorth.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),f=u-d,p;if(u===0&&d===0)p=10;else if(f<=0)p=3;else{let e=d>0?d/u:0;p=e<.3?20:e<.6?15:e<.8?10:6}let h;if(n===0)h=10;else{let e=u/n;h=e>=6?20:e>=3?15:e>=1?8:u===0?5:3}let g=(m.goals||[]).filter(e=>e.status!==`achieved`),_;if(g.length===0)_=8;else{let e=g.reduce((e,t)=>e+Math.min((t.saved||0)/(t.target||1),1),0)/g.length;_=10+Math.round(e*10)}let v=a+l+p+h+_,y=v>=85?`A`:v>=70?`B`:v>=55?`C`:v>=40?`D`:`F`,b=v>=80?`#10b981`:v>=60?`#f59e0b`:v>=40?`#f97316`:`#ef4444`,x=[...[{score:a,tip:`Boost your savings rate — aim for 20%+ of income (currently ${t>0?Math.round((i||0)*100):0}%)`},{score:l,tip:`Log actuals monthly in the Budget tab to stay on track`},{score:p,tip:`Reduce liabilities or grow assets to strengthen your net worth`},{score:h,tip:`Build an emergency fund of 3–6 months expenses (${w(n*3)}–${w(n*6)})`},{score:_,tip:`Set specific savings goals in the Goals tab to stay focused`}]].sort((e,t)=>e.score-t.score)[0];return{total:v,grade:y,color:b,insight:x.score<12?x.tip:`Great shape — stay consistent and keep building your financial cushion.`,dimensions:[{label:`Savings Rate`,score:a,max:20},{label:`Budget Tracking`,score:l,max:20},{label:`Net Worth`,score:p,max:20},{label:`Emergency Buffer`,score:h,max:20},{label:`Goals`,score:_,max:20}]}}var xc={Wallet:`#059669`,Plan:`#0891b2`,Home:`#7c3aed`};function Sc(e){return e?`<span style="font-size:10px;font-weight:700;color:${xc[e]||`#71717a`};margin-right:6px">${e}</span>`:``}function Cc(e){let t={red:`#ef4444`,amber:`#f59e0b`,green:`#10b981`,blue:`#0891b2`}[e.cls]||`#a1a1aa`,n=e.onclick?e.onclick:e.tab?`activateTab('${e.tab}')`:``;return`<div class="notif-tl-item">
    ...
    </div>`,r.addEventListener(`click`,t=>{t.target===r&&Dc(e.id)}),document.body.appendChild(r)}function jc(){if(!m.settings?.typeAMode)return;let e=Ec();if(!e)return;let t=new Date().toISOString().slice(0,10);if(m.settings.typeAMissionId!==e.id){m.settings.typeAMissionId=e.id,m.settings.typeAMissionShownDate=t,B(m);return}kc()>=1&&setTimeout(()=>Ac(e),1500)}function Mc(){Tc();let e=G(K),t=e.expenses.reduce((e,t)=>e+J(t.id,K),0),r=j(e.expenses),i=L(1),a=m.meals?.plan?.[i]||{},o=Object.values(a).reduce((e,t)=>e+ +!!t.b+ +!!t.l+ +!!t.d,0),s=(m.maintenance||[]).filter(e=>{let t=Se(e);return t!==null&&t<0}).length,c=(m.bills||[]).filter(e=>{let t=n(e);return t>=0&&t<=7}),l=(m.meals?.pantry||[]).filter(e=>e.status===`need`||e.status===`low`).length,u=document.createElement(`div`);u.className=`reset-overlay`,u.innerHTML=`
  ...
  </div>`}function Fc(){let e=Ec();if(!e)return``;let t=kc(),n=e.onclick?`onclick="${e.onclick}"`:e.tab?`onclick="activateTab('${e.tab}')"`:``;return`<div class="mission-card" ${n}>
    ...
    </div>`}).join(``)+`</div>`}function Kc(e){let t=e.onclick?e.onclick:e.tab?`activateTab('${e.tab}')`:``,n=Vc(e),r=[`red`,`amber`,`green`,`blue`].includes(e.cls)?e.cls:`grey`;return`<div class="brief-row"${t?` onclick="${t}"`:``}>
    ...
    <svg class="brief-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
  </div>`}function qc(){let e=document.getElementById(`today-content`);if(!e)return;let t=new Date,r=t.getHours(),i=t.toISOString().slice(0,10);function a(e){return e<5?`overnight`:e<12?`morning`:e<17?`afternoon`:e<21?`evening`:`night`}let o=a(r),s={morning:`Good morning,`,afternoon:`Good afternoon,`,evening:`Wind down,`,night:`Tomorrow at a glance —`,overnight:`Still up,`}[o]||`Hello,`,c=R?.displayName?.split(` `)[0]||m.settings?.adultName?.split(` `)[0]||m.settings?.adults?.[0]?.name?.split(` `)[0]||m.householdProfile?.members?.find(e=>e.role===`adult`)?.name?.split(` `)[0]||``,l=t.toLocaleDateString(`en-AU`,{weekday:`long`,month:`long`,day:`numeric`}).toUpperCase(),u=[],d=(m.bills||[]).map(e=>({...e,days:n(e)})).filter(e=>e.days!==null&&e.days<=2).sort((e,t)=>e.days-t.days);(m.maintenance||[]).filter(e=>{let t=Se(e);return t!==null&&t<0}),(m.documents||[]).filter(e=>e.expiryDate&&new Date(e.expiryDate)<t),(m.vehicles||[]).filter(e=>e.regoExpiry&&new Date(e.regoExpiry)<t);let f=[];(m.documents||[]).forEach(e=>{e.expiryDate&&new Date(e.expiryDate)<t&&f.push({label:x(e.name),sub:`Document expired`,cls:`alert`,tab:`documents`})}),(m.maintenance||[]).forEach(e=>{let t=Se(e);t!==null&&t<0&&f.push({label:x(e.name),sub:`${Math.abs(t)}d overdue`,cls:`watch`,tab:`maintenance`})}),(m.vehicles||[]).forEach(e=>{e.regoExpiry&&new Date(e.regoExpiry)<t&&f.push({label:x(e.name)+` rego`,sub:`Expired`,cls:`alert`,tab:`vehicles`})});let p=d.length>0,h=f.length>0;if(p||h){let e=d.length===1?d[0].days===0?`due today`:d[0].days===1?`due tomorrow`:`due in ${d[0].days} days`:`bill${d.length===1?``:`s`} due soon`,t=p?`
      ...
      <div style="flex:1;min-width:0;background:#F0FDF4;border-radius:var(--r-lg);padding:16px;display:flex;flex-direction:column;justify-content:space-between;min-height:140px;border:1px solid rgba(16,185,129,.18);box-shadow:0 1px 0 rgba(255,255,255,.9) inset">
      ...
      </div>`;u.push({type:`priority`,urgency:d.length>0?3:h?2:0,html:`<div style="display:flex;gap:12px;margin-bottom:12px">${t}${n}</div>`})}let g=o===`evening`||o===`night`?new Date(t.getTime()+864e5).toISOString().slice(0,10):i,_=g===i?`Today`:`Tomorrow`,v=Ht?Ht(g):[];if(v.length>0){let e=t.getHours()*60+t.getMinutes(),n=v.slice(0,4).map((t,n,r)=>{let a=t.allDay||!t.time?`All day`:Ut?Ut(t.time):t.time,o=zt?zt(t):``,s=Rt?Rt(t):{dot:`var(--iris-2)`},c=P?P[t.category]||P.other:{emoji:`📅`,label:``},l=t.time?parseInt(t.time.split(`:`)[0])*60+parseInt(t.time.split(`:`)[1]):-1,u=g===i&&l>=0&&e>=l&&e<l+90,d=n===Math.min(v.length,4)-1,f=c.color||`#f1f5f9`,p=c.text||`#475569`;return p.replace(/^#/,``),`<div class="pl-agenda-ev" style="margin-bottom:${d?`0`:`8px`}">
        <div class="pl-agenda-time-col">
      ...
      </div>`})}let y=G(K),b=j(y.income),S=j(y.expenses),C=b-S,ee=(y.expenses||[]).reduce((e,t)=>e+J(t.id,K),0),w=new Date(t.getFullYear(),t.getMonth()+1,0).getDate()-t.getDate(),T=S>0?Math.min(100,Math.round(ee/S*100)):0;if(b>0||S>0){let e=C>=0?``:`td-money-status-watch`,n=C>=0?`On track`:`Over budget`,r=Math.abs(C),i=[];d.forEach(e=>i.push(`<span class="td-money-flag td-money-flag-watch">${x(e.name)} due ${e.days===0?`today`:e.days===1?`tomorrow`:`in `+e.days+`d`}</span>`)),u.push({type:`money`,urgency:0,html:`<div class="td-card td-card-money">
        ...
        ${o?``:`<div style="font-size:11px;color:var(--muted-soft);padding:4px 0 2px;font-family:var(--mono)">${Ua?Ua(e):``}</div>`}
    ...
    ${se}
    ${ce}
  `,m.settings?.typeAMode&&jc(),typeof nl==`function`){let e=typeof bc==`function`?bc():null,n=typeof L==`function`?L(0):null,r=n&&m.meals?.plan?.[n]?.[t.getDay()===0?6:t.getDay()-1]||{};nl(u.map(e=>({title:e.type})),C,w,r,e)}}function Jc(){let e=(m.bills||[]).map(e=>({...e,days:n(e)})).filter(e=>e.days!==null&&e.days<=2).sort((e,t)=>e.days-t.days);if(!e.length)return;let t=e.reduce((e,t)=>e+(parseFloat(t.amount)||0),0);Xc(`Heads Up`,e.map(e=>{let t=e.days===0?`Due today`:e.days===1?`Tomorrow`:`In ${e.days} days`,n=e.days===0?`background:#FEF2F2;color:#b91c1c`:e.days===1?`background:#FFF4EE;color:#c2410c`:`background:var(--paper);color:var(--muted)`,r=e.amount?`$${parseFloat(e.amount).toLocaleString(`en-AU`,{minimumFractionDigits:2,maximumFractionDigits:2})}`:``,i=e.days===0?`box-shadow:0 0 0 3px rgba(239,68,68,.2)`:e.days===1?`box-shadow:0 0 0 3px rgba(249,115,22,.2)`:``;return`<div style="display:flex;align-items:center;padding:13px 18px;border-bottom:1px solid var(--hairline);gap:14px">
  ...
  </div>`)}function Yc(){let e=new Date,t=[];(m.documents||[]).forEach(n=>{n.expiryDate&&new Date(n.expiryDate)<e&&t.push({label:n.name,sub:`Documents`,badge:`Expired`,cls:`alert`,tab:`documents`})}),(m.maintenance||[]).forEach(e=>{let n=Se(e);n!==null&&n<0&&t.push({label:e.name,sub:`Maintenance`,badge:`${Math.abs(n)}d overdue`,cls:`watch`,tab:`maintenance`})}),(m.vehicles||[]).forEach(n=>{n.regoExpiry&&new Date(n.regoExpiry)<e&&t.push({label:n.name+` rego`,sub:`Vehicles`,badge:`Expired`,cls:`alert`,tab:`vehicles`})}),t.length&&Xc(`Slipping`,t.map(e=>{let t=e.cls===`alert`?`#ef4444`:`var(--ember)`,n=e.cls===`alert`?`box-shadow:0 0 0 3px rgba(239,68,68,.15)`:`box-shadow:0 0 0 3px rgba(249,115,22,.18)`,r=e.cls===`alert`?`background:#FEF2F2;color:#b91c1c`:`background:#FFF4EE;color:#c2410c`;return`<div onclick="activateTab('${e.tab}');_tdCloseSheet()" style="display:flex;align-items:center;padding:13px 18px;border-bottom:1px solid var(--hairline);gap:14px;cursor:pointer">
  ...
  </div>`)}function Xc(e,t){let n=document.getElementById(`td-sheet-overlay`);n||(n=document.createElement(`div`),n.id=`td-sheet-overlay`,n.style.cssText=`position:fixed;inset:0;z-index:1200;display:flex;flex-direction:column;justify-content:flex-end;background:rgba(0,0,0,.4)`,n.onclick=e=>{e.target===n&&Zc()},document.body.appendChild(n)),n.innerHTML=`
  ...
  </div>`).join(``);typeof Q==`function`&&Q(`💡 Insights`,`<div style="padding:0 4px">${i}</div>`,null)}var el=``,tl=``;async function nl(e,t,n,r,i){let a=localStorage.getItem(`toto_ai_key`);if(!a)return;let o=new Date().toISOString().slice(0,10);if(el===o&&tl){let e=document.getElementById(`today-briefing-text`);e&&(e.textContent=tl);return}let s=e.filter(e=>e.cls===`red`).map(e=>e.title),c=e.filter(e=>e.cls===`amber`).map(e=>e.title),l=`You are Toto, a friendly family personal assistant app. Write a 2-sentence daily briefing for the user based on this context:
...
- Don't start with "Here's" or "Today"`;try{let e=await fetch(Ji,{method:`POST`,headers:{"x-api-key":a,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:100,messages:[{role:`user`,content:l}]})});if(!e.ok)return;let t=(await e.json()).content[0].text.trim().replace(/^["']|["']$/g,``);tl=t,el=o;let n=document.getElementById(`today-briefing-text`);n&&(n.textContent=t)}catch{}}function rl(){let e=m,r=e.buildContract,i=(e.netWorth.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),a=(e.netWorth.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),o=i-a,s=e.netWorth.snapshots||[],c=``;if(s.length>=2){let e=o-s[s.length-2].netWorth;c=`<span class="${e>=0?`up`:`dn`}">${e>=0?`+`:``}${E(e)}</span> vs last snapshot`}let l=K,u=G(l),d=j(u.income),f=j(u.expenses),p=d-f,h=(e.subscriptions||[]).reduce((e,t)=>e+_t(t),0),g=(e.bills||[]).filter(e=>{let t=n(e);return t>=0&&t<=31}).reduce((e,t)=>e+(parseFloat(t.amount)||0),0),_=[...e.bills||[]].filter(e=>n(e)>=-1).sort((e,t)=>n(e)-n(t)).slice(0,5),v=(e.goals||[]).filter(e=>e.status!==`achieved`).slice(0,4),y=r.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0),b=(r.variations||[]).filter(e=>e.status===`approved`).reduce((e,t)=>e+(t.amount||0),0),S=r.total+b,C=Math.round(y/S*100),ee=r.stages.find(e=>!e.paid),T=((e.kids||{}).completions||[]).filter(e=>e.status===`pending`).length+((e.kids||{}).redemptions||[]).filter(e=>e.status===`pending`).length,D=Bs(),te=j(u.expenses),O=D.map(e=>{let t=Object.values(m.budget.actuals[e]||{}).reduce((e,t)=>e+t,0);return{label:zs(e),budget:te,actual:t}}),ne=te>0||O.some(e=>e.actual>0),k=bc(),re=251.3,A=(k.total/100*re).toFixed(1),M=k.dimensions.map(e=>{let t=Math.round(e.score/e.max*100),n=t>=75?`#10b981`:t>=50?`#f59e0b`:`#ef4444`;return`
    ...
    <div class="db-widget" style="margin:0 24px 20px">
          ...
          <svg viewBox="0 0 100 100" width="110" height="110" style="display:block;margin:0 auto">
            <g transform="rotate(-90 50 50)">
              ...
              <circle cx="50" cy="50" r="40" fill="none" stroke="${k.color}" stroke-width="10"
                stroke-dasharray="${A} ${re}" stroke-linecap="round"/>
            </g>
    ...
    </div>`,ae=``;if(ne){let e=Math.max(...O.flatMap(e=>[e.budget,e.actual]),1),t=532/O.length,n=t*.28,r=t*.04;ae=`<div class="db-widget">
      <div class="db-widget-header">
      ...
      <div style="padding:12px 16px 8px">
        ...
        <text x="53" y="${n+4}" text-anchor="end" font-size="9" fill="#94a3b8">${w(t*e)}</text>`}).join(``)}${O.map((i,a)=>{let o=58+a*t+t*.08,s=i.budget>0?i.budget/e*140:0,c=i.actual>0?i.actual/e*140:0,l=i.actual>i.budget?`#ef4444`:`#10b981`;return`<rect x="${o}" y="${150-s}" width="${n}" height="${s}" fill="#2563eb" opacity="0.65" rx="2"/>
    ...
    <div class="db-hero-row">
      <div class="db-nw-card" onclick="activateTab('networth')" style="cursor:pointer">
        <div>
          ...
          <div class="db-nw-amount">${E(o)}</div>
    ...
    <div class="db-grid">
      <div>
        ...
        <div class="db-widget">
          ...
          ${_.length?_.map(e=>{let r=n(e),i=r<0?`<span class="bill-due-badge overdue">Overdue</span>`:r===0?`<span class="bill-due-badge today">Today</span>`:r<=7?`<span class="bill-due-badge soon">${r}d</span>`:`<span class="bill-due-badge ok">${t(e).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}</span>`;return`<div class="db-bill-row">
              <div class="db-bill-icon">${nt(e.category)}</div>
      ...
      <div>
        ...
        <div class="db-widget">
          <div class="db-widget-header">
            <span class="db-widget-title">Budget · ${q(l)}</span>
    ...
    <div class="section" style="border-left:4px solid ${X.build.contract}">
      ...
      <div style="padding:16px 20px;border-bottom:1px solid var(--border)">
        <div style="display:flex;gap:0;position:relative">
          ${e.stages.map((t,n)=>{let r=(t.amount/e.total*100).toFixed(0),i=!t.paid&&e.stages.slice(0,n).every(e=>e.paid),a=t.paid?`#dcfce7`:i?`#dbeafe`:`var(--surface2)`,o=t.paid?`#16a34a`:i?`var(--primary)`:`var(--border)`,s=t.paid?`#15803d`:i?`var(--primary)`:`var(--text-muted)`,c=t.paid?`✓`:i?`→`:`${n+1}`,l=t.paid&&t.paidDate?D(t.paidDate):t.expectedDate?`Exp. `+D(t.expectedDate):``,u=!t.paid&&t.expectedDate&&te(t.expectedDate);return`
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${e.stages.map(t=>{let n=(t.amount/e.total*100).toFixed(1),r=!t.paid&&t.expectedDate&&te(t.expectedDate),i=t.paid?`<span class="badge paid">Paid</span>`:r?`<span class="badge overdue">Overdue</span>`:`<span class="badge unpaid">Upcoming</span>`;return`<tr>
  ...
  `;let u=m.extras,d=u.reduce((e,t)=>e+(t.totalAmount||0),0),f=u.reduce((e,t)=>e+(t.amountPaid||0),0);c+=`
    <div class="section" style="border-left:4px solid ${X.build.extras}">
      <div class="section-header">
        <div>
  ...
  `;let p=m.furniture,h=p.reduce((e,t)=>e+(t.price||0),0),g=p.filter(e=>e.status===`delivered`||e.status===`ordered`),_=p.filter(e=>e.status===`to-purchase`),v=g.reduce((e,t)=>e+(t.price||0),0),y=_.reduce((e,t)=>e+(t.price||0),0);c+=`
    <div class="section" style="border-left:4px solid ${X.build.furniture}">
      <div class="section-header">
        <div>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${p.length===0?`<tr><td colspan="8"><div class="empty"><div class="empty-icon">🛋️</div>No furniture items yet. Add sofas, beds, appliances and more.</div></td></tr>`:p.map(e=>{let t={"to-purchase":`<span class="badge unpaid">To Purchase</span>`,ordered:`<span class="badge partial">Ordered</span>`,delivered:`<span class="badge paid">Delivered</span>`},n=e.deliveryDate&&e.status!==`delivered`&&te(e.deliveryDate);return`<tr>
                    <td style="font-weight:500">${x(e.name)}</td>
  ...
  `;let b=m.appliances,C=b.reduce((e,t)=>e+(t.price||0),0),ee=b.filter(e=>e.status===`delivered`||e.status===`ordered`),T=b.filter(e=>e.status===`to-purchase`),E=ee.reduce((e,t)=>e+(t.price||0),0),O=T.reduce((e,t)=>e+(t.price||0),0);c+=`
    <div class="section" style="border-left:4px solid ${X.build.appliances}">
      <div class="section-header">
        <div>
          <div class="section-title">Appliances</div>
          <div class="section-subtitle">${b.length} items · ${w(E)} purchased · ${w(O)} remaining</div>
        </div>
        <div style="display:flex;align-items:center;gap:8px">
          ${b.length>0?`
          <div style="display:flex;gap:6px">
      ...
      <div class="table-wrap">
        <table>
          <thead><tr><th>Item</th><th>Room</th><th>Store / Vendor</th><th>Price</th><th>Status</th><th>Funding</th><th>Delivery Date</th><th>Notes</th><th></th></tr></thead>
          <tbody>
            ${b.length===0?`<tr><td colspan="9"><div class="empty"><div class="empty-icon">🍳</div>No appliances yet. Add fridges, dishwashers, ovens and more.</div></td></tr>`:b.map(e=>{let t={"to-purchase":`<span class="badge unpaid">To Purchase</span>`,ordered:`<span class="badge partial">Ordered</span>`,delivered:`<span class="badge paid">Delivered</span>`},n=e.deliveryDate&&e.status!==`delivered`&&te(e.deliveryDate);return`<tr>
                    <td style="font-weight:500">${x(e.name)}</td>
                    <td style="color:var(--text-muted)">${x(e.room||`—`)}</td>
                    <td>${e.vendor?x(e.vendor):`<span style="color:var(--text-muted)">—</span>`}</td>
                    <td class="amount">${e.price?w(e.price):`<span class="amount muted">TBC</span>`}</td>
          ...
          <tfoot>
            <tr style="background:var(--surface2);border-top:2px solid var(--border)">
              ...
              <td colspan="4" style="padding:11px 16px;font-size:12px;color:var(--text-muted)">
                ${w(E)} purchased · ${w(O)} still to buy
              </td>
            </tr>
          </tfoot>`:``}
        </table>
  ...
  `,document.getElementById(`build-content`).innerHTML=c}function al(){return m.expenseCategories||Yi.expenseCategories}function ol(){return m.incomeCategories||Yi.incomeCategories}var sl=[{value:`spending`,label:`Spending Limit`,icon:`📉`},{value:`savings`,label:`Savings Target`,icon:`🏦`},{value:`income`,label:`Income Target`,icon:`📈`}];function cl(e){if(e.type===`spending`){let t=Object.keys(m.budget.actuals).sort().reverse(),n=null;for(let r of t){let t=(G(r).expenses||[]).filter(t=>(t.category||`Other`)===e.category).reduce((e,t)=>e+(m.budget.actuals[r]?.[t.id]||0),0);if(t>0){n=t;break}}let r=e.targetMonthly||0;if(n===null)return{pct:null,label:`No actuals yet`,actual:null,target:r};let i=r>0?Math.max(0,Math.min(100,n/r*100)):0,a=n<=r;return{pct:i,label:`${w(n)} actual vs ${w(r)} limit`,actual:n,target:r,ok:a}}if(e.type===`savings`){let t=e.currentSaved||0,n=e.targetTotal||1;return{pct:Math.min(100,t/n*100),label:`${w(t)} of ${w(n)} saved`,ok:t>=n}}if(e.type===`income`){let t=j(G(K).income),n=e.targetMonthly||1;return{pct:Math.min(100,t/n*100),label:`${w(t)}/mo of ${w(n)}/mo target`,ok:t>=n}}return{pct:0,label:``,ok:!1}}function ll(){let e=m.goals,t=e.filter(e=>e.status===`active`),n=e.filter(e=>e.status===`achieved`),r=``;e.length>0&&(r+=`
    ...
    <button class="btn btn-primary" onclick="openAddGoal()">+ New Goal</button>
  </div>`,i.length===0){let e=G(K),t=j(e.income)-j(e.expenses),n=t>0?`<div style="font-size:14px;color:#64748b;margin-bottom:4px">You have <strong style="color:#16a34a">${w(t)}</strong> surplus each month.</div>
      ...
      <div style="background:#fff;border:2px dashed #cbd5e1;border-radius:16px;padding:36px 24px;text-align:center;margin-top:8px">
        ...
        </div>`});document.getElementById(`goals-content`).innerHTML=r}function ul(e={}){let t=e.type||`spending`;return`
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <select class="form-select" id="f-goal-type" onchange="toggleGoalFields()">
        ${sl.map(e=>`<option value="${e.value}" ${t===e.value?`selected`:``}>${e.icon} ${e.label}</option>`).join(``)}
      </select>
    </div>
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <select class="form-select" id="f-goal-category">
            ${al().map(t=>`<option value="${t}" ${e.category===t?`selected`:``}>${t}</option>`).join(``)}
          </select>
        </div>
        <div class="form-group">
  ...
  `}function dl(){let e=document.getElementById(`f-goal-type`).value;document.getElementById(`goal-spending-fields`).style.display=e===`spending`?``:`none`,document.getElementById(`goal-savings-fields`).style.display=e===`savings`?``:`none`,document.getElementById(`goal-income-fields`).style.display=e===`income`?``:`none`}function fl(e){let t=document.getElementById(`f-goal-type`).value,n={id:e,name:document.getElementById(`f-goal-name`).value.trim(),type:t,status:document.getElementById(`f-goal-status`).value,deadline:document.getElementById(`f-goal-deadline`).value||null,notes:document.getElementById(`f-goal-notes`).value.trim()};return t===`spending`&&(n.category=document.getElementById(`f-goal-category`).value,n.targetMonthly=parseFloat(document.getElementById(`f-goal-target-monthly`).value)||0),t===`savings`&&(n.targetTotal=parseFloat(document.getElementById(`f-goal-target-total`).value)||0,n.currentSaved=parseFloat(document.getElementById(`f-goal-current-saved`).value)||0),t===`income`&&(n.targetMonthly=parseFloat(document.getElementById(`f-goal-target-monthly-inc`).value)||0),n}function pl(){Q(`New Goal`,ul(),()=>{let e=fl(M(m.goals));e.name&&(m.goals.push(e),B(m),$(),ll())})}function ml(e){let t=m.goals.find(t=>t.id===e);Q(`Edit Goal`,ul(t),()=>{Object.assign(t,fl(e)),B(m),$(),ll()})}function hl(e){confirm(`Delete this goal?`)&&(m.goals=m.goals.filter(t=>t.id!==e),B(m),ll())}function gl(e){let t=m.goals.find(t=>t.id===e);t&&(t.status=`achieved`,B(m),ll())}var _l=null,vl=[{value:`add-income`,label:`Add income source`,icon:`💰`},{value:`remove-income`,label:`Remove income source`,icon:`➖`},{value:`reduce-income`,label:`Reduce income amount`,icon:`📉`},{value:`add-expense`,label:`Add new expense`,icon:`➕`},{value:`remove-expense`,label:`Remove expense`,icon:`✂️`},{value:`reduce-expense`,label:`Reduce expense amount`,icon:`📉`}];function yl(e){let t=G(K),n=JSON.parse(JSON.stringify(t.income)),r=JSON.parse(JSON.stringify(t.expenses));return(e.adjustments||[]).forEach(e=>{if(e.type===`add-income`)n.push({id:-(e.id||0),name:e.name,amount:e.amount||0,frequency:e.frequency||`monthly`});else if(e.type===`remove-income`)n=n.filter(t=>t.id!==e.itemId);else if(e.type===`reduce-income`){let t=n.find(t=>t.id===e.itemId);t&&(t.amount=e.changeType===`percent`?Math.max(0,t.amount*(1-e.changeAmount/100)):Math.max(0,t.amount-(e.changeAmount||0)))}else if(e.type===`add-expense`)r.push({id:-(e.id||0),name:e.name,amount:e.amount||0,frequency:e.frequency||`monthly`,category:e.category||`Other`});else if(e.type===`remove-expense`)r=r.filter(t=>t.id!==e.itemId);else if(e.type===`reduce-expense`){let t=r.find(t=>t.id===e.itemId);t&&(t.amount=e.changeType===`percent`?Math.max(0,t.amount*(1-e.changeAmount/100)):Math.max(0,t.amount-(e.changeAmount||0)))}}),{income:n,expenses:r,totalIncome:j(n),totalExpenses:j(r),surplus:j(n)-j(r)}}function bl(){let e=m.scenarios,t=G(K),n=j(t.income),r=j(t.expenses),i=n-r,a=`<div style="display:flex;justify-content:flex-end;margin-bottom:16px">
    <button class="btn btn-primary" onclick="openAddScenario()">+ New Scenario</button>
  </div>`;e.length===0?a+=`<div class="empty"><div class="empty-icon">🔬</div>No scenarios yet. Create one to model income changes, expense cuts, or lifestyle adjustments.</div>`:e.forEach(e=>{let t=yl(e),o=t.totalIncome-n,s=t.totalExpenses-r,c=t.surplus-i,l=_l===e.id;a+=`
        ...
        </div>`}),document.getElementById(`scenarios-content`).innerHTML=a}function xl(e){_l=_l===e?null:e,bl()}function Sl(e={}){return`
    <div class="form-group">
  ...
  `}function Cl(e,t={}){return{id:e,name:document.getElementById(`f-sc-name`).value.trim(),description:document.getElementById(`f-sc-desc`).value.trim(),adjustments:t.adjustments||[]}}function wl(){Q(`New Scenario`,Sl(),()=>{let e=Cl(M(m.scenarios));e.name&&(m.scenarios.push(e),B(m),$(),bl())})}function Tl(e){let t=m.scenarios.find(t=>t.id===e);Q(`Edit Scenario`,Sl(t),()=>{let n=Cl(e,t);Object.assign(t,n),B(m),$(),bl()})}function El(e){confirm(`Delete this scenario?`)&&(m.scenarios=m.scenarios.filter(t=>t.id!==e),_l===e&&(_l=null),B(m),bl())}function Dl(e){let t=G(K),n=t.income.map(e=>`<option value="${e.id}">${x(e.name)} (${w(A(e))}/mo)</option>`).join(``),r=t.expenses.map(e=>`<option value="${e.id}">${x(e.name)} (${w(A(e))}/mo)</option>`).join(``);return`
    <div class="form-group">
      <label class="form-label">Adjustment Type</label>
      <select class="form-select" id="f-adj-type" onchange="toggleAdjFields()">
        ${vl.map(e=>`<option value="${e.value}">${e.icon} ${e.label}</option>`).join(``)}
      </select>
    </div>
  ...
  `}function Ol(){let e=document.getElementById(`f-adj-type`).value;document.getElementById(`adj-add-income`).style.display=e===`add-income`||e===`add-expense`?``:`none`,document.getElementById(`adj-add-income-extra`).style.display=e===`add-income`||e===`add-expense`?``:`none`,document.getElementById(`adj-cat-wrap`).style.display=e===`add-expense`?``:`none`,document.getElementById(`adj-remove-income`).style.display=e===`remove-income`?``:`none`,document.getElementById(`adj-reduce-income`).style.display=e===`reduce-income`?``:`none`,document.getElementById(`adj-remove-expense`).style.display=e===`remove-expense`?``:`none`,document.getElementById(`adj-reduce-expense`).style.display=e===`reduce-expense`?``:`none`}function kl(e){let t=m.scenarios.find(t=>t.id===e);t&&Q(`Add Adjustment`,Dl(t),()=>{let e=document.getElementById(`f-adj-type`).value,n=G(K),r={id:M(t.adjustments||[]),type:e};if(e===`add-income`){if(r.name=document.getElementById(`f-adj-name`).value.trim(),r.amount=parseFloat(document.getElementById(`f-adj-amount`).value)||0,r.frequency=document.getElementById(`f-adj-freq`).value,!r.name)return}else if(e===`add-expense`){if(r.name=document.getElementById(`f-adj-name`).value.trim(),r.amount=parseFloat(document.getElementById(`f-adj-amount`).value)||0,r.frequency=document.getElementById(`f-adj-freq`).value,r.category=document.getElementById(`f-adj-cat`).value,!r.name)return}else if(e===`remove-income`){let e=document.getElementById(`f-adj-inc-sel`);r.itemId=parseInt(e.value),r.itemName=e.options[e.selectedIndex]?.text||``}else if(e===`reduce-income`){let e=document.getElementById(`f-adj-inc-reduce-sel`);r.itemId=parseInt(e.value),r.itemName=n.income.find(e=>e.id===r.itemId)?.name||``,r.changeAmount=parseFloat(document.getElementById(`f-adj-change-amount`).value)||0,r.changeType=document.getElementById(`f-adj-change-type-inc`).value}else if(e===`remove-expense`){let e=document.getElementById(`f-adj-exp-sel`);r.itemId=parseInt(e.value),r.itemName=e.options[e.selectedIndex]?.text||``}else if(e===`reduce-expense`){let e=document.getElementById(`f-adj-exp-reduce-sel`);r.itemId=parseInt(e.value),r.itemName=n.expenses.find(e=>e.id===r.itemId)?.name||``,r.changeAmount=parseFloat(document.getElementById(`f-adj-change-amount-exp`).value)||0,r.changeType=document.getElementById(`f-adj-change-type-exp`).value}t.adjustments||(t.adjustments=[]),t.adjustments.push(r),B(m),$(),bl()})}function Al(e,t){let n=m.scenarios.find(t=>t.id===e);n&&(n.adjustments=(n.adjustments||[]).filter(e=>e.id!==t),B(m),bl())}var jl=`home_finance_colors_v1`,Ml={expense:{"Mortgage / Rent":`#6366f1`,Insurance:`#8b5cf6`,Utilities:`#06b6d4`,Groceries:`#10b981`,Transport:`#f59e0b`,"Childcare / Education":`#3b82f6`,Health:`#ef4444`,Entertainment:`#f97316`,Subscriptions:`#84cc16`,"Dining Out":`#14b8a6`,Clothing:`#ec4899`,"Personal Care":`#a855f7`,"Savings / Investment":`#22c55e`,Other:`#94a3b8`},income:`#10b981`,build:{contract:`#3b82f6`,extras:`#f59e0b`,furniture:`#8b5cf6`,appliances:`#ef4444`}};function Nl(){try{let e=localStorage.getItem(jl);if(!e)return JSON.parse(JSON.stringify(Ml));let t=JSON.parse(e);return t.expense||(t.expense={}),t.build||(t.build={}),t.income||(t.income=Ml.income),al().forEach(e=>{t.expense[e]||(t.expense[e]=Ml.expense[e]||`#94a3b8`)}),Object.keys(Ml.build).forEach(e=>{t.build[e]||(t.build[e]=Ml.build[e])}),t}catch{return JSON.parse(JSON.stringify(Ml))}}function Pl(e){localStorage.setItem(jl,JSON.stringify(e))}var X=Nl();function Fl(e,t,n){e===`expense`?X.expense[t]=n:e===`income`?X.income=n:e===`build`&&(X.build[t]=n),Pl(X),Hu(),il(),rl()}function Il(){return(m.householdProfile.members||[]).filter(e=>e.role===`adult`).length||1}function Ll(){return(m.householdProfile.members||[]).filter(e=>e.role===`child`).length}function Rl(e){m.householdProfile.members.push({role:e||`adult`,age:null}),bu(),Z()}function zl(e){let t=m.householdProfile.members[e];if(!t)return;let n=t.name||(t.role===`child`?`this child`:`this adult`);if(confirm(`Remove ${n} from the household?\n\nThis cannot be undone.`)){if(t.role===`child`&&t.name){let e=(m.kids?.profiles||[]).find(e=>e.name===t.name);e&&(m.kids.profiles=m.kids.profiles.filter(t=>t.id!==e.id),m.kids.chores=m.kids.chores.filter(t=>t.assignedTo!==e.id),m.kids.completions=m.kids.completions.filter(t=>t.kidId!==e.id),m.kids.redemptions=m.kids.redemptions.filter(t=>t.kidId!==e.id),m.meals?.lunchbox?.profiles&&(m.meals.lunchbox.profiles=m.meals.lunchbox.profiles.filter(t=>t.id!==e.id)),String(ca())===String(e.id)&&la(`adult`))}m.householdProfile.members.splice(e,1),B(m),renderAll()}}function Bl(e,t,n){let r=m.householdProfile.members[e];r&&(r[t]=n,bu(),(t===`role`||t===`name`)&&Z())}function Vl(e){m.householdProfile.pets.push({type:e||`dog`,name:``}),bu(),Z()}function Hl(e){m.householdProfile.pets.splice(e,1),bu(),Z()}function Ul(e,t,n){let r=m.householdProfile.pets[e];r&&(r[t]=n,bu())}function Wl(e){m.householdProfile.cars=e,bu()}function Gl(e,t,n){let r=t+n;return[{category:`Mortgage / Rent`,min:e*.2,max:e*.3,label:`20–30% of income`,source:`ABS / MoneySmart`,needs:!0},{category:`Groceries`,min:380+(t-1)*260+n*160,max:560+(t-1)*360+n*220,label:`$${Math.round(380+(t-1)*260+n*160)}–$${Math.round(560+(t-1)*360+n*220)}/month for ${r} ${r===1?`person`:`people`}`,source:`ABS HES 2022`,needs:!0},{category:`Transport`,min:e*.08,max:e*.15,label:`8–15% of income`,source:`ABS HES 2022`,needs:!0},{category:`Utilities`,min:180+t*25+n*15,max:360+t*40+n*25,label:`$${Math.round(180+t*25+n*15)}–$${Math.round(360+t*40+n*25)}/month`,source:`AER / ABS`,needs:!0},{category:`Insurance`,min:180+t*40+n*20,max:420+t*60+n*30,label:`$${Math.round(180+t*40+n*20)}–$${Math.round(420+t*60+n*30)}/month`,source:`APRA industry avg`,needs:!0},{category:`Health`,min:60*t+30*n,max:180*t+60*n,label:`$${60*t+30*n}–$${180*t+60*n}/month`,source:`AIHW / ABS`,needs:!0},...n>0?[{category:`Childcare / Education`,min:700*n,max:2200*n,label:`$700–$2,200/month per child (before subsidies)`,source:`ACCC Childcare Report`,needs:!0}]:[],{category:`Dining Out`,min:e*.02,max:e*.05,label:`2–5% of income`,source:`MoneySmart`,needs:!1},{category:`Entertainment`,min:e*.02,max:e*.05,label:`2–5% of income`,source:`MoneySmart`,needs:!1},{category:`Subscriptions`,min:30,max:120,label:`$30–$120/month`,source:`Industry average`,needs:!1},{category:`Clothing`,min:50*t+30*n,max:150*t+80*n,label:`$${50*t+30*n}–$${150*t+80*n}/month`,source:`ABS HES 2022`,needs:!1},{category:`Savings / Investment`,min:e*.1,max:e*.2,label:`10–20% of income (aim for 20%)`,source:`50/30/20 rule`,needs:!1}]}function Kl(e,t,n){return e<t*.9?`under`:e>n*1.1?`over`:`within`}var ql=`home_finance_ai_key`;function Jl(){return localStorage.getItem(ql)||``}function Yl(e){localStorage.setItem(ql,e)}function Xl(){let e=Bs(),t={};return e.forEach(e=>{let n=G(e),r={},i={};n.expenses.forEach(t=>{let n=t.category||`Other`;r[n]=(r[n]||0)+A(t);let a=J(t.id,e);a>0&&(i[n]=(i[n]||0)+a)}),new Set([...Object.keys(r),...Object.keys(i)]).forEach(n=>{t[n]||(t[n]=[]),t[n].push({mo:e,budget:r[n]||0,actual:i[n]||0,hasActual:(i[n]||0)>0})})}),t}function Zl(e){let t=[];return Object.entries(e).forEach(([e,n])=>{let r=n.filter(e=>e.hasActual);if(r.length<2)return;let i=r.filter(e=>e.budget>0&&e.actual>e.budget*1.05).length,a=r.filter(e=>e.budget>0&&e.actual<e.budget*.92).length,o=r.reduce((e,t)=>e+(t.actual-t.budget),0)/r.length,s=n.slice(-3).filter(e=>e.hasActual),c=n.slice(0,3).filter(e=>e.hasActual),l=s.length?s.reduce((e,t)=>e+t.actual,0)/s.length:0,u=c.length?c.reduce((e,t)=>e+t.actual,0)/c.length:0,d=u>50?(l-u)/u:0;i>=3&&o>20?t.push({cat:e,level:`warning`,icon:`⚠️`,title:`Consistently over on ${e}`,body:`Over budget ${i}/${r.length} months, avg +${w(Math.abs(o))}/mo. Consider raising the budget or cutting back.`,months:r}):a>=4&&n[n.length-1]?.budget>0?t.push({cat:e,level:`good`,icon:`✅`,title:`Consistently under on ${e}`,body:`Under budget ${a}/${r.length} months, avg ${w(Math.abs(o))}/mo less. You may be able to reallocate this budget elsewhere.`,months:r}):d>.25&&l>50?t.push({cat:e,level:`warning`,icon:`📈`,title:`${e} trending up`,body:`Spending up ${Math.round(d*100)}% over recent months — now averaging ${w(l)}/mo. Worth keeping an eye on.`,months:r}):d<-.25&&u>50&&t.push({cat:e,level:`good`,icon:`📉`,title:`${e} trending down`,body:`Down ${Math.round(Math.abs(d)*100)}% recently — now ${w(l)}/mo. Nice improvement.`,months:r})}),t.sort((e,t)=>[`warning`,`alert`,`good`,`info`].indexOf(e.level)-[`warning`,`alert`,`good`,`info`].indexOf(t.level)).slice(0,6)}function Ql(){let e=G(K);if(e.expenses.length===0)return``;let t={};e.expenses.forEach(e=>{let n=e.category||`Other`;t[n]||(t[n]={budget:0,actual:0}),t[n].budget+=A(e),t[n].actual+=J(e.id,K)});let n=Object.entries(t).filter(([,e])=>e.budget>0||e.actual>0).sort((e,t)=>Math.max(t[1].budget,t[1].actual)-Math.max(e[1].budget,e[1].actual));if(!n.length)return``;let r=Math.max(...n.flatMap(([,e])=>[e.budget,e.actual]),1),i=n.map(([e,t])=>{let n=t.actual>0,i=(t.budget/r*100).toFixed(1),a=(t.actual/r*100).toFixed(1),o=t.actual-t.budget,s=n?o>5?`over`:o<-5?`under`:``:``,c=n?o>5?`<span class="spi-over">+${w(o)}</span>`:o<-5?`<span class="spi-under">${w(o)}</span>`:`<span class="spi-on">on track</span>`:`<span class="spi-no-actual">no actuals</span>`;return`<div class="spi-cat-row">
    ...
    <div class="spi-breakdown-header">
      <span style="font-size:13px;font-weight:700">Budget vs Actual — ${q(K)}</span>
    ...
    ${i}
  </div>`}function $l(){let e=Zl(Xl()),t=Ql(),n={warning:{bg:`#fffbeb`,border:`#fcd34d`,title:`#92400e`},good:{bg:`#ecfeff`,border:`#86efac`,title:`#166534`},alert:{bg:`#fef2f2`,border:`#fca5a5`,title:`#991b1b`},info:{bg:`#f8fafc`,border:`#cbd5e1`,title:`#475569`}};return`<div class="spi-section">
...
Reply with ONLY the JSON array, no other text.`;try{let e=await fetch(tu,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:u}]})});if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(t.error?.message||`API error ${e.status}`)}let t=(await e.json()).content[0].text.trim();t=t.replace(/^```[a-z]*\n?/i,``).replace(/\n?```$/,``).trim(),ru(JSON.parse(t),!0)}catch(e){let t=e.message;(t.includes(`Failed to fetch`)||t.includes(`NetworkError`)||t.includes(`CORS`))&&(t=`CORS blocked — the browser can't call the Anthropic API directly. We need a small proxy (Cloudflare Worker). Ask me to set it up — it takes 5 minutes and is free.`),document.getElementById(`ai-output`).innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:12px">
      ...
      </div>`}let h=i.filter(e=>r[e.category]!==void 0||e.category===`Savings / Investment`).map(e=>{let t=r[e.category]||0,n=Kl(t,e.min,e.max),i=n===`under`?`#3b82f6`:n===`within`?`#10b981`:`#ef4444`,a=n===`under`?`Below avg`:n===`within`?`On track`:`Above avg`,o=e.max>0?Math.min(t/(e.max*1.5)*100,100):0,s=e.max>0?Math.min(e.max/(e.max*1.5)*100,100):0;return`
      <tr>
        <td style="border-left:3px solid ${X.expense[e.category]||`#94a3b8`};font-weight:500">${e.category}</td>
  ...
  `}function ou(e){let t={good:{bg:`#ecfeff`,border:`#86efac`,text:`#166534`},ok:{bg:`#eff6ff`,border:`#93c5fd`,text:`#1e40af`},warning:{bg:`#fffbeb`,border:`#fcd34d`,text:`#92400e`},alert:{bg:`#fef2f2`,border:`#fca5a5`,text:`#991b1b`},info:{bg:`#f8fafc`,border:`#cbd5e1`,text:`#475569`}};return e.map(e=>{let n=t[e.level]||t.info;return`
      ...
      </div>`}).join(``)}function su(){let[e,t]=K.split(`-`).map(Number),n=new Date(e,t-2,1);K=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,safeRender(au),safeRender(yc),safeRender(Hu)}function cu(){let[e,t]=K.split(`-`).map(Number),n=new Date(e,t,1);K=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,safeRender(au),safeRender(yc),safeRender(Hu)}var lu=`🏠.🏡.🏗️.🔑.💡.🔌.🚿.🛋️.🛏️.🪴.🍽️.🍕.🍔.🛒.🥗.🍷.☕.🍰.🥩.🧃.🚗.🚙.🚌.✈️.⛽.🚕.🏎️.🚲.🛵.🚂.👨‍👩‍👧.👶.📚.🏫.💊.🏥.💅.💆.🧴.👕.🎮.🎬.🎵.🏋️.📺.🎲.🏄.🎯.🎨.🎭.💰.💳.🏦.📈.💸.🪙.💎.📊.🏆.💼.📦.🛍️.🎁.🔧.🛠️.📱.💻.🧹.🧺.🖨️.🐕.🐈.🐠.🌱.☀️.❄️.🎄.🎂.⚽.🧸`.split(`.`);function uu(e,t){let n=document.createElement(`div`);n.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.45);z-index:9999;display:flex;align-items:center;justify-content:center`,n.innerHTML=`
  ...
  `,document.body.appendChild(n),n.querySelector(`#emoji-picker-close`).onclick=()=>document.body.removeChild(n),n.querySelectorAll(`[data-emoji]`).forEach(e=>{e.onclick=()=>{t(e.dataset.emoji),document.body.removeChild(n)}}),n.addEventListener(`click`,e=>{e.target===n&&document.body.removeChild(n)})}function du(){Q(`Add Category Group`,`
    <div class="form-row">
  ...
  `,()=>{let e=document.getElementById(`f-grp-icon`).value||`📦`,t=document.getElementById(`f-grp-name`).value.trim();if(!t)return;let n=M(m.categoryGroups);m.categoryGroups.push({id:n,name:t,icon:e,categories:[]}),z(`Added category group`,t),B(m),$(),Z()}),document.getElementById(`f-grp-icon-btn`).addEventListener(`click`,()=>{let e=document.getElementById(`f-grp-icon`).value;uu(e,e=>{document.getElementById(`f-grp-icon`).value=e,document.getElementById(`f-grp-icon-btn`).textContent=e})})}function fu(e){let t=m.categoryGroups.find(t=>t.id===e);t&&uu(t.icon,t=>{mu(e,`icon`,t);let n=document.getElementById(`grp-icon-btn-${e}`);n&&(n.textContent=t)})}function pu(e){let t=m.categoryGroups.find(t=>t.id===e);confirm(`Delete group "${t?t.name:``}"? Categories will become unassigned.`)&&(m.categoryGroups=m.categoryGroups.filter(t=>t.id!==e),z(`Deleted category group`,t?t.name:``),B(m),Z())}function mu(e,t,n){let r=m.categoryGroups.find(t=>t.id===e);r&&(r[t]=n,B(m))}function hu(e,t){if(!t)return;al().includes(t)||(m.expenseCategories||(m.expenseCategories=al().slice()),m.expenseCategories.push(t)),m.categoryGroups.forEach(e=>{e.categories=e.categories.filter(e=>e!==t)});let n=m.categoryGroups.find(t=>t.id===e);n&&n.categories.push(t),B(m),Z()}function gu(e){let t=al(),n=new Set((m.categoryGroups||[]).filter(t=>t.id!==e).flatMap(e=>e.categories)),r=m.categoryGroups.find(t=>t.id===e),i=new Set(r?r.categories:[]),a=t.filter(e=>!i.has(e)&&!n.has(e));Q(`Add Category to Group`,`
    ${a.length>0?`
  ...
  `,()=>{let t=document.getElementById(`f-cat-selected`).value,n=document.getElementById(`f-cat-new`).value.trim()||t;n&&(hu(e,n),$())})}function _u(e,t){let n=m.categoryGroups.find(t=>t.id===e);n&&(n.categories=n.categories.filter(e=>e!==t),B(m),Z())}var vu=!1,yu=null;function bu(){vu||(yu=JSON.parse(JSON.stringify(m))),vu=!0;let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`flex`)}function xu(){vu=!1,yu=null,B(m);let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`none`);let t=document.getElementById(`settings-save-btn`);if(t){let e=t.textContent;t.textContent=`Saved`,t.style.background=`#10b981`,setTimeout(()=>{t.textContent=e,t.style.background=``},1500)}renderAll()}function Su(){yu&&Object.assign(m,yu),vu=!1,yu=null;let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`none`),Z()}function Cu(e){vu&&(confirm(`You have unsaved changes in Settings. Save before leaving?`)?xu():Su())}function wu(e,t){m.settings||(m.settings={}),m.settings[e]=t,bu()}function Tu(){let e=document.getElementById(`settings-api-key`)?.value.trim();if(!e)return;localStorage.setItem(`toto_ai_key`,e),localStorage.setItem(`toto_ai_key_meta`,JSON.stringify({addedAt:new Date().toISOString(),prefix:e.slice(0,10),suffix:e.slice(-4)}));let t=document.getElementById(`api-key-status`);t&&(t.textContent=`✓ Key saved!`,t.style.color=`var(--success)`,setTimeout(()=>{t.textContent=``,t.style.color=``},2e3));let n=document.getElementById(`api-key-summary`);n&&(n.outerHTML=Du())}function Eu(){confirm(`Remove saved API key? Toto and cost estimation will stop working.`)&&(localStorage.removeItem(`toto_ai_key`),localStorage.removeItem(`toto_ai_key_meta`),Z())}function Du(){let e=localStorage.getItem(`toto_ai_key`);if(!e)return`<div id="api-key-summary"></div>`;let t=JSON.parse(localStorage.getItem(`toto_ai_key_meta`)||`{}`),n=t.addedAt?new Date(t.addedAt).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`}):`Unknown date`;return`
    ...
    </div>`}function Ou(e){let t=document.getElementById(`sacc-body-${e}`),n=document.getElementById(`sacc-chev-${e}`);if(!t)return;let r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n&&(n.textContent=r?`▼`:`▲`),r?Ds.delete(e):Ds.add(e)}function ku(){confirm(`Clear the entire activity log? This cannot be undone.`)&&(m.activityLog=[],B(m),Z())}function Au(e){let t=document.getElementById(`new-cat-${e}`),n=(t.value||``).trim();if(!n){t.focus();return}let r=e===`expense`?m.expenseCategories:m.incomeCategories;if(r.includes(n)){alert(`That category already exists.`);return}r.push(n),z(`Added ${e} category`,n),bu(),t.value=``,Z()}function ju(e,t){let n=e===`expense`?m.expenseCategories:m.incomeCategories;if(e===`expense`&&(m.budget.expenses.some(e=>e.category===t)||Object.values(m.budget.months||{}).some(e=>(e.expenses||[]).some(e=>e.category===t)))&&!confirm(`"${t}" is used by existing expenses. Remove anyway?`))return;let r=n.indexOf(t);r!==-1&&n.splice(r,1),z(`Removed ${e} category`,t),bu(),Z()}function Z(){function e(e){return e.replace(/[^a-z0-9]/gi,`_`)}function t(t,n,r,i){let a=`${t}_${e(n)}`;return`
      <div class="color-row">
    ...
    <div class="toto-sec-header" style="margin-top:6px"><span class="toto-sec-title">Settings</span></div>`+u(`ai`,`🤖 AI Assistant (Toto)`,`Powers cost estimation, Toto chat, and CSV import analysis`,`
      ...
      <div class="section-body">
        ...
        <div style="margin-top:16px;padding:14px;background:var(--surface2);border-radius:10px">
          ...
          <div style="font-size:28px;font-weight:900;color:#0891b2">${Tc().total}%</div>
        ...
        <div style="margin-top:20px;padding-top:16px;border-top:1px solid var(--border)">
          ...
          <button class="btn btn-sm" style="background:#fef2f2;border:1px solid #fecaca;color:#b91c1c;font-weight:600" onclick="resetAllData()">Reset all data…</button>
            ...
            ${s?`<button onclick="event.stopPropagation();clearAdultPin(${a})" style="padding:6px 10px;border:1px solid #fecaca;border-radius:6px;background:var(--surface);font-size:11px;font-weight:600;color:#b91c1c;cursor:pointer">Remove</button>`:``}
              ...
              </div>`+c}}else{let e=(m.kids?.profiles||[]).find(e=>e.name&&r.name&&e.name.toLowerCase()===r.name.toLowerCase()),t=!!e?.pinHash,n=!!(r.name&&r.name.trim());d=e&&ps&&ps(e.id)?`<div style="padding:10px 12px;background:#fef2f2;border-radius:8px;border:1px solid #fecaca">
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
                <span style="font-size:16px">🔒</span>
                <div style="flex:1">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:12px">
          ${al().map(e=>`
            <span style="display:inline-flex;align-items:center;gap:6px;background:var(--surface2);border:1px solid var(--border);border-radius:20px;padding:5px 10px 5px 12px;font-size:13px">
              <span style="width:10px;height:10px;border-radius:50%;background:${X.expense[e]||`#94a3b8`};flex-shrink:0"></span>
              ${e}
      ...
      <div class="section-body">
        ...
        <div class="color-grid" style="margin-bottom:24px">
          ${al().map(e=>t(`expense`,e,e,X.expense[e]||Ml.expense[e]||`#94a3b8`)).join(``)}
        </div>
        ...
        <div class="color-grid" style="grid-template-columns:repeat(auto-fill,minmax(220px,220px));margin-bottom:24px">
          ${t(`income`,`income`,`Income`,X.income)}
        </div>
        ...
        <div class="color-grid" style="grid-template-columns:repeat(auto-fill,minmax(220px,220px))">
          ${t(`build`,`contract`,`Fixed Price Contract`,X.build.contract)}
          ${t(`build`,`extras`,`Outside Contract`,X.build.extras)}
          ${t(`build`,`furniture`,`Furniture`,X.build.furniture)}
          ${t(`build`,`appliances`,`Appliances`,X.build.appliances)}
        </div>
    ...
    </div>`);let g=ca(),_=m.kids?.profiles||[],v=g?g===`adult`?`Adult — opens straight to the full app`:g===`shared`?`Shared — shows profile picker on open`:(_.find(e=>e.id===g)?.name||`Unknown`)+` — kid device`:`Not configured`;h+=u(`this-device`,`📱 This Device`,`Assigned to: ${v}`,`<div class="section-body">
      <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px;background:var(--surface2);border-radius:10px;border:1px solid var(--border)">
        <div>
  ...
  </div>`,h+=`<div class="settings-save-bar" id="settings-save-bar" style="display:${vu?`flex`:`none`}">
  ...
  </div>`,document.getElementById(`settings-content`).innerHTML=h}function Mu(){if(confirm(`This will permanently delete ALL household data — budget, kids, goals, everything — from this device and the cloud.

This cannot be undone. Are you sure?`)&&confirm(`Last chance. All data will be gone. Continue?`)){if(R&&fbStore){let e=ji();e&&e.delete().catch(()=>{})}localStorage.removeItem(Hi),sa(Oi),Pi&&(Pi(),Pi=null),fbAuth.signOut().then(()=>{window.location.reload()})}}function Nu(){let e=new Blob([JSON.stringify(m,null,2)],{type:`application/json`}),t=document.createElement(`a`);t.href=URL.createObjectURL(e),t.download=`home-budget-backup-${new Date().toISOString().slice(0,10)}.json`,t.click(),URL.revokeObjectURL(t.href)}function Pu(e){let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target.result);if(!t.budget){alert(`Invalid backup file — missing budget data.`);return}if(!confirm(`This will replace ALL current data with the backup. Continue?`))return;localStorage.setItem(Hi,JSON.stringify(t)),location.reload()}catch(e){alert(`Failed to read backup file: `+e.message)}},n.readAsText(t)}function Fu(e){let t=document.getElementById(`grp-body-${e}`),n=document.getElementById(`grp-arrow-${e}`);if(!t)return;let r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n&&(n.textContent=r?`▼`:`▲`)}function Iu(e){Es=e,Hu()}function Lu(e){let t=m.categoryGroups||Yi.categoryGroups;m.budget.actuals[K];let n=(m.colors||{}).expense||{},r=new Set(t.flatMap(e=>e.categories)),i=[...new Set(e.map(e=>e.category||`Other`))].filter(e=>!r.has(e)),a=i.length>0?[...t,{id:`ug`,name:`Ungrouped`,icon:`📋`,categories:i}]:t,o=`<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:16px;margin-top:4px;align-items:start">`;for(let t of a){let r=e.filter(e=>t.categories.includes(e.category||`Other`));if(r.length===0)continue;let i=r.reduce((e,t)=>e+A(t),0),a=r.reduce((e,t)=>e+J(t.id,K),0),s=i>0?Math.round(a/i*100):0,c=Math.min(100,s),l=s>=100?`var(--danger)`:s>=80?`var(--warning)`:`var(--success)`,u=a>0,d=a>i&&u,f=r[0]&&r[0].category||`Other`,p=n[f]||X.expense[f]||`#94a3b8`;o+=`
    <div style="background:var(--surface);border:1px solid ${d?`var(--danger)`:`var(--border)`};border-radius:10px;overflow:hidden">
      ...
      <div id="grp-body-${t.id}" style="border-top:1px solid var(--border)">
        ...
        ${r.map(e=>{let t=A(e),r=J(e.id,K),i=t>0?Math.min(100,Math.round(r/t*100)):0,a=n[e.category||`Other`]||X.expense[e.category||`Other`]||`#94a3b8`,o=r>t&&r>0,s=o?`var(--danger)`:i>=80?`var(--warning)`:r>0?a:`var(--border)`;return r>0?`${w(r)}${w(t)}${i}`:`${w(t)}`,`
    ...
    <div class="summary-hero" onclick="toggleBudgetDetail()">
      ...
      <div class="summary-hero-expand" id="budget-expand-label">${Uu?`Hide details ▲`:`See breakdown ▼`}</div>
    </div>`,d+=`
    <div class="summary-mini-grid">
    ...
    </div>`;let f=Ru({income:e,expenses:t});if(f.segments.length){let e=f.segments.map(e=>`<div style="background:${e.color};flex:${e.pct.toFixed(2)}"></div>`).join(``),t=f.segments.map(e=>`<div class="alloc-row">
        <div class="tdot" style="background:${e.color}"><svg viewBox="0 0 24 24"><use href="#${Vu(e.name)}"/></svg></div>
        <div class="body">
          <div class="ticker">${Bu(e.name)}</div>
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;cursor:pointer;user-select:none;margin-bottom:${Wu?`12px`:`0`}" onclick="_allocExpanded=!_allocExpanded;renderBudget()">
        <div class="alloc-title" style="margin-bottom:0">Budget Allocation</div>
        <span style="font-size:11px;color:var(--muted);font-family:var(--mono)">${Wu?`▲`:`▼`}</span>
      </div>
      <div class="alloc-bar" style="margin-bottom:${Wu?`12px`:`0`}">${e}</div>
      ${Wu?`<div class="alloc-list">${t}</div>`:``}
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;cursor:pointer;user-select:none;margin-bottom:${Uu?`16px`:`0`}" onclick="toggleBudgetDetail()">
      ...
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <span style="font-size:11px;color:var(--muted);font-family:var(--mono)" id="budget-expand-chevron">${Uu?`▲`:`▼`}</span>
      </div>
    </div>
    <div class="detail-panel ${Uu?`expanded`:`collapsed`}" id="budget-detail" style="margin:0 -4px">`,vs(K)||(d+=`<div style="display:flex;align-items:center;justify-content:space-between;background:var(--primary-light);border:1px solid #bfdbfe;border-radius:8px;padding:10px 16px;margin-bottom:16px;gap:12px;flex-wrap:wrap">
      <div>
        <span style="font-size:13px;font-weight:600;color:var(--primary)">Using default budget</span>
      </div>
      <button class="btn btn-primary btn-sm" onclick="copyMonthFromPrevious('${K}')">
        Copy from ${q(u)}
      </button>
    </div>`),d+=er(K,i),d+=jn(K),d+=`
    <div class="section" style="margin-bottom:20px">
      <div class="section-header">
        <div>
          <div class="section-title">Income</div>
        ...
        <table>
          ...
          <tbody>
            ${e.length===0?`<tr><td colspan="6"><div class="empty"><div class="empty-icon">💵</div>Add your income sources</div></td></tr>`:e.map(e=>{let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():`<span style="color:var(--text-muted)">—</span>`,n=e.recurring===!1?`<span style="font-size:10px;font-weight:600;padding:1px 6px;border-radius:99px;background:#fef9c3;color:#854d0e;border:1px solid #fde047;margin-left:6px;white-space:nowrap">one-time</span>`:``;return`<tr>
              <td style="font-weight:500;border-left:4px solid ${X.income}">${x(e.name)}${n}</td>
              <td class="amount">${T(e.amount)}</td>
              <td>${t}</td>
  ...
  `;let p=[`all`,...Array.from(new Set(t.map(e=>e.category||`Other`))).sort()],h=Sd===`all`?t:t.filter(e=>(e.category||`Other`)===Sd),g=h.reduce((e,t)=>e+A(t),0),_=h.reduce((e,t)=>e+J(t.id,K),0),v=g-_,y=Sd!==`all`;d+=`
    <div class="section">
      <div class="section-header">
        <div>
        ...
        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
          <div style="display:flex;border:1px solid var(--border);border-radius:6px;overflow:hidden">
            <button onclick="setBudgetView('grouped')" style="padding:5px 12px;font-size:12px;font-weight:600;border:none;cursor:pointer;background:${Es===`grouped`?`var(--primary)`:`var(--surface)`};color:${Es===`grouped`?`#fff`:`var(--text-muted)`}">⊞ Groups</button>
            <button onclick="setBudgetView('table')" style="padding:5px 12px;font-size:12px;font-weight:600;border:none;border-left:1px solid var(--border);cursor:pointer;background:${Es===`table`?`var(--primary)`:`var(--surface)`};color:${Es===`table`?`#fff`:`var(--text-muted)`}">≡ Table</button>
          </div>
          ${Es===`table`?`<select class="form-select" style="width:auto;padding:6px 10px;font-size:12px" onchange="setExpenseFilter(this.value)">
            ${p.map(e=>`<option value="${e}" ${Sd===e?`selected`:``}>${e===`all`?`All categories`:e}</option>`).join(``)}
          </select>`:``}
          ...
          <table>
            <thead>
              <tr>
                ...
                ${Td(`variance`,`Variance`)}
                <th></th>
              </tr>
            </thead>
            <tbody>
              ${h.length===0?`<tr><td colspan="8"><div class="empty"><div class="empty-icon">📋</div>${t.length===0?`Add your household expenses`:`No expenses in this category`}</div></td></tr>`:[...h].sort((e,t)=>{if(!bd)return 0;let n,r;if(bd===`name`)n=e.name.toLowerCase(),r=t.name.toLowerCase();else if(bd===`category`)n=(e.category||`Other`).toLowerCase(),r=(t.category||`Other`).toLowerCase();else if(bd===`frequency`)n=k(e),r=k(t);else if(bd===`due`)n=e.dueDate||`￿`,r=t.dueDate||`￿`;else if(bd===`budget`)n=A(e),r=A(t);else if(bd===`actual`)n=J(e.id,K),r=J(t.id,K);else if(bd===`variance`)n=A(e)-J(e.id,K),r=A(t)-J(t.id,K);else return 0;return n<r?xd===`asc`?-1:1:n>r?xd===`asc`?1:-1:0}).map(e=>{let t=A(e),n=J(e.id,K),r=t-n,i=n>0,a;a=i?r>=0?`<span class="var-under">▼ ${w(r)}</span>`:`<span class="var-over">▲ ${w(Math.abs(r))}</span>`:`<span class="var-none">—</span>`;let o=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():`<span style="color:var(--text-muted)">—</span>`,s=X.expense[e.category||`Other`]||`#94a3b8`,c=e.recurring===!1?`<span style="font-size:10px;font-weight:600;padding:1px 6px;border-radius:99px;background:#fef9c3;color:#854d0e;border:1px solid #fde047;margin-left:6px;white-space:nowrap">one-time</span>`:``;return`<tr>
            ...
            <tfoot>
              <tr style="background:var(--surface2);border-top:2px solid var(--border)">
                <td colspan="4" style="padding:11px 16px;font-size:13px;color:var(--text-muted);font-style:italic">Total ${y?Sd:`all categories`}</td>
  ...
  `,d+=`</div></div>`,document.getElementById(`budget-content`).innerHTML=d}catch(e){console.error(`renderBudget error:`,e);let t=document.getElementById(`budget-content`);t&&(t.innerHTML=`<div style="padding:24px;color:var(--alert);font-family:var(--mono);font-size:13px">Render error: ${x(e.message)}<br><small>${x(e.stack||``)}</small></div>`)}}var Uu=!1,Wu=!1;function Gu(){Uu=!Uu;let e=document.getElementById(`budget-detail`),t=document.getElementById(`budget-expand-label`),n=document.getElementById(`budget-expand-chevron`),r=e&&e.parentElement;e&&(e.classList.toggle(`collapsed`,!Uu),e.classList.toggle(`expanded`,Uu)),r&&(r.style.marginBottom=Uu?`16px`:`0`),t&&(t.textContent=Uu?`Hide details ▲`:`See breakdown ▼`),n&&(n.textContent=Uu?`▲`:`▼`)}function Q(e,t,n){document.getElementById(`modal-title`).textContent=e,document.getElementById(`modal-body`).innerHTML=t,document.getElementById(`modal-footer`).innerHTML=`
    <button class="btn btn-ghost" onclick="closeModal()">Cancel</button>
    <button class="btn btn-primary" id="modal-save-btn">Save</button>
  `,window._modalSaveHandler=n,document.getElementById(`modal-save-btn`).onclick=()=>window._modalSaveHandler?.(),document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function $(){Fi=null,window._actualEditorRefresh=null,window._csvSuggestions=null,window._csvSuggestNames=null,document.getElementById(`modal-body`).innerHTML=``,document.getElementById(`modal-footer`).innerHTML=``,document.getElementById(`modal-overlay`).classList.add(`hidden`)}document.getElementById(`modal-overlay`).addEventListener(`click`,e=>{e.target===document.getElementById(`modal-overlay`)&&$()});function Ku(){Q(`Edit Contract Total`,`
    <div class="form-group">
  ...
  `,()=>{let e=parseFloat(document.getElementById(`f-contract-total`).value);!isNaN(e)&&e>0&&(z(`Updated contract total`,w(e)),m.buildContract.total=e,B(m),$(),renderAll())})}function qu(e={}){return`
    <div class="form-row">
      <div class="form-group">
  ...
  `}function Ju(e){return{id:e,name:document.getElementById(`f-stage-name`).value.trim(),amount:parseFloat(document.getElementById(`f-stage-amount`).value)||0,paid:document.getElementById(`f-stage-paid`).checked,expectedDate:document.getElementById(`f-stage-expected`).value,paidDate:document.getElementById(`f-stage-paiddate`).value,invoiceRef:document.getElementById(`f-stage-ref`).value.trim(),funding:document.getElementById(`f-stage-funding`).value,notes:document.getElementById(`f-stage-notes`).value.trim()}}function Yu(){Q(`Add Contract Stage`,qu(),()=>{let e=Ju(M(m.buildContract.stages));e.name&&(z(`Added build stage`,e.name),m.buildContract.stages.push(e),B(m),$(),renderAll())})}function Xu(e){let t=m.buildContract.stages.find(t=>t.id===e);Q(`Edit Stage`,qu(t),()=>{let n=Ju(e);z(`Edited build stage`,n.name||t.name),Object.assign(t,n),B(m),$(),renderAll()})}function Zu(e){if(!confirm(`Delete this stage?`))return;let t=m.buildContract.stages.find(t=>t.id===e);z(`Deleted build stage`,t?t.name:``),m.buildContract.stages=m.buildContract.stages.filter(t=>t.id!==e),B(m),renderAll()}function Qu(e={}){return`
    <div class="form-row">
      <div class="form-group">
  ...
  `}function $u(e){return{id:e,ref:document.getElementById(`f-var-ref`).value.trim(),name:document.getElementById(`f-var-name`).value.trim(),amount:parseFloat(document.getElementById(`f-var-amount`).value)||0,status:document.getElementById(`f-var-status`).value,funding:document.getElementById(`f-var-funding`).value,dateRaised:document.getElementById(`f-var-raised`).value,dateApproved:document.getElementById(`f-var-approved`).value,notes:document.getElementById(`f-var-notes`).value.trim()}}function ed(){Q(`Add Variation`,Qu(),()=>{let e=$u(M(m.buildContract.variations));e.name&&(z(`Added variation`,`${e.ref?e.ref+` · `:``}${e.name}`),m.buildContract.variations.push(e),B(m),il())})}function td(e){Q(`Edit Variation`,Qu(m.buildContract.variations.find(t=>t.id===e)),()=>{let t=$u(e);if(!t.name)return;z(`Edited variation`,`${t.ref?t.ref+` · `:``}${t.name}`);let n=m.buildContract.variations.findIndex(t=>t.id===e);n!==-1&&(m.buildContract.variations[n]=t),B(m),il()})}function nd(e){if(!confirm(`Delete this variation?`))return;let t=m.buildContract.variations.find(t=>t.id===e);z(`Deleted variation`,t?t.name:``),m.buildContract.variations=m.buildContract.variations.filter(t=>t.id!==e),B(m),il()}var rd=[{value:`not-quoted`,label:`Not Quoted`},{value:`quoted`,label:`Quoted`},{value:`approved`,label:`Approved`},{value:`partial`,label:`Partially Paid`},{value:`paid`,label:`Paid`}];function id(e={}){let t=e.status||(e.totalAmount?`approved`:`not-quoted`);return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Item Name</label>
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <select class="form-select" id="f-extra-status">
          ${rd.map(e=>`<option value="${e.value}" ${t===e.value?`selected`:``}>${e.label}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
  ...
  `}function ad(e){return{id:e,name:document.getElementById(`f-extra-name`).value.trim(),vendor:document.getElementById(`f-extra-vendor`).value.trim(),status:document.getElementById(`f-extra-status`).value,funding:document.getElementById(`f-extra-funding`).value,totalAmount:parseFloat(document.getElementById(`f-extra-total`).value)||0,amountPaid:parseFloat(document.getElementById(`f-extra-paid`).value)||0,dueDate:document.getElementById(`f-extra-due`).value,notes:document.getElementById(`f-extra-notes`).value.trim()}}function od(){Q(`Add Outside Contract Item`,id(),()=>{let e=ad(M(m.extras));e.name&&(z(`Added extra item`,e.name),m.extras.push(e),B(m),$(),renderAll())})}function sd(e){let t=m.extras.find(t=>t.id===e);Q(`Edit Item`,id(t),()=>{let n=ad(e);z(`Edited extra item`,n.name||t.name),Object.assign(t,n),B(m),$(),renderAll()})}function cd(e){if(!confirm(`Delete this item?`))return;let t=m.extras.find(t=>t.id===e);z(`Deleted extra item`,t?t.name:``),m.extras=m.extras.filter(t=>t.id!==e),B(m),renderAll()}function ld(e={}){let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():``,n=[`weekly`,`fortnightly`,`monthly`,`quarterly`,`annually`,`custom`],r=e.frequency===`custom`;return`
    <div class="form-group">
  ...
  `}function ud(e){let t=document.getElementById(`f-inc-freq`)?document.getElementById(`f-inc-freq`).value:`monthly`,n=document.getElementById(`f-inc-recurring`),r={id:e,name:document.getElementById(`f-inc-name`).value.trim(),amount:parseFloat(document.getElementById(`f-inc-amount`).value)||0,frequency:t,dueDate:document.getElementById(`f-inc-duedate`).value||null,recurring:n?n.checked:!0};return t===`custom`&&(r.customEvery=parseInt(document.getElementById(`f-inc-custom-n`).value)||1,r.customUnit=document.getElementById(`f-inc-custom-unit`).value),r}function dd(){Q(`Add Income`,ld(),()=>{let e=ud(M(G(K).income));e.name&&(z(`Added income`,e.name),Cs(()=>{let t=ys(K);e.id=M(t.income),t.income.push(e),B(m),renderAll()},()=>{e.id=M(m.budget.income),m.budget.income.push(e),B(m),renderAll()}))})}function fd(e){let t=G(K).income.find(t=>t.id===e);Q(`Edit Income`,ld(t),()=>{let n=ud(e);z(`Edited income`,n.name||t&&t.name||``),Cs(()=>{let t=ys(K),r=t.income.find(t=>t.id===e);r?Object.assign(r,n):t.income.push(n),B(m),renderAll()},()=>{let t=m.budget.income.find(t=>t.id===e);t&&Object.assign(t,n),B(m),renderAll()})})}function pd(e){let t=G(K).income.find(t=>t.id===e),n=t?t.name:`this income`;z(`Deleted income`,n),Ss=null,document.getElementById(`modal-title`).textContent=`Delete income`,document.getElementById(`modal-body`).innerHTML=`
    <p style="font-size:14px;line-height:1.6;margin:0;color:var(--text-muted)">
      Delete <strong style="color:var(--text)">${n}</strong>? Apply to
      <strong style="color:var(--text)">${q(K)}</strong> only,
      or remove from all months?
    </p>`,Ss={onThisMonth:()=>{let t=ys(K);t.income=t.income.filter(t=>t.id!==e),B(m),renderAll()},onAllMonths:()=>{m.budget.income=m.budget.income.filter(t=>t.id!==e),m.budget.months&&Object.values(m.budget.months).forEach(t=>{t.income=t.income.filter(t=>t.id!==e)}),B(m),renderAll()}},document.getElementById(`modal-footer`).innerHTML=`
    <button class="btn btn-ghost" onclick="closeModal()">Cancel</button>
    <button class="btn btn-secondary" onclick="doScopeAll()">Remove from all months</button>
    <button class="btn btn-danger" onclick="doScopeMonth()">Delete from ${q(K)}</button>
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function md(e={}){let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():``,n=[`weekly`,`fortnightly`,`monthly`,`quarterly`,`annually`,`custom`],r=e.frequency===`custom`;return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Description</label>
      ...
      <div class="form-group">
        ...
        <select class="form-select" id="f-exp-cat">
          ${al().map(t=>`<option value="${t}" ${(e.category||`Other`)===t?`selected`:``}>${t}</option>`).join(``)}
        </select>
      </div>
    </div>
    <div class="form-group">
  ...
  `}function hd(e){let t=document.getElementById(`f-exp-freq`)?document.getElementById(`f-exp-freq`).value:`monthly`,n=document.getElementById(`f-exp-recurring`),r={id:e,name:document.getElementById(`f-exp-name`).value.trim(),category:document.getElementById(`f-exp-cat`).value,vendor:(document.getElementById(`f-exp-vendor`)?.value||``).trim()||null,amount:parseFloat(document.getElementById(`f-exp-amount`).value)||0,frequency:t,dueDate:document.getElementById(`f-exp-duedate`).value||null,recurring:n?n.checked:!0};return t===`custom`&&(r.customEvery=parseInt(document.getElementById(`f-exp-custom-n`).value)||1,r.customUnit=document.getElementById(`f-exp-custom-unit`).value),r}function gd(e){let t=document.getElementById(`f-${e}-freq`).value,n=document.getElementById(`f-${e}-custom-wrap`);n&&(n.style.display=t===`custom`?`flex`:`none`)}function _d(){Q(`Add Expense`,md(),()=>{let e=hd(M(G(K).expenses));e.name&&(z(`Added expense`,`${e.name} (${e.category||`Other`})`),Cs(()=>{let t=ys(K);e.id=M(t.expenses),t.expenses.push(e),B(m),renderAll()},()=>{if(e.id=M(m.budget.expenses),m.budget.expenses.push(e),vs(K)){let t=m.budget.months[K];t.expenses.push({...e,id:M(t.expenses)})}B(m),renderAll()}))})}function vd(e){let t=G(K).expenses.find(t=>t.id===e);Q(`Edit Expense`,md(t),()=>{let n=hd(e);z(`Edited expense`,`${n.name||t&&t.name||``} (${n.category||`Other`})`),Cs(()=>{let t=ys(K),r=t.expenses.find(t=>t.id===e);r?Object.assign(r,n):t.expenses.push(n),B(m),renderAll()},()=>{let t=m.budget.expenses.find(t=>t.id===e);if(t&&Object.assign(t,n),vs(K)){let t=m.budget.months[K].expenses.find(t=>t.id===e);t&&Object.assign(t,n)}B(m),renderAll()})});let n=document.createElement(`button`);n.className=`btn btn-danger`,n.textContent=`Delete`,n.style.marginRight=`auto`,n.onclick=()=>{$(),yd(e)};let r=document.getElementById(`modal-footer`);r.insertBefore(n,r.firstChild)}function yd(e){let t=G(K).expenses.find(t=>t.id===e),n=t?t.name:`this expense`;z(`Deleted expense`,n),Ss={onThisMonth:()=>{let t=ys(K);t.expenses=t.expenses.filter(t=>t.id!==e),B(m),renderAll()},onAllMonths:()=>{m.budget.expenses=m.budget.expenses.filter(t=>t.id!==e),m.budget.months&&Object.values(m.budget.months).forEach(t=>{t.expenses=t.expenses.filter(t=>t.id!==e)}),B(m),renderAll()}},document.getElementById(`modal-title`).textContent=`Delete expense`,document.getElementById(`modal-body`).innerHTML=`
    <p style="font-size:14px;line-height:1.6;margin:0;color:var(--text-muted)">
      Delete <strong style="color:var(--text)">${n}</strong>? Apply to
      <strong style="color:var(--text)">${q(K)}</strong> only,
      or remove from all months?
  ...
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}var bd=null,xd=`asc`,Sd=`all`;function Cd(e){Sd=e,Hu()}function wd(e){xd=bd===e&&xd===`asc`?`desc`:`asc`,bd=e,Hu()}function Td(e,t,n=``){let r=bd===e;return`<th class="sortable${r?` sort-active`:``}" onclick="sortExpenses('${e}')">${t}${n}<span class="sort-icon">${r?xd===`asc`?`↑`:`↓`:`↕`}</span></th>`}function Ed(e){let t=[`th`,`st`,`nd`,`rd`],n=e%100;return e+(t[(n-20)%10]||t[n]||t[0])}function Dd(){let e=document.getElementById(`dev-tools-overlay`),t=document.getElementById(`dev-tools-sheet`),n=document.getElementById(`dev-tools-body`);if(!e||!t)return;let r=new Date().toISOString().slice(0,10);new Date(Date.now()+864e5).toISOString().slice(0,10),new Date(Date.now()+3*864e5).toISOString().slice(0,10),new Date(Date.now()+7*864e5).toISOString().slice(0,10),new Date(new Date().setMonth(new Date().getMonth()-1)).toISOString().slice(0,7),r.slice(0,7),n.innerHTML=[{label:`💰 Wallet — full budget`,desc:`Income, expenses, actuals, bills, goals, net worth`,fn:`_devLoadWallet`},{label:`👨‍👩‍👧 Kids zone`,desc:`Two kids, chores, prizes, completions, redemptions`,fn:`_devLoadKids`},{label:`📋 Routines`,desc:`Morning & evening routines with steps, assigned to kids`,fn:`_devLoadRoutines`},{label:`📅 Planner & events`,desc:`Events today, tomorrow, this week, recurring`,fn:`_devLoadPlanner`},{label:`🏠 Home — docs, vehicles, maintenance`,desc:`Documents expiring, vehicle rego, maintenance tasks`,fn:`_devLoadHome`},{label:`🍽 Meals & lunchbox`,desc:`This week's meal plan + kids lunchbox entries`,fn:`_devLoadMeals`},{label:`🌟 Load everything`,desc:`All of the above in one shot`,fn:`_devLoadAll`,primary:!0},{label:`🗑 Reset to empty`,desc:`Clears all state back to defaults`,fn:`_devReset`,danger:!0}].map(e=>`
    ...
    </div>`,e.style.display=`block`,t.style.display=`block`}function Od(){document.getElementById(`dev-tools-overlay`).style.display=`none`,document.getElementById(`dev-tools-sheet`).style.display=`none`}function kd(){let e=new Date().toISOString().slice(0,7);new Date(new Date().setMonth(new Date().getMonth()-1)).toISOString().slice(0,7),m.budget.income=[{id:uid(),name:`Salary`,category:`Salary`,amount:8500,frequency:`monthly`},{id:uid(),name:`Freelance`,category:`Freelance / Contract`,amount:1200,frequency:`monthly`}],m.budget.expenses=[{id:uid(),name:`Mortgage`,category:`Mortgage / Rent`,amount:2800,frequency:`monthly`},{id:uid(),name:`Groceries`,category:`Groceries`,amount:900,frequency:`monthly`},{id:uid(),name:`Electricity`,category:`Utilities`,amount:220,frequency:`monthly`},{id:uid(),name:`Internet`,category:`Utilities`,amount:89,frequency:`monthly`},{id:uid(),name:`Car insurance`,category:`Insurance`,amount:180,frequency:`monthly`},{id:uid(),name:`Dining out`,category:`Dining Out`,amount:350,frequency:`monthly`},{id:uid(),name:`Netflix`,category:`Subscriptions`,amount:23,frequency:`monthly`},{id:uid(),name:`Spotify`,category:`Subscriptions`,amount:12,frequency:`monthly`},{id:uid(),name:`Gym`,category:`Health`,amount:75,frequency:`monthly`},{id:uid(),name:`Kids activities`,category:`Childcare / Education`,amount:280,frequency:`monthly`}];let t={};m.budget.expenses.forEach(e=>{t[e.id]=Math.round(parseFloat(e.amount)*(.4+Math.random()*.7))}),m.budget.actuals[e]=t;let n=e=>{let t=new Date;return t.setDate(t.getDate()+e),t.getDate()},r=e=>{let t=new Date;return t.setDate(t.getDate()+e),t.getMonth()+1};m.bills=[{id:uid(),name:`Electricity`,amount:180,dueDay:n(0),dueMonth:r(0),category:`Utilities`},{id:uid(),name:`Council rates`,amount:420,dueDay:n(1),dueMonth:r(1),category:`Other`},{id:uid(),name:`Phone plan`,amount:45,dueDay:n(2),dueMonth:r(2),category:`Utilities`},{id:uid(),name:`Water bill`,amount:185,dueDay:n(4),dueMonth:r(4),category:`Utilities`},{id:uid(),name:`Internet`,amount:89,dueDay:n(5),dueMonth:r(5),category:`Utilities`},{id:uid(),name:`Spotify`,amount:12,dueDay:n(6),dueMonth:r(6),category:`Subscriptions`},{id:uid(),name:`Home insurance`,amount:290,dueDay:n(14),dueMonth:r(14),category:`Insurance`}],m.goals=[{id:uid(),name:`Emergency fund`,type:`emergency`,targetAmount:25e3,currentAmount:11200,deadline:``},{id:uid(),name:`Europe holiday`,type:`holiday`,targetAmount:8e3,currentAmount:2400,deadline:`2026-12-01`},{id:uid(),name:`New car`,type:`vehicle`,targetAmount:35e3,currentAmount:7800,deadline:`2027-06-01`}],m.netWorth={assets:[{id:uid(),name:`Home`,category:`Property`,amount:85e4},{id:uid(),name:`Super`,category:`Super`,amount:142e3},{id:uid(),name:`Savings`,category:`Savings`,amount:28e3},{id:uid(),name:`Car`,category:`Vehicle`,amount:22e3}],liabilities:[{id:uid(),name:`Mortgage`,category:`Mortgage`,amount:52e4},{id:uid(),name:`Car loan`,category:`Loan`,amount:12e3}],snapshots:[],target:{amount:15e5,byYear:2040}},m.settings={...m.settings,adultName:`Robert Gentilcore`,householdName:`Gentilcore Family`},B(m),renderAll()}function Ad(){_routineTodayKey();let e=uid(),t=uid(),n=uid(),r=uid(),i=uid(),a=uid(),o=uid();m.kids={profiles:[{id:e,name:`Amy`,emoji:`🌸`,dob:`2015-03-14`,pinHash:null},{id:t,name:`Johnny`,emoji:`⚡`,dob:`2013-07-22`,pinHash:null}],chores:[{id:n,name:`Make bed`,emoji:`🛏️`,assignedTo:e,points:5,frequency:`Daily`},{id:r,name:`Tidy room`,emoji:`🧹`,assignedTo:e,points:10,frequency:`Daily`},{id:i,name:`Take out bins`,emoji:`🗑️`,assignedTo:t,points:15,frequency:`Weekly`}],prizes:[{id:a,name:`Extra screen time`,emoji:`📱`,pointCost:30},{id:o,name:`Movie night pick`,emoji:`🎬`,pointCost:50},{id:uid(),name:`Takeaway dinner choice`,emoji:`🍕`,pointCost:80}],completions:[{id:uid(),kidId:e,choreId:n,status:`approved`,ts:new Date().toISOString(),completedAt:new Date().toISOString()},{id:uid(),kidId:e,choreId:r,status:`pending`,ts:new Date().toISOString()},{id:uid(),kidId:t,choreId:i,status:`approved`,ts:new Date().toISOString(),completedAt:new Date().toISOString()}],redemptions:[{id:uid(),kidId:e,prizeId:a,status:`pending`,ts:new Date().toISOString()}],notifications:[],allowances:[]},m.childEvents=[{id:uid(),title:`Soccer training`,emoji:`⚽`,date:new Date().toISOString().slice(0,10),time:`17:00`,assignedTo:[t],isHouseholdWide:!1,createdBy:`dev`},{id:uid(),title:`Piano lesson`,emoji:`🎹`,date:new Date(Date.now()+864e5).toISOString().slice(0,10),time:`15:30`,assignedTo:[e],isHouseholdWide:!1,createdBy:`dev`},{id:uid(),title:`Family dinner`,emoji:`🍽️`,date:new Date(Date.now()+2*864e5).toISOString().slice(0,10),time:`19:00`,assignedTo:[],isHouseholdWide:!0,createdBy:`dev`}],B(m),renderAll()}function jd(){let e=_routineTodayKey(),t=m.kids?.profiles?.[0],n=m.kids?.profiles?.[1],r=[{id:uid(),label:`Make bed`,emoji:`🛏️`,points:5,durationMin:2},{id:uid(),label:`Shower`,emoji:`🚿`,points:5,durationMin:10},{id:uid(),label:`Breakfast`,emoji:`🥣`,points:5,durationMin:15},{id:uid(),label:`Pack bag`,emoji:`🎒`,points:5,durationMin:5}],i=[{id:uid(),label:`Homework`,emoji:`📚`,points:10,durationMin:30},{id:uid(),label:`Tidy room`,emoji:`🧹`,points:5,durationMin:10},{id:uid(),label:`Brush teeth`,emoji:`🦷`,points:5,durationMin:3}],a=[{id:uid(),label:`Exercise`,emoji:`💪`,points:0,durationMin:30},{id:uid(),label:`Meditate`,emoji:`🧘`,points:0,durationMin:10},{id:uid(),label:`Plan the day`,emoji:`📋`,points:0,durationMin:5},{id:uid(),label:`Vitamins`,emoji:`💊`,points:0,durationMin:1}],o=[{id:uid(),label:`Tidy kitchen`,emoji:`🍽️`,points:0,durationMin:10},{id:uid(),label:`Review the day`,emoji:`🪞`,points:0,durationMin:5},{id:uid(),label:`Read`,emoji:`📖`,points:0,durationMin:20},{id:uid(),label:`Lights out`,emoji:`💤`,points:0,durationMin:0}],s=new Date().getHours(),c=uid(),l=uid(),u=uid(),d=uid(),f=[{id:c,name:`Morning`,emoji:`☀️`,ownerType:`adult`,ownerId:`dev`,sharedWith:[],steps:a,pointsPerCompletion:0,triggerTime:`07:00`,recurrence:{type:`weekdays`,startDate:`2026-01-01`},skippedDates:[],pausePeriods:[],completions:{}},{id:l,name:`Evening`,emoji:`🌙`,ownerType:`adult`,ownerId:`dev`,sharedWith:[],steps:o,pointsPerCompletion:0,triggerTime:`${String(s).padStart(2,`0`)}:00`,recurrence:{type:`daily`,startDate:`2026-01-01`},skippedDates:[],pausePeriods:[],completions:{}},{id:u,name:`Morning routine`,emoji:`🌤️`,ownerType:`household`,ownerId:`dev`,sharedWith:[],steps:r,pointsPerCompletion:10,triggerTime:`07:30`,recurrence:{type:`weekdays`,startDate:`2026-01-01`},skippedDates:[],pausePeriods:[]},{id:d,name:`Evening routine`,emoji:`🌙`,ownerType:`household`,ownerId:`dev`,sharedWith:[],steps:i,pointsPerCompletion:10,triggerTime:`${String(s).padStart(2,`0`)}:00`,recurrence:{type:`daily`,startDate:`2026-01-01`},skippedDates:[],pausePeriods:[]}];m.routines=[...(m.routines||[]).filter(e=>e.ownerType!==`adult`&&e.ownerType!==`household`),...f];let p=[];if(t){let n={id:uid(),routineId:u,childId:t.id,completionState:{}};n.completionState[e]=[r[0].id,r[1].id],p.push(n),p.push({id:uid(),routineId:d,childId:t.id,completionState:{}})}n&&(p.push({id:uid(),routineId:u,childId:n.id,completionState:{}}),p.push({id:uid(),routineId:d,childId:n.id,completionState:{}})),m.routineAssignments=[...m.routineAssignments||[],...p];let h=f[0];h.completions[e]=[a[0].id,a[1].id],B(m),renderAll()}function Md(){let e=new Date().toISOString().slice(0,10),t=new Date(Date.now()+864e5).toISOString().slice(0,10),n=new Date(Date.now()+3*864e5).toISOString().slice(0,10),r=new Date(Date.now()+5*864e5).toISOString().slice(0,10),i=new Date(Date.now()+7*864e5).toISOString().slice(0,10),a=Ft(),o=a[0]?.id||`everyone`,s=a[1]?.id||o;m.planner={events:[{id:uid(),title:`School drop-off`,category:`family`,date:e,time:`08:30`,memberIds:[o],allDay:!1,recurrence:{type:`weekdays`,startDate:`2026-01-01`}},{id:uid(),title:`Team standup`,category:`work`,date:e,time:`09:00`,memberIds:[o],allDay:!1},{id:uid(),title:`Dentist appointment`,category:`health`,date:e,time:`14:00`,memberIds:[o],allDay:!1},{id:uid(),title:`Dinner reservation`,category:`social`,date:e,time:`19:30`,memberIds:[`everyone`],allDay:!1},{id:uid(),title:`Parent–teacher night`,category:`family`,date:t,time:`18:00`,memberIds:[o,s],allDay:!1},{id:uid(),title:`Grocery run`,category:`family`,date:t,time:`10:00`,memberIds:[o],allDay:!1},{id:uid(),title:`Weekend hike`,category:`social`,date:n,time:`08:00`,memberIds:[`everyone`],allDay:!1},{id:uid(),title:`Car service`,category:`home`,date:r,time:`09:00`,memberIds:[o],allDay:!1},{id:uid(),title:`Amy's birthday`,category:`family`,date:i,allDay:!0,memberIds:[`everyone`]}]},B(m),renderAll()}function Nd(){new Date().toISOString().slice(0,10);let e=new Date(Date.now()+14*864e5).toISOString().slice(0,10),t=new Date(Date.now()+60*864e5).toISOString().slice(0,10),n=new Date(Date.now()-7*864e5).toISOString().slice(0,10),r=new Date(Date.now()-30*864e5).toISOString().slice(0,10),i=new Date(Date.now()-90*864e5).toISOString().slice(0,10);m.documents=[{id:uid(),name:`Passport — Robert`,provider:`DFAT`,expiryDate:e},{id:uid(),name:`Home insurance`,provider:`NRMA`,expiryDate:t},{id:uid(),name:`Working with children check`,provider:`Service NSW`,expiryDate:r},{id:uid(),name:`First aid certificate`,provider:`St John`,expiryDate:n}],m.vehicles=[{id:uid(),name:`Tesla Model 3`,make:`Tesla`,model:`Model 3`,plate:`ABC123`,regoExpiry:t,insurance:{provider:`NRMA`,renewalDate:t}},{id:uid(),name:`Toyota RAV4`,make:`Toyota`,model:`RAV4`,plate:`XYZ789`,regoExpiry:n,insurance:{provider:`AAMI`,renewalDate:t}}],m.maintenance=[{id:uid(),name:`Gutter clean`,provider:`Jim's`,nextDue:i,frequency:`Biannual`,notes:`Both sides`},{id:uid(),name:`Car service — RAV4`,provider:`Toyota Service`,nextDue:r,frequency:`Annual`,notes:`15,000km service`},{id:uid(),name:`Termite inspection`,provider:`Rentokil`,nextDue:n,frequency:`Annual`,notes:``},{id:uid(),name:`HVAC filter`,provider:``,nextDue:e,frequency:`Quarterly`,notes:``},{id:uid(),name:`Smoke alarm test`,provider:``,nextDue:t,frequency:`Annual`,notes:``}],m.householdProfile={...m.householdProfile,members:[{role:`adult`,name:`Robert`,age:38,emoji:`👨`},{role:`adult`,name:`Sarah`,age:36,emoji:`👩`}]},B(m),renderAll()}function Pd(){let e=typeof L==`function`?L(0):`week-0`,t={},n=[[`Porridge`,`Sandwich & apple`,`Chicken stir-fry`],[`Eggs on toast`,`Leftovers`,`Beef tacos`],[`Smoothie`,`Caesar salad`,`Pasta bolognese`],[`Avocado toast`,`Sushi`,`Lamb roast`],[`Cereal`,`Toasted sandwich`,`Fish & chips`],[`Pancakes`,`Fruit bowl`,`BBQ`],[`French toast`,`Cold cuts`,`Pizza night`]];for(let e=0;e<7;e++)t[e]={b:n[e][0],l:n[e][1],d:n[e][2]};m.meals||(m.meals={plan:{},shopping:[],lunchbox:{profiles:[],plans:{}},pantry:[]}),m.meals.plan[e]=t;let r=m.kids?.profiles?.[0];if(r){let t=typeof L==`function`?L(0):e;m.meals.lunchbox.plans||(m.meals.lunchbox.plans={}),m.meals.lunchbox.plans[t]||(m.meals.lunchbox.plans[t]={});let n=new Date().getDay()===0?6:new Date().getDay()-1;m.meals.lunchbox.plans[t][r.id]={},m.meals.lunchbox.plans[t][r.id][n]={main:`🥪 Vegemite sandwich`,snack:`🍫 Muesli bar`,fruit:`🍎 Apple`,drink:`💧 Water`}}m.lists||zi(m);let i=new Date().toISOString();m.lists.food.items=[{id:`dev-f1`,name:`Milk`,quantity:2,unit:`L`,notes:``,aisle:`dairy`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f2`,name:`Eggs`,quantity:1,unit:`dozen`,notes:`Free range`,aisle:`dairy`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f3`,name:`Chicken breast`,quantity:500,unit:`g`,notes:``,aisle:`meat`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f4`,name:`Spinach`,quantity:1,unit:`units`,notes:``,aisle:`produce`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f5`,name:`Bread`,quantity:1,unit:`units`,notes:`Sourdough`,aisle:`bakery`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f6`,name:`Pasta`,quantity:500,unit:`g`,notes:``,aisle:`pantry`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f7`,name:`Beer`,quantity:1,unit:`units`,notes:``,aisle:`drinks`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f8`,name:`Avocado`,quantity:2,unit:`units`,notes:``,aisle:`produce`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f9`,name:`Butter`,quantity:1,unit:`units`,notes:`Salted`,aisle:`dairy`,state:`got_it`,addedBy:`dev`,addedAt:i,stateChangedAt:i,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f10`,name:`Orange juice`,quantity:1,unit:`L`,notes:``,aisle:`drinks`,state:`got_it`,addedBy:`dev`,addedAt:i,stateChangedAt:i,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f11`,name:`Oat milk`,quantity:1,unit:`L`,notes:``,aisle:`dairy`,state:`not_found`,addedBy:`dev`,addedAt:i,stateChangedAt:i,mealTag:null,manualPrice:null,barcodeId:null}],m.lists.food.weeklyBudget=200,m.lists.food.favourites=[{name:`Milk`,addedCount:8,pinned:!0},{name:`Eggs`,addedCount:7,pinned:!0},{name:`Bread`,addedCount:6,pinned:!1},{name:`Chicken breast`,addedCount:5,pinned:!1},{name:`Butter`,addedCount:4,pinned:!1}],m.lists.wishlist.items=[{id:`dev-w1`,name:`AirPods Pro`,quantity:1,unit:`units`,notes:`Gen 2`,aisle:`other`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-w2`,name:`Standing desk mat`,quantity:1,unit:`units`,notes:``,aisle:`other`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-w3`,name:`Kindle Paperwhite`,quantity:1,unit:`units`,notes:``,aisle:`other`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null}],B(m),renderAll()}function Fd(){kd(),Ad(),jd(),Md(),Nd(),Pd()}function Id(){if(!confirm(`Reset all data to empty defaults?`))return;let e=JSON.parse(JSON.stringify(Yi));e.onboarded=!0,e.setupProgressDismissed=!1,f(e),B(e),renderAll()}window._acceptInviteAndContinue=Uo,window._addRecurrenceToDate=ar,window._adultPinKey=Ra,window._adultPinSubmit=za,window._applyActiveProfile=Ea,window._applyChildNav=Da,window._applyMigrations=zi,window._assignmentCompletedToday=_assignmentCompletedToday,window._assignmentHistory=_assignmentHistory,window._assignmentStreak=_assignmentStreak,window._autoCreateRecurringEvents=or,window._briefIcon=Vc,window._briefRow=Kc,window._budgetAllocByCategory=Ru,window._buildTotoContext=vr,window._capacitorPrefs=ra,window._categoryIcon=Vu,window._checkInviteOnLoad=No,window._checkMissionEscalation=jc,window._checkSettingsUnsaved=Cu,window._chipClassFor=Hc,window._chipLabelFor=Uc,window._cleanupGuide=_cleanupGuide,window._copyInviteLinkForMember=Do,window._csOpen=Ki,window._csvSetExpense=rc,window._csvToggle=tc,window._csvToggleAll=nc,window._csvUpdateApplyBtn=ic,window._cvAgeBracket=Ba,window._cvCalViewToggle=co,window._cvConfetti=Wa,window._cvDismissNotif=ho,window._cvEventsForDate=eo,window._cvFmt12h=to,window._cvMonthDayTap=po,window._cvRefreshSchedulePanel=io,window._cvRender7Day=lo,window._cvRenderCalendar=so,window._cvRenderMonth=fo,window._cvRenderPrizesTab=qa,window._cvRoutineAvailLabel=Ua,window._cvRoutineIsActive=Ha,window._cvRoutineSchedCard=oo,window._cvScheduleHtml=ao,window._cvShowDayDetail=mo,window._cvShowPrizeConfirm=go,window._cvSwitchTab=$a,window._cvTimeGreeting=Va,window._cvToggleRoutineExpand=no,window._cvToggleStepFromCal=ro,window._cvUpdatePrizesBadge=Ka,window._cvViewCalendar=_cvViewCalendar,window._cvWeekDayTap=uo,window._deleteChildEvent=_deleteChildEvent,window._devLoadAll=Fd,window._devLoadHome=Nd,window._devLoadKids=Ad,window._devLoadMeals=Pd,window._devLoadPlanner=Md,window._devLoadRoutines=jd,window._devLoadWallet=kd,window._devReset=Id,window._devToolsClose=Od,window._devToolsOpen=Dd,window._dismissInviteFlow=Jo,window._docCatMeta=me,window._ensureKidProfileAndPin=Eo,window._ensureNWModals=Je,window._estimateLbCalories=_estimateLbCalories,window._estimateMealCalories=Ur,window._fetchAIBriefing=nl,window._finishInviteJourney=Go,window._getHouseholdDocRef=ji,window._getHouseholdOwnerUID=Ai,window._getInviteUrl=Oo,window._getNthDayOfMonth=nr,window._getPinTotalAttempts=us,window._handlePendingInvite=Po,window._hashPin=ma,window._highlightStep=_highlightStep,window._incPinTotalAttempts=ds,window._inferAisle=Dr,window._initAuthListener=Vi,window._isPinHardLocked=ps,window._listsAddFavourite=ai,window._listsAddItem=Xr,window._listsAddUsual=oi,window._listsArchive=ii,window._listsClearTrolley=ri,window._listsDeleteItem=Qr,window._listsOpenAddForm=ei,window._listsQuickAdd=$r,window._listsSaveForm=ni,window._listsSetState=Zr,window._listsUpdateParsePreview=si,window._maintDaysUntil=Se,window._maintNextDue=xe,window._markSettingsDirty=bu,window._mealGetSuggestions=Vr,window._mealPill=Rr,window._mealPriceSlide=Br,window._mealToggleFilter=zr,window._mealWeekDates=jr,window._mealWeekKey=L,window._missionDaysIgnored=kc,window._nextForecastMonth=Kt,window._openChildEventModal=_openChildEventModal,window._pantryToAisle=ti,window._parseShopInput=Or,window._pickAdult=ya,window._pickKid=ba,window._pinKey=wa,window._plannerCloseDaySheet=_plannerCloseDaySheet,window._plannerCloseDetail=_n,window._plannerCloseLifeSheet=mn,window._plannerCloseShare=xn,window._plannerCopyShareUrl=Cn,window._plannerEditFromDetail=yn,window._plannerEvMemberIds=Lt,window._plannerEvPrimaryMember=Rt,window._plannerEvWhoLabel=zt,window._plannerEventsForDate=Ht,window._plannerFmt12h=Ut,window._plannerGoToday=rn,window._plannerHandleDaySheetClick=dn,window._plannerHandleDetailClick=vn,window._plannerHandleLifeSheetClick=hn,window._plannerHandleShareClick=Sn,window._plannerMemberById=It,window._plannerMembers=Ft,window._plannerNextMonth=$t,window._plannerNudges=Tn,window._plannerOpenDaySheet=cn,window._plannerOpenDetail=gn,window._plannerOpenLifeSheet=pn,window._plannerOpenModalFromSheet=fn,window._plannerOpenShare=bn,window._plannerPrevMonth=Qt,window._plannerRecurrenceLabel=Bt,window._plannerRenderDaySheetList=ln,window._plannerSelectDay=en,window._plannerSetView=an,window._plannerShareVia=wn,window._plannerToggleFilter=sn,window._plannerToggleSection=on,window._plannerVisibleEvents=Vt,window._pmDpClear=Yn,window._pmDpNext=Qn,window._pmDpOpen=Gn,window._pmDpOutsideClick=Kn,window._pmDpPrev=Zn,window._pmDpRender=qn,window._pmDpSelect=Jn,window._pmDpToday=Xn,window._pmFmtDate=zn,window._pmFmtDateShort=Bn,window._pmHandleCatChange=Wn,window._pmRenderMemberPicker=Vn,window._pmToggleAllDay=Un,window._pmToggleMember=Hn,window._prevForecastMonth=Gt,window._psoHoldEnd=os,window._psoHoldStart=as,window._psoKey=ss,window._psoRender=is,window._psoSubmit=cs,window._psoTourDone=ls,window._pushAllEventsToBudget=tr,window._qaKey=mc,window._qaSelectCat=hc,window._qahAction=uc,window._qahApplyParsed=fc,window._qahSendText=dc,window._recordInviteAcceptance=Wo,window._recurrenceMatchesDate=_recurrenceMatchesDate,window._refreshSetupProgress=Lc,window._renderAdultPinModal=La,window._renderAdultRoutines=_renderAdultRoutines,window._renderApiKeySummary=Du,window._renderChildEventsMgmt=_renderChildEventsMgmt,window._renderChildRoutines=_renderChildRoutines,window._renderContextBanners=wc,window._renderCsvPreview=Qs,window._renderCsvReview=ec,window._renderInviteFlow=qo,window._renderLifeAreas=Gc,window._renderLifeScore=Pc,window._renderListItem=di,window._renderListsDetail=ui,window._renderListsSelector=li,window._renderMealPlan=Nr,window._renderMissionCard=Fc,window._renderNudgeSection=ir,window._renderPinDots=Sa,window._renderPinPad=Ca,window._renderPlannerAgenda=tn,window._renderPlannerEventRow=Zt,window._renderPlannerMonthGrid=Yt,window._renderPlannerWeekStrip=Xt,window._renderQAHub=lc,window._renderQASheet=pc,window._renderRoutinesTodayCard=_renderRoutinesTodayCard,window._renderShoppingList=Wr,window._renderSuggestionsSection=_renderSuggestionsSection,window._renderTourSlide=Bo,window._renderWeekStrip=Wc,window._resetPinAttempts=fs,window._routineAddStep=_routineAddStep,window._routineAddSuggestion=_routineAddSuggestion,window._routineAssertScope=_routineAssertScope,window._routineAvailableSuggestions=_routineAvailableSuggestions,window._routineAwardPoints=_routineAwardPoints,window._routineAwardStepPoints=_routineAwardStepPoints,window._routineCheckDailyReset=_routineCheckDailyReset,window._routineCompletedToday=_routineCompletedToday,window._routineCreate=_routineCreate,window._routineCurrentUserId=_routineCurrentUserId,window._routineDateKey=_routineDateKey,window._routineDelete=_routineDelete,window._routineDeleteChild=_routineDeleteChild,window._routineDeleteStep=_routineDeleteStep,window._routineDragEnd=_routineDragEnd,window._routineDragOver=_routineDragOver,window._routineDragStart=_routineDragStart,window._routineDrop=_routineDrop,window._routineDuplicateFromJoined=_routineDuplicateFromJoined,window._routineDuplicateTo=_routineDuplicateTo,window._routineEdit=_routineEdit,window._routineEditStep=_routineEditStep,window._routineEditSuggestion=_routineEditSuggestion,window._routineExpandSugg=_routineExpandSugg,window._routineGetAssignment=_routineGetAssignment,window._routineHistory=_routineHistory,window._routineIntelNudge=_routineIntelNudge,window._routineIsOwner=_routineIsOwner,window._routineJoin=_routineJoin,window._routineKids=_routineKids,window._routineLeave=_routineLeave,window._routineManageAssignments=_routineManageAssignments,window._routineMatchesDate=_routineMatchesDate,window._routineNextId=_routineNextId,window._routineOtherAdults=_routineOtherAdults,window._routinePauseMenu=_routinePauseMenu,window._routinePropagateStepAdd=_routinePropagateStepAdd,window._routinePropagateStepDelete=_routinePropagateStepDelete,window._routineRecurrenceCollect=_routineRecurrenceCollect,window._routineRecurrenceFormHtml=_routineRecurrenceFormHtml,window._routineRecurrenceSummaryUpdate=_routineRecurrenceSummaryUpdate,window._routineRecurrenceTypeChange=_routineRecurrenceTypeChange,window._routineRemovePause=_routineRemovePause,window._routineResetToday=_routineResetToday,window._routineResetTodayAllKids=_routineResetTodayAllKids,window._routineResetTodayKid=_routineResetTodayKid,window._routineSaveValidated=_routineSaveValidated,window._routineSetTab=_routineSetTab,window._routineShareMenu=_routineShareMenu,window._routineShowHistory=_routineShowHistory,window._routineSkipDay=_routineSkipDay,window._routineStreak=_routineStreak,window._routineTodayKey=_routineTodayKey,window._routineToggleAssignment=_routineToggleAssignment,window._routineToggleShare=_routineToggleShare,window._routineToggleStep=_routineToggleStep,window._routineToggleStepKid=_routineToggleStepKid,window._routineToggleSugg=_routineToggleSugg,window._routineTypeSelect=_routineTypeSelect,window._routineUnassign=_routineUnassign,window._routinesForCurrentUser=_routinesForCurrentUser,window._routinesForHousehold=_routinesForHousehold,window._saveInviteIncome=Ho,window._saveLbSlot=_saveLbSlot,window._sectionTag=Sc,window._secureClear=sa,window._secureGet=aa,window._securePrewarm=ia,window._secureSet=oa,window._setHouseholdOwner=Mi,window._setInviteRole=Co,window._setPinHardLock=ms,window._showGuideStep=_showGuideStep,window._showInviteA1=Fo,window._showInviteA3=Io,window._showInviteA4=zo,window._showInviteExpired=Ko,window._showInviteIncomePrompt=Vo,window._showMissionLightbox=Ac,window._showParentLockNotification=gs,window._showPinScreen=xa,window._showToast=Yr,window._startFirestoreSync=Bi,window._syncVehicleBill=se,window._tdCloseSheet=Zc,window._tdOpenHeadsUpSheet=Jc,window._tdOpenSheet=Xc,window._tdOpenSlippingSheet=Yc,window._tdToggleStep=Qc,window._ticker=Bu,window._tlItem=Cc,window._todayAllocSegments=Bc,window._totoAppendMessage=yr,window._totoInitPanel=mr,window._totoRemoveTyping=xr,window._totoSend=_r,window._totoSendSuggestion=hr,window._totoShowTyping=br,window._updateSwitchBtn=Ta,window._verifyPin=hs,window.addActualEntry=Ws,window.addCatToGroup=hu,window.addCategory=Au,window.addHouseholdMember=Rl,window.addLink=addLink,window.addPet=Vl,window.addSavings=addSavings,window.addShopItem=Gr,window.addSubFromImport=Et,window.adjForm=Dl,window.aiPlanLunchbox=aiPlanLunchbox,window.applianceForm=yi,window.applianceFromForm=bi,window.applyCsvImport=ac,window.approveCompletion=approveCompletion,window.approveRedemption=approveRedemption,window.approveSuggestion=kn,window.assignDevice=_a,window.attachBtn=attachBtn,window.aud=w,window.audD=T,window.billCatIcon=nt,window.billDueBadge=rt,window.billMonthlyEquiv=it,window.billsModal=ct,window.calcFinancialHealth=bc,window.calcLifeScore=Tc,window.calcScenario=yl,window.cancelSettingsChanges=Su,window.clearActivityLog=ku,window.clearAdultPin=Ma,window.clearCheckedShopItems=Jr,window.clearDeviceProfile=ua,window.clearKidPin=Aa,window.clearKidSession=pa,window.closeBillModal=ut,window.closeModal=$,window.closeNWModal=Xe,window.closeNWTargetModal=Ge,window.closePinSetupOverlay=rs,window.closeQuickAdd=cc,window.closeSubModal=St,window.closeTotoAssistant=pr,window.completeMission=Oc,window.completeWeeklyReset=Nc,window.confirmScope=Cs,window.copyInviteLink=ko,window.copyMonthFromPrevious=xs,window.customSelect=Gi,window.cyclePantryStatus=Me,window.deleteAdjustment=Al,window.deleteAppliance=Ci,window.deleteBill=pt,window.deleteCategoryGroup=pu,window.deleteChore=deleteChore,window.deleteDoc=ve,window.deleteExpense=yd,window.deleteExtra=cd,window.deleteFurniture=vi,window.deleteGoal=hl,window.deleteIncome=pd,window.deleteKid=deleteKid,window.deleteLbProfile=deleteLbProfile,window.deleteMaint=Ee,window.deleteNWItem=Qe,window.deletePantryItem=Fe,window.deletePlannerEvent=Nn,window.deletePrize=deletePrize,window.deleteReceiptById=deleteReceiptById,window.deleteScenario=El,window.deleteService=de,window.deleteStage=Zu,window.deleteSub=wt,window.deleteVariation=nd,window.deleteVehicle=ce,window.detectSpendingPatterns=Zl,window.dismissMission=Dc,window.dismissSubResult=Dt,window.dismissSuggestion=An,window.doScopeAll=Ts,window.doScopeMonth=ws,window.dpClearDate=Is,window.dpDateInput=As,window.dpNextMonth=Ps,window.dpPrevMonth=Ns,window.dpSelectDate=Fs,window.editActual=Ks,window.emojiPicker=emojiPicker,window.endGuide=endGuide,window.ensureMonthOverride=ys,window.escAttr=S,window.escHtml=x,window.estimateAllEvents=Jt,window.estimatePlannerEvent=Pn,window.exitChildView=exitChildView,window.expenseCategories=al,window.expenseForm=md,window.expenseFromForm=hd,window.exportData=Nu,window.extraForm=id,window.extraFromForm=ad,window.fileIcon=fileIcon,window.fileSizeStr=fileSizeStr,window.fmtDate=D,window.fmtNW=E,window.freqDisplay=ne,window.freqDisplayItem=k,window.freqLabel=O,window.freqLabelItem=re,window.fundingBadge=fundingBadge,window.furnitureForm=mi,window.furnitureFromForm=hi,window.generateInvite=wo,window.generateMission=Ec,window.generateShoppingList=fi,window.generateSmartInsights=eu,window.generateSmartInsightsHTML=ou,window.getAIKey=Jl,window.getActual=J,window.getActualEntries=Vs,window.getBenchmarkStatus=Kl,window.getBenchmarks=Gl,window.getCategoryHistoryData=Xl,window.getDB=getDB,window.getDeviceProfile=ca,window.getKidSession=da,window.getLast6Months=Bs,window.getMonthData=G,window.getReceipts=getReceipts,window.getSeasonalNudges=rr,window.goToPlannerDay=nn,window.goalForm=ul,window.goalFromForm=fl,window.goalProgress=cl,window.guestMode=Li,window.handleCsvFile=Zs,window.handleDeviceRouting=ha,window.handleSubCSV=Tt,window.hideOnboarding=hideOnboarding,window.importData=Pu,window.incomeCategories=ol,window.incomeForm=ld,window.incomeFromForm=ud,window.installApp=installApp,window.inviteMember=To,window.isMonthCustomized=vs,window.isOverdue=te,window.itemMonthly=A,window.kidBalance=kidBalance,window.lbToShoppingList=lbToShoppingList,window.loadColors=Nl,window.loadData=Xi,window.logActivity=z,window.markBillPaid=mt,window.markChoreChildView=_o,window.markChoreDone=markChoreDone,window.markGoalAchieved=gl,window.markMaintDone=De,window.monthLabel=q,window.monthShortLabel=zs,window.monthlyTotal=j,window.nextGuideStep=nextGuideStep,window.nextId=M,window.nextInsightsMonth=cu,window.nextMoneyMonth=vc,window.nextMonth=Rs,window.nwItemRow=Ve,window.obBack=obBack,window.obFinish=obFinish,window.obNext=obNext,window.obPickEmoji=obPickEmoji,window.obSetAdults=obSetAdults,window.obSetKids=obSetKids,window.obSkip=obSkip,window.obSkipExpenses=obSkipExpenses,window.obStepPosition=obStepPosition,window.obStepSequence=obStepSequence,window.obToggleEmojiPicker=obToggleEmojiPicker,window.obToggleExpenseSkip=obToggleExpenseSkip,window.openActualEditor=Us,window.openAddAdjustment=kl,window.openAddAppliance=xi,window.openAddCatToGroup=gu,window.openAddCategoryGroup=du,window.openAddExpense=_d,window.openAddExtra=od,window.openAddFurniture=gi,window.openAddGoal=pl,window.openAddIncome=dd,window.openAddKidModal=openAddKidModal,window.openAddScenario=wl,window.openAddStage=Yu,window.openAddVariation=ed,window.openBillModal=lt,window.openChoreModal=openChoreModal,window.openCsvImport=Ys,window.openDatePicker=js,window.openDocForm=ge,window.openEditAppliance=Si,window.openEditContractTotal=Ku,window.openEditExpense=vd,window.openEditExtra=sd,window.openEditFurniture=_i,window.openEditGoal=ml,window.openEditIncome=fd,window.openEditKidModal=openEditKidModal,window.openEditScenario=Tl,window.openEditStage=Xu,window.openEditVariation=td,window.openEmojiPickerModal=uu,window.openIconPickerForGroup=fu,window.openLunchboxEdit=openLunchboxEdit,window.openLunchboxProfile=openLunchboxProfile,window.openMaintForm=we,window.openMealEdit=Lr,window.openModal=Q,window.openNWModal=Ye,window.openNWTargetModal=We,window.openNavGroupFor=Di,window.openPantryForm=Ne,window.openPinSetup=ns,window.openPlannerModal=Rn,window.openPrizeModal=openPrizeModal,window.openQuickAdd=sc,window.openReceiptsModal=openReceiptsModal,window.openSavingsModal=openSavingsModal,window.openServiceForm=le,window.openSubModal=xt,window.openTotoAssistant=fr,window.openVehicleForm=N,window.openWeeklyReset=Mc,window.ordinal=Ed,window.pantryToShoppingList=Le,window.parseBankCSV=Xs,window.pickEmoji=pickEmoji,window.pickedEmoji=pickedEmoji,window.prevInsightsMonth=su,window.prevMoneyMonth=_c,window.prevMonth=Ls,window.prevMonthStr=bs,window.profileAdults=Il,window.profileChildren=Ll,window.quickAddMaint=Oe,window.quickAddPantry=Ie,window.redeemPrizeChildView=vo,window.refreshReceiptCounts=refreshReceiptCounts,window.rejectCompletion=rejectCompletion,window.rejectRedemption=rejectRedemption,window.removeActualEntry=Gs,window.removeApiKey=Eu,window.removeCatFromGroup=_u,window.removeCategory=ju,window.removeHouseholdMember=zl,window.removePet=Hl,window.removeReceipt=removeReceipt,window.removeShopItem=qr,window.renderAll=renderAll,window.renderApprovals=renderApprovals,window.renderBenchmarksSection=iu,window.renderBills=at,window.renderBudget=Hu,window.renderBudgetForecast=er,window.renderBudgetSuggestions=jn,window.renderBuild=il,window.renderCategoryBreakdown=Ql,window.renderChoreMgmt=renderChoreMgmt,window.renderDashboard=rl,window.renderDocuments=he,window.renderDpCalendar=Ms,window.renderExpenseGroups=Lu,window.renderForecast=qt,window.renderGoals=ll,window.renderInsightCards=ru,window.renderInsights=au,window.renderKidView=renderKidView,window.renderKids=renderKids,window.renderKidsOverview=renderKidsOverview,window.renderKidsParent=renderKidsParent,window.renderLists=ci,window.renderLunchbox=renderLunchbox,window.renderMaintenance=Ce,window.renderMeals=Mr,window.renderMoneyDashboard=yc,window.renderNWDebtCard=Ue,window.renderNWTargetCard=He,window.renderNWTrend=qe,window.renderNetWorth=Be,window.renderObStep=renderObStep,window.renderPantry=je,window.renderPlanner=I,window.renderPrizeMgmt=renderPrizeMgmt,window.renderReceiptsList=renderReceiptsList,window.renderRoutines=renderRoutines,window.renderScenarios=bl,window.renderSettings=Z,window.renderSetupProgress=Rc,window.renderSpendingPatterns=$l,window.renderSubImportResults=bt,window.renderSubscriptions=st,window.renderToday=qc,window.renderVehicles=ae,window.requestRedemption=requestRedemption,window.resetAllData=Mu,window.resetKidPinLock=_s,window.revokeInvite=jo,window.runAIInsights=nu,window.runCsvCategorise=$s,window.safeRender=safeRender,window.sanitiseState=ie,window.saveAIKey=Yl,window.saveApiKey=Tu,window.saveBill=ft,window.saveChore=saveChore,window.saveColors=Pl,window.saveData=B,window.saveDoc=_e,window.saveKid=saveKid,window.saveLbProfile=saveLbProfile,window.saveMaint=Te,window.saveMealSlot=Hr,window.saveNWItem=Ze,window.saveNWSnapshot=$e,window.saveNWTarget=Ke,window.savePantryItem=Pe,window.savePlannerEvent=$n,window.savePrize=savePrize,window.saveQuickAdd=gc,window.saveReceipt=saveReceipt,window.saveService=ue,window.saveSettingsChanges=xu,window.saveSub=Ct,window.saveVehicle=oe,window.scenarioForm=Sl,window.scenarioFromForm=Cl,window.sendInviteEmail=Ao,window.sendTotoMessage=gr,window.setActual=Hs,window.setAdultPin=ja,window.setBillsFilter=ot,window.setBudgetView=Iu,window.setDeviceProfile=la,window.setExpenseFilter=Cd,window.setKidPin=ka,window.setKidSession=fa,window.setupProgressTasks=Ic,window.showChildView=Ga,window.showDeviceSetup=ga,window.showOnboarding=showOnboarding,window.showProfileSelector=va,window.signInWithGoogle=Ii,window.signOutUser=Ri,window.sortExpenses=wd,window.stageForm=qu,window.stageFromForm=Ju,window.startGuide=startGuide,window.startHealthGuide=startHealthGuide,window.subCatIcon=gt,window.subMonthlyAmount=_t,window.suggestEventToBudget=On,window.switchProfile=Oa,window.switchToKidMode=yo,window.thSort=Td,window.toggleAdjFields=Ol,window.toggleBillDayField=dt,window.toggleBudgetDetail=Gu,window.toggleCustomFreq=gd,window.toggleGoalFields=dl,window.toggleGroupExpand=Fu,window.toggleHealthPopover=toggleHealthPopover,window.toggleInsightSheet=$c,window.toggleNavGroup=Ei,window.togglePlannerCard=En,window.togglePlannerEstimate=Dn,window.toggleScenario=xl,window.toggleSettingsSection=Ou,window.toggleShopItem=Kr,window.toggleSidebar=wi,window.toggleTotoAssistant=dr,window.uid=uid,window.unpushEventFromBudget=Mn,window.updateCars=Wl,window.updateCategoryGroup=mu,window.updateColor=Fl,window.updateMember=Bl,window.updatePet=Ul,window.updateSetting=wu,window.upgradeSelects=qi,window.uploadFiles=uploadFiles,window.uploadReceiptFiles=uploadReceiptFiles,window.variationForm=Qu,window.variationFromForm=$u,window.viewChildToday=viewChildToday,window.viewReceipt=viewReceipt;
//# sourceMappingURL=index-DrUzu5QA.js.map