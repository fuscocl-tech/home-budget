import"./firebase-DD2PS53O.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(e,t){return t===`daily`?e*365/12:t===`weekly`?e*52/12:t===`fortnightly`?e*26/12:t===`quarterly`?e/3:t===`annually`||t===`annual`?e/12:e}function t(e){let t=new Date;t.setHours(0,0,0,0);let n=e.frequency||`Monthly`;if(n===`Monthly`){let n=parseInt(e.dueDay)||1,r=new Date(t.getFullYear(),t.getMonth(),n);return r<t&&(r=new Date(t.getFullYear(),t.getMonth()+1,n)),r}let r=e.lastPaid?new Date(e.lastPaid):e.startDate?new Date(e.startDate):t;r.setHours(0,0,0,0);let i={Weekly:7,Fortnightly:14,Quarterly:91,Annually:365}[n]||30,a=new Date(r);for(;a<=t;)a=new Date(a.getTime()+i*864e5);return a}function n(e){let n=new Date;n.setHours(0,0,0,0);let r=t(e);return Math.round((r-n)/864e5)}var r={},i=new Set,a=new Set,o={},s=null,c=!1;function l(e,t){o=e,s=t}function u(){c||(c=!0,requestAnimationFrame(d))}function d(){if(c=!1,!s)return;if(a.has(`__all__`)||a.size===0){a.clear(),s();return}let e=new Set(a);a.clear(),e.add(`today`),e.forEach(e=>{let t=o[e];t&&t.forEach(t=>{try{t()}catch(t){console.error(`render error in`,e,t)}})})}function f(e){return i.add(e),()=>i.delete(e)}function p(){i.forEach(e=>{try{e(r)}catch(e){console.error(`store subscriber error:`,e)}})}function m(e){r=e,a.add(`__all__`),u(),p()}function h(e){r=e}var g=new Proxy({},{get(e,t){if(t!==`then`)return r[t]},set(e,t,n){return r[t]=n,!0},has(e,t){return t in r},ownKeys(){return Reflect.ownKeys(r)},getOwnPropertyDescriptor(e,t){let n=Object.getOwnPropertyDescriptor(r,t);return n?{...n,configurable:!0}:void 0}}),_={wallet:{navTab:`budget`,label:`Wallet`,tabs:[{tab:`budget`,label:`Budget`},{tab:`bills`,label:`Bills`},{tab:`networth`,label:`Net Worth`},{tab:`goals`,label:`Goals`},{tab:`insights`,label:`Insights`},{tab:`build`,label:`Build`}]},plan:{navTab:`planner`,label:`Plan`,tabs:[{tab:`planner`,label:`Planner`},{tab:`projects`,label:`Projects`},{tab:`forecast`,label:`Forecast`},{tab:`meals`,label:`Meals`},{tab:`lunchbox`,label:`Lunchbox`},{tab:`pantry`,label:`Pantry`},{tab:`routines`,label:`Routines`},{tab:`lists`,label:`Lists`}]},home:{navTab:`documents`,label:`Home`,tabs:[{tab:`documents`,label:`Documents`},{tab:`vehicles`,label:`Vehicles`},{tab:`maintenance`,label:`Maintenance`},{tab:`kids`,label:`Kids`}]}},v=()=>{};function y(e){v=e}function b(e){for(let[t,n]of Object.entries(_))if(n.tabs.some(t=>t.tab===e))return t;return null}function x(){let e=document.querySelector(`.tab-panel.active`);return e?e.id.replace(`tab-`,``):`today`}function S(e){if(!e)return;let t=e.querySelector(`.section-pills`);if(!t)return;let n=t.scrollWidth-t.scrollLeft-t.clientWidth>4,r=t.scrollLeft>4;e.classList.toggle(`has-overflow-right`,n),e.classList.toggle(`has-overflow-left`,r)}function C(e){e===`subscriptions`&&(e=`bills`),e===`scenarios`&&(e=`insights`),e===`money`&&(e=`budget`),e===`dashboard`&&(e=`budget`),document.getElementById(`tab-`+e)||(e=`today`),typeof window._checkSettingsUnsaved==`function`&&x()===`settings`&&e!==`settings`&&window._checkSettingsUnsaved(e),document.querySelectorAll(`.nav-item, .nav-text-item, .bn-item`).forEach(e=>e.classList.remove(`active`)),document.querySelectorAll(`.tab-panel`).forEach(e=>e.classList.remove(`active`));let t=document.getElementById(`tab-`+e);t&&t.classList.add(`active`);let n=b(e);if(n){let e=_[n].navTab;document.querySelectorAll(`[data-tab="${e}"]`).forEach(e=>e.classList.add(`active`))}else document.querySelectorAll(`[data-tab="${e}"]`).forEach(e=>e.classList.add(`active`));if(document.body.dataset.section=n||e,document.querySelectorAll(`.static-section-header`).forEach(e=>e.classList.remove(`active`)),n){let t=document.getElementById(n+`-section-header`);if(t){t.classList.add(`active`);let r=document.getElementById(n+`-header-date`);r&&(r.textContent=new Date().toLocaleDateString(`en-AU`,{weekday:`long`,month:`long`,day:`numeric`})),t.querySelectorAll(`.section-pill`).forEach(t=>t.classList.toggle(`active`,t.dataset.pill===e)),requestAnimationFrame(()=>t.querySelectorAll(`.section-pills-wrap`).forEach(S))}}v()}function w(e){e===`subscriptions`&&(e=`bills`),e===`scenarios`&&(e=`insights`),e===`money`&&(e=`budget`),e===`dashboard`&&(e=`budget`),(location.hash.slice(1)||`today`)!==e&&history.pushState({tab:e},``,`#`+e),C(e)}window.addEventListener(`popstate`,e=>{C(e.state?.tab||location.hash.slice(1)||`today`)}),(function(){let e=location.hash.slice(1)||`today`;history.replaceState({tab:e},``,e===`today`?location.pathname+location.search:`#`+e)})();function T(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function E(e){return T(e).replace(/\\/g,`\\\\`)}var ee=new Intl.NumberFormat(`en-AU`,{style:`currency`,currency:`AUD`,maximumFractionDigits:0}),te=new Intl.NumberFormat(`en-AU`,{style:`currency`,currency:`AUD`,minimumFractionDigits:2,maximumFractionDigits:2});function D(e){return ee.format(e||0)}function ne(e){return te.format(e||0)}function O(e){let t=Math.abs(e),n=t>=1e6?(t/1e6).toFixed(2)+`M`:t>=1e3?(t/1e3).toFixed(1)+`k`:t.toFixed(0);return(e<0?`-$`:`$`)+n}function k(e){if(!e)return`—`;let[t,n,r]=e.split(`-`);return`${r}/${n}/${t}`}function re(e){return e?new Date(e)<new Date:!1}function ie(e){return{daily:`/day`,weekly:`/wk`,fortnightly:`/fn`,monthly:`/mo`,quarterly:`/qtr`,annually:`/yr`,annual:`/yr`}[e]||`/mo`}function ae(e){return{daily:`Daily`,weekly:`Weekly`,fortnightly:`Fortnightly`,monthly:`Monthly`,quarterly:`Quarterly`,annually:`Annually`,annual:`Annually`,custom:`Custom`}[e]||`Monthly`}function A(e){return(e.frequency||`monthly`)===`custom`?`Every ${e.customEvery||1} ${e.customUnit||`weeks`}`:ae(e.frequency||`monthly`)}function oe(e){return(e.frequency||`monthly`)===`custom`?`/${e.customEvery||1}${e.customUnit===`months`?`mo`:`wk`}`:ie(e.frequency||`monthly`)}function j(t){let n=t.frequency||`monthly`;if(n===`custom`){let e=t.customEvery||1;return t.customUnit===`months`?(t.amount||0)/e:(t.amount||0)*52/(e*12)}return e(t.amount||0,n)}function M(e){return e.reduce((e,t)=>e+j(t),0)}function N(e){return e.length?Math.max(...e.map(e=>e.id))+1:1}function se(e){function t(e){if(!(!e||typeof e!=`object`))for(let n of Object.keys(e))typeof e[n]==`string`&&e[n].length>500?e[n]=e[n].slice(0,500):Array.isArray(e[n])?e[n].forEach(e=>t(e)):typeof e[n]==`object`&&e[n]!==null&&t(e[n])}t(e)}function ce(){let e=g.vehicles||[];if(e.length===0){document.getElementById(`vehicles-content`).innerHTML=`
      ...
      <div class="veh-card">
        <div class="veh-card-header">
          ...
          <div style="flex:1;min-width:0">
            <div class="veh-name">${T(e.name)}</div>
            ${e.plate?`<span class="veh-plate">${T(e.plate)}${e.state?` · `+e.state:``}</span>`:``}
          </div>
        ...
        <div class="veh-stat-grid">
          ...
          ${e.insurance&&e.insurance.provider?`<div class="veh-stat"><div class="veh-stat-label">Insurer</div><div class="veh-stat-value">${T(e.insurance.provider)}</div></div>`:``}
          <div class="veh-stat"><div class="veh-stat-label">Services (all time)</div><div class="veh-stat-value">${D(a)}</div></div>
          ${u>0?`<div class="veh-stat"><div class="veh-stat-label">Annual Cost</div><div class="veh-stat-value">${D(u)}</div></div>`:``}
          ${d>0?`<div class="veh-stat"><div class="veh-stat-label">Monthly Cost</div><div class="veh-stat-value">${D(d)}/mo</div></div>`:``}
        </div>

        ${c||l?`<div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:14px">
          ${c?`<span style="font-size:11px;color:#0369a1;cursor:pointer;font-weight:600" onclick="activateTab('bills')">Rego bill: ${D(parseFloat(c.amount)||0)} →</span>`:``}
          ${l?`<span style="font-size:11px;color:#0369a1;cursor:pointer;font-weight:600" onclick="activateTab('bills')">Insurance bill: ${D(parseFloat(l.amount)||0)} →</span>`:``}
          ...
          ${(e.services||[]).length===0?`<div style="padding:16px 20px;color:var(--text-muted);font-size:13px;text-align:center">No service records yet</div>`:`<div class="table-wrap"><table>
                ...
                <tbody>
                  ${[...e.services].sort((e,t)=>new Date(t.date)-new Date(e.date)).map(t=>`<tr>
                    ...
                    <td style="font-weight:500">${T(t.type||`—`)}</td>
                    <td>${t.odometer?t.odometer.toLocaleString()+` km`:`—`}</td>
                    <td style="color:var(--text-muted)">${T(t.provider||`—`)}</td>
                    <td class="amount">${t.cost?D(t.cost):`—`}</td>
                    <td><button class="btn btn-sm" style="color:var(--danger);font-size:11px" onclick="deleteService('${e.id}','${t.id}')">×</button></td>
                  </tr>`).join(``)}
                </tbody>
              </table></div>`}
        </div>
      </div>`}),document.getElementById(`vehicles-content`).innerHTML=t}function le(e){let t=e?(g.vehicles||[]).find(t=>t.id===e):null,n=!!t;document.getElementById(`modal-title`).textContent=n?`Edit ${t.name}`:`Add Vehicle`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
      <label class="form-label">Vehicle Name</label>
      <input class="form-input" id="vf-name" type="text" maxlength="200" value="${t?E(t.name):``}" placeholder="e.g. Mitsubishi Outlander">
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        <label class="form-label">Plate Number</label>
        <input class="form-input" id="vf-plate" type="text" maxlength="200" value="${t?E(t.plate||``):``}" placeholder="ABC123" style="text-transform:uppercase">
      </div>
      <div class="form-group">
    ...
    <div style="border-top:1px solid var(--border);padding-top:16px;margin-top:8px">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
        <div class="form-group">
          ...
          <input class="form-input" id="vf-ins-provider" type="text" maxlength="200" value="${t&&t.insurance?E(t.insurance.provider||``):``}" placeholder="e.g. AAMI">
        </div>
        <div class="form-group">
          <label class="form-label">Policy Number</label>
          <input class="form-input" id="vf-ins-policy" type="text" maxlength="200" value="${t&&t.insurance?E(t.insurance.policyNo||``):``}">
        </div>
      </div>
      <div class="form-group">
    ...
    <input class="doc-search" type="text" maxlength="200" placeholder="Search documents…" value="${_e}" oninput="_docSearch=this.value;renderDocuments()" style="margin:0 20px;width:calc(100% - 40px)">`,u={};n.forEach(e=>{let t=e.category||`Other`;u[t]||(u[t]=[]),u[t].push(e)}),ge.forEach(e=>{let n=u[e.key];!n||!n.length||(l+=`<div class="doc-cat-group">
      <div class="doc-cat-header">${e.icon} ${e.key} <span style="font-weight:400;text-transform:none">(${n.length})</span></div>`,n.sort((e,t)=>e.expiryDate&&t.expiryDate?new Date(e.expiryDate)-new Date(t.expiryDate):e.expiryDate?-1:1).forEach(n=>{let r=``;if(n.expiryDate){let e=Math.ceil((new Date(n.expiryDate)-t)/864e5);r=e<0?`<span class="veh-badge red" style="font-size:11px">Expired ${Math.abs(e)}d ago</span>`:e<=30?`<span class="veh-badge amber" style="font-size:11px">Expires in ${e}d</span>`:`<span class="veh-badge green" style="font-size:11px">${new Date(n.expiryDate).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`})}</span>`}let i=[n.provider?T(n.provider):``,n.reference?T(n.reference):``,n.storedAt?`📍 ${T(n.storedAt)}`:``].filter(Boolean);l+=`
        <div class="doc-card" onclick="openDocForm('${n.id}')">
          <div class="doc-cat-icon" style="background:${e.bg}">${e.icon}</div>
          <div class="doc-card-body">
            <div class="doc-card-name">${T(n.name)}</div>
            ${i.length?`<div class="doc-card-sub">${i.join(` · `)}</div>`:``}
          </div>
          ${r}
        </div>`}),l+=`</div>`)}),n.length,document.getElementById(`documents-content`).innerHTML=l}function be(e){let t=e?(g.documents||[]).find(t=>t.id===e):null,n=!!t;document.getElementById(`modal-title`).textContent=n?`Edit Document`:`Add Document`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
      <label class="form-label">Document Name</label>
      <input class="form-input" id="df-name" type="text" maxlength="200" value="${t?E(t.name):``}" placeholder="e.g. Home & Contents Insurance">
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        <label class="form-label">Category</label>
        <select class="form-select" id="df-cat">
          ${ge.map(e=>`<option value="${e.key}"${t&&t.category===e.key?` selected`:``}>${e.icon} ${e.key}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
        <label class="form-label">Provider / Issuer</label>
        <input class="form-input" id="df-provider" type="text" maxlength="200" value="${t?E(t.provider||``):``}" placeholder="e.g. AAMI, Medicare">
      </div>
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        <label class="form-label">Reference / Policy No.</label>
        <input class="form-input" id="df-ref" type="text" maxlength="200" value="${t?E(t.reference||``):``}" placeholder="POL-12345">
      </div>
      <div class="form-group">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      ...
      <div class="form-group">
        ...
        <input class="form-input" id="df-stored" type="text" maxlength="200" value="${t?E(t.storedAt||``):``}" placeholder="e.g. Filing cabinet, Google Drive, Email">
      </div>
    </div>
    <div class="form-group">
      <label class="form-label">Notes <span style="font-weight:400;color:var(--text-muted)">(optional)</span></label>
      <input class="form-input" id="df-notes" type="text" maxlength="200" value="${t?E(t.notes||``):``}" placeholder="e.g. $1000 excess, covers building + contents">
    </div>`,document.getElementById(`modal-footer`).innerHTML=`
    ${n?`<button class="btn" style="color:var(--danger);margin-right:auto" onclick="deleteDoc(${e})">Delete</button>`:``}
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    <button class="btn btn-primary" onclick="saveDoc(${e||`null`})">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function xe(e){let t=document.getElementById(`df-name`)?.value.trim();if(!t)return;let n={name:t,category:document.getElementById(`df-cat`)?.value||`Other`,provider:document.getElementById(`df-provider`)?.value.trim()||``,reference:document.getElementById(`df-ref`)?.value.trim()||``,expiryDate:document.getElementById(`df-expiry`)?.value||``,renewalCost:parseFloat(document.getElementById(`df-cost`)?.value)||0,storedAt:document.getElementById(`df-stored`)?.value.trim()||``,notes:document.getElementById(`df-notes`)?.value.trim()||``};if(e){let t=g.documents.find(t=>t.id===e);t&&Object.assign(t,n)}else n.id=g.documents.length?Math.max(...g.documents.map(e=>e.id))+1:1,g.documents.push(n);if(n.expiryDate&&n.renewalCost>0){g.bills||(g.bills=[]);let t=`doc_${e||n.id}`,r=g.bills.find(e=>e._docRef===t),i={name:`${n.name}${n.provider?` - `+n.provider:``}`,amount:n.renewalCost,category:n.category===`Vehicle`?`Insurance`:n.category,frequency:`Annual`,autopay:!1,startDate:n.expiryDate,_docRef:t};r?Object.assign(r,i):(i.id=uid(),g.bills.push(i))}window.saveData(g),window.closeModal(),window.renderAll()}function Se(e){if(!confirm(`Delete this document?`))return;let t=`doc_${e}`;g.bills=(g.bills||[]).filter(e=>e._docRef!==t),g.documents=g.documents.filter(t=>t.id!==e),window.saveData(g),window.closeModal(),window.renderAll()}var Ce=[{key:`HVAC`,icon:`❄️`},{key:`Plumbing`,icon:`🚿`},{key:`Electrical`,icon:`💡`},{key:`Garden`,icon:`🌿`},{key:`Cleaning`,icon:`🧹`},{key:`Safety`,icon:`🔥`},{key:`Appliance`,icon:`🔧`},{key:`Exterior`,icon:`🏠`},{key:`Other`,icon:`📋`}],we=[{name:`Gutters Cleaned`,category:`Exterior`,intervalNum:6,intervalUnit:`months`,icon:`🏠`},{name:`Smoke Alarm Batteries`,category:`Safety`,intervalNum:12,intervalUnit:`months`,icon:`🔥`},{name:`Pest Control`,category:`Exterior`,intervalNum:12,intervalUnit:`months`,icon:`🐛`},{name:`AC Filter Cleaned`,category:`HVAC`,intervalNum:3,intervalUnit:`months`,icon:`❄️`},{name:`Hot Water System Flush`,category:`Plumbing`,intervalNum:12,intervalUnit:`months`,icon:`🚿`},{name:`Lawn Mowing`,category:`Garden`,intervalNum:2,intervalUnit:`weeks`,icon:`🌿`},{name:`Oven Clean`,category:`Cleaning`,intervalNum:6,intervalUnit:`months`,icon:`🧹`},{name:`Pool Maintenance`,category:`Exterior`,intervalNum:1,intervalUnit:`months`,icon:`🏊`},{name:`Drains / Septic`,category:`Plumbing`,intervalNum:2,intervalUnit:`years`,icon:`🚿`},{name:`Roof Inspection`,category:`Exterior`,intervalNum:2,intervalUnit:`years`,icon:`🏠`}];function Te(e){if(!e.lastDone)return null;let t=new Date(e.lastDone),n=e.intervalNum||1,r=e.intervalUnit||`months`;return r===`days`?t.setDate(t.getDate()+n):r===`weeks`?t.setDate(t.getDate()+n*7):r===`months`?t.setMonth(t.getMonth()+n):r===`years`&&t.setFullYear(t.getFullYear()+n),t}function Ee(e){let t=Te(e);return t?Math.ceil((t-new Date)/864e5):null}function De(){let e=g.maintenance||[];if(e.length===0){let t=new Set(e.map(e=>e.name.toLowerCase())),n=we.filter(e=>!t.has(e.name.toLowerCase()));document.getElementById(`maintenance-content`).innerHTML=`
      <div class="empty" style="margin-top:24px">
        <div class="empty-icon">🔧</div>
        ...
        <div class="maint-starter">
          ${n.map((e,t)=>`
            <button class="maint-starter-btn" onclick="quickAddMaint(${t})">
              <div class="maint-starter-name">${e.icon} ${T(e.name)}</div>
              <div class="maint-starter-sub">Every ${e.intervalNum} ${e.intervalUnit}</div>
            </button>`).join(``)}
        </div>
      </div>`:``}`;return}let t=[...e].map(e=>{let t=Ee(e);return{...e,_days:t}}).sort((e,t)=>e._days===null&&t._days===null?0:e._days===null?1:t._days===null?-1:e._days-t._days),n=t.filter(e=>e._days!==null&&e._days<0).length,r=t.filter(e=>e._days!==null&&e._days>=0&&e._days<=14).length,i=`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap;gap:10px">
    ...
    </div>`;if(t.forEach(e=>{let t=e._days,n=`ok`,r=``;t===null?(n=`ok`,r=e.lastDone?`Last done ${new Date(e.lastDone).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`})}`:`Never done`):t<0?(n=`overdue`,r=`Overdue by ${Math.abs(t)} day${Math.abs(t)===1?``:`s`}`):t<=14?(n=`due-soon`,r=t===0?`Due today`:`Due in ${t} day${t===1?``:`s`}`):r=`Due ${Te(e).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}`;let a=Ce.find(t=>t.key===e.category)||Ce[Ce.length-1],o=e.intervalNum?`Every ${e.intervalNum} ${e.intervalUnit}`:``;i+=`
      <div class="maint-item ${n}">
        <div class="maint-row">
          <div class="maint-icon">${a.icon}</div>
          <div class="maint-body">
            <div class="maint-name">${T(e.name)}</div>
            <div class="maint-sub">${[r,o,e.provider?T(e.provider):``].filter(Boolean).join(` · `)}</div>
          </div>
        ...
        ${e.lastCost?`<div style="font-size:11px;color:var(--text-muted);margin-top:6px;padding-left:48px">Last cost: ${D(e.lastCost)}</div>`:``}
      </div>`}),e.length<3){let t=new Set(e.map(e=>e.name.toLowerCase())),n=we.filter(e=>!t.has(e.name.toLowerCase()));n.length&&(i+=`<div style="margin-top:20px">
      ...
      </div>`)}document.getElementById(`maintenance-content`).innerHTML=i}function Oe(e){let t=e?(g.maintenance||[]).find(t=>t.id===e):null,n=!!t;document.getElementById(`modal-title`).textContent=n?`Edit ${t.name}`:`Add Maintenance Item`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
      <label class="form-label">Item Name</label>
      <input class="form-input" id="mf-name" type="text" maxlength="200" value="${t?E(t.name):``}" placeholder="e.g. Gutters Cleaned, Pest Control">
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        <label class="form-label">Category</label>
      ...
      <div class="form-group">
        <label class="form-label">Provider</label>
        <input class="form-input" id="mf-provider" type="text" maxlength="200" value="${t?E(t.provider||``):``}" placeholder="e.g. Jim's Mowing, DIY">
      </div>
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      ...
      <div class="form-group">
        <label class="form-label">Notes <span style="font-weight:400;color:var(--text-muted)">(optional)</span></label>
        <input class="form-input" id="mf-notes" type="text" maxlength="200" value="${t?E(t.notes||``):``}">
      </div>
    </div>`,document.getElementById(`modal-footer`).innerHTML=`
    ${n?`<button class="btn" style="color:var(--danger);margin-right:auto" onclick="deleteMaint(${e})">Delete</button>`:``}
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    <button class="btn btn-primary" onclick="saveMaint(${e||`null`})">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function ke(e){let t=document.getElementById(`mf-name`)?.value.trim();if(!t)return;let n={name:t,category:document.getElementById(`mf-cat`)?.value||`Other`,provider:document.getElementById(`mf-provider`)?.value.trim()||``,intervalNum:parseInt(document.getElementById(`mf-interval-num`)?.value)||1,intervalUnit:document.getElementById(`mf-interval-unit`)?.value||`months`,lastDone:document.getElementById(`mf-last`)?.value||``,lastCost:parseFloat(document.getElementById(`mf-cost`)?.value)||0,notes:document.getElementById(`mf-notes`)?.value.trim()||``};if(e){let t=g.maintenance.find(t=>t.id===e);t&&Object.assign(t,n)}else n.id=g.maintenance.length?Math.max(...g.maintenance.map(e=>e.id))+1:1,g.maintenance.push(n);window.saveData(g),window.closeModal(),window.renderAll()}function Ae(e){confirm(`Delete this maintenance item?`)&&(g.maintenance=g.maintenance.filter(t=>t.id!==e),window.saveData(g),window.closeModal(),window.renderAll())}function je(e){let t=g.maintenance.find(t=>t.id===e);if(!t)return;let n=new Date().toISOString().slice(0,10);if(t.lastDone=n,t.lastCost>0){let e=n.slice(0,7),r=window.getMonthData(e),i=r.expenses.find(e=>(e.category||``).toLowerCase()===`other`&&(e.name||``).toLowerCase().includes(`maintenance`))||r.expenses.find(e=>(e.name||``).toLowerCase().includes(`maintenance`));if(!i&&(i={id:N(g.budget.expenses),name:`Home Maintenance`,amount:0,frequency:`monthly`,category:`Other`,dueDate:``,vendor:null},g.budget.expenses.push(i),window.isMonthCustomized(e))){let t=g.budget.months[e];i={...i,id:N(t.expenses)},t.expenses.push(i)}g.budget.actuals[e]||(g.budget.actuals[e]={});let a=window.getActualEntries(i.id,e);a.push({id:a.length?Math.max(...a.map(e=>e.id))+1:1,amount:t.lastCost,date:n,note:`${t.name}${t.provider?` - `+t.provider:``}`}),g.budget.actuals[e][i.id]=a}window.saveData(g),window.renderAll()}function Me(e){let t=we[e];if(!t)return;let n={id:g.maintenance.length?Math.max(...g.maintenance.map(e=>e.id))+1:1,name:t.name,category:t.category,provider:``,intervalNum:t.intervalNum,intervalUnit:t.intervalUnit,lastDone:``,lastCost:0,notes:``};g.maintenance.push(n),window.saveData(g),window.renderAll()}var Ne=[`Fridge`,`Freezer`,`Pantry`,`Fruit & Veg`,`Spices`,`Drinks`,`Cleaning`,`Other`],Pe=[{name:`Milk`,cat:`Fridge`},{name:`Eggs`,cat:`Fridge`},{name:`Cheese`,cat:`Fridge`},{name:`Butter`,cat:`Fridge`},{name:`Yoghurt`,cat:`Fridge`},{name:`Chicken breast`,cat:`Freezer`},{name:`Mince`,cat:`Freezer`},{name:`Fish fillets`,cat:`Freezer`},{name:`Frozen veg`,cat:`Freezer`},{name:`Pasta`,cat:`Pantry`},{name:`Rice`,cat:`Pantry`},{name:`Tinned tomatoes`,cat:`Pantry`},{name:`Olive oil`,cat:`Pantry`},{name:`Flour`,cat:`Pantry`},{name:`Sugar`,cat:`Pantry`},{name:`Bread`,cat:`Pantry`},{name:`Cereal`,cat:`Pantry`},{name:`Onions`,cat:`Fruit & Veg`},{name:`Potatoes`,cat:`Fruit & Veg`},{name:`Bananas`,cat:`Fruit & Veg`},{name:`Apples`,cat:`Fruit & Veg`},{name:`Salt`,cat:`Spices`},{name:`Pepper`,cat:`Spices`},{name:`Garlic`,cat:`Spices`}];function Fe(){let e=document.getElementById(`pantry-content`);if(!e)return;let t=g.meals.pantry||[];if(t.length===0){e.innerHTML=`
      <div class="empty" style="margin-top:24px">
      ...
      <div style="margin-top:20px">
        ...
        <div class="pantry-starter">
          ${Pe.map(e=>`<button class="pantry-starter-btn" onclick="quickAddPantry('${E(e.name)}','${e.cat}')">${T(e.name)}</button>`).join(``)}
        </div>
      </div>`;return}let n={};Ne.forEach(e=>n[e]=[]),t.forEach(e=>{n[Ne.includes(e.cat)?e.cat:`Other`].push(e)});let r=t.filter(e=>e.status===`need`).length,i=t.filter(e=>e.status===`low`).length,a=`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap;gap:10px">
      <div style="display:flex;gap:8px;flex-wrap:wrap">
    ...
    </div>`;if(Ne.forEach(e=>{let t=n[e];t.length&&(a+=`<div class="pantry-cat-header">${T(e)} (${t.length})</div>`,t.forEach(e=>{let t=e.status===`stocked`?`✓`:e.status===`low`?`!`:`✗`;e.status===`stocked`||e.status,a+=`<div class="pantry-item">
        <div class="pantry-status ${e.status}" onclick="cyclePantryStatus('${e.id}')" title="Tap to change">${t}</div>
        <div class="pantry-body">
          <div class="pantry-name">${T(e.name)}</div>
          ${e.qty?`<div class="pantry-meta">${T(e.qty)}</div>`:``}
        </div>
      ...
      </div>`}))}),t.length<10){let e=new Set(t.map(e=>e.name.toLowerCase())),n=Pe.filter(t=>!e.has(t.name.toLowerCase()));n.length&&(a+=`<div style="margin-top:20px">
        <div style="font-size:13px;font-weight:600;margin-bottom:8px">Quick-add more</div>
        <div class="pantry-starter">
          ${n.slice(0,12).map(e=>`<button class="pantry-starter-btn" onclick="quickAddPantry('${E(e.name)}','${e.cat}')">${T(e.name)}</button>`).join(``)}
        </div>
      </div>`)}e.innerHTML=a}function Ie(e){let t=(g.meals.pantry||[]).find(t=>t.id===e);t&&(t.status={stocked:`low`,low:`need`,need:`stocked`}[t.status]||`stocked`,window.saveData(g),Fe())}function Le(e){let t=e?(g.meals.pantry||[]).find(t=>t.id===e):null;document.getElementById(`modal-title`).textContent=t?`Edit Item`:`Add Pantry Item`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
      <label class="form-label">Item Name</label>
      <input class="form-input" id="pf-name" type="text" maxlength="200" value="${t?E(t.name):``}" placeholder="e.g. Pasta, Milk, Chicken">
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        <label class="form-label">Category</label>
        <select class="form-select" id="pf-cat">
          ${Ne.map(e=>`<option value="${e}"${t&&t.cat===e?` selected`:``}>${e}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
        <label class="form-label">Quantity <span style="font-weight:400;color:var(--text-muted)">(optional)</span></label>
        <input class="form-input" id="pf-qty" type="text" maxlength="200" value="${t?E(t.qty||``):``}" placeholder="e.g. 2 bags, 1L, 500g">
      </div>
    </div>
    <div class="form-group">
    ...
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    <button class="btn btn-primary" onclick="savePantryItem(${e||`null`})">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Re(e){let t=document.getElementById(`pf-name`)?.value.trim();if(!t)return;let n={name:t,cat:document.getElementById(`pf-cat`)?.value||`Other`,qty:document.getElementById(`pf-qty`)?.value.trim()||``,status:document.querySelector(`input[name="pf-status"]:checked`)?.value||`stocked`},r=g.meals.pantry;if(e){let t=r.find(t=>t.id===e);t&&Object.assign(t,n)}else n.id=r.length?Math.max(...r.map(e=>e.id))+1:1,r.push(n);window.saveData(g),window.closeModal(),Fe()}function ze(e){g.meals.pantry=(g.meals.pantry||[]).filter(t=>t.id!==e),window.saveData(g),Fe()}function Be(e,t){let n=g.meals.pantry;n.push({id:n.length?Math.max(...n.map(e=>e.id))+1:1,name:e,cat:t,qty:``,status:`stocked`}),window.saveData(g),Fe()}function Ve(){let e=(g.meals.pantry||[]).filter(e=>e.status===`need`||e.status===`low`);if(!e.length)return;g.lists||(g.lists={}),g.lists.food||(g.lists.food={items:[],weeklyBudget:200,budget:0,stores:[],favourites:[],history:[]});let t=g.lists.food.items,n={Fridge:`dairy`,Freezer:`frozen`,Pantry:`pantry`,"Fruit & Veg":`produce`,Spices:`pantry`,Drinks:`drinks`,Cleaning:`cleaning`,Other:`other`},r=0;e.forEach(e=>{t.some(t=>t.name.toLowerCase()===e.name.toLowerCase()&&t.state===`active`)||(t.push({id:`si-`+Date.now()+`-`+r,name:e.name,quantity:1,unit:`units`,notes:``,aisle:n[e.cat]||`other`,state:`active`,addedBy:`pantry`,addedAt:new Date().toISOString(),mealTag:`Pantry`,manualPrice:null,barcodeId:null}),r++)}),r>0&&(window.saveData(g),_listsActiveType=`food`,_listsView=`list`,activateTab(`lists`));let i=document.querySelector(`[onclick*="pantryToShoppingList"]`);if(i){let e=i.textContent;i.textContent=`Added ${r} items`,i.style.color=`var(--success)`,setTimeout(()=>{i.textContent=e,i.style.color=``},2e3)}}var He=[`Cash & Savings`,`Investments`,`Property`,`Superannuation`,`Vehicle`,`Other`],Ue=[`Mortgage`,`Car Loan`,`Credit Card`,`Personal Loan`,`HECS/HELP`,`Other`];function We(){let e=document.getElementById(`networth-content`);if(!e)return;let t=g.netWorth,n=t.assets||[],r=t.liabilities||[],i=t.snapshots||[],a=n.reduce((e,t)=>e+(parseFloat(t.value)||0),0),o=r.reduce((e,t)=>e+(parseFloat(t.value)||0),0),s=a-o,c=``;if(i.length>=2){let e=s-i[i.length-2].netWorth;c=`<span class="${e>=0?`up`:`down`}">${e>=0?`+`:``}${O(e)}</span> vs last snapshot`}if(!n.length&&!r.length){e.innerHTML=`
      <div style="background:#fff;border:2px dashed #cbd5e1;border-radius:16px;padding:36px 24px;margin-top:8px">
        <div style="display:flex;align-items:center;gap:16px;margin-bottom:20px">
          <div style="font-size:40px">📊</div>
          <div>
    ...
    <div class="nw-hero">
      ...
      <div class="nw-hero-amount ${s>=0?`positive`:`negative`}">${O(s)}</div>
      ${c?`<div class="nw-hero-change">${c}</div>`:``}
    </div>

    ${Ke(s)}
    ${r.some(e=>e.rate)?qe(r):``}
    ${i.length>1?Ze(i):``}
    ...
    <div class="nw-cols">
      <div class="nw-col-card assets">
        <div class="nw-col-header">
          ...
          <span class="nw-col-total">${O(a)}</span>
        </div>
        ${n.length?n.map(e=>Ge(e,`asset`)).join(``):`<div class="nw-empty">No assets yet</div>`}
      ...
      <div class="nw-col-card liabilities">
        <div class="nw-col-header">
          ...
          <span class="nw-col-total">${O(o)}</span>
        </div>
        ${r.length?r.map(e=>Ge(e,`liability`)).join(``):`<div class="nw-empty">No liabilities yet</div>`}
        <div class="nw-add-row">
  ...
  `}function Ge(e,t){let n=e.category||``;if(t===`liability`&&e.rate){let t=parseFloat(e.value)||0,r=parseFloat(e.rate),i=t*r/1200;n+=n?` · `:``,n+=`${r}% p.a. · $${Math.round(i).toLocaleString()}/mo interest`}return`
    <div class="nw-item">
      <div style="flex:1;min-width:0">
        <div class="nw-item-name">${T(e.name)}</div>
        ${n?`<div class="nw-item-cat">${n}</div>`:``}
      </div>
      <div class="nw-item-value">${O(parseFloat(e.value)||0)}</div>
    ...
    </div>`}function Ke(e){let t=g.netWorth.target||{},n=parseFloat(t.amount)||0,r=parseInt(t.byYear)||0,i=new Date().getFullYear();if(!n||!r)return`
    ...
    <div class="nw-target-card">
      ...
      <div style="display:flex;align-items:baseline;gap:8px;flex-wrap:wrap">
        <div class="nw-target-goal">${O(n)}</div>
      ...
      <div style="display:flex;justify-content:space-between;font-size:12px;color:#94a3b8;margin-bottom:14px">
        ...
        <span>${u?`🎉 Goal reached!`:O(o)+` to go`}</span>
      </div>
    ...
    </div>`}function Je(){let e=g.netWorth.target||{};document.getElementById(`nw-t-amount`).value=e.amount||``,document.getElementById(`nw-t-year`).value=e.byYear||``,document.getElementById(`nw-target-modal`).style.display=`flex`}function Ye(){document.getElementById(`nw-target-modal`).style.display=`none`}function Xe(){let e=parseFloat(document.getElementById(`nw-t-amount`).value),t=parseInt(document.getElementById(`nw-t-year`).value);!e||!t||(g.netWorth.target||(g.netWorth.target={}),g.netWorth.target.amount=e,g.netWorth.target.byYear=t,window.saveData(g),We(),Ye())}function Ze(e){let t=e.slice(-12),n=Math.max(...t.map(e=>Math.abs(e.netWorth)),1);return`
    ...
    </div>`}function Qe(){if(document.getElementById(`nw-modal`))return;let e=document.createElement(`div`);for(e.innerHTML=`
    ...
    </div>`;e.firstChild;)document.body.appendChild(e.firstChild)}function $e(e,t){Qe();let n=g.netWorth,r=e===`asset`?n.assets:n.liabilities,i=e===`asset`?He:Ue,a=t?r.find(e=>e.id===t):null,o=document.getElementById(`nw-modal`);if(!o)return;document.getElementById(`nw-modal-title`).textContent=(a?`Edit`:`Add`)+` `+(e===`asset`?`Asset`:`Liability`),document.getElementById(`nw-edit-id`).value=t||``,document.getElementById(`nw-edit-type`).value=e,document.getElementById(`nw-name`).value=a?a.name:``,document.getElementById(`nw-value`).value=a?a.value:``,document.getElementById(`nw-rate`).value=a&&a.rate?a.rate:``,document.getElementById(`nw-payment`).value=a&&a.monthlyPayment?a.monthlyPayment:``;let s=a?.category||i[0],c=document.getElementById(`nw-cat-wrap`);c&&(c.innerHTML=window.customSelect(`nw-cat`,i,s,e=>{_csStore[`nw-cat`].value=e}));let l=document.getElementById(`nw-debt-fields`);l&&(l.style.display=e===`liability`?`flex`:`none`),o.style.display=`flex`}function et(){let e=document.getElementById(`nw-modal`);e&&(e.style.display=`none`)}function tt(){let e=document.getElementById(`nw-name`).value.trim(),t=parseFloat(document.getElementById(`nw-value`).value),n=_csStore[`nw-cat`]?.value||``,r=document.getElementById(`nw-edit-type`).value,i=document.getElementById(`nw-edit-id`).value,a=parseFloat(document.getElementById(`nw-rate`).value)||0,o=parseFloat(document.getElementById(`nw-payment`).value)||0;if(!e||isNaN(t))return;let s=r===`asset`?g.netWorth.assets:g.netWorth.liabilities,c={name:e,value:t,category:n};if(r===`liability`&&(a&&(c.rate=a),o&&(c.monthlyPayment=o)),i){let e=s.findIndex(e=>e.id===i);e!==-1&&(s[e]={...s[e],...c})}else s.push({id:uid(),...c});window.saveData(g),et(),We()}function nt(e,t){let n=e===`asset`?g.netWorth.assets:g.netWorth.liabilities,r=n.findIndex(e=>e.id===t);r!==-1&&(n.splice(r,1),window.saveData(g),We())}function rt(){let e=g.netWorth,t=(e.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0)-(e.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),n=new Date().toISOString().slice(0,10);e.snapshots||(e.snapshots=[]);let r=e.snapshots.findIndex(e=>e.date===n),i={date:n,netWorth:t,assets:(e.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),liabilities:(e.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0)};r===-1?e.snapshots.push(i):e.snapshots[r]=i,window.saveData(g),We()}function P(e){return window._secureGet(e)}function it(e,t){window._secureSet(e,t)}function at(e){window._secureClear(e)}var ot=[{label:`Streaming`,icon:`📺`},{label:`Music`,icon:`🎵`},{label:`Software`,icon:`💻`},{label:`Fitness`,icon:`💪`},{label:`Gaming`,icon:`🎮`},{label:`News`,icon:`📰`},{label:`Insurance`,icon:`🛡️`},{label:`Education`,icon:`📚`},{label:`Other`,icon:`📦`}];function st(e){let t=ot.find(t=>t.label===e);return t?t.icon:`📦`}function ct(e){let t=parseFloat(e.amount)||0;return e.frequency===`Annual`?t/12:e.frequency===`Weekly`?t*52/12:t}var lt=[],ut=new Set;Object.defineProperty(window,`_subImportResults`,{get(){return lt},set(e){lt=e},configurable:!0}),Object.defineProperty(window,`_subImportDismissed`,{get(){return ut},set(e){ut=e},configurable:!0});function dt(e){let t=e.map(e=>`
    <div class="sub-result-row">
      <div class="sub-result-icon">${st(e.category)}</div>
      <div class="sub-result-info">
        <div class="sub-result-name">${T(e.name)}</div>
        <div class="sub-result-meta">${T(e.category)} · ${e.frequency} · ${T(e.description||``)}</div>
      </div>
    ...
    ${t}
  </div>`}function ft(e){let t=e?(g.subscriptions||[]).find(t=>t.id===e):null;document.getElementById(`sub-modal-title`).textContent=t?`Edit Subscription`:`Add Subscription`,document.getElementById(`sub-edit-id`).value=e||``,document.getElementById(`sub-name`).value=t?t.name:``,document.getElementById(`sub-cat`).value=t&&t.category||`Streaming`,document.getElementById(`sub-freq`).value=t&&t.frequency||`Monthly`,document.getElementById(`sub-amount`).value=t?t.amount:``,document.getElementById(`sub-renewal`).value=t&&t.renewalDate||``,document.getElementById(`sub-modal`).style.display=`flex`}function pt(){document.getElementById(`sub-modal`).style.display=`none`}function mt(){let e=document.getElementById(`sub-name`).value.trim(),t=parseFloat(document.getElementById(`sub-amount`).value),n=document.getElementById(`sub-cat`).value,r=document.getElementById(`sub-freq`).value,i=document.getElementById(`sub-renewal`).value,a=document.getElementById(`sub-edit-id`).value;if(!e||isNaN(t))return;g.subscriptions||(g.subscriptions=[]);let o={name:e,amount:t,category:n,frequency:r,renewalDate:i};if(a){let e=g.subscriptions.findIndex(e=>e.id===a);e!==-1&&(g.subscriptions[e]={...g.subscriptions[e],...o})}else g.subscriptions.push({id:uid(),...o});window.saveData(g),pt(),renderSubscriptions()}function ht(e){g.subscriptions=(g.subscriptions||[]).filter(t=>t.id!==e),window.saveData(g),renderSubscriptions()}async function gt(e){let t=e.target.files[0];if(!t)return;let n=P(`toto_ai_key`),r=document.getElementById(`sub-import-status`);if(!n){r&&(r.textContent=`⚠ Please enter your Anthropic API key above first.`,r.style.display=``);return}let i=(await t.text()).split(`
...
If nothing new found, return [].`;try{let t=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":n,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:o}]})});if(!t.ok)throw Error(`API error ${t.status}`);let i=(await t.json()).content[0].text.trim().match(/\[[\s\S]*\]/);if(!i)throw Error(`No JSON found in response`);lt=JSON.parse(i[0]).map((e,t)=>({...e,_key:`import_${Date.now()}_${t}`})),ut=new Set,r&&(r.style.display=`none`),e.target.value=``,renderSubscriptions()}catch(e){r&&(r.textContent=`⚠ ${e.message}`,r.style.display=``)}}function _t(e,t){let n=lt.find(t=>t._key===e);if(n){if(t===`subscription`)g.subscriptions||(g.subscriptions=[]),g.subscriptions.push({id:uid(),name:n.name,amount:n.amount,category:n.category,frequency:n.frequency}),window.saveData(g);else{let e=window.ensureMonthOverride(window.selectedBudgetMonth);e.expenses.push({id:N(e.expenses),name:n.name,amount:n.amount,frequency:`monthly`,category:`Subscriptions`,recurring:!0}),window.saveData(g)}ut.add(e),renderSubscriptions()}}function vt(e){ut.add(e),renderSubscriptions()}var yt=[{label:`Mortgage / Rent`,icon:`🏠`},{label:`Electricity`,icon:`⚡`},{label:`Gas`,icon:`🔥`},{label:`Water`,icon:`💧`},{label:`Internet`,icon:`📡`},{label:`Phone`,icon:`📱`},{label:`Insurance`,icon:`🛡️`},{label:`Car Registration`,icon:`🚗`},{label:`Rates & Taxes`,icon:`🏛️`},{label:`Loan Repayment`,icon:`💳`},{label:`Education`,icon:`📚`},{label:`Subscriptions`,icon:`📺`},{label:`Health`,icon:`🏥`},{label:`Other`,icon:`📦`}],bt=[`Monthly`,`Fortnightly`,`Weekly`,`Quarterly`,`Annually`];function xt(e){let t=yt.find(t=>t.label===e);return t?t.icon:`📦`}function St(e){if(e<0)return`<span class="bill-due-badge overdue">Overdue ${Math.abs(e)}d</span>`;if(e===0)return`<span class="bill-due-badge today">Due today</span>`;if(e<=7)return`<span class="bill-due-badge soon">Due in ${e}d</span>`;let t=new Date;return t.setDate(t.getDate()+e),`<span class="bill-due-badge ok">${t.toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}</span>`}function Ct(e){return(parseFloat(e.amount)||0)*({Weekly:52/12,Fortnightly:26/12,Monthly:1,Quarterly:1/3,Annually:1/12}[e.frequency||`Monthly`]||1)}function wt(){let e=document.getElementById(`bills-content`);if(!e)return;let r=g.bills||[],i=g.subscriptions||[],a=window._billsSubsFilter,o=`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>`,s=`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4h6v2"/></svg>`,c=r.reduce((e,t)=>e+Ct(t),0)+i.reduce((e,t)=>e+subMonthlyAmount(t),0),l=r.filter(e=>n(e)<0).length,u=r.filter(e=>{let t=n(e);return t>=0&&t<=7}).length,d=new Date;d.setHours(0,0,0,0);let f=[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`],p=Array.from({length:14},(e,n)=>{let i=new Date(d);i.setDate(i.getDate()+n);let a=r.filter(e=>t(e).toDateString()===i.toDateString()),o=[i.toDateString()===d.toDateString()&&`today`,a.length&&`has-bill`].filter(Boolean).join(` `);return`<div class="bills-day" title="${a.map(e=>e.name).join(`, `)}">
    ...
    </div>`}function h(e){let t=subMonthlyAmount(e),n=e.frequency===`Annual`?`$${parseFloat(e.amount).toLocaleString()}/yr`:e.frequency===`Weekly`?`$${parseFloat(e.amount).toFixed(2)}/wk`:`$${parseFloat(e.amount).toFixed(2)}/mo`,r=e.renewalDate?` · Renews ${e.renewalDate}`:``;return`<div class="bill-row">
      <div class="bill-icon">${subCatIcon(e.category)}</div>
      <div class="bill-info">
        <div class="bill-name">${T(e.name)}<span style="font-size:10px;font-weight:700;padding:1px 6px;border-radius:99px;background:#ede9fe;color:#5b21b6;margin-left:6px">SUB</span></div>
    ...
    </div>`}let _=[...r].sort((e,t)=>n(e)-n(t)),v=_.filter(e=>n(e)<0),y=_.filter(e=>{let t=n(e);return t>=0&&t<=7}),b=_.filter(e=>{let t=n(e);return t>7&&t<=31}),x=_.filter(e=>n(e)>31),S=a===`all`||a===`bills`,C=a===`all`||a===`subs`,w=window._subImportResults.filter(e=>!window._subImportDismissed.has(e._key));e.innerHTML=`
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
            <div>
              ...
              <select id="sub-cat" class="form-select" style="width:100%">
                ${ot.map(e=>`<option value="${e.label}">${e.icon} ${e.label}</option>`).join(``)}
              </select>
            </div>
            <div>
    ...
    </div>`}function Tt(e){window._billsSubsFilter=e,wt()}function Et(){wt()}function Dt(e){let t=e?(g.bills||[]).find(t=>t.id===e):null,n=yt.map(e=>`<option value="${e.label}" ${t&&t.category===e.label?`selected`:``}>${e.icon} ${e.label}</option>`).join(``),r=bt.map(e=>`<option value="${e}" ${t&&t.frequency===e||(!t||!t.frequency)&&e===`Monthly`?`selected`:``}>${e}</option>`).join(``),i=`width:100%;border:1px solid var(--border);border-radius:var(--r-sm);padding:9px 12px;font-size:14px;outline:none`,a=`font-size:12px;font-weight:600;color:var(--text-muted);display:block;margin-bottom:5px`;return`
      ...
      <div style="background:var(--paper);border-radius:var(--r-lg);padding:28px;width:100%;max-width:440px;box-shadow:0 20px 60px rgba(0,0,0,0.2);max-height:90vh;overflow-y:auto">
        ...
        <div style="display:flex;flex-direction:column;gap:14px">
          <div>
            ...
            <input id="bill-name" type="text" maxlength="200" placeholder="e.g. AGL Electricity" style="${i}" value="${t?E(t.name):``}">
          </div>
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
            <div>
    ...
    </div>`}function Ot(e){let t=e?(g.bills||[]).find(t=>t.id===e):null;wt();let n=document.getElementById(`bill-modal`);n&&(document.getElementById(`bill-modal-title`).textContent=t?`Edit Bill`:`Add Bill`,document.getElementById(`bill-edit-id`).value=e||``,t&&(document.getElementById(`bill-name`).value=t.name||``,document.getElementById(`bill-cat`).value=t.category||yt[0].label,document.getElementById(`bill-freq`).value=t.frequency||`Monthly`,document.getElementById(`bill-amount`).value=t.amount||``,document.getElementById(`bill-day`).value=t.dueDay||``,document.getElementById(`bill-start`).value=t.startDate||``,document.getElementById(`bill-autopay`).checked=!!t.autopay),At(),n.style.display=`flex`)}function kt(){let e=document.getElementById(`bill-modal`);e&&(e.style.display=`none`)}function At(){let e=document.getElementById(`bill-freq`)?.value,t=document.getElementById(`bill-day-wrap`),n=document.getElementById(`bill-start-wrap`);if(!t||!n)return;let r=e===`Monthly`;t.style.display=r?`block`:`none`,n.style.display=r?`none`:`block`}function jt(){let e=document.getElementById(`bill-name`).value.trim(),t=parseFloat(document.getElementById(`bill-amount`).value),n=document.getElementById(`bill-cat`).value,r=document.getElementById(`bill-freq`).value,i=parseInt(document.getElementById(`bill-day`).value)||null,a=document.getElementById(`bill-start`).value||null,o=document.getElementById(`bill-autopay`).checked,s=document.getElementById(`bill-edit-id`).value;if(!e||isNaN(t))return;let c={name:e,amount:t,category:n,frequency:r,autopay:o};if(r===`Monthly`?c.dueDay=i:c.startDate=a,g.bills||(g.bills=[]),s){let e=g.bills.findIndex(e=>e.id===s);e!==-1&&(g.bills[e]={...g.bills[e],...c})}else g.bills.push({id:uid(),...c});window.saveData(g),kt(),wt()}function Mt(e){g.bills=(g.bills||[]).filter(t=>t.id!==e),window.saveData(g),wt()}function Nt(e){let t=(g.bills||[]).find(t=>t.id===e);t&&(t.lastPaid=new Date().toISOString().slice(0,10),window.saveData(g),wt())}function Pt(e,t){if(!e)return!0;let{type:n,days:r,intervalDays:i,startDate:a,endDate:o}=e;if(a&&t<a||o&&t>o)return!1;let s=new Date(t+`T12:00:00`),c=s.getDay();switch(n){case`daily`:return!0;case`weekdays`:return c>=1&&c<=5;case`weekends`:return c===0||c===6;case`specific_days`:return Array.isArray(r)&&r.includes(String(c));case`interval`:{if(!a||!i)return!1;let e=new Date(a+`T12:00:00`),t=Math.round((s-e)/864e5);return t>=0&&t%i===0}case`one_time`:return t===a;default:return!0}}var F={work:{label:`Work`,emoji:`💼`,color:`#dbeafe`,text:`#1e40af`,financial:!1},study:{label:`Study`,emoji:`📚`,color:`#fef3c7`,text:`#92400e`,financial:!1},social:{label:`Social`,emoji:`🎉`,color:`#ede9fe`,text:`#5b21b6`,financial:!0},family:{label:`Family`,emoji:`👨‍👩‍👧`,color:`#fce7f3`,text:`#9d174d`,financial:!1},travel:{label:`Travel`,emoji:`✈️`,color:`#e0f2fe`,text:`#075985`,financial:!0},health:{label:`Health`,emoji:`🏥`,color:`#fef2f2`,text:`#991b1b`,financial:!0},finance:{label:`Finance`,emoji:`💰`,color:`#ecfeff`,text:`#155e75`,financial:!0},home:{label:`Home`,emoji:`🏠`,color:`#ecfeff`,text:`#166534`,financial:!0},school:{label:`School`,emoji:`🏫`,color:`#fff7ed`,text:`#9a3412`,financial:!0},other:{label:`Other`,emoji:`📦`,color:`#f1f5f9`,text:`#475569`,financial:!1}},Ft=new Date().toISOString().slice(0,7),It=new Date().toISOString().slice(0,10),Lt=new Set,Rt=`week`,zt=new Set,Bt={"life-areas":!1,nudge:!1},Vt=!1,Ht=null;Object.defineProperty(window,`_plannerMonth`,{get(){return Ft},set(e){Ft=e},configurable:!0}),Object.defineProperty(window,`_plannerSelectedDay`,{get(){return It},set(e){It=e},configurable:!0}),Object.defineProperty(window,`_plannerView`,{get(){return Rt},set(e){Rt=e},configurable:!0}),Object.defineProperty(window,`_plannerDetailEvId`,{get(){return Ht},set(e){Ht=e},configurable:!0}),Object.defineProperty(window,`_typeADimsExpanded`,{get(){return Vt},set(e){Vt=e},configurable:!0}),window._plannerExpanded=Lt,window._plannerFilterMembers=zt,window._plannerCollapseState=Bt;var Ut=[{dot:`#2563eb`,bg:`#dbeafe`,text:`#1e40af`},{dot:`#db2777`,bg:`#fce7f3`,text:`#9d174d`},{dot:`#d97706`,bg:`#fef3c7`,text:`#92400e`},{dot:`#7c3aed`,bg:`#ede9fe`,text:`#5b21b6`},{dot:`#16a34a`,bg:`#dcfce7`,text:`#166534`},{dot:`#0891b2`,bg:`#ecfeff`,text:`#155e75`},{dot:`#ea580c`,bg:`#ffedd5`,text:`#9a3412`},{dot:`#be185d`,bg:`#fdf2f8`,text:`#831843`}];function Wt(){let e=g.householdProfile?.members||[],t=g.kids?.profiles||[],n=[],r=0;return e.forEach((e,t)=>{let i=Ut[r%Ut.length];e.role===`adult`&&e.name&&(n.push({id:`adult-`+t,name:e.name,emoji:e.emoji||`🧑`,...i}),r++)}),t.forEach((e,t)=>{let i=Ut[r%Ut.length];n.push({id:e.id||`kid-`+t,name:e.name,emoji:e.emoji||`🧒`,...i}),r++}),n.length===0&&n.push({id:`adult-0`,name:`Everyone`,emoji:`👨‍👩‍👧`,...Ut[0]}),n}function Gt(e){return!e||e===`everyone`?{id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`}:Wt().find(t=>t.id===e)||{id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`}}function Kt(e){return Array.isArray(e.memberIds)?e.memberIds:e.memberId?[e.memberId]:[`everyone`]}function qt(e){return Gt(Kt(e).find(e=>e!==`everyone`)||`everyone`)}function Jt(e){let t=Kt(e);return t.includes(`everyone`)||t.length===0?`Everyone`:t.map(e=>Gt(e).name).join(`, `)}function Yt(e){if(e.recurrence&&e.recurrence.type&&e.recurrence.type!==`one_time`){let t={daily:`Every day`,weekdays:`Mon–Fri`,weekends:`Sat & Sun`};if(t[e.recurrence.type])return t[e.recurrence.type];if(e.recurrence.type===`specific_days`)return(e.recurrence.days||[]).map(e=>[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`][e]).join(`, `)||`Specific days`;if(e.recurrence.type===`interval`)return`Every ${e.recurrence.intervalDays} days`}return e.recurring&&e.recurring!==`none`?{weekly:`Every week`,fortnightly:`Every 2 weeks`,monthly:`Every month`,quarterly:`Every 3 months`,yearly:`Annually`}[e.recurring]||e.recurring:``}function Xt(){let e=g.planner?.events||[];return zt.size===0?e:e.filter(e=>{let t=Kt(e);return t.includes(`everyone`)?!0:[...zt].some(e=>t.includes(e))})}function Zt(e){return Xt().filter(t=>t._recurringSourceId?t.date===e:t.recurrence&&t.recurrence.type!==`one_time`?Pt(t.recurrence,e):t.endDate&&t.endDate>t.date?e>=t.date&&e<=t.endDate:t.date===e)}function Qt(e){if(!e)return``;let[t,n]=e.split(`:`).map(Number);return`${t%12||12}:${String(n).padStart(2,`0`)}${t>=12?`pm`:`am`}`}var $t=new Date().toISOString().slice(0,7);function en(){let[e,t]=$t.split(`-`).map(Number),n=new Date(e,t-2,1);$t=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,renderForecast()}function tn(){let[e,t]=$t.split(`-`).map(Number),n=new Date(e,t,1);$t=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,renderForecast()}function nn(){let e=document.getElementById(`forecast-content`);if(!e)return;let t=(g.planner?.events||[]).filter(e=>e.date&&e.date.startsWith($t)),n=window.getMonthData($t),r=M(n.income)-M(n.expenses),[i,a]=$t.split(`-`).map(Number),o=new Date(i,a,0).getDate(),s=[],c=1;for(;c<=o;){new Date(i,a-1,c);let e=c;for(;e<o&&new Date(i,a-1,e+1).getDay()!==1;)e++;s.push({start:c,end:e,events:[]}),c=e+1}t.sort((e,t)=>e.date.localeCompare(t.date)).forEach(e=>{let t=parseInt(e.date.split(`-`)[2]),n=s.find(e=>t>=e.start&&t<=e.end);n&&n.events.push(e)}),t.filter(e=>e.estimates&&e.estimates.length>0);let l=t.filter(e=>!e.estimates||e.estimates.length===0),u=t.reduce((e,t)=>e+(t.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0),0),d=r-u,f=new Date(i,a-1).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`}),p=!!P(`toto_ai_key`),m=`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;flex-wrap:wrap;gap:12px">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:12px;margin-bottom:24px">
      <div style="background:var(--surface2);border-radius:var(--radius);padding:16px 18px">
        ...
        <div style="font-size:22px;font-weight:800;color:var(--danger)">${D(u)}</div>
      </div>
      <div style="background:var(--surface2);border-radius:var(--radius);padding:16px 18px">
        ...
        <div style="font-size:22px;font-weight:800;color:${r>=0?`var(--success)`:`var(--danger)`}">${D(Math.abs(r))}</div>
      </div>
      <div style="background:var(--surface2);border-radius:var(--radius);padding:16px 18px">
        ...
        <div style="font-size:22px;font-weight:800;color:${d>=0?`var(--success)`:`var(--danger)`}">${d>=0?``:`-`}${D(Math.abs(d))}</div>
      </div>
      <div style="background:var(--surface2);border-radius:var(--radius);padding:16px 18px">
      ...
      <div class="section" style="margin-bottom:16px">
        <div class="section-header">
          ...
          <span style="font-size:15px;font-weight:700;color:${n>0?`var(--danger)`:`var(--text-muted)`}">${n>0?D(n):`No estimates`}</span>
        </div>
          ...
          <table>
            ...
            <tbody>
              ${e.events.map(e=>{let t=F[e.category]||F.other,n=(e.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0),r=new Date(e.date+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`short`,day:`numeric`}),i=e.estimates&&e.estimates.length>0;return`<tr>
                  ...
                  <td style="font-weight:500">${T(e.title)}</td>
                  ...
                  <td class="amount" style="font-weight:600;${i?``:`color:var(--text-muted)`}">${i?D(n):`—`}</td>
                  <td style="text-align:right">
                    ${i?`<details style="font-size:11px;color:var(--text-muted)"><summary style="cursor:pointer">breakdown</summary>
                          <div style="padding:4px 0">${e.estimates.filter(e=>e.accepted).map(e=>`<div style="display:flex;justify-content:space-between;gap:12px;padding:2px 0"><span>${T(e.name)}</span><span>${D(e.amount)}</span></div>`).join(``)}</div>
        ...
        <div style="padding:16px 20px">
          ${_.map(([e,t])=>{let n=u>0?t/u*100:0;return`<div style="margin-bottom:12px">
              <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:4px">
                ...
                <span style="font-weight:600">${D(t)} <span style="font-weight:400;color:var(--text-muted)">${Math.round(n)}%</span></span>
              </div>
      ...
      </div>`),e.innerHTML=m}async function rn(){let e=P(`toto_ai_key`);if(!e)return;let t=(g.planner?.events||[]).filter(e=>e.date&&e.date.startsWith($t)&&(!e.estimates||e.estimates.length===0));if(!t.length)return;let n=document.getElementById(`estimate-all-btn`);n&&(n.textContent=`⏳ Estimating…`,n.disabled=!0);let r=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`).length||2,i=(g.householdProfile?.members||[]).filter(e=>e.role===`child`).length||0,a=t.map(e=>({id:e.id,title:e.title,category:(F[e.category]||F.other).label,date:e.date,notes:e.notes||``})),o=`You are a family finance assistant for an Australian family (${r} adult${r>1?`s`:``}, ${i} child${i===1?``:`ren`}).
...
- No markdown, no code fences, just raw JSON`;try{let t=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":e,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:4096,messages:[{role:`user`,content:o}]})});if(!t.ok)throw Error(`API ${t.status}`);let n=(await t.json()).content[0].text.replace(/```[\w]*\n?/g,``).trim().match(/\[[\s\S]*\]/);if(!n)throw Error(`No JSON`);JSON.parse(n[0]).forEach(e=>{let t=(g.planner?.events||[]).find(t=>t.id===e.id);t&&e.items&&(t.estimates=e.items.map((e,t)=>({id:`est-${Date.now()}-${t}`,name:e.name,amount:Number(e.amount)||0,category:e.category||`Other`,accepted:!0})))}),window.saveData(g),nn()}catch(e){n&&(n.textContent=`Estimate all (${t.length} events)`,n.disabled=!1),console.error(`Batch estimate error:`,e)}}function I(){let e=document.getElementById(`planner-content`);if(!e)return;g.planner||(g.planner={events:[]});let t=new Date().toISOString().slice(0,10),n=Wt(),r={id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`},i=[...n,r],a=i.map(e=>e.name[0].toUpperCase()),o=i.map((e,t)=>{if(e.id===`everyone`)return`👨‍👩‍👧`;let n=e.name[0].toUpperCase();return a.filter(e=>e===n).length>1?(e.name[0]+(e.name[1]||``)).toUpperCase():n}),s=i.map((e,t)=>{let n=e.id===`everyone`,r=n?window._plannerFilterMembers.size===0:window._plannerFilterMembers.has(e.id),i=!r&&window._plannerFilterMembers.size>0&&!n,a=n?`<span style="font-size:14px">👨‍👩‍👧</span>`:`<span>${o[t]}</span>`;return`<div class="pl-legend-chip ${r?`active`:``} ${i?`dimmed`:``}"
      onclick="_plannerToggleFilter('${e.id}')">
      <div class="pl-chip-avatar" style="background:${e.bg};color:${e.text}">${a}</div>
      <span>${e.name}</span>
    </div>`}).join(``),c=``;c=_plannerView===`month`?an():on();let l=new Date;l.setDate(l.getDate()+30);let u=l.toISOString().slice(0,10),d=Xt().filter(e=>e.date>=t&&e.date<=u),f=0,p=Object.entries(F).map(([e,t])=>{let n=d.filter(t=>t.category===e);n.length&&(f+=n.length);let r=n[0],i=r?T(r.title)+(r.date?` · ${new Date(r.date+`T12:00:00`).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}`:``):`Nothing planned`;return`<div class="pl-life-tile" onclick="_plannerOpenLifeSheet('${e}')">
    ...
    </div>`}).join(``),m=Pn(),h=m.map(e=>{let t=e.days<0?`Now!`:e.days===0?`Today!`:e.days===1?`Tomorrow`:`In ${e.days} days`,n=e.days<=0?`var(--alert)`:e.days===1?`var(--good)`:e.days<=3?`var(--watch)`:`var(--iris-1)`;return`<div class="pl-nudge-tile">
      <div class="pl-nudge-tile-icon" style="background:${e.days<=0?`var(--alert-light)`:e.days===1?`var(--good-light)`:e.days<=3?`var(--watch-light)`:`var(--purple-tint)`}">${e.emoji}</div>
      <div class="pl-nudge-tile-body">
        <div class="pl-nudge-tile-title">${T(e.title)}</div>
        <div class="pl-nudge-tile-sub">${T(e.body)}</div>
      </div>
      <div class="pl-nudge-tile-day" style="color:${n}">${t}</div>
    </div>`}).join(``),_=_plannerCollapseState[`life-areas`],v=_plannerCollapseState.nudge,y=t.slice(0,7);new Date().toLocaleDateString(`en-AU`,{weekday:`long`,month:`long`,day:`numeric`}),e.innerHTML=`
      ...
      <div class="pl-control-tile">
        <div class="pl-sub-bar">
          <div class="pl-view-toggle">
            <button class="pl-view-btn ${_plannerMonth===y&&_plannerSelectedDay===t?`active`:``}" onclick="_plannerGoToday()">Today</button>
    ...
    </div>`}function an(){let[e,t]=_plannerMonth.split(`-`).map(Number),n=new Date().toISOString().slice(0,10),r=new Date(e,t-1,1).getDay(),i=r===0?6:r-1,a=new Date(e,t,0).getDate(),o=new Date(e,t-1,0).getDate(),s=[];for(let n=i-1;n>=0;n--){let r=o-n,i=t-1||12,a=i===12?e-1:e;s.push({dateStr:`${a}-${String(i).padStart(2,`0`)}-${String(r).padStart(2,`0`)}`,day:r,muted:!0})}for(let n=1;n<=a;n++)s.push({dateStr:`${e}-${String(t).padStart(2,`0`)}-${String(n).padStart(2,`0`)}`,day:n,muted:!1});let c=s.length%7==0?0:7-s.length%7;for(let n=1;n<=c;n++){let r=t+1>12?1:t+1,i=r===1?e+1:e;s.push({dateStr:`${i}-${String(r).padStart(2,`0`)}-${String(n).padStart(2,`0`)}`,day:n,muted:!0})}return`<div class="pl-month-grid">${s.map(e=>{let t=e.dateStr===n,r=e.dateStr===_plannerSelectedDay,i=e.dateStr?Zt(e.dateStr):[],a=[...new Set(i.flatMap(e=>Kt(e)))].filter(e=>e!==`everyone`).slice(0,3).map(e=>`<div class="pl-cell-dot" style="background:${Gt(e).dot}"></div>`).join(``),o=i.length>3?`<div style="font-size:8px;color:var(--text-muted);font-weight:600">+</div>`:``;return`<div class="pl-cal-cell ${e.muted?`muted`:``} ${t?`today`:``} ${r?`selected`:``}"
                 onclick="_plannerSelectDay('${e.dateStr}')">
      <div class="pl-cell-num">${e.day}</div>
      <div class="pl-cell-dots">${a}${o}</div>
    </div>`}).join(``)}</div>`}function on(){let e=new Date(_plannerSelectedDay+`T12:00:00`),t=e.getDay(),n=new Date(e);n.setDate(e.getDate()-(t===0?6:t-1));let r=new Date().toISOString().slice(0,10),i=[`S`,`M`,`T`,`W`,`T`,`F`,`S`];return`<div class="week-strip">${Array.from({length:7},(e,t)=>{let r=new Date(n);return r.setDate(n.getDate()+t),{date:r,dateStr:r.toISOString().slice(0,10)}}).map(({date:e,dateStr:t})=>{let n=t===r,a=t===_plannerSelectedDay,o=Zt(t),s=o.length>0,c=[...new Set(o.flatMap(e=>Kt(e)))].filter(e=>e!==`everyone`).slice(0,3),l=a?`rgba(255,255,255,0.6)`:c.length?Gt(c[0]).dot:`#C4C2D4`;return`<div class="${a?`ws-day selected`+(n?` today-outline`:``):n?`ws-day today-outline`:`ws-day`}${s?` has`:``}" onclick="_plannerSelectDay('${t}')">
      <div class="ws-init">${i[e.getDay()]}</div>
      <div class="ws-num">${e.getDate()}</div>
      <div class="ws-dot" style="${s?`background:${l}`:``}"></div>
    </div>`}).join(``)}</div>`}function sn(e){let t=F[e.category]||F.other,n=_plannerExpanded.has(e.id),r=e.estimates||[],i=r.filter(e=>e.accepted),a=i.reduce((e,t)=>e+(t.amount||0),0),o=r.reduce((e,t)=>e+(t.amount||0),0),s=e.pushed?`<span class="planner-pushed-badge">✓ In budget</span>`:r.length>0?`<span style="font-size:12px;color:var(--text-muted)">$${a.toLocaleString(`en-AU`)}</span>`:``,c=Yt(e);c&&(s=`<span class="recurring-badge">🔄 ${c}</span> `+s);let l=``;return n&&(l=`<div class="planner-event-body">`,e.notes&&(l+=`<p class="planner-notes">${T(e.notes)}</p>`),r.length>0?(l+=r.map(t=>`
        <div class="planner-estimate-row">
          ...
          <div class="planner-estimate-name"><div>${T(t.name)}</div><div class="planner-estimate-cat">${T(t.category)}</div></div>
    ...
    <div class="planner-event-header" onclick="togglePlannerCard('${e.id}')">
      ...
      <div class="planner-event-meta">
        <div class="planner-event-title">${T(e.title)}</div>
    ...
    ${l}
  </div>`}function cn(){let[e,t]=_plannerMonth.split(`-`).map(Number),n=t===1?e-1:e,r=t===1?12:t-1;_plannerMonth=`${n}-${String(r).padStart(2,`0`)}`,_plannerSelectedDay=`${n}-${String(r).padStart(2,`0`)}-01`,I()}function ln(){let[e,t]=_plannerMonth.split(`-`).map(Number),n=t===12?e+1:e,r=t===12?1:t+1;_plannerMonth=`${n}-${String(r).padStart(2,`0`)}`,_plannerSelectedDay=`${n}-${String(r).padStart(2,`0`)}-01`,I()}function un(e){_plannerSelectedDay=e,_plannerMonth=e.slice(0,7),I()}function dn(e){let t=new Date(e+`T12:00:00`),n=e===new Date().toISOString().slice(0,10)?`Today`:t.toLocaleDateString(`en-AU`,{weekday:`long`}),r=t.toLocaleDateString(`en-AU`,{day:`numeric`,month:`long`,year:`numeric`}),i=Zt(e).sort((e,t)=>e.allDay&&!t.allDay?-1:!e.allDay&&t.allDay?1:(e.time||`99:99`).localeCompare(t.time||`99:99`)),a=``;return a=i.length===0?`<div class="pl-agenda-empty">Nothing planned — enjoy the quiet ☀️<br><span style="color:var(--iris-1);cursor:pointer;font-weight:600;font-size:13px" onclick="openPlannerModal(null,'${e}')">+ Add an event</span></div>`:`<div class="pl-agenda-list">${i.map(t=>{let n=qt(t),r=F[t.category]||F.other,i=t.allDay||!t.time?`All day`:Qt(t.time),a=Jt(t),o=new Date().getHours()*60+new Date().getMinutes(),s=t.time?parseInt(t.time.split(`:`)[0])*60+parseInt(t.time.split(`:`)[1]):-1,c=e===new Date().toISOString().slice(0,10)&&s>=0&&o>=s&&o<s+90,l=r.color||`#f1f5f9`,u=r.text||`#475569`;return`<div class="pl-agenda-ev">
        ...
        <div class="pl-agenda-card" style="background:${l};border-color:${u}22" onclick="_plannerOpenDetail('${t.id}')">
          <div class="pl-agenda-card-title">${T(t.title)}</div>
    ...
    <div style="padding:${i.length?`12px 16px`:`0`}">${a}</div>
  </div>`}function fn(e){_plannerMonth=e.slice(0,7),_plannerSelectedDay=e,activateTab(`planner`)}function pn(){let e=new Date().toISOString().slice(0,10);_plannerMonth=e.slice(0,7),_plannerSelectedDay=e,I()}function mn(e){_plannerView=e,_plannerCollapseState[`life-areas`]=e===`week`,_plannerCollapseState.nudge=e===`week`,I()}function hn(e){_plannerCollapseState[e]=!_plannerCollapseState[e],I()}function gn(e){e===`everyone`?window._plannerFilterMembers.clear():window._plannerFilterMembers.has(e)?window._plannerFilterMembers.delete(e):window._plannerFilterMembers.add(e),I()}function _n(e){let t=document.getElementById(`pl-day-sheet-overlay`);if(!t)return;let n=new Date(e+`T12:00:00`),r=new Date().toISOString().slice(0,10);document.getElementById(`pl-sheet-title`).textContent=e===r?`Today`:n.toLocaleDateString(`en-AU`,{weekday:`long`}),document.getElementById(`pl-sheet-date`).textContent=n.toLocaleDateString(`en-AU`,{day:`numeric`,month:`long`,year:`numeric`}),document.getElementById(`pl-sheet-add-btn`).dataset.date=e,vn(e),t.classList.add(`open`)}function vn(e){let t=Zt(e).sort((e,t)=>(e.time||`99:99`).localeCompare(t.time||`99:99`)),n=document.getElementById(`pl-sheet-list`);if(n){if(t.length===0){n.innerHTML=`<div class="pl-sheet-empty">Nothing planned. <span style="color:var(--primary);cursor:pointer;font-weight:600" onclick="_plannerOpenModalFromSheet()">Add an event →</span></div>`;return}n.innerHTML=t.map((e,t)=>{let n=qt(e),r=F[e.category]||F.other,i=Jt(e),a=e.allDay||!e.time?`All day`:Qt(e.time);return`<div class="pl-sheet-ev" onclick="_plannerOpenDetail('${e.id}')">
      <div class="pl-sheet-ev-time">${a}</div>
      <div class="pl-sheet-ev-bar" style="background:${n.dot}"></div>
      <div style="flex:1;min-width:0">
        <div class="pl-sheet-ev-title">${T(e.title)}</div>
      ...
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#D4D4D8" stroke-width="2" stroke-linecap="round"><polyline points="9 18 15 12 9 6"/></svg>
    </div>`}).join(``)}}function yn(){let e=document.getElementById(`pl-day-sheet-overlay`);e&&e.classList.remove(`open`)}function bn(e){e.target===document.getElementById(`pl-day-sheet-overlay`)&&yn()}function xn(){let e=document.getElementById(`pl-sheet-add-btn`)?.dataset?.date||_plannerSelectedDay;yn(),Kn(null,e)}function Sn(e){let t=F[e];if(!t)return;let n=new Date().toISOString().slice(0,10),r=(g.planner?.events||[]).filter(t=>t.category===e&&t.date>=n).sort((e,t)=>e.date.localeCompare(t.date));document.getElementById(`pl-life-sheet-icon`).textContent=t.emoji,document.getElementById(`pl-life-sheet-title`).textContent=t.label,document.getElementById(`pl-life-sheet-count`).textContent=r.length+` upcoming`;let i=``;if(r.length===0)i=`<div class="pl-sheet-empty">No upcoming ${t.label.toLowerCase()} events.</div>`;else{let e=``;r.forEach(t=>{let n=t.date.slice(0,7);if(n!==e){let r=new Date(t.date+`T12:00:00`);i+=`<div class="pl-life-day-hdr">${r.toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`})}</div>`,e=n}let r=qt(t),a=Jt(t),o=new Date(t.date+`T12:00:00`);i+=`<div class="pl-life-ev-row" onclick="_plannerCloseLifeSheet();_plannerOpenDetail('${t.id}')">
        ...
        <div class="pl-life-ev-content">
          <div class="pl-life-ev-title">${T(t.title)}</div>
          <div class="pl-life-ev-meta">${a}${t.time?` · `+Qt(t.time):``}</div>
        </div>
      </div>`})}document.getElementById(`pl-life-sheet-list`).innerHTML=i,document.getElementById(`pl-life-overlay`).classList.add(`open`)}function Cn(){document.getElementById(`pl-life-overlay`)?.classList.remove(`open`)}function wn(e){e.target===document.getElementById(`pl-life-overlay`)&&Cn()}function Tn(e){let t=(g.planner?.events||[]).find(t=>t.id===e);if(!t)return;_plannerDetailEvId=e;let n=qt(t),r=F[t.category]||F.other,i=Kt(t);document.getElementById(`pl-detail-title`).textContent=t.title,document.getElementById(`pl-detail-color-bar`).style.background=n.dot;let a=new Date(t.date+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`,year:`numeric`}),o=t.allDay?`All day`:t.time?Qt(t.time):``;!t.allDay&&t.endTime&&(o+=` – `+Qt(t.endTime));let s=(i.includes(`everyone`)?[{id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`}]:i.map(e=>Gt(e))).map(e=>`<span style="display:inline-flex;align-items:center;gap:5px;background:${e.bg};color:${e.text};padding:4px 10px;border-radius:99px;font-size:12px;font-weight:600">${e.emoji} ${e.name}</span>`).join(` `),c=(t.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0),l=[{icon:`📅`,label:`Date`,value:a},o?{icon:`🕐`,label:`Time`,value:o}:null,t.location?{icon:`📍`,label:`Address`,value:T(t.location)}:null,{icon:`👥`,label:`Who`,value:`<div style="display:flex;flex-wrap:wrap;gap:6px;margin-top:4px">${s}</div>`},{icon:r.emoji,label:`Category`,value:r.label},Yt(t)?{icon:`🔄`,label:`Repeats`,value:Yt(t)}:null,c>0?{icon:`💰`,label:`Est. cost`,value:`$${c.toLocaleString(`en-AU`)}`}:null,t.notes?{icon:`📝`,label:`Notes`,value:T(t.notes)}:null].filter(Boolean);document.getElementById(`pl-detail-body`).innerHTML=l.map(e=>`<div class="pl-detail-row">
      <div class="pl-detail-icon">${e.icon}</div>
      <div style="flex:1;min-width:0">
        <div class="pl-detail-row-label">${e.label}</div>
        <div class="pl-detail-row-value">${e.value}</div>
      </div>
    </div>`).join(``)+(r.financial?`<button class="planner-ai-btn" style="width:100%;justify-content:center;margin-top:16px" onclick="_plannerCloseDetail();estimatePlannerEvent('${e}')">✦ Estimate costs with AI</button>`:``)+`<button class="pl-detail-share-btn" onclick="_plannerOpenShare('${e}')">🔗 Share this event</button>`,document.getElementById(`pl-detail-overlay`).classList.add(`open`)}function En(){document.getElementById(`pl-detail-overlay`)?.classList.remove(`open`),_plannerDetailEvId=null}function Dn(e){e.target===document.getElementById(`pl-detail-overlay`)&&En()}function On(){let e=_plannerDetailEvId;En(),e&&Kn(e)}function kn(e){let t=(g.planner?.events||[]).find(t=>t.id===e);if(!t)return;let n=`https://toto.app/event/${t.title.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/(^-|-$)/g,``)}-${Math.random().toString(36).slice(2,10)}`,r=document.getElementById(`pl-share-sub`),i=document.getElementById(`pl-share-url`),a=document.getElementById(`pl-share-copy-btn`);r&&(r.textContent=t.title),i&&(i.textContent=n),a&&(a.textContent=`Copy`,a.classList.remove(`copied`)),document.getElementById(`pl-share-overlay`)?.classList.add(`open`)}function An(){document.getElementById(`pl-share-overlay`)?.classList.remove(`open`)}function jn(e){e.target===document.getElementById(`pl-share-overlay`)&&An()}function Mn(){let e=document.getElementById(`pl-share-url`)?.textContent;e&&navigator.clipboard?.writeText(e).catch(()=>{});let t=document.getElementById(`pl-share-copy-btn`);t&&(t.textContent=`Copied!`,t.classList.add(`copied`),setTimeout(()=>{t.textContent=`Copy`,t.classList.remove(`copied`)},2e3))}function Nn(e){let t=document.getElementById(`pl-share-url`)?.textContent||``,n=(g.planner?.events||[]).find(e=>e.id===_plannerDetailEvId),r=n?`${n.title} — ${t}`:t;e===`sms`&&window.open(`sms:?body=${encodeURIComponent(r)}`),e===`whatsapp`&&window.open(`https://wa.me/?text=${encodeURIComponent(r)}`),e===`email`&&window.open(`mailto:?subject=${encodeURIComponent(n?.title||`Event`)}&body=${encodeURIComponent(r)}`)}function Pn(){function e(e){return Math.ceil((e-new Date().setHours(0,0,0,0))/864e5)}function t(e,t,n,r){let i=new Date(e,t,1);for(;i.getDay()!==n;)i.setDate(i.getDate()+1);return i.setDate(i.getDate()+(r-1)*7),i}let n=new Date().getFullYear();return[{emoji:`🧾`,title:`EOFY`,days:e(new Date(n,5,30)),body:`Tax time — accountant fees, donations, prepayments`},{emoji:`🎄`,title:`Christmas`,days:e(new Date(n,11,25)),body:`Gifts, travel, food — start budgeting early`},{emoji:`💐`,title:`Mother's Day`,days:e(t(n,4,0,2)),body:`Gift, brunch or dinner for Mum`},{emoji:`👔`,title:`Father's Day`,days:e(t(n,8,0,1)),body:`Gift or outing for Dad`}].filter(e=>e.days>=-3&&e.days<=60).sort((e,t)=>e.days-t.days)}function Fn(e){_plannerExpanded.has(e)?_plannerExpanded.delete(e):_plannerExpanded.add(e),I()}function In(e,t){let n=(g.planner?.events||[]).find(t=>t.id===e);if(!n)return;let r=(n.estimates||[]).find(e=>e.id===t);r&&(r.accepted=!r.accepted,window.saveData(g),I())}function Ln(e){let t=(g.planner?.events||[]).find(t=>t.id===e);if(!t)return;let n=(t.estimates||[]).filter(e=>e.accepted);if(!n.length)return;let r=t.date.slice(0,7);g.budget.suggestions||(g.budget.suggestions=[]),g.budget.suggestions=g.budget.suggestions.filter(e=>e.eventId!==t.id),n.forEach(e=>{g.budget.suggestions.push({id:`sug-`+Date.now()+`-`+Math.random().toString(36).slice(2,5),month:r,eventId:t.id,eventTitle:t.title,estId:e.id,name:e.name,amount:e.amount,category:e.category,status:`pending`})}),t.pushed=`suggested`,window.saveData(g),_plannerExpanded.add(e),I();let i=new Date(r+`-15`).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`});r===window.selectedBudgetMonth?window.safeRender(renderBudget):confirm(`${n.length} suggestion${n.length>1?`s`:``} sent to ${i} budget.\n\nGo to Monthly Budget to approve them?`)&&(window.selectedBudgetMonth=r,activateTab(`budget`))}function Rn(e){let t=(g.budget.suggestions||[]).find(t=>t.id===e);if(!t)return;let n=window.ensureMonthOverride(t.month);n.expenses.push({id:N(n.expenses),name:`${t.name} (${t.eventTitle})`,amount:t.amount,frequency:`monthly`,category:t.category,recurring:!1,_plannerEventId:t.eventId}),t.status=`approved`;let r=(g.planner?.events||[]).find(e=>e.id===t.eventId);r&&(g.budget.suggestions||[]).filter(e=>e.eventId===r.id&&e.status===`pending`).length===0&&(r.pushed=!0),window.saveData(g),window.safeRender(renderBudget),window.safeRender(I)}function zn(e){let t=(g.budget.suggestions||[]).find(t=>t.id===e);if(!t)return;t.status=`dismissed`;let n=(g.planner?.events||[]).find(e=>e.id===t.eventId);n&&(g.budget.suggestions||[]).filter(e=>e.eventId===n.id&&e.status===`pending`).length===0&&(n.pushed=n.pushed===`suggested`?!1:n.pushed),window.saveData(g),window.safeRender(renderBudget)}function Bn(e){let t=(g.budget?.suggestions||[]).filter(t=>t.month===e&&t.status===`pending`);if(!t.length)return``;let n={};t.forEach(e=>{n[e.eventTitle]||(n[e.eventTitle]=[]),n[e.eventTitle].push(e)});let r=t.map(e=>`
    <div class="suggestion-row">
      <span class="suggestion-event-tag">📅 ${T(e.eventTitle)}</span>
      <div style="flex:1;min-width:0">
        <div class="suggestion-name">${T(e.name)}</div>
        <div class="suggestion-cat">${e.category}</div>
      </div>
      <span class="suggestion-amount">${D(e.amount)}</span>
    ...
    ${r}
  </div>`}function Vn(e){let t=(g.planner?.events||[]).find(t=>t.id===e);t&&(Object.values(g.budget.months||{}).forEach(t=>{t.expenses=(t.expenses||[]).filter(t=>t._plannerEventId!==e)}),g.budget.expenses=(g.budget.expenses||[]).filter(t=>t._plannerEventId!==e),g.budget.suggestions=(g.budget.suggestions||[]).filter(t=>t.eventId!==e),t.pushed=!1,window.saveData(g),I(),window.safeRender(renderBudget))}function Hn(e){confirm(`Delete this event and remove it from the budget?`)&&(Vn(e),g.planner.events=g.planner.events.filter(t=>t.id!==e),_plannerExpanded.delete(e),window.saveData(g),window.closeModal(),I())}async function Un(e){let t=P(`toto_ai_key`);if(!t){alert(`Add your AI API key in Settings to use cost estimation.`);return}let n=(g.planner?.events||[]).find(t=>t.id===e);if(!n)return;let r=document.getElementById(`ai-btn-${e}`);r&&(r.disabled=!0,r.textContent=`✦ Estimating…`);let i=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`).length||2,a=(g.householdProfile?.members||[]).filter(e=>e.role===`child`).length||0,o=new Date(n.date+`T12:00:00`).toLocaleDateString(`en-AU`,{day:`numeric`,month:`long`,year:`numeric`}),s=`You are a family finance assistant for an Australian family. Suggest realistic cost estimates for the following life event.
...
- Use ONLY these categories: Transport, Accommodation, Food & Dining, Entertainment, Gifts, Clothing, Health, Education, Shopping, Other`;try{let r=((await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:512,messages:[{role:`user`,content:s}]})})).json()).content?.[0]?.text||``).match(/\[[\s\S]*?\]/);if(!r)throw Error(`No JSON array in response`);n.estimates=JSON.parse(r[0]).map((e,t)=>({id:`est-${Date.now()}-${t}`,name:e.name,amount:Number(e.amount)||0,category:e.category||`Other`,accepted:!0})),_plannerExpanded.add(e),window.saveData(g),I()}catch(e){console.error(`Planner estimate error:`,e),r&&(r.disabled=!1,r.innerHTML=`✦ Try again`),alert(`Could not estimate costs. Check your AI API key in Settings.`)}}var L=new Set,Wn=`start`,Gn=new Date().toISOString().slice(0,7);function Kn(e,t){let n=e?(g.planner?.events||[]).find(t=>t.id===e):null,r=t||_plannerSelectedDay||new Date().toISOString().slice(0,10);L=new Set,Wn=`start`,Gn=(n?.date||r).slice(0,7),n?Kt(n).forEach(e=>L.add(e)):window._plannerFilterMembers.size>0&&window._plannerFilterMembers.forEach(e=>L.add(e)),document.getElementById(`modal-title`).textContent=n?`Edit Event`:`Add Event`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <div class="form-group">
      ...
      <input class="form-input" id="pe-title" placeholder="e.g. Mia's swimming lesson" value="${n?E(n.title):``}">
    </div>
    <!-- All day -->
    <div class="form-group">
    ...
    <div style="display:grid;grid-template-columns:minmax(0,1.15fr) minmax(0,0.85fr);gap:8px" class="form-group">
      <div>
        ...
        <button type="button" class="form-input" id="pm-start-trigger" onclick="_pmDpOpen('start')" style="text-align:left;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">
          <span id="pm-start-display">${Jn(n?n.date:r)}</span>
        </button>
      </div>
    ...
    <div style="display:grid;grid-template-columns:minmax(0,1.15fr) minmax(0,0.85fr);gap:8px" class="form-group" id="pm-end-group">
      <div>
        ...
        <button type="button" class="form-input" id="pm-end-trigger" onclick="_pmDpOpen('end')" style="text-align:left;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:${n?.endDate?`var(--text)`:`var(--text-muted)`}">
          <span id="pm-end-display">${n?.endDate?Jn(n.endDate):`Same day`}</span>
        </button>
      </div>
    ...
    <div class="form-group">
      ...
      <input class="form-input" id="pe-location" placeholder="e.g. 123 Main St, Sydney" value="${n?E(n.location||``):``}">
    </div>
    <!-- Notes -->
    <div class="form-group">
      <label class="form-label">Notes <span style="font-weight:400;color:var(--text-muted)">(helps AI estimate costs)</span></label>
      <textarea class="form-input" id="pe-notes" rows="2" placeholder="e.g. Flying from Sydney, 5 nights, gift budget ~$100">${n?T(n.notes||``):``}</textarea>
    </div>`,document.getElementById(`modal-footer`).innerHTML=`
    ...
    </div>`,document.getElementById(`modal-footer`).style.justifyContent=`space-between`,document.getElementById(`modal-overlay`).classList.remove(`hidden`),Yn(),Zn(),setTimeout(()=>{_routineRecurrenceSummaryUpdate()},100)}function qn(e){return e?new Date(e+`T12:00:00`).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`}):``}function Jn(e){return e?new Date(e+`T12:00:00`).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`}):``}function Yn(){let e=Wt(),t={id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`},n=document.getElementById(`pm-member-picker`);if(!n)return;n.innerHTML=[t,...e].map(e=>`<button type="button" style="display:flex;align-items:center;gap:6px;padding:6px 12px;border-radius:99px;font-size:12px;font-weight:600;border:2px solid ${(e.id===`everyone`?L.size===0:L.has(e.id))?e.dot:`transparent`};background:${e.bg};color:${e.text};cursor:pointer;transition:all .15s" onclick="_pmToggleMember('${e.id}')">
      ${e.emoji} ${e.name}
    </button>`).join(``);let r=[...L][0],i=r?e.find(e=>e.id===r):null,a=document.getElementById(`pm-save-btn`);a&&(a.style.background=i?i.dot:``)}function Xn(e){e===`everyone`?L.clear():L.has(e)?L.delete(e):L.add(e),Yn()}function Zn(){let e=document.getElementById(`pe-allday`)?.checked,t=document.getElementById(`pm-start-time-col`),n=document.getElementById(`pm-end-time-col`);t&&(t.style.display=e?`none`:``),n&&(n.style.display=e?`none`:``)}function Qn(){}function $n(e){Wn=e;let t=e===`end`?`pm-end-trigger`:`pm-start-trigger`,n=document.getElementById(t);if(!n)return;let r=document.getElementById(`pm-dp-popover`);r||(r=document.createElement(`div`),r.id=`pm-dp-popover`,r.style.cssText=`display:none;position:fixed;width:260px;background:var(--paper);border:1.5px solid var(--hairline);border-radius:var(--r);box-shadow:0 12px 40px rgba(0,0,0,.16);padding:14px;z-index:9999`,document.body.appendChild(r),document.addEventListener(`click`,er)),Gn=(document.getElementById(`pe-date`)?.value||new Date().toISOString().slice(0,10)).slice(0,7),tr(r);let i=n.getBoundingClientRect();r.style.top=i.bottom+6+`px`,r.style.left=Math.max(8,Math.min(i.left,window.innerWidth-272))+`px`,r.style.display=`block`}function er(e){let t=document.getElementById(`pm-dp-popover`),n=document.getElementById(`pm-start-trigger`),r=document.getElementById(`pm-end-trigger`);t&&!t.contains(e.target)&&e.target!==n&&e.target!==r&&!n?.contains(e.target)&&!r?.contains(e.target)&&t&&(t.style.display=`none`)}function tr(e){if(e||(e=document.getElementById(`pm-dp-popover`)),!e)return;let[t,n]=Gn.split(`-`).map(Number),r=new Date().toISOString().slice(0,10),i=Wn===`end`?document.getElementById(`pe-end-date`)?.value||``:document.getElementById(`pe-date`)?.value||``,a=new Date(t,n-1,1).getDay(),o=a===0?6:a-1,s=new Date(t,n,0).getDate(),c=new Date(t,n-1,0).getDate(),l=new Date(t,n-1,15).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`}),u=[];for(let e=o-1;e>=0;e--)u.push({day:c-e,muted:!0,dateStr:null});for(let e=1;e<=s;e++){let r=`${t}-${String(n).padStart(2,`0`)}-${String(e).padStart(2,`0`)}`;u.push({day:e,muted:!1,dateStr:r})}let d=u.length%7==0?0:7-u.length%7;for(let e=1;e<=d;e++)u.push({day:e,muted:!0,dateStr:null});let f=u.map(e=>{let t=e.dateStr&&e.dateStr===i,n=e.dateStr===r,a=t?`background:#2563eb;color:#fff;border-radius:50%`:n?`color:#2563eb;font-weight:700`:e.muted?`color:#d1d5db`:``;return`<button type="button" onclick="_pmDpSelect('${e.dateStr}')" ${e.dateStr?``:`disabled`} style="aspect-ratio:1;display:flex;align-items:center;justify-content:center;font-size:12px;border:none;background:none;cursor:${e.dateStr?`pointer`:`default`};font-family:inherit;${a}">${e.day}</button>`}).join(``);e.innerHTML=`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px">
      ...
      <div style="font-size:14px;font-weight:700;color:var(--text)">${l}</div>
    ...
    <div style="display:grid;grid-template-columns:repeat(7,1fr);gap:1px;margin-bottom:4px">
      ${[`M`,`T`,`W`,`T`,`F`,`S`,`S`].map(e=>`<div style="text-align:center;font-size:10px;font-weight:700;color:var(--muted);padding:3px 0">${e}</div>`).join(``)}
    </div>
    ...
    </div>`}function nr(e){if(!e)return;let t=Wn===`end`?`pe-end-date`:`pe-date`,n=Wn===`end`?`pm-end-display`:`pm-start-display`,r=document.getElementById(t),i=document.getElementById(n);r&&(r.value=e),i&&(i.textContent=Jn(e),i.style.color=`var(--text)`),Gn=e.slice(0,7),document.getElementById(`pm-dp-popover`).style.display=`none`}function rr(){nr(``);let e=Wn===`end`?`pm-end-display`:`pm-start-display`,t=document.getElementById(e);t&&(t.textContent=Wn===`end`?`Same day`:``,t.style.color=`#94a3b8`)}function ir(){nr(new Date().toISOString().slice(0,10))}function ar(){let[e,t]=Gn.split(`-`).map(Number),n=t===1?e-1:e,r=t===1?12:t-1;Gn=`${n}-${String(r).padStart(2,`0`)}`,tr()}function or(){let[e,t]=Gn.split(`-`).map(Number),n=t===12?e+1:e,r=t===12?1:t+1;Gn=`${n}-${String(r).padStart(2,`0`)}`,tr()}function sr(e){let t=document.getElementById(`pe-title`).value.trim(),n=document.getElementById(`pe-cat`).value,r=document.getElementById(`pe-date`).value,i=document.getElementById(`pe-end-date`)?.value||``,a=document.getElementById(`pe-allday`)?.checked||!1,o=a?``:document.getElementById(`pe-time`)?.value||``,s=a?``:document.getElementById(`pe-end-time`)?.value||``,c=document.getElementById(`pe-notes`).value.trim(),l=document.getElementById(`pe-location`)?.value.trim()||``,u=_routineRecurrenceCollect(),d=(u.type,`none`),f=L.size>0?[...L]:[`everyone`];if(!t||!r){alert(`Title and date are required.`);return}if(g.planner||(g.planner={events:[]}),e){let p=g.planner.events.find(t=>t.id===e);p&&(p.title=t,p.category=n,p.date=r,p.endDate=i||r,p.allDay=a,p.time=o,p.endTime=s,p.notes=c,p.location=l,p.recurrence=u,p.recurring=d,p.memberIds=f)}else{let e=`ev-`+Date.now();g.planner.events.push({id:e,title:t,category:n,date:r,endDate:i||r,allDay:a,time:o,endTime:s,notes:c,location:l,recurrence:u,recurring:d,memberIds:f,estimates:[],pushed:!1}),_plannerExpanded.add(e),_plannerSelectedDay=r,_plannerMonth=r.slice(0,7)}window.saveData(g),window.closeModal(),I()}function cr(e,t){let n=(g.planner?.events||[]).filter(t=>t.date?.slice(0,7)===e&&(t.estimates||[]).some(e=>e.accepted));if(n.length===0)return``;let r=n.reduce((e,t)=>e+(t.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0),0),i=t-r,a=n.filter(e=>!e.pushed),o=n.map(e=>{let t=F[e.category]||F.other,n=(e.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0),r=new Date(e.date+`T12:00:00`).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`});return`<div class="forecast-row">
      <span class="forecast-ev-name">${t.emoji} ${T(e.title)}</span>
      <span class="forecast-ev-date">${r}</span>
      <span class="forecast-ev-cost">${D(n)}</span>
    ...
    <div class="forecast-header">
      <span class="forecast-header-title">📅 Planned Events — ${D(r)} this month</span>
    ...
    <div class="forecast-total">
      ...
      <span style="font-weight:800;font-size:15px;color:${i>=0?`#10b981`:`#ef4444`}">${D(Math.abs(i))} ${i>=0?`surplus`:`deficit`}</span>
    </div>
  </div>`}function lr(e){(g.planner?.events||[]).filter(t=>t.date?.slice(0,7)===e&&!t.pushed&&(t.estimates||[]).some(e=>e.accepted)).forEach(e=>Ln(e.id)),renderBudget()}function ur(e,t,n,r){let i=0;for(let a=1;a<=31;a++){let o=new Date(e,t,a);if(o.getMonth()!==t)break;if(o.getDay()===n&&(i++,i===r))return o}}function dr(){let e=new Date;e.setHours(0,0,0,0);let t=e.getFullYear(),n=t=>Math.ceil((t-e)/864e5);return[{d:new Date(t,3,25),emoji:`🌿`,title:`Anzac Day`,body:`Public holiday — any plans or travel?`},{d:new Date(t,5,30),emoji:`🧾`,title:`EOFY`,body:`Tax time — accountant fees, donations, prepayments`},{d:new Date(t,11,25),emoji:`🎄`,title:`Christmas`,body:`Gifts, travel, food — start budgeting early`},{d:new Date(t,11,26),emoji:`🛍️`,title:`Boxing Day`,body:`Sales, travel, family catch-ups`},{d:new Date(t+1,0,1),emoji:`🎆`,title:`New Year's`,body:`Celebrations, travel plans`},{d:ur(t,4,0,2),emoji:`💐`,title:`Mother's Day`,body:`Gift, brunch or dinner for Mum`},{d:ur(t,8,0,1),emoji:`👔`,title:`Father's Day`,body:`Gift or outing for Dad`},{d:ur(t,10,2,1),emoji:`🏆`,title:`Melbourne Cup`,body:`Event day — sweepstakes, lunch, outfits`},{d:new Date(t,3,6),emoji:`🎒`,title:`Term 1 Holidays`,body:`2 weeks — activities, childcare, day trips`},{d:new Date(t,6,5),emoji:`🎒`,title:`Term 2 Holidays`,body:`2 weeks — winter school holidays`},{d:new Date(t,8,19),emoji:`🎒`,title:`Term 3 Holidays`,body:`2 weeks — spring school holidays`},{d:new Date(t,11,18),emoji:`🎒`,title:`Summer Holidays`,body:`6 weeks — the big one, plan early`}].filter(e=>e.d).map(e=>({...e,days:n(e.d)})).filter(e=>e.days>=-3&&e.days<=45).sort((e,t)=>e.days-t.days).slice(0,4)}function fr(){let e=dr();return e.length===0?``:`<div class="nudge-section">
    <div class="diary-section-title">Heads up from Toto 🐕</div>
    <div class="nudge-row">${e.map(e=>{let t=e.days<0?`Now!`:e.days===0?`Today!`:e.days===1?`Tomorrow`:`In ${e.days} days`;return`<div class="nudge-card" onclick="openTotoAssistant();_totoSend('Help me plan for ${E(e.title)}')">
      <div class="nudge-card-icon">${e.emoji}</div>
      <div class="nudge-card-title">${T(e.title)}</div>
      <div class="nudge-card-days">${t}</div>
      <div class="nudge-card-body">${T(e.body)}</div>
    </div>`}).join(``)}</div>
  </div>`}function pr(e,t){let n=new Date(e);switch(t){case`weekly`:n.setDate(n.getDate()+7);break;case`fortnightly`:n.setDate(n.getDate()+14);break;case`monthly`:n.setMonth(n.getMonth()+1);break;case`quarterly`:n.setMonth(n.getMonth()+3);break;case`yearly`:n.setFullYear(n.getFullYear()+1);break}return n}function mr(){if(!g.planner?.events)return;let e=g.planner.events,t=new Date;t.setHours(0,0,0,0);let n=!1,r={weekly:3,fortnightly:3,monthly:6,quarterly:12,yearly:24};e.filter(e=>e.recurring&&e.recurring!==`none`&&!e._recurringSourceId).forEach(i=>{let a=i.recurring,o=new Date(t);o.setMonth(o.getMonth()+(r[a]||12));let s=new Date(i.date+`T12:00:00`);for(;s<t;)s=pr(s,a);let c=0;for(;s<=o&&c++<200;){let t=s.toISOString().slice(0,10);e.some(e=>e.date===t&&(e.id===i.id||e._recurringSourceId===i.id))||(e.push({id:`ev-`+Date.now()+`-r`+Math.random().toString(36).slice(2,6),title:i.title,category:i.category,date:t,notes:i.notes||``,recurring:a,_recurringSourceId:i.id,estimates:(i.estimates||[]).map(e=>({...e,id:`est-`+Date.now()+Math.random(),accepted:!0})),pushed:!1}),n=!0),s=pr(s,a)}}),n&&window.saveData(g)}var hr=!1,gr=[],_r=!1,vr=[{icon:`📅`,text:`What should I plan for this month?`},{icon:`💸`,text:`Any upcoming events I should budget for?`},{icon:`🎒`,text:`Help me plan for school holidays`},{icon:`✈️`,text:`I have a trip coming up — what do I need to organise?`}];function yr(){hr?xr():br()}function br(){hr=!0,document.getElementById(`toto-panel`).classList.add(`open`),gr.length===0&&Sr()}function xr(){hr=!1,document.getElementById(`toto-panel`).classList.remove(`open`)}function Sr(){let e=new Date().toISOString().slice(0,10),t=new Date;t.setDate(t.getDate()+7);let n=t.toISOString().slice(0,10),r=(g.planner?.events||[]).filter(t=>t.date>=e&&t.date<=n),i=[];r.slice(0,2).forEach(t=>{let n=F[t.category]||F.other,r=new Date(t.date+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`short`,day:`numeric`,month:`short`});n.financial&&(!t.estimates||t.estimates.length===0)?i.push({icon:n.emoji,text:`${T(t.title)} is ${r} — want me to estimate costs?`}):t.date===e&&i.push({icon:n.emoji,text:`You have "${T(t.title)}" today — anything to prepare?`})});let a=getSeasonalNudges().slice(0,2).map(e=>({icon:e.emoji,text:`Help me plan for ${T(e.title)} (${e.days<=0?`now!`:`in ${e.days} days`})`})),o=[...i,...a,...vr].slice(0,4),s=document.getElementById(`toto-suggestions`);s.innerHTML=o.map(e=>`<button class="toto-suggestion" onclick="_totoSendSuggestion(this)">${e.icon} ${e.text}</button>`).join(``);let c=new Date().getHours(),l=c<12?`Good morning`:c<17?`Good afternoon`:`Good evening`,u=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`).length||2,d=(g.householdProfile?.members||[]).filter(e=>e.role===`child`).length||0,f=d>0?` and ${d} kid${d>1?`s`:``}`:``;Dr(`toto`,`${l}! 👋 I'm Toto, your family planning assistant. You have ${u} adult${u>1?`s`:``}${f} in your household.\n\nI can help you plan events, estimate costs, and make sure nothing slips through the cracks. What would you like to work on?`)}function Cr(e){let t=e.textContent.trim();e.closest(`.toto-suggestions`).style.display=`none`,Tr(t)}async function wr(){let e=document.getElementById(`toto-input`),t=e.value.trim();!t||_r||(e.value=``,document.getElementById(`toto-suggestions`).style.display=`none`,Tr(t))}async function Tr(e){let t=P(`toto_ai_key`);if(!t){Dr(`toto`,`To chat with me, you'll need to add your AI API key in Settings. It only takes a second! ⚙️`);return}Dr(`user`,e),gr.push({role:`user`,content:e}),_r=!0,document.getElementById(`toto-send`).disabled=!0;let n=Or();try{let e=Er(),r=(await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:600,system:e,messages:gr})})).json()).content?.[0]?.text||`Sorry, I couldn't get a response. Try again?`;gr.push({role:`assistant`,content:r}),kr(n),Dr(`toto`,r)}catch{kr(n),Dr(`toto`,`Oops, something went wrong. Check your internet connection and try again.`)}finally{_r=!1,document.getElementById(`toto-send`).disabled=!1,document.getElementById(`toto-input`).focus()}}function Er(){let e=new Date().toISOString().slice(0,10),t=new Date().toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`,year:`numeric`}),n=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`).length||2,r=(g.householdProfile?.members||[]).filter(e=>e.role===`child`).length||0,i=new Date;i.setDate(i.getDate()+60);let a=(g.planner?.events||[]).filter(t=>t.date>=e&&t.date<=i.toISOString().slice(0,10)).sort((e,t)=>e.date.localeCompare(t.date)).slice(0,15).map(e=>{let t=F[e.category]||F.other,n=new Date(e.date+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`short`,day:`numeric`,month:`short`}),r=(e.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0);return`- ${n}: ${e.title} (${t.label})${r>0?` — $`+r.toLocaleString(`en-AU`)+` budgeted`:``}${e.notes?` — Notes: `+e.notes:``}`}).join(`
`)||`None`,o=window.getMonthData(window.selectedBudgetMonth),s=monthlyTotal(o.income),c=monthlyTotal(o.expenses),l=s-c,u=(g.goals||[]).filter(e=>e.status!==`achieved`).slice(0,4).map(e=>`${e.name} ($${(e.saved||0).toLocaleString()}/$${(e.target||0).toLocaleString()})`).join(`, `)||`None`;return`You are Toto, a warm and practical AI assistant for a family finance and life planning app called Toto. You help Australian families plan their lives and stay on top of their money.
...
- Keep responses to 3-5 sentences unless a list is genuinely helpful`}function Dr(e,t){let n=document.getElementById(`toto-messages`),r=document.createElement(`div`);r.className=`toto-msg ${e}`;let i=t.replace(/\n/g,`<br>`);e===`toto`?r.innerHTML=`<div class="toto-msg-avatar">🐕</div><div class="toto-msg-bubble">${i}</div>`:r.innerHTML=`<div class="toto-msg-bubble">${i}</div>`,n.appendChild(r),n.scrollTop=n.scrollHeight}function Or(){let e=document.getElementById(`toto-messages`),t=`toto-typing-`+Date.now(),n=document.createElement(`div`);return n.className=`toto-msg toto`,n.id=t,n.innerHTML=`<div class="toto-msg-avatar">🐕</div><div class="toto-msg-bubble"><div class="toto-typing"><span></span><span></span><span></span></div></div>`,e.appendChild(n),e.scrollTop=e.scrollHeight,t}function kr(e){document.getElementById(e)?.remove()}`serviceWorker`in navigator&&navigator.serviceWorker.register(`/home-budget/sw.js`,{scope:`/home-budget/`}).catch(e=>console.warn(`SW registration failed:`,e));var Ar=[`Produce`,`Meat & Seafood`,`Dairy & Eggs`,`Pantry`,`Bakery`,`Frozen`,`Household`,`Other`],jr={Produce:`🥦`,"Meat & Seafood":`🥩`,"Dairy & Eggs":`🥛`,Pantry:`🥫`,Bakery:`🍞`,Frozen:`🧊`,Household:`🏠`,Other:`🛒`},Mr={food:{label:`Food`,emoji:`🛒`,color:`#dcfce7`,text:`#166534`,aisles:!0,priceEst:!0},clothes:{label:`Clothes`,emoji:`👕`,color:`#dbeafe`,text:`#1e40af`,aisles:!1,priceEst:!1},wishlist:{label:`Wishlist`,emoji:`🎁`,color:`#fce7f3`,text:`#9d174d`,aisles:!1,priceEst:!1},home:{label:`Home & Garden`,emoji:`🛠`,color:`#fef3c7`,text:`#92400e`,aisles:!0,priceEst:!1},pharmacy:{label:`Pharmacy`,emoji:`💊`,color:`#ede9fe`,text:`#5b21b6`,aisles:!0,priceEst:!1}},Nr={food:[{key:`produce`,emoji:`🥦`,label:`Produce`},{key:`dairy`,emoji:`🥛`,label:`Dairy & Eggs`},{key:`bakery`,emoji:`🍞`,label:`Bakery`},{key:`meat`,emoji:`🥩`,label:`Meat & Seafood`},{key:`pantry`,emoji:`🥫`,label:`Pantry`},{key:`frozen`,emoji:`🧊`,label:`Frozen`},{key:`health`,emoji:`🧴`,label:`Health & Beauty`},{key:`bathroom`,emoji:`🚿`,label:`Bathroom`},{key:`cleaning`,emoji:`🧹`,label:`Cleaning`},{key:`drinks`,emoji:`🍷`,label:`Drinks & Alcohol`},{key:`other`,emoji:`🛒`,label:`Uncategorised`}],home:[{key:`tools`,emoji:`🔨`,label:`Tools & Hardware`},{key:`garden`,emoji:`🌱`,label:`Garden`},{key:`cleaning`,emoji:`🧹`,label:`Cleaning`},{key:`other`,emoji:`🛒`,label:`Other`}],pharmacy:[{key:`medicine`,emoji:`💊`,label:`Medicine`},{key:`skincare`,emoji:`🧴`,label:`Skincare`},{key:`vitamins`,emoji:`💪`,label:`Vitamins`},{key:`other`,emoji:`🛒`,label:`Other`}]},Pr={milk:`dairy`,cheese:`dairy`,butter:`dairy`,eggs:`dairy`,yoghurt:`dairy`,cream:`dairy`,bread:`bakery`,rolls:`bakery`,muffin:`bakery`,croissant:`bakery`,baguette:`bakery`,apple:`produce`,banana:`produce`,orange:`produce`,strawberry:`produce`,tomato:`produce`,lettuce:`produce`,spinach:`produce`,carrot:`produce`,broccoli:`produce`,potato:`produce`,onion:`produce`,garlic:`produce`,cucumber:`produce`,capsicum:`produce`,avocado:`produce`,lemon:`produce`,lime:`produce`,grapes:`produce`,mango:`produce`,pineapple:`produce`,watermelon:`produce`,chicken:`meat`,beef:`meat`,mince:`meat`,steak:`meat`,pork:`meat`,lamb:`meat`,salmon:`meat`,fish:`meat`,tuna:`meat`,prawn:`meat`,sausage:`meat`,bacon:`meat`,rice:`pantry`,pasta:`pantry`,flour:`pantry`,sugar:`pantry`,oil:`pantry`,vinegar:`pantry`,salt:`pantry`,pepper:`pantry`,sauce:`pantry`,stock:`pantry`,beans:`pantry`,lentils:`pantry`,chickpeas:`pantry`,cereal:`pantry`,oats:`pantry`,honey:`pantry`,jam:`pantry`,peanut:`pantry`,coffee:`pantry`,tea:`pantry`,biscuit:`pantry`,cracker:`pantry`,chocolate:`pantry`,chips:`pantry`,nuts:`pantry`,icecream:`frozen`,peas:`frozen`,corn:`frozen`,pizza:`frozen`,shampoo:`health`,conditioner:`health`,deodorant:`health`,sunscreen:`health`,moisturiser:`health`,makeup:`health`,lipstick:`health`,mascara:`health`,toothpaste:`bathroom`,toothbrush:`bathroom`,soap:`bathroom`,toilet:`bathroom`,razors:`bathroom`,tampons:`bathroom`,pads:`bathroom`,detergent:`cleaning`,bleach:`cleaning`,sponge:`cleaning`,dishwashing:`cleaning`,bins:`cleaning`,mop:`cleaning`,water:`drinks`,juice:`drinks`,beer:`drinks`,wine:`drinks`,spirits:`drinks`,softdrink:`drinks`,soda:`drinks`,kombucha:`drinks`};function Fr(e){for(var t=e.toLowerCase(),n=Object.keys(Pr),r=0;r<n.length;r++)if(t.indexOf(n[r])!==-1)return Pr[n[r]];return`other`}function Ir(e){var t=e.trim(),n=1,r=`units`,i=t,a=t.match(/^(\d+(?:\.\d+)?)\s*(kg|g|L|l|ml|dozen|doz)\s+(.+)$/i);if(a)n=parseFloat(a[1]),r=a[2].toLowerCase()===`l`?`L`:a[2].toLowerCase()===`doz`?`dozen`:a[2],i=a[3];else{var o=t.match(/^(\d+(?:\.\d+)?)\s+(.+)$/);o?(n=parseFloat(o[1]),i=o[2]):/^dozen\s+/i.test(t)&&(n=1,r=`dozen`,i=t.replace(/^dozen\s+/i,``))}return i=i.charAt(0).toUpperCase()+i.slice(1),{qty:n,unit:r,name:i}}var Lr=`food`,Rr=`selector`;Object.defineProperty(window,`_listsActiveType`,{get(){return Lr},set(e){Lr=e},configurable:!0}),Object.defineProperty(window,`_listsView`,{get(){return Rr},set(e){Rr=e},configurable:!0});function zr(e){let t=new Date,n=t.getDay()===0?-6:1-t.getDay(),r=new Date(t);return r.setDate(t.getDate()+n+(e||0)*7),r.toISOString().slice(0,10)}function Br(e){let t=new Date(e+`T00:00:00`);return Array.from({length:7},(e,n)=>{let r=new Date(t);return r.setDate(t.getDate()+n),r})}function Vr(){window._mealView===`shopping`?Qr():Hr()}function Hr(){let e=zr(0),t=Br(e),n=g.meals.plan[e]||{},r=new Date().toISOString().slice(0,10),i=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`,`Sun`],a=[{key:`b`,label:`Breakfast`},{key:`l`,label:`Lunch`},{key:`d`,label:`Dinner`}];t[0].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`}),t[6].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`});let o=[];for(let e=0;e<7;e++){let t=n[e]||{};[`b`,`l`,`d`].forEach(e=>{t[e]&&o.push(t[e])})}let s=``;a.forEach(i=>{s+=`<div class="meal-grid-label">${i.label}</div>`,t.forEach((t,a)=>{let o=(n[a]||{})[i.key]||``,c=t.toISOString().slice(0,10)===r;s+=`<div class="meal-cell${c?` today`:``}" onclick="openMealEdit('${e}',${a},'${i.key}')">
    ...
    <p style="font-size:12px;color:var(--text-muted);margin-top:6px">Tap any cell to add or change a meal.</p>`}var R={cuisine:`Any`,price:0,dietary:`Any`},Ur=[`Any`,`Italian`,`Asian`,`Mexican`,`Indian`,`Mediterranean`,`Thai`,`Japanese`,`Middle Eastern`,`Australian`],Wr=[`Any`,`Vegetarian`,`Vegan`,`Gluten-free`,`Quick (<30min)`,`Family-friendly`];function Gr(e,t,n){let r=[`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`,`Sunday`],i={b:`Breakfast`,l:`Lunch`,d:`Dinner`},a=((g.meals.plan[e]||{})[t]||{})[n]||``,o=!!P(`toto_ai_key`),s=new Set;Object.values(g.meals.plan).forEach(e=>Object.values(e).forEach(e=>{typeof e==`object`&&[`b`,`l`,`d`].forEach(t=>{e[t]&&s.add(e[t])})}));let c=[...s].filter(e=>e!==a).slice(0,16);document.getElementById(`modal-title`).textContent=`${r[t]} · ${i[n]}`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
    ...
    style="padding:4px 10px;border-radius:99px;font-size:12px;cursor:pointer;white-space:nowrap;
      ...
      color:${n?`#0891b2`:`var(--text)`}">${t}</button>`}function qr(e,t){R[e]=t,document.querySelectorAll(`[data-filter="${e}"]`).forEach(e=>{let n=e.dataset.val===t;e.style.borderColor=n?`#0891b2`:`var(--border)`,e.style.background=n?`#ecfeff`:`var(--surface)`,e.style.color=n?`#0891b2`:`var(--text)`})}function Jr(e){R.price=e;let t=document.getElementById(`meal-price-lbl`);t&&(t.textContent=e>0?`$${e}`:`Any`)}async function Yr(e){let t=P(`toto_ai_key`);if(!t)return;let n=document.getElementById(`meal-suggest-btn`),r=document.getElementById(`meal-suggest-out`);n&&(n.textContent=`⏳ Thinking…`,n.disabled=!0),r&&(r.innerHTML=``);let i={b:`Breakfast`,l:`Lunch`,d:`Dinner`},a=[R.cuisine===`Any`?``:`Cuisine: ${R.cuisine}`,R.price>0?`Budget: up to $${R.price} per serve`:``,R.dietary===`Any`?``:`Style: ${R.dietary}`].filter(Boolean).join(`, `)||`No specific filters`,o=`Suggest 8 ${i[e]} meal ideas. Filters: ${a}.
Return ONLY a JSON array of meal names, no other text: ["Meal 1","Meal 2",...]`;try{let e=(await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:256,messages:[{role:`user`,content:o}]})})).json()).content[0].text.match(/\[[\s\S]*\]/);if(!e)throw Error(`No JSON`);let n=JSON.parse(e[0]);r&&(r.innerHTML=`<div style="display:flex;flex-wrap:wrap;gap:6px">
      ${n.map(e=>`<button style="padding:6px 12px;border-radius:99px;border:1px solid #0891b2;background:#ecfeff;color:#0891b2;font-size:12px;font-weight:500;cursor:pointer"
        onclick="document.getElementById('meal-input').value='${e.replace(/'/g,`\\'`)}'">${e}</button>`).join(``)}
    </div>`)}catch(e){r&&(r.innerHTML=`<span style="font-size:12px;color:var(--danger)">⚠ ${e.message}</span>`)}finally{n&&(n.textContent=`Get suggestions`,n.disabled=!1)}}function Xr(e,t,n,r){g.meals.plan[e]||(g.meals.plan[e]={}),g.meals.plan[e][t]||(g.meals.plan[e][t]={b:``,l:``,d:``}),g.meals.plan[e][t][n]=r,delete g.meals.plan[e][t][`cal_`+n],window.saveData(g),window.closeModal(),Hr(),r&&g.settings?.showCalories&&Zr(e,t,n,r)}async function Zr(e,t,n,r){let i=P(`toto_ai_key`);if(!(!i||!r))try{let a=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":i,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:50,messages:[{role:`user`,content:`Estimate the calories in this meal: "${r}". Return ONLY a number, nothing else. For example: 450`}]})});if(!a.ok)return;let o=await a.json(),s=parseInt(o.content[0].text.trim().replace(/[^0-9]/g,``));s>0&&s<5e3&&g.meals.plan[e]?.[t]&&(g.meals.plan[e][t][`cal_`+n]=s,window.saveData(g),Hr())}catch{}}function Qr(){let e=g.meals.shopping||[],t=e.filter(e=>e.checked).length,n=e.length-t,r={};Ar.forEach(e=>r[e]=[]),e.forEach(e=>{r[Ar.includes(e.cat)?e.cat:`Other`].push(e)});let i=``;Ar.forEach(e=>{let t=r[e];t.length&&(i+=`
      <div style="margin-bottom:18px">
        ...
        ${t.map(e=>`
          <div class="shop-row">
            ...
            <span style="flex:1;font-size:14px;${e.checked?`text-decoration:line-through;color:var(--text-muted)`:``}">${T(e.name)}</span>
      ...
      <div style="padding:14px 20px;display:flex;gap:10px;flex-wrap:wrap;align-items:flex-end">
        ...
        <div style="flex:1;min-width:120px">
          ...
          <select class="form-select" id="shop-cat">
            ${Ar.map(e=>`<option value="${e}">${jr[e]} ${e}</option>`).join(``)}
          </select>
        </div>
    ...
    </div>`}function $r(){let e=document.getElementById(`shop-name`)?.value.trim();if(!e)return;let t=document.getElementById(`shop-qty`)?.value.trim()||``,n=document.getElementById(`shop-cat`)?.value||`Other`,r=g.meals.shopping;r.push({id:r.length?Math.max(...r.map(e=>e.id))+1:1,name:e,qty:t,cat:n,checked:!1}),window.saveData(g),Qr()}function ei(e,t){let n=g.meals.shopping.find(t=>t.id===e);n&&(n.checked=t,window.saveData(g))}function ti(e){g.meals.shopping=g.meals.shopping.filter(t=>t.id!==e),window.saveData(g),Qr()}function ni(){g.meals.shopping=g.meals.shopping.filter(e=>!e.checked),window.saveData(g),Qr()}function ri(e){var t=document.getElementById(`ls-toast`);t&&t.remove();var n=document.createElement(`div`);n.id=`ls-toast`,n.textContent=e,n.style.cssText=`position:fixed;bottom:96px;left:50%;transform:translateX(-50%) translateY(20px);background:#1a1814;color:#fff;padding:10px 18px;border-radius:99px;font-size:13px;font-weight:600;z-index:9999;opacity:0;transition:opacity .2s,transform .2s;pointer-events:none;white-space:nowrap;max-width:80vw;text-align:center;font-family:var(--sans,system-ui,sans-serif)`,document.body.appendChild(n),requestAnimationFrame(function(){n.style.opacity=`1`,n.style.transform=`translateX(-50%) translateY(0)`}),setTimeout(function(){n.style.opacity=`0`,n.style.transform=`translateX(-50%) translateY(10px)`,setTimeout(function(){n.parentNode&&n.remove()},300)},2400)}function ii(e,t,n,r,i,a,o){g.lists||window._applyMigrations(g);var s=g.lists[e];if(s){if(s.items.find(function(e){return e.state===`active`&&e.name.toLowerCase()===t.toLowerCase()}))return ri(T(t)+` is already on your list`),!1;var c={id:`li-`+Date.now()+`-`+Math.random().toString(36).slice(2,6),name:t,quantity:n||1,unit:r||`units`,notes:a||``,aisle:i||(e===`food`?Fr(t):`other`),state:`active`,addedBy:`user`,addedAt:new Date().toISOString(),stateChangedAt:null,mealTag:o||null,manualPrice:null,barcodeId:null};return s.items.push(c),pi(e,t),window.saveData(g),!0}}function ai(e,t,n){if(!(!g.lists||!g.lists[e])){var r=g.lists[e].items.find(function(e){return e.id===t});r&&(r.state=n,r.stateChangedAt=new Date().toISOString(),window.saveData(g),gi())}}function oi(e,t){!g.lists||!g.lists[e]||(g.lists[e].items=g.lists[e].items.filter(function(e){return e.id!==t}),window.saveData(g),gi())}function si(e){var t=document.getElementById(`ls-quick-input`);if(t){var n=t.value.trim();if(n){var r=Ir(n),i=e===`food`?Fr(r.name):`other`;if(ii(e,r.name,r.qty,r.unit,i,``,null)!==!1){t.value=``;var a=document.getElementById(`ls-parse-preview`);a&&(a.innerHTML=``),gi()}}}}function ci(e,t){let n=e===`food`,r=g.lists?.[e]?.items||[],i=t?r.find(e=>e.id===t):null,a=n?PANTRY_CATS:[`Other`],o=[`units`,`kg`,`g`,`L`,`ml`,`dozen`];document.getElementById(`modal-title`).textContent=i?`Edit Item`:`Add Item`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
      <label class="form-label">Item Name</label>
      <input class="form-input" id="lf-name" type="text" maxlength="200"
        value="${i?E(i.name):``}" placeholder="e.g. Pasta, Milk, Chicken">
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        <label class="form-label">Category</label>
        <select class="form-select" id="lf-cat">
          ${a.map(e=>`<option value="${e}"${i&&i.aisle===li(e)?` selected`:``}>${e}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
        <label class="form-label">Quantity <span style="font-weight:400;color:var(--text-muted)">(optional)</span></label>
        <input class="form-input" id="lf-qty" type="text" maxlength="200"
          value="${i?E(String(i.quantity||``)):``}" placeholder="e.g. 2 bags, 1L, 500g">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input class="form-input" id="lf-notes" type="text" maxlength="200"
        value="${i?E(i.notes||``):``}" placeholder="e.g. Get the organic one, only if on sale">
    </div>
    <div class="form-group">
      <label class="form-label">Status</label>
      <div style="display:flex;gap:8px">
    ...
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    <button class="btn btn-primary" onclick="_listsSaveForm('${e}','${t||``}')">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function li(e){return{Fridge:`dairy`,Freezer:`frozen`,Pantry:`pantry`,"Fruit & Veg":`produce`,Spices:`pantry`,Drinks:`drinks`,Cleaning:`cleaning`,Other:`other`}[e]||`other`}function ui(e,t){let n=document.getElementById(`lf-name`)?.value.trim();if(!n)return;let r=document.getElementById(`lf-cat`)?.value||`Other`,i=document.getElementById(`lf-qty`)?.value.trim()||`1`,a=document.getElementById(`lf-unit`)?.value||`units`,o=document.getElementById(`lf-notes`)?.value.trim()||``,s=document.querySelector(`input[name="lf-state"]:checked`)?.value||`active`,c=parseFloat(i)||1,l=e===`food`?li(r):`other`;g.lists||(g.lists={}),g.lists[e]||(g.lists[e]={items:[],weeklyBudget:0,budget:0,stores:[],favourites:[],history:[]});let u=g.lists[e].items;if(t){let e=u.find(e=>e.id===t);e&&(e.name=n,e.quantity=c,e.unit=a,e.notes=o,e.aisle=l,e.state=s)}else{if(u.find(e=>e.name.toLowerCase()===n.toLowerCase()&&e.state===`active`)&&!confirm(`"${n}" is already on your list. Add another?`))return;u.push({id:`si-`+Date.now(),name:n,quantity:c,unit:a,notes:o,aisle:l,state:s,addedBy:window._currentUser?.uid||`guest`,addedAt:new Date().toISOString(),mealTag:null,manualPrice:null,barcodeId:null}),pi(e,n)}window.saveData(g),window.closeModal(),gi()}function di(e){if(!(!g.lists||!g.lists[e])){var t=g.lists[e].items.filter(function(e){return e.state===`got_it`});t.length&&confirm(`Remove `+t.length+` trolley item`+(t.length===1?``:`s`)+`?`)&&(g.lists[e].items=g.lists[e].items.filter(function(e){return e.state!==`got_it`}),window.saveData(g),gi())}}function fi(e){if(!(!g.lists||!g.lists[e])){var t=g.lists[e];t.history||(t.history=[]),t.history.push({archivedAt:new Date().toISOString(),items:JSON.parse(JSON.stringify(t.items))}),t.items=[],window.saveData(g),ri(`Shop archived!`),gi()}}function pi(e,t){if(!(!g.lists||!g.lists[e])){var n=g.lists[e].favourites,r=n.find(function(e){return e.name.toLowerCase()===t.toLowerCase()});r?r.addedCount=(r.addedCount||0)+1:n.push({name:t,addedCount:1,pinned:!1})}}function mi(e){if(!(!g.lists||!g.lists[e])){var t=g.lists[e].favourites,n=t.filter(function(e){return e.pinned}),r=n.length?n:t.sort(function(e,t){return(t.addedCount||0)-(e.addedCount||0)}).slice(0,5),i=0;r.forEach(function(t){g.lists[e].items.find(function(e){return e.state===`active`&&e.name.toLowerCase()===t.name.toLowerCase()})||(ii(e,t.name,1,`units`,e===`food`?Fr(t.name):`other`,``,null),i++)}),i?gi():ri(`All usual items are already on the list`)}}function hi(){var e=document.getElementById(`ls-quick-input`),t=document.getElementById(`ls-parse-preview`);if(!(!e||!t)){var n=e.value.trim();if(!n){t.innerHTML=``;return}var r=Ir(n),i=``;(r.qty!==1||r.unit!==`units`)&&(i+=`<span class="ls-parse-chip">`+T(String(r.qty))+` `+T(r.unit)+`</span>`),i+=`<span class="ls-parse-chip">`+T(r.name)+`</span>`,t.innerHTML=i}}function gi(){var e=document.getElementById(`lists-content`);e&&(g.lists||window._applyMigrations(g),Rr===`selector`?_i(e):vi(e,Lr))}function _i(e){var t=`<div class="ls-screen">`;t+=`<div style="font-size:22px;font-weight:800;color:var(--ink,#1a1814);margin-bottom:4px">My Lists</div>`,t+=`<div style="font-size:13px;color:var(--muted,#8c8880);margin-bottom:20px">Tap a list to open it</div>`,t+=`<div class="ls-type-grid">`,Object.keys(Mr).forEach(function(e){var n=Mr[e],r=(g.lists&&g.lists[e]?g.lists[e]:{items:[]}).items.filter(function(e){return e.state===`active`}).length;t+=`<div class="ls-type-card" onclick="_listsActiveType='`+e+`';_listsView='list';renderLists()">`,t+=`<div class="ls-type-icon" style="background:`+n.color+`;color:`+n.text+`">`+n.emoji+`</div>`,t+=`<div class="ls-type-label">`+T(n.label)+`</div>`,t+=`<div class="ls-type-count">`+(r>0?r+` item`+(r===1?``:`s`):`Empty`)+`</div>`,t+=`</div>`}),t+=`</div>`,t+=`</div>`,e.innerHTML=t}function vi(e,t){var n=Mr[t],r=g.lists&&g.lists[t]?g.lists[t]:{items:[],weeklyBudget:0,favourites:[]},i=r.items||[],a=i.filter(function(e){return e.state===`active`}),o=i.filter(function(e){return e.state===`got_it`}),s=i.filter(function(e){return e.state===`not_found`}),c=`<div class="ls-screen">`;if(c+=`<button class="ls-back-btn" onclick="_listsView='selector';renderLists()">← Lists</button>`,c+=`<div class="ls-header">`,c+=`<div style="font-size:22px;margin-right:6px">`+n.emoji+`</div>`,c+=`<div class="ls-header-title">`+T(n.label)+`</div>`,c+=`<div class="ls-sync-dot"></div>`,c+=`<div class="ls-header-count">`+a.length+` to get</div>`,c+=`</div>`,r.weeklyBudget>0){var l=i.filter(function(e){return e.state===`got_it`&&e.manualPrice}).reduce(function(e,t){return e+(t.manualPrice||0)},0),u=Math.min(100,Math.round(l/r.weeklyBudget*100)),d=u>100?`over`:u>80?`warn`:``;c+=`<div class="ls-budget-bar-wrap">`,c+=`<div class="ls-budget-bar-meta"><span>$`+l.toFixed(0)+` spent</span><span>$`+r.weeklyBudget+` budget</span></div>`,c+=`<div class="ls-budget-bar"><div class="ls-budget-fill `+d+`" style="width:`+u+`%"></div></div>`,c+=`</div>`}var f=(r.favourites||[]).filter(function(e){return!a.find(function(t){return t.name.toLowerCase()===e.name.toLowerCase()})}).sort(function(e,t){return(t.addedCount||0)-(e.addedCount||0)}).slice(0,5);if(f.length>0&&(c+=`<div class="ls-fav-chips">`,f.forEach(function(e){c+=`<button class="ls-fav-chip" onclick="_listsAddItem('`+t+`','`+T(e.name).replace(/'/g,`\\'`)+`',1,'units','`+(t===`food`?Fr(e.name):`other`)+`','',null);renderLists()">+ `+T(e.name)+`</button>`}),c+=`</div>`),(r.favourites||[]).length>0&&(c+=`<button class="ls-usual-btn" onclick="_listsAddUsual('`+t+`')">The usual →</button>`),c+=`<div class="ls-quick-add">`,c+=`<div class="ls-quick-add-row">`,c+=`<input class="ls-quick-input" id="ls-quick-input" type="text" placeholder="Add item…" autocomplete="off" oninput="_listsUpdateParsePreview()" onkeydown="if(event.key==='Enter')_listsQuickAdd('`+t+`')">`,c+=`<button class="ls-quick-add-btn" onclick="_listsQuickAdd('`+t+`')">Add</button>`,c+=`<button class="ls-quick-add-btn" style="background:var(--purple-soft);color:var(--iris-1);min-width:36px;padding:0 10px" onclick="_listsOpenAddForm('`+t+`')">⋯</button>`,c+=`</div>`,c+=`<div class="ls-parse-preview" id="ls-parse-preview"></div>`,c+=`</div>`,a.length>0)if(n.aisles){var p=Nr[t]||[{key:`other`,emoji:`🛒`,label:`Other`}],m={};p.forEach(function(e){m[e.key]=[]}),a.forEach(function(e){var t=e.aisle&&m[e.aisle]!==void 0?e.aisle:`other`;m[t]||(m[t]=[]),m[t].push(e)}),p.forEach(function(e){!m[e.key]||!m[e.key].length||(c+=`<div class="ls-aisle-header">`+e.emoji+` `+T(e.label)+`</div>`,m[e.key].forEach(function(e){c+=yi(t,e)}))})}else a.forEach(function(e){c+=yi(t,e)});else c+=`<div style="text-align:center;padding:32px 0;color:var(--muted,#8c8880);font-size:14px">Nothing to get yet — add something above</div>`;o.length>0&&(c+=`<div class="ls-aisle-header">🛒 In the trolley</div>`,o.forEach(function(e){c+=yi(t,e)})),s.length>0&&(c+=`<div class="ls-aisle-header">🚫 Not found</div>`,s.forEach(function(e){c+=yi(t,e)})),c+=`<div class="ls-footer-row">`,o.length>0&&(c+=`<button class="ls-footer-btn" onclick="_listsClearTrolley('`+t+`')">Clear trolley (`+o.length+`)</button>`),a.length===0&&i.length>0&&(c+=`<button class="ls-footer-btn" style="background:var(--iris-2,#6366f1);color:#fff;border-color:var(--iris-2,#6366f1)" onclick="_listsArchive('`+t+`')">Archive this shop</button>`),c+=`</div>`,c+=`</div>`,e.innerHTML=c}function yi(e,t){var n=t.state===`got_it`?`got-it`:t.state===`not_found`?`not-found`:``,r=t.state===`got_it`?`✓`:``,i=t.state===`active`?`got_it`:`active`,a=t.quantity&&t.unit&&t.unit!==`units`?t.quantity+` `+t.unit:t.quantity&&t.quantity!==1?`x`+t.quantity:``;T(t.id);var o=T(t.name),s=`<div class="ls-item `+n+`">`;return s+=`<button class="ls-item-check" onclick="_listsSetState('`+e+`','`+t.id+`','`+i+`')">`+r+`</button>`,s+=`<div class="ls-item-body">`,s+=`<div class="ls-item-name">`+o+`</div>`,a&&(s+=`<div class="ls-item-qty">`+T(a)+`</div>`),t.notes&&(s+=`<div class="ls-item-notes">`+T(t.notes)+`</div>`),s+=`</div>`,t.state===`active`?s+=`<button class="ls-item-notfound-btn" title="Not found" onclick="_listsSetState('`+e+`','`+t.id+`','not_found')">🚫</button>`:t.state===`not_found`&&(s+=`<button class="ls-item-notfound-btn" title="Mark active again" onclick="_listsSetState('`+e+`','`+t.id+`','active')">↩</button>`),s+=`<button class="ls-item-notfound-btn" title="Edit" onclick="_listsOpenAddForm('`+e+`','`+t.id+`')">✏️</button>`,s+=`<button class="ls-item-del" onclick="_listsDeleteItem('`+e+`','`+t.id+`')">×</button>`,s+=`</div>`,s}async function bi(e){let t=g.meals.plan[e]||{},n=[];for(let e=0;e<7;e++){let r=t[e]||{};[`b`,`l`,`d`].forEach(e=>{r[e]&&n.push(r[e])})}if(!n.length)return;let r=P(`toto_ai_key`);if(!r){Lr=`food`,Rr=`list`,activateTab(`lists`);return}let i=document.getElementById(`gen-shop-btn`);i&&(i.textContent=`⏳ Generating…`,i.disabled=!0);let a=`Generate a grocery shopping list for these meals: ${n.join(`, `)}.
...
Combine quantities where sensible. No duplicates. No other text.`,o={Produce:`produce`,"Meat & Seafood":`meat`,"Dairy & Eggs":`dairy`,Pantry:`pantry`,Bakery:`bakery`,Frozen:`frozen`,Household:`cleaning`,Other:`other`};try{let e=(await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":r,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:a}]})})).json()).content[0].text.match(/\[[\s\S]*\]/);if(!e)throw Error(`No JSON`);let t=JSON.parse(e[0]);g.lists||(g.lists={}),g.lists.food||(g.lists.food={items:[],weeklyBudget:200,budget:0,stores:[],favourites:[],history:[]});let n=g.lists.food.items,i=0;t.forEach(e=>{n.some(t=>t.name.toLowerCase()===e.name.toLowerCase()&&t.state===`active`)||n.push({id:`si-meal-`+Date.now()+`-`+ i++,name:e.name,quantity:1,unit:`units`,notes:e.qty||``,aisle:o[e.cat]||(Fr?Fr(e.name):`other`),state:`active`,addedBy:`meals`,addedAt:new Date().toISOString(),mealTag:`Meal plan`,manualPrice:null,barcodeId:null})}),window.saveData(g),Lr=`food`,Rr=`list`,activateTab(`lists`)}catch{i&&(i.textContent=`🛒 Generate shopping list`,i.disabled=!1)}}var xi=[`Living Room`,`Dining Room`,`Kitchen`,`Master Bedroom`,`Bedroom 2`,`Bedroom 3`,`Study / Office`,`Bathroom`,`Laundry`,`Outdoor / Alfresco`,`Other`];function Si(e={}){let t=e.deliveryDate?(()=>{let[t,n,r]=e.deliveryDate.split(`-`);return`${r}/${n}/${t}`})():``;return`
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <input class="form-input" id="f-furn-vendor" type="text" maxlength="200" value="${E(e.vendor||``)}" placeholder="e.g. Nick Scali">
      </div>
      <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input class="form-input" id="f-furn-notes" type="text" maxlength="200" value="${E(e.notes||``)}" placeholder="Optional — colour, dimensions, order number...">
    </div>
    <div class="form-group">
  ...
  `}function Ci(e){return{id:e,name:document.getElementById(`f-furn-name`).value.trim(),room:document.getElementById(`f-furn-room`).value,vendor:document.getElementById(`f-furn-vendor`).value.trim(),price:parseFloat(document.getElementById(`f-furn-price`).value)||0,status:document.getElementById(`f-furn-status`).value,funding:document.getElementById(`f-furn-funding`).value,deliveryDate:document.getElementById(`f-exp-duedate`).value||null,notes:document.getElementById(`f-furn-notes`).value.trim()}}function wi(){window.openModal(`Add Furniture Item`,Si(),()=>{let e=Ci(N(g.furniture));e.name&&(window.logActivity(`Added furniture`,e.name),g.furniture.push(e),window.saveData(g),window.closeModal(),window.renderAll())})}function Ti(e){let t=g.furniture.find(t=>t.id===e);window.openModal(`Edit Furniture Item`,Si(t),()=>{let n=Ci(e);window.logActivity(`Edited furniture`,n.name||t.name),Object.assign(t,n),window.saveData(g),window.closeModal(),window.renderAll()})}function Ei(e){if(!confirm(`Delete this item?`))return;let t=g.furniture.find(t=>t.id===e);window.logActivity(`Deleted furniture`,t?t.name:``),g.furniture=g.furniture.filter(t=>t.id!==e),window.saveData(g),window.renderAll()}function Di(e={}){let t=e.deliveryDate?(()=>{let[t,n,r]=e.deliveryDate.split(`-`);return`${r}/${n}/${t}`})():``;return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Item Name</label>
        <input class="form-input" id="f-appl-name" type="text" maxlength="200" value="${E(e.name||``)}" placeholder="e.g. Dishwasher">
      </div>
      <div class="form-group">
        <label class="form-label">Room</label>
    ...
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Store / Vendor</label>
        <input class="form-input" id="f-appl-vendor" type="text" maxlength="200" value="${E(e.vendor||``)}" placeholder="e.g. Harvey Norman">
      </div>
      <div class="form-group">
        <label class="form-label">Price (AUD)</label>
    ...
    <div class="form-group">
      <label class="form-label">Notes</label>
      <input class="form-input" id="f-appl-notes" type="text" maxlength="200" value="${E(e.notes||``)}" placeholder="Optional — model number, colour, order reference...">
    </div>
    <div class="form-group">
      <label class="form-label">Funding</label>
  ...
  `}function Oi(e){return{id:e,name:document.getElementById(`f-appl-name`).value.trim(),room:document.getElementById(`f-appl-room`).value,vendor:document.getElementById(`f-appl-vendor`).value.trim(),price:parseFloat(document.getElementById(`f-appl-price`).value)||0,status:document.getElementById(`f-appl-status`).value,funding:document.getElementById(`f-appl-funding`).value,deliveryDate:document.getElementById(`f-exp-duedate`).value||null,notes:document.getElementById(`f-appl-notes`).value.trim()}}function ki(){window.openModal(`Add Appliance`,Di(),()=>{let e=Oi(N(g.appliances));e.name&&(window.logActivity(`Added appliance`,e.name),g.appliances.push(e),window.saveData(g),window.closeModal(),window.renderAll())})}function Ai(e){let t=g.appliances.find(t=>t.id===e);window.openModal(`Edit Appliance`,Di(t),()=>{let n=Oi(e);window.logActivity(`Edited appliance`,n.name||t.name),Object.assign(t,n),window.saveData(g),window.closeModal(),window.renderAll()})}function ji(e){if(!confirm(`Delete this item?`))return;let t=g.appliances.find(t=>t.id===e);window.logActivity(`Deleted appliance`,t?t.name:``),g.appliances=g.appliances.filter(t=>t.id!==e),window.saveData(g),window.renderAll()}function Mi(){let[e,t]=window.selectedBudgetMonth.split(`-`).map(Number),n=new Date(e,t-2,1);window.selectedBudgetMonth=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,window.safeRender(Pi),window.safeRender(renderBudget)}function Ni(){let[e,t]=window.selectedBudgetMonth.split(`-`).map(Number),n=new Date(e,t,1);window.selectedBudgetMonth=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,window.safeRender(Pi),window.safeRender(renderBudget)}function Pi(){let e=window.getMonthData(window.selectedBudgetMonth),t=e.income,n=e.expenses,r=M(t),i=M(n),a=r-i,o=r>0?Math.round(a/r*100):0,s={};n.forEach(e=>{let t=e.category||`Other`;s[t]=(s[t]||0)+j(e)});let c=Object.entries(s).sort((e,t)=>t[1]-e[1]),l=g.budget.actuals[window.selectedBudgetMonth]||{},u=n.reduce((e,t)=>e+window.getActual(t.id,window.selectedBudgetMonth),0),d=u>0,f=`
  ...
  `;if(f+=`<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(320px,1fr));gap:20px;margin-bottom:20px">`,f+=`
    <div class="section">
      <div class="section-header">
        ...
        <span style="font-size:15px;font-weight:700;color:var(--success)">${D(r)}</span>
      </div>
      <div class="table-wrap">
        <table>
          <thead><tr><th>Source</th><th>Frequency</th><th class="amount">Monthly</th></tr></thead>
          <tbody>
            ${t.length===0?`<tr><td colspan="3" style="text-align:center;color:var(--text-muted);padding:20px">No income added yet</td></tr>`:t.map(e=>{let t=r>0?Math.round(j(e)/r*100):0;return`<tr>
                    <td style="font-weight:500;border-left:4px solid #10b981">${T(e.name)}</td>
                    <td style="color:var(--text-muted);font-size:12px">${freqDisplayItem(e)}</td>
                    <td class="amount">${D(j(e))} <span style="color:var(--text-muted);font-size:11px">${t}%</span></td>
                  </tr>`}).join(``)}
          </tbody>
        </table>
      </div>
  ...
  `,f+=`
    <div class="section">
      <div class="section-header">
        ...
        <span style="font-size:15px;font-weight:700;color:var(--danger)">${D(i)}</span>
      </div>
      <div style="padding:16px 20px">
        ${c.length===0?`<div style="color:var(--text-muted);text-align:center;padding:20px">No expenses added yet</div>`:c.map(([e,t])=>{let r=colors.expense[e]||`#94a3b8`,a=i>0?t/i*100:0,o=n.filter(t=>(t.category||`Other`)===e).reduce((e,t)=>e+(l[t.id]||0),0),s=n.some(t=>(t.category||`Other`)===e&&l[t.id]!==void 0);return`
                <div style="margin-bottom:16px">
                  <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:5px">
                    ...
                    <span style="font-size:13px;font-weight:600">${D(t)}
                  ...
                  ${s?`<div style="font-size:11px;color:var(--text-muted);margin-top:3px">Actual: ${D(o)}</div>`:``}
                </div>
              `}).join(``)}
      </div>
    </div>
  `,f+=`</div>`,d){let e=i-u;f+=`
      <div class="section" style="margin-bottom:20px">
        <div class="section-header">
          ...
          <div style="display:flex;gap:16px;align-items:center;font-size:13px;flex-wrap:wrap">
            <span>Budget: <strong>${D(i)}</strong></span>
            <span>Actual: <strong>${D(u)}</strong></span>
            <span style="font-weight:600;color:${e>=0?`var(--success)`:`var(--danger)`}">
              ${e>=0?`▼`:`▲`} ${D(Math.abs(e))} ${e>=0?`under`:`over`}
            </span>
          </div>
        </div>
        <div class="table-wrap">
          <table>
            ...
            <tbody>
              ${n.filter(e=>l[e.id]!==void 0).map(e=>{let t=j(e),n=l[e.id]||0,r=t-n,i=colors.expense[e.category||`Other`]||`#94a3b8`;return`<tr>
                    <td style="font-weight:500;border-left:4px solid ${i}">${T(e.name)}</td>
    ...
    `}let p=window.getLast6Months().map(e=>{let t=window.getMonthData(e);return{label:window.monthShortLabel(e),income:M(t.income),expenses:M(t.expenses),actual:Object.values(g.budget.actuals[e]||{}).reduce((e,t)=>e+t,0)}}),m=Math.max(...p.flatMap(e=>[e.income,e.expenses,e.actual]),1),h=524/p.length,_=h*.22,v=[0,.25,.5,.75,1].map(e=>{let t=148-e*136;return`<line x1="64" y1="${t}" x2="588" y2="${t}" stroke="#e2e8f0" stroke-width="1"/>
      <text x="59" y="${t+4}" text-anchor="end" font-size="9" fill="#94a3b8">${D(e*m)}</text>`}).join(``),y=p.map((e,t)=>{let n=64+t*h+h*.05,r=e.income>0?e.income/m*136:0,i=e.expenses>0?e.expenses/m*136:0,a=e.actual>0?e.actual/m*136:0,o=n+_+_/2+h*.04;return`
  ...
  `,document.getElementById(`money-content`).innerHTML=f}function Fi(){if(g.setupProgressDismissed)return``;let e=window.setupProgressTasks(),t=e.filter(e=>e.done),n=e.filter(e=>!e.done),r=t.length,i=e.length,a=Math.round(r/i*100);if(r===i)return`<div class="td-card td-card-win" style="display:flex;align-items:center;gap:12px;margin-bottom:10px">
      <span style="font-size:22px">🎉</span>
      <div style="flex:1">
    ...
    <div style="margin-top:10px;border-top:1px solid var(--hairline-soft);padding-top:10px">
      ...
      ${window._spDoneExpanded?`<div style="display:flex;flex-direction:column;gap:5px">${u}</div>`:``}
    </div>`:``}
    ...
    </div>`}).join(``)+`</div>`}function Ui(e){let t=e.onclick?e.onclick:e.tab?`activateTab('${e.tab}')`:``,n=Ri(e),r=[`red`,`amber`,`green`,`blue`].includes(e.cls)?e.cls:`grey`;return`<div class="brief-row"${t?` onclick="${t}"`:``}>
    ...
    <svg class="brief-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
  </div>`}function Wi(){let e=document.getElementById(`today-content`);if(!e)return;let t=new Date,r=t.getHours(),i=t.toISOString().slice(0,10);function a(e){return e<5?`overnight`:e<12?`morning`:e<17?`afternoon`:e<21?`evening`:`night`}let o=a(r),s={morning:`Good morning,`,afternoon:`Good afternoon,`,evening:`Wind down,`,night:`Tomorrow at a glance —`,overnight:`Still up,`}[o]||`Hello,`,c=window._currentUser?.displayName?.split(` `)[0]||g.settings?.adultName?.split(` `)[0]||g.settings?.adults?.[0]?.name?.split(` `)[0]||g.householdProfile?.members?.find(e=>e.role===`adult`)?.name?.split(` `)[0]||``,l=t.toLocaleDateString(`en-AU`,{weekday:`long`,month:`long`,day:`numeric`}).toUpperCase(),u=[],d=(g.bills||[]).map(e=>({...e,days:n(e)})).filter(e=>e.days!==null&&e.days<=2).sort((e,t)=>e.days-t.days);(g.maintenance||[]).filter(e=>{let t=window._maintDaysUntil(e);return t!==null&&t<0}),(g.documents||[]).filter(e=>e.expiryDate&&new Date(e.expiryDate)<t),(g.vehicles||[]).filter(e=>e.regoExpiry&&new Date(e.regoExpiry)<t);let f=[];(g.documents||[]).forEach(e=>{e.expiryDate&&new Date(e.expiryDate)<t&&f.push({label:T(e.name),sub:`Document expired`,cls:`alert`,tab:`documents`})}),(g.maintenance||[]).forEach(e=>{let t=window._maintDaysUntil(e);t!==null&&t<0&&f.push({label:T(e.name),sub:`${Math.abs(t)}d overdue`,cls:`watch`,tab:`maintenance`})}),(g.vehicles||[]).forEach(e=>{e.regoExpiry&&new Date(e.regoExpiry)<t&&f.push({label:T(e.name)+` rego`,sub:`Expired`,cls:`alert`,tab:`vehicles`})});let p=d.length>0,m=f.length>0;if(p||m){let e=d.length===1?d[0].days===0?`due today`:d[0].days===1?`due tomorrow`:`due in ${d[0].days} days`:`bill${d.length===1?``:`s`} due soon`,t=p?`
      ...
      <div style="flex:1;min-width:0;background:#F0FDF4;border-radius:var(--r-lg);padding:16px;display:flex;flex-direction:column;justify-content:space-between;min-height:140px;border:1px solid rgba(16,185,129,.18);box-shadow:0 1px 0 rgba(255,255,255,.9) inset">
      ...
      </div>`;u.push({type:`priority`,urgency:d.length>0?3:m?2:0,html:`<div style="display:flex;gap:12px;margin-bottom:12px">${t}${n}</div>`})}let h=o===`evening`||o===`night`?new Date(t.getTime()+864e5).toISOString().slice(0,10):i,_=h===i?`Today`:`Tomorrow`,v=Zt?Zt(h):[];if(v.length>0){let e=t.getHours()*60+t.getMinutes(),n=v.slice(0,4).map((t,n,r)=>{let a=t.allDay||!t.time?`All day`:Qt?Qt(t.time):t.time,o=Jt?Jt(t):``,s=qt?qt(t):{dot:`var(--iris-2)`},c=F?F[t.category]||F.other:{emoji:`📅`,label:``},l=t.time?parseInt(t.time.split(`:`)[0])*60+parseInt(t.time.split(`:`)[1]):-1,u=h===i&&l>=0&&e>=l&&e<l+90,d=n===Math.min(v.length,4)-1,f=c.color||`#f1f5f9`,p=c.text||`#475569`;return p.replace(/^#/,``),`<div class="pl-agenda-ev" style="margin-bottom:${d?`0`:`8px`}">
        <div class="pl-agenda-time-col">
      ...
      </div>`})}let y=window.getMonthData(window.selectedBudgetMonth),b=M(y.income),x=M(y.expenses),S=b-x,C=(y.expenses||[]).reduce((e,t)=>e+window.getActual(t.id,window.selectedBudgetMonth),0),w=new Date(t.getFullYear(),t.getMonth()+1,0).getDate()-t.getDate(),E=x>0?Math.min(100,Math.round(C/x*100)):0;if(b>0||x>0){let e=S>=0?``:`td-money-status-watch`,n=S>=0?`On track`:`Over budget`,r=Math.abs(S),i=[];d.forEach(e=>i.push(`<span class="td-money-flag td-money-flag-watch">${T(e.name)} due ${e.days===0?`today`:e.days===1?`tomorrow`:`in `+e.days+`d`}</span>`)),u.push({type:`money`,urgency:0,html:`<div class="td-card td-card-money">
        ...
        <div class="td-money-flags">${i.join(``)}<span class="td-money-flag">${w} days left</span></div>
      </div>`})}let ee=typeof _routinesForCurrentUser==`function`?_routinesForCurrentUser().filter(e=>_routineMatchesDate(e,i)):[];function te(e){if(!e.triggerTime)return!0;let[n,r]=e.triggerTime.split(`:`).map(Number),i=t.getHours()*60+t.getMinutes(),a=n*60+(r||0);return i>=a-90&&i<a+360}let D=ee.filter(te),ne=typeof _routineTodayKey==`function`?_routineTodayKey():i.replace(/-/g,``),O=ee.filter(e=>!te(e)&&(e.completions?.[ne]||[]).length>0),k=[...new Set([...D,...O])];if(k.length>0){let e=k.map(e=>{let t=(e.completions?.[ne]||[]).map(String),n=e.steps.length,r=t.length,i=n>0?Math.round(r/n*100):0,a=r===n&&n>0,o=te(e),s=e.triggerTime?`<span style="font-family:var(--mono);font-size:10px;color:var(--muted);margin-left:6px">${e.triggerTime}</span>`:``,c=e.steps.map(n=>{let r=t.includes(String(n.id)),i=n.durationMin?`<span style="font-family:var(--mono);font-size:10px;color:var(--muted-soft);margin-left:auto;padding-left:8px;flex-shrink:0">${n.durationMin}m</span>`:``;return`<div class="td-routine-step ${r?`td-routine-step-done`:``}" onclick="_tdToggleStep('${e.id}','${n.id}')">
          ...
          <span class="td-routine-step-label ${r?`td-routine-step-label-done`:``}">${T(n.label)}</span>
        ...
        <div class="td-routine-header">
          ...
          <div style="flex:1;min-width:0">
            <div style="font-size:14px;font-weight:600;color:var(--ink)">${T(e.name)}${s}</div>
        ...
        ${e}
      </div>`})}let re=new Date(t.getTime()+7*864e5).toISOString().slice(0,10),ie=(g.planner?.events||[]).filter(e=>e.date>i&&e.date<=re).sort((e,t)=>e.date.localeCompare(t.date)).slice(0,3),ae=(g.bills||[]).map(e=>({...e,days:n(e)})).filter(e=>e.days!==null&&e.days>2&&e.days<=7);if(ie.length+ae.length>0){let e=[...ie.map(e=>{let t=new Date(e.date+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`short`,day:`numeric`,month:`short`}),n=!e.allDay&&e.time?Qt?Qt(e.time):e.time:``;return`<div class="td-up-row td-clickable" onclick="activateTab('planner');setTimeout(()=>_plannerOpenDetail&&_plannerOpenDetail('${e.id}'),120)">
          ...
          <span class="td-up-title" style="flex:1">${T(e.title)}</span>
        ...
        </div>`}),...ae.map(e=>`<div class="td-up-row td-clickable" onclick="activateTab('bills')">
        <span class="td-up-date">In ${e.days}d</span>
        <span class="td-up-title" style="flex:1">${T(e.name)} <span style="font-family:var(--mono);color:var(--muted)">$${parseFloat(e.amount).toFixed(0)}</span></span>
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--hairline)" stroke-width="2" stroke-linecap="round"><polyline points="9 18 15 12 9 6"/></svg>
      </div>`)].slice(0,4).join(``);u.push({type:`upcoming`,urgency:0,html:`<div class="td-card">
        <div class="td-card-meta"><span class="td-meta-label">Coming up</span><span class="td-meta-count">${ie.length+ae.length}</span></div>
        <div class="td-up-list">${e}</div>
      </div>`})}let A=(g.kids?.profiles||[]).map(e=>{let t=(g.routineAssignments||[]).filter(t=>t.childId===e.id),n=0;return t.forEach(e=>{let t=(g.routines||[]).find(t=>t.id===e.routineId);if(t){let r=_assignmentStreak?_assignmentStreak(e,t.steps.length):0;r>n&&(n=r)}}),{kid:e,streak:n}}).filter(e=>e.streak>=3);if(A.length>0){let e=A[0];u.push({type:`win`,urgency:0,html:`<div class="td-card td-card-win">
        <div class="td-card-meta"><span class="td-meta-label" style="color:var(--lime-deep)">Win</span></div>
        <div class="td-card-headline" style="font-family:var(--serif);font-style:italic">${T(e.kid.name)} did every routine. ${e.streak} days running.</div>
      ...
      </div>`,s=i>0?`#FFF4EE`:`#F0FDF4`,c=i>0?`rgba(249,115,22,.18)`:`rgba(16,185,129,.18)`,l=i>0?`rgba(249,115,22,.15)`:`rgba(16,185,129,.15)`,d=i>0?`#c2410c`:`#059669`,f=i>0?`var(--ember)`:`var(--good)`,p=a?`
      <div onclick="activateTab('kids')" style="flex:1;min-width:0;background:${s};border-radius:var(--r-lg);padding:16px;cursor:pointer;display:flex;flex-direction:column;justify-content:space-between;min-height:130px;border:1px solid ${c};box-shadow:0 1px 0 rgba(255,255,255,.9) inset,0 2px 8px ${l};position:relative;overflow:hidden">
        <div style="position:absolute;top:-20px;right:-20px;width:80px;height:80px;border-radius:50%;background:radial-gradient(circle,${l} 0%,transparent 70%);pointer-events:none"></div>
        <div>
          <div style="font-family:var(--mono);font-size:10px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:${d};margin-bottom:6px">Kids</div>
          <div style="font-size:28px;font-weight:800;color:${f};letter-spacing:-.04em;line-height:1">${i>0?i:`✓`}</div>
          <div style="font-size:12px;color:${d};margin-top:2px">${i>0?`approval${i===1?``:`s`} pending`:`all clear`}</div>
        </div>
        <div style="font-size:12px;font-weight:700;color:${f};margin-top:10px">${i>0?`Review →`:`View kids →`}</div>
      </div>`:``;u.push({type:`lists`,urgency:+(i>0),html:`<div style="display:flex;gap:12px;margin-bottom:12px">${o}${p}</div>`})}function oe(){let e={overnight:`Quiet night.`,morning:`Quiet day ahead.`,afternoon:`Quiet afternoon.`,evening:`Quiet evening.`,night:`Nothing pressing tonight.`},t=[];if(v.length>=3?t.push(`${v.length} things on the calendar.`):v.length===0&&f.length===0&&d.length===0&&t.push(e[o]||`Quiet day ahead.`),d.length>0){let e=d[0];t.push(`${e.name} ${e.days===0?`is due today`:`is due tomorrow`}.`)}return t.length===0&&t.push(e[o]||`Quiet day ahead.`),t.slice(0,2).join(` `)}let j=oe(),N={priority:0,schedule:1,money:2,lists:3,kids:4,slipping:5,upcoming:6,win:7};u.sort((e,t)=>(N[e.type]??9)-(N[t.type]??9));let se=u.map(e=>e.html).join(``),ce=u.length<=1?`<div class="td-calm">You're sorted.<br>See you tomorrow.</div>`:``,le=typeof Fi==`function`?`<div id="setup-progress-card">${Fi()}</div>`:``;if(e.innerHTML=`
    ...
    <div class="td-greeting">
      ...
      <div class="td-greeting-brief">${T(j)}</div>
    </div>
    ...
    ${se}
    ${ce}
  `,g.settings?.typeAMode&&window._checkMissionEscalation(),typeof $i==`function`){let e=typeof window.calcFinancialHealth==`function`?window.calcFinancialHealth():null,n=typeof _mealWeekKey==`function`?_mealWeekKey(0):null,r=n&&g.meals?.plan?.[n]?.[t.getDay()===0?6:t.getDay()-1]||{};$i(u.map(e=>({title:e.type})),S,w,r,e)}}function Gi(){let e=(g.bills||[]).map(e=>({...e,days:n(e)})).filter(e=>e.days!==null&&e.days<=2).sort((e,t)=>e.days-t.days);if(!e.length)return;let t=e.reduce((e,t)=>e+(parseFloat(t.amount)||0),0);qi(`Heads Up`,e.map(e=>{let t=e.days===0?`Due today`:e.days===1?`Tomorrow`:`In ${e.days} days`,n=e.days===0?`background:#FEF2F2;color:#b91c1c`:e.days===1?`background:#FFF4EE;color:#c2410c`:`background:var(--paper);color:var(--muted)`,r=e.amount?`$${parseFloat(e.amount).toLocaleString(`en-AU`,{minimumFractionDigits:2,maximumFractionDigits:2})}`:``,i=e.days===0?`box-shadow:0 0 0 3px rgba(239,68,68,.2)`:e.days===1?`box-shadow:0 0 0 3px rgba(249,115,22,.2)`:``;return`<div style="display:flex;align-items:center;padding:13px 18px;border-bottom:1px solid var(--hairline);gap:14px">
      ...
      <div style="flex:1;min-width:0">
        <div style="font-size:14px;font-weight:600;color:var(--ink)">${T(e.name)}</div>
        ${e.notes?`<div style="font-size:11px;color:var(--muted);margin-top:2px;font-family:var(--mono)">${T(e.notes)}</div>`:``}
      </div>
  ...
  </div>`)}function Ki(){let e=new Date,t=[];(g.documents||[]).forEach(n=>{n.expiryDate&&new Date(n.expiryDate)<e&&t.push({label:n.name,sub:`Documents`,badge:`Expired`,cls:`alert`,tab:`documents`})}),(g.maintenance||[]).forEach(e=>{let n=window._maintDaysUntil(e);n!==null&&n<0&&t.push({label:e.name,sub:`Maintenance`,badge:`${Math.abs(n)}d overdue`,cls:`watch`,tab:`maintenance`})}),(g.vehicles||[]).forEach(n=>{n.regoExpiry&&new Date(n.regoExpiry)<e&&t.push({label:n.name+` rego`,sub:`Vehicles`,badge:`Expired`,cls:`alert`,tab:`vehicles`})}),t.length&&qi(`Slipping`,t.map(e=>{let t=e.cls===`alert`?`#ef4444`:`var(--ember)`,n=e.cls===`alert`?`box-shadow:0 0 0 3px rgba(239,68,68,.15)`:`box-shadow:0 0 0 3px rgba(249,115,22,.18)`,r=e.cls===`alert`?`background:#FEF2F2;color:#b91c1c`:`background:#FFF4EE;color:#c2410c`;return`<div onclick="activateTab('${e.tab}');_tdCloseSheet()" style="display:flex;align-items:center;padding:13px 18px;border-bottom:1px solid var(--hairline);gap:14px;cursor:pointer">
      <div style="width:8px;height:8px;border-radius:50%;background:${t};flex-shrink:0;${n}"></div>
      <div style="flex:1;min-width:0">
        <div style="font-size:14px;font-weight:600;color:var(--ink)">${T(e.label)}</div>
  ...
  </div>`)}function qi(e,t){let n=document.getElementById(`td-sheet-overlay`);n||(n=document.createElement(`div`),n.id=`td-sheet-overlay`,n.style.cssText=`position:fixed;inset:0;z-index:1200;display:flex;flex-direction:column;justify-content:flex-end;background:rgba(0,0,0,.4)`,n.onclick=e=>{e.target===n&&Ji()},document.body.appendChild(n)),n.innerHTML=`
    <div id="td-sheet-panel" style="background:var(--pearl);border-radius:24px 24px 0 0;max-height:80vh;display:flex;flex-direction:column;padding-bottom:env(safe-area-inset-bottom,16px)">
      <div style="display:flex;align-items:center;justify-content:space-between;padding:18px 18px 14px;border-bottom:1px solid var(--hairline);flex-shrink:0">
        ...
        <div style="font-size:17px;font-weight:800;color:var(--ink);letter-spacing:-.015em">${T(e)}</div>
    ...
    </div>`,n.style.display=`flex`}function Ji(){let e=document.getElementById(`td-sheet-overlay`);e&&(e.style.display=`none`)}function Yi(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(!n)return;let r=_routineTodayKey();n.completions||(n.completions={}),n.completions[r]||(n.completions[r]=[]),n.completions[r]=n.completions[r].map(String);let i=String(t),a=n.completions[r].indexOf(i);a===-1?n.completions[r].push(i):n.completions[r].splice(a,1),window.saveData(g),Wi()}function Xi(){let e=[],t=new Date,n=window.getMonthData(window.selectedBudgetMonth),r=M(n.income)-M(n.expenses);r<0&&e.push({headline:`Spending is ahead of budget this month.`,detail:`You're $${Math.abs(r).toFixed(0)} over.`,action:`budget`}),(g.documents||[]).filter(e=>e.expiryDate).forEach(n=>{let r=Math.ceil((new Date(n.expiryDate)-t)/864e5);r>=0&&r<=30&&e.push({headline:`${n.name} expires in ${r} day${r===1?``:`s`}.`,detail:`Keep it updated.`,action:`documents`})}),e.length===0&&e.push({headline:`All clear. Nothing to flag.`,detail:`Check back later.`,action:null});let i=e.map(e=>`<div style="padding:16px 0;border-bottom:1px solid var(--hairline)">
    <div style="font-family:var(--serif);font-style:italic;font-size:17px;font-weight:400;margin-bottom:4px;color:var(--ink)">${T(e.headline)}</div>
    <div style="font-size:13px;color:var(--muted)">${T(e.detail)}</div>
  ...
  </div>`).join(``);typeof window.openModal==`function`&&window.openModal(`💡 Insights`,`<div style="padding:0 4px">${i}</div>`,null)}var Zi=``,Qi=``;async function $i(e,t,n,r,i){let a=P(`toto_ai_key`);if(!a)return;let o=new Date().toISOString().slice(0,10);if(Zi===o&&Qi){let e=document.getElementById(`today-briefing-text`);e&&(e.textContent=Qi);return}let s=e.filter(e=>e.cls===`red`).map(e=>e.title),c=e.filter(e=>e.cls===`amber`).map(e=>e.title),l=`You are Toto, a friendly family personal assistant app. Write a 2-sentence daily briefing for the user based on this context:

${[`Budget: ${D(Math.abs(t))} ${t>=0?`surplus`:`over budget`}, ${n} days left in the month`,`Health score: ${i.total}/100 (${i.grade})`,s.length?`Urgent: ${s.join(`, `)}`:``,c.length?`Coming up: ${c.join(`, `)}`:``,r.d?`Dinner tonight: ${r.d}`:`No dinner planned`,`${(g.goals||[]).filter(e=>e.status!==`achieved`).length} active goals`].filter(Boolean).join(`. `)}
...
- Don't start with "Here's" or "Today"`;try{let e=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":a,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:100,messages:[{role:`user`,content:l}]})});if(!e.ok)return;let t=(await e.json()).content[0].text.trim().replace(/^["']|["']$/g,``);Qi=t,Zi=o;let n=document.getElementById(`today-briefing-text`);n&&(n.textContent=t)}catch{}}function ea(){let e=g,r=e.buildContract,i=(e.netWorth.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),a=(e.netWorth.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),o=i-a,s=e.netWorth.snapshots||[],c=``;if(s.length>=2){let e=o-s[s.length-2].netWorth;c=`<span class="${e>=0?`up`:`dn`}">${e>=0?`+`:``}${fmtNW(e)}</span> vs last snapshot`}let l=window.selectedBudgetMonth,u=window.getMonthData(l),d=M(u.income),f=M(u.expenses),p=d-f,m=(e.subscriptions||[]).reduce((e,t)=>e+subMonthlyAmount(t),0),h=(e.bills||[]).filter(e=>{let t=n(e);return t>=0&&t<=31}).reduce((e,t)=>e+(parseFloat(t.amount)||0),0),_=[...e.bills||[]].filter(e=>n(e)>=-1).sort((e,t)=>n(e)-n(t)).slice(0,5),v=(e.goals||[]).filter(e=>e.status!==`achieved`).slice(0,4),y=r.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0),b=(r.variations||[]).filter(e=>e.status===`approved`).reduce((e,t)=>e+(t.amount||0),0),x=r.total+b,S=Math.round(y/x*100),C=r.stages.find(e=>!e.paid),w=((e.kids||{}).completions||[]).filter(e=>e.status===`pending`).length+((e.kids||{}).redemptions||[]).filter(e=>e.status===`pending`).length,E=window.getLast6Months(),ee=M(u.expenses),te=E.map(e=>{let t=Object.values(g.budget.actuals[e]||{}).reduce((e,t)=>e+t,0);return{label:window.monthShortLabel(e),budget:ee,actual:t}}),ne=ee>0||te.some(e=>e.actual>0),O=window.calcFinancialHealth(),k=251.3,re=(O.total/100*k).toFixed(1),ie=O.dimensions.map(e=>{let t=Math.round(e.score/e.max*100),n=t>=75?`#10b981`:t>=50?`#f59e0b`:`#ef4444`;return`
    ...
    <div class="db-widget" style="margin:0 24px 20px">
    ...
    </div>`,A=``;if(ne){let e=Math.max(...te.flatMap(e=>[e.budget,e.actual]),1),t=532/te.length,n=t*.28,r=t*.04;A=`<div class="db-widget">
      <div class="db-widget-header">
      ...
      <div style="padding:12px 16px 8px">
        ...
        <text x="53" y="${n+4}" text-anchor="end" font-size="9" fill="#94a3b8">${D(t*e)}</text>`}).join(``)}${te.map((i,a)=>{let o=58+a*t+t*.08,s=i.budget>0?i.budget/e*140:0,c=i.actual>0?i.actual/e*140:0,l=i.actual>i.budget?`#ef4444`:`#10b981`;return`<rect x="${o}" y="${150-s}" width="${n}" height="${s}" fill="#2563eb" opacity="0.65" rx="2"/>
    ...
    <div class="db-hero-row">
      <div class="db-nw-card" onclick="activateTab('networth')" style="cursor:pointer">
        ...
        <div style="font-size:12px;opacity:0.6;margin-top:12px">${D(i)} assets · ${D(a)} liabilities</div>
      </div>
      <div class="db-stats-col">
        <div class="db-stat">
          <div class="db-stat-val ${p>=0?`green`:`red`}">${D(Math.abs(p))}</div>
    ...
    <div class="db-grid">
      <div>
        ...
        <div class="db-widget">
          ...
          ${_.length?_.map(e=>{let r=n(e),i=r<0?`<span class="bill-due-badge overdue">Overdue</span>`:r===0?`<span class="bill-due-badge today">Today</span>`:r<=7?`<span class="bill-due-badge soon">${r}d</span>`:`<span class="bill-due-badge ok">${t(e).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}</span>`;return`<div class="db-bill-row">
              ...
              <div class="db-bill-name">${T(e.name)}</div>
              ${i}
              <div class="db-bill-amount">${D(parseFloat(e.amount)||0)}</div>
        ...
        <div class="db-widget">
          ...
          ${v.length?v.map(e=>{let t=Math.min(Math.round((e.saved||0)/(e.target||1)*100),100);return`<div class="db-goal-row">
              <div class="db-goal-top">
                <span class="db-goal-name">${e.emoji||`🎯`} ${T(e.name)}</span>
                <span class="db-goal-pct">${D(e.saved||0)} of ${D(e.target||0)} · ${t}%</span>
              </div>
      ...
      <div>
        ...
        <div class="db-widget">
          <div class="db-widget-header">
            <span class="db-widget-title">Budget · ${window.monthLabel(l)}</span>
          ...
          <div class="db-budget-row">
            ...
            <span class="db-budget-val" style="color:#10b981">${D(d)}</span>
          </div>
          <div class="db-budget-row">
            <span class="db-budget-label">Expenses</span>
            <span class="db-budget-val" style="color:#ef4444">${D(f)}</span>
          </div>
          <div class="db-budget-row" style="border-top:2px solid var(--border)">
            ...
            <span class="db-budget-val" style="color:${p>=0?`#10b981`:`#ef4444`}">${D(Math.abs(p))}</span>
          </div>
        </div>
        ...
        <div class="db-widget">
          ...
          <div style="padding:14px 18px">
            <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:8px">
              <span style="font-weight:600">${D(y)} paid</span>
              <span style="color:#94a3b8">${S}% of ${D(x)}</span>
            </div>
            <div class="db-build-bar" style="margin:0 0 10px">
              <div class="db-build-fill" style="width:${S}%"></div>
            </div>
            ${C?`<div style="font-size:12px;color:#64748b">Next: <strong>${T(C.name)}</strong> — ${D(C.amount)}</div>`:`<div style="font-size:12px;color:#10b981;font-weight:600">✓ All stages paid</div>`}
          </div>
        </div>
      </div>
    </div>
    ...
    ${A}
  `;document.getElementById(`dashboard-content`).innerHTML=oe}function ta(){function e(e){return e.replace(/[^a-z0-9]/gi,`_`)}function t(t,n,r,i){let a=`${t}_${e(n)}`;return`
      <div class="color-row">
    ...
    <div class="settings-profile" style="margin:0 0 8px">
      ...
      <div style="flex:1;min-width:0">
        <div class="profile-name">${T(f)}</div>
        ${p?`<div class="profile-email">${T(p)}</div>`:``}
    ...
    <div class="toto-sec-header" style="margin-top:6px"><span class="toto-sec-title">Settings</span></div>`+u(`ai`,`🤖 AI Assistant (Toto)`,`Powers cost estimation, Toto chat, and CSV import analysis`,`
              ...
              <div style="display:flex;align-items:flex-start;gap:12px;padding:12px 20px;border-bottom:1px solid var(--border)">
                ...
                <div style="flex:1;min-width:0">
                  <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-bottom:3px">
                    <span style="font-weight:600;font-size:13px">${T(e.name)}</span>
                    <span style="display:inline-block;padding:2px 10px;border-radius:99px;font-size:11px;font-weight:600;color:#fff;background:${l(e.action)}">${T(e.action)}</span>
                    ${e.detail?`<span style="font-size:13px;color:var(--text)">${T(e.detail)}</span>`:``}
                  </div>
            ...
            ${s?`<button onclick="event.stopPropagation();clearAdultPin(${a})" style="padding:6px 10px;border:1px solid #fecaca;border-radius:6px;background:var(--surface);font-size:11px;font-weight:600;color:#b91c1c;cursor:pointer">Remove</button>`:``}
              ...
              <div style="flex:1">
                ...
                <div style="flex:1">
                  ...
                  <div style="font-size:11px;color:#64748b">${T((e||{}).email||`Joined via invite`)}</div>
                </div>
                ...
                <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
                  ...
                  <div style="flex:1">
                    ...
                    <div style="font-size:11px;color:#78350f">Expires ${new Date(a.expiresAt).toLocaleDateString()}${a.email?` · `+T(a.email):``}</div>
                  </div>
                </div>
                <div style="display:flex;gap:6px">
                ...
                <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
                  ...
                  <div style="flex:1">
                    ...
                    <div style="font-size:11px;color:var(--text-muted)">Send an invite link so ${T(r.name||`this person`)} can join</div>
                  </div>
                </div>
              ...
              </div>`+c}}else{let e=(g.kids?.profiles||[]).find(e=>e.name&&r.name&&e.name.toLowerCase()===r.name.toLowerCase()),t=!!e?.pinHash,n=!!(r.name&&r.name.trim());d=e&&window._isPinHardLocked&&window._isPinHardLocked(e.id)?`<div style="padding:10px 12px;background:#fef2f2;border-radius:8px;border:1px solid #fecaca">
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
                <span style="font-size:16px">🔒</span>
                <div style="flex:1">
              ...
              <div style="flex:1">
                ...
                <div style="font-size:11px;color:var(--text-muted)">${t?`PIN is active — tap to change it`:`Set a PIN so `+T(r.name)+` can log in`}</div>
              </div>
              ...
              <div style="flex:1">
                ...
                <div style="font-size:11px;color:var(--text-muted)">Save changes first, then set a PIN for ${T(r.name)}</div>
              </div>
              <button onclick="event.stopPropagation();window._ensureKidProfileAndPin('${E(r.name)}')" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;background:var(--surface);font-size:11px;font-weight:600;color:var(--text);cursor:pointer">Set PIN</button>
            </div>`:`<div style="display:flex;align-items:center;gap:8px;padding:10px 12px;background:var(--surface2);border-radius:8px;border:1px solid var(--border)">
              <span style="font-size:16px">🔢</span>
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px;background:var(--surface2);border-radius:10px;border:1px solid var(--border)">
        ...
        <button onclick="event.stopPropagation();state.setupProgressDismissed=${!g.setupProgressDismissed};window.saveData(state);window._refreshSetupProgress();renderSettings()" class="btn btn-secondary btn-sm">
          ${g.setupProgressDismissed?`Show again`:`Hide`}
        </button>
      </div>
    </div>`);let h=window.getDeviceProfile(),_=g.kids?.profiles||[],v=h?h===`adult`?`Adult — opens straight to the full app`:h===`shared`?`Shared — shows profile picker on open`:(_.find(e=>e.id===h)?.name||`Unknown`)+` — kid device`:`Not configured`;m+=u(`this-device`,`📱 This Device`,`Assigned to: ${v}`,`<div class="section-body">
      <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px;background:var(--surface2);border-radius:10px;border:1px solid var(--border)">
        <div>
          <div style="font-size:14px;font-weight:600;color:var(--text)">Assigned to</div>
          <div style="font-size:13px;color:var(--text-muted);margin-top:2px">${T(v)}</div>
        </div>
  ...
  </div>`,m+=`<div class="settings-save-bar" id="settings-save-bar" style="display:${window._settingsDirty?`flex`:`none`}">
  ...
  </div>`,document.getElementById(`settings-content`).innerHTML=m}function na(){if(confirm(`This will permanently delete ALL household data — budget, kids, goals, everything — from this device and the cloud.

This cannot be undone. Are you sure?`)&&confirm(`Last chance. All data will be gone. Continue?`)){if(window._currentUser&&fbStore){let e=window._getHouseholdDocRef();e&&e.delete().catch(()=>{})}at(window.STORAGE_KEY),window._secureClear(HOUSEHOLD_OWNER_KEY),window._fsUnsubscribe&&(window._fsUnsubscribe(),window._fsUnsubscribe=null),fbAuth.signOut().then(()=>{window.location.reload()})}}function ra(){let e=new Blob([JSON.stringify(g,null,2)],{type:`application/json`}),t=document.createElement(`a`);t.href=URL.createObjectURL(e),t.download=`home-budget-backup-${new Date().toISOString().slice(0,10)}.json`,t.click(),URL.revokeObjectURL(t.href)}function ia(e){let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target.result);if(!t.budget){alert(`Invalid backup file — missing budget data.`);return}if(!confirm(`This will replace ALL current data with the backup. Continue?`))return;it(window.STORAGE_KEY,JSON.stringify(t)),location.reload()}catch(e){alert(`Failed to read backup file: `+e.message)}},n.readAsText(t)}function aa(e){let t=document.getElementById(`grp-body-${e}`),n=document.getElementById(`grp-arrow-${e}`);if(!t)return;let r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n&&(n.textContent=r?`▼`:`▲`)}function oa(e){window.budgetViewMode=e,renderBudget()}function sa(){let e=g.buildContract,t=e.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0);e.total-t;let n=e.stages.filter(e=>e.paid).length,r=e.stages.length,i=e.variations||[],a=i.filter(e=>e.status===`approved`).reduce((e,t)=>e+(t.amount||0),0),o=i.filter(e=>e.status===`pending`).reduce((e,t)=>e+(t.amount||0),0),s=e.total+a,c=`
    <div class="section" style="border-left:4px solid ${colors.build.contract}">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:1px;background:var(--border);border-bottom:1px solid var(--border)">
        <div style="background:var(--surface);padding:14px 20px">
          ...
          <div style="font-size:18px;font-weight:700">${D(e.total)}</div>
        </div>
        ${a===0?``:`
        <div style="background:var(--surface);padding:14px 20px">
          ...
          <div style="font-size:18px;font-weight:700;color:${a>0?`var(--danger)`:`var(--success)`}">${a>0?`+`:``}${D(a)}</div>
        </div>
        <div style="background:var(--surface);padding:14px 20px">
          ...
          <div style="font-size:18px;font-weight:700;color:var(--primary)">${D(s)}</div>
        </div>`}
        <div style="background:var(--surface);padding:14px 20px">
          ...
          <div style="font-size:18px;font-weight:700;color:var(--success)">${D(t)}</div>
        </div>
        <div style="background:var(--surface);padding:14px 20px">
          ...
          <div style="font-size:18px;font-weight:700;color:var(--danger)">${D(s-t)}</div>
        </div>
        ${o>0?`
        <div style="background:#fffbeb;padding:14px 20px">
          ...
          <div style="font-size:18px;font-weight:700;color:#d97706">+${D(o)}</div>
        </div>`:``}
      </div>
      ...
      <div style="padding:16px 20px;border-bottom:1px solid var(--border)">
        <div style="display:flex;gap:0;position:relative">
          ${e.stages.map((t,n)=>{let r=(t.amount/e.total*100).toFixed(0),i=!t.paid&&e.stages.slice(0,n).every(e=>e.paid),a=t.paid?`#dcfce7`:i?`#dbeafe`:`var(--surface2)`,o=t.paid?`#16a34a`:i?`var(--primary)`:`var(--border)`,s=t.paid?`#15803d`:i?`var(--primary)`:`var(--text-muted)`,c=t.paid?`✓`:i?`→`:`${n+1}`,l=t.paid&&t.paidDate?k(t.paidDate):t.expectedDate?`Exp. `+k(t.expectedDate):``,u=!t.paid&&t.expectedDate&&isOverdue(t.expectedDate);return`
            <div style="flex:1;min-width:0;border:1px solid ${u?`var(--danger)`:o};border-radius:8px;padding:10px 10px 8px;margin-right:${n<e.stages.length-1?`6px`:`0`};background:${u?`#fef2f2`:a};cursor:pointer;position:relative" onclick="openEditStage('${t.id}')" title="Edit ${E(t.name)}">
              ...
              <div style="font-size:12px;font-weight:600;color:var(--text);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;margin-bottom:2px">${T(t.name)}</div>
              <div style="font-size:12px;font-weight:700;color:${t.paid?`#15803d`:`var(--text)`}">${D(t.amount)}</div>
        ...
        <table>
          ...
          <tbody>
            ${e.stages.map(t=>{let n=(t.amount/e.total*100).toFixed(1),r=!t.paid&&t.expectedDate&&isOverdue(t.expectedDate),i=t.paid?`<span class="badge paid">Paid</span>`:r?`<span class="badge overdue">Overdue</span>`:`<span class="badge unpaid">Upcoming</span>`;return`<tr>
                ...
                <td class="amount">${D(t.amount)}</td>
                <td style="color:var(--text-muted)">${n}%</td>
                <td>${i}</td>
                <td>${fundingBadge(t.funding||`loan`)}</td>
                <td>${t.expectedDate?k(t.expectedDate):`<span style="color:var(--text-muted)">—</span>`}</td>
                <td>${k(t.paidDate)}</td>
                <td style="color:var(--text-muted)">${T(t.invoiceRef||`—`)}</td>
                <td class="actions">
                  ${attachBtn(`stage-${t.id}`,E(t.name))}
    ...
    <div class="section" style="border-left:4px solid #8b5cf6">
      <div class="section-header">
        <div>
          ...
          <div class="section-subtitle">
            ${i.length===0?`No variations yet`:`${i.filter(e=>e.status===`approved`).length} approved · ${i.filter(e=>e.status===`pending`).length} pending · ${a>=0?`+`:``}${D(a)} net impact`}
          </div>
        </div>
      ...
      ${i.length===0?`<div style="padding:24px 20px;text-align:center;color:var(--text-muted);font-size:13px">No variations raised yet. Builder-initiated or owner-requested changes to the contract will appear here.</div>`:`<div class="table-wrap">
            <table>
              ...
              <tbody>
                ${i.map(e=>`<tr>
                  <td style="font-weight:600;color:var(--primary);white-space:nowrap">${T(e.ref||`—`)}</td>
                  <td style="font-weight:500">${T(e.name)}</td>
                  <td class="amount" style="color:${(e.amount||0)<0?`var(--success)`:`var(--danger)`};font-weight:600">${e.amount>0?`+`:``}${D(e.amount)}</td>
                  <td>${l[e.status]||l.pending}</td>
                  <td>${fundingBadge(e.funding||`loan`)}</td>
                  <td>${k(e.dateRaised)}</td>
                  <td>${k(e.dateApproved)}</td>
                  <td style="color:var(--text-muted);font-size:12px;max-width:160px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${T(e.notes||`—`)}</td>
                  <td class="actions">
              ...
              <tfoot>
                <tr style="background:var(--surface2);border-top:2px solid var(--border)">
                  ...
                  <td class="amount" style="padding:11px 16px;font-weight:700;color:${a>=0?`var(--danger)`:`var(--success)`}">${a>0?`+`:``}${D(a)}</td>
                  <td colspan="6" style="padding:11px 16px;font-size:12px;color:var(--text-muted)">Revised contract: <strong>${D(s)}</strong>${o>0?` · <span style="color:#d97706">+${D(o)} pending</span>`:``}</td>
                </tr>
              </tfoot>
            </table>
          </div>`}
  ...
  `;let u=g.extras,d=u.reduce((e,t)=>e+(t.totalAmount||0),0),f=u.reduce((e,t)=>e+(t.amountPaid||0),0);c+=`
    <div class="section" style="border-left:4px solid ${colors.build.extras}">
      <div class="section-header">
        ...
        <div style="display:flex;align-items:center;gap:10px">
          ${d>0?`<span class="contract-total-badge">${D(f)} / ${D(d)}</span>`:``}
        ...
        <table>
          ...
          <tbody>
            ${u.length===0?`<tr><td colspan="8"><div class="empty"><div class="empty-icon">📋</div>No items yet. Add landscaping, solar, or other extras.</div></td></tr>`:u.map(e=>{let t=(e.totalAmount||0)-(e.amountPaid||0),n={"not-quoted":`<span class="badge unpaid">Not Quoted</span>`,quoted:`<span class="badge pending">Quoted</span>`,approved:`<span class="badge" style="background:#ede9fe;color:#5b21b6">Approved</span>`,partial:`<span class="badge partial">Partially Paid</span>`,paid:`<span class="badge paid">Paid</span>`},r=e.dueDate&&isOverdue(e.dueDate)&&e.status!==`paid`,i=n[e.status||`not-quoted`]+(r?` <span class="badge overdue">Overdue</span>`:``);return`<tr>
                <td style="font-weight:500">${T(e.name)}</td>
                <td>${e.vendor?T(e.vendor):`<span style="color:var(--text-muted)">—</span>`}</td>
                <td class="amount">${e.totalAmount?D(e.totalAmount):`<span class="amount muted">TBC</span>`}</td>
                <td class="amount">${D(e.amountPaid)}</td>
                <td class="amount ${t>0?``:`muted`}">${t>0?D(t):`—`}</td>
                <td>${k(e.dueDate)}</td>
                <td>${i}</td>
                <td>${fundingBadge(e.funding||`loan`)}</td>
                <td class="actions">
                  ${attachBtn(`extra-${e.id}`,E(e.name))}
    ...
    <div class="section" style="border-left:4px solid ${colors.build.furniture}">
      <div class="section-header">
        <div>
          ...
          <div class="section-subtitle">${p.length} items · ${D(v)} purchased · ${D(y)} remaining</div>
        </div>
        <div style="display:flex;align-items:center;gap:8px">
          ${p.length>0?`
          <div style="display:flex;gap:6px">
        ...
        <table>
          ...
          <tbody>
            ${p.length===0?`<tr><td colspan="8"><div class="empty"><div class="empty-icon">🛋️</div>No furniture items yet. Add sofas, beds, appliances and more.</div></td></tr>`:p.map(e=>{let t={"to-purchase":`<span class="badge unpaid">To Purchase</span>`,ordered:`<span class="badge partial">Ordered</span>`,delivered:`<span class="badge paid">Delivered</span>`},n=e.deliveryDate&&e.status!==`delivered`&&isOverdue(e.deliveryDate);return`<tr>
                    <td style="font-weight:500">${T(e.name)}</td>
                    <td style="color:var(--text-muted)">${T(e.room||`—`)}</td>
                    <td>${e.vendor?T(e.vendor):`<span style="color:var(--text-muted)">—</span>`}</td>
                    <td class="amount">${e.price?D(e.price):`<span class="amount muted">TBC</span>`}</td>
                    <td>${t[e.status]||t[`to-purchase`]}</td>
                    <td>${fundingBadge(e.funding||`own-funds`)}</td>
                    <td>${e.deliveryDate?n?`<span class="badge overdue">${k(e.deliveryDate)}</span>`:k(e.deliveryDate):`<span style="color:var(--text-muted)">—</span>`}</td>
                    <td style="color:var(--text-muted);font-size:12px;max-width:160px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${T(e.notes||`—`)}</td>
                    <td class="actions">
                      ${attachBtn(`furniture-${e.id}`,E(e.name))}
          ...
          <tfoot>
            <tr style="background:var(--surface2);border-top:2px solid var(--border)">
              ...
              <td class="amount" style="padding:11px 16px;font-weight:700">${D(m)}</td>
              <td colspan="4" style="padding:11px 16px;font-size:12px;color:var(--text-muted)">
                ${D(v)} purchased · ${D(y)} still to buy
              </td>
            </tr>
          </tfoot>`:``}
        </table>
  ...
  `;let b=g.appliances,x=b.reduce((e,t)=>e+(t.price||0),0),S=b.filter(e=>e.status===`delivered`||e.status===`ordered`),C=b.filter(e=>e.status===`to-purchase`),w=S.reduce((e,t)=>e+(t.price||0),0),ee=C.reduce((e,t)=>e+(t.price||0),0);c+=`
    <div class="section" style="border-left:4px solid ${colors.build.appliances}">
      <div class="section-header">
        <div>
          <div class="section-title">Appliances</div>
          <div class="section-subtitle">${b.length} items · ${D(w)} purchased · ${D(ee)} remaining</div>
        </div>
        <div style="display:flex;align-items:center;gap:8px">
          ${b.length>0?`
          <div style="display:flex;gap:6px">
            ...
            <span class="badge unpaid">${C.length} to buy</span>
          </div>`:``}
        ...
        <table>
          ...
          <tbody>
            ${b.length===0?`<tr><td colspan="9"><div class="empty"><div class="empty-icon">🍳</div>No appliances yet. Add fridges, dishwashers, ovens and more.</div></td></tr>`:b.map(e=>{let t={"to-purchase":`<span class="badge unpaid">To Purchase</span>`,ordered:`<span class="badge partial">Ordered</span>`,delivered:`<span class="badge paid">Delivered</span>`},n=e.deliveryDate&&e.status!==`delivered`&&isOverdue(e.deliveryDate);return`<tr>
                    ...
                    <td style="color:var(--text-muted);font-size:12px;max-width:160px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${T(e.notes||`—`)}</td>
                    <td class="actions">
                      ${attachBtn(`appliance-${e.id}`,E(e.name))}
          ...
          <tfoot>
            <tr style="background:var(--surface2);border-top:2px solid var(--border)">
              <td colspan="3" style="padding:11px 16px;font-size:13px;color:var(--text-muted);font-style:italic">Total</td>
              <td class="amount" style="padding:11px 16px;font-weight:700">${D(x)}</td>
              <td colspan="4" style="padding:11px 16px;font-size:12px;color:var(--text-muted)">
                ${D(w)} purchased · ${D(ee)} still to buy
              </td>
            </tr>
          </tfoot>`:``}
        </table>
  ...
  `,document.getElementById(`build-content`).innerHTML=c}function ca(){return g.expenseCategories||DEFAULT_DATA.expenseCategories}function la(){return g.incomeCategories||DEFAULT_DATA.incomeCategories}function ua(e){if(e.type===`spending`){let t=Object.keys(g.budget.actuals).sort().reverse(),n=null;for(let r of t){let t=(window.getMonthData(r).expenses||[]).filter(t=>(t.category||`Other`)===e.category).reduce((e,t)=>e+(g.budget.actuals[r]?.[t.id]||0),0);if(t>0){n=t;break}}let r=e.targetMonthly||0;if(n===null)return{pct:null,label:`No actuals yet`,actual:null,target:r};let i=r>0?Math.max(0,Math.min(100,n/r*100)):0,a=n<=r;return{pct:i,label:`${D(n)} actual vs ${D(r)} limit`,actual:n,target:r,ok:a}}if(e.type===`savings`){let t=e.currentSaved||0,n=e.targetTotal||1;return{pct:Math.min(100,t/n*100),label:`${D(t)} of ${D(n)} saved`,ok:t>=n}}if(e.type===`income`){let t=monthlyTotal(window.getMonthData(window.selectedBudgetMonth).income),n=e.targetMonthly||1;return{pct:Math.min(100,t/n*100),label:`${D(t)}/mo of ${D(n)}/mo target`,ok:t>=n}}return{pct:0,label:``,ok:!1}}var da=`https://api.anthropic.com/v1/messages`,fa={holiday:{label:`Holiday`,emoji:`✈️`,sub:`FLIGHTS · ACCOM · PACKING`,heroGradient:`linear-gradient(135deg, #0F4D8B 0%, #2E96D7 100%)`,sections:[`tasks`,`bookings`],defaultTasks:[{name:`Book flights`},{name:`Book accommodation`},{name:`Travel insurance`},{name:`Check passports valid 6+ months`},{name:`Stop the mail`},{name:`House sitter / dog boarding`}]},reno:{label:`Reno / build`,emoji:`🌳`,sub:`QUOTES · STAGES · PHOTOS`,heroGradient:`linear-gradient(135deg, #166534 0%, #4D7C0F 100%)`,sections:[`tasks`,`quotes`,`stages`],defaultTasks:[{name:`Get 3 quotes`},{name:`Council approval (if needed)`},{name:`Sign contract`},{name:`Schedule start date`},{name:`Materials list`},{name:`Final walkthrough`}]},party:{label:`Party / event`,emoji:`🎉`,sub:`GUESTS · FOOD · DECOR`,heroGradient:`linear-gradient(135deg, #BE123C 0%, #F472B6 100%)`,sections:[`tasks`],defaultTasks:[{name:`Send invitations`},{name:`Confirm headcount`},{name:`Order cake`},{name:`Decorations`},{name:`Food / catering`},{name:`Music / entertainment`}]},"life-event":{label:`Big life event`,emoji:`👶`,sub:`BABY · MOVE · SCHOOL`,heroGradient:`linear-gradient(135deg, #5B21B6 0%, #A78BFA 100%)`,sections:[`tasks`],defaultTasks:[{name:`Make a checklist`},{name:`Tell key people`},{name:`Update insurance / paperwork`},{name:`Set a budget`},{name:`Plan the timeline`}]},seasonal:{label:`Seasonal`,emoji:`🎄`,sub:`XMAS · HOLS · BIRTHDAYS`,heroGradient:`linear-gradient(135deg, #B91C1C 0%, #F59E0B 100%)`,sections:[`tasks`],defaultTasks:[{name:`Set the budget`},{name:`Make a gift list`},{name:`Plan meals / hosting`},{name:`Travel arrangements`}]},custom:{label:`Custom`,emoji:`✨`,sub:`START FROM SCRATCH`,heroGradient:`linear-gradient(135deg, #4B5563 0%, #9CA3AF 100%)`,sections:[`tasks`],defaultTasks:[]}},pa={planning:{label:`Planning`,color:`#6B5CFF`,bg:`#EFEDFF`},active:{label:`Active`,color:`#065F46`,bg:`#DCFCE7`},done:{label:`Done`,color:`#52525B`,bg:`#F4F4F5`},paused:{label:`Paused`,color:`#92400E`,bg:`#FEF3C7`}},z=`list`,ma=null,ha=null,ga=null,_a=``,va=!1,ya=``;Object.defineProperty(window,`_projectsView`,{get(){return z},set(e){z=e},configurable:!0}),Object.defineProperty(window,`_activeProjectId`,{get(){return ma},set(e){ma=e},configurable:!0}),Object.defineProperty(window,`_newProjectTemplate`,{get(){return ha},set(e){ha=e},configurable:!0});function ba(){g.projects||(g.projects=[]),g.activeFamilyGoalProjectId===void 0&&(g.activeFamilyGoalProjectId=null)}function xa(){return ba(),g.projects}function Sa(e){return ba(),g.projects.find(t=>t.id===e)}function Ca(e){let t=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name).map((e,t)=>({id:`a`+t,name:e.name,role:`adult`})),n=(g.kids?.profiles||[]).map(e=>({id:`k`+e.id,name:e.name,role:`child`,emoji:e.emoji})),r=[...t,...n];return(e.members||[]).map(e=>r.find(t=>t.id===e)).filter(Boolean)}function wa(e){return(e.bookings||[]).reduce((e,t)=>e+(t.cost||0),0)+(e.spentManual||0)}function Ta(e){let t=(e.tasks||[]).length,n=(e.tasks||[]).filter(e=>e.done).length;return{total:t,done:n,pct:t>0?Math.round(n/t*100):0}}function B(){let e=document.getElementById(`projects-content`);if(e)if(ba(),z===`detail`&&ma){let t=Sa(ma);if(!t)return z=`list`,ma=null,B();e.innerHTML=Ma(t)}else z===`ai-draft`?e.innerHTML=Ja():z===`new`?e.innerHTML=ka():e.innerHTML=Ea()}function Ea(){let e=xa(),t=e.filter(e=>e.status===`active`),n=e.filter(e=>e.status===`planning`),r=e.filter(e=>e.status===`done`),i=e.filter(e=>e.status===`paused`),a=`
    <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 20px 6px;gap:10px">
      <div>
        <div style="font-size:11px;font-family:var(--mono);font-weight:600;color:var(--muted);letter-spacing:0.5px;text-transform:uppercase">${t.length} active · ${n.length} planning</div>
      </div>
      ...
      </div>`;let o=[];return t.length&&o.push(Da(`Active`,t)),n.length&&o.push(Da(`Planning`,n)),i.length&&o.push(Da(`Paused`,i)),r.length&&o.push(Da(`Done`,r)),a+o.join(``)}function Da(e,t){return`
    <div style="margin:14px 0 0">
      <div style="padding:6px 20px 8px;font-size:11px;font-family:var(--mono);font-weight:600;color:var(--muted);text-transform:uppercase;letter-spacing:0.5px">${T(e)}</div>
      <div style="display:flex;flex-direction:column;gap:10px;padding:0 16px">
        ${t.map(Oa).join(``)}
      </div>
    </div>`}function Oa(e){let t=fa[e.template]||fa.custom,n=pa[e.status]||pa.planning,r=Ta(e),i=wa(e),a=e.startDate?e.endDate?`${k(e.startDate)}–${k(e.endDate)}`:`From ${k(e.startDate)}`:``,o=Ca(e).slice(0,4),s=g.activeFamilyGoalProjectId===e.id;return`
    <div style="background:var(--paper);border:1px solid ${s?`var(--purple)`:`var(--hairline)`};border-radius:20px;overflow:hidden;cursor:pointer" onclick="_projectsOpenDetail('${e.id}')">
      <div style="padding:14px 16px 12px;background:${t.heroGradient};color:#fff">
        <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px">
          <div>
            <div style="font-size:11px;font-family:var(--mono);text-transform:uppercase;letter-spacing:0.5px;opacity:0.8;margin-bottom:3px">
              ${t.emoji} ${t.label}${s?` · ⭐ Family goal`:``}
            </div>
            <div style="font-size:18px;font-weight:700;letter-spacing:-0.3px">${T(e.name)}</div>
            ${a?`<div style="font-size:11px;opacity:0.85;font-family:var(--mono);margin-top:3px">${a}</div>`:``}
          </div>
          <span style="background:rgba(255,255,255,0.20);font-family:var(--mono);font-size:9px;font-weight:600;padding:3px 8px;border-radius:6px;letter-spacing:0.3px;text-transform:uppercase;flex-shrink:0">${n.label}</span>
        </div>
      </div>
      <div style="padding:12px 16px;display:flex;justify-content:space-between;align-items:center;gap:10px">
        <div style="flex:1;min-width:0">
          ${r.total>0?`
            <div style="font-size:11px;color:var(--muted);font-family:var(--mono);margin-bottom:5px">${r.done}/${r.total} TASKS · ${r.pct}%</div>
            <div style="height:5px;background:var(--hairline);border-radius:99px;overflow:hidden">
              <div style="height:100%;width:${r.pct}%;background:var(--purple);border-radius:99px"></div>
            </div>
        ...
        ${e.budget>0?`
          <div style="text-align:right;flex-shrink:0">
            ...
            <div style="font-size:13px;font-weight:600;color:var(--ink)">${D(i)} / ${D(e.budget)}</div>
          </div>`:``}
      </div>
      ${o.length>0?`
        <div style="padding:0 16px 12px;display:flex;gap:4px">
          ${o.map(e=>`<div style="width:22px;height:22px;border-radius:50%;background:${e.role===`child`?`#FF6B5C`:`#5B4CF5`};color:#fff;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:600;border:1.5px solid var(--paper)">${e.role===`child`&&e.emoji?e.emoji:(e.name[0]||`?`).toUpperCase()}</div>`).join(``)}
        </div>`:``}
    </div>`}function ka(){return ha?ja(ha):Aa()}function Aa(){let e=!!P(`toto_ai_key`),t=ya?`<div style="margin-top:10px;font-size:12px;color:#FCA5A5">${T(ya)}</div>`:``,n=e?`
    <div style="margin:8px 16px 0;background:linear-gradient(160deg,#221F1A 0%,#16140F 100%);border-radius:24px;padding:18px;color:#fff;position:relative">
      ...
      <div style="display:flex;align-items:flex-start;gap:10px;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.10);border-radius:16px;padding:12px 14px">
        <textarea id="proj-ai-input" rows="3" placeholder='e.g. "Bali holiday in October, $8K budget, just our family"' style="flex:1;background:transparent;border:none;outline:none;color:#fff;font-size:13px;font-family:var(--sans);line-height:1.4;resize:none;min-height:60px" ${va?`disabled`:``}>${E(_a)}</textarea>
      </div>
      <div style="display:flex;align-items:center;justify-content:space-between;margin-top:10px;gap:10px">
        <span style="font-family:var(--mono);font-size:10px;color:rgba(255,255,255,0.45);letter-spacing:0.3px">${va?`TOTO IS THINKING…`:`TELL TOTO WHAT TO PLAN`}</span>
        <button onclick="_projectsAiSubmit()" ${va?`disabled`:``} style="background:linear-gradient(135deg,var(--iris-2),var(--purple));color:#fff;border:none;border-radius:99px;padding:9px 18px;font-size:12px;font-weight:600;cursor:${va?`wait`:`pointer`};font-family:var(--sans);opacity:${va?.6:1}">${va?`…`:`Go →`}</button>
      </div>
      ${t}
    </div>`:`
    ...
    <div style="margin:0 16px;display:grid;grid-template-columns:1fr 1fr;gap:8px">
      ${Object.entries(fa).map(([e,t])=>`
        <div style="background:var(--paper);border:1px ${e===`custom`?`dashed`:`solid`} var(--hairline);border-radius:18px;padding:14px 12px;cursor:pointer;display:flex;flex-direction:column;gap:6px;${e===`custom`?`background:var(--paper-warm);`:``}" onclick="_projectsPickTemplate('${e}')">
    ...
    </div>`;return`<div style="padding:14px 20px 6px"><button onclick="_projectsBackToList()" style="background:none;border:none;color:var(--muted);font-size:13px;font-family:var(--sans);cursor:pointer;padding:0">← Back</button></div><div style="padding:0 20px 6px"><div style="font-size:24px;font-weight:700;letter-spacing:-0.5px">New project</div><div style="font-family:var(--mono);font-size:11px;color:var(--muted);margin-top:4px">CHOOSE A STARTING POINT</div></div>`+n+`<div style="margin:18px 20px 10px;display:flex;align-items:center;gap:10px;color:var(--muted)"><span style="flex:1;height:1px;background:var(--hairline)"></span><span style="font-family:var(--mono);font-size:10px;font-weight:600;text-transform:uppercase;letter-spacing:0.8px">or pick a template</span><span style="flex:1;height:1px;background:var(--hairline)"></span></div>`+r+`<div style="height:24px"></div>`}function ja(e){let t=fa[e];if(!t)return ha=null,Aa();let n=[...(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name).map((e,t)=>({id:`a`+t,name:e.name,role:`adult`})),...(g.kids?.profiles||[]).map(e=>({id:`k`+e.id,name:e.name,role:`child`,emoji:e.emoji}))];return`<div style="padding:14px 20px 6px"><button onclick="_projectsPickTemplate(null)" style="background:none;border:none;color:var(--muted);font-size:13px;font-family:var(--sans);cursor:pointer;padding:0">← Pick another template</button></div>
    <div style="padding:0 20px 6px">
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:6px">
        <span style="font-size:34px">${t.emoji}</span>
        <div>
          <div style="font-size:22px;font-weight:700;letter-spacing:-0.4px">New ${t.label.toLowerCase()}</div>
          <div style="font-family:var(--mono);font-size:11px;color:var(--muted);margin-top:2px">FILL THE BASICS, EDIT MORE LATER</div>
        </div>
      </div>
    </div>
    <form id="projects-create-form" onsubmit="event.preventDefault();_projectsSaveNew('${e}')" style="margin:6px 16px 0;background:var(--paper);border:1px solid var(--hairline);border-radius:20px;padding:18px;display:flex;flex-direction:column;gap:14px">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:6px">
          ${n.map(e=>`
            <label style="display:flex;align-items:center;gap:6px;background:var(--paper-warm);border:1px solid var(--hairline);border-radius:99px;padding:5px 10px;cursor:pointer;font-size:12px">
              <input type="checkbox" name="proj-member" value="${e.id}" style="margin:0">
              <span>${e.role===`child`&&e.emoji?e.emoji+` `:``}${T(e.name)}</span>
            </label>`).join(``)}
          ${n.length===0?`<span style="font-size:12px;color:var(--muted)">No members set up yet — add them in Settings.</span>`:``}
        </div>
      </div>
      <label style="display:flex;flex-direction:column;gap:4px">
      ...
      <div style="background:var(--purple-tint);border:1px solid var(--purple-soft);border-radius:12px;padding:10px 12px;font-size:12px;color:var(--ink-soft);line-height:1.4">
        <strong>${t.defaultTasks.length} starter task${t.defaultTasks.length===1?``:`s`}</strong> will be added automatically — you can tick them off, swap them, or delete what doesn't apply.
      </div>
      ...
      <div style="display:flex;gap:8px;margin-top:4px">
        ...
        <button type="button" class="btn btn-primary" onclick="event.preventDefault();_projectsSaveNew('${e}')" style="flex:1;padding:12px;justify-content:center">Create project →</button>
      </div>
    </form>
    <div style="height:24px"></div>`}function Ma(e){let t=fa[e.template]||fa.custom;pa[e.status]||pa.planning;let n=Ta(e),r=wa(e),i=(e.budget||0)-r,a=g.activeFamilyGoalProjectId===e.id,o=e.startDate?e.endDate?`${k(e.startDate)} – ${k(e.endDate)}`:`From ${k(e.startDate)}`:`No dates set`,s=Ca(e),c=`
    <div style="margin:6px 16px 0;background:${t.heroGradient};border-radius:24px;padding:18px;color:#fff">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:10px">
        <div style="flex:1;min-width:0">
          <div style="display:inline-block;background:rgba(255,255,255,0.20);font-family:var(--mono);font-size:9px;font-weight:600;padding:3px 8px;border-radius:6px;letter-spacing:0.3px;text-transform:uppercase;margin-bottom:8px">
            ${t.emoji} ${t.label}${a?` · ⭐ FAMILY GOAL`:``}
          </div>
          <div style="font-size:24px;font-weight:700;letter-spacing:-0.5px;line-height:1.1">${T(e.name)}</div>
          <div style="font-family:var(--mono);font-size:11px;color:rgba(255,255,255,0.75);margin-top:4px">${o}${e.location?` · `+T(e.location):``}</div>
        </div>
        <select onchange="_projectsSetStatus('${e.id}',this.value)" style="background:rgba(255,255,255,0.15);color:#fff;border:none;border-radius:8px;padding:5px 8px;font-family:var(--mono);font-size:10px;font-weight:600;letter-spacing:0.3px;text-transform:uppercase;cursor:pointer">
          ${Object.entries(pa).map(([t,n])=>`<option value="${t}" ${e.status===t?`selected`:``}>${n.label}</option>`).join(``)}
        </select>
      </div>
      ${n.total>0?`
        <div style="margin-top:14px">
          <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:6px">
            ...
            <span style="font-size:14px;font-weight:600">${n.done} of ${n.total}</span>
          </div>
          <div style="height:6px;background:rgba(255,255,255,0.15);border-radius:99px;overflow:hidden">
            <div style="height:100%;background:#fff;border-radius:99px;width:${n.pct}%"></div>
          </div>
        </div>`:``}
    </div>`,l=e.budget>0?`
    <div style="margin:12px 16px 0;background:var(--paper);border:1px solid var(--hairline);border-radius:20px;padding:16px">
      <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:8px">
        ...
        <span style="font-size:13px;font-weight:600;color:var(--ink)">${D(e.budget)}</span>
      </div>
      <div style="height:8px;background:var(--hairline-soft);border-radius:99px;overflow:hidden;margin-top:6px">
        <div style="height:100%;background:${i<0?`var(--ember)`:`var(--watch)`};border-radius:99px;width:${Math.min(100,e.budget>0?r/e.budget*100:0)}%"></div>
      </div>
      <div style="display:flex;justify-content:space-between;font-size:11px;color:var(--muted);margin-top:6px;font-family:var(--mono)">
        <span><span style="color:var(--watch)">●</span> ${D(r)} spent</span>
        <span><span style="color:${i<0?`var(--ember)`:`var(--good)`}">●</span> ${i<0?D(-i)+` over`:D(i)+` left`}</span>
      </div>
    </div>`:``,u=s.length>0?`
    <div style="margin:12px 16px 0;background:var(--paper);border:1px solid var(--hairline);border-radius:20px;padding:14px 16px">
      ...
      <div style="display:flex;gap:6px;flex-wrap:wrap">
        ${s.map(e=>`<div style="display:flex;align-items:center;gap:6px;background:var(--paper-warm);border:1px solid var(--hairline);border-radius:99px;padding:4px 10px 4px 4px;font-size:12px">
          <span style="width:22px;height:22px;border-radius:50%;background:${e.role===`child`?`#FF6B5C`:`#5B4CF5`};color:#fff;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:600">${e.role===`child`&&e.emoji?e.emoji:(e.name[0]||`?`).toUpperCase()}</span>
          <span>${T(e.name)}</span>
        </div>`).join(``)}
      </div>
    </div>`:``,d=`
    <div style="margin:18px 20px 6px;display:flex;align-items:center;justify-content:space-between">
      ...
      <button onclick="_projectsAddTask('${e.id}')" style="background:none;border:none;color:var(--purple);font-size:12px;font-weight:600;font-family:var(--mono);text-transform:uppercase;letter-spacing:0.5px;cursor:pointer;padding:0">+ Add</button>
    </div>
    <div style="margin:0 16px;background:var(--paper);border:1px solid var(--hairline);border-radius:18px;overflow:hidden">
      ...
      `:(e.tasks||[]).map(t=>`
        <div style="display:flex;align-items:center;gap:10px;padding:11px 14px;border-bottom:1px solid var(--hairline-soft)">
          <div onclick="_projectsToggleTask('${e.id}','${t.id}')" style="width:20px;height:20px;border-radius:50%;border:1.5px solid ${t.done?`var(--good)`:`var(--muted-soft)`};background:${t.done?`var(--good)`:`transparent`};color:#fff;flex-shrink:0;cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:11px">${t.done?`✓`:``}</div>
          <div style="flex:1;font-size:13px;color:var(--ink);${t.done?`text-decoration:line-through;color:var(--muted)`:``}">${T(t.name)}</div>
          <button onclick="_projectsDeleteTask('${e.id}','${t.id}')" style="background:none;border:none;color:var(--muted-soft);font-size:14px;cursor:pointer;padding:4px">×</button>
        </div>`).join(``)}
    </div>`,f=`
    <div style="margin:12px 16px 0;background:${a?`var(--purple-soft)`:`var(--paper)`};border:1px solid ${a?`var(--purple)`:`var(--hairline)`};border-radius:20px;padding:14px 16px">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:10px">
        <div style="flex:1">
          <div style="font-size:13px;font-weight:600;color:${a?`var(--purple)`:`var(--ink)`}">⭐ Family goal</div>
          <div style="font-size:11px;color:var(--muted);margin-top:3px;line-height:1.4">${a?`Kids contribute chore points towards this project. Set their target below.`:`Make this the active project kids contribute their chore points to.`}</div>
        </div>
        <button onclick="_projectsToggleFamilyGoal('${e.id}')" style="background:${a?`var(--purple)`:`var(--paper-warm)`};color:${a?`#fff`:`var(--ink)`};border:1px solid ${a?`var(--purple)`:`var(--hairline)`};border-radius:99px;padding:6px 12px;font-size:12px;font-weight:600;font-family:var(--sans);cursor:pointer">${a?`Active`:`Set as goal`}</button>
      </div>
      ${a?`
        <div style="margin-top:10px;padding-top:10px;border-top:1px solid var(--purple-soft)">
          <label style="display:flex;align-items:center;gap:8px;font-size:12px;color:var(--ink-soft)">
            ...
            <input type="number" min="0" step="100" value="${e.goalKidPointsTarget||0}" onchange="_projectsSetGoalTarget('${e.id}', this.value)" style="border:1px solid var(--hairline);border-radius:8px;padding:5px 8px;width:80px;font-size:12px;font-family:var(--mono);background:var(--paper)">
            <span style="font-size:11px;color:var(--muted)">points</span>
          </label>
        </div>`:``}
    </div>`,p=e.notes&&e.notes.trim()?`
    <div style="margin:12px 16px 0;background:var(--paper);border:1px solid var(--hairline);border-radius:20px;padding:14px 16px">
      ...
      <div style="font-size:13px;color:var(--ink-soft);line-height:1.5;white-space:pre-wrap">${T(e.notes)}</div>
    </div>`:``,m=`
    <div style="margin:18px 16px 0;display:flex;justify-content:center">
      <button onclick="_projectsDelete('${e.id}')" style="background:none;border:none;color:var(--ember);font-size:12px;font-weight:600;font-family:var(--sans);cursor:pointer;padding:8px">Delete project</button>
    </div>`;return`<div style="padding:14px 20px 6px"><button onclick="_projectsBackToList()" style="background:none;border:none;color:var(--muted);font-size:13px;font-family:var(--sans);cursor:pointer;padding:0">← All projects</button></div>`+c+l+u+f+d+p+m+`<div style="height:24px"></div>`}function Na(){z=`new`,ha=null,B()}function Pa(){z=`list`,ma=null,ha=null,B()}function Fa(e){z=`detail`,ma=e,B()}function Ia(e){ha=e,B()}function La(e){let t=fa[e];if(!t)return;let n=(document.getElementById(`proj-name`)?.value||``).trim();if(!n){document.getElementById(`proj-name`)?.focus();return}let r=document.getElementById(`proj-start`)?.value||``,i=document.getElementById(`proj-end`)?.value||``,a=parseFloat(document.getElementById(`proj-budget`)?.value)||0,o=(document.getElementById(`proj-location`)?.value||``).trim(),s=(document.getElementById(`proj-notes`)?.value||``).trim(),c=document.querySelectorAll(`input[name="proj-member"]:checked`),l=Array.from(c).map(e=>e.value);ba();let u={id:`proj-`+N(g.projects||[]),name:n,emoji:t.emoji,template:e,status:`planning`,members:l,isFamilyGoal:!1,goalKidPointsTarget:0,startDate:r,endDate:i,budget:a,location:o,notes:s,spentManual:0,tasks:t.defaultTasks.map(e=>({id:`t-`+Date.now().toString(36)+Math.random().toString(36).slice(2),name:e.name,done:!1,dueDate:``})),bookings:[],quotes:[],stages:[],createdAt:new Date().toISOString()};g.projects.push(u),window.saveData(g),ma=u.id,z=`detail`,ha=null,B()}function Ra(e){confirm(`Delete this project? This cannot be undone.`)&&(ba(),g.projects=g.projects.filter(t=>t.id!==e),g.activeFamilyGoalProjectId===e&&(g.activeFamilyGoalProjectId=null),window.saveData(g),Pa())}function za(e,t){let n=Sa(e);n&&(n.status=t,window.saveData(g),B())}function Ba(e){ba(),g.activeFamilyGoalProjectId=g.activeFamilyGoalProjectId===e?null:e,window.saveData(g),B()}function Va(e,t){let n=Sa(e);n&&(n.goalKidPointsTarget=Math.max(0,parseInt(t,10)||0),window.saveData(g))}function Ha(e,t){let n=Sa(e);if(!n)return;let r=(n.tasks||[]).find(e=>e.id===t);r&&(r.done=!r.done,r.done?r.completedAt=new Date().toISOString():delete r.completedAt,window.saveData(g),B())}function Ua(e){let t=Sa(e);if(!t)return;let n=(window.prompt(`Task name:`,``)||``).trim();n&&(t.tasks||(t.tasks=[]),t.tasks.push({id:`t-`+Date.now().toString(36)+Math.random().toString(36).slice(2),name:n,done:!1,dueDate:``}),window.saveData(g),B())}function Wa(e,t){let n=Sa(e);n&&(n.tasks=(n.tasks||[]).filter(e=>e.id!==t),window.saveData(g),B())}var Ga=`You are Toto, a family planning assistant. The user has tapped "+ New project" and described what they want to plan. Extract a structured project draft.
...
Output ONLY the JSON. No prose, no \`\`\`json fences.`;async function Ka(){let e=document.getElementById(`proj-ai-input`),t=(e?.value||``).trim();if(!t){e?.focus();return}let n=P(`toto_ai_key`);if(!n){ya=`Add your AI key in Settings first.`,B();return}_a=t,va=!0,ya=``,B();let r=new Date().toISOString().slice(0,10),i=Ga.replace(`%TODAY%`,r);try{let e=await fetch(da,{method:`POST`,headers:{"x-api-key":n,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:800,system:i,messages:[{role:`user`,content:t}]})}),r=await e.json();if(!e.ok)throw Error(r.error?.message||`API error`);let a=qa(r.content?.[0]?.text||``);if(!a||!a.name||!a.template)throw Error(`Toto came back with an unexpected reply. Try again.`);fa[a.template]||(a.template=`custom`),ga={name:String(a.name||``).slice(0,60),template:a.template,startDate:a.startDate||``,endDate:a.endDate||``,budget:Math.max(0,parseFloat(a.budget)||0),location:String(a.location||``),notes:String(a.notes||``),tasks:Array.isArray(a.tasks)?a.tasks.filter(e=>e&&typeof e==`string`).slice(0,12):[]},va=!1,z=`ai-draft`,B()}catch(e){va=!1,ya=e.message||`Something went wrong. Try again.`,B()}}function qa(e){if(!e)return null;try{return JSON.parse(e)}catch{}let t=e.match(/```(?:json)?\s*(\{[\s\S]*?\})\s*```/);if(t)try{return JSON.parse(t[1])}catch{}let n=e.match(/\{[\s\S]*\}/);if(n)try{return JSON.parse(n[0])}catch{}return null}function Ja(){let e=ga;if(!e)return z=`new`,ka();let t=fa[e.template]||fa.custom,n=e.startDate?e.endDate?`${k(e.startDate)} – ${k(e.endDate)}`:`From ${k(e.startDate)}`:``,r=`
    ...
    <div style="margin:8px 20px 0;display:flex;gap:10px;align-items:flex-start">
      ...
      <div style="flex:1;background:var(--ink);color:#fff;border-radius:4px 18px 18px 18px;padding:12px 14px;font-size:13px;line-height:1.4">Sounds like a <strong style="color:var(--lime);font-weight:600">${t.label.toLowerCase()}</strong>! Here's a draft — confirm or tweak.</div>
    </div>`,a=`
    <div style="margin:12px 16px 0;background:var(--paper);border:1.5px solid var(--purple);border-radius:24px;padding:18px;box-shadow:0 8px 24px -4px rgba(91,76,245,0.18)">
      ...
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:6px">
        <span style="font-size:34px">${t.emoji}</span>
        <div style="font-size:22px;font-weight:700;letter-spacing:-0.5px;color:var(--ink)">${T(e.name)}</div>
      </div>
      <span style="display:inline-block;background:var(--purple-soft);color:var(--purple);font-family:var(--mono);font-size:10px;font-weight:600;padding:3px 8px;border-radius:6px;letter-spacing:0.3px;text-transform:uppercase;margin-bottom:14px">${t.emoji} ${t.label} template</span>

      ${n?`<div style="display:flex;align-items:center;gap:10px;padding:10px 0;border-top:1px solid var(--hairline-soft)"><span style="font-family:var(--mono);font-size:10px;font-weight:600;color:var(--muted);text-transform:uppercase;letter-spacing:0.5px;min-width:64px">Dates</span><span style="font-size:13px;color:var(--ink);flex:1">${n}</span></div>`:``}
      ${e.budget>0?`<div style="display:flex;align-items:center;gap:10px;padding:10px 0;border-top:1px solid var(--hairline-soft)"><span style="font-family:var(--mono);font-size:10px;font-weight:600;color:var(--muted);text-transform:uppercase;letter-spacing:0.5px;min-width:64px">Budget</span><span style="font-size:13px;color:var(--ink);flex:1">${D(e.budget)}</span></div>`:``}
      ${e.location?`<div style="display:flex;align-items:center;gap:10px;padding:10px 0;border-top:1px solid var(--hairline-soft)"><span style="font-family:var(--mono);font-size:10px;font-weight:600;color:var(--muted);text-transform:uppercase;letter-spacing:0.5px;min-width:64px">Location</span><span style="font-size:13px;color:var(--ink);flex:1">${T(e.location)}</span></div>`:``}
      ${e.notes?`<div style="display:flex;align-items:flex-start;gap:10px;padding:10px 0;border-top:1px solid var(--hairline-soft)"><span style="font-family:var(--mono);font-size:10px;font-weight:600;color:var(--muted);text-transform:uppercase;letter-spacing:0.5px;min-width:64px;padding-top:1px">Notes</span><span style="font-size:13px;color:var(--ink-soft);flex:1;line-height:1.4;white-space:pre-wrap">${T(e.notes)}</span></div>`:``}

      ${e.tasks.length>0?`
        <div style="margin-top:12px;padding-top:12px;border-top:1px solid var(--hairline-soft)">
          <div style="font-family:var(--mono);font-size:10px;font-weight:600;color:var(--muted);text-transform:uppercase;letter-spacing:0.5px;margin-bottom:8px">Auto-added · ${e.tasks.length} tasks</div>
          ${e.tasks.map(e=>`<div style="display:flex;align-items:center;gap:8px;font-size:12px;color:var(--ink-soft);padding:5px 0">○ ${T(e)}</div>`).join(``)}
        </div>`:``}
    </div>`;return`<div style="padding:14px 20px 6px"><button onclick="_projectsAiBack()" style="background:none;border:none;color:var(--muted);font-size:13px;font-family:var(--sans);cursor:pointer;padding:0">← Tweak it</button></div>`+r+i+a+`
    ...
    <div style="height:24px"></div>`}function Ya(){ga=null,ya=``,z=`new`,ha=null,B()}function Xa(){let e=ga;if(!e)return;ba();let t=fa[e.template]||fa.custom,n={id:`proj-`+N(g.projects||[]),name:e.name,emoji:t.emoji,template:e.template,status:`planning`,members:[],isFamilyGoal:!1,goalKidPointsTarget:0,startDate:e.startDate||``,endDate:e.endDate||``,budget:e.budget||0,location:e.location||``,notes:e.notes||``,spentManual:0,tasks:e.tasks.map(e=>({id:`t-`+Date.now().toString(36)+Math.random().toString(36).slice(2),name:e,done:!1,dueDate:``})),bookings:[],quotes:[],stages:[],createdAt:new Date().toISOString()};g.projects.push(n),window.saveData(g),ga=null,_a=``,ma=n.id,z=`detail`,B()}window._projectsOpenNew=Na,window._projectsBackToList=Pa,window._projectsOpenDetail=Fa,window._projectsPickTemplate=Ia,window._projectsSaveNew=La,window._projectsDelete=Ra,window._projectsSetStatus=za,window._projectsToggleFamilyGoal=Ba,window._projectsSetGoalTarget=Va,window._projectsToggleTask=Ha,window._projectsAddTask=Ua,window._projectsDeleteTask=Wa,window._projectsAiSubmit=Ka,window._projectsAiBack=Ya,window._projectsAiConfirm=Xa;function Za(){let e=g.goals,t=e.filter(e=>e.status===`active`),n=e.filter(e=>e.status===`achieved`),r=``;e.length>0&&(r+=`
  ...
  </div>`,i.length===0){let e=window.getMonthData(window.selectedBudgetMonth),t=M(e.income)-M(e.expenses),n=t>0?`<div style="font-size:14px;color:#64748b;margin-bottom:4px">You have <strong style="color:#16a34a">${D(t)}</strong> surplus each month.</div>
      ...
      <div style="background:#fff;border:2px dashed #cbd5e1;border-radius:16px;padding:36px 24px;text-align:center;margin-top:8px">
        ...
        <div class="goal-card" style="opacity:${e.status===`abandoned`?`0.6`:`1`}">
          <div class="goal-card-header">
            <div>
              <div class="goal-card-title">${t.icon} ${T(e.name)}</div>
          ...
          ${o}
          ${e.notes?`<div style="font-size:12px;color:var(--text-muted);margin-top:8px">${T(e.notes)}</div>`:``}
        </div>`});document.getElementById(`goals-content`).innerHTML=r}function Qa(e={}){let t=e.type||`spending`;return`
    <div class="form-group">
      <label class="form-label">Goal Name</label>
      <input class="form-input" id="f-goal-name" type="text" maxlength="200" value="${E(e.name||``)}" placeholder="e.g. Cut dining out">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label class="form-label">Notes</label>
      <input class="form-input" id="f-goal-notes" type="text" maxlength="200" value="${E(e.notes||``)}" placeholder="Optional notes">
    </div>
  `}function $a(){let e=document.getElementById(`f-goal-type`).value;document.getElementById(`goal-spending-fields`).style.display=e===`spending`?``:`none`,document.getElementById(`goal-savings-fields`).style.display=e===`savings`?``:`none`,document.getElementById(`goal-income-fields`).style.display=e===`income`?``:`none`}function eo(e){let t=document.getElementById(`f-goal-type`).value,n={id:e,name:document.getElementById(`f-goal-name`).value.trim(),type:t,status:document.getElementById(`f-goal-status`).value,deadline:document.getElementById(`f-goal-deadline`).value||null,notes:document.getElementById(`f-goal-notes`).value.trim()};return t===`spending`&&(n.category=document.getElementById(`f-goal-category`).value,n.targetMonthly=parseFloat(document.getElementById(`f-goal-target-monthly`).value)||0),t===`savings`&&(n.targetTotal=parseFloat(document.getElementById(`f-goal-target-total`).value)||0,n.currentSaved=parseFloat(document.getElementById(`f-goal-current-saved`).value)||0),t===`income`&&(n.targetMonthly=parseFloat(document.getElementById(`f-goal-target-monthly-inc`).value)||0),n}function to(){window.openModal(`New Goal`,Qa(),()=>{let e=eo(N(g.goals));e.name&&(g.goals.push(e),window.saveData(g),window.closeModal(),Za())})}function no(e){let t=g.goals.find(t=>t.id===e);window.openModal(`Edit Goal`,Qa(t),()=>{Object.assign(t,eo(e)),window.saveData(g),window.closeModal(),Za()})}function ro(e){confirm(`Delete this goal?`)&&(g.goals=g.goals.filter(t=>t.id!==e),window.saveData(g),Za())}function io(e){let t=g.goals.find(t=>t.id===e);t&&(t.status=`achieved`,window.saveData(g),Za())}var ao=null,oo=[{value:`add-income`,label:`Add income source`,icon:`💰`},{value:`remove-income`,label:`Remove income source`,icon:`➖`},{value:`reduce-income`,label:`Reduce income amount`,icon:`📉`},{value:`add-expense`,label:`Add new expense`,icon:`➕`},{value:`remove-expense`,label:`Remove expense`,icon:`✂️`},{value:`reduce-expense`,label:`Reduce expense amount`,icon:`📉`}];function so(e){let t=window.getMonthData(window.selectedBudgetMonth),n=JSON.parse(JSON.stringify(t.income)),r=JSON.parse(JSON.stringify(t.expenses));return(e.adjustments||[]).forEach(e=>{if(e.type===`add-income`)n.push({id:-(e.id||0),name:e.name,amount:e.amount||0,frequency:e.frequency||`monthly`});else if(e.type===`remove-income`)n=n.filter(t=>t.id!==e.itemId);else if(e.type===`reduce-income`){let t=n.find(t=>t.id===e.itemId);t&&(t.amount=e.changeType===`percent`?Math.max(0,t.amount*(1-e.changeAmount/100)):Math.max(0,t.amount-(e.changeAmount||0)))}else if(e.type===`add-expense`)r.push({id:-(e.id||0),name:e.name,amount:e.amount||0,frequency:e.frequency||`monthly`,category:e.category||`Other`});else if(e.type===`remove-expense`)r=r.filter(t=>t.id!==e.itemId);else if(e.type===`reduce-expense`){let t=r.find(t=>t.id===e.itemId);t&&(t.amount=e.changeType===`percent`?Math.max(0,t.amount*(1-e.changeAmount/100)):Math.max(0,t.amount-(e.changeAmount||0)))}}),{income:n,expenses:r,totalIncome:M(n),totalExpenses:M(r),surplus:M(n)-M(r)}}function co(){let e=g.scenarios,t=window.getMonthData(window.selectedBudgetMonth),n=M(t.income),r=M(t.expenses),i=n-r,a=`<div style="display:flex;justify-content:flex-end;margin-bottom:16px">
    <button class="btn btn-primary" onclick="openAddScenario()">+ New Scenario</button>
  </div>`;e.length===0?a+=`<div class="empty"><div class="empty-icon">🔬</div>No scenarios yet. Create one to model income changes, expense cuts, or lifestyle adjustments.</div>`:e.forEach(e=>{let t=so(e),o=t.totalIncome-n,s=t.totalExpenses-r,c=t.surplus-i,l=ao===e.id;a+=`
        <div class="scenario-card">
          <div class="scenario-card-header" onclick="toggleScenario('${e.id}')">
            <div style="flex:1">
              <div style="font-weight:600;font-size:14px">${T(e.name)}</div>
              ${e.description?`<div style="font-size:12px;color:var(--text-muted);margin-top:2px">${T(e.description)}</div>`:``}
            </div>
            <div style="display:flex;align-items:center;gap:12px;flex-shrink:0">
              <div style="text-align:right">
                <div style="font-size:11px;color:var(--text-muted)">Surplus impact</div>
                <div style="font-size:14px;font-weight:700;color:${c>=0?`var(--success)`:`var(--danger)`}">${c>=0?`+`:``}${D(c)}/mo</div>
              </div>
          ...
          <div class="scenario-card-body${l?` open`:``}">
            ...
            <div class="adj-list">
              ${(e.adjustments||[]).length===0?`<div style="font-size:13px;color:var(--text-muted);padding:8px 0">No adjustments yet. Add income or expense changes.</div>`:(e.adjustments||[]).map(t=>{let n=oo.find(e=>e.value===t.type)||oo[0],r=``;return t.type===`add-income`||t.type===`add-expense`?r=`${T(t.name)} · ${D(t.amount||0)}/${t.frequency||`mo`}${t.category?` · `+t.category:``}`:t.type===`remove-income`||t.type===`remove-expense`?r=T(t.itemName||`—`):(t.type===`reduce-income`||t.type===`reduce-expense`)&&(r=`${T(t.itemName)} · reduce by ${t.changeType===`percent`?t.changeAmount+`%`:D(t.changeAmount||0)}`),`<div class="adj-item">
            ...
            <div class="scenario-compare">
              <div class="compare-col">
                ...
                <div class="compare-row"><span>Monthly Income</span><span class="amount" style="color:var(--success)">${D(n)}</span></div>
                <div class="compare-row"><span>Monthly Expenses</span><span class="amount" style="color:var(--danger)">${D(r)}</span></div>
                <div class="compare-row"><span>Monthly Surplus</span><span class="amount" style="color:${i>=0?`var(--success)`:`var(--danger)`}">${D(i)}</span></div>
                <div class="compare-row"><span style="color:var(--text-muted);font-size:12px">Annual surplus</span><span style="color:var(--text-muted);font-size:12px">${D(i*12)}</span></div>
              </div>
              <div class="compare-col" style="border:2px solid var(--primary)">
                <div class="compare-col-title" style="color:var(--primary)">Scenario: ${T(e.name)}</div>
                <div class="compare-row">
                  <span>Monthly Income</span>
                  <span class="amount" style="color:var(--success)">${D(t.totalIncome)} ${o===0?``:`<small style="color:${o>0?`var(--success)`:`var(--danger)`}">(${o>0?`+`:``}${D(o)})</small>`}</span>
                </div>
                <div class="compare-row">
                  <span>Monthly Expenses</span>
                  <span class="amount" style="color:var(--danger)">${D(t.totalExpenses)} ${s===0?``:`<small style="color:${s<0?`var(--success)`:`var(--danger)`}">(${s>0?`+`:``}${D(s)})</small>`}</span>
                </div>
                <div class="compare-row">
                  <span>Monthly Surplus</span>
                  <span class="amount" style="color:${t.surplus>=0?`var(--success)`:`var(--danger)`};font-weight:700">${D(t.surplus)}</span>
                </div>
                <div class="compare-row">
                  <span style="font-size:12px">Annual surplus</span>
                  <span style="font-size:12px;font-weight:600;color:${t.surplus>=0?`var(--success)`:`var(--danger)`}">${D(t.surplus*12)} ${c===0?``:`<small>(${c>0?`+`:``}${D(c*12)}/yr)</small>`}</span>
                </div>
              </div>
            </div>
          </div>
        </div>`}),document.getElementById(`scenarios-content`).innerHTML=a}function lo(e){ao=ao===e?null:e,co()}function uo(e={}){return`
    <div class="form-group">
      <label class="form-label">Scenario Name</label>
      <input class="form-input" id="f-sc-name" type="text" maxlength="200" value="${E(e.name||``)}" placeholder="e.g. Pick up second job">
    </div>
    <div class="form-group">
      <label class="form-label">Description</label>
      <input class="form-input" id="f-sc-desc" type="text" maxlength="200" value="${E(e.description||``)}" placeholder="Brief description of what you're testing">
    </div>
  `}function fo(e,t={}){return{id:e,name:document.getElementById(`f-sc-name`).value.trim(),description:document.getElementById(`f-sc-desc`).value.trim(),adjustments:t.adjustments||[]}}function po(){window.openModal(`New Scenario`,uo(),()=>{let e=fo(N(g.scenarios));e.name&&(g.scenarios.push(e),window.saveData(g),window.closeModal(),co())})}function mo(e){let t=g.scenarios.find(t=>t.id===e);window.openModal(`Edit Scenario`,uo(t),()=>{let n=fo(e,t);Object.assign(t,n),window.saveData(g),window.closeModal(),co()})}function ho(e){confirm(`Delete this scenario?`)&&(g.scenarios=g.scenarios.filter(t=>t.id!==e),ao===e&&(ao=null),window.saveData(g),co())}function go(e){let t=window.getMonthData(window.selectedBudgetMonth),n=t.income.map(e=>`<option value="${e.id}">${T(e.name)} (${D(j(e))}/mo)</option>`).join(``),r=t.expenses.map(e=>`<option value="${e.id}">${T(e.name)} (${D(j(e))}/mo)</option>`).join(``);return`
    <div class="form-group">
      <label class="form-label">Adjustment Type</label>
      <select class="form-select" id="f-adj-type" onchange="toggleAdjFields()">
        ${oo.map(e=>`<option value="${e.value}">${e.icon} ${e.label}</option>`).join(``)}
      </select>
    </div>
  ...
  `}function _o(){let e=document.getElementById(`f-adj-type`).value;document.getElementById(`adj-add-income`).style.display=e===`add-income`||e===`add-expense`?``:`none`,document.getElementById(`adj-add-income-extra`).style.display=e===`add-income`||e===`add-expense`?``:`none`,document.getElementById(`adj-cat-wrap`).style.display=e===`add-expense`?``:`none`,document.getElementById(`adj-remove-income`).style.display=e===`remove-income`?``:`none`,document.getElementById(`adj-reduce-income`).style.display=e===`reduce-income`?``:`none`,document.getElementById(`adj-remove-expense`).style.display=e===`remove-expense`?``:`none`,document.getElementById(`adj-reduce-expense`).style.display=e===`reduce-expense`?``:`none`}function vo(e){let t=g.scenarios.find(t=>t.id===e);t&&window.openModal(`Add Adjustment`,go(t),()=>{let e=document.getElementById(`f-adj-type`).value,n=window.getMonthData(window.selectedBudgetMonth),r={id:N(t.adjustments||[]),type:e};if(e===`add-income`){if(r.name=document.getElementById(`f-adj-name`).value.trim(),r.amount=parseFloat(document.getElementById(`f-adj-amount`).value)||0,r.frequency=document.getElementById(`f-adj-freq`).value,!r.name)return}else if(e===`add-expense`){if(r.name=document.getElementById(`f-adj-name`).value.trim(),r.amount=parseFloat(document.getElementById(`f-adj-amount`).value)||0,r.frequency=document.getElementById(`f-adj-freq`).value,r.category=document.getElementById(`f-adj-cat`).value,!r.name)return}else if(e===`remove-income`){let e=document.getElementById(`f-adj-inc-sel`);r.itemId=parseInt(e.value),r.itemName=e.options[e.selectedIndex]?.text||``}else if(e===`reduce-income`){let e=document.getElementById(`f-adj-inc-reduce-sel`);r.itemId=parseInt(e.value),r.itemName=n.income.find(e=>e.id===r.itemId)?.name||``,r.changeAmount=parseFloat(document.getElementById(`f-adj-change-amount`).value)||0,r.changeType=document.getElementById(`f-adj-change-type-inc`).value}else if(e===`remove-expense`){let e=document.getElementById(`f-adj-exp-sel`);r.itemId=parseInt(e.value),r.itemName=e.options[e.selectedIndex]?.text||``}else if(e===`reduce-expense`){let e=document.getElementById(`f-adj-exp-reduce-sel`);r.itemId=parseInt(e.value),r.itemName=n.expenses.find(e=>e.id===r.itemId)?.name||``,r.changeAmount=parseFloat(document.getElementById(`f-adj-change-amount-exp`).value)||0,r.changeType=document.getElementById(`f-adj-change-type-exp`).value}t.adjustments||(t.adjustments=[]),t.adjustments.push(r),window.saveData(g),window.closeModal(),co()})}function yo(e,t){let n=g.scenarios.find(t=>t.id===e);n&&(n.adjustments=(n.adjustments||[]).filter(e=>e.id!==t),window.saveData(g),co())}var bo=`home_finance_colors_v1`,xo={expense:{"Mortgage / Rent":`#6366f1`,Insurance:`#8b5cf6`,Utilities:`#06b6d4`,Groceries:`#10b981`,Transport:`#f59e0b`,"Childcare / Education":`#3b82f6`,Health:`#ef4444`,Entertainment:`#f97316`,Subscriptions:`#84cc16`,"Dining Out":`#14b8a6`,Clothing:`#ec4899`,"Personal Care":`#a855f7`,"Savings / Investment":`#22c55e`,Other:`#94a3b8`},income:`#10b981`,build:{contract:`#3b82f6`,extras:`#f59e0b`,furniture:`#8b5cf6`,appliances:`#ef4444`}};function So(){try{let e=P(bo);if(!e)return JSON.parse(JSON.stringify(xo));let t=JSON.parse(e);return t.expense||(t.expense={}),t.build||(t.build={}),t.income||(t.income=xo.income),ca().forEach(e=>{t.expense[e]||(t.expense[e]=xo.expense[e]||`#94a3b8`)}),Object.keys(xo.build).forEach(e=>{t.build[e]||(t.build[e]=xo.build[e])}),t}catch{return JSON.parse(JSON.stringify(xo))}}function Co(e){it(bo,JSON.stringify(e))}var wo=So();Object.defineProperty(window,`colors`,{get(){return wo},set(e){wo=e},configurable:!0});function To(e,t,n){e===`expense`?wo.expense[t]=n:e===`income`?wo.income=n:e===`build`&&(wo.build[t]=n),Co(wo),renderBudget(),renderBuild(),renderDashboard()}function Eo(){return(g.householdProfile.members||[]).filter(e=>e.role===`adult`).length||1}function Do(){return(g.householdProfile.members||[]).filter(e=>e.role===`child`).length}function Oo(e){g.householdProfile.members.push({role:e||`adult`,age:null}),us(),renderSettings()}function ko(e){let t=g.householdProfile.members[e];if(!t)return;let n=t.name||(t.role===`child`?`this child`:`this adult`);if(confirm(`Remove ${n} from the household?\n\nThis cannot be undone.`)){if(t.role===`child`&&t.name){let e=(g.kids?.profiles||[]).find(e=>e.name===t.name);e&&(g.kids.profiles=g.kids.profiles.filter(t=>t.id!==e.id),g.kids.chores=g.kids.chores.filter(t=>t.assignedTo!==e.id),g.kids.completions=g.kids.completions.filter(t=>t.kidId!==e.id),g.kids.redemptions=g.kids.redemptions.filter(t=>t.kidId!==e.id),g.meals?.lunchbox?.profiles&&(g.meals.lunchbox.profiles=g.meals.lunchbox.profiles.filter(t=>t.id!==e.id)),String(window.getDeviceProfile())===String(e.id)&&window.setDeviceProfile(`adult`))}g.householdProfile.members.splice(e,1),window.saveData(g),window.renderAll()}}function Ao(e,t,n){let r=g.householdProfile.members[e];r&&(r[t]=n,us(),(t===`role`||t===`name`)&&renderSettings())}function jo(e){g.householdProfile.pets.push({type:e||`dog`,name:``}),us(),renderSettings()}function Mo(e){g.householdProfile.pets.splice(e,1),us(),renderSettings()}function No(e,t,n){let r=g.householdProfile.pets[e];r&&(r[t]=n,us())}function Po(e){g.householdProfile.cars=e,us()}function Fo(e,t,n){let r=t+n;return[{category:`Mortgage / Rent`,min:e*.2,max:e*.3,label:`20–30% of income`,source:`ABS / MoneySmart`,needs:!0},{category:`Groceries`,min:380+(t-1)*260+n*160,max:560+(t-1)*360+n*220,label:`$${Math.round(380+(t-1)*260+n*160)}–$${Math.round(560+(t-1)*360+n*220)}/month for ${r} ${r===1?`person`:`people`}`,source:`ABS HES 2022`,needs:!0},{category:`Transport`,min:e*.08,max:e*.15,label:`8–15% of income`,source:`ABS HES 2022`,needs:!0},{category:`Utilities`,min:180+t*25+n*15,max:360+t*40+n*25,label:`$${Math.round(180+t*25+n*15)}–$${Math.round(360+t*40+n*25)}/month`,source:`AER / ABS`,needs:!0},{category:`Insurance`,min:180+t*40+n*20,max:420+t*60+n*30,label:`$${Math.round(180+t*40+n*20)}–$${Math.round(420+t*60+n*30)}/month`,source:`APRA industry avg`,needs:!0},{category:`Health`,min:60*t+30*n,max:180*t+60*n,label:`$${60*t+30*n}–$${180*t+60*n}/month`,source:`AIHW / ABS`,needs:!0},...n>0?[{category:`Childcare / Education`,min:700*n,max:2200*n,label:`$700–$2,200/month per child (before subsidies)`,source:`ACCC Childcare Report`,needs:!0}]:[],{category:`Dining Out`,min:e*.02,max:e*.05,label:`2–5% of income`,source:`MoneySmart`,needs:!1},{category:`Entertainment`,min:e*.02,max:e*.05,label:`2–5% of income`,source:`MoneySmart`,needs:!1},{category:`Subscriptions`,min:30,max:120,label:`$30–$120/month`,source:`Industry average`,needs:!1},{category:`Clothing`,min:50*t+30*n,max:150*t+80*n,label:`$${50*t+30*n}–$${150*t+80*n}/month`,source:`ABS HES 2022`,needs:!1},{category:`Savings / Investment`,min:e*.1,max:e*.2,label:`10–20% of income (aim for 20%)`,source:`50/30/20 rule`,needs:!1}]}function Io(e,t,n){return e<t*.9?`under`:e>n*1.1?`over`:`within`}var Lo=`home_finance_ai_key`;function Ro(){return P(`home_finance_ai_key`)||``}function zo(e){it(Lo,e)}function Bo(){let e=window.getLast6Months(),t={};return e.forEach(e=>{let n=window.getMonthData(e),r={},i={};n.expenses.forEach(t=>{let n=t.category||`Other`;r[n]=(r[n]||0)+j(t);let a=window.getActual(t.id,e);a>0&&(i[n]=(i[n]||0)+a)}),new Set([...Object.keys(r),...Object.keys(i)]).forEach(n=>{t[n]||(t[n]=[]),t[n].push({mo:e,budget:r[n]||0,actual:i[n]||0,hasActual:(i[n]||0)>0})})}),t}function Vo(e){let t=[];return Object.entries(e).forEach(([e,n])=>{let r=n.filter(e=>e.hasActual);if(r.length<2)return;let i=r.filter(e=>e.budget>0&&e.actual>e.budget*1.05).length,a=r.filter(e=>e.budget>0&&e.actual<e.budget*.92).length,o=r.reduce((e,t)=>e+(t.actual-t.budget),0)/r.length,s=n.slice(-3).filter(e=>e.hasActual),c=n.slice(0,3).filter(e=>e.hasActual),l=s.length?s.reduce((e,t)=>e+t.actual,0)/s.length:0,u=c.length?c.reduce((e,t)=>e+t.actual,0)/c.length:0,d=u>50?(l-u)/u:0;i>=3&&o>20?t.push({cat:e,level:`warning`,icon:`⚠️`,title:`Consistently over on ${e}`,body:`Over budget ${i}/${r.length} months, avg +${D(Math.abs(o))}/mo. Consider raising the budget or cutting back.`,months:r}):a>=4&&n[n.length-1]?.budget>0?t.push({cat:e,level:`good`,icon:`✅`,title:`Consistently under on ${e}`,body:`Under budget ${a}/${r.length} months, avg ${D(Math.abs(o))}/mo less. You may be able to reallocate this budget elsewhere.`,months:r}):d>.25&&l>50?t.push({cat:e,level:`warning`,icon:`📈`,title:`${e} trending up`,body:`Spending up ${Math.round(d*100)}% over recent months — now averaging ${D(l)}/mo. Worth keeping an eye on.`,months:r}):d<-.25&&u>50&&t.push({cat:e,level:`good`,icon:`📉`,title:`${e} trending down`,body:`Down ${Math.round(Math.abs(d)*100)}% recently — now ${D(l)}/mo. Nice improvement.`,months:r})}),t.sort((e,t)=>[`warning`,`alert`,`good`,`info`].indexOf(e.level)-[`warning`,`alert`,`good`,`info`].indexOf(t.level)).slice(0,6)}function Ho(){let e=window.getMonthData(window.selectedBudgetMonth);if(e.expenses.length===0)return``;let t={};e.expenses.forEach(e=>{let n=e.category||`Other`;t[n]||(t[n]={budget:0,actual:0}),t[n].budget+=j(e),t[n].actual+=window.getActual(e.id,window.selectedBudgetMonth)});let n=Object.entries(t).filter(([,e])=>e.budget>0||e.actual>0).sort((e,t)=>Math.max(t[1].budget,t[1].actual)-Math.max(e[1].budget,e[1].actual));if(!n.length)return``;let r=Math.max(...n.flatMap(([,e])=>[e.budget,e.actual]),1),i=n.map(([e,t])=>{let n=t.actual>0,i=(t.budget/r*100).toFixed(1),a=(t.actual/r*100).toFixed(1),o=t.actual-t.budget,s=n?o>5?`over`:o<-5?`under`:``:``,c=n?o>5?`<span class="spi-over">+${D(o)}</span>`:o<-5?`<span class="spi-under">${D(o)}</span>`:`<span class="spi-on">on track</span>`:`<span class="spi-no-actual">no actuals</span>`;return`<div class="spi-cat-row">
      ...
      <div class="spi-cat-amounts"><span>${D(t.budget)}</span>${c}</div>
    ...
    ${i}
  </div>`}function Uo(){let e=Vo(Bo()),t=Ho(),n={warning:{bg:`#fffbeb`,border:`#fcd34d`,title:`#92400e`},good:{bg:`#ecfeff`,border:`#86efac`,title:`#166534`},alert:{bg:`#fef2f2`,border:`#fca5a5`,title:`#991b1b`},info:{bg:`#f8fafc`,border:`#cbd5e1`,title:`#475569`}};return`<div class="spi-section">
    ...
    ${e.length===0?`<div class="spi-empty-state">Add actuals in Monthly Budget over a few months to unlock pattern detection.</div>`:`<div class="spi-patterns-grid">${e.map(e=>{let t=n[e.level]||n.info,r=Math.max(...(e.months||[]).map(e=>e.actual),1),i=(e.months||[]).map(e=>`<div class="spi-spark-bar" style="height:${Math.max(Math.round(e.actual/r*20),e.hasActual?2:0)}px;background:${e.hasActual?e.actual>e.budget*1.05?`#ef4444`:e.actual<e.budget*.95?`#10b981`:`#2563eb`:`#e2e8f0`}"></div>`).join(``);return`<div class="spi-pattern-card" style="background:${t.bg};border:1.5px solid ${t.border}">
          ...
          <div>
            <div class="spi-pattern-title" style="color:${t.title}">${T(e.title)}</div>
            <div class="spi-pattern-body">${T(e.body)}</div>
            <div class="spi-sparkline">${i}</div>
          </div>
        </div>`}).join(``)}</div>`}
  </div>`}function Wo(){let e=window.getMonthData(window.selectedBudgetMonth),t=M(e.income),n=M(e.expenses),r=t-n,i=t>0?r/t*100:0,a={};e.expenses.forEach(e=>{let t=e.category||`Other`;a[t]=(a[t]||0)+j(e)});let o=Object.entries(a).sort((e,t)=>t[1]-e[1]),s=window.getLast6Months(),c=s.reduce((e,t)=>e+M(window.getMonthData(t).expenses),0)/6;s.reduce((e,t)=>e+M(window.getMonthData(t).income),0)/6;let l=[];if(i>=20?l.push({level:`good`,icon:`🌟`,title:`Excellent savings rate`,body:`You're saving ${Math.round(i)}% of income — above the recommended 20%. Keep it up and consider putting the surplus toward your goals.`}):i>=10?l.push({level:`ok`,icon:`📈`,title:`Decent savings rate`,body:`You're saving ${Math.round(i)}% of income. Pushing to 20% would mean an extra ${D(t*.2-r)}/month going toward your future.`}):i>0?l.push({level:`warning`,icon:`⚠️`,title:`Low savings rate`,body:`Only ${Math.round(i)}% of income is being saved (${D(r)}/month). Look for the biggest discretionary expense you can reduce.`}):t>0&&l.push({level:`alert`,icon:`🚨`,title:`Spending exceeds income`,body:`You're spending ${D(Math.abs(r))} more than you earn each month. This requires urgent attention — identify what can be cut immediately.`}),c>0){let e=n-c,t=Math.round(Math.abs(e)/c*100);e>c*.1?l.push({level:`warning`,icon:`📊`,title:`Expenses above your average`,body:`This month's expenses are ${t}% above your 6-month average (${D(c)}). The extra ${D(e)} could be a one-off — worth reviewing.`}):e<-c*.08&&c>0&&l.push({level:`good`,icon:`📊`,title:`Expenses below your average`,body:`Nice — this month you spent ${t}% less than your 6-month average. That's ${D(Math.abs(e))} extra in your pocket.`})}if(o.length>0){let[e,t]=o[0],r=n>0?Math.round(t/n*100):0;r>45&&e!==`Mortgage / Rent`&&l.push({level:`warning`,icon:`💸`,title:`${e} is dominating your budget`,body:`${e} makes up ${r}% of your total expenses (${D(t)}/month). Reducing this by 20% would save ${D(t*.2)}/month.`})}let u=a[`Dining Out`]||0;u>0&&n>0&&u/n>.08&&l.push({level:`ok`,icon:`🍽️`,title:`Dining out is notable`,body:`You're spending ${D(u)}/month dining out. Cooking at home 2–3 more times a week could save ${D(u*.35)}/month.`}),e.income.length===1&&t>0&&l.push({level:`info`,icon:`💡`,title:`Single income source`,body:`You rely on one income stream. Even a small side income (freelance, rental, etc.) would significantly improve your financial resilience.`});let d=g.buildContract.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0),f=g.buildContract.total-d;if(f>0&&r>0){let e=Math.round(f/r);l.push({level:`info`,icon:`🏗️`,title:`Build payments still ahead`,body:`You have ${D(f)} left in contract payments. At your current savings rate that represents ${e} month${e===1?``:`s`} of surplus — plan accordingly.`})}let p=(g.goals||[]).filter(e=>!e.achieved);return p.length>0&&r>0&&l.push({level:`good`,icon:`🎯`,title:`${p.length} active goal${p.length>1?`s`:``}`,body:`Your ${D(r)}/month surplus can work toward your goals. Review the Goals page to see progress and adjust contributions.`}),e.expenses.length===0&&l.push({level:`info`,icon:`📝`,title:`Add your expenses`,body:`Head to Monthly Budget and add your regular expenses to unlock personalised insights.`}),l}var Go=`https://home-finance-proxy.fuscocl.workers.dev`;async function Ko(){let e=document.getElementById(`ai-run-btn`);e.disabled=!0,e.textContent=`Analysing…`;let t=window.getMonthData(window.selectedBudgetMonth),n=M(t.income),r=M(t.expenses),i=n-r,a=n>0?Math.round(i/n*100):0,o={};t.expenses.forEach(e=>{o[e.category||`Other`]=(o[e.category||`Other`]||0)+j(e)});let s=window.getLast6Months().map(e=>{let t=window.getMonthData(e);return{month:e,income:M(t.income),expenses:M(t.expenses)}}),c=Fo(n,Eo(),Do()).filter(e=>o[e.category]!==void 0).map(e=>({category:e.category,yourSpend:Math.round(o[e.category]||0),benchmarkMin:Math.round(e.min),benchmarkMax:Math.round(e.max),benchmarkLabel:e.label,status:Io(o[e.category]||0,e.min,e.max)})),l={month:window.monthLabel(window.selectedBudgetMonth),household:(function(){let e=g.householdProfile||{},t=e.members||[],n=t.filter(e=>e.role===`adult`),r=t.filter(e=>e.role===`child`);return{adults:n.length||2,children:r.length,totalPeople:t.length||2,memberAges:t.map(e=>({role:e.role,age:e.age})),pets:(e.pets||[]).map(e=>e.type),cars:e.cars||0}})(),monthlyIncome:n,monthlyExpenses:r,surplus:i,savingsRatePct:a,expensesByCategory:o,benchmarkComparisons:c,incomeStreams:t.income.map(e=>({name:e.name,monthlyAmount:j(e)})),last6MonthsTrend:s,activeGoals:(g.goals||[]).filter(e=>!e.achieved).map(e=>({name:e.name,type:e.type})),buildRemaining:g.buildContract.total-g.buildContract.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0),currency:`AUD`},u=`You are a friendly but direct personal finance advisor for an Australian family. Analyse their budget data and benchmark comparisons, then give 4-6 concise, specific, actionable insights.
...
Reply with ONLY the JSON array, no other text.`;try{let e=await fetch(Go,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:u}]})});if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(t.error?.message||`API error ${e.status}`)}let t=(await e.json()).content[0].text.trim();t=t.replace(/^```[a-z]*\n?/i,``).replace(/\n?```$/,``).trim(),qo(JSON.parse(t),!0)}catch(e){let t=e.message;(t.includes(`Failed to fetch`)||t.includes(`NetworkError`)||t.includes(`CORS`))&&(t=`CORS blocked — the browser can't call the Anthropic API directly. We need a small proxy (Cloudflare Worker). Ask me to set it up — it takes 5 minutes and is free.`),document.getElementById(`ai-output`).innerHTML=`
      ...
      <div style="background:${t.bg};border:1.5px solid ${t.border};border-radius:12px;padding:16px 18px;display:flex;gap:14px;align-items:flex-start">
        ...
        <div style="flex:1;min-width:0">
          <div style="font-weight:700;font-size:14px;color:${t.text};margin-bottom:4px">${T(e.title)}</div>
          <div style="font-size:13px;color:var(--text);line-height:1.5">${T(e.body)}</div>
          ${e.action?`<div style="margin-top:8px;font-size:12px;font-weight:600;color:${t.text}">→ ${T(e.action)}</div>`:``}
        </div>
    ...
    <div style="display:flex;flex-direction:column;gap:12px">
      ...
      </div>`}let h=i.filter(e=>r[e.category]!==void 0||e.category===`Savings / Investment`).map(e=>{let t=r[e.category]||0,n=Io(t,e.min,e.max),i=n===`under`?`#3b82f6`:n===`within`?`#10b981`:`#ef4444`,a=n===`under`?`Below avg`:n===`within`?`On track`:`Above avg`,o=e.max>0?Math.min(t/(e.max*1.5)*100,100):0,s=e.max>0?Math.min(e.max/(e.max*1.5)*100,100):0;return`
      <tr>
        <td style="border-left:3px solid ${wo.expense[e.category]||`#94a3b8`};font-weight:500">${e.category}</td>
        <td class="amount" style="font-weight:600">${t>0?D(t):`<span style="color:var(--text-muted)">—</span>`}</td>
          ...
          <div style="display:flex;gap:16px;flex-wrap:wrap">
            ${[{label:`Needs`,pct:d,target:50,amt:c,color:`#3b82f6`},{label:`Wants`,pct:f,target:30,amt:l,color:`#f59e0b`},{label:`Saving`,pct:p,target:20,amt:u,color:`#10b981`}].map(e=>`
              <div style="text-align:center;min-width:70px">
                ...
                <div style="font-size:11px;color:var(--text-muted)">${D(e.amt)}</div>
              </div>`).join(``)}
          </div>
        </div>
      </div>
    ...
    </div>`}function Yo(){Ro();let e=Wo(),t=window.getMonthData(window.selectedBudgetMonth),n=M(t.income),r=M(t.expenses),i=n-r,a=n>0?Math.round(i/n*100):0,o=Eo(),s=Do(),c={};t.expenses.forEach(e=>{let t=e.category||`Other`;c[t]=(c[t]||0)+j(e)});let l=0;a>=20?l+=40:a>=10?l+=28:a>0&&(l+=14),t.income.length>1&&(l+=10),(g.goals||[]).some(e=>!e.achieved)&&(l+=15),g.buildContract.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0)>0&&(l+=10),r>0&&r<n&&(l+=25);let u=l>=70?`#10b981`:l>=45?`#f59e0b`:`#ef4444`,d=l>=70?`Great shape`:l>=45?`On track`:`Needs attention`;document.getElementById(`insights-content`).innerHTML=`
    ...
    <div class="cards" style="margin-bottom:24px">
      ...
      <div class="card">
        ...
        <div class="card-sub">${D(Math.max(i,0))}/month saved</div>
      </div>
      <div class="card">
        <div class="card-label">Monthly Surplus</div>
        <div class="card-value ${i>=0?`green`:`red`}">${D(Math.abs(i))}</div>
        <div class="card-sub">${i>=0?`available`:`overspending`}</div>
      </div>
      <div class="card">
        <div class="card-label">Income / Expenses</div>
        <div class="card-value">${D(n)}</div>
        <div class="card-sub">vs ${D(r)} out</div>
      </div>
    </div>
  ...
  `}function Xo(e){let t={good:{bg:`#ecfeff`,border:`#86efac`,text:`#166534`},ok:{bg:`#eff6ff`,border:`#93c5fd`,text:`#1e40af`},warning:{bg:`#fffbeb`,border:`#fcd34d`,text:`#92400e`},alert:{bg:`#fef2f2`,border:`#fca5a5`,text:`#991b1b`},info:{bg:`#f8fafc`,border:`#cbd5e1`,text:`#475569`}};return e.map(e=>{let n=t[e.level]||t.info;return`
      <div style="background:${n.bg};border:1.5px solid ${n.border};border-radius:10px;padding:14px 16px;display:flex;gap:12px;align-items:flex-start">
        ...
        <div>
          <div style="font-weight:700;font-size:13px;color:${n.text};margin-bottom:3px">${T(e.title)}</div>
          <div style="font-size:12px;color:var(--text);line-height:1.5">${T(e.body)}</div>
        </div>
      </div>`}).join(``)}function Zo(){let[e,t]=window.selectedBudgetMonth.split(`-`).map(Number),n=new Date(e,t-2,1);window.selectedBudgetMonth=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,window.safeRender(Yo),window.safeRender(renderMoneyDashboard),window.safeRender(renderBudget)}function Qo(){let[e,t]=window.selectedBudgetMonth.split(`-`).map(Number),n=new Date(e,t,1);window.selectedBudgetMonth=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,window.safeRender(Yo),window.safeRender(renderMoneyDashboard),window.safeRender(renderBudget)}var $o=`🏠.🏡.🏗️.🔑.💡.🔌.🚿.🛋️.🛏️.🪴.🍽️.🍕.🍔.🛒.🥗.🍷.☕.🍰.🥩.🧃.🚗.🚙.🚌.✈️.⛽.🚕.🏎️.🚲.🛵.🚂.👨‍👩‍👧.👶.📚.🏫.💊.🏥.💅.💆.🧴.👕.🎮.🎬.🎵.🏋️.📺.🎲.🏄.🎯.🎨.🎭.💰.💳.🏦.📈.💸.🪙.💎.📊.🏆.💼.📦.🛍️.🎁.🔧.🛠️.📱.💻.🧹.🧺.🖨️.🐕.🐈.🐠.🌱.☀️.❄️.🎄.🎂.⚽.🧸`.split(`.`);function es(e,t){let n=document.createElement(`div`);n.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.45);z-index:9999;display:flex;align-items:center;justify-content:center`,n.innerHTML=`
  ...
  `,document.body.appendChild(n),n.querySelector(`#emoji-picker-close`).onclick=()=>document.body.removeChild(n),n.querySelectorAll(`[data-emoji]`).forEach(e=>{e.onclick=()=>{t(e.dataset.emoji),document.body.removeChild(n)}}),n.addEventListener(`click`,e=>{e.target===n&&document.body.removeChild(n)})}function ts(){window.openModal(`Add Category Group`,`
    <div class="form-row">
  ...
  `,()=>{let e=document.getElementById(`f-grp-icon`).value||`📦`,t=document.getElementById(`f-grp-name`).value.trim();if(!t)return;let n=N(g.categoryGroups);g.categoryGroups.push({id:n,name:t,icon:e,categories:[]}),window.logActivity(`Added category group`,t),window.saveData(g),window.closeModal(),renderSettings()}),document.getElementById(`f-grp-icon-btn`).addEventListener(`click`,()=>{let e=document.getElementById(`f-grp-icon`).value;es(e,e=>{document.getElementById(`f-grp-icon`).value=e,document.getElementById(`f-grp-icon-btn`).textContent=e})})}function ns(e){let t=g.categoryGroups.find(t=>t.id===e);t&&es(t.icon,t=>{is(e,`icon`,t);let n=document.getElementById(`grp-icon-btn-${e}`);n&&(n.textContent=t)})}function rs(e){let t=g.categoryGroups.find(t=>t.id===e);confirm(`Delete group "${t?t.name:``}"? Categories will become unassigned.`)&&(g.categoryGroups=g.categoryGroups.filter(t=>t.id!==e),window.logActivity(`Deleted category group`,t?t.name:``),window.saveData(g),renderSettings())}function is(e,t,n){let r=g.categoryGroups.find(t=>t.id===e);r&&(r[t]=n,window.saveData(g))}function as(e,t){if(!t)return;ca().includes(t)||(g.expenseCategories||(g.expenseCategories=ca().slice()),g.expenseCategories.push(t)),g.categoryGroups.forEach(e=>{e.categories=e.categories.filter(e=>e!==t)});let n=g.categoryGroups.find(t=>t.id===e);n&&n.categories.push(t),window.saveData(g),renderSettings()}function os(e){let t=ca(),n=new Set((g.categoryGroups||[]).filter(t=>t.id!==e).flatMap(e=>e.categories)),r=g.categoryGroups.find(t=>t.id===e),i=new Set(r?r.categories:[]),a=t.filter(e=>!i.has(e)&&!n.has(e));window.openModal(`Add Category to Group`,`
    ${a.length>0?`
  ...
  `,()=>{let t=document.getElementById(`f-cat-selected`).value,n=document.getElementById(`f-cat-new`).value.trim()||t;n&&(as(e,n),window.closeModal())})}function ss(e,t){let n=g.categoryGroups.find(t=>t.id===e);n&&(n.categories=n.categories.filter(e=>e!==t),window.saveData(g),renderSettings())}var cs=!1,ls=null;function us(){cs||(ls=JSON.parse(JSON.stringify(g))),cs=!0;let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`flex`)}function ds(){cs=!1,ls=null,window.saveData(g);let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`none`);let t=document.getElementById(`settings-save-btn`);if(t){let e=t.textContent;t.textContent=`Saved`,t.style.background=`#10b981`,setTimeout(()=>{t.textContent=e,t.style.background=``},1500)}window.renderAll()}function fs(){ls&&Object.assign(g,ls),cs=!1,ls=null;let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`none`),renderSettings()}function ps(e){cs&&(confirm(`You have unsaved changes in Settings. Save before leaving?`)?ds():fs())}function ms(e,t){g.settings||(g.settings={}),g.settings[e]=t,us()}function hs(){let e=document.getElementById(`settings-api-key`)?.value.trim();if(!e)return;it(`toto_ai_key`,e),it(`toto_ai_key_meta`,JSON.stringify({addedAt:new Date().toISOString(),prefix:e.slice(0,10),suffix:e.slice(-4)}));let t=document.getElementById(`api-key-status`);t&&(t.textContent=`✓ Key saved!`,t.style.color=`var(--success)`,setTimeout(()=>{t.textContent=``,t.style.color=``},2e3));let n=document.getElementById(`api-key-summary`);n&&(n.outerHTML=_s())}function gs(){confirm(`Remove saved API key? Toto and cost estimation will stop working.`)&&(at(`toto_ai_key`),at(`toto_ai_key_meta`),renderSettings())}function _s(){let e=P(`toto_ai_key`);if(!e)return`<div id="api-key-summary"></div>`;let t=JSON.parse(P(`toto_ai_key_meta`)||`{}`),n=t.addedAt?new Date(t.addedAt).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`}):`Unknown date`;return`
    ...
    </div>`}function vs(e){let t=document.getElementById(`sacc-body-${e}`),n=document.getElementById(`sacc-chev-${e}`);if(!t)return;let r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n&&(n.textContent=r?`▼`:`▲`),r?_settingsOpen.delete(e):_settingsOpen.add(e)}function ys(){confirm(`Clear the entire activity log? This cannot be undone.`)&&(g.activityLog=[],window.saveData(g),renderSettings())}function bs(e){let t=document.getElementById(`new-cat-${e}`),n=(t.value||``).trim();if(!n){t.focus();return}let r=e===`expense`?g.expenseCategories:g.incomeCategories;if(r.includes(n)){alert(`That category already exists.`);return}r.push(n),window.logActivity(`Added ${e} category`,n),us(),t.value=``,renderSettings()}function xs(e,t){let n=e===`expense`?g.expenseCategories:g.incomeCategories;if(e===`expense`&&(g.budget.expenses.some(e=>e.category===t)||Object.values(g.budget.months||{}).some(e=>(e.expenses||[]).some(e=>e.category===t)))&&!confirm(`"${t}" is used by existing expenses. Remove anyway?`))return;let r=n.indexOf(t);r!==-1&&n.splice(r,1),window.logActivity(`Removed ${e} category`,t),us(),renderSettings()}function Ss(e){let t=g.categoryGroups||DEFAULT_DATA.categoryGroups;g.budget.actuals[window.selectedBudgetMonth];let n=(g.colors||{}).expense||{},r=new Set(t.flatMap(e=>e.categories)),i=[...new Set(e.map(e=>e.category||`Other`))].filter(e=>!r.has(e)),a=i.length>0?[...t,{id:`ug`,name:`Ungrouped`,icon:`📋`,categories:i}]:t,o=`<div style="display:flex;flex-direction:column;gap:16px;margin-top:4px">`;for(let t of a){let r=e.filter(e=>t.categories.includes(e.category||`Other`));if(r.length===0)continue;let i=r.reduce((e,t)=>e+j(t),0),a=r.reduce((e,t)=>e+window.getActual(t.id,window.selectedBudgetMonth),0),s=i>0?Math.round(a/i*100):0,c=Math.min(100,s),l=s>=100?`var(--danger)`:s>=80?`var(--warning)`:`var(--success)`,u=a>0,d=a>i&&u,f=r[0]&&r[0].category||`Other`,p=n[f]||window.colors.expense[f]||`#94a3b8`;o+=`
    <div style="background:var(--surface);border:1px solid ${d?`var(--danger)`:`var(--border)`};border-radius:10px;overflow:hidden">
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;padding:11px 14px;cursor:pointer;user-select:none;background:${p}22;border-bottom:3px solid ${p}" onclick="toggleGroupExpand('${t.id}')">
        <div style="display:flex;align-items:center;gap:8px">
          ...
          <span style="font-weight:700;font-size:14px">${T(t.name)}</span>
          <span style="font-size:11px;color:var(--text-muted)">${r.length} item${r.length===1?``:`s`}</span>
        </div>
        <div style="display:flex;align-items:center;gap:10px">
          <span style="font-weight:700;font-size:14px">${D(i)}<span style="font-size:11px;font-weight:400;color:var(--text-muted)">/mo</span></span>
      ...
      <div style="padding:12px 14px;background:var(--surface2);border-top:1px solid var(--border)">
        ...
        <div style="display:flex;justify-content:space-between;font-size:12px">
          <span style="color:${u?l:`var(--text-muted)`}">
            ${u?`${D(a)} spent · ${s}%${d?` — over budget!`:``}`:`No actuals entered yet`}
          </span>
          <span style="color:var(--text-muted)">${D(i)} budgeted</span>
        </div>
      </div>
      ...
      <div id="grp-body-${t.id}" style="border-top:1px solid var(--border)">
        ...
        ${r.map(e=>{let t=j(e),r=window.getActual(e.id,window.selectedBudgetMonth),i=t>0?Math.min(100,Math.round(r/t*100)):0,a=n[e.category||`Other`]||window.colors.expense[e.category||`Other`]||`#94a3b8`,o=r>t&&r>0;return r>0?`${D(r)}${D(t)}${i}`:`${D(t)}`,`
          <div class="expense-row" style="--row-color:${a};display:flex;align-items:center;gap:10px;padding:10px 14px;border-bottom:1px solid var(--border)">
            ...
            <div style="flex:1;min-width:0;cursor:pointer" onclick="event.stopPropagation();openEditExpense('${e.id}')">
              <div style="font-size:13px;font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${T(e.name)}</div>
              <div style="font-size:11px;color:var(--text-muted)">${e.category||`Other`}${e.vendor?` · ${T(e.vendor)}`:``} · ${A(e)}</div>
            </div>
            <div style="text-align:right;flex-shrink:0;margin-right:4px">
              <div style="font-size:13px;font-weight:600">${D(t)}/mo</div>
              ${r>0?`<div style="font-size:11px;font-weight:600;color:${o?`var(--danger)`:i>=80?`var(--warning)`:`var(--success)`}">${D(r)} actual${o?` ▲`:``}</div>`:`<div style="font-size:11px;color:var(--text-muted);cursor:pointer" onclick="event.stopPropagation();window.editActual('${e.id}')">+ add actual</div>`}
            </div>
    ...
    <div class="summary-hero" onclick="toggleBudgetDetail()">
      ...
      <div class="summary-hero-num">${D(Math.abs(i))}</div>
      <div class="summary-hero-sub">${D(n)} income · ${D(r)} expenses</div>
      <div class="summary-hero-expand" id="budget-expand-label">${Os?`Hide details ▲`:`See breakdown ▼`}</div>
    </div>`,d+=`
    ...
    <div class="summary-mini-grid">
      <div class="summary-mini">
        <div class="summary-mini-num" style="color:var(--good)">${D(n)}</div>
        <div class="summary-mini-label">Income</div>
      </div>
      <div class="summary-mini">
        <div class="summary-mini-num">${D(r)}</div>
        <div class="summary-mini-label">Budgeted</div>
      </div>
      <div class="summary-mini">
        <div class="summary-mini-num" style="color:${a>r?`var(--alert)`:`var(--text)`}">${D(a)}</div>
    ...
    </div>`;let f=Cs({income:e,expenses:t});if(f.segments.length){let e=f.segments.map(e=>`<div style="background:${e.color};flex:${e.pct.toFixed(2)}"></div>`).join(``),t=f.segments.map(e=>`<div class="alloc-row">
        <div class="tdot" style="background:${e.color}"><svg viewBox="0 0 24 24"><use href="#${Es(e.name)}"/></svg></div>
        <div class="body">
          <div class="ticker">${Ts(e.name)}</div>
          <div class="name">${T(e.name)}</div>
        </div>
        <div>
          <div class="pct">${Math.round(e.pct)}%</div>
          <div class="amt">${D(e.amount)}</div>
        </div>
      </div>`).join(``);d+=`<div class="alloc-section" style="margin-bottom:16px">
      <div style="display:flex;align-items:center;justify-content:space-between;cursor:pointer;user-select:none;margin-bottom:${ks?`12px`:`0`}" onclick="_toggleAllocExpanded()">
        <div class="alloc-title" style="margin-bottom:0">Budget Allocation</div>
        <span style="font-size:11px;color:var(--muted);font-family:var(--mono)">${ks?`▲`:`▼`}</span>
      </div>
      <div class="alloc-bar" style="margin-bottom:${ks?`12px`:`0`}">${e}</div>
      ${ks?`<div class="alloc-list">${t}</div>`:``}
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;cursor:pointer;user-select:none;margin-bottom:${Os?`16px`:`0`}" onclick="toggleBudgetDetail()">
      <div class="alloc-title" style="margin-bottom:0">Detailed Breakdown</div>
      <span style="font-size:11px;color:var(--muted);font-family:var(--mono)" id="budget-expand-chevron">${Os?`▲`:`▼`}</span>
    </div>
    <div class="detail-panel ${Os?`expanded`:`collapsed`}" id="budget-detail" style="margin:0 -4px">`,window.isMonthCustomized(window.selectedBudgetMonth)||(d+=`<div style="display:flex;align-items:center;justify-content:space-between;background:var(--primary-light);border:1px solid #bfdbfe;border-radius:var(--r-sm);padding:10px 16px;margin-bottom:16px;gap:12px;flex-wrap:wrap">
      <div>
      ...
      <button class="btn btn-primary btn-sm" onclick="window.copyMonthFromPrevious('${window.selectedBudgetMonth}')">
        Copy from ${window.monthLabel(u)}
      </button>
    </div>`),d+=renderBudgetForecast(window.selectedBudgetMonth,i),d+=renderBudgetSuggestions(window.selectedBudgetMonth),d+=`
    <div class="section" id="budget-income-section" style="margin-bottom:20px">
      <div class="section-header">
        <div>
          <div class="section-title">Income</div>
          <div class="section-subtitle">${D(n)}/mo total</div>
        </div>
        <button class="btn btn-primary btn-sm" onclick="openAddIncome()">+ Income</button>
      </div>
      <div style="padding:0 20px 8px">
        ${e.length===0?`<div class="empty"><div class="empty-icon">💵</div>Add your income sources</div>`:e.map(e=>{let t=window.colors.income||`var(--good)`,n=e.recurring===!1?`<span style="font-size:10px;font-weight:600;padding:1px 6px;border-radius:var(--r-pill);background:#fef9c3;color:#854d0e;border:1px solid #fde047;margin-left:6px">one-time</span>`:``;return`
              <div style="display:flex;align-items:center;gap:12px;padding:12px 0;border-bottom:1px solid var(--hairline)">
                <div style="width:4px;height:44px;border-radius:2px;background:${t};flex-shrink:0"></div>
                <div style="flex:1;min-width:0">
                  <div style="font-size:14px;font-weight:600;margin-bottom:2px">${T(e.name)}${n}</div>
                  <div style="font-size:12px;color:var(--text-muted)">${A(e)}${e.dueDate?` · due ${e.dueDate.split(`-`).reverse().join(`/`)}`:``}</div>
                </div>
                <div style="text-align:right;flex-shrink:0">
                  <div style="font-size:14px;font-weight:700;color:var(--good)">${D(j(e))}<span style="font-size:11px;font-weight:400;color:var(--text-muted)">/mo</span></div>
                  ${e.amount===j(e)?``:`<div style="font-size:12px;color:var(--text-muted)">${ne(e.amount)} ${A(e).toLowerCase()}</div>`}
                </div>
  ...
  `;let p=[`all`,...Array.from(new Set(t.map(e=>e.category||`Other`))).sort()],m=window.expenseFilterCat===`all`?t:t.filter(e=>(e.category||`Other`)===window.expenseFilterCat),h=m.reduce((e,t)=>e+j(t),0),_=m.reduce((e,t)=>e+window.getActual(t.id,window.selectedBudgetMonth),0),v=h-_,y=window.expenseFilterCat!==`all`;d+=`
    <div class="section">
      <div id="budget-expense-section" style="padding:16px 20px 12px">
        <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:12px">
          <div>
            ...
            <div class="section-subtitle">
              Budget: ${D(r)}/mo
              ${a>0?` · Actual: ${D(a)} · <span class="${o>=0?`var-under`:`var-over`}">${o>=0?`▼`:`▲`} ${D(Math.abs(o))}</span>`:``}
            </div>
          </div>
        ...
        ${window.budgetViewMode===`table`?`<select class="form-select" style="width:100%;margin-top:8px" onchange="window.setExpenseFilter(this.value)">
          ${p.map(e=>`<option value="${e}" ${window.expenseFilterCat===e?`selected`:``}>${e===`all`?`All categories`:e}</option>`).join(``)}
        </select>`:``}
      </div>

      <div style="padding:0 12px 16px">
      ${window.budgetViewMode===`report`?Ps(t,r,a):window.budgetViewMode===`grouped`?Ss(t):m.length===0?`<div class="empty"><div class="empty-icon">📋</div>${t.length===0?`Add your household expenses`:`No expenses in this category`}</div>`:`<div>${[...m].sort((e,t)=>{if(!window.expenseSortCol)return 0;let n,r;if(window.expenseSortCol===`name`)n=e.name.toLowerCase(),r=t.name.toLowerCase();else if(window.expenseSortCol===`category`)n=(e.category||`Other`).toLowerCase(),r=(t.category||`Other`).toLowerCase();else if(window.expenseSortCol===`budget`)n=j(e),r=j(t);else if(window.expenseSortCol===`actual`)n=window.getActual(e.id,window.selectedBudgetMonth),r=window.getActual(t.id,window.selectedBudgetMonth);else if(window.expenseSortCol===`variance`)n=j(e)-window.getActual(e.id,window.selectedBudgetMonth),r=j(t)-window.getActual(t.id,window.selectedBudgetMonth);else return 0;return n<r?window.expenseSortDir===`asc`?-1:1:n>r?window.expenseSortDir===`asc`?1:-1:0}).map(e=>{let t=j(e),n=window.getActual(e.id,window.selectedBudgetMonth),r=t-n,i=n>0,a=i&&n>t,o=t>0?Math.min(100,Math.round(n/t*100)):0,s=a?`var(--alert)`:o>=80?`var(--watch)`:`var(--good)`,c=window.colors.expense[e.category||`Other`]||`#94a3b8`,l=e.recurring===!1?`<span style="font-size:10px;font-weight:600;padding:1px 6px;border-radius:var(--r-pill);background:#fef9c3;color:#854d0e;border:1px solid #fde047;margin-left:6px">one-time</span>`:``,u=i?a?`<span style="color:var(--alert);font-size:11px;font-weight:600">▲ ${D(Math.abs(r))} over</span>`:`<span style="color:var(--good);font-size:11px;font-weight:600">▼ ${D(r)} left</span>`:``;return`
            <div style="display:flex;align-items:center;gap:12px;padding:12px 0;border-bottom:1px solid var(--hairline)">
              <div style="width:4px;height:44px;border-radius:2px;background:${c};flex-shrink:0"></div>
              <div style="flex:1;min-width:0">
                <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-bottom:2px">
                  <span style="font-size:14px;font-weight:600">${T(e.name)}${l}</span>
                  <span style="font-size:11px;padding:1px 8px;border-radius:var(--r-pill);background:${c};color:#fff;font-weight:600;white-space:nowrap">${e.category||`Other`}</span>
                </div>
                <div style="font-size:12px;color:var(--text-muted)">${A(e)}${e.dueDate?` · due ${e.dueDate.split(`-`).reverse().join(`/`)}`:``}</div>
                ${i?`<div style="margin-top:5px"><div style="background:var(--hairline);border-radius:var(--r-pill);height:4px;overflow:hidden;margin-bottom:3px"><div style="height:100%;width:${o}%;background:${s};border-radius:var(--r-pill)"></div></div>${u}</div>`:``}
              </div>
              <div style="text-align:right;flex-shrink:0">
                <div style="font-size:14px;font-weight:700">${D(t)}<span style="font-size:11px;font-weight:400;color:var(--text-muted)">/mo</span></div>
                <div style="font-size:12px;font-weight:600;color:${i?a?`var(--alert)`:`var(--good)`:`var(--teal)`};cursor:pointer;margin-top:2px" onclick="window.editActual('${e.id}')">
                  ${i?D(n)+` actual`:`+ add actual`}
                </div>
              </div>
            ...
            </div>`}).join(``)}${m.length>0?`<div style="display:flex;justify-content:space-between;padding:12px 0 0;font-size:13px;font-weight:700;border-top:2px solid var(--hairline);margin-top:4px">
            <span style="color:var(--text-muted)">Total ${y?window.expenseFilterCat:`all`}</span>
            <div style="text-align:right">
              <div>${D(h)}/mo</div>
              ${_>0?`<div style="font-size:12px"><span class="${v>=0?`var-under`:`var-over`}">${v>=0?`▼`:`▲`} ${D(Math.abs(v))}</span> · ${D(_)} actual</div>`:``}
            </div>
          </div>`:``}</div>`}
      </div>
    </div>
  `,d+=`</div></div>`,document.getElementById(`budget-content`).innerHTML=d}catch(e){console.error(`renderBudget error:`,e);let t=document.getElementById(`budget-content`);t&&(t.innerHTML=`<div style="padding:24px;color:var(--alert);font-family:var(--mono);font-size:13px">Render error: ${T(e.message)}<br><small>${T(e.stack||``)}</small></div>`)}}var Os=!1,ks=!1;function As(){ks=!ks,Ds()}function js(){V(`What would you like to add?`,`
    ...
    </div>`,null),document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="closeModal()">Cancel</button>`}function Ms(e){Os=!0,Ds(),setTimeout(()=>{let t=e===`income`?`budget-income-section`:`budget-expense-section`;document.getElementById(t)?.scrollIntoView({behavior:`smooth`,block:`start`})},100)}function Ns(e){let t=(g.budget?.expenses||[]).find(t=>t.id===e);t&&(V(T(t.name),`
    <div style="display:flex;flex-direction:column;gap:10px;padding:4px 0">
      <button onclick="closeModal();openEditExpense('${e}')"
      ...
      <button onclick="closeModal();window.editActual('${e}')"
        style="width:100%;padding:13px 16px;text-align:left;border:1px solid var(--hairline);background:var(--surface2);border-radius:var(--r);font-size:14px;font-weight:600;color:var(--text);cursor:pointer;font-family:var(--sans);display:flex;align-items:center;gap:12px">
        <span style="font-size:20px">💰</span> Update actual spend
      </button>
      <button onclick="closeModal();deleteExpense('${e}')"
    ...
    </div>`,null),document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="closeModal()">Cancel</button>`)}function Ps(e,t,n){if(!e.length)return`<div style="text-align:center;padding:32px;color:var(--text-muted)">No expenses to report on.</div>`;let r={};e.forEach(e=>{let t=e.category||`Other`;r[t]||(r[t]={budget:0,actual:0});let n=window.itemMonthly?window.itemMonthly(e):e.amount||0;r[t].budget+=n,r[t].actual+=window.getActual?window.getActual(e.id,window.selectedBudgetMonth):0});let i=Object.entries(r).sort((e,t)=>t[1].budget-e[1].budget),a=[`#5B4CF5`,`#0891b2`,`#10b981`,`#f59e0b`,`#ef4444`,`#8b5cf6`,`#06b6d4`,`#84cc16`,`#f97316`,`#ec4899`],o=i.reduce((e,[,t])=>e+t.budget,0),s=0,c=2*Math.PI*70;return`<div style="display:flex;justify-content:center;margin-bottom:20px">
    <svg width="180" height="180" viewBox="0 0 180 180">
      ${i.map(([e,t],n)=>{let r=o>0?t.budget/o:0,i=r*c,l=c-i,u=`<circle cx="90" cy="90" r="70" fill="none" stroke="${a[n%a.length]}" stroke-width="28"
      stroke-dasharray="${i.toFixed(2)} ${l.toFixed(2)}"
      stroke-dashoffset="${(-s*c).toFixed(2)}"
      style="transform:rotate(-90deg);transform-origin:90px 90px"/>`;return s+=r,u}).join(``)}
      <text x="90" y="84" text-anchor="middle" style="font-size:11px;fill:var(--text-muted);font-family:var(--mono)">BUDGET</text>
      <text x="90" y="102" text-anchor="middle" style="font-size:16px;font-weight:700;fill:var(--text);font-family:var(--mono)">${D(o)}</text>
    </svg>
  </div><div>${i.map(([e,t],n)=>{let r=o>0?Math.round(t.budget/o*100):0,i=t.actual>t.budget&&t.actual>0;return`<div style="display:flex;align-items:center;gap:10px;padding:10px 0;border-bottom:1px solid var(--hairline)">
      <div style="width:12px;height:12px;border-radius:3px;background:${a[n%a.length]};flex-shrink:0"></div>
      <div style="flex:1;font-size:13px;font-weight:500">${T(e)}</div>
      <div style="text-align:right;font-size:12px">
        <div style="font-weight:700">${D(t.budget)}/mo <span style="color:var(--text-muted);font-weight:400">(${r}%)</span></div>
        ${t.actual>0?`<div style="color:${i?`var(--alert)`:`var(--good)`};">${D(t.actual)} actual${i?` ▲`:``}</div>`:``}
      </div>
    </div>`}).join(``)}</div>`}function Fs(){Os=!Os;let e=document.getElementById(`budget-detail`),t=document.getElementById(`budget-expand-label`),n=document.getElementById(`budget-expand-chevron`),r=e&&e.parentElement;e&&(e.classList.toggle(`collapsed`,!Os),e.classList.toggle(`expanded`,Os)),r&&(r.style.marginBottom=Os?`16px`:`0`),t&&(t.textContent=Os?`Hide details ▲`:`See breakdown ▼`),n&&(n.textContent=Os?`▲`:`▼`)}function V(e,t,n){document.getElementById(`modal-title`).textContent=e,document.getElementById(`modal-body`).innerHTML=t,document.getElementById(`modal-footer`).innerHTML=`
    <button class="btn btn-ghost" onclick="closeModal()">Cancel</button>
    <button class="btn btn-primary" id="modal-save-btn">Save</button>
  `,window._modalSaveHandler=n,document.getElementById(`modal-save-btn`).onclick=()=>window._modalSaveHandler?.(),document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Is(){window._pendingLogEntry=null,window._actualEditorRefresh=null,window._csvSuggestions=null,window._csvSuggestNames=null,document.getElementById(`modal-body`).innerHTML=``,document.getElementById(`modal-footer`).innerHTML=``,document.getElementById(`modal-overlay`).classList.add(`hidden`)}document.getElementById(`modal-overlay`).addEventListener(`click`,e=>{e.target===document.getElementById(`modal-overlay`)&&Is()});function Ls(){V(`Edit Contract Total`,`
    <div class="form-group">
  ...
  `,()=>{let e=parseFloat(document.getElementById(`f-contract-total`).value);!isNaN(e)&&e>0&&(window.logActivity(`Updated contract total`,D(e)),g.buildContract.total=e,window.saveData(g),Is(),window.renderAll())})}function Rs(e={}){return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Stage Name</label>
        <input class="form-input" id="f-stage-name" type="text" maxlength="200" value="${E(e.name||``)}" placeholder="e.g. Base / Slab">
      </div>
      <div class="form-group">
        <label class="form-label">Amount (AUD)</label>
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <input class="form-input" id="f-stage-ref" type="text" maxlength="200" value="${E(e.invoiceRef||``)}" placeholder="Optional">
      </div>
    </div>
    <div class="form-row">
  ...
  `}function zs(e){return{id:e,name:document.getElementById(`f-stage-name`).value.trim(),amount:parseFloat(document.getElementById(`f-stage-amount`).value)||0,paid:document.getElementById(`f-stage-paid`).checked,expectedDate:document.getElementById(`f-stage-expected`).value,paidDate:document.getElementById(`f-stage-paiddate`).value,invoiceRef:document.getElementById(`f-stage-ref`).value.trim(),funding:document.getElementById(`f-stage-funding`).value,notes:document.getElementById(`f-stage-notes`).value.trim()}}function Bs(){V(`Add Contract Stage`,Rs(),()=>{let e=zs(N(g.buildContract.stages));e.name&&(window.logActivity(`Added build stage`,e.name),g.buildContract.stages.push(e),window.saveData(g),Is(),window.renderAll())})}function Vs(e){let t=g.buildContract.stages.find(t=>t.id===e);V(`Edit Stage`,Rs(t),()=>{let n=zs(e);window.logActivity(`Edited build stage`,n.name||t.name),Object.assign(t,n),window.saveData(g),Is(),window.renderAll()})}function Hs(e){if(!confirm(`Delete this stage?`))return;let t=g.buildContract.stages.find(t=>t.id===e);window.logActivity(`Deleted build stage`,t?t.name:``),g.buildContract.stages=g.buildContract.stages.filter(t=>t.id!==e),window.saveData(g),window.renderAll()}function Us(e={}){return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Variation Ref</label>
        <input class="form-input" id="f-var-ref" type="text" maxlength="200" value="${E(e.ref||``)}" placeholder="e.g. V001">
      </div>
      <div class="form-group">
        <label class="form-label">Status</label>
    ...
    <div class="form-group">
      <label class="form-label">Description</label>
      <input class="form-input" id="f-var-name" type="text" maxlength="200" value="${E(e.name||``)}" placeholder="e.g. Tile upgrade — master bathroom">
    </div>
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Amount (AUD)</label>
    ...
    <div class="form-group">
      <label class="form-label">Notes</label>
      <input class="form-input" id="f-var-notes" type="text" maxlength="200" value="${E(e.notes||``)}" placeholder="Optional">
    </div>
  `}function Ws(e){return{id:e,ref:document.getElementById(`f-var-ref`).value.trim(),name:document.getElementById(`f-var-name`).value.trim(),amount:parseFloat(document.getElementById(`f-var-amount`).value)||0,status:document.getElementById(`f-var-status`).value,funding:document.getElementById(`f-var-funding`).value,dateRaised:document.getElementById(`f-var-raised`).value,dateApproved:document.getElementById(`f-var-approved`).value,notes:document.getElementById(`f-var-notes`).value.trim()}}function Gs(){V(`Add Variation`,Us(),()=>{let e=Ws(N(g.buildContract.variations));e.name&&(window.logActivity(`Added variation`,`${e.ref?e.ref+` · `:``}${e.name}`),g.buildContract.variations.push(e),window.saveData(g),renderBuild())})}function Ks(e){V(`Edit Variation`,Us(g.buildContract.variations.find(t=>t.id===e)),()=>{let t=Ws(e);if(!t.name)return;window.logActivity(`Edited variation`,`${t.ref?t.ref+` · `:``}${t.name}`);let n=g.buildContract.variations.findIndex(t=>t.id===e);n!==-1&&(g.buildContract.variations[n]=t),window.saveData(g),renderBuild()})}function qs(e){if(!confirm(`Delete this variation?`))return;let t=g.buildContract.variations.find(t=>t.id===e);window.logActivity(`Deleted variation`,t?t.name:``),g.buildContract.variations=g.buildContract.variations.filter(t=>t.id!==e),window.saveData(g),renderBuild()}var Js=[{value:`not-quoted`,label:`Not Quoted`},{value:`quoted`,label:`Quoted`},{value:`approved`,label:`Approved`},{value:`partial`,label:`Partially Paid`},{value:`paid`,label:`Paid`}];function Ys(e={}){let t=e.status||(e.totalAmount?`approved`:`not-quoted`);return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Item Name</label>
        <input class="form-input" id="f-extra-name" type="text" maxlength="200" value="${E(e.name||``)}" placeholder="e.g. Solar">
      </div>
      <div class="form-group">
        <label class="form-label">Vendor / Contractor</label>
        <input class="form-input" id="f-extra-vendor" type="text" maxlength="200" value="${E(e.vendor||``)}" placeholder="Company name">
      </div>
    </div>
    <div class="form-row">
      <div class="form-group">
        ...
        <select class="form-select" id="f-extra-status">
          ${Js.map(e=>`<option value="${e.value}" ${t===e.value?`selected`:``}>${e.label}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
    ...
    <div class="form-row">
      ...
      <div class="form-group">
        <label class="form-label">Notes</label>
        <input class="form-input" id="f-extra-notes" type="text" maxlength="200" value="${E(e.notes||``)}" placeholder="Optional">
      </div>
    </div>
  `}function Xs(e){return{id:e,name:document.getElementById(`f-extra-name`).value.trim(),vendor:document.getElementById(`f-extra-vendor`).value.trim(),status:document.getElementById(`f-extra-status`).value,funding:document.getElementById(`f-extra-funding`).value,totalAmount:parseFloat(document.getElementById(`f-extra-total`).value)||0,amountPaid:parseFloat(document.getElementById(`f-extra-paid`).value)||0,dueDate:document.getElementById(`f-extra-due`).value,notes:document.getElementById(`f-extra-notes`).value.trim()}}function Zs(){V(`Add Outside Contract Item`,Ys(),()=>{let e=Xs(N(g.extras));e.name&&(window.logActivity(`Added extra item`,e.name),g.extras.push(e),window.saveData(g),Is(),window.renderAll())})}function Qs(e){let t=g.extras.find(t=>t.id===e);V(`Edit Item`,Ys(t),()=>{let n=Xs(e);window.logActivity(`Edited extra item`,n.name||t.name),Object.assign(t,n),window.saveData(g),Is(),window.renderAll()})}function $s(e){if(!confirm(`Delete this item?`))return;let t=g.extras.find(t=>t.id===e);window.logActivity(`Deleted extra item`,t?t.name:``),g.extras=g.extras.filter(t=>t.id!==e),window.saveData(g),window.renderAll()}function ec(e={}){let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():``,n=[`weekly`,`fortnightly`,`monthly`,`quarterly`,`annually`,`custom`],r=e.frequency===`custom`;return`
    <div class="form-group">
      <label class="form-label">Source / Description</label>
      <input class="form-input" id="f-inc-name" type="text" maxlength="200" value="${E(e.name||``)}" placeholder="e.g. Salary — Chris">
    </div>
    <div class="form-group">
      <label class="form-label">Amount (AUD)</label>
  ...
  `}function tc(e){let t=document.getElementById(`f-inc-freq`)?document.getElementById(`f-inc-freq`).value:`monthly`,n=document.getElementById(`f-inc-recurring`),r={id:e,name:document.getElementById(`f-inc-name`).value.trim(),amount:parseFloat(document.getElementById(`f-inc-amount`).value)||0,frequency:t,dueDate:document.getElementById(`f-inc-duedate`).value||null,recurring:n?n.checked:!0};return t===`custom`&&(r.customEvery=parseInt(document.getElementById(`f-inc-custom-n`).value)||1,r.customUnit=document.getElementById(`f-inc-custom-unit`).value),r}function nc(){V(`Add Income`,ec(),()=>{let e=tc(N(window.getMonthData(window.selectedBudgetMonth).income));e.name&&(window.logActivity(`Added income`,e.name),window.confirmScope(()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth);e.id=N(t.income),t.income.push(e),window.saveData(g),window.renderAll()},()=>{e.id=N(g.budget.income),g.budget.income.push(e),window.saveData(g),window.renderAll()}))})}function rc(e){let t=window.getMonthData(window.selectedBudgetMonth).income.find(t=>t.id===e);V(`Edit Income`,ec(t),()=>{let n=tc(e);window.logActivity(`Edited income`,n.name||t&&t.name||``),window.confirmScope(()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth),r=t.income.find(t=>t.id===e);r?Object.assign(r,n):t.income.push(n),window.saveData(g),window.renderAll()},()=>{let t=g.budget.income.find(t=>t.id===e);t&&Object.assign(t,n),window.saveData(g),window.renderAll()})})}function ic(e){let t=window.getMonthData(window.selectedBudgetMonth).income.find(t=>t.id===e),n=t?t.name:`this income`;window.logActivity(`Deleted income`,n),window._scopePending=null,document.getElementById(`modal-title`).textContent=`Delete income`,document.getElementById(`modal-body`).innerHTML=`
    ...
    </p>`,window._scopePending={onThisMonth:()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth);t.income=t.income.filter(t=>t.id!==e),window.saveData(g),window.renderAll()},onAllMonths:()=>{g.budget.income=g.budget.income.filter(t=>t.id!==e),g.budget.months&&Object.values(g.budget.months).forEach(t=>{t.income=t.income.filter(t=>t.id!==e)}),window.saveData(g),window.renderAll()}},document.getElementById(`modal-footer`).innerHTML=`
    <button class="btn btn-ghost" onclick="closeModal()">Cancel</button>
  ...
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function ac(e={}){let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():``,n=[`weekly`,`fortnightly`,`monthly`,`quarterly`,`annually`,`custom`],r=e.frequency===`custom`;return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Description</label>
        <input class="form-input" id="f-exp-name" type="text" maxlength="200" value="${E(e.name||``)}" placeholder="e.g. Mortgage">
      </div>
      <div class="form-group">
        <label class="form-label">Category</label>
    ...
    <div class="form-group">
      ...
      <input class="form-input" id="f-exp-vendor" type="text" maxlength="200" value="${E(e.vendor||``)}" placeholder="e.g. ANZ, Woolworths, Netflix">
    </div>
    <div class="form-group">
      <label class="form-label">Amount (AUD)</label>
  ...
  `}function oc(e){let t=document.getElementById(`f-exp-freq`)?document.getElementById(`f-exp-freq`).value:`monthly`,n=document.getElementById(`f-exp-recurring`),r={id:e,name:document.getElementById(`f-exp-name`).value.trim(),category:document.getElementById(`f-exp-cat`).value,vendor:(document.getElementById(`f-exp-vendor`)?.value||``).trim()||null,amount:parseFloat(document.getElementById(`f-exp-amount`).value)||0,frequency:t,dueDate:document.getElementById(`f-exp-duedate`).value||null,recurring:n?n.checked:!0};return t===`custom`&&(r.customEvery=parseInt(document.getElementById(`f-exp-custom-n`).value)||1,r.customUnit=document.getElementById(`f-exp-custom-unit`).value),r}function sc(e){let t=document.getElementById(`f-${e}-freq`).value,n=document.getElementById(`f-${e}-custom-wrap`);n&&(n.style.display=t===`custom`?`flex`:`none`)}function cc(){V(`Add Expense`,ac(),()=>{let e=oc(N(window.getMonthData(window.selectedBudgetMonth).expenses));e.name&&(window.logActivity(`Added expense`,`${e.name} (${e.category||`Other`})`),window.confirmScope(()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth);e.id=N(t.expenses),t.expenses.push(e),window.saveData(g),window.renderAll()},()=>{if(e.id=N(g.budget.expenses),g.budget.expenses.push(e),window.isMonthCustomized(window.selectedBudgetMonth)){let t=g.budget.months[window.selectedBudgetMonth];t.expenses.push({...e,id:N(t.expenses)})}window.saveData(g),window.renderAll()}))})}function lc(e){let t=window.getMonthData(window.selectedBudgetMonth).expenses.find(t=>t.id===e);V(`Edit Expense`,ac(t),()=>{let n=oc(e);window.logActivity(`Edited expense`,`${n.name||t&&t.name||``} (${n.category||`Other`})`),window.confirmScope(()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth),r=t.expenses.find(t=>t.id===e);r?Object.assign(r,n):t.expenses.push(n),window.saveData(g),window.renderAll()},()=>{let t=g.budget.expenses.find(t=>t.id===e);if(t&&Object.assign(t,n),window.isMonthCustomized(window.selectedBudgetMonth)){let t=g.budget.months[window.selectedBudgetMonth].expenses.find(t=>t.id===e);t&&Object.assign(t,n)}window.saveData(g),window.renderAll()})});let n=document.createElement(`button`);n.className=`btn btn-danger`,n.textContent=`Delete`,n.style.marginRight=`auto`,n.onclick=()=>{Is(),uc(e)};let r=document.getElementById(`modal-footer`);r.insertBefore(n,r.firstChild)}function uc(e){let t=window.getMonthData(window.selectedBudgetMonth).expenses.find(t=>t.id===e),n=t?t.name:`this expense`;window.logActivity(`Deleted expense`,n),window._scopePending={onThisMonth:()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth);t.expenses=t.expenses.filter(t=>t.id!==e),window.saveData(g),window.renderAll()},onAllMonths:()=>{g.budget.expenses=g.budget.expenses.filter(t=>t.id!==e),g.budget.months&&Object.values(g.budget.months).forEach(t=>{t.expenses=t.expenses.filter(t=>t.id!==e)}),window.saveData(g),window.renderAll()}},document.getElementById(`modal-title`).textContent=`Delete expense`,document.getElementById(`modal-body`).innerHTML=`
    <p style="font-size:14px;line-height:1.6;margin:0;color:var(--text-muted)">
      Delete <strong style="color:var(--text)">${n}</strong>? Apply to
      <strong style="color:var(--text)">${window.monthLabel(window.selectedBudgetMonth)}</strong> only,
      or remove from all months?
    ...
    <button class="btn btn-secondary" onclick="window.doScopeAll()">Remove from all months</button>
    <button class="btn btn-danger" onclick="window.doScopeMonth()">Delete from ${window.monthLabel(window.selectedBudgetMonth)}</button>
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function dc(){return document.getElementById(`f-exp-duedate`)||document.getElementById(`f-inc-duedate`)}function fc(e){e.stopPropagation();let t=document.getElementById(`dp-popup`);if(!t)return;let n=(dc()||{}).value||``;if(n)[window.dpViewYear,window.dpViewMonth]=n.split(`-`).map(Number);else{let e=new Date;window.dpViewYear=e.getFullYear(),window.dpViewMonth=e.getMonth()+1}t.classList.remove(`hidden`),pc();function r(e){let n=document.getElementById(`dp-wrap`);n&&!n.contains(e.target)?t.classList.add(`hidden`):document.addEventListener(`click`,r,{once:!0})}document.addEventListener(`click`,r,{once:!0})}function pc(){let e=document.getElementById(`dp-popup`);if(!e)return;let t=window.dpViewYear,n=window.dpViewMonth,r=new Date(t,n-1,1).getDay(),i=new Date(t,n,0).getDate(),a=new Date,o=(dc()||{}).value||``,s=`
    <div class="dp-nav">
  ...
  `;for(let e=0;e<r;e++)s+=`<div class="dp-day dp-other"></div>`;for(let e=1;e<=i;e++){let r=`${t}-${String(n).padStart(2,`0`)}-${String(e).padStart(2,`0`)}`,i=[`dp-day`,a.getFullYear()===t&&a.getMonth()+1===n&&a.getDate()===e?`dp-today`:``,o===r?`dp-selected`:``].filter(Boolean).join(` `);s+=`<div class="${i}" onclick="dpSelectDate('${r}',event)">${e}</div>`}s+=`</div>`,o&&(s+=`<div class="dp-clear"><button class="dp-clear-btn" onclick="dpClearDate(event)">Clear date</button></div>`),e.innerHTML=s}function mc(e){e.stopPropagation(),window.dpViewMonth===1?(window.dpViewMonth=12,window.dpViewYear--):window.dpViewMonth--,pc()}function hc(e){e.stopPropagation(),window.dpViewMonth===12?(window.dpViewMonth=1,window.dpViewYear++):window.dpViewMonth++,pc()}function gc(e,t){t&&t.stopPropagation();let n=dc();n&&(n.value=e);let[r,i,a]=e.split(`-`);document.getElementById(`dp-display`).textContent=`${a}/${i}/${r}`,document.getElementById(`dp-trigger`).classList.add(`has-value`),document.getElementById(`dp-popup`).classList.add(`hidden`);let o=document.getElementById(`dp-repeats-wrap`);o&&(o.style.display=``)}function _c(e){e.stopPropagation();let t=dc();t&&(t.value=``),document.getElementById(`dp-display`).textContent=`Select a date`,document.getElementById(`dp-trigger`).classList.remove(`has-value`),document.getElementById(`dp-popup`).classList.add(`hidden`);let n=document.getElementById(`dp-repeats-wrap`);n&&(n.style.display=`none`)}var vc=[],yc=[];function bc(){document.getElementById(`modal-title`).textContent=`Import Bank Transactions`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <div>
      <div style="background:var(--success-light);border:1px solid #6ee7b7;border-radius:8px;padding:10px 14px;margin-bottom:16px;font-size:13px;color:#155e75">
        Found <strong>${vc.length} expense transactions</strong> in your CSV
      </div>
        ...
        <table>
          ...
          <tbody>
            ${t.map(e=>`<tr>
              ...
              <td style="font-weight:500">${T(e.description)}</td>
              <td class="amount">${ne(e.amount)}</td>
            </tr>`).join(``)}
            ${vc.length>5?`<tr><td colspan="3" style="text-align:center;color:var(--text-muted);font-size:12px;padding:8px">+ ${vc.length-5} more rows…</td></tr>`:``}
          </tbody>
        </table>
      </div>
    ...
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    ${e?`<button class="btn btn-primary" onclick="runCsvCategorise()">Categorise with AI →</button>`:`<button class="btn btn-primary" onclick="_renderCsvReview(null)">Assign Manually →</button>`}`}async function wc(){let e=window._secureGet(`toto_ai_key`);if(!e){Tc(null);return}document.getElementById(`modal-body`).innerHTML=`
    <div style="text-align:center;padding:48px 16px">
      <div style="font-size:32px;margin-bottom:12px">🤖</div>
      <div style="font-weight:600;margin-bottom:6px">Categorising ${vc.length} transactions…</div>
...
`),n=vc.some(e=>e.bankCat),r,i;if(window._csvSuggestions={},n){let e={};vc.forEach((t,n)=>{let r=t.bankCat||`Other`;e[r]||(e[r]={bankCat:r,indices:[],sample:t.description}),e[r].indices.push(n)});let t=Object.values(e);r=t.map((e,t)=>({idx:t,bankCategory:e.bankCat,sample:e.sample})),i=e=>{let n={};return e.forEach(e=>{let r=t[e.idx];r&&r.indices.forEach(t=>{n[t]=e.expenseId,e.suggest&&(_csvSuggestions[t]=e.suggest)})}),n}}else{let e={};vc.forEach((t,n)=>{let r=t.description.toUpperCase().replace(/\s+/g,` `).trim();e[r]||(e[r]={desc:t.description,indices:[]}),e[r].indices.push(n)});let t=Object.values(e);r=t.map((e,t)=>({idx:t,description:e.desc})),i=e=>{let n={};return e.forEach(e=>{let r=t[e.idx];r&&r.indices.forEach(t=>{n[t]=e.expenseId,e.suggest&&(_csvSuggestions[t]=e.suggest)})}),n}}let a=n?`bank categories`:`unique transaction descriptions`,o=`You are categorising Australian bank transactions for a family budget app.

The user's EXISTING budget expense categories (id: name):
${t||`(none yet)`}

Here are ${r.length} ${a} from their bank statement (${vc.length} total transactions):
${JSON.stringify(r)}
...
[{"idx":0,"expenseId":3},{"idx":1,"expenseId":-1,"suggest":"Dining Out"},{"idx":2,"expenseId":-1}]`;try{let t=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":e,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:4096,messages:[{role:`user`,content:o}]})});if(!t.ok)throw Error(`API error ${t.status}`);let n=(await t.json()).content[0].text.replace(/```[\w]*\n?/g,``).trim().match(/\[[\s\S]*\]/);if(!n)throw Error(`No JSON in response`);let r=JSON.parse(n[0]);Tc(i(r))}catch(e){document.getElementById(`modal-body`).innerHTML=`
      ...
      <button class="btn" onclick="window.closeModal()">Cancel</button>
      <button class="btn btn-primary" onclick="_renderCsvReview(null)" style="margin-left:8px">Assign Manually →</button>`}}function Tc(e){let t=window.getMonthData(window.selectedBudgetMonth).expenses,n=vc.some(e=>e.bankCat),r=vc.map((t,n)=>({...t,idx:n,expenseId:e?e[n]??-1:-1})),i={};r.forEach(e=>{let t=n?e.bankCat||`Other`:String(e.expenseId);i[t]||(i[t]={key:t,txns:[],total:0}),i[t].txns.push(e),i[t].total+=e.amount});let a={},o=-100,s=window._csvSuggestions||{};yc=Object.values(i).map((t,r)=>{let i=-1,c=``;if(e){let e={};t.txns.forEach(t=>{let n=t.expenseId;n!=null&&n!==-1&&(e[n]=(e[n]||0)+1)});let n=Object.entries(e).sort((e,t)=>t[1]-e[1])[0];if(n&&(i=parseInt(n[0])),i===-1){let e={};t.txns.forEach(t=>{let n=s[t.idx];n&&(e[n]=(e[n]||0)+1)});let n=Object.entries(e).sort((e,t)=>t[1]-e[1])[0];n&&(c=n[0],a[c]||(a[c]=o--),i=a[c])}}return{gIdx:r,expenseId:i,suggest:c,total:Math.round(t.total*100)/100,count:t.txns.length,txns:t.txns,descs:[...new Set(t.txns.map(e=>e.description))].slice(0,4),label:n?t.key:null,checked:i!==-1}}).sort((e,t)=>t.total-e.total),window._csvSuggestNames={},Object.entries(a).forEach(([e,t])=>{window._csvSuggestNames[t]=e});function c(e,n){let r=`<option value="-1"${e===-1?` selected`:``}>— Skip —</option>`;return Object.entries(a).forEach(([t,n])=>{r+=`<option value="${n}"${e===n?` selected`:``}>➕ Create: ${T(t)}</option>`}),r+=t.map(t=>`<option value="${t.id}"${t.id===e?` selected`:``}>${T(t.name)}</option>`).join(``),r}let l=yc.map((e,t)=>{let n=e.descs.join(`, `)+(e.count>e.descs.length?` +${e.count-e.descs.length} more`:``),r=e.label?`<div style="font-size:11px;font-weight:600;color:var(--primary);margin-bottom:2px">${T(e.label)}</div>`:``;return`<tr>
      ...
      <td style="font-size:11px;color:var(--text-muted);max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap" title="${escAttr(n)}">${T(n)}</td>
      <td class="amount" style="white-space:nowrap;font-weight:600">${ne(e.total)}</td>
    </tr>`}).join(``),u=e?`<div style="font-size:12px;color:var(--text-muted);margin-bottom:10px">🤖 Transactions grouped by category — review and adjust as needed.</div>`:``,d=yc.filter(e=>e.checked&&e.expenseId!==-1).length,f=yc.filter(e=>e.checked&&e.expenseId!==-1).reduce((e,t)=>e+t.count,0);document.getElementById(`modal-body`).innerHTML=`
    <div>
      ${u}
    ...
    </div>`;let p=yc.filter(e=>e.checked&&e.expenseId===-1).length;document.getElementById(`modal-footer`).innerHTML=`
    ...
    </div>`}function Ec(e,t){yc[e].checked=t,kc()}function Dc(e){yc.forEach((t,n)=>{t.checked=e;let r=document.getElementById(`csv-chk-${n}`);r&&(r.checked=e)}),kc()}function Oc(e,t){yc[e].expenseId=t,yc[e].checked=!0;let n=document.getElementById(`csv-chk-${e}`);n&&(n.checked=!0),kc()}function kc(){let e=yc.filter(e=>e.checked&&e.expenseId!==-1),t=yc.filter(e=>e.checked&&e.expenseId===-1),n=e.length,r=e.reduce((e,t)=>e+t.count,0),i=document.getElementById(`csv-apply-btn`);i&&(i.textContent=`Apply ${n} group${n===1?``:`s`} (${r} txns)`,i.disabled=n===0);let a=document.getElementById(`csv-pending-note`);a&&(a.textContent=t.length>0?`${t.length} checked group${t.length===1?``:`s`} still need a category assigned`:``)}function Ac(){let e=yc.filter(e=>e.checked&&e.expenseId!==-1);if(!e.length){window.closeModal();return}g.budget.actuals[window.selectedBudgetMonth]||(g.budget.actuals[window.selectedBudgetMonth]={});let t=window._csvSuggestNames||{},n={};e.forEach(e=>{let r=e.expenseId;if(r<-1&&t[r]){if(!n[r]){let e={id:nextId(g.budget.expenses),name:t[r],amount:0,frequency:`monthly`,category:t[r],dueDate:``,vendor:null};if(g.budget.expenses.push(e),window.isMonthCustomized(window.selectedBudgetMonth)){let t=g.budget.months[window.selectedBudgetMonth];t.expenses.push({...e,id:nextId(t.expenses)}),n[r]=t.expenses[t.expenses.length-1].id}else n[r]=e.id}r=n[r]}let i=window.getActualEntries(r,window.selectedBudgetMonth),a=i.length?Math.max(...i.map(e=>e.id))+1:1,o=e.descs.join(`, `)+(e.count>e.descs.length?` +${e.count-e.descs.length} more`:``);i.push({id:a,amount:e.total,date:e.txns[0].date,note:`${e.count} transactions: ${o}`}),g.budget.actuals[window.selectedBudgetMonth][r]=i}),window.saveData(g),window.closeModal(),window.renderAll()}var jc=null,H=``;function Mc(){Pc(),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>document.getElementById(`qa-sheet`).classList.add(`open`))}function Nc(){document.getElementById(`qa-sheet`).classList.remove(`open`),document.getElementById(`qa-overlay`).classList.remove(`open`)}function Pc(){document.getElementById(`qa-sheet`).innerHTML=`
    ...
    <div style="height:max(12px,env(safe-area-inset-bottom))"></div>`,requestAnimationFrame(()=>document.getElementById(`qah-text`)?.focus())}function Fc(e){Nc(),setTimeout(()=>{if(e===`event`)activateTab(`planner`),setTimeout(()=>openPlannerModal(null,new Date().toISOString().slice(0,10)),300);else if(e===`expense`){let e=window.getMonthData(window.selectedBudgetMonth).expenses,t=parseInt(window._secureGet(`toto_qa_last`)||`0`);jc=e.find(e=>e.id===t)?.id??e[0]?.id??null,H=``,Rc(e),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>document.getElementById(`qa-sheet`).classList.add(`open`))}else e===`income`?(activateTab(`budget`),setTimeout(()=>openAddIncome(),300)):e===`bill`?(activateTab(`bills`),setTimeout(()=>openBillModal(),300)):e===`chore`?(activateTab(`kids`),setTimeout(()=>{typeof renderChoreMgmt==`function`&&renderChoreMgmt()},300)):e===`shopping`?(window._listsActiveType=`food`,window._listsView=`list`,activateTab(`lists`)):e===`ai`&&typeof toggleTotoAssistant==`function`&&toggleTotoAssistant()},320)}async function Ic(){let e=document.getElementById(`qah-text`)?.value.trim();if(!e){Fc(`ai`);return}let t=document.querySelector(`.qah-ai-send`);t&&(t.textContent=`…`,t.disabled=!0);let n=`Today is ${new Date().toISOString().slice(0,10)}. The user typed: "${e}"
...
- If genuinely unclear → unknown`;try{let t=g.settings?.claudeApiKey,r=(await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:150,messages:[{role:`user`,content:n}]})})).json()).content?.[0]?.text?.trim()||`{"type":"unknown"}`,i=JSON.parse(r.replace(/```[\w]*\n?/g,``).trim());Nc(),await Lc(i,e)}catch{Nc(),setTimeout(()=>{typeof toggleTotoAssistant==`function`&&toggleTotoAssistant(),setTimeout(()=>{let t=document.getElementById(`toto-input`)||document.querySelector(`.toto-msg-input`);t&&(t.value=e,t.focus())},400)},320)}}async function Lc(e,t){let n=e=>new Promise(t=>setTimeout(t,e));if(e.type===`event`){activateTab(`planner`),await n(320),openPlannerModal(null,e.date||new Date().toISOString().slice(0,10)),await n(200);let r=document.getElementById(`pe-title`),i=document.getElementById(`pe-time`);if(r&&(r.value=e.title||t),i&&e.time&&(i.value=e.time),e.date){let t=document.getElementById(`pe-date`),n=document.getElementById(`pm-start-display`);t&&(t.value=e.date),n&&typeof _pmFmtDateShort==`function`&&(n.textContent=_pmFmtDateShort(e.date))}}else if(e.type===`expense`){let t=window.getMonthData(window.selectedBudgetMonth).expenses,n=parseInt(window._secureGet(`toto_qa_last`)||`0`);jc=t.find(e=>e.id===n)?.id??t[0]?.id??null,H=e.amount?String(e.amount):``,Rc(t),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>{document.getElementById(`qa-sheet`).classList.add(`open`);let t=document.getElementById(`qa-note`);t&&e.note&&(t.value=e.note)})}else if(e.type===`income`){activateTab(`budget`),await n(320),openAddIncome(),await n(200);let t=document.getElementById(`inc-name`)||document.querySelector(`#modal-body [id*="name"]`),r=document.getElementById(`inc-amount`)||document.querySelector(`#modal-body [id*="amount"]`);t&&e.name&&(t.value=e.name),r&&e.amount&&(r.value=e.amount)}else if(e.type===`bill`){activateTab(`bills`),await n(320),openBillModal(),await n(200);let t=document.getElementById(`bill-name`),r=document.getElementById(`bill-amount`),i=document.getElementById(`bill-due`);t&&e.name&&(t.value=e.name),r&&e.amount&&(r.value=e.amount),i&&e.dueDate&&(i.value=e.dueDate)}else if(e.type===`chore`)activateTab(`kids`),await n(320);else if(e.type===`shopping`){window._listsActiveType=`food`,window._listsView=`list`,activateTab(`lists`),await n(320);let t=document.getElementById(`ls-quick-input`);t&&e.name&&(t.value=e.name,t.focus())}else{typeof toggleTotoAssistant==`function`&&toggleTotoAssistant(),await n(400);let e=document.getElementById(`toto-input`)||document.querySelector(`.toto-msg-input`);e&&(e.value=t,e.focus())}}function Rc(e){let t=e||window.getMonthData(window.selectedBudgetMonth).expenses,n=H?`$${H}`:`$0`,r=!H,i=t.length?`<select class="form-select" style="width:100%" onchange="_qaSelectCat(this.value)">
    ...
    <div style="padding:0 20px 12px">${i}</div>
    ...
    </div>`}function zc(e){if(e===`⌫`)H=H.slice(0,-1);else if(e===`.`)H.includes(`.`)||(H+=(H?``:`0`)+`.`);else{let t=H.split(`.`);if(t[1]!==void 0&&t[1].length>=2||H.replace(`.`,``).length>=6)return;H===`0`&&e!==`.`?H=e:H+=e}let t=document.getElementById(`qa-display`);if(!t)return;let n=!H;t.textContent=H?`$${H}`:`$0`,t.className=`qa-amount-display${n?` zero`:``}`}function Bc(e){jc=e}function Vc(){let e=parseFloat(H);if(!e||e<=0){let e=document.getElementById(`qa-display`);e&&(e.style.color=`var(--danger)`,setTimeout(()=>e.style.color=``,600));return}if(!jc){let e=document.getElementById(`qa-cats`);e&&(e.style.outline=`2px solid var(--danger)`,e.style.borderRadius=`8px`,setTimeout(()=>{e.style.outline=``},600));return}let t=document.getElementById(`qa-note`)?.value.trim()||``,n=new Date().toISOString().slice(0,10);g.budget.actuals[window.selectedBudgetMonth]||(g.budget.actuals[window.selectedBudgetMonth]={});let r=window.getActualEntries(jc,window.selectedBudgetMonth),i=r.length?Math.max(...r.map(e=>e.id))+1:1;r.push({id:i,amount:e,date:n,note:t}),g.budget.actuals[window.selectedBudgetMonth][jc]=r,window._secureSet(`toto_qa_last`,String(jc)),window.saveData(g),Nc(),window.renderAll();let a=document.getElementById(`qa-fab`);a&&(a.textContent=`✓`,a.style.background=`#10b981`,setTimeout(()=>{a.textContent=`+`,a.style.background=``},1800))}window.addEventListener(`resize`,()=>{document.querySelectorAll(`.section-pills-wrap`).forEach(_updatePillsOverflow)}),document.querySelectorAll(`.nav-item, .nav-text-item`).forEach(e=>{e.addEventListener(`click`,()=>activateTab(e.dataset.tab))});function Hc(){let e=window._activeProfile?.role===`child`;document.body.classList.toggle(`kid-mode`,e);let t=document.getElementById(`kid-banner-label`);t&&e&&(t.textContent=`${window._activeProfile.emoji||`😊`} ${window._activeProfile.name}'s view`);let n=window.getDeviceProfile(),r=document.getElementById(`header-switch-profile`);if(r){let t=n&&n!==`adult`;if(r.style.display=t?``:`none`,t)if(e)r.textContent=`👨‍👩‍👧 Parent`;else{let e=(g.kids?.profiles||[]).find(e=>e.id===n);r.textContent=e?`Back to ${e.name}`:`Switch`}}}function Uc(){let e=window.getDeviceProfile();if(window._activeProfile?.role===`child`)window.clearKidSession(),window._activeProfile=null,Hc(),window.renderAll();else if(e===`shared`)window.showProfileSelector();else if(e&&e!==`adult`){let t=(g.kids?.profiles||[]).find(t=>t.id===e);t&&(t.pinHash?(window._pinTargetId=t.id,window._pinBuffer=``,window._pinAttempts=0,window._showPinScreen(t)):(window._activeProfile={id:t.id,name:t.name,emoji:t.emoji,role:`child`},window.setKidSession(t.id),window._applyActiveProfile()))}}async function Wc(e,t){let n=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));!n||t.length!==4||(n.pinHash=await window._hashPin(t,window._getHouseholdOwnerUID()),window.saveData(g))}function Gc(e){let t=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(delete t.pinHash,window.saveData(g))}function Kc(e){(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[e]&&(Jc=e,Xc=``,Zc=``,Yc=`enter`,Qc(),document.getElementById(`adult-pin-modal`).classList.remove(`hidden`))}function qc(e){let t=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name);t[e]&&(delete t[e].pinHash,window.saveData(g),renderSettings())}var Jc=0,Yc=`enter`,Xc=``,Zc=``;function Qc(){let e=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[Jc];if(!e)return;let t=Yc===`enter`,n=t?e.pinHash?`Change your PIN 🔢`:`Set your PIN 🔢`:`Confirm your PIN ✅`,r=t?`Pick 4 numbers — used on shared devices`:`Enter it again to confirm`,i=[0,1,2,3].map(e=>{let t=e<Zc.length;return`<div style="width:52px;height:60px;border:2px solid ${t?`#0891b2`:`#e2e8f0`};border-radius:10px;background:${t?`#ecfeff`:`#f8fafc`};display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:700;color:#0891b2">${t?`●`:``}</div>`}).join(``),a=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div></div>`:`<div onclick="_adultPinKey('${e}')" style="height:52px;border:1.5px solid #e2e8f0;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:600;color:#374151;cursor:pointer;background:#fff;-webkit-tap-highlight-color:transparent;user-select:none">${e}</div>`).join(``);document.getElementById(`adult-pin-modal-body`).innerHTML=`
    ...
    <button onclick="document.getElementById('adult-pin-modal').classList.add('hidden')" style="font-size:13px;color:#94a3b8;background:none;border:none;cursor:pointer">Cancel</button>`}function $c(e){if(e===`⌫`){Zc=Zc.slice(0,-1),Qc();return}Zc.length>=4||(Zc+=e,Qc(),Zc.length===4&&el())}async function el(){if(Yc===`enter`)Xc=Zc,Zc=``,Yc=`confirm`,Qc();else{if(Zc!==Xc){Zc=``,Xc=``,Yc=`enter`,Qc();let e=document.getElementById(`adult-pin-error`);e&&(e.textContent=`Those didn't match — try again`);return}let e=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name);e[Jc].pinHash=await window._hashPin(Zc,window._getHouseholdOwnerUID()),window.saveData(g),document.getElementById(`adult-pin-modal`).classList.add(`hidden`),renderSettings()}}function tl(e){let t=Number(e.age||0);return t<5?`tiny-tots`:t<8?`early-reader`:t<12?`independent`:`tween`}function nl(){let e=new Date().getHours();return e<12?`Good morning`:e<17?`Good afternoon`:`Good evening`}function rl(e){if(!e.triggerTime)return!0;let[t,n]=e.triggerTime.split(`:`).map(Number),r=new Date,i=r.getHours()*60+r.getMinutes(),a=t*60+(n||0),o=a+360;return i>=a&&i<o}function il(e){if(!e.triggerTime)return``;let[t]=e.triggerTime.split(`:`).map(Number);return t<12?`Available this morning`:t<17?`Available this afternoon`:`Available tonight`}function al(){let e=document.getElementById(`child-view-overlay`);if(!e)return;let t=document.getElementById(`cv-confetti-wrap`);t&&t.remove(),t=document.createElement(`div`),t.id=`cv-confetti-wrap`,t.className=`cv2-confetti-wrap`,e.appendChild(t);let n=[`#5B4CF5`,`#7C3AED`,`#F59E0B`,`#10B981`,`#F43F5E`,`#FBBF24`];for(let e=0;e<60;e++){let r=document.createElement(`div`);r.className=`cv2-confetti-particle`,r.style.cssText=`
    ...
    `,t.appendChild(r)}setTimeout(()=>{t.parentNode&&t.remove()},3500)}function ol(e){let t=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));if(!t)return;ll=e,ul=`today`;let n=g.kids,r=kidBalance(n,t.id),i=tl(t),a=i===`tiny-tots`,o=i===`tween`,s=_cvReadOnly,c=document.getElementById(`child-view-overlay`);document.getElementById(`cv-avatar`).textContent=t.emoji||`😊`,document.getElementById(`cv-name`).innerHTML=`<span class="ember-text">${T(t.name)}</span>`,document.getElementById(`cv-greeting`).textContent=nl()+`!`;let l=(n.completions||[]).filter(e=>e.kidId===t.id&&e.status===`approved`&&new Date(e.completedAt||e.ts).toDateString()===new Date().toDateString()).reduce((e,t)=>e+((n.chores||[]).find(e=>e.id===t.choreId)?.points||0),0),u=document.getElementById(`cv-nudge`);l>0&&!a&&!s?(u.textContent=`You've earned ⭐ ${l} points today — keep going!`,u.style.display=``):u.style.display=`none`,c.className=c.className.replace(/cv2-age-\S+/g,``).trim(),i===`early-reader`&&c.classList.add(`cv2-age-early`),a&&c.classList.add(`cv2-age-tiny`),o&&c.classList.add(`cv2-age-tween`);let d=document.getElementById(`cv-nav`);d&&(d.style.display=a?`none`:``),document.getElementById(`cv-nav-today`)?.classList.add(`active`),document.getElementById(`cv-nav-calendar`)?.classList.remove(`active`),document.getElementById(`cv-nav-prizes`)?.classList.remove(`active`),sl(t);let f=new Date().toISOString().slice(0,10),p=(g.routineAssignments||[]).filter(e=>{if(e.childId!==t.id)return!1;let n=(g.routines||[]).find(t=>t.id===e.routineId);return n&&_routineMatchesDate(n,f)}),m=_routineTodayKey(),h=``,_=0,v=0;p.length&&p.forEach(e=>{let n=(g.routines||[]).find(t=>t.id===e.routineId);if(!n)return;let r=e.completionState?.[m]||[],i=n.steps.length,o=i>0?Math.round(r.length/i*100):0,c=r.length===i&&i>0,l=rl(n);v+=i,_+=r.length;let u=l?``:il(n),d=_assignmentStreak(e,i),f=_assignmentHistory(e,i,7).filter(e=>e.done===e.total&&e.total>0).length;if(h+=`<div class="cv2-card${l?``:` cv2-card--locked`}" style="margin-bottom:10px">
        <div class="cv2-routine-header">
          ...
          ${l?`<span class="cv2-routine-frac">${r.length}/${i}${n.pointsPerCompletion>0?` · ⭐${n.pointsPerCompletion}`:``}</span>`:`<span class="cv2-routine-lock">🔒 ${T(u)}</span>`}
        </div>
      ...
      </div>`});let S=_mealWeekKey(0),C=new Date().getDay()===0?6:new Date().getDay()-1,w=g.meals?.lunchbox?.plans?.[S]||{},E=w[w[t.id]===void 0?(g.meals?.lunchbox?.profiles||[]).find(e=>e.name?.toLowerCase()===t.name?.toLowerCase())?.id??t.id:t.id]?.[C]||{},ee=[`main`,`snack`,`fruit`,`drink`],te=ee.map(e=>E[e]).filter(Boolean),D={main:`🥪`,snack:`🍪`,fruit:`🍎`,drink:`🥤`},ne=``;if(te.length){let e=``;ee.forEach(t=>{E[t]&&(e+=`<div class="cv2-lb-chip">${D[t]}${a?``:` `+T(E[t])}</div>`)}),ne=`<div class="cv2-group">
      <div class="cv2-group-heading">🥪 Lunchbox</div>
      <div class="cv2-card cv2-card--warm">
        <div class="cv2-lb-chips">${e}</div>
      </div>
    </div>`}let{events:O}=hl(t,f),k=[...O].sort((e,t)=>(e.time||`99:99`).localeCompare(t.time||`99:99`)),re=``;k.length&&!a&&(re=`<div class="cv2-group">
      <div class="cv2-group-heading">📅 Today's Events</div>
      <div class="cv2-card">${k.map(e=>`
      <div class="cv2-event-row">
        <span class="cv2-event-time">${e.time?gl(e.time):``}</span>
        <div class="cv2-event-bar"></div>
        <span class="cv2-event-emoji">${e.emoji}</span>
        <div class="cv2-event-body">
          <div class="cv2-event-title">${T(e.label)}</div>
          ${e.notes?`<div class="cv2-event-sub">${T(e.notes)}</div>`:``}
        </div>
      </div>`).join(``)}</div>
    </div>`);let ie=(n.prizes||[]).filter(e=>r>=e.pointCost),ae=``;if(!a){let e=ie.length?`<div style="display:flex;align-items:center;gap:10px;padding:14px 15px">
          <span style="font-size:28px">${ie[0].emoji||`🎁`}</span>
          <div style="flex:1">
            <div style="font-size:13px;font-weight:700;color:#18181B">You can afford ${ie.length} prize${ie.length>1?`s`:``}!</div>
    ...
    </div>`}let A=(n.notifications||[]).filter(e=>e.kidId===t.id&&!e.read),oe=``;A.length&&!s&&(oe=A.map(e=>{let n=e.type===`prize_approved`;return`<div class="cv2-notif-bar ${n?`cv2-notif-bar--approved`:`cv2-notif-bar--declined`}">
        <span>${n?`${e.prizeEmoji} <strong>${T(e.prizeName)}</strong> approved! You can redeem it now.`:`${e.prizeEmoji} <strong>${T(e.prizeName)}</strong> request was declined.`}</span>
        <button class="cv2-notif-dismiss" onclick="_cvDismissNotif('${e.id}','${t.id}')">×</button>
      </div>`}).join(``));let j=v>0&&_===v,M;j&&!s?M=`<div class="cv2-celebration">
      <div class="cv2-celeb-emoji">${a?`🌟`:`🏆`}</div>
      <div class="cv2-celeb-title">${a?`🎉 Yay!`:`Amazing work, ${T(t.name)}!`}</div>
      <div class="cv2-celeb-sub">${a?`All done! You're a star!`:`You've finished everything for today. You're a superstar! ⭐`}</div>
    </div>
    ${re}${ne}${ae}`:(M=oe,i!==`tiny-tots`&&!s&&(M+=`<button class="cv2-week-shortcut" onclick="_cvSwitchTab('calendar','${t.id}')">📅 See my week →</button>`),p.length&&(M+=`<div class="cv2-group">
        <div class="cv2-group-heading">📋 My Routines</div>
        ${h}
      </div>`),y.length&&(M+=`<div class="cv2-group">
        <div class="cv2-group-heading">🧹 Chores</div>
        <div class="cv2-card">${x}</div>
      </div>`),M+=re,M+=ne,M+=ae),document.getElementById(`cv-content`).innerHTML=M,c.classList.remove(`hidden`),c.style.display=`flex`,j&&!s&&al()}function sl(e){let t=document.getElementById(`cv-prizes-badge`);if(!t)return;let n=g.kids,r=kidBalance(n,e.id),i=(n.notifications||[]).filter(t=>t.kidId===e.id&&!t.read).length,a=(n.prizes||[]).filter(e=>r>=e.pointCost).length,o=i+(a>0&&i===0?a:0);o>0?(t.textContent=o>9?`9+`:String(o),t.style.display=``):t.style.display=`none`}function cl(e){let t=g.kids,n=kidBalance(t,e.id),r=tl(e)===`tiny-tots`,i=_cvReadOnly,a=t.prizes||[],o=!1;(t.notifications||[]).filter(t=>t.kidId===e.id&&!t.read).forEach(e=>{e.read=!0,o=!0}),o&&window.saveData(g),sl(e);let s=r?`${`⭐`.repeat(Math.min(n,10))}${n>10?`+`:``}`:`${n}`,c=`<div class="cv2-prizes-balance">
    ...
    <span class="cv2-prizes-balance-emoji">🏆</span>
        ...
        <div class="cv2-prize-info">
          <div class="cv2-prize-name">${T(t.name)}</div>
        ...
        <div style="flex:1;min-width:0">
          <div style="font-size:13px;font-weight:600;color:#18181B">${T(t.name)}</div>
      ...
      </div>`}),c+=`</div>`);let u=document.getElementById(`cv-content`);u&&(u.innerHTML=c)}var ll=null,ul=`today`,dl=`7day`,fl=null,pl=new Set;function ml(e,t){t&&(ll=t);let n=(g.kids?.profiles||[]).find(e=>String(e.id)===String(ll));if(!n)return;let r=tl(n),i=document.getElementById(`cv-nav`);i&&(i.style.display=r===`tiny-tots`?`none`:``),document.getElementById(`cv-nav-today`)?.classList.toggle(`active`,e===`today`),document.getElementById(`cv-nav-calendar`)?.classList.toggle(`active`,e===`calendar`),document.getElementById(`cv-nav-prizes`)?.classList.toggle(`active`,e===`prizes`),e===`today`?ol(ll):e===`prizes`?cl(n):(fl=null,Sl(n))}function hl(e,t){let n=(g.routineAssignments||[]).filter(t=>t.childId===e.id).map(e=>{let n=(g.routines||[]).find(t=>t.id===e.routineId);return n&&_routineMatchesDate(n,t)?{type:`routine`,routine:n,assignment:e,label:n.name,emoji:n.emoji,color:`#7C3AED`,tag:`Routine`,time:n.triggerTime||null}:null}).filter(Boolean),r=(g.childEvents||[]).filter(n=>{let r=Array.isArray(n.assignedTo)?n.assignedTo:[n.assignedTo];return r.includes(e.id)||r.includes(`all`)||n.isHouseholdWide?n.recurrence?Pt(n.recurrence,t):n.date===t:!1}).map(e=>({type:`event`,label:e.title,emoji:e.emoji||`📅`,color:`#10b981`,tag:`Event`,notes:e.notes,time:e.time||null})),i=(g.planner?.events||[]).filter(e=>Kt(e).includes(`everyone`)?e.recurrence&&e.recurrence.type!==`one_time`?Pt(e.recurrence,t):e.endDate&&e.endDate>e.date?t>=e.date&&t<=e.endDate:e.date===t:!1).map(e=>({type:`event`,label:e.title,emoji:F[e.category]?.emoji||`📅`,color:`#10b981`,tag:`Event`,notes:e.notes||``,time:e.time||null}));return{routines:n,events:[...r,...i],chores:(g.kids?.chores||[]).filter(t=>(t.assignedTo===e.id||t.assignedTo===`all`)&&!t._isRoutine).map(e=>({type:`chore`,label:e.name,emoji:e.emoji||`📋`,color:`#ec4899`,tag:`Chore`,time:null}))}}function gl(e){if(!e)return``;let[t,n]=e.split(`:`).map(Number);return`${t%12||12}:${String(n).padStart(2,`0`)} ${t>=12?`pm`:`am`}`}function _l(e){pl.has(e)?pl.delete(e):pl.add(e);let t=(g.kids?.profiles||[]).find(e=>String(e.id)===String(ll));t&&(dl===`7day`||tl(t)===`early-reader`?yl(t,new Date().toISOString().slice(0,10)):yl(t,fl))}function vl(e,t,n){if(_cvReadOnly)return;let r=_routineGetAssignment(e,ll);if(!r)return;r.completionState||(r.completionState={});let i=n;r.completionState[i]||(r.completionState[i]=[]);let a=r.completionState[i].indexOf(t),o=a===-1;o?r.completionState[i].push(t):r.completionState[i].splice(a,1);let s=new Date().toISOString().slice(0,10);if(o&&n===s){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(n){let e=n.steps.find(e=>e.id===t);(e?.points||0)>0&&_routineAwardStepPoints(n,e,ll);let a=n.steps.length;r.completionState[i].length===a&&a>0&&(n.pointsPerCompletion||0)>0&&_routineAwardPoints(n,ll)}}window.saveData(g);let c=(g.kids?.profiles||[]).find(e=>String(e.id)===String(ll));c&&yl(c,n)}function yl(e,t){let n=dl===`month`?`cv-day-panel`:`cv-schedule-panel`,r=document.getElementById(n);r&&(r.innerHTML=bl(e,t))}function bl(e,t){if(!t)return``;let{routines:n,events:r,chores:i}=hl(e,t),a=t;if(!n.length&&!r.length&&!i.length)return`<div style="text-align:center;padding:28px 0;color:#A1A1AA;font-size:13px">Nothing scheduled</div>`;let o=[...n.map(e=>({...e,sortKey:e.time||`23:59`})),...r.map(e=>({...e,sortKey:e.time||`23:59`}))].sort((e,t)=>e.sortKey.localeCompare(t.sortKey)),s=``;return o.length&&(s+=`<div class="cv-sched-section-hdr">Schedule</div>`,o.forEach(e=>{e.type===`routine`?s+=xl(e.routine,e.assignment,a):s+=`<div class="cv-sched-item">
          <div class="cv-sched-row">
            <span class="cv-sched-time">${e.time?gl(e.time):``}</span>
            <div class="cv-sched-color-bar" style="background:${e.color}"></div>
            <span class="cv-sched-emoji">${e.emoji}</span>
            <div class="cv-sched-body">
              <div class="cv-sched-title">${T(e.label)}</div>
              ${e.notes?`<div class="cv-sched-sub">${T(e.notes)}</div>`:``}
            </div>
        ...
        <div class="cv-sched-row">
          ...
          <div class="cv-sched-body">
            <div class="cv-sched-title">${T(t.label)}</div>
          </div>
      ...
      </div>`})),s}function xl(e,t,n){let r=t.completionState?.[n]||[],i=e.steps.length,a=i>0?Math.round(r.length/i*100):0,o=r.length===i&&i>0,s=pl.has(e.id),c=i>0?`
    <div class="cv-sched-progress">
      ...
      <span style="font-size:11px;color:#94a3b8;font-weight:600">${r.length}/${i}</span>
        ...
        <span class="cv-sched-step-label${i?` cv-sched-step-label--done`:``}">${T(t.label)}</span>
    ...
    <div class="cv-sched-row" style="cursor:pointer" onclick="_cvToggleRoutineExpand(${JSON.stringify(e.id)})">
      <span class="cv-sched-time">${e.triggerTime?gl(e.triggerTime):``}</span>
      <div class="cv-sched-color-bar" style="background:#7C3AED"></div>
      <span class="cv-sched-emoji">${e.emoji}</span>
      <div class="cv-sched-body">
        <div class="cv-sched-title">${T(e.name)}</div>
        ${o?`<div class="cv-sched-sub" style="color:#5B4CF5;font-weight:700">✓ Complete</div>`:e.triggerTime?`<div class="cv-sched-sub">${gl(e.triggerTime)}</div>`:``}
      </div>
      ${c}
      <button class="cv-sched-expand-btn">${s?`▲`:`▼`}</button>
    </div>
    ${l}
  </div>`}function Sl(e){if(!e)return;let t=tl(e)===`early-reader`,n=t?`7day`:dl,r=new Date().toISOString().slice(0,10),i=document.getElementById(`cv-content`);if(!i)return;let a=``;t||(a+=`<div style="display:flex;gap:8px;margin-bottom:14px">
    ...
    </div>`),a+=n===`7day`?wl(e,r):El(e,r),i.innerHTML=a}function Cl(e,t){dl=e,fl=null;let n=(g.kids?.profiles||[]).find(e=>String(e.id)===String(t));n&&Sl(n)}function wl(e,t){let n=[`S`,`M`,`T`,`W`,`T`,`F`,`S`],r=new Date(t+`T12:00:00`),i=`<div class="cv-week-strip">`;for(let a=0;a<7;a++){let o=new Date(r);o.setDate(r.getDate()+a);let s=o.toISOString().slice(0,10),c=s===t,{routines:l,events:u,chores:d}=hl(e,s),f=[...l,...u,...d].slice(0,3).map(e=>`<div class="cv-cal-dot" style="background:${e.color}"></div>`).join(``);i+=`<div class="cv-week-cell ${c?`cv-today`:``}" onclick="_cvWeekDayTap('${s}','${e.id}')">
    ...
    </div>`}i+=`</div>`;let a=new Date(t+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`});return i+=`<div style="font-size:13px;font-weight:700;color:#1e293b;margin:10px 0 2px">${T(a)}</div>`,i+=`<div id="cv-schedule-panel">${bl(e,t)}</div>`,i}function Tl(e,t){let n=(g.kids?.profiles||[]).find(e=>String(e.id)===String(t));if(!n)return;pl.clear(),document.querySelectorAll(`.cv-week-cell`).forEach(t=>{t.classList.toggle(`cv-today`,t.getAttribute(`onclick`)?.includes(`'${e}'`))});let r=new Date(e+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`}),i=document.getElementById(`cv-schedule-panel`);i&&(i.previousElementSibling.textContent=r,i.innerHTML=bl(n,e))}function El(e,t){let n=new Date(t+`T12:00:00`),r=n.getFullYear(),i=n.getMonth(),a=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`],o=[`S`,`M`,`T`,`W`,`T`,`F`,`S`],s=new Date(r,i,1).getDay(),c=new Date(r,i+1,0).getDate(),l=fl||t,u=`<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
    <span style="font-size:14px;font-weight:800;color:#18181B">${a[i]} ${r}</span>
  </div>`;u+=`<div class="cv-cal-grid">`,o.forEach(e=>{u+=`<div class="cv-cal-day-hdr">${e}</div>`});for(let e=0;e<s;e++)u+=`<div class="cv-cal-cell cv-other"></div>`;for(let n=1;n<=c;n++){let a=`${r}-${String(i+1).padStart(2,`0`)}-${String(n).padStart(2,`0`)}`,o=a===t,s=a===l,{routines:c,events:d,chores:f}=hl(e,a),p=[...c,...d,...f].slice(0,3).map(e=>`<div class="cv-cal-dot" style="background:${e.color}"></div>`).join(``);u+=`<div class="cv-cal-cell ${o?`cv-today`:``} ${s&&!o?`cv-cal-cell--sel`:``}" onclick="_cvMonthDayTap('${a}','${e.id}')">
    ...
    <div class="cv-month-day-panel-title">${T(d)}</div>
    <div id="cv-day-panel">${bl(e,l)}</div>
  </div>`,u}function Dl(e,t){fl=e,pl.clear();let n=(g.kids?.profiles||[]).find(e=>String(e.id)===String(t));n&&Sl(n)}function Ol(e,t){Dl(e,t)}function kl(e,t){let n=(g.kids?.notifications||[]).find(t=>t.id===e);n&&(n.read=!0),window.saveData(g),ol(t)}function Al(e,t){let n=(g.kids?.prizes||[]).find(e=>String(e.id)===String(t));if(!n)return;let r=`<div class="cv2-confirm">
    <div class="cv2-confirm-emoji">${n.emoji||`🎁`}</div>
    <div class="cv2-confirm-title">${T(n.name)}</div>
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 0;border-bottom:1px solid var(--hairline-soft)">
    ...
    </div>`,e.style.display=`block`,t.style.display=`block`}function Fl(){document.getElementById(`dev-tools-overlay`).style.display=`none`,document.getElementById(`dev-tools-sheet`).style.display=`none`}function Il(){let e=new Date().toISOString().slice(0,7);new Date(new Date().setMonth(new Date().getMonth()-1)).toISOString().slice(0,7),g.budget.income=[{id:uid(),name:`Salary`,category:`Salary`,amount:8500,frequency:`monthly`},{id:uid(),name:`Freelance`,category:`Freelance / Contract`,amount:1200,frequency:`monthly`}],g.budget.expenses=[{id:uid(),name:`Mortgage`,category:`Mortgage / Rent`,amount:2800,frequency:`monthly`},{id:uid(),name:`Groceries`,category:`Groceries`,amount:900,frequency:`monthly`},{id:uid(),name:`Electricity`,category:`Utilities`,amount:220,frequency:`monthly`},{id:uid(),name:`Internet`,category:`Utilities`,amount:89,frequency:`monthly`},{id:uid(),name:`Car insurance`,category:`Insurance`,amount:180,frequency:`monthly`},{id:uid(),name:`Dining out`,category:`Dining Out`,amount:350,frequency:`monthly`},{id:uid(),name:`Netflix`,category:`Subscriptions`,amount:23,frequency:`monthly`},{id:uid(),name:`Spotify`,category:`Subscriptions`,amount:12,frequency:`monthly`},{id:uid(),name:`Gym`,category:`Health`,amount:75,frequency:`monthly`},{id:uid(),name:`Kids activities`,category:`Childcare / Education`,amount:280,frequency:`monthly`}];let t={};g.budget.expenses.forEach(e=>{t[e.id]=Math.round(parseFloat(e.amount)*(.4+Math.random()*.7))}),g.budget.actuals[e]=t;let n=e=>{let t=new Date;return t.setDate(t.getDate()+e),t.getDate()},r=e=>{let t=new Date;return t.setDate(t.getDate()+e),t.getMonth()+1};g.bills=[{id:uid(),name:`Electricity`,amount:180,dueDay:n(0),dueMonth:r(0),category:`Utilities`},{id:uid(),name:`Council rates`,amount:420,dueDay:n(1),dueMonth:r(1),category:`Other`},{id:uid(),name:`Phone plan`,amount:45,dueDay:n(2),dueMonth:r(2),category:`Utilities`},{id:uid(),name:`Water bill`,amount:185,dueDay:n(4),dueMonth:r(4),category:`Utilities`},{id:uid(),name:`Internet`,amount:89,dueDay:n(5),dueMonth:r(5),category:`Utilities`},{id:uid(),name:`Spotify`,amount:12,dueDay:n(6),dueMonth:r(6),category:`Subscriptions`},{id:uid(),name:`Home insurance`,amount:290,dueDay:n(14),dueMonth:r(14),category:`Insurance`}],g.goals=[{id:uid(),name:`Emergency fund`,type:`emergency`,targetAmount:25e3,currentAmount:11200,deadline:``},{id:uid(),name:`Europe holiday`,type:`holiday`,targetAmount:8e3,currentAmount:2400,deadline:`2026-12-01`},{id:uid(),name:`New car`,type:`vehicle`,targetAmount:35e3,currentAmount:7800,deadline:`2027-06-01`}],g.netWorth={assets:[{id:uid(),name:`Home`,category:`Property`,amount:85e4},{id:uid(),name:`Super`,category:`Super`,amount:142e3},{id:uid(),name:`Savings`,category:`Savings`,amount:28e3},{id:uid(),name:`Car`,category:`Vehicle`,amount:22e3}],liabilities:[{id:uid(),name:`Mortgage`,category:`Mortgage`,amount:52e4},{id:uid(),name:`Car loan`,category:`Loan`,amount:12e3}],snapshots:[],target:{amount:15e5,byYear:2040}},g.settings={...g.settings,adultName:`Robert Gentilcore`,householdName:`Gentilcore Family`},window.saveData(g),window.renderAll()}function Ll(){_routineTodayKey();let e=uid(),t=uid(),n=uid(),r=uid(),i=uid(),a=uid(),o=uid();g.kids={profiles:[{id:e,name:`Amy`,emoji:`🌸`,dob:`2015-03-14`,pinHash:null},{id:t,name:`Johnny`,emoji:`⚡`,dob:`2013-07-22`,pinHash:null}],chores:[{id:n,name:`Make bed`,emoji:`🛏️`,assignedTo:e,points:5,frequency:`Daily`},{id:r,name:`Tidy room`,emoji:`🧹`,assignedTo:e,points:10,frequency:`Daily`},{id:i,name:`Take out bins`,emoji:`🗑️`,assignedTo:t,points:15,frequency:`Weekly`}],prizes:[{id:a,name:`Extra screen time`,emoji:`📱`,pointCost:30},{id:o,name:`Movie night pick`,emoji:`🎬`,pointCost:50},{id:uid(),name:`Takeaway dinner choice`,emoji:`🍕`,pointCost:80}],completions:[{id:uid(),kidId:e,choreId:n,status:`approved`,ts:new Date().toISOString(),completedAt:new Date().toISOString()},{id:uid(),kidId:e,choreId:r,status:`pending`,ts:new Date().toISOString()},{id:uid(),kidId:t,choreId:i,status:`approved`,ts:new Date().toISOString(),completedAt:new Date().toISOString()}],redemptions:[{id:uid(),kidId:e,prizeId:a,status:`pending`,ts:new Date().toISOString()}],notifications:[],allowances:[]},g.childEvents=[{id:uid(),title:`Soccer training`,emoji:`⚽`,date:new Date().toISOString().slice(0,10),time:`17:00`,assignedTo:[t],isHouseholdWide:!1,createdBy:`dev`},{id:uid(),title:`Piano lesson`,emoji:`🎹`,date:new Date(Date.now()+864e5).toISOString().slice(0,10),time:`15:30`,assignedTo:[e],isHouseholdWide:!1,createdBy:`dev`},{id:uid(),title:`Family dinner`,emoji:`🍽️`,date:new Date(Date.now()+2*864e5).toISOString().slice(0,10),time:`19:00`,assignedTo:[],isHouseholdWide:!0,createdBy:`dev`}],window.saveData(g),window.renderAll()}function Rl(){let e=_routineTodayKey(),t=g.kids?.profiles?.[0],n=g.kids?.profiles?.[1],r=[{id:uid(),label:`Make bed`,emoji:`🛏️`,points:5,durationMin:2},{id:uid(),label:`Shower`,emoji:`🚿`,points:5,durationMin:10},{id:uid(),label:`Breakfast`,emoji:`🥣`,points:5,durationMin:15},{id:uid(),label:`Pack bag`,emoji:`🎒`,points:5,durationMin:5}],i=[{id:uid(),label:`Homework`,emoji:`📚`,points:10,durationMin:30},{id:uid(),label:`Tidy room`,emoji:`🧹`,points:5,durationMin:10},{id:uid(),label:`Brush teeth`,emoji:`🦷`,points:5,durationMin:3}],a=[{id:uid(),label:`Exercise`,emoji:`💪`,points:0,durationMin:30},{id:uid(),label:`Meditate`,emoji:`🧘`,points:0,durationMin:10},{id:uid(),label:`Plan the day`,emoji:`📋`,points:0,durationMin:5},{id:uid(),label:`Vitamins`,emoji:`💊`,points:0,durationMin:1}],o=[{id:uid(),label:`Tidy kitchen`,emoji:`🍽️`,points:0,durationMin:10},{id:uid(),label:`Review the day`,emoji:`🪞`,points:0,durationMin:5},{id:uid(),label:`Read`,emoji:`📖`,points:0,durationMin:20},{id:uid(),label:`Lights out`,emoji:`💤`,points:0,durationMin:0}],s=new Date().getHours(),c=window._currentUser?.uid||window.uid||window._routineCurrentUserId?.()||`guest`,l=uid(),u=uid(),d=uid(),f=uid(),p=[{id:l,name:`Morning`,emoji:`☀️`,ownerType:`adult`,ownerId:c,sharedWith:[],steps:a,pointsPerCompletion:0,triggerTime:`07:00`,recurrence:{type:`weekdays`,startDate:`2026-01-01`},skippedDates:[],pausePeriods:[],completions:{}},{id:u,name:`Evening`,emoji:`🌙`,ownerType:`adult`,ownerId:c,sharedWith:[],steps:o,pointsPerCompletion:0,triggerTime:`${String(s).padStart(2,`0`)}:00`,recurrence:{type:`daily`,startDate:`2026-01-01`},skippedDates:[],pausePeriods:[],completions:{}},{id:d,name:`Morning routine`,emoji:`🌤️`,ownerType:`household`,ownerId:`household`,sharedWith:[],steps:r,pointsPerCompletion:10,triggerTime:`07:30`,recurrence:{type:`weekdays`,startDate:`2026-01-01`},skippedDates:[],pausePeriods:[]},{id:f,name:`Evening routine`,emoji:`🌙`,ownerType:`household`,ownerId:`household`,sharedWith:[],steps:i,pointsPerCompletion:10,triggerTime:`${String(s).padStart(2,`0`)}:00`,recurrence:{type:`daily`,startDate:`2026-01-01`},skippedDates:[],pausePeriods:[]}];g.routines=[...(g.routines||[]).filter(e=>e.ownerType!==`adult`&&e.ownerType!==`household`),...p];let m=[];if(t){let n={id:uid(),routineId:d,childId:t.id,completionState:{}};n.completionState[e]=[r[0].id,r[1].id],m.push(n),m.push({id:uid(),routineId:f,childId:t.id,completionState:{}})}n&&(m.push({id:uid(),routineId:d,childId:n.id,completionState:{}}),m.push({id:uid(),routineId:f,childId:n.id,completionState:{}})),g.routineAssignments=[...g.routineAssignments||[],...m];let h=p[0];h.completions[e]=[a[0].id,a[1].id],window.saveData(g),window.renderAll()}function zl(){let e=new Date().toISOString().slice(0,10),t=new Date(Date.now()+864e5).toISOString().slice(0,10),n=new Date(Date.now()+3*864e5).toISOString().slice(0,10),r=new Date(Date.now()+5*864e5).toISOString().slice(0,10),i=new Date(Date.now()+7*864e5).toISOString().slice(0,10),a=Wt(),o=a[0]?.id||`everyone`,s=a[1]?.id||o;g.planner={events:[{id:uid(),title:`School drop-off`,category:`family`,date:e,time:`08:30`,memberIds:[o],allDay:!1,recurrence:{type:`weekdays`,startDate:`2026-01-01`}},{id:uid(),title:`Team standup`,category:`work`,date:e,time:`09:00`,memberIds:[o],allDay:!1},{id:uid(),title:`Dentist appointment`,category:`health`,date:e,time:`14:00`,memberIds:[o],allDay:!1},{id:uid(),title:`Dinner reservation`,category:`social`,date:e,time:`19:30`,memberIds:[`everyone`],allDay:!1},{id:uid(),title:`Parent–teacher night`,category:`family`,date:t,time:`18:00`,memberIds:[o,s],allDay:!1},{id:uid(),title:`Grocery run`,category:`family`,date:t,time:`10:00`,memberIds:[o],allDay:!1},{id:uid(),title:`Weekend hike`,category:`social`,date:n,time:`08:00`,memberIds:[`everyone`],allDay:!1},{id:uid(),title:`Car service`,category:`home`,date:r,time:`09:00`,memberIds:[o],allDay:!1},{id:uid(),title:`Amy's birthday`,category:`family`,date:i,allDay:!0,memberIds:[`everyone`]}]},window.saveData(g),window.renderAll()}function Bl(){new Date().toISOString().slice(0,10);let e=new Date(Date.now()+14*864e5).toISOString().slice(0,10),t=new Date(Date.now()+60*864e5).toISOString().slice(0,10),n=new Date(Date.now()-7*864e5).toISOString().slice(0,10),r=new Date(Date.now()-30*864e5).toISOString().slice(0,10),i=new Date(Date.now()-90*864e5).toISOString().slice(0,10);g.documents=[{id:uid(),name:`Passport — Robert`,provider:`DFAT`,expiryDate:e},{id:uid(),name:`Home insurance`,provider:`NRMA`,expiryDate:t},{id:uid(),name:`Working with children check`,provider:`Service NSW`,expiryDate:r},{id:uid(),name:`First aid certificate`,provider:`St John`,expiryDate:n}],g.vehicles=[{id:uid(),name:`Tesla Model 3`,make:`Tesla`,model:`Model 3`,plate:`ABC123`,regoExpiry:t,insurance:{provider:`NRMA`,renewalDate:t}},{id:uid(),name:`Toyota RAV4`,make:`Toyota`,model:`RAV4`,plate:`XYZ789`,regoExpiry:n,insurance:{provider:`AAMI`,renewalDate:t}}],g.maintenance=[{id:uid(),name:`Gutter clean`,provider:`Jim's`,nextDue:i,frequency:`Biannual`,notes:`Both sides`},{id:uid(),name:`Car service — RAV4`,provider:`Toyota Service`,nextDue:r,frequency:`Annual`,notes:`15,000km service`},{id:uid(),name:`Termite inspection`,provider:`Rentokil`,nextDue:n,frequency:`Annual`,notes:``},{id:uid(),name:`HVAC filter`,provider:``,nextDue:e,frequency:`Quarterly`,notes:``},{id:uid(),name:`Smoke alarm test`,provider:``,nextDue:t,frequency:`Annual`,notes:``}],g.householdProfile={...g.householdProfile,members:[{role:`adult`,name:`Robert`,age:38,emoji:`👨`},{role:`adult`,name:`Sarah`,age:36,emoji:`👩`}]},window.saveData(g),window.renderAll()}function Vl(){let e=typeof _mealWeekKey==`function`?_mealWeekKey(0):`week-0`,t={},n=[[`Porridge`,`Sandwich & apple`,`Chicken stir-fry`],[`Eggs on toast`,`Leftovers`,`Beef tacos`],[`Smoothie`,`Caesar salad`,`Pasta bolognese`],[`Avocado toast`,`Sushi`,`Lamb roast`],[`Cereal`,`Toasted sandwich`,`Fish & chips`],[`Pancakes`,`Fruit bowl`,`BBQ`],[`French toast`,`Cold cuts`,`Pizza night`]];for(let e=0;e<7;e++)t[e]={b:n[e][0],l:n[e][1],d:n[e][2]};g.meals||(g.meals={plan:{},shopping:[],lunchbox:{profiles:[],plans:{}},pantry:[]}),g.meals.plan[e]=t;let r=g.kids?.profiles?.[0];if(r){let t=typeof _mealWeekKey==`function`?_mealWeekKey(0):e;g.meals.lunchbox.plans||(g.meals.lunchbox.plans={}),g.meals.lunchbox.plans[t]||(g.meals.lunchbox.plans[t]={});let n=new Date().getDay()===0?6:new Date().getDay()-1;g.meals.lunchbox.plans[t][r.id]={},g.meals.lunchbox.plans[t][r.id][n]={main:`🥪 Vegemite sandwich`,snack:`🍫 Muesli bar`,fruit:`🍎 Apple`,drink:`💧 Water`}}g.lists||window._applyMigrations(g);let i=new Date().toISOString();g.lists.food.items=[{id:`dev-f1`,name:`Milk`,quantity:2,unit:`L`,notes:``,aisle:`dairy`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f2`,name:`Eggs`,quantity:1,unit:`dozen`,notes:`Free range`,aisle:`dairy`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f3`,name:`Chicken breast`,quantity:500,unit:`g`,notes:``,aisle:`meat`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f4`,name:`Spinach`,quantity:1,unit:`units`,notes:``,aisle:`produce`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f5`,name:`Bread`,quantity:1,unit:`units`,notes:`Sourdough`,aisle:`bakery`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f6`,name:`Pasta`,quantity:500,unit:`g`,notes:``,aisle:`pantry`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f7`,name:`Beer`,quantity:1,unit:`units`,notes:``,aisle:`drinks`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f8`,name:`Avocado`,quantity:2,unit:`units`,notes:``,aisle:`produce`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f9`,name:`Butter`,quantity:1,unit:`units`,notes:`Salted`,aisle:`dairy`,state:`got_it`,addedBy:`dev`,addedAt:i,stateChangedAt:i,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f10`,name:`Orange juice`,quantity:1,unit:`L`,notes:``,aisle:`drinks`,state:`got_it`,addedBy:`dev`,addedAt:i,stateChangedAt:i,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f11`,name:`Oat milk`,quantity:1,unit:`L`,notes:``,aisle:`dairy`,state:`not_found`,addedBy:`dev`,addedAt:i,stateChangedAt:i,mealTag:null,manualPrice:null,barcodeId:null}],g.lists.food.weeklyBudget=200,g.lists.food.favourites=[{name:`Milk`,addedCount:8,pinned:!0},{name:`Eggs`,addedCount:7,pinned:!0},{name:`Bread`,addedCount:6,pinned:!1},{name:`Chicken breast`,addedCount:5,pinned:!1},{name:`Butter`,addedCount:4,pinned:!1}],g.lists.wishlist.items=[{id:`dev-w1`,name:`AirPods Pro`,quantity:1,unit:`units`,notes:`Gen 2`,aisle:`other`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-w2`,name:`Standing desk mat`,quantity:1,unit:`units`,notes:``,aisle:`other`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-w3`,name:`Kindle Paperwhite`,quantity:1,unit:`units`,notes:``,aisle:`other`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null}],window.saveData(g),window.renderAll()}function Hl(){Il(),Ll(),Rl(),zl(),Bl(),Vl()}function Ul(){if(!confirm(`Reset all data to empty defaults?`))return;let e=JSON.parse(JSON.stringify(window.DEFAULT_DATA));e.onboarded=!0,e.setupProgressDismissed=!1,m(e),window.saveData(e),window.renderAll()}var Wl=null,Gl=[{key:`main`,label:`Main`},{key:`snack`,label:`Snack`},{key:`fruit`,label:`Fruit`},{key:`drink`,label:`Drink`}],Kl=[`Nuts`,`Dairy`,`Gluten`,`Eggs`,`Soy`,`Seafood`,`Sesame`];function ql(){let e=document.getElementById(`lunchbox-content`);if(!e)return;let t=g.meals.lunchbox,n=t.profiles||[];if(n.length===0){e.innerHTML=`
      <div class="empty" style="margin-top:24px">
        <div class="empty-icon" style="font-size:48px">🍱</div>
      ...
      </div>`;return}(!Wl||!n.find(e=>e.id===Wl))&&(Wl=n[0].id);let r=n.find(e=>e.id===Wl),i=_mealWeekKey(0),a=_mealWeekDates(i).slice(0,5),o=(t.plans[i]||{})[Wl]||{},s=new Date().toISOString().slice(0,10),c=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`],l=n.map(e=>`<button class="lb-kid-tab${e.id===Wl?` active`:``}" onclick="_lbActiveKid='${e.id}';renderLunchbox()">${T(e.name)}</button>`).join(``);a[0].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`}),a[4].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`});let u=``;Gl.forEach(e=>{u+=`<div class="lb-label">${e.label}</div>`,a.forEach((t,n)=>{let r=(o[n]||{})[e.key]||``,a=t.toISOString().slice(0,10)===s;u+=`<div class="lb-cell${a?` today`:``}" onclick="openLunchboxEdit('${i}',${Wl},${n},'${e.key}')">
        ${r?`<span class="lb-cell-text">${T(r)}${g.settings?.showCalories&&(o[n]||{})[`cal_`+e.key]?`<br><span style="font-size:8px;color:var(--text-muted);font-weight:600">${o[n][`cal_`+e.key]} cal</span>`:``}</span>`:`<span class="lb-cell-plus">+</span>`}
      </div>`})});let d=(r.allergies||[]).map(e=>`<span class="lb-tag allergy">${T(e)}</span>`).join(``),f=(r.dislikes||[]).map(e=>`<span class="lb-tag dislike">${T(e)}</span>`).join(``),p=(r.favourites||[]).map(e=>`<span class="lb-tag fav">${T(e)}</span>`).join(``),m=!!localStorage.getItem(`toto_ai_key`),h=Object.values(o).reduce((e,t)=>e+Object.values(t||{}).filter(Boolean).length,0);e.innerHTML=`
    ...
    <div class="lb-profile-card">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px">
        <div style="font-size:15px;font-weight:700">${T(r.name)}</div>
        ${r.school?`<span style="font-size:12px;color:var(--text-muted)">${T(r.school)}</span>`:``}
      </div>
      <div style="display:flex;flex-wrap:wrap;gap:4px">
        ${d||``}${f||``}${p||``}
        ${!d&&!f&&!p?`<span style="font-size:12px;color:var(--text-muted)">No preferences set — edit profile to add allergies, dislikes, favourites</span>`:``}
      </div>
      ${r.schoolRules?`<div style="font-size:11px;color:var(--text-muted);margin-top:6px">School rules: ${T(r.schoolRules)}</div>`:``}
    </div>
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;flex-wrap:wrap;gap:10px">
      ...
      <div style="display:flex;gap:8px">
        ${m?`<button class="btn btn-primary btn-sm" id="lb-ai-btn" onclick="aiPlanLunchbox('${i}','${r.id}')">Plan this week</button>`:``}
        ${h>0?`<button class="btn btn-sm" onclick="lbToShoppingList('${i}','${r.id}')">Add to shopping list</button>`:``}
      </div>
    </div>
    ...
    </div>`}function Jl(e){let t=e?(g.meals.lunchbox.profiles||[]).find(t=>t.id===e):null;document.getElementById(`modal-title`).textContent=t?`Edit ${T(t.name)}`:`Add Child`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
      <label class="form-label">Child's Name</label>
      <input class="form-input" id="lb-name" type="text" maxlength="200" value="${t?E(t.name):``}" placeholder="e.g. Jake">
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        <label class="form-label">School</label>
        <input class="form-input" id="lb-school" type="text" maxlength="200" value="${t?E(t.school||``):``}" placeholder="e.g. Emmaus Christian">
      </div>
      <div class="form-group">
        <label class="form-label">School Rules</label>
        <input class="form-input" id="lb-rules" type="text" maxlength="200" value="${t?E(t.schoolRules||``):``}" placeholder="e.g. Nut-free zone">
      </div>
    </div>
    <div class="form-group">
      ...
      <div id="lb-allergies" style="display:flex;flex-wrap:wrap;gap:6px">
        ${Kl.map(e=>{let n=t&&(t.allergies||[]).includes(e);return`<button type="button" class="lb-tag${n?` allergy`:``}" style="cursor:pointer;${n?``:`background:var(--surface2);color:var(--text-muted);border:1px solid var(--border)`}"
    ...
    <div>
      ...
      <div style="display:flex;flex-wrap:wrap;gap:6px">
        ${c.map(e=>`<button style="padding:4px 12px;border-radius:99px;border:1px solid var(--border);background:var(--surface2);font-size:12px;cursor:pointer"
          onclick="document.getElementById('lb-input').value='${E(e)}'">${T(e)}</button>`).join(``)}
      </div>
    </div>`:``}`,document.getElementById(`modal-footer`).innerHTML=`
    <button class="btn" onclick="_saveLbSlot('${e}',${t},${n},'${r}','')">Clear</button>
    <button class="btn btn-primary" onclick="_saveLbSlot('${e}',${t},${n},'${r}',document.getElementById('lb-input').value.trim())">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`),setTimeout(()=>{let e=document.getElementById(`lb-input`);e&&(e.focus(),e.select())},80)}function Ql(e,t,n,r,i){g.meals.lunchbox.plans[e]||(g.meals.lunchbox.plans[e]={}),g.meals.lunchbox.plans[e][t]||(g.meals.lunchbox.plans[e][t]={}),g.meals.lunchbox.plans[e][t][n]||(g.meals.lunchbox.plans[e][t][n]={}),g.meals.lunchbox.plans[e][t][n][r]=i,delete g.meals.lunchbox.plans[e][t][n][`cal_`+r],window.saveData(g),window.closeModal(),ql(),i&&g.settings?.showCalories&&$l(e,t,n,r,i)}async function $l(e,t,n,r,i){let a=localStorage.getItem(`toto_ai_key`);if(!(!a||!i))try{let o=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":a,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:50,messages:[{role:`user`,content:`Estimate the calories in this school lunch item: "${i}". Return ONLY a number, nothing else. For example: 250`}]})});if(!o.ok)return;let s=await o.json(),c=parseInt(s.content[0].text.trim().replace(/[^0-9]/g,``));c>0&&c<3e3&&g.meals.lunchbox.plans[e]?.[t]?.[n]&&(g.meals.lunchbox.plans[e][t][n][`cal_`+r]=c,window.saveData(g),ql())}catch{}}async function eu(e,t){let n=localStorage.getItem(`toto_ai_key`);if(!n)return;let r=(g.meals.lunchbox.profiles||[]).find(e=>e.id===t);if(!r)return;let i=document.getElementById(`lb-ai-btn`);i&&(i.textContent=`Planning...`,i.disabled=!0);let a=`Plan 5 days (Monday to Friday) of school lunches for a child:
...
No markdown, no code fences, just raw JSON.`;try{let r=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":n,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:a}]})});if(!r.ok)throw Error(`API ${r.status}`);let i=(await r.json()).content[0].text.replace(/```[\w]*\n?/g,``).trim().match(/\[[\s\S]*\]/);if(!i)throw Error(`No JSON`);let o=JSON.parse(i[0]);g.meals.lunchbox.plans[e]||(g.meals.lunchbox.plans[e]={}),g.meals.lunchbox.plans[e][t]||(g.meals.lunchbox.plans[e][t]={}),o.forEach(n=>{let r={main:n.main||``,snack:n.snack||``,fruit:n.fruit||``,drink:n.drink||``};n.cal_main&&(r.cal_main=n.cal_main),n.cal_snack&&(r.cal_snack=n.cal_snack),n.cal_fruit&&(r.cal_fruit=n.cal_fruit),n.cal_drink&&(r.cal_drink=n.cal_drink),g.meals.lunchbox.plans[e][t][n.day]=r}),window.saveData(g),ql()}catch(e){console.error(`Lunchbox AI error:`,e),i&&(i.textContent=`Plan this week`,i.disabled=!1)}}function tu(e,t){let n=(g.meals.lunchbox.plans[e]||{})[t]||{},r=new Set;Object.values(n).forEach(e=>{e.main&&r.add(e.main),e.snack&&r.add(e.snack),e.fruit&&r.add(e.fruit)}),g.lists||(g.lists={}),g.lists.food||(g.lists.food={items:[],weeklyBudget:200,budget:0,stores:[],favourites:[],history:[]});let i=g.lists.food.items,a=0;r.forEach(e=>{i.some(t=>t.name.toLowerCase()===e.toLowerCase()&&t.state===`active`)||(i.push({id:`si-lb-`+Date.now()+`-`+a,name:e,quantity:1,unit:`units`,notes:``,aisle:_inferAisle?_inferAisle(e):`other`,state:`active`,addedBy:`lunchbox`,addedAt:new Date().toISOString(),mealTag:`Lunchbox`,manualPrice:null,barcodeId:null}),a++)}),a>0&&(window.saveData(g),_listsActiveType=`food`,_listsView=`list`,activateTab(`lists`));let o=document.querySelector(`[onclick^="lbToShoppingList"]`);if(o){let e=o.textContent;o.textContent=`Added ${a} items`,o.style.color=`var(--success)`,setTimeout(()=>{o.textContent=e,o.style.color=``},2e3)}}function nu(e){let t=document.querySelector(`.health-popover`);if(t){t.remove();return}let n=window._lastHealth;if(!n)return;let r=window._lastHealthGuides||[`savings`,`tracking`,`netWorth`,`emergency`,`goals`],i={A:`#10b981`,B:`#0891b2`,C:`#f59e0b`,D:`#f97316`,F:`#ef4444`},a={A:`Excellent`,B:`Good`,C:`Fair — some areas need work`,D:`Needs attention`,F:`Critical — take action`},o={"Savings Rate":n.dimensions[0].score>=15?`Healthy savings rate`:n.dimensions[0].score>=8?`Could save more each month`:`Very little being saved`,"Budget Tracking":n.dimensions[1].score>=15?`Consistently logging actuals`:n.dimensions[1].score>=8?`Some months tracked`:`Not tracking actual spending`,"Net Worth":n.dimensions[2].score>=15?`Assets outweigh liabilities`:n.dimensions[2].score>=8?`Building slowly`:`Liabilities are high or no data`,"Emergency Buffer":n.dimensions[3].score>=15?`3+ months of expenses covered`:n.dimensions[3].score>=8?`Some buffer building`:`Less than 1 month covered`,Goals:n.dimensions[4].score>=15?`Goals set and progressing`:n.dimensions[4].score>=8?`Goals need more progress`:`No active goals set`},s=``;n.dimensions.forEach((e,t)=>{let n=Math.round(e.score/e.max*100),i=n>=75?`#10b981`:n>=50?`#f59e0b`:`#ef4444`,a=o[e.label]||``,c=r[t],l=e.score<15&&HEALTH_GUIDES[c];s+=`<div class="health-dim">
    ...
    ${s}`,document.body.appendChild(c);let l=e.getBoundingClientRect(),u=l.bottom+10,d=l.left+l.width/2-150;d<12&&(d=12),d+300>window.innerWidth-12&&(d=window.innerWidth-312),u+c.offsetHeight>window.innerHeight-12&&(u=l.top-c.offsetHeight-10),c.style.top=u+`px`,c.style.left=d+`px`,setTimeout(()=>{let t=n=>{!c.contains(n.target)&&n.target!==e&&(c.remove(),document.removeEventListener(`click`,t))};document.addEventListener(`click`,t)},10)}var ru=[],iu=0,au=null;function ou(e){ru=e,iu=0,su()}function su(){if(du(),iu>=ru.length){uu();return}let e=ru[iu];e.tab&&_activeTab()!==e.tab?(activateTab(e.tab),setTimeout(()=>cu(e),500)):setTimeout(()=>cu(e),100)}function cu(e){let t=e.el?typeof e.el==`string`?document.querySelector(e.el):e.el:null,n=document.createElement(`div`);n.className=`guide-overlay`,n.onclick=()=>uu(),document.body.appendChild(n);let r=null,i=null;t&&(t.scrollIntoView({behavior:`smooth`,block:`center`}),i=t.getBoundingClientRect(),r=document.createElement(`div`),r.className=`guide-spotlight guide-pulse`,r.style.cssText=`top:${i.top-6}px;left:${i.left-6}px;width:${i.width+12}px;height:${i.height+12}px;`,document.body.appendChild(r));let a=document.createElement(`div`);if(a.className=`guide-tooltip`,a.innerHTML=`
    <div class="guide-tooltip-step">Step ${iu+1} of ${ru.length}</div>
    ...
    <div class="guide-tooltip-actions">
      ...
      ${iu<ru.length-1?`<button class="guide-tooltip-btn" style="background:#0891b2;color:#fff" onclick="nextGuideStep()">Next</button>`:`<button class="guide-tooltip-btn" style="background:#0891b2;color:#fff" onclick="endGuide()">Done</button>`}
    </div>`,a.onclick=e=>e.stopPropagation(),document.body.appendChild(a),i){let e=a.offsetWidth,t=a.offsetHeight,n=i.bottom+14,r=i.left+i.width/2-e/2;r<12&&(r=12),r+e>window.innerWidth-12&&(r=window.innerWidth-e-12),n+t>window.innerHeight-12&&(n=i.top-t-14),a.style.top=n+`px`,a.style.left=r+`px`}else a.style.top=`50%`,a.style.left=`50%`,a.style.transform=`translate(-50%, -50%)`;if(au=()=>{n.remove(),r&&r.remove(),a.remove()},e.watchClick&&t){let e=()=>{t.removeEventListener(`click`,e),setTimeout(()=>lu(),400)};t.addEventListener(`click`,e)}}function lu(){iu++,su()}function uu(){du(),ru=[],iu=0}function du(){au&&(au(),au=null)}var fu={emergency:[{tab:`goals`,title:`Create an Emergency Fund`,text:`An emergency fund covers 3-6 months of expenses. Let's set one up as a savings goal.`,el:null},{tab:`goals`,title:`Tap "+ New Goal"`,text:`This button creates a new savings goal. Set the name to "Emergency Fund" and the target to your 3-month expenses.`,el:`[onclick*="openAddGoal"]`,watchClick:!0}],savings:[{tab:`budget`,title:`Improve your savings rate`,text:`Your savings rate is the gap between income and expenses. To improve it, you can either reduce expenses or increase income.`,el:null},{tab:`budget`,title:`Review your expenses`,text:`Look through your expenses below. Are there any you could reduce? Tap any expense to edit it.`,el:`#budget-content`}],tracking:[{tab:`budget`,title:`Track your actual spending`,text:`Recording what you actually spend helps you stay on track. You can import your bank statement or log spends manually.`,el:null},{tab:`budget`,title:`Import transactions`,text:`Tap "Import Transactions" to upload a bank CSV, or use the + button to log individual spends.`,el:`[onclick*="openCsvImport"]`,watchClick:!0}],netWorth:[{tab:`networth`,title:`Build your net worth picture`,text:`Add what you own (property, savings, super) as assets. Add what you owe (mortgage, loans, credit cards) as liabilities.`,el:null},{tab:`networth`,title:`Start adding`,text:`Use the buttons below to add your first asset or liability. Even rough numbers help build the picture.`,el:`#networth-content`}],goals:[{tab:`goals`,title:`Set a financial goal`,text:`Goals keep you motivated — a holiday fund, debt payoff, or savings target. Let's create your first one.`,el:null},{tab:`goals`,title:`Tap "+ New Goal"`,text:`Choose a goal type, set a target amount, and start tracking your progress.`,el:`[onclick*="openAddGoal"]`,watchClick:!0}]};function pu(e){let t=fu[e];t&&ou(t)}var mu=!1;function hu(e){mu=!0;let t=document.getElementById(`cv-readonly-bar`),n=document.getElementById(`cv-signout-btn`);t&&(t.style.display=``),n&&(n.style.display=`none`),window.showChildView(e)}function gu(e){mu=!0;let t=document.getElementById(`cv-readonly-bar`),n=document.getElementById(`cv-signout-btn`);t&&(t.style.display=``),n&&(n.style.display=`none`),window.showChildView(e),setTimeout(()=>{_cvSwitchTab(`calendar`,e)},50)}function _u(){let e=document.getElementById(`child-view-overlay`);e.classList.add(`hidden`),e.style.display=``;let t=document.getElementById(`cv-readonly-bar`),n=document.getElementById(`cv-signout-btn`);t&&(t.style.display=`none`),n&&(n.style.display=``);let r=mu;mu=!1,r||(window._activeProfile=null,window.clearKidSession(),window.switchProfile())}function vu(){let e=Number(g.settings?.routineResetHour??0),t=new Date,n=new Date(t);n.setHours(e,0,0,0),t<n&&n.setDate(n.getDate()-1),n.toISOString().slice(0,10);let r=!1;(g.routineAssignments||[]).forEach(e=>{e.completionState&&Object.keys(e.completionState).forEach(e=>{})});let i=t.toISOString().slice(0,10);if(g.settings?.lastRoutineResetCheck!==i){if(g.settings||(g.settings={}),g.settings.lastRoutineResetCheck=i,g.kids?.completions){let e=g.kids.completions.length;g.kids.completions=g.kids.completions.filter(e=>e.status===`pending`?new Date(e.completedAt||e.ts||0).toISOString().slice(0,10)>=i:!0),g.kids.completions.length!==e&&(r=!0)}r=!0}r&&window.saveData(g)}function yu(e,t){return!e||(e.pausePeriods||[]).some(e=>t>=e.from&&(!e.to||t<=e.to))||(e.skippedDates||[]).includes(t)?!1:Pt(e.recurrence||null,t)}var bu={morning:[{label:`Make bed`,emoji:`🛏`,durationMin:2},{label:`Shower`,emoji:`🚿`,durationMin:10},{label:`Breakfast`,emoji:`🍳`,durationMin:15},{label:`Exercise`,emoji:`💪`,durationMin:20},{label:`Meditate`,emoji:`🧘`,durationMin:10},{label:`Plan the day`,emoji:`📋`,durationMin:5},{label:`Read`,emoji:`📚`,durationMin:15},{label:`Vitamins`,emoji:`💊`,durationMin:1},{label:`Walk`,emoji:`🚶`,durationMin:20},{label:`Journaling`,emoji:`✍️`,durationMin:10}],evening:[{label:`Tidy kitchen`,emoji:`🍽`,durationMin:10},{label:`Prep tomorrow`,emoji:`👔`,durationMin:5},{label:`Family time`,emoji:`👨‍👩‍👧`,durationMin:30},{label:`Read`,emoji:`📚`,durationMin:20},{label:`Lights out`,emoji:`💤`,durationMin:0},{label:`Stretch`,emoji:`🤸`,durationMin:10},{label:`Review the day`,emoji:`🪞`,durationMin:5},{label:`Skincare`,emoji:`🧴`,durationMin:5},{label:`No screens`,emoji:`📵`,durationMin:0},{label:`Brush teeth`,emoji:`🦷`,durationMin:3}],general:[{label:`Drink water`,emoji:`💧`,durationMin:1},{label:`Check messages`,emoji:`📱`,durationMin:5},{label:`Quick tidy`,emoji:`🧹`,durationMin:5},{label:`Gratitude`,emoji:`🙏`,durationMin:3}]};function xu(e){let t=e||new Date;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`}function U(){return xu(new Date)}function Su(){return window._currentUser?.uid||`guest`}function Cu(){let e=Su();return(g.routines||[]).filter(t=>t.ownerType===`adult`&&(t.ownerId===e||(t.sharedWith||[]).includes(e)))}function wu(){return(g.routines||[]).filter(e=>e.ownerType===`household`)}function Tu(e){return e.ownerId===Su()}function Eu(){return g.kids?.profiles||[]}function Du(){return Date.now().toString(36)+Math.random().toString(36).slice(2)}function Ou(){return Su(),(g.householdProfile?.authorizedUsers||[]).filter(e=>e.uid!==window.uid)}function ku(e,t){return(g.routineAssignments||[]).find(n=>n.routineId===e&&n.childId===t)}function Au(e){return(e?.completionState?.[U()]||[]).length}function ju(e,t){if(!e)return 0;let n=0,r=new Date;for(;(e.completionState?.[xu(r)]||[]).length===t&&t>0;)n++,r.setDate(r.getDate()-1);return n}function Mu(e,t,n){let r=[],i=new Date;for(let a=n-1;a>=0;a--){let n=new Date(i);n.setDate(i.getDate()-a);let o=xu(n),s=(e?.completionState?.[o]||[]).length;r.push({key:o,label:n.getDate(),done:s,total:t})}return r}function Nu(e){return(e.completions?.[U()]||[]).length}function Pu(e){let t=0,n=new Date;for(;(e.completions?.[xu(n)]||[]).length===e.steps.length&&e.steps.length>0;)t++,n.setDate(n.getDate()-1);return t}function Fu(e,t){let n=[],r=new Date;for(let i=t-1;i>=0;i--){let t=new Date(r);t.setDate(r.getDate()-i);let a=xu(t),o=(e.completions?.[a]||[]).length;n.push({key:a,label:t.getDate(),done:o,total:e.steps.length})}return n}function Iu(e){let t=new Set(e.steps.map(e=>e.label.toLowerCase())),n=e.name.toLowerCase(),r;return r=n.includes(`morning`)?[...bu.morning,...bu.general]:n.includes(`evening`)||n.includes(`night`)||n.includes(`bed`)?[...bu.evening,...bu.general]:[...bu.morning,...bu.evening,...bu.general],r.filter(e=>!t.has(e.label.toLowerCase()))}function Lu(e){if(e.ownerType===`household`){if(e.ownerId!==`household`)throw Error(`Scope violation: household routine has ownerId="${e.ownerId}"`)}else if(e.ownerType===`adult`){if(!e.ownerId||e.ownerId===`household`)throw Error(`Scope violation: adult routine has ownerId="${e.ownerId}"`)}else throw Error(`Scope violation: unknown ownerType="${e.ownerType}"`)}function Ru(e){(g.routines||[]).forEach(t=>{try{Lu(t)}catch(n){console.error(`[Routines] ${e}:`,n.message,t)}}),window.saveData(g)}function zu(){let e=Cu(),t=new Date().getHours();for(let n of e){let e=Nu(n),r=n.steps.length;if(!r)continue;let[i]=(n.triggerTime||`00:00`).split(`:`).map(Number),a=Pu(n);if(t>=i+1&&e===0)return{icon:n.emoji,text:`Your ${n.name} routine hasn't been started yet.`};if(a>0&&a%7==0)return{icon:`🔥`,text:`${a}-day streak on your ${n.name} routine — keep it up!`};if(e>0&&e===r-1)return{icon:n.emoji,text:`One step left in your ${n.name} routine!`}}return null}function Bu(){let e=new Date().toISOString().slice(0,10),t=Cu().filter(t=>yu(t,e));if(!t.length)return``;let n=new Date().getHours(),r=t.map(e=>{let t=Nu(e),r=e.steps.length,i=r>0?Math.round(t/r*100):0,[a]=(e.triggerTime||`00:00`).split(`:`).map(Number),o=n>=a+1&&t===0&&r>0;return`<div class="routine-today-row">
      <div class="routine-today-emoji">${e.emoji}</div>
      <div class="routine-today-name">${T(e.name)}</div>
    ...
    </div>`}).join(``),i=zu();return`${i?`<div class="routine-intel-nudge" onclick="activateTab('routines')" style="margin-bottom:8px">
    <div class="routine-intel-icon">${i.icon}</div>
    <div class="routine-intel-body"><div class="routine-intel-label">Routines</div>${T(i.text)}</div>
  ...
  </div>`}var Vu=`mine`;Object.defineProperty(window,`_routineActiveTab`,{get(){return Vu},set(e){Vu=e},configurable:!0});function W(){let e=document.getElementById(`routines-content`);if(!e)return;let t=Eu(),n=t.length>0,r=`<div class="page-header" style="margin-bottom:4px">
    <h1>Routines</h1>
  ...
  <div style="display:flex;justify-content:flex-end;margin-bottom:16px">
    <button class="btn btn-primary btn-sm" onclick="_routineCreate()">＋ New routine</button>
      ...
      <button class="routine-tab${Vu===`mine`?` active`:``}" onclick="_routineSetTab('mine')">My Routines</button>
      <button class="routine-tab${Vu===`children`?` active`:``}" onclick="_routineSetTab('children')">Children's Routines</button>
    </div>`),r+=Vu===`children`&&n?Zu(t):Uu(),e.innerHTML=r}function Hu(e){Vu=e,W()}function Uu(){let e=Su(),t=!1;(g.routines||[]).forEach(n=>{n.ownerType===`adult`&&(n.ownerId===`guest`||n.ownerId===`dev`)&&(n.ownerId=e,t=!0)}),t&&Ru(`lazy-uid-claim`);let n=new Date().toISOString().slice(0,10),r=Cu().filter(e=>yu(e,n)),i=U(),a=``;return r.length?(r.forEach(e=>{let t=Tu(e),n=e.linkedType===`join`,r=!t&&(e.sharedWith||[]).includes(window.uid),o=e.completions?.[i]||[],s=e.steps.length,c=s>0?Math.round(o.length/s*100):0,l=o.length===s&&s>0,u=Pu(e),d=e.steps.reduce((e,t)=>e+(t.durationMin||0),0),f=t&&!n,p=``;n?p=`<span class="routine-owner-badge routine-joined-badge">🔗 Joined</span>`:e.linkedType===`duplicate`?p=`<span class="routine-owner-badge">📋 Duplicated</span>`:r&&(p=`<span class="routine-owner-badge routine-shared-badge">👥 Shared with you</span>`);let m=e.steps.map((t,n)=>{let r=o.includes(t.id);return`<div class="routine-step"${f?` draggable="true" data-routine="'${e.id}'" data-step="'${t.id}'" data-idx="${n}"
        ...
        <span class="routine-step-label${r?` done`:``}">${T(t.label)}</span>
        ${t.durationMin?`<span class="routine-step-dur">${t.durationMin}m</span>`:``}
        ${t.notes?`<span class="routine-step-dur" style="font-style:italic">${T(t.notes)}</span>`:``}
      </div>`}).join(``),h=(e.skippedDates||[]).includes(new Date().toISOString().slice(0,10)),g=f?`
      ...
      <button class="btn btn-sm btn-ghost" style="color:#ef4444" onclick="_routineDelete('${e.id}')" title="Delete">🗑</button>`:``,_=`<button class="btn btn-sm btn-secondary" onclick="_routineResetToday('${e.id}')">↺ Reset today</button>
      <button class="btn btn-sm btn-secondary" onclick="_routineShowHistory('${e.id}',null)">📅 History</button>`;f?_+=`<button class="btn btn-sm btn-secondary" onclick="_routineShareMenu('${e.id}')">👥 Share</button>`:n?_+=`<button class="btn btn-sm btn-secondary" onclick="_routineDuplicateFromJoined('${e.id}')">📋 Duplicate to mine</button>
        <button class="btn btn-sm btn-ghost" style="color:#ef4444;margin-left:auto" onclick="_routineLeave('${e.id}')">Leave</button>`:r&&(_+=`<button class="btn btn-sm btn-secondary" onclick="_routineDuplicateTo('${e.id}')">📋 Duplicate to mine</button>
        <button class="btn btn-sm btn-secondary" onclick="_routineJoin('${e.id}')">🔗 Join (stay in sync)</button>`),a+=`<div class="routine-card">
      <div class="routine-card-header">
        <div class="routine-card-title">${e.emoji} ${T(e.name)}</div>
      ...
      ${f?Ju(e):``}
      <div class="routine-card-btns" style="margin-top:12px">${_}</div>
    ...
    <div class="routine-new-card" onclick="_routineCreate()">
      <span style="font-size:22px">＋</span>
      <span class="routine-new-card-label">Create new routine</span>
    </div>`}var Wu={},Gu={};function Ku(e){Wu[e]=!Wu[e],W()}function qu(e){Gu[e]=!0,W()}function Ju(e){let t=Iu(e);if(!t.length)return``;let n=!Wu[e.id],r=!!Gu[e.id],i=r?t:t.slice(0,3),a=t.length-3,o=e.ownerType===`household`,s=i.map(t=>`
    <div class="routine-suggestion-row"
      onclick="_routineAddSuggestion('${e.id}','${T(t.label).replace(/'/g,`\\'`)}','${t.emoji}',${t.durationMin})" style="cursor:pointer">
      <span class="routine-suggestion-emoji" style="pointer-events:none">${t.emoji}</span>
      <span class="routine-suggestion-label" style="pointer-events:none">${T(t.label)}</span>
      ${t.durationMin?`<span class="routine-suggestion-dur" style="pointer-events:none">${t.durationMin}m</span>`:``}
      <div style="display:flex;align-items:center;gap:6px;flex-shrink:0;margin-left:auto;pointer-events:none">
        ${o?`<button class="btn btn-sm btn-ghost" style="padding:2px 7px;font-size:12px;pointer-events:auto"
          onclick="event.stopPropagation();_routineEditSuggestion('${e.id}','${T(t.label).replace(/'/g,`\\'`)}','${t.emoji}',${t.durationMin})"
  ...
  </div>`}function Yu(e,t,n,r){window.openModal(`Add step`,`
    <div class="form-group" style="display:flex;gap:12px">
      <div style="flex:1"><label class="form-label">Label</label>
        <input class="form-input" id="rse-label" value="${T(t)}" maxlength="40"></div>
  ...
  `,()=>{Xu(e,document.getElementById(`rse-label`)?.value.trim()||t,document.getElementById(`rse-emoji`)?.value.trim()||n,parseInt(document.getElementById(`rse-dur`)?.value)||0,parseInt(document.getElementById(`rse-pts`)?.value)||0,document.getElementById(`rse-notes`)?.value.trim()||``)})}function Xu(e,t,n,r,i,a){let o=(g.routines||[]).find(t=>String(t.id)===String(e));if(!o)return;let s=new Set([...o.steps.map(e=>e.id),...Object.values(o.completions||{}).flat(),...(g.routineAssignments||[]).filter(t=>t.routineId===e).flatMap(e=>Object.values(e.completionState||{}).flat())]),c=Math.max(0,...s)+1;for(;s.has(c);)c++;o.steps.push({id:c,label:t,emoji:n,durationMin:r||0,points:i||0,notes:a||``}),hd(o.id,o.steps[o.steps.length-1]),window.saveData(g),W()}function Zu(e){let t=g.routineAssignments||[],n=wu(),r=U();if(!n.length)return`<div style="text-align:center;padding:32px 20px;color:var(--text-muted)">
    ...
    <div class="routine-new-card" onclick="_routineCreate('child')">
      ...
      <span class="routine-new-card-label">Create children's routine</span>
        ...
        title="${t?`Remove`:`Assign`} ${T(e.name)}">
        ${e.emoji||`👤`} ${T(e.name)}
      </span>`}).join(``),l=o.length?o.map(({kid:e,assignment:t})=>{let n=t.completionState?.[r]||[],i=s>0?Math.round(n.length/s*100):0,a=ju(t,s),o=n.length===s&&s>0;return`<div style="display:flex;align-items:center;gap:8px;padding:4px 0">
            <span style="font-size:14px;width:22px;text-align:center;flex-shrink:0">${e.emoji||`👤`}</span>
            <span style="font-size:12px;font-weight:600;color:var(--text);flex-shrink:0;min-width:52px">${T(e.name)}</span>
      ...
      <div class="routine-step" draggable="true"
        ...
        <span class="routine-step-label">${T(e.label)}</span>
        ${e.durationMin?`<span class="routine-step-dur">${e.durationMin}m</span>`:``}
        ${e.notes?`<span class="routine-step-dur" style="font-style:italic">${T(e.notes)}</span>`:``}
      ...
      <div class="routine-card-header">
        <div class="routine-card-title">${n.emoji} ${T(n.name)}</div>
    ...
    <span style="font-size:22px">＋</span>
    <span class="routine-new-card-label">Create children's routine</span>
  </div>`,i}function Qu(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));t&&confirm(`Delete "${t.name}"? All assignments and history will be removed.`)&&(g.routines=g.routines.filter(t=>t.id!==e),g.routineAssignments=(g.routineAssignments||[]).filter(t=>t.routineId!==e),window.saveData(g),W())}function $u(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(!n||n.ownerType!==`adult`)return;let r=U();n.completions||(n.completions={}),n.completions[r]||(n.completions[r]=[]);let i=n.completions[r].indexOf(t);i===-1?n.completions[r].push(t):n.completions[r].splice(i,1),window.saveData(g),W()}function ed(e,t,n){let r=ku(e,n);if(!r)return;r.completionState||(r.completionState={});let i=U();r.completionState[i]||(r.completionState[i]=[]);let a=r.completionState[i].indexOf(t),o=a===-1;o?r.completionState[i].push(t):r.completionState[i].splice(a,1);let s=(g.routines||[]).find(t=>String(t.id)===String(e));if(s&&o){let e=s.steps.find(e=>e.id===t);(e?.points||0)>0&&td(s,e,n);let a=s.steps.length;r.completionState[i].length===a&&a>0&&(s.pointsPerCompletion||0)>0&&nd(s,n)}window.saveData(g),window._activeProfile?.role===`child`?window.showChildView(n):W()}function td(e,t,n){if(!g.kids)return;g.kids.completions||(g.kids.completions=[]),g.kids.chores||(g.kids.chores=[]);let r=`routine-'${e.id}'-step-'${t.id}'`,i=g.kids.chores.find(e=>e.id===r);i?i.points=t.points:g.kids.chores.push({id:r,name:`${e.name}: ${t.label}`,emoji:t.emoji,points:t.points,frequency:`daily`,assignedTo:n,_isRoutine:!0,_isStep:!0});let a=new Date().toDateString();g.kids.completions.some(e=>e.choreId===r&&e.kidId===n&&new Date(e.completedAt).toDateString()===a&&e.status===`approved`)||g.kids.completions.push({id:window.uid(),choreId:r,kidId:n,completedAt:Date.now(),status:`approved`,_fromRoutine:!0})}function nd(e,t){if(!g.kids)return;g.kids.completions||(g.kids.completions=[]);let n=`routine-'${e.id}'`;g.kids.chores||(g.kids.chores=[]);let r=g.kids.chores.find(e=>e.id===n);r?r.points=e.pointsPerCompletion:g.kids.chores.push({id:n,name:e.name,emoji:e.emoji,points:e.pointsPerCompletion,frequency:`daily`,assignedTo:t,_isRoutine:!0});let i=new Date().toDateString();g.kids.completions.some(e=>e.choreId===n&&e.kidId===t&&new Date(e.completedAt).toDateString()===i&&e.status===`approved`)||g.kids.completions.push({id:window.uid(),choreId:n,kidId:t,completedAt:Date.now(),status:`approved`,_fromRoutine:!0})}function rd(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));t&&(delete t.completions[U()],window.saveData(g),W())}function id(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=new Date().toISOString().slice(0,10);t.skippedDates||(t.skippedDates=[]),t.skippedDates.includes(n)?t.skippedDates=t.skippedDates.filter(e=>e!==n):t.skippedDates.push(n),window.saveData(g),W()}function ad(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;t.pausePeriods||(t.pausePeriods=[]);let n=new Date().toISOString().slice(0,10),r=t.pausePeriods.filter(e=>!e.to||e.to>=n),i=r.length?`<div style="margin-bottom:12px"><div style="font-size:11px;font-weight:700;text-transform:uppercase;color:var(--text-muted);margin-bottom:6px">Active pauses</div>${r.map((n,r)=>`<div style="display:flex;align-items:center;gap:8px;padding:6px 0;font-size:13px;border-bottom:1px solid var(--border)">
          <span style="flex:1">${n.from}${n.to?` → `+n.to:` (indefinite)`}${n.reason?` · `+T(n.reason):``}</span>
  ...
  `,()=>{let e=document.getElementById(`rp-from`)?.value;if(!e)return;let n=document.getElementById(`rp-to`)?.value||void 0,r=document.getElementById(`rp-reason`)?.value.trim()||void 0;t.pausePeriods.push({from:e,to:n,reason:r}),window.saveData(g),window.closeModal(),W()})}function od(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));!n||!n.pausePeriods||(n.pausePeriods.splice(t,1),window.saveData(g),window.closeModal(),W())}function sd(e,t){let n=ku(e,t);n&&(n.completionState&&delete n.completionState[U()],window.saveData(g),W())}function cd(e){let t=U();(g.routineAssignments||[]).filter(t=>t.routineId===e).forEach(e=>{e.completionState&&delete e.completionState[t]}),window.saveData(g),W()}var ld=null;Object.defineProperty(window,`_routineDragIdx`,{get(){return ld},set(e){ld=e},configurable:!0});function ud(e){ld=parseInt(e.currentTarget.dataset.idx),e.currentTarget.classList.add(`dragging`),e.dataTransfer.effectAllowed=`move`}function dd(e){e.preventDefault(),e.dataTransfer.dropEffect=`move`,document.querySelectorAll(`.routine-step.drag-over`).forEach(e=>e.classList.remove(`drag-over`)),e.currentTarget.classList.add(`drag-over`)}function fd(e,t){e.preventDefault();let n=parseInt(e.currentTarget.dataset.idx);if(ld===null||ld===n)return;let r=(g.routines||[]).find(e=>String(e.id)===String(t));if(!r)return;let i=r.steps.splice(ld,1)[0];r.steps.splice(n,0,i),ld=null,window.saveData(g),W()}function pd(e){e.currentTarget.classList.remove(`dragging`),document.querySelectorAll(`.routine-step.drag-over`).forEach(e=>e.classList.remove(`drag-over`)),ld=null}function md(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=t.ownerType===`household`;window.openModal(`Add step`,`
    ...
    </div>`,()=>{let r=document.getElementById(`rs-label`)?.value.trim();if(!r)return;let i=new Set([...t.steps.map(e=>e.id),...Object.values(t.completions||{}).flat(),...(g.routineAssignments||[]).filter(t=>t.routineId===e).flatMap(e=>Object.values(e.completionState||{}).flat())]),a=Math.max(0,...i)+1;for(;i.has(a);)a++;let o={id:a,label:r,emoji:document.getElementById(`rs-emoji`)?.value.trim()||`✅`,durationMin:parseInt(document.getElementById(`rs-dur`)?.value)||0,points:n&&parseInt(document.getElementById(`rs-pts`)?.value)||0,notes:document.getElementById(`rs-notes`)?.value.trim()||``};t.steps.push(o),hd(t.id,o),window.saveData(g),window.closeModal(),W()}),setTimeout(()=>document.getElementById(`rs-label`)?.focus(),100)}function hd(e,t){(g.routines||[]).forEach(n=>{if(n.linkedType===`join`&&n.linkedFrom===e&&!n.steps.some(e=>e.label===t.label)){let e=Math.max(0,...n.steps.map(e=>e.id),0)+1;n.steps.push({...t,id:e})}})}function gd(e,t){(g.routines||[]).forEach(n=>{n.linkedType===`join`&&n.linkedFrom===e&&(n.steps=n.steps.filter(e=>e.label!==t))})}function _d(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=t.ownerType===`household`,r=t.steps.map(t=>`
    <div style="display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:1px solid var(--border)">
      <span style="font-size:16px">${t.emoji}</span>
      <span style="flex:1;font-size:13px;font-weight:500">${T(t.label)}</span>
    ...
    <div class="form-group" style="display:flex;gap:12px">
      <div style="flex:1"><label class="form-label">Name</label>
        <input class="form-input" id="re-name" value="${T(t.name)}" maxlength="30"></div>
      <div><label class="form-label">Emoji</label>
  ...
  `,()=>{let e=document.getElementById(`re-name`)?.value.trim(),n=document.getElementById(`re-emoji`)?.value.trim(),r=document.getElementById(`re-time`)?.value;if(e&&(t.name=e),n&&(t.emoji=n),r&&(t.triggerTime=r),t.ownerType===`household`){let e=parseInt(document.getElementById(`re-pts`)?.value);isNaN(e)||(t.pointsPerCompletion=e)}t.recurrence=Td(),t.lastEditedBy=Su(),t.lastEditedAt=new Date().toISOString(),window.saveData(g),window.closeModal(),W()}),setTimeout(()=>{wd()},100)}function vd(e,t,n){let r=(g.routines||[]).find(t=>String(t.id)===String(e));if(!r)return;let i=r.steps.find(e=>e.id===t);r.steps=r.steps.filter(e=>e.id!==t),Object.keys(r.completions||{}).forEach(e=>{r.completions[e]=r.completions[e].filter(e=>e!==t)}),(g.routineAssignments||[]).filter(t=>t.routineId===e).forEach(e=>{Object.keys(e.completionState||{}).forEach(n=>{e.completionState[n]=e.completionState[n].filter(e=>e!==t)})}),i&&gd(r.id,i.label),window.saveData(g),n?(window.closeModal(),_d(e)):(window.closeModal(),W())}function yd(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(!n)return;let r=n.steps.find(e=>e.id===t);if(!r)return;let i=n.ownerType===`household`;window.openModal(`Edit step`,`
    <div class="form-group" style="display:flex;gap:12px">
      <div style="flex:1"><label class="form-label">Label</label>
        <input class="form-input" id="rst-label" value="${T(r.label)}" maxlength="40"></div>
      <div><label class="form-label">Emoji</label>
    ...
    <div class="form-group"><label class="form-label">Notes (optional)</label>
      <input class="form-input" id="rst-notes" value="${T(r.notes||``)}" maxlength="80">
    </div>
  `,()=>{let e=document.getElementById(`rst-label`)?.value.trim();e&&(r.label=e,r.emoji=document.getElementById(`rst-emoji`)?.value.trim()||r.emoji,r.durationMin=parseInt(document.getElementById(`rst-dur`)?.value)||0,r.notes=document.getElementById(`rst-notes`)?.value.trim()||``,i&&(r.points=parseInt(document.getElementById(`rst-pts`)?.value)||0),window.saveData(g),window.closeModal(),W())})}function bd(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=Eu();if(!n.length){window.openModal(`Assign`,`<p style="color:var(--text-muted);font-size:13px">No children in this household yet.</p>`,()=>window.closeModal());return}let r=g.routineAssignments||[],i=n.map(t=>{let n=r.some(n=>n.routineId===e&&n.childId===t.id);return`<div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid var(--border)">
      <span style="font-size:22px">${t.emoji||`👤`}</span>
      <span style="flex:1;font-size:14px;font-weight:600">${T(t.name)}</span>
    ...
    ${i}
  `,()=>window.closeModal())}function xd(e,t){g.routineAssignments||(g.routineAssignments=[]);let n=ku(e,t);n?(n.archivedCompletionState=JSON.parse(JSON.stringify(n.completionState||{})),n.archivedAt=new Date().toISOString(),g.routineAssignments=g.routineAssignments.filter(n=>!(n.routineId===e&&n.childId===t))):g.routineAssignments.push({id:window.uid(),routineId:e,childId:t,assignedBy:Su(),assignedAt:new Date().toISOString(),completionState:{},archivedCompletionState:null,childIds:[t]}),window.saveData(g),W()}function Sd(e){let t=e?.type||`daily`,n=e?.startDate||new Date().toISOString().slice(0,10),r=e?.endDate||``,i=e?.intervalDays||2,a=e?.days||[];return`
    <div class="form-group">
    ...
    <div id="rn-rec-summary" style="font-size:12px;color:var(--primary);font-weight:600;padding:8px 12px;background:var(--primary-light);border-radius:8px;margin-bottom:4px"></div>`}function Cd(){let e=document.getElementById(`rn-rec-type`)?.value;e&&(document.getElementById(`rn-rec-days`).style.display=e===`specific_days`?`flex`:`none`,document.getElementById(`rn-rec-interval`).style.display=e===`interval`?`flex`:`none`,wd())}function wd(){let e=document.getElementById(`rn-rec-summary`);if(!e)return;let t=document.getElementById(`rn-rec-type`)?.value,n={daily:`Every day`,weekdays:`Mon – Fri`,weekends:`Sat & Sun`,one_time:`Once only`};if(n[t]){e.textContent=n[t];return}if(t===`specific_days`){let t=[...document.querySelectorAll(`input[name="rn-rec-dow"]:checked`)].map(e=>[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`][e.value]);e.textContent=t.length?t.join(`, `):`No days selected`}else t===`interval`&&(e.textContent=`Every ${document.getElementById(`rn-rec-interval-days`)?.value||2} days`)}function Td(){let e=document.getElementById(`rn-rec-type`)?.value||`daily`,t=document.getElementById(`rn-rec-start`)?.value||new Date().toISOString().slice(0,10),n=document.getElementById(`rn-rec-end`)?.value||void 0,r={type:e,startDate:t};return n&&(r.endDate=n),e===`specific_days`&&(r.days=[...document.querySelectorAll(`input[name="rn-rec-dow"]:checked`)].map(e=>e.value)),e===`interval`&&(r.intervalDays=parseInt(document.getElementById(`rn-rec-interval-days`)?.value)||2),r}function Ed(e){let t=e===`child`;window.openModal(`New routine`,`
    <div class="form-group">
    ...
    ${Sd(null)}
  `,()=>{let e=document.getElementById(`rn-name`)?.value.trim();if(!e)return;let t=document.querySelector(`input[name="rn-type"]:checked`)?.value||`adult`,n=document.getElementById(`rn-emoji`)?.value.trim()||`📋`,r=document.getElementById(`rn-time`)?.value||(t===`child`?`19:30`:`08:00`),i=parseInt(document.getElementById(`rn-pts`)?.value)||0,a=Su(),o=Du(),s=Td();if(t===`adult`){let t={id:o,name:e,emoji:n,triggerTime:r,steps:[],completions:{},assignedTo:[],ownerType:`adult`,ownerId:a,sharedWith:[],linkedFrom:null,linkedType:null,pointsPerCompletion:0,recurrence:s,skippedDates:[],pausePeriods:[]};Lu(t),g.routines.push(t),Ru(`create:adult`),window.closeModal(),Vu=`mine`}else{let t={id:o,name:e,emoji:n,triggerTime:r,steps:[],completions:{},assignedTo:[],ownerType:`household`,ownerId:`household`,sharedWith:[],linkedFrom:null,linkedType:null,pointsPerCompletion:i,createdBy:a,lastEditedBy:a,lastEditedAt:new Date().toISOString(),recurrence:s,skippedDates:[],pausePeriods:[]};Lu(t),g.routines.push(t),Ru(`create:child`),window.closeModal(),Vu=`children`}W()}),setTimeout(()=>{document.getElementById(`rn-name`)?.focus(),wd()},100)}function Dd(e){document.querySelectorAll(`input[name="rn-type"]`).forEach(t=>t.checked=t.value===e),document.getElementById(`rn-type-adult`)?.classList.toggle(`selected`,e===`adult`),document.getElementById(`rn-type-child`)?.classList.toggle(`selected`,e===`child`);let t=document.getElementById(`rn-time`);t&&(t.value=e===`child`?`19:30`:`08:00`);let n=document.getElementById(`rn-pts-group`);n&&(n.style.display=e===`child`?`block`:`none`)}function Od(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));t&&confirm(`Delete "${t.name}"? This cannot be undone.`)&&(g.routines=g.routines.filter(t=>t.id!==e),g.routineAssignments=(g.routineAssignments||[]).filter(t=>t.routineId!==e),window.saveData(g),W())}function kd(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));t&&confirm(`Leave "${t.name}"? Your completion history will be removed.`)&&(g.routines=g.routines.filter(t=>t.id!==e),window.saveData(g),W())}function Ad(e,t){if(!confirm(`Unassign this child? Their completion history will be archived.`))return;let n=ku(e,t);n&&(n.archivedCompletionState=JSON.parse(JSON.stringify(n.completionState||{})),n.archivedAt=new Date().toISOString()),g.routineAssignments=(g.routineAssignments||[]).filter(n=>!(n.routineId===e&&n.childId===t)),(g.routineAssignments||[]).some(t=>t.routineId===e)||(g.routines=g.routines.filter(t=>t.id!==e)),window.saveData(g),W()}function jd(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=Ou();if(!n.length){window.openModal(`Share routine`,`<p style="color:var(--text-muted);font-size:13px">No other adults have joined yet. Invite them via Settings → Household first.</p>`,()=>window.closeModal());return}let r=t.sharedWith||[],i=n.map(t=>{let n=r.includes(t.uid);return`<div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid var(--border)">
      <span style="flex:1;font-size:14px;font-weight:500">${T(t.name||t.email||t.uid)}</span>
      <button class="btn btn-sm ${n?`btn-danger-ghost`:`btn-primary`}"
    ...
    ${i}
  `,()=>window.closeModal())}function Md(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(!n)return;n.sharedWith||(n.sharedWith=[]);let r=n.sharedWith.indexOf(t);r===-1?n.sharedWith.push(t):n.sharedWith.splice(r,1),window.saveData(g),window.closeModal(),jd(e)}function Nd(e){let t=(g.routines||[]).find(t=>t.id===e);if(!t)return;Su();let n={...JSON.parse(JSON.stringify(t)),id:Du(),ownerId:window.uid,ownerType:`adult`,sharedWith:[],completions:{},linkedFrom:e,linkedType:`duplicate`};g.routines.push(n),window.saveData(g),window.closeModal(),W()}function Pd(e){let t=(g.routines||[]).find(t=>t.id===e);if(!t)return;if(Su(),(g.routines||[]).some(t=>t.linkedFrom===e&&t.linkedType===`join`&&t.ownerId===window.uid)){alert(`You have already joined this routine.`);return}let n={...JSON.parse(JSON.stringify(t)),id:Du(),ownerId:window.uid,ownerType:`adult`,sharedWith:[],completions:{},linkedFrom:e,linkedType:`join`};g.routines.push(n),window.saveData(g),window.closeModal(),W()}function Fd(e){let t=(g.routines||[]).find(t=>t.id===e);t?.linkedFrom&&Nd(t.linkedFrom)}function Id(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(!n)return;let r=n.steps.length,i,a,o;if(t){let s=ku(e,t),c=Eu().find(e=>e.id===t);i=Mu(s,r,90),a=ju(s,r),o=`${n.emoji} ${n.name} — ${c?.name||`Child`}`}else i=Fu(n,90),a=Pu(n),o=`${n.emoji} ${n.name} — History`;let s=i.filter(e=>e.done===e.total&&e.total>0).length,c=i.filter(e=>e.done>0&&e.done<e.total).length,l=i.map(e=>{let t=e.done===e.total&&e.total>0?`full`:e.done>0?`partial`:`empty`,n=e.done===e.total&&e.total>0?`✓`:e.done>0?`${e.done}`:``;return`<div class="routine-history-dot ${t}" title="${e.key}: ${e.done}/${e.total}">${n}</div>`}).join(``);window.openModal(o,`
  ...
  `,()=>window.closeModal())}var Ld=`parent`,Rd=`overview`;Object.defineProperty(window,`kidsView`,{get(){return Ld},set(e){Ld=e},configurable:!0}),Object.defineProperty(window,`kidsParentTab`,{get(){return Rd},set(e){Rd=e},configurable:!0});function zd(){return Date.now().toString(36)+Math.random().toString(36).slice(2)}function G(){let e=document.getElementById(`kids-content`);if(!e)return;let t=g.kids;if(Ld===`parent`)Vd(e,t,t.completions.filter(e=>e.status===`pending`).length+t.redemptions.filter(e=>e.status===`pending`).length);else{let n=t.profiles.find(e=>e.id===Ld);n?Kd(e,t,n):(Ld=`parent`,G())}}function Bd(e,t){return e.completions.filter(e=>e.kidId===t&&e.status===`approved`).reduce((t,n)=>t+(e.chores.find(e=>e.id===n.choreId)?.points||0),0)-e.redemptions.filter(e=>e.kidId===t&&e.status===`approved`).reduce((t,n)=>t+(e.prizes.find(e=>e.id===n.prizeId)?.pointCost||0),0)}function Vd(e,t,n){let r=`
    <div style="display:flex;justify-content:flex-end;margin-bottom:16px">
    ...
    </div>`;let t=`<div class="kids-grid">`;return e.profiles.forEach(n=>{let r=Bd(e,n.id),i=e.chores.filter(e=>e.assignedTo===n.id||e.assignedTo===`all`).length,a=e.completions.filter(e=>e.kidId===n.id&&e.status===`pending`).length;t+=`
      <div class="kid-card" style="cursor:default">
        <button onclick="openEditKidModal('${n.id}')" style="position:absolute;top:10px;right:10px;background:none;border:none;cursor:pointer;color:#cbd5e1;font-size:14px;padding:2px 5px;border-radius:var(--r-sm)" title="Edit">✏️</button>
        <div onclick="kidsView='${n.id}';renderKids()" style="cursor:pointer">
          <div class="kid-avatar">${n.emoji}</div>
          <div class="kid-name">${T(n.name)}</div>
          ...
          <div style="display:flex;gap:10px;font-size:12px;color:var(--text-muted);margin-top:4px">
            <span>📋 ${i}</span>
            ${a?`<span style="color:var(--watch);font-weight:600">⏳ ${a}</span>`:``}
            ${n.savings?`<span style="color:#0891b2">💰 $${n.savings.toFixed(0)}</span>`:``}
          </div>
        </div>
        <button onclick="window.switchToKidMode('${n.id}')" style="width:100%;margin-top:10px;padding:8px;background:#ecfeff;border:1.5px solid #0891b2;border-radius:var(--r-sm);font-size:12px;color:#0891b2;font-weight:600;cursor:pointer">
          Switch to ${T(n.name)}'s view →
        </button>
        <button onclick="viewChildToday('${n.id}')" style="width:100%;margin-top:6px;padding:7px;background:#f5f3ff;border:1px solid #ddd6fe;border-radius:var(--r-sm);font-size:12px;color:#5B4CF5;font-weight:600;cursor:pointer">
          👁 View ${T(n.name)}'s Today
        </button>
        <button onclick="_cvViewCalendar('${n.id}')" style="width:100%;margin-top:6px;padding:7px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:var(--r-sm);font-size:12px;color:#15803d;font-weight:600;cursor:pointer">
          📅 View ${T(n.name)}'s Calendar
        </button>
        <button onclick="window.openPinSetup('${n.id}')" style="width:100%;margin-top:6px;padding:7px;background:${n.pinHash?`var(--good-light)`:`var(--watch-light)`};border:1px solid ${n.pinHash?`var(--good-soft)`:`var(--watch-soft)`};border-radius:var(--r-sm);font-size:12px;color:${n.pinHash?`var(--good)`:`var(--watch)`};font-weight:600;cursor:pointer">
          ${n.pinHash?`🔒 PIN set — change`:`🔓 Set PIN for login`}
        </button>
      </div>`}),t+=`</div>`,t}function Ud(e){let t=`<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
    ...
    <button class="btn btn-primary btn-sm" onclick="openChoreModal()">+ Add Chore</button>
      ...
      <div style="background:#fff;border:2px dashed #cbd5e1;border-radius:16px;padding:36px 24px;text-align:center;margin-top:8px">
        ...
        <div style="font-size:16px;font-weight:700;color:#1e293b;margin-bottom:6px">${T(r)} has no chores yet</div>
        <div style="font-size:13px;color:#64748b;margin-bottom:18px">Add chores to help ${T(r)} earn coins and unlock prizes.</div>
        <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap;margin-bottom:20px">
          ${a}
      ...
      <div style="flex:1"><div class="chore-name">${T(n.name)}</div><div class="chore-meta">${T(r)} · ${n.frequency}</div></div>
    ...
    </div>`}),t}function Wd(e){let t=`<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
    ...
    <button class="btn btn-primary btn-sm" onclick="openPrizeModal()">+ Add Prize</button>
      ...
      <div style="flex:1"><div class="prize-name">${T(e.name)}</div><div class="prize-desc">${T(e.description||e.type)}</div></div>
      ...
      <button onclick="deletePrize('${e.id}')" class="btn btn-ghost btn-sm" style="color:#ef4444">🗑</button>
        ...
        <div style="flex:1"><div class="prize-name">${T(i.name)}</div><div class="prize-desc">${n.emoji} ${T(n.name)} wants this</div></div>
      ...
      </div>`)})),r}function Kd(e,t,n){let r=Bd(t,n.id),i=t.chores.filter(e=>e.assignedTo===n.id||e.assignedTo===`all`),a=new Set(t.completions.filter(e=>e.kidId===n.id&&e.status===`pending`).map(e=>e.choreId)),o=new Date().toDateString(),s=new Set(t.completions.filter(e=>e.kidId===n.id&&e.status===`approved`&&new Date(e.completedAt).toDateString()===o).map(e=>e.choreId)),c=`
    ...
    <div style="background:linear-gradient(135deg,#0891b2,#0e7490);border-radius:16px;padding:24px 28px;color:#fff;margin-bottom:24px;display:flex;align-items:center;gap:20px">
      ...
      <div style="flex:1">
        ...
        <div style="font-size:24px;font-weight:800">${T(n.name)}!</div>
      </div>
      <div style="text-align:right">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
      <div>
        ...
        <div style="flex:1"><div class="chore-name">${T(e.name)}</div><div class="chore-meta">${t?`⏳ Waiting...`:r?`✅ Done!`:e.frequency}</div></div>
        <div style="display:flex;flex-direction:column;align-items:flex-end;gap:4px">
    ...
    <div style="font-size:15px;font-weight:700;margin-bottom:12px">Prize Shelf 🎁</div>`,t.prizes.length?t.prizes.forEach(e=>{let i=r>=e.pointCost,a=t.redemptions.some(t=>t.prizeId===e.id&&t.kidId===n.id&&t.status===`pending`);c+=`<div class="prize-card ${i&&!a?`can-afford`:``} ${a?`pending-redemption`:``}">
        <div class="prize-icon">${e.emoji}</div>
        <div style="flex:1"><div class="prize-name">${T(e.name)}</div><div class="prize-desc">${a?`⏳ Pending...`:i?`✅ You can get this!`:`${e.pointCost-r} pts to go`}</div></div>
        <div style="display:flex;flex-direction:column;align-items:flex-end;gap:4px">
          <div class="prize-cost">⭐ ${e.pointCost}</div>
      ...
      </div>`}):c+=`<div style="color:#64748b;font-size:13px;padding:20px;text-align:center;background:#f8fafc;border-radius:10px">No prizes on the shelf yet!</div>`,c+=`</div></div>`,e.innerHTML=c}function qd(){let e=g.childEvents||[],t=g.kids?.profiles||[],n=`<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
    ...
    </div>`}var Jd=[`📅`,`⚽`,`🏊`,`🎓`,`🎂`,`🎨`,`🏃`,`🎭`,`🚌`,`🎡`,`🏖`,`🎪`];function Yd(e){let t=e?(g.childEvents||[]).find(t=>t.id===e):null,n=g.kids?.profiles||[];window.openModal(t?`Edit Event`:`Add Event`,`
    ${e?`<input type="hidden" id="ce-id" value="${e}">`:``}
    <div class="form-group" style="display:flex;gap:12px">
      <div style="flex:1"><label class="form-label">Title</label>
        <input class="form-input" id="ce-title" value="${E(t?.title||``)}" placeholder="e.g. Swimming lesson" autofocus maxlength="50"></div>
      <div><label class="form-label">Emoji</label>
    ...
    <div class="form-group"><label class="form-label">Assign to</label>
      <select class="form-input" id="ce-who" style="max-width:240px">
        ...
        ${n.map(e=>`<option value="${e.id}" ${Array.isArray(t?.assignedTo)&&t.assignedTo.includes(e.id)?`selected`:``}>${e.emoji||``} ${T(e.name)}</option>`).join(``)}
      </select>
    </div>
    ${_routineRecurrenceFormHtml(t?.recurrence||null)}
    <div class="form-group"><label class="form-label">Notes (optional)</label>
      <input class="form-input" id="ce-notes" value="${E(t?.notes||``)}" placeholder="e.g. Bring water bottle" maxlength="200"></div>
  `,()=>{let e=document.getElementById(`ce-title`)?.value.trim();if(!e)return;let t=document.getElementById(`ce-emoji`)?.value.trim()||`📅`,n=document.getElementById(`ce-date`)?.value,r=document.getElementById(`ce-time`)?.value||void 0,i=document.getElementById(`ce-who`)?.value,a=document.getElementById(`ce-notes`)?.value.trim()||``,o=_routineRecurrenceCollect(),s=document.getElementById(`ce-id`)?.value;if(g.childEvents||(g.childEvents=[]),s){let c=g.childEvents.find(e=>e.id===s);c&&Object.assign(c,{title:e,emoji:t,date:n,time:r,notes:a,recurrence:o,isHouseholdWide:i===`all`,assignedTo:i===`all`?`all`:[i]})}else g.childEvents.push({id:zd(),title:e,emoji:t,date:n,time:r,notes:a,recurrence:o,assignedTo:i===`all`?`all`:[i],isHouseholdWide:i===`all`,createdBy:_routineCurrentUserId()});window.saveData(g),window.closeModal(),G()}),setTimeout(()=>{_routineRecurrenceSummaryUpdate()},100)}function Xd(e){confirm(`Delete this event?`)&&(g.childEvents=(g.childEvents||[]).filter(t=>t.id!==e),window.saveData(g),G())}function Zd(e,t){g.kids.completions.push({id:zd(),choreId:e,kidId:t,completedAt:Date.now(),status:`pending`}),window.saveData(g),G()}function Qd(e){let t=g.kids.completions.find(t=>t.id===e);t&&(t.status=`approved`,t.approvedAt=Date.now()),window.saveData(g),G()}function $d(e){let t=g.kids.completions.find(t=>t.id===e);t&&(t.status=`rejected`),window.saveData(g),G()}function ef(e,t){g.kids.redemptions.push({id:zd(),prizeId:e,kidId:t,requestedAt:Date.now(),status:`pending`}),window.saveData(g),G()}function tf(e){let t=g.kids.redemptions.find(t=>t.id===e);if(t){t.status=`approved`,t.approvedAt=Date.now();let e=(g.kids.prizes||[]).find(e=>e.id===t.prizeId);g.kids.notifications||(g.kids.notifications=[]),g.kids.notifications.push({id:zd(),kidId:t.kidId,type:`prize_approved`,prizeId:t.prizeId,prizeName:e?.name||`Prize`,prizeEmoji:e?.emoji||`🎁`,ts:Date.now(),read:!1})}window.saveData(g),G()}function nf(e){let t=g.kids.redemptions.find(t=>t.id===e);if(t){t.status=`rejected`;let e=(g.kids.prizes||[]).find(e=>e.id===t.prizeId);g.kids.notifications||(g.kids.notifications=[]),g.kids.notifications.push({id:zd(),kidId:t.kidId,type:`prize_declined`,prizeId:t.prizeId,prizeName:e?.name||`Prize`,prizeEmoji:e?.emoji||`🎁`,ts:Date.now(),read:!1})}window.saveData(g),G()}function rf(e){g.kids.chores=g.kids.chores.filter(t=>t.id!==e),window.saveData(g),G()}function af(e){g.kids.prizes=g.kids.prizes.filter(t=>t.id!==e),window.saveData(g),G()}var of=[`😊`,`🦁`,`🐯`,`🐻`,`🦊`,`🐸`,`🐧`,`🦋`,`🌟`,`🎈`,`🚀`,`⚡`],sf=[`🧹`,`🍽`,`🐕`,`🛏`,`📚`,`🌿`,`🧺`,`🗑`,`🧽`,`🚿`,`🛒`,`🪴`],cf=[`🍦`,`🎬`,`🎮`,`🍕`,`🎁`,`💰`,`🏖`,`🎡`,`🎨`,`👟`,`📱`,`🎭`];function lf(e,t){return`<div style="display:flex;flex-wrap:wrap;gap:6px" id="emoji-pick">
  ...
  </div>`}function uf(e){e.closest(`#emoji-pick`).querySelectorAll(`button`).forEach(e=>{e.style.borderColor=`var(--border)`,e.style.background=`none`}),e.style.borderColor=`#0891b2`,e.style.background=`#ecfeff`}function df(e){let t=document.querySelector(`#emoji-pick button[style*="#0891b2"]`);return t?t.dataset.e:e}function ff(){pf(null)}function pf(e){let t=e?g.kids.profiles.find(t=>String(t.id)===String(e)):null;document.getElementById(`modal-title`).textContent=t?`Edit Kid`:`Add Kid`,document.getElementById(`modal-body`).innerHTML=`
    ${e?`<input type="hidden" id="k-id" value="${e}">`:``}
    <div class="form-group"><label class="form-label">Name</label><input class="form-input" id="k-name" value="${E(t?.name||``)}" placeholder="e.g. Emma" autofocus></div>
    <div class="form-group"><label class="form-label">Avatar</label>${lf(of,t?.emoji||`😊`)}</div>
    <div class="form-group">
      <label class="form-label">Age</label>
      <input class="form-input" id="k-age" type="number" min="1" max="18" value="${E(String(t?.age||``))}" placeholder="e.g. 8">
      <div style="font-size:11px;color:var(--text-muted);margin-top:5px;line-height:1.5">
        Age determines how ${T(t?.name||`your child`)} sees their Today screen —
        larger tap targets and emoji-only for younger kids, a cleaner layout for tweens.
        You can update this any time.
      </div>
    </div>
    ${e?`<div style="margin-top:8px"><button class="btn btn-danger btn-sm" onclick="deleteKid('${e}')">Delete ${T(t.name)}</button></div>`:``}
  `,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Cancel</button><button class="btn btn-primary" onclick="saveKid()">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function mf(){let e=document.getElementById(`k-name`).value.trim();if(!e)return;let t=parseInt(document.getElementById(`k-age`).value)||null,n=df(`😊`),r=document.getElementById(`k-id`)?.value;if(r){let i=g.kids.profiles.find(e=>String(e.id)===String(r));i&&Object.assign(i,{name:e,emoji:n,age:t})}else g.kids.profiles.push({id:zd(),name:e,emoji:n,age:t,savings:0});window.saveData(g),window.closeModal(),G()}function hf(e){let t=g.kids.profiles.find(t=>String(t.id)===String(e));t&&confirm(`Remove ${t.name} from this household?\n\nThis will permanently delete their chores, prizes and points history. This cannot be undone.`)&&(g.kids.profiles=g.kids.profiles.filter(t=>t.id!==e),g.kids.chores=g.kids.chores.filter(t=>t.assignedTo!==e),g.kids.completions=g.kids.completions.filter(t=>t.kidId!==e),g.kids.redemptions=g.kids.redemptions.filter(t=>t.kidId!==e),g.meals?.lunchbox?.profiles&&(g.meals.lunchbox.profiles=g.meals.lunchbox.profiles.filter(t=>t.id!==e)),g.childEvents&&(g.childEvents=g.childEvents.filter(t=>{if(t.isHouseholdWide)return!0;let n=(Array.isArray(t.assignedTo)?t.assignedTo:[t.assignedTo]).filter(t=>t!==e);return n.length?(t.assignedTo=n,!0):!1})),window.getDeviceProfile()===e&&window.setDeviceProfile(`adult`),window.saveData(g),window.closeModal(),Ld=`parent`,G())}function gf(e){let t=e?g.kids.chores.find(t=>t.id===e):null,n=g.kids.profiles;document.getElementById(`modal-title`).textContent=t?`Edit Chore`:`Add Chore`,document.getElementById(`modal-body`).innerHTML=`
    ${e?`<input type="hidden" id="c-id" value="${e}">`:``}
    <div class="form-group"><label class="form-label">Chore Name</label><input class="form-input" id="c-name" value="${E(t?.name||``)}" placeholder="e.g. Tidy bedroom" autofocus></div>
    <div class="form-group"><label class="form-label">Emoji</label>${lf(sf,t?.emoji||`🧹`)}</div>
    <div class="form-row">
    ...
    <div class="form-group"><label class="form-label">Assign to</label><select class="form-select" id="c-who"><option value="all">All kids</option>${n.map(e=>`<option value="${e.id}" ${t?.assignedTo===e.id?`selected`:``}>${e.emoji} ${T(e.name)}</option>`).join(``)}</select></div>
  `,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Cancel</button><button class="btn btn-primary" onclick="saveChore()">Save Chore</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function _f(){let e=document.getElementById(`c-name`).value.trim();if(!e)return;let t=parseInt(document.getElementById(`c-pts`).value)||10,n=document.getElementById(`c-freq`).value,r=document.getElementById(`c-who`).value,i=df(`🧹`),a=document.getElementById(`c-id`)?.value;if(a){let o=g.kids.chores.find(e=>e.id===a);o&&Object.assign(o,{name:e,emoji:i,points:t,frequency:n,assignedTo:r})}else g.kids.chores.push({id:zd(),name:e,emoji:i,points:t,frequency:n,assignedTo:r});window.saveData(g),window.closeModal(),G()}function vf(e){let t=e?g.kids.prizes.find(t=>String(t.id)===String(e)):null;document.getElementById(`modal-title`).textContent=t?`Edit Prize`:`Add Prize`,document.getElementById(`modal-body`).innerHTML=`
    ${e?`<input type="hidden" id="p-id" value="${e}">`:``}
    <div class="form-group"><label class="form-label">Prize Name</label><input class="form-input" id="p-name" value="${E(t?.name||``)}" placeholder="e.g. Movie night" autofocus></div>
    <div class="form-group"><label class="form-label">Emoji</label>${lf(cf,t?.emoji||`🎁`)}</div>
    <div class="form-row">
    ...
    <div class="form-group"><label class="form-label">Description (optional)</label><input class="form-input" id="p-desc" value="${E(t?.description||``)}" placeholder="e.g. Any movie of your choice"></div>
  `,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Cancel</button><button class="btn btn-primary" onclick="savePrize()">Save Prize</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function yf(){let e=document.getElementById(`p-name`).value.trim();if(!e)return;let t=parseInt(document.getElementById(`p-cost`).value)||50,n=document.getElementById(`p-type`).value,r=document.getElementById(`p-desc`).value.trim(),i=df(`🎁`),a=document.getElementById(`p-id`)?.value;if(a){let o=g.kids.prizes.find(e=>e.id===a);o&&Object.assign(o,{name:e,emoji:i,pointCost:t,type:n,description:r})}else g.kids.prizes.push({id:zd(),name:e,emoji:i,pointCost:t,type:n,description:r});window.saveData(g),window.closeModal(),G()}function bf(e){let t=g.kids.profiles.find(t=>t.id===e);t&&(document.getElementById(`modal-title`).textContent=`${t.emoji} ${t.name}'s Savings Jar`,document.getElementById(`modal-body`).innerHTML=`
  ...
  `,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Cancel</button><button class="btn btn-primary" onclick="addSavings('${e}')">Add to Jar 💰</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`))}function xf(e){let t=parseFloat(document.getElementById(`s-amount`).value)||0;if(!t)return;let n=g.kids.profiles.find(t=>t.id===e);n&&(n.savings=(n.savings||0)+t),window.saveData(g),window.closeModal(),G()}var Sf=null,Cf={};function wf(){return Sf?Promise.resolve(Sf):new Promise((e,t)=>{let n=indexedDB.open(`home_finance_receipts`,1);n.onupgradeneeded=e=>{let t=e.target.result;t.objectStoreNames.contains(`receipts`)||t.createObjectStore(`receipts`,{keyPath:`id`,autoIncrement:!0}).createIndex(`itemKey`,`itemKey`,{unique:!1})},n.onsuccess=t=>{Sf=t.target.result,e(Sf)},n.onerror=()=>t(n.error)})}async function Tf(){let e=await wf();return new Promise(t=>{let n=e.transaction(`receipts`,`readonly`).objectStore(`receipts`).getAll();n.onsuccess=()=>{Cf={},n.result.forEach(e=>{Cf[e.itemKey]=(Cf[e.itemKey]||0)+1}),t()}})}async function Ef(e){let t=await wf();return new Promise(n=>{let r=t.transaction(`receipts`,`readonly`).objectStore(`receipts`).index(`itemKey`).getAll(e);r.onsuccess=()=>n(r.result)})}async function Df(e,t){let n=await wf();return new Promise((r,i)=>{let a=n.transaction(`receipts`,`readwrite`).objectStore(`receipts`).add({itemKey:e,fileName:t.name,fileType:t.type,fileSize:t.size,data:t,uploadedAt:new Date().toISOString()});a.onsuccess=()=>r(),a.onerror=()=>i(a.error)})}async function Of(e){let t=await wf();return new Promise(n=>{let r=t.transaction(`receipts`,`readwrite`);r.objectStore(`receipts`).delete(e),r.oncomplete=n})}function kf(e){return e===`own-funds`?`<span class="badge" style="background:#ecfeff;color:#166534;border:1px solid #bbf7d0">Own Funds</span>`:`<span class="badge" style="background:#eff6ff;color:#1e40af;border:1px solid #bfdbfe">Loan</span>`}function Af(e,t){let n=Cf[e]||0;return`<button class="attach-btn${n?` has-files`:``}" onclick="openReceiptsModal('${e}','${t.replace(/'/g,`\\'`)}')" title="${n?n+` receipt(s)`:`Add receipt`}">📎${n?` ${n}`:``}</button>`}function jf(e){return e>1048576?`${(e/1048576).toFixed(1)} MB`:`${Math.round(e/1024)} KB`}function Mf(e){return e===`application/pdf`?`📄`:e.startsWith(`image/`)?`🖼️`:`📎`}async function Nf(e,t){window.openModal(`Receipts — ${t}`,`<div style="padding:20px;text-align:center;color:var(--text-muted)">Loading…</div>`,()=>{}),document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Close</button>`,await Pf(e,t)}async function Pf(e,t){let n=e,r=t.replace(/'/g,`\\'`),i=await Ef(e),a=``;i.length?i.forEach(e=>{let t=e.type===`link`,i=t?`🔗`:Mf(e.fileType),o=t?e.linkName||e.url:e.fileName,s=t?`<span style="color:var(--text-muted);font-size:11px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:block;max-width:260px">${e.url}</span>`:`<span>${jf(e.fileSize)} · ${new Date(e.uploadedAt).toLocaleDateString(`en-AU`)}</span>`,c=t?`<button class="btn btn-ghost btn-sm" onclick="window.open('${e.url.replace(/'/g,`\\'`).replace(/"/g,`&quot;`)}','_blank')">Open</button>`:`<button class="btn btn-ghost btn-sm" onclick="viewReceipt('${e.id}')">View</button>`;a+=`
    ...
    <div class="drop-zone" id="drop-zone" onclick="document.getElementById('receipt-file-input').click()">
    ...
    </div>`,document.getElementById(`modal-body`).innerHTML=a;let o=document.getElementById(`drop-zone`);o.addEventListener(`dragover`,e=>{e.preventDefault(),o.classList.add(`drag-over`)}),o.addEventListener(`dragleave`,()=>o.classList.remove(`drag-over`)),o.addEventListener(`drop`,async n=>{n.preventDefault(),o.classList.remove(`drag-over`),await Lf(e,t,Array.from(n.dataTransfer.files))})}async function Ff(e,t){let n=document.getElementById(`link-url`).value.trim();if(!n){document.getElementById(`link-url`).focus();return}let r=document.getElementById(`link-name`).value.trim(),i=await wf();await new Promise((t,a)=>{let o=i.transaction(`receipts`,`readwrite`).objectStore(`receipts`).add({itemKey:e,type:`link`,url:n,linkName:r,uploadedAt:new Date().toISOString()});o.onsuccess=t,o.onerror=()=>a(o.error)}),await Tf(),renderBuild(),await Pf(e,t)}async function If(e,t){let n=document.getElementById(`receipt-file-input`);await Lf(e,t,Array.from(n.files))}async function Lf(e,t,n){for(let t of n)await Df(e,t);await Tf(),renderBuild(),await Pf(e,t)}async function Rf(e){let t=await wf(),n=await new Promise(n=>{let r=t.transaction(`receipts`,`readonly`).objectStore(`receipts`).get(e);r.onsuccess=()=>n(r.result)});if(n.type===`link`){window.open(n.url,`_blank`);return}let r=URL.createObjectURL(n.data);window.open(r,`_blank`),setTimeout(()=>URL.revokeObjectURL(r),15e3)}async function zf(e,t,n){confirm(`Delete this receipt?`)&&(await Of(e),await Tf(),renderBuild(),await Pf(t,n))}var Bf=null;window.addEventListener(`beforeinstallprompt`,e=>{e.preventDefault(),Bf=e;let t=document.getElementById(`install-btn`);t&&(t.style.display=`flex`)}),window.addEventListener(`appinstalled`,()=>{Bf=null;let e=document.getElementById(`install-btn`);e&&(e.style.display=`none`)});function Vf(){Bf&&(Bf.prompt(),Bf.userChoice.then(()=>{Bf=null}))}var Hf={building:[{name:`Mortgage / Rent`,category:`Mortgage / Rent`,amount:3e3},{name:`Groceries`,category:`Groceries`,amount:1200},{name:`Utilities`,category:`Utilities`,amount:400},{name:`Transport`,category:`Transport`,amount:500},{name:`Insurance`,category:`Insurance`,amount:350},{name:`Entertainment`,category:`Entertainment`,amount:200}],mortgage:[{name:`Mortgage`,category:`Mortgage / Rent`,amount:3500},{name:`Groceries`,category:`Groceries`,amount:1200},{name:`Utilities`,category:`Utilities`,amount:400},{name:`Transport`,category:`Transport`,amount:500},{name:`Insurance`,category:`Insurance`,amount:350},{name:`Entertainment`,category:`Entertainment`,amount:200}],renting:[{name:`Rent`,category:`Mortgage / Rent`,amount:2500},{name:`Groceries`,category:`Groceries`,amount:1200},{name:`Utilities`,category:`Utilities`,amount:300},{name:`Transport`,category:`Transport`,amount:500},{name:`Insurance`,category:`Insurance`,amount:250},{name:`Entertainment`,category:`Entertainment`,amount:200}],own:[{name:`Groceries`,category:`Groceries`,amount:1200},{name:`Utilities`,category:`Utilities`,amount:400},{name:`Transport`,category:`Transport`,amount:500},{name:`Insurance`,category:`Insurance`,amount:400},{name:`Health`,category:`Health`,amount:300},{name:`Entertainment`,category:`Entertainment`,amount:300}]},K={step:1,adults:2,adultNames:[``,``],adultAges:[``,``],kids:0,kidProfiles:[],homeType:`mortgage`,incomes:[{name:``,amount:``,frequency:`Monthly`}],expenses:[],_emojiPickerOpen:null};function Uf(){return K.kids>0?[1,2,3,4,5,6]:[1,2,4,5,6]}function Wf(){return Uf().indexOf(K.step)}function Gf(){K={step:1,adults:2,adultNames:[``,``],adultAges:[``,``],kids:0,kidProfiles:[],homeType:`mortgage`,incomes:[{name:``,amount:``,frequency:`Monthly`}],expenses:[],_emojiPickerOpen:null},document.getElementById(`onboarding-overlay`).style.display=`flex`,Qf()}function Kf(){document.getElementById(`onboarding-overlay`).style.display=`none`}function qf(e){for(K.adults=e;K.adultNames.length<e;)K.adultNames.push(``);for(K.adultNames=K.adultNames.slice(0,e);K.adultAges.length<e;)K.adultAges.push(``);K.adultAges=K.adultAges.slice(0,e),Qf()}function Jf(e){K.kids=e,K.kidProfiles.length>e&&(K.kidProfiles=K.kidProfiles.slice(0,e)),Qf()}function Yf(e){K._emojiPickerOpen=K._emojiPickerOpen===e?null:e,Qf()}function Xf(e,t){K.kidProfiles[e].emoji=t,K._emojiPickerOpen=null,Qf()}function Zf(e){K.expenses[e].skipped=!K.expenses[e].skipped,Qf()}function Qf(){let e=document.getElementById(`onboarding-card`),t=Uf(),n=Wf(),r=K.step,i=t.map((e,t)=>`<div class="ob-dot ${t<n?`done`:t===n?`active`:``}"></div>`).join(``),a=``,o=``,s=``;if(r===1)a=`
      ...
      <div class="ob-subtitle">Tell us who's home so we can tailor Toto for you.</div>`;let e=[1,2,3].map(e=>`<button class="ob-option ${K.adults===e?`selected`:``}" onclick="obSetAdults(${e})">${e} adult${e>1?`s`:``}</button>`).join(``),t=K.adultNames.map((e,t)=>`
      <div style="display:grid;grid-template-columns:1fr 90px;gap:8px;margin-bottom:10px">
        <div>
          ...
          <input class="ob-input" placeholder="${t===0?`e.g. Chris`:`e.g. Sam`}" value="${E(e)}"
            oninput="_ob.adultNames[${t}]=this.value"
            style="${K._nameError&&!e.trim()?`border-color:#ef4444`:``}" required>
          ${K._nameError&&!e.trim()?`<div style="font-size:11px;color:#ef4444;margin-top:3px">Please enter a name</div>`:``}
        </div>
        <div>
          <div class="ob-input-label">Age (optional)</div>
          <input class="ob-input" type="number" min="18" max="99" placeholder="Age" value="${E(String(K.adultAges[t]||``))}"
            oninput="_ob.adultAges[${t}]=this.value">
        </div>
      </div>`).join(``),n=[0,1,2,3,`4+`].map(e=>{let t=e===`4+`?4:e;return`<button class="ob-option ${K.kids===t?`selected`:``}" onclick="obSetKids(${t})">${e===0?`No kids`:e+(e===1?` kid`:` kids`)}</button>`}).join(``);o=`
      ...
      <div class="ob-options">${[{val:`renting`,label:`🏢 Renting`},{val:`mortgage`,label:`🏠 Mortgage`},{val:`building`,label:`🏗️ Building`},{val:`own`,label:`✅ Own outright`}].map(e=>`<button class="ob-option ${K.homeType===e.val?`selected`:``}" onclick="_ob.homeType='${e.val}';renderObStep()">${e.label}</button>`).join(``)}</div>
      ...
      <button class="ob-next" onclick="obNext()">Continue →</button>`}else if(r===3)K.kidProfiles.length<K.kids&&(K.kidProfiles=Array.from({length:K.kids},(e,t)=>K.kidProfiles[t]||{name:``,age:``,emoji:KID_EMOJIS[t%KID_EMOJIS.length]})),a=`
      <div class="ob-step-dots">${i}</div>
      <div class="ob-title">Your kids 👶</div>
      <div class="ob-subtitle">We'll set up chores and lunchbox for each of them.</div>`,o=K.kidProfiles.map((e,t)=>{let n=K._emojiPickerOpen===t?`
        ...
        <div style="margin-bottom:20px">
          ...
          <div class="ob-kid-row">
            <button class="ob-emoji-btn" onclick="obToggleEmojiPicker(${t})" title="Pick emoji">${T(e.emoji)}</button>
            <div>
              <div class="ob-input-label">Name</div>
              <input class="ob-input" placeholder="Name" value="${E(e.name)}"
                oninput="_ob.kidProfiles[${t}].name=this.value">
            </div>
            <div>
              <div class="ob-input-label">Age</div>
              <input class="ob-input" type="number" min="0" max="17" placeholder="Age" value="${E(String(e.age))}"
      ...
      ${K.incomes.map((t,n)=>{let r=K.adultNames[n]?`${K.adultNames[n]}'s salary`:n===0?`e.g. Salary`:`e.g. Partner salary`,i=e.map(e=>`<button class="ob-option ${t.frequency===e?`selected`:``}" style="padding:6px 14px;font-size:12px"
        ...
        <div style="margin-bottom:16px;padding-bottom:16px;border-bottom:1px solid var(--hairline)">
          <div style="margin-bottom:10px">
            ...
            <input class="ob-input" placeholder="${E(r)}" value="${E(t.name)}"
      ...
      ${K.incomes.length<4?`<button class="ob-add-link" onclick="_ob.incomes.push({name:'',amount:'',frequency:'Monthly'});renderObStep()">+ Add another income source</button>`:``}`,s=`
      <button class="ob-back" onclick="obBack()">← Back</button>
      <button class="ob-next" onclick="obNext()">Continue →</button>`}else if(r===5)K.expenses.length||(K.expenses=Hf[K.homeType].map(e=>({...e,skipped:!1})),K.kids>0&&K.expenses.push({name:`Kids activities / sport`,category:`Childcare / Education`,amount:300,skipped:!1})),a=`
      <div class="ob-step-dots">${i}</div>
      ...
      <div class="ob-expense-row ${e.skipped?`skipped`:``}">
        <div>
          <div class="ob-expense-name">${T(e.name)}</div>
      ...
      <button class="ob-back" onclick="obBack()">← Back</button>
      <button class="ob-next" onclick="obNext()">Continue →</button>`;else if(r===6){let e=K.incomes.reduce((e,t)=>{let n=parseFloat(t.amount)||0;return n?e+(t.frequency===`Weekly`?n*52/12:t.frequency===`Fortnightly`?n*26/12:t.frequency===`Annual`?n/12:n):e},0),t=K.expenses.filter(e=>!e.skipped).reduce((e,t)=>e+(parseFloat(t.amount)||0),0),n=K.adultNames.filter(e=>e),r=n.length>0?n.join(` & `):`${K.adults} adult${K.adults>1?`s`:``}`,i={renting:`Renting`,mortgage:`Mortgage`,building:`Building`,own:`Own outright`}[K.homeType]||``,c=[`
      <div class="ob-summary-member">
        <div class="ob-summary-avatar">👤</div>
        <div>
          <div style="font-size:14px;font-weight:600">${T(r)}</div>
          <div style="font-size:12px;color:var(--text-muted)">Adults · ${i}</div>
        </div>
      </div>`];K.kidProfiles.forEach(e=>{e.name&&c.push(`
        <div class="ob-summary-member">
          <div class="ob-summary-avatar">${T(e.emoji)}</div>
          <div>
            <div style="font-size:14px;font-weight:600">${T(e.name)}${e.age?`, age ${e.age}`:``}</div>
    ...
    <div class="ob-footer">${s}</div>`}function $f(){let e=Uf(),t=Wf();if(t>=e.length-1){rp();return}if(K.step===2){if(K.adultNames.some(e=>!e.trim())){K._nameError=!0,Qf();return}K._nameError=!1}let n=e[t+1];n===3&&(K.kidProfiles=Array.from({length:K.kids},(e,t)=>K.kidProfiles[t]||{name:``,age:``,emoji:KID_EMOJIS[t%KID_EMOJIS.length]})),n===5&&!K.expenses.length&&(K.expenses=Hf[K.homeType].map(e=>({...e,skipped:!1})),K.kids>0&&K.expenses.push({name:`Kids activities / sport`,category:`Childcare / Education`,amount:300,skipped:!1})),K.step=n,Qf()}function ep(){let e=Uf(),t=Wf();t<=0||(K.step=e[t-1],Qf())}function tp(){g.onboarded=!0,window.saveData(g),Kf()}function np(){K.expenses=[];let e=Uf(),t=Wf();K.step=e[t+1],Qf()}function rp(){g.householdProfile.members=[];for(let e=0;e<K.adults;e++)g.householdProfile.members.push({role:`adult`,name:K.adultNames[e]||``,age:K.adultAges[e]?parseInt(K.adultAges[e]):null});g.kids||(g.kids={profiles:[],chores:[],prizes:[],completions:[],redemptions:[]}),g.meals||(g.meals={}),g.meals.lunchbox||(g.meals.lunchbox={profiles:[]}),g.meals.lunchbox.profiles||(g.meals.lunchbox.profiles=[]),g.kids.profiles=[],g.meals.lunchbox.profiles=[],K.kidProfiles.forEach(e=>{if(g.householdProfile.members.push({role:`child`,name:e.name,age:e.age?parseInt(e.age):null,emoji:e.emoji}),!e.name)return;let t=nextId(g.kids.profiles);g.kids.profiles.push({id:t,name:e.name,age:e.age?parseInt(e.age):null,emoji:e.emoji}),g.meals.lunchbox.profiles.push({id:t,name:e.name,emoji:e.emoji})}),g.householdProfile.homeType=K.homeType;let e=window.ensureMonthOverride(window.selectedBudgetMonth);K.incomes.forEach((t,n)=>{let r=parseFloat(t.amount);if(!r)return;let i=t.frequency===`Weekly`?r*52/12:t.frequency===`Fortnightly`?r*26/12:t.frequency===`Annual`?r/12:r,a=t.name||(K.adultNames[n]?`${K.adultNames[n]}'s salary`:`Income ${n+1}`);e.income.push({id:nextId(e.income),name:a,amount:i,frequency:`monthly`,category:`Salary`})}),K.expenses.forEach(t=>{t.skipped||!t.amount||e.expenses.push({id:nextId(e.expenses),name:t.name,amount:t.amount,frequency:`monthly`,category:t.category,recurring:!0})}),g.onboarded=!0,window.saveData(g),Kf(),window.renderAll()}document.getElementById(`btn-guest-mode`)?.addEventListener(`click`,()=>vp()),document.getElementById(`btn-google-signin`)?.addEventListener(`click`,()=>_p());function ip(){document.getElementById(`sidebar`).classList.toggle(`collapsed`)}var ap={};function op(e){let t=document.getElementById(`icon-group-${e}`),n=document.getElementById(`icon-group-${e}-children`),r=document.getElementById(`text-group-${e}`),i=document.getElementById(`text-group-${e}-children`),a=n&&n.classList.contains(`open`);t&&t.classList.toggle(`open`,!a),n&&n.classList.toggle(`open`,!a),r&&r.classList.toggle(`open`,!a),i&&i.classList.toggle(`open`,!a)}function sp(e){for(let[t,n]of Object.entries(ap))if(n.includes(e)){let e=document.getElementById(`icon-group-${t}-children`);e&&!e.classList.contains(`open`)&&op(t);return}}window.addEventListener(`unhandledrejection`,e=>{console.error(`[unhandledrejection]`,e.reason)}),window.addEventListener(`error`,e=>{console.error(`[uncaughtError]`,e.message,e.filename,e.lineno)});var cp=`toto_household_owner`,lp=`toto_pending_household`;function up(){return sessionStorage.getItem(lp)||zp(cp)||q?.uid||null}function dp(){let e=up();return e?fbStore.collection(`families`).doc(e):null}function fp(e){Bp(cp,e),sessionStorage.removeItem(lp)}var q=null,pp=!1,mp=null;Object.defineProperty(window,`_fsUnsubscribe`,{get(){return mp},set(e){mp=e},configurable:!0});var hp=null;Object.defineProperty(window,`_pendingLogEntry`,{get(){return hp},set(e){hp=e},configurable:!0}),Object.defineProperty(window,`_currentUser`,{get(){return q},set(e){q=e},configurable:!0});function gp(e,t){hp={ts:new Date().toISOString(),name:q&&(q.displayName||q.email)||`Unknown`,photo:q&&q.photoURL||``,action:e,detail:t||``}}function _p(){let e=new fbAuth.GoogleAuthProvider;fbAuth.signInWithPopup(e).catch(e=>{let t=document.getElementById(`login-error`);t&&(t.textContent=e.message,t.style.display=``)})}async function vp(){pp=!0;let e=document.getElementById(`login-overlay`);e&&e.classList.add(`hidden`),await Jp,g.onboarded||(g.onboarded=!0,J(g));let t=location.hash.slice(1);t&&document.getElementById(`tab-`+t)?(history.replaceState({tab:t},``,`#`+t),C(t)):vh(),Xp()}function yp(){mp&&(mp(),mp=null),Np=!1,Y=null,qp(),fbAuth.signOut()}function bp(e){return e.budget||(e.budget={income:[],expenses:[],actuals:{},months:{}}),e.budget.actuals||(e.budget.actuals={}),e.budget.months||(e.budget.months={}),e.budget.suggestions||(e.budget.suggestions=[]),e.goals||(e.goals=[]),e.scenarios||(e.scenarios=[]),e.furniture||(e.furniture=[]),e.appliances||(e.appliances=[]),e.planner||(e.planner={events:[]}),e.projects||(e.projects=[]),e.activeFamilyGoalProjectId===void 0&&(e.activeFamilyGoalProjectId=null),e.lists||(e.lists={food:{items:[],budget:0,weeklyBudget:200,stores:[],favourites:[],history:[]},clothes:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},wishlist:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},home:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},pharmacy:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]}},e.meals&&e.meals.shopping&&e.meals.shopping.length&&(e.lists.food.items=e.meals.shopping.map(function(e,t){return{id:`si-`+t,name:e.name,quantity:1,unit:`units`,notes:``,aisle:e.cat||`other`,state:e.checked?`got_it`:`active`,addedBy:`migration`,addedAt:new Date().toISOString(),mealTag:null,manualPrice:null,barcodeId:null}}))),[`food`,`clothes`,`wishlist`,`home`,`pharmacy`].forEach(function(t){e.lists[t]||(e.lists[t]={items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]}),e.lists[t].items||(e.lists[t].items=[]),e.lists[t].stores||(e.lists[t].stores=[]),e.lists[t].favourites||(e.lists[t].favourites=[]),e.lists[t].history||(e.lists[t].history=[])}),e.routines&&e.routines.forEach(function(e){e.ownerType===`household`&&e.ownerId!==`household`&&(e.ownerId=`household`)}),e}function xp(){mp&&mp(),!zp(cp)&&!sessionStorage.getItem(lp)&&fp(q.uid);let e=dp();if(!e){console.error(`No household doc ref`);return}mp=e.onSnapshot(async t=>{if(t.exists){let e=bp(t.data());Object.assign(g,e),Bp(Cp,JSON.stringify(g))}else{let t=await fbStore.collection(`family`).doc(`shared`).get().catch(()=>null);if(t&&t.exists){let n=bp(t.data());Object.assign(g,n),e.set(g).catch(()=>{}),Bp(Cp,JSON.stringify(g))}else e.set(g).catch(()=>{})}Tf().then(()=>{mr();let e=location.hash.slice(1);e&&document.getElementById(`tab-`+e)?(history.replaceState({tab:e},``,`#`+e),C(e)):vh(),g.onboarded||(g.onboarded=!0,J(g));let t=sessionStorage.getItem(bm),n=sessionStorage.getItem(`toto_post_invite_action`);t||n?(sessionStorage.removeItem(`toto_post_invite_action`),Sm()):Xp()})},e=>{console.error(`Firestore sync error:`,e),vh()})}function Sp(){fbAuth.onAuthStateChanged(e=>{if(pp&&!e)return;q=e;let t=document.getElementById(`login-overlay`),n=document.getElementById(`header-avatar`),r=document.getElementById(`header-sign-out`);if(e)t&&t.classList.add(`hidden`),n&&(n.src=e.photoURL||``,n.style.display=`block`),r&&(r.style.display=`block`),xp();else{t&&t.classList.remove(`hidden`),n&&(n.style.display=`none`),r&&(r.style.display=`none`),mp&&(mp(),mp=null);let e=sessionStorage.getItem(bm),i=document.getElementById(`login-invite-banner`),a=document.getElementById(`login-tagline`);e&&i&&(i.style.display=`block`,a&&(a.style.display=`none`))}})}Sp();var Cp=`home_finance_v1`;window.STORAGE_KEY=Cp;var wp=null,Tp={};function Ep(e,t,n,r){Tp[e]={options:t,value:n,onChange:r};let i=t.find(e=>(e.value??e)===n)||t[0],a=i?.label??i?.value??i??``;return`<div class="cs-wrap">
    <button type="button" class="cs-trigger" id="cs-${e}" onclick="event.stopPropagation();_csOpen('${e}',this)">
      <span id="cs-label-${e}">${T(String(a))}</span>
      <span class="cs-chevron">▼</span>
    </button>
  </div>`}function Dp(e,t){wp&&(wp.remove(),wp=null,document.querySelectorAll(`.cs-trigger.open`).forEach(e=>e.classList.remove(`open`)));let n=Tp[e];if(!n)return;t.classList.add(`open`);let r=t.getBoundingClientRect(),i=document.createElement(`div`);i.className=`cs-dropdown`,i.style.left=r.left+`px`,i.style.width=Math.max(r.width,180)+`px`;let a=window.innerHeight-r.bottom-8,o=r.top-8,s=Math.min(260,n.options.length*43);i.style.top=a>=s||a>=o?r.bottom+4+`px`:Math.max(8,r.top-s-4)+`px`,n.options.forEach(r=>{let a=r.value??r,o=r.label??r.value??r,s=document.createElement(`div`);s.className=`cs-option`+(a===n.value?` cs-selected`:``),s.textContent=o,s.addEventListener(`click`,r=>{r.stopPropagation(),n.value=a;let s=document.getElementById(`cs-label-`+e);s&&(s.textContent=o),n.onChange(a),i.remove(),wp=null,t.classList.remove(`open`)}),i.appendChild(s)}),document.body.appendChild(i),wp=i}document.addEventListener(`click`,()=>{wp&&(wp.remove(),wp=null,document.querySelectorAll(`.cs-trigger.open`).forEach(e=>e.classList.remove(`open`)))});function Op(e){e&&e.querySelectorAll(`select.form-select:not(.cs-upgraded)`).forEach(e=>{e.classList.add(`cs-upgraded`);let t=(e.id||`cs`+Math.random().toString(36).slice(2,7))+`__cs`,n=Array.from(e.options).map(e=>({value:e.value,label:e.text})),r=e.value||n[0]?.value||``;e.style.cssText=`position:absolute;opacity:0;pointer-events:none;width:1px;height:1px;overflow:hidden`;let i=document.createElement(`div`);i.className=`cs-wrap`,i.innerHTML=Ep(t,n,r,t=>{e.value=t,e.dispatchEvent(new Event(`change`,{bubbles:!0}))}),e.parentNode.insertBefore(i,e)})}(function(){let e=document.getElementById(`modal-overlay`);e&&new MutationObserver(()=>{e.classList.contains(`hidden`)||Op(document.getElementById(`modal-body`))}).observe(e,{attributes:!0,attributeFilter:[`class`]})})();var kp={buildContract:{total:79e4,stages:[{id:1,name:`Deposit`,amount:39500,paid:!1,paidDate:``,expectedDate:``,invoiceRef:``,funding:`loan`,notes:``},{id:2,name:`Base / Slab`,amount:79e3,paid:!1,paidDate:``,expectedDate:``,invoiceRef:``,funding:`loan`,notes:``},{id:3,name:`Frame`,amount:118500,paid:!1,paidDate:``,expectedDate:``,invoiceRef:``,funding:`loan`,notes:``},{id:4,name:`Lock-up / Enclosed`,amount:276500,paid:!1,paidDate:``,expectedDate:``,invoiceRef:``,funding:`loan`,notes:``},{id:5,name:`Fixing / Fitout`,amount:197500,paid:!1,paidDate:``,expectedDate:``,invoiceRef:``,funding:`loan`,notes:``},{id:6,name:`Practical Completion`,amount:79e3,paid:!1,paidDate:``,expectedDate:``,invoiceRef:``,funding:`loan`,notes:``}],variations:[]},extras:[{id:1,name:`Solar`,vendor:``,totalAmount:0,amountPaid:0,dueDate:``,notes:``},{id:2,name:`Landscaping`,vendor:``,totalAmount:0,amountPaid:0,dueDate:``,notes:``}],furniture:[],appliances:[],goals:[],scenarios:[],kids:{profiles:[],chores:[],prizes:[],completions:[],redemptions:[]},netWorth:{assets:[],liabilities:[],snapshots:[],target:{amount:0,byYear:0}},bills:[],subscriptions:[],planner:{events:[]},meals:{plan:{},shopping:[],lunchbox:{profiles:[],plans:{}},pantry:[]},vehicles:[],documents:[],maintenance:[],onboarded:!1,setupProgressDismissed:!1,activityLog:[],householdProfile:{members:[{role:`adult`,age:null},{role:`adult`,age:null}],pets:[],cars:1,invites:[],authorizedUsers:[]},expenseCategories:[`Mortgage / Rent`,`Insurance`,`Utilities`,`Groceries`,`Transport`,`Childcare / Education`,`Health`,`Entertainment`,`Subscriptions`,`Dining Out`,`Clothing`,`Personal Care`,`Savings / Investment`,`Other`],incomeCategories:[`Salary`,`Freelance / Contract`,`Rental Income`,`Government / Benefits`,`Investment`,`Other`],budget:{income:[],expenses:[],actuals:{},months:{}},settings:{autoFillMonths:!1},categoryGroups:[{id:1,name:`Housing`,icon:`🏠`,categories:[`Mortgage / Rent`,`Utilities`,`Insurance`]},{id:2,name:`Food & Dining`,icon:`🍽️`,categories:[`Groceries`,`Dining Out`]},{id:3,name:`Transport`,icon:`🚗`,categories:[`Transport`]},{id:4,name:`Family & Health`,icon:`👨‍👩‍👧`,categories:[`Childcare / Education`,`Health`,`Personal Care`]},{id:5,name:`Lifestyle`,icon:`🎮`,categories:[`Entertainment`,`Subscriptions`,`Clothing`]},{id:6,name:`Savings`,icon:`💰`,categories:[`Savings / Investment`]},{id:7,name:`Other`,icon:`📦`,categories:[`Other`]}],routines:[],routineAssignments:[],childEvents:[],projects:[],activeFamilyGoalProjectId:null};function Ap(){try{let e=zp(Cp);if(!e)return JSON.parse(JSON.stringify(kp));let t=JSON.parse(e);t.budget.actuals||(t.budget.actuals={}),t.budget.months||(t.budget.months={}),t.budget.suggestions||(t.budget.suggestions=[]),t.goals||(t.goals=[]),t.scenarios||(t.scenarios=[]),t.netWorth||(t.netWorth={assets:[],liabilities:[],snapshots:[]}),t.netWorth.snapshots||(t.netWorth.snapshots=[]),t.netWorth.target||(t.netWorth.target={amount:0,byYear:0}),t.bills||(t.bills=[]),t.subscriptions||(t.subscriptions=[]),t.onboarded===void 0&&(t.onboarded=!0),t.planner||(t.planner={events:[]}),t.planner?.events&&t.planner.events.forEach(e=>{if(e.recurring||(e.recurring=`none`),!e.recurrence&&e.recurring&&e.recurring!==`none`){let t={weekly:{type:`interval`,intervalDays:7},fortnightly:{type:`interval`,intervalDays:14},monthly:{type:`interval`,intervalDays:30},quarterly:{type:`interval`,intervalDays:91},yearly:{type:`interval`,intervalDays:365}}[e.recurring];t&&(e.recurrence={...t,startDate:e.date||new Date().toISOString().slice(0,10)})}}),t.kids||(t.kids={profiles:[],chores:[],prizes:[],completions:[],redemptions:[]}),t.kids.profiles||(t.kids.profiles=[]),t.kids.chores||(t.kids.chores=[]),t.kids.prizes||(t.kids.prizes=[]),t.kids.completions||(t.kids.completions=[]),t.kids.redemptions||(t.kids.redemptions=[]);let n=new Map;if(t.kids.profiles.forEach(e=>{e.name&&n.set(e.name.toLowerCase(),e)}),n.size<t.kids.profiles.length&&(t.kids.profiles=Array.from(n.values())),t.furniture||(t.furniture=[]),t.appliances||(t.appliances=[]),t.activityLog||(t.activityLog=[]),!t.householdProfile)t.householdProfile={members:[{role:`adult`,age:null},{role:`adult`,age:null}],pets:[],cars:1};else if(`adults`in t.householdProfile){let e=t.householdProfile.adults||2,n=t.householdProfile.children||0;t.householdProfile={members:[...Array.from({length:e},()=>({role:`adult`,age:null})),...Array.from({length:n},()=>({role:`child`,age:null}))],pets:[],cars:1}}t.householdProfile.pets||(t.householdProfile.pets=[]),t.householdProfile.cars===void 0&&(t.householdProfile.cars=1),t.householdProfile.invites||(t.householdProfile.invites=[]),t.householdProfile.authorizedUsers||(t.householdProfile.authorizedUsers=[]),(t.householdProfile.members||[]).forEach((e,n)=>{if(!e.name)if(e.role===`child`){let r=(t.kids?.profiles||[])[n-(t.householdProfile.members||[]).filter((e,t)=>t<n&&e.role===`adult`).length];r?.name&&(e.name=r.name,!e.age&&r.age&&(e.age=r.age),!e.emoji&&r.emoji&&(e.emoji=r.emoji))}else{let r=(t.budget?.income||[])[(t.householdProfile.members||[]).filter((e,t)=>t<n&&e.role===`adult`).length];if(r?.name){let t=r.name.match(/^([^'\s]+)'s\s/i)||r.name.match(/^([^'\s]+)\s/);t&&(e.name=t[1])}}}),t.meals||(t.meals={plan:{},shopping:[]}),t.meals.plan||(t.meals.plan={}),t.meals.shopping||(t.meals.shopping=[]),t.meals.lunchbox||(t.meals.lunchbox={profiles:[],plans:{}}),t.meals.lunchbox.profiles||(t.meals.lunchbox.profiles=[]),t.meals.lunchbox.plans||(t.meals.lunchbox.plans={}),t.meals.pantry||(t.meals.pantry=[]),t.vehicles||(t.vehicles=[]),t.documents||(t.documents=[]),t.maintenance||(t.maintenance=[]),t.routines||(t.routines=[]),t.routineAssignments||(t.routineAssignments=[]),t.routines=t.routines.filter(e=>e.id!=null&&e.id!==`null`&&e.id!==``);let r=new Set((t.routineAssignments||[]).map(e=>e.routineId));if(t.routines.forEach(e=>{if(e.completions||(e.completions={}),e.sharedWith||(e.sharedWith=[]),e.assignedTo||(e.assignedTo=[]),e.linkedFrom||(e.linkedFrom=null),e.linkedType||(e.linkedType=null),e.pointsPerCompletion===void 0&&(e.pointsPerCompletion=0),(e.steps||[]).forEach(e=>{e.points===void 0&&(e.points=0)}),e.skippedDates||(e.skippedDates=[]),e.pausePeriods||(e.pausePeriods=[]),e.recurrence||(e.recurrence={type:`daily`,startDate:(e.lastEditedAt||new Date().toISOString()).slice(0,10)}),(!e.ownerType||!e.ownerId)&&(r.has(e.id)?(e.ownerType=`household`,e.ownerId=`household`):(e.ownerType=`adult`,e.ownerId=`guest`)),r.has(e.id)&&e.ownerType!==`household`&&(e.ownerType=`household`,e.ownerId=`household`),e.ownerType===`adult`&&e.ownerId===`guest`&&e.steps?.length>0){let t=new Set([`Make bed`,`Shower`,`Breakfast`,`Exercise`,`Plan the day`,`Tidy kitchen`,`Prep tomorrow`,`Family time`,`Read`,`Lights out`]);e.steps.every(e=>t.has(e.label))&&(e.steps=[])}}),t.routineAssignments.forEach(e=>{if(!e.completionState){let n=t.routines.find(t=>t.id===e.routineId);e.completionState=n&&Object.keys(n.completions||{}).length?JSON.parse(JSON.stringify(n.completions)):{}}e.archivedCompletionState||(e.archivedCompletionState=null),e.childIds||(e.childIds=e.childId?[e.childId]:[])}),t.routines.forEach(e=>{e.ownerType===`household`&&(e.completions={})}),t.childEvents||(t.childEvents=[]),t.childEvents.forEach(e=>{e.recurrence||(e.recurrence=null),e.assignedTo||(e.assignedTo=[]),e.isHouseholdWide===void 0&&(e.isHouseholdWide=!1)}),t.settings||(t.settings={autoFillMonths:!1}),t.settings.notifStyle||(t.settings.notifStyle=`focus-timeline`),t.settings.routineResetHour===void 0&&(t.settings.routineResetHour=0),t.kids.notifications||(t.kids.notifications=[]),t.settings.typeAMode===void 0&&(t.settings.typeAMode=!1),t.settings.typeAStreak||(t.settings.typeAStreak=0),t.settings.typeALastReset||(t.settings.typeALastReset=``),t.settings.typeADismissedMission||(t.settings.typeADismissedMission=``),t.settings.typeAMissionShownDate||(t.settings.typeAMissionShownDate=``),t.settings.typeAMissionId||(t.settings.typeAMissionId=``),t.settings.typeALastResetDate||(t.settings.typeALastResetDate=``),t.categoryGroups||(t.categoryGroups=JSON.parse(JSON.stringify(kp.categoryGroups))),t.buildContract.variations||(t.buildContract.variations=[]),t.buildContract.stages.forEach(e=>{e.expectedDate||(e.expectedDate=``)}),t.expenseCategories||(t.expenseCategories=JSON.parse(JSON.stringify(kp.expenseCategories))),t.incomeCategories||(t.incomeCategories=JSON.parse(JSON.stringify(kp.incomeCategories))),t.budget&&t.budget.expenses){let e=new Date;t.budget.expenses.forEach(t=>{if(t.dueDay&&!t.dueDate){let n=e.getFullYear(),r=e.getMonth()+1,i=Math.min(t.dueDay,new Date(n,r,0).getDate());t.dueDate=`${n}-${String(r).padStart(2,`0`)}-${String(i).padStart(2,`0`)}`,delete t.dueDay}t.frequency===`annual`&&(t.frequency=`annually`)})}return t}catch{return JSON.parse(JSON.stringify(kp))}}function J(e){if(se(e),hp&&(e.activityLog||(e.activityLog=[]),e.activityLog.unshift(hp),e.activityLog.length>200&&(e.activityLog.length=200),hp=null),Bp(Cp,JSON.stringify(e)),q){let t=dp();t&&t.set(e).catch(e=>{console.error(`Firestore save error:`,e)})}}window._saveData=J;var jp=`toto_device_profile`,Mp=`toto_kid_session`,Y=null,Np=!1,X=0,Pp=0,Z=``,Fp=null;Object.defineProperty(window,`_activeProfile`,{get(){return Y},set(e){Y=e},configurable:!0}),Object.defineProperty(window,`_deviceRoutingDone`,{get(){return Np},set(e){Np=e},configurable:!0}),Object.defineProperty(window,`_pinAttempts`,{get(){return X},set(e){X=e},configurable:!0}),Object.defineProperty(window,`_pinBuffer`,{get(){return Z},set(e){Z=e},configurable:!0}),Object.defineProperty(window,`_pinTargetId`,{get(){return Fp},set(e){Fp=e},configurable:!0});var Ip={};function Lp(){return window.Capacitor?.Plugins?.Preferences??null}async function Rp(e){let t=Lp();for(let n of e)if(t)try{let{value:e}=await t.get({key:n});Ip[n]=e}catch{Ip[n]=localStorage.getItem(n)}else Ip[n]=localStorage.getItem(n)}function zp(e){return e in Ip?Ip[e]:localStorage.getItem(e)}function Bp(e,t){Ip[e]=t,localStorage.setItem(e,t);let n=Lp();n&&n.set({key:e,value:t}).catch(()=>{})}function Vp(e){delete Ip[e],localStorage.removeItem(e);let t=Lp();t&&t.remove({key:e}).catch(()=>{})}function Hp(){return zp(jp)}function Up(e){Bp(jp,e)}function Wp(){Vp(jp)}function Gp(){return zp(Mp)}function Kp(e){Bp(Mp,String(e))}function qp(){Vp(Mp)}var Jp=Rp([cp,jp,Mp,Cp,`toto_ai_key`,`toto_ai_key_meta`,`toto_qa_last`,`home_finance_colors_v1`]);async function Yp(e,t){let n=t||`toto-pin-`,r=await crypto.subtle.digest(`SHA-256`,new TextEncoder().encode(n+e));return Array.from(new Uint8Array(r)).map(e=>e.toString(16).padStart(2,`0`)).join(``)}function Xp(){if(Np||!g.onboarded)return;Np=!0;let e=Hp();if(!e){Zp();return}if(e===`adult`){Y=null,om();return}if(e===`shared`){$p();return}let t=(g.kids?.profiles||[]).find(t=>t.id===e);if(!t){Wp(),Zp();return}if(String(Gp())===String(t.id)){Y={id:t.id,name:t.name,emoji:t.emoji,role:`child`},sm();return}t.pinHash?(Fp=t.id,Z=``,X=0,nm(t)):(Y={id:t.id,name:t.name,emoji:t.emoji,role:`child`},Kp(t.id),sm())}function Zp(){let e=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name),t=g.kids?.profiles||[],n=``,r=e.length?e.map(e=>e.name).join(` / `):`Adult`;n+=`<div class="profile-card" onclick="assignDevice('adult')">
    <div class="profile-avatar">👤</div>
    <div style="flex:1">
      <div style="font-size:15px;font-weight:700;color:#1e293b">${T(r)}</div>
      ...
      <div class="profile-avatar">${T(e.emoji||`😊`)}</div>
      <div style="flex:1">
        <div style="font-size:15px;font-weight:700;color:#1e293b">${T(e.name)}</div>
  ...
  </div>`,document.getElementById(`profile-list`).innerHTML=n,document.getElementById(`profile-overlay-title`).textContent=`Who uses this device?`,document.getElementById(`profile-overlay-sub`).textContent=`Set it once — the app will open straight to the right view. You can change this any time in Settings.`,document.getElementById(`profile-overlay`).classList.remove(`hidden`)}function Qp(e){if(Up(e),Np=!0,document.getElementById(`profile-overlay`).classList.add(`hidden`),e===`adult`)Y=null,om(),vh();else if(e===`shared`)$p();else{let t=(g.kids?.profiles||[]).find(t=>t.id===e);if(!t){Y=null,Hc(),vh();return}t.pinHash?(Fp=t.id,Z=``,X=0,nm(t)):(Y={id:t.id,name:t.name,emoji:t.emoji,role:`child`},Kp(t.id),sm())}}function $p(){document.getElementById(`pin-overlay`).classList.add(`hidden`);let e=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name),t=g.kids?.profiles||[],n=``;e.forEach((e,t)=>{let r=!!e.pinHash;n+=`<div class="profile-card" onclick="_pickAdult(${t})">
      <div class="profile-avatar">🧑</div>
      <div style="flex:1">
        <div style="font-size:15px;font-weight:700;color:#1e293b">${T(e.name)}</div>
    ...
    </div>`}),document.getElementById(`profile-list`).innerHTML=n,document.getElementById(`profile-overlay-title`).textContent=`Who's using Toto?`,document.getElementById(`profile-overlay-sub`).textContent=`Tap your name to continue`,document.getElementById(`profile-overlay`).classList.remove(`hidden`)}function em(e){let t=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[e??0];if(t?.pinHash){Fp=`adult:`+(e??0),Z=``,X=0,Pp=0,nm({emoji:`🧑`,name:t.name,_isAdult:!0,_memberIndex:e??0});return}Y=null,qp(),document.getElementById(`profile-overlay`).classList.add(`hidden`),sm()}function tm(e){let t=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(t.pinHash?(Fp=e,Z=``,X=0,nm(t)):(Y={id:t.id,name:t.name,emoji:t.emoji,role:`child`},Kp(t.id),document.getElementById(`profile-overlay`).classList.add(`hidden`),sm()))}function nm(e){document.getElementById(`profile-overlay`).classList.add(`hidden`),document.getElementById(`pin-avatar`).textContent=e.emoji||(e._isAdult?`🧑`:`😊`),document.getElementById(`pin-greeting`).textContent=`Hi ${e.name}! 👋`,document.getElementById(`pin-sub`).textContent=`Enter your PIN to continue`,document.getElementById(`pin-error`).textContent=``,rm(),im(),document.getElementById(`pin-overlay`).classList.remove(`hidden`)}function rm(){let e=document.getElementById(`pin-dots`);e&&(e.innerHTML=[0,1,2,3].map(e=>`<div class="pin-dot ${e<Z.length?`filled`:``}">${e<Z.length?`●`:``}</div>`).join(``))}function im(){let e=document.getElementById(`pin-pad`);if(!e)return;let t=Date.now();if(t<Pp){let n=Math.ceil((Pp-t)/1e3);document.getElementById(`pin-error`).textContent=`Too many attempts — try again in ${n}s`,e.innerHTML=``,setTimeout(im,1e3);return}e.innerHTML=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div class="pin-key empty"></div>`:`<div class="pin-key" onclick="_pinKey('${e}')">${e}</div>`).join(``)}function am(e){if(!(Date.now()<Pp)){if(e===`⌫`){Z=Z.slice(0,-1),rm();return}Z.length>=4||(Z+=e,rm(),Z.length===4&&rh())}}function om(){let e=document.getElementById(`header-switch-profile`);if(!e)return;let t=Hp();e.style.display=t&&t!==`adult`?``:`none`}function sm(){om(),Hc(),Y?.role===`child`?(window.kidsView=Y.id,w(`kids`),ol(Y.id)):document.querySelectorAll(`.nav-item, .nav-text-item`).forEach(e=>e.style.display=``),vh()}var cm=`member`,lm=null,um=null;function dm(e){cm=e;let t=document.getElementById(`inv-role-member`),n=document.getElementById(`inv-role-owner`);!t||!n||(e===`member`?(t.style.borderColor=`#0d9488`,t.style.background=`#f0fdfa`,t.style.color=`#0d9488`,n.style.borderColor=`var(--border)`,n.style.background=`var(--surface)`,n.style.color=`var(--text-muted)`):(n.style.borderColor=`#0d9488`,n.style.background=`#f0fdfa`,n.style.color=`#0d9488`,t.style.borderColor=`var(--border)`,t.style.background=`var(--surface)`,t.style.color=`var(--text-muted)`))}function fm(e,t){let n=document.getElementById(`inv-email`),r=n?n.value.trim():``,i=(g.householdProfile.members||[]).find(e=>e.role===`adult`)?.name||`Someone`,a=new Date(Date.now()+10080*60*1e3).toISOString(),o={id:yh(),email:r,role:cm,inviterName:i,memberName:t||null,memberIdx:e??null,createdAt:new Date().toISOString(),expiresAt:a,status:`pending`};g.householdProfile.invites||(g.householdProfile.invites=[]),g.householdProfile.invites.push(o),J(g),lm=o.id;let s=gm(o.id),c=document.getElementById(`invite-link-wrap`),l=document.getElementById(`invite-form-wrap`),u=document.getElementById(`invite-link-display`);c&&(c.dataset.invEmail=r,c.dataset.invToken=o.id,c.style.display=`block`),l&&(l.style.display=`none`),u&&(u.textContent=s)}function pm(e){let t=(g.householdProfile.members||[])[e];if(!t)return;let n=(g.householdProfile.members||[]).find((e,t)=>e.role===`adult`&&t===0)?.name||`Someone`,r=new Date(Date.now()+10080*60*1e3).toISOString(),i={id:yh(),email:``,role:`member`,inviterName:n,memberName:t.name||null,memberIdx:e,createdAt:new Date().toISOString(),expiresAt:r,status:`pending`};g.householdProfile.invites||(g.householdProfile.invites=[]),g.householdProfile.invites.push(i),J(g);let a=gm(i.id),o=T(t.name||`this person`),s=document.createElement(`div`);s.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:24px`,s.innerHTML=`<div style="background:#fff;border-radius:16px;padding:24px;max-width:400px;width:100%">
    ...
    <button onclick="this.closest('div[style*=\"position:fixed\"]').remove();renderSettings()"
  ...
  </div>`,document.body.appendChild(s),s.addEventListener(`click`,e=>{e.target===s&&(s.remove(),ta())})}function mm(e){if(!e)return;let t=(g.kids?.profiles||[]).find(t=>t.name&&t.name.toLowerCase()===e.toLowerCase());if(!t){g.kids||(g.kids={profiles:[],chores:[],prizes:[],completions:[],redemptions:[]});let n=(g.householdProfile.members||[]).find(t=>t.name&&t.name.toLowerCase()===e.toLowerCase()),r=N(g.kids.profiles);t={id:r,name:e,age:n?.age||null,emoji:n?.emoji||`🧒`},g.kids.profiles.push(t),g.meals?.lunchbox?.profiles||(g.meals||(g.meals={}),g.meals.lunchbox||(g.meals.lunchbox={profiles:[]})),g.meals.lunchbox.profiles.push({id:r,name:e,emoji:t.emoji}),J(g)}Wm(t.id)}function hm(e){navigator.clipboard.writeText(gm(e)).then(()=>{let e=event.target,t=e.textContent;e.textContent=`✓ Copied!`,setTimeout(()=>{e.textContent=t},2e3)})}function gm(e){let t=up()||``;return window.location.origin+window.location.pathname+`?invite=`+e+`&h=`+t}function _m(){let e=document.getElementById(`invite-link-wrap`)?.dataset.invToken||lm;e&&navigator.clipboard.writeText(gm(e)).then(()=>{let e=event.target,t=e.textContent;e.textContent=`✓ Copied!`,setTimeout(()=>{e.textContent=t},2e3)})}function vm(){let e=document.getElementById(`invite-link-wrap`),t=e?.dataset.invToken||lm,n=e?.dataset.invEmail||``;if(!t)return;let r=(g.householdProfile.invites||[]).find(e=>e.id===t)?.inviterName||`Your partner`,i=gm(t),a=encodeURIComponent(`${r} invited you to join their Toto household`),o=encodeURIComponent(`Hi,\n\n${r} has invited you to join their Toto household — a shared family finance and planning app.\n\nClick the link below to accept the invite (expires in 7 days):\n\n${i}\n\nSee you there!`);window.open(`mailto:${n}?subject=${a}&body=${o}`,`_blank`)}function ym(e){if(!confirm(`Revoke this invite link?`))return;let t=(g.householdProfile.invites||[]).find(t=>t.id===e);t&&(t.status=`revoked`),J(g),ta()}var bm=`toto_pending_invite`;function xm(){let e=new URLSearchParams(window.location.search),t=e.get(`invite`),n=e.get(`h`);t&&(sessionStorage.setItem(bm,t),n&&sessionStorage.setItem(lp,n),window.history.replaceState({},``,window.location.pathname+window.location.hash))}function Sm(){let e=sessionStorage.getItem(bm);if(!e)return;let t=(g.householdProfile.invites||[]).find(t=>t.id===e);if(!t){sessionStorage.removeItem(bm);return}if(t.status!==`pending`||new Date(t.expiresAt)<new Date){sessionStorage.removeItem(bm),Pm(t);return}sessionStorage.removeItem(bm),um=t,Cm(t)}function Cm(t){let n=g.householdProfile.members||[],r=n.filter(e=>e.role===`adult`),i=n.filter(e=>e.role===`child`),a=(()=>{let t=new Date,n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}`,r=getOrCreateMonthData(n);return(r.income||[]).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)-(r.expenses||[]).filter(e=>!e.skipped).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)})(),o=[...r.map(e=>`
      <div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid #f1f5f9">
        ...
        <div><div style="font-size:14px;font-weight:600">${T(e.name||`Adult`)}</div><div style="font-size:12px;color:#64748b">Adult · Owner</div></div>
      </div>`),...i.map(e=>`
      <div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid #f1f5f9">
        ...
        <div><div style="font-size:14px;font-weight:600">${T(e.name||`Kid`)}</div><div style="font-size:12px;color:#64748b">Kid · age ${e.age||`?`}</div></div>
      </div>`)].join(``);Fm(`
    <div style="text-align:center;font-size:56px;margin-bottom:20px;margin-top:8px">🏡</div>
    <div style="font-size:22px;font-weight:800;color:#1e293b;text-align:center;margin-bottom:6px;line-height:1.3">${T(t.inviterName||`Someone`)} invited you to join their Toto household</div>
    ...
    ${t.email?`<div style="font-size:12px;color:#94a3b8;text-align:center;margin-bottom:16px">Invite sent to <strong style="color:#475569">${T(t.email)}</strong> · Expires ${new Date(t.expiresAt).toLocaleDateString()}</div>`:``}
  ...
  `)}function wm(){let t=um,n=q?.displayName?.split(` `)[0]||`there`,r=g.householdProfile.members||[],i=r.filter(e=>e.role===`adult`),a=r.filter(e=>e.role===`child`),o=(()=>{let t=new Date,n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}`,r=getOrCreateMonthData(n);return(r.income||[]).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)-(r.expenses||[]).filter(e=>!e.skipped).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)})(),s=(g.goals||[]).length,c=[...i.map((e,t)=>`
      <div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid #f1f5f9">
        <div style="width:40px;height:40px;border-radius:50%;background:linear-gradient(135deg,#ecfeff,#ccfbf1);display:flex;align-items:center;justify-content:center;font-size:20px">👤</div>
        <div>
          <div style="font-size:14px;font-weight:600">${T(e.name||`Adult`)}${t===i.length-1?` — <span style="color:#0d9488">that's you!</span>`:``}</div>
    ...
    <div style="font-size:24px;font-weight:800;color:#1e293b;text-align:center;margin-bottom:6px">You're in, ${T(n)}!</div>
    <div style="font-size:14px;color:#64748b;text-align:center;margin-bottom:24px">Welcome to ${T(t?.inviterName||`the`)}'s Toto household.</div>
  ...
  `)}var Tm=0,Em=[{emoji:`💰`,title:`The Kitty`,desc:`Budget, bills, goals & net worth. See where the money goes each month.`},{emoji:`📅`,title:`Plan`,desc:`Weekly planner, meal plans & the kids' lunchboxes. One place for the week ahead.`},{emoji:`🏠`,title:`Home`,desc:`Documents, vehicles & maintenance reminders. Never miss a rego or warranty renewal.`}];function Dm(){Tm=0,Om()}function Om(){let e=Em[Tm],t=Em.map((e,t)=>`<div style="width:${t===Tm?20:8}px;height:8px;border-radius:99px;background:${t===Tm?`#0d9488`:`#e2e8f0`};transition:all .2s"></div>`).join(``),n=Tm===Em.length-1;Fm(`
  ...
  `)}function Am(){let e=document.getElementById(`inv-inc-name`)?.value.trim()||``,t=parseFloat(document.getElementById(`inv-inc-amount`)?.value)||0,n=document.getElementById(`inv-inc-freq`)?.value||`Monthly`;(e||t)&&(g.budget.income||(g.budget.income=[]),g.budget.income.push({id:N(g.budget.income),name:e,amount:t,frequency:n}),J(g)),Nm()}function jm(){let e=um;if(!q){sessionStorage.setItem(`toto_post_invite_action`,e?.id||``),_p();return}Mm(e),wm()}function Mm(e){if(!e)return;e.status=`accepted`;let t=q,n=up();n&&fp(n),g.householdProfile.authorizedUsers||(g.householdProfile.authorizedUsers=[]),g.householdProfile.authorizedUsers.some(e=>e.uid===t.uid)||g.householdProfile.authorizedUsers.push({uid:t.uid,name:t.displayName||``,email:t.email||``,role:e.role||`member`,joinedAt:new Date().toISOString()});let r=g.householdProfile.members||[],i=(t.displayName||``).split(` `)[0];i&&!r.some(e=>e.name===i)&&g.householdProfile.members.push({role:`adult`,name:i,age:null}),J(g)}function Nm(){um=null,Im(),vh(),Xp()}function Pm(e){Fm(`
    <div style="text-align:center;margin-top:40px">
      <div style="font-size:56px;margin-bottom:16px">⏰</div>
      <div style="font-size:20px;font-weight:800;color:#1e293b;margin-bottom:8px">This invite has expired</div>
      <div style="font-size:14px;color:#64748b;margin-bottom:24px">The 7-day window has passed. Ask ${T(e?.inviterName||`the household owner`)} to send a new invite link.</div>
  ...
  `)}function Fm(e){document.getElementById(`invite-flow-content`).innerHTML=e;let t=document.getElementById(`invite-flow-overlay`);t.classList.remove(`hidden`),t.style.display=`flex`,t.scrollTop=0}function Im(){let e=document.getElementById(`invite-flow-overlay`);e.classList.add(`hidden`),e.style.display=``}var Lm=`toto_pin_hard_`,Rm=`toto_pin_att_`,zm=null,Q=`gate`,Bm=``,Vm=``,Hm=0,Um=null;function Wm(e){let t=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(zm=e,Vm=``,Bm=``,Q=t.pinHash?`enter`:`gate`,Km(),document.getElementById(`pin-setup-overlay`).classList.remove(`hidden`))}function Gm(){Um&&(clearInterval(Um),Um=null),document.getElementById(`pin-setup-overlay`).classList.add(`hidden`),zm=null}function Km(){let e=(g.kids?.profiles||[]).find(e=>String(e.id)===String(zm));if(!e)return;let t=document.getElementById(`pso-screen`);if(!t)return;let n=e.emoji||`🧒`,r=T(e.name),i={gate:`#f8fafc`,hello:`linear-gradient(160deg,#f0fdfa,#ecfeff)`,enter:`#f8fafc`,confirm:`#f8fafc`,tour:`#f8fafc`};if(document.getElementById(`pin-setup-overlay`).style.background=i[Q]||`#f8fafc`,Q===`gate`)t.innerHTML=`
      ...
      <button onclick="_psoStep='enter';_psoRender()"
        ...
        Let's go! →
      </button>`;else if(Q===`enter`||Q===`confirm`){let n=Q===`enter`,i=n?e.pinHash?`Change ${r}'s PIN`:`Choose your secret code 🔢`:`Type it again ✅`,a=n?`Pick 4 numbers only you know!`:`Just to make sure!`,o=[0,1,2,3].map(e=>{let t=e<Vm.length;return`<div style="width:52px;height:60px;border:2px solid ${t?`#0d9488`:`#e2e8f0`};border-radius:10px;background:${t?`#f0fdfa`:`#f8fafc`};display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:700;color:#0d9488">${t?`●`:``}</div>`}).join(``),s=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div></div>`:`<div onclick="_psoKey('${e}')" style="height:52px;border:1.5px solid #e2e8f0;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:600;color:#374151;cursor:pointer;background:#fff;-webkit-tap-highlight-color:transparent;user-select:none">${e}</div>`).join(``);t.innerHTML=`
      ...
      ${r?``:`<button onclick="_psoTourDone()" style="font-size:13px;color:#94a3b8;background:none;border:none;cursor:pointer">Skip</button>`}`}}function qm(){if(Um)return;let e=0,t=document.getElementById(`pso-hold-fill`);t&&(t.style.transition=`none`,t.style.transform=`scaleX(0)`),Um=setInterval(()=>{e+=50;let n=Math.min(e/2e3,1);t&&(t.style.transition=`none`,t.style.transform=`scaleX(${n})`),e>=2e3&&(clearInterval(Um),Um=null,Q=`hello`,Km())},50)}function Jm(){Um&&(clearInterval(Um),Um=null);let e=document.getElementById(`pso-hold-fill`);e&&(e.style.transition=`transform .3s`,e.style.transform=`scaleX(0)`)}function Ym(e){if(e===`⌫`){Vm=Vm.slice(0,-1),Km();return}Vm.length>=4||(Vm+=e,Km(),Vm.length===4&&Xm())}async function Xm(){if(Q===`enter`)Bm=Vm,Vm=``,Q=`confirm`,Km();else if(Q===`confirm`){if(Vm!==Bm){Vm=``,Bm=``,Q=`enter`,Km();let e=document.getElementById(`pso-error`);e&&(e.textContent=`Those didn't match — try again 🙈`);return}await Wc(zm,Vm);let e=(g.kids?.profiles||[]).find(e=>String(e.id)===String(zm));e&&!e._pinWasSet?(Hm=0,Q=`tour`,Km()):(Gm(),G(),ta()),e._pinWasSet=!0}}function Zm(){let e=(g.kids?.profiles||[]).find(e=>String(e.id)===String(zm));Gm(),e&&ol(e.id)}function Qm(e){return parseInt(zp(Rm+e)||`0`)}function $m(e){let t=Qm(e)+1;return Bp(Rm+e,String(t)),t}function eh(e){Vp(Rm+e),Vp(Lm+e)}function th(e){return zp(Lm+e)===`1`}function nh(e){Bp(Lm+e,`1`)}async function rh(){let e=await Yp(Z,up());if(typeof Fp==`string`&&Fp.startsWith(`adult:`)){let t=parseInt(Fp.split(`:`)[1]),n=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[t];if(!n)return;e===n.pinHash?(X=0,Y=null,qp(),document.getElementById(`pin-overlay`).classList.add(`hidden`),sm()):(X++,Z=``,rm(),X>=3?(Pp=Date.now()+3e4,X=0,im()):document.getElementById(`pin-error`).textContent=`Wrong PIN — ${3-X} tr${3-X==1?`y`:`ies`} left`);return}let t=(g.kids?.profiles||[]).find(e=>e.id===Fp);if(t){if(th(t.id)){document.getElementById(`pin-error`).textContent=`PIN locked — ask mum or dad to reset it 🔒`,document.getElementById(`pin-pad`).innerHTML=``,ih(t);return}if(e===t.pinHash)eh(t.id),X=0,Y={id:t.id,name:t.name,emoji:t.emoji,role:`child`},Kp(t.id),document.getElementById(`pin-overlay`).classList.add(`hidden`),sm();else if(Z=``,rm(),X++,$m(t.id)>=10)nh(t.id),Pp=0,document.getElementById(`pin-error`).textContent=`PIN locked — ask mum or dad to reset it 🔒`,document.getElementById(`pin-pad`).innerHTML=``,ih(t);else if(X>=3)Pp=Date.now()+3e4,X=0,im();else{let e=3-X;document.getElementById(`pin-error`).textContent=`Wrong PIN — ${e} try${e===1?``:`s`} left`}}}function ih(e){g.notifications||(g.notifications=[]),g.notifications.some(t=>t.type===`pin-lock`&&t.kidId===e.id)||(g.notifications.unshift({id:yh(),type:`pin-lock`,kidId:e.id,msg:`${e.name}'s PIN has been locked after too many failed attempts. Reset it in Settings → Household.`,ts:new Date().toISOString(),read:!1}),J(g))}function ah(e){eh(e),X=0,Pp=0,ta()}function oh(e){return g.budget.months&&g.budget.months[e]||{income:g.budget.income,expenses:g.budget.expenses}}function sh(e){return!!(g.budget.months&&g.budget.months[e])}function ch(e){return g.budget.months||(g.budget.months={}),g.budget.months[e]||(g.budget.months[e]={income:JSON.parse(JSON.stringify(g.budget.income)),expenses:JSON.parse(JSON.stringify(g.budget.expenses))}),g.budget.months[e]}function lh(e){let[t,n]=e.split(`-`).map(Number),r=new Date(t,n-2,1);return`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}`}function uh(e){let t=lh(e),n=oh(t);g.budget.months||(g.budget.months={}),g.budget.months[e]={income:JSON.parse(JSON.stringify(n.income.filter(e=>e.recurring!==!1))),expenses:JSON.parse(JSON.stringify(n.expenses.filter(e=>e.recurring!==!1)))},gp(`Auto-filled`,`${Eh(e)} copied from ${Eh(t)}`),J(g),hh(Ds),hh(Pi)}var dh=null;Object.defineProperty(window,`_scopePending`,{get(){return dh},set(e){dh=e},configurable:!0});function fh(e,t){dh={onThisMonth:e,onAllMonths:t};let n=Eh($);document.getElementById(`modal-title`).textContent=`Apply changes`,document.getElementById(`modal-body`).innerHTML=`
    <p style="font-size:14px;line-height:1.6;margin:0;color:var(--text-muted)">
      Apply this change to <strong style="color:var(--text)">${n}</strong> only,
      or update the default for all months?
    </p>
    ${sh($)?`<p style="font-size:12px;color:var(--primary);margin-top:10px;margin-bottom:0">
  ...
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function ph(){dh&&(dh.onThisMonth(),dh=null),Is()}function mh(){dh&&(dh.onAllMonths(),dh=null),Is()}function hh(e){try{e()}catch(t){let n=t?.message||String(t),r=t?.stack||``;console.error(`Render error in `+(e.name||`?`)+`: `+n+`
`+r),typeof Sentry<`u`&&Sentry.withScope(n=>{n.setTag(`renderer`,e.name||`anonymous`),Sentry.captureException(t)})}}var gh={today:[()=>Wi()],money:[()=>Pi()],dashboard:[()=>ea()],budget:[()=>Ds()],bills:[()=>wt()],networth:[()=>We()],goals:[()=>Za()],scenarios:[()=>co()],insights:[()=>Yo()],build:[()=>sa()],settings:[()=>ta()],kids:[()=>G()],planner:[()=>I()],forecast:[()=>nn()],meals:[()=>Vr()],lunchbox:[()=>ql()],pantry:[()=>Fe()],vehicles:[()=>ce()],documents:[()=>ye()],maintenance:[()=>De()],routines:[()=>W()],lists:[()=>gi()],projects:[()=>B()]},_h=!1;function vh(){Hc(),hh(Wi);let e=gh[x()];e&&e.forEach(e=>hh(e)),_h||(_h=!0,window.Capacitor?.Plugins?.SplashScreen?.hide().catch(()=>{}))}f(vh),y(vh),l(gh,vh);function yh(){return Date.now().toString(36)+Math.random().toString(36).slice(2)}h(Ap()),xm(),setTimeout(()=>{try{vu()}catch{}},0);var $=new Date().toISOString().slice(0,7),bh=`grouped`;Object.defineProperty(window,`budgetViewMode`,{get(){return bh},set(e){bh=e},configurable:!0}),Object.defineProperty(window,`selectedBudgetMonth`,{get(){return $},set(e){$=e},configurable:!0}),window._settingsOpen=new Set([`ai`,`household`]);var xh=`all`;Object.defineProperty(window,`_billsSubsFilter`,{get(){return xh},set(e){xh=e},configurable:!0});var Sh=new Date().getFullYear();Object.defineProperty(window,`dpViewYear`,{get(){return Sh},set(e){Sh=e},configurable:!0});var Ch=new Date().getMonth()+1;Object.defineProperty(window,`dpViewMonth`,{get(){return Ch},set(e){Ch=e},configurable:!0});function wh(){let[e,t]=$.split(`-`).map(Number),n=new Date(e,t-2,1);$=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,Ds()}function Th(){let[e,t]=$.split(`-`).map(Number),n=new Date(e,t,1);if($=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,g.settings&&g.settings.autoFillMonths&&!sh($)){uh($);return}Ds()}function Eh(e){let[t,n]=e.split(`-`).map(Number);return new Date(t,n-1,1).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`})}function Dh(e){let[t,n]=e.split(`-`).map(Number);return new Date(t,n-1,1).toLocaleDateString(`en-AU`,{month:`short`,year:`2-digit`})}function Oh(){let e=[],t=new Date;for(let n=5;n>=0;n--){let r=new Date(t.getFullYear(),t.getMonth()-n,1);e.push(`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}`)}return e}function kh(e,t){let n=(g.budget.actuals[t]||{})[e];return n?typeof n==`number`?[{id:1,amount:n,date:``,note:``}]:Array.isArray(n)?n:[]:[]}function Ah(e,t){return kh(e,t).reduce((e,t)=>e+(t.amount||0),0)}function jh(e,t,n){g.budget.actuals[t]||(g.budget.actuals[t]={});let r=kh(e,t);r.length===1&&!r[0].date&&!r[0].note?g.budget.actuals[t][e]=[{...r[0],amount:n}]:g.budget.actuals[t][e]=[{id:1,amount:n,date:``,note:``}],J(g)}function Mh(e){let t=oh($).expenses.find(t=>t.id===e);if(!t)return;let n=j(t);function r(){let t=kh(e,$),r=t.reduce((e,t)=>e+(t.amount||0),0),i=n>0?Math.round(r/n*100):0,a=i>=100?`var(--danger)`:i>=80?`var(--warning)`:`var(--success)`;return`
      <div style="background:var(--surface2);border-radius:8px;padding:12px 14px;margin-bottom:16px">
        <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:8px">
          ...
          <span style="font-weight:700;font-size:15px">${D(n)}</span>
        </div>
        <div style="background:var(--border);border-radius:99px;height:8px;overflow:hidden;margin-bottom:6px">
          <div style="height:100%;width:${Math.min(100,i)}%;background:${a};border-radius:99px"></div>
        </div>
        <div style="display:flex;justify-content:space-between;font-size:12px">
          <span style="font-weight:600;color:${a}">${D(r)} spent · ${i}%</span>
          <span style="color:${i>=100?`var(--danger)`:`var(--text-muted)`}">${i>=100?`Over by `+D(r-n):D(n-r)+` remaining`}</span>
        </div>
      </div>
      ${t.length>0?`
      <div style="margin-bottom:14px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px">
          ...
          <div style="display:flex;align-items:center;gap:10px;background:var(--surface2);border:1px solid var(--border);border-radius:6px;padding:8px 12px">
            <div style="flex:1">
              <span style="font-weight:600;font-size:13px">${D(t.amount)}</span>
              ${t.date?`<span style="font-size:12px;color:var(--text-muted);margin-left:8px">${k(t.date)}</span>`:``}
              ${t.note?`<span style="font-size:12px;color:var(--text-muted);margin-left:8px">— ${T(t.note)}</span>`:``}
            </div>
        ...
        <div style="display:flex;justify-content:space-between;padding:8px 12px 0;font-size:13px;font-weight:700;border-top:1px solid var(--border);margin-top:8px">
          <span>Total</span><span>${D(r)}</span>
        </div>
      </div>`:`<p style="font-size:13px;color:var(--text-muted);margin-bottom:14px">No entries yet for ${Eh($)}.</p>`}
    ...
    `}document.getElementById(`modal-title`).textContent=`Actuals — ${t.name}`,document.getElementById(`modal-body`).innerHTML=`<div id="actual-editor-body">${r()}</div>`,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-primary" onclick="closeModal();renderBudget()">Done</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Nh(e){let t=parseFloat(document.getElementById(`ae-amount`).value);if(!t||t<=0)return;let n=document.getElementById(`ae-date`).value||``,r=document.getElementById(`ae-note`).value.trim();g.budget.actuals[$]||(g.budget.actuals[$]={});let i=kh(e,$);i.push({id:i.length?Math.max(...i.map(e=>e.id))+1:1,amount:t,date:n,note:r}),g.budget.actuals[$][e]=i,J(g),window._actualEditorRefresh&&window._actualEditorRefresh()}function Ph(e,t){if(!g.budget.actuals[$])return;let n=kh(e,$);n.splice(t,1),g.budget.actuals[$][e]=n,J(g),window._actualEditorRefresh&&window._actualEditorRefresh()}function Fh(e){Mh(e)}function Ih(){let e=oh($),t=M(e.income),n=M(e.expenses),r=t-n,i=t>0?r/t:null,a;a=t===0?10:i>=.2?20:i>=0?Math.round(i/.2*20):0;let o=Oh().slice(3),s=0,c=0;o.forEach(e=>{let t=oh(e);t.expenses.some(t=>kh(t.id,e).length>0)&&(s++,t.expenses.reduce((t,n)=>t+Ah(n.id,e),0)<=M(t.expenses)&&c++)});let l=s===0?5:Math.round(s/3*10+c/s*10),u=(g.netWorth.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),d=(g.netWorth.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),f=u-d,p;if(u===0&&d===0)p=10;else if(f<=0)p=3;else{let e=d>0?d/u:0;p=e<.3?20:e<.6?15:e<.8?10:6}let m;if(n===0)m=10;else{let e=u/n;m=e>=6?20:e>=3?15:e>=1?8:u===0?5:3}let h=(g.goals||[]).filter(e=>e.status!==`achieved`),_;if(h.length===0)_=8;else{let e=h.reduce((e,t)=>e+Math.min((t.saved||0)/(t.target||1),1),0)/h.length;_=10+Math.round(e*10)}let v=a+l+p+m+_,y=v>=85?`A`:v>=70?`B`:v>=55?`C`:v>=40?`D`:`F`,b=v>=80?`#10b981`:v>=60?`#f59e0b`:v>=40?`#f97316`:`#ef4444`,x=[...[{score:a,tip:`Boost your savings rate — aim for 20%+ of income (currently ${t>0?Math.round((i||0)*100):0}%)`},{score:l,tip:`Log actuals monthly in the Budget tab to stay on track`},{score:p,tip:`Reduce liabilities or grow assets to strengthen your net worth`},{score:m,tip:`Build an emergency fund of 3–6 months expenses (${D(n*3)}–${D(n*6)})`},{score:_,tip:`Set specific savings goals in the Goals tab to stay focused`}]].sort((e,t)=>e.score-t.score)[0];return{total:v,grade:y,color:b,insight:x.score<12?x.tip:`Great shape — stay consistent and keep building your financial cushion.`,dimensions:[{label:`Savings Rate`,score:a,max:20},{label:`Budget Tracking`,score:l,max:20},{label:`Net Worth`,score:p,max:20},{label:`Emergency Buffer`,score:m,max:20},{label:`Goals`,score:_,max:20}]}}var Lh={Wallet:`#059669`,Plan:`#0891b2`,Home:`#7c3aed`};function Rh(e){return e?`<span style="font-size:10px;font-weight:700;color:${Lh[e]||`#71717a`};margin-right:6px">${e}</span>`:``}function zh(e){let t={red:`#ef4444`,amber:`#f59e0b`,green:`#10b981`,blue:`#0891b2`}[e.cls]||`#a1a1aa`,n=e.onclick?e.onclick:e.tab?`activateTab('${e.tab}')`:``;return`<div class="notif-tl-item">
    <div class="notif-tl-dot" style="background:${t}"></div>
    <div class="notif-tl-body"><div class="notif-tl-title">${Rh(e.section)}${e.title}</div>${e.sub?`<div class="notif-tl-sub">${e.sub}</div>`:``}</div>
    <div class="notif-tl-action" onclick="${n}">${e.action.replace(` →`,``)}</div>
  </div>`}function Bh(e){let t=[];return e===`budget`&&oh($).expenses.forEach(e=>{let n=j(e),r=Ah(e.id,$);n>0&&r/n>=.8&&r<n?t.push({cls:`amber`,text:`${T(e.name)} at ${Math.round(r/n*100)}% — ${D(n-r)} left`,tab:null}):n>0&&r>=n&&t.push({cls:`red`,text:`${T(e.name)} over budget by ${D(r-n)}`,tab:null})}),t.slice(0,2).map(e=>`<div class="notif-banner ${e.cls}">
    ...
    </div>`).join(``)}function Vh(){let e=[],t=new Date,r=$,i=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`),a=g.kids?.profiles||[],o=a.length>0,s=Math.max(1,i.length)+a.length,c=oh(r),l=c.income.length>0,u=c.expenses.length>0,d=c.expenses.some(e=>kh(e.id,r).length>0),f=(l?30:0)+(u?30:0)+(d?40:0);e.push({key:`budget`,label:`Budget`,score:f,tip:l?u?d?`On track`:`Log actual spending this month`:`Add your expenses`:`Add your income sources`,tab:`budget`});let p=zr(0),m=g.meals?.plan?.[p]||{},h=0,_=s===1?7:s<=3?14:21;for(let e=0;e<7;e++){let t=m[e]||{};s===1?t.d&&h++:s<=3?(t.l&&h++,t.d&&h++):(t.b&&h++,t.l&&h++,t.d&&h++)}let v=Math.round(h/_*80),y=g.lists?.food?.items||[],b=y.filter(e=>e.state===`active`).length,x=y.filter(e=>e.state===`got_it`).length,S=b>0||x>0,C=v+(S?20:0);e.push({key:`meals`,label:`Meals`,score:Math.min(100,C),tip:h===0?`Plan this week's meals`:h<_?`${h}/${_} meals planned`:S?`Meals sorted`:`Add items to your shopping list`,tab:`meals`});let w=g.maintenance||[],T=w.filter(e=>{let t=Ee(e);return t!==null&&t<0}).length,E=w.length===0?30:Math.max(0,100-T*25),ee=g.vehicles||[],te=ee.filter(e=>!!(e.regoExpiry&&Math.ceil((new Date(e.regoExpiry)-t)/864e5)<30||e.insurance?.renewalDate&&Math.ceil((new Date(e.insurance.renewalDate)-t)/864e5)<30)).length,D=g.documents||[],ne=D.filter(e=>e.expiryDate&&Math.ceil((new Date(e.expiryDate)-t)/864e5)<30).length,O=ee.length>0?.3:0,k=.3,re=1-O-k,ie=Math.max(0,Math.min(100,Math.round(E*re+(ee.length>0?Math.max(0,100-te*30)*O:0)+(D.length>0?Math.max(0,100-ne*20):50)*k)));if(e.push({key:`home`,label:`Home`,score:ie,tip:T>0?`${T} maintenance overdue`:te>0?`Vehicle rego or insurance expiring`:ne>0?`Documents expiring soon`:w.length===0?`Add maintenance items to track`:`Home is sorted`,tab:`maintenance`}),o){let t=g.meals?.lunchbox?.plans||{},n=zr(0),r=0,i=a.length*20;a.forEach(e=>{let i=(t[n]||{})[e.id]||{};for(let e=0;e<5;e++){let t=i[e]||{};t.main&&r++,t.snack&&r++,t.fruit&&r++,t.drink&&r++}}),typeof U==`function`?U():new Date().toISOString().slice(0,10).replace(/-/g,``);let o=g.kids?.chores||[],s=g.kids?.completions||[],c=s.filter(e=>e.status===`pending`).length,l=s.filter(e=>e.status===`approved`&&e.completedAt?.startsWith(new Date().toISOString().slice(0,10))).length,u=o.length===0?50:Math.max(0,100-c*10+l*5),d=i>0?Math.round(r/i*100):50,f=Math.min(100,Math.round(d*.5+Math.min(100,u)*.5));e.push({key:`family`,label:`Family`,score:f,tip:r===0?`Plan school lunches this week`:c>0?`${c} chore approval${c===1?``:`s`} waiting`:`Family is sorted`,tab:`kids`})}let ae=g.goals||[],A=ae.filter(e=>e.status===`active`),oe=A.length>0?A.reduce((e,t)=>e+Math.min((t.saved||t.currentAmount||0)/(t.target||t.targetAmount||1),1),0)/A.length*100:0,j=ae.length===0?20:Math.round(30+oe*.7);e.push({key:`goals`,label:`Goals`,score:Math.min(100,j),tip:ae.length===0?`Set a savings or spending goal`:oe<30?`Make progress on your goals`:`Goals progressing well`,tab:`goals`});let M=typeof Cu==`function`?Cu():[];if(M.length>0){let t=typeof U==`function`?U():new Date().toISOString().slice(0,10).replace(/-/g,``),n=M.filter(e=>{let n=(e.completions?.[t]||[]).length;return e.steps.length>0&&n===e.steps.length}),r=Math.round(n.length/M.length*100),i=M.reduce((e,t)=>{let n=typeof Pu==`function`?Pu(t):0;return Math.max(e,n)},0),a=Math.min(40,Math.round(i/10*40)),o=Math.min(100,20+Math.round(r*.4)+a);e.push({key:`habits`,label:`Habits`,score:o,tip:n.length===0?`Complete a routine today`:i<3?`Keep your streak going`:`${i}-day streak — keep it up`,tab:`routines`})}let N=new Date().toISOString().slice(0,10),se=new Date(Date.now()+7*864e5).toISOString().slice(0,10),ce=(g.planner?.events||[]).filter(e=>e.date>=N&&e.date<=se).length,le=(g.bills||[]).filter(e=>{let t=n(e);return t!==null&&t<0}).length,ue=(g.documents||[]).filter(e=>e.expiryDate&&new Date(e.expiryDate)<t).length,de=Math.min(100,Math.round((ce>0?40:10)+Math.max(0,30-le*15)+Math.max(0,30-ue*15)));return e.push({key:`plan`,label:`Plan`,score:de,tip:le>0?`${le} bill${le===1?``:`s`} overdue`:ue>0?`${ue} document${ue===1?``:`s`} expired`:ce===0?`Add something to your calendar`:`Plan looks good`,tab:`planner`}),{total:Math.round(e.reduce((e,t)=>e+t.score,0)/e.length),dims:e}}function Hh(){let e=Vh();new Date().toISOString().slice(0,10);let t=g.settings?.typeADismissedMission||``,n=[...e.dims].sort((e,t)=>e.score-t.score),r=[];return n.forEach(e=>{if(e.key===`budget`&&e.score<70&&(oh($).income.length?oh($).expenses.length?r.push({id:`log-actuals`,title:`Log this month's actual spending`,sub:`Import a bank statement or add manually`,tab:`budget`,impact:30}):r.push({id:`add-expenses`,title:`Set up your monthly expenses`,sub:`List your regular costs`,tab:`budget`,impact:35}):r.push({id:`add-income`,title:`Add your income sources`,sub:`Takes about 1 minute`,tab:`budget`,impact:40})),e.key===`meals`&&e.score<70){let e=zr(0),t=g.meals?.plan?.[e]||{},n=Object.values(t).filter(e=>e.d).length,i=(g.lists?.food?.items||[]).filter(e=>e.state===`active`).length;n<3?r.push({id:`plan-dinners`,title:`Plan this week's dinners`,sub:`Just the evening meals — takes 2 minutes`,tab:`meals`,impact:25}):i===0&&r.push({id:`shopping-list`,title:`Add items to your shopping list`,sub:`Start with essentials you need this week`,tab:`lists`,impact:15})}if(e.key===`home`&&e.score<70){let e=(g.maintenance||[]).filter(e=>{let t=Ee(e);return t!==null&&t<0});e.length?r.push({id:`maint-overdue`,title:`Clear overdue: ${T(e[0].name)}`,sub:`Mark it done or reschedule`,tab:`maintenance`,impact:20}):(g.maintenance||[]).length||r.push({id:`setup-maint`,title:`Set up household maintenance`,sub:`Add items like gutters, pest control, smoke alarms`,tab:`maintenance`,impact:20})}if(e.key===`family`&&e.score<70){let e=(g.kids?.completions||[]).filter(e=>e.status===`pending`).length,t=g.kids?.profiles||[];e>0?r.push({id:`approve-chores`,title:`Review ${e} chore approval${e===1?``:`s`}`,sub:`Kids are waiting for your sign-off`,tab:`kids`,impact:20}):t.length>0&&r.push({id:`plan-lunchbox`,title:`Plan school lunches this week`,sub:`AI can do it in one tap`,tab:`lunchbox`,impact:18})}if(e.key===`goals`&&e.score<50&&((g.goals||[]).length||r.push({id:`add-goal`,title:`Set your first savings goal`,sub:`Holiday fund, emergency savings, or debt payoff`,tab:`goals`,impact:15})),e.key===`habits`&&e.score<70&&((typeof Cu==`function`?Cu():[]).length===0?r.push({id:`create-routine`,title:`Create your first daily routine`,sub:`Morning or evening — takes 2 minutes to set up`,tab:`routines`,impact:25}):r.push({id:`complete-routine`,title:`Complete a routine today`,sub:`Tap each step as you go`,tab:`today`,impact:20})),e.key===`plan`&&e.score<70){let e=new Date().toISOString().slice(0,10),t=new Date(Date.now()+7*864e5).toISOString().slice(0,10);(g.planner?.events||[]).filter(n=>n.date>=e&&n.date<=t).length===0?r.push({id:`add-event`,title:`Add something to your calendar`,sub:`Even one event this week helps keep life organised`,tab:`planner`,impact:15}):r.push({id:`review-bills`,title:`Review upcoming bills`,sub:`Make sure nothing catches you off guard`,tab:`bills`,impact:15})}}),r.filter(e=>e.id!==t).sort((e,t)=>t.impact-e.impact)[0]||null}function Uh(e){g.settings||(g.settings={}),g.settings.typeADismissedMission=e,J(g);let t=document.querySelector(`.mission-lightbox`);t&&t.remove(),Wi()}function Wh(e){g.settings||(g.settings={}),g.settings.typeAMissionId=``,g.settings.typeAMissionShownDate=``,g.settings.typeADismissedMission=e,J(g);let t=document.querySelector(`.mission-lightbox`);t&&t.remove()}function Gh(){let e=g.settings?.typeAMissionShownDate;if(!e)return 0;let t=Math.floor((new Date-new Date(e))/864e5);return Math.max(0,t)}function Kh(e){if(document.querySelector(`.mission-lightbox`))return;let t=Gh(),n=e.onclick?e.onclick:e.tab?`activateTab('${e.tab}')`:``,r=document.createElement(`div`);r.className=`mission-lightbox`,r.innerHTML=`
    ...
    </div>`,r.addEventListener(`click`,t=>{t.target===r&&Uh(e.id)}),document.body.appendChild(r)}function qh(){if(!g.settings?.typeAMode)return;let e=Hh();if(!e)return;let t=new Date().toISOString().slice(0,10);if(g.settings.typeAMissionId!==e.id){g.settings.typeAMissionId=e.id,g.settings.typeAMissionShownDate=t,J(g);return}Gh()>=1&&setTimeout(()=>Kh(e),1500)}function Jh(){Vh();let e=oh($),t=e.expenses.reduce((e,t)=>e+Ah(t.id,$),0),r=M(e.expenses),i=zr(1),a=g.meals?.plan?.[i]||{},o=Object.values(a).reduce((e,t)=>e+ +!!t.b+ +!!t.l+ +!!t.d,0),s=(g.maintenance||[]).filter(e=>{let t=Ee(e);return t!==null&&t<0}).length,c=(g.bills||[]).filter(e=>{let t=n(e);return t>=0&&t<=7}),l=(g.meals?.pantry||[]).filter(e=>e.status===`need`||e.status===`low`).length,u=document.createElement(`div`);u.className=`reset-overlay`,u.innerHTML=`
    <div class="reset-card">
      ...
      <div class="reset-step">
        ...
        <div class="reset-step-sub">${t>0?`You've spent ${D(t)} of ${D(r)} budgeted`:`No actuals logged yet this month`}</div>
      ...
      <div class="reset-step">
        ...
        <div class="reset-step-sub">${c.length>0?`${c.length} bill${c.length===1?``:`s`} due this week — ${D(c.reduce((e,t)=>e+(parseFloat(t.amount)||0),0))}`:`No bills due this week`}</div>
        <div class="reset-step-actions">
    ...
    </div>`,u.addEventListener(`click`,e=>{e.target===u&&u.remove()}),document.body.appendChild(u)}function Yh(){let e=document.querySelector(`.reset-overlay`);e&&e.remove(),g.settings||(g.settings={});let t=new Date().toISOString().slice(0,10),n=g.settings.typeALastResetDate||``;n&&Math.floor((new Date-new Date(n))/864e5)<=9?g.settings.typeAStreak=(g.settings.typeAStreak||0)+1:g.settings.typeAStreak=1,g.settings.typeALastResetDate=t,J(g),Wi()}function Xh(){let e=Vh(),t=2*Math.PI*22,n=(e.total/100*t).toFixed(1),r=e.total>=80?`var(--good,#10b981)`:e.total>=60?`var(--iris-2)`:e.total>=40?`var(--amber,#f59e0b)`:`var(--ember,#f97316)`,i=e.total>=80?`Crushing it — keep going`:e.total>=60?`Good shape — a few things to tidy`:e.total>=40?`Getting there — some gaps to fill`:`Just getting started`,a=Vt?`▲`:`▼`,o=e.dims.map(e=>{let t=e.score>=75?`var(--good,#10b981)`:e.score>=50?`var(--iris-2)`:e.score>=30?`var(--amber,#f59e0b)`:`var(--ember,#f97316)`,n=e.score>=75?`var(--good,#10b981)`:e.score>=50?`var(--iris-1)`:e.score>=30?`var(--amber,#f59e0b)`:`var(--ember,#f97316)`;return`<div class="life-dim">
  ...
  </div>`}function Zh(){let e=Hh();if(!e)return``;let t=Gh(),n=e.onclick?`onclick="${e.onclick}"`:e.tab?`onclick="activateTab('${e.tab}')"`:``;return`<div class="mission-card" ${n}>
  ...
  </div>`}function Qh(){let e=oh($),t=g.householdProfile?.members||[],n=t.filter(e=>e.role===`adult`),r=t.filter(e=>e.role===`child`),i=[];if(i.push({id:`members`,label:`Add your household members`,done:n.length>0,tab:null}),i.push({id:`income`,label:`Set up income sources`,done:(e.income||[]).length>0,tab:`budget`}),i.push({id:`expenses`,label:`Add monthly expenses`,done:(e.expenses||[]).length>0,tab:`budget`}),r.length>0&&i.push({id:`kids`,label:`Add kids to your household`,done:!0,tab:null}),n.length>=2){let e=n[1]?.name||`your partner`,t=(g.householdProfile.authorizedUsers||[]).length>0||(g.householdProfile.invites||[]).some(e=>e.status===`accepted`);i.push({id:`invite`,label:`Invite ${e} to your household`,done:t,tab:`settings`,settingsSection:`household-access`})}if(i.push({id:`goals`,label:`Set your first savings goal`,done:(g.goals||[]).length>0,tab:`goals`}),i.push({id:`networth`,label:`Add your net worth (assets & debts)`,done:(g.netWorth?.assets||[]).length>0||(g.netWorth?.liabilities||[]).length>0,tab:`networth`}),i.push({id:`vehicles`,label:`Add your vehicles`,done:(g.vehicles||[]).length>0,tab:`vehicles`}),r.length>0){let e=r[0]?.name||`your child`;i.push({id:`chores`,label:`Set up ${T(e)}'s first chores`,done:(g.kids?.chores||[]).length>0,tab:`kids`})}return i}var $h=!1;Object.defineProperty(window,`_spExpanded`,{get(){return $h},set(e){$h=e},configurable:!0});var eg=!1;Object.defineProperty(window,`_spDoneExpanded`,{get(){return eg},set(e){eg=e},configurable:!0});function tg(){let e=document.getElementById(`setup-progress-card`);e&&(e.innerHTML=Fi())}var ng=null;Object.defineProperty(window,`expenseSortCol`,{get(){return ng},set(e){ng=e},configurable:!0});var rg=`asc`;Object.defineProperty(window,`expenseSortDir`,{get(){return rg},set(e){rg=e},configurable:!0});var ig=`all`;Object.defineProperty(window,`expenseFilterCat`,{get(){return ig},set(e){ig=e},configurable:!0});function ag(e){ig=e,Ds()}function og(e){rg=ng===e&&rg===`asc`?`desc`:`asc`,ng=e,Ds()}function sg(e,t,n=``){let r=ng===e;return`<th class="sortable${r?` sort-active`:``}" onclick="sortExpenses('${e}')">${t}${n}<span class="sort-icon">${r?rg===`asc`?`↑`:`↓`:`↕`}</span></th>`}function cg(e){let t=[`th`,`st`,`nd`,`rd`],n=e%100;return e+(t[(n-20)%10]||t[n]||t[0])}var lg=`plan`;Object.defineProperty(window,`_mealView`,{get(){return lg},set(e){lg=e},configurable:!0}),window._acceptInviteAndContinue=jm,window._addRecurrenceToDate=pr,window._adultPinKey=$c,window._adultPinSubmit=el,window._applyActiveProfile=sm,window._applyChildNav=Hc,window._applyMigrations=bp,window._autoCreateRecurringEvents=mr,window._briefIcon=Ri,window._briefRow=Ui,window._budgetAllocByCategory=Cs,window._toggleAllocExpanded=As,window._budgetShowAddMenu=js,window._budgetScrollTo=Ms,window._budgetExpenseMenu=Ns,window._budgetRenderReport=Ps,window._buildTotoContext=Er,window._capacitorPrefs=Lp,window._categoryIcon=Es,window._checkInviteOnLoad=xm,window._checkMissionEscalation=qh,window._checkSettingsUnsaved=ps,window._chipClassFor=zi,window._chipLabelFor=Bi,window._copyInviteLinkForMember=hm,window._csOpen=Dp,window._csvSetExpense=Oc,window._csvToggle=Ec,window._csvToggleAll=Dc,window._csvUpdateApplyBtn=kc,window._cvAgeBracket=tl,window._cvCalViewToggle=Cl,window._cvConfetti=al,window._cvDismissNotif=kl,window._cvEventsForDate=hl,window._cvFmt12h=gl,window._cvMonthDayTap=Dl,window._cvRefreshSchedulePanel=yl,window._cvRender7Day=wl,window._cvRenderCalendar=Sl,window._cvRenderMonth=El,window._cvRenderPrizesTab=cl,window._cvRoutineAvailLabel=il,window._cvRoutineIsActive=rl,window._cvRoutineSchedCard=xl,window._cvScheduleHtml=bl,window._cvShowDayDetail=Ol,window._cvShowPrizeConfirm=Al,window._cvSwitchTab=ml,window._cvTimeGreeting=nl,window._cvToggleRoutineExpand=_l,window._cvToggleStepFromCal=vl,window._cvUpdatePrizesBadge=sl,window._cvWeekDayTap=Tl,window._devLoadAll=Hl,window._devLoadHome=Bl,window._devLoadKids=Ll,window._devLoadMeals=Vl,window._devLoadPlanner=zl,window._devLoadRoutines=Rl,window._devLoadWallet=Il,window._devReset=Ul,window._devToolsClose=Fl,window._devToolsOpen=Pl,window._dismissInviteFlow=Im,window._docCatMeta=ve,window._ensureKidProfileAndPin=mm,window._ensureNWModals=Qe,window._estimateMealCalories=Zr,window._fetchAIBriefing=$i,window._finishInviteJourney=Nm,window._getHouseholdDocRef=dp,window._getHouseholdOwnerUID=up,window._getInviteUrl=gm,window._getNthDayOfMonth=ur,window._getPinTotalAttempts=Qm,window._handlePendingInvite=Sm,window._hashPin=Yp,window._incPinTotalAttempts=$m,window._inferAisle=Fr,window._initAuthListener=Sp,window._isPinHardLocked=th,window._listsAddFavourite=pi,window._listsAddItem=ii,window._listsAddUsual=mi,window._listsArchive=fi,window._listsClearTrolley=di,window._listsDeleteItem=oi,window._listsOpenAddForm=ci,window._listsQuickAdd=si,window._listsSaveForm=ui,window._listsSetState=ai,window._listsUpdateParsePreview=hi,window._maintDaysUntil=Ee,window._maintNextDue=Te,window._markSettingsDirty=us,window._mealGetSuggestions=Yr,window._mealPill=Kr,window._mealPriceSlide=Jr,window._mealToggleFilter=qr,window._mealWeekDates=Br,window._mealWeekKey=zr,window._missionDaysIgnored=Gh,window._nextForecastMonth=tn,window._pantryToAisle=li,window._parseShopInput=Ir,window._pickAdult=em,window._pickKid=tm,window._pinKey=am,window._plannerCloseDaySheet=yn,window._plannerCloseDetail=En,window._plannerCloseLifeSheet=Cn,window._plannerCloseShare=An,window._plannerCopyShareUrl=Mn,window._plannerEditFromDetail=On,window._plannerEvMemberIds=Kt,window._plannerEvPrimaryMember=qt,window._plannerEvWhoLabel=Jt,window._plannerEventsForDate=Zt,window._plannerFmt12h=Qt,window._plannerGoToday=pn,window._plannerHandleDaySheetClick=bn,window._plannerHandleDetailClick=Dn,window._plannerHandleLifeSheetClick=wn,window._plannerHandleShareClick=jn,window._plannerMemberById=Gt,window._plannerMembers=Wt,window._plannerNextMonth=ln,window._plannerNudges=Pn,window._plannerOpenDaySheet=_n,window._plannerOpenDetail=Tn,window._plannerOpenLifeSheet=Sn,window._plannerOpenModalFromSheet=xn,window._plannerOpenShare=kn,window._plannerPrevMonth=cn,window._plannerRecurrenceLabel=Yt,window._plannerRenderDaySheetList=vn,window._plannerSelectDay=un,window._plannerSetView=mn,window._plannerShareVia=Nn,window._plannerToggleFilter=gn,window._plannerToggleSection=hn,window._plannerVisibleEvents=Xt,window._pmDpClear=rr,window._pmDpNext=or,window._pmDpOpen=$n,window._pmDpOutsideClick=er,window._pmDpPrev=ar,window._pmDpRender=tr,window._pmDpSelect=nr,window._pmDpToday=ir,window._pmFmtDate=qn,window._pmFmtDateShort=Jn,window._pmHandleCatChange=Qn,window._pmRenderMemberPicker=Yn,window._pmToggleAllDay=Zn,window._pmToggleMember=Xn,window._prevForecastMonth=en,window._psoHoldEnd=Jm,window._psoHoldStart=qm,window._psoKey=Ym,window._psoRender=Km,window._psoSubmit=Xm,window._psoTourDone=Zm,window._pushAllEventsToBudget=lr,window._qaKey=zc,window._qaSelectCat=Bc,window._qahAction=Fc,window._qahApplyParsed=Lc,window._qahSendText=Ic,window._recordInviteAcceptance=Mm,window._refreshSetupProgress=tg,window._renderAdultPinModal=Qc,window._renderApiKeySummary=_s,window._renderContextBanners=Bh,window._renderCsvPreview=Cc,window._renderCsvReview=Tc,window._renderInviteFlow=Fm,window._renderLifeAreas=Hi,window._renderLifeScore=Xh,window._renderListItem=yi,window._renderListsDetail=vi,window._renderListsSelector=_i,window._renderMealPlan=Hr,window._renderMissionCard=Zh,window._renderNudgeSection=fr,window._renderPinDots=rm,window._renderPinPad=im,window._renderPlannerAgenda=dn,window._renderPlannerEventRow=sn,window._renderPlannerMonthGrid=an,window._renderPlannerWeekStrip=on,window._renderQAHub=Pc,window._renderQASheet=Rc,window._renderShoppingList=Qr,window._renderTourSlide=Om,window._renderWeekStrip=Vi,window._resetPinAttempts=eh,window._saveInviteIncome=Am,window._sectionTag=Rh,window._secureClear=Vp,window._secureGet=zp,window._securePrewarm=Rp,window._secureSet=Bp,window.prefsGet=zp,window.prefsSet=Bp,window.prefsClear=Vp,window._setHouseholdOwner=fp,window._setInviteRole=dm,window._setPinHardLock=nh,window._showInviteA1=Cm,window._showInviteA3=wm,window._showInviteA4=Dm,window._showInviteExpired=Pm,window._showInviteIncomePrompt=km,window._showMissionLightbox=Kh,window._showParentLockNotification=ih,window._showPinScreen=nm,window._showToast=ri,window._startFirestoreSync=xp,window._syncVehicleBill=de,window._tdCloseSheet=Ji,window._tdOpenHeadsUpSheet=Gi,window._tdOpenSheet=qi,window._tdOpenSlippingSheet=Ki,window._tdToggleStep=Yi,window._ticker=Ts,window._tlItem=zh,window._todayAllocSegments=Li,window._totoAppendMessage=Dr,window._totoInitPanel=Sr,window._totoRemoveTyping=kr,window._totoSend=Tr,window._totoSendSuggestion=Cr,window._totoShowTyping=Or,window._updatePillsOverflow=S,window._updateSwitchBtn=om,window._verifyPin=rh,window.activateTab=w,window.addActualEntry=Nh,window.addCatToGroup=as,window.addCategory=bs,window.addHouseholdMember=Oo,window.addPet=jo,window.addShopItem=$r,window.addSubFromImport=_t,window.adjForm=go,window.applianceForm=Di,window.applianceFromForm=Oi,window.applyCsvImport=Ac,window.approveSuggestion=Rn,window.assignDevice=Qp,window.aud=D,window.audD=ne,window.billCatIcon=xt,window.billDueBadge=St,window.billMonthlyEquiv=Ct,window.billsModal=Dt,window.calcFinancialHealth=Ih,window.calcLifeScore=Vh,window.calcScenario=so,window.cancelSettingsChanges=fs,window.clearActivityLog=ys,window.clearAdultPin=qc,window.clearCheckedShopItems=ni,window.clearDeviceProfile=Wp,window.clearKidPin=Gc,window.clearKidSession=qp,window.closeBillModal=kt,window.closeModal=Is,window.closeNWModal=et,window.closeNWTargetModal=Ye,window.closePinSetupOverlay=Gm,window.closeQuickAdd=Nc,window.closeSubModal=pt,window.closeTotoAssistant=xr,window.completeMission=Wh,window.completeWeeklyReset=Yh,window.confirmScope=fh,window.copyInviteLink=_m,window.copyMonthFromPrevious=uh,window.customSelect=Ep,window.cyclePantryStatus=Ie,window.deleteAdjustment=yo,window.deleteAppliance=ji,window.deleteBill=Mt,window.deleteCategoryGroup=rs,window.deleteDoc=Se,window.deleteExpense=uc,window.deleteExtra=$s,window.deleteFurniture=Ei,window.deleteGoal=ro,window.deleteIncome=ic,window.deleteMaint=Ae,window.deleteNWItem=nt,window.deletePantryItem=ze,window.deletePlannerEvent=Hn,window.deleteScenario=ho,window.deleteService=he,window.deleteStage=Hs,window.deleteSub=ht,window.deleteVariation=qs,window.deleteVehicle=fe,window.detectSpendingPatterns=Vo,window.dismissMission=Uh,window.dismissSubResult=vt,window.dismissSuggestion=zn,window.doScopeAll=mh,window.doScopeMonth=ph,window.dpClearDate=_c,window.dpDateInput=dc,window.dpNextMonth=hc,window.dpPrevMonth=mc,window.dpSelectDate=gc,window.editActual=Fh,window.ensureMonthOverride=ch,window.escAttr=E,window.escHtml=T,window.estimateAllEvents=rn,window.estimatePlannerEvent=Un,window.expenseCategories=ca,window.expenseForm=ac,window.expenseFromForm=oc,window.exportData=ra,window.extraForm=Ys,window.extraFromForm=Xs,window.fmtDate=k,window.fmtNW=O,window.freqDisplay=ae,window.freqDisplayItem=A,window.freqLabel=ie,window.freqLabelItem=oe,window.furnitureForm=Si,window.furnitureFromForm=Ci,window.generateInvite=fm,window.generateMission=Hh,window.generateShoppingList=bi,window.generateSmartInsights=Wo,window.generateSmartInsightsHTML=Xo,window.getAIKey=Ro,window.getActual=Ah,window.getActualEntries=kh,window.getBenchmarkStatus=Io,window.getBenchmarks=Fo,window.getCategoryHistoryData=Bo,window.getDeviceProfile=Hp,window.getKidSession=Gp,window.getLast6Months=Oh,window.getMonthData=oh,window.getSeasonalNudges=dr,window.goToPlannerDay=fn,window.goalForm=Qa,window.goalFromForm=eo,window.goalProgress=ua,window.guestMode=vp,window.handleCsvFile=Sc,window.handleDeviceRouting=Xp,window.handleSubCSV=gt,window.importData=ia,window.incomeCategories=la,window.incomeForm=ec,window.incomeFromForm=tc,window.inviteMember=pm,window.isMonthCustomized=sh,window.isOverdue=re,window.itemMonthly=j,window.loadColors=So,window.loadData=Ap,window.logActivity=gp,window.markBillPaid=Nt,window.markChoreChildView=jl,window.markGoalAchieved=io,window.markMaintDone=je,window.monthLabel=Eh,window.monthShortLabel=Dh,window.monthlyTotal=M,window.nextId=N,window.nextInsightsMonth=Qo,window.nextMoneyMonth=Ni,window.nextMonth=Th,window.nwItemRow=Ge,window.openActualEditor=Mh,window.openAddAdjustment=vo,window.openAddAppliance=ki,window.openAddCatToGroup=os,window.openAddCategoryGroup=ts,window.openAddExpense=cc,window.openAddExtra=Zs,window.openAddFurniture=wi,window.openAddGoal=to,window.openAddIncome=nc,window.openAddScenario=po,window.openAddStage=Bs,window.openAddVariation=Gs,window.openBillModal=Ot,window.openCsvImport=bc,window.openDatePicker=fc,window.openDocForm=be,window.openEditAppliance=Ai,window.openEditContractTotal=Ls,window.openEditExpense=lc,window.openEditExtra=Qs,window.openEditFurniture=Ti,window.openEditGoal=no,window.openEditIncome=rc,window.openEditScenario=mo,window.openEditStage=Vs,window.openEditVariation=Ks,window.openEmojiPickerModal=es,window.openIconPickerForGroup=ns,window.openMaintForm=Oe,window.openMealEdit=Gr,window.openModal=V,window.openNWModal=$e,window.openNWTargetModal=Je,window.openNavGroupFor=sp,window.openPantryForm=Le,window.openPinSetup=Wm,window.openPlannerModal=Kn,window.openQuickAdd=Mc,window.openServiceForm=pe,window.openSubModal=ft,window.openTotoAssistant=br,window.openVehicleForm=le,window.openWeeklyReset=Jh,window.ordinal=cg,window.pantryToShoppingList=Ve,window.parseBankCSV=xc,window.prevInsightsMonth=Zo,window.prevMoneyMonth=Mi,window.prevMonth=wh,window.prevMonthStr=lh,window.profileAdults=Eo,window.profileChildren=Do,window.quickAddMaint=Me,window.quickAddPantry=Be,window.redeemPrizeChildView=Ml,window.removeActualEntry=Ph,window.removeApiKey=gs,window.removeCatFromGroup=ss,window.removeCategory=xs,window.removeHouseholdMember=ko,window.removePet=Mo,window.removeShopItem=ti,window.renderAll=vh,window.renderBenchmarksSection=Jo,window.renderBills=wt,window.renderBudget=Ds,window.renderBudgetForecast=cr,window.renderBudgetSuggestions=Bn,window.renderBuild=sa,window.renderCategoryBreakdown=Ho,window.renderDashboard=ea,window.renderDocuments=ye,window.renderDpCalendar=pc,window.renderExpenseGroups=Ss,window.renderForecast=nn,window.renderGoals=Za,window.renderInsightCards=qo,window.renderInsights=Yo,window.renderLists=gi,window.renderLunchbox=ql,window.renderMaintenance=De,window.renderMeals=Vr,window.renderMoneyDashboard=Pi,window.renderNWDebtCard=qe,window.renderNWTargetCard=Ke,window.renderNWTrend=Ze,window.renderNetWorth=We,window.renderPantry=Fe,window.renderPlanner=I,window.renderRoutines=W,window.renderScenarios=co,window.renderSettings=ta,window.renderSetupProgress=Fi,window.renderSpendingPatterns=Uo,window.renderSubImportResults=dt,window.renderSubscriptions=Et,window.renderToday=Wi,window.renderVehicles=ce,window.resetAllData=na,window.resetKidPinLock=ah,window.revokeInvite=ym,window.runAIInsights=Ko,window.runCsvCategorise=wc,window.safeRender=hh,window.sanitiseState=se,window.saveAIKey=zo,window.saveApiKey=hs,window.saveBill=jt,window.saveColors=Co,window.saveData=J,window.saveDoc=xe,window.saveMaint=ke,window.saveMealSlot=Xr,window.saveNWItem=tt,window.saveNWSnapshot=rt,window.saveNWTarget=Xe,window.savePantryItem=Re,window.savePlannerEvent=sr,window.saveQuickAdd=Vc,window.saveService=me,window.saveSettingsChanges=ds,window.saveSub=mt,window.saveVehicle=ue,window.scenarioForm=uo,window.scenarioFromForm=fo,window.sendInviteEmail=vm,window.sendTotoMessage=wr,window.setActual=jh,window.setAdultPin=Kc,window.setBillsFilter=Tt,window.setBudgetView=oa,window.setDeviceProfile=Up,window.setExpenseFilter=ag,window.setKidPin=Wc,window.setKidSession=Kp,window.setupProgressTasks=Qh,window.showChildView=ol,window.showDeviceSetup=Zp,window.showProfileSelector=$p,window.signInWithGoogle=_p,window.signOutUser=yp,window.sortExpenses=og,window.stageForm=Rs,window.stageFromForm=zs,window.subCatIcon=st,window.subMonthlyAmount=ct,window.suggestEventToBudget=Ln,window.switchProfile=Uc,window.switchToKidMode=Nl,window.thSort=sg,window.toggleAdjFields=_o,window.toggleBillDayField=At,window.toggleBudgetDetail=Fs,window.toggleCustomFreq=sc,window.toggleGoalFields=$a,window.toggleGroupExpand=aa,window.toggleInsightSheet=Xi,window.toggleNavGroup=op,window.togglePlannerCard=Fn,window.togglePlannerEstimate=In,window.toggleScenario=lo,window.toggleSettingsSection=vs,window.toggleShopItem=ei,window.toggleSidebar=ip,window.toggleTotoAssistant=yr,window.uid=yh,window.DEFAULT_DATA=kp,window.unpushEventFromBudget=Vn,window.updateCars=Po,window.updateCategoryGroup=is,window.updateColor=To,window.updateMember=Ao,window.updatePet=No,window.updateSetting=ms,window.upgradeSelects=Op,window.variationForm=Us,window.variationFromForm=Ws,window.LB_ALLERGIES=Kl,window.LB_SLOTS=Gl,window._estimateLbCalories=$l,window._lbActiveKid=Wl,window._lbWeekOffset=0,window._saveLbSlot=Ql,window.aiPlanLunchbox=eu,window.deleteLbProfile=Xl,window.lbToShoppingList=tu,window.openLunchboxEdit=Zl,window.openLunchboxProfile=Jl,window.saveLbProfile=Yl,window.HEALTH_GUIDES=fu,window._cleanupGuide=du,window._cvReadOnly=mu,window._cvViewCalendar=gu,window._guideCleanup=au,window._guideIdx=iu,window._guideSteps=ru,window._highlightStep=cu,window._recurrenceMatchesDate=Pt,window._showGuideStep=su,window.endGuide=uu,window.exitChildView=_u,window.nextGuideStep=lu,window.startGuide=ou,window.startHealthGuide=pu,window.toggleHealthPopover=nu,window.viewChildToday=hu,window.ROUTINE_SUGGESTIONS=bu,window.SUGG_PREVIEW=3,window._assignmentCompletedToday=Au,window._assignmentHistory=Mu,window._assignmentStreak=ju,window._renderAdultRoutines=Uu,window._renderChildRoutines=Zu,window._renderRoutinesTodayCard=Bu,window._renderSuggestionsSection=Ju,window._routineActiveTab=Vu,window._routineAddStep=md,window._routineAddSuggestion=Xu,window._routineAssertScope=Lu,window._routineAvailableSuggestions=Iu,window._routineAwardPoints=nd,window._routineAwardStepPoints=td,window._routineCheckDailyReset=vu,window._routineCompletedToday=Nu,window._routineCreate=Ed,window._routineCurrentUserId=Su,window._routineDateKey=xu,window._routineDelete=Od,window._routineDeleteChild=Qu,window._routineDeleteStep=vd,window._routineDragEnd=pd,window._routineDragIdx=ld,window._routineDragOver=dd,window._routineDragStart=ud,window._routineDrop=fd,window._routineDuplicateFromJoined=Fd,window._routineDuplicateTo=Nd,window._routineEdit=_d,window._routineEditStep=yd,window._routineEditSuggestion=Yu,window._routineExpandSugg=qu,window._routineGetAssignment=ku,window._routineHistory=Fu,window._routineIntelNudge=zu,window._routineIsOwner=Tu,window._routineJoin=Pd,window._routineKids=Eu,window._routineLeave=kd,window._routineManageAssignments=bd,window._routineMatchesDate=yu,window._routineNextId=Du,window._routineOtherAdults=Ou,window._routinePauseMenu=ad,window._routinePropagateStepAdd=hd,window._routinePropagateStepDelete=gd,window._routineRecurrenceCollect=Td,window._routineRecurrenceFormHtml=Sd,window._routineRecurrenceSummaryUpdate=wd,window._routineRecurrenceTypeChange=Cd,window._routineRemovePause=od,window._routineResetToday=rd,window._routineResetTodayAllKids=cd,window._routineResetTodayKid=sd,window._routineSaveValidated=Ru,window._routineSetTab=Hu,window._routineShareMenu=jd,window._routineShowHistory=Id,window._routineSkipDay=id,window._routineStreak=Pu,window._routineSuggCollapsed=Wu,window._routineSuggExpanded=Gu,window._routineTodayKey=U,window._routineToggleAssignment=xd,window._routineToggleShare=Md,window._routineToggleStep=$u,window._routineToggleStepKid=ed,window._routineToggleSugg=Ku,window._routineTypeSelect=Dd,window._routineUnassign=Ad,window._routinesForCurrentUser=Cu,window._routinesForHousehold=wu,window.CHILD_EVENT_EMOJIS=Jd,window.CHORE_EMOJIS=sf,window.KID_EMOJIS=of,window.PRIZE_EMOJIS=cf,window._deleteChildEvent=Xd,window._openChildEventModal=Yd,window._renderChildEventsMgmt=qd,window.addSavings=xf,window.approveCompletion=Qd,window.approveRedemption=tf,window.deleteChore=rf,window.deleteKid=hf,window.deletePrize=af,window.emojiPicker=lf,window.kidBalance=Bd,window.kidsParentTab=Rd,window.kidsView=Ld,window.markChoreDone=Zd,window.openAddKidModal=ff,window.openChoreModal=gf,window.openEditKidModal=pf,window.openPrizeModal=vf,window.openSavingsModal=bf,window.pickEmoji=uf,window.pickedEmoji=df,window.rejectCompletion=$d,window.rejectRedemption=nf,window.renderApprovals=Gd,window.renderChoreMgmt=Ud,window.renderKidView=Kd,window.renderKids=G,window.renderKidsOverview=Hd,window.renderKidsParent=Vd,window.renderPrizeMgmt=Wd,window.requestRedemption=ef,window.saveChore=_f,window.saveKid=mf,window.savePrize=yf,window.addLink=Ff,window.attachBtn=Af,window.deleteReceiptById=Of,window.fileIcon=Mf,window.fileSizeStr=jf,window.fundingBadge=kf,window.getDB=wf,window.getReceipts=Ef,window.installApp=Vf,window.openReceiptsModal=Nf,window.refreshReceiptCounts=Tf,window.removeReceipt=zf,window.renderReceiptsList=Pf,window.saveReceipt=Df,window.uploadFiles=Lf,window.uploadReceiptFiles=If,window.viewReceipt=Rf,window.OB_EXPENSE_PRESETS=Hf,window.hideOnboarding=Kf,window.obBack=ep,window.obFinish=rp,window.obNext=$f,window.obPickEmoji=Xf,window.obSetAdults=qf,window.obSetKids=Jf,window.obSkip=tp,window.obSkipExpenses=np,window.obStepPosition=Wf,window.obStepSequence=Uf,window.obToggleEmojiPicker=Yf,window.obToggleExpenseSkip=Zf,window.renderObStep=Qf,window.showOnboarding=Gf;
//# sourceMappingURL=index-w8Tq1WqC.js.map