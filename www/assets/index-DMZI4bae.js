...
- Keep responses to 3-5 sentences unless a list is genuinely helpful`}function yr(e,t){let n=document.getElementById(`toto-messages`),r=document.createElement(`div`);r.className=`toto-msg ${e}`;let i=t.replace(/\n/g,`<br>`);e===`toto`?r.innerHTML=`<div class="toto-msg-avatar">🐕</div><div class="toto-msg-bubble">${i}</div>`:r.innerHTML=`<div class="toto-msg-bubble">${i}</div>`,n.appendChild(r),n.scrollTop=n.scrollHeight}function br(){let e=document.getElementById(`toto-messages`),t=`toto-typing-`+Date.now(),n=document.createElement(`div`);return n.className=`toto-msg toto`,n.id=t,n.innerHTML=`<div class="toto-msg-avatar">🐕</div><div class="toto-msg-bubble"><div class="toto-typing"><span></span><span></span><span></span></div></div>`,e.appendChild(n),e.scrollTop=e.scrollHeight,t}function xr(e){document.getElementById(e)?.remove()}`serviceWorker`in navigator&&navigator.serviceWorker.register(`/home-budget/sw.js`,{scope:`/home-budget/`}).catch(e=>console.warn(`SW registration failed:`,e)),document.getElementById(`btn-guest-mode`)?.addEventListener(`click`,()=>Fr()),document.getElementById(`btn-google-signin`)?.addEventListener(`click`,()=>Pr());function Sr(){document.getElementById(`sidebar`).classList.toggle(`collapsed`)}var Cr={};function wr(e){let t=document.getElementById(`icon-group-${e}`),n=document.getElementById(`icon-group-${e}-children`),r=document.getElementById(`text-group-${e}`),i=document.getElementById(`text-group-${e}-children`),a=n&&n.classList.contains(`open`);t&&t.classList.toggle(`open`,!a),n&&n.classList.toggle(`open`,!a),r&&r.classList.toggle(`open`,!a),i&&i.classList.toggle(`open`,!a)}function Tr(e){for(let[t,n]of Object.entries(Cr))if(n.includes(e)){let e=document.getElementById(`icon-group-${t}-children`);e&&!e.classList.contains(`open`)&&wr(t);return}}window.addEventListener(`unhandledrejection`,e=>{console.error(`[unhandledrejection]`,e.reason)}),window.addEventListener(`error`,e=>{console.error(`[uncaughtError]`,e.message,e.filename,e.lineno)});var Er=`toto_household_owner`,Dr=`toto_pending_household`;function Or(){return sessionStorage.getItem(Dr)||ri(Er)||L?.uid||null}function kr(){let e=Or();return e?fbStore.collection(`families`).doc(e):null}function Ar(e){ii(Er,e),sessionStorage.removeItem(Dr)}var L=null,jr=!1,Mr=null,Nr=null;function R(e,t){Nr={ts:new Date().toISOString(),name:L&&(L.displayName||L.email)||`Unknown`,photo:L&&L.photoURL||``,action:e,detail:t||``}}function Pr(){let e=new fbAuth.GoogleAuthProvider;fbAuth.signInWithPopup(e).catch(e=>{let t=document.getElementById(`login-error`);t&&(t.textContent=e.message,t.style.display=``)})}function Fr(){jr=!0;let e=document.getElementById(`login-overlay`);if(e&&e.classList.add(`hidden`),!m.onboarded)showOnboarding();else{let e=location.hash.slice(1);e&&document.getElementById(`tab-`+e)?(history.replaceState({tab:e},``,`#`+e),y(e)):renderAll(),pi()}}function Ir(){Mr&&(Mr(),Mr=null),Zr=!1,B=null,di(),fbAuth.signOut()}function Lr(e){return e.budget||(e.budget={income:[],expenses:[],actuals:{},months:{}}),e.budget.actuals||(e.budget.actuals={}),e.budget.months||(e.budget.months={}),e.budget.suggestions||(e.budget.suggestions=[]),e.goals||(e.goals=[]),e.scenarios||(e.scenarios=[]),e.furniture||(e.furniture=[]),e.appliances||(e.appliances=[]),e.planner||(e.planner={events:[]}),e.lists||(e.lists={food:{items:[],budget:0,weeklyBudget:200,stores:[],favourites:[],history:[]},clothes:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},wishlist:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},home:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},pharmacy:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]}},e.meals&&e.meals.shopping&&e.meals.shopping.length&&(e.lists.food.items=e.meals.shopping.map(function(e,t){return{id:`si-`+t,name:e.name,quantity:1,unit:`units`,notes:``,aisle:e.cat||`other`,state:e.checked?`got_it`:`active`,addedBy:`migration`,addedAt:new Date().toISOString(),mealTag:null,manualPrice:null,barcodeId:null}}))),[`food`,`clothes`,`wishlist`,`home`,`pharmacy`].forEach(function(t){e.lists[t]||(e.lists[t]={items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]}),e.lists[t].items||(e.lists[t].items=[]),e.lists[t].stores||(e.lists[t].stores=[]),e.lists[t].favourites||(e.lists[t].favourites=[]),e.lists[t].history||(e.lists[t].history=[])}),e}function Rr(){Mr&&Mr(),!ri(Er)&&!sessionStorage.getItem(Dr)&&Ar(L.uid);let e=kr();if(!e){console.error(`No household doc ref`);return}Mr=e.onSnapshot(async t=>{if(t.exists){let e=Lr(t.data());Object.assign(m,e),localStorage.setItem(Br,JSON.stringify(m))}else{let t=await fbStore.collection(`family`).doc(`shared`).get().catch(()=>null);if(t&&t.exists){let n=Lr(t.data());Object.assign(m,n),e.set(m).catch(()=>{}),localStorage.setItem(Br,JSON.stringify(m))}else e.set(m).catch(()=>{})}refreshReceiptCounts().then(()=>{or();let e=location.hash.slice(1);if(e&&document.getElementById(`tab-`+e)?(history.replaceState({tab:e},``,`#`+e),y(e)):renderAll(),!m.onboarded)showOnboarding();else{let e=sessionStorage.getItem(ka),t=sessionStorage.getItem(`toto_post_invite_action`);e||t?(sessionStorage.removeItem(`toto_post_invite_action`),ja()):pi()}})},e=>{console.error(`Firestore sync error:`,e),renderAll(),m.onboarded||showOnboarding()})}function zr(){fbAuth.onAuthStateChanged(e=>{if(jr&&!e)return;L=e;let t=document.getElementById(`login-overlay`),n=document.getElementById(`header-avatar`),r=document.getElementById(`header-sign-out`);if(e)t&&t.classList.add(`hidden`),n&&(n.src=e.photoURL||``,n.style.display=`block`),r&&(r.style.display=`block`),Rr();else{t&&t.classList.remove(`hidden`),n&&(n.style.display=`none`),r&&(r.style.display=`none`),Mr&&(Mr(),Mr=null);let e=sessionStorage.getItem(ka),i=document.getElementById(`login-invite-banner`),a=document.getElementById(`login-tagline`);e&&i&&(i.style.display=`block`,a&&(a.style.display=`none`))}})}zr();var Br=`home_finance_v1`,Vr=null,Hr={};function Ur(e,t,n,r){Hr[e]={options:t,value:n,onChange:r};let i=t.find(e=>(e.value??e)===n)||t[0],a=i?.label??i?.value??i??``;return`<div class="cs-wrap">
  ...
  </div>`,document.getElementById(`profile-list`).innerHTML=n,document.getElementById(`profile-overlay-title`).textContent=`Who uses this device?`,document.getElementById(`profile-overlay-sub`).textContent=`Set it once — the app will open straight to the right view. You can change this any time in Settings.`,document.getElementById(`profile-overlay`).classList.remove(`hidden`)}function hi(e){if(si(e),Zr=!0,document.getElementById(`profile-overlay`).classList.add(`hidden`),e===`adult`)B=null,Ci(),renderAll();else if(e===`shared`)gi();else{let t=(m.kids?.profiles||[]).find(t=>t.id===e);if(!t){B=null,Ti(),renderAll();return}t.pinHash?($r=t.id,H=``,V=0,yi(t)):(B={id:t.id,name:t.name,emoji:t.emoji,role:`child`},ui(t.id),wi())}}function gi(){document.getElementById(`pin-overlay`).classList.add(`hidden`);let e=(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name),t=m.kids?.profiles||[],n=``;e.forEach((e,t)=>{let r=!!e.pinHash;n+=`<div class="profile-card" onclick="_pickAdult(${t})">
      <div class="profile-avatar">🧑</div>
      <div style="flex:1">
        <div style="font-size:15px;font-weight:700;color:#1e293b">${x(e.name)}</div>
    ...
    </div>`}),document.getElementById(`profile-list`).innerHTML=n,document.getElementById(`profile-overlay-title`).textContent=`Who's using Toto?`,document.getElementById(`profile-overlay-sub`).textContent=`Tap your name to continue`,document.getElementById(`profile-overlay`).classList.remove(`hidden`)}function _i(e){let t=(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[e??0];if(t?.pinHash){$r=`adult:`+(e??0),H=``,V=0,Qr=0,yi({emoji:`🧑`,name:t.name,_isAdult:!0,_memberIndex:e??0});return}B=null,di(),document.getElementById(`profile-overlay`).classList.add(`hidden`),wi()}function vi(e){let t=(m.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(t.pinHash?($r=e,H=``,V=0,yi(t)):(B={id:t.id,name:t.name,emoji:t.emoji,role:`child`},ui(t.id),document.getElementById(`profile-overlay`).classList.add(`hidden`),wi()))}function yi(e){document.getElementById(`profile-overlay`).classList.add(`hidden`),document.getElementById(`pin-avatar`).textContent=e.emoji||(e._isAdult?`🧑`:`😊`),document.getElementById(`pin-greeting`).textContent=`Hi ${e.name}! 👋`,document.getElementById(`pin-sub`).textContent=`Enter your PIN to continue`,document.getElementById(`pin-error`).textContent=``,bi(),xi(),document.getElementById(`pin-overlay`).classList.remove(`hidden`)}function bi(){let e=document.getElementById(`pin-dots`);e&&(e.innerHTML=[0,1,2,3].map(e=>`<div class="pin-dot ${e<H.length?`filled`:``}">${e<H.length?`●`:``}</div>`).join(``))}function xi(){let e=document.getElementById(`pin-pad`);if(!e)return;let t=Date.now();if(t<Qr){let n=Math.ceil((Qr-t)/1e3);document.getElementById(`pin-error`).textContent=`Too many attempts — try again in ${n}s`,e.innerHTML=``,setTimeout(xi,1e3);return}e.innerHTML=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div class="pin-key empty"></div>`:`<div class="pin-key" onclick="_pinKey('${e}')">${e}</div>`).join(``)}function Si(e){if(!(Date.now()<Qr)){if(e===`⌫`){H=H.slice(0,-1),bi();return}H.length>=4||(H+=e,bi(),H.length===4&&po())}}function Ci(){let e=document.getElementById(`header-switch-profile`);if(!e)return;let t=oi();e.style.display=t&&t!==`adult`?``:`none`}function wi(){Ci(),Ti(),B?.role===`child`?(window.kidsView=B.id,b(`kids`),Ui(B.id)):document.querySelectorAll(`.nav-item, .nav-text-item`).forEach(e=>e.style.display=``),renderAll()}function Ti(){let e=B?.role===`child`;document.body.classList.toggle(`kid-mode`,e);let t=document.getElementById(`kid-banner-label`);t&&e&&(t.textContent=`${B.emoji||`😊`} ${B.name}'s view`);let n=oi(),r=document.getElementById(`header-switch-profile`);if(r){let t=n&&n!==`adult`;if(r.style.display=t?``:`none`,t)if(e)r.textContent=`👨‍👩‍👧 Parent`;else{let e=(m.kids?.profiles||[]).find(e=>e.id===n);r.textContent=e?`Back to ${e.name}`:`Switch`}}}function Ei(){let e=oi();if(B?.role===`child`)di(),B=null,Ti(),renderAll();else if(e===`shared`)gi();else if(e&&e!==`adult`){let t=(m.kids?.profiles||[]).find(t=>t.id===e);t&&(t.pinHash?($r=t.id,H=``,V=0,yi(t)):(B={id:t.id,name:t.name,emoji:t.emoji,role:`child`},ui(t.id),wi()))}}async function Di(e,t){let n=(m.kids?.profiles||[]).find(t=>String(t.id)===String(e));!n||t.length!==4||(n.pinHash=await fi(t,Or()),z(m))}function Oi(e){let t=(m.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(delete t.pinHash,z(m))}function ki(e){(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[e]&&(ji=e,Ni=``,Pi=``,Mi=`enter`,Fi(),document.getElementById(`adult-pin-modal`).classList.remove(`hidden`))}function Ai(e){let t=(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name);t[e]&&(delete t[e].pinHash,z(m),X())}var ji=0,Mi=`enter`,Ni=``,Pi=``;function Fi(){let e=(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[ji];if(!e)return;let t=Mi===`enter`,n=t?e.pinHash?`Change your PIN 🔢`:`Set your PIN 🔢`:`Confirm your PIN ✅`,r=t?`Pick 4 numbers — used on shared devices`:`Enter it again to confirm`,i=[0,1,2,3].map(e=>{let t=e<Pi.length;return`<div style="width:52px;height:60px;border:2px solid ${t?`#0891b2`:`#e2e8f0`};border-radius:10px;background:${t?`#ecfeff`:`#f8fafc`};display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:700;color:#0891b2">${t?`●`:``}</div>`}).join(``),a=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div></div>`:`<div onclick="_adultPinKey('${e}')" style="height:52px;border:1.5px solid #e2e8f0;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:600;color:#374151;cursor:pointer;background:#fff;-webkit-tap-highlight-color:transparent;user-select:none">${e}</div>`).join(``);document.getElementById(`adult-pin-modal-body`).innerHTML=`
    ...
    <button onclick="document.getElementById('adult-pin-modal').classList.add('hidden')" style="font-size:13px;color:#94a3b8;background:none;border:none;cursor:pointer">Cancel</button>`}function Ii(e){if(e===`⌫`){Pi=Pi.slice(0,-1),Fi();return}Pi.length>=4||(Pi+=e,Fi(),Pi.length===4&&Li())}async function Li(){if(Mi===`enter`)Ni=Pi,Pi=``,Mi=`confirm`,Fi();else{if(Pi!==Ni){Pi=``,Ni=``,Mi=`enter`,Fi();let e=document.getElementById(`adult-pin-error`);e&&(e.textContent=`Those didn't match — try again`);return}let e=(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name);e[ji].pinHash=await fi(Pi,Or()),z(m),document.getElementById(`adult-pin-modal`).classList.add(`hidden`),X()}}function Ri(e){let t=Number(e.age||0);return t<5?`tiny-tots`:t<8?`early-reader`:t<12?`independent`:`tween`}function zi(){let e=new Date().getHours();return e<12?`Good morning`:e<17?`Good afternoon`:`Good evening`}function Bi(e){if(!e.triggerTime)return!0;let[t,n]=e.triggerTime.split(`:`).map(Number),r=new Date,i=r.getHours()*60+r.getMinutes(),a=t*60+(n||0),o=a+360;return i>=a&&i<o}function Vi(e){if(!e.triggerTime)return``;let[t]=e.triggerTime.split(`:`).map(Number);return t<12?`Available this morning`:t<17?`Available this afternoon`:`Available tonight`}function Hi(){let e=document.getElementById(`child-view-overlay`);if(!e)return;let t=document.getElementById(`cv-confetti-wrap`);t&&t.remove(),t=document.createElement(`div`),t.id=`cv-confetti-wrap`,t.className=`cv2-confetti-wrap`,e.appendChild(t);let n=[`#5B4CF5`,`#7C3AED`,`#F59E0B`,`#10B981`,`#F43F5E`,`#FBBF24`];for(let e=0;e<60;e++){let r=document.createElement(`div`);r.className=`cv2-confetti-particle`,r.style.cssText=`
    ...
    </div>`}let{events:ne}=Qi(t,f),k=[...ne].sort((e,t)=>(e.time||`99:99`).localeCompare(t.time||`99:99`)),re=``;k.length&&!a&&(re=`<div class="cv2-group">
      <div class="cv2-group-heading">📅 Today's Events</div>
      <div class="cv2-card">${k.map(e=>`
      <div class="cv2-event-row">
        <span class="cv2-event-time">${e.time?$i(e.time):``}</span>
    ...
    ${re}${O}${j}`:(N=ie,i!==`tiny-tots`&&!s&&(N+=`<button class="cv2-week-shortcut" onclick="_cvSwitchTab('calendar','${t.id}')">📅 See my week →</button>`),p.length&&(N+=`<div class="cv2-group">
      ...
      </div>`),N+=re,N+=O,N+=j),document.getElementById(`cv-content`).innerHTML=N,c.classList.remove(`hidden`),c.style.display=`flex`,ae&&!s&&Hi()}function Wi(e){let t=document.getElementById(`cv-prizes-badge`);if(!t)return;let n=m.kids,r=kidBalance(n,e.id),i=(n.notifications||[]).filter(t=>t.kidId===e.id&&!t.read).length,a=(n.prizes||[]).filter(e=>r>=e.pointCost).length,o=i+(a>0&&i===0?a:0);o>0?(t.textContent=o>9?`9+`:String(o),t.style.display=``):t.style.display=`none`}function Gi(e){let t=m.kids,n=kidBalance(t,e.id),r=Ri(e)===`tiny-tots`,i=_cvReadOnly,a=t.prizes||[],o=!1;(t.notifications||[]).filter(t=>t.kidId===e.id&&!t.read).forEach(e=>{e.read=!0,o=!0}),o&&z(m),Wi(e);let s=r?`${`⭐`.repeat(Math.min(n,10))}${n>10?`+`:``}`:`${n}`,c=`<div class="cv2-prizes-balance">
    ...
    <span class="cv2-prizes-balance-emoji">🏆</span>
      ...
      </div>`}),c+=`</div>`);let u=document.getElementById(`cv-content`);u&&(u.innerHTML=c)}var Ki=null,qi=`today`,Ji=`7day`,Yi=null,Xi=new Set;function Zi(e,t){t&&(Ki=t);let n=(m.kids?.profiles||[]).find(e=>String(e.id)===String(Ki));if(!n)return;let r=Ri(n),i=document.getElementById(`cv-nav`);i&&(i.style.display=r===`tiny-tots`?`none`:``),document.getElementById(`cv-nav-today`)?.classList.toggle(`active`,e===`today`),document.getElementById(`cv-nav-calendar`)?.classList.toggle(`active`,e===`calendar`),document.getElementById(`cv-nav-prizes`)?.classList.toggle(`active`,e===`prizes`),e===`today`?Ui(Ki):e===`prizes`?Gi(n):(Yi=null,aa(n))}function Qi(e,t){let n=(m.routineAssignments||[]).filter(t=>t.childId===e.id).map(e=>{let n=(m.routines||[]).find(t=>t.id===e.routineId);return n&&_routineMatchesDate(n,t)?{type:`routine`,routine:n,assignment:e,label:n.name,emoji:n.emoji,color:`#7C3AED`,tag:`Routine`,time:n.triggerTime||null}:null}).filter(Boolean),r=(m.childEvents||[]).filter(n=>{let r=Array.isArray(n.assignedTo)?n.assignedTo:[n.assignedTo];return r.includes(e.id)||r.includes(`all`)||n.isHouseholdWide?n.recurrence?_recurrenceMatchesDate(n.recurrence,t):n.date===t:!1}).map(e=>({type:`event`,label:e.title,emoji:e.emoji||`📅`,color:`#10b981`,tag:`Event`,notes:e.notes,time:e.time||null})),i=(m.planner?.events||[]).filter(e=>Lt(e).includes(`everyone`)?e.recurrence&&e.recurrence.type!==`one_time`?_recurrenceMatchesDate(e.recurrence,t):e.endDate&&e.endDate>e.date?t>=e.date&&t<=e.endDate:e.date===t:!1).map(e=>({type:`event`,label:e.title,emoji:P[e.category]?.emoji||`📅`,color:`#10b981`,tag:`Event`,notes:e.notes||``,time:e.time||null}));return{routines:n,events:[...r,...i],chores:(m.kids?.chores||[]).filter(t=>(t.assignedTo===e.id||t.assignedTo===`all`)&&!t._isRoutine).map(e=>({type:`chore`,label:e.name,emoji:e.emoji||`📋`,color:`#ec4899`,tag:`Chore`,time:null}))}}function $i(e){if(!e)return``;let[t,n]=e.split(`:`).map(Number);return`${t%12||12}:${String(n).padStart(2,`0`)} ${t>=12?`pm`:`am`}`}function ea(e){Xi.has(e)?Xi.delete(e):Xi.add(e);let t=(m.kids?.profiles||[]).find(e=>String(e.id)===String(Ki));t&&(Ji===`7day`||Ri(t)===`early-reader`?na(t,new Date().toISOString().slice(0,10)):na(t,Yi))}function ta(e,t,n){if(_cvReadOnly)return;let r=_routineGetAssignment(e,Ki);if(!r)return;r.completionState||(r.completionState={});let i=n;r.completionState[i]||(r.completionState[i]=[]);let a=r.completionState[i].indexOf(t),o=a===-1;o?r.completionState[i].push(t):r.completionState[i].splice(a,1);let s=new Date().toISOString().slice(0,10);if(o&&n===s){let n=(m.routines||[]).find(t=>String(t.id)===String(e));if(n){let e=n.steps.find(e=>e.id===t);(e?.points||0)>0&&_routineAwardStepPoints(n,e,Ki);let a=n.steps.length;r.completionState[i].length===a&&a>0&&(n.pointsPerCompletion||0)>0&&_routineAwardPoints(n,Ki)}}z(m);let c=(m.kids?.profiles||[]).find(e=>String(e.id)===String(Ki));c&&na(c,n)}function na(e,t){let n=Ji===`month`?`cv-day-panel`:`cv-schedule-panel`,r=document.getElementById(n);r&&(r.innerHTML=ra(e,t))}function ra(e,t){if(!t)return``;let{routines:n,events:r,chores:i}=Qi(e,t),a=t;if(!n.length&&!r.length&&!i.length)return`<div style="text-align:center;padding:28px 0;color:#A1A1AA;font-size:13px">Nothing scheduled</div>`;let o=[...n.map(e=>({...e,sortKey:e.time||`23:59`})),...r.map(e=>({...e,sortKey:e.time||`23:59`}))].sort((e,t)=>e.sortKey.localeCompare(t.sortKey)),s=``;return o.length&&(s+=`<div class="cv-sched-section-hdr">Schedule</div>`,o.forEach(e=>{e.type===`routine`?s+=ia(e.routine,e.assignment,a):s+=`<div class="cv-sched-item">
          <div class="cv-sched-row">
            <span class="cv-sched-time">${e.time?$i(e.time):``}</span>
      ...
      </div>`})),s}function ia(e,t,n){let r=t.completionState?.[n]||[],i=e.steps.length,a=i>0?Math.round(r.length/i*100):0,o=r.length===i&&i>0,s=Xi.has(e.id),c=i>0?`
    ...
    <div class="cv-sched-row" style="cursor:pointer" onclick="_cvToggleRoutineExpand(${JSON.stringify(e.id)})">
      <span class="cv-sched-time">${e.triggerTime?$i(e.triggerTime):``}</span>
      <div class="cv-sched-color-bar" style="background:#7C3AED"></div>
      <span class="cv-sched-emoji">${e.emoji}</span>
      <div class="cv-sched-body">
        <div class="cv-sched-title">${x(e.name)}</div>
        ${o?`<div class="cv-sched-sub" style="color:#5B4CF5;font-weight:700">✓ Complete</div>`:e.triggerTime?`<div class="cv-sched-sub">${$i(e.triggerTime)}</div>`:``}
      </div>
      ${c}
      <button class="cv-sched-expand-btn">${s?`▲`:`▼`}</button>
    </div>
    ${l}
  </div>`}function aa(e){if(!e)return;let t=Ri(e)===`early-reader`,n=t?`7day`:Ji,r=new Date().toISOString().slice(0,10),i=document.getElementById(`cv-content`);if(!i)return;let a=``;t||(a+=`<div style="display:flex;gap:8px;margin-bottom:14px">
    ...
    </div>`),a+=n===`7day`?sa(e,r):la(e,r),i.innerHTML=a}function oa(e,t){Ji=e,Yi=null;let n=(m.kids?.profiles||[]).find(e=>String(e.id)===String(t));n&&aa(n)}function sa(e,t){let n=[`S`,`M`,`T`,`W`,`T`,`F`,`S`],r=new Date(t+`T12:00:00`),i=`<div class="cv-week-strip">`;for(let a=0;a<7;a++){let o=new Date(r);o.setDate(r.getDate()+a);let s=o.toISOString().slice(0,10),c=s===t,{routines:l,events:u,chores:d}=Qi(e,s),f=[...l,...u,...d].slice(0,3).map(e=>`<div class="cv-cal-dot" style="background:${e.color}"></div>`).join(``);i+=`<div class="cv-week-cell ${c?`cv-today`:``}" onclick="_cvWeekDayTap('${s}','${e.id}')">
    ...
    </div>`}i+=`</div>`;let a=new Date(t+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`});return i+=`<div style="font-size:13px;font-weight:700;color:#1e293b;margin:10px 0 2px">${x(a)}</div>`,i+=`<div id="cv-schedule-panel">${ra(e,t)}</div>`,i}function ca(e,t){let n=(m.kids?.profiles||[]).find(e=>String(e.id)===String(t));if(!n)return;Xi.clear(),document.querySelectorAll(`.cv-week-cell`).forEach(t=>{t.classList.toggle(`cv-today`,t.getAttribute(`onclick`)?.includes(`'${e}'`))});let r=new Date(e+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`}),i=document.getElementById(`cv-schedule-panel`);i&&(i.previousElementSibling.textContent=r,i.innerHTML=ra(n,e))}function la(e,t){let n=new Date(t+`T12:00:00`),r=n.getFullYear(),i=n.getMonth(),a=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`],o=[`S`,`M`,`T`,`W`,`T`,`F`,`S`],s=new Date(r,i,1).getDay(),c=new Date(r,i+1,0).getDate(),l=Yi||t,u=`<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
    <span style="font-size:14px;font-weight:800;color:#18181B">${a[i]} ${r}</span>
  </div>`;u+=`<div class="cv-cal-grid">`,o.forEach(e=>{u+=`<div class="cv-cal-day-hdr">${e}</div>`});for(let e=0;e<s;e++)u+=`<div class="cv-cal-cell cv-other"></div>`;for(let n=1;n<=c;n++){let a=`${r}-${String(i+1).padStart(2,`0`)}-${String(n).padStart(2,`0`)}`,o=a===t,s=a===l,{routines:c,events:d,chores:f}=Qi(e,a),p=[...c,...d,...f].slice(0,3).map(e=>`<div class="cv-cal-dot" style="background:${e.color}"></div>`).join(``);u+=`<div class="cv-cal-cell ${o?`cv-today`:``} ${s&&!o?`cv-cal-cell--sel`:``}" onclick="_cvMonthDayTap('${a}','${e.id}')">
    ...
    <div id="cv-day-panel">${ra(e,l)}</div>
  </div>`,u}function ua(e,t){Yi=e,Xi.clear();let n=(m.kids?.profiles||[]).find(e=>String(e.id)===String(t));n&&aa(n)}function da(e,t){ua(e,t)}function fa(e,t){let n=(m.kids?.notifications||[]).find(t=>t.id===e);n&&(n.read=!0),z(m),Ui(t)}function pa(e,t){let n=(m.kids?.prizes||[]).find(e=>String(e.id)===String(t));if(!n)return;let r=`<div class="cv2-confirm">
  ...
  </div>`;document.getElementById(`cv-content`).innerHTML=r}function ma(e,t){m.kids.completions.find(n=>n.kidId===e&&n.choreId===t&&n.status===`pending`)||(m.kids.completions.push({id:uid(),kidId:e,choreId:t,status:`pending`,ts:new Date().toISOString()}),z(m),Ui(e))}function ha(e,t){m.kids.redemptions.push({id:uid(),kidId:e,prizeId:t,status:`pending`,ts:new Date().toISOString()}),z(m),Zi(`prizes`,e)}function ga(e){let t=(m.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(B={id:t.id,name:t.name,emoji:t.emoji,role:`child`},ui(t.id),Ui(e))}var _a=`member`,va=null,ya=null;function ba(e){_a=e;let t=document.getElementById(`inv-role-member`),n=document.getElementById(`inv-role-owner`);!t||!n||(e===`member`?(t.style.borderColor=`#0d9488`,t.style.background=`#f0fdfa`,t.style.color=`#0d9488`,n.style.borderColor=`var(--border)`,n.style.background=`var(--surface)`,n.style.color=`var(--text-muted)`):(n.style.borderColor=`#0d9488`,n.style.background=`#f0fdfa`,n.style.color=`#0d9488`,t.style.borderColor=`var(--border)`,t.style.background=`var(--surface)`,t.style.color=`var(--text-muted)`))}function xa(e,t){let n=document.getElementById(`inv-email`),r=n?n.value.trim():``,i=(m.householdProfile.members||[]).find(e=>e.role===`adult`)?.name||`Someone`,a=new Date(Date.now()+10080*60*1e3).toISOString(),o={id:uid(),email:r,role:_a,inviterName:i,memberName:t||null,memberIdx:e??null,createdAt:new Date().toISOString(),expiresAt:a,status:`pending`};m.householdProfile.invites||(m.householdProfile.invites=[]),m.householdProfile.invites.push(o),z(m),va=o.id;let s=Ta(o.id),c=document.getElementById(`invite-link-wrap`),l=document.getElementById(`invite-form-wrap`),u=document.getElementById(`invite-link-display`);c&&(c.dataset.invEmail=r,c.dataset.invToken=o.id,c.style.display=`block`),l&&(l.style.display=`none`),u&&(u.textContent=s)}function Sa(e){let t=(m.householdProfile.members||[])[e];if(!t)return;let n=(m.householdProfile.members||[]).find((e,t)=>e.role===`adult`&&t===0)?.name||`Someone`,r=new Date(Date.now()+10080*60*1e3).toISOString(),i={id:uid(),email:``,role:`member`,inviterName:n,memberName:t.name||null,memberIdx:e,createdAt:new Date().toISOString(),expiresAt:r,status:`pending`};m.householdProfile.invites||(m.householdProfile.invites=[]),m.householdProfile.invites.push(i),z(m);let a=Ta(i.id),o=x(t.name||`this person`),s=document.createElement(`div`);s.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:24px`,s.innerHTML=`<div style="background:#fff;border-radius:16px;padding:24px;max-width:400px;width:100%">
  ...
  </div>`,document.body.appendChild(s),s.addEventListener(`click`,e=>{e.target===s&&(s.remove(),X())})}function Ca(e){if(!e)return;let t=(m.kids?.profiles||[]).find(t=>t.name&&t.name.toLowerCase()===e.toLowerCase());if(!t){m.kids||(m.kids={profiles:[],chores:[],prizes:[],completions:[],redemptions:[]});let n=(m.householdProfile.members||[]).find(t=>t.name&&t.name.toLowerCase()===e.toLowerCase()),r=M(m.kids.profiles);t={id:r,name:e,age:n?.age||null,emoji:n?.emoji||`🧒`},m.kids.profiles.push(t),m.meals?.lunchbox?.profiles||(m.meals||(m.meals={}),m.meals.lunchbox||(m.meals.lunchbox={profiles:[]})),m.meals.lunchbox.profiles.push({id:r,name:e,emoji:t.emoji}),z(m)}$a(t.id)}function wa(e){navigator.clipboard.writeText(Ta(e)).then(()=>{let e=event.target,t=e.textContent;e.textContent=`✓ Copied!`,setTimeout(()=>{e.textContent=t},2e3)})}function Ta(e){let t=Or()||``;return window.location.origin+window.location.pathname+`?invite=`+e+`&h=`+t}function Ea(){let e=document.getElementById(`invite-link-wrap`)?.dataset.invToken||va;e&&navigator.clipboard.writeText(Ta(e)).then(()=>{let e=event.target,t=e.textContent;e.textContent=`✓ Copied!`,setTimeout(()=>{e.textContent=t},2e3)})}function Da(){let e=document.getElementById(`invite-link-wrap`),t=e?.dataset.invToken||va,n=e?.dataset.invEmail||``;if(!t)return;let r=(m.householdProfile.invites||[]).find(e=>e.id===t)?.inviterName||`Your partner`,i=Ta(t),a=encodeURIComponent(`${r} invited you to join their Toto household`),o=encodeURIComponent(`Hi,\n\n${r} has invited you to join their Toto household — a shared family finance and planning app.\n\nClick the link below to accept the invite (expires in 7 days):\n\n${i}\n\nSee you there!`);window.open(`mailto:${n}?subject=${a}&body=${o}`,`_blank`)}function Oa(e){if(!confirm(`Revoke this invite link?`))return;let t=(m.householdProfile.invites||[]).find(t=>t.id===e);t&&(t.status=`revoked`),z(m),X()}var ka=`toto_pending_invite`;function Aa(){let e=new URLSearchParams(window.location.search),t=e.get(`invite`),n=e.get(`h`);t&&(sessionStorage.setItem(ka,t),n&&sessionStorage.setItem(Dr,n),window.history.replaceState({},``,window.location.pathname+window.location.hash))}function ja(){let e=sessionStorage.getItem(ka);if(!e)return;let t=(m.householdProfile.invites||[]).find(t=>t.id===e);if(!t){sessionStorage.removeItem(ka);return}if(t.status!==`pending`||new Date(t.expiresAt)<new Date){sessionStorage.removeItem(ka),Ua(t);return}sessionStorage.removeItem(ka),ya=t,Ma(t)}function Ma(t){let n=m.householdProfile.members||[],r=n.filter(e=>e.role===`adult`),i=n.filter(e=>e.role===`child`),a=(()=>{let t=new Date,n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}`,r=getOrCreateMonthData(n);return(r.income||[]).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)-(r.expenses||[]).filter(e=>!e.skipped).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)})(),o=[...r.map(e=>`
  ...
  `)}function Na(){let t=ya,n=L?.displayName?.split(` `)[0]||`there`,r=m.householdProfile.members||[],i=r.filter(e=>e.role===`adult`),a=r.filter(e=>e.role===`child`),o=(()=>{let t=new Date,n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}`,r=getOrCreateMonthData(n);return(r.income||[]).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)-(r.expenses||[]).filter(e=>!e.skipped).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)})(),s=(m.goals||[]).length,c=[...i.map((e,t)=>`
      <div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid #f1f5f9">
        <div style="width:40px;height:40px;border-radius:50%;background:linear-gradient(135deg,#ecfeff,#ccfbf1);display:flex;align-items:center;justify-content:center;font-size:20px">👤</div>
        <div>
  ...
  `)}var Pa=0,Fa=[{emoji:`💰`,title:`The Kitty`,desc:`Budget, bills, goals & net worth. See where the money goes each month.`},{emoji:`📅`,title:`Plan`,desc:`Weekly planner, meal plans & the kids' lunchboxes. One place for the week ahead.`},{emoji:`🏠`,title:`Home`,desc:`Documents, vehicles & maintenance reminders. Never miss a rego or warranty renewal.`}];function Ia(){Pa=0,La()}function La(){let e=Fa[Pa],t=Fa.map((e,t)=>`<div style="width:${t===Pa?20:8}px;height:8px;border-radius:99px;background:${t===Pa?`#0d9488`:`#e2e8f0`};transition:all .2s"></div>`).join(``),n=Pa===Fa.length-1;Wa(`
  ...
  `)}function za(){let e=document.getElementById(`inv-inc-name`)?.value.trim()||``,t=parseFloat(document.getElementById(`inv-inc-amount`)?.value)||0,n=document.getElementById(`inv-inc-freq`)?.value||`Monthly`;(e||t)&&(m.budget.income||(m.budget.income=[]),m.budget.income.push({id:M(m.budget.income),name:e,amount:t,frequency:n}),z(m)),Ha()}function Ba(){let e=ya;if(!L){sessionStorage.setItem(`toto_post_invite_action`,e?.id||``),Pr();return}Va(e),Na()}function Va(e){if(!e)return;e.status=`accepted`;let t=L,n=Or();n&&Ar(n),m.householdProfile.authorizedUsers||(m.householdProfile.authorizedUsers=[]),m.householdProfile.authorizedUsers.some(e=>e.uid===t.uid)||m.householdProfile.authorizedUsers.push({uid:t.uid,name:t.displayName||``,email:t.email||``,role:e.role||`member`,joinedAt:new Date().toISOString()});let r=m.householdProfile.members||[],i=(t.displayName||``).split(` `)[0];i&&!r.some(e=>e.name===i)&&m.householdProfile.members.push({role:`adult`,name:i,age:null}),z(m)}function Ha(){ya=null,Ga(),renderAll(),pi()}function Ua(e){Wa(`
  ...
  `)}function Wa(e){document.getElementById(`invite-flow-content`).innerHTML=e;let t=document.getElementById(`invite-flow-overlay`);t.classList.remove(`hidden`),t.style.display=`flex`,t.scrollTop=0}function Ga(){let e=document.getElementById(`invite-flow-overlay`);e.classList.add(`hidden`),e.style.display=``}var Ka=`toto_pin_hard_`,qa=`toto_pin_att_`,Ja=null,U=`gate`,Ya=``,Xa=``,Za=0,Qa=null;function $a(e){let t=(m.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(Ja=e,Xa=``,Ya=``,U=t.pinHash?`enter`:`gate`,to(),document.getElementById(`pin-setup-overlay`).classList.remove(`hidden`))}function eo(){Qa&&(clearInterval(Qa),Qa=null),document.getElementById(`pin-setup-overlay`).classList.add(`hidden`),Ja=null}function to(){let e=(m.kids?.profiles||[]).find(e=>String(e.id)===String(Ja));if(!e)return;let t=document.getElementById(`pso-screen`);if(!t)return;let n=e.emoji||`🧒`,r=x(e.name),i={gate:`#f8fafc`,hello:`linear-gradient(160deg,#f0fdfa,#ecfeff)`,enter:`#f8fafc`,confirm:`#f8fafc`,tour:`#f8fafc`};if(document.getElementById(`pin-setup-overlay`).style.background=i[U]||`#f8fafc`,U===`gate`)t.innerHTML=`
      ...
      <button onclick="closePinSetupOverlay()" style="font-size:13px;color:#94a3b8;background:none;border:none;cursor:pointer">Cancel</button>`;else if(U===`hello`)t.innerHTML=`
      ...
      <button onclick="_psoStep='enter';_psoRender()"
        ...
        Let's go! →
      </button>`;else if(U===`enter`||U===`confirm`){let n=U===`enter`,i=n?e.pinHash?`Change ${r}'s PIN`:`Choose your secret code 🔢`:`Type it again ✅`,a=n?`Pick 4 numbers only you know!`:`Just to make sure!`,o=[0,1,2,3].map(e=>{let t=e<Xa.length;return`<div style="width:52px;height:60px;border:2px solid ${t?`#0d9488`:`#e2e8f0`};border-radius:10px;background:${t?`#f0fdfa`:`#f8fafc`};display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:700;color:#0d9488">${t?`●`:``}</div>`}).join(``),s=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div></div>`:`<div onclick="_psoKey('${e}')" style="height:52px;border:1.5px solid #e2e8f0;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:600;color:#374151;cursor:pointer;background:#fff;-webkit-tap-highlight-color:transparent;user-select:none">${e}</div>`).join(``);t.innerHTML=`
      ...
      ${r?``:`<button onclick="_psoTourDone()" style="font-size:13px;color:#94a3b8;background:none;border:none;cursor:pointer">Skip</button>`}`}}function no(){if(Qa)return;let e=0,t=document.getElementById(`pso-hold-fill`);t&&(t.style.transition=`none`,t.style.transform=`scaleX(0)`),Qa=setInterval(()=>{e+=50;let n=Math.min(e/2e3,1);t&&(t.style.transition=`none`,t.style.transform=`scaleX(${n})`),e>=2e3&&(clearInterval(Qa),Qa=null,U=`hello`,to())},50)}function ro(){Qa&&(clearInterval(Qa),Qa=null);let e=document.getElementById(`pso-hold-fill`);e&&(e.style.transition=`transform .3s`,e.style.transform=`scaleX(0)`)}function io(e){if(e===`⌫`){Xa=Xa.slice(0,-1),to();return}Xa.length>=4||(Xa+=e,to(),Xa.length===4&&ao())}async function ao(){if(U===`enter`)Ya=Xa,Xa=``,U=`confirm`,to();else if(U===`confirm`){if(Xa!==Ya){Xa=``,Ya=``,U=`enter`,to();let e=document.getElementById(`pso-error`);e&&(e.textContent=`Those didn't match — try again 🙈`);return}await Di(Ja,Xa);let e=(m.kids?.profiles||[]).find(e=>String(e.id)===String(Ja));e&&!e._pinWasSet?(Za=0,U=`tour`,to()):(eo(),renderKids(),X()),e._pinWasSet=!0}}function oo(){let e=(m.kids?.profiles||[]).find(e=>String(e.id)===String(Ja));eo(),e&&Ui(e.id)}function so(e){return parseInt(ri(qa+e)||`0`)}function co(e){let t=so(e)+1;return ii(qa+e,String(t)),t}function lo(e){ai(qa+e),ai(Ka+e)}function uo(e){return ri(Ka+e)===`1`}function fo(e){ii(Ka+e,`1`)}async function po(){let e=await fi(H,Or());if(typeof $r==`string`&&$r.startsWith(`adult:`)){let t=parseInt($r.split(`:`)[1]),n=(m.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[t];if(!n)return;e===n.pinHash?(V=0,B=null,di(),document.getElementById(`pin-overlay`).classList.add(`hidden`),wi()):(V++,H=``,bi(),V>=3?(Qr=Date.now()+3e4,V=0,xi()):document.getElementById(`pin-error`).textContent=`Wrong PIN — ${3-V} tr${3-V==1?`y`:`ies`} left`);return}let t=(m.kids?.profiles||[]).find(e=>e.id===$r);if(t){if(uo(t.id)){document.getElementById(`pin-error`).textContent=`PIN locked — ask mum or dad to reset it 🔒`,document.getElementById(`pin-pad`).innerHTML=``,mo(t);return}if(e===t.pinHash)lo(t.id),V=0,B={id:t.id,name:t.name,emoji:t.emoji,role:`child`},ui(t.id),document.getElementById(`pin-overlay`).classList.add(`hidden`),wi();else if(H=``,bi(),V++,co(t.id)>=10)fo(t.id),Qr=0,document.getElementById(`pin-error`).textContent=`PIN locked — ask mum or dad to reset it 🔒`,document.getElementById(`pin-pad`).innerHTML=``,mo(t);else if(V>=3)Qr=Date.now()+3e4,V=0,xi();else{let e=3-V;document.getElementById(`pin-error`).textContent=`Wrong PIN — ${e} try${e===1?``:`s`} left`}}}function mo(e){m.notifications||(m.notifications=[]),m.notifications.some(t=>t.type===`pin-lock`&&t.kidId===e.id)||(m.notifications.unshift({id:uid(),type:`pin-lock`,kidId:e.id,msg:`${e.name}'s PIN has been locked after too many failed attempts. Reset it in Settings → Household.`,ts:new Date().toISOString(),read:!1}),z(m))}function ho(e){lo(e),V=0,Qr=0,X()}function W(e){return m.budget.months&&m.budget.months[e]||{income:m.budget.income,expenses:m.budget.expenses}}function go(e){return!!(m.budget.months&&m.budget.months[e])}function _o(e){return m.budget.months||(m.budget.months={}),m.budget.months[e]||(m.budget.months[e]={income:JSON.parse(JSON.stringify(m.budget.income)),expenses:JSON.parse(JSON.stringify(m.budget.expenses))}),m.budget.months[e]}function vo(e){let[t,n]=e.split(`-`).map(Number),r=new Date(t,n-2,1);return`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}`}function yo(e){let t=vo(e),n=W(t);m.budget.months||(m.budget.months={}),m.budget.months[e]={income:JSON.parse(JSON.stringify(n.income.filter(e=>e.recurring!==!1))),expenses:JSON.parse(JSON.stringify(n.expenses.filter(e=>e.recurring!==!1)))},R(`Auto-filled`,`${K(e)} copied from ${K(t)}`),z(m),safeRender(Bl),safeRender(_s)}var bo=null;function xo(e,t){bo={onThisMonth:e,onAllMonths:t};let n=K(G);document.getElementById(`modal-title`).textContent=`Apply changes`,document.getElementById(`modal-body`).innerHTML=`
    ...
    ${go(G)?`<p style="font-size:12px;color:var(--primary);margin-top:10px;margin-bottom:0">
  ...
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function So(){bo&&(bo.onThisMonth(),bo=null),Q()}function Co(){bo&&(bo.onAllMonths(),bo=null),Q()}p(Jr()),Aa(),setTimeout(()=>{try{_routineCheckDailyReset()}catch{}},0);var G=new Date().toISOString().slice(0,7),wo=`grouped`,To=new Set([`ai`,`household`]),Eo=new Date().getFullYear(),Do=new Date().getMonth()+1;function Oo(){return document.getElementById(`f-exp-duedate`)||document.getElementById(`f-inc-duedate`)}function ko(e){e.stopPropagation();let t=document.getElementById(`dp-popup`);if(!t)return;let n=(Oo()||{}).value||``;if(n)[Eo,Do]=n.split(`-`).map(Number);else{let e=new Date;Eo=e.getFullYear(),Do=e.getMonth()+1}t.classList.remove(`hidden`),Ao();function r(e){let n=document.getElementById(`dp-wrap`);n&&!n.contains(e.target)?t.classList.add(`hidden`):document.addEventListener(`click`,r,{once:!0})}document.addEventListener(`click`,r,{once:!0})}function Ao(){let e=document.getElementById(`dp-popup`);if(!e)return;let t=Eo,n=Do,r=new Date(t,n-1,1).getDay(),i=new Date(t,n,0).getDate(),a=new Date,o=(Oo()||{}).value||``,s=`
    <div class="dp-nav">
  ...
  `;for(let e=0;e<r;e++)s+=`<div class="dp-day dp-other"></div>`;for(let e=1;e<=i;e++){let r=`${t}-${String(n).padStart(2,`0`)}-${String(e).padStart(2,`0`)}`,i=[`dp-day`,a.getFullYear()===t&&a.getMonth()+1===n&&a.getDate()===e?`dp-today`:``,o===r?`dp-selected`:``].filter(Boolean).join(` `);s+=`<div class="${i}" onclick="dpSelectDate('${r}',event)">${e}</div>`}s+=`</div>`,o&&(s+=`<div class="dp-clear"><button class="dp-clear-btn" onclick="dpClearDate(event)">Clear date</button></div>`),e.innerHTML=s}function jo(e){e.stopPropagation(),Do===1?(Do=12,Eo--):Do--,Ao()}function Mo(e){e.stopPropagation(),Do===12?(Do=1,Eo++):Do++,Ao()}function No(e,t){t&&t.stopPropagation();let n=Oo();n&&(n.value=e);let[r,i,a]=e.split(`-`);document.getElementById(`dp-display`).textContent=`${a}/${i}/${r}`,document.getElementById(`dp-trigger`).classList.add(`has-value`),document.getElementById(`dp-popup`).classList.add(`hidden`);let o=document.getElementById(`dp-repeats-wrap`);o&&(o.style.display=``)}function Po(e){e.stopPropagation();let t=Oo();t&&(t.value=``),document.getElementById(`dp-display`).textContent=`Select a date`,document.getElementById(`dp-trigger`).classList.remove(`has-value`),document.getElementById(`dp-popup`).classList.add(`hidden`);let n=document.getElementById(`dp-repeats-wrap`);n&&(n.style.display=`none`)}function Fo(){let[e,t]=G.split(`-`).map(Number),n=new Date(e,t-2,1);G=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,Bl()}function Io(){let[e,t]=G.split(`-`).map(Number),n=new Date(e,t,1);if(G=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,m.settings&&m.settings.autoFillMonths&&!go(G)){yo(G);return}Bl()}function K(e){let[t,n]=e.split(`-`).map(Number);return new Date(t,n-1,1).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`})}function Lo(e){let[t,n]=e.split(`-`).map(Number);return new Date(t,n-1,1).toLocaleDateString(`en-AU`,{month:`short`,year:`2-digit`})}function Ro(){let e=[],t=new Date;for(let n=5;n>=0;n--){let r=new Date(t.getFullYear(),t.getMonth()-n,1);e.push(`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}`)}return e}function zo(e,t){let n=(m.budget.actuals[t]||{})[e];return n?typeof n==`number`?[{id:1,amount:n,date:``,note:``}]:Array.isArray(n)?n:[]:[]}function q(e,t){return zo(e,t).reduce((e,t)=>e+(t.amount||0),0)}function Bo(e,t,n){m.budget.actuals[t]||(m.budget.actuals[t]={});let r=zo(e,t);r.length===1&&!r[0].date&&!r[0].note?m.budget.actuals[t][e]=[{...r[0],amount:n}]:m.budget.actuals[t][e]=[{id:1,amount:n,date:``,note:``}],z(m)}function Vo(e){let t=W(G).expenses.find(t=>t.id===e);if(!t)return;let n=A(t);function r(){let t=zo(e,G),r=t.reduce((e,t)=>e+(t.amount||0),0),i=n>0?Math.round(r/n*100):0,a=i>=100?`var(--danger)`:i>=80?`var(--warning)`:`var(--success)`;return`
      ...
      </div>`:`<p style="font-size:13px;color:var(--text-muted);margin-bottom:14px">No entries yet for ${K(G)}.</p>`}
    ...
    `}function i(){document.getElementById(`actual-editor-body`).innerHTML=r()}window._actualEditorRefresh=i,document.getElementById(`modal-title`).textContent=`Actuals — ${t.name}`,document.getElementById(`modal-body`).innerHTML=`<div id="actual-editor-body">${r()}</div>`,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-primary" onclick="closeModal();renderBudget()">Done</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Ho(e){let t=parseFloat(document.getElementById(`ae-amount`).value);if(!t||t<=0)return;let n=document.getElementById(`ae-date`).value||``,r=document.getElementById(`ae-note`).value.trim();m.budget.actuals[G]||(m.budget.actuals[G]={});let i=zo(e,G);i.push({id:i.length?Math.max(...i.map(e=>e.id))+1:1,amount:t,date:n,note:r}),m.budget.actuals[G][e]=i,z(m),window._actualEditorRefresh&&window._actualEditorRefresh()}function Uo(e,t){if(!m.budget.actuals[G])return;let n=zo(e,G);n.splice(t,1),m.budget.actuals[G][e]=n,z(m),window._actualEditorRefresh&&window._actualEditorRefresh()}function Wo(e){Vo(e)}var Go=[],Ko=[];function qo(){document.getElementById(`modal-title`).textContent=`Import Bank Transactions`,document.getElementById(`modal-body`).innerHTML=`
    <div style="padding:4px 0">
      <p style="font-size:13px;color:var(--text-muted);margin-bottom:16px">
        Upload a CSV exported from your bank. Works with ANZ, CBA, Westpac, NAB and most Australian banks.
        Transactions will be matched to your <strong>${K(G)}</strong> budget categories.
      </p>
    ...
    <div>
      <div style="background:var(--success-light);border:1px solid #6ee7b7;border-radius:8px;padding:10px 14px;margin-bottom:16px;font-size:13px;color:#155e75">
        Found <strong>${Go.length} expense transactions</strong> in your CSV
      </div>
      <div class="table-wrap" style="margin-bottom:16px">
        <table>
          ...
          <tbody>
            ...
            ${Go.length>5?`<tr><td colspan="3" style="text-align:center;color:var(--text-muted);font-size:12px;padding:8px">+ ${Go.length-5} more rows…</td></tr>`:``}
          </tbody>
        </table>
      </div>
    ...
    <button class="btn" onclick="closeModal()">Cancel</button>
    ${e?`<button class="btn btn-primary" onclick="runCsvCategorise()">Categorise with AI →</button>`:`<button class="btn btn-primary" onclick="_renderCsvReview(null)">Assign Manually →</button>`}`}async function Zo(){let e=localStorage.getItem(`toto_ai_key`);if(!e){Qo(null);return}document.getElementById(`modal-body`).innerHTML=`
    <div style="text-align:center;padding:48px 16px">
      <div style="font-size:32px;margin-bottom:12px">🤖</div>
      <div style="font-weight:600;margin-bottom:6px">Categorising ${Go.length} transactions…</div>
      <div style="font-size:12px;color:var(--text-muted)">Matching to your ${K(G)} budget categories</div>
    </div>`,document.getElementById(`modal-footer`).innerHTML=``;let t=W(G).expenses.map(e=>`${e.id}: ${e.name}${e.category?` (`+e.category+`)`:``}`).join(`
`),n=Go.some(e=>e.bankCat),r,i;if(window._csvSuggestions={},n){let e={};Go.forEach((t,n)=>{let r=t.bankCat||`Other`;e[r]||(e[r]={bankCat:r,indices:[],sample:t.description}),e[r].indices.push(n)});let t=Object.values(e);r=t.map((e,t)=>({idx:t,bankCategory:e.bankCat,sample:e.sample})),i=e=>{let n={};return e.forEach(e=>{let r=t[e.idx];r&&r.indices.forEach(t=>{n[t]=e.expenseId,e.suggest&&(_csvSuggestions[t]=e.suggest)})}),n}}else{let e={};Go.forEach((t,n)=>{let r=t.description.toUpperCase().replace(/\s+/g,` `).trim();e[r]||(e[r]={desc:t.description,indices:[]}),e[r].indices.push(n)});let t=Object.values(e);r=t.map((e,t)=>({idx:t,description:e.desc})),i=e=>{let n={};return e.forEach(e=>{let r=t[e.idx];r&&r.indices.forEach(t=>{n[t]=e.expenseId,e.suggest&&(_csvSuggestions[t]=e.suggest)})}),n}}let a=n?`bank categories`:`unique transaction descriptions`,o=`You are categorising Australian bank transactions for a family budget app.

The user's EXISTING budget expense categories (id: name):
${t||`(none yet)`}

Here are ${r.length} ${a} from their bank statement (${Go.length} total transactions):
${JSON.stringify(r)}
...
[{"idx":0,"expenseId":3},{"idx":1,"expenseId":-1,"suggest":"Dining Out"},{"idx":2,"expenseId":-1}]`;try{let t=await fetch(Kr,{method:`POST`,headers:{"x-api-key":e,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:4096,messages:[{role:`user`,content:o}]})});if(!t.ok)throw Error(`API error ${t.status}`);let n=(await t.json()).content[0].text.replace(/```[\w]*\n?/g,``).trim().match(/\[[\s\S]*\]/);if(!n)throw Error(`No JSON in response`);let r=JSON.parse(n[0]);Qo(i(r))}catch(e){document.getElementById(`modal-body`).innerHTML=`
    ...
    </tr>`}).join(``),u=e?`<div style="font-size:12px;color:var(--text-muted);margin-bottom:10px">🤖 Transactions grouped by category — review and adjust as needed.</div>`:``,d=Ko.filter(e=>e.checked&&e.expenseId!==-1).length,f=Ko.filter(e=>e.checked&&e.expenseId!==-1).reduce((e,t)=>e+t.count,0);document.getElementById(`modal-body`).innerHTML=`
    <div>
      ${u}
    ...
    </div>`;let p=Ko.filter(e=>e.checked&&e.expenseId===-1).length;document.getElementById(`modal-footer`).innerHTML=`
    ...
    </div>`}function $o(e,t){Ko[e].checked=t,ns()}function es(e){Ko.forEach((t,n)=>{t.checked=e;let r=document.getElementById(`csv-chk-${n}`);r&&(r.checked=e)}),ns()}function ts(e,t){Ko[e].expenseId=t,Ko[e].checked=!0;let n=document.getElementById(`csv-chk-${e}`);n&&(n.checked=!0),ns()}function ns(){let e=Ko.filter(e=>e.checked&&e.expenseId!==-1),t=Ko.filter(e=>e.checked&&e.expenseId===-1),n=e.length,r=e.reduce((e,t)=>e+t.count,0),i=document.getElementById(`csv-apply-btn`);i&&(i.textContent=`Apply ${n} group${n===1?``:`s`} (${r} txns)`,i.disabled=n===0);let a=document.getElementById(`csv-pending-note`);a&&(a.textContent=t.length>0?`${t.length} checked group${t.length===1?``:`s`} still need a category assigned`:``)}function rs(){let e=Ko.filter(e=>e.checked&&e.expenseId!==-1);if(!e.length){Q();return}m.budget.actuals[G]||(m.budget.actuals[G]={});let t=window._csvSuggestNames||{},n={};e.forEach(e=>{let r=e.expenseId;if(r<-1&&t[r]){if(!n[r]){let e={id:M(m.budget.expenses),name:t[r],amount:0,frequency:`monthly`,category:t[r],dueDate:``,vendor:null};if(m.budget.expenses.push(e),go(G)){let t=m.budget.months[G];t.expenses.push({...e,id:M(t.expenses)}),n[r]=t.expenses[t.expenses.length-1].id}else n[r]=e.id}r=n[r]}let i=zo(r,G),a=i.length?Math.max(...i.map(e=>e.id))+1:1,o=e.descs.join(`, `)+(e.count>e.descs.length?` +${e.count-e.descs.length} more`:``);i.push({id:a,amount:e.total,date:e.txns[0].date,note:`${e.count} transactions: ${o}`}),m.budget.actuals[G][r]=i}),z(m),Q(),renderAll()}var J=``,is=null;function as(){ss(),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>document.getElementById(`qa-sheet`).classList.add(`open`))}function os(){document.getElementById(`qa-sheet`).classList.remove(`open`),document.getElementById(`qa-overlay`).classList.remove(`open`)}function ss(){document.getElementById(`qa-sheet`).innerHTML=`
    ...
    <div style="height:max(12px,env(safe-area-inset-bottom))"></div>`,requestAnimationFrame(()=>document.getElementById(`qah-text`)?.focus())}function cs(e){os(),setTimeout(()=>{if(e===`event`)b(`planner`),setTimeout(()=>Rn(null,new Date().toISOString().slice(0,10)),300);else if(e===`expense`){let e=W(G).expenses,t=parseInt(localStorage.getItem(`toto_qa_last`)||`0`);is=e.find(e=>e.id===t)?.id??e[0]?.id??null,J=``,ds(e),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>document.getElementById(`qa-sheet`).classList.add(`open`))}else e===`income`?(b(`budget`),setTimeout(()=>lu(),300)):e===`bill`?(b(`bills`),setTimeout(()=>lt(),300)):e===`chore`?(b(`kids`),setTimeout(()=>{typeof renderChoreMgmt==`function`&&renderChoreMgmt()},300)):e===`shopping`?(Gu=`food`,Ku=`list`,b(`lists`)):e===`ai`&&typeof dr==`function`&&dr()},320)}async function ls(){let e=document.getElementById(`qah-text`)?.value.trim();if(!e){cs(`ai`);return}let t=document.querySelector(`.qah-ai-send`);t&&(t.textContent=`…`,t.disabled=!0);let n=`Today is ${new Date().toISOString().slice(0,10)}. The user typed: "${e}"
...
- If genuinely unclear → unknown`;try{let t=m.settings?.claudeApiKey,r=(await(await fetch(Kr,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:150,messages:[{role:`user`,content:n}]})})).json()).content?.[0]?.text?.trim()||`{"type":"unknown"}`,i=JSON.parse(r.replace(/```[\w]*\n?/g,``).trim());os(),await us(i,e)}catch{os(),setTimeout(()=>{typeof dr==`function`&&dr(),setTimeout(()=>{let t=document.getElementById(`toto-input`)||document.querySelector(`.toto-msg-input`);t&&(t.value=e,t.focus())},400)},320)}}async function us(e,t){let n=e=>new Promise(t=>setTimeout(t,e));if(e.type===`event`){b(`planner`),await n(320),Rn(null,e.date||new Date().toISOString().slice(0,10)),await n(200);let r=document.getElementById(`pe-title`),i=document.getElementById(`pe-time`);if(r&&(r.value=e.title||t),i&&e.time&&(i.value=e.time),e.date){let t=document.getElementById(`pe-date`),n=document.getElementById(`pm-start-display`);t&&(t.value=e.date),n&&typeof Bn==`function`&&(n.textContent=Bn(e.date))}}else if(e.type===`expense`){let t=W(G).expenses,n=parseInt(localStorage.getItem(`toto_qa_last`)||`0`);is=t.find(e=>e.id===n)?.id??t[0]?.id??null,J=e.amount?String(e.amount):``,ds(t),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>{document.getElementById(`qa-sheet`).classList.add(`open`);let t=document.getElementById(`qa-note`);t&&e.note&&(t.value=e.note)})}else if(e.type===`income`){b(`budget`),await n(320),lu(),await n(200);let t=document.getElementById(`inc-name`)||document.querySelector(`#modal-body [id*="name"]`),r=document.getElementById(`inc-amount`)||document.querySelector(`#modal-body [id*="amount"]`);t&&e.name&&(t.value=e.name),r&&e.amount&&(r.value=e.amount)}else if(e.type===`bill`){b(`bills`),await n(320),lt(),await n(200);let t=document.getElementById(`bill-name`),r=document.getElementById(`bill-amount`),i=document.getElementById(`bill-due`);t&&e.name&&(t.value=e.name),r&&e.amount&&(r.value=e.amount),i&&e.dueDate&&(i.value=e.dueDate)}else if(e.type===`chore`)b(`kids`),await n(320);else if(e.type===`shopping`){Gu=`food`,Ku=`list`,b(`lists`),await n(320);let t=document.getElementById(`ls-quick-input`);t&&e.name&&(t.value=e.name,t.focus())}else{typeof dr==`function`&&dr(),await n(400);let e=document.getElementById(`toto-input`)||document.querySelector(`.toto-msg-input`);e&&(e.value=t,e.focus())}}function ds(e){let t=e||W(G).expenses,n=J?`$${J}`:`$0`,r=!J,i=t.length?t.map(e=>`<button class="qa-cat${e.id===is?` selected`:``}" onclick="_qaSelectCat(${e.id})">${x(e.name)}</button>`).join(``):`<span style="color:var(--text-muted);font-size:13px;padding:6px 4px">Add budget expenses first</span>`,a=[`1`,`2`,`3`,`4`,`5`,`6`,`7`,`8`,`9`,`.`,`0`,`⌫`];document.getElementById(`qa-sheet`).innerHTML=`
    <div class="qa-handle"></div>
    ...
    </div>`}function fs(e){if(e===`⌫`)J=J.slice(0,-1);else if(e===`.`)J.includes(`.`)||(J+=(J?``:`0`)+`.`);else{let t=J.split(`.`);if(t[1]!==void 0&&t[1].length>=2||J.replace(`.`,``).length>=6)return;J===`0`&&e!==`.`?J=e:J+=e}let t=document.getElementById(`qa-display`);if(!t)return;let n=!J;t.textContent=J?`$${J}`:`$0`,t.className=`qa-amount-display${n?` zero`:``}`}function ps(e){is=e,document.querySelectorAll(`.qa-cat`).forEach(t=>{t.classList.toggle(`selected`,parseInt(t.getAttribute(`onclick`).match(/\d+/)[0])===e)})}function ms(){let e=parseFloat(J);if(!e||e<=0){let e=document.getElementById(`qa-display`);e&&(e.style.color=`var(--danger)`,setTimeout(()=>e.style.color=``,600));return}if(!is){let e=document.getElementById(`qa-cats`);e&&(e.style.outline=`2px solid var(--danger)`,e.style.borderRadius=`8px`,setTimeout(()=>{e.style.outline=``},600));return}let t=document.getElementById(`qa-note`)?.value.trim()||``,n=new Date().toISOString().slice(0,10);m.budget.actuals[G]||(m.budget.actuals[G]={});let r=zo(is,G),i=r.length?Math.max(...r.map(e=>e.id))+1:1;r.push({id:i,amount:e,date:n,note:t}),m.budget.actuals[G][is]=r,localStorage.setItem(`toto_qa_last`,String(is)),z(m),os(),renderAll();let a=document.getElementById(`qa-fab`);a&&(a.textContent=`✓`,a.style.background=`#10b981`,setTimeout(()=>{a.textContent=`+`,a.style.background=``},1800))}window.addEventListener(`resize`,()=>{document.querySelectorAll(`.section-pills-wrap`).forEach(v)}),document.querySelectorAll(`.nav-item, .nav-text-item`).forEach(e=>{e.addEventListener(`click`,()=>b(e.dataset.tab))});function hs(){let[e,t]=G.split(`-`).map(Number),n=new Date(e,t-2,1);G=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,safeRender(_s),safeRender(Bl)}function gs(){let[e,t]=G.split(`-`).map(Number),n=new Date(e,t,1);G=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,safeRender(_s),safeRender(Bl)}function _s(){let e=W(G),t=e.income,n=e.expenses,r=j(t),i=j(n),a=r-i,o=r>0?Math.round(a/r*100):0,s={};n.forEach(e=>{let t=e.category||`Other`;s[t]=(s[t]||0)+A(e)});let c=Object.entries(s).sort((e,t)=>t[1]-e[1]),l=m.budget.actuals[G]||{},u=n.reduce((e,t)=>e+q(t.id,G),0),d=u>0,f=`
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px">
      <button class="btn btn-sm" onclick="prevMoneyMonth()" style="font-size:16px;padding:2px 10px">‹</button>
      <span style="font-size:16px;font-weight:600;min-width:140px;text-align:center">${K(G)}</span>
      <button class="btn btn-sm" onclick="nextMoneyMonth()" style="font-size:16px;padding:2px 10px">›</button>
      ${go(G)?`<span style="margin-left:8px;font-size:12px;padding:2px 10px;background:#dbeafe;color:#1d4ed8;border-radius:99px">Custom month</span>`:``}
    </div>
  ...
  `,f+=`
    <div class="section">
      ...
      <div style="padding:16px 20px">
        ${c.length===0?`<div style="color:var(--text-muted);text-align:center;padding:20px">No expenses added yet</div>`:c.map(([e,t])=>{let r=Y.expense[e]||`#94a3b8`,a=i>0?t/i*100:0,o=n.filter(t=>(t.category||`Other`)===e).reduce((e,t)=>e+(l[t.id]||0),0),s=n.some(t=>(t.category||`Other`)===e&&l[t.id]!==void 0);return`
  ...
  `,f+=`</div>`,d){let e=i-u;f+=`
      <div class="section" style="margin-bottom:20px">
        <div class="section-header">
          <div>
            <div class="section-title">Actuals — ${K(G)}</div>
        ...
        <div class="table-wrap">
          <table>
            ...
            <tbody>
              ${n.filter(e=>l[e.id]!==void 0).map(e=>{let t=A(e),n=l[e.id]||0,r=t-n,i=Y.expense[e.category||`Other`]||`#94a3b8`;return`<tr>
    ...
    `}let p=Ro().map(e=>{let t=W(e);return{label:Lo(e),income:j(t.income),expenses:j(t.expenses),actual:Object.values(m.budget.actuals[e]||{}).reduce((e,t)=>e+t,0)}}),h=Math.max(...p.flatMap(e=>[e.income,e.expenses,e.actual]),1),g=524/p.length,_=g*.22,v=[0,.25,.5,.75,1].map(e=>{let t=148-e*136;return`<line x1="64" y1="${t}" x2="588" y2="${t}" stroke="#e2e8f0" stroke-width="1"/>
  ...
  `,document.getElementById(`money-content`).innerHTML=f}function vs(){let e=W(G),t=j(e.income),n=j(e.expenses),r=t-n,i=t>0?r/t:null,a;a=t===0?10:i>=.2?20:i>=0?Math.round(i/.2*20):0;let o=Ro().slice(3),s=0,c=0;o.forEach(e=>{let t=W(e);t.expenses.some(t=>zo(t.id,e).length>0)&&(s++,t.expenses.reduce((t,n)=>t+q(n.id,e),0)<=j(t.expenses)&&c++)});let l=s===0?5:Math.round(s/3*10+c/s*10),u=(m.netWorth.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),d=(m.netWorth.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),f=u-d,p;if(u===0&&d===0)p=10;else if(f<=0)p=3;else{let e=d>0?d/u:0;p=e<.3?20:e<.6?15:e<.8?10:6}let h;if(n===0)h=10;else{let e=u/n;h=e>=6?20:e>=3?15:e>=1?8:u===0?5:3}let g=(m.goals||[]).filter(e=>e.status!==`achieved`),_;if(g.length===0)_=8;else{let e=g.reduce((e,t)=>e+Math.min((t.saved||0)/(t.target||1),1),0)/g.length;_=10+Math.round(e*10)}let v=a+l+p+h+_,y=v>=85?`A`:v>=70?`B`:v>=55?`C`:v>=40?`D`:`F`,b=v>=80?`#10b981`:v>=60?`#f59e0b`:v>=40?`#f97316`:`#ef4444`,x=[...[{score:a,tip:`Boost your savings rate — aim for 20%+ of income (currently ${t>0?Math.round((i||0)*100):0}%)`},{score:l,tip:`Log actuals monthly in the Budget tab to stay on track`},{score:p,tip:`Reduce liabilities or grow assets to strengthen your net worth`},{score:h,tip:`Build an emergency fund of 3–6 months expenses (${w(n*3)}–${w(n*6)})`},{score:_,tip:`Set specific savings goals in the Goals tab to stay focused`}]].sort((e,t)=>e.score-t.score)[0];return{total:v,grade:y,color:b,insight:x.score<12?x.tip:`Great shape — stay consistent and keep building your financial cushion.`,dimensions:[{label:`Savings Rate`,score:a,max:20},{label:`Budget Tracking`,score:l,max:20},{label:`Net Worth`,score:p,max:20},{label:`Emergency Buffer`,score:h,max:20},{label:`Goals`,score:_,max:20}]}}var ys={Wallet:`#059669`,Plan:`#0891b2`,Home:`#7c3aed`};function bs(e){return e?`<span style="font-size:10px;font-weight:700;color:${ys[e]||`#71717a`};margin-right:6px">${e}</span>`:``}function xs(e){let t={red:`#ef4444`,amber:`#f59e0b`,green:`#10b981`,blue:`#0891b2`}[e.cls]||`#a1a1aa`,n=e.onclick?e.onclick:e.tab?`activateTab('${e.tab}')`:``;return`<div class="notif-tl-item">
    ...
    </div>`,r.addEventListener(`click`,t=>{t.target===r&&Ts(e.id)}),document.body.appendChild(r)}function ks(){if(!m.settings?.typeAMode)return;let e=ws();if(!e)return;let t=new Date().toISOString().slice(0,10);if(m.settings.typeAMissionId!==e.id){m.settings.typeAMissionId=e.id,m.settings.typeAMissionShownDate=t,z(m);return}Ds()>=1&&setTimeout(()=>Os(e),1500)}function As(){Cs();let e=W(G),t=e.expenses.reduce((e,t)=>e+q(t.id,G),0),r=j(e.expenses),i=$(1),a=m.meals?.plan?.[i]||{},o=Object.values(a).reduce((e,t)=>e+ +!!t.b+ +!!t.l+ +!!t.d,0),s=(m.maintenance||[]).filter(e=>{let t=Se(e);return t!==null&&t<0}).length,c=(m.bills||[]).filter(e=>{let t=n(e);return t>=0&&t<=7}),l=(m.meals?.pantry||[]).filter(e=>e.status===`need`||e.status===`low`).length,u=document.createElement(`div`);u.className=`reset-overlay`,u.innerHTML=`
  ...
  </div>`}function Ns(){let e=ws();if(!e)return``;let t=Ds(),n=e.onclick?`onclick="${e.onclick}"`:e.tab?`onclick="activateTab('${e.tab}')"`:``;return`<div class="mission-card" ${n}>
    ...
    </div>`}).join(``)+`</div>`}function Ws(e){let t=e.onclick?e.onclick:e.tab?`activateTab('${e.tab}')`:``,n=zs(e),r=[`red`,`amber`,`green`,`blue`].includes(e.cls)?e.cls:`grey`;return`<div class="brief-row"${t?` onclick="${t}"`:``}>
    ...
    <svg class="brief-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
      ...
      <div style="flex:1;min-width:0;background:#F0FDF4;border-radius:var(--r-lg);padding:16px;display:flex;flex-direction:column;justify-content:space-between;min-height:140px;border:1px solid rgba(16,185,129,.18);box-shadow:0 1px 0 rgba(255,255,255,.9) inset">
      ...
      </div>`})}let y=W(G),b=j(y.income),S=j(y.expenses),C=b-S,ee=(y.expenses||[]).reduce((e,t)=>e+q(t.id,G),0),w=new Date(t.getFullYear(),t.getMonth()+1,0).getDate()-t.getDate(),T=S>0?Math.min(100,Math.round(ee/S*100)):0;if(b>0||S>0){let e=C>=0?``:`td-money-status-watch`,n=C>=0?`On track`:`Over budget`,r=Math.abs(C),i=[];d.forEach(e=>i.push(`<span class="td-money-flag td-money-flag-watch">${x(e.name)} due ${e.days===0?`today`:e.days===1?`tomorrow`:`in `+e.days+`d`}</span>`)),u.push({type:`money`,urgency:0,html:`<div class="td-card td-card-money">
        ...
        ${o?``:`<div style="font-size:11px;color:var(--muted-soft);padding:4px 0 2px;font-family:var(--mono)">${Vi?Vi(e):``}</div>`}
    ...
    ${se}
    ${ce}
  `,m.settings?.typeAMode&&ks(),typeof ec==`function`){let e=typeof vs==`function`?vs():null,n=typeof $==`function`?$(0):null,r=n&&m.meals?.plan?.[n]?.[t.getDay()===0?6:t.getDay()-1]||{};ec(u.map(e=>({title:e.type})),C,w,r,e)}}function Ks(){let e=(m.bills||[]).map(e=>({...e,days:n(e)})).filter(e=>e.days!==null&&e.days<=2).sort((e,t)=>e.days-t.days);if(!e.length)return;let t=e.reduce((e,t)=>e+(parseFloat(t.amount)||0),0);Js(`Heads Up`,e.map(e=>{let t=e.days===0?`Due today`:e.days===1?`Tomorrow`:`In ${e.days} days`,n=e.days===0?`background:#FEF2F2;color:#b91c1c`:e.days===1?`background:#FFF4EE;color:#c2410c`:`background:var(--paper);color:var(--muted)`,r=e.amount?`$${parseFloat(e.amount).toLocaleString(`en-AU`,{minimumFractionDigits:2,maximumFractionDigits:2})}`:``,i=e.days===0?`box-shadow:0 0 0 3px rgba(239,68,68,.2)`:e.days===1?`box-shadow:0 0 0 3px rgba(249,115,22,.2)`:``;return`<div style="display:flex;align-items:center;padding:13px 18px;border-bottom:1px solid var(--hairline);gap:14px">
  ...
  </div>`)}function qs(){let e=new Date,t=[];(m.documents||[]).forEach(n=>{n.expiryDate&&new Date(n.expiryDate)<e&&t.push({label:n.name,sub:`Documents`,badge:`Expired`,cls:`alert`,tab:`documents`})}),(m.maintenance||[]).forEach(e=>{let n=Se(e);n!==null&&n<0&&t.push({label:e.name,sub:`Maintenance`,badge:`${Math.abs(n)}d overdue`,cls:`watch`,tab:`maintenance`})}),(m.vehicles||[]).forEach(n=>{n.regoExpiry&&new Date(n.regoExpiry)<e&&t.push({label:n.name+` rego`,sub:`Vehicles`,badge:`Expired`,cls:`alert`,tab:`vehicles`})}),t.length&&Js(`Slipping`,t.map(e=>{let t=e.cls===`alert`?`#ef4444`:`var(--ember)`,n=e.cls===`alert`?`box-shadow:0 0 0 3px rgba(239,68,68,.15)`:`box-shadow:0 0 0 3px rgba(249,115,22,.18)`,r=e.cls===`alert`?`background:#FEF2F2;color:#b91c1c`:`background:#FFF4EE;color:#c2410c`;return`<div onclick="activateTab('${e.tab}');_tdCloseSheet()" style="display:flex;align-items:center;padding:13px 18px;border-bottom:1px solid var(--hairline);gap:14px;cursor:pointer">
  ...
  </div>`)}function Js(e,t){let n=document.getElementById(`td-sheet-overlay`);n||(n=document.createElement(`div`),n.id=`td-sheet-overlay`,n.style.cssText=`position:fixed;inset:0;z-index:1200;display:flex;flex-direction:column;justify-content:flex-end;background:rgba(0,0,0,.4)`,n.onclick=e=>{e.target===n&&Ys()},document.body.appendChild(n)),n.innerHTML=`
  ...
  </div>`).join(``);typeof Z==`function`&&Z(`💡 Insights`,`<div style="padding:0 4px">${i}</div>`,null)}var Qs=``,$s=``;async function ec(e,t,n,r,i){let a=localStorage.getItem(`toto_ai_key`);if(!a)return;let o=new Date().toISOString().slice(0,10);if(Qs===o&&$s){let e=document.getElementById(`today-briefing-text`);e&&(e.textContent=$s);return}let s=e.filter(e=>e.cls===`red`).map(e=>e.title),c=e.filter(e=>e.cls===`amber`).map(e=>e.title),l=`You are Toto, a friendly family personal assistant app. Write a 2-sentence daily briefing for the user based on this context:
...
- Don't start with "Here's" or "Today"`;try{let e=await fetch(Kr,{method:`POST`,headers:{"x-api-key":a,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:100,messages:[{role:`user`,content:l}]})});if(!e.ok)return;let t=(await e.json()).content[0].text.trim().replace(/^["']|["']$/g,``);$s=t,Qs=o;let n=document.getElementById(`today-briefing-text`);n&&(n.textContent=t)}catch{}}function tc(){let e=m,r=e.buildContract,i=(e.netWorth.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),a=(e.netWorth.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),o=i-a,s=e.netWorth.snapshots||[],c=``;if(s.length>=2){let e=o-s[s.length-2].netWorth;c=`<span class="${e>=0?`up`:`dn`}">${e>=0?`+`:``}${E(e)}</span> vs last snapshot`}let l=G,u=W(l),d=j(u.income),f=j(u.expenses),p=d-f,h=(e.subscriptions||[]).reduce((e,t)=>e+_t(t),0),g=(e.bills||[]).filter(e=>{let t=n(e);return t>=0&&t<=31}).reduce((e,t)=>e+(parseFloat(t.amount)||0),0),_=[...e.bills||[]].filter(e=>n(e)>=-1).sort((e,t)=>n(e)-n(t)).slice(0,5),v=(e.goals||[]).filter(e=>e.status!==`achieved`).slice(0,4),y=r.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0),b=(r.variations||[]).filter(e=>e.status===`approved`).reduce((e,t)=>e+(t.amount||0),0),S=r.total+b,C=Math.round(y/S*100),ee=r.stages.find(e=>!e.paid),T=((e.kids||{}).completions||[]).filter(e=>e.status===`pending`).length+((e.kids||{}).redemptions||[]).filter(e=>e.status===`pending`).length,D=Ro(),te=j(u.expenses),O=D.map(e=>{let t=Object.values(m.budget.actuals[e]||{}).reduce((e,t)=>e+t,0);return{label:Lo(e),budget:te,actual:t}}),ne=te>0||O.some(e=>e.actual>0),k=vs(),re=251.3,A=(k.total/100*re).toFixed(1),M=k.dimensions.map(e=>{let t=Math.round(e.score/e.max*100),n=t>=75?`#10b981`:t>=50?`#f59e0b`:`#ef4444`;return`
    ...
    <div class="db-grid">
      ...
      <div>
        ...
        <div class="db-widget">
          <div class="db-widget-header">
            <span class="db-widget-title">Budget · ${K(l)}</span>
  ...
  `;let u=m.extras,d=u.reduce((e,t)=>e+(t.totalAmount||0),0),f=u.reduce((e,t)=>e+(t.amountPaid||0),0);c+=`
    <div class="section" style="border-left:4px solid ${Y.build.extras}">
      <div class="section-header">
        <div>
  ...
  `;let p=m.furniture,h=p.reduce((e,t)=>e+(t.price||0),0),g=p.filter(e=>e.status===`delivered`||e.status===`ordered`),_=p.filter(e=>e.status===`to-purchase`),v=g.reduce((e,t)=>e+(t.price||0),0),y=_.reduce((e,t)=>e+(t.price||0),0);c+=`
    <div class="section" style="border-left:4px solid ${Y.build.furniture}">
      <div class="section-header">
        <div>
  ...
  `;let b=m.appliances,C=b.reduce((e,t)=>e+(t.price||0),0),ee=b.filter(e=>e.status===`delivered`||e.status===`ordered`),T=b.filter(e=>e.status===`to-purchase`),E=ee.reduce((e,t)=>e+(t.price||0),0),O=T.reduce((e,t)=>e+(t.price||0),0);c+=`
    <div class="section" style="border-left:4px solid ${Y.build.appliances}">
      <div class="section-header">
        <div>
  ...
  `,document.getElementById(`build-content`).innerHTML=c}function rc(){return m.expenseCategories||qr.expenseCategories}function ic(){return m.incomeCategories||qr.incomeCategories}var ac=[{value:`spending`,label:`Spending Limit`,icon:`📉`},{value:`savings`,label:`Savings Target`,icon:`🏦`},{value:`income`,label:`Income Target`,icon:`📈`}];function oc(e){if(e.type===`spending`){let t=Object.keys(m.budget.actuals).sort().reverse(),n=null;for(let r of t){let t=(W(r).expenses||[]).filter(t=>(t.category||`Other`)===e.category).reduce((e,t)=>e+(m.budget.actuals[r]?.[t.id]||0),0);if(t>0){n=t;break}}let r=e.targetMonthly||0;if(n===null)return{pct:null,label:`No actuals yet`,actual:null,target:r};let i=r>0?Math.max(0,Math.min(100,n/r*100)):0,a=n<=r;return{pct:i,label:`${w(n)} actual vs ${w(r)} limit`,actual:n,target:r,ok:a}}if(e.type===`savings`){let t=e.currentSaved||0,n=e.targetTotal||1;return{pct:Math.min(100,t/n*100),label:`${w(t)} of ${w(n)} saved`,ok:t>=n}}if(e.type===`income`){let t=j(W(G).income),n=e.targetMonthly||1;return{pct:Math.min(100,t/n*100),label:`${w(t)}/mo of ${w(n)}/mo target`,ok:t>=n}}return{pct:0,label:``,ok:!1}}function sc(){let e=m.goals,t=e.filter(e=>e.status===`active`),n=e.filter(e=>e.status===`achieved`),r=``;e.length>0&&(r+=`
    ...
    <button class="btn btn-primary" onclick="openAddGoal()">+ New Goal</button>
  </div>`,i.length===0){let e=W(G),t=j(e.income)-j(e.expenses),n=t>0?`<div style="font-size:14px;color:#64748b;margin-bottom:4px">You have <strong style="color:#16a34a">${w(t)}</strong> surplus each month.</div>
      ...
      <div style="background:#fff;border:2px dashed #cbd5e1;border-radius:16px;padding:36px 24px;text-align:center;margin-top:8px">
        ...
        </div>`});document.getElementById(`goals-content`).innerHTML=r}function cc(e={}){let t=e.type||`spending`;return`
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <select class="form-select" id="f-goal-type" onchange="toggleGoalFields()">
        ${ac.map(e=>`<option value="${e.value}" ${t===e.value?`selected`:``}>${e.icon} ${e.label}</option>`).join(``)}
      </select>
    </div>
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <select class="form-select" id="f-goal-category">
            ${rc().map(t=>`<option value="${t}" ${e.category===t?`selected`:``}>${t}</option>`).join(``)}
          </select>
        </div>
        <div class="form-group">
  ...
  `}function lc(){let e=document.getElementById(`f-goal-type`).value;document.getElementById(`goal-spending-fields`).style.display=e===`spending`?``:`none`,document.getElementById(`goal-savings-fields`).style.display=e===`savings`?``:`none`,document.getElementById(`goal-income-fields`).style.display=e===`income`?``:`none`}function uc(e){let t=document.getElementById(`f-goal-type`).value,n={id:e,name:document.getElementById(`f-goal-name`).value.trim(),type:t,status:document.getElementById(`f-goal-status`).value,deadline:document.getElementById(`f-goal-deadline`).value||null,notes:document.getElementById(`f-goal-notes`).value.trim()};return t===`spending`&&(n.category=document.getElementById(`f-goal-category`).value,n.targetMonthly=parseFloat(document.getElementById(`f-goal-target-monthly`).value)||0),t===`savings`&&(n.targetTotal=parseFloat(document.getElementById(`f-goal-target-total`).value)||0,n.currentSaved=parseFloat(document.getElementById(`f-goal-current-saved`).value)||0),t===`income`&&(n.targetMonthly=parseFloat(document.getElementById(`f-goal-target-monthly-inc`).value)||0),n}function dc(){Z(`New Goal`,cc(),()=>{let e=uc(M(m.goals));e.name&&(m.goals.push(e),z(m),Q(),sc())})}function fc(e){let t=m.goals.find(t=>t.id===e);Z(`Edit Goal`,cc(t),()=>{Object.assign(t,uc(e)),z(m),Q(),sc()})}function pc(e){confirm(`Delete this goal?`)&&(m.goals=m.goals.filter(t=>t.id!==e),z(m),sc())}function mc(e){let t=m.goals.find(t=>t.id===e);t&&(t.status=`achieved`,z(m),sc())}var hc=null,gc=[{value:`add-income`,label:`Add income source`,icon:`💰`},{value:`remove-income`,label:`Remove income source`,icon:`➖`},{value:`reduce-income`,label:`Reduce income amount`,icon:`📉`},{value:`add-expense`,label:`Add new expense`,icon:`➕`},{value:`remove-expense`,label:`Remove expense`,icon:`✂️`},{value:`reduce-expense`,label:`Reduce expense amount`,icon:`📉`}];function _c(e){let t=W(G),n=JSON.parse(JSON.stringify(t.income)),r=JSON.parse(JSON.stringify(t.expenses));return(e.adjustments||[]).forEach(e=>{if(e.type===`add-income`)n.push({id:-(e.id||0),name:e.name,amount:e.amount||0,frequency:e.frequency||`monthly`});else if(e.type===`remove-income`)n=n.filter(t=>t.id!==e.itemId);else if(e.type===`reduce-income`){let t=n.find(t=>t.id===e.itemId);t&&(t.amount=e.changeType===`percent`?Math.max(0,t.amount*(1-e.changeAmount/100)):Math.max(0,t.amount-(e.changeAmount||0)))}else if(e.type===`add-expense`)r.push({id:-(e.id||0),name:e.name,amount:e.amount||0,frequency:e.frequency||`monthly`,category:e.category||`Other`});else if(e.type===`remove-expense`)r=r.filter(t=>t.id!==e.itemId);else if(e.type===`reduce-expense`){let t=r.find(t=>t.id===e.itemId);t&&(t.amount=e.changeType===`percent`?Math.max(0,t.amount*(1-e.changeAmount/100)):Math.max(0,t.amount-(e.changeAmount||0)))}}),{income:n,expenses:r,totalIncome:j(n),totalExpenses:j(r),surplus:j(n)-j(r)}}function vc(){let e=m.scenarios,t=W(G),n=j(t.income),r=j(t.expenses),i=n-r,a=`<div style="display:flex;justify-content:flex-end;margin-bottom:16px">
    <button class="btn btn-primary" onclick="openAddScenario()">+ New Scenario</button>
  </div>`;e.length===0?a+=`<div class="empty"><div class="empty-icon">🔬</div>No scenarios yet. Create one to model income changes, expense cuts, or lifestyle adjustments.</div>`:e.forEach(e=>{let t=_c(e),o=t.totalIncome-n,s=t.totalExpenses-r,c=t.surplus-i,l=hc===e.id;a+=`
        ...
        </div>`}),document.getElementById(`scenarios-content`).innerHTML=a}function yc(e){hc=hc===e?null:e,vc()}function bc(e={}){return`
    <div class="form-group">
  ...
  `}function xc(e,t={}){return{id:e,name:document.getElementById(`f-sc-name`).value.trim(),description:document.getElementById(`f-sc-desc`).value.trim(),adjustments:t.adjustments||[]}}function Sc(){Z(`New Scenario`,bc(),()=>{let e=xc(M(m.scenarios));e.name&&(m.scenarios.push(e),z(m),Q(),vc())})}function Cc(e){let t=m.scenarios.find(t=>t.id===e);Z(`Edit Scenario`,bc(t),()=>{let n=xc(e,t);Object.assign(t,n),z(m),Q(),vc()})}function wc(e){confirm(`Delete this scenario?`)&&(m.scenarios=m.scenarios.filter(t=>t.id!==e),hc===e&&(hc=null),z(m),vc())}function Tc(e){let t=W(G),n=t.income.map(e=>`<option value="${e.id}">${x(e.name)} (${w(A(e))}/mo)</option>`).join(``),r=t.expenses.map(e=>`<option value="${e.id}">${x(e.name)} (${w(A(e))}/mo)</option>`).join(``);return`
    <div class="form-group">
      <label class="form-label">Adjustment Type</label>
      <select class="form-select" id="f-adj-type" onchange="toggleAdjFields()">
        ${gc.map(e=>`<option value="${e.value}">${e.icon} ${e.label}</option>`).join(``)}
      </select>
    </div>
      ...
      <div class="form-row" id="adj-add-income-extra">
        ...
        <div class="form-group" id="adj-cat-wrap" style="display:none">
          ...
          <select class="form-select" id="f-adj-cat">
            ${rc().map(e=>`<option value="${e}">${e}</option>`).join(``)}
          </select>
        </div>
      </div>
    </div>
  ...
  `}function Ec(){let e=document.getElementById(`f-adj-type`).value;document.getElementById(`adj-add-income`).style.display=e===`add-income`||e===`add-expense`?``:`none`,document.getElementById(`adj-add-income-extra`).style.display=e===`add-income`||e===`add-expense`?``:`none`,document.getElementById(`adj-cat-wrap`).style.display=e===`add-expense`?``:`none`,document.getElementById(`adj-remove-income`).style.display=e===`remove-income`?``:`none`,document.getElementById(`adj-reduce-income`).style.display=e===`reduce-income`?``:`none`,document.getElementById(`adj-remove-expense`).style.display=e===`remove-expense`?``:`none`,document.getElementById(`adj-reduce-expense`).style.display=e===`reduce-expense`?``:`none`}function Dc(e){let t=m.scenarios.find(t=>t.id===e);t&&Z(`Add Adjustment`,Tc(t),()=>{let e=document.getElementById(`f-adj-type`).value,n=W(G),r={id:M(t.adjustments||[]),type:e};if(e===`add-income`){if(r.name=document.getElementById(`f-adj-name`).value.trim(),r.amount=parseFloat(document.getElementById(`f-adj-amount`).value)||0,r.frequency=document.getElementById(`f-adj-freq`).value,!r.name)return}else if(e===`add-expense`){if(r.name=document.getElementById(`f-adj-name`).value.trim(),r.amount=parseFloat(document.getElementById(`f-adj-amount`).value)||0,r.frequency=document.getElementById(`f-adj-freq`).value,r.category=document.getElementById(`f-adj-cat`).value,!r.name)return}else if(e===`remove-income`){let e=document.getElementById(`f-adj-inc-sel`);r.itemId=parseInt(e.value),r.itemName=e.options[e.selectedIndex]?.text||``}else if(e===`reduce-income`){let e=document.getElementById(`f-adj-inc-reduce-sel`);r.itemId=parseInt(e.value),r.itemName=n.income.find(e=>e.id===r.itemId)?.name||``,r.changeAmount=parseFloat(document.getElementById(`f-adj-change-amount`).value)||0,r.changeType=document.getElementById(`f-adj-change-type-inc`).value}else if(e===`remove-expense`){let e=document.getElementById(`f-adj-exp-sel`);r.itemId=parseInt(e.value),r.itemName=e.options[e.selectedIndex]?.text||``}else if(e===`reduce-expense`){let e=document.getElementById(`f-adj-exp-reduce-sel`);r.itemId=parseInt(e.value),r.itemName=n.expenses.find(e=>e.id===r.itemId)?.name||``,r.changeAmount=parseFloat(document.getElementById(`f-adj-change-amount-exp`).value)||0,r.changeType=document.getElementById(`f-adj-change-type-exp`).value}t.adjustments||(t.adjustments=[]),t.adjustments.push(r),z(m),Q(),vc()})}function Oc(e,t){let n=m.scenarios.find(t=>t.id===e);n&&(n.adjustments=(n.adjustments||[]).filter(e=>e.id!==t),z(m),vc())}var kc=`home_finance_colors_v1`,Ac={expense:{"Mortgage / Rent":`#6366f1`,Insurance:`#8b5cf6`,Utilities:`#06b6d4`,Groceries:`#10b981`,Transport:`#f59e0b`,"Childcare / Education":`#3b82f6`,Health:`#ef4444`,Entertainment:`#f97316`,Subscriptions:`#84cc16`,"Dining Out":`#14b8a6`,Clothing:`#ec4899`,"Personal Care":`#a855f7`,"Savings / Investment":`#22c55e`,Other:`#94a3b8`},income:`#10b981`,build:{contract:`#3b82f6`,extras:`#f59e0b`,furniture:`#8b5cf6`,appliances:`#ef4444`}};function jc(){try{let e=localStorage.getItem(kc);if(!e)return JSON.parse(JSON.stringify(Ac));let t=JSON.parse(e);return t.expense||(t.expense={}),t.build||(t.build={}),t.income||(t.income=Ac.income),rc().forEach(e=>{t.expense[e]||(t.expense[e]=Ac.expense[e]||`#94a3b8`)}),Object.keys(Ac.build).forEach(e=>{t.build[e]||(t.build[e]=Ac.build[e])}),t}catch{return JSON.parse(JSON.stringify(Ac))}}function Mc(e){localStorage.setItem(kc,JSON.stringify(e))}var Y=jc();function Nc(e,t,n){e===`expense`?Y.expense[t]=n:e===`income`?Y.income=n:e===`build`&&(Y.build[t]=n),Mc(Y),Bl(),nc(),tc()}function Pc(){return(m.householdProfile.members||[]).filter(e=>e.role===`adult`).length||1}function Fc(){return(m.householdProfile.members||[]).filter(e=>e.role===`child`).length}function Ic(e){m.householdProfile.members.push({role:e||`adult`,age:null}),vl(),X()}function Lc(e){let t=m.householdProfile.members[e];if(!t)return;let n=t.name||(t.role===`child`?`this child`:`this adult`);if(confirm(`Remove ${n} from the household?\n\nThis cannot be undone.`)){if(t.role===`child`&&t.name){let e=(m.kids?.profiles||[]).find(e=>e.name===t.name);e&&(m.kids.profiles=m.kids.profiles.filter(t=>t.id!==e.id),m.kids.chores=m.kids.chores.filter(t=>t.assignedTo!==e.id),m.kids.completions=m.kids.completions.filter(t=>t.kidId!==e.id),m.kids.redemptions=m.kids.redemptions.filter(t=>t.kidId!==e.id),m.meals?.lunchbox?.profiles&&(m.meals.lunchbox.profiles=m.meals.lunchbox.profiles.filter(t=>t.id!==e.id)),String(oi())===String(e.id)&&si(`adult`))}m.householdProfile.members.splice(e,1),z(m),renderAll()}}function Rc(e,t,n){let r=m.householdProfile.members[e];r&&(r[t]=n,vl(),(t===`role`||t===`name`)&&X())}function zc(e){m.householdProfile.pets.push({type:e||`dog`,name:``}),vl(),X()}function Bc(e){m.householdProfile.pets.splice(e,1),vl(),X()}function Vc(e,t,n){let r=m.householdProfile.pets[e];r&&(r[t]=n,vl())}function Hc(e){m.householdProfile.cars=e,vl()}function Uc(e,t,n){let r=t+n;return[{category:`Mortgage / Rent`,min:e*.2,max:e*.3,label:`20–30% of income`,source:`ABS / MoneySmart`,needs:!0},{category:`Groceries`,min:380+(t-1)*260+n*160,max:560+(t-1)*360+n*220,label:`$${Math.round(380+(t-1)*260+n*160)}–$${Math.round(560+(t-1)*360+n*220)}/month for ${r} ${r===1?`person`:`people`}`,source:`ABS HES 2022`,needs:!0},{category:`Transport`,min:e*.08,max:e*.15,label:`8–15% of income`,source:`ABS HES 2022`,needs:!0},{category:`Utilities`,min:180+t*25+n*15,max:360+t*40+n*25,label:`$${Math.round(180+t*25+n*15)}–$${Math.round(360+t*40+n*25)}/month`,source:`AER / ABS`,needs:!0},{category:`Insurance`,min:180+t*40+n*20,max:420+t*60+n*30,label:`$${Math.round(180+t*40+n*20)}–$${Math.round(420+t*60+n*30)}/month`,source:`APRA industry avg`,needs:!0},{category:`Health`,min:60*t+30*n,max:180*t+60*n,label:`$${60*t+30*n}–$${180*t+60*n}/month`,source:`AIHW / ABS`,needs:!0},...n>0?[{category:`Childcare / Education`,min:700*n,max:2200*n,label:`$700–$2,200/month per child (before subsidies)`,source:`ACCC Childcare Report`,needs:!0}]:[],{category:`Dining Out`,min:e*.02,max:e*.05,label:`2–5% of income`,source:`MoneySmart`,needs:!1},{category:`Entertainment`,min:e*.02,max:e*.05,label:`2–5% of income`,source:`MoneySmart`,needs:!1},{category:`Subscriptions`,min:30,max:120,label:`$30–$120/month`,source:`Industry average`,needs:!1},{category:`Clothing`,min:50*t+30*n,max:150*t+80*n,label:`$${50*t+30*n}–$${150*t+80*n}/month`,source:`ABS HES 2022`,needs:!1},{category:`Savings / Investment`,min:e*.1,max:e*.2,label:`10–20% of income (aim for 20%)`,source:`50/30/20 rule`,needs:!1}]}function Wc(e,t,n){return e<t*.9?`under`:e>n*1.1?`over`:`within`}var Gc=`home_finance_ai_key`;function Kc(){return localStorage.getItem(Gc)||``}function qc(e){localStorage.setItem(Gc,e)}function Jc(){let e=Ro(),t={};return e.forEach(e=>{let n=W(e),r={},i={};n.expenses.forEach(t=>{let n=t.category||`Other`;r[n]=(r[n]||0)+A(t);let a=q(t.id,e);a>0&&(i[n]=(i[n]||0)+a)}),new Set([...Object.keys(r),...Object.keys(i)]).forEach(n=>{t[n]||(t[n]=[]),t[n].push({mo:e,budget:r[n]||0,actual:i[n]||0,hasActual:(i[n]||0)>0})})}),t}function Yc(e){let t=[];return Object.entries(e).forEach(([e,n])=>{let r=n.filter(e=>e.hasActual);if(r.length<2)return;let i=r.filter(e=>e.budget>0&&e.actual>e.budget*1.05).length,a=r.filter(e=>e.budget>0&&e.actual<e.budget*.92).length,o=r.reduce((e,t)=>e+(t.actual-t.budget),0)/r.length,s=n.slice(-3).filter(e=>e.hasActual),c=n.slice(0,3).filter(e=>e.hasActual),l=s.length?s.reduce((e,t)=>e+t.actual,0)/s.length:0,u=c.length?c.reduce((e,t)=>e+t.actual,0)/c.length:0,d=u>50?(l-u)/u:0;i>=3&&o>20?t.push({cat:e,level:`warning`,icon:`⚠️`,title:`Consistently over on ${e}`,body:`Over budget ${i}/${r.length} months, avg +${w(Math.abs(o))}/mo. Consider raising the budget or cutting back.`,months:r}):a>=4&&n[n.length-1]?.budget>0?t.push({cat:e,level:`good`,icon:`✅`,title:`Consistently under on ${e}`,body:`Under budget ${a}/${r.length} months, avg ${w(Math.abs(o))}/mo less. You may be able to reallocate this budget elsewhere.`,months:r}):d>.25&&l>50?t.push({cat:e,level:`warning`,icon:`📈`,title:`${e} trending up`,body:`Spending up ${Math.round(d*100)}% over recent months — now averaging ${w(l)}/mo. Worth keeping an eye on.`,months:r}):d<-.25&&u>50&&t.push({cat:e,level:`good`,icon:`📉`,title:`${e} trending down`,body:`Down ${Math.round(Math.abs(d)*100)}% recently — now ${w(l)}/mo. Nice improvement.`,months:r})}),t.sort((e,t)=>[`warning`,`alert`,`good`,`info`].indexOf(e.level)-[`warning`,`alert`,`good`,`info`].indexOf(t.level)).slice(0,6)}function Xc(){let e=W(G);if(e.expenses.length===0)return``;let t={};e.expenses.forEach(e=>{let n=e.category||`Other`;t[n]||(t[n]={budget:0,actual:0}),t[n].budget+=A(e),t[n].actual+=q(e.id,G)});let n=Object.entries(t).filter(([,e])=>e.budget>0||e.actual>0).sort((e,t)=>Math.max(t[1].budget,t[1].actual)-Math.max(e[1].budget,e[1].actual));if(!n.length)return``;let r=Math.max(...n.flatMap(([,e])=>[e.budget,e.actual]),1),i=n.map(([e,t])=>{let n=t.actual>0,i=(t.budget/r*100).toFixed(1),a=(t.actual/r*100).toFixed(1),o=t.actual-t.budget,s=n?o>5?`over`:o<-5?`under`:``:``,c=n?o>5?`<span class="spi-over">+${w(o)}</span>`:o<-5?`<span class="spi-under">${w(o)}</span>`:`<span class="spi-on">on track</span>`:`<span class="spi-no-actual">no actuals</span>`;return`<div class="spi-cat-row">
    ...
    <div class="spi-breakdown-header">
      <span style="font-size:13px;font-weight:700">Budget vs Actual — ${K(G)}</span>
    ...
    ${i}
  </div>`}function Zc(){let e=Yc(Jc()),t=Xc(),n={warning:{bg:`#fffbeb`,border:`#fcd34d`,title:`#92400e`},good:{bg:`#ecfeff`,border:`#86efac`,title:`#166534`},alert:{bg:`#fef2f2`,border:`#fca5a5`,title:`#991b1b`},info:{bg:`#f8fafc`,border:`#cbd5e1`,title:`#475569`}};return`<div class="spi-section">
...
Reply with ONLY the JSON array, no other text.`;try{let e=await fetch($c,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:u}]})});if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(t.error?.message||`API error ${e.status}`)}let t=(await e.json()).content[0].text.trim();t=t.replace(/^```[a-z]*\n?/i,``).replace(/\n?```$/,``).trim(),tl(JSON.parse(t),!0)}catch(e){let t=e.message;(t.includes(`Failed to fetch`)||t.includes(`NetworkError`)||t.includes(`CORS`))&&(t=`CORS blocked — the browser can't call the Anthropic API directly. We need a small proxy (Cloudflare Worker). Ask me to set it up — it takes 5 minutes and is free.`),document.getElementById(`ai-output`).innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:12px">
      ...
      </div>`}let h=i.filter(e=>r[e.category]!==void 0||e.category===`Savings / Investment`).map(e=>{let t=r[e.category]||0,n=Wc(t,e.min,e.max),i=n===`under`?`#3b82f6`:n===`within`?`#10b981`:`#ef4444`,a=n===`under`?`Below avg`:n===`within`?`On track`:`Above avg`,o=e.max>0?Math.min(t/(e.max*1.5)*100,100):0,s=e.max>0?Math.min(e.max/(e.max*1.5)*100,100):0;return`
      <tr>
        <td style="border-left:3px solid ${Y.expense[e.category]||`#94a3b8`};font-weight:500">${e.category}</td>
  ...
  `}function il(e){let t={good:{bg:`#ecfeff`,border:`#86efac`,text:`#166534`},ok:{bg:`#eff6ff`,border:`#93c5fd`,text:`#1e40af`},warning:{bg:`#fffbeb`,border:`#fcd34d`,text:`#92400e`},alert:{bg:`#fef2f2`,border:`#fca5a5`,text:`#991b1b`},info:{bg:`#f8fafc`,border:`#cbd5e1`,text:`#475569`}};return e.map(e=>{let n=t[e.level]||t.info;return`
      ...
      </div>`}).join(``)}function al(){let[e,t]=G.split(`-`).map(Number),n=new Date(e,t-2,1);G=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,safeRender(rl),safeRender(_s),safeRender(Bl)}function ol(){let[e,t]=G.split(`-`).map(Number),n=new Date(e,t,1);G=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,safeRender(rl),safeRender(_s),safeRender(Bl)}var sl=`🏠.🏡.🏗️.🔑.💡.🔌.🚿.🛋️.🛏️.🪴.🍽️.🍕.🍔.🛒.🥗.🍷.☕.🍰.🥩.🧃.🚗.🚙.🚌.✈️.⛽.🚕.🏎️.🚲.🛵.🚂.👨‍👩‍👧.👶.📚.🏫.💊.🏥.💅.💆.🧴.👕.🎮.🎬.🎵.🏋️.📺.🎲.🏄.🎯.🎨.🎭.💰.💳.🏦.📈.💸.🪙.💎.📊.🏆.💼.📦.🛍️.🎁.🔧.🛠️.📱.💻.🧹.🧺.🖨️.🐕.🐈.🐠.🌱.☀️.❄️.🎄.🎂.⚽.🧸`.split(`.`);function cl(e,t){let n=document.createElement(`div`);n.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.45);z-index:9999;display:flex;align-items:center;justify-content:center`,n.innerHTML=`
  ...
  `,document.body.appendChild(n),n.querySelector(`#emoji-picker-close`).onclick=()=>document.body.removeChild(n),n.querySelectorAll(`[data-emoji]`).forEach(e=>{e.onclick=()=>{t(e.dataset.emoji),document.body.removeChild(n)}}),n.addEventListener(`click`,e=>{e.target===n&&document.body.removeChild(n)})}function ll(){Z(`Add Category Group`,`
    <div class="form-row">
  ...
  `,()=>{let e=document.getElementById(`f-grp-icon`).value||`📦`,t=document.getElementById(`f-grp-name`).value.trim();if(!t)return;let n=M(m.categoryGroups);m.categoryGroups.push({id:n,name:t,icon:e,categories:[]}),R(`Added category group`,t),z(m),Q(),X()}),document.getElementById(`f-grp-icon-btn`).addEventListener(`click`,()=>{let e=document.getElementById(`f-grp-icon`).value;cl(e,e=>{document.getElementById(`f-grp-icon`).value=e,document.getElementById(`f-grp-icon-btn`).textContent=e})})}function ul(e){let t=m.categoryGroups.find(t=>t.id===e);t&&cl(t.icon,t=>{fl(e,`icon`,t);let n=document.getElementById(`grp-icon-btn-${e}`);n&&(n.textContent=t)})}function dl(e){let t=m.categoryGroups.find(t=>t.id===e);confirm(`Delete group "${t?t.name:``}"? Categories will become unassigned.`)&&(m.categoryGroups=m.categoryGroups.filter(t=>t.id!==e),R(`Deleted category group`,t?t.name:``),z(m),X())}function fl(e,t,n){let r=m.categoryGroups.find(t=>t.id===e);r&&(r[t]=n,z(m))}function pl(e,t){if(!t)return;rc().includes(t)||(m.expenseCategories||(m.expenseCategories=rc().slice()),m.expenseCategories.push(t)),m.categoryGroups.forEach(e=>{e.categories=e.categories.filter(e=>e!==t)});let n=m.categoryGroups.find(t=>t.id===e);n&&n.categories.push(t),z(m),X()}function ml(e){let t=rc(),n=new Set((m.categoryGroups||[]).filter(t=>t.id!==e).flatMap(e=>e.categories)),r=m.categoryGroups.find(t=>t.id===e),i=new Set(r?r.categories:[]),a=t.filter(e=>!i.has(e)&&!n.has(e));Z(`Add Category to Group`,`
    ${a.length>0?`
  ...
  `,()=>{let t=document.getElementById(`f-cat-selected`).value,n=document.getElementById(`f-cat-new`).value.trim()||t;n&&(pl(e,n),Q())})}function hl(e,t){let n=m.categoryGroups.find(t=>t.id===e);n&&(n.categories=n.categories.filter(e=>e!==t),z(m),X())}var gl=!1,_l=null;function vl(){gl||(_l=JSON.parse(JSON.stringify(m))),gl=!0;let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`flex`)}function yl(){gl=!1,_l=null,z(m);let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`none`);let t=document.getElementById(`settings-save-btn`);if(t){let e=t.textContent;t.textContent=`Saved`,t.style.background=`#10b981`,setTimeout(()=>{t.textContent=e,t.style.background=``},1500)}renderAll()}function bl(){_l&&Object.assign(m,_l),gl=!1,_l=null;let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`none`),X()}function xl(e){gl&&(confirm(`You have unsaved changes in Settings. Save before leaving?`)?yl():bl())}function Sl(e,t){m.settings||(m.settings={}),m.settings[e]=t,vl()}function Cl(){let e=document.getElementById(`settings-api-key`)?.value.trim();if(!e)return;localStorage.setItem(`toto_ai_key`,e),localStorage.setItem(`toto_ai_key_meta`,JSON.stringify({addedAt:new Date().toISOString(),prefix:e.slice(0,10),suffix:e.slice(-4)}));let t=document.getElementById(`api-key-status`);t&&(t.textContent=`✓ Key saved!`,t.style.color=`var(--success)`,setTimeout(()=>{t.textContent=``,t.style.color=``},2e3));let n=document.getElementById(`api-key-summary`);n&&(n.outerHTML=Tl())}function wl(){confirm(`Remove saved API key? Toto and cost estimation will stop working.`)&&(localStorage.removeItem(`toto_ai_key`),localStorage.removeItem(`toto_ai_key_meta`),X())}function Tl(){let e=localStorage.getItem(`toto_ai_key`);if(!e)return`<div id="api-key-summary"></div>`;let t=JSON.parse(localStorage.getItem(`toto_ai_key_meta`)||`{}`),n=t.addedAt?new Date(t.addedAt).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`}):`Unknown date`;return`
    ...
    </div>`}function El(e){let t=document.getElementById(`sacc-body-${e}`),n=document.getElementById(`sacc-chev-${e}`);if(!t)return;let r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n&&(n.textContent=r?`▼`:`▲`),r?To.delete(e):To.add(e)}function Dl(){confirm(`Clear the entire activity log? This cannot be undone.`)&&(m.activityLog=[],z(m),X())}function Ol(e){let t=document.getElementById(`new-cat-${e}`),n=(t.value||``).trim();if(!n){t.focus();return}let r=e===`expense`?m.expenseCategories:m.incomeCategories;if(r.includes(n)){alert(`That category already exists.`);return}r.push(n),R(`Added ${e} category`,n),vl(),t.value=``,X()}function kl(e,t){let n=e===`expense`?m.expenseCategories:m.incomeCategories;if(e===`expense`&&(m.budget.expenses.some(e=>e.category===t)||Object.values(m.budget.months||{}).some(e=>(e.expenses||[]).some(e=>e.category===t)))&&!confirm(`"${t}" is used by existing expenses. Remove anyway?`))return;let r=n.indexOf(t);r!==-1&&n.splice(r,1),R(`Removed ${e} category`,t),vl(),X()}function X(){function e(e){return e.replace(/[^a-z0-9]/gi,`_`)}function t(t,n,r,i){let a=`${t}_${e(n)}`;return`
      <div class="color-row">
    ...
    <div class="toto-sec-header" style="margin-top:6px"><span class="toto-sec-title">Settings</span></div>`+u(`ai`,`🤖 AI Assistant (Toto)`,`Powers cost estimation, Toto chat, and CSV import analysis`,`
      ...
      <div class="section-body">
        ...
        <div style="margin-top:16px;padding:14px;background:var(--surface2);border-radius:10px">
          ...
          <div style="font-size:28px;font-weight:900;color:#0891b2">${Cs().total}%</div>
        ...
        <div style="margin-top:20px;padding-top:16px;border-top:1px solid var(--border)">
          ...
          <button class="btn btn-sm" style="background:#fef2f2;border:1px solid #fecaca;color:#b91c1c;font-weight:600" onclick="resetAllData()">Reset all data…</button>
            ...
            ${s?`<button onclick="event.stopPropagation();clearAdultPin(${a})" style="padding:6px 10px;border:1px solid #fecaca;border-radius:6px;background:var(--surface);font-size:11px;font-weight:600;color:#b91c1c;cursor:pointer">Remove</button>`:``}
              ...
              </div>`+c}}else{let e=(m.kids?.profiles||[]).find(e=>e.name&&r.name&&e.name.toLowerCase()===r.name.toLowerCase()),t=!!e?.pinHash,n=!!(r.name&&r.name.trim());d=e&&uo&&uo(e.id)?`<div style="padding:10px 12px;background:#fef2f2;border-radius:8px;border:1px solid #fecaca">
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
                <span style="font-size:16px">🔒</span>
                <div style="flex:1">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:12px">
          ${rc().map(e=>`
            <span style="display:inline-flex;align-items:center;gap:6px;background:var(--surface2);border:1px solid var(--border);border-radius:20px;padding:5px 10px 5px 12px;font-size:13px">
              <span style="width:10px;height:10px;border-radius:50%;background:${Y.expense[e]||`#94a3b8`};flex-shrink:0"></span>
              ${e}
      ...
      <div class="section-body">
        ...
        <div class="color-grid" style="margin-bottom:24px">
          ${rc().map(e=>t(`expense`,e,e,Y.expense[e]||Ac.expense[e]||`#94a3b8`)).join(``)}
        </div>
        ...
        <div class="color-grid" style="grid-template-columns:repeat(auto-fill,minmax(220px,220px));margin-bottom:24px">
          ${t(`income`,`income`,`Income`,Y.income)}
        </div>
        ...
        <div class="color-grid" style="grid-template-columns:repeat(auto-fill,minmax(220px,220px))">
          ${t(`build`,`contract`,`Fixed Price Contract`,Y.build.contract)}
          ${t(`build`,`extras`,`Outside Contract`,Y.build.extras)}
          ${t(`build`,`furniture`,`Furniture`,Y.build.furniture)}
          ${t(`build`,`appliances`,`Appliances`,Y.build.appliances)}
        </div>
    ...
    </div>`);let g=oi(),_=m.kids?.profiles||[],v=g?g===`adult`?`Adult — opens straight to the full app`:g===`shared`?`Shared — shows profile picker on open`:(_.find(e=>e.id===g)?.name||`Unknown`)+` — kid device`:`Not configured`;h+=u(`this-device`,`📱 This Device`,`Assigned to: ${v}`,`<div class="section-body">
      <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px;background:var(--surface2);border-radius:10px;border:1px solid var(--border)">
        <div>
  ...
  </div>`,h+=`<div class="settings-save-bar" id="settings-save-bar" style="display:${gl?`flex`:`none`}">
  ...
  </div>`,document.getElementById(`settings-content`).innerHTML=h}function Al(){if(confirm(`This will permanently delete ALL household data — budget, kids, goals, everything — from this device and the cloud.

This cannot be undone. Are you sure?`)&&confirm(`Last chance. All data will be gone. Continue?`)){if(L&&fbStore){let e=kr();e&&e.delete().catch(()=>{})}localStorage.removeItem(Br),ai(Er),Mr&&(Mr(),Mr=null),fbAuth.signOut().then(()=>{window.location.reload()})}}function jl(){let e=new Blob([JSON.stringify(m,null,2)],{type:`application/json`}),t=document.createElement(`a`);t.href=URL.createObjectURL(e),t.download=`home-budget-backup-${new Date().toISOString().slice(0,10)}.json`,t.click(),URL.revokeObjectURL(t.href)}function Ml(e){let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target.result);if(!t.budget){alert(`Invalid backup file — missing budget data.`);return}if(!confirm(`This will replace ALL current data with the backup. Continue?`))return;localStorage.setItem(Br,JSON.stringify(t)),location.reload()}catch(e){alert(`Failed to read backup file: `+e.message)}},n.readAsText(t)}function Nl(e){let t=document.getElementById(`grp-body-${e}`),n=document.getElementById(`grp-arrow-${e}`);if(!t)return;let r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n&&(n.textContent=r?`▼`:`▲`)}function Pl(e){wo=e,Bl()}function Fl(e){let t=m.categoryGroups||qr.categoryGroups;m.budget.actuals[G];let n=(m.colors||{}).expense||{},r=new Set(t.flatMap(e=>e.categories)),i=[...new Set(e.map(e=>e.category||`Other`))].filter(e=>!r.has(e)),a=i.length>0?[...t,{id:`ug`,name:`Ungrouped`,icon:`📋`,categories:i}]:t,o=`<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:16px;margin-top:4px;align-items:start">`;for(let t of a){let r=e.filter(e=>t.categories.includes(e.category||`Other`));if(r.length===0)continue;let i=r.reduce((e,t)=>e+A(t),0),a=r.reduce((e,t)=>e+q(t.id,G),0),s=i>0?Math.round(a/i*100):0,c=Math.min(100,s),l=s>=100?`var(--danger)`:s>=80?`var(--warning)`:`var(--success)`,u=a>0,d=a>i&&u,f=r[0]&&r[0].category||`Other`,p=n[f]||Y.expense[f]||`#94a3b8`;o+=`
    <div style="background:var(--surface);border:1px solid ${d?`var(--danger)`:`var(--border)`};border-radius:10px;overflow:hidden">
      ...
      <div id="grp-body-${t.id}" style="border-top:1px solid var(--border)">
        ...
        ${r.map(e=>{let t=A(e),r=q(e.id,G),i=t>0?Math.min(100,Math.round(r/t*100)):0,a=n[e.category||`Other`]||Y.expense[e.category||`Other`]||`#94a3b8`,o=r>t&&r>0,s=o?`var(--danger)`:i>=80?`var(--warning)`:r>0?a:`var(--border)`;return r>0?`${w(r)}${w(t)}${i}`:`${w(t)}`,`
    ...
    <div class="summary-hero" onclick="toggleBudgetDetail()">
      ...
      <div class="summary-hero-expand" id="budget-expand-label">${Vl?`Hide details ▲`:`See breakdown ▼`}</div>
    </div>`,d+=`
    <div class="summary-mini-grid">
    ...
    </div>`;let f=Il({income:e,expenses:t});if(f.segments.length){let e=f.segments.map(e=>`<div style="background:${e.color};flex:${e.pct.toFixed(2)}"></div>`).join(``),t=f.segments.map(e=>`<div class="alloc-row">
        <div class="tdot" style="background:${e.color}"><svg viewBox="0 0 24 24"><use href="#${zl(e.name)}"/></svg></div>
        <div class="body">
          <div class="ticker">${Rl(e.name)}</div>
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;cursor:pointer;user-select:none;margin-bottom:${Hl?`12px`:`0`}" onclick="_allocExpanded=!_allocExpanded;renderBudget()">
        <div class="alloc-title" style="margin-bottom:0">Budget Allocation</div>
        <span style="font-size:11px;color:var(--muted);font-family:var(--mono)">${Hl?`▲`:`▼`}</span>
      </div>
      <div class="alloc-bar" style="margin-bottom:${Hl?`12px`:`0`}">${e}</div>
      ${Hl?`<div class="alloc-list">${t}</div>`:``}
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;cursor:pointer;user-select:none;margin-bottom:${Vl?`16px`:`0`}" onclick="toggleBudgetDetail()">
      ...
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <span style="font-size:11px;color:var(--muted);font-family:var(--mono)" id="budget-expand-chevron">${Vl?`▲`:`▼`}</span>
      </div>
    </div>
    <div class="detail-panel ${Vl?`expanded`:`collapsed`}" id="budget-detail" style="margin:0 -4px">`,go(G)||(d+=`<div style="display:flex;align-items:center;justify-content:space-between;background:var(--primary-light);border:1px solid #bfdbfe;border-radius:8px;padding:10px 16px;margin-bottom:16px;gap:12px;flex-wrap:wrap">
      <div>
        <span style="font-size:13px;font-weight:600;color:var(--primary)">Using default budget</span>
      </div>
      <button class="btn btn-primary btn-sm" onclick="copyMonthFromPrevious('${G}')">
        Copy from ${K(u)}
      </button>
    </div>`),d+=er(G,i),d+=jn(G),d+=`
    <div class="section" style="margin-bottom:20px">
      <div class="section-header">
        <div>
          <div class="section-title">Income</div>
        ...
        <table>
          ...
          <tbody>
            ${e.length===0?`<tr><td colspan="6"><div class="empty"><div class="empty-icon">💵</div>Add your income sources</div></td></tr>`:e.map(e=>{let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():`<span style="color:var(--text-muted)">—</span>`,n=e.recurring===!1?`<span style="font-size:10px;font-weight:600;padding:1px 6px;border-radius:99px;background:#fef9c3;color:#854d0e;border:1px solid #fde047;margin-left:6px;white-space:nowrap">one-time</span>`:``;return`<tr>
              <td style="font-weight:500;border-left:4px solid ${Y.income}">${x(e.name)}${n}</td>
              <td class="amount">${T(e.amount)}</td>
              <td>${t}</td>
  ...
  `;let p=[`all`,...Array.from(new Set(t.map(e=>e.category||`Other`))).sort()],h=ju===`all`?t:t.filter(e=>(e.category||`Other`)===ju),g=h.reduce((e,t)=>e+A(t),0),_=h.reduce((e,t)=>e+q(t.id,G),0),v=g-_,y=ju!==`all`;d+=`
    <div class="section">
      <div class="section-header">
        <div>
        ...
        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
          <div style="display:flex;border:1px solid var(--border);border-radius:6px;overflow:hidden">
            <button onclick="setBudgetView('grouped')" style="padding:5px 12px;font-size:12px;font-weight:600;border:none;cursor:pointer;background:${wo===`grouped`?`var(--primary)`:`var(--surface)`};color:${wo===`grouped`?`#fff`:`var(--text-muted)`}">⊞ Groups</button>
            <button onclick="setBudgetView('table')" style="padding:5px 12px;font-size:12px;font-weight:600;border:none;border-left:1px solid var(--border);cursor:pointer;background:${wo===`table`?`var(--primary)`:`var(--surface)`};color:${wo===`table`?`#fff`:`var(--text-muted)`}">≡ Table</button>
          </div>
          ${wo===`table`?`<select class="form-select" style="width:auto;padding:6px 10px;font-size:12px" onchange="setExpenseFilter(this.value)">
            ${p.map(e=>`<option value="${e}" ${ju===e?`selected`:``}>${e===`all`?`All categories`:e}</option>`).join(``)}
          </select>`:``}
          ...
          <table>
            <thead>
              <tr>
                ...
                ${Pu(`variance`,`Variance`)}
                <th></th>
              </tr>
            </thead>
            <tbody>
              ${h.length===0?`<tr><td colspan="8"><div class="empty"><div class="empty-icon">📋</div>${t.length===0?`Add your household expenses`:`No expenses in this category`}</div></td></tr>`:[...h].sort((e,t)=>{if(!ku)return 0;let n,r;if(ku===`name`)n=e.name.toLowerCase(),r=t.name.toLowerCase();else if(ku===`category`)n=(e.category||`Other`).toLowerCase(),r=(t.category||`Other`).toLowerCase();else if(ku===`frequency`)n=k(e),r=k(t);else if(ku===`due`)n=e.dueDate||`￿`,r=t.dueDate||`￿`;else if(ku===`budget`)n=A(e),r=A(t);else if(ku===`actual`)n=q(e.id,G),r=q(t.id,G);else if(ku===`variance`)n=A(e)-q(e.id,G),r=A(t)-q(t.id,G);else return 0;return n<r?Au===`asc`?-1:1:n>r?Au===`asc`?1:-1:0}).map(e=>{let t=A(e),n=q(e.id,G),r=t-n,i=n>0,a;a=i?r>=0?`<span class="var-under">▼ ${w(r)}</span>`:`<span class="var-over">▲ ${w(Math.abs(r))}</span>`:`<span class="var-none">—</span>`;let o=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():`<span style="color:var(--text-muted)">—</span>`,s=Y.expense[e.category||`Other`]||`#94a3b8`,c=e.recurring===!1?`<span style="font-size:10px;font-weight:600;padding:1px 6px;border-radius:99px;background:#fef9c3;color:#854d0e;border:1px solid #fde047;margin-left:6px;white-space:nowrap">one-time</span>`:``;return`<tr>
            ...
            <tfoot>
              <tr style="background:var(--surface2);border-top:2px solid var(--border)">
                <td colspan="4" style="padding:11px 16px;font-size:13px;color:var(--text-muted);font-style:italic">Total ${y?ju:`all categories`}</td>
  ...
  `,d+=`</div></div>`,document.getElementById(`budget-content`).innerHTML=d}catch(e){console.error(`renderBudget error:`,e);let t=document.getElementById(`budget-content`);t&&(t.innerHTML=`<div style="padding:24px;color:var(--alert);font-family:var(--mono);font-size:13px">Render error: ${x(e.message)}<br><small>${x(e.stack||``)}</small></div>`)}}var Vl=!1,Hl=!1;function Ul(){Vl=!Vl;let e=document.getElementById(`budget-detail`),t=document.getElementById(`budget-expand-label`),n=document.getElementById(`budget-expand-chevron`),r=e&&e.parentElement;e&&(e.classList.toggle(`collapsed`,!Vl),e.classList.toggle(`expanded`,Vl)),r&&(r.style.marginBottom=Vl?`16px`:`0`),t&&(t.textContent=Vl?`Hide details ▲`:`See breakdown ▼`),n&&(n.textContent=Vl?`▲`:`▼`)}function Z(e,t,n){document.getElementById(`modal-title`).textContent=e,document.getElementById(`modal-body`).innerHTML=t,document.getElementById(`modal-footer`).innerHTML=`
    <button class="btn btn-ghost" onclick="closeModal()">Cancel</button>
    <button class="btn btn-primary" id="modal-save-btn">Save</button>
  `,window._modalSaveHandler=n,document.getElementById(`modal-save-btn`).onclick=()=>window._modalSaveHandler?.(),document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Q(){Nr=null,window._actualEditorRefresh=null,window._csvSuggestions=null,window._csvSuggestNames=null,document.getElementById(`modal-body`).innerHTML=``,document.getElementById(`modal-footer`).innerHTML=``,document.getElementById(`modal-overlay`).classList.add(`hidden`)}document.getElementById(`modal-overlay`).addEventListener(`click`,e=>{e.target===document.getElementById(`modal-overlay`)&&Q()});function Wl(){Z(`Edit Contract Total`,`
    <div class="form-group">
  ...
  `,()=>{let e=parseFloat(document.getElementById(`f-contract-total`).value);!isNaN(e)&&e>0&&(R(`Updated contract total`,w(e)),m.buildContract.total=e,z(m),Q(),renderAll())})}function Gl(e={}){return`
    <div class="form-row">
      <div class="form-group">
  ...
  `}function Kl(e){return{id:e,name:document.getElementById(`f-stage-name`).value.trim(),amount:parseFloat(document.getElementById(`f-stage-amount`).value)||0,paid:document.getElementById(`f-stage-paid`).checked,expectedDate:document.getElementById(`f-stage-expected`).value,paidDate:document.getElementById(`f-stage-paiddate`).value,invoiceRef:document.getElementById(`f-stage-ref`).value.trim(),funding:document.getElementById(`f-stage-funding`).value,notes:document.getElementById(`f-stage-notes`).value.trim()}}function ql(){Z(`Add Contract Stage`,Gl(),()=>{let e=Kl(M(m.buildContract.stages));e.name&&(R(`Added build stage`,e.name),m.buildContract.stages.push(e),z(m),Q(),renderAll())})}function Jl(e){let t=m.buildContract.stages.find(t=>t.id===e);Z(`Edit Stage`,Gl(t),()=>{let n=Kl(e);R(`Edited build stage`,n.name||t.name),Object.assign(t,n),z(m),Q(),renderAll()})}function Yl(e){if(!confirm(`Delete this stage?`))return;let t=m.buildContract.stages.find(t=>t.id===e);R(`Deleted build stage`,t?t.name:``),m.buildContract.stages=m.buildContract.stages.filter(t=>t.id!==e),z(m),renderAll()}function Xl(e={}){return`
    <div class="form-row">
      <div class="form-group">
  ...
  `}function Zl(e){return{id:e,ref:document.getElementById(`f-var-ref`).value.trim(),name:document.getElementById(`f-var-name`).value.trim(),amount:parseFloat(document.getElementById(`f-var-amount`).value)||0,status:document.getElementById(`f-var-status`).value,funding:document.getElementById(`f-var-funding`).value,dateRaised:document.getElementById(`f-var-raised`).value,dateApproved:document.getElementById(`f-var-approved`).value,notes:document.getElementById(`f-var-notes`).value.trim()}}function Ql(){Z(`Add Variation`,Xl(),()=>{let e=Zl(M(m.buildContract.variations));e.name&&(R(`Added variation`,`${e.ref?e.ref+` · `:``}${e.name}`),m.buildContract.variations.push(e),z(m),nc())})}function $l(e){Z(`Edit Variation`,Xl(m.buildContract.variations.find(t=>t.id===e)),()=>{let t=Zl(e);if(!t.name)return;R(`Edited variation`,`${t.ref?t.ref+` · `:``}${t.name}`);let n=m.buildContract.variations.findIndex(t=>t.id===e);n!==-1&&(m.buildContract.variations[n]=t),z(m),nc()})}function eu(e){if(!confirm(`Delete this variation?`))return;let t=m.buildContract.variations.find(t=>t.id===e);R(`Deleted variation`,t?t.name:``),m.buildContract.variations=m.buildContract.variations.filter(t=>t.id!==e),z(m),nc()}var tu=[{value:`not-quoted`,label:`Not Quoted`},{value:`quoted`,label:`Quoted`},{value:`approved`,label:`Approved`},{value:`partial`,label:`Partially Paid`},{value:`paid`,label:`Paid`}];function nu(e={}){let t=e.status||(e.totalAmount?`approved`:`not-quoted`);return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Item Name</label>
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <select class="form-select" id="f-extra-status">
          ${tu.map(e=>`<option value="${e.value}" ${t===e.value?`selected`:``}>${e.label}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
  ...
  `}function ru(e){return{id:e,name:document.getElementById(`f-extra-name`).value.trim(),vendor:document.getElementById(`f-extra-vendor`).value.trim(),status:document.getElementById(`f-extra-status`).value,funding:document.getElementById(`f-extra-funding`).value,totalAmount:parseFloat(document.getElementById(`f-extra-total`).value)||0,amountPaid:parseFloat(document.getElementById(`f-extra-paid`).value)||0,dueDate:document.getElementById(`f-extra-due`).value,notes:document.getElementById(`f-extra-notes`).value.trim()}}function iu(){Z(`Add Outside Contract Item`,nu(),()=>{let e=ru(M(m.extras));e.name&&(R(`Added extra item`,e.name),m.extras.push(e),z(m),Q(),renderAll())})}function au(e){let t=m.extras.find(t=>t.id===e);Z(`Edit Item`,nu(t),()=>{let n=ru(e);R(`Edited extra item`,n.name||t.name),Object.assign(t,n),z(m),Q(),renderAll()})}function ou(e){if(!confirm(`Delete this item?`))return;let t=m.extras.find(t=>t.id===e);R(`Deleted extra item`,t?t.name:``),m.extras=m.extras.filter(t=>t.id!==e),z(m),renderAll()}function su(e={}){let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():``,n=[`weekly`,`fortnightly`,`monthly`,`quarterly`,`annually`,`custom`],r=e.frequency===`custom`;return`
    <div class="form-group">
  ...
  `}function cu(e){let t=document.getElementById(`f-inc-freq`)?document.getElementById(`f-inc-freq`).value:`monthly`,n=document.getElementById(`f-inc-recurring`),r={id:e,name:document.getElementById(`f-inc-name`).value.trim(),amount:parseFloat(document.getElementById(`f-inc-amount`).value)||0,frequency:t,dueDate:document.getElementById(`f-inc-duedate`).value||null,recurring:n?n.checked:!0};return t===`custom`&&(r.customEvery=parseInt(document.getElementById(`f-inc-custom-n`).value)||1,r.customUnit=document.getElementById(`f-inc-custom-unit`).value),r}function lu(){Z(`Add Income`,su(),()=>{let e=cu(M(W(G).income));e.name&&(R(`Added income`,e.name),xo(()=>{let t=_o(G);e.id=M(t.income),t.income.push(e),z(m),renderAll()},()=>{e.id=M(m.budget.income),m.budget.income.push(e),z(m),renderAll()}))})}function uu(e){let t=W(G).income.find(t=>t.id===e);Z(`Edit Income`,su(t),()=>{let n=cu(e);R(`Edited income`,n.name||t&&t.name||``),xo(()=>{let t=_o(G),r=t.income.find(t=>t.id===e);r?Object.assign(r,n):t.income.push(n),z(m),renderAll()},()=>{let t=m.budget.income.find(t=>t.id===e);t&&Object.assign(t,n),z(m),renderAll()})})}function du(e){let t=W(G).income.find(t=>t.id===e),n=t?t.name:`this income`;R(`Deleted income`,n),bo=null,document.getElementById(`modal-title`).textContent=`Delete income`,document.getElementById(`modal-body`).innerHTML=`
    <p style="font-size:14px;line-height:1.6;margin:0;color:var(--text-muted)">
      Delete <strong style="color:var(--text)">${n}</strong>? Apply to
      <strong style="color:var(--text)">${K(G)}</strong> only,
      or remove from all months?
    </p>`,bo={onThisMonth:()=>{let t=_o(G);t.income=t.income.filter(t=>t.id!==e),z(m),renderAll()},onAllMonths:()=>{m.budget.income=m.budget.income.filter(t=>t.id!==e),m.budget.months&&Object.values(m.budget.months).forEach(t=>{t.income=t.income.filter(t=>t.id!==e)}),z(m),renderAll()}},document.getElementById(`modal-footer`).innerHTML=`
    <button class="btn btn-ghost" onclick="closeModal()">Cancel</button>
    <button class="btn btn-secondary" onclick="doScopeAll()">Remove from all months</button>
    <button class="btn btn-danger" onclick="doScopeMonth()">Delete from ${K(G)}</button>
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function fu(e={}){let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():``,n=[`weekly`,`fortnightly`,`monthly`,`quarterly`,`annually`,`custom`],r=e.frequency===`custom`;return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Description</label>
      ...
      <div class="form-group">
        ...
        <select class="form-select" id="f-exp-cat">
          ${rc().map(t=>`<option value="${t}" ${(e.category||`Other`)===t?`selected`:``}>${t}</option>`).join(``)}
        </select>
      </div>
    </div>
    <div class="form-group">
  ...
  `}function pu(e){let t=document.getElementById(`f-exp-freq`)?document.getElementById(`f-exp-freq`).value:`monthly`,n=document.getElementById(`f-exp-recurring`),r={id:e,name:document.getElementById(`f-exp-name`).value.trim(),category:document.getElementById(`f-exp-cat`).value,vendor:(document.getElementById(`f-exp-vendor`)?.value||``).trim()||null,amount:parseFloat(document.getElementById(`f-exp-amount`).value)||0,frequency:t,dueDate:document.getElementById(`f-exp-duedate`).value||null,recurring:n?n.checked:!0};return t===`custom`&&(r.customEvery=parseInt(document.getElementById(`f-exp-custom-n`).value)||1,r.customUnit=document.getElementById(`f-exp-custom-unit`).value),r}function mu(e){let t=document.getElementById(`f-${e}-freq`).value,n=document.getElementById(`f-${e}-custom-wrap`);n&&(n.style.display=t===`custom`?`flex`:`none`)}function hu(){Z(`Add Expense`,fu(),()=>{let e=pu(M(W(G).expenses));e.name&&(R(`Added expense`,`${e.name} (${e.category||`Other`})`),xo(()=>{let t=_o(G);e.id=M(t.expenses),t.expenses.push(e),z(m),renderAll()},()=>{if(e.id=M(m.budget.expenses),m.budget.expenses.push(e),go(G)){let t=m.budget.months[G];t.expenses.push({...e,id:M(t.expenses)})}z(m),renderAll()}))})}function gu(e){let t=W(G).expenses.find(t=>t.id===e);Z(`Edit Expense`,fu(t),()=>{let n=pu(e);R(`Edited expense`,`${n.name||t&&t.name||``} (${n.category||`Other`})`),xo(()=>{let t=_o(G),r=t.expenses.find(t=>t.id===e);r?Object.assign(r,n):t.expenses.push(n),z(m),renderAll()},()=>{let t=m.budget.expenses.find(t=>t.id===e);if(t&&Object.assign(t,n),go(G)){let t=m.budget.months[G].expenses.find(t=>t.id===e);t&&Object.assign(t,n)}z(m),renderAll()})});let n=document.createElement(`button`);n.className=`btn btn-danger`,n.textContent=`Delete`,n.style.marginRight=`auto`,n.onclick=()=>{Q(),_u(e)};let r=document.getElementById(`modal-footer`);r.insertBefore(n,r.firstChild)}function _u(e){let t=W(G).expenses.find(t=>t.id===e),n=t?t.name:`this expense`;R(`Deleted expense`,n),bo={onThisMonth:()=>{let t=_o(G);t.expenses=t.expenses.filter(t=>t.id!==e),z(m),renderAll()},onAllMonths:()=>{m.budget.expenses=m.budget.expenses.filter(t=>t.id!==e),m.budget.months&&Object.values(m.budget.months).forEach(t=>{t.expenses=t.expenses.filter(t=>t.id!==e)}),z(m),renderAll()}},document.getElementById(`modal-title`).textContent=`Delete expense`,document.getElementById(`modal-body`).innerHTML=`
    <p style="font-size:14px;line-height:1.6;margin:0;color:var(--text-muted)">
      Delete <strong style="color:var(--text)">${n}</strong>? Apply to
      <strong style="color:var(--text)">${K(G)}</strong> only,
      or remove from all months?
    ...
    <button class="btn btn-secondary" onclick="doScopeAll()">Remove from all months</button>
    <button class="btn btn-danger" onclick="doScopeMonth()">Delete from ${K(G)}</button>
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}var vu=[`Living Room`,`Dining Room`,`Kitchen`,`Master Bedroom`,`Bedroom 2`,`Bedroom 3`,`Study / Office`,`Bathroom`,`Laundry`,`Outdoor / Alfresco`,`Other`];function yu(e={}){let t=e.deliveryDate?(()=>{let[t,n,r]=e.deliveryDate.split(`-`);return`${r}/${n}/${t}`})():``;return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Item Name</label>
      ...
      <div class="form-group">
        ...
        <select class="form-select" id="f-furn-room">
          ...
          ${vu.map(t=>`<option value="${t}" ${e.room===t?`selected`:``}>${t}</option>`).join(``)}
        </select>
      </div>
    </div>
    <div class="form-row">
  ...
  `}function bu(e){return{id:e,name:document.getElementById(`f-furn-name`).value.trim(),room:document.getElementById(`f-furn-room`).value,vendor:document.getElementById(`f-furn-vendor`).value.trim(),price:parseFloat(document.getElementById(`f-furn-price`).value)||0,status:document.getElementById(`f-furn-status`).value,funding:document.getElementById(`f-furn-funding`).value,deliveryDate:document.getElementById(`f-exp-duedate`).value||null,notes:document.getElementById(`f-furn-notes`).value.trim()}}function xu(){Z(`Add Furniture Item`,yu(),()=>{let e=bu(M(m.furniture));e.name&&(R(`Added furniture`,e.name),m.furniture.push(e),z(m),Q(),renderAll())})}function Su(e){let t=m.furniture.find(t=>t.id===e);Z(`Edit Furniture Item`,yu(t),()=>{let n=bu(e);R(`Edited furniture`,n.name||t.name),Object.assign(t,n),z(m),Q(),renderAll()})}function Cu(e){if(!confirm(`Delete this item?`))return;let t=m.furniture.find(t=>t.id===e);R(`Deleted furniture`,t?t.name:``),m.furniture=m.furniture.filter(t=>t.id!==e),z(m),renderAll()}function wu(e={}){let t=e.deliveryDate?(()=>{let[t,n,r]=e.deliveryDate.split(`-`);return`${r}/${n}/${t}`})():``;return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Item Name</label>
  ...
  `}function Tu(e){return{id:e,name:document.getElementById(`f-appl-name`).value.trim(),room:document.getElementById(`f-appl-room`).value,vendor:document.getElementById(`f-appl-vendor`).value.trim(),price:parseFloat(document.getElementById(`f-appl-price`).value)||0,status:document.getElementById(`f-appl-status`).value,funding:document.getElementById(`f-appl-funding`).value,deliveryDate:document.getElementById(`f-exp-duedate`).value||null,notes:document.getElementById(`f-appl-notes`).value.trim()}}function Eu(){Z(`Add Appliance`,wu(),()=>{let e=Tu(M(m.appliances));e.name&&(R(`Added appliance`,e.name),m.appliances.push(e),z(m),Q(),renderAll())})}function Du(e){let t=m.appliances.find(t=>t.id===e);Z(`Edit Appliance`,wu(t),()=>{let n=Tu(e);R(`Edited appliance`,n.name||t.name),Object.assign(t,n),z(m),Q(),renderAll()})}function Ou(e){if(!confirm(`Delete this item?`))return;let t=m.appliances.find(t=>t.id===e);R(`Deleted appliance`,t?t.name:``),m.appliances=m.appliances.filter(t=>t.id!==e),z(m),renderAll()}var ku=null,Au=`asc`,ju=`all`;function Mu(e){ju=e,Bl()}function Nu(e){Au=ku===e&&Au===`asc`?`desc`:`asc`,ku=e,Bl()}function Pu(e,t,n=``){let r=ku===e;return`<th class="sortable${r?` sort-active`:``}" onclick="sortExpenses('${e}')">${t}${n}<span class="sort-icon">${r?Au===`asc`?`↑`:`↓`:`↕`}</span></th>`}function Fu(e){let t=[`th`,`st`,`nd`,`rd`],n=e%100;return e+(t[(n-20)%10]||t[n]||t[0])}var Iu=`plan`,Lu=0,Ru=[`Produce`,`Meat & Seafood`,`Dairy & Eggs`,`Pantry`,`Bakery`,`Frozen`,`Household`,`Other`],zu={Produce:`🥦`,"Meat & Seafood":`🥩`,"Dairy & Eggs":`🥛`,Pantry:`🥫`,Bakery:`🍞`,Frozen:`🧊`,Household:`🏠`,Other:`🛒`},Bu={food:{label:`Food`,emoji:`🛒`,color:`#dcfce7`,text:`#166534`,aisles:!0,priceEst:!0},clothes:{label:`Clothes`,emoji:`👕`,color:`#dbeafe`,text:`#1e40af`,aisles:!1,priceEst:!1},wishlist:{label:`Wishlist`,emoji:`🎁`,color:`#fce7f3`,text:`#9d174d`,aisles:!1,priceEst:!1},home:{label:`Home & Garden`,emoji:`🛠`,color:`#fef3c7`,text:`#92400e`,aisles:!0,priceEst:!1},pharmacy:{label:`Pharmacy`,emoji:`💊`,color:`#ede9fe`,text:`#5b21b6`,aisles:!0,priceEst:!1}},Vu={food:[{key:`produce`,emoji:`🥦`,label:`Produce`},{key:`dairy`,emoji:`🥛`,label:`Dairy & Eggs`},{key:`bakery`,emoji:`🍞`,label:`Bakery`},{key:`meat`,emoji:`🥩`,label:`Meat & Seafood`},{key:`pantry`,emoji:`🥫`,label:`Pantry`},{key:`frozen`,emoji:`🧊`,label:`Frozen`},{key:`health`,emoji:`🧴`,label:`Health & Beauty`},{key:`bathroom`,emoji:`🚿`,label:`Bathroom`},{key:`cleaning`,emoji:`🧹`,label:`Cleaning`},{key:`drinks`,emoji:`🍷`,label:`Drinks & Alcohol`},{key:`other`,emoji:`🛒`,label:`Uncategorised`}],home:[{key:`tools`,emoji:`🔨`,label:`Tools & Hardware`},{key:`garden`,emoji:`🌱`,label:`Garden`},{key:`cleaning`,emoji:`🧹`,label:`Cleaning`},{key:`other`,emoji:`🛒`,label:`Other`}],pharmacy:[{key:`medicine`,emoji:`💊`,label:`Medicine`},{key:`skincare`,emoji:`🧴`,label:`Skincare`},{key:`vitamins`,emoji:`💪`,label:`Vitamins`},{key:`other`,emoji:`🛒`,label:`Other`}]},Hu={milk:`dairy`,cheese:`dairy`,butter:`dairy`,eggs:`dairy`,yoghurt:`dairy`,cream:`dairy`,bread:`bakery`,rolls:`bakery`,muffin:`bakery`,croissant:`bakery`,baguette:`bakery`,apple:`produce`,banana:`produce`,orange:`produce`,strawberry:`produce`,tomato:`produce`,lettuce:`produce`,spinach:`produce`,carrot:`produce`,broccoli:`produce`,potato:`produce`,onion:`produce`,garlic:`produce`,cucumber:`produce`,capsicum:`produce`,avocado:`produce`,lemon:`produce`,lime:`produce`,grapes:`produce`,mango:`produce`,pineapple:`produce`,watermelon:`produce`,chicken:`meat`,beef:`meat`,mince:`meat`,steak:`meat`,pork:`meat`,lamb:`meat`,salmon:`meat`,fish:`meat`,tuna:`meat`,prawn:`meat`,sausage:`meat`,bacon:`meat`,rice:`pantry`,pasta:`pantry`,flour:`pantry`,sugar:`pantry`,oil:`pantry`,vinegar:`pantry`,salt:`pantry`,pepper:`pantry`,sauce:`pantry`,stock:`pantry`,beans:`pantry`,lentils:`pantry`,chickpeas:`pantry`,cereal:`pantry`,oats:`pantry`,honey:`pantry`,jam:`pantry`,peanut:`pantry`,coffee:`pantry`,tea:`pantry`,biscuit:`pantry`,cracker:`pantry`,chocolate:`pantry`,chips:`pantry`,nuts:`pantry`,icecream:`frozen`,peas:`frozen`,corn:`frozen`,pizza:`frozen`,shampoo:`health`,conditioner:`health`,deodorant:`health`,sunscreen:`health`,moisturiser:`health`,makeup:`health`,lipstick:`health`,mascara:`health`,toothpaste:`bathroom`,toothbrush:`bathroom`,soap:`bathroom`,toilet:`bathroom`,razors:`bathroom`,tampons:`bathroom`,pads:`bathroom`,detergent:`cleaning`,bleach:`cleaning`,sponge:`cleaning`,dishwashing:`cleaning`,bins:`cleaning`,mop:`cleaning`,water:`drinks`,juice:`drinks`,beer:`drinks`,wine:`drinks`,spirits:`drinks`,softdrink:`drinks`,soda:`drinks`,kombucha:`drinks`};function Uu(e){for(var t=e.toLowerCase(),n=Object.keys(Hu),r=0;r<n.length;r++)if(t.indexOf(n[r])!==-1)return Hu[n[r]];return`other`}function Wu(e){var t=e.trim(),n=1,r=`units`,i=t,a=t.match(/^(\d+(?:\.\d+)?)\s*(kg|g|L|l|ml|dozen|doz)\s+(.+)$/i);if(a)n=parseFloat(a[1]),r=a[2].toLowerCase()===`l`?`L`:a[2].toLowerCase()===`doz`?`dozen`:a[2],i=a[3];else{var o=t.match(/^(\d+(?:\.\d+)?)\s+(.+)$/);o?(n=parseFloat(o[1]),i=o[2]):/^dozen\s+/i.test(t)&&(n=1,r=`dozen`,i=t.replace(/^dozen\s+/i,``))}return i=i.charAt(0).toUpperCase()+i.slice(1),{qty:n,unit:r,name:i}}var Gu=`food`,Ku=`selector`;function $(e){let t=new Date,n=t.getDay()===0?-6:1-t.getDay(),r=new Date(t);return r.setDate(t.getDate()+n+(e||0)*7),r.toISOString().slice(0,10)}function qu(e){let t=new Date(e+`T00:00:00`);return Array.from({length:7},(e,n)=>{let r=new Date(t);return r.setDate(t.getDate()+n),r})}function Ju(){Iu===`shopping`?od():Yu()}function Yu(){let e=$(Lu),t=qu(e),n=m.meals.plan[e]||{},r=new Date().toISOString().slice(0,10),i=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`,`Sun`],a=[{key:`b`,label:`Breakfast`},{key:`l`,label:`Lunch`},{key:`d`,label:`Dinner`}],o=t[0].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`}),s=t[6].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`}),c=[];for(let e=0;e<7;e++){let t=n[e]||{};[`b`,`l`,`d`].forEach(e=>{t[e]&&c.push(t[e])})}let l=``;a.forEach(i=>{l+=`<div class="meal-grid-label">${i.label}</div>`,t.forEach((t,a)=>{let o=(n[a]||{})[i.key]||``,s=t.toISOString().slice(0,10)===r;l+=`<div class="meal-cell${s?` today`:``}" onclick="openMealEdit('${e}',${a},'${i.key}')">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;flex-wrap:wrap;gap:12px">
      <div style="display:flex;align-items:center;gap:8px">
        ...
        <span style="font-size:15px;font-weight:600;min-width:150px;text-align:center">
          ${Lu===0?`This Week`:Lu===1?`Next Week`:Lu===-1?`Last Week`:`${o} – ${s}`}
        </span>
        <button class="btn btn-sm" onclick="_mealWeekOffset++;renderMeals()" style="font-size:16px;padding:2px 10px">›</button>
        ${Lu===0?``:`<button class="btn btn-sm" onclick="_mealWeekOffset=0;renderMeals()">This week</button>`}
      </div>
      <div style="display:flex;gap:8px;flex-wrap:wrap">
    ...
    <div style="border:1px solid var(--border);border-radius:10px;padding:14px;margin-bottom:16px;background:var(--surface2)">
      ...
      <div style="margin-bottom:12px">
        <div class="form-label" style="display:flex;justify-content:space-between;margin-bottom:5px">
          ...
          <span id="meal-price-lbl" style="color:#0891b2;font-weight:700">${Xu.price>0?`$`+Xu.price:`Any`}</span>
        </div>
        <input type="range" min="0" max="200" step="5" value="${Xu.price}"
    ...
    style="padding:4px 10px;border-radius:99px;font-size:12px;cursor:pointer;white-space:nowrap;
      ...
      color:${n?`#0891b2`:`var(--text)`}">${t}</button>`}function td(e,t){Xu[e]=t,document.querySelectorAll(`[data-filter="${e}"]`).forEach(e=>{let n=e.dataset.val===t;e.style.borderColor=n?`#0891b2`:`var(--border)`,e.style.background=n?`#ecfeff`:`var(--surface)`,e.style.color=n?`#0891b2`:`var(--text)`})}function nd(e){Xu.price=e;let t=document.getElementById(`meal-price-lbl`);t&&(t.textContent=e>0?`$${e}`:`Any`)}async function rd(e){let t=localStorage.getItem(`toto_ai_key`);if(!t)return;let n=document.getElementById(`meal-suggest-btn`),r=document.getElementById(`meal-suggest-out`);n&&(n.textContent=`⏳ Thinking…`,n.disabled=!0),r&&(r.innerHTML=``);let i={b:`Breakfast`,l:`Lunch`,d:`Dinner`},a=[Xu.cuisine===`Any`?``:`Cuisine: ${Xu.cuisine}`,Xu.price>0?`Budget: up to $${Xu.price} per serve`:``,Xu.dietary===`Any`?``:`Style: ${Xu.dietary}`].filter(Boolean).join(`, `)||`No specific filters`,o=`Suggest 8 ${i[e]} meal ideas. Filters: ${a}.
Return ONLY a JSON array of meal names, no other text: ["Meal 1","Meal 2",...]`;try{let e=(await(await fetch(Kr,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:256,messages:[{role:`user`,content:o}]})})).json()).content[0].text.match(/\[[\s\S]*\]/);if(!e)throw Error(`No JSON`);let n=JSON.parse(e[0]);r&&(r.innerHTML=`<div style="display:flex;flex-wrap:wrap;gap:6px">
      ${n.map(e=>`<button style="padding:6px 12px;border-radius:99px;border:1px solid #0891b2;background:#ecfeff;color:#0891b2;font-size:12px;font-weight:500;cursor:pointer"
        onclick="document.getElementById('meal-input').value='${e.replace(/'/g,`\\'`)}'">${e}</button>`).join(``)}
    </div>`)}catch(e){r&&(r.innerHTML=`<span style="font-size:12px;color:var(--danger)">⚠ ${e.message}</span>`)}finally{n&&(n.textContent=`Get suggestions`,n.disabled=!1)}}function id(e,t,n,r){m.meals.plan[e]||(m.meals.plan[e]={}),m.meals.plan[e][t]||(m.meals.plan[e][t]={b:``,l:``,d:``}),m.meals.plan[e][t][n]=r,delete m.meals.plan[e][t][`cal_`+n],z(m),Q(),Yu(),r&&m.settings?.showCalories&&ad(e,t,n,r)}async function ad(e,t,n,r){let i=localStorage.getItem(`toto_ai_key`);if(!(!i||!r))try{let a=await fetch(Kr,{method:`POST`,headers:{"x-api-key":i,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:50,messages:[{role:`user`,content:`Estimate the calories in this meal: "${r}". Return ONLY a number, nothing else. For example: 450`}]})});if(!a.ok)return;let o=await a.json(),s=parseInt(o.content[0].text.trim().replace(/[^0-9]/g,``));s>0&&s<5e3&&m.meals.plan[e]?.[t]&&(m.meals.plan[e][t][`cal_`+n]=s,z(m),Yu())}catch{}}function od(){let e=m.meals.shopping||[],t=e.filter(e=>e.checked).length,n=e.length-t,r={};Ru.forEach(e=>r[e]=[]),e.forEach(e=>{r[Ru.includes(e.cat)?e.cat:`Other`].push(e)});let i=``;Ru.forEach(e=>{let t=r[e];t.length&&(i+=`
      ...
      <div style="padding:14px 20px;display:flex;gap:10px;flex-wrap:wrap;align-items:flex-end">
        ...
        <div style="flex:1;min-width:120px">
          ...
          <select class="form-select" id="shop-cat">
            ${Ru.map(e=>`<option value="${e}">${zu[e]} ${e}</option>`).join(``)}
          </select>
        </div>
    ...
    </div>`}function sd(){let e=document.getElementById(`shop-name`)?.value.trim();if(!e)return;let t=document.getElementById(`shop-qty`)?.value.trim()||``,n=document.getElementById(`shop-cat`)?.value||`Other`,r=m.meals.shopping;r.push({id:r.length?Math.max(...r.map(e=>e.id))+1:1,name:e,qty:t,cat:n,checked:!1}),z(m),od()}function cd(e,t){let n=m.meals.shopping.find(t=>t.id===e);n&&(n.checked=t,z(m))}function ld(e){m.meals.shopping=m.meals.shopping.filter(t=>t.id!==e),z(m),od()}function ud(){m.meals.shopping=m.meals.shopping.filter(e=>!e.checked),z(m),od()}function dd(e){var t=document.getElementById(`ls-toast`);t&&t.remove();var n=document.createElement(`div`);n.id=`ls-toast`,n.textContent=e,n.style.cssText=`position:fixed;bottom:96px;left:50%;transform:translateX(-50%) translateY(20px);background:#1a1814;color:#fff;padding:10px 18px;border-radius:99px;font-size:13px;font-weight:600;z-index:9999;opacity:0;transition:opacity .2s,transform .2s;pointer-events:none;white-space:nowrap;max-width:80vw;text-align:center;font-family:var(--sans,system-ui,sans-serif)`,document.body.appendChild(n),requestAnimationFrame(function(){n.style.opacity=`1`,n.style.transform=`translateX(-50%) translateY(0)`}),setTimeout(function(){n.style.opacity=`0`,n.style.transform=`translateX(-50%) translateY(10px)`,setTimeout(function(){n.parentNode&&n.remove()},300)},2400)}function fd(e,t,n,r,i,a,o){m.lists||Lr(m);var s=m.lists[e];if(s){if(s.items.find(function(e){return e.state===`active`&&e.name.toLowerCase()===t.toLowerCase()}))return dd(x(t)+` is already on your list`),!1;var c={id:`li-`+Date.now()+`-`+Math.random().toString(36).slice(2,6),name:t,quantity:n||1,unit:r||`units`,notes:a||``,aisle:i||(e===`food`?Uu(t):`other`),state:`active`,addedBy:`user`,addedAt:new Date().toISOString(),stateChangedAt:null,mealTag:o||null,manualPrice:null,barcodeId:null};return s.items.push(c),xd(e,t),z(m),!0}}function pd(e,t,n){if(!(!m.lists||!m.lists[e])){var r=m.lists[e].items.find(function(e){return e.id===t});r&&(r.state=n,r.stateChangedAt=new Date().toISOString(),z(m),wd())}}function md(e,t){!m.lists||!m.lists[e]||(m.lists[e].items=m.lists[e].items.filter(function(e){return e.id!==t}),z(m),wd())}function hd(e){var t=document.getElementById(`ls-quick-input`);if(t){var n=t.value.trim();if(n){var r=Wu(n),i=e===`food`?Uu(r.name):`other`;if(fd(e,r.name,r.qty,r.unit,i,``,null)!==!1){t.value=``;var a=document.getElementById(`ls-parse-preview`);a&&(a.innerHTML=``),wd()}}}}function gd(e,t){let n=e===`food`,r=m.lists?.[e]?.items||[],i=t?r.find(e=>e.id===t):null,a=n?ke:[`Other`],o=[`units`,`kg`,`g`,`L`,`ml`,`dozen`];document.getElementById(`modal-title`).textContent=i?`Edit Item`:`Add Item`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
      <label class="form-label">Item Name</label>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        ...
        <select class="form-select" id="lf-cat">
          ${a.map(e=>`<option value="${e}"${i&&i.aisle===_d(e)?` selected`:``}>${e}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
        <label class="form-label">Quantity <span style="font-weight:400;color:var(--text-muted)">(optional)</span></label>
    ...
    <button class="btn" onclick="closeModal()">Cancel</button>
    <button class="btn btn-primary" onclick="_listsSaveForm('${e}','${t||``}')">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function _d(e){return{Fridge:`dairy`,Freezer:`frozen`,Pantry:`pantry`,"Fruit & Veg":`produce`,Spices:`pantry`,Drinks:`drinks`,Cleaning:`cleaning`,Other:`other`}[e]||`other`}function vd(e,t){let n=document.getElementById(`lf-name`)?.value.trim();if(!n)return;let r=document.getElementById(`lf-cat`)?.value||`Other`,i=document.getElementById(`lf-qty`)?.value.trim()||`1`,a=document.getElementById(`lf-unit`)?.value||`units`,o=document.getElementById(`lf-notes`)?.value.trim()||``,s=document.querySelector(`input[name="lf-state"]:checked`)?.value||`active`,c=parseFloat(i)||1,l=e===`food`?_d(r):`other`;m.lists||(m.lists={}),m.lists[e]||(m.lists[e]={items:[],weeklyBudget:0,budget:0,stores:[],favourites:[],history:[]});let u=m.lists[e].items;if(t){let e=u.find(e=>e.id===t);e&&(e.name=n,e.quantity=c,e.unit=a,e.notes=o,e.aisle=l,e.state=s)}else{if(u.find(e=>e.name.toLowerCase()===n.toLowerCase()&&e.state===`active`)&&!confirm(`"${n}" is already on your list. Add another?`))return;u.push({id:`si-`+Date.now(),name:n,quantity:c,unit:a,notes:o,aisle:l,state:s,addedBy:L?.uid||`guest`,addedAt:new Date().toISOString(),mealTag:null,manualPrice:null,barcodeId:null}),xd(e,n)}z(m),Q(),wd()}function yd(e){if(!(!m.lists||!m.lists[e])){var t=m.lists[e].items.filter(function(e){return e.state===`got_it`});t.length&&confirm(`Remove `+t.length+` trolley item`+(t.length===1?``:`s`)+`?`)&&(m.lists[e].items=m.lists[e].items.filter(function(e){return e.state!==`got_it`}),z(m),wd())}}function bd(e){if(!(!m.lists||!m.lists[e])){var t=m.lists[e];t.history||(t.history=[]),t.history.push({archivedAt:new Date().toISOString(),items:JSON.parse(JSON.stringify(t.items))}),t.items=[],z(m),dd(`Shop archived!`),wd()}}function xd(e,t){if(!(!m.lists||!m.lists[e])){var n=m.lists[e].favourites,r=n.find(function(e){return e.name.toLowerCase()===t.toLowerCase()});r?r.addedCount=(r.addedCount||0)+1:n.push({name:t,addedCount:1,pinned:!1})}}function Sd(e){if(!(!m.lists||!m.lists[e])){var t=m.lists[e].favourites,n=t.filter(function(e){return e.pinned}),r=n.length?n:t.sort(function(e,t){return(t.addedCount||0)-(e.addedCount||0)}).slice(0,5),i=0;r.forEach(function(t){m.lists[e].items.find(function(e){return e.state===`active`&&e.name.toLowerCase()===t.name.toLowerCase()})||(fd(e,t.name,1,`units`,e===`food`?Uu(t.name):`other`,``,null),i++)}),i?wd():dd(`All usual items are already on the list`)}}function Cd(){var e=document.getElementById(`ls-quick-input`),t=document.getElementById(`ls-parse-preview`);if(!(!e||!t)){var n=e.value.trim();if(!n){t.innerHTML=``;return}var r=Wu(n),i=``;(r.qty!==1||r.unit!==`units`)&&(i+=`<span class="ls-parse-chip">`+x(String(r.qty))+` `+x(r.unit)+`</span>`),i+=`<span class="ls-parse-chip">`+x(r.name)+`</span>`,t.innerHTML=i}}function wd(){var e=document.getElementById(`lists-content`);e&&(m.lists||Lr(m),Ku===`selector`?Td(e):Ed(e,Gu))}function Td(e){var t=`<div class="ls-screen">`;t+=`<div style="font-size:22px;font-weight:800;color:var(--ink,#1a1814);margin-bottom:4px">My Lists</div>`,t+=`<div style="font-size:13px;color:var(--muted,#8c8880);margin-bottom:20px">Tap a list to open it</div>`,t+=`<div class="ls-type-grid">`,Object.keys(Bu).forEach(function(e){var n=Bu[e],r=(m.lists&&m.lists[e]?m.lists[e]:{items:[]}).items.filter(function(e){return e.state===`active`}).length;t+=`<div class="ls-type-card" onclick="_listsActiveType='`+e+`';_listsView='list';renderLists()">`,t+=`<div class="ls-type-icon" style="background:`+n.color+`;color:`+n.text+`">`+n.emoji+`</div>`,t+=`<div class="ls-type-label">`+x(n.label)+`</div>`,t+=`<div class="ls-type-count">`+(r>0?r+` item`+(r===1?``:`s`):`Empty`)+`</div>`,t+=`</div>`}),t+=`</div>`,t+=`</div>`,e.innerHTML=t}function Ed(e,t){var n=Bu[t],r=m.lists&&m.lists[t]?m.lists[t]:{items:[],weeklyBudget:0,favourites:[]},i=r.items||[],a=i.filter(function(e){return e.state===`active`}),o=i.filter(function(e){return e.state===`got_it`}),s=i.filter(function(e){return e.state===`not_found`}),c=`<div class="ls-screen">`;if(c+=`<button class="ls-back-btn" onclick="_listsView='selector';renderLists()">← Lists</button>`,c+=`<div class="ls-header">`,c+=`<div style="font-size:22px;margin-right:6px">`+n.emoji+`</div>`,c+=`<div class="ls-header-title">`+x(n.label)+`</div>`,c+=`<div class="ls-sync-dot"></div>`,c+=`<div class="ls-header-count">`+a.length+` to get</div>`,c+=`</div>`,r.weeklyBudget>0){var l=i.filter(function(e){return e.state===`got_it`&&e.manualPrice}).reduce(function(e,t){return e+(t.manualPrice||0)},0),u=Math.min(100,Math.round(l/r.weeklyBudget*100)),d=u>100?`over`:u>80?`warn`:``;c+=`<div class="ls-budget-bar-wrap">`,c+=`<div class="ls-budget-bar-meta"><span>$`+l.toFixed(0)+` spent</span><span>$`+r.weeklyBudget+` budget</span></div>`,c+=`<div class="ls-budget-bar"><div class="ls-budget-fill `+d+`" style="width:`+u+`%"></div></div>`,c+=`</div>`}var f=(r.favourites||[]).filter(function(e){return!a.find(function(t){return t.name.toLowerCase()===e.name.toLowerCase()})}).sort(function(e,t){return(t.addedCount||0)-(e.addedCount||0)}).slice(0,5);if(f.length>0&&(c+=`<div class="ls-fav-chips">`,f.forEach(function(e){c+=`<button class="ls-fav-chip" onclick="_listsAddItem('`+t+`','`+x(e.name).replace(/'/g,`\\'`)+`',1,'units','`+(t===`food`?Uu(e.name):`other`)+`','',null);renderLists()">+ `+x(e.name)+`</button>`}),c+=`</div>`),(r.favourites||[]).length>0&&(c+=`<button class="ls-usual-btn" onclick="_listsAddUsual('`+t+`')">The usual →</button>`),c+=`<div class="ls-quick-add">`,c+=`<div class="ls-quick-add-row">`,c+=`<input class="ls-quick-input" id="ls-quick-input" type="text" placeholder="Add item…" autocomplete="off" oninput="_listsUpdateParsePreview()" onkeydown="if(event.key==='Enter')_listsQuickAdd('`+t+`')">`,c+=`<button class="ls-quick-add-btn" onclick="_listsQuickAdd('`+t+`')">Add</button>`,c+=`<button class="ls-quick-add-btn" style="background:var(--purple-soft);color:var(--iris-1);min-width:36px;padding:0 10px" onclick="_listsOpenAddForm('`+t+`')">⋯</button>`,c+=`</div>`,c+=`<div class="ls-parse-preview" id="ls-parse-preview"></div>`,c+=`</div>`,a.length>0)if(n.aisles){var p=Vu[t]||[{key:`other`,emoji:`🛒`,label:`Other`}],h={};p.forEach(function(e){h[e.key]=[]}),a.forEach(function(e){var t=e.aisle&&h[e.aisle]!==void 0?e.aisle:`other`;h[t]||(h[t]=[]),h[t].push(e)}),p.forEach(function(e){!h[e.key]||!h[e.key].length||(c+=`<div class="ls-aisle-header">`+e.emoji+` `+x(e.label)+`</div>`,h[e.key].forEach(function(e){c+=Dd(t,e)}))})}else a.forEach(function(e){c+=Dd(t,e)});else c+=`<div style="text-align:center;padding:32px 0;color:var(--muted,#8c8880);font-size:14px">Nothing to get yet — add something above</div>`;o.length>0&&(c+=`<div class="ls-aisle-header">🛒 In the trolley</div>`,o.forEach(function(e){c+=Dd(t,e)})),s.length>0&&(c+=`<div class="ls-aisle-header">🚫 Not found</div>`,s.forEach(function(e){c+=Dd(t,e)})),c+=`<div class="ls-footer-row">`,o.length>0&&(c+=`<button class="ls-footer-btn" onclick="_listsClearTrolley('`+t+`')">Clear trolley (`+o.length+`)</button>`),a.length===0&&i.length>0&&(c+=`<button class="ls-footer-btn" style="background:var(--iris-2,#6366f1);color:#fff;border-color:var(--iris-2,#6366f1)" onclick="_listsArchive('`+t+`')">Archive this shop</button>`),c+=`</div>`,c+=`</div>`,e.innerHTML=c}function Dd(e,t){var n=t.state===`got_it`?`got-it`:t.state===`not_found`?`not-found`:``,r=t.state===`got_it`?`✓`:``,i=t.state===`active`?`got_it`:`active`,a=t.quantity&&t.unit&&t.unit!==`units`?t.quantity+` `+t.unit:t.quantity&&t.quantity!==1?`x`+t.quantity:``;x(t.id);var o=x(t.name),s=`<div class="ls-item `+n+`">`;return s+=`<button class="ls-item-check" onclick="_listsSetState('`+e+`','`+t.id+`','`+i+`')">`+r+`</button>`,s+=`<div class="ls-item-body">`,s+=`<div class="ls-item-name">`+o+`</div>`,a&&(s+=`<div class="ls-item-qty">`+x(a)+`</div>`),t.notes&&(s+=`<div class="ls-item-notes">`+x(t.notes)+`</div>`),s+=`</div>`,t.state===`active`?s+=`<button class="ls-item-notfound-btn" title="Not found" onclick="_listsSetState('`+e+`','`+t.id+`','not_found')">🚫</button>`:t.state===`not_found`&&(s+=`<button class="ls-item-notfound-btn" title="Mark active again" onclick="_listsSetState('`+e+`','`+t.id+`','active')">↩</button>`),s+=`<button class="ls-item-notfound-btn" title="Edit" onclick="_listsOpenAddForm('`+e+`','`+t.id+`')">✏️</button>`,s+=`<button class="ls-item-del" onclick="_listsDeleteItem('`+e+`','`+t.id+`')">×</button>`,s+=`</div>`,s}async function Od(e){let t=m.meals.plan[e]||{},n=[];for(let e=0;e<7;e++){let r=t[e]||{};[`b`,`l`,`d`].forEach(e=>{r[e]&&n.push(r[e])})}if(!n.length)return;let r=localStorage.getItem(`toto_ai_key`);if(!r){Gu=`food`,Ku=`list`,b(`lists`);return}let i=document.getElementById(`gen-shop-btn`);i&&(i.textContent=`⏳ Generating…`,i.disabled=!0);let a=`Generate a grocery shopping list for these meals: ${n.join(`, `)}.
...
Combine quantities where sensible. No duplicates. No other text.`,o={Produce:`produce`,"Meat & Seafood":`meat`,"Dairy & Eggs":`dairy`,Pantry:`pantry`,Bakery:`bakery`,Frozen:`frozen`,Household:`cleaning`,Other:`other`};try{let e=(await(await fetch(Kr,{method:`POST`,headers:{"x-api-key":r,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:a}]})})).json()).content[0].text.match(/\[[\s\S]*\]/);if(!e)throw Error(`No JSON`);let t=JSON.parse(e[0]);m.lists||(m.lists={}),m.lists.food||(m.lists.food={items:[],weeklyBudget:200,budget:0,stores:[],favourites:[],history:[]});let n=m.lists.food.items,i=0;t.forEach(e=>{n.some(t=>t.name.toLowerCase()===e.name.toLowerCase()&&t.state===`active`)||n.push({id:`si-meal-`+Date.now()+`-`+ i++,name:e.name,quantity:1,unit:`units`,notes:e.qty||``,aisle:o[e.cat]||(Uu?Uu(e.name):`other`),state:`active`,addedBy:`meals`,addedAt:new Date().toISOString(),mealTag:`Meal plan`,manualPrice:null,barcodeId:null})}),z(m),Gu=`food`,Ku=`list`,b(`lists`)}catch{i&&(i.textContent=`🛒 Generate shopping list`,i.disabled=!1)}}function kd(){let e=document.getElementById(`dev-tools-overlay`),t=document.getElementById(`dev-tools-sheet`),n=document.getElementById(`dev-tools-body`);if(!e||!t)return;let r=new Date().toISOString().slice(0,10);new Date(Date.now()+864e5).toISOString().slice(0,10),new Date(Date.now()+3*864e5).toISOString().slice(0,10),new Date(Date.now()+7*864e5).toISOString().slice(0,10),new Date(new Date().setMonth(new Date().getMonth()-1)).toISOString().slice(0,7),r.slice(0,7),n.innerHTML=[{label:`💰 Wallet — full budget`,desc:`Income, expenses, actuals, bills, goals, net worth`,fn:`_devLoadWallet`},{label:`👨‍👩‍👧 Kids zone`,desc:`Two kids, chores, prizes, completions, redemptions`,fn:`_devLoadKids`},{label:`📋 Routines`,desc:`Morning & evening routines with steps, assigned to kids`,fn:`_devLoadRoutines`},{label:`📅 Planner & events`,desc:`Events today, tomorrow, this week, recurring`,fn:`_devLoadPlanner`},{label:`🏠 Home — docs, vehicles, maintenance`,desc:`Documents expiring, vehicle rego, maintenance tasks`,fn:`_devLoadHome`},{label:`🍽 Meals & lunchbox`,desc:`This week's meal plan + kids lunchbox entries`,fn:`_devLoadMeals`},{label:`🌟 Load everything`,desc:`All of the above in one shot`,fn:`_devLoadAll`,primary:!0},{label:`🗑 Reset to empty`,desc:`Clears all state back to defaults`,fn:`_devReset`,danger:!0}].map(e=>`
    ...
    </div>`,e.style.display=`block`,t.style.display=`block`}function Ad(){document.getElementById(`dev-tools-overlay`).style.display=`none`,document.getElementById(`dev-tools-sheet`).style.display=`none`}function jd(){let e=new Date().toISOString().slice(0,7);new Date(new Date().setMonth(new Date().getMonth()-1)).toISOString().slice(0,7),m.budget.income=[{id:uid(),name:`Salary`,category:`Salary`,amount:8500,frequency:`monthly`},{id:uid(),name:`Freelance`,category:`Freelance / Contract`,amount:1200,frequency:`monthly`}],m.budget.expenses=[{id:uid(),name:`Mortgage`,category:`Mortgage / Rent`,amount:2800,frequency:`monthly`},{id:uid(),name:`Groceries`,category:`Groceries`,amount:900,frequency:`monthly`},{id:uid(),name:`Electricity`,category:`Utilities`,amount:220,frequency:`monthly`},{id:uid(),name:`Internet`,category:`Utilities`,amount:89,frequency:`monthly`},{id:uid(),name:`Car insurance`,category:`Insurance`,amount:180,frequency:`monthly`},{id:uid(),name:`Dining out`,category:`Dining Out`,amount:350,frequency:`monthly`},{id:uid(),name:`Netflix`,category:`Subscriptions`,amount:23,frequency:`monthly`},{id:uid(),name:`Spotify`,category:`Subscriptions`,amount:12,frequency:`monthly`},{id:uid(),name:`Gym`,category:`Health`,amount:75,frequency:`monthly`},{id:uid(),name:`Kids activities`,category:`Childcare / Education`,amount:280,frequency:`monthly`}];let t={};m.budget.expenses.forEach(e=>{t[e.id]=Math.round(parseFloat(e.amount)*(.4+Math.random()*.7))}),m.budget.actuals[e]=t;let n=e=>{let t=new Date;return t.setDate(t.getDate()+e),t.getDate()},r=e=>{let t=new Date;return t.setDate(t.getDate()+e),t.getMonth()+1};m.bills=[{id:uid(),name:`Electricity`,amount:180,dueDay:n(0),dueMonth:r(0),category:`Utilities`},{id:uid(),name:`Council rates`,amount:420,dueDay:n(1),dueMonth:r(1),category:`Other`},{id:uid(),name:`Phone plan`,amount:45,dueDay:n(2),dueMonth:r(2),category:`Utilities`},{id:uid(),name:`Water bill`,amount:185,dueDay:n(4),dueMonth:r(4),category:`Utilities`},{id:uid(),name:`Internet`,amount:89,dueDay:n(5),dueMonth:r(5),category:`Utilities`},{id:uid(),name:`Spotify`,amount:12,dueDay:n(6),dueMonth:r(6),category:`Subscriptions`},{id:uid(),name:`Home insurance`,amount:290,dueDay:n(14),dueMonth:r(14),category:`Insurance`}],m.goals=[{id:uid(),name:`Emergency fund`,type:`emergency`,targetAmount:25e3,currentAmount:11200,deadline:``},{id:uid(),name:`Europe holiday`,type:`holiday`,targetAmount:8e3,currentAmount:2400,deadline:`2026-12-01`},{id:uid(),name:`New car`,type:`vehicle`,targetAmount:35e3,currentAmount:7800,deadline:`2027-06-01`}],m.netWorth={assets:[{id:uid(),name:`Home`,category:`Property`,amount:85e4},{id:uid(),name:`Super`,category:`Super`,amount:142e3},{id:uid(),name:`Savings`,category:`Savings`,amount:28e3},{id:uid(),name:`Car`,category:`Vehicle`,amount:22e3}],liabilities:[{id:uid(),name:`Mortgage`,category:`Mortgage`,amount:52e4},{id:uid(),name:`Car loan`,category:`Loan`,amount:12e3}],snapshots:[],target:{amount:15e5,byYear:2040}},m.settings={...m.settings,adultName:`Robert Gentilcore`,householdName:`Gentilcore Family`},z(m),renderAll()}function Md(){_routineTodayKey();let e=uid(),t=uid(),n=uid(),r=uid(),i=uid(),a=uid(),o=uid();m.kids={profiles:[{id:e,name:`Amy`,emoji:`🌸`,dob:`2015-03-14`,pinHash:null},{id:t,name:`Johnny`,emoji:`⚡`,dob:`2013-07-22`,pinHash:null}],chores:[{id:n,name:`Make bed`,emoji:`🛏️`,assignedTo:e,points:5,frequency:`Daily`},{id:r,name:`Tidy room`,emoji:`🧹`,assignedTo:e,points:10,frequency:`Daily`},{id:i,name:`Take out bins`,emoji:`🗑️`,assignedTo:t,points:15,frequency:`Weekly`}],prizes:[{id:a,name:`Extra screen time`,emoji:`📱`,pointCost:30},{id:o,name:`Movie night pick`,emoji:`🎬`,pointCost:50},{id:uid(),name:`Takeaway dinner choice`,emoji:`🍕`,pointCost:80}],completions:[{id:uid(),kidId:e,choreId:n,status:`approved`,ts:new Date().toISOString(),completedAt:new Date().toISOString()},{id:uid(),kidId:e,choreId:r,status:`pending`,ts:new Date().toISOString()},{id:uid(),kidId:t,choreId:i,status:`approved`,ts:new Date().toISOString(),completedAt:new Date().toISOString()}],redemptions:[{id:uid(),kidId:e,prizeId:a,status:`pending`,ts:new Date().toISOString()}],notifications:[],allowances:[]},m.childEvents=[{id:uid(),title:`Soccer training`,emoji:`⚽`,date:new Date().toISOString().slice(0,10),time:`17:00`,assignedTo:[t],isHouseholdWide:!1,createdBy:`dev`},{id:uid(),title:`Piano lesson`,emoji:`🎹`,date:new Date(Date.now()+864e5).toISOString().slice(0,10),time:`15:30`,assignedTo:[e],isHouseholdWide:!1,createdBy:`dev`},{id:uid(),title:`Family dinner`,emoji:`🍽️`,date:new Date(Date.now()+2*864e5).toISOString().slice(0,10),time:`19:00`,assignedTo:[],isHouseholdWide:!0,createdBy:`dev`}],z(m),renderAll()}function Nd(){let e=_routineTodayKey(),t=m.kids?.profiles?.[0],n=m.kids?.profiles?.[1],r=[{id:uid(),label:`Make bed`,emoji:`🛏️`,points:5,durationMin:2},{id:uid(),label:`Shower`,emoji:`🚿`,points:5,durationMin:10},{id:uid(),label:`Breakfast`,emoji:`🥣`,points:5,durationMin:15},{id:uid(),label:`Pack bag`,emoji:`🎒`,points:5,durationMin:5}],i=[{id:uid(),label:`Homework`,emoji:`📚`,points:10,durationMin:30},{id:uid(),label:`Tidy room`,emoji:`🧹`,points:5,durationMin:10},{id:uid(),label:`Brush teeth`,emoji:`🦷`,points:5,durationMin:3}],a=[{id:uid(),label:`Exercise`,emoji:`💪`,points:0,durationMin:30},{id:uid(),label:`Meditate`,emoji:`🧘`,points:0,durationMin:10},{id:uid(),label:`Plan the day`,emoji:`📋`,points:0,durationMin:5},{id:uid(),label:`Vitamins`,emoji:`💊`,points:0,durationMin:1}],o=[{id:uid(),label:`Tidy kitchen`,emoji:`🍽️`,points:0,durationMin:10},{id:uid(),label:`Review the day`,emoji:`🪞`,points:0,durationMin:5},{id:uid(),label:`Read`,emoji:`📖`,points:0,durationMin:20},{id:uid(),label:`Lights out`,emoji:`💤`,points:0,durationMin:0}],s=new Date().getHours(),c=uid(),l=uid(),u=uid(),d=uid(),f=[{id:c,name:`Morning`,emoji:`☀️`,ownerType:`adult`,ownerId:`dev`,sharedWith:[],steps:a,pointsPerCompletion:0,triggerTime:`07:00`,recurrence:{type:`weekdays`,startDate:`2026-01-01`},skippedDates:[],pausePeriods:[],completions:{}},{id:l,name:`Evening`,emoji:`🌙`,ownerType:`adult`,ownerId:`dev`,sharedWith:[],steps:o,pointsPerCompletion:0,triggerTime:`${String(s).padStart(2,`0`)}:00`,recurrence:{type:`daily`,startDate:`2026-01-01`},skippedDates:[],pausePeriods:[],completions:{}},{id:u,name:`Morning routine`,emoji:`🌤️`,ownerType:`household`,ownerId:`dev`,sharedWith:[],steps:r,pointsPerCompletion:10,triggerTime:`07:30`,recurrence:{type:`weekdays`,startDate:`2026-01-01`},skippedDates:[],pausePeriods:[]},{id:d,name:`Evening routine`,emoji:`🌙`,ownerType:`household`,ownerId:`dev`,sharedWith:[],steps:i,pointsPerCompletion:10,triggerTime:`${String(s).padStart(2,`0`)}:00`,recurrence:{type:`daily`,startDate:`2026-01-01`},skippedDates:[],pausePeriods:[]}];m.routines=[...(m.routines||[]).filter(e=>e.ownerType!==`adult`&&e.ownerType!==`household`),...f];let p=[];if(t){let n={id:uid(),routineId:u,childId:t.id,completionState:{}};n.completionState[e]=[r[0].id,r[1].id],p.push(n),p.push({id:uid(),routineId:d,childId:t.id,completionState:{}})}n&&(p.push({id:uid(),routineId:u,childId:n.id,completionState:{}}),p.push({id:uid(),routineId:d,childId:n.id,completionState:{}})),m.routineAssignments=[...m.routineAssignments||[],...p];let h=f[0];h.completions[e]=[a[0].id,a[1].id],z(m),renderAll()}function Pd(){let e=new Date().toISOString().slice(0,10),t=new Date(Date.now()+864e5).toISOString().slice(0,10),n=new Date(Date.now()+3*864e5).toISOString().slice(0,10),r=new Date(Date.now()+5*864e5).toISOString().slice(0,10),i=new Date(Date.now()+7*864e5).toISOString().slice(0,10),a=Ft(),o=a[0]?.id||`everyone`,s=a[1]?.id||o;m.planner={events:[{id:uid(),title:`School drop-off`,category:`family`,date:e,time:`08:30`,memberIds:[o],allDay:!1,recurrence:{type:`weekdays`,startDate:`2026-01-01`}},{id:uid(),title:`Team standup`,category:`work`,date:e,time:`09:00`,memberIds:[o],allDay:!1},{id:uid(),title:`Dentist appointment`,category:`health`,date:e,time:`14:00`,memberIds:[o],allDay:!1},{id:uid(),title:`Dinner reservation`,category:`social`,date:e,time:`19:30`,memberIds:[`everyone`],allDay:!1},{id:uid(),title:`Parent–teacher night`,category:`family`,date:t,time:`18:00`,memberIds:[o,s],allDay:!1},{id:uid(),title:`Grocery run`,category:`family`,date:t,time:`10:00`,memberIds:[o],allDay:!1},{id:uid(),title:`Weekend hike`,category:`social`,date:n,time:`08:00`,memberIds:[`everyone`],allDay:!1},{id:uid(),title:`Car service`,category:`home`,date:r,time:`09:00`,memberIds:[o],allDay:!1},{id:uid(),title:`Amy's birthday`,category:`family`,date:i,allDay:!0,memberIds:[`everyone`]}]},z(m),renderAll()}function Fd(){new Date().toISOString().slice(0,10);let e=new Date(Date.now()+14*864e5).toISOString().slice(0,10),t=new Date(Date.now()+60*864e5).toISOString().slice(0,10),n=new Date(Date.now()-7*864e5).toISOString().slice(0,10),r=new Date(Date.now()-30*864e5).toISOString().slice(0,10),i=new Date(Date.now()-90*864e5).toISOString().slice(0,10);m.documents=[{id:uid(),name:`Passport — Robert`,provider:`DFAT`,expiryDate:e},{id:uid(),name:`Home insurance`,provider:`NRMA`,expiryDate:t},{id:uid(),name:`Working with children check`,provider:`Service NSW`,expiryDate:r},{id:uid(),name:`First aid certificate`,provider:`St John`,expiryDate:n}],m.vehicles=[{id:uid(),name:`Tesla Model 3`,make:`Tesla`,model:`Model 3`,plate:`ABC123`,regoExpiry:t,insurance:{provider:`NRMA`,renewalDate:t}},{id:uid(),name:`Toyota RAV4`,make:`Toyota`,model:`RAV4`,plate:`XYZ789`,regoExpiry:n,insurance:{provider:`AAMI`,renewalDate:t}}],m.maintenance=[{id:uid(),name:`Gutter clean`,provider:`Jim's`,nextDue:i,frequency:`Biannual`,notes:`Both sides`},{id:uid(),name:`Car service — RAV4`,provider:`Toyota Service`,nextDue:r,frequency:`Annual`,notes:`15,000km service`},{id:uid(),name:`Termite inspection`,provider:`Rentokil`,nextDue:n,frequency:`Annual`,notes:``},{id:uid(),name:`HVAC filter`,provider:``,nextDue:e,frequency:`Quarterly`,notes:``},{id:uid(),name:`Smoke alarm test`,provider:``,nextDue:t,frequency:`Annual`,notes:``}],m.householdProfile={...m.householdProfile,members:[{role:`adult`,name:`Robert`,age:38,emoji:`👨`},{role:`adult`,name:`Sarah`,age:36,emoji:`👩`}]},z(m),renderAll()}function Id(){let e=typeof $==`function`?$(0):`week-0`,t={},n=[[`Porridge`,`Sandwich & apple`,`Chicken stir-fry`],[`Eggs on toast`,`Leftovers`,`Beef tacos`],[`Smoothie`,`Caesar salad`,`Pasta bolognese`],[`Avocado toast`,`Sushi`,`Lamb roast`],[`Cereal`,`Toasted sandwich`,`Fish & chips`],[`Pancakes`,`Fruit bowl`,`BBQ`],[`French toast`,`Cold cuts`,`Pizza night`]];for(let e=0;e<7;e++)t[e]={b:n[e][0],l:n[e][1],d:n[e][2]};m.meals||(m.meals={plan:{},shopping:[],lunchbox:{profiles:[],plans:{}},pantry:[]}),m.meals.plan[e]=t;let r=m.kids?.profiles?.[0];if(r){let t=typeof $==`function`?$(0):e;m.meals.lunchbox.plans||(m.meals.lunchbox.plans={}),m.meals.lunchbox.plans[t]||(m.meals.lunchbox.plans[t]={});let n=new Date().getDay()===0?6:new Date().getDay()-1;m.meals.lunchbox.plans[t][r.id]={},m.meals.lunchbox.plans[t][r.id][n]={main:`🥪 Vegemite sandwich`,snack:`🍫 Muesli bar`,fruit:`🍎 Apple`,drink:`💧 Water`}}m.lists||Lr(m);let i=new Date().toISOString();m.lists.food.items=[{id:`dev-f1`,name:`Milk`,quantity:2,unit:`L`,notes:``,aisle:`dairy`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f2`,name:`Eggs`,quantity:1,unit:`dozen`,notes:`Free range`,aisle:`dairy`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f3`,name:`Chicken breast`,quantity:500,unit:`g`,notes:``,aisle:`meat`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f4`,name:`Spinach`,quantity:1,unit:`units`,notes:``,aisle:`produce`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f5`,name:`Bread`,quantity:1,unit:`units`,notes:`Sourdough`,aisle:`bakery`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f6`,name:`Pasta`,quantity:500,unit:`g`,notes:``,aisle:`pantry`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f7`,name:`Beer`,quantity:1,unit:`units`,notes:``,aisle:`drinks`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f8`,name:`Avocado`,quantity:2,unit:`units`,notes:``,aisle:`produce`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f9`,name:`Butter`,quantity:1,unit:`units`,notes:`Salted`,aisle:`dairy`,state:`got_it`,addedBy:`dev`,addedAt:i,stateChangedAt:i,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f10`,name:`Orange juice`,quantity:1,unit:`L`,notes:``,aisle:`drinks`,state:`got_it`,addedBy:`dev`,addedAt:i,stateChangedAt:i,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-f11`,name:`Oat milk`,quantity:1,unit:`L`,notes:``,aisle:`dairy`,state:`not_found`,addedBy:`dev`,addedAt:i,stateChangedAt:i,mealTag:null,manualPrice:null,barcodeId:null}],m.lists.food.weeklyBudget=200,m.lists.food.favourites=[{name:`Milk`,addedCount:8,pinned:!0},{name:`Eggs`,addedCount:7,pinned:!0},{name:`Bread`,addedCount:6,pinned:!1},{name:`Chicken breast`,addedCount:5,pinned:!1},{name:`Butter`,addedCount:4,pinned:!1}],m.lists.wishlist.items=[{id:`dev-w1`,name:`AirPods Pro`,quantity:1,unit:`units`,notes:`Gen 2`,aisle:`other`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-w2`,name:`Standing desk mat`,quantity:1,unit:`units`,notes:``,aisle:`other`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null},{id:`dev-w3`,name:`Kindle Paperwhite`,quantity:1,unit:`units`,notes:``,aisle:`other`,state:`active`,addedBy:`dev`,addedAt:i,stateChangedAt:null,mealTag:null,manualPrice:null,barcodeId:null}],z(m),renderAll()}function Ld(){jd(),Md(),Nd(),Pd(),Fd(),Id()}function Rd(){if(!confirm(`Reset all data to empty defaults?`))return;let e=JSON.parse(JSON.stringify(qr));e.onboarded=!0,e.setupProgressDismissed=!1,f(e),z(e),renderAll()}window._acceptInviteAndContinue=Ba,window._addRecurrenceToDate=ar,window._adultPinKey=Ii,window._adultPinSubmit=Li,window._applyActiveProfile=wi,window._applyChildNav=Ti,window._applyMigrations=Lr,window._assignmentCompletedToday=_assignmentCompletedToday,window._assignmentHistory=_assignmentHistory,window._assignmentStreak=_assignmentStreak,window._autoCreateRecurringEvents=or,window._briefIcon=zs,window._briefRow=Ws,window._budgetAllocByCategory=Il,window._buildTotoContext=vr,window._capacitorPrefs=ti,window._categoryIcon=zl,window._checkInviteOnLoad=Aa,window._checkMissionEscalation=ks,window._checkSettingsUnsaved=xl,window._chipClassFor=Bs,window._chipLabelFor=Vs,window._cleanupGuide=_cleanupGuide,window._copyInviteLinkForMember=wa,window._csOpen=Wr,window._csvSetExpense=ts,window._csvToggle=$o,window._csvToggleAll=es,window._csvUpdateApplyBtn=ns,window._cvAgeBracket=Ri,window._cvCalViewToggle=oa,window._cvConfetti=Hi,window._cvDismissNotif=fa,window._cvEventsForDate=Qi,window._cvFmt12h=$i,window._cvMonthDayTap=ua,window._cvRefreshSchedulePanel=na,window._cvRender7Day=sa,window._cvRenderCalendar=aa,window._cvRenderMonth=la,window._cvRenderPrizesTab=Gi,window._cvRoutineAvailLabel=Vi,window._cvRoutineIsActive=Bi,window._cvRoutineSchedCard=ia,window._cvScheduleHtml=ra,window._cvShowDayDetail=da,window._cvShowPrizeConfirm=pa,window._cvSwitchTab=Zi,window._cvTimeGreeting=zi,window._cvToggleRoutineExpand=ea,window._cvToggleStepFromCal=ta,window._cvUpdatePrizesBadge=Wi,window._cvViewCalendar=_cvViewCalendar,window._cvWeekDayTap=ca,window._deleteChildEvent=_deleteChildEvent,window._devLoadAll=Ld,window._devLoadHome=Fd,window._devLoadKids=Md,window._devLoadMeals=Id,window._devLoadPlanner=Pd,window._devLoadRoutines=Nd,window._devLoadWallet=jd,window._devReset=Rd,window._devToolsClose=Ad,window._devToolsOpen=kd,window._dismissInviteFlow=Ga,window._docCatMeta=me,window._ensureKidProfileAndPin=Ca,window._ensureNWModals=Je,window._estimateLbCalories=_estimateLbCalories,window._estimateMealCalories=ad,window._fetchAIBriefing=ec,window._finishInviteJourney=Ha,window._getHouseholdDocRef=kr,window._getHouseholdOwnerUID=Or,window._getInviteUrl=Ta,window._getNthDayOfMonth=nr,window._getPinTotalAttempts=so,window._handlePendingInvite=ja,window._hashPin=fi,window._highlightStep=_highlightStep,window._incPinTotalAttempts=co,window._inferAisle=Uu,window._initAuthListener=zr,window._isPinHardLocked=uo,window._listsAddFavourite=xd,window._listsAddItem=fd,window._listsAddUsual=Sd,window._listsArchive=bd,window._listsClearTrolley=yd,window._listsDeleteItem=md,window._listsOpenAddForm=gd,window._listsQuickAdd=hd,window._listsSaveForm=vd,window._listsSetState=pd,window._listsUpdateParsePreview=Cd,window._maintDaysUntil=Se,window._maintNextDue=xe,window._markSettingsDirty=vl,window._mealGetSuggestions=rd,window._mealPill=ed,window._mealPriceSlide=nd,window._mealToggleFilter=td,window._mealWeekDates=qu,window._mealWeekKey=$,window._missionDaysIgnored=Ds,window._nextForecastMonth=Kt,window._openChildEventModal=_openChildEventModal,window._pantryToAisle=_d,window._parseShopInput=Wu,window._pickAdult=_i,window._pickKid=vi,window._pinKey=Si,window._plannerCloseDaySheet=_plannerCloseDaySheet,window._plannerCloseDetail=_n,window._plannerCloseLifeSheet=mn,window._plannerCloseShare=xn,window._plannerCopyShareUrl=Cn,window._plannerEditFromDetail=yn,window._plannerEvMemberIds=Lt,window._plannerEvPrimaryMember=Rt,window._plannerEvWhoLabel=zt,window._plannerEventsForDate=Ht,window._plannerFmt12h=Ut,window._plannerGoToday=rn,window._plannerHandleDaySheetClick=dn,window._plannerHandleDetailClick=vn,window._plannerHandleLifeSheetClick=hn,window._plannerHandleShareClick=Sn,window._plannerMemberById=It,window._plannerMembers=Ft,window._plannerNextMonth=$t,window._plannerNudges=Tn,window._plannerOpenDaySheet=cn,window._plannerOpenDetail=gn,window._plannerOpenLifeSheet=pn,window._plannerOpenModalFromSheet=fn,window._plannerOpenShare=bn,window._plannerPrevMonth=Qt,window._plannerRecurrenceLabel=Bt,window._plannerRenderDaySheetList=ln,window._plannerSelectDay=en,window._plannerSetView=an,window._plannerShareVia=wn,window._plannerToggleFilter=sn,window._plannerToggleSection=on,window._plannerVisibleEvents=Vt,window._pmDpClear=Yn,window._pmDpNext=Qn,window._pmDpOpen=Gn,window._pmDpOutsideClick=Kn,window._pmDpPrev=Zn,window._pmDpRender=qn,window._pmDpSelect=Jn,window._pmDpToday=Xn,window._pmFmtDate=zn,window._pmFmtDateShort=Bn,window._pmHandleCatChange=Wn,window._pmRenderMemberPicker=Vn,window._pmToggleAllDay=Un,window._pmToggleMember=Hn,window._prevForecastMonth=Gt,window._psoHoldEnd=ro,window._psoHoldStart=no,window._psoKey=io,window._psoRender=to,window._psoSubmit=ao,window._psoTourDone=oo,window._pushAllEventsToBudget=tr,window._qaKey=fs,window._qaSelectCat=ps,window._qahAction=cs,window._qahApplyParsed=us,window._qahSendText=ls,window._recordInviteAcceptance=Va,window._recurrenceMatchesDate=_recurrenceMatchesDate,window._refreshSetupProgress=Fs,window._renderAdultPinModal=Fi,window._renderAdultRoutines=_renderAdultRoutines,window._renderApiKeySummary=Tl,window._renderChildEventsMgmt=_renderChildEventsMgmt,window._renderChildRoutines=_renderChildRoutines,window._renderContextBanners=Ss,window._renderCsvPreview=Xo,window._renderCsvReview=Qo,window._renderInviteFlow=Wa,window._renderLifeAreas=Us,window._renderLifeScore=Ms,window._renderListItem=Dd,window._renderListsDetail=Ed,window._renderListsSelector=Td,window._renderMealPlan=Yu,window._renderMissionCard=Ns,window._renderNudgeSection=ir,window._renderPinDots=bi,window._renderPinPad=xi,window._renderPlannerAgenda=tn,window._renderPlannerEventRow=Zt,window._renderPlannerMonthGrid=Yt,window._renderPlannerWeekStrip=Xt,window._renderQAHub=ss,window._renderQASheet=ds,window._renderRoutinesTodayCard=_renderRoutinesTodayCard,window._renderShoppingList=od,window._renderSuggestionsSection=_renderSuggestionsSection,window._renderTourSlide=La,window._renderWeekStrip=Hs,window._resetPinAttempts=lo,window._routineAddStep=_routineAddStep,window._routineAddSuggestion=_routineAddSuggestion,window._routineAssertScope=_routineAssertScope,window._routineAvailableSuggestions=_routineAvailableSuggestions,window._routineAwardPoints=_routineAwardPoints,window._routineAwardStepPoints=_routineAwardStepPoints,window._routineCheckDailyReset=_routineCheckDailyReset,window._routineCompletedToday=_routineCompletedToday,window._routineCreate=_routineCreate,window._routineCurrentUserId=_routineCurrentUserId,window._routineDateKey=_routineDateKey,window._routineDelete=_routineDelete,window._routineDeleteChild=_routineDeleteChild,window._routineDeleteStep=_routineDeleteStep,window._routineDragEnd=_routineDragEnd,window._routineDragOver=_routineDragOver,window._routineDragStart=_routineDragStart,window._routineDrop=_routineDrop,window._routineDuplicateFromJoined=_routineDuplicateFromJoined,window._routineDuplicateTo=_routineDuplicateTo,window._routineEdit=_routineEdit,window._routineEditStep=_routineEditStep,window._routineEditSuggestion=_routineEditSuggestion,window._routineExpandSugg=_routineExpandSugg,window._routineGetAssignment=_routineGetAssignment,window._routineHistory=_routineHistory,window._routineIntelNudge=_routineIntelNudge,window._routineIsOwner=_routineIsOwner,window._routineJoin=_routineJoin,window._routineKids=_routineKids,window._routineLeave=_routineLeave,window._routineManageAssignments=_routineManageAssignments,window._routineMatchesDate=_routineMatchesDate,window._routineNextId=_routineNextId,window._routineOtherAdults=_routineOtherAdults,window._routinePauseMenu=_routinePauseMenu,window._routinePropagateStepAdd=_routinePropagateStepAdd,window._routinePropagateStepDelete=_routinePropagateStepDelete,window._routineRecurrenceCollect=_routineRecurrenceCollect,window._routineRecurrenceFormHtml=_routineRecurrenceFormHtml,window._routineRecurrenceSummaryUpdate=_routineRecurrenceSummaryUpdate,window._routineRecurrenceTypeChange=_routineRecurrenceTypeChange,window._routineRemovePause=_routineRemovePause,window._routineResetToday=_routineResetToday,window._routineResetTodayAllKids=_routineResetTodayAllKids,window._routineResetTodayKid=_routineResetTodayKid,window._routineSaveValidated=_routineSaveValidated,window._routineSetTab=_routineSetTab,window._routineShareMenu=_routineShareMenu,window._routineShowHistory=_routineShowHistory,window._routineSkipDay=_routineSkipDay,window._routineStreak=_routineStreak,window._routineTodayKey=_routineTodayKey,window._routineToggleAssignment=_routineToggleAssignment,window._routineToggleShare=_routineToggleShare,window._routineToggleStep=_routineToggleStep,window._routineToggleStepKid=_routineToggleStepKid,window._routineToggleSugg=_routineToggleSugg,window._routineTypeSelect=_routineTypeSelect,window._routineUnassign=_routineUnassign,window._routinesForCurrentUser=_routinesForCurrentUser,window._routinesForHousehold=_routinesForHousehold,window._saveInviteIncome=za,window._saveLbSlot=_saveLbSlot,window._sectionTag=bs,window._secureClear=ai,window._secureGet=ri,window._securePrewarm=ni,window._secureSet=ii,window._setHouseholdOwner=Ar,window._setInviteRole=ba,window._setPinHardLock=fo,window._showGuideStep=_showGuideStep,window._showInviteA1=Ma,window._showInviteA3=Na,window._showInviteA4=Ia,window._showInviteExpired=Ua,window._showInviteIncomePrompt=Ra,window._showMissionLightbox=Os,window._showParentLockNotification=mo,window._showPinScreen=yi,window._showToast=dd,window._startFirestoreSync=Rr,window._syncVehicleBill=se,window._tdCloseSheet=Ys,window._tdOpenHeadsUpSheet=Ks,window._tdOpenSheet=Js,window._tdOpenSlippingSheet=qs,window._tdToggleStep=Xs,window._ticker=Rl,window._tlItem=xs,window._todayAllocSegments=Rs,window._totoAppendMessage=yr,window._totoInitPanel=mr,window._totoRemoveTyping=xr,window._totoSend=_r,window._totoSendSuggestion=hr,window._totoShowTyping=br,window._updateSwitchBtn=Ci,window._verifyPin=po,window.addActualEntry=Ho,window.addCatToGroup=pl,window.addCategory=Ol,window.addHouseholdMember=Ic,window.addLink=addLink,window.addPet=zc,window.addSavings=addSavings,window.addShopItem=sd,window.addSubFromImport=Et,window.adjForm=Tc,window.aiPlanLunchbox=aiPlanLunchbox,window.applianceForm=wu,window.applianceFromForm=Tu,window.applyCsvImport=rs,window.approveCompletion=approveCompletion,window.approveRedemption=approveRedemption,window.approveSuggestion=kn,window.assignDevice=hi,window.attachBtn=attachBtn,window.aud=w,window.audD=T,window.billCatIcon=nt,window.billDueBadge=rt,window.billMonthlyEquiv=it,window.billsModal=ct,window.calcFinancialHealth=vs,window.calcLifeScore=Cs,window.calcScenario=_c,window.cancelSettingsChanges=bl,window.clearActivityLog=Dl,window.clearAdultPin=Ai,window.clearCheckedShopItems=ud,window.clearDeviceProfile=ci,window.clearKidPin=Oi,window.clearKidSession=di,window.closeBillModal=ut,window.closeModal=Q,window.closeNWModal=Xe,window.closeNWTargetModal=Ge,window.closePinSetupOverlay=eo,window.closeQuickAdd=os,window.closeSubModal=St,window.closeTotoAssistant=pr,window.completeMission=Es,window.completeWeeklyReset=js,window.confirmScope=xo,window.copyInviteLink=Ea,window.copyMonthFromPrevious=yo,window.customSelect=Ur,window.cyclePantryStatus=Me,window.deleteAdjustment=Oc,window.deleteAppliance=Ou,window.deleteBill=pt,window.deleteCategoryGroup=dl,window.deleteChore=deleteChore,window.deleteDoc=ve,window.deleteExpense=_u,window.deleteExtra=ou,window.deleteFurniture=Cu,window.deleteGoal=pc,window.deleteIncome=du,window.deleteKid=deleteKid,window.deleteLbProfile=deleteLbProfile,window.deleteMaint=Ee,window.deleteNWItem=Qe,window.deletePantryItem=Fe,window.deletePlannerEvent=Nn,window.deletePrize=deletePrize,window.deleteReceiptById=deleteReceiptById,window.deleteScenario=wc,window.deleteService=de,window.deleteStage=Yl,window.deleteSub=wt,window.deleteVariation=eu,window.deleteVehicle=ce,window.detectSpendingPatterns=Yc,window.dismissMission=Ts,window.dismissSubResult=Dt,window.dismissSuggestion=An,window.doScopeAll=Co,window.doScopeMonth=So,window.dpClearDate=Po,window.dpDateInput=Oo,window.dpNextMonth=Mo,window.dpPrevMonth=jo,window.dpSelectDate=No,window.editActual=Wo,window.emojiPicker=emojiPicker,window.endGuide=endGuide,window.ensureMonthOverride=_o,window.escAttr=S,window.escHtml=x,window.estimateAllEvents=Jt,window.estimatePlannerEvent=Pn,window.exitChildView=exitChildView,window.expenseCategories=rc,window.expenseForm=fu,window.expenseFromForm=pu,window.exportData=jl,window.extraForm=nu,window.extraFromForm=ru,window.fileIcon=fileIcon,window.fileSizeStr=fileSizeStr,window.fmtDate=D,window.fmtNW=E,window.freqDisplay=ne,window.freqDisplayItem=k,window.freqLabel=O,window.freqLabelItem=re,window.fundingBadge=fundingBadge,window.furnitureForm=yu,window.furnitureFromForm=bu,window.generateInvite=xa,window.generateMission=ws,window.generateShoppingList=Od,window.generateSmartInsights=Qc,window.generateSmartInsightsHTML=il,window.getAIKey=Kc,window.getActual=q,window.getActualEntries=zo,window.getBenchmarkStatus=Wc,window.getBenchmarks=Uc,window.getCategoryHistoryData=Jc,window.getDB=getDB,window.getDeviceProfile=oi,window.getKidSession=li,window.getLast6Months=Ro,window.getMonthData=W,window.getReceipts=getReceipts,window.getSeasonalNudges=rr,window.goToPlannerDay=nn,window.goalForm=cc,window.goalFromForm=uc,window.goalProgress=oc,window.guestMode=Fr,window.handleCsvFile=Yo,window.handleDeviceRouting=pi,window.handleSubCSV=Tt,window.hideOnboarding=hideOnboarding,window.importData=Ml,window.incomeCategories=ic,window.incomeForm=su,window.incomeFromForm=cu,window.installApp=installApp,window.inviteMember=Sa,window.isMonthCustomized=go,window.isOverdue=te,window.itemMonthly=A,window.kidBalance=kidBalance,window.lbToShoppingList=lbToShoppingList,window.loadColors=jc,window.loadData=Jr,window.logActivity=R,window.markBillPaid=mt,window.markChoreChildView=ma,window.markChoreDone=markChoreDone,window.markGoalAchieved=mc,window.markMaintDone=De,window.monthLabel=K,window.monthShortLabel=Lo,window.monthlyTotal=j,window.nextGuideStep=nextGuideStep,window.nextId=M,window.nextInsightsMonth=ol,window.nextMoneyMonth=gs,window.nextMonth=Io,window.nwItemRow=Ve,window.obBack=obBack,window.obFinish=obFinish,window.obNext=obNext,window.obPickEmoji=obPickEmoji,window.obSetAdults=obSetAdults,window.obSetKids=obSetKids,window.obSkip=obSkip,window.obSkipExpenses=obSkipExpenses,window.obStepPosition=obStepPosition,window.obStepSequence=obStepSequence,window.obToggleEmojiPicker=obToggleEmojiPicker,window.obToggleExpenseSkip=obToggleExpenseSkip,window.openActualEditor=Vo,window.openAddAdjustment=Dc,window.openAddAppliance=Eu,window.openAddCatToGroup=ml,window.openAddCategoryGroup=ll,window.openAddExpense=hu,window.openAddExtra=iu,window.openAddFurniture=xu,window.openAddGoal=dc,window.openAddIncome=lu,window.openAddKidModal=openAddKidModal,window.openAddScenario=Sc,window.openAddStage=ql,window.openAddVariation=Ql,window.openBillModal=lt,window.openChoreModal=openChoreModal,window.openCsvImport=qo,window.openDatePicker=ko,window.openDocForm=ge,window.openEditAppliance=Du,window.openEditContractTotal=Wl,window.openEditExpense=gu,window.openEditExtra=au,window.openEditFurniture=Su,window.openEditGoal=fc,window.openEditIncome=uu,window.openEditKidModal=openEditKidModal,window.openEditScenario=Cc,window.openEditStage=Jl,window.openEditVariation=$l,window.openEmojiPickerModal=cl,window.openIconPickerForGroup=ul,window.openLunchboxEdit=openLunchboxEdit,window.openLunchboxProfile=openLunchboxProfile,window.openMaintForm=we,window.openMealEdit=$u,window.openModal=Z,window.openNWModal=Ye,window.openNWTargetModal=We,window.openNavGroupFor=Tr,window.openPantryForm=Ne,window.openPinSetup=$a,window.openPlannerModal=Rn,window.openPrizeModal=openPrizeModal,window.openQuickAdd=as,window.openReceiptsModal=openReceiptsModal,window.openSavingsModal=openSavingsModal,window.openServiceForm=le,window.openSubModal=xt,window.openTotoAssistant=fr,window.openVehicleForm=N,window.openWeeklyReset=As,window.ordinal=Fu,window.pantryToShoppingList=Le,window.parseBankCSV=Jo,window.pickEmoji=pickEmoji,window.pickedEmoji=pickedEmoji,window.prevInsightsMonth=al,window.prevMoneyMonth=hs,window.prevMonth=Fo,window.prevMonthStr=vo,window.profileAdults=Pc,window.profileChildren=Fc,window.quickAddMaint=Oe,window.quickAddPantry=Ie,window.redeemPrizeChildView=ha,window.refreshReceiptCounts=refreshReceiptCounts,window.rejectCompletion=rejectCompletion,window.rejectRedemption=rejectRedemption,window.removeActualEntry=Uo,window.removeApiKey=wl,window.removeCatFromGroup=hl,window.removeCategory=kl,window.removeHouseholdMember=Lc,window.removePet=Bc,window.removeReceipt=removeReceipt,window.removeShopItem=ld,window.renderAll=renderAll,window.renderApprovals=renderApprovals,window.renderBenchmarksSection=nl,window.renderBills=at,window.renderBudget=Bl,window.renderBudgetForecast=er,window.renderBudgetSuggestions=jn,window.renderBuild=nc,window.renderCategoryBreakdown=Xc,window.renderChoreMgmt=renderChoreMgmt,window.renderDashboard=tc,window.renderDocuments=he,window.renderDpCalendar=Ao,window.renderExpenseGroups=Fl,window.renderForecast=qt,window.renderGoals=sc,window.renderInsightCards=tl,window.renderInsights=rl,window.renderKidView=renderKidView,window.renderKids=renderKids,window.renderKidsOverview=renderKidsOverview,window.renderKidsParent=renderKidsParent,window.renderLists=wd,window.renderLunchbox=renderLunchbox,window.renderMaintenance=Ce,window.renderMeals=Ju,window.renderMoneyDashboard=_s,window.renderNWDebtCard=Ue,window.renderNWTargetCard=He,window.renderNWTrend=qe,window.renderNetWorth=Be,window.renderObStep=renderObStep,window.renderPantry=je,window.renderPlanner=I,window.renderPrizeMgmt=renderPrizeMgmt,window.renderReceiptsList=renderReceiptsList,window.renderRoutines=renderRoutines,window.renderScenarios=vc,window.renderSettings=X,window.renderSetupProgress=Is,window.renderSpendingPatterns=Zc,window.renderSubImportResults=bt,window.renderSubscriptions=st,window.renderToday=Gs,window.renderVehicles=ae,window.requestRedemption=requestRedemption,window.resetAllData=Al,window.resetKidPinLock=ho,window.revokeInvite=Oa,window.runAIInsights=el,window.runCsvCategorise=Zo,window.safeRender=safeRender,window.sanitiseState=ie,window.saveAIKey=qc,window.saveApiKey=Cl,window.saveBill=ft,window.saveChore=saveChore,window.saveColors=Mc,window.saveData=z,window.saveDoc=_e,window.saveKid=saveKid,window.saveLbProfile=saveLbProfile,window.saveMaint=Te,window.saveMealSlot=id,window.saveNWItem=Ze,window.saveNWSnapshot=$e,window.saveNWTarget=Ke,window.savePantryItem=Pe,window.savePlannerEvent=$n,window.savePrize=savePrize,window.saveQuickAdd=ms,window.saveReceipt=saveReceipt,window.saveService=ue,window.saveSettingsChanges=yl,window.saveSub=Ct,window.saveVehicle=oe,window.scenarioForm=bc,window.scenarioFromForm=xc,window.sendInviteEmail=Da,window.sendTotoMessage=gr,window.setActual=Bo,window.setAdultPin=ki,window.setBillsFilter=ot,window.setBudgetView=Pl,window.setDeviceProfile=si,window.setExpenseFilter=Mu,window.setKidPin=Di,window.setKidSession=ui,window.setupProgressTasks=Ps,window.showChildView=Ui,window.showDeviceSetup=mi,window.showOnboarding=showOnboarding,window.showProfileSelector=gi,window.signInWithGoogle=Pr,window.signOutUser=Ir,window.sortExpenses=Nu,window.stageForm=Gl,window.stageFromForm=Kl,window.startGuide=startGuide,window.startHealthGuide=startHealthGuide,window.subCatIcon=gt,window.subMonthlyAmount=_t,window.suggestEventToBudget=On,window.switchProfile=Ei,window.switchToKidMode=ga,window.thSort=Pu,window.toggleAdjFields=Ec,window.toggleBillDayField=dt,window.toggleBudgetDetail=Ul,window.toggleCustomFreq=mu,window.toggleGoalFields=lc,window.toggleGroupExpand=Nl,window.toggleHealthPopover=toggleHealthPopover,window.toggleInsightSheet=Zs,window.toggleNavGroup=wr,window.togglePlannerCard=En,window.togglePlannerEstimate=Dn,window.toggleScenario=yc,window.toggleSettingsSection=El,window.toggleShopItem=cd,window.toggleSidebar=Sr,window.toggleTotoAssistant=dr,window.uid=uid,window.unpushEventFromBudget=Mn,window.updateCars=Hc,window.updateCategoryGroup=fl,window.updateColor=Nc,window.updateMember=Rc,window.updatePet=Vc,window.updateSetting=Sl,window.upgradeSelects=Gr,window.uploadFiles=uploadFiles,window.uploadReceiptFiles=uploadReceiptFiles,window.variationForm=Xl,window.variationFromForm=Zl,window.viewChildToday=viewChildToday,window.viewReceipt=viewReceipt;
//# sourceMappingURL=index-DMZI4bae.js.map