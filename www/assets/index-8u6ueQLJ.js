import"./firebase-DD2PS53O.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(e,t){return t===`daily`?e*365/12:t===`weekly`?e*52/12:t===`fortnightly`?e*26/12:t===`quarterly`?e/3:t===`annually`||t===`annual`?e/12:e}function t(e){let t=new Date;t.setHours(0,0,0,0);let n=e.frequency||`Monthly`;if(n===`Monthly`){let n=parseInt(e.dueDay)||1,r=new Date(t.getFullYear(),t.getMonth(),n);return r<t&&(r=new Date(t.getFullYear(),t.getMonth()+1,n)),r}let r=e.lastPaid?new Date(e.lastPaid):e.startDate?new Date(e.startDate):t;r.setHours(0,0,0,0);let i={Weekly:7,Fortnightly:14,Quarterly:91,Annually:365}[n]||30,a=new Date(r);for(;a<=t;)a=new Date(a.getTime()+i*864e5);return a}function n(e){let n=new Date;n.setHours(0,0,0,0);let r=t(e);return Math.round((r-n)/864e5)}var r={},i=new Set,a=new Set,o={},s=null,c=!1;function l(e,t){o=e,s=t}function u(){c||(c=!0,requestAnimationFrame(d))}function d(){if(c=!1,!s)return;if(a.has(`__all__`)||a.size===0){a.clear(),s();return}let e=new Set(a);a.clear(),e.add(`today`),e.forEach(e=>{let t=o[e];t&&t.forEach(t=>{try{t()}catch(t){console.error(`render error in`,e,t)}})})}function f(e){return i.add(e),()=>i.delete(e)}function p(){i.forEach(e=>{try{e(r)}catch(e){console.error(`store subscriber error:`,e)}})}function m(e){r=e,a.add(`__all__`),u(),p()}function h(e){r=e}var g=new Proxy({},{get(e,t){if(t!==`then`)return r[t]},set(e,t,n){return r[t]=n,!0},has(e,t){return t in r},ownKeys(){return Reflect.ownKeys(r)},getOwnPropertyDescriptor(e,t){let n=Object.getOwnPropertyDescriptor(r,t);return n?{...n,configurable:!0}:void 0}}),_={wallet:{navTab:`budget`,label:`Wallet`,tabs:[{tab:`budget`,label:`Budget`},{tab:`bills`,label:`Bills`},{tab:`networth`,label:`Net Worth`},{tab:`goals`,label:`Goals`},{tab:`insights`,label:`Insights`},{tab:`build`,label:`Build`}]},plan:{navTab:`planner`,label:`Plan`,tabs:[{tab:`planner`,label:`Planner`},{tab:`projects`,label:`Projects`},{tab:`forecast`,label:`Forecast`},{tab:`meals`,label:`Meals`},{tab:`lunchbox`,label:`Lunchbox`},{tab:`pantry`,label:`Pantry`},{tab:`routines`,label:`Routines`},{tab:`lists`,label:`Lists`}]},home:{navTab:`documents`,label:`Home`,tabs:[{tab:`documents`,label:`Documents`},{tab:`vehicles`,label:`Vehicles`},{tab:`maintenance`,label:`Maintenance`},{tab:`kids`,label:`Kids`}]}},v=()=>{};function y(e){v=e}function b(e){for(let[t,n]of Object.entries(_))if(n.tabs.some(t=>t.tab===e))return t;return null}function x(){let e=document.querySelector(`.tab-panel.active`);return e?e.id.replace(`tab-`,``):`today`}function S(e){if(!e)return;let t=e.querySelector(`.section-pills`);if(!t)return;let n=t.scrollWidth-t.scrollLeft-t.clientWidth>4,r=t.scrollLeft>4;e.classList.toggle(`has-overflow-right`,n),e.classList.toggle(`has-overflow-left`,r)}function C(e){e===`subscriptions`&&(e=`bills`),e===`scenarios`&&(e=`insights`),e===`money`&&(e=`budget`),e===`dashboard`&&(e=`budget`),document.getElementById(`tab-`+e)||(e=`today`),typeof window._checkSettingsUnsaved==`function`&&x()===`settings`&&e!==`settings`&&window._checkSettingsUnsaved(e),document.querySelectorAll(`.nav-item, .nav-text-item, .bn-item`).forEach(e=>e.classList.remove(`active`)),document.querySelectorAll(`.tab-panel`).forEach(e=>e.classList.remove(`active`));let t=document.getElementById(`tab-`+e);t&&t.classList.add(`active`);let n=b(e);if(n){let e=_[n].navTab;document.querySelectorAll(`[data-tab="${e}"]`).forEach(e=>e.classList.add(`active`))}else document.querySelectorAll(`[data-tab="${e}"]`).forEach(e=>e.classList.add(`active`));if(document.body.dataset.section=n||e,document.querySelectorAll(`.static-section-header`).forEach(e=>e.classList.remove(`active`)),n){let t=document.getElementById(n+`-section-header`);if(t){t.classList.add(`active`);let r=document.getElementById(n+`-header-date`);r&&(r.textContent=new Date().toLocaleDateString(`en-AU`,{weekday:`long`,month:`long`,day:`numeric`})),t.querySelectorAll(`.section-pill`).forEach(t=>t.classList.toggle(`active`,t.dataset.pill===e)),requestAnimationFrame(()=>t.querySelectorAll(`.section-pills-wrap`).forEach(S))}}v()}function w(e){e===`subscriptions`&&(e=`bills`),e===`scenarios`&&(e=`insights`),e===`money`&&(e=`budget`),e===`dashboard`&&(e=`budget`),(location.hash.slice(1)||`today`)!==e&&history.pushState({tab:e},``,`#`+e),C(e)}window.addEventListener(`popstate`,e=>{C(e.state?.tab||location.hash.slice(1)||`today`)}),(function(){let e=location.hash.slice(1)||`today`;history.replaceState({tab:e},``,e===`today`?location.pathname+location.search:`#`+e)})();function T(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function E(e){return T(e).replace(/\\/g,`\\\\`)}var ee=new Intl.NumberFormat(`en-AU`,{style:`currency`,currency:`AUD`,maximumFractionDigits:0}),te=new Intl.NumberFormat(`en-AU`,{style:`currency`,currency:`AUD`,minimumFractionDigits:2,maximumFractionDigits:2});function D(e){return ee.format(e||0)}function O(e){return te.format(e||0)}function k(e){let t=Math.abs(e),n=t>=1e6?(t/1e6).toFixed(2)+`M`:t>=1e3?(t/1e3).toFixed(1)+`k`:t.toFixed(0);return(e<0?`-$`:`$`)+n}function A(e){if(!e)return`—`;let[t,n,r]=e.split(`-`);return`${r}/${n}/${t}`}function ne(e){return e?new Date(e)<new Date:!1}function re(e){return{daily:`/day`,weekly:`/wk`,fortnightly:`/fn`,monthly:`/mo`,quarterly:`/qtr`,annually:`/yr`,annual:`/yr`}[e]||`/mo`}function ie(e){return{daily:`Daily`,weekly:`Weekly`,fortnightly:`Fortnightly`,monthly:`Monthly`,quarterly:`Quarterly`,annually:`Annually`,annual:`Annually`,custom:`Custom`}[e]||`Monthly`}function j(e){return(e.frequency||`monthly`)===`custom`?`Every ${e.customEvery||1} ${e.customUnit||`weeks`}`:ie(e.frequency||`monthly`)}function ae(e){return(e.frequency||`monthly`)===`custom`?`/${e.customEvery||1}${e.customUnit===`months`?`mo`:`wk`}`:re(e.frequency||`monthly`)}function M(t){let n=t.frequency||`monthly`;if(n===`custom`){let e=t.customEvery||1;return t.customUnit===`months`?(t.amount||0)/e:(t.amount||0)*52/(e*12)}return e(t.amount||0,n)}function N(e){return e.reduce((e,t)=>e+M(t),0)}function P(e){return e.length?Math.max(...e.map(e=>e.id))+1:1}function oe(e){function t(e){if(!(!e||typeof e!=`object`))for(let n of Object.keys(e))typeof e[n]==`string`&&e[n].length>500?e[n]=e[n].slice(0,500):Array.isArray(e[n])?e[n].forEach(e=>t(e)):typeof e[n]==`object`&&e[n]!==null&&t(e[n])}t(e)}function se(){let e=g.vehicles||[];if(e.length===0){document.getElementById(`vehicles-content`).innerHTML=`
    ...
    <button class="btn btn-primary btn-sm" onclick="openVehicleForm()">+ Add Vehicle</button>
      ...
      </div>`}),document.getElementById(`vehicles-content`).innerHTML=t}function ce(e){let t=e?(g.vehicles||[]).find(t=>t.id===e):null,n=!!t;document.getElementById(`modal-title`).textContent=n?`Edit ${t.name}`:`Add Vehicle`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <button class="btn btn-primary" onclick="saveVehicle(${e||`null`})">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function le(e){let t=document.getElementById(`vf-name`)?.value.trim();if(!t)return;let n={name:t,plate:(document.getElementById(`vf-plate`)?.value||``).trim().toUpperCase(),state:document.getElementById(`vf-state`)?.value||`SA`,fuel:document.getElementById(`vf-fuel`)?.value||`petrol`,regoExpiry:document.getElementById(`vf-rego`)?.value||``,odometer:{reading:parseInt(document.getElementById(`vf-odo`)?.value)||0,date:new Date().toISOString().slice(0,10)},serviceInterval:parseInt(document.getElementById(`vf-interval`)?.value)||1e4,insurance:{provider:document.getElementById(`vf-ins-provider`)?.value.trim()||``,policyNo:document.getElementById(`vf-ins-policy`)?.value.trim()||``,renewalDate:document.getElementById(`vf-ins-renewal`)?.value||``}};if(e){let t=g.vehicles.find(t=>t.id===e);t&&Object.assign(t,n)}else n.id=g.vehicles.length?Math.max(...g.vehicles.map(e=>e.id))+1:1,n.services=[],g.vehicles.push(n);g.bills||(g.bills=[]),ue(n,`rego`,`Rego - ${n.name}`,n.regoExpiry,0,`Insurance`),n.insurance&&n.insurance.renewalDate&&ue(n,`insurance`,`Insurance - ${n.name}`,n.insurance.renewalDate,0,`Insurance`),window.saveData(g),window.closeModal(),window.renderAll()}function ue(e,t,n,r,i,a){if(!r)return;let o=`vehicle_${e.id||e.name}_${t}`,s=g.bills.find(e=>e._vehicleRef===o),c={name:n,amount:i||(s?s.amount:0),category:a,frequency:`Annual`,autopay:!1,startDate:r,_vehicleRef:o};s?Object.assign(s,c):(c.id=uid(),g.bills.push(c))}function de(e){if(!confirm(`Delete this vehicle and all its service history?`))return;let t=`vehicle_${e}_`;g.bills=(g.bills||[]).filter(e=>!(e._vehicleRef&&e._vehicleRef.startsWith(t))),g.vehicles=g.vehicles.filter(t=>t.id!==e),window.saveData(g),window.renderAll()}function fe(e){document.getElementById(`modal-title`).textContent=`Add Service Record`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
    ...
    <input class="doc-search" type="text" maxlength="200" placeholder="Search documents…" value="${ge}" oninput="_docSearch=this.value;renderDocuments()" style="margin:0 20px;width:calc(100% - 40px)">`,u={};n.forEach(e=>{let t=e.category||`Other`;u[t]||(u[t]=[]),u[t].push(e)}),he.forEach(e=>{let n=u[e.key];!n||!n.length||(l+=`<div class="doc-cat-group">
      <div class="doc-cat-header">${e.icon} ${e.key} <span style="font-weight:400;text-transform:none">(${n.length})</span></div>`,n.sort((e,t)=>e.expiryDate&&t.expiryDate?new Date(e.expiryDate)-new Date(t.expiryDate):e.expiryDate?-1:1).forEach(n=>{let r=``;if(n.expiryDate){let e=Math.ceil((new Date(n.expiryDate)-t)/864e5);r=e<0?`<span class="veh-badge red" style="font-size:11px">Expired ${Math.abs(e)}d ago</span>`:e<=30?`<span class="veh-badge amber" style="font-size:11px">Expires in ${e}d</span>`:`<span class="veh-badge green" style="font-size:11px">${new Date(n.expiryDate).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`})}</span>`}let i=[n.provider?T(n.provider):``,n.reference?T(n.reference):``,n.storedAt?`📍 ${T(n.storedAt)}`:``].filter(Boolean);l+=`
        <div class="doc-card" onclick="openDocForm(${n.id})">
          ...
          ${r}
        </div>`}),l+=`</div>`)}),n.length,document.getElementById(`documents-content`).innerHTML=l}function ye(e){let t=e?(g.documents||[]).find(t=>t.id===e):null,n=!!t;document.getElementById(`modal-title`).textContent=n?`Edit Document`:`Add Document`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
    ...
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    <button class="btn btn-primary" onclick="saveDoc(${e||`null`})">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function be(e){let t=document.getElementById(`df-name`)?.value.trim();if(!t)return;let n={name:t,category:document.getElementById(`df-cat`)?.value||`Other`,provider:document.getElementById(`df-provider`)?.value.trim()||``,reference:document.getElementById(`df-ref`)?.value.trim()||``,expiryDate:document.getElementById(`df-expiry`)?.value||``,renewalCost:parseFloat(document.getElementById(`df-cost`)?.value)||0,storedAt:document.getElementById(`df-stored`)?.value.trim()||``,notes:document.getElementById(`df-notes`)?.value.trim()||``};if(e){let t=g.documents.find(t=>t.id===e);t&&Object.assign(t,n)}else n.id=g.documents.length?Math.max(...g.documents.map(e=>e.id))+1:1,g.documents.push(n);if(n.expiryDate&&n.renewalCost>0){g.bills||(g.bills=[]);let t=`doc_${e||n.id}`,r=g.bills.find(e=>e._docRef===t),i={name:`${n.name}${n.provider?` - `+n.provider:``}`,amount:n.renewalCost,category:n.category===`Vehicle`?`Insurance`:n.category,frequency:`Annual`,autopay:!1,startDate:n.expiryDate,_docRef:t};r?Object.assign(r,i):(i.id=uid(),g.bills.push(i))}window.saveData(g),window.closeModal(),window.renderAll()}function xe(e){if(!confirm(`Delete this document?`))return;let t=`doc_${e}`;g.bills=(g.bills||[]).filter(e=>e._docRef!==t),g.documents=g.documents.filter(t=>t.id!==e),window.saveData(g),window.closeModal(),window.renderAll()}var Se=[{key:`HVAC`,icon:`❄️`},{key:`Plumbing`,icon:`🚿`},{key:`Electrical`,icon:`💡`},{key:`Garden`,icon:`🌿`},{key:`Cleaning`,icon:`🧹`},{key:`Safety`,icon:`🔥`},{key:`Appliance`,icon:`🔧`},{key:`Exterior`,icon:`🏠`},{key:`Other`,icon:`📋`}],Ce=[{name:`Gutters Cleaned`,category:`Exterior`,intervalNum:6,intervalUnit:`months`,icon:`🏠`},{name:`Smoke Alarm Batteries`,category:`Safety`,intervalNum:12,intervalUnit:`months`,icon:`🔥`},{name:`Pest Control`,category:`Exterior`,intervalNum:12,intervalUnit:`months`,icon:`🐛`},{name:`AC Filter Cleaned`,category:`HVAC`,intervalNum:3,intervalUnit:`months`,icon:`❄️`},{name:`Hot Water System Flush`,category:`Plumbing`,intervalNum:12,intervalUnit:`months`,icon:`🚿`},{name:`Lawn Mowing`,category:`Garden`,intervalNum:2,intervalUnit:`weeks`,icon:`🌿`},{name:`Oven Clean`,category:`Cleaning`,intervalNum:6,intervalUnit:`months`,icon:`🧹`},{name:`Pool Maintenance`,category:`Exterior`,intervalNum:1,intervalUnit:`months`,icon:`🏊`},{name:`Drains / Septic`,category:`Plumbing`,intervalNum:2,intervalUnit:`years`,icon:`🚿`},{name:`Roof Inspection`,category:`Exterior`,intervalNum:2,intervalUnit:`years`,icon:`🏠`}];function we(e){if(!e.lastDone)return null;let t=new Date(e.lastDone),n=e.intervalNum||1,r=e.intervalUnit||`months`;return r===`days`?t.setDate(t.getDate()+n):r===`weeks`?t.setDate(t.getDate()+n*7):r===`months`?t.setMonth(t.getMonth()+n):r===`years`&&t.setFullYear(t.getFullYear()+n),t}function Te(e){let t=we(e);return t?Math.ceil((t-new Date)/864e5):null}function Ee(){let e=g.maintenance||[];if(e.length===0){let t=new Set(e.map(e=>e.name.toLowerCase())),n=Ce.filter(e=>!t.has(e.name.toLowerCase()));document.getElementById(`maintenance-content`).innerHTML=`
      <div class="empty" style="margin-top:24px">
        <div class="empty-icon">🔧</div>
      ...
      </div>`:``}`;return}let t=[...e].map(e=>{let t=Te(e);return{...e,_days:t}}).sort((e,t)=>e._days===null&&t._days===null?0:e._days===null?1:t._days===null?-1:e._days-t._days),n=t.filter(e=>e._days!==null&&e._days<0).length,r=t.filter(e=>e._days!==null&&e._days>=0&&e._days<=14).length,i=`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap;gap:10px">
    ...
    </div>`;if(t.forEach(e=>{let t=e._days,n=`ok`,r=``;t===null?(n=`ok`,r=e.lastDone?`Last done ${new Date(e.lastDone).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`})}`:`Never done`):t<0?(n=`overdue`,r=`Overdue by ${Math.abs(t)} day${Math.abs(t)===1?``:`s`}`):t<=14?(n=`due-soon`,r=t===0?`Due today`:`Due in ${t} day${t===1?``:`s`}`):r=`Due ${we(e).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}`;let a=Se.find(t=>t.key===e.category)||Se[Se.length-1],o=e.intervalNum?`Every ${e.intervalNum} ${e.intervalUnit}`:``;i+=`
      ...
      </div>`}),e.length<3){let t=new Set(e.map(e=>e.name.toLowerCase())),n=Ce.filter(e=>!t.has(e.name.toLowerCase()));n.length&&(i+=`<div style="margin-top:20px">
      ...
      </div>`)}document.getElementById(`maintenance-content`).innerHTML=i}function De(e){let t=e?(g.maintenance||[]).find(t=>t.id===e):null,n=!!t;document.getElementById(`modal-title`).textContent=n?`Edit ${t.name}`:`Add Maintenance Item`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        ...
        <select class="form-select" id="mf-cat">
          ${Se.map(e=>`<option value="${e.key}"${t&&t.category===e.key?` selected`:``}>${e.icon} ${e.key}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
        <label class="form-label">Provider</label>
    ...
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    <button class="btn btn-primary" onclick="saveMaint(${e||`null`})">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Oe(e){let t=document.getElementById(`mf-name`)?.value.trim();if(!t)return;let n={name:t,category:document.getElementById(`mf-cat`)?.value||`Other`,provider:document.getElementById(`mf-provider`)?.value.trim()||``,intervalNum:parseInt(document.getElementById(`mf-interval-num`)?.value)||1,intervalUnit:document.getElementById(`mf-interval-unit`)?.value||`months`,lastDone:document.getElementById(`mf-last`)?.value||``,lastCost:parseFloat(document.getElementById(`mf-cost`)?.value)||0,notes:document.getElementById(`mf-notes`)?.value.trim()||``};if(e){let t=g.maintenance.find(t=>t.id===e);t&&Object.assign(t,n)}else n.id=g.maintenance.length?Math.max(...g.maintenance.map(e=>e.id))+1:1,g.maintenance.push(n);window.saveData(g),window.closeModal(),window.renderAll()}function ke(e){confirm(`Delete this maintenance item?`)&&(g.maintenance=g.maintenance.filter(t=>t.id!==e),window.saveData(g),window.closeModal(),window.renderAll())}function Ae(e){let t=g.maintenance.find(t=>t.id===e);if(!t)return;let n=new Date().toISOString().slice(0,10);if(t.lastDone=n,t.lastCost>0){let e=n.slice(0,7),r=window.getMonthData(e),i=r.expenses.find(e=>(e.category||``).toLowerCase()===`other`&&(e.name||``).toLowerCase().includes(`maintenance`))||r.expenses.find(e=>(e.name||``).toLowerCase().includes(`maintenance`));if(!i&&(i={id:P(g.budget.expenses),name:`Home Maintenance`,amount:0,frequency:`monthly`,category:`Other`,dueDate:``,vendor:null},g.budget.expenses.push(i),window.isMonthCustomized(e))){let t=g.budget.months[e];i={...i,id:P(t.expenses)},t.expenses.push(i)}g.budget.actuals[e]||(g.budget.actuals[e]={});let a=window.getActualEntries(i.id,e);a.push({id:a.length?Math.max(...a.map(e=>e.id))+1:1,amount:t.lastCost,date:n,note:`${t.name}${t.provider?` - `+t.provider:``}`}),g.budget.actuals[e][i.id]=a}window.saveData(g),window.renderAll()}function je(e){let t=Ce[e];if(!t)return;let n={id:g.maintenance.length?Math.max(...g.maintenance.map(e=>e.id))+1:1,name:t.name,category:t.category,provider:``,intervalNum:t.intervalNum,intervalUnit:t.intervalUnit,lastDone:``,lastCost:0,notes:``};g.maintenance.push(n),window.saveData(g),window.renderAll()}var Me=[`Fridge`,`Freezer`,`Pantry`,`Fruit & Veg`,`Spices`,`Drinks`,`Cleaning`,`Other`],Ne=[{name:`Milk`,cat:`Fridge`},{name:`Eggs`,cat:`Fridge`},{name:`Cheese`,cat:`Fridge`},{name:`Butter`,cat:`Fridge`},{name:`Yoghurt`,cat:`Fridge`},{name:`Chicken breast`,cat:`Freezer`},{name:`Mince`,cat:`Freezer`},{name:`Fish fillets`,cat:`Freezer`},{name:`Frozen veg`,cat:`Freezer`},{name:`Pasta`,cat:`Pantry`},{name:`Rice`,cat:`Pantry`},{name:`Tinned tomatoes`,cat:`Pantry`},{name:`Olive oil`,cat:`Pantry`},{name:`Flour`,cat:`Pantry`},{name:`Sugar`,cat:`Pantry`},{name:`Bread`,cat:`Pantry`},{name:`Cereal`,cat:`Pantry`},{name:`Onions`,cat:`Fruit & Veg`},{name:`Potatoes`,cat:`Fruit & Veg`},{name:`Bananas`,cat:`Fruit & Veg`},{name:`Apples`,cat:`Fruit & Veg`},{name:`Salt`,cat:`Spices`},{name:`Pepper`,cat:`Spices`},{name:`Garlic`,cat:`Spices`}];function Pe(){let e=document.getElementById(`pantry-content`);if(!e)return;let t=g.meals.pantry||[];if(t.length===0){e.innerHTML=`
      <div class="empty" style="margin-top:24px">
      ...
      <div style="margin-top:20px">
        ...
        <div class="pantry-starter">
          ${Ne.map(e=>`<button class="pantry-starter-btn" onclick="quickAddPantry('${E(e.name)}','${e.cat}')">${T(e.name)}</button>`).join(``)}
        </div>
      </div>`;return}let n={};Me.forEach(e=>n[e]=[]),t.forEach(e=>{n[Me.includes(e.cat)?e.cat:`Other`].push(e)});let r=t.filter(e=>e.status===`need`).length,i=t.filter(e=>e.status===`low`).length,a=`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap;gap:10px">
      <div style="display:flex;gap:8px;flex-wrap:wrap">
    ...
    </div>`;if(Me.forEach(e=>{let t=n[e];t.length&&(a+=`<div class="pantry-cat-header">${T(e)} (${t.length})</div>`,t.forEach(e=>{let t=e.status===`stocked`?`✓`:e.status===`low`?`!`:`✗`;e.status===`stocked`||e.status,a+=`<div class="pantry-item">
      ...
      </div>`}))}),t.length<10){let e=new Set(t.map(e=>e.name.toLowerCase())),n=Ne.filter(t=>!e.has(t.name.toLowerCase()));n.length&&(a+=`<div style="margin-top:20px">
        <div style="font-size:13px;font-weight:600;margin-bottom:8px">Quick-add more</div>
        <div class="pantry-starter">
          ${n.slice(0,12).map(e=>`<button class="pantry-starter-btn" onclick="quickAddPantry('${E(e.name)}','${e.cat}')">${T(e.name)}</button>`).join(``)}
        </div>
      </div>`)}e.innerHTML=a}function Fe(e){let t=(g.meals.pantry||[]).find(t=>t.id===e);t&&(t.status={stocked:`low`,low:`need`,need:`stocked`}[t.status]||`stocked`,window.saveData(g),Pe())}function Ie(e){let t=e?(g.meals.pantry||[]).find(t=>t.id===e):null;document.getElementById(`modal-title`).textContent=t?`Edit Item`:`Add Pantry Item`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
      <label class="form-label">Item Name</label>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        ...
        <select class="form-select" id="pf-cat">
          ${Me.map(e=>`<option value="${e}"${t&&t.cat===e?` selected`:``}>${e}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
    ...
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    <button class="btn btn-primary" onclick="savePantryItem(${e||`null`})">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Le(e){let t=document.getElementById(`pf-name`)?.value.trim();if(!t)return;let n={name:t,cat:document.getElementById(`pf-cat`)?.value||`Other`,qty:document.getElementById(`pf-qty`)?.value.trim()||``,status:document.querySelector(`input[name="pf-status"]:checked`)?.value||`stocked`},r=g.meals.pantry;if(e){let t=r.find(t=>t.id===e);t&&Object.assign(t,n)}else n.id=r.length?Math.max(...r.map(e=>e.id))+1:1,r.push(n);window.saveData(g),window.closeModal(),Pe()}function Re(e){g.meals.pantry=(g.meals.pantry||[]).filter(t=>t.id!==e),window.saveData(g),Pe()}function ze(e,t){let n=g.meals.pantry;n.push({id:n.length?Math.max(...n.map(e=>e.id))+1:1,name:e,cat:t,qty:``,status:`stocked`}),window.saveData(g),Pe()}function Be(){let e=(g.meals.pantry||[]).filter(e=>e.status===`need`||e.status===`low`);if(!e.length)return;g.lists||(g.lists={}),g.lists.food||(g.lists.food={items:[],weeklyBudget:200,budget:0,stores:[],favourites:[],history:[]});let t=g.lists.food.items,n={Fridge:`dairy`,Freezer:`frozen`,Pantry:`pantry`,"Fruit & Veg":`produce`,Spices:`pantry`,Drinks:`drinks`,Cleaning:`cleaning`,Other:`other`},r=0;e.forEach(e=>{t.some(t=>t.name.toLowerCase()===e.name.toLowerCase()&&t.state===`active`)||(t.push({id:`si-`+Date.now()+`-`+r,name:e.name,quantity:1,unit:`units`,notes:``,aisle:n[e.cat]||`other`,state:`active`,addedBy:`pantry`,addedAt:new Date().toISOString(),mealTag:`Pantry`,manualPrice:null,barcodeId:null}),r++)}),r>0&&(window.saveData(g),_listsActiveType=`food`,_listsView=`list`,activateTab(`lists`));let i=document.querySelector(`[onclick*="pantryToShoppingList"]`);if(i){let e=i.textContent;i.textContent=`Added ${r} items`,i.style.color=`var(--success)`,setTimeout(()=>{i.textContent=e,i.style.color=``},2e3)}}var Ve=[`Cash & Savings`,`Investments`,`Property`,`Superannuation`,`Vehicle`,`Other`],He=[`Mortgage`,`Car Loan`,`Credit Card`,`Personal Loan`,`HECS/HELP`,`Other`];function Ue(){let e=document.getElementById(`networth-content`);if(!e)return;let t=g.netWorth,n=t.assets||[],r=t.liabilities||[],i=t.snapshots||[],a=n.reduce((e,t)=>e+(parseFloat(t.value)||0),0),o=r.reduce((e,t)=>e+(parseFloat(t.value)||0),0),s=a-o,c=``;if(i.length>=2){let e=s-i[i.length-2].netWorth;c=`<span class="${e>=0?`up`:`down`}">${e>=0?`+`:``}${k(e)}</span> vs last snapshot`}if(!n.length&&!r.length){e.innerHTML=`
      <div style="background:#fff;border:2px dashed #cbd5e1;border-radius:16px;padding:36px 24px;margin-top:8px">
        <div style="display:flex;align-items:center;gap:16px;margin-bottom:20px">
          <div style="font-size:40px">📊</div>
          <div>
    ...
    <div class="nw-hero">
      ...
      <div class="nw-hero-amount ${s>=0?`positive`:`negative`}">${k(s)}</div>
      ${c?`<div class="nw-hero-change">${c}</div>`:``}
    </div>

    ${Ge(s)}
    ${r.some(e=>e.rate)?Ke(r):``}
    ${i.length>1?Xe(i):``}
    ...
    <div class="nw-cols">
      <div class="nw-col-card assets">
        <div class="nw-col-header">
          ...
          <span class="nw-col-total">${k(a)}</span>
        </div>
        ${n.length?n.map(e=>We(e,`asset`)).join(``):`<div class="nw-empty">No assets yet</div>`}
      ...
      <div class="nw-col-card liabilities">
        <div class="nw-col-header">
          ...
          <span class="nw-col-total">${k(o)}</span>
        </div>
        ${r.length?r.map(e=>We(e,`liability`)).join(``):`<div class="nw-empty">No liabilities yet</div>`}
        <div class="nw-add-row">
  ...
  `}function We(e,t){let n=e.category||``;if(t===`liability`&&e.rate){let t=parseFloat(e.value)||0,r=parseFloat(e.rate),i=t*r/1200;n+=n?` · `:``,n+=`${r}% p.a. · $${Math.round(i).toLocaleString()}/mo interest`}return`
    <div class="nw-item">
      <div style="flex:1;min-width:0">
        <div class="nw-item-name">${T(e.name)}</div>
        ${n?`<div class="nw-item-cat">${n}</div>`:``}
      </div>
      <div class="nw-item-value">${k(parseFloat(e.value)||0)}</div>
    ...
    </div>`}function Ge(e){let t=g.netWorth.target||{},n=parseFloat(t.amount)||0,r=parseInt(t.byYear)||0,i=new Date().getFullYear();if(!n||!r)return`
    ...
    <div class="nw-target-card">
      ...
      <div style="display:flex;align-items:baseline;gap:8px;flex-wrap:wrap">
        <div class="nw-target-goal">${k(n)}</div>
      ...
      <div style="display:flex;justify-content:space-between;font-size:12px;color:#94a3b8;margin-bottom:14px">
        ...
        <span>${u?`🎉 Goal reached!`:k(o)+` to go`}</span>
      </div>
    ...
    </div>`}function qe(){let e=g.netWorth.target||{};document.getElementById(`nw-t-amount`).value=e.amount||``,document.getElementById(`nw-t-year`).value=e.byYear||``,document.getElementById(`nw-target-modal`).style.display=`flex`}function Je(){document.getElementById(`nw-target-modal`).style.display=`none`}function Ye(){let e=parseFloat(document.getElementById(`nw-t-amount`).value),t=parseInt(document.getElementById(`nw-t-year`).value);!e||!t||(g.netWorth.target||(g.netWorth.target={}),g.netWorth.target.amount=e,g.netWorth.target.byYear=t,window.saveData(g),Ue(),Je())}function Xe(e){let t=e.slice(-12),n=Math.max(...t.map(e=>Math.abs(e.netWorth)),1);return`
    ...
    </div>`;e.firstChild;)document.body.appendChild(e.firstChild)}function Qe(e,t){Ze();let n=g.netWorth,r=e===`asset`?n.assets:n.liabilities,i=e===`asset`?Ve:He,a=t?r.find(e=>e.id===t):null,o=document.getElementById(`nw-modal`);if(!o)return;document.getElementById(`nw-modal-title`).textContent=(a?`Edit`:`Add`)+` `+(e===`asset`?`Asset`:`Liability`),document.getElementById(`nw-edit-id`).value=t||``,document.getElementById(`nw-edit-type`).value=e,document.getElementById(`nw-name`).value=a?a.name:``,document.getElementById(`nw-value`).value=a?a.value:``,document.getElementById(`nw-rate`).value=a&&a.rate?a.rate:``,document.getElementById(`nw-payment`).value=a&&a.monthlyPayment?a.monthlyPayment:``;let s=a?.category||i[0],c=document.getElementById(`nw-cat-wrap`);c&&(c.innerHTML=window.customSelect(`nw-cat`,i,s,e=>{_csStore[`nw-cat`].value=e}));let l=document.getElementById(`nw-debt-fields`);l&&(l.style.display=e===`liability`?`flex`:`none`),o.style.display=`flex`}function $e(){let e=document.getElementById(`nw-modal`);e&&(e.style.display=`none`)}function et(){let e=document.getElementById(`nw-name`).value.trim(),t=parseFloat(document.getElementById(`nw-value`).value),n=_csStore[`nw-cat`]?.value||``,r=document.getElementById(`nw-edit-type`).value,i=document.getElementById(`nw-edit-id`).value,a=parseFloat(document.getElementById(`nw-rate`).value)||0,o=parseFloat(document.getElementById(`nw-payment`).value)||0;if(!e||isNaN(t))return;let s=r===`asset`?g.netWorth.assets:g.netWorth.liabilities,c={name:e,value:t,category:n};if(r===`liability`&&(a&&(c.rate=a),o&&(c.monthlyPayment=o)),i){let e=s.findIndex(e=>e.id===i);e!==-1&&(s[e]={...s[e],...c})}else s.push({id:uid(),...c});window.saveData(g),$e(),Ue()}function tt(e,t){let n=e===`asset`?g.netWorth.assets:g.netWorth.liabilities,r=n.findIndex(e=>e.id===t);r!==-1&&(n.splice(r,1),window.saveData(g),Ue())}function nt(){let e=g.netWorth,t=(e.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0)-(e.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),n=new Date().toISOString().slice(0,10);e.snapshots||(e.snapshots=[]);let r=e.snapshots.findIndex(e=>e.date===n),i={date:n,netWorth:t,assets:(e.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),liabilities:(e.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0)};r===-1?e.snapshots.push(i):e.snapshots[r]=i,window.saveData(g),Ue()}function F(e){return window._secureGet(e)}function rt(e,t){window._secureSet(e,t)}function it(e){window._secureClear(e)}var at=[{label:`Streaming`,icon:`📺`},{label:`Music`,icon:`🎵`},{label:`Software`,icon:`💻`},{label:`Fitness`,icon:`💪`},{label:`Gaming`,icon:`🎮`},{label:`News`,icon:`📰`},{label:`Insurance`,icon:`🛡️`},{label:`Education`,icon:`📚`},{label:`Other`,icon:`📦`}];function ot(e){let t=at.find(t=>t.label===e);return t?t.icon:`📦`}function st(e){let t=parseFloat(e.amount)||0;return e.frequency===`Annual`?t/12:e.frequency===`Weekly`?t*52/12:t}var ct=[],lt=new Set;Object.defineProperty(window,`_subImportResults`,{get(){return ct},set(e){ct=e},configurable:!0}),Object.defineProperty(window,`_subImportDismissed`,{get(){return lt},set(e){lt=e},configurable:!0});function ut(e){let t=e.map(e=>`
    <div class="sub-result-row">
      <div class="sub-result-icon">${ot(e.category)}</div>
    ...
    ${t}
  </div>`}function dt(e){let t=e?(g.subscriptions||[]).find(t=>t.id===e):null;document.getElementById(`sub-modal-title`).textContent=t?`Edit Subscription`:`Add Subscription`,document.getElementById(`sub-edit-id`).value=e||``,document.getElementById(`sub-name`).value=t?t.name:``,document.getElementById(`sub-cat`).value=t&&t.category||`Streaming`,document.getElementById(`sub-freq`).value=t&&t.frequency||`Monthly`,document.getElementById(`sub-amount`).value=t?t.amount:``,document.getElementById(`sub-renewal`).value=t&&t.renewalDate||``,document.getElementById(`sub-modal`).style.display=`flex`}function ft(){document.getElementById(`sub-modal`).style.display=`none`}function pt(){let e=document.getElementById(`sub-name`).value.trim(),t=parseFloat(document.getElementById(`sub-amount`).value),n=document.getElementById(`sub-cat`).value,r=document.getElementById(`sub-freq`).value,i=document.getElementById(`sub-renewal`).value,a=document.getElementById(`sub-edit-id`).value;if(!e||isNaN(t))return;g.subscriptions||(g.subscriptions=[]);let o={name:e,amount:t,category:n,frequency:r,renewalDate:i};if(a){let e=g.subscriptions.findIndex(e=>e.id===a);e!==-1&&(g.subscriptions[e]={...g.subscriptions[e],...o})}else g.subscriptions.push({id:uid(),...o});window.saveData(g),ft(),renderSubscriptions()}function mt(e){g.subscriptions=(g.subscriptions||[]).filter(t=>t.id!==e),window.saveData(g),renderSubscriptions()}async function ht(e){let t=e.target.files[0];if(!t)return;let n=F(`toto_ai_key`),r=document.getElementById(`sub-import-status`);if(!n){r&&(r.textContent=`⚠ Please enter your Anthropic API key above first.`,r.style.display=``);return}let i=(await t.text()).split(`
...
If nothing new found, return [].`;try{let t=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":n,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:o}]})});if(!t.ok)throw Error(`API error ${t.status}`);let i=(await t.json()).content[0].text.trim().match(/\[[\s\S]*\]/);if(!i)throw Error(`No JSON found in response`);ct=JSON.parse(i[0]).map((e,t)=>({...e,_key:`import_${Date.now()}_${t}`})),lt=new Set,r&&(r.style.display=`none`),e.target.value=``,renderSubscriptions()}catch(e){r&&(r.textContent=`⚠ ${e.message}`,r.style.display=``)}}function gt(e,t){let n=ct.find(t=>t._key===e);if(n){if(t===`subscription`)g.subscriptions||(g.subscriptions=[]),g.subscriptions.push({id:uid(),name:n.name,amount:n.amount,category:n.category,frequency:n.frequency}),window.saveData(g);else{let e=window.ensureMonthOverride(window.selectedBudgetMonth);e.expenses.push({id:P(e.expenses),name:n.name,amount:n.amount,frequency:`monthly`,category:`Subscriptions`,recurring:!0}),window.saveData(g)}lt.add(e),renderSubscriptions()}}function _t(e){lt.add(e),renderSubscriptions()}var vt=[{label:`Mortgage / Rent`,icon:`🏠`},{label:`Electricity`,icon:`⚡`},{label:`Gas`,icon:`🔥`},{label:`Water`,icon:`💧`},{label:`Internet`,icon:`📡`},{label:`Phone`,icon:`📱`},{label:`Insurance`,icon:`🛡️`},{label:`Car Registration`,icon:`🚗`},{label:`Rates & Taxes`,icon:`🏛️`},{label:`Loan Repayment`,icon:`💳`},{label:`Education`,icon:`📚`},{label:`Subscriptions`,icon:`📺`},{label:`Health`,icon:`🏥`},{label:`Other`,icon:`📦`}],yt=[`Monthly`,`Fortnightly`,`Weekly`,`Quarterly`,`Annually`];function bt(e){let t=vt.find(t=>t.label===e);return t?t.icon:`📦`}function xt(e){if(e<0)return`<span class="bill-due-badge overdue">Overdue ${Math.abs(e)}d</span>`;if(e===0)return`<span class="bill-due-badge today">Due today</span>`;if(e<=7)return`<span class="bill-due-badge soon">Due in ${e}d</span>`;let t=new Date;return t.setDate(t.getDate()+e),`<span class="bill-due-badge ok">${t.toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}</span>`}function St(e){return(parseFloat(e.amount)||0)*({Weekly:52/12,Fortnightly:26/12,Monthly:1,Quarterly:1/3,Annually:1/12}[e.frequency||`Monthly`]||1)}function Ct(){let e=document.getElementById(`bills-content`);if(!e)return;let r=g.bills||[],i=g.subscriptions||[],a=window._billsSubsFilter,o=`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>`,s=`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4h6v2"/></svg>`,c=r.reduce((e,t)=>e+St(t),0)+i.reduce((e,t)=>e+subMonthlyAmount(t),0),l=r.filter(e=>n(e)<0).length,u=r.filter(e=>{let t=n(e);return t>=0&&t<=7}).length,d=new Date;d.setHours(0,0,0,0);let f=[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`],p=Array.from({length:14},(e,n)=>{let i=new Date(d);i.setDate(i.getDate()+n);let a=r.filter(e=>t(e).toDateString()===i.toDateString()),o=[i.toDateString()===d.toDateString()&&`today`,a.length&&`has-bill`].filter(Boolean).join(` `);return`<div class="bills-day" title="${a.map(e=>e.name).join(`, `)}">
      ...
      <div class="bill-icon">${bt(e.category)}</div>
      <div class="bill-info">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
            <div>
              ...
              <select id="sub-cat" class="form-select" style="width:100%">
                ${at.map(e=>`<option value="${e.label}">${e.icon} ${e.label}</option>`).join(``)}
              </select>
            </div>
            <div>
    ...
    </div>`}function wt(e){window._billsSubsFilter=e,Ct()}function Tt(){Ct()}function Et(e){let t=e?(g.bills||[]).find(t=>t.id===e):null,n=vt.map(e=>`<option value="${e.label}" ${t&&t.category===e.label?`selected`:``}>${e.icon} ${e.label}</option>`).join(``),r=yt.map(e=>`<option value="${e}" ${t&&t.frequency===e||(!t||!t.frequency)&&e===`Monthly`?`selected`:``}>${e}</option>`).join(``),i=`width:100%;border:1px solid var(--border);border-radius:8px;padding:9px 12px;font-size:14px;outline:none`,a=`font-size:12px;font-weight:600;color:#64748b;display:block;margin-bottom:5px`;return`
    ...
    </div>`}function Dt(e){let t=e?(g.bills||[]).find(t=>t.id===e):null;Ct();let n=document.getElementById(`bill-modal`);n&&(document.getElementById(`bill-modal-title`).textContent=t?`Edit Bill`:`Add Bill`,document.getElementById(`bill-edit-id`).value=e||``,t&&(document.getElementById(`bill-name`).value=t.name||``,document.getElementById(`bill-cat`).value=t.category||vt[0].label,document.getElementById(`bill-freq`).value=t.frequency||`Monthly`,document.getElementById(`bill-amount`).value=t.amount||``,document.getElementById(`bill-day`).value=t.dueDay||``,document.getElementById(`bill-start`).value=t.startDate||``,document.getElementById(`bill-autopay`).checked=!!t.autopay),kt(),n.style.display=`flex`)}function Ot(){let e=document.getElementById(`bill-modal`);e&&(e.style.display=`none`)}function kt(){let e=document.getElementById(`bill-freq`)?.value,t=document.getElementById(`bill-day-wrap`),n=document.getElementById(`bill-start-wrap`);if(!t||!n)return;let r=e===`Monthly`;t.style.display=r?`block`:`none`,n.style.display=r?`none`:`block`}function At(){let e=document.getElementById(`bill-name`).value.trim(),t=parseFloat(document.getElementById(`bill-amount`).value),n=document.getElementById(`bill-cat`).value,r=document.getElementById(`bill-freq`).value,i=parseInt(document.getElementById(`bill-day`).value)||null,a=document.getElementById(`bill-start`).value||null,o=document.getElementById(`bill-autopay`).checked,s=document.getElementById(`bill-edit-id`).value;if(!e||isNaN(t))return;let c={name:e,amount:t,category:n,frequency:r,autopay:o};if(r===`Monthly`?c.dueDay=i:c.startDate=a,g.bills||(g.bills=[]),s){let e=g.bills.findIndex(e=>e.id===s);e!==-1&&(g.bills[e]={...g.bills[e],...c})}else g.bills.push({id:uid(),...c});window.saveData(g),Ot(),Ct()}function jt(e){g.bills=(g.bills||[]).filter(t=>t.id!==e),window.saveData(g),Ct()}function Mt(e){let t=(g.bills||[]).find(t=>t.id===e);t&&(t.lastPaid=new Date().toISOString().slice(0,10),window.saveData(g),Ct())}function Nt(e,t){if(!e)return!0;let{type:n,days:r,intervalDays:i,startDate:a,endDate:o}=e;if(a&&t<a||o&&t>o)return!1;let s=new Date(t+`T12:00:00`),c=s.getDay();switch(n){case`daily`:return!0;case`weekdays`:return c>=1&&c<=5;case`weekends`:return c===0||c===6;case`specific_days`:return Array.isArray(r)&&r.includes(String(c));case`interval`:{if(!a||!i)return!1;let e=new Date(a+`T12:00:00`),t=Math.round((s-e)/864e5);return t>=0&&t%i===0}case`one_time`:return t===a;default:return!0}}var I={work:{label:`Work`,emoji:`💼`,color:`#dbeafe`,text:`#1e40af`,financial:!1},study:{label:`Study`,emoji:`📚`,color:`#fef3c7`,text:`#92400e`,financial:!1},social:{label:`Social`,emoji:`🎉`,color:`#ede9fe`,text:`#5b21b6`,financial:!0},family:{label:`Family`,emoji:`👨‍👩‍👧`,color:`#fce7f3`,text:`#9d174d`,financial:!1},travel:{label:`Travel`,emoji:`✈️`,color:`#e0f2fe`,text:`#075985`,financial:!0},health:{label:`Health`,emoji:`🏥`,color:`#fef2f2`,text:`#991b1b`,financial:!0},finance:{label:`Finance`,emoji:`💰`,color:`#ecfeff`,text:`#155e75`,financial:!0},home:{label:`Home`,emoji:`🏠`,color:`#ecfeff`,text:`#166534`,financial:!0},school:{label:`School`,emoji:`🏫`,color:`#fff7ed`,text:`#9a3412`,financial:!0},other:{label:`Other`,emoji:`📦`,color:`#f1f5f9`,text:`#475569`,financial:!1}},Pt=new Date().toISOString().slice(0,7),Ft=new Date().toISOString().slice(0,10),It=new Set,Lt=`week`,Rt=new Set,zt={"life-areas":!1,nudge:!1},Bt=!1,Vt=null;Object.defineProperty(window,`_plannerMonth`,{get(){return Pt},set(e){Pt=e},configurable:!0}),Object.defineProperty(window,`_plannerSelectedDay`,{get(){return Ft},set(e){Ft=e},configurable:!0}),Object.defineProperty(window,`_plannerView`,{get(){return Lt},set(e){Lt=e},configurable:!0}),Object.defineProperty(window,`_plannerDetailEvId`,{get(){return Vt},set(e){Vt=e},configurable:!0}),Object.defineProperty(window,`_typeADimsExpanded`,{get(){return Bt},set(e){Bt=e},configurable:!0}),window._plannerExpanded=It,window._plannerFilterMembers=Rt,window._plannerCollapseState=zt;var Ht=[{dot:`#2563eb`,bg:`#dbeafe`,text:`#1e40af`},{dot:`#db2777`,bg:`#fce7f3`,text:`#9d174d`},{dot:`#d97706`,bg:`#fef3c7`,text:`#92400e`},{dot:`#7c3aed`,bg:`#ede9fe`,text:`#5b21b6`},{dot:`#16a34a`,bg:`#dcfce7`,text:`#166534`},{dot:`#0891b2`,bg:`#ecfeff`,text:`#155e75`},{dot:`#ea580c`,bg:`#ffedd5`,text:`#9a3412`},{dot:`#be185d`,bg:`#fdf2f8`,text:`#831843`}];function Ut(){let e=g.householdProfile?.members||[],t=g.kids?.profiles||[],n=[],r=0;return e.forEach((e,t)=>{let i=Ht[r%Ht.length];e.role===`adult`&&e.name&&(n.push({id:`adult-`+t,name:e.name,emoji:e.emoji||`🧑`,...i}),r++)}),t.forEach((e,t)=>{let i=Ht[r%Ht.length];n.push({id:e.id||`kid-`+t,name:e.name,emoji:e.emoji||`🧒`,...i}),r++}),n.length===0&&n.push({id:`adult-0`,name:`Everyone`,emoji:`👨‍👩‍👧`,...Ht[0]}),n}function Wt(e){return!e||e===`everyone`?{id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`}:Ut().find(t=>t.id===e)||{id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`}}function Gt(e){return Array.isArray(e.memberIds)?e.memberIds:e.memberId?[e.memberId]:[`everyone`]}function Kt(e){return Wt(Gt(e).find(e=>e!==`everyone`)||`everyone`)}function qt(e){let t=Gt(e);return t.includes(`everyone`)||t.length===0?`Everyone`:t.map(e=>Wt(e).name).join(`, `)}function Jt(e){if(e.recurrence&&e.recurrence.type&&e.recurrence.type!==`one_time`){let t={daily:`Every day`,weekdays:`Mon–Fri`,weekends:`Sat & Sun`};if(t[e.recurrence.type])return t[e.recurrence.type];if(e.recurrence.type===`specific_days`)return(e.recurrence.days||[]).map(e=>[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`][e]).join(`, `)||`Specific days`;if(e.recurrence.type===`interval`)return`Every ${e.recurrence.intervalDays} days`}return e.recurring&&e.recurring!==`none`?{weekly:`Every week`,fortnightly:`Every 2 weeks`,monthly:`Every month`,quarterly:`Every 3 months`,yearly:`Annually`}[e.recurring]||e.recurring:``}function Yt(){let e=g.planner?.events||[];return Rt.size===0?e:e.filter(e=>{let t=Gt(e);return t.includes(`everyone`)?!0:[...Rt].some(e=>t.includes(e))})}function Xt(e){return Yt().filter(t=>t._recurringSourceId?t.date===e:t.recurrence&&t.recurrence.type!==`one_time`?Nt(t.recurrence,e):t.endDate&&t.endDate>t.date?e>=t.date&&e<=t.endDate:t.date===e)}function Zt(e){if(!e)return``;let[t,n]=e.split(`:`).map(Number);return`${t%12||12}:${String(n).padStart(2,`0`)}${t>=12?`pm`:`am`}`}var Qt=new Date().toISOString().slice(0,7);function $t(){let[e,t]=Qt.split(`-`).map(Number),n=new Date(e,t-2,1);Qt=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,renderForecast()}function en(){let[e,t]=Qt.split(`-`).map(Number),n=new Date(e,t,1);Qt=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,renderForecast()}function tn(){let e=document.getElementById(`forecast-content`);if(!e)return;let t=(g.planner?.events||[]).filter(e=>e.date&&e.date.startsWith(Qt)),n=window.getMonthData(Qt),r=N(n.income)-N(n.expenses),[i,a]=Qt.split(`-`).map(Number),o=new Date(i,a,0).getDate(),s=[],c=1;for(;c<=o;){new Date(i,a-1,c);let e=c;for(;e<o&&new Date(i,a-1,e+1).getDay()!==1;)e++;s.push({start:c,end:e,events:[]}),c=e+1}t.sort((e,t)=>e.date.localeCompare(t.date)).forEach(e=>{let t=parseInt(e.date.split(`-`)[2]),n=s.find(e=>t>=e.start&&t<=e.end);n&&n.events.push(e)}),t.filter(e=>e.estimates&&e.estimates.length>0);let l=t.filter(e=>!e.estimates||e.estimates.length===0),u=t.reduce((e,t)=>e+(t.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0),0),d=r-u,f=new Date(i,a-1).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`}),p=!!F(`toto_ai_key`),m=`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;flex-wrap:wrap;gap:12px">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:12px;margin-bottom:24px">
      ...
      </div>`),e.innerHTML=m}async function nn(){let e=F(`toto_ai_key`);if(!e)return;let t=(g.planner?.events||[]).filter(e=>e.date&&e.date.startsWith(Qt)&&(!e.estimates||e.estimates.length===0));if(!t.length)return;let n=document.getElementById(`estimate-all-btn`);n&&(n.textContent=`⏳ Estimating…`,n.disabled=!0);let r=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`).length||2,i=(g.householdProfile?.members||[]).filter(e=>e.role===`child`).length||0,a=t.map(e=>({id:e.id,title:e.title,category:(I[e.category]||I.other).label,date:e.date,notes:e.notes||``})),o=`You are a family finance assistant for an Australian family (${r} adult${r>1?`s`:``}, ${i} child${i===1?``:`ren`}).
...
- No markdown, no code fences, just raw JSON`;try{let t=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":e,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:4096,messages:[{role:`user`,content:o}]})});if(!t.ok)throw Error(`API ${t.status}`);let n=(await t.json()).content[0].text.replace(/```[\w]*\n?/g,``).trim().match(/\[[\s\S]*\]/);if(!n)throw Error(`No JSON`);JSON.parse(n[0]).forEach(e=>{let t=(g.planner?.events||[]).find(t=>t.id===e.id);t&&e.items&&(t.estimates=e.items.map((e,t)=>({id:`est-${Date.now()}-${t}`,name:e.name,amount:Number(e.amount)||0,category:e.category||`Other`,accepted:!0})))}),window.saveData(g),tn()}catch(e){n&&(n.textContent=`Estimate all (${t.length} events)`,n.disabled=!1),console.error(`Batch estimate error:`,e)}}function L(){let e=document.getElementById(`planner-content`);if(!e)return;g.planner||(g.planner={events:[]});let t=new Date().toISOString().slice(0,10),n=Ut(),r={id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`},i=[...n,r],a=i.map(e=>e.name[0].toUpperCase()),o=i.map((e,t)=>{if(e.id===`everyone`)return`👨‍👩‍👧`;let n=e.name[0].toUpperCase();return a.filter(e=>e===n).length>1?(e.name[0]+(e.name[1]||``)).toUpperCase():n}),s=i.map((e,t)=>{let n=e.id===`everyone`,r=n?window._plannerFilterMembers.size===0:window._plannerFilterMembers.has(e.id),i=!r&&window._plannerFilterMembers.size>0&&!n,a=n?`<span style="font-size:14px">👨‍👩‍👧</span>`:`<span>${o[t]}</span>`;return`<div class="pl-legend-chip ${r?`active`:``} ${i?`dimmed`:``}"
      onclick="_plannerToggleFilter('${e.id}')">
      <div class="pl-chip-avatar" style="background:${e.bg};color:${e.text}">${a}</div>
      <span>${e.name}</span>
    </div>`}).join(``),c=``;c=_plannerView===`month`?rn():an();let l=new Date;l.setDate(l.getDate()+30);let u=l.toISOString().slice(0,10),d=Yt().filter(e=>e.date>=t&&e.date<=u),f=0,p=Object.entries(I).map(([e,t])=>{let n=d.filter(t=>t.category===e);n.length&&(f+=n.length);let r=n[0],i=r?T(r.title)+(r.date?` · ${new Date(r.date+`T12:00:00`).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}`:``):`Nothing planned`;return`<div class="pl-life-tile" onclick="_plannerOpenLifeSheet('${e}')">
    ...
    </div>`}).join(``),m=Nn(),h=m.map(e=>{let t=e.days<0?`Now!`:e.days===0?`Today!`:e.days===1?`Tomorrow`:`In ${e.days} days`,n=e.days<=0?`var(--alert)`:e.days===1?`var(--good)`:e.days<=3?`var(--watch)`:`var(--iris-1)`;return`<div class="pl-nudge-tile">
    ...
    ${l}
  </div>`}function sn(){let[e,t]=_plannerMonth.split(`-`).map(Number),n=t===1?e-1:e,r=t===1?12:t-1;_plannerMonth=`${n}-${String(r).padStart(2,`0`)}`,_plannerSelectedDay=`${n}-${String(r).padStart(2,`0`)}-01`,L()}function cn(){let[e,t]=_plannerMonth.split(`-`).map(Number),n=t===12?e+1:e,r=t===12?1:t+1;_plannerMonth=`${n}-${String(r).padStart(2,`0`)}`,_plannerSelectedDay=`${n}-${String(r).padStart(2,`0`)}-01`,L()}function ln(e){_plannerSelectedDay=e,_plannerMonth=e.slice(0,7),L()}function un(e){let t=new Date(e+`T12:00:00`),n=e===new Date().toISOString().slice(0,10)?`Today`:t.toLocaleDateString(`en-AU`,{weekday:`long`}),r=t.toLocaleDateString(`en-AU`,{day:`numeric`,month:`long`,year:`numeric`}),i=Xt(e).sort((e,t)=>e.allDay&&!t.allDay?-1:!e.allDay&&t.allDay?1:(e.time||`99:99`).localeCompare(t.time||`99:99`)),a=``;return a=i.length===0?`<div class="pl-agenda-empty">Nothing planned — enjoy the quiet ☀️<br><span style="color:var(--iris-1);cursor:pointer;font-weight:600;font-size:13px" onclick="openPlannerModal(null,'${e}')">+ Add an event</span></div>`:`<div class="pl-agenda-list">${i.map(t=>{let n=Kt(t),r=I[t.category]||I.other,i=t.allDay||!t.time?`All day`:Zt(t.time),a=qt(t),o=new Date().getHours()*60+new Date().getMinutes(),s=t.time?parseInt(t.time.split(`:`)[0])*60+parseInt(t.time.split(`:`)[1]):-1,c=e===new Date().toISOString().slice(0,10)&&s>=0&&o>=s&&o<s+90,l=r.color||`#f1f5f9`,u=r.text||`#475569`;return`<div class="pl-agenda-ev">
    ...
    <div style="padding:${i.length?`12px 16px`:`0`}">${a}</div>
  </div>`}function dn(e){_plannerMonth=e.slice(0,7),_plannerSelectedDay=e,activateTab(`planner`)}function fn(){let e=new Date().toISOString().slice(0,10);_plannerMonth=e.slice(0,7),_plannerSelectedDay=e,L()}function pn(e){_plannerView=e,_plannerCollapseState[`life-areas`]=e===`week`,_plannerCollapseState.nudge=e===`week`,L()}function mn(e){_plannerCollapseState[e]=!_plannerCollapseState[e],L()}function hn(e){e===`everyone`?window._plannerFilterMembers.clear():window._plannerFilterMembers.has(e)?window._plannerFilterMembers.delete(e):window._plannerFilterMembers.add(e),L()}function gn(e){let t=document.getElementById(`pl-day-sheet-overlay`);if(!t)return;let n=new Date(e+`T12:00:00`),r=new Date().toISOString().slice(0,10);document.getElementById(`pl-sheet-title`).textContent=e===r?`Today`:n.toLocaleDateString(`en-AU`,{weekday:`long`}),document.getElementById(`pl-sheet-date`).textContent=n.toLocaleDateString(`en-AU`,{day:`numeric`,month:`long`,year:`numeric`}),document.getElementById(`pl-sheet-add-btn`).dataset.date=e,_n(e),t.classList.add(`open`)}function _n(e){let t=Xt(e).sort((e,t)=>(e.time||`99:99`).localeCompare(t.time||`99:99`)),n=document.getElementById(`pl-sheet-list`);if(n){if(t.length===0){n.innerHTML=`<div class="pl-sheet-empty">Nothing planned. <span style="color:var(--primary);cursor:pointer;font-weight:600" onclick="_plannerOpenModalFromSheet()">Add an event →</span></div>`;return}n.innerHTML=t.map((e,t)=>{let n=Kt(e),r=I[e.category]||I.other,i=qt(e),a=e.allDay||!e.time?`All day`:Zt(e.time);return`<div class="pl-sheet-ev" onclick="_plannerOpenDetail('${e.id}')">
      ...
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#D4D4D8" stroke-width="2" stroke-linecap="round"><polyline points="9 18 15 12 9 6"/></svg>
    </div>`}).join(``)}}function vn(){let e=document.getElementById(`pl-day-sheet-overlay`);e&&e.classList.remove(`open`)}function yn(e){e.target===document.getElementById(`pl-day-sheet-overlay`)&&vn()}function bn(){let e=document.getElementById(`pl-sheet-add-btn`)?.dataset?.date||_plannerSelectedDay;vn(),Kn(null,e)}function xn(e){let t=I[e];if(!t)return;let n=new Date().toISOString().slice(0,10),r=(g.planner?.events||[]).filter(t=>t.category===e&&t.date>=n).sort((e,t)=>e.date.localeCompare(t.date));document.getElementById(`pl-life-sheet-icon`).textContent=t.emoji,document.getElementById(`pl-life-sheet-title`).textContent=t.label,document.getElementById(`pl-life-sheet-count`).textContent=r.length+` upcoming`;let i=``;if(r.length===0)i=`<div class="pl-sheet-empty">No upcoming ${t.label.toLowerCase()} events.</div>`;else{let e=``;r.forEach(t=>{let n=t.date.slice(0,7);if(n!==e){let r=new Date(t.date+`T12:00:00`);i+=`<div class="pl-life-day-hdr">${r.toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`})}</div>`,e=n}let r=Kt(t),a=qt(t),o=new Date(t.date+`T12:00:00`);i+=`<div class="pl-life-ev-row" onclick="_plannerCloseLifeSheet();_plannerOpenDetail('${t.id}')">
        ...
        <div class="pl-life-ev-content">
          ...
          <div class="pl-life-ev-meta">${a}${t.time?` · `+Zt(t.time):``}</div>
        </div>
      </div>`})}document.getElementById(`pl-life-sheet-list`).innerHTML=i,document.getElementById(`pl-life-overlay`).classList.add(`open`)}function Sn(){document.getElementById(`pl-life-overlay`)?.classList.remove(`open`)}function Cn(e){e.target===document.getElementById(`pl-life-overlay`)&&Sn()}function wn(e){let t=(g.planner?.events||[]).find(t=>t.id===e);if(!t)return;_plannerDetailEvId=e;let n=Kt(t),r=I[t.category]||I.other,i=Gt(t);document.getElementById(`pl-detail-title`).textContent=t.title,document.getElementById(`pl-detail-color-bar`).style.background=n.dot;let a=new Date(t.date+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`,year:`numeric`}),o=t.allDay?`All day`:t.time?Zt(t.time):``;!t.allDay&&t.endTime&&(o+=` – `+Zt(t.endTime));let s=(i.includes(`everyone`)?[{id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`}]:i.map(e=>Wt(e))).map(e=>`<span style="display:inline-flex;align-items:center;gap:5px;background:${e.bg};color:${e.text};padding:4px 10px;border-radius:99px;font-size:12px;font-weight:600">${e.emoji} ${e.name}</span>`).join(` `),c=(t.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0),l=[{icon:`📅`,label:`Date`,value:a},o?{icon:`🕐`,label:`Time`,value:o}:null,t.location?{icon:`📍`,label:`Address`,value:T(t.location)}:null,{icon:`👥`,label:`Who`,value:`<div style="display:flex;flex-wrap:wrap;gap:6px;margin-top:4px">${s}</div>`},{icon:r.emoji,label:`Category`,value:r.label},Jt(t)?{icon:`🔄`,label:`Repeats`,value:Jt(t)}:null,c>0?{icon:`💰`,label:`Est. cost`,value:`$${c.toLocaleString(`en-AU`)}`}:null,t.notes?{icon:`📝`,label:`Notes`,value:T(t.notes)}:null].filter(Boolean);document.getElementById(`pl-detail-body`).innerHTML=l.map(e=>`<div class="pl-detail-row">
      <div class="pl-detail-icon">${e.icon}</div>
      <div style="flex:1;min-width:0">
        <div class="pl-detail-row-label">${e.label}</div>
        <div class="pl-detail-row-value">${e.value}</div>
      </div>
    </div>`).join(``)+(r.financial?`<button class="planner-ai-btn" style="width:100%;justify-content:center;margin-top:16px" onclick="_plannerCloseDetail();estimatePlannerEvent('${e}')">✦ Estimate costs with AI</button>`:``)+`<button class="pl-detail-share-btn" onclick="_plannerOpenShare('${e}')">🔗 Share this event</button>`,document.getElementById(`pl-detail-overlay`).classList.add(`open`)}function Tn(){document.getElementById(`pl-detail-overlay`)?.classList.remove(`open`),_plannerDetailEvId=null}function En(e){e.target===document.getElementById(`pl-detail-overlay`)&&Tn()}function Dn(){let e=_plannerDetailEvId;Tn(),e&&Kn(e)}function On(e){let t=(g.planner?.events||[]).find(t=>t.id===e);if(!t)return;let n=`https://toto.app/event/${t.title.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/(^-|-$)/g,``)}-${Math.random().toString(36).slice(2,10)}`,r=document.getElementById(`pl-share-sub`),i=document.getElementById(`pl-share-url`),a=document.getElementById(`pl-share-copy-btn`);r&&(r.textContent=t.title),i&&(i.textContent=n),a&&(a.textContent=`Copy`,a.classList.remove(`copied`)),document.getElementById(`pl-share-overlay`)?.classList.add(`open`)}function kn(){document.getElementById(`pl-share-overlay`)?.classList.remove(`open`)}function An(e){e.target===document.getElementById(`pl-share-overlay`)&&kn()}function jn(){let e=document.getElementById(`pl-share-url`)?.textContent;e&&navigator.clipboard?.writeText(e).catch(()=>{});let t=document.getElementById(`pl-share-copy-btn`);t&&(t.textContent=`Copied!`,t.classList.add(`copied`),setTimeout(()=>{t.textContent=`Copy`,t.classList.remove(`copied`)},2e3))}function Mn(e){let t=document.getElementById(`pl-share-url`)?.textContent||``,n=(g.planner?.events||[]).find(e=>e.id===_plannerDetailEvId),r=n?`${n.title} — ${t}`:t;e===`sms`&&window.open(`sms:?body=${encodeURIComponent(r)}`),e===`whatsapp`&&window.open(`https://wa.me/?text=${encodeURIComponent(r)}`),e===`email`&&window.open(`mailto:?subject=${encodeURIComponent(n?.title||`Event`)}&body=${encodeURIComponent(r)}`)}function Nn(){function e(e){return Math.ceil((e-new Date().setHours(0,0,0,0))/864e5)}function t(e,t,n,r){let i=new Date(e,t,1);for(;i.getDay()!==n;)i.setDate(i.getDate()+1);return i.setDate(i.getDate()+(r-1)*7),i}let n=new Date().getFullYear();return[{emoji:`🧾`,title:`EOFY`,days:e(new Date(n,5,30)),body:`Tax time — accountant fees, donations, prepayments`},{emoji:`🎄`,title:`Christmas`,days:e(new Date(n,11,25)),body:`Gifts, travel, food — start budgeting early`},{emoji:`💐`,title:`Mother's Day`,days:e(t(n,4,0,2)),body:`Gift, brunch or dinner for Mum`},{emoji:`👔`,title:`Father's Day`,days:e(t(n,8,0,1)),body:`Gift or outing for Dad`}].filter(e=>e.days>=-3&&e.days<=60).sort((e,t)=>e.days-t.days)}function Pn(e){_plannerExpanded.has(e)?_plannerExpanded.delete(e):_plannerExpanded.add(e),L()}function Fn(e,t){let n=(g.planner?.events||[]).find(t=>t.id===e);if(!n)return;let r=(n.estimates||[]).find(e=>e.id===t);r&&(r.accepted=!r.accepted,window.saveData(g),L())}function In(e){let t=(g.planner?.events||[]).find(t=>t.id===e);if(!t)return;let n=(t.estimates||[]).filter(e=>e.accepted);if(!n.length)return;let r=t.date.slice(0,7);g.budget.suggestions||(g.budget.suggestions=[]),g.budget.suggestions=g.budget.suggestions.filter(e=>e.eventId!==t.id),n.forEach(e=>{g.budget.suggestions.push({id:`sug-`+Date.now()+`-`+Math.random().toString(36).slice(2,5),month:r,eventId:t.id,eventTitle:t.title,estId:e.id,name:e.name,amount:e.amount,category:e.category,status:`pending`})}),t.pushed=`suggested`,window.saveData(g),_plannerExpanded.add(e),L();let i=new Date(r+`-15`).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`});r===window.selectedBudgetMonth?window.safeRender(renderBudget):confirm(`${n.length} suggestion${n.length>1?`s`:``} sent to ${i} budget.\n\nGo to Monthly Budget to approve them?`)&&(window.selectedBudgetMonth=r,activateTab(`budget`))}function Ln(e){let t=(g.budget.suggestions||[]).find(t=>t.id===e);if(!t)return;let n=window.ensureMonthOverride(t.month);n.expenses.push({id:P(n.expenses),name:`${t.name} (${t.eventTitle})`,amount:t.amount,frequency:`monthly`,category:t.category,recurring:!1,_plannerEventId:t.eventId}),t.status=`approved`;let r=(g.planner?.events||[]).find(e=>e.id===t.eventId);r&&(g.budget.suggestions||[]).filter(e=>e.eventId===r.id&&e.status===`pending`).length===0&&(r.pushed=!0),window.saveData(g),window.safeRender(renderBudget),window.safeRender(L)}function Rn(e){let t=(g.budget.suggestions||[]).find(t=>t.id===e);if(!t)return;t.status=`dismissed`;let n=(g.planner?.events||[]).find(e=>e.id===t.eventId);n&&(g.budget.suggestions||[]).filter(e=>e.eventId===n.id&&e.status===`pending`).length===0&&(n.pushed=n.pushed===`suggested`?!1:n.pushed),window.saveData(g),window.safeRender(renderBudget)}function zn(e){let t=(g.budget?.suggestions||[]).filter(t=>t.month===e&&t.status===`pending`);if(!t.length)return``;let n={};t.forEach(e=>{n[e.eventTitle]||(n[e.eventTitle]=[]),n[e.eventTitle].push(e)});let r=t.map(e=>`
    ...
    ${r}
  </div>`}function Bn(e){let t=(g.planner?.events||[]).find(t=>t.id===e);t&&(Object.values(g.budget.months||{}).forEach(t=>{t.expenses=(t.expenses||[]).filter(t=>t._plannerEventId!==e)}),g.budget.expenses=(g.budget.expenses||[]).filter(t=>t._plannerEventId!==e),g.budget.suggestions=(g.budget.suggestions||[]).filter(t=>t.eventId!==e),t.pushed=!1,window.saveData(g),L(),window.safeRender(renderBudget))}function Vn(e){confirm(`Delete this event and remove it from the budget?`)&&(Bn(e),g.planner.events=g.planner.events.filter(t=>t.id!==e),_plannerExpanded.delete(e),window.saveData(g),window.closeModal(),L())}async function Hn(e){let t=F(`toto_ai_key`);if(!t){alert(`Add your AI API key in Settings to use cost estimation.`);return}let n=(g.planner?.events||[]).find(t=>t.id===e);if(!n)return;let r=document.getElementById(`ai-btn-${e}`);r&&(r.disabled=!0,r.textContent=`✦ Estimating…`);let i=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`).length||2,a=(g.householdProfile?.members||[]).filter(e=>e.role===`child`).length||0,o=new Date(n.date+`T12:00:00`).toLocaleDateString(`en-AU`,{day:`numeric`,month:`long`,year:`numeric`}),s=`You are a family finance assistant for an Australian family. Suggest realistic cost estimates for the following life event.
...
- Keep responses to 3-5 sentences unless a list is genuinely helpful`}function Dr(e,t){let n=document.getElementById(`toto-messages`),r=document.createElement(`div`);r.className=`toto-msg ${e}`;let i=t.replace(/\n/g,`<br>`);e===`toto`?r.innerHTML=`<div class="toto-msg-avatar">🐕</div><div class="toto-msg-bubble">${i}</div>`:r.innerHTML=`<div class="toto-msg-bubble">${i}</div>`,n.appendChild(r),n.scrollTop=n.scrollHeight}function Or(){let e=document.getElementById(`toto-messages`),t=`toto-typing-`+Date.now(),n=document.createElement(`div`);return n.className=`toto-msg toto`,n.id=t,n.innerHTML=`<div class="toto-msg-avatar">🐕</div><div class="toto-msg-bubble"><div class="toto-typing"><span></span><span></span><span></span></div></div>`,e.appendChild(n),e.scrollTop=e.scrollHeight,t}function kr(e){document.getElementById(e)?.remove()}`serviceWorker`in navigator&&navigator.serviceWorker.register(`/home-budget/sw.js`,{scope:`/home-budget/`}).catch(e=>console.warn(`SW registration failed:`,e));var Ar=[`Produce`,`Meat & Seafood`,`Dairy & Eggs`,`Pantry`,`Bakery`,`Frozen`,`Household`,`Other`],jr={Produce:`🥦`,"Meat & Seafood":`🥩`,"Dairy & Eggs":`🥛`,Pantry:`🥫`,Bakery:`🍞`,Frozen:`🧊`,Household:`🏠`,Other:`🛒`},Mr={food:{label:`Food`,emoji:`🛒`,color:`#dcfce7`,text:`#166534`,aisles:!0,priceEst:!0},clothes:{label:`Clothes`,emoji:`👕`,color:`#dbeafe`,text:`#1e40af`,aisles:!1,priceEst:!1},wishlist:{label:`Wishlist`,emoji:`🎁`,color:`#fce7f3`,text:`#9d174d`,aisles:!1,priceEst:!1},home:{label:`Home & Garden`,emoji:`🛠`,color:`#fef3c7`,text:`#92400e`,aisles:!0,priceEst:!1},pharmacy:{label:`Pharmacy`,emoji:`💊`,color:`#ede9fe`,text:`#5b21b6`,aisles:!0,priceEst:!1}},Nr={food:[{key:`produce`,emoji:`🥦`,label:`Produce`},{key:`dairy`,emoji:`🥛`,label:`Dairy & Eggs`},{key:`bakery`,emoji:`🍞`,label:`Bakery`},{key:`meat`,emoji:`🥩`,label:`Meat & Seafood`},{key:`pantry`,emoji:`🥫`,label:`Pantry`},{key:`frozen`,emoji:`🧊`,label:`Frozen`},{key:`health`,emoji:`🧴`,label:`Health & Beauty`},{key:`bathroom`,emoji:`🚿`,label:`Bathroom`},{key:`cleaning`,emoji:`🧹`,label:`Cleaning`},{key:`drinks`,emoji:`🍷`,label:`Drinks & Alcohol`},{key:`other`,emoji:`🛒`,label:`Uncategorised`}],home:[{key:`tools`,emoji:`🔨`,label:`Tools & Hardware`},{key:`garden`,emoji:`🌱`,label:`Garden`},{key:`cleaning`,emoji:`🧹`,label:`Cleaning`},{key:`other`,emoji:`🛒`,label:`Other`}],pharmacy:[{key:`medicine`,emoji:`💊`,label:`Medicine`},{key:`skincare`,emoji:`🧴`,label:`Skincare`},{key:`vitamins`,emoji:`💪`,label:`Vitamins`},{key:`other`,emoji:`🛒`,label:`Other`}]},Pr={milk:`dairy`,cheese:`dairy`,butter:`dairy`,eggs:`dairy`,yoghurt:`dairy`,cream:`dairy`,bread:`bakery`,rolls:`bakery`,muffin:`bakery`,croissant:`bakery`,baguette:`bakery`,apple:`produce`,banana:`produce`,orange:`produce`,strawberry:`produce`,tomato:`produce`,lettuce:`produce`,spinach:`produce`,carrot:`produce`,broccoli:`produce`,potato:`produce`,onion:`produce`,garlic:`produce`,cucumber:`produce`,capsicum:`produce`,avocado:`produce`,lemon:`produce`,lime:`produce`,grapes:`produce`,mango:`produce`,pineapple:`produce`,watermelon:`produce`,chicken:`meat`,beef:`meat`,mince:`meat`,steak:`meat`,pork:`meat`,lamb:`meat`,salmon:`meat`,fish:`meat`,tuna:`meat`,prawn:`meat`,sausage:`meat`,bacon:`meat`,rice:`pantry`,pasta:`pantry`,flour:`pantry`,sugar:`pantry`,oil:`pantry`,vinegar:`pantry`,salt:`pantry`,pepper:`pantry`,sauce:`pantry`,stock:`pantry`,beans:`pantry`,lentils:`pantry`,chickpeas:`pantry`,cereal:`pantry`,oats:`pantry`,honey:`pantry`,jam:`pantry`,peanut:`pantry`,coffee:`pantry`,tea:`pantry`,biscuit:`pantry`,cracker:`pantry`,chocolate:`pantry`,chips:`pantry`,nuts:`pantry`,icecream:`frozen`,peas:`frozen`,corn:`frozen`,pizza:`frozen`,shampoo:`health`,conditioner:`health`,deodorant:`health`,sunscreen:`health`,moisturiser:`health`,makeup:`health`,lipstick:`health`,mascara:`health`,toothpaste:`bathroom`,toothbrush:`bathroom`,soap:`bathroom`,toilet:`bathroom`,razors:`bathroom`,tampons:`bathroom`,pads:`bathroom`,detergent:`cleaning`,bleach:`cleaning`,sponge:`cleaning`,dishwashing:`cleaning`,bins:`cleaning`,mop:`cleaning`,water:`drinks`,juice:`drinks`,beer:`drinks`,wine:`drinks`,spirits:`drinks`,softdrink:`drinks`,soda:`drinks`,kombucha:`drinks`};function Fr(e){for(var t=e.toLowerCase(),n=Object.keys(Pr),r=0;r<n.length;r++)if(t.indexOf(n[r])!==-1)return Pr[n[r]];return`other`}function Ir(e){var t=e.trim(),n=1,r=`units`,i=t,a=t.match(/^(\d+(?:\.\d+)?)\s*(kg|g|L|l|ml|dozen|doz)\s+(.+)$/i);if(a)n=parseFloat(a[1]),r=a[2].toLowerCase()===`l`?`L`:a[2].toLowerCase()===`doz`?`dozen`:a[2],i=a[3];else{var o=t.match(/^(\d+(?:\.\d+)?)\s+(.+)$/);o?(n=parseFloat(o[1]),i=o[2]):/^dozen\s+/i.test(t)&&(n=1,r=`dozen`,i=t.replace(/^dozen\s+/i,``))}return i=i.charAt(0).toUpperCase()+i.slice(1),{qty:n,unit:r,name:i}}var Lr=`food`,Rr=`selector`;Object.defineProperty(window,`_listsActiveType`,{get(){return Lr},set(e){Lr=e},configurable:!0}),Object.defineProperty(window,`_listsView`,{get(){return Rr},set(e){Rr=e},configurable:!0});function zr(e){let t=new Date,n=t.getDay()===0?-6:1-t.getDay(),r=new Date(t);return r.setDate(t.getDate()+n+(e||0)*7),r.toISOString().slice(0,10)}function Br(e){let t=new Date(e+`T00:00:00`);return Array.from({length:7},(e,n)=>{let r=new Date(t);return r.setDate(t.getDate()+n),r})}function Vr(){window._mealView===`shopping`?Qr():Hr()}function Hr(){let e=zr(0),t=Br(e),n=g.meals.plan[e]||{},r=new Date().toISOString().slice(0,10),i=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`,`Sun`],a=[{key:`b`,label:`Breakfast`},{key:`l`,label:`Lunch`},{key:`d`,label:`Dinner`}];t[0].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`}),t[6].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`});let o=[];for(let e=0;e<7;e++){let t=n[e]||{};[`b`,`l`,`d`].forEach(e=>{t[e]&&o.push(t[e])})}let s=``;a.forEach(i=>{s+=`<div class="meal-grid-label">${i.label}</div>`,t.forEach((t,a)=>{let o=(n[a]||{})[i.key]||``,c=t.toISOString().slice(0,10)===r;s+=`<div class="meal-cell${c?` today`:``}" onclick="openMealEdit('${e}',${a},'${i.key}')">
    ...
    <p style="font-size:12px;color:var(--text-muted);margin-top:6px">Tap any cell to add or change a meal.</p>`}var R={cuisine:`Any`,price:0,dietary:`Any`},Ur=[`Any`,`Italian`,`Asian`,`Mexican`,`Indian`,`Mediterranean`,`Thai`,`Japanese`,`Middle Eastern`,`Australian`],Wr=[`Any`,`Vegetarian`,`Vegan`,`Gluten-free`,`Quick (<30min)`,`Family-friendly`];function Gr(e,t,n){let r=[`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`,`Sunday`],i={b:`Breakfast`,l:`Lunch`,d:`Dinner`},a=((g.meals.plan[e]||{})[t]||{})[n]||``,o=!!F(`toto_ai_key`),s=new Set;Object.values(g.meals.plan).forEach(e=>Object.values(e).forEach(e=>{typeof e==`object`&&[`b`,`l`,`d`].forEach(t=>{e[t]&&s.add(e[t])})}));let c=[...s].filter(e=>e!==a).slice(0,16);document.getElementById(`modal-title`).textContent=`${r[t]} · ${i[n]}`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
...
Combine quantities where sensible. No duplicates. No other text.`,o={Produce:`produce`,"Meat & Seafood":`meat`,"Dairy & Eggs":`dairy`,Pantry:`pantry`,Bakery:`bakery`,Frozen:`frozen`,Household:`cleaning`,Other:`other`};try{let e=(await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":r,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:a}]})})).json()).content[0].text.match(/\[[\s\S]*\]/);if(!e)throw Error(`No JSON`);let t=JSON.parse(e[0]);g.lists||(g.lists={}),g.lists.food||(g.lists.food={items:[],weeklyBudget:200,budget:0,stores:[],favourites:[],history:[]});let n=g.lists.food.items,i=0;t.forEach(e=>{n.some(t=>t.name.toLowerCase()===e.name.toLowerCase()&&t.state===`active`)||n.push({id:`si-meal-`+Date.now()+`-`+ i++,name:e.name,quantity:1,unit:`units`,notes:e.qty||``,aisle:o[e.cat]||(Fr?Fr(e.name):`other`),state:`active`,addedBy:`meals`,addedAt:new Date().toISOString(),mealTag:`Meal plan`,manualPrice:null,barcodeId:null})}),window.saveData(g),Lr=`food`,Rr=`list`,activateTab(`lists`)}catch{i&&(i.textContent=`🛒 Generate shopping list`,i.disabled=!1)}}var xi=[`Living Room`,`Dining Room`,`Kitchen`,`Master Bedroom`,`Bedroom 2`,`Bedroom 3`,`Study / Office`,`Bathroom`,`Laundry`,`Outdoor / Alfresco`,`Other`];function Si(e={}){let t=e.deliveryDate?(()=>{let[t,n,r]=e.deliveryDate.split(`-`);return`${r}/${n}/${t}`})():``;return`
    ...
    <div class="section">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${t.length===0?`<tr><td colspan="3" style="text-align:center;color:var(--text-muted);padding:20px">No income added yet</td></tr>`:t.map(e=>{let t=r>0?Math.round(M(e)/r*100):0;return`<tr>
                    ...
                    <td class="amount">${D(M(e))} <span style="color:var(--text-muted);font-size:11px">${t}%</span></td>
                  </tr>`}).join(``)}
          </tbody>
        </table>
      </div>
  ...
  `,f+=`</div>`,d){let e=i-u;f+=`
      <div class="section" style="margin-bottom:20px">
        ...
        <div class="table-wrap">
          <table>
            ...
            <tbody>
              ${n.filter(e=>l[e.id]!==void 0).map(e=>{let t=M(e),n=l[e.id]||0,r=t-n,i=colors.expense[e.category||`Other`]||`#94a3b8`;return`<tr>
    ...
    `}let p=window.getLast6Months().map(e=>{let t=window.getMonthData(e);return{label:window.monthShortLabel(e),income:N(t.income),expenses:N(t.expenses),actual:Object.values(g.budget.actuals[e]||{}).reduce((e,t)=>e+t,0)}}),m=Math.max(...p.flatMap(e=>[e.income,e.expenses,e.actual]),1),h=524/p.length,_=h*.22,v=[0,.25,.5,.75,1].map(e=>{let t=148-e*136;return`<line x1="64" y1="${t}" x2="588" y2="${t}" stroke="#e2e8f0" stroke-width="1"/>
  ...
  `,document.getElementById(`money-content`).innerHTML=f}function Fi(){if(g.setupProgressDismissed)return``;let e=window.setupProgressTasks(),t=e.filter(e=>e.done),n=e.filter(e=>!e.done),r=t.length,i=e.length,a=Math.round(r/i*100);if(r===i)return`<div class="td-card td-card-win" style="display:flex;align-items:center;gap:12px;margin-bottom:10px">
    ...
    <svg class="brief-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
      ...
      <div style="flex:1;min-width:0;background:#F0FDF4;border-radius:var(--r-lg);padding:16px;display:flex;flex-direction:column;justify-content:space-between;min-height:140px;border:1px solid rgba(16,185,129,.18);box-shadow:0 1px 0 rgba(255,255,255,.9) inset">
      ...
      </div>`;u.push({type:`priority`,urgency:d.length>0?3:m?2:0,html:`<div style="display:flex;gap:12px;margin-bottom:12px">${t}${n}</div>`})}let h=o===`evening`||o===`night`?new Date(t.getTime()+864e5).toISOString().slice(0,10):i,_=h===i?`Today`:`Tomorrow`,v=Xt?Xt(h):[];if(v.length>0){let e=t.getHours()*60+t.getMinutes(),n=v.slice(0,4).map((t,n,r)=>{let a=t.allDay||!t.time?`All day`:Zt?Zt(t.time):t.time,o=qt?qt(t):``,s=Kt?Kt(t):{dot:`var(--iris-2)`},c=I?I[t.category]||I.other:{emoji:`📅`,label:``},l=t.time?parseInt(t.time.split(`:`)[0])*60+parseInt(t.time.split(`:`)[1]):-1,u=h===i&&l>=0&&e>=l&&e<l+90,d=n===Math.min(v.length,4)-1,f=c.color||`#f1f5f9`,p=c.text||`#475569`;return p.replace(/^#/,``),`<div class="pl-agenda-ev" style="margin-bottom:${d?`0`:`8px`}">
        <div class="pl-agenda-time-col">
        ...
        <div class="td-card-meta" style="margin-bottom:10px"><span class="td-meta-label">My Routines</span><span class="td-meta-count">${A.length}</span></div>
        ${e}
      </div>`})}let ne=new Date(t.getTime()+7*864e5).toISOString().slice(0,10),re=(g.planner?.events||[]).filter(e=>e.date>i&&e.date<=ne).sort((e,t)=>e.date.localeCompare(t.date)).slice(0,3),ie=(g.bills||[]).map(e=>({...e,days:n(e)})).filter(e=>e.days!==null&&e.days>2&&e.days<=7);if(re.length+ie.length>0){let e=[...re.map(e=>{let t=new Date(e.date+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`short`,day:`numeric`,month:`short`}),n=!e.allDay&&e.time?Zt?Zt(e.time):e.time:``;return`<div class="td-up-row td-clickable" onclick="activateTab('planner');setTimeout(()=>_plannerOpenDetail&&_plannerOpenDetail('${e.id}'),120)">
        ...
        <div class="td-card-meta"><span class="td-meta-label">Coming up</span><span class="td-meta-count">${re.length+ie.length}</span></div>
        <div class="td-up-list">${e}</div>
      </div>`})}let j=(g.kids?.profiles||[]).map(e=>{let t=(g.routineAssignments||[]).filter(t=>t.childId===e.id),n=0;return t.forEach(e=>{let t=(g.routines||[]).find(t=>t.id===e.routineId);if(t){let r=_assignmentStreak?_assignmentStreak(e,t.steps.length):0;r>n&&(n=r)}}),{kid:e,streak:n}}).filter(e=>e.streak>=3);if(j.length>0){let e=j[0];u.push({type:`win`,urgency:0,html:`<div class="td-card td-card-win">
      ...
      </div>`:``;u.push({type:`lists`,urgency:+(i>0),html:`<div style="display:flex;gap:12px;margin-bottom:12px">${o}${s}</div>`})}function ae(){let e={overnight:`Quiet night.`,morning:`Quiet day ahead.`,afternoon:`Quiet afternoon.`,evening:`Quiet evening.`,night:`Nothing pressing tonight.`},t=[];if(v.length>=3?t.push(`${v.length} things on the calendar.`):v.length===0&&f.length===0&&d.length===0&&t.push(e[o]||`Quiet day ahead.`),d.length>0){let e=d[0];t.push(`${e.name} ${e.days===0?`is due today`:`is due tomorrow`}.`)}return t.length===0&&t.push(e[o]||`Quiet day ahead.`),t.slice(0,2).join(` `)}let M=ae(),P={priority:0,schedule:1,money:2,lists:3,kids:4,slipping:5,upcoming:6,win:7};u.sort((e,t)=>(P[e.type]??9)-(P[t.type]??9));let oe=u.map(e=>e.html).join(``),se=u.length<=1?`<div class="td-calm">You're sorted.<br>See you tomorrow.</div>`:``,ce=typeof Fi==`function`?`<div id="setup-progress-card">${Fi()}</div>`:``;if(e.innerHTML=`
    ...
    <div class="td-greeting">
      ...
      <div class="td-greeting-brief">${T(M)}</div>
    </div>
  ...
  </div>`).join(``);typeof window.openModal==`function`&&window.openModal(`💡 Insights`,`<div style="padding:0 4px">${i}</div>`,null)}var Zi=``,Qi=``;async function $i(e,t,n,r,i){let a=F(`toto_ai_key`);if(!a)return;let o=new Date().toISOString().slice(0,10);if(Zi===o&&Qi){let e=document.getElementById(`today-briefing-text`);e&&(e.textContent=Qi);return}let s=e.filter(e=>e.cls===`red`).map(e=>e.title),c=e.filter(e=>e.cls===`amber`).map(e=>e.title),l=`You are Toto, a friendly family personal assistant app. Write a 2-sentence daily briefing for the user based on this context:
...
- Don't start with "Here's" or "Today"`;try{let e=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":a,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:100,messages:[{role:`user`,content:l}]})});if(!e.ok)return;let t=(await e.json()).content[0].text.trim().replace(/^["']|["']$/g,``);Qi=t,Zi=o;let n=document.getElementById(`today-briefing-text`);n&&(n.textContent=t)}catch{}}function ea(){let e=g,r=e.buildContract,i=(e.netWorth.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),a=(e.netWorth.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),o=i-a,s=e.netWorth.snapshots||[],c=``;if(s.length>=2){let e=o-s[s.length-2].netWorth;c=`<span class="${e>=0?`up`:`dn`}">${e>=0?`+`:``}${fmtNW(e)}</span> vs last snapshot`}let l=window.selectedBudgetMonth,u=window.getMonthData(l),d=N(u.income),f=N(u.expenses),p=d-f,m=(e.subscriptions||[]).reduce((e,t)=>e+subMonthlyAmount(t),0),h=(e.bills||[]).filter(e=>{let t=n(e);return t>=0&&t<=31}).reduce((e,t)=>e+(parseFloat(t.amount)||0),0),_=[...e.bills||[]].filter(e=>n(e)>=-1).sort((e,t)=>n(e)-n(t)).slice(0,5),v=(e.goals||[]).filter(e=>e.status!==`achieved`).slice(0,4),y=r.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0),b=(r.variations||[]).filter(e=>e.status===`approved`).reduce((e,t)=>e+(t.amount||0),0),x=r.total+b,S=Math.round(y/x*100),C=r.stages.find(e=>!e.paid),w=((e.kids||{}).completions||[]).filter(e=>e.status===`pending`).length+((e.kids||{}).redemptions||[]).filter(e=>e.status===`pending`).length,E=window.getLast6Months(),ee=N(u.expenses),te=E.map(e=>{let t=Object.values(g.budget.actuals[e]||{}).reduce((e,t)=>e+t,0);return{label:window.monthShortLabel(e),budget:ee,actual:t}}),O=ee>0||te.some(e=>e.actual>0),k=window.calcFinancialHealth(),A=251.3,ne=(k.total/100*A).toFixed(1),re=k.dimensions.map(e=>{let t=Math.round(e.score/e.max*100),n=t>=75?`#10b981`:t>=50?`#f59e0b`:`#ef4444`;return`
        ...
        <div style="text-align:center">
          <svg viewBox="0 0 100 100" width="110" height="110" style="display:block;margin:0 auto">
            <g transform="rotate(-90 50 50)">
              ...
              <circle cx="50" cy="50" r="40" fill="none" stroke="${k.color}" stroke-width="10"
                stroke-dasharray="${ne} ${A}" stroke-linecap="round"/>
            </g>
            <text x="50" y="47" text-anchor="middle" font-size="24" font-weight="800" fill="${k.color}">${k.total}</text>
            <text x="50" y="63" text-anchor="middle" font-size="13" font-weight="600" fill="#94a3b8">Grade ${k.grade}</text>
          </svg>
        </div>
        <div style="display:flex;flex-direction:column;gap:10px">${re}</div>
      </div>
    ...
    </div>`,j=``;if(O){let e=Math.max(...te.flatMap(e=>[e.budget,e.actual]),1),t=532/te.length,n=t*.28,r=t*.04;j=`<div class="db-widget">
      <div class="db-widget-header">
    ...
    ${j}
  `;document.getElementById(`dashboard-content`).innerHTML=ae}function ta(){function e(e){return e.replace(/[^a-z0-9]/gi,`_`)}function t(t,n,r,i){let a=`${t}_${e(n)}`;return`
      <div class="color-row">
...
This cannot be undone. Are you sure?`)&&confirm(`Last chance. All data will be gone. Continue?`)){if(window._currentUser&&fbStore){let e=window._getHouseholdDocRef();e&&e.delete().catch(()=>{})}it(window.STORAGE_KEY),window._secureClear(HOUSEHOLD_OWNER_KEY),window._fsUnsubscribe&&(window._fsUnsubscribe(),window._fsUnsubscribe=null),fbAuth.signOut().then(()=>{window.location.reload()})}}function ra(){let e=new Blob([JSON.stringify(g,null,2)],{type:`application/json`}),t=document.createElement(`a`);t.href=URL.createObjectURL(e),t.download=`home-budget-backup-${new Date().toISOString().slice(0,10)}.json`,t.click(),URL.revokeObjectURL(t.href)}function ia(e){let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target.result);if(!t.budget){alert(`Invalid backup file — missing budget data.`);return}if(!confirm(`This will replace ALL current data with the backup. Continue?`))return;rt(window.STORAGE_KEY,JSON.stringify(t)),location.reload()}catch(e){alert(`Failed to read backup file: `+e.message)}},n.readAsText(t)}function aa(e){let t=document.getElementById(`grp-body-${e}`),n=document.getElementById(`grp-arrow-${e}`);if(!t)return;let r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n&&(n.textContent=r?`▼`:`▲`)}function oa(e){window.budgetViewMode=e,renderBudget()}function sa(){let e=g.buildContract,t=e.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0);e.total-t;let n=e.stages.filter(e=>e.paid).length,r=e.stages.length,i=e.variations||[],a=i.filter(e=>e.status===`approved`).reduce((e,t)=>e+(t.amount||0),0),o=i.filter(e=>e.status===`pending`).reduce((e,t)=>e+(t.amount||0),0),s=e.total+a,c=`
    <div class="section" style="border-left:4px solid ${colors.build.contract}">
      ...
      <div style="padding:16px 20px;border-bottom:1px solid var(--border)">
        <div style="display:flex;gap:0;position:relative">
          ${e.stages.map((t,n)=>{let r=(t.amount/e.total*100).toFixed(0),i=!t.paid&&e.stages.slice(0,n).every(e=>e.paid),a=t.paid?`#dcfce7`:i?`#dbeafe`:`var(--surface2)`,o=t.paid?`#16a34a`:i?`var(--primary)`:`var(--border)`,s=t.paid?`#15803d`:i?`var(--primary)`:`var(--text-muted)`,c=t.paid?`✓`:i?`→`:`${n+1}`,l=t.paid&&t.paidDate?A(t.paidDate):t.expectedDate?`Exp. `+A(t.expectedDate):``,u=!t.paid&&t.expectedDate&&isOverdue(t.expectedDate);return`
        ...
        <table>
          ...
          <tbody>
            ${e.stages.map(t=>{let n=(t.amount/e.total*100).toFixed(1),r=!t.paid&&t.expectedDate&&isOverdue(t.expectedDate),i=t.paid?`<span class="badge paid">Paid</span>`:r?`<span class="badge overdue">Overdue</span>`:`<span class="badge unpaid">Upcoming</span>`;return`<tr>
                ...
                <td>${t.expectedDate?A(t.expectedDate):`<span style="color:var(--text-muted)">—</span>`}</td>
                <td>${A(t.paidDate)}</td>
            ...
            <table>
              ...
              <tbody>
                ${i.map(e=>`<tr>
                  ...
                  <td>${A(e.dateRaised)}</td>
                  <td>${A(e.dateApproved)}</td>
        ...
        <table>
          ...
          <tbody>
            ${p.length===0?`<tr><td colspan="8"><div class="empty"><div class="empty-icon">🛋️</div>No furniture items yet. Add sofas, beds, appliances and more.</div></td></tr>`:p.map(e=>{let t={"to-purchase":`<span class="badge unpaid">To Purchase</span>`,ordered:`<span class="badge partial">Ordered</span>`,delivered:`<span class="badge paid">Delivered</span>`},n=e.deliveryDate&&e.status!==`delivered`&&isOverdue(e.deliveryDate);return`<tr>
                    ...
                    <td>${e.deliveryDate?n?`<span class="badge overdue">${A(e.deliveryDate)}</span>`:A(e.deliveryDate):`<span style="color:var(--text-muted)">—</span>`}</td>
                    <td style="color:var(--text-muted);font-size:12px;max-width:160px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${T(e.notes||`—`)}</td>
                    <td class="actions">
  ...
  `,document.getElementById(`build-content`).innerHTML=c}function ca(){return g.expenseCategories||DEFAULT_DATA.expenseCategories}function la(){return g.incomeCategories||DEFAULT_DATA.incomeCategories}function ua(e){if(e.type===`spending`){let t=Object.keys(g.budget.actuals).sort().reverse(),n=null;for(let r of t){let t=(window.getMonthData(r).expenses||[]).filter(t=>(t.category||`Other`)===e.category).reduce((e,t)=>e+(g.budget.actuals[r]?.[t.id]||0),0);if(t>0){n=t;break}}let r=e.targetMonthly||0;if(n===null)return{pct:null,label:`No actuals yet`,actual:null,target:r};let i=r>0?Math.max(0,Math.min(100,n/r*100)):0,a=n<=r;return{pct:i,label:`${D(n)} actual vs ${D(r)} limit`,actual:n,target:r,ok:a}}if(e.type===`savings`){let t=e.currentSaved||0,n=e.targetTotal||1;return{pct:Math.min(100,t/n*100),label:`${D(t)} of ${D(n)} saved`,ok:t>=n}}if(e.type===`income`){let t=monthlyTotal(window.getMonthData(window.selectedBudgetMonth).income),n=e.targetMonthly||1;return{pct:Math.min(100,t/n*100),label:`${D(t)}/mo of ${D(n)}/mo target`,ok:t>=n}}return{pct:0,label:``,ok:!1}}var da=`https://api.anthropic.com/v1/messages`,fa={holiday:{label:`Holiday`,emoji:`✈️`,sub:`FLIGHTS · ACCOM · PACKING`,heroGradient:`linear-gradient(135deg, #0F4D8B 0%, #2E96D7 100%)`,sections:[`tasks`,`bookings`],defaultTasks:[{name:`Book flights`},{name:`Book accommodation`},{name:`Travel insurance`},{name:`Check passports valid 6+ months`},{name:`Stop the mail`},{name:`House sitter / dog boarding`}]},reno:{label:`Reno / build`,emoji:`🌳`,sub:`QUOTES · STAGES · PHOTOS`,heroGradient:`linear-gradient(135deg, #166534 0%, #4D7C0F 100%)`,sections:[`tasks`,`quotes`,`stages`],defaultTasks:[{name:`Get 3 quotes`},{name:`Council approval (if needed)`},{name:`Sign contract`},{name:`Schedule start date`},{name:`Materials list`},{name:`Final walkthrough`}]},party:{label:`Party / event`,emoji:`🎉`,sub:`GUESTS · FOOD · DECOR`,heroGradient:`linear-gradient(135deg, #BE123C 0%, #F472B6 100%)`,sections:[`tasks`],defaultTasks:[{name:`Send invitations`},{name:`Confirm headcount`},{name:`Order cake`},{name:`Decorations`},{name:`Food / catering`},{name:`Music / entertainment`}]},"life-event":{label:`Big life event`,emoji:`👶`,sub:`BABY · MOVE · SCHOOL`,heroGradient:`linear-gradient(135deg, #5B21B6 0%, #A78BFA 100%)`,sections:[`tasks`],defaultTasks:[{name:`Make a checklist`},{name:`Tell key people`},{name:`Update insurance / paperwork`},{name:`Set a budget`},{name:`Plan the timeline`}]},seasonal:{label:`Seasonal`,emoji:`🎄`,sub:`XMAS · HOLS · BIRTHDAYS`,heroGradient:`linear-gradient(135deg, #B91C1C 0%, #F59E0B 100%)`,sections:[`tasks`],defaultTasks:[{name:`Set the budget`},{name:`Make a gift list`},{name:`Plan meals / hosting`},{name:`Travel arrangements`}]},custom:{label:`Custom`,emoji:`✨`,sub:`START FROM SCRATCH`,heroGradient:`linear-gradient(135deg, #4B5563 0%, #9CA3AF 100%)`,sections:[`tasks`],defaultTasks:[]}},pa={planning:{label:`Planning`,color:`#6B5CFF`,bg:`#EFEDFF`},active:{label:`Active`,color:`#065F46`,bg:`#DCFCE7`},done:{label:`Done`,color:`#52525B`,bg:`#F4F4F5`},paused:{label:`Paused`,color:`#92400E`,bg:`#FEF3C7`}},z=`list`,ma=null,ha=null,ga=null,_a=``,va=!1,ya=``;Object.defineProperty(window,`_projectsView`,{get(){return z},set(e){z=e},configurable:!0}),Object.defineProperty(window,`_activeProjectId`,{get(){return ma},set(e){ma=e},configurable:!0}),Object.defineProperty(window,`_newProjectTemplate`,{get(){return ha},set(e){ha=e},configurable:!0});function ba(){g.projects||(g.projects=[]),g.activeFamilyGoalProjectId===void 0&&(g.activeFamilyGoalProjectId=null)}function xa(){return ba(),g.projects}function Sa(e){return ba(),g.projects.find(t=>t.id===e)}function Ca(e){let t=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name).map((e,t)=>({id:`a`+t,name:e.name,role:`adult`})),n=(g.kids?.profiles||[]).map(e=>({id:`k`+e.id,name:e.name,role:`child`,emoji:e.emoji})),r=[...t,...n];return(e.members||[]).map(e=>r.find(t=>t.id===e)).filter(Boolean)}function wa(e){return(e.bookings||[]).reduce((e,t)=>e+(t.cost||0),0)+(e.spentManual||0)}function Ta(e){let t=(e.tasks||[]).length,n=(e.tasks||[]).filter(e=>e.done).length;return{total:t,done:n,pct:t>0?Math.round(n/t*100):0}}function B(){let e=document.getElementById(`projects-content`);if(e)if(ba(),z===`detail`&&ma){let t=Sa(ma);if(!t)return z=`list`,ma=null,B();e.innerHTML=Ma(t)}else z===`ai-draft`?e.innerHTML=Ja():z===`new`?e.innerHTML=ka():e.innerHTML=Ea()}function Ea(){let e=xa(),t=e.filter(e=>e.status===`active`),n=e.filter(e=>e.status===`planning`),r=e.filter(e=>e.status===`done`),i=e.filter(e=>e.status===`paused`),a=`
    ...
    </div>`}function Oa(e){let t=fa[e.template]||fa.custom,n=pa[e.status]||pa.planning,r=Ta(e),i=wa(e),a=e.startDate?e.endDate?`${A(e.startDate)}–${A(e.endDate)}`:`From ${A(e.startDate)}`:``,o=Ca(e).slice(0,4),s=g.activeFamilyGoalProjectId===e.id;return`
    ...
    </div>`}function ka(){return ha?ja(ha):Aa()}function Aa(){let e=!!F(`toto_ai_key`),t=ya?`<div style="margin-top:10px;font-size:12px;color:#FCA5A5">${T(ya)}</div>`:``,n=e?`
    ...
    <form id="projects-create-form" onsubmit="event.preventDefault();_projectsSaveNew('${e}')" style="margin:6px 16px 0;background:var(--paper);border:1px solid var(--hairline);border-radius:20px;padding:18px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="display:flex;gap:8px;margin-top:4px">
        ...
        <button type="button" onclick="event.preventDefault();_projectsSaveNew('${e}')" style="flex:1;padding:12px;border-radius:14px;border:none;background:linear-gradient(135deg,var(--iris-2),var(--purple));color:#fff;font-size:13px;font-weight:600;font-family:var(--sans);cursor:pointer;box-shadow:0 6px 16px -4px rgba(91,76,245,0.30)">Create project →</button>
      </div>
    </form>
    <div style="height:24px"></div>`}function Ma(e){let t=fa[e.template]||fa.custom;pa[e.status]||pa.planning;let n=Ta(e),r=wa(e),i=(e.budget||0)-r,a=g.activeFamilyGoalProjectId===e.id,o=e.startDate?e.endDate?`${A(e.startDate)} – ${A(e.endDate)}`:`From ${A(e.startDate)}`:`No dates set`,s=Ca(e),c=`
...
Output ONLY the JSON. No prose, no \`\`\`json fences.`;async function Ka(){let e=document.getElementById(`proj-ai-input`),t=(e?.value||``).trim();if(!t){e?.focus();return}let n=F(`toto_ai_key`);if(!n){ya=`Add your AI key in Settings first.`,B();return}_a=t,va=!0,ya=``,B();let r=new Date().toISOString().slice(0,10),i=Ga.replace(`%TODAY%`,r);try{let e=await fetch(da,{method:`POST`,headers:{"x-api-key":n,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:800,system:i,messages:[{role:`user`,content:t}]})}),r=await e.json();if(!e.ok)throw Error(r.error?.message||`API error`);let a=qa(r.content?.[0]?.text||``);if(!a||!a.name||!a.template)throw Error(`Toto came back with an unexpected reply. Try again.`);fa[a.template]||(a.template=`custom`),ga={name:String(a.name||``).slice(0,60),template:a.template,startDate:a.startDate||``,endDate:a.endDate||``,budget:Math.max(0,parseFloat(a.budget)||0),location:String(a.location||``),notes:String(a.notes||``),tasks:Array.isArray(a.tasks)?a.tasks.filter(e=>e&&typeof e==`string`).slice(0,12):[]},va=!1,z=`ai-draft`,B()}catch(e){va=!1,ya=e.message||`Something went wrong. Try again.`,B()}}function qa(e){if(!e)return null;try{return JSON.parse(e)}catch{}let t=e.match(/```(?:json)?\s*(\{[\s\S]*?\})\s*```/);if(t)try{return JSON.parse(t[1])}catch{}let n=e.match(/\{[\s\S]*\}/);if(n)try{return JSON.parse(n[0])}catch{}return null}function Ja(){let e=ga;if(!e)return z=`new`,ka();let t=fa[e.template]||fa.custom,n=e.startDate?e.endDate?`${A(e.startDate)} – ${A(e.endDate)}`:`From ${A(e.startDate)}`:``,r=`
  ...
  </div>`,i.length===0){let e=window.getMonthData(window.selectedBudgetMonth),t=N(e.income)-N(e.expenses),n=t>0?`<div style="font-size:14px;color:#64748b;margin-bottom:4px">You have <strong style="color:#16a34a">${D(t)}</strong> surplus each month.</div>
...
Reply with ONLY the JSON array, no other text.`;try{let e=await fetch(Go,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:u}]})});if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(t.error?.message||`API error ${e.status}`)}let t=(await e.json()).content[0].text.trim();t=t.replace(/^```[a-z]*\n?/i,``).replace(/\n?```$/,``).trim(),qo(JSON.parse(t),!0)}catch(e){let t=e.message;(t.includes(`Failed to fetch`)||t.includes(`NetworkError`)||t.includes(`CORS`))&&(t=`CORS blocked — the browser can't call the Anthropic API directly. We need a small proxy (Cloudflare Worker). Ask me to set it up — it takes 5 minutes and is free.`),document.getElementById(`ai-output`).innerHTML=`
  ...
  `,()=>{let t=document.getElementById(`f-cat-selected`).value,n=document.getElementById(`f-cat-new`).value.trim()||t;n&&(as(e,n),window.closeModal())})}function ss(e,t){let n=g.categoryGroups.find(t=>t.id===e);n&&(n.categories=n.categories.filter(e=>e!==t),window.saveData(g),renderSettings())}var cs=!1,ls=null;function us(){cs||(ls=JSON.parse(JSON.stringify(g))),cs=!0;let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`flex`)}function ds(){cs=!1,ls=null,window.saveData(g);let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`none`);let t=document.getElementById(`settings-save-btn`);if(t){let e=t.textContent;t.textContent=`Saved`,t.style.background=`#10b981`,setTimeout(()=>{t.textContent=e,t.style.background=``},1500)}window.renderAll()}function fs(){ls&&Object.assign(g,ls),cs=!1,ls=null;let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`none`),renderSettings()}function ps(e){cs&&(confirm(`You have unsaved changes in Settings. Save before leaving?`)?ds():fs())}function ms(e,t){g.settings||(g.settings={}),g.settings[e]=t,us()}function hs(){let e=document.getElementById(`settings-api-key`)?.value.trim();if(!e)return;rt(`toto_ai_key`,e),rt(`toto_ai_key_meta`,JSON.stringify({addedAt:new Date().toISOString(),prefix:e.slice(0,10),suffix:e.slice(-4)}));let t=document.getElementById(`api-key-status`);t&&(t.textContent=`✓ Key saved!`,t.style.color=`var(--success)`,setTimeout(()=>{t.textContent=``,t.style.color=``},2e3));let n=document.getElementById(`api-key-summary`);n&&(n.outerHTML=_s())}function gs(){confirm(`Remove saved API key? Toto and cost estimation will stop working.`)&&(it(`toto_ai_key`),it(`toto_ai_key_meta`),renderSettings())}function _s(){let e=F(`toto_ai_key`);if(!e)return`<div id="api-key-summary"></div>`;let t=JSON.parse(F(`toto_ai_key_meta`)||`{}`),n=t.addedAt?new Date(t.addedAt).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`}):`Unknown date`;return`
    ...
    <div style="background:var(--surface);border:1px solid ${d?`var(--danger)`:`var(--border)`};border-radius:10px;overflow:hidden">
      ...
      <div id="grp-body-${t.id}" style="border-top:1px solid var(--border)">
        ...
        ${r.map(e=>{let t=M(e),r=window.getActual(e.id,window.selectedBudgetMonth),i=t>0?Math.min(100,Math.round(r/t*100)):0,a=n[e.category||`Other`]||window.colors.expense[e.category||`Other`]||`#94a3b8`,o=r>t&&r>0,s=o?`var(--danger)`:i>=80?`var(--warning)`:r>0?a:`var(--border)`;return r>0?`${D(r)}${D(t)}${i}`:`${D(t)}`,`
          <div class="expense-row" style="--row-color:${a};display:flex;align-items:center;gap:10px;padding:10px 14px;border-bottom:1px solid var(--border)">
            ...
            <div style="flex:1;min-width:0;cursor:pointer" onclick="event.stopPropagation();openEditExpense(${e.id})">
              ...
              <div style="font-size:11px;color:var(--text-muted)">${e.category||`Other`}${e.vendor?` · ${T(e.vendor)}`:``} · ${j(e)}</div>
            </div>
    ...
    </div>`;let f=Cs({income:e,expenses:t});if(f.segments.length){let e=f.segments.map(e=>`<div style="background:${e.color};flex:${e.pct.toFixed(2)}"></div>`).join(``);f.segments.map(e=>`<div class="alloc-row">
        ...
        <table>
          ...
          <tbody>
            ${e.length===0?`<tr><td colspan="6"><div class="empty"><div class="empty-icon">💵</div>Add your income sources</div></td></tr>`:e.map(e=>{let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():`<span style="color:var(--text-muted)">—</span>`,n=e.recurring===!1?`<span style="font-size:10px;font-weight:600;padding:1px 6px;border-radius:99px;background:#fef9c3;color:#854d0e;border:1px solid #fde047;margin-left:6px;white-space:nowrap">one-time</span>`:``;return`<tr>
              <td style="font-weight:500;border-left:4px solid ${window.colors.income}">${T(e.name)}${n}</td>
              <td class="amount">${O(e.amount)}</td>
              <td>${t}</td>
              <td style="color:var(--text-muted)">${j(e)}</td>
              <td class="amount" style="color:var(--success)">${D(M(e))}/mo</td>
              <td class="actions">
  ...
  `;let p=[`all`,...Array.from(new Set(t.map(e=>e.category||`Other`))).sort()],m=window.expenseFilterCat===`all`?t:t.filter(e=>(e.category||`Other`)===window.expenseFilterCat),h=m.reduce((e,t)=>e+M(t),0),_=m.reduce((e,t)=>e+window.getActual(t.id,window.selectedBudgetMonth),0),v=h-_,y=window.expenseFilterCat!==`all`;d+=`
    <div class="section">
      <div class="section-header">
        <div>
      ...
      <div style="padding:16px 20px">
      ${window.budgetViewMode===`grouped`?Ss(t):`
        <div class="table-wrap" style="margin:0 -20px">
          <table>
            ...
            <tbody>
              ${m.length===0?`<tr><td colspan="8"><div class="empty"><div class="empty-icon">📋</div>${t.length===0?`Add your household expenses`:`No expenses in this category`}</div></td></tr>`:[...m].sort((e,t)=>{if(!window.expenseSortCol)return 0;let n,r;if(window.expenseSortCol===`name`)n=e.name.toLowerCase(),r=t.name.toLowerCase();else if(window.expenseSortCol===`category`)n=(e.category||`Other`).toLowerCase(),r=(t.category||`Other`).toLowerCase();else if(window.expenseSortCol===`frequency`)n=j(e),r=j(t);else if(window.expenseSortCol===`due`)n=e.dueDate||`￿`,r=t.dueDate||`￿`;else if(window.expenseSortCol===`budget`)n=M(e),r=M(t);else if(window.expenseSortCol===`actual`)n=window.getActual(e.id,window.selectedBudgetMonth),r=window.getActual(t.id,window.selectedBudgetMonth);else if(window.expenseSortCol===`variance`)n=M(e)-window.getActual(e.id,window.selectedBudgetMonth),r=M(t)-window.getActual(t.id,window.selectedBudgetMonth);else return 0;return n<r?window.expenseSortDir===`asc`?-1:1:n>r?window.expenseSortDir===`asc`?1:-1:0}).map(e=>{let t=M(e),n=window.getActual(e.id,window.selectedBudgetMonth),r=t-n,i=n>0,a;a=i?r>=0?`<span class="var-under">▼ ${D(r)}</span>`:`<span class="var-over">▲ ${D(Math.abs(r))}</span>`:`<span class="var-none">—</span>`;let o=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():`<span style="color:var(--text-muted)">—</span>`,s=window.colors.expense[e.category||`Other`]||`#94a3b8`,c=e.recurring===!1?`<span style="font-size:10px;font-weight:600;padding:1px 6px;border-radius:99px;background:#fef9c3;color:#854d0e;border:1px solid #fde047;margin-left:6px;white-space:nowrap">one-time</span>`:``;return`<tr>
                        <td style="font-weight:500;border-left:4px solid ${s}">${T(e.name)}${c}${e.vendor?`<br><span style="font-size:11px;font-weight:400;color:var(--text-muted)">${T(e.vendor)}</span>`:``}</td>
                        ...
                        <td>${o}</td>
                        <td class="amount">${D(t)}</td>
                        <td class="actual-cell amount" id="actual-${e.id}" onclick="window.editActual(${e.id})">${i?D(n):`<span style="color:var(--text-muted);font-size:12px">+ add</span>`}</td>
                        <td>${a}</td>
                        <td class="actions">
            ...
            <tfoot>
              <tr style="background:var(--surface2);border-top:2px solid var(--border)">
                <td colspan="4" style="padding:11px 16px;font-size:13px;color:var(--text-muted);font-style:italic">Total ${y?window.expenseFilterCat:`all categories`}</td>
                <td class="amount" style="padding:11px 16px;font-weight:700">${D(h)}/mo</td>
                <td class="amount" style="padding:11px 16px;font-weight:700">${_>0?D(_):`—`}</td>
                <td style="padding:11px 16px;font-weight:700">${_>0?`<span class="${v>=0?`var-under`:`var-over`}">${v>=0?`▼`:`▲`} ${D(Math.abs(v))}</span>`:`—`}</td>
                <td></td>
              </tr>
            </tfoot>`:``}
          </table>
  ...
  `,d+=`</div></div>`,document.getElementById(`budget-content`).innerHTML=d}catch(e){console.error(`renderBudget error:`,e);let t=document.getElementById(`budget-content`);t&&(t.innerHTML=`<div style="padding:24px;color:var(--alert);font-family:var(--mono);font-size:13px">Render error: ${T(e.message)}<br><small>${T(e.stack||``)}</small></div>`)}}var Os=!1;function ks(){Os=!Os;let e=document.getElementById(`budget-detail`),t=document.getElementById(`budget-expand-label`),n=document.getElementById(`budget-expand-chevron`),r=e&&e.parentElement;e&&(e.classList.toggle(`collapsed`,!Os),e.classList.toggle(`expanded`,Os)),r&&(r.style.marginBottom=Os?`16px`:`0`),t&&(t.textContent=Os?`Hide details ▲`:`See breakdown ▼`),n&&(n.textContent=Os?`▲`:`▼`)}function V(e,t,n){document.getElementById(`modal-title`).textContent=e,document.getElementById(`modal-body`).innerHTML=t,document.getElementById(`modal-footer`).innerHTML=`
    <button class="btn btn-ghost" onclick="closeModal()">Cancel</button>
    <button class="btn btn-primary" id="modal-save-btn">Save</button>
  `,window._modalSaveHandler=n,document.getElementById(`modal-save-btn`).onclick=()=>window._modalSaveHandler?.(),document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function As(){window._pendingLogEntry=null,window._actualEditorRefresh=null,window._csvSuggestions=null,window._csvSuggestNames=null,document.getElementById(`modal-body`).innerHTML=``,document.getElementById(`modal-footer`).innerHTML=``,document.getElementById(`modal-overlay`).classList.add(`hidden`)}document.getElementById(`modal-overlay`).addEventListener(`click`,e=>{e.target===document.getElementById(`modal-overlay`)&&As()});function js(){V(`Edit Contract Total`,`
    <div class="form-group">
  ...
  `,()=>{let e=parseFloat(document.getElementById(`f-contract-total`).value);!isNaN(e)&&e>0&&(window.logActivity(`Updated contract total`,D(e)),g.buildContract.total=e,window.saveData(g),As(),window.renderAll())})}function Ms(e={}){return`
    <div class="form-row">
      <div class="form-group">
  ...
  `}function Ns(e){return{id:e,name:document.getElementById(`f-stage-name`).value.trim(),amount:parseFloat(document.getElementById(`f-stage-amount`).value)||0,paid:document.getElementById(`f-stage-paid`).checked,expectedDate:document.getElementById(`f-stage-expected`).value,paidDate:document.getElementById(`f-stage-paiddate`).value,invoiceRef:document.getElementById(`f-stage-ref`).value.trim(),funding:document.getElementById(`f-stage-funding`).value,notes:document.getElementById(`f-stage-notes`).value.trim()}}function Ps(){V(`Add Contract Stage`,Ms(),()=>{let e=Ns(P(g.buildContract.stages));e.name&&(window.logActivity(`Added build stage`,e.name),g.buildContract.stages.push(e),window.saveData(g),As(),window.renderAll())})}function Fs(e){let t=g.buildContract.stages.find(t=>t.id===e);V(`Edit Stage`,Ms(t),()=>{let n=Ns(e);window.logActivity(`Edited build stage`,n.name||t.name),Object.assign(t,n),window.saveData(g),As(),window.renderAll()})}function Is(e){if(!confirm(`Delete this stage?`))return;let t=g.buildContract.stages.find(t=>t.id===e);window.logActivity(`Deleted build stage`,t?t.name:``),g.buildContract.stages=g.buildContract.stages.filter(t=>t.id!==e),window.saveData(g),window.renderAll()}function Ls(e={}){return`
    <div class="form-row">
      <div class="form-group">
  ...
  `}function Rs(e){return{id:e,ref:document.getElementById(`f-var-ref`).value.trim(),name:document.getElementById(`f-var-name`).value.trim(),amount:parseFloat(document.getElementById(`f-var-amount`).value)||0,status:document.getElementById(`f-var-status`).value,funding:document.getElementById(`f-var-funding`).value,dateRaised:document.getElementById(`f-var-raised`).value,dateApproved:document.getElementById(`f-var-approved`).value,notes:document.getElementById(`f-var-notes`).value.trim()}}function zs(){V(`Add Variation`,Ls(),()=>{let e=Rs(P(g.buildContract.variations));e.name&&(window.logActivity(`Added variation`,`${e.ref?e.ref+` · `:``}${e.name}`),g.buildContract.variations.push(e),window.saveData(g),renderBuild())})}function Bs(e){V(`Edit Variation`,Ls(g.buildContract.variations.find(t=>t.id===e)),()=>{let t=Rs(e);if(!t.name)return;window.logActivity(`Edited variation`,`${t.ref?t.ref+` · `:``}${t.name}`);let n=g.buildContract.variations.findIndex(t=>t.id===e);n!==-1&&(g.buildContract.variations[n]=t),window.saveData(g),renderBuild()})}function Vs(e){if(!confirm(`Delete this variation?`))return;let t=g.buildContract.variations.find(t=>t.id===e);window.logActivity(`Deleted variation`,t?t.name:``),g.buildContract.variations=g.buildContract.variations.filter(t=>t.id!==e),window.saveData(g),renderBuild()}var Hs=[{value:`not-quoted`,label:`Not Quoted`},{value:`quoted`,label:`Quoted`},{value:`approved`,label:`Approved`},{value:`partial`,label:`Partially Paid`},{value:`paid`,label:`Paid`}];function Us(e={}){let t=e.status||(e.totalAmount?`approved`:`not-quoted`);return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Item Name</label>
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <select class="form-select" id="f-extra-status">
          ${Hs.map(e=>`<option value="${e.value}" ${t===e.value?`selected`:``}>${e.label}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
  ...
  `}function Ws(e){return{id:e,name:document.getElementById(`f-extra-name`).value.trim(),vendor:document.getElementById(`f-extra-vendor`).value.trim(),status:document.getElementById(`f-extra-status`).value,funding:document.getElementById(`f-extra-funding`).value,totalAmount:parseFloat(document.getElementById(`f-extra-total`).value)||0,amountPaid:parseFloat(document.getElementById(`f-extra-paid`).value)||0,dueDate:document.getElementById(`f-extra-due`).value,notes:document.getElementById(`f-extra-notes`).value.trim()}}function Gs(){V(`Add Outside Contract Item`,Us(),()=>{let e=Ws(P(g.extras));e.name&&(window.logActivity(`Added extra item`,e.name),g.extras.push(e),window.saveData(g),As(),window.renderAll())})}function Ks(e){let t=g.extras.find(t=>t.id===e);V(`Edit Item`,Us(t),()=>{let n=Ws(e);window.logActivity(`Edited extra item`,n.name||t.name),Object.assign(t,n),window.saveData(g),As(),window.renderAll()})}function qs(e){if(!confirm(`Delete this item?`))return;let t=g.extras.find(t=>t.id===e);window.logActivity(`Deleted extra item`,t?t.name:``),g.extras=g.extras.filter(t=>t.id!==e),window.saveData(g),window.renderAll()}function Js(e={}){let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():``,n=[`weekly`,`fortnightly`,`monthly`,`quarterly`,`annually`,`custom`],r=e.frequency===`custom`;return`
    <div class="form-group">
  ...
  `}function Ys(e){let t=document.getElementById(`f-inc-freq`)?document.getElementById(`f-inc-freq`).value:`monthly`,n=document.getElementById(`f-inc-recurring`),r={id:e,name:document.getElementById(`f-inc-name`).value.trim(),amount:parseFloat(document.getElementById(`f-inc-amount`).value)||0,frequency:t,dueDate:document.getElementById(`f-inc-duedate`).value||null,recurring:n?n.checked:!0};return t===`custom`&&(r.customEvery=parseInt(document.getElementById(`f-inc-custom-n`).value)||1,r.customUnit=document.getElementById(`f-inc-custom-unit`).value),r}function Xs(){V(`Add Income`,Js(),()=>{let e=Ys(P(window.getMonthData(window.selectedBudgetMonth).income));e.name&&(window.logActivity(`Added income`,e.name),window.confirmScope(()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth);e.id=P(t.income),t.income.push(e),window.saveData(g),window.renderAll()},()=>{e.id=P(g.budget.income),g.budget.income.push(e),window.saveData(g),window.renderAll()}))})}function Zs(e){let t=window.getMonthData(window.selectedBudgetMonth).income.find(t=>t.id===e);V(`Edit Income`,Js(t),()=>{let n=Ys(e);window.logActivity(`Edited income`,n.name||t&&t.name||``),window.confirmScope(()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth),r=t.income.find(t=>t.id===e);r?Object.assign(r,n):t.income.push(n),window.saveData(g),window.renderAll()},()=>{let t=g.budget.income.find(t=>t.id===e);t&&Object.assign(t,n),window.saveData(g),window.renderAll()})})}function Qs(e){let t=window.getMonthData(window.selectedBudgetMonth).income.find(t=>t.id===e),n=t?t.name:`this income`;window.logActivity(`Deleted income`,n),window._scopePending=null,document.getElementById(`modal-title`).textContent=`Delete income`,document.getElementById(`modal-body`).innerHTML=`
  ...
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function $s(e={}){let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():``,n=[`weekly`,`fortnightly`,`monthly`,`quarterly`,`annually`,`custom`],r=e.frequency===`custom`;return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Description</label>
  ...
  `}function ec(e){let t=document.getElementById(`f-exp-freq`)?document.getElementById(`f-exp-freq`).value:`monthly`,n=document.getElementById(`f-exp-recurring`),r={id:e,name:document.getElementById(`f-exp-name`).value.trim(),category:document.getElementById(`f-exp-cat`).value,vendor:(document.getElementById(`f-exp-vendor`)?.value||``).trim()||null,amount:parseFloat(document.getElementById(`f-exp-amount`).value)||0,frequency:t,dueDate:document.getElementById(`f-exp-duedate`).value||null,recurring:n?n.checked:!0};return t===`custom`&&(r.customEvery=parseInt(document.getElementById(`f-exp-custom-n`).value)||1,r.customUnit=document.getElementById(`f-exp-custom-unit`).value),r}function tc(e){let t=document.getElementById(`f-${e}-freq`).value,n=document.getElementById(`f-${e}-custom-wrap`);n&&(n.style.display=t===`custom`?`flex`:`none`)}function nc(){V(`Add Expense`,$s(),()=>{let e=ec(P(window.getMonthData(window.selectedBudgetMonth).expenses));e.name&&(window.logActivity(`Added expense`,`${e.name} (${e.category||`Other`})`),window.confirmScope(()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth);e.id=P(t.expenses),t.expenses.push(e),window.saveData(g),window.renderAll()},()=>{if(e.id=P(g.budget.expenses),g.budget.expenses.push(e),window.isMonthCustomized(window.selectedBudgetMonth)){let t=g.budget.months[window.selectedBudgetMonth];t.expenses.push({...e,id:P(t.expenses)})}window.saveData(g),window.renderAll()}))})}function rc(e){let t=window.getMonthData(window.selectedBudgetMonth).expenses.find(t=>t.id===e);V(`Edit Expense`,$s(t),()=>{let n=ec(e);window.logActivity(`Edited expense`,`${n.name||t&&t.name||``} (${n.category||`Other`})`),window.confirmScope(()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth),r=t.expenses.find(t=>t.id===e);r?Object.assign(r,n):t.expenses.push(n),window.saveData(g),window.renderAll()},()=>{let t=g.budget.expenses.find(t=>t.id===e);if(t&&Object.assign(t,n),window.isMonthCustomized(window.selectedBudgetMonth)){let t=g.budget.months[window.selectedBudgetMonth].expenses.find(t=>t.id===e);t&&Object.assign(t,n)}window.saveData(g),window.renderAll()})});let n=document.createElement(`button`);n.className=`btn btn-danger`,n.textContent=`Delete`,n.style.marginRight=`auto`,n.onclick=()=>{As(),ic(e)};let r=document.getElementById(`modal-footer`);r.insertBefore(n,r.firstChild)}function ic(e){let t=window.getMonthData(window.selectedBudgetMonth).expenses.find(t=>t.id===e),n=t?t.name:`this expense`;window.logActivity(`Deleted expense`,n),window._scopePending={onThisMonth:()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth);t.expenses=t.expenses.filter(t=>t.id!==e),window.saveData(g),window.renderAll()},onAllMonths:()=>{g.budget.expenses=g.budget.expenses.filter(t=>t.id!==e),g.budget.months&&Object.values(g.budget.months).forEach(t=>{t.expenses=t.expenses.filter(t=>t.id!==e)}),window.saveData(g),window.renderAll()}},document.getElementById(`modal-title`).textContent=`Delete expense`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <button class="btn btn-secondary" onclick="window.doScopeAll()">Remove from all months</button>
    <button class="btn btn-danger" onclick="window.doScopeMonth()">Delete from ${window.monthLabel(window.selectedBudgetMonth)}</button>
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function ac(){return document.getElementById(`f-exp-duedate`)||document.getElementById(`f-inc-duedate`)}function oc(e){e.stopPropagation();let t=document.getElementById(`dp-popup`);if(!t)return;let n=(ac()||{}).value||``;if(n)[window.dpViewYear,window.dpViewMonth]=n.split(`-`).map(Number);else{let e=new Date;window.dpViewYear=e.getFullYear(),window.dpViewMonth=e.getMonth()+1}t.classList.remove(`hidden`),sc();function r(e){let n=document.getElementById(`dp-wrap`);n&&!n.contains(e.target)?t.classList.add(`hidden`):document.addEventListener(`click`,r,{once:!0})}document.addEventListener(`click`,r,{once:!0})}function sc(){let e=document.getElementById(`dp-popup`);if(!e)return;let t=window.dpViewYear,n=window.dpViewMonth,r=new Date(t,n-1,1).getDay(),i=new Date(t,n,0).getDate(),a=new Date,o=(ac()||{}).value||``,s=`
    <div class="dp-nav">
  ...
  `;for(let e=0;e<r;e++)s+=`<div class="dp-day dp-other"></div>`;for(let e=1;e<=i;e++){let r=`${t}-${String(n).padStart(2,`0`)}-${String(e).padStart(2,`0`)}`,i=[`dp-day`,a.getFullYear()===t&&a.getMonth()+1===n&&a.getDate()===e?`dp-today`:``,o===r?`dp-selected`:``].filter(Boolean).join(` `);s+=`<div class="${i}" onclick="dpSelectDate('${r}',event)">${e}</div>`}s+=`</div>`,o&&(s+=`<div class="dp-clear"><button class="dp-clear-btn" onclick="dpClearDate(event)">Clear date</button></div>`),e.innerHTML=s}function cc(e){e.stopPropagation(),window.dpViewMonth===1?(window.dpViewMonth=12,window.dpViewYear--):window.dpViewMonth--,sc()}function lc(e){e.stopPropagation(),window.dpViewMonth===12?(window.dpViewMonth=1,window.dpViewYear++):window.dpViewMonth++,sc()}function uc(e,t){t&&t.stopPropagation();let n=ac();n&&(n.value=e);let[r,i,a]=e.split(`-`);document.getElementById(`dp-display`).textContent=`${a}/${i}/${r}`,document.getElementById(`dp-trigger`).classList.add(`has-value`),document.getElementById(`dp-popup`).classList.add(`hidden`);let o=document.getElementById(`dp-repeats-wrap`);o&&(o.style.display=``)}function dc(e){e.stopPropagation();let t=ac();t&&(t.value=``),document.getElementById(`dp-display`).textContent=`Select a date`,document.getElementById(`dp-trigger`).classList.remove(`has-value`),document.getElementById(`dp-popup`).classList.add(`hidden`);let n=document.getElementById(`dp-repeats-wrap`);n&&(n.style.display=`none`)}var H=[],fc=[];function pc(){document.getElementById(`modal-title`).textContent=`Import Bank Transactions`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    ${e?`<button class="btn btn-primary" onclick="runCsvCategorise()">Categorise with AI →</button>`:`<button class="btn btn-primary" onclick="_renderCsvReview(null)">Assign Manually →</button>`}`}async function _c(){let e=window._secureGet(`toto_ai_key`);if(!e){vc(null);return}document.getElementById(`modal-body`).innerHTML=`
...
[{"idx":0,"expenseId":3},{"idx":1,"expenseId":-1,"suggest":"Dining Out"},{"idx":2,"expenseId":-1}]`;try{let t=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":e,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:4096,messages:[{role:`user`,content:o}]})});if(!t.ok)throw Error(`API error ${t.status}`);let n=(await t.json()).content[0].text.replace(/```[\w]*\n?/g,``).trim().match(/\[[\s\S]*\]/);if(!n)throw Error(`No JSON in response`);let r=JSON.parse(n[0]);vc(i(r))}catch(e){document.getElementById(`modal-body`).innerHTML=`
      ...
      <td class="amount" style="white-space:nowrap;font-weight:600">${O(e.total)}</td>
    </tr>`}).join(``),u=e?`<div style="font-size:12px;color:var(--text-muted);margin-bottom:10px">🤖 Transactions grouped by category — review and adjust as needed.</div>`:``,d=fc.filter(e=>e.checked&&e.expenseId!==-1).length,f=fc.filter(e=>e.checked&&e.expenseId!==-1).reduce((e,t)=>e+t.count,0);document.getElementById(`modal-body`).innerHTML=`
    <div>
      ${u}
    ...
    </div>`;let p=fc.filter(e=>e.checked&&e.expenseId===-1).length;document.getElementById(`modal-footer`).innerHTML=`
    ...
    <div style="height:max(12px,env(safe-area-inset-bottom))"></div>`,requestAnimationFrame(()=>document.getElementById(`qah-text`)?.focus())}function Dc(e){Tc(),setTimeout(()=>{if(e===`event`)activateTab(`planner`),setTimeout(()=>openPlannerModal(null,new Date().toISOString().slice(0,10)),300);else if(e===`expense`){let e=window.getMonthData(window.selectedBudgetMonth).expenses,t=parseInt(window._secureGet(`toto_qa_last`)||`0`);_qaExpenseId=e.find(e=>e.id===t)?.id??e[0]?.id??null,_qaAmount=``,Ac(e),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>document.getElementById(`qa-sheet`).classList.add(`open`))}else e===`income`?(activateTab(`budget`),setTimeout(()=>openAddIncome(),300)):e===`bill`?(activateTab(`bills`),setTimeout(()=>openBillModal(),300)):e===`chore`?(activateTab(`kids`),setTimeout(()=>{typeof renderChoreMgmt==`function`&&renderChoreMgmt()},300)):e===`shopping`?(window._listsActiveType=`food`,window._listsView=`list`,activateTab(`lists`)):e===`ai`&&typeof toggleTotoAssistant==`function`&&toggleTotoAssistant()},320)}async function Oc(){let e=document.getElementById(`qah-text`)?.value.trim();if(!e){Dc(`ai`);return}let t=document.querySelector(`.qah-ai-send`);t&&(t.textContent=`…`,t.disabled=!0);let n=`Today is ${new Date().toISOString().slice(0,10)}. The user typed: "${e}"
...
- If genuinely unclear → unknown`;try{let t=g.settings?.claudeApiKey,r=(await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:150,messages:[{role:`user`,content:n}]})})).json()).content?.[0]?.text?.trim()||`{"type":"unknown"}`,i=JSON.parse(r.replace(/```[\w]*\n?/g,``).trim());Tc(),await kc(i,e)}catch{Tc(),setTimeout(()=>{typeof toggleTotoAssistant==`function`&&toggleTotoAssistant(),setTimeout(()=>{let t=document.getElementById(`toto-input`)||document.querySelector(`.toto-msg-input`);t&&(t.value=e,t.focus())},400)},320)}}async function kc(e,t){let n=e=>new Promise(t=>setTimeout(t,e));if(e.type===`event`){activateTab(`planner`),await n(320),openPlannerModal(null,e.date||new Date().toISOString().slice(0,10)),await n(200);let r=document.getElementById(`pe-title`),i=document.getElementById(`pe-time`);if(r&&(r.value=e.title||t),i&&e.time&&(i.value=e.time),e.date){let t=document.getElementById(`pe-date`),n=document.getElementById(`pm-start-display`);t&&(t.value=e.date),n&&typeof _pmFmtDateShort==`function`&&(n.textContent=_pmFmtDateShort(e.date))}}else if(e.type===`expense`){let t=window.getMonthData(window.selectedBudgetMonth).expenses,n=parseInt(window._secureGet(`toto_qa_last`)||`0`);_qaExpenseId=t.find(e=>e.id===n)?.id??t[0]?.id??null,_qaAmount=e.amount?String(e.amount):``,Ac(t),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>{document.getElementById(`qa-sheet`).classList.add(`open`);let t=document.getElementById(`qa-note`);t&&e.note&&(t.value=e.note)})}else if(e.type===`income`){activateTab(`budget`),await n(320),openAddIncome(),await n(200);let t=document.getElementById(`inc-name`)||document.querySelector(`#modal-body [id*="name"]`),r=document.getElementById(`inc-amount`)||document.querySelector(`#modal-body [id*="amount"]`);t&&e.name&&(t.value=e.name),r&&e.amount&&(r.value=e.amount)}else if(e.type===`bill`){activateTab(`bills`),await n(320),openBillModal(),await n(200);let t=document.getElementById(`bill-name`),r=document.getElementById(`bill-amount`),i=document.getElementById(`bill-due`);t&&e.name&&(t.value=e.name),r&&e.amount&&(r.value=e.amount),i&&e.dueDate&&(i.value=e.dueDate)}else if(e.type===`chore`)activateTab(`kids`),await n(320);else if(e.type===`shopping`){window._listsActiveType=`food`,window._listsView=`list`,activateTab(`lists`),await n(320);let t=document.getElementById(`ls-quick-input`);t&&e.name&&(t.value=e.name,t.focus())}else{typeof toggleTotoAssistant==`function`&&toggleTotoAssistant(),await n(400);let e=document.getElementById(`toto-input`)||document.querySelector(`.toto-msg-input`);e&&(e.value=t,e.focus())}}function Ac(e){let t=e||window.getMonthData(window.selectedBudgetMonth).expenses,n=_qaAmount?`$${_qaAmount}`:`$0`,r=!_qaAmount,i=t.length?t.map(e=>`<button class="qa-cat${e.id===_qaExpenseId?` selected`:``}" onclick="_qaSelectCat(${e.id})">${T(e.name)}</button>`).join(``):`<span style="color:var(--text-muted);font-size:13px;padding:6px 4px">Add budget expenses first</span>`,a=[`1`,`2`,`3`,`4`,`5`,`6`,`7`,`8`,`9`,`.`,`0`,`⌫`];document.getElementById(`qa-sheet`).innerHTML=`
    ...
    </div>`}function jc(e){if(e===`⌫`)_qaAmount=_qaAmount.slice(0,-1);else if(e===`.`)_qaAmount.includes(`.`)||(_qaAmount+=(_qaAmount?``:`0`)+`.`);else{let t=_qaAmount.split(`.`);if(t[1]!==void 0&&t[1].length>=2||_qaAmount.replace(`.`,``).length>=6)return;_qaAmount===`0`&&e!==`.`?_qaAmount=e:_qaAmount+=e}let t=document.getElementById(`qa-display`);if(!t)return;let n=!_qaAmount;t.textContent=_qaAmount?`$${_qaAmount}`:`$0`,t.className=`qa-amount-display${n?` zero`:``}`}function Mc(e){_qaExpenseId=e,document.querySelectorAll(`.qa-cat`).forEach(t=>{t.classList.toggle(`selected`,parseInt(t.getAttribute(`onclick`).match(/\d+/)[0])===e)})}function Nc(){let e=parseFloat(_qaAmount);if(!e||e<=0){let e=document.getElementById(`qa-display`);e&&(e.style.color=`var(--danger)`,setTimeout(()=>e.style.color=``,600));return}if(!_qaExpenseId){let e=document.getElementById(`qa-cats`);e&&(e.style.outline=`2px solid var(--danger)`,e.style.borderRadius=`8px`,setTimeout(()=>{e.style.outline=``},600));return}let t=document.getElementById(`qa-note`)?.value.trim()||``,n=new Date().toISOString().slice(0,10);g.budget.actuals[window.selectedBudgetMonth]||(g.budget.actuals[window.selectedBudgetMonth]={});let r=window.getActualEntries(_qaExpenseId,window.selectedBudgetMonth),i=r.length?Math.max(...r.map(e=>e.id))+1:1;r.push({id:i,amount:e,date:n,note:t}),g.budget.actuals[window.selectedBudgetMonth][_qaExpenseId]=r,window._secureSet(`toto_qa_last`,String(_qaExpenseId)),window.saveData(g),Tc(),window.renderAll();let a=document.getElementById(`qa-fab`);a&&(a.textContent=`✓`,a.style.background=`#10b981`,setTimeout(()=>{a.textContent=`+`,a.style.background=``},1800))}window.addEventListener(`resize`,()=>{document.querySelectorAll(`.section-pills-wrap`).forEach(_updatePillsOverflow)}),document.querySelectorAll(`.nav-item, .nav-text-item`).forEach(e=>{e.addEventListener(`click`,()=>activateTab(e.dataset.tab))});function Pc(){let e=window._activeProfile?.role===`child`;document.body.classList.toggle(`kid-mode`,e);let t=document.getElementById(`kid-banner-label`);t&&e&&(t.textContent=`${window._activeProfile.emoji||`😊`} ${window._activeProfile.name}'s view`);let n=window.getDeviceProfile(),r=document.getElementById(`header-switch-profile`);if(r){let t=n&&n!==`adult`;if(r.style.display=t?``:`none`,t)if(e)r.textContent=`👨‍👩‍👧 Parent`;else{let e=(g.kids?.profiles||[]).find(e=>e.id===n);r.textContent=e?`Back to ${e.name}`:`Switch`}}}function Fc(){let e=window.getDeviceProfile();if(window._activeProfile?.role===`child`)window.clearKidSession(),window._activeProfile=null,Pc(),window.renderAll();else if(e===`shared`)window.showProfileSelector();else if(e&&e!==`adult`){let t=(g.kids?.profiles||[]).find(t=>t.id===e);t&&(t.pinHash?(window._pinTargetId=t.id,window._pinBuffer=``,window._pinAttempts=0,window._showPinScreen(t)):(window._activeProfile={id:t.id,name:t.name,emoji:t.emoji,role:`child`},window.setKidSession(t.id),window._applyActiveProfile()))}}async function Ic(e,t){let n=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));!n||t.length!==4||(n.pinHash=await window._hashPin(t,window._getHouseholdOwnerUID()),window.saveData(g))}function Lc(e){let t=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(delete t.pinHash,window.saveData(g))}function Rc(e){(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[e]&&(Bc=e,Hc=``,Uc=``,Vc=`enter`,Wc(),document.getElementById(`adult-pin-modal`).classList.remove(`hidden`))}function zc(e){let t=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name);t[e]&&(delete t[e].pinHash,window.saveData(g),renderSettings())}var Bc=0,Vc=`enter`,Hc=``,Uc=``;function Wc(){let e=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[Bc];if(!e)return;let t=Vc===`enter`,n=t?e.pinHash?`Change your PIN 🔢`:`Set your PIN 🔢`:`Confirm your PIN ✅`,r=t?`Pick 4 numbers — used on shared devices`:`Enter it again to confirm`,i=[0,1,2,3].map(e=>{let t=e<Uc.length;return`<div style="width:52px;height:60px;border:2px solid ${t?`#0891b2`:`#e2e8f0`};border-radius:10px;background:${t?`#ecfeff`:`#f8fafc`};display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:700;color:#0891b2">${t?`●`:``}</div>`}).join(``),a=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div></div>`:`<div onclick="_adultPinKey('${e}')" style="height:52px;border:1.5px solid #e2e8f0;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:600;color:#374151;cursor:pointer;background:#fff;-webkit-tap-highlight-color:transparent;user-select:none">${e}</div>`).join(``);document.getElementById(`adult-pin-modal-body`).innerHTML=`
    ...
    <button onclick="document.getElementById('adult-pin-modal').classList.add('hidden')" style="font-size:13px;color:#94a3b8;background:none;border:none;cursor:pointer">Cancel</button>`}function Gc(e){if(e===`⌫`){Uc=Uc.slice(0,-1),Wc();return}Uc.length>=4||(Uc+=e,Wc(),Uc.length===4&&Kc())}async function Kc(){if(Vc===`enter`)Hc=Uc,Uc=``,Vc=`confirm`,Wc();else{if(Uc!==Hc){Uc=``,Hc=``,Vc=`enter`,Wc();let e=document.getElementById(`adult-pin-error`);e&&(e.textContent=`Those didn't match — try again`);return}let e=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name);e[Bc].pinHash=await window._hashPin(Uc,window._getHouseholdOwnerUID()),window.saveData(g),document.getElementById(`adult-pin-modal`).classList.add(`hidden`),renderSettings()}}function qc(e){let t=Number(e.age||0);return t<5?`tiny-tots`:t<8?`early-reader`:t<12?`independent`:`tween`}function Jc(){let e=new Date().getHours();return e<12?`Good morning`:e<17?`Good afternoon`:`Good evening`}function Yc(e){if(!e.triggerTime)return!0;let[t,n]=e.triggerTime.split(`:`).map(Number),r=new Date,i=r.getHours()*60+r.getMinutes(),a=t*60+(n||0),o=a+360;return i>=a&&i<o}function Xc(e){if(!e.triggerTime)return``;let[t]=e.triggerTime.split(`:`).map(Number);return t<12?`Available this morning`:t<17?`Available this afternoon`:`Available tonight`}function Zc(){let e=document.getElementById(`child-view-overlay`);if(!e)return;let t=document.getElementById(`cv-confetti-wrap`);t&&t.remove(),t=document.createElement(`div`),t.id=`cv-confetti-wrap`,t.className=`cv2-confetti-wrap`,e.appendChild(t);let n=[`#5B4CF5`,`#7C3AED`,`#F59E0B`,`#10B981`,`#F43F5E`,`#FBBF24`];for(let e=0;e<60;e++){let r=document.createElement(`div`);r.className=`cv2-confetti-particle`,r.style.cssText=`
    ...
    `,t.appendChild(r)}setTimeout(()=>{t.parentNode&&t.remove()},3500)}function Qc(e){let t=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));if(!t)return;tl=e,nl=`today`;let n=g.kids,r=kidBalance(n,t.id),i=qc(t),a=i===`tiny-tots`,o=i===`tween`,s=_cvReadOnly,c=document.getElementById(`child-view-overlay`);document.getElementById(`cv-avatar`).textContent=t.emoji||`😊`,document.getElementById(`cv-name`).innerHTML=`<span class="ember-text">${T(t.name)}</span>`,document.getElementById(`cv-greeting`).textContent=Jc()+`!`;let l=(n.completions||[]).filter(e=>e.kidId===t.id&&e.status===`approved`&&new Date(e.completedAt||e.ts).toDateString()===new Date().toDateString()).reduce((e,t)=>e+((n.chores||[]).find(e=>e.id===t.choreId)?.points||0),0),u=document.getElementById(`cv-nudge`);l>0&&!a&&!s?(u.textContent=`You've earned ⭐ ${l} points today — keep going!`,u.style.display=``):u.style.display=`none`,c.className=c.className.replace(/cv2-age-\S+/g,``).trim(),i===`early-reader`&&c.classList.add(`cv2-age-early`),a&&c.classList.add(`cv2-age-tiny`),o&&c.classList.add(`cv2-age-tween`);let d=document.getElementById(`cv-nav`);d&&(d.style.display=a?`none`:``),document.getElementById(`cv-nav-today`)?.classList.add(`active`),document.getElementById(`cv-nav-calendar`)?.classList.remove(`active`),document.getElementById(`cv-nav-prizes`)?.classList.remove(`active`),$c(t);let f=new Date().toISOString().slice(0,10),p=(g.routineAssignments||[]).filter(e=>{if(e.childId!==t.id)return!1;let n=(g.routines||[]).find(t=>t.id===e.routineId);return n&&_routineMatchesDate(n,f)}),m=_routineTodayKey(),h=``,_=0,v=0;p.length&&p.forEach(e=>{let n=(g.routines||[]).find(t=>t.id===e.routineId);if(!n)return;let r=e.completionState?.[m]||[],i=n.steps.length,o=i>0?Math.round(r.length/i*100):0,c=r.length===i&&i>0,l=Yc(n);v+=i,_+=r.length;let u=l?``:Xc(n),d=_assignmentStreak(e,i),f=_assignmentHistory(e,i,7).filter(e=>e.done===e.total&&e.total>0).length;if(h+=`<div class="cv2-card${l?``:` cv2-card--locked`}" style="margin-bottom:10px">
    ...
    </div>`}let j=(n.notifications||[]).filter(e=>e.kidId===t.id&&!e.read),ae=``;j.length&&!s&&(ae=j.map(e=>{let n=e.type===`prize_approved`;return`<div class="cv2-notif-bar ${n?`cv2-notif-bar--approved`:`cv2-notif-bar--declined`}">
      ...
      </div>`}).join(``));let M=v>0&&_===v,N;M&&!s?N=`<div class="cv2-celebration">
    ...
    ${ne}${O}${ie}`:(N=ae,i!==`tiny-tots`&&!s&&(N+=`<button class="cv2-week-shortcut" onclick="_cvSwitchTab('calendar','${t.id}')">📅 See my week →</button>`),p.length&&(N+=`<div class="cv2-group">
      ...
      </div>`),N+=ne,N+=O,N+=ie),document.getElementById(`cv-content`).innerHTML=N,c.classList.remove(`hidden`),c.style.display=`flex`,M&&!s&&Zc()}function $c(e){let t=document.getElementById(`cv-prizes-badge`);if(!t)return;let n=g.kids,r=kidBalance(n,e.id),i=(n.notifications||[]).filter(t=>t.kidId===e.id&&!t.read).length,a=(n.prizes||[]).filter(e=>r>=e.pointCost).length,o=i+(a>0&&i===0?a:0);o>0?(t.textContent=o>9?`9+`:String(o),t.style.display=``):t.style.display=`none`}function el(e){let t=g.kids,n=kidBalance(t,e.id),r=qc(e)===`tiny-tots`,i=_cvReadOnly,a=t.prizes||[],o=!1;(t.notifications||[]).filter(t=>t.kidId===e.id&&!t.read).forEach(e=>{e.read=!0,o=!0}),o&&window.saveData(g),$c(e);let s=r?`${`⭐`.repeat(Math.min(n,10))}${n>10?`+`:``}`:`${n}`,c=`<div class="cv2-prizes-balance">
    ...
    <span class="cv2-prizes-balance-emoji">🏆</span>
      ...
      </div>`}),c+=`</div>`);let u=document.getElementById(`cv-content`);u&&(u.innerHTML=c)}var tl=null,nl=`today`,rl=`7day`,il=null,al=new Set;function ol(e,t){t&&(tl=t);let n=(g.kids?.profiles||[]).find(e=>String(e.id)===String(tl));if(!n)return;let r=qc(n),i=document.getElementById(`cv-nav`);i&&(i.style.display=r===`tiny-tots`?`none`:``),document.getElementById(`cv-nav-today`)?.classList.toggle(`active`,e===`today`),document.getElementById(`cv-nav-calendar`)?.classList.toggle(`active`,e===`calendar`),document.getElementById(`cv-nav-prizes`)?.classList.toggle(`active`,e===`prizes`),e===`today`?Qc(tl):e===`prizes`?el(n):(il=null,ml(n))}function sl(e,t){let n=(g.routineAssignments||[]).filter(t=>t.childId===e.id).map(e=>{let n=(g.routines||[]).find(t=>t.id===e.routineId);return n&&_routineMatchesDate(n,t)?{type:`routine`,routine:n,assignment:e,label:n.name,emoji:n.emoji,color:`#7C3AED`,tag:`Routine`,time:n.triggerTime||null}:null}).filter(Boolean),r=(g.childEvents||[]).filter(n=>{let r=Array.isArray(n.assignedTo)?n.assignedTo:[n.assignedTo];return r.includes(e.id)||r.includes(`all`)||n.isHouseholdWide?n.recurrence?Nt(n.recurrence,t):n.date===t:!1}).map(e=>({type:`event`,label:e.title,emoji:e.emoji||`📅`,color:`#10b981`,tag:`Event`,notes:e.notes,time:e.time||null})),i=(g.planner?.events||[]).filter(e=>Gt(e).includes(`everyone`)?e.recurrence&&e.recurrence.type!==`one_time`?Nt(e.recurrence,t):e.endDate&&e.endDate>e.date?t>=e.date&&t<=e.endDate:e.date===t:!1).map(e=>({type:`event`,label:e.title,emoji:I[e.category]?.emoji||`📅`,color:`#10b981`,tag:`Event`,notes:e.notes||``,time:e.time||null}));return{routines:n,events:[...r,...i],chores:(g.kids?.chores||[]).filter(t=>(t.assignedTo===e.id||t.assignedTo===`all`)&&!t._isRoutine).map(e=>({type:`chore`,label:e.name,emoji:e.emoji||`📋`,color:`#ec4899`,tag:`Chore`,time:null}))}}function cl(e){if(!e)return``;let[t,n]=e.split(`:`).map(Number);return`${t%12||12}:${String(n).padStart(2,`0`)} ${t>=12?`pm`:`am`}`}function ll(e){al.has(e)?al.delete(e):al.add(e);let t=(g.kids?.profiles||[]).find(e=>String(e.id)===String(tl));t&&(rl===`7day`||qc(t)===`early-reader`?dl(t,new Date().toISOString().slice(0,10)):dl(t,il))}function ul(e,t,n){if(_cvReadOnly)return;let r=_routineGetAssignment(e,tl);if(!r)return;r.completionState||(r.completionState={});let i=n;r.completionState[i]||(r.completionState[i]=[]);let a=r.completionState[i].indexOf(t),o=a===-1;o?r.completionState[i].push(t):r.completionState[i].splice(a,1);let s=new Date().toISOString().slice(0,10);if(o&&n===s){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(n){let e=n.steps.find(e=>e.id===t);(e?.points||0)>0&&_routineAwardStepPoints(n,e,tl);let a=n.steps.length;r.completionState[i].length===a&&a>0&&(n.pointsPerCompletion||0)>0&&_routineAwardPoints(n,tl)}}window.saveData(g);let c=(g.kids?.profiles||[]).find(e=>String(e.id)===String(tl));c&&dl(c,n)}function dl(e,t){let n=rl===`month`?`cv-day-panel`:`cv-schedule-panel`,r=document.getElementById(n);r&&(r.innerHTML=fl(e,t))}function fl(e,t){if(!t)return``;let{routines:n,events:r,chores:i}=sl(e,t),a=t;if(!n.length&&!r.length&&!i.length)return`<div style="text-align:center;padding:28px 0;color:#A1A1AA;font-size:13px">Nothing scheduled</div>`;let o=[...n.map(e=>({...e,sortKey:e.time||`23:59`})),...r.map(e=>({...e,sortKey:e.time||`23:59`}))].sort((e,t)=>e.sortKey.localeCompare(t.sortKey)),s=``;return o.length&&(s+=`<div class="cv-sched-section-hdr">Schedule</div>`,o.forEach(e=>{e.type===`routine`?s+=pl(e.routine,e.assignment,a):s+=`<div class="cv-sched-item">
          <div class="cv-sched-row">
            <span class="cv-sched-time">${e.time?cl(e.time):``}</span>
      ...
      </div>`})),s}function pl(e,t,n){let r=t.completionState?.[n]||[],i=e.steps.length,a=i>0?Math.round(r.length/i*100):0,o=r.length===i&&i>0,s=al.has(e.id),c=i>0?`
    ...
    <div class="cv-sched-row" style="cursor:pointer" onclick="_cvToggleRoutineExpand(${JSON.stringify(e.id)})">
      <span class="cv-sched-time">${e.triggerTime?cl(e.triggerTime):``}</span>
      <div class="cv-sched-color-bar" style="background:#7C3AED"></div>
      <span class="cv-sched-emoji">${e.emoji}</span>
      <div class="cv-sched-body">
        <div class="cv-sched-title">${T(e.name)}</div>
        ${o?`<div class="cv-sched-sub" style="color:#5B4CF5;font-weight:700">✓ Complete</div>`:e.triggerTime?`<div class="cv-sched-sub">${cl(e.triggerTime)}</div>`:``}
      </div>
      ${c}
      <button class="cv-sched-expand-btn">${s?`▲`:`▼`}</button>
    </div>
    ${l}
  </div>`}function ml(e){if(!e)return;let t=qc(e)===`early-reader`,n=t?`7day`:rl,r=new Date().toISOString().slice(0,10),i=document.getElementById(`cv-content`);if(!i)return;let a=``;t||(a+=`<div style="display:flex;gap:8px;margin-bottom:14px">
    ...
    </div>`),a+=n===`7day`?gl(e,r):vl(e,r),i.innerHTML=a}function hl(e,t){rl=e,il=null;let n=(g.kids?.profiles||[]).find(e=>String(e.id)===String(t));n&&ml(n)}function gl(e,t){let n=[`S`,`M`,`T`,`W`,`T`,`F`,`S`],r=new Date(t+`T12:00:00`),i=`<div class="cv-week-strip">`;for(let a=0;a<7;a++){let o=new Date(r);o.setDate(r.getDate()+a);let s=o.toISOString().slice(0,10),c=s===t,{routines:l,events:u,chores:d}=sl(e,s),f=[...l,...u,...d].slice(0,3).map(e=>`<div class="cv-cal-dot" style="background:${e.color}"></div>`).join(``);i+=`<div class="cv-week-cell ${c?`cv-today`:``}" onclick="_cvWeekDayTap('${s}','${e.id}')">
    ...
    </div>`}i+=`</div>`;let a=new Date(t+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`});return i+=`<div style="font-size:13px;font-weight:700;color:#1e293b;margin:10px 0 2px">${T(a)}</div>`,i+=`<div id="cv-schedule-panel">${fl(e,t)}</div>`,i}function _l(e,t){let n=(g.kids?.profiles||[]).find(e=>String(e.id)===String(t));if(!n)return;al.clear(),document.querySelectorAll(`.cv-week-cell`).forEach(t=>{t.classList.toggle(`cv-today`,t.getAttribute(`onclick`)?.includes(`'${e}'`))});let r=new Date(e+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`}),i=document.getElementById(`cv-schedule-panel`);i&&(i.previousElementSibling.textContent=r,i.innerHTML=fl(n,e))}function vl(e,t){let n=new Date(t+`T12:00:00`),r=n.getFullYear(),i=n.getMonth(),a=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`],o=[`S`,`M`,`T`,`W`,`T`,`F`,`S`],s=new Date(r,i,1).getDay(),c=new Date(r,i+1,0).getDate(),l=il||t,u=`<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
    <span style="font-size:14px;font-weight:800;color:#18181B">${a[i]} ${r}</span>
  </div>`;u+=`<div class="cv-cal-grid">`,o.forEach(e=>{u+=`<div class="cv-cal-day-hdr">${e}</div>`});for(let e=0;e<s;e++)u+=`<div class="cv-cal-cell cv-other"></div>`;for(let n=1;n<=c;n++){let a=`${r}-${String(i+1).padStart(2,`0`)}-${String(n).padStart(2,`0`)}`,o=a===t,s=a===l,{routines:c,events:d,chores:f}=sl(e,a),p=[...c,...d,...f].slice(0,3).map(e=>`<div class="cv-cal-dot" style="background:${e.color}"></div>`).join(``);u+=`<div class="cv-cal-cell ${o?`cv-today`:``} ${s&&!o?`cv-cal-cell--sel`:``}" onclick="_cvMonthDayTap('${a}','${e.id}')">
    ...
    <div id="cv-day-panel">${fl(e,l)}</div>
  </div>`,u}function yl(e,t){il=e,al.clear();let n=(g.kids?.profiles||[]).find(e=>String(e.id)===String(t));n&&ml(n)}function bl(e,t){yl(e,t)}function xl(e,t){let n=(g.kids?.notifications||[]).find(t=>t.id===e);n&&(n.read=!0),window.saveData(g),Qc(t)}function Sl(e,t){let n=(g.kids?.prizes||[]).find(e=>String(e.id)===String(t));if(!n)return;let r=`<div class="cv2-confirm">
    ...
    </div>`}function Bl(e){let t=e?(g.meals.lunchbox.profiles||[]).find(t=>t.id===e):null;document.getElementById(`modal-title`).textContent=t?`Edit ${T(t.name)}`:`Add Child`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div id="lb-allergies" style="display:flex;flex-wrap:wrap;gap:6px">
        ${Rl.map(e=>{let n=t&&(t.allergies||[]).includes(e);return`<button type="button" class="lb-tag${n?` allergy`:``}" style="cursor:pointer;${n?``:`background:var(--surface2);color:var(--text-muted);border:1px solid var(--border)`}"
    ...
    <button class="btn btn-primary" onclick="_saveLbSlot('${e}',${t},${n},'${r}',document.getElementById('lb-input').value.trim())">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`),setTimeout(()=>{let e=document.getElementById(`lb-input`);e&&(e.focus(),e.select())},80)}function Wl(e,t,n,r,i){g.meals.lunchbox.plans[e]||(g.meals.lunchbox.plans[e]={}),g.meals.lunchbox.plans[e][t]||(g.meals.lunchbox.plans[e][t]={}),g.meals.lunchbox.plans[e][t][n]||(g.meals.lunchbox.plans[e][t][n]={}),g.meals.lunchbox.plans[e][t][n][r]=i,delete g.meals.lunchbox.plans[e][t][n][`cal_`+r],window.saveData(g),window.closeModal(),zl(),i&&g.settings?.showCalories&&Gl(e,t,n,r,i)}async function Gl(e,t,n,r,i){let a=localStorage.getItem(`toto_ai_key`);if(!(!a||!i))try{let o=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":a,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:50,messages:[{role:`user`,content:`Estimate the calories in this school lunch item: "${i}". Return ONLY a number, nothing else. For example: 250`}]})});if(!o.ok)return;let s=await o.json(),c=parseInt(s.content[0].text.trim().replace(/[^0-9]/g,``));c>0&&c<3e3&&g.meals.lunchbox.plans[e]?.[t]?.[n]&&(g.meals.lunchbox.plans[e][t][n][`cal_`+r]=c,window.saveData(g),zl())}catch{}}async function Kl(e,t){let n=localStorage.getItem(`toto_ai_key`);if(!n)return;let r=(g.meals.lunchbox.profiles||[]).find(e=>e.id===t);if(!r)return;let i=document.getElementById(`lb-ai-btn`);i&&(i.textContent=`Planning...`,i.disabled=!0);let a=`Plan 5 days (Monday to Friday) of school lunches for a child:
...
No markdown, no code fences, just raw JSON.`;try{let r=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":n,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:a}]})});if(!r.ok)throw Error(`API ${r.status}`);let i=(await r.json()).content[0].text.replace(/```[\w]*\n?/g,``).trim().match(/\[[\s\S]*\]/);if(!i)throw Error(`No JSON`);let o=JSON.parse(i[0]);g.meals.lunchbox.plans[e]||(g.meals.lunchbox.plans[e]={}),g.meals.lunchbox.plans[e][t]||(g.meals.lunchbox.plans[e][t]={}),o.forEach(n=>{let r={main:n.main||``,snack:n.snack||``,fruit:n.fruit||``,drink:n.drink||``};n.cal_main&&(r.cal_main=n.cal_main),n.cal_snack&&(r.cal_snack=n.cal_snack),n.cal_fruit&&(r.cal_fruit=n.cal_fruit),n.cal_drink&&(r.cal_drink=n.cal_drink),g.meals.lunchbox.plans[e][t][n.day]=r}),window.saveData(g),zl()}catch(e){console.error(`Lunchbox AI error:`,e),i&&(i.textContent=`Plan this week`,i.disabled=!1)}}function ql(e,t){let n=(g.meals.lunchbox.plans[e]||{})[t]||{},r=new Set;Object.values(n).forEach(e=>{e.main&&r.add(e.main),e.snack&&r.add(e.snack),e.fruit&&r.add(e.fruit)}),g.lists||(g.lists={}),g.lists.food||(g.lists.food={items:[],weeklyBudget:200,budget:0,stores:[],favourites:[],history:[]});let i=g.lists.food.items,a=0;r.forEach(e=>{i.some(t=>t.name.toLowerCase()===e.toLowerCase()&&t.state===`active`)||(i.push({id:`si-lb-`+Date.now()+`-`+a,name:e,quantity:1,unit:`units`,notes:``,aisle:_inferAisle?_inferAisle(e):`other`,state:`active`,addedBy:`lunchbox`,addedAt:new Date().toISOString(),mealTag:`Lunchbox`,manualPrice:null,barcodeId:null}),a++)}),a>0&&(window.saveData(g),_listsActiveType=`food`,_listsView=`list`,activateTab(`lists`));let o=document.querySelector(`[onclick^="lbToShoppingList"]`);if(o){let e=o.textContent;o.textContent=`Added ${a} items`,o.style.color=`var(--success)`,setTimeout(()=>{o.textContent=e,o.style.color=``},2e3)}}function Jl(e){let t=document.querySelector(`.health-popover`);if(t){t.remove();return}let n=window._lastHealth;if(!n)return;let r=window._lastHealthGuides||[`savings`,`tracking`,`netWorth`,`emergency`,`goals`],i={A:`#10b981`,B:`#0891b2`,C:`#f59e0b`,D:`#f97316`,F:`#ef4444`},a={A:`Excellent`,B:`Good`,C:`Fair — some areas need work`,D:`Needs attention`,F:`Critical — take action`},o={"Savings Rate":n.dimensions[0].score>=15?`Healthy savings rate`:n.dimensions[0].score>=8?`Could save more each month`:`Very little being saved`,"Budget Tracking":n.dimensions[1].score>=15?`Consistently logging actuals`:n.dimensions[1].score>=8?`Some months tracked`:`Not tracking actual spending`,"Net Worth":n.dimensions[2].score>=15?`Assets outweigh liabilities`:n.dimensions[2].score>=8?`Building slowly`:`Liabilities are high or no data`,"Emergency Buffer":n.dimensions[3].score>=15?`3+ months of expenses covered`:n.dimensions[3].score>=8?`Some buffer building`:`Less than 1 month covered`,Goals:n.dimensions[4].score>=15?`Goals set and progressing`:n.dimensions[4].score>=8?`Goals need more progress`:`No active goals set`},s=``;n.dimensions.forEach((e,t)=>{let n=Math.round(e.score/e.max*100),i=n>=75?`#10b981`:n>=50?`#f59e0b`:`#ef4444`,a=o[e.label]||``,c=r[t],l=e.score<15&&HEALTH_GUIDES[c];s+=`<div class="health-dim">
    ...
    ${s}`,document.body.appendChild(c);let l=e.getBoundingClientRect(),u=l.bottom+10,d=l.left+l.width/2-150;d<12&&(d=12),d+300>window.innerWidth-12&&(d=window.innerWidth-312),u+c.offsetHeight>window.innerHeight-12&&(u=l.top-c.offsetHeight-10),c.style.top=u+`px`,c.style.left=d+`px`,setTimeout(()=>{let t=n=>{!c.contains(n.target)&&n.target!==e&&(c.remove(),document.removeEventListener(`click`,t))};document.addEventListener(`click`,t)},10)}var Yl=[],Xl=0,Zl=null;function Ql(e){Yl=e,Xl=0,$l()}function $l(){if(ru(),Xl>=Yl.length){nu();return}let e=Yl[Xl];e.tab&&_activeTab()!==e.tab?(activateTab(e.tab),setTimeout(()=>eu(e),500)):setTimeout(()=>eu(e),100)}function eu(e){let t=e.el?typeof e.el==`string`?document.querySelector(e.el):e.el:null,n=document.createElement(`div`);n.className=`guide-overlay`,n.onclick=()=>nu(),document.body.appendChild(n);let r=null,i=null;t&&(t.scrollIntoView({behavior:`smooth`,block:`center`}),i=t.getBoundingClientRect(),r=document.createElement(`div`),r.className=`guide-spotlight guide-pulse`,r.style.cssText=`top:${i.top-6}px;left:${i.left-6}px;width:${i.width+12}px;height:${i.height+12}px;`,document.body.appendChild(r));let a=document.createElement(`div`);if(a.className=`guide-tooltip`,a.innerHTML=`
    <div class="guide-tooltip-step">Step ${Xl+1} of ${Yl.length}</div>
    ...
    <div class="guide-tooltip-actions">
      ...
      ${Xl<Yl.length-1?`<button class="guide-tooltip-btn" style="background:#0891b2;color:#fff" onclick="nextGuideStep()">Next</button>`:`<button class="guide-tooltip-btn" style="background:#0891b2;color:#fff" onclick="endGuide()">Done</button>`}
    </div>`,a.onclick=e=>e.stopPropagation(),document.body.appendChild(a),i){let e=a.offsetWidth,t=a.offsetHeight,n=i.bottom+14,r=i.left+i.width/2-e/2;r<12&&(r=12),r+e>window.innerWidth-12&&(r=window.innerWidth-e-12),n+t>window.innerHeight-12&&(n=i.top-t-14),a.style.top=n+`px`,a.style.left=r+`px`}else a.style.top=`50%`,a.style.left=`50%`,a.style.transform=`translate(-50%, -50%)`;if(Zl=()=>{n.remove(),r&&r.remove(),a.remove()},e.watchClick&&t){let e=()=>{t.removeEventListener(`click`,e),setTimeout(()=>tu(),400)};t.addEventListener(`click`,e)}}function tu(){Xl++,$l()}function nu(){ru(),Yl=[],Xl=0}function ru(){Zl&&(Zl(),Zl=null)}var iu={emergency:[{tab:`goals`,title:`Create an Emergency Fund`,text:`An emergency fund covers 3-6 months of expenses. Let's set one up as a savings goal.`,el:null},{tab:`goals`,title:`Tap "+ New Goal"`,text:`This button creates a new savings goal. Set the name to "Emergency Fund" and the target to your 3-month expenses.`,el:`[onclick*="openAddGoal"]`,watchClick:!0}],savings:[{tab:`budget`,title:`Improve your savings rate`,text:`Your savings rate is the gap between income and expenses. To improve it, you can either reduce expenses or increase income.`,el:null},{tab:`budget`,title:`Review your expenses`,text:`Look through your expenses below. Are there any you could reduce? Tap any expense to edit it.`,el:`#budget-content`}],tracking:[{tab:`budget`,title:`Track your actual spending`,text:`Recording what you actually spend helps you stay on track. You can import your bank statement or log spends manually.`,el:null},{tab:`budget`,title:`Import transactions`,text:`Tap "Import Transactions" to upload a bank CSV, or use the + button to log individual spends.`,el:`[onclick*="openCsvImport"]`,watchClick:!0}],netWorth:[{tab:`networth`,title:`Build your net worth picture`,text:`Add what you own (property, savings, super) as assets. Add what you owe (mortgage, loans, credit cards) as liabilities.`,el:null},{tab:`networth`,title:`Start adding`,text:`Use the buttons below to add your first asset or liability. Even rough numbers help build the picture.`,el:`#networth-content`}],goals:[{tab:`goals`,title:`Set a financial goal`,text:`Goals keep you motivated — a holiday fund, debt payoff, or savings target. Let's create your first one.`,el:null},{tab:`goals`,title:`Tap "+ New Goal"`,text:`Choose a goal type, set a target amount, and start tracking your progress.`,el:`[onclick*="openAddGoal"]`,watchClick:!0}]};function au(e){let t=iu[e];t&&Ql(t)}var ou=!1;function su(e){ou=!0;let t=document.getElementById(`cv-readonly-bar`),n=document.getElementById(`cv-signout-btn`);t&&(t.style.display=``),n&&(n.style.display=`none`),window.showChildView(e)}function cu(e){ou=!0;let t=document.getElementById(`cv-readonly-bar`),n=document.getElementById(`cv-signout-btn`);t&&(t.style.display=``),n&&(n.style.display=`none`),window.showChildView(e),setTimeout(()=>{_cvSwitchTab(`calendar`,e)},50)}function lu(){let e=document.getElementById(`child-view-overlay`);e.classList.add(`hidden`),e.style.display=``;let t=document.getElementById(`cv-readonly-bar`),n=document.getElementById(`cv-signout-btn`);t&&(t.style.display=`none`),n&&(n.style.display=``);let r=ou;ou=!1,r||(window._activeProfile=null,window.clearKidSession(),window.switchProfile())}function uu(){let e=Number(g.settings?.routineResetHour??0),t=new Date,n=new Date(t);n.setHours(e,0,0,0),t<n&&n.setDate(n.getDate()-1),n.toISOString().slice(0,10);let r=!1;(g.routineAssignments||[]).forEach(e=>{e.completionState&&Object.keys(e.completionState).forEach(e=>{})});let i=t.toISOString().slice(0,10);if(g.settings?.lastRoutineResetCheck!==i){if(g.settings||(g.settings={}),g.settings.lastRoutineResetCheck=i,g.kids?.completions){let e=g.kids.completions.length;g.kids.completions=g.kids.completions.filter(e=>e.status===`pending`?new Date(e.completedAt||e.ts||0).toISOString().slice(0,10)>=i:!0),g.kids.completions.length!==e&&(r=!0)}r=!0}r&&window.saveData(g)}function du(e,t){return!e||(e.pausePeriods||[]).some(e=>t>=e.from&&(!e.to||t<=e.to))||(e.skippedDates||[]).includes(t)?!1:Nt(e.recurrence||null,t)}var fu={morning:[{label:`Make bed`,emoji:`🛏`,durationMin:2},{label:`Shower`,emoji:`🚿`,durationMin:10},{label:`Breakfast`,emoji:`🍳`,durationMin:15},{label:`Exercise`,emoji:`💪`,durationMin:20},{label:`Meditate`,emoji:`🧘`,durationMin:10},{label:`Plan the day`,emoji:`📋`,durationMin:5},{label:`Read`,emoji:`📚`,durationMin:15},{label:`Vitamins`,emoji:`💊`,durationMin:1},{label:`Walk`,emoji:`🚶`,durationMin:20},{label:`Journaling`,emoji:`✍️`,durationMin:10}],evening:[{label:`Tidy kitchen`,emoji:`🍽`,durationMin:10},{label:`Prep tomorrow`,emoji:`👔`,durationMin:5},{label:`Family time`,emoji:`👨‍👩‍👧`,durationMin:30},{label:`Read`,emoji:`📚`,durationMin:20},{label:`Lights out`,emoji:`💤`,durationMin:0},{label:`Stretch`,emoji:`🤸`,durationMin:10},{label:`Review the day`,emoji:`🪞`,durationMin:5},{label:`Skincare`,emoji:`🧴`,durationMin:5},{label:`No screens`,emoji:`📵`,durationMin:0},{label:`Brush teeth`,emoji:`🦷`,durationMin:3}],general:[{label:`Drink water`,emoji:`💧`,durationMin:1},{label:`Check messages`,emoji:`📱`,durationMin:5},{label:`Quick tidy`,emoji:`🧹`,durationMin:5},{label:`Gratitude`,emoji:`🙏`,durationMin:3}]};function pu(e){let t=e||new Date;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`}function U(){return pu(new Date)}function mu(){return window._currentUser?.uid||`guest`}function hu(){let e=mu();return(g.routines||[]).filter(t=>t.ownerType===`adult`&&(t.ownerId===e||(t.sharedWith||[]).includes(e)))}function gu(){return(g.routines||[]).filter(e=>e.ownerType===`household`)}function _u(e){return e.ownerId===mu()}function vu(){return g.kids?.profiles||[]}function yu(){return Date.now().toString(36)+Math.random().toString(36).slice(2)}function bu(){return mu(),(g.householdProfile?.authorizedUsers||[]).filter(e=>e.uid!==window.uid)}function xu(e,t){return(g.routineAssignments||[]).find(n=>n.routineId===e&&n.childId===t)}function Su(e){return(e?.completionState?.[U()]||[]).length}function Cu(e,t){if(!e)return 0;let n=0,r=new Date;for(;(e.completionState?.[pu(r)]||[]).length===t&&t>0;)n++,r.setDate(r.getDate()-1);return n}function wu(e,t,n){let r=[],i=new Date;for(let a=n-1;a>=0;a--){let n=new Date(i);n.setDate(i.getDate()-a);let o=pu(n),s=(e?.completionState?.[o]||[]).length;r.push({key:o,label:n.getDate(),done:s,total:t})}return r}function Tu(e){return(e.completions?.[U()]||[]).length}function Eu(e){let t=0,n=new Date;for(;(e.completions?.[pu(n)]||[]).length===e.steps.length&&e.steps.length>0;)t++,n.setDate(n.getDate()-1);return t}function Du(e,t){let n=[],r=new Date;for(let i=t-1;i>=0;i--){let t=new Date(r);t.setDate(r.getDate()-i);let a=pu(t),o=(e.completions?.[a]||[]).length;n.push({key:a,label:t.getDate(),done:o,total:e.steps.length})}return n}function Ou(e){let t=new Set(e.steps.map(e=>e.label.toLowerCase())),n=e.name.toLowerCase(),r;return r=n.includes(`morning`)?[...fu.morning,...fu.general]:n.includes(`evening`)||n.includes(`night`)||n.includes(`bed`)?[...fu.evening,...fu.general]:[...fu.morning,...fu.evening,...fu.general],r.filter(e=>!t.has(e.label.toLowerCase()))}function ku(e){if(e.ownerType===`household`){if(e.ownerId!==`household`)throw Error(`Scope violation: household routine has ownerId="${e.ownerId}"`)}else if(e.ownerType===`adult`){if(!e.ownerId||e.ownerId===`household`)throw Error(`Scope violation: adult routine has ownerId="${e.ownerId}"`)}else throw Error(`Scope violation: unknown ownerType="${e.ownerType}"`)}function Au(e){(g.routines||[]).forEach(t=>{try{ku(t)}catch(n){console.error(`[Routines] ${e}:`,n.message,t)}}),window.saveData(g)}function ju(){let e=hu(),t=new Date().getHours();for(let n of e){let e=Tu(n),r=n.steps.length;if(!r)continue;let[i]=(n.triggerTime||`00:00`).split(`:`).map(Number),a=Eu(n);if(t>=i+1&&e===0)return{icon:n.emoji,text:`Your ${n.name} routine hasn't been started yet.`};if(a>0&&a%7==0)return{icon:`🔥`,text:`${a}-day streak on your ${n.name} routine — keep it up!`};if(e>0&&e===r-1)return{icon:n.emoji,text:`One step left in your ${n.name} routine!`}}return null}function Mu(){let e=new Date().toISOString().slice(0,10),t=hu().filter(t=>du(t,e));if(!t.length)return``;let n=new Date().getHours(),r=t.map(e=>{let t=Tu(e),r=e.steps.length,i=r>0?Math.round(t/r*100):0,[a]=(e.triggerTime||`00:00`).split(`:`).map(Number),o=n>=a+1&&t===0&&r>0;return`<div class="routine-today-row">
    ...
    </div>`}).join(``),i=ju();return`${i?`<div class="routine-intel-nudge" onclick="activateTab('routines')" style="margin-bottom:8px">
  ...
  </div>`}var Nu=`mine`;Object.defineProperty(window,`_routineActiveTab`,{get(){return Nu},set(e){Nu=e},configurable:!0});function W(){let e=document.getElementById(`routines-content`);if(!e)return;let t=vu(),n=t.length>0,r=`<div class="page-header" style="margin-bottom:4px">
    <h1>Routines</h1>
  ...
  <div style="display:flex;justify-content:flex-end;margin-bottom:16px">
    ...
    </div>`),r+=Nu===`children`&&n?Uu(t):Fu(),e.innerHTML=r}function Pu(e){Nu=e,W()}function Fu(){let e=mu(),t=!1;(g.routines||[]).forEach(n=>{n.ownerType===`adult`&&(n.ownerId===`guest`||n.ownerId===`dev`)&&(n.ownerId=e,t=!0)}),t&&Au(`lazy-uid-claim`);let n=new Date().toISOString().slice(0,10),r=hu().filter(e=>du(e,n)),i=U(),a=``;return r.length?(r.forEach(e=>{let t=_u(e),n=e.linkedType===`join`,r=!t&&(e.sharedWith||[]).includes(window.uid),o=e.completions?.[i]||[],s=e.steps.length,c=s>0?Math.round(o.length/s*100):0,l=o.length===s&&s>0,u=Eu(e),d=e.steps.reduce((e,t)=>e+(t.durationMin||0),0),f=t&&!n,p=``;n?p=`<span class="routine-owner-badge routine-joined-badge">🔗 Joined</span>`:e.linkedType===`duplicate`?p=`<span class="routine-owner-badge">📋 Duplicated</span>`:r&&(p=`<span class="routine-owner-badge routine-shared-badge">👥 Shared with you</span>`);let m=e.steps.map((t,n)=>{let r=o.includes(t.id);return`<div class="routine-step"${f?` draggable="true" data-routine="'${e.id}'" data-step="'${t.id}'" data-idx="${n}"
    ...
    <div class="routine-new-card" onclick="_routineCreate()">
      <span style="font-size:22px">＋</span>
      <span class="routine-new-card-label">Create new routine</span>
    </div>`}var Iu={},Lu={};function Ru(e){Iu[e]=!Iu[e],W()}function zu(e){Lu[e]=!0,W()}function Bu(e){let t=Ou(e);if(!t.length)return``;let n=!Iu[e.id],r=!!Lu[e.id],i=r?t:t.slice(0,3),a=t.length-3,o=e.ownerType===`household`,s=i.map(t=>`
  ...
  </div>`}function Vu(e,t,n,r){window.openModal(`Add step`,`
  ...
  `,()=>{Hu(e,document.getElementById(`rse-label`)?.value.trim()||t,document.getElementById(`rse-emoji`)?.value.trim()||n,parseInt(document.getElementById(`rse-dur`)?.value)||0,parseInt(document.getElementById(`rse-pts`)?.value)||0,document.getElementById(`rse-notes`)?.value.trim()||``)})}function Hu(e,t,n,r,i,a){let o=(g.routines||[]).find(t=>String(t.id)===String(e));if(!o)return;let s=new Set([...o.steps.map(e=>e.id),...Object.values(o.completions||{}).flat(),...(g.routineAssignments||[]).filter(t=>t.routineId===e).flatMap(e=>Object.values(e.completionState||{}).flat())]),c=Math.max(0,...s)+1;for(;s.has(c);)c++;o.steps.push({id:c,label:t,emoji:n,durationMin:r||0,points:i||0,notes:a||``}),sd(o.id,o.steps[o.steps.length-1]),window.saveData(g),W()}function Uu(e){let t=g.routineAssignments||[],n=gu(),r=U();if(!n.length)return`<div style="text-align:center;padding:32px 20px;color:var(--text-muted)">
    ...
    <div class="routine-new-card" onclick="_routineCreate('child')">
      ...
      <span class="routine-new-card-label">Create children's routine</span>
        ...
        ${e.emoji||`👤`} ${T(e.name)}
      </span>`}).join(``),l=o.length?o.map(({kid:e,assignment:t})=>{let n=t.completionState?.[r]||[],i=s>0?Math.round(n.length/s*100):0,a=Cu(t,s),o=n.length===s&&s>0;return`<div style="display:flex;align-items:center;gap:8px;padding:4px 0">
  ...
  `,()=>{let e=document.getElementById(`rp-from`)?.value;if(!e)return;let n=document.getElementById(`rp-to`)?.value||void 0,r=document.getElementById(`rp-reason`)?.value.trim()||void 0;t.pausePeriods.push({from:e,to:n,reason:r}),window.saveData(g),window.closeModal(),W()})}function Qu(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));!n||!n.pausePeriods||(n.pausePeriods.splice(t,1),window.saveData(g),window.closeModal(),W())}function $u(e,t){let n=xu(e,t);n&&(n.completionState&&delete n.completionState[U()],window.saveData(g),W())}function ed(e){let t=U();(g.routineAssignments||[]).filter(t=>t.routineId===e).forEach(e=>{e.completionState&&delete e.completionState[t]}),window.saveData(g),W()}var td=null;Object.defineProperty(window,`_routineDragIdx`,{get(){return td},set(e){td=e},configurable:!0});function nd(e){td=parseInt(e.currentTarget.dataset.idx),e.currentTarget.classList.add(`dragging`),e.dataTransfer.effectAllowed=`move`}function rd(e){e.preventDefault(),e.dataTransfer.dropEffect=`move`,document.querySelectorAll(`.routine-step.drag-over`).forEach(e=>e.classList.remove(`drag-over`)),e.currentTarget.classList.add(`drag-over`)}function id(e,t){e.preventDefault();let n=parseInt(e.currentTarget.dataset.idx);if(td===null||td===n)return;let r=(g.routines||[]).find(e=>String(e.id)===String(t));if(!r)return;let i=r.steps.splice(td,1)[0];r.steps.splice(n,0,i),td=null,window.saveData(g),W()}function ad(e){e.currentTarget.classList.remove(`dragging`),document.querySelectorAll(`.routine-step.drag-over`).forEach(e=>e.classList.remove(`drag-over`)),td=null}function od(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=t.ownerType===`household`;window.openModal(`Add step`,`
    ...
    </div>`,()=>{let r=document.getElementById(`rs-label`)?.value.trim();if(!r)return;let i=new Set([...t.steps.map(e=>e.id),...Object.values(t.completions||{}).flat(),...(g.routineAssignments||[]).filter(t=>t.routineId===e).flatMap(e=>Object.values(e.completionState||{}).flat())]),a=Math.max(0,...i)+1;for(;i.has(a);)a++;let o={id:a,label:r,emoji:document.getElementById(`rs-emoji`)?.value.trim()||`✅`,durationMin:parseInt(document.getElementById(`rs-dur`)?.value)||0,points:n&&parseInt(document.getElementById(`rs-pts`)?.value)||0,notes:document.getElementById(`rs-notes`)?.value.trim()||``};t.steps.push(o),sd(t.id,o),window.saveData(g),window.closeModal(),W()}),setTimeout(()=>document.getElementById(`rs-label`)?.focus(),100)}function sd(e,t){(g.routines||[]).forEach(n=>{if(n.linkedType===`join`&&n.linkedFrom===e&&!n.steps.some(e=>e.label===t.label)){let e=Math.max(0,...n.steps.map(e=>e.id),0)+1;n.steps.push({...t,id:e})}})}function cd(e,t){(g.routines||[]).forEach(n=>{n.linkedType===`join`&&n.linkedFrom===e&&(n.steps=n.steps.filter(e=>e.label!==t))})}function ld(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=t.ownerType===`household`,r=t.steps.map(t=>`
  ...
  `,()=>{let e=document.getElementById(`re-name`)?.value.trim(),n=document.getElementById(`re-emoji`)?.value.trim(),r=document.getElementById(`re-time`)?.value;if(e&&(t.name=e),n&&(t.emoji=n),r&&(t.triggerTime=r),t.ownerType===`household`){let e=parseInt(document.getElementById(`re-pts`)?.value);isNaN(e)||(t.pointsPerCompletion=e)}t.recurrence=_d(),t.lastEditedBy=mu(),t.lastEditedAt=new Date().toISOString(),window.saveData(g),window.closeModal(),W()}),setTimeout(()=>{gd()},100)}function ud(e,t,n){let r=(g.routines||[]).find(t=>String(t.id)===String(e));if(!r)return;let i=r.steps.find(e=>e.id===t);r.steps=r.steps.filter(e=>e.id!==t),Object.keys(r.completions||{}).forEach(e=>{r.completions[e]=r.completions[e].filter(e=>e!==t)}),(g.routineAssignments||[]).filter(t=>t.routineId===e).forEach(e=>{Object.keys(e.completionState||{}).forEach(n=>{e.completionState[n]=e.completionState[n].filter(e=>e!==t)})}),i&&cd(r.id,i.label),window.saveData(g),n?(window.closeModal(),ld(e)):(window.closeModal(),W())}function dd(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(!n)return;let r=n.steps.find(e=>e.id===t);if(!r)return;let i=n.ownerType===`household`;window.openModal(`Edit step`,`
    <div class="form-group" style="display:flex;gap:12px">
      <div style="flex:1"><label class="form-label">Label</label>
  ...
  `,()=>{let e=document.getElementById(`rst-label`)?.value.trim();e&&(r.label=e,r.emoji=document.getElementById(`rst-emoji`)?.value.trim()||r.emoji,r.durationMin=parseInt(document.getElementById(`rst-dur`)?.value)||0,r.notes=document.getElementById(`rst-notes`)?.value.trim()||``,i&&(r.points=parseInt(document.getElementById(`rst-pts`)?.value)||0),window.saveData(g),window.closeModal(),W())})}function fd(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=vu();if(!n.length){window.openModal(`Assign`,`<p style="color:var(--text-muted);font-size:13px">No children in this household yet.</p>`,()=>window.closeModal());return}let r=g.routineAssignments||[],i=n.map(t=>{let n=r.some(n=>n.routineId===e&&n.childId===t.id);return`<div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid var(--border)">
    ...
    ${i}
  `,()=>window.closeModal())}function pd(e,t){g.routineAssignments||(g.routineAssignments=[]);let n=xu(e,t);n?(n.archivedCompletionState=JSON.parse(JSON.stringify(n.completionState||{})),n.archivedAt=new Date().toISOString(),g.routineAssignments=g.routineAssignments.filter(n=>!(n.routineId===e&&n.childId===t))):g.routineAssignments.push({id:window.uid(),routineId:e,childId:t,assignedBy:mu(),assignedAt:new Date().toISOString(),completionState:{},archivedCompletionState:null,childIds:[t]}),window.saveData(g),W()}function md(e){let t=e?.type||`daily`,n=e?.startDate||new Date().toISOString().slice(0,10),r=e?.endDate||``,i=e?.intervalDays||2,a=e?.days||[];return`
    <div class="form-group">
    ...
    <div id="rn-rec-summary" style="font-size:12px;color:var(--primary);font-weight:600;padding:8px 12px;background:var(--primary-light);border-radius:8px;margin-bottom:4px"></div>`}function hd(){let e=document.getElementById(`rn-rec-type`)?.value;e&&(document.getElementById(`rn-rec-days`).style.display=e===`specific_days`?`flex`:`none`,document.getElementById(`rn-rec-interval`).style.display=e===`interval`?`flex`:`none`,gd())}function gd(){let e=document.getElementById(`rn-rec-summary`);if(!e)return;let t=document.getElementById(`rn-rec-type`)?.value,n={daily:`Every day`,weekdays:`Mon – Fri`,weekends:`Sat & Sun`,one_time:`Once only`};if(n[t]){e.textContent=n[t];return}if(t===`specific_days`){let t=[...document.querySelectorAll(`input[name="rn-rec-dow"]:checked`)].map(e=>[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`][e.value]);e.textContent=t.length?t.join(`, `):`No days selected`}else t===`interval`&&(e.textContent=`Every ${document.getElementById(`rn-rec-interval-days`)?.value||2} days`)}function _d(){let e=document.getElementById(`rn-rec-type`)?.value||`daily`,t=document.getElementById(`rn-rec-start`)?.value||new Date().toISOString().slice(0,10),n=document.getElementById(`rn-rec-end`)?.value||void 0,r={type:e,startDate:t};return n&&(r.endDate=n),e===`specific_days`&&(r.days=[...document.querySelectorAll(`input[name="rn-rec-dow"]:checked`)].map(e=>e.value)),e===`interval`&&(r.intervalDays=parseInt(document.getElementById(`rn-rec-interval-days`)?.value)||2),r}function vd(e){let t=e===`child`;window.openModal(`New routine`,`
    <div class="form-group">
    ...
    ${md(null)}
  `,()=>{let e=document.getElementById(`rn-name`)?.value.trim();if(!e)return;let t=document.querySelector(`input[name="rn-type"]:checked`)?.value||`adult`,n=document.getElementById(`rn-emoji`)?.value.trim()||`📋`,r=document.getElementById(`rn-time`)?.value||(t===`child`?`19:30`:`08:00`),i=parseInt(document.getElementById(`rn-pts`)?.value)||0,a=mu(),o=yu(),s=_d();if(t===`adult`){let t={id:o,name:e,emoji:n,triggerTime:r,steps:[],completions:{},assignedTo:[],ownerType:`adult`,ownerId:a,sharedWith:[],linkedFrom:null,linkedType:null,pointsPerCompletion:0,recurrence:s,skippedDates:[],pausePeriods:[]};ku(t),g.routines.push(t),Au(`create:adult`),window.closeModal(),Nu=`mine`}else{let t={id:o,name:e,emoji:n,triggerTime:r,steps:[],completions:{},assignedTo:[],ownerType:`household`,ownerId:`household`,sharedWith:[],linkedFrom:null,linkedType:null,pointsPerCompletion:i,createdBy:a,lastEditedBy:a,lastEditedAt:new Date().toISOString(),recurrence:s,skippedDates:[],pausePeriods:[]};ku(t),g.routines.push(t),Au(`create:child`),window.closeModal(),Nu=`children`}W()}),setTimeout(()=>{document.getElementById(`rn-name`)?.focus(),gd()},100)}function yd(e){document.querySelectorAll(`input[name="rn-type"]`).forEach(t=>t.checked=t.value===e),document.getElementById(`rn-type-adult`)?.classList.toggle(`selected`,e===`adult`),document.getElementById(`rn-type-child`)?.classList.toggle(`selected`,e===`child`);let t=document.getElementById(`rn-time`);t&&(t.value=e===`child`?`19:30`:`08:00`);let n=document.getElementById(`rn-pts-group`);n&&(n.style.display=e===`child`?`block`:`none`)}function bd(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));t&&confirm(`Delete "${t.name}"? This cannot be undone.`)&&(g.routines=g.routines.filter(t=>t.id!==e),g.routineAssignments=(g.routineAssignments||[]).filter(t=>t.routineId!==e),window.saveData(g),W())}function xd(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));t&&confirm(`Leave "${t.name}"? Your completion history will be removed.`)&&(g.routines=g.routines.filter(t=>t.id!==e),window.saveData(g),W())}function Sd(e,t){if(!confirm(`Unassign this child? Their completion history will be archived.`))return;let n=xu(e,t);n&&(n.archivedCompletionState=JSON.parse(JSON.stringify(n.completionState||{})),n.archivedAt=new Date().toISOString()),g.routineAssignments=(g.routineAssignments||[]).filter(n=>!(n.routineId===e&&n.childId===t)),(g.routineAssignments||[]).some(t=>t.routineId===e)||(g.routines=g.routines.filter(t=>t.id!==e)),window.saveData(g),W()}function Cd(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=bu();if(!n.length){window.openModal(`Share routine`,`<p style="color:var(--text-muted);font-size:13px">No other adults have joined yet. Invite them via Settings → Household first.</p>`,()=>window.closeModal());return}let r=t.sharedWith||[],i=n.map(t=>{let n=r.includes(t.uid);return`<div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid var(--border)">
    ...
    ${i}
  `,()=>window.closeModal())}function wd(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(!n)return;n.sharedWith||(n.sharedWith=[]);let r=n.sharedWith.indexOf(t);r===-1?n.sharedWith.push(t):n.sharedWith.splice(r,1),window.saveData(g),window.closeModal(),Cd(e)}function Td(e){let t=(g.routines||[]).find(t=>t.id===e);if(!t)return;mu();let n={...JSON.parse(JSON.stringify(t)),id:yu(),ownerId:window.uid,ownerType:`adult`,sharedWith:[],completions:{},linkedFrom:e,linkedType:`duplicate`};g.routines.push(n),window.saveData(g),window.closeModal(),W()}function Ed(e){let t=(g.routines||[]).find(t=>t.id===e);if(!t)return;if(mu(),(g.routines||[]).some(t=>t.linkedFrom===e&&t.linkedType===`join`&&t.ownerId===window.uid)){alert(`You have already joined this routine.`);return}let n={...JSON.parse(JSON.stringify(t)),id:yu(),ownerId:window.uid,ownerType:`adult`,sharedWith:[],completions:{},linkedFrom:e,linkedType:`join`};g.routines.push(n),window.saveData(g),window.closeModal(),W()}function Dd(e){let t=(g.routines||[]).find(t=>t.id===e);t?.linkedFrom&&Td(t.linkedFrom)}function Od(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(!n)return;let r=n.steps.length,i,a,o;if(t){let s=xu(e,t),c=vu().find(e=>e.id===t);i=wu(s,r,90),a=Cu(s,r),o=`${n.emoji} ${n.name} — ${c?.name||`Child`}`}else i=Du(n,90),a=Eu(n),o=`${n.emoji} ${n.name} — History`;let s=i.filter(e=>e.done===e.total&&e.total>0).length,c=i.filter(e=>e.done>0&&e.done<e.total).length,l=i.map(e=>{let t=e.done===e.total&&e.total>0?`full`:e.done>0?`partial`:`empty`,n=e.done===e.total&&e.total>0?`✓`:e.done>0?`${e.done}`:``;return`<div class="routine-history-dot ${t}" title="${e.key}: ${e.done}/${e.total}">${n}</div>`}).join(``);window.openModal(o,`
  ...
  `,()=>window.closeModal())}var kd=`parent`,Ad=`overview`;Object.defineProperty(window,`kidsView`,{get(){return kd},set(e){kd=e},configurable:!0}),Object.defineProperty(window,`kidsParentTab`,{get(){return Ad},set(e){Ad=e},configurable:!0});function jd(){return Date.now().toString(36)+Math.random().toString(36).slice(2)}function G(){let e=document.getElementById(`kids-content`);if(!e)return;let t=g.kids;if(kd===`parent`)Nd(e,t,t.completions.filter(e=>e.status===`pending`).length+t.redemptions.filter(e=>e.status===`pending`).length);else{let n=t.profiles.find(e=>e.id===kd);n?Rd(e,t,n):(kd=`parent`,G())}}function Md(e,t){return e.completions.filter(e=>e.kidId===t&&e.status===`approved`).reduce((t,n)=>t+(e.chores.find(e=>e.id===n.choreId)?.points||0),0)-e.redemptions.filter(e=>e.kidId===t&&e.status===`approved`).reduce((t,n)=>t+(e.prizes.find(e=>e.id===n.prizeId)?.pointCost||0),0)}function Nd(e,t,n){let r=`
    <div style="display:flex;justify-content:flex-end;margin-bottom:16px">
    ...
    <div style="text-align:center;padding:60px 20px">
    ...
    </div>`;let t=`<div class="kids-grid">`;return e.profiles.forEach(n=>{let r=Md(e,n.id),i=e.chores.filter(e=>e.assignedTo===n.id||e.assignedTo===`all`).length,a=e.completions.filter(e=>e.kidId===n.id&&e.status===`pending`).length;t+=`
      ...
      </div>`}),t+=`</div>`,t}function Fd(e){let t=`<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
    ...
    </div>`}),t}function Id(e){let t=`<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
    ...
    <button class="btn btn-primary btn-sm" onclick="openPrizeModal()">+ Add Prize</button>
      ...
      </div>`)})),r}function Rd(e,t,n){let r=Md(t,n.id),i=t.chores.filter(e=>e.assignedTo===n.id||e.assignedTo===`all`),a=new Set(t.completions.filter(e=>e.kidId===n.id&&e.status===`pending`).map(e=>e.choreId)),o=new Date().toDateString(),s=new Set(t.completions.filter(e=>e.kidId===n.id&&e.status===`approved`&&new Date(e.completedAt).toDateString()===o).map(e=>e.choreId)),c=`
    ...
    <div style="font-size:15px;font-weight:700;margin-bottom:12px">Prize Shelf 🎁</div>`,t.prizes.length?t.prizes.forEach(e=>{let i=r>=e.pointCost,a=t.redemptions.some(t=>t.prizeId===e.id&&t.kidId===n.id&&t.status===`pending`);c+=`<div class="prize-card ${i&&!a?`can-afford`:``} ${a?`pending-redemption`:``}">
      ...
      </div>`}):c+=`<div style="color:#64748b;font-size:13px;padding:20px;text-align:center;background:#f8fafc;border-radius:10px">No prizes on the shelf yet!</div>`,c+=`</div></div>`,e.innerHTML=c}function zd(){let e=g.childEvents||[],t=g.kids?.profiles||[],n=`<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
    ...
    </div>`}var Bd=[`📅`,`⚽`,`🏊`,`🎓`,`🎂`,`🎨`,`🏃`,`🎭`,`🚌`,`🎡`,`🏖`,`🎪`];function Vd(e){let t=e?(g.childEvents||[]).find(t=>t.id===e):null,n=g.kids?.profiles||[];window.openModal(t?`Edit Event`:`Add Event`,`
  ...
  `,()=>{let e=document.getElementById(`ce-title`)?.value.trim();if(!e)return;let t=document.getElementById(`ce-emoji`)?.value.trim()||`📅`,n=document.getElementById(`ce-date`)?.value,r=document.getElementById(`ce-time`)?.value||void 0,i=document.getElementById(`ce-who`)?.value,a=document.getElementById(`ce-notes`)?.value.trim()||``,o=_routineRecurrenceCollect(),s=document.getElementById(`ce-id`)?.value;if(g.childEvents||(g.childEvents=[]),s){let c=g.childEvents.find(e=>e.id===s);c&&Object.assign(c,{title:e,emoji:t,date:n,time:r,notes:a,recurrence:o,isHouseholdWide:i===`all`,assignedTo:i===`all`?`all`:[i]})}else g.childEvents.push({id:jd(),title:e,emoji:t,date:n,time:r,notes:a,recurrence:o,assignedTo:i===`all`?`all`:[i],isHouseholdWide:i===`all`,createdBy:_routineCurrentUserId()});window.saveData(g),window.closeModal(),G()}),setTimeout(()=>{_routineRecurrenceSummaryUpdate()},100)}function Hd(e){confirm(`Delete this event?`)&&(g.childEvents=(g.childEvents||[]).filter(t=>t.id!==e),window.saveData(g),G())}function Ud(e,t){g.kids.completions.push({id:jd(),choreId:e,kidId:t,completedAt:Date.now(),status:`pending`}),window.saveData(g),G()}function Wd(e){let t=g.kids.completions.find(t=>t.id===e);t&&(t.status=`approved`,t.approvedAt=Date.now()),window.saveData(g),G()}function Gd(e){let t=g.kids.completions.find(t=>t.id===e);t&&(t.status=`rejected`),window.saveData(g),G()}function Kd(e,t){g.kids.redemptions.push({id:jd(),prizeId:e,kidId:t,requestedAt:Date.now(),status:`pending`}),window.saveData(g),G()}function qd(e){let t=g.kids.redemptions.find(t=>t.id===e);if(t){t.status=`approved`,t.approvedAt=Date.now();let e=(g.kids.prizes||[]).find(e=>e.id===t.prizeId);g.kids.notifications||(g.kids.notifications=[]),g.kids.notifications.push({id:jd(),kidId:t.kidId,type:`prize_approved`,prizeId:t.prizeId,prizeName:e?.name||`Prize`,prizeEmoji:e?.emoji||`🎁`,ts:Date.now(),read:!1})}window.saveData(g),G()}function Jd(e){let t=g.kids.redemptions.find(t=>t.id===e);if(t){t.status=`rejected`;let e=(g.kids.prizes||[]).find(e=>e.id===t.prizeId);g.kids.notifications||(g.kids.notifications=[]),g.kids.notifications.push({id:jd(),kidId:t.kidId,type:`prize_declined`,prizeId:t.prizeId,prizeName:e?.name||`Prize`,prizeEmoji:e?.emoji||`🎁`,ts:Date.now(),read:!1})}window.saveData(g),G()}function Yd(e){g.kids.chores=g.kids.chores.filter(t=>t.id!==e),window.saveData(g),G()}function Xd(e){g.kids.prizes=g.kids.prizes.filter(t=>t.id!==e),window.saveData(g),G()}var Zd=[`😊`,`🦁`,`🐯`,`🐻`,`🦊`,`🐸`,`🐧`,`🦋`,`🌟`,`🎈`,`🚀`,`⚡`],Qd=[`🧹`,`🍽`,`🐕`,`🛏`,`📚`,`🌿`,`🧺`,`🗑`,`🧽`,`🚿`,`🛒`,`🪴`],$d=[`🍦`,`🎬`,`🎮`,`🍕`,`🎁`,`💰`,`🏖`,`🎡`,`🎨`,`👟`,`📱`,`🎭`];function ef(e,t){return`<div style="display:flex;flex-wrap:wrap;gap:6px" id="emoji-pick">
  ...
  </div>`}function tf(e){e.closest(`#emoji-pick`).querySelectorAll(`button`).forEach(e=>{e.style.borderColor=`var(--border)`,e.style.background=`none`}),e.style.borderColor=`#0891b2`,e.style.background=`#ecfeff`}function nf(e){let t=document.querySelector(`#emoji-pick button[style*="#0891b2"]`);return t?t.dataset.e:e}function rf(){af(null)}function af(e){let t=e?g.kids.profiles.find(t=>String(t.id)===String(e)):null;document.getElementById(`modal-title`).textContent=t?`Edit Kid`:`Add Kid`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <div class="form-group"><label class="form-label">Avatar</label>${ef(Zd,t?.emoji||`😊`)}</div>
    <div class="form-group">
  ...
  `,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Cancel</button><button class="btn btn-primary" onclick="saveKid()">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function of(){let e=document.getElementById(`k-name`).value.trim();if(!e)return;let t=parseInt(document.getElementById(`k-age`).value)||null,n=nf(`😊`),r=document.getElementById(`k-id`)?.value;if(r){let i=g.kids.profiles.find(e=>String(e.id)===String(r));i&&Object.assign(i,{name:e,emoji:n,age:t})}else g.kids.profiles.push({id:jd(),name:e,emoji:n,age:t,savings:0});window.saveData(g),window.closeModal(),G()}function sf(e){let t=g.kids.profiles.find(t=>String(t.id)===String(e));t&&confirm(`Remove ${t.name} from this household?\n\nThis will permanently delete their chores, prizes and points history. This cannot be undone.`)&&(g.kids.profiles=g.kids.profiles.filter(t=>t.id!==e),g.kids.chores=g.kids.chores.filter(t=>t.assignedTo!==e),g.kids.completions=g.kids.completions.filter(t=>t.kidId!==e),g.kids.redemptions=g.kids.redemptions.filter(t=>t.kidId!==e),g.meals?.lunchbox?.profiles&&(g.meals.lunchbox.profiles=g.meals.lunchbox.profiles.filter(t=>t.id!==e)),g.childEvents&&(g.childEvents=g.childEvents.filter(t=>{if(t.isHouseholdWide)return!0;let n=(Array.isArray(t.assignedTo)?t.assignedTo:[t.assignedTo]).filter(t=>t!==e);return n.length?(t.assignedTo=n,!0):!1})),window.getDeviceProfile()===e&&window.setDeviceProfile(`adult`),window.saveData(g),window.closeModal(),kd=`parent`,G())}function cf(e){let t=e?g.kids.chores.find(t=>t.id===e):null,n=g.kids.profiles;document.getElementById(`modal-title`).textContent=t?`Edit Chore`:`Add Chore`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <div class="form-group"><label class="form-label">Emoji</label>${ef(Qd,t?.emoji||`🧹`)}</div>
    <div class="form-row">
  ...
  `,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Cancel</button><button class="btn btn-primary" onclick="saveChore()">Save Chore</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function lf(){let e=document.getElementById(`c-name`).value.trim();if(!e)return;let t=parseInt(document.getElementById(`c-pts`).value)||10,n=document.getElementById(`c-freq`).value,r=document.getElementById(`c-who`).value,i=nf(`🧹`),a=document.getElementById(`c-id`)?.value;if(a){let o=g.kids.chores.find(e=>e.id===a);o&&Object.assign(o,{name:e,emoji:i,points:t,frequency:n,assignedTo:r})}else g.kids.chores.push({id:jd(),name:e,emoji:i,points:t,frequency:n,assignedTo:r});window.saveData(g),window.closeModal(),G()}function uf(e){let t=e?g.kids.prizes.find(t=>String(t.id)===String(e)):null;document.getElementById(`modal-title`).textContent=t?`Edit Prize`:`Add Prize`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <div class="form-group"><label class="form-label">Emoji</label>${ef($d,t?.emoji||`🎁`)}</div>
    <div class="form-row">
  ...
  `,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Cancel</button><button class="btn btn-primary" onclick="savePrize()">Save Prize</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function df(){let e=document.getElementById(`p-name`).value.trim();if(!e)return;let t=parseInt(document.getElementById(`p-cost`).value)||50,n=document.getElementById(`p-type`).value,r=document.getElementById(`p-desc`).value.trim(),i=nf(`🎁`),a=document.getElementById(`p-id`)?.value;if(a){let o=g.kids.prizes.find(e=>e.id===a);o&&Object.assign(o,{name:e,emoji:i,pointCost:t,type:n,description:r})}else g.kids.prizes.push({id:jd(),name:e,emoji:i,pointCost:t,type:n,description:r});window.saveData(g),window.closeModal(),G()}function ff(e){let t=g.kids.profiles.find(t=>t.id===e);t&&(document.getElementById(`modal-title`).textContent=`${t.emoji} ${t.name}'s Savings Jar`,document.getElementById(`modal-body`).innerHTML=`
  ...
  `,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Cancel</button><button class="btn btn-primary" onclick="addSavings('${e}')">Add to Jar 💰</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`))}function pf(e){let t=parseFloat(document.getElementById(`s-amount`).value)||0;if(!t)return;let n=g.kids.profiles.find(t=>t.id===e);n&&(n.savings=(n.savings||0)+t),window.saveData(g),window.closeModal(),G()}var mf=null,hf={};function gf(){return mf?Promise.resolve(mf):new Promise((e,t)=>{let n=indexedDB.open(`home_finance_receipts`,1);n.onupgradeneeded=e=>{let t=e.target.result;t.objectStoreNames.contains(`receipts`)||t.createObjectStore(`receipts`,{keyPath:`id`,autoIncrement:!0}).createIndex(`itemKey`,`itemKey`,{unique:!1})},n.onsuccess=t=>{mf=t.target.result,e(mf)},n.onerror=()=>t(n.error)})}async function _f(){let e=await gf();return new Promise(t=>{let n=e.transaction(`receipts`,`readonly`).objectStore(`receipts`).getAll();n.onsuccess=()=>{hf={},n.result.forEach(e=>{hf[e.itemKey]=(hf[e.itemKey]||0)+1}),t()}})}async function vf(e){let t=await gf();return new Promise(n=>{let r=t.transaction(`receipts`,`readonly`).objectStore(`receipts`).index(`itemKey`).getAll(e);r.onsuccess=()=>n(r.result)})}async function yf(e,t){let n=await gf();return new Promise((r,i)=>{let a=n.transaction(`receipts`,`readwrite`).objectStore(`receipts`).add({itemKey:e,fileName:t.name,fileType:t.type,fileSize:t.size,data:t,uploadedAt:new Date().toISOString()});a.onsuccess=()=>r(),a.onerror=()=>i(a.error)})}async function bf(e){let t=await gf();return new Promise(n=>{let r=t.transaction(`receipts`,`readwrite`);r.objectStore(`receipts`).delete(e),r.oncomplete=n})}function xf(e){return e===`own-funds`?`<span class="badge" style="background:#ecfeff;color:#166534;border:1px solid #bbf7d0">Own Funds</span>`:`<span class="badge" style="background:#eff6ff;color:#1e40af;border:1px solid #bfdbfe">Loan</span>`}function Sf(e,t){let n=hf[e]||0;return`<button class="attach-btn${n?` has-files`:``}" onclick="openReceiptsModal('${e}','${t.replace(/'/g,`\\'`)}')" title="${n?n+` receipt(s)`:`Add receipt`}">📎${n?` ${n}`:``}</button>`}function Cf(e){return e>1048576?`${(e/1048576).toFixed(1)} MB`:`${Math.round(e/1024)} KB`}function wf(e){return e===`application/pdf`?`📄`:e.startsWith(`image/`)?`🖼️`:`📎`}async function Tf(e,t){window.openModal(`Receipts — ${t}`,`<div style="padding:20px;text-align:center;color:var(--text-muted)">Loading…</div>`,()=>{}),document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Close</button>`,await Ef(e,t)}async function Ef(e,t){let n=e,r=t.replace(/'/g,`\\'`),i=await vf(e),a=``;i.length?i.forEach(e=>{let t=e.type===`link`,i=t?`🔗`:wf(e.fileType),o=t?e.linkName||e.url:e.fileName,s=t?`<span style="color:var(--text-muted);font-size:11px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:block;max-width:260px">${e.url}</span>`:`<span>${Cf(e.fileSize)} · ${new Date(e.uploadedAt).toLocaleDateString(`en-AU`)}</span>`,c=t?`<button class="btn btn-ghost btn-sm" onclick="window.open('${e.url.replace(/'/g,`\\'`).replace(/"/g,`&quot;`)}','_blank')">Open</button>`:`<button class="btn btn-ghost btn-sm" onclick="viewReceipt(${e.id})">View</button>`;a+=`
    ...
    <div class="drop-zone" id="drop-zone" onclick="document.getElementById('receipt-file-input').click()">
    ...
    </div>`,document.getElementById(`modal-body`).innerHTML=a;let o=document.getElementById(`drop-zone`);o.addEventListener(`dragover`,e=>{e.preventDefault(),o.classList.add(`drag-over`)}),o.addEventListener(`dragleave`,()=>o.classList.remove(`drag-over`)),o.addEventListener(`drop`,async n=>{n.preventDefault(),o.classList.remove(`drag-over`),await kf(e,t,Array.from(n.dataTransfer.files))})}async function Df(e,t){let n=document.getElementById(`link-url`).value.trim();if(!n){document.getElementById(`link-url`).focus();return}let r=document.getElementById(`link-name`).value.trim(),i=await gf();await new Promise((t,a)=>{let o=i.transaction(`receipts`,`readwrite`).objectStore(`receipts`).add({itemKey:e,type:`link`,url:n,linkName:r,uploadedAt:new Date().toISOString()});o.onsuccess=t,o.onerror=()=>a(o.error)}),await _f(),renderBuild(),await Ef(e,t)}async function Of(e,t){let n=document.getElementById(`receipt-file-input`);await kf(e,t,Array.from(n.files))}async function kf(e,t,n){for(let t of n)await yf(e,t);await _f(),renderBuild(),await Ef(e,t)}async function Af(e){let t=await gf(),n=await new Promise(n=>{let r=t.transaction(`receipts`,`readonly`).objectStore(`receipts`).get(e);r.onsuccess=()=>n(r.result)});if(n.type===`link`){window.open(n.url,`_blank`);return}let r=URL.createObjectURL(n.data);window.open(r,`_blank`),setTimeout(()=>URL.revokeObjectURL(r),15e3)}async function jf(e,t,n){confirm(`Delete this receipt?`)&&(await bf(e),await _f(),renderBuild(),await Ef(t,n))}var Mf=null;window.addEventListener(`beforeinstallprompt`,e=>{e.preventDefault(),Mf=e;let t=document.getElementById(`install-btn`);t&&(t.style.display=`flex`)}),window.addEventListener(`appinstalled`,()=>{Mf=null;let e=document.getElementById(`install-btn`);e&&(e.style.display=`none`)});function Nf(){Mf&&(Mf.prompt(),Mf.userChoice.then(()=>{Mf=null}))}var Pf={building:[{name:`Mortgage / Rent`,category:`Mortgage / Rent`,amount:3e3},{name:`Groceries`,category:`Groceries`,amount:1200},{name:`Utilities`,category:`Utilities`,amount:400},{name:`Transport`,category:`Transport`,amount:500},{name:`Insurance`,category:`Insurance`,amount:350},{name:`Entertainment`,category:`Entertainment`,amount:200}],mortgage:[{name:`Mortgage`,category:`Mortgage / Rent`,amount:3500},{name:`Groceries`,category:`Groceries`,amount:1200},{name:`Utilities`,category:`Utilities`,amount:400},{name:`Transport`,category:`Transport`,amount:500},{name:`Insurance`,category:`Insurance`,amount:350},{name:`Entertainment`,category:`Entertainment`,amount:200}],renting:[{name:`Rent`,category:`Mortgage / Rent`,amount:2500},{name:`Groceries`,category:`Groceries`,amount:1200},{name:`Utilities`,category:`Utilities`,amount:300},{name:`Transport`,category:`Transport`,amount:500},{name:`Insurance`,category:`Insurance`,amount:250},{name:`Entertainment`,category:`Entertainment`,amount:200}],own:[{name:`Groceries`,category:`Groceries`,amount:1200},{name:`Utilities`,category:`Utilities`,amount:400},{name:`Transport`,category:`Transport`,amount:500},{name:`Insurance`,category:`Insurance`,amount:400},{name:`Health`,category:`Health`,amount:300},{name:`Entertainment`,category:`Entertainment`,amount:300}]},K={step:1,adults:2,adultNames:[``,``],adultAges:[``,``],kids:0,kidProfiles:[],homeType:`mortgage`,incomes:[{name:``,amount:``,frequency:`Monthly`}],expenses:[],_emojiPickerOpen:null};function Ff(){return K.kids>0?[1,2,3,4,5,6]:[1,2,4,5,6]}function If(){return Ff().indexOf(K.step)}function Lf(){K={step:1,adults:2,adultNames:[``,``],adultAges:[``,``],kids:0,kidProfiles:[],homeType:`mortgage`,incomes:[{name:``,amount:``,frequency:`Monthly`}],expenses:[],_emojiPickerOpen:null},document.getElementById(`onboarding-overlay`).style.display=`flex`,Wf()}function Rf(){document.getElementById(`onboarding-overlay`).style.display=`none`}function zf(e){for(K.adults=e;K.adultNames.length<e;)K.adultNames.push(``);for(K.adultNames=K.adultNames.slice(0,e);K.adultAges.length<e;)K.adultAges.push(``);K.adultAges=K.adultAges.slice(0,e),Wf()}function Bf(e){K.kids=e,K.kidProfiles.length>e&&(K.kidProfiles=K.kidProfiles.slice(0,e)),Wf()}function Vf(e){K._emojiPickerOpen=K._emojiPickerOpen===e?null:e,Wf()}function Hf(e,t){K.kidProfiles[e].emoji=t,K._emojiPickerOpen=null,Wf()}function Uf(e){K.expenses[e].skipped=!K.expenses[e].skipped,Wf()}function Wf(){let e=document.getElementById(`onboarding-card`),t=Ff(),n=If(),r=K.step,i=t.map((e,t)=>`<div class="ob-dot ${t<n?`done`:t===n?`active`:``}"></div>`).join(``),a=``,o=``,s=``;if(r===1)a=`
      ...
      <button class="ob-back" onclick="obBack()">← Back</button>
      <button class="ob-next" onclick="obNext()">Continue →</button>`}else if(r===5)K.expenses.length||(K.expenses=Pf[K.homeType].map(e=>({...e,skipped:!1})),K.kids>0&&K.expenses.push({name:`Kids activities / sport`,category:`Childcare / Education`,amount:300,skipped:!1})),a=`
      <div class="ob-step-dots">${i}</div>
    ...
    <div class="ob-footer">${s}</div>`}function Gf(){let e=Ff(),t=If();if(t>=e.length-1){Yf();return}if(K.step===2){if(K.adultNames.some(e=>!e.trim())){K._nameError=!0,Wf();return}K._nameError=!1}let n=e[t+1];n===3&&(K.kidProfiles=Array.from({length:K.kids},(e,t)=>K.kidProfiles[t]||{name:``,age:``,emoji:KID_EMOJIS[t%KID_EMOJIS.length]})),n===5&&!K.expenses.length&&(K.expenses=Pf[K.homeType].map(e=>({...e,skipped:!1})),K.kids>0&&K.expenses.push({name:`Kids activities / sport`,category:`Childcare / Education`,amount:300,skipped:!1})),K.step=n,Wf()}function Kf(){let e=Ff(),t=If();t<=0||(K.step=e[t-1],Wf())}function qf(){g.onboarded=!0,window.saveData(g),Rf()}function Jf(){K.expenses=[];let e=Ff(),t=If();K.step=e[t+1],Wf()}function Yf(){g.householdProfile.members=[];for(let e=0;e<K.adults;e++)g.householdProfile.members.push({role:`adult`,name:K.adultNames[e]||``,age:K.adultAges[e]?parseInt(K.adultAges[e]):null});g.kids||(g.kids={profiles:[],chores:[],prizes:[],completions:[],redemptions:[]}),g.meals||(g.meals={}),g.meals.lunchbox||(g.meals.lunchbox={profiles:[]}),g.meals.lunchbox.profiles||(g.meals.lunchbox.profiles=[]),g.kids.profiles=[],g.meals.lunchbox.profiles=[],K.kidProfiles.forEach(e=>{if(g.householdProfile.members.push({role:`child`,name:e.name,age:e.age?parseInt(e.age):null,emoji:e.emoji}),!e.name)return;let t=nextId(g.kids.profiles);g.kids.profiles.push({id:t,name:e.name,age:e.age?parseInt(e.age):null,emoji:e.emoji}),g.meals.lunchbox.profiles.push({id:t,name:e.name,emoji:e.emoji})}),g.householdProfile.homeType=K.homeType;let e=window.ensureMonthOverride(window.selectedBudgetMonth);K.incomes.forEach((t,n)=>{let r=parseFloat(t.amount);if(!r)return;let i=t.frequency===`Weekly`?r*52/12:t.frequency===`Fortnightly`?r*26/12:t.frequency===`Annual`?r/12:r,a=t.name||(K.adultNames[n]?`${K.adultNames[n]}'s salary`:`Income ${n+1}`);e.income.push({id:nextId(e.income),name:a,amount:i,frequency:`monthly`,category:`Salary`})}),K.expenses.forEach(t=>{t.skipped||!t.amount||e.expenses.push({id:nextId(e.expenses),name:t.name,amount:t.amount,frequency:`monthly`,category:t.category,recurring:!0})}),g.onboarded=!0,window.saveData(g),Rf(),window.renderAll()}document.getElementById(`btn-guest-mode`)?.addEventListener(`click`,()=>up()),document.getElementById(`btn-google-signin`)?.addEventListener(`click`,()=>lp());function Xf(){document.getElementById(`sidebar`).classList.toggle(`collapsed`)}var Zf={};function Qf(e){let t=document.getElementById(`icon-group-${e}`),n=document.getElementById(`icon-group-${e}-children`),r=document.getElementById(`text-group-${e}`),i=document.getElementById(`text-group-${e}-children`),a=n&&n.classList.contains(`open`);t&&t.classList.toggle(`open`,!a),n&&n.classList.toggle(`open`,!a),r&&r.classList.toggle(`open`,!a),i&&i.classList.toggle(`open`,!a)}function $f(e){for(let[t,n]of Object.entries(Zf))if(n.includes(e)){let e=document.getElementById(`icon-group-${t}-children`);e&&!e.classList.contains(`open`)&&Qf(t);return}}window.addEventListener(`unhandledrejection`,e=>{console.error(`[unhandledrejection]`,e.reason)}),window.addEventListener(`error`,e=>{console.error(`[uncaughtError]`,e.message,e.filename,e.lineno)});var ep=`toto_household_owner`,tp=`toto_pending_household`;function np(){return sessionStorage.getItem(tp)||jp(ep)||q?.uid||null}function rp(){let e=np();return e?fbStore.collection(`families`).doc(e):null}function ip(e){Mp(ep,e),sessionStorage.removeItem(tp)}var q=null,ap=!1,op=null;Object.defineProperty(window,`_fsUnsubscribe`,{get(){return op},set(e){op=e},configurable:!0});var sp=null;Object.defineProperty(window,`_pendingLogEntry`,{get(){return sp},set(e){sp=e},configurable:!0}),Object.defineProperty(window,`_currentUser`,{get(){return q},set(e){q=e},configurable:!0});function cp(e,t){sp={ts:new Date().toISOString(),name:q&&(q.displayName||q.email)||`Unknown`,photo:q&&q.photoURL||``,action:e,detail:t||``}}function lp(){let e=new fbAuth.GoogleAuthProvider;fbAuth.signInWithPopup(e).catch(e=>{let t=document.getElementById(`login-error`);t&&(t.textContent=e.message,t.style.display=``)})}async function up(){ap=!0;let e=document.getElementById(`login-overlay`);e&&e.classList.add(`hidden`),await Bp,g.onboarded||(g.onboarded=!0,J(g));let t=location.hash.slice(1);t&&document.getElementById(`tab-`+t)?(history.replaceState({tab:t},``,`#`+t),C(t)):uh(),Hp()}function dp(){op&&(op(),op=null),Tp=!1,Y=null,zp(),fbAuth.signOut()}function fp(e){return e.budget||(e.budget={income:[],expenses:[],actuals:{},months:{}}),e.budget.actuals||(e.budget.actuals={}),e.budget.months||(e.budget.months={}),e.budget.suggestions||(e.budget.suggestions=[]),e.goals||(e.goals=[]),e.scenarios||(e.scenarios=[]),e.furniture||(e.furniture=[]),e.appliances||(e.appliances=[]),e.planner||(e.planner={events:[]}),e.projects||(e.projects=[]),e.activeFamilyGoalProjectId===void 0&&(e.activeFamilyGoalProjectId=null),e.lists||(e.lists={food:{items:[],budget:0,weeklyBudget:200,stores:[],favourites:[],history:[]},clothes:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},wishlist:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},home:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},pharmacy:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]}},e.meals&&e.meals.shopping&&e.meals.shopping.length&&(e.lists.food.items=e.meals.shopping.map(function(e,t){return{id:`si-`+t,name:e.name,quantity:1,unit:`units`,notes:``,aisle:e.cat||`other`,state:e.checked?`got_it`:`active`,addedBy:`migration`,addedAt:new Date().toISOString(),mealTag:null,manualPrice:null,barcodeId:null}}))),[`food`,`clothes`,`wishlist`,`home`,`pharmacy`].forEach(function(t){e.lists[t]||(e.lists[t]={items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]}),e.lists[t].items||(e.lists[t].items=[]),e.lists[t].stores||(e.lists[t].stores=[]),e.lists[t].favourites||(e.lists[t].favourites=[]),e.lists[t].history||(e.lists[t].history=[])}),e.routines&&e.routines.forEach(function(e){e.ownerType===`household`&&e.ownerId!==`household`&&(e.ownerId=`household`)}),e}function pp(){op&&op(),!jp(ep)&&!sessionStorage.getItem(tp)&&ip(q.uid);let e=rp();if(!e){console.error(`No household doc ref`);return}op=e.onSnapshot(async t=>{if(t.exists){let e=fp(t.data());Object.assign(g,e),Mp(hp,JSON.stringify(g))}else{let t=await fbStore.collection(`family`).doc(`shared`).get().catch(()=>null);if(t&&t.exists){let n=fp(t.data());Object.assign(g,n),e.set(g).catch(()=>{}),Mp(hp,JSON.stringify(g))}else e.set(g).catch(()=>{})}_f().then(()=>{mr();let e=location.hash.slice(1);e&&document.getElementById(`tab-`+e)?(history.replaceState({tab:e},``,`#`+e),C(e)):uh(),g.onboarded||(g.onboarded=!0,J(g));let t=sessionStorage.getItem(fm),n=sessionStorage.getItem(`toto_post_invite_action`);t||n?(sessionStorage.removeItem(`toto_post_invite_action`),mm()):Hp()})},e=>{console.error(`Firestore sync error:`,e),uh()})}function mp(){fbAuth.onAuthStateChanged(e=>{if(ap&&!e)return;q=e;let t=document.getElementById(`login-overlay`),n=document.getElementById(`header-avatar`),r=document.getElementById(`header-sign-out`);if(e)t&&t.classList.add(`hidden`),n&&(n.src=e.photoURL||``,n.style.display=`block`),r&&(r.style.display=`block`),pp();else{t&&t.classList.remove(`hidden`),n&&(n.style.display=`none`),r&&(r.style.display=`none`),op&&(op(),op=null);let e=sessionStorage.getItem(fm),i=document.getElementById(`login-invite-banner`),a=document.getElementById(`login-tagline`);e&&i&&(i.style.display=`block`,a&&(a.style.display=`none`))}})}mp();var hp=`home_finance_v1`;window.STORAGE_KEY=hp;var gp=null,_p={};function vp(e,t,n,r){_p[e]={options:t,value:n,onChange:r};let i=t.find(e=>(e.value??e)===n)||t[0],a=i?.label??i?.value??i??``;return`<div class="cs-wrap">
  ...
  </div>`,document.getElementById(`profile-list`).innerHTML=n,document.getElementById(`profile-overlay-title`).textContent=`Who uses this device?`,document.getElementById(`profile-overlay-sub`).textContent=`Set it once — the app will open straight to the right view. You can change this any time in Settings.`,document.getElementById(`profile-overlay`).classList.remove(`hidden`)}function Wp(e){if(Fp(e),Tp=!0,document.getElementById(`profile-overlay`).classList.add(`hidden`),e===`adult`)Y=null,Qp(),uh();else if(e===`shared`)Gp();else{let t=(g.kids?.profiles||[]).find(t=>t.id===e);if(!t){Y=null,Pc(),uh();return}t.pinHash?(Dp=t.id,Z=``,X=0,Jp(t)):(Y={id:t.id,name:t.name,emoji:t.emoji,role:`child`},Rp(t.id),$p())}}function Gp(){document.getElementById(`pin-overlay`).classList.add(`hidden`);let e=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name),t=g.kids?.profiles||[],n=``;e.forEach((e,t)=>{let r=!!e.pinHash;n+=`<div class="profile-card" onclick="_pickAdult(${t})">
      <div class="profile-avatar">🧑</div>
      <div style="flex:1">
        <div style="font-size:15px;font-weight:700;color:#1e293b">${T(e.name)}</div>
    ...
    </div>`}),document.getElementById(`profile-list`).innerHTML=n,document.getElementById(`profile-overlay-title`).textContent=`Who's using Toto?`,document.getElementById(`profile-overlay-sub`).textContent=`Tap your name to continue`,document.getElementById(`profile-overlay`).classList.remove(`hidden`)}function Kp(e){let t=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[e??0];if(t?.pinHash){Dp=`adult:`+(e??0),Z=``,X=0,Ep=0,Jp({emoji:`🧑`,name:t.name,_isAdult:!0,_memberIndex:e??0});return}Y=null,zp(),document.getElementById(`profile-overlay`).classList.add(`hidden`),$p()}function qp(e){let t=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(t.pinHash?(Dp=e,Z=``,X=0,Jp(t)):(Y={id:t.id,name:t.name,emoji:t.emoji,role:`child`},Rp(t.id),document.getElementById(`profile-overlay`).classList.add(`hidden`),$p()))}function Jp(e){document.getElementById(`profile-overlay`).classList.add(`hidden`),document.getElementById(`pin-avatar`).textContent=e.emoji||(e._isAdult?`🧑`:`😊`),document.getElementById(`pin-greeting`).textContent=`Hi ${e.name}! 👋`,document.getElementById(`pin-sub`).textContent=`Enter your PIN to continue`,document.getElementById(`pin-error`).textContent=``,Yp(),Xp(),document.getElementById(`pin-overlay`).classList.remove(`hidden`)}function Yp(){let e=document.getElementById(`pin-dots`);e&&(e.innerHTML=[0,1,2,3].map(e=>`<div class="pin-dot ${e<Z.length?`filled`:``}">${e<Z.length?`●`:``}</div>`).join(``))}function Xp(){let e=document.getElementById(`pin-pad`);if(!e)return;let t=Date.now();if(t<Ep){let n=Math.ceil((Ep-t)/1e3);document.getElementById(`pin-error`).textContent=`Too many attempts — try again in ${n}s`,e.innerHTML=``,setTimeout(Xp,1e3);return}e.innerHTML=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div class="pin-key empty"></div>`:`<div class="pin-key" onclick="_pinKey('${e}')">${e}</div>`).join(``)}function Zp(e){if(!(Date.now()<Ep)){if(e===`⌫`){Z=Z.slice(0,-1),Yp();return}Z.length>=4||(Z+=e,Yp(),Z.length===4&&Ym())}}function Qp(){let e=document.getElementById(`header-switch-profile`);if(!e)return;let t=Pp();e.style.display=t&&t!==`adult`?``:`none`}function $p(){Qp(),Pc(),Y?.role===`child`?(window.kidsView=Y.id,w(`kids`),Qc(Y.id)):document.querySelectorAll(`.nav-item, .nav-text-item`).forEach(e=>e.style.display=``),uh()}var em=`member`,tm=null,nm=null;function rm(e){em=e;let t=document.getElementById(`inv-role-member`),n=document.getElementById(`inv-role-owner`);!t||!n||(e===`member`?(t.style.borderColor=`#0d9488`,t.style.background=`#f0fdfa`,t.style.color=`#0d9488`,n.style.borderColor=`var(--border)`,n.style.background=`var(--surface)`,n.style.color=`var(--text-muted)`):(n.style.borderColor=`#0d9488`,n.style.background=`#f0fdfa`,n.style.color=`#0d9488`,t.style.borderColor=`var(--border)`,t.style.background=`var(--surface)`,t.style.color=`var(--text-muted)`))}function im(e,t){let n=document.getElementById(`inv-email`),r=n?n.value.trim():``,i=(g.householdProfile.members||[]).find(e=>e.role===`adult`)?.name||`Someone`,a=new Date(Date.now()+10080*60*1e3).toISOString(),o={id:dh(),email:r,role:em,inviterName:i,memberName:t||null,memberIdx:e??null,createdAt:new Date().toISOString(),expiresAt:a,status:`pending`};g.householdProfile.invites||(g.householdProfile.invites=[]),g.householdProfile.invites.push(o),J(g),tm=o.id;let s=cm(o.id),c=document.getElementById(`invite-link-wrap`),l=document.getElementById(`invite-form-wrap`),u=document.getElementById(`invite-link-display`);c&&(c.dataset.invEmail=r,c.dataset.invToken=o.id,c.style.display=`block`),l&&(l.style.display=`none`),u&&(u.textContent=s)}function am(e){let t=(g.householdProfile.members||[])[e];if(!t)return;let n=(g.householdProfile.members||[]).find((e,t)=>e.role===`adult`&&t===0)?.name||`Someone`,r=new Date(Date.now()+10080*60*1e3).toISOString(),i={id:dh(),email:``,role:`member`,inviterName:n,memberName:t.name||null,memberIdx:e,createdAt:new Date().toISOString(),expiresAt:r,status:`pending`};g.householdProfile.invites||(g.householdProfile.invites=[]),g.householdProfile.invites.push(i),J(g);let a=cm(i.id),o=T(t.name||`this person`),s=document.createElement(`div`);s.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:24px`,s.innerHTML=`<div style="background:#fff;border-radius:16px;padding:24px;max-width:400px;width:100%">
  ...
  </div>`,document.body.appendChild(s),s.addEventListener(`click`,e=>{e.target===s&&(s.remove(),ta())})}function om(e){if(!e)return;let t=(g.kids?.profiles||[]).find(t=>t.name&&t.name.toLowerCase()===e.toLowerCase());if(!t){g.kids||(g.kids={profiles:[],chores:[],prizes:[],completions:[],redemptions:[]});let n=(g.householdProfile.members||[]).find(t=>t.name&&t.name.toLowerCase()===e.toLowerCase()),r=P(g.kids.profiles);t={id:r,name:e,age:n?.age||null,emoji:n?.emoji||`🧒`},g.kids.profiles.push(t),g.meals?.lunchbox?.profiles||(g.meals||(g.meals={}),g.meals.lunchbox||(g.meals.lunchbox={profiles:[]})),g.meals.lunchbox.profiles.push({id:r,name:e,emoji:t.emoji}),J(g)}Im(t.id)}function sm(e){navigator.clipboard.writeText(cm(e)).then(()=>{let e=event.target,t=e.textContent;e.textContent=`✓ Copied!`,setTimeout(()=>{e.textContent=t},2e3)})}function cm(e){let t=np()||``;return window.location.origin+window.location.pathname+`?invite=`+e+`&h=`+t}function lm(){let e=document.getElementById(`invite-link-wrap`)?.dataset.invToken||tm;e&&navigator.clipboard.writeText(cm(e)).then(()=>{let e=event.target,t=e.textContent;e.textContent=`✓ Copied!`,setTimeout(()=>{e.textContent=t},2e3)})}function um(){let e=document.getElementById(`invite-link-wrap`),t=e?.dataset.invToken||tm,n=e?.dataset.invEmail||``;if(!t)return;let r=(g.householdProfile.invites||[]).find(e=>e.id===t)?.inviterName||`Your partner`,i=cm(t),a=encodeURIComponent(`${r} invited you to join their Toto household`),o=encodeURIComponent(`Hi,\n\n${r} has invited you to join their Toto household — a shared family finance and planning app.\n\nClick the link below to accept the invite (expires in 7 days):\n\n${i}\n\nSee you there!`);window.open(`mailto:${n}?subject=${a}&body=${o}`,`_blank`)}function dm(e){if(!confirm(`Revoke this invite link?`))return;let t=(g.householdProfile.invites||[]).find(t=>t.id===e);t&&(t.status=`revoked`),J(g),ta()}var fm=`toto_pending_invite`;function pm(){let e=new URLSearchParams(window.location.search),t=e.get(`invite`),n=e.get(`h`);t&&(sessionStorage.setItem(fm,t),n&&sessionStorage.setItem(tp,n),window.history.replaceState({},``,window.location.pathname+window.location.hash))}function mm(){let e=sessionStorage.getItem(fm);if(!e)return;let t=(g.householdProfile.invites||[]).find(t=>t.id===e);if(!t){sessionStorage.removeItem(fm);return}if(t.status!==`pending`||new Date(t.expiresAt)<new Date){sessionStorage.removeItem(fm),Em(t);return}sessionStorage.removeItem(fm),nm=t,hm(t)}function hm(t){let n=g.householdProfile.members||[],r=n.filter(e=>e.role===`adult`),i=n.filter(e=>e.role===`child`),a=(()=>{let t=new Date,n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}`,r=getOrCreateMonthData(n);return(r.income||[]).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)-(r.expenses||[]).filter(e=>!e.skipped).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)})(),o=[...r.map(e=>`
  ...
  `)}function gm(){let t=nm,n=q?.displayName?.split(` `)[0]||`there`,r=g.householdProfile.members||[],i=r.filter(e=>e.role===`adult`),a=r.filter(e=>e.role===`child`),o=(()=>{let t=new Date,n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}`,r=getOrCreateMonthData(n);return(r.income||[]).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)-(r.expenses||[]).filter(e=>!e.skipped).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)})(),s=(g.goals||[]).length,c=[...i.map((e,t)=>`
      <div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid #f1f5f9">
        <div style="width:40px;height:40px;border-radius:50%;background:linear-gradient(135deg,#ecfeff,#ccfbf1);display:flex;align-items:center;justify-content:center;font-size:20px">👤</div>
        <div>
  ...
  `)}var _m=0,vm=[{emoji:`💰`,title:`The Kitty`,desc:`Budget, bills, goals & net worth. See where the money goes each month.`},{emoji:`📅`,title:`Plan`,desc:`Weekly planner, meal plans & the kids' lunchboxes. One place for the week ahead.`},{emoji:`🏠`,title:`Home`,desc:`Documents, vehicles & maintenance reminders. Never miss a rego or warranty renewal.`}];function ym(){_m=0,bm()}function bm(){let e=vm[_m],t=vm.map((e,t)=>`<div style="width:${t===_m?20:8}px;height:8px;border-radius:99px;background:${t===_m?`#0d9488`:`#e2e8f0`};transition:all .2s"></div>`).join(``),n=_m===vm.length-1;Dm(`
  ...
  `)}function Sm(){let e=document.getElementById(`inv-inc-name`)?.value.trim()||``,t=parseFloat(document.getElementById(`inv-inc-amount`)?.value)||0,n=document.getElementById(`inv-inc-freq`)?.value||`Monthly`;(e||t)&&(g.budget.income||(g.budget.income=[]),g.budget.income.push({id:P(g.budget.income),name:e,amount:t,frequency:n}),J(g)),Tm()}function Cm(){let e=nm;if(!q){sessionStorage.setItem(`toto_post_invite_action`,e?.id||``),lp();return}wm(e),gm()}function wm(e){if(!e)return;e.status=`accepted`;let t=q,n=np();n&&ip(n),g.householdProfile.authorizedUsers||(g.householdProfile.authorizedUsers=[]),g.householdProfile.authorizedUsers.some(e=>e.uid===t.uid)||g.householdProfile.authorizedUsers.push({uid:t.uid,name:t.displayName||``,email:t.email||``,role:e.role||`member`,joinedAt:new Date().toISOString()});let r=g.householdProfile.members||[],i=(t.displayName||``).split(` `)[0];i&&!r.some(e=>e.name===i)&&g.householdProfile.members.push({role:`adult`,name:i,age:null}),J(g)}function Tm(){nm=null,Om(),uh(),Hp()}function Em(e){Dm(`
  ...
  `)}function Dm(e){document.getElementById(`invite-flow-content`).innerHTML=e;let t=document.getElementById(`invite-flow-overlay`);t.classList.remove(`hidden`),t.style.display=`flex`,t.scrollTop=0}function Om(){let e=document.getElementById(`invite-flow-overlay`);e.classList.add(`hidden`),e.style.display=``}var km=`toto_pin_hard_`,Am=`toto_pin_att_`,jm=null,Q=`gate`,Mm=``,Nm=``,Pm=0,Fm=null;function Im(e){let t=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(jm=e,Nm=``,Mm=``,Q=t.pinHash?`enter`:`gate`,Rm(),document.getElementById(`pin-setup-overlay`).classList.remove(`hidden`))}function Lm(){Fm&&(clearInterval(Fm),Fm=null),document.getElementById(`pin-setup-overlay`).classList.add(`hidden`),jm=null}function Rm(){let e=(g.kids?.profiles||[]).find(e=>String(e.id)===String(jm));if(!e)return;let t=document.getElementById(`pso-screen`);if(!t)return;let n=e.emoji||`🧒`,r=T(e.name),i={gate:`#f8fafc`,hello:`linear-gradient(160deg,#f0fdfa,#ecfeff)`,enter:`#f8fafc`,confirm:`#f8fafc`,tour:`#f8fafc`};if(document.getElementById(`pin-setup-overlay`).style.background=i[Q]||`#f8fafc`,Q===`gate`)t.innerHTML=`
      ...
      <button onclick="_psoStep='enter';_psoRender()"
        ...
        Let's go! →
      </button>`;else if(Q===`enter`||Q===`confirm`){let n=Q===`enter`,i=n?e.pinHash?`Change ${r}'s PIN`:`Choose your secret code 🔢`:`Type it again ✅`,a=n?`Pick 4 numbers only you know!`:`Just to make sure!`,o=[0,1,2,3].map(e=>{let t=e<Nm.length;return`<div style="width:52px;height:60px;border:2px solid ${t?`#0d9488`:`#e2e8f0`};border-radius:10px;background:${t?`#f0fdfa`:`#f8fafc`};display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:700;color:#0d9488">${t?`●`:``}</div>`}).join(``),s=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div></div>`:`<div onclick="_psoKey('${e}')" style="height:52px;border:1.5px solid #e2e8f0;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:600;color:#374151;cursor:pointer;background:#fff;-webkit-tap-highlight-color:transparent;user-select:none">${e}</div>`).join(``);t.innerHTML=`
      ...
      ${r?``:`<button onclick="_psoTourDone()" style="font-size:13px;color:#94a3b8;background:none;border:none;cursor:pointer">Skip</button>`}`}}function zm(){if(Fm)return;let e=0,t=document.getElementById(`pso-hold-fill`);t&&(t.style.transition=`none`,t.style.transform=`scaleX(0)`),Fm=setInterval(()=>{e+=50;let n=Math.min(e/2e3,1);t&&(t.style.transition=`none`,t.style.transform=`scaleX(${n})`),e>=2e3&&(clearInterval(Fm),Fm=null,Q=`hello`,Rm())},50)}function Bm(){Fm&&(clearInterval(Fm),Fm=null);let e=document.getElementById(`pso-hold-fill`);e&&(e.style.transition=`transform .3s`,e.style.transform=`scaleX(0)`)}function Vm(e){if(e===`⌫`){Nm=Nm.slice(0,-1),Rm();return}Nm.length>=4||(Nm+=e,Rm(),Nm.length===4&&Hm())}async function Hm(){if(Q===`enter`)Mm=Nm,Nm=``,Q=`confirm`,Rm();else if(Q===`confirm`){if(Nm!==Mm){Nm=``,Mm=``,Q=`enter`,Rm();let e=document.getElementById(`pso-error`);e&&(e.textContent=`Those didn't match — try again 🙈`);return}await Ic(jm,Nm);let e=(g.kids?.profiles||[]).find(e=>String(e.id)===String(jm));e&&!e._pinWasSet?(Pm=0,Q=`tour`,Rm()):(Lm(),G(),ta()),e._pinWasSet=!0}}function Um(){let e=(g.kids?.profiles||[]).find(e=>String(e.id)===String(jm));Lm(),e&&Qc(e.id)}function Wm(e){return parseInt(jp(Am+e)||`0`)}function Gm(e){let t=Wm(e)+1;return Mp(Am+e,String(t)),t}function Km(e){Np(Am+e),Np(km+e)}function qm(e){return jp(km+e)===`1`}function Jm(e){Mp(km+e,`1`)}async function Ym(){let e=await Vp(Z,np());if(typeof Dp==`string`&&Dp.startsWith(`adult:`)){let t=parseInt(Dp.split(`:`)[1]),n=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[t];if(!n)return;e===n.pinHash?(X=0,Y=null,zp(),document.getElementById(`pin-overlay`).classList.add(`hidden`),$p()):(X++,Z=``,Yp(),X>=3?(Ep=Date.now()+3e4,X=0,Xp()):document.getElementById(`pin-error`).textContent=`Wrong PIN — ${3-X} tr${3-X==1?`y`:`ies`} left`);return}let t=(g.kids?.profiles||[]).find(e=>e.id===Dp);if(t){if(qm(t.id)){document.getElementById(`pin-error`).textContent=`PIN locked — ask mum or dad to reset it 🔒`,document.getElementById(`pin-pad`).innerHTML=``,Xm(t);return}if(e===t.pinHash)Km(t.id),X=0,Y={id:t.id,name:t.name,emoji:t.emoji,role:`child`},Rp(t.id),document.getElementById(`pin-overlay`).classList.add(`hidden`),$p();else if(Z=``,Yp(),X++,Gm(t.id)>=10)Jm(t.id),Ep=0,document.getElementById(`pin-error`).textContent=`PIN locked — ask mum or dad to reset it 🔒`,document.getElementById(`pin-pad`).innerHTML=``,Xm(t);else if(X>=3)Ep=Date.now()+3e4,X=0,Xp();else{let e=3-X;document.getElementById(`pin-error`).textContent=`Wrong PIN — ${e} try${e===1?``:`s`} left`}}}function Xm(e){g.notifications||(g.notifications=[]),g.notifications.some(t=>t.type===`pin-lock`&&t.kidId===e.id)||(g.notifications.unshift({id:dh(),type:`pin-lock`,kidId:e.id,msg:`${e.name}'s PIN has been locked after too many failed attempts. Reset it in Settings → Household.`,ts:new Date().toISOString(),read:!1}),J(g))}function Zm(e){Km(e),X=0,Ep=0,ta()}function Qm(e){return g.budget.months&&g.budget.months[e]||{income:g.budget.income,expenses:g.budget.expenses}}function $m(e){return!!(g.budget.months&&g.budget.months[e])}function eh(e){return g.budget.months||(g.budget.months={}),g.budget.months[e]||(g.budget.months[e]={income:JSON.parse(JSON.stringify(g.budget.income)),expenses:JSON.parse(JSON.stringify(g.budget.expenses))}),g.budget.months[e]}function th(e){let[t,n]=e.split(`-`).map(Number),r=new Date(t,n-2,1);return`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}`}function nh(e){let t=th(e),n=Qm(t);g.budget.months||(g.budget.months={}),g.budget.months[e]={income:JSON.parse(JSON.stringify(n.income.filter(e=>e.recurring!==!1))),expenses:JSON.parse(JSON.stringify(n.expenses.filter(e=>e.recurring!==!1)))},cp(`Auto-filled`,`${vh(e)} copied from ${vh(t)}`),J(g),sh(Ds),sh(Pi)}var rh=null;Object.defineProperty(window,`_scopePending`,{get(){return rh},set(e){rh=e},configurable:!0});function ih(e,t){rh={onThisMonth:e,onAllMonths:t};let n=vh($);document.getElementById(`modal-title`).textContent=`Apply changes`,document.getElementById(`modal-body`).innerHTML=`
    <p style="font-size:14px;line-height:1.6;margin:0;color:var(--text-muted)">
      Apply this change to <strong style="color:var(--text)">${n}</strong> only,
      or update the default for all months?
    </p>
    ${$m($)?`<p style="font-size:12px;color:var(--primary);margin-top:10px;margin-bottom:0">
  ...
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function ah(){rh&&(rh.onThisMonth(),rh=null),As()}function oh(){rh&&(rh.onAllMonths(),rh=null),As()}function sh(e){try{e()}catch(t){let n=t?.message||String(t),r=t?.stack||``;console.error(`Render error in `+(e.name||`?`)+`: `+n+`
`+r),typeof Sentry<`u`&&Sentry.withScope(n=>{n.setTag(`renderer`,e.name||`anonymous`),Sentry.captureException(t)})}}var ch={today:[()=>Wi()],money:[()=>Pi()],dashboard:[()=>ea()],budget:[()=>Ds()],bills:[()=>Ct()],networth:[()=>Ue()],goals:[()=>Za()],scenarios:[()=>co()],insights:[()=>Yo()],build:[()=>sa()],settings:[()=>ta()],kids:[()=>G()],planner:[()=>L()],forecast:[()=>tn()],meals:[()=>Vr()],lunchbox:[()=>zl()],pantry:[()=>Pe()],vehicles:[()=>se()],documents:[()=>ve()],maintenance:[()=>Ee()],routines:[()=>W()],lists:[()=>gi()],projects:[()=>B()]},lh=!1;function uh(){Pc(),sh(Wi);let e=ch[x()];e&&e.forEach(e=>sh(e)),lh||(lh=!0,window.Capacitor?.Plugins?.SplashScreen?.hide().catch(()=>{}))}f(uh),y(uh),l(ch,uh);function dh(){return Date.now().toString(36)+Math.random().toString(36).slice(2)}h(Sp()),pm(),setTimeout(()=>{try{uu()}catch{}},0);var $=new Date().toISOString().slice(0,7),fh=`grouped`;Object.defineProperty(window,`budgetViewMode`,{get(){return fh},set(e){fh=e},configurable:!0}),Object.defineProperty(window,`selectedBudgetMonth`,{get(){return $},set(e){$=e},configurable:!0}),window._settingsOpen=new Set([`ai`,`household`]);var ph=`all`;Object.defineProperty(window,`_billsSubsFilter`,{get(){return ph},set(e){ph=e},configurable:!0});var mh=new Date().getFullYear();Object.defineProperty(window,`dpViewYear`,{get(){return mh},set(e){mh=e},configurable:!0});var hh=new Date().getMonth()+1;Object.defineProperty(window,`dpViewMonth`,{get(){return hh},set(e){hh=e},configurable:!0});function gh(){let[e,t]=$.split(`-`).map(Number),n=new Date(e,t-2,1);$=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,Ds()}function _h(){let[e,t]=$.split(`-`).map(Number),n=new Date(e,t,1);if($=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,g.settings&&g.settings.autoFillMonths&&!$m($)){nh($);return}Ds()}function vh(e){let[t,n]=e.split(`-`).map(Number);return new Date(t,n-1,1).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`})}function yh(e){let[t,n]=e.split(`-`).map(Number);return new Date(t,n-1,1).toLocaleDateString(`en-AU`,{month:`short`,year:`2-digit`})}function bh(){let e=[],t=new Date;for(let n=5;n>=0;n--){let r=new Date(t.getFullYear(),t.getMonth()-n,1);e.push(`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}`)}return e}function xh(e,t){let n=(g.budget.actuals[t]||{})[e];return n?typeof n==`number`?[{id:1,amount:n,date:``,note:``}]:Array.isArray(n)?n:[]:[]}function Sh(e,t){return xh(e,t).reduce((e,t)=>e+(t.amount||0),0)}function Ch(e,t,n){g.budget.actuals[t]||(g.budget.actuals[t]={});let r=xh(e,t);r.length===1&&!r[0].date&&!r[0].note?g.budget.actuals[t][e]=[{...r[0],amount:n}]:g.budget.actuals[t][e]=[{id:1,amount:n,date:``,note:``}],J(g)}function wh(e){let t=Qm($).expenses.find(t=>t.id===e);if(!t)return;let n=M(t);function r(){let t=xh(e,$),r=t.reduce((e,t)=>e+(t.amount||0),0),i=n>0?Math.round(r/n*100):0,a=i>=100?`var(--danger)`:i>=80?`var(--warning)`:`var(--success)`;return`
        ...
        <div style="display:flex;flex-direction:column;gap:6px">
          ...
          <div style="display:flex;align-items:center;gap:10px;background:var(--surface2);border:1px solid var(--border);border-radius:6px;padding:8px 12px">
            <div style="flex:1">
              ...
              ${t.date?`<span style="font-size:12px;color:var(--text-muted);margin-left:8px">${A(t.date)}</span>`:``}
      ...
      </div>`:`<p style="font-size:13px;color:var(--text-muted);margin-bottom:14px">No entries yet for ${vh($)}.</p>`}
    ...
    `}document.getElementById(`modal-title`).textContent=`Actuals — ${t.name}`,document.getElementById(`modal-body`).innerHTML=`<div id="actual-editor-body">${r()}</div>`,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-primary" onclick="closeModal();renderBudget()">Done</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Th(e){let t=parseFloat(document.getElementById(`ae-amount`).value);if(!t||t<=0)return;let n=document.getElementById(`ae-date`).value||``,r=document.getElementById(`ae-note`).value.trim();g.budget.actuals[$]||(g.budget.actuals[$]={});let i=xh(e,$);i.push({id:i.length?Math.max(...i.map(e=>e.id))+1:1,amount:t,date:n,note:r}),g.budget.actuals[$][e]=i,J(g),window._actualEditorRefresh&&window._actualEditorRefresh()}function Eh(e,t){if(!g.budget.actuals[$])return;let n=xh(e,$);n.splice(t,1),g.budget.actuals[$][e]=n,J(g),window._actualEditorRefresh&&window._actualEditorRefresh()}function Dh(e){wh(e)}function Oh(){let e=Qm($),t=N(e.income),n=N(e.expenses),r=t-n,i=t>0?r/t:null,a;a=t===0?10:i>=.2?20:i>=0?Math.round(i/.2*20):0;let o=bh().slice(3),s=0,c=0;o.forEach(e=>{let t=Qm(e);t.expenses.some(t=>xh(t.id,e).length>0)&&(s++,t.expenses.reduce((t,n)=>t+Sh(n.id,e),0)<=N(t.expenses)&&c++)});let l=s===0?5:Math.round(s/3*10+c/s*10),u=(g.netWorth.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),d=(g.netWorth.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),f=u-d,p;if(u===0&&d===0)p=10;else if(f<=0)p=3;else{let e=d>0?d/u:0;p=e<.3?20:e<.6?15:e<.8?10:6}let m;if(n===0)m=10;else{let e=u/n;m=e>=6?20:e>=3?15:e>=1?8:u===0?5:3}let h=(g.goals||[]).filter(e=>e.status!==`achieved`),_;if(h.length===0)_=8;else{let e=h.reduce((e,t)=>e+Math.min((t.saved||0)/(t.target||1),1),0)/h.length;_=10+Math.round(e*10)}let v=a+l+p+m+_,y=v>=85?`A`:v>=70?`B`:v>=55?`C`:v>=40?`D`:`F`,b=v>=80?`#10b981`:v>=60?`#f59e0b`:v>=40?`#f97316`:`#ef4444`,x=[...[{score:a,tip:`Boost your savings rate — aim for 20%+ of income (currently ${t>0?Math.round((i||0)*100):0}%)`},{score:l,tip:`Log actuals monthly in the Budget tab to stay on track`},{score:p,tip:`Reduce liabilities or grow assets to strengthen your net worth`},{score:m,tip:`Build an emergency fund of 3–6 months expenses (${D(n*3)}–${D(n*6)})`},{score:_,tip:`Set specific savings goals in the Goals tab to stay focused`}]].sort((e,t)=>e.score-t.score)[0];return{total:v,grade:y,color:b,insight:x.score<12?x.tip:`Great shape — stay consistent and keep building your financial cushion.`,dimensions:[{label:`Savings Rate`,score:a,max:20},{label:`Budget Tracking`,score:l,max:20},{label:`Net Worth`,score:p,max:20},{label:`Emergency Buffer`,score:m,max:20},{label:`Goals`,score:_,max:20}]}}var kh={Wallet:`#059669`,Plan:`#0891b2`,Home:`#7c3aed`};function Ah(e){return e?`<span style="font-size:10px;font-weight:700;color:${kh[e]||`#71717a`};margin-right:6px">${e}</span>`:``}function jh(e){let t={red:`#ef4444`,amber:`#f59e0b`,green:`#10b981`,blue:`#0891b2`}[e.cls]||`#a1a1aa`,n=e.onclick?e.onclick:e.tab?`activateTab('${e.tab}')`:``;return`<div class="notif-tl-item">
    <div class="notif-tl-dot" style="background:${t}"></div>
    <div class="notif-tl-body"><div class="notif-tl-title">${Ah(e.section)}${e.title}</div>${e.sub?`<div class="notif-tl-sub">${e.sub}</div>`:``}</div>
    <div class="notif-tl-action" onclick="${n}">${e.action.replace(` →`,``)}</div>
  </div>`}function Mh(e){let t=[];return e===`budget`&&Qm($).expenses.forEach(e=>{let n=M(e),r=Sh(e.id,$);n>0&&r/n>=.8&&r<n?t.push({cls:`amber`,text:`${T(e.name)} at ${Math.round(r/n*100)}% — ${D(n-r)} left`,tab:null}):n>0&&r>=n&&t.push({cls:`red`,text:`${T(e.name)} over budget by ${D(r-n)}`,tab:null})}),t.slice(0,2).map(e=>`<div class="notif-banner ${e.cls}">
    ...
    </div>`).join(``)}function Nh(){let e=[],t=new Date,r=$,i=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`),a=g.kids?.profiles||[],o=a.length>0,s=Math.max(1,i.length)+a.length,c=Qm(r),l=c.income.length>0,u=c.expenses.length>0,d=c.expenses.some(e=>xh(e.id,r).length>0),f=(l?30:0)+(u?30:0)+(d?40:0);e.push({key:`budget`,label:`Budget`,score:f,tip:l?u?d?`On track`:`Log actual spending this month`:`Add your expenses`:`Add your income sources`,tab:`budget`});let p=zr(0),m=g.meals?.plan?.[p]||{},h=0,_=s===1?7:s<=3?14:21;for(let e=0;e<7;e++){let t=m[e]||{};s===1?t.d&&h++:s<=3?(t.l&&h++,t.d&&h++):(t.b&&h++,t.l&&h++,t.d&&h++)}let v=Math.round(h/_*80),y=g.lists?.food?.items||[],b=y.filter(e=>e.state===`active`).length,x=y.filter(e=>e.state===`got_it`).length,S=b>0||x>0,C=v+(S?20:0);e.push({key:`meals`,label:`Meals`,score:Math.min(100,C),tip:h===0?`Plan this week's meals`:h<_?`${h}/${_} meals planned`:S?`Meals sorted`:`Add items to your shopping list`,tab:`meals`});let w=g.maintenance||[],T=w.filter(e=>{let t=Te(e);return t!==null&&t<0}).length,E=w.length===0?30:Math.max(0,100-T*25),ee=g.vehicles||[],te=ee.filter(e=>!!(e.regoExpiry&&Math.ceil((new Date(e.regoExpiry)-t)/864e5)<30||e.insurance?.renewalDate&&Math.ceil((new Date(e.insurance.renewalDate)-t)/864e5)<30)).length,D=g.documents||[],O=D.filter(e=>e.expiryDate&&Math.ceil((new Date(e.expiryDate)-t)/864e5)<30).length,k=ee.length>0?.3:0,A=.3,ne=1-k-A,re=Math.max(0,Math.min(100,Math.round(E*ne+(ee.length>0?Math.max(0,100-te*30)*k:0)+(D.length>0?Math.max(0,100-O*20):50)*A)));if(e.push({key:`home`,label:`Home`,score:re,tip:T>0?`${T} maintenance overdue`:te>0?`Vehicle rego or insurance expiring`:O>0?`Documents expiring soon`:w.length===0?`Add maintenance items to track`:`Home is sorted`,tab:`maintenance`}),o){let t=g.meals?.lunchbox?.plans||{},n=zr(0),r=0,i=a.length*20;a.forEach(e=>{let i=(t[n]||{})[e.id]||{};for(let e=0;e<5;e++){let t=i[e]||{};t.main&&r++,t.snack&&r++,t.fruit&&r++,t.drink&&r++}}),typeof U==`function`?U():new Date().toISOString().slice(0,10).replace(/-/g,``);let o=g.kids?.chores||[],s=g.kids?.completions||[],c=s.filter(e=>e.status===`pending`).length,l=s.filter(e=>e.status===`approved`&&e.completedAt?.startsWith(new Date().toISOString().slice(0,10))).length,u=o.length===0?50:Math.max(0,100-c*10+l*5),d=i>0?Math.round(r/i*100):50,f=Math.min(100,Math.round(d*.5+Math.min(100,u)*.5));e.push({key:`family`,label:`Family`,score:f,tip:r===0?`Plan school lunches this week`:c>0?`${c} chore approval${c===1?``:`s`} waiting`:`Family is sorted`,tab:`kids`})}let ie=g.goals||[],j=ie.filter(e=>e.status===`active`),ae=j.length>0?j.reduce((e,t)=>e+Math.min((t.saved||t.currentAmount||0)/(t.target||t.targetAmount||1),1),0)/j.length*100:0,M=ie.length===0?20:Math.round(30+ae*.7);e.push({key:`goals`,label:`Goals`,score:Math.min(100,M),tip:ie.length===0?`Set a savings or spending goal`:ae<30?`Make progress on your goals`:`Goals progressing well`,tab:`goals`});let N=typeof hu==`function`?hu():[];if(N.length>0){let t=typeof U==`function`?U():new Date().toISOString().slice(0,10).replace(/-/g,``),n=N.filter(e=>{let n=(e.completions?.[t]||[]).length;return e.steps.length>0&&n===e.steps.length}),r=Math.round(n.length/N.length*100),i=N.reduce((e,t)=>{let n=typeof Eu==`function`?Eu(t):0;return Math.max(e,n)},0),a=Math.min(40,Math.round(i/10*40)),o=Math.min(100,20+Math.round(r*.4)+a);e.push({key:`habits`,label:`Habits`,score:o,tip:n.length===0?`Complete a routine today`:i<3?`Keep your streak going`:`${i}-day streak — keep it up`,tab:`routines`})}let P=new Date().toISOString().slice(0,10),oe=new Date(Date.now()+7*864e5).toISOString().slice(0,10),se=(g.planner?.events||[]).filter(e=>e.date>=P&&e.date<=oe).length,ce=(g.bills||[]).filter(e=>{let t=n(e);return t!==null&&t<0}).length,le=(g.documents||[]).filter(e=>e.expiryDate&&new Date(e.expiryDate)<t).length,ue=Math.min(100,Math.round((se>0?40:10)+Math.max(0,30-ce*15)+Math.max(0,30-le*15)));return e.push({key:`plan`,label:`Plan`,score:ue,tip:ce>0?`${ce} bill${ce===1?``:`s`} overdue`:le>0?`${le} document${le===1?``:`s`} expired`:se===0?`Add something to your calendar`:`Plan looks good`,tab:`planner`}),{total:Math.round(e.reduce((e,t)=>e+t.score,0)/e.length),dims:e}}function Ph(){let e=Nh();new Date().toISOString().slice(0,10);let t=g.settings?.typeADismissedMission||``,n=[...e.dims].sort((e,t)=>e.score-t.score),r=[];return n.forEach(e=>{if(e.key===`budget`&&e.score<70&&(Qm($).income.length?Qm($).expenses.length?r.push({id:`log-actuals`,title:`Log this month's actual spending`,sub:`Import a bank statement or add manually`,tab:`budget`,impact:30}):r.push({id:`add-expenses`,title:`Set up your monthly expenses`,sub:`List your regular costs`,tab:`budget`,impact:35}):r.push({id:`add-income`,title:`Add your income sources`,sub:`Takes about 1 minute`,tab:`budget`,impact:40})),e.key===`meals`&&e.score<70){let e=zr(0),t=g.meals?.plan?.[e]||{},n=Object.values(t).filter(e=>e.d).length,i=(g.lists?.food?.items||[]).filter(e=>e.state===`active`).length;n<3?r.push({id:`plan-dinners`,title:`Plan this week's dinners`,sub:`Just the evening meals — takes 2 minutes`,tab:`meals`,impact:25}):i===0&&r.push({id:`shopping-list`,title:`Add items to your shopping list`,sub:`Start with essentials you need this week`,tab:`lists`,impact:15})}if(e.key===`home`&&e.score<70){let e=(g.maintenance||[]).filter(e=>{let t=Te(e);return t!==null&&t<0});e.length?r.push({id:`maint-overdue`,title:`Clear overdue: ${T(e[0].name)}`,sub:`Mark it done or reschedule`,tab:`maintenance`,impact:20}):(g.maintenance||[]).length||r.push({id:`setup-maint`,title:`Set up household maintenance`,sub:`Add items like gutters, pest control, smoke alarms`,tab:`maintenance`,impact:20})}if(e.key===`family`&&e.score<70){let e=(g.kids?.completions||[]).filter(e=>e.status===`pending`).length,t=g.kids?.profiles||[];e>0?r.push({id:`approve-chores`,title:`Review ${e} chore approval${e===1?``:`s`}`,sub:`Kids are waiting for your sign-off`,tab:`kids`,impact:20}):t.length>0&&r.push({id:`plan-lunchbox`,title:`Plan school lunches this week`,sub:`AI can do it in one tap`,tab:`lunchbox`,impact:18})}if(e.key===`goals`&&e.score<50&&((g.goals||[]).length||r.push({id:`add-goal`,title:`Set your first savings goal`,sub:`Holiday fund, emergency savings, or debt payoff`,tab:`goals`,impact:15})),e.key===`habits`&&e.score<70&&((typeof hu==`function`?hu():[]).length===0?r.push({id:`create-routine`,title:`Create your first daily routine`,sub:`Morning or evening — takes 2 minutes to set up`,tab:`routines`,impact:25}):r.push({id:`complete-routine`,title:`Complete a routine today`,sub:`Tap each step as you go`,tab:`today`,impact:20})),e.key===`plan`&&e.score<70){let e=new Date().toISOString().slice(0,10),t=new Date(Date.now()+7*864e5).toISOString().slice(0,10);(g.planner?.events||[]).filter(n=>n.date>=e&&n.date<=t).length===0?r.push({id:`add-event`,title:`Add something to your calendar`,sub:`Even one event this week helps keep life organised`,tab:`planner`,impact:15}):r.push({id:`review-bills`,title:`Review upcoming bills`,sub:`Make sure nothing catches you off guard`,tab:`bills`,impact:15})}}),r.filter(e=>e.id!==t).sort((e,t)=>t.impact-e.impact)[0]||null}function Fh(e){g.settings||(g.settings={}),g.settings.typeADismissedMission=e,J(g);let t=document.querySelector(`.mission-lightbox`);t&&t.remove(),Wi()}function Ih(e){g.settings||(g.settings={}),g.settings.typeAMissionId=``,g.settings.typeAMissionShownDate=``,g.settings.typeADismissedMission=e,J(g);let t=document.querySelector(`.mission-lightbox`);t&&t.remove()}function Lh(){let e=g.settings?.typeAMissionShownDate;if(!e)return 0;let t=Math.floor((new Date-new Date(e))/864e5);return Math.max(0,t)}function Rh(e){if(document.querySelector(`.mission-lightbox`))return;let t=Lh(),n=e.onclick?e.onclick:e.tab?`activateTab('${e.tab}')`:``,r=document.createElement(`div`);r.className=`mission-lightbox`,r.innerHTML=`
    ...
    </div>`,r.addEventListener(`click`,t=>{t.target===r&&Fh(e.id)}),document.body.appendChild(r)}function zh(){if(!g.settings?.typeAMode)return;let e=Ph();if(!e)return;let t=new Date().toISOString().slice(0,10);if(g.settings.typeAMissionId!==e.id){g.settings.typeAMissionId=e.id,g.settings.typeAMissionShownDate=t,J(g);return}Lh()>=1&&setTimeout(()=>Rh(e),1500)}function Bh(){Nh();let e=Qm($),t=e.expenses.reduce((e,t)=>e+Sh(t.id,$),0),r=N(e.expenses),i=zr(1),a=g.meals?.plan?.[i]||{},o=Object.values(a).reduce((e,t)=>e+ +!!t.b+ +!!t.l+ +!!t.d,0),s=(g.maintenance||[]).filter(e=>{let t=Te(e);return t!==null&&t<0}).length,c=(g.bills||[]).filter(e=>{let t=n(e);return t>=0&&t<=7}),l=(g.meals?.pantry||[]).filter(e=>e.status===`need`||e.status===`low`).length,u=document.createElement(`div`);u.className=`reset-overlay`,u.innerHTML=`
    ...
    </div>`,u.addEventListener(`click`,e=>{e.target===u&&u.remove()}),document.body.appendChild(u)}function Vh(){let e=document.querySelector(`.reset-overlay`);e&&e.remove(),g.settings||(g.settings={});let t=new Date().toISOString().slice(0,10),n=g.settings.typeALastResetDate||``;n&&Math.floor((new Date-new Date(n))/864e5)<=9?g.settings.typeAStreak=(g.settings.typeAStreak||0)+1:g.settings.typeAStreak=1,g.settings.typeALastResetDate=t,J(g),Wi()}function Hh(){let e=Nh(),t=2*Math.PI*22,n=(e.total/100*t).toFixed(1),r=e.total>=80?`var(--good,#10b981)`:e.total>=60?`var(--iris-2)`:e.total>=40?`var(--amber,#f59e0b)`:`var(--ember,#f97316)`,i=e.total>=80?`Crushing it — keep going`:e.total>=60?`Good shape — a few things to tidy`:e.total>=40?`Getting there — some gaps to fill`:`Just getting started`,a=Bt?`▲`:`▼`,o=e.dims.map(e=>{let t=e.score>=75?`var(--good,#10b981)`:e.score>=50?`var(--iris-2)`:e.score>=30?`var(--amber,#f59e0b)`:`var(--ember,#f97316)`,n=e.score>=75?`var(--good,#10b981)`:e.score>=50?`var(--iris-1)`:e.score>=30?`var(--amber,#f59e0b)`:`var(--ember,#f97316)`;return`<div class="life-dim">
  ...
  </div>`}function Uh(){let e=Ph();if(!e)return``;let t=Lh(),n=e.onclick?`onclick="${e.onclick}"`:e.tab?`onclick="activateTab('${e.tab}')"`:``;return`<div class="mission-card" ${n}>
  ...
  </div>`}function Wh(){let e=Qm($),t=g.householdProfile?.members||[],n=t.filter(e=>e.role===`adult`),r=t.filter(e=>e.role===`child`),i=[];if(i.push({id:`members`,label:`Add your household members`,done:n.length>0,tab:null}),i.push({id:`income`,label:`Set up income sources`,done:(e.income||[]).length>0,tab:`budget`}),i.push({id:`expenses`,label:`Add monthly expenses`,done:(e.expenses||[]).length>0,tab:`budget`}),r.length>0&&i.push({id:`kids`,label:`Add kids to your household`,done:!0,tab:null}),n.length>=2){let e=n[1]?.name||`your partner`,t=(g.householdProfile.authorizedUsers||[]).length>0||(g.householdProfile.invites||[]).some(e=>e.status===`accepted`);i.push({id:`invite`,label:`Invite ${e} to your household`,done:t,tab:`settings`,settingsSection:`household-access`})}if(i.push({id:`goals`,label:`Set your first savings goal`,done:(g.goals||[]).length>0,tab:`goals`}),i.push({id:`networth`,label:`Add your net worth (assets & debts)`,done:(g.netWorth?.assets||[]).length>0||(g.netWorth?.liabilities||[]).length>0,tab:`networth`}),i.push({id:`vehicles`,label:`Add your vehicles`,done:(g.vehicles||[]).length>0,tab:`vehicles`}),r.length>0){let e=r[0]?.name||`your child`;i.push({id:`chores`,label:`Set up ${T(e)}'s first chores`,done:(g.kids?.chores||[]).length>0,tab:`kids`})}return i}var Gh=!1;Object.defineProperty(window,`_spExpanded`,{get(){return Gh},set(e){Gh=e},configurable:!0});var Kh=!1;Object.defineProperty(window,`_spDoneExpanded`,{get(){return Kh},set(e){Kh=e},configurable:!0});function qh(){let e=document.getElementById(`setup-progress-card`);e&&(e.innerHTML=Fi())}var Jh=null;Object.defineProperty(window,`expenseSortCol`,{get(){return Jh},set(e){Jh=e},configurable:!0});var Yh=`asc`;Object.defineProperty(window,`expenseSortDir`,{get(){return Yh},set(e){Yh=e},configurable:!0});var Xh=`all`;Object.defineProperty(window,`expenseFilterCat`,{get(){return Xh},set(e){Xh=e},configurable:!0});function Zh(e){Xh=e,Ds()}function Qh(e){Yh=Jh===e&&Yh===`asc`?`desc`:`asc`,Jh=e,Ds()}function $h(e,t,n=``){let r=Jh===e;return`<th class="sortable${r?` sort-active`:``}" onclick="sortExpenses('${e}')">${t}${n}<span class="sort-icon">${r?Yh===`asc`?`↑`:`↓`:`↕`}</span></th>`}function eg(e){let t=[`th`,`st`,`nd`,`rd`],n=e%100;return e+(t[(n-20)%10]||t[n]||t[0])}var tg=`plan`;Object.defineProperty(window,`_mealView`,{get(){return tg},set(e){tg=e},configurable:!0}),window._acceptInviteAndContinue=Cm,window._addRecurrenceToDate=pr,window._adultPinKey=Gc,window._adultPinSubmit=Kc,window._applyActiveProfile=$p,window._applyChildNav=Pc,window._applyMigrations=fp,window._autoCreateRecurringEvents=mr,window._briefIcon=Ri,window._briefRow=Ui,window._budgetAllocByCategory=Cs,window._buildTotoContext=Er,window._capacitorPrefs=kp,window._categoryIcon=Es,window._checkInviteOnLoad=pm,window._checkMissionEscalation=zh,window._checkSettingsUnsaved=ps,window._chipClassFor=zi,window._chipLabelFor=Bi,window._copyInviteLinkForMember=sm,window._csOpen=yp,window._csvSetExpense=xc,window._csvToggle=yc,window._csvToggleAll=bc,window._csvUpdateApplyBtn=Sc,window._cvAgeBracket=qc,window._cvCalViewToggle=hl,window._cvConfetti=Zc,window._cvDismissNotif=xl,window._cvEventsForDate=sl,window._cvFmt12h=cl,window._cvMonthDayTap=yl,window._cvRefreshSchedulePanel=dl,window._cvRender7Day=gl,window._cvRenderCalendar=ml,window._cvRenderMonth=vl,window._cvRenderPrizesTab=el,window._cvRoutineAvailLabel=Xc,window._cvRoutineIsActive=Yc,window._cvRoutineSchedCard=pl,window._cvScheduleHtml=fl,window._cvShowDayDetail=bl,window._cvShowPrizeConfirm=Sl,window._cvSwitchTab=ol,window._cvTimeGreeting=Jc,window._cvToggleRoutineExpand=ll,window._cvToggleStepFromCal=ul,window._cvUpdatePrizesBadge=$c,window._cvWeekDayTap=_l,window._devLoadAll=Pl,window._devLoadHome=Ml,window._devLoadKids=kl,window._devLoadMeals=Nl,window._devLoadPlanner=jl,window._devLoadRoutines=Al,window._devLoadWallet=Ol,window._devReset=Fl,window._devToolsClose=Dl,window._devToolsOpen=El,window._dismissInviteFlow=Om,window._docCatMeta=_e,window._ensureKidProfileAndPin=om,window._ensureNWModals=Ze,window._estimateMealCalories=Zr,window._fetchAIBriefing=$i,window._finishInviteJourney=Tm,window._getHouseholdDocRef=rp,window._getHouseholdOwnerUID=np,window._getInviteUrl=cm,window._getNthDayOfMonth=ur,window._getPinTotalAttempts=Wm,window._handlePendingInvite=mm,window._hashPin=Vp,window._incPinTotalAttempts=Gm,window._inferAisle=Fr,window._initAuthListener=mp,window._isPinHardLocked=qm,window._listsAddFavourite=pi,window._listsAddItem=ii,window._listsAddUsual=mi,window._listsArchive=fi,window._listsClearTrolley=di,window._listsDeleteItem=oi,window._listsOpenAddForm=ci,window._listsQuickAdd=si,window._listsSaveForm=ui,window._listsSetState=ai,window._listsUpdateParsePreview=hi,window._maintDaysUntil=Te,window._maintNextDue=we,window._markSettingsDirty=us,window._mealGetSuggestions=Yr,window._mealPill=Kr,window._mealPriceSlide=Jr,window._mealToggleFilter=qr,window._mealWeekDates=Br,window._mealWeekKey=zr,window._missionDaysIgnored=Lh,window._nextForecastMonth=en,window._pantryToAisle=li,window._parseShopInput=Ir,window._pickAdult=Kp,window._pickKid=qp,window._pinKey=Zp,window._plannerCloseDaySheet=vn,window._plannerCloseDetail=Tn,window._plannerCloseLifeSheet=Sn,window._plannerCloseShare=kn,window._plannerCopyShareUrl=jn,window._plannerEditFromDetail=Dn,window._plannerEvMemberIds=Gt,window._plannerEvPrimaryMember=Kt,window._plannerEvWhoLabel=qt,window._plannerEventsForDate=Xt,window._plannerFmt12h=Zt,window._plannerGoToday=fn,window._plannerHandleDaySheetClick=yn,window._plannerHandleDetailClick=En,window._plannerHandleLifeSheetClick=Cn,window._plannerHandleShareClick=An,window._plannerMemberById=Wt,window._plannerMembers=Ut,window._plannerNextMonth=cn,window._plannerNudges=Nn,window._plannerOpenDaySheet=gn,window._plannerOpenDetail=wn,window._plannerOpenLifeSheet=xn,window._plannerOpenModalFromSheet=bn,window._plannerOpenShare=On,window._plannerPrevMonth=sn,window._plannerRecurrenceLabel=Jt,window._plannerRenderDaySheetList=_n,window._plannerSelectDay=ln,window._plannerSetView=pn,window._plannerShareVia=Mn,window._plannerToggleFilter=hn,window._plannerToggleSection=mn,window._plannerVisibleEvents=Yt,window._pmDpClear=rr,window._pmDpNext=or,window._pmDpOpen=$n,window._pmDpOutsideClick=er,window._pmDpPrev=ar,window._pmDpRender=tr,window._pmDpSelect=nr,window._pmDpToday=ir,window._pmFmtDate=qn,window._pmFmtDateShort=Jn,window._pmHandleCatChange=Qn,window._pmRenderMemberPicker=Yn,window._pmToggleAllDay=Zn,window._pmToggleMember=Xn,window._prevForecastMonth=$t,window._psoHoldEnd=Bm,window._psoHoldStart=zm,window._psoKey=Vm,window._psoRender=Rm,window._psoSubmit=Hm,window._psoTourDone=Um,window._pushAllEventsToBudget=lr,window._qaKey=jc,window._qaSelectCat=Mc,window._qahAction=Dc,window._qahApplyParsed=kc,window._qahSendText=Oc,window._recordInviteAcceptance=wm,window._refreshSetupProgress=qh,window._renderAdultPinModal=Wc,window._renderApiKeySummary=_s,window._renderContextBanners=Mh,window._renderCsvPreview=gc,window._renderCsvReview=vc,window._renderInviteFlow=Dm,window._renderLifeAreas=Hi,window._renderLifeScore=Hh,window._renderListItem=yi,window._renderListsDetail=vi,window._renderListsSelector=_i,window._renderMealPlan=Hr,window._renderMissionCard=Uh,window._renderNudgeSection=fr,window._renderPinDots=Yp,window._renderPinPad=Xp,window._renderPlannerAgenda=un,window._renderPlannerEventRow=on,window._renderPlannerMonthGrid=rn,window._renderPlannerWeekStrip=an,window._renderQAHub=Ec,window._renderQASheet=Ac,window._renderShoppingList=Qr,window._renderTourSlide=bm,window._renderWeekStrip=Vi,window._resetPinAttempts=Km,window._saveInviteIncome=Sm,window._sectionTag=Ah,window._secureClear=Np,window._secureGet=jp,window._securePrewarm=Ap,window._secureSet=Mp,window.prefsGet=jp,window.prefsSet=Mp,window.prefsClear=Np,window._setHouseholdOwner=ip,window._setInviteRole=rm,window._setPinHardLock=Jm,window._showInviteA1=hm,window._showInviteA3=gm,window._showInviteA4=ym,window._showInviteExpired=Em,window._showInviteIncomePrompt=xm,window._showMissionLightbox=Rh,window._showParentLockNotification=Xm,window._showPinScreen=Jp,window._showToast=ri,window._startFirestoreSync=pp,window._syncVehicleBill=ue,window._tdCloseSheet=Ji,window._tdOpenHeadsUpSheet=Gi,window._tdOpenSheet=qi,window._tdOpenSlippingSheet=Ki,window._tdToggleStep=Yi,window._ticker=Ts,window._tlItem=jh,window._todayAllocSegments=Li,window._totoAppendMessage=Dr,window._totoInitPanel=Sr,window._totoRemoveTyping=kr,window._totoSend=Tr,window._totoSendSuggestion=Cr,window._totoShowTyping=Or,window._updatePillsOverflow=S,window._updateSwitchBtn=Qp,window._verifyPin=Ym,window.activateTab=w,window.addActualEntry=Th,window.addCatToGroup=as,window.addCategory=bs,window.addHouseholdMember=Oo,window.addPet=jo,window.addShopItem=$r,window.addSubFromImport=gt,window.adjForm=go,window.applianceForm=Di,window.applianceFromForm=Oi,window.applyCsvImport=Cc,window.approveSuggestion=Ln,window.assignDevice=Wp,window.aud=D,window.audD=O,window.billCatIcon=bt,window.billDueBadge=xt,window.billMonthlyEquiv=St,window.billsModal=Et,window.calcFinancialHealth=Oh,window.calcLifeScore=Nh,window.calcScenario=so,window.cancelSettingsChanges=fs,window.clearActivityLog=ys,window.clearAdultPin=zc,window.clearCheckedShopItems=ni,window.clearDeviceProfile=Ip,window.clearKidPin=Lc,window.clearKidSession=zp,window.closeBillModal=Ot,window.closeModal=As,window.closeNWModal=$e,window.closeNWTargetModal=Je,window.closePinSetupOverlay=Lm,window.closeQuickAdd=Tc,window.closeSubModal=ft,window.closeTotoAssistant=xr,window.completeMission=Ih,window.completeWeeklyReset=Vh,window.confirmScope=ih,window.copyInviteLink=lm,window.copyMonthFromPrevious=nh,window.customSelect=vp,window.cyclePantryStatus=Fe,window.deleteAdjustment=yo,window.deleteAppliance=ji,window.deleteBill=jt,window.deleteCategoryGroup=rs,window.deleteDoc=xe,window.deleteExpense=ic,window.deleteExtra=qs,window.deleteFurniture=Ei,window.deleteGoal=ro,window.deleteIncome=Qs,window.deleteMaint=ke,window.deleteNWItem=tt,window.deletePantryItem=Re,window.deletePlannerEvent=Vn,window.deleteScenario=ho,window.deleteService=me,window.deleteStage=Is,window.deleteSub=mt,window.deleteVariation=Vs,window.deleteVehicle=de,window.detectSpendingPatterns=Vo,window.dismissMission=Fh,window.dismissSubResult=_t,window.dismissSuggestion=Rn,window.doScopeAll=oh,window.doScopeMonth=ah,window.dpClearDate=dc,window.dpDateInput=ac,window.dpNextMonth=lc,window.dpPrevMonth=cc,window.dpSelectDate=uc,window.editActual=Dh,window.ensureMonthOverride=eh,window.escAttr=E,window.escHtml=T,window.estimateAllEvents=nn,window.estimatePlannerEvent=Hn,window.expenseCategories=ca,window.expenseForm=$s,window.expenseFromForm=ec,window.exportData=ra,window.extraForm=Us,window.extraFromForm=Ws,window.fmtDate=A,window.fmtNW=k,window.freqDisplay=ie,window.freqDisplayItem=j,window.freqLabel=re,window.freqLabelItem=ae,window.furnitureForm=Si,window.furnitureFromForm=Ci,window.generateInvite=im,window.generateMission=Ph,window.generateShoppingList=bi,window.generateSmartInsights=Wo,window.generateSmartInsightsHTML=Xo,window.getAIKey=Ro,window.getActual=Sh,window.getActualEntries=xh,window.getBenchmarkStatus=Io,window.getBenchmarks=Fo,window.getCategoryHistoryData=Bo,window.getDeviceProfile=Pp,window.getKidSession=Lp,window.getLast6Months=bh,window.getMonthData=Qm,window.getSeasonalNudges=dr,window.goToPlannerDay=dn,window.goalForm=Qa,window.goalFromForm=eo,window.goalProgress=ua,window.guestMode=up,window.handleCsvFile=hc,window.handleDeviceRouting=Hp,window.handleSubCSV=ht,window.importData=ia,window.incomeCategories=la,window.incomeForm=Js,window.incomeFromForm=Ys,window.inviteMember=am,window.isMonthCustomized=$m,window.isOverdue=ne,window.itemMonthly=M,window.loadColors=So,window.loadData=Sp,window.logActivity=cp,window.markBillPaid=Mt,window.markChoreChildView=Cl,window.markGoalAchieved=io,window.markMaintDone=Ae,window.monthLabel=vh,window.monthShortLabel=yh,window.monthlyTotal=N,window.nextId=P,window.nextInsightsMonth=Qo,window.nextMoneyMonth=Ni,window.nextMonth=_h,window.nwItemRow=We,window.openActualEditor=wh,window.openAddAdjustment=vo,window.openAddAppliance=ki,window.openAddCatToGroup=os,window.openAddCategoryGroup=ts,window.openAddExpense=nc,window.openAddExtra=Gs,window.openAddFurniture=wi,window.openAddGoal=to,window.openAddIncome=Xs,window.openAddScenario=po,window.openAddStage=Ps,window.openAddVariation=zs,window.openBillModal=Dt,window.openCsvImport=pc,window.openDatePicker=oc,window.openDocForm=ye,window.openEditAppliance=Ai,window.openEditContractTotal=js,window.openEditExpense=rc,window.openEditExtra=Ks,window.openEditFurniture=Ti,window.openEditGoal=no,window.openEditIncome=Zs,window.openEditScenario=mo,window.openEditStage=Fs,window.openEditVariation=Bs,window.openEmojiPickerModal=es,window.openIconPickerForGroup=ns,window.openMaintForm=De,window.openMealEdit=Gr,window.openModal=V,window.openNWModal=Qe,window.openNWTargetModal=qe,window.openNavGroupFor=$f,window.openPantryForm=Ie,window.openPinSetup=Im,window.openPlannerModal=Kn,window.openQuickAdd=wc,window.openServiceForm=fe,window.openSubModal=dt,window.openTotoAssistant=br,window.openVehicleForm=ce,window.openWeeklyReset=Bh,window.ordinal=eg,window.pantryToShoppingList=Be,window.parseBankCSV=mc,window.prevInsightsMonth=Zo,window.prevMoneyMonth=Mi,window.prevMonth=gh,window.prevMonthStr=th,window.profileAdults=Eo,window.profileChildren=Do,window.quickAddMaint=je,window.quickAddPantry=ze,window.redeemPrizeChildView=wl,window.removeActualEntry=Eh,window.removeApiKey=gs,window.removeCatFromGroup=ss,window.removeCategory=xs,window.removeHouseholdMember=ko,window.removePet=Mo,window.removeShopItem=ti,window.renderAll=uh,window.renderBenchmarksSection=Jo,window.renderBills=Ct,window.renderBudget=Ds,window.renderBudgetForecast=cr,window.renderBudgetSuggestions=zn,window.renderBuild=sa,window.renderCategoryBreakdown=Ho,window.renderDashboard=ea,window.renderDocuments=ve,window.renderDpCalendar=sc,window.renderExpenseGroups=Ss,window.renderForecast=tn,window.renderGoals=Za,window.renderInsightCards=qo,window.renderInsights=Yo,window.renderLists=gi,window.renderLunchbox=zl,window.renderMaintenance=Ee,window.renderMeals=Vr,window.renderMoneyDashboard=Pi,window.renderNWDebtCard=Ke,window.renderNWTargetCard=Ge,window.renderNWTrend=Xe,window.renderNetWorth=Ue,window.renderPantry=Pe,window.renderPlanner=L,window.renderRoutines=W,window.renderScenarios=co,window.renderSettings=ta,window.renderSetupProgress=Fi,window.renderSpendingPatterns=Uo,window.renderSubImportResults=ut,window.renderSubscriptions=Tt,window.renderToday=Wi,window.renderVehicles=se,window.resetAllData=na,window.resetKidPinLock=Zm,window.revokeInvite=dm,window.runAIInsights=Ko,window.runCsvCategorise=_c,window.safeRender=sh,window.sanitiseState=oe,window.saveAIKey=zo,window.saveApiKey=hs,window.saveBill=At,window.saveColors=Co,window.saveData=J,window.saveDoc=be,window.saveMaint=Oe,window.saveMealSlot=Xr,window.saveNWItem=et,window.saveNWSnapshot=nt,window.saveNWTarget=Ye,window.savePantryItem=Le,window.savePlannerEvent=sr,window.saveQuickAdd=Nc,window.saveService=pe,window.saveSettingsChanges=ds,window.saveSub=pt,window.saveVehicle=le,window.scenarioForm=uo,window.scenarioFromForm=fo,window.sendInviteEmail=um,window.sendTotoMessage=wr,window.setActual=Ch,window.setAdultPin=Rc,window.setBillsFilter=wt,window.setBudgetView=oa,window.setDeviceProfile=Fp,window.setExpenseFilter=Zh,window.setKidPin=Ic,window.setKidSession=Rp,window.setupProgressTasks=Wh,window.showChildView=Qc,window.showDeviceSetup=Up,window.showProfileSelector=Gp,window.signInWithGoogle=lp,window.signOutUser=dp,window.sortExpenses=Qh,window.stageForm=Ms,window.stageFromForm=Ns,window.subCatIcon=ot,window.subMonthlyAmount=st,window.suggestEventToBudget=In,window.switchProfile=Fc,window.switchToKidMode=Tl,window.thSort=$h,window.toggleAdjFields=_o,window.toggleBillDayField=kt,window.toggleBudgetDetail=ks,window.toggleCustomFreq=tc,window.toggleGoalFields=$a,window.toggleGroupExpand=aa,window.toggleInsightSheet=Xi,window.toggleNavGroup=Qf,window.togglePlannerCard=Pn,window.togglePlannerEstimate=Fn,window.toggleScenario=lo,window.toggleSettingsSection=vs,window.toggleShopItem=ei,window.toggleSidebar=Xf,window.toggleTotoAssistant=yr,window.uid=dh,window.DEFAULT_DATA=xp,window.unpushEventFromBudget=Bn,window.updateCars=Po,window.updateCategoryGroup=is,window.updateColor=To,window.updateMember=Ao,window.updatePet=No,window.updateSetting=ms,window.upgradeSelects=bp,window.variationForm=Ls,window.variationFromForm=Rs,window.LB_ALLERGIES=Rl,window.LB_SLOTS=Ll,window._estimateLbCalories=Gl,window._lbActiveKid=Il,window._lbWeekOffset=0,window._saveLbSlot=Wl,window.aiPlanLunchbox=Kl,window.deleteLbProfile=Hl,window.lbToShoppingList=ql,window.openLunchboxEdit=Ul,window.openLunchboxProfile=Bl,window.saveLbProfile=Vl,window.HEALTH_GUIDES=iu,window._cleanupGuide=ru,window._cvReadOnly=ou,window._cvViewCalendar=cu,window._guideCleanup=Zl,window._guideIdx=Xl,window._guideSteps=Yl,window._highlightStep=eu,window._recurrenceMatchesDate=Nt,window._showGuideStep=$l,window.endGuide=nu,window.exitChildView=lu,window.nextGuideStep=tu,window.startGuide=Ql,window.startHealthGuide=au,window.toggleHealthPopover=Jl,window.viewChildToday=su,window.ROUTINE_SUGGESTIONS=fu,window.SUGG_PREVIEW=3,window._assignmentCompletedToday=Su,window._assignmentHistory=wu,window._assignmentStreak=Cu,window._renderAdultRoutines=Fu,window._renderChildRoutines=Uu,window._renderRoutinesTodayCard=Mu,window._renderSuggestionsSection=Bu,window._routineActiveTab=Nu,window._routineAddStep=od,window._routineAddSuggestion=Hu,window._routineAssertScope=ku,window._routineAvailableSuggestions=Ou,window._routineAwardPoints=Ju,window._routineAwardStepPoints=qu,window._routineCheckDailyReset=uu,window._routineCompletedToday=Tu,window._routineCreate=vd,window._routineCurrentUserId=mu,window._routineDateKey=pu,window._routineDelete=bd,window._routineDeleteChild=Wu,window._routineDeleteStep=ud,window._routineDragEnd=ad,window._routineDragIdx=td,window._routineDragOver=rd,window._routineDragStart=nd,window._routineDrop=id,window._routineDuplicateFromJoined=Dd,window._routineDuplicateTo=Td,window._routineEdit=ld,window._routineEditStep=dd,window._routineEditSuggestion=Vu,window._routineExpandSugg=zu,window._routineGetAssignment=xu,window._routineHistory=Du,window._routineIntelNudge=ju,window._routineIsOwner=_u,window._routineJoin=Ed,window._routineKids=vu,window._routineLeave=xd,window._routineManageAssignments=fd,window._routineMatchesDate=du,window._routineNextId=yu,window._routineOtherAdults=bu,window._routinePauseMenu=Zu,window._routinePropagateStepAdd=sd,window._routinePropagateStepDelete=cd,window._routineRecurrenceCollect=_d,window._routineRecurrenceFormHtml=md,window._routineRecurrenceSummaryUpdate=gd,window._routineRecurrenceTypeChange=hd,window._routineRemovePause=Qu,window._routineResetToday=Yu,window._routineResetTodayAllKids=ed,window._routineResetTodayKid=$u,window._routineSaveValidated=Au,window._routineSetTab=Pu,window._routineShareMenu=Cd,window._routineShowHistory=Od,window._routineSkipDay=Xu,window._routineStreak=Eu,window._routineSuggCollapsed=Iu,window._routineSuggExpanded=Lu,window._routineTodayKey=U,window._routineToggleAssignment=pd,window._routineToggleShare=wd,window._routineToggleStep=Gu,window._routineToggleStepKid=Ku,window._routineToggleSugg=Ru,window._routineTypeSelect=yd,window._routineUnassign=Sd,window._routinesForCurrentUser=hu,window._routinesForHousehold=gu,window.CHILD_EVENT_EMOJIS=Bd,window.CHORE_EMOJIS=Qd,window.KID_EMOJIS=Zd,window.PRIZE_EMOJIS=$d,window._deleteChildEvent=Hd,window._openChildEventModal=Vd,window._renderChildEventsMgmt=zd,window.addSavings=pf,window.approveCompletion=Wd,window.approveRedemption=qd,window.deleteChore=Yd,window.deleteKid=sf,window.deletePrize=Xd,window.emojiPicker=ef,window.kidBalance=Md,window.kidsParentTab=Ad,window.kidsView=kd,window.markChoreDone=Ud,window.openAddKidModal=rf,window.openChoreModal=cf,window.openEditKidModal=af,window.openPrizeModal=uf,window.openSavingsModal=ff,window.pickEmoji=tf,window.pickedEmoji=nf,window.rejectCompletion=Gd,window.rejectRedemption=Jd,window.renderApprovals=Ld,window.renderChoreMgmt=Fd,window.renderKidView=Rd,window.renderKids=G,window.renderKidsOverview=Pd,window.renderKidsParent=Nd,window.renderPrizeMgmt=Id,window.requestRedemption=Kd,window.saveChore=lf,window.saveKid=of,window.savePrize=df,window.addLink=Df,window.attachBtn=Sf,window.deleteReceiptById=bf,window.fileIcon=wf,window.fileSizeStr=Cf,window.fundingBadge=xf,window.getDB=gf,window.getReceipts=vf,window.installApp=Nf,window.openReceiptsModal=Tf,window.refreshReceiptCounts=_f,window.removeReceipt=jf,window.renderReceiptsList=Ef,window.saveReceipt=yf,window.uploadFiles=kf,window.uploadReceiptFiles=Of,window.viewReceipt=Af,window.OB_EXPENSE_PRESETS=Pf,window.hideOnboarding=Rf,window.obBack=Kf,window.obFinish=Yf,window.obNext=Gf,window.obPickEmoji=Hf,window.obSetAdults=zf,window.obSetKids=Bf,window.obSkip=qf,window.obSkipExpenses=Jf,window.obStepPosition=If,window.obStepSequence=Ff,window.obToggleEmojiPicker=Vf,window.obToggleExpenseSkip=Uf,window.renderObStep=Wf,window.showOnboarding=Lf;
//# sourceMappingURL=index-8u6ueQLJ.js.map