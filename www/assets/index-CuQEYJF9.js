import"./firebase-DD2PS53O.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(e,t){return t===`daily`?e*365/12:t===`weekly`?e*52/12:t===`fortnightly`?e*26/12:t===`quarterly`?e/3:t===`annually`||t===`annual`?e/12:e}function t(e){let t=new Date;t.setHours(0,0,0,0);let n=e.frequency||`Monthly`;if(n===`Monthly`){let n=parseInt(e.dueDay)||1,r=new Date(t.getFullYear(),t.getMonth(),n);return r<t&&(r=new Date(t.getFullYear(),t.getMonth()+1,n)),r}let r=e.lastPaid?new Date(e.lastPaid):e.startDate?new Date(e.startDate):t;r.setHours(0,0,0,0);let i={Weekly:7,Fortnightly:14,Quarterly:91,Annually:365}[n]||30,a=new Date(r);for(;a<=t;)a=new Date(a.getTime()+i*864e5);return a}function n(e){let n=new Date;n.setHours(0,0,0,0);let r=t(e);return Math.round((r-n)/864e5)}var r={},i=new Set,a=new Set,o={},s=null,c=!1;function l(e,t){o=e,s=t}function u(){c||(c=!0,requestAnimationFrame(d))}function d(){if(c=!1,!s)return;if(a.has(`__all__`)||a.size===0){a.clear(),s();return}let e=new Set(a);a.clear(),e.add(`today`),e.forEach(e=>{let t=o[e];t&&t.forEach(t=>{try{t()}catch(t){console.error(`render error in`,e,t)}})})}function f(e){return i.add(e),()=>i.delete(e)}function p(){i.forEach(e=>{try{e(r)}catch(e){console.error(`store subscriber error:`,e)}})}function m(e){r=e,a.add(`__all__`),u(),p()}function h(e){r=e}var g=new Proxy({},{get(e,t){if(t!==`then`)return r[t]},set(e,t,n){return r[t]=n,!0},has(e,t){return t in r},ownKeys(){return Reflect.ownKeys(r)},getOwnPropertyDescriptor(e,t){let n=Object.getOwnPropertyDescriptor(r,t);return n?{...n,configurable:!0}:void 0}}),_={wallet:{navTab:`budget`,label:`Wallet`,tabs:[{tab:`budget`,label:`Budget`},{tab:`bills`,label:`Bills`},{tab:`networth`,label:`Net Worth`},{tab:`goals`,label:`Goals`},{tab:`insights`,label:`Insights`},{tab:`build`,label:`Build`}]},plan:{navTab:`planner`,label:`Plan`,tabs:[{tab:`planner`,label:`Planner`},{tab:`forecast`,label:`Forecast`},{tab:`meals`,label:`Meals`},{tab:`lunchbox`,label:`Lunchbox`},{tab:`pantry`,label:`Pantry`},{tab:`routines`,label:`Routines`},{tab:`lists`,label:`Lists`}]},home:{navTab:`documents`,label:`Home`,tabs:[{tab:`documents`,label:`Documents`},{tab:`vehicles`,label:`Vehicles`},{tab:`maintenance`,label:`Maintenance`},{tab:`kids`,label:`Kids`}]}},v=()=>{};function y(e){v=e}function b(e){for(let[t,n]of Object.entries(_))if(n.tabs.some(t=>t.tab===e))return t;return null}function x(){let e=document.querySelector(`.tab-panel.active`);return e?e.id.replace(`tab-`,``):`today`}function S(e){if(!e)return;let t=e.querySelector(`.section-pills`);if(!t)return;let n=t.scrollWidth-t.scrollLeft-t.clientWidth>4,r=t.scrollLeft>4;e.classList.toggle(`has-overflow-right`,n),e.classList.toggle(`has-overflow-left`,r)}function C(e){e===`subscriptions`&&(e=`bills`),e===`scenarios`&&(e=`insights`),e===`money`&&(e=`budget`),e===`dashboard`&&(e=`budget`),document.getElementById(`tab-`+e)||(e=`today`),typeof window._checkSettingsUnsaved==`function`&&x()===`settings`&&e!==`settings`&&window._checkSettingsUnsaved(e),document.querySelectorAll(`.nav-item, .nav-text-item, .bn-item`).forEach(e=>e.classList.remove(`active`)),document.querySelectorAll(`.tab-panel`).forEach(e=>e.classList.remove(`active`));let t=document.getElementById(`tab-`+e);t&&t.classList.add(`active`);let n=b(e);if(n){let e=_[n].navTab;document.querySelectorAll(`[data-tab="${e}"]`).forEach(e=>e.classList.add(`active`))}else document.querySelectorAll(`[data-tab="${e}"]`).forEach(e=>e.classList.add(`active`));if(document.body.dataset.section=n||e,document.querySelectorAll(`.static-section-header`).forEach(e=>e.classList.remove(`active`)),n){let t=document.getElementById(n+`-section-header`);if(t){t.classList.add(`active`);let r=document.getElementById(n+`-header-date`);r&&(r.textContent=new Date().toLocaleDateString(`en-AU`,{weekday:`long`,month:`long`,day:`numeric`})),t.querySelectorAll(`.section-pill`).forEach(t=>t.classList.toggle(`active`,t.dataset.pill===e)),requestAnimationFrame(()=>t.querySelectorAll(`.section-pills-wrap`).forEach(S))}}v()}function w(e){e===`subscriptions`&&(e=`bills`),e===`scenarios`&&(e=`insights`),e===`money`&&(e=`budget`),e===`dashboard`&&(e=`budget`),(location.hash.slice(1)||`today`)!==e&&history.pushState({tab:e},``,`#`+e),C(e)}window.addEventListener(`popstate`,e=>{C(e.state?.tab||location.hash.slice(1)||`today`)}),(function(){let e=location.hash.slice(1)||`today`;history.replaceState({tab:e},``,e===`today`?location.pathname+location.search:`#`+e)})();function T(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function E(e){return T(e).replace(/\\/g,`\\\\`)}var D=new Intl.NumberFormat(`en-AU`,{style:`currency`,currency:`AUD`,maximumFractionDigits:0}),ee=new Intl.NumberFormat(`en-AU`,{style:`currency`,currency:`AUD`,minimumFractionDigits:2,maximumFractionDigits:2});function O(e){return D.format(e||0)}function te(e){return ee.format(e||0)}function k(e){let t=Math.abs(e),n=t>=1e6?(t/1e6).toFixed(2)+`M`:t>=1e3?(t/1e3).toFixed(1)+`k`:t.toFixed(0);return(e<0?`-$`:`$`)+n}function A(e){if(!e)return`—`;let[t,n,r]=e.split(`-`);return`${r}/${n}/${t}`}function ne(e){return e?new Date(e)<new Date:!1}function re(e){return{daily:`/day`,weekly:`/wk`,fortnightly:`/fn`,monthly:`/mo`,quarterly:`/qtr`,annually:`/yr`,annual:`/yr`}[e]||`/mo`}function j(e){return{daily:`Daily`,weekly:`Weekly`,fortnightly:`Fortnightly`,monthly:`Monthly`,quarterly:`Quarterly`,annually:`Annually`,annual:`Annually`,custom:`Custom`}[e]||`Monthly`}function M(e){return(e.frequency||`monthly`)===`custom`?`Every ${e.customEvery||1} ${e.customUnit||`weeks`}`:j(e.frequency||`monthly`)}function ie(e){return(e.frequency||`monthly`)===`custom`?`/${e.customEvery||1}${e.customUnit===`months`?`mo`:`wk`}`:re(e.frequency||`monthly`)}function N(t){let n=t.frequency||`monthly`;if(n===`custom`){let e=t.customEvery||1;return t.customUnit===`months`?(t.amount||0)/e:(t.amount||0)*52/(e*12)}return e(t.amount||0,n)}function P(e){return e.reduce((e,t)=>e+N(t),0)}function F(e){return e.length?Math.max(...e.map(e=>e.id))+1:1}function ae(e){function t(e){if(!(!e||typeof e!=`object`))for(let n of Object.keys(e))typeof e[n]==`string`&&e[n].length>500?e[n]=e[n].slice(0,500):Array.isArray(e[n])?e[n].forEach(e=>t(e)):typeof e[n]==`object`&&e[n]!==null&&t(e[n])}t(e)}function oe(){let e=g.vehicles||[];if(e.length===0){document.getElementById(`vehicles-content`).innerHTML=`
    ...
    <button class="btn btn-primary btn-sm" onclick="openVehicleForm()">+ Add Vehicle</button>
      ...
      <div class="veh-card">
        ...
        <div class="veh-stat-grid">
          ...
          <div class="veh-stat"><div class="veh-stat-label">Services (all time)</div><div class="veh-stat-value">${O(a)}</div></div>
          ${u>0?`<div class="veh-stat"><div class="veh-stat-label">Annual Cost</div><div class="veh-stat-value">${O(u)}</div></div>`:``}
          ${d>0?`<div class="veh-stat"><div class="veh-stat-label">Monthly Cost</div><div class="veh-stat-value">${O(d)}/mo</div></div>`:``}
        </div>

        ${c||l?`<div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:14px">
          ${c?`<span style="font-size:11px;color:#0369a1;cursor:pointer;font-weight:600" onclick="activateTab('bills')">Rego bill: ${O(parseFloat(c.amount)||0)} →</span>`:``}
          ${l?`<span style="font-size:11px;color:#0369a1;cursor:pointer;font-weight:600" onclick="activateTab('bills')">Insurance bill: ${O(parseFloat(l.amount)||0)} →</span>`:``}
          ...
          ${(e.services||[]).length===0?`<div style="padding:16px 20px;color:var(--text-muted);font-size:13px;text-align:center">No service records yet</div>`:`<div class="table-wrap"><table>
                ...
                <tbody>
                  ${[...e.services].sort((e,t)=>new Date(t.date)-new Date(e.date)).map(t=>`<tr>
                    ...
                    <td class="amount">${t.cost?O(t.cost):`—`}</td>
                    <td><button class="btn btn-sm" style="color:var(--danger);font-size:11px" onclick="deleteService(${e.id},${t.id})">×</button></td>
                  </tr>`).join(``)}
                </tbody>
              </table></div>`}
        </div>
      </div>`}),document.getElementById(`vehicles-content`).innerHTML=t}function se(e){let t=e?(g.vehicles||[]).find(t=>t.id===e):null,n=!!t;document.getElementById(`modal-title`).textContent=n?`Edit ${t.name}`:`Add Vehicle`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <button class="btn btn-primary" onclick="saveVehicle(${e||`null`})">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function ce(e){let t=document.getElementById(`vf-name`)?.value.trim();if(!t)return;let n={name:t,plate:(document.getElementById(`vf-plate`)?.value||``).trim().toUpperCase(),state:document.getElementById(`vf-state`)?.value||`SA`,fuel:document.getElementById(`vf-fuel`)?.value||`petrol`,regoExpiry:document.getElementById(`vf-rego`)?.value||``,odometer:{reading:parseInt(document.getElementById(`vf-odo`)?.value)||0,date:new Date().toISOString().slice(0,10)},serviceInterval:parseInt(document.getElementById(`vf-interval`)?.value)||1e4,insurance:{provider:document.getElementById(`vf-ins-provider`)?.value.trim()||``,policyNo:document.getElementById(`vf-ins-policy`)?.value.trim()||``,renewalDate:document.getElementById(`vf-ins-renewal`)?.value||``}};if(e){let t=g.vehicles.find(t=>t.id===e);t&&Object.assign(t,n)}else n.id=g.vehicles.length?Math.max(...g.vehicles.map(e=>e.id))+1:1,n.services=[],g.vehicles.push(n);g.bills||(g.bills=[]),le(n,`rego`,`Rego - ${n.name}`,n.regoExpiry,0,`Insurance`),n.insurance&&n.insurance.renewalDate&&le(n,`insurance`,`Insurance - ${n.name}`,n.insurance.renewalDate,0,`Insurance`),window.saveData(g),window.closeModal(),window.renderAll()}function le(e,t,n,r,i,a){if(!r)return;let o=`vehicle_${e.id||e.name}_${t}`,s=g.bills.find(e=>e._vehicleRef===o),c={name:n,amount:i||(s?s.amount:0),category:a,frequency:`Annual`,autopay:!1,startDate:r,_vehicleRef:o};s?Object.assign(s,c):(c.id=uid(),g.bills.push(c))}function ue(e){if(!confirm(`Delete this vehicle and all its service history?`))return;let t=`vehicle_${e}_`;g.bills=(g.bills||[]).filter(e=>!(e._vehicleRef&&e._vehicleRef.startsWith(t))),g.vehicles=g.vehicles.filter(t=>t.id!==e),window.saveData(g),window.renderAll()}function de(e){document.getElementById(`modal-title`).textContent=`Add Service Record`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
    ...
    <input class="doc-search" type="text" maxlength="200" placeholder="Search documents…" value="${he}" oninput="_docSearch=this.value;renderDocuments()" style="margin:0 20px;width:calc(100% - 40px)">`,u={};n.forEach(e=>{let t=e.category||`Other`;u[t]||(u[t]=[]),u[t].push(e)}),me.forEach(e=>{let n=u[e.key];!n||!n.length||(l+=`<div class="doc-cat-group">
      <div class="doc-cat-header">${e.icon} ${e.key} <span style="font-weight:400;text-transform:none">(${n.length})</span></div>`,n.sort((e,t)=>e.expiryDate&&t.expiryDate?new Date(e.expiryDate)-new Date(t.expiryDate):e.expiryDate?-1:1).forEach(n=>{let r=``;if(n.expiryDate){let e=Math.ceil((new Date(n.expiryDate)-t)/864e5);r=e<0?`<span class="veh-badge red" style="font-size:11px">Expired ${Math.abs(e)}d ago</span>`:e<=30?`<span class="veh-badge amber" style="font-size:11px">Expires in ${e}d</span>`:`<span class="veh-badge green" style="font-size:11px">${new Date(n.expiryDate).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`})}</span>`}let i=[n.provider?T(n.provider):``,n.reference?T(n.reference):``,n.storedAt?`📍 ${T(n.storedAt)}`:``].filter(Boolean);l+=`
        <div class="doc-card" onclick="openDocForm(${n.id})">
          ...
          ${r}
        </div>`}),l+=`</div>`)}),n.length,document.getElementById(`documents-content`).innerHTML=l}function ve(e){let t=e?(g.documents||[]).find(t=>t.id===e):null,n=!!t;document.getElementById(`modal-title`).textContent=n?`Edit Document`:`Add Document`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        ...
        <select class="form-select" id="df-cat">
          ${me.map(e=>`<option value="${e.key}"${t&&t.category===e.key?` selected`:``}>${e.icon} ${e.key}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
    ...
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    <button class="btn btn-primary" onclick="saveDoc(${e||`null`})">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function ye(e){let t=document.getElementById(`df-name`)?.value.trim();if(!t)return;let n={name:t,category:document.getElementById(`df-cat`)?.value||`Other`,provider:document.getElementById(`df-provider`)?.value.trim()||``,reference:document.getElementById(`df-ref`)?.value.trim()||``,expiryDate:document.getElementById(`df-expiry`)?.value||``,renewalCost:parseFloat(document.getElementById(`df-cost`)?.value)||0,storedAt:document.getElementById(`df-stored`)?.value.trim()||``,notes:document.getElementById(`df-notes`)?.value.trim()||``};if(e){let t=g.documents.find(t=>t.id===e);t&&Object.assign(t,n)}else n.id=g.documents.length?Math.max(...g.documents.map(e=>e.id))+1:1,g.documents.push(n);if(n.expiryDate&&n.renewalCost>0){g.bills||(g.bills=[]);let t=`doc_${e||n.id}`,r=g.bills.find(e=>e._docRef===t),i={name:`${n.name}${n.provider?` - `+n.provider:``}`,amount:n.renewalCost,category:n.category===`Vehicle`?`Insurance`:n.category,frequency:`Annual`,autopay:!1,startDate:n.expiryDate,_docRef:t};r?Object.assign(r,i):(i.id=uid(),g.bills.push(i))}window.saveData(g),window.closeModal(),window.renderAll()}function be(e){if(!confirm(`Delete this document?`))return;let t=`doc_${e}`;g.bills=(g.bills||[]).filter(e=>e._docRef!==t),g.documents=g.documents.filter(t=>t.id!==e),window.saveData(g),window.closeModal(),window.renderAll()}var xe=[{key:`HVAC`,icon:`❄️`},{key:`Plumbing`,icon:`🚿`},{key:`Electrical`,icon:`💡`},{key:`Garden`,icon:`🌿`},{key:`Cleaning`,icon:`🧹`},{key:`Safety`,icon:`🔥`},{key:`Appliance`,icon:`🔧`},{key:`Exterior`,icon:`🏠`},{key:`Other`,icon:`📋`}],Se=[{name:`Gutters Cleaned`,category:`Exterior`,intervalNum:6,intervalUnit:`months`,icon:`🏠`},{name:`Smoke Alarm Batteries`,category:`Safety`,intervalNum:12,intervalUnit:`months`,icon:`🔥`},{name:`Pest Control`,category:`Exterior`,intervalNum:12,intervalUnit:`months`,icon:`🐛`},{name:`AC Filter Cleaned`,category:`HVAC`,intervalNum:3,intervalUnit:`months`,icon:`❄️`},{name:`Hot Water System Flush`,category:`Plumbing`,intervalNum:12,intervalUnit:`months`,icon:`🚿`},{name:`Lawn Mowing`,category:`Garden`,intervalNum:2,intervalUnit:`weeks`,icon:`🌿`},{name:`Oven Clean`,category:`Cleaning`,intervalNum:6,intervalUnit:`months`,icon:`🧹`},{name:`Pool Maintenance`,category:`Exterior`,intervalNum:1,intervalUnit:`months`,icon:`🏊`},{name:`Drains / Septic`,category:`Plumbing`,intervalNum:2,intervalUnit:`years`,icon:`🚿`},{name:`Roof Inspection`,category:`Exterior`,intervalNum:2,intervalUnit:`years`,icon:`🏠`}];function Ce(e){if(!e.lastDone)return null;let t=new Date(e.lastDone),n=e.intervalNum||1,r=e.intervalUnit||`months`;return r===`days`?t.setDate(t.getDate()+n):r===`weeks`?t.setDate(t.getDate()+n*7):r===`months`?t.setMonth(t.getMonth()+n):r===`years`&&t.setFullYear(t.getFullYear()+n),t}function we(e){let t=Ce(e);return t?Math.ceil((t-new Date)/864e5):null}function Te(){let e=g.maintenance||[];if(e.length===0){let t=new Set(e.map(e=>e.name.toLowerCase())),n=Se.filter(e=>!t.has(e.name.toLowerCase()));document.getElementById(`maintenance-content`).innerHTML=`
      <div class="empty" style="margin-top:24px">
        <div class="empty-icon">🔧</div>
      ...
      </div>`:``}`;return}let t=[...e].map(e=>{let t=we(e);return{...e,_days:t}}).sort((e,t)=>e._days===null&&t._days===null?0:e._days===null?1:t._days===null?-1:e._days-t._days),n=t.filter(e=>e._days!==null&&e._days<0).length,r=t.filter(e=>e._days!==null&&e._days>=0&&e._days<=14).length,i=`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap;gap:10px">
    ...
    </div>`;if(t.forEach(e=>{let t=e._days,n=`ok`,r=``;t===null?(n=`ok`,r=e.lastDone?`Last done ${new Date(e.lastDone).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`})}`:`Never done`):t<0?(n=`overdue`,r=`Overdue by ${Math.abs(t)} day${Math.abs(t)===1?``:`s`}`):t<=14?(n=`due-soon`,r=t===0?`Due today`:`Due in ${t} day${t===1?``:`s`}`):r=`Due ${Ce(e).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}`;let a=xe.find(t=>t.key===e.category)||xe[xe.length-1],o=e.intervalNum?`Every ${e.intervalNum} ${e.intervalUnit}`:``;i+=`
      <div class="maint-item ${n}">
        ...
        ${e.lastCost?`<div style="font-size:11px;color:var(--text-muted);margin-top:6px;padding-left:48px">Last cost: ${O(e.lastCost)}</div>`:``}
      </div>`}),e.length<3){let t=new Set(e.map(e=>e.name.toLowerCase())),n=Se.filter(e=>!t.has(e.name.toLowerCase()));n.length&&(i+=`<div style="margin-top:20px">
      ...
      </div>`)}document.getElementById(`maintenance-content`).innerHTML=i}function Ee(e){let t=e?(g.maintenance||[]).find(t=>t.id===e):null,n=!!t;document.getElementById(`modal-title`).textContent=n?`Edit ${t.name}`:`Add Maintenance Item`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        ...
        <select class="form-select" id="mf-cat">
          ${xe.map(e=>`<option value="${e.key}"${t&&t.category===e.key?` selected`:``}>${e.icon} ${e.key}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
        <label class="form-label">Provider</label>
    ...
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    <button class="btn btn-primary" onclick="saveMaint(${e||`null`})">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function De(e){let t=document.getElementById(`mf-name`)?.value.trim();if(!t)return;let n={name:t,category:document.getElementById(`mf-cat`)?.value||`Other`,provider:document.getElementById(`mf-provider`)?.value.trim()||``,intervalNum:parseInt(document.getElementById(`mf-interval-num`)?.value)||1,intervalUnit:document.getElementById(`mf-interval-unit`)?.value||`months`,lastDone:document.getElementById(`mf-last`)?.value||``,lastCost:parseFloat(document.getElementById(`mf-cost`)?.value)||0,notes:document.getElementById(`mf-notes`)?.value.trim()||``};if(e){let t=g.maintenance.find(t=>t.id===e);t&&Object.assign(t,n)}else n.id=g.maintenance.length?Math.max(...g.maintenance.map(e=>e.id))+1:1,g.maintenance.push(n);window.saveData(g),window.closeModal(),window.renderAll()}function Oe(e){confirm(`Delete this maintenance item?`)&&(g.maintenance=g.maintenance.filter(t=>t.id!==e),window.saveData(g),window.closeModal(),window.renderAll())}function ke(e){let t=g.maintenance.find(t=>t.id===e);if(!t)return;let n=new Date().toISOString().slice(0,10);if(t.lastDone=n,t.lastCost>0){let e=n.slice(0,7),r=window.getMonthData(e),i=r.expenses.find(e=>(e.category||``).toLowerCase()===`other`&&(e.name||``).toLowerCase().includes(`maintenance`))||r.expenses.find(e=>(e.name||``).toLowerCase().includes(`maintenance`));if(!i&&(i={id:F(g.budget.expenses),name:`Home Maintenance`,amount:0,frequency:`monthly`,category:`Other`,dueDate:``,vendor:null},g.budget.expenses.push(i),window.isMonthCustomized(e))){let t=g.budget.months[e];i={...i,id:F(t.expenses)},t.expenses.push(i)}g.budget.actuals[e]||(g.budget.actuals[e]={});let a=window.getActualEntries(i.id,e);a.push({id:a.length?Math.max(...a.map(e=>e.id))+1:1,amount:t.lastCost,date:n,note:`${t.name}${t.provider?` - `+t.provider:``}`}),g.budget.actuals[e][i.id]=a}window.saveData(g),window.renderAll()}function Ae(e){let t=Se[e];if(!t)return;let n={id:g.maintenance.length?Math.max(...g.maintenance.map(e=>e.id))+1:1,name:t.name,category:t.category,provider:``,intervalNum:t.intervalNum,intervalUnit:t.intervalUnit,lastDone:``,lastCost:0,notes:``};g.maintenance.push(n),window.saveData(g),window.renderAll()}var je=[`Fridge`,`Freezer`,`Pantry`,`Fruit & Veg`,`Spices`,`Drinks`,`Cleaning`,`Other`],Me=[{name:`Milk`,cat:`Fridge`},{name:`Eggs`,cat:`Fridge`},{name:`Cheese`,cat:`Fridge`},{name:`Butter`,cat:`Fridge`},{name:`Yoghurt`,cat:`Fridge`},{name:`Chicken breast`,cat:`Freezer`},{name:`Mince`,cat:`Freezer`},{name:`Fish fillets`,cat:`Freezer`},{name:`Frozen veg`,cat:`Freezer`},{name:`Pasta`,cat:`Pantry`},{name:`Rice`,cat:`Pantry`},{name:`Tinned tomatoes`,cat:`Pantry`},{name:`Olive oil`,cat:`Pantry`},{name:`Flour`,cat:`Pantry`},{name:`Sugar`,cat:`Pantry`},{name:`Bread`,cat:`Pantry`},{name:`Cereal`,cat:`Pantry`},{name:`Onions`,cat:`Fruit & Veg`},{name:`Potatoes`,cat:`Fruit & Veg`},{name:`Bananas`,cat:`Fruit & Veg`},{name:`Apples`,cat:`Fruit & Veg`},{name:`Salt`,cat:`Spices`},{name:`Pepper`,cat:`Spices`},{name:`Garlic`,cat:`Spices`}];function Ne(){let e=document.getElementById(`pantry-content`);if(!e)return;let t=g.meals.pantry||[];if(t.length===0){e.innerHTML=`
      <div class="empty" style="margin-top:24px">
      ...
      <div style="margin-top:20px">
        ...
        <div class="pantry-starter">
          ${Me.map(e=>`<button class="pantry-starter-btn" onclick="quickAddPantry('${E(e.name)}','${e.cat}')">${T(e.name)}</button>`).join(``)}
        </div>
      </div>`;return}let n={};je.forEach(e=>n[e]=[]),t.forEach(e=>{n[je.includes(e.cat)?e.cat:`Other`].push(e)});let r=t.filter(e=>e.status===`need`).length,i=t.filter(e=>e.status===`low`).length,a=`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap;gap:10px">
      <div style="display:flex;gap:8px;flex-wrap:wrap">
    ...
    </div>`;if(je.forEach(e=>{let t=n[e];t.length&&(a+=`<div class="pantry-cat-header">${T(e)} (${t.length})</div>`,t.forEach(e=>{let t=e.status===`stocked`?`✓`:e.status===`low`?`!`:`✗`;e.status===`stocked`||e.status,a+=`<div class="pantry-item">
      ...
      </div>`}))}),t.length<10){let e=new Set(t.map(e=>e.name.toLowerCase())),n=Me.filter(t=>!e.has(t.name.toLowerCase()));n.length&&(a+=`<div style="margin-top:20px">
        <div style="font-size:13px;font-weight:600;margin-bottom:8px">Quick-add more</div>
        <div class="pantry-starter">
          ${n.slice(0,12).map(e=>`<button class="pantry-starter-btn" onclick="quickAddPantry('${E(e.name)}','${e.cat}')">${T(e.name)}</button>`).join(``)}
        </div>
      </div>`)}e.innerHTML=a}function Pe(e){let t=(g.meals.pantry||[]).find(t=>t.id===e);t&&(t.status={stocked:`low`,low:`need`,need:`stocked`}[t.status]||`stocked`,window.saveData(g),Ne())}function Fe(e){let t=e?(g.meals.pantry||[]).find(t=>t.id===e):null;document.getElementById(`modal-title`).textContent=t?`Edit Item`:`Add Pantry Item`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
      <label class="form-label">Item Name</label>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-group">
        ...
        <select class="form-select" id="pf-cat">
          ${je.map(e=>`<option value="${e}"${t&&t.cat===e?` selected`:``}>${e}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
    ...
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    <button class="btn btn-primary" onclick="savePantryItem(${e||`null`})">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Ie(e){let t=document.getElementById(`pf-name`)?.value.trim();if(!t)return;let n={name:t,cat:document.getElementById(`pf-cat`)?.value||`Other`,qty:document.getElementById(`pf-qty`)?.value.trim()||``,status:document.querySelector(`input[name="pf-status"]:checked`)?.value||`stocked`},r=g.meals.pantry;if(e){let t=r.find(t=>t.id===e);t&&Object.assign(t,n)}else n.id=r.length?Math.max(...r.map(e=>e.id))+1:1,r.push(n);window.saveData(g),window.closeModal(),Ne()}function Le(e){g.meals.pantry=(g.meals.pantry||[]).filter(t=>t.id!==e),window.saveData(g),Ne()}function Re(e,t){let n=g.meals.pantry;n.push({id:n.length?Math.max(...n.map(e=>e.id))+1:1,name:e,cat:t,qty:``,status:`stocked`}),window.saveData(g),Ne()}function ze(){let e=(g.meals.pantry||[]).filter(e=>e.status===`need`||e.status===`low`);if(!e.length)return;g.lists||(g.lists={}),g.lists.food||(g.lists.food={items:[],weeklyBudget:200,budget:0,stores:[],favourites:[],history:[]});let t=g.lists.food.items,n={Fridge:`dairy`,Freezer:`frozen`,Pantry:`pantry`,"Fruit & Veg":`produce`,Spices:`pantry`,Drinks:`drinks`,Cleaning:`cleaning`,Other:`other`},r=0;e.forEach(e=>{t.some(t=>t.name.toLowerCase()===e.name.toLowerCase()&&t.state===`active`)||(t.push({id:`si-`+Date.now()+`-`+r,name:e.name,quantity:1,unit:`units`,notes:``,aisle:n[e.cat]||`other`,state:`active`,addedBy:`pantry`,addedAt:new Date().toISOString(),mealTag:`Pantry`,manualPrice:null,barcodeId:null}),r++)}),r>0&&(window.saveData(g),_listsActiveType=`food`,_listsView=`list`,activateTab(`lists`));let i=document.querySelector(`[onclick*="pantryToShoppingList"]`);if(i){let e=i.textContent;i.textContent=`Added ${r} items`,i.style.color=`var(--success)`,setTimeout(()=>{i.textContent=e,i.style.color=``},2e3)}}var Be=[`Cash & Savings`,`Investments`,`Property`,`Superannuation`,`Vehicle`,`Other`],Ve=[`Mortgage`,`Car Loan`,`Credit Card`,`Personal Loan`,`HECS/HELP`,`Other`];function He(){let e=document.getElementById(`networth-content`);if(!e)return;let t=g.netWorth,n=t.assets||[],r=t.liabilities||[],i=t.snapshots||[],a=n.reduce((e,t)=>e+(parseFloat(t.value)||0),0),o=r.reduce((e,t)=>e+(parseFloat(t.value)||0),0),s=a-o,c=``;if(i.length>=2){let e=s-i[i.length-2].netWorth;c=`<span class="${e>=0?`up`:`down`}">${e>=0?`+`:``}${k(e)}</span> vs last snapshot`}if(!n.length&&!r.length){e.innerHTML=`
      <div style="background:#fff;border:2px dashed #cbd5e1;border-radius:16px;padding:36px 24px;margin-top:8px">
        <div style="display:flex;align-items:center;gap:16px;margin-bottom:20px">
          <div style="font-size:40px">📊</div>
          <div>
    ...
    <div class="nw-cols">
      <div class="nw-col-card assets">
        ...
        ${n.length?n.map(e=>Ue(e,`asset`)).join(``):`<div class="nw-empty">No assets yet</div>`}
      ...
      <div class="nw-col-card liabilities">
        ...
        ${r.length?r.map(e=>Ue(e,`liability`)).join(``):`<div class="nw-empty">No liabilities yet</div>`}
        <div class="nw-add-row">
  ...
  `}function Ue(e,t){let n=e.category||``;if(t===`liability`&&e.rate){let t=parseFloat(e.value)||0,r=parseFloat(e.rate),i=t*r/1200;n+=n?` · `:``,n+=`${r}% p.a. · $${Math.round(i).toLocaleString()}/mo interest`}return`
    <div class="nw-item">
      <div style="flex:1;min-width:0">
    ...
    </div>`}function We(e){let t=g.netWorth.target||{},n=parseFloat(t.amount)||0,r=parseInt(t.byYear)||0,i=new Date().getFullYear();if(!n||!r)return`
    ...
    </div>`}function Ke(){let e=g.netWorth.target||{};document.getElementById(`nw-t-amount`).value=e.amount||``,document.getElementById(`nw-t-year`).value=e.byYear||``,document.getElementById(`nw-target-modal`).style.display=`flex`}function qe(){document.getElementById(`nw-target-modal`).style.display=`none`}function Je(){let e=parseFloat(document.getElementById(`nw-t-amount`).value),t=parseInt(document.getElementById(`nw-t-year`).value);!e||!t||(g.netWorth.target||(g.netWorth.target={}),g.netWorth.target.amount=e,g.netWorth.target.byYear=t,window.saveData(g),He(),qe())}function Ye(e){let t=e.slice(-12),n=Math.max(...t.map(e=>Math.abs(e.netWorth)),1);return`
    ...
    </div>`}function Xe(){if(document.getElementById(`nw-modal`))return;let e=document.createElement(`div`);for(e.innerHTML=`
    ...
    </div>`;e.firstChild;)document.body.appendChild(e.firstChild)}function Ze(e,t){Xe();let n=g.netWorth,r=e===`asset`?n.assets:n.liabilities,i=e===`asset`?Be:Ve,a=t?r.find(e=>e.id===t):null,o=document.getElementById(`nw-modal`);if(!o)return;document.getElementById(`nw-modal-title`).textContent=(a?`Edit`:`Add`)+` `+(e===`asset`?`Asset`:`Liability`),document.getElementById(`nw-edit-id`).value=t||``,document.getElementById(`nw-edit-type`).value=e,document.getElementById(`nw-name`).value=a?a.name:``,document.getElementById(`nw-value`).value=a?a.value:``,document.getElementById(`nw-rate`).value=a&&a.rate?a.rate:``,document.getElementById(`nw-payment`).value=a&&a.monthlyPayment?a.monthlyPayment:``;let s=a?.category||i[0],c=document.getElementById(`nw-cat-wrap`);c&&(c.innerHTML=window.customSelect(`nw-cat`,i,s,e=>{_csStore[`nw-cat`].value=e}));let l=document.getElementById(`nw-debt-fields`);l&&(l.style.display=e===`liability`?`flex`:`none`),o.style.display=`flex`}function Qe(){let e=document.getElementById(`nw-modal`);e&&(e.style.display=`none`)}function $e(){let e=document.getElementById(`nw-name`).value.trim(),t=parseFloat(document.getElementById(`nw-value`).value),n=_csStore[`nw-cat`]?.value||``,r=document.getElementById(`nw-edit-type`).value,i=document.getElementById(`nw-edit-id`).value,a=parseFloat(document.getElementById(`nw-rate`).value)||0,o=parseFloat(document.getElementById(`nw-payment`).value)||0;if(!e||isNaN(t))return;let s=r===`asset`?g.netWorth.assets:g.netWorth.liabilities,c={name:e,value:t,category:n};if(r===`liability`&&(a&&(c.rate=a),o&&(c.monthlyPayment=o)),i){let e=s.findIndex(e=>e.id===i);e!==-1&&(s[e]={...s[e],...c})}else s.push({id:uid(),...c});window.saveData(g),Qe(),He()}function et(e,t){let n=e===`asset`?g.netWorth.assets:g.netWorth.liabilities,r=n.findIndex(e=>e.id===t);r!==-1&&(n.splice(r,1),window.saveData(g),He())}function tt(){let e=g.netWorth,t=(e.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0)-(e.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),n=new Date().toISOString().slice(0,10);e.snapshots||(e.snapshots=[]);let r=e.snapshots.findIndex(e=>e.date===n),i={date:n,netWorth:t,assets:(e.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),liabilities:(e.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0)};r===-1?e.snapshots.push(i):e.snapshots[r]=i,window.saveData(g),He()}function I(e){return window._secureGet(e)}function nt(e,t){window._secureSet(e,t)}function rt(e){window._secureClear(e)}var it=[{label:`Streaming`,icon:`📺`},{label:`Music`,icon:`🎵`},{label:`Software`,icon:`💻`},{label:`Fitness`,icon:`💪`},{label:`Gaming`,icon:`🎮`},{label:`News`,icon:`📰`},{label:`Insurance`,icon:`🛡️`},{label:`Education`,icon:`📚`},{label:`Other`,icon:`📦`}];function at(e){let t=it.find(t=>t.label===e);return t?t.icon:`📦`}function ot(e){let t=parseFloat(e.amount)||0;return e.frequency===`Annual`?t/12:e.frequency===`Weekly`?t*52/12:t}var st=[],ct=new Set;Object.defineProperty(window,`_subImportResults`,{get(){return st},set(e){st=e},configurable:!0}),Object.defineProperty(window,`_subImportDismissed`,{get(){return ct},set(e){ct=e},configurable:!0});function lt(e){let t=e.map(e=>`
    <div class="sub-result-row">
      <div class="sub-result-icon">${at(e.category)}</div>
    ...
    ${t}
  </div>`}function ut(e){let t=e?(g.subscriptions||[]).find(t=>t.id===e):null;document.getElementById(`sub-modal-title`).textContent=t?`Edit Subscription`:`Add Subscription`,document.getElementById(`sub-edit-id`).value=e||``,document.getElementById(`sub-name`).value=t?t.name:``,document.getElementById(`sub-cat`).value=t&&t.category||`Streaming`,document.getElementById(`sub-freq`).value=t&&t.frequency||`Monthly`,document.getElementById(`sub-amount`).value=t?t.amount:``,document.getElementById(`sub-renewal`).value=t&&t.renewalDate||``,document.getElementById(`sub-modal`).style.display=`flex`}function dt(){document.getElementById(`sub-modal`).style.display=`none`}function ft(){let e=document.getElementById(`sub-name`).value.trim(),t=parseFloat(document.getElementById(`sub-amount`).value),n=document.getElementById(`sub-cat`).value,r=document.getElementById(`sub-freq`).value,i=document.getElementById(`sub-renewal`).value,a=document.getElementById(`sub-edit-id`).value;if(!e||isNaN(t))return;g.subscriptions||(g.subscriptions=[]);let o={name:e,amount:t,category:n,frequency:r,renewalDate:i};if(a){let e=g.subscriptions.findIndex(e=>e.id===a);e!==-1&&(g.subscriptions[e]={...g.subscriptions[e],...o})}else g.subscriptions.push({id:uid(),...o});window.saveData(g),dt(),renderSubscriptions()}function pt(e){g.subscriptions=(g.subscriptions||[]).filter(t=>t.id!==e),window.saveData(g),renderSubscriptions()}async function mt(e){let t=e.target.files[0];if(!t)return;let n=I(`toto_ai_key`),r=document.getElementById(`sub-import-status`);if(!n){r&&(r.textContent=`⚠ Please enter your Anthropic API key above first.`,r.style.display=``);return}let i=(await t.text()).split(`
...
If nothing new found, return [].`;try{let t=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":n,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:o}]})});if(!t.ok)throw Error(`API error ${t.status}`);let i=(await t.json()).content[0].text.trim().match(/\[[\s\S]*\]/);if(!i)throw Error(`No JSON found in response`);st=JSON.parse(i[0]).map((e,t)=>({...e,_key:`import_${Date.now()}_${t}`})),ct=new Set,r&&(r.style.display=`none`),e.target.value=``,renderSubscriptions()}catch(e){r&&(r.textContent=`⚠ ${e.message}`,r.style.display=``)}}function ht(e,t){let n=st.find(t=>t._key===e);if(n){if(t===`subscription`)g.subscriptions||(g.subscriptions=[]),g.subscriptions.push({id:uid(),name:n.name,amount:n.amount,category:n.category,frequency:n.frequency}),window.saveData(g);else{let e=window.ensureMonthOverride(window.selectedBudgetMonth);e.expenses.push({id:F(e.expenses),name:n.name,amount:n.amount,frequency:`monthly`,category:`Subscriptions`,recurring:!0}),window.saveData(g)}ct.add(e),renderSubscriptions()}}function gt(e){ct.add(e),renderSubscriptions()}var _t=[{label:`Mortgage / Rent`,icon:`🏠`},{label:`Electricity`,icon:`⚡`},{label:`Gas`,icon:`🔥`},{label:`Water`,icon:`💧`},{label:`Internet`,icon:`📡`},{label:`Phone`,icon:`📱`},{label:`Insurance`,icon:`🛡️`},{label:`Car Registration`,icon:`🚗`},{label:`Rates & Taxes`,icon:`🏛️`},{label:`Loan Repayment`,icon:`💳`},{label:`Education`,icon:`📚`},{label:`Subscriptions`,icon:`📺`},{label:`Health`,icon:`🏥`},{label:`Other`,icon:`📦`}],vt=[`Monthly`,`Fortnightly`,`Weekly`,`Quarterly`,`Annually`];function yt(e){let t=_t.find(t=>t.label===e);return t?t.icon:`📦`}function bt(e){if(e<0)return`<span class="bill-due-badge overdue">Overdue ${Math.abs(e)}d</span>`;if(e===0)return`<span class="bill-due-badge today">Due today</span>`;if(e<=7)return`<span class="bill-due-badge soon">Due in ${e}d</span>`;let t=new Date;return t.setDate(t.getDate()+e),`<span class="bill-due-badge ok">${t.toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}</span>`}function xt(e){return(parseFloat(e.amount)||0)*({Weekly:52/12,Fortnightly:26/12,Monthly:1,Quarterly:1/3,Annually:1/12}[e.frequency||`Monthly`]||1)}function St(){let e=document.getElementById(`bills-content`);if(!e)return;let r=g.bills||[],i=g.subscriptions||[],a=window._billsSubsFilter,o=`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>`,s=`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4h6v2"/></svg>`,c=r.reduce((e,t)=>e+xt(t),0)+i.reduce((e,t)=>e+subMonthlyAmount(t),0),l=r.filter(e=>n(e)<0).length,u=r.filter(e=>{let t=n(e);return t>=0&&t<=7}).length,d=new Date;d.setHours(0,0,0,0);let f=[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`],p=Array.from({length:14},(e,n)=>{let i=new Date(d);i.setDate(i.getDate()+n);let a=r.filter(e=>t(e).toDateString()===i.toDateString()),o=[i.toDateString()===d.toDateString()&&`today`,a.length&&`has-bill`].filter(Boolean).join(` `);return`<div class="bills-day" title="${a.map(e=>e.name).join(`, `)}">
      ...
      <div class="bill-icon">${yt(e.category)}</div>
      <div class="bill-info">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
            <div>
              ...
              <select id="sub-cat" class="form-select" style="width:100%">
                ${it.map(e=>`<option value="${e.label}">${e.icon} ${e.label}</option>`).join(``)}
              </select>
            </div>
            <div>
    ...
    </div>`}function Ct(e){window._billsSubsFilter=e,St()}function wt(){St()}function Tt(e){let t=e?(g.bills||[]).find(t=>t.id===e):null,n=_t.map(e=>`<option value="${e.label}" ${t&&t.category===e.label?`selected`:``}>${e.icon} ${e.label}</option>`).join(``),r=vt.map(e=>`<option value="${e}" ${t&&t.frequency===e||(!t||!t.frequency)&&e===`Monthly`?`selected`:``}>${e}</option>`).join(``),i=`width:100%;border:1px solid var(--border);border-radius:8px;padding:9px 12px;font-size:14px;outline:none`,a=`font-size:12px;font-weight:600;color:#64748b;display:block;margin-bottom:5px`;return`
    ...
    </div>`}function Et(e){let t=e?(g.bills||[]).find(t=>t.id===e):null;St();let n=document.getElementById(`bill-modal`);n&&(document.getElementById(`bill-modal-title`).textContent=t?`Edit Bill`:`Add Bill`,document.getElementById(`bill-edit-id`).value=e||``,t&&(document.getElementById(`bill-name`).value=t.name||``,document.getElementById(`bill-cat`).value=t.category||_t[0].label,document.getElementById(`bill-freq`).value=t.frequency||`Monthly`,document.getElementById(`bill-amount`).value=t.amount||``,document.getElementById(`bill-day`).value=t.dueDay||``,document.getElementById(`bill-start`).value=t.startDate||``,document.getElementById(`bill-autopay`).checked=!!t.autopay),Ot(),n.style.display=`flex`)}function Dt(){let e=document.getElementById(`bill-modal`);e&&(e.style.display=`none`)}function Ot(){let e=document.getElementById(`bill-freq`)?.value,t=document.getElementById(`bill-day-wrap`),n=document.getElementById(`bill-start-wrap`);if(!t||!n)return;let r=e===`Monthly`;t.style.display=r?`block`:`none`,n.style.display=r?`none`:`block`}function kt(){let e=document.getElementById(`bill-name`).value.trim(),t=parseFloat(document.getElementById(`bill-amount`).value),n=document.getElementById(`bill-cat`).value,r=document.getElementById(`bill-freq`).value,i=parseInt(document.getElementById(`bill-day`).value)||null,a=document.getElementById(`bill-start`).value||null,o=document.getElementById(`bill-autopay`).checked,s=document.getElementById(`bill-edit-id`).value;if(!e||isNaN(t))return;let c={name:e,amount:t,category:n,frequency:r,autopay:o};if(r===`Monthly`?c.dueDay=i:c.startDate=a,g.bills||(g.bills=[]),s){let e=g.bills.findIndex(e=>e.id===s);e!==-1&&(g.bills[e]={...g.bills[e],...c})}else g.bills.push({id:uid(),...c});window.saveData(g),Dt(),St()}function At(e){g.bills=(g.bills||[]).filter(t=>t.id!==e),window.saveData(g),St()}function jt(e){let t=(g.bills||[]).find(t=>t.id===e);t&&(t.lastPaid=new Date().toISOString().slice(0,10),window.saveData(g),St())}function Mt(e,t){if(!e)return!0;let{type:n,days:r,intervalDays:i,startDate:a,endDate:o}=e;if(a&&t<a||o&&t>o)return!1;let s=new Date(t+`T12:00:00`),c=s.getDay();switch(n){case`daily`:return!0;case`weekdays`:return c>=1&&c<=5;case`weekends`:return c===0||c===6;case`specific_days`:return Array.isArray(r)&&r.includes(String(c));case`interval`:{if(!a||!i)return!1;let e=new Date(a+`T12:00:00`),t=Math.round((s-e)/864e5);return t>=0&&t%i===0}case`one_time`:return t===a;default:return!0}}var L={work:{label:`Work`,emoji:`💼`,color:`#dbeafe`,text:`#1e40af`,financial:!1},study:{label:`Study`,emoji:`📚`,color:`#fef3c7`,text:`#92400e`,financial:!1},social:{label:`Social`,emoji:`🎉`,color:`#ede9fe`,text:`#5b21b6`,financial:!0},family:{label:`Family`,emoji:`👨‍👩‍👧`,color:`#fce7f3`,text:`#9d174d`,financial:!1},travel:{label:`Travel`,emoji:`✈️`,color:`#e0f2fe`,text:`#075985`,financial:!0},health:{label:`Health`,emoji:`🏥`,color:`#fef2f2`,text:`#991b1b`,financial:!0},finance:{label:`Finance`,emoji:`💰`,color:`#ecfeff`,text:`#155e75`,financial:!0},home:{label:`Home`,emoji:`🏠`,color:`#ecfeff`,text:`#166534`,financial:!0},school:{label:`School`,emoji:`🏫`,color:`#fff7ed`,text:`#9a3412`,financial:!0},other:{label:`Other`,emoji:`📦`,color:`#f1f5f9`,text:`#475569`,financial:!1}},Nt=new Date().toISOString().slice(0,7),Pt=new Date().toISOString().slice(0,10),Ft=new Set,It=`week`,Lt=new Set,Rt={"life-areas":!1,nudge:!1},zt=!1,Bt=null;Object.defineProperty(window,`_plannerMonth`,{get(){return Nt},set(e){Nt=e},configurable:!0}),Object.defineProperty(window,`_plannerSelectedDay`,{get(){return Pt},set(e){Pt=e},configurable:!0}),Object.defineProperty(window,`_plannerView`,{get(){return It},set(e){It=e},configurable:!0}),Object.defineProperty(window,`_plannerDetailEvId`,{get(){return Bt},set(e){Bt=e},configurable:!0}),Object.defineProperty(window,`_typeADimsExpanded`,{get(){return zt},set(e){zt=e},configurable:!0}),window._plannerExpanded=Ft,window._plannerFilterMembers=Lt,window._plannerCollapseState=Rt;var Vt=[{dot:`#2563eb`,bg:`#dbeafe`,text:`#1e40af`},{dot:`#db2777`,bg:`#fce7f3`,text:`#9d174d`},{dot:`#d97706`,bg:`#fef3c7`,text:`#92400e`},{dot:`#7c3aed`,bg:`#ede9fe`,text:`#5b21b6`},{dot:`#16a34a`,bg:`#dcfce7`,text:`#166534`},{dot:`#0891b2`,bg:`#ecfeff`,text:`#155e75`},{dot:`#ea580c`,bg:`#ffedd5`,text:`#9a3412`},{dot:`#be185d`,bg:`#fdf2f8`,text:`#831843`}];function Ht(){let e=g.householdProfile?.members||[],t=g.kids?.profiles||[],n=[],r=0;return e.forEach((e,t)=>{let i=Vt[r%Vt.length];e.role===`adult`&&e.name&&(n.push({id:`adult-`+t,name:e.name,emoji:e.emoji||`🧑`,...i}),r++)}),t.forEach((e,t)=>{let i=Vt[r%Vt.length];n.push({id:e.id||`kid-`+t,name:e.name,emoji:e.emoji||`🧒`,...i}),r++}),n.length===0&&n.push({id:`adult-0`,name:`Everyone`,emoji:`👨‍👩‍👧`,...Vt[0]}),n}function Ut(e){return!e||e===`everyone`?{id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`}:Ht().find(t=>t.id===e)||{id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`}}function Wt(e){return Array.isArray(e.memberIds)?e.memberIds:e.memberId?[e.memberId]:[`everyone`]}function Gt(e){return Ut(Wt(e).find(e=>e!==`everyone`)||`everyone`)}function Kt(e){let t=Wt(e);return t.includes(`everyone`)||t.length===0?`Everyone`:t.map(e=>Ut(e).name).join(`, `)}function qt(e){if(e.recurrence&&e.recurrence.type&&e.recurrence.type!==`one_time`){let t={daily:`Every day`,weekdays:`Mon–Fri`,weekends:`Sat & Sun`};if(t[e.recurrence.type])return t[e.recurrence.type];if(e.recurrence.type===`specific_days`)return(e.recurrence.days||[]).map(e=>[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`][e]).join(`, `)||`Specific days`;if(e.recurrence.type===`interval`)return`Every ${e.recurrence.intervalDays} days`}return e.recurring&&e.recurring!==`none`?{weekly:`Every week`,fortnightly:`Every 2 weeks`,monthly:`Every month`,quarterly:`Every 3 months`,yearly:`Annually`}[e.recurring]||e.recurring:``}function Jt(){let e=g.planner?.events||[];return Lt.size===0?e:e.filter(e=>{let t=Wt(e);return t.includes(`everyone`)?!0:[...Lt].some(e=>t.includes(e))})}function Yt(e){return Jt().filter(t=>t._recurringSourceId?t.date===e:t.recurrence&&t.recurrence.type!==`one_time`?Mt(t.recurrence,e):t.endDate&&t.endDate>t.date?e>=t.date&&e<=t.endDate:t.date===e)}function Xt(e){if(!e)return``;let[t,n]=e.split(`:`).map(Number);return`${t%12||12}:${String(n).padStart(2,`0`)}${t>=12?`pm`:`am`}`}var Zt=new Date().toISOString().slice(0,7);function Qt(){let[e,t]=Zt.split(`-`).map(Number),n=new Date(e,t-2,1);Zt=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,renderForecast()}function $t(){let[e,t]=Zt.split(`-`).map(Number),n=new Date(e,t,1);Zt=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,renderForecast()}function en(){let e=document.getElementById(`forecast-content`);if(!e)return;let t=(g.planner?.events||[]).filter(e=>e.date&&e.date.startsWith(Zt)),n=window.getMonthData(Zt),r=P(n.income)-P(n.expenses),[i,a]=Zt.split(`-`).map(Number),o=new Date(i,a,0).getDate(),s=[],c=1;for(;c<=o;){new Date(i,a-1,c);let e=c;for(;e<o&&new Date(i,a-1,e+1).getDay()!==1;)e++;s.push({start:c,end:e,events:[]}),c=e+1}t.sort((e,t)=>e.date.localeCompare(t.date)).forEach(e=>{let t=parseInt(e.date.split(`-`)[2]),n=s.find(e=>t>=e.start&&t<=e.end);n&&n.events.push(e)}),t.filter(e=>e.estimates&&e.estimates.length>0);let l=t.filter(e=>!e.estimates||e.estimates.length===0),u=t.reduce((e,t)=>e+(t.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0),0),d=r-u,f=new Date(i,a-1).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`}),p=!!I(`toto_ai_key`),m=`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;flex-wrap:wrap;gap:12px">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:12px;margin-bottom:24px">
      <div style="background:var(--surface2);border-radius:var(--radius);padding:16px 18px">
        ...
        <div style="font-size:22px;font-weight:800;color:var(--danger)">${O(u)}</div>
      </div>
      <div style="background:var(--surface2);border-radius:var(--radius);padding:16px 18px">
        ...
        <div style="font-size:22px;font-weight:800;color:${r>=0?`var(--success)`:`var(--danger)`}">${O(Math.abs(r))}</div>
      </div>
      <div style="background:var(--surface2);border-radius:var(--radius);padding:16px 18px">
        ...
        <div style="font-size:22px;font-weight:800;color:${d>=0?`var(--success)`:`var(--danger)`}">${d>=0?``:`-`}${O(Math.abs(d))}</div>
      </div>
      <div style="background:var(--surface2);border-radius:var(--radius);padding:16px 18px">
      ...
      <div class="section" style="margin-bottom:16px">
        <div class="section-header">
          ...
          <span style="font-size:15px;font-weight:700;color:${n>0?`var(--danger)`:`var(--text-muted)`}">${n>0?O(n):`No estimates`}</span>
        </div>
        <div class="table-wrap">
          <table>
            <thead><tr><th>Date</th><th>Event</th><th>Category</th><th class="amount">Estimated</th><th></th></tr></thead>
            <tbody>
              ${e.events.map(e=>{let t=L[e.category]||L.other,n=(e.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0),r=new Date(e.date+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`short`,day:`numeric`}),i=e.estimates&&e.estimates.length>0;return`<tr>
                  ...
                  <td class="amount" style="font-weight:600;${i?``:`color:var(--text-muted)`}">${i?O(n):`—`}</td>
                  <td style="text-align:right">
                    ${i?`<details style="font-size:11px;color:var(--text-muted)"><summary style="cursor:pointer">breakdown</summary>
                          <div style="padding:4px 0">${e.estimates.filter(e=>e.accepted).map(e=>`<div style="display:flex;justify-content:space-between;gap:12px;padding:2px 0"><span>${T(e.name)}</span><span>${O(e.amount)}</span></div>`).join(``)}</div>
        ...
        <div style="padding:16px 20px">
          ${_.map(([e,t])=>{let n=u>0?t/u*100:0;return`<div style="margin-bottom:12px">
              <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:4px">
                ...
                <span style="font-weight:600">${O(t)} <span style="font-weight:400;color:var(--text-muted)">${Math.round(n)}%</span></span>
              </div>
      ...
      </div>`),e.innerHTML=m}async function tn(){let e=I(`toto_ai_key`);if(!e)return;let t=(g.planner?.events||[]).filter(e=>e.date&&e.date.startsWith(Zt)&&(!e.estimates||e.estimates.length===0));if(!t.length)return;let n=document.getElementById(`estimate-all-btn`);n&&(n.textContent=`⏳ Estimating…`,n.disabled=!0);let r=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`).length||2,i=(g.householdProfile?.members||[]).filter(e=>e.role===`child`).length||0,a=t.map(e=>({id:e.id,title:e.title,category:(L[e.category]||L.other).label,date:e.date,notes:e.notes||``})),o=`You are a family finance assistant for an Australian family (${r} adult${r>1?`s`:``}, ${i} child${i===1?``:`ren`}).
...
- No markdown, no code fences, just raw JSON`;try{let t=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":e,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:4096,messages:[{role:`user`,content:o}]})});if(!t.ok)throw Error(`API ${t.status}`);let n=(await t.json()).content[0].text.replace(/```[\w]*\n?/g,``).trim().match(/\[[\s\S]*\]/);if(!n)throw Error(`No JSON`);JSON.parse(n[0]).forEach(e=>{let t=(g.planner?.events||[]).find(t=>t.id===e.id);t&&e.items&&(t.estimates=e.items.map((e,t)=>({id:`est-${Date.now()}-${t}`,name:e.name,amount:Number(e.amount)||0,category:e.category||`Other`,accepted:!0})))}),window.saveData(g),en()}catch(e){n&&(n.textContent=`Estimate all (${t.length} events)`,n.disabled=!1),console.error(`Batch estimate error:`,e)}}function R(){let e=document.getElementById(`planner-content`);if(!e)return;g.planner||(g.planner={events:[]});let t=new Date().toISOString().slice(0,10),n=Ht(),r={id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`},i=[...n,r],a=i.map(e=>e.name[0].toUpperCase()),o=i.map((e,t)=>{if(e.id===`everyone`)return`👨‍👩‍👧`;let n=e.name[0].toUpperCase();return a.filter(e=>e===n).length>1?(e.name[0]+(e.name[1]||``)).toUpperCase():n}),s=i.map((e,t)=>{let n=e.id===`everyone`,r=n?window._plannerFilterMembers.size===0:window._plannerFilterMembers.has(e.id),i=!r&&window._plannerFilterMembers.size>0&&!n,a=n?`<span style="font-size:14px">👨‍👩‍👧</span>`:`<span>${o[t]}</span>`;return`<div class="pl-legend-chip ${r?`active`:``} ${i?`dimmed`:``}"
      onclick="_plannerToggleFilter('${e.id}')">
      <div class="pl-chip-avatar" style="background:${e.bg};color:${e.text}">${a}</div>
      <span>${e.name}</span>
    </div>`}).join(``),c=``;c=_plannerView===`month`?nn():rn();let l=new Date;l.setDate(l.getDate()+30);let u=l.toISOString().slice(0,10),d=Jt().filter(e=>e.date>=t&&e.date<=u),f=0,p=Object.entries(L).map(([e,t])=>{let n=d.filter(t=>t.category===e);n.length&&(f+=n.length);let r=n[0],i=r?T(r.title)+(r.date?` · ${new Date(r.date+`T12:00:00`).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}`:``):`Nothing planned`;return`<div class="pl-life-tile" onclick="_plannerOpenLifeSheet('${e}')">
    ...
    </div>`}).join(``),m=Mn(),h=m.map(e=>{let t=e.days<0?`Now!`:e.days===0?`Today!`:e.days===1?`Tomorrow`:`In ${e.days} days`,n=e.days<=0?`#ef4444`:e.days===1?`var(--good)`:e.days<=3?`#f59e0b`:`var(--iris-1)`;return`<div class="pl-nudge-tile">
    ...
    </div>`}function nn(){let[e,t]=_plannerMonth.split(`-`).map(Number),n=new Date().toISOString().slice(0,10),r=new Date(e,t-1,1).getDay(),i=r===0?6:r-1,a=new Date(e,t,0).getDate(),o=new Date(e,t-1,0).getDate(),s=[];for(let n=i-1;n>=0;n--){let r=o-n,i=t-1||12,a=i===12?e-1:e;s.push({dateStr:`${a}-${String(i).padStart(2,`0`)}-${String(r).padStart(2,`0`)}`,day:r,muted:!0})}for(let n=1;n<=a;n++)s.push({dateStr:`${e}-${String(t).padStart(2,`0`)}-${String(n).padStart(2,`0`)}`,day:n,muted:!1});let c=s.length%7==0?0:7-s.length%7;for(let n=1;n<=c;n++){let r=t+1>12?1:t+1,i=r===1?e+1:e;s.push({dateStr:`${i}-${String(r).padStart(2,`0`)}-${String(n).padStart(2,`0`)}`,day:n,muted:!0})}return`<div class="pl-month-grid">${s.map(e=>{let t=e.dateStr===n,r=e.dateStr===_plannerSelectedDay,i=e.dateStr?Yt(e.dateStr):[],a=[...new Set(i.flatMap(e=>Wt(e)))].filter(e=>e!==`everyone`).slice(0,3).map(e=>`<div class="pl-cell-dot" style="background:${Ut(e).dot}"></div>`).join(``),o=i.length>3?`<div style="font-size:8px;color:var(--text-muted);font-weight:600">+</div>`:``;return`<div class="pl-cal-cell ${e.muted?`muted`:``} ${t?`today`:``} ${r?`selected`:``}"
                 onclick="_plannerSelectDay('${e.dateStr}')">
      <div class="pl-cell-num">${e.day}</div>
      <div class="pl-cell-dots">${a}${o}</div>
    </div>`}).join(``)}</div>`}function rn(){let e=new Date(_plannerSelectedDay+`T12:00:00`),t=e.getDay(),n=new Date(e);n.setDate(e.getDate()-(t===0?6:t-1));let r=new Date().toISOString().slice(0,10),i=[`S`,`M`,`T`,`W`,`T`,`F`,`S`];return`<div class="week-strip">${Array.from({length:7},(e,t)=>{let r=new Date(n);return r.setDate(n.getDate()+t),{date:r,dateStr:r.toISOString().slice(0,10)}}).map(({date:e,dateStr:t})=>{let n=t===r,a=t===_plannerSelectedDay,o=Yt(t),s=o.length>0,c=[...new Set(o.flatMap(e=>Wt(e)))].filter(e=>e!==`everyone`).slice(0,3),l=a?`rgba(255,255,255,0.6)`:c.length?Ut(c[0]).dot:`#C4C2D4`;return`<div class="${a?`ws-day selected`+(n?` today-outline`:``):n?`ws-day today-outline`:`ws-day`}${s?` has`:``}" onclick="_plannerSelectDay('${t}')">
      <div class="ws-init">${i[e.getDay()]}</div>
      <div class="ws-num">${e.getDate()}</div>
      <div class="ws-dot" style="${s?`background:${l}`:``}"></div>
    </div>`}).join(``)}</div>`}function an(e){let t=L[e.category]||L.other,n=_plannerExpanded.has(e.id),r=e.estimates||[],i=r.filter(e=>e.accepted),a=i.reduce((e,t)=>e+(t.amount||0),0),o=r.reduce((e,t)=>e+(t.amount||0),0),s=e.pushed?`<span class="planner-pushed-badge">✓ In budget</span>`:r.length>0?`<span style="font-size:12px;color:var(--text-muted)">$${a.toLocaleString(`en-AU`)}</span>`:``,c=qt(e);c&&(s=`<span class="recurring-badge">🔄 ${c}</span> `+s);let l=``;return n&&(l=`<div class="planner-event-body">`,e.notes&&(l+=`<p class="planner-notes">${T(e.notes)}</p>`),r.length>0?(l+=r.map(t=>`
    ...
    ${l}
  </div>`}function on(){let[e,t]=_plannerMonth.split(`-`).map(Number),n=t===1?e-1:e,r=t===1?12:t-1;_plannerMonth=`${n}-${String(r).padStart(2,`0`)}`,_plannerSelectedDay=`${n}-${String(r).padStart(2,`0`)}-01`,R()}function sn(){let[e,t]=_plannerMonth.split(`-`).map(Number),n=t===12?e+1:e,r=t===12?1:t+1;_plannerMonth=`${n}-${String(r).padStart(2,`0`)}`,_plannerSelectedDay=`${n}-${String(r).padStart(2,`0`)}-01`,R()}function cn(e){_plannerSelectedDay=e,_plannerMonth=e.slice(0,7),R()}function ln(e){let t=new Date(e+`T12:00:00`),n=e===new Date().toISOString().slice(0,10)?`Today`:t.toLocaleDateString(`en-AU`,{weekday:`long`}),r=t.toLocaleDateString(`en-AU`,{day:`numeric`,month:`long`,year:`numeric`}),i=Yt(e).sort((e,t)=>e.allDay&&!t.allDay?-1:!e.allDay&&t.allDay?1:(e.time||`99:99`).localeCompare(t.time||`99:99`)),a=``;return a=i.length===0?`<div class="pl-agenda-empty">Nothing planned — enjoy the quiet ☀️<br><span style="color:var(--iris-1);cursor:pointer;font-weight:600;font-size:13px" onclick="openPlannerModal(null,'${e}')">+ Add an event</span></div>`:`<div class="pl-agenda-list">${i.map(t=>{let n=Gt(t),r=L[t.category]||L.other,i=t.allDay||!t.time?`All day`:Xt(t.time),a=Kt(t),o=new Date().getHours()*60+new Date().getMinutes(),s=t.time?parseInt(t.time.split(`:`)[0])*60+parseInt(t.time.split(`:`)[1]):-1,c=e===new Date().toISOString().slice(0,10)&&s>=0&&o>=s&&o<s+90,l=r.color||`#f1f5f9`,u=r.text||`#475569`;return`<div class="pl-agenda-ev">
    ...
    <div style="padding:${i.length?`12px 16px`:`0`}">${a}</div>
  </div>`}function un(e){_plannerMonth=e.slice(0,7),_plannerSelectedDay=e,activateTab(`planner`)}function dn(){let e=new Date().toISOString().slice(0,10);_plannerMonth=e.slice(0,7),_plannerSelectedDay=e,R()}function fn(e){_plannerView=e,_plannerCollapseState[`life-areas`]=e===`week`,_plannerCollapseState.nudge=e===`week`,R()}function pn(e){_plannerCollapseState[e]=!_plannerCollapseState[e],R()}function mn(e){e===`everyone`?window._plannerFilterMembers.clear():window._plannerFilterMembers.has(e)?window._plannerFilterMembers.delete(e):window._plannerFilterMembers.add(e),R()}function hn(e){let t=document.getElementById(`pl-day-sheet-overlay`);if(!t)return;let n=new Date(e+`T12:00:00`),r=new Date().toISOString().slice(0,10);document.getElementById(`pl-sheet-title`).textContent=e===r?`Today`:n.toLocaleDateString(`en-AU`,{weekday:`long`}),document.getElementById(`pl-sheet-date`).textContent=n.toLocaleDateString(`en-AU`,{day:`numeric`,month:`long`,year:`numeric`}),document.getElementById(`pl-sheet-add-btn`).dataset.date=e,gn(e),t.classList.add(`open`)}function gn(e){let t=Yt(e).sort((e,t)=>(e.time||`99:99`).localeCompare(t.time||`99:99`)),n=document.getElementById(`pl-sheet-list`);if(n){if(t.length===0){n.innerHTML=`<div class="pl-sheet-empty">Nothing planned. <span style="color:var(--primary);cursor:pointer;font-weight:600" onclick="_plannerOpenModalFromSheet()">Add an event →</span></div>`;return}n.innerHTML=t.map((e,t)=>{let n=Gt(e),r=L[e.category]||L.other,i=Kt(e),a=e.allDay||!e.time?`All day`:Xt(e.time);return`<div class="pl-sheet-ev" onclick="_plannerOpenDetail('${e.id}')">
      ...
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#D4D4D8" stroke-width="2" stroke-linecap="round"><polyline points="9 18 15 12 9 6"/></svg>
    </div>`}).join(``)}}function _n(){let e=document.getElementById(`pl-day-sheet-overlay`);e&&e.classList.remove(`open`)}function vn(e){e.target===document.getElementById(`pl-day-sheet-overlay`)&&_n()}function yn(){let e=document.getElementById(`pl-sheet-add-btn`)?.dataset?.date||_plannerSelectedDay;_n(),Gn(null,e)}function bn(e){let t=L[e];if(!t)return;let n=new Date().toISOString().slice(0,10),r=(g.planner?.events||[]).filter(t=>t.category===e&&t.date>=n).sort((e,t)=>e.date.localeCompare(t.date));document.getElementById(`pl-life-sheet-icon`).textContent=t.emoji,document.getElementById(`pl-life-sheet-title`).textContent=t.label,document.getElementById(`pl-life-sheet-count`).textContent=r.length+` upcoming`;let i=``;if(r.length===0)i=`<div class="pl-sheet-empty">No upcoming ${t.label.toLowerCase()} events.</div>`;else{let e=``;r.forEach(t=>{let n=t.date.slice(0,7);if(n!==e){let r=new Date(t.date+`T12:00:00`);i+=`<div class="pl-life-day-hdr">${r.toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`})}</div>`,e=n}let r=Gt(t),a=Kt(t),o=new Date(t.date+`T12:00:00`);i+=`<div class="pl-life-ev-row" onclick="_plannerCloseLifeSheet();_plannerOpenDetail('${t.id}')">
        ...
        <div class="pl-life-ev-content">
          ...
          <div class="pl-life-ev-meta">${a}${t.time?` · `+Xt(t.time):``}</div>
        </div>
      </div>`})}document.getElementById(`pl-life-sheet-list`).innerHTML=i,document.getElementById(`pl-life-overlay`).classList.add(`open`)}function xn(){document.getElementById(`pl-life-overlay`)?.classList.remove(`open`)}function Sn(e){e.target===document.getElementById(`pl-life-overlay`)&&xn()}function Cn(e){let t=(g.planner?.events||[]).find(t=>t.id===e);if(!t)return;_plannerDetailEvId=e;let n=Gt(t),r=L[t.category]||L.other,i=Wt(t);document.getElementById(`pl-detail-title`).textContent=t.title,document.getElementById(`pl-detail-color-bar`).style.background=n.dot;let a=new Date(t.date+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`,year:`numeric`}),o=t.allDay?`All day`:t.time?Xt(t.time):``;!t.allDay&&t.endTime&&(o+=` – `+Xt(t.endTime));let s=(i.includes(`everyone`)?[{id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`}]:i.map(e=>Ut(e))).map(e=>`<span style="display:inline-flex;align-items:center;gap:5px;background:${e.bg};color:${e.text};padding:4px 10px;border-radius:99px;font-size:12px;font-weight:600">${e.emoji} ${e.name}</span>`).join(` `),c=(t.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0),l=[{icon:`📅`,label:`Date`,value:a},o?{icon:`🕐`,label:`Time`,value:o}:null,t.location?{icon:`📍`,label:`Address`,value:T(t.location)}:null,{icon:`👥`,label:`Who`,value:`<div style="display:flex;flex-wrap:wrap;gap:6px;margin-top:4px">${s}</div>`},{icon:r.emoji,label:`Category`,value:r.label},qt(t)?{icon:`🔄`,label:`Repeats`,value:qt(t)}:null,c>0?{icon:`💰`,label:`Est. cost`,value:`$${c.toLocaleString(`en-AU`)}`}:null,t.notes?{icon:`📝`,label:`Notes`,value:T(t.notes)}:null].filter(Boolean);document.getElementById(`pl-detail-body`).innerHTML=l.map(e=>`<div class="pl-detail-row">
      <div class="pl-detail-icon">${e.icon}</div>
      <div style="flex:1;min-width:0">
        <div class="pl-detail-row-label">${e.label}</div>
        <div class="pl-detail-row-value">${e.value}</div>
      </div>
    </div>`).join(``)+(r.financial?`<button class="planner-ai-btn" style="width:100%;justify-content:center;margin-top:16px" onclick="_plannerCloseDetail();estimatePlannerEvent('${e}')">✦ Estimate costs with AI</button>`:``)+`<button class="pl-detail-share-btn" onclick="_plannerOpenShare('${e}')">🔗 Share this event</button>`,document.getElementById(`pl-detail-overlay`).classList.add(`open`)}function wn(){document.getElementById(`pl-detail-overlay`)?.classList.remove(`open`),_plannerDetailEvId=null}function Tn(e){e.target===document.getElementById(`pl-detail-overlay`)&&wn()}function En(){let e=_plannerDetailEvId;wn(),e&&Gn(e)}function Dn(e){let t=(g.planner?.events||[]).find(t=>t.id===e);if(!t)return;let n=`https://toto.app/event/${t.title.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/(^-|-$)/g,``)}-${Math.random().toString(36).slice(2,10)}`,r=document.getElementById(`pl-share-sub`),i=document.getElementById(`pl-share-url`),a=document.getElementById(`pl-share-copy-btn`);r&&(r.textContent=t.title),i&&(i.textContent=n),a&&(a.textContent=`Copy`,a.classList.remove(`copied`)),document.getElementById(`pl-share-overlay`)?.classList.add(`open`)}function On(){document.getElementById(`pl-share-overlay`)?.classList.remove(`open`)}function kn(e){e.target===document.getElementById(`pl-share-overlay`)&&On()}function An(){let e=document.getElementById(`pl-share-url`)?.textContent;e&&navigator.clipboard?.writeText(e).catch(()=>{});let t=document.getElementById(`pl-share-copy-btn`);t&&(t.textContent=`Copied!`,t.classList.add(`copied`),setTimeout(()=>{t.textContent=`Copy`,t.classList.remove(`copied`)},2e3))}function jn(e){let t=document.getElementById(`pl-share-url`)?.textContent||``,n=(g.planner?.events||[]).find(e=>e.id===_plannerDetailEvId),r=n?`${n.title} — ${t}`:t;e===`sms`&&window.open(`sms:?body=${encodeURIComponent(r)}`),e===`whatsapp`&&window.open(`https://wa.me/?text=${encodeURIComponent(r)}`),e===`email`&&window.open(`mailto:?subject=${encodeURIComponent(n?.title||`Event`)}&body=${encodeURIComponent(r)}`)}function Mn(){function e(e){return Math.ceil((e-new Date().setHours(0,0,0,0))/864e5)}function t(e,t,n,r){let i=new Date(e,t,1);for(;i.getDay()!==n;)i.setDate(i.getDate()+1);return i.setDate(i.getDate()+(r-1)*7),i}let n=new Date().getFullYear();return[{emoji:`🧾`,title:`EOFY`,days:e(new Date(n,5,30)),body:`Tax time — accountant fees, donations, prepayments`},{emoji:`🎄`,title:`Christmas`,days:e(new Date(n,11,25)),body:`Gifts, travel, food — start budgeting early`},{emoji:`💐`,title:`Mother's Day`,days:e(t(n,4,0,2)),body:`Gift, brunch or dinner for Mum`},{emoji:`👔`,title:`Father's Day`,days:e(t(n,8,0,1)),body:`Gift or outing for Dad`}].filter(e=>e.days>=-3&&e.days<=60).sort((e,t)=>e.days-t.days)}function Nn(e){_plannerExpanded.has(e)?_plannerExpanded.delete(e):_plannerExpanded.add(e),R()}function Pn(e,t){let n=(g.planner?.events||[]).find(t=>t.id===e);if(!n)return;let r=(n.estimates||[]).find(e=>e.id===t);r&&(r.accepted=!r.accepted,window.saveData(g),R())}function Fn(e){let t=(g.planner?.events||[]).find(t=>t.id===e);if(!t)return;let n=(t.estimates||[]).filter(e=>e.accepted);if(!n.length)return;let r=t.date.slice(0,7);g.budget.suggestions||(g.budget.suggestions=[]),g.budget.suggestions=g.budget.suggestions.filter(e=>e.eventId!==t.id),n.forEach(e=>{g.budget.suggestions.push({id:`sug-`+Date.now()+`-`+Math.random().toString(36).slice(2,5),month:r,eventId:t.id,eventTitle:t.title,estId:e.id,name:e.name,amount:e.amount,category:e.category,status:`pending`})}),t.pushed=`suggested`,window.saveData(g),_plannerExpanded.add(e),R();let i=new Date(r+`-15`).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`});r===window.selectedBudgetMonth?window.safeRender(renderBudget):confirm(`${n.length} suggestion${n.length>1?`s`:``} sent to ${i} budget.\n\nGo to Monthly Budget to approve them?`)&&(window.selectedBudgetMonth=r,activateTab(`budget`))}function In(e){let t=(g.budget.suggestions||[]).find(t=>t.id===e);if(!t)return;let n=window.ensureMonthOverride(t.month);n.expenses.push({id:F(n.expenses),name:`${t.name} (${t.eventTitle})`,amount:t.amount,frequency:`monthly`,category:t.category,recurring:!1,_plannerEventId:t.eventId}),t.status=`approved`;let r=(g.planner?.events||[]).find(e=>e.id===t.eventId);r&&(g.budget.suggestions||[]).filter(e=>e.eventId===r.id&&e.status===`pending`).length===0&&(r.pushed=!0),window.saveData(g),window.safeRender(renderBudget),window.safeRender(R)}function Ln(e){let t=(g.budget.suggestions||[]).find(t=>t.id===e);if(!t)return;t.status=`dismissed`;let n=(g.planner?.events||[]).find(e=>e.id===t.eventId);n&&(g.budget.suggestions||[]).filter(e=>e.eventId===n.id&&e.status===`pending`).length===0&&(n.pushed=n.pushed===`suggested`?!1:n.pushed),window.saveData(g),window.safeRender(renderBudget)}function Rn(e){let t=(g.budget?.suggestions||[]).filter(t=>t.month===e&&t.status===`pending`);if(!t.length)return``;let n={};t.forEach(e=>{n[e.eventTitle]||(n[e.eventTitle]=[]),n[e.eventTitle].push(e)});let r=t.map(e=>`
    <div class="suggestion-row">
      ...
      <span class="suggestion-amount">${O(e.amount)}</span>
    ...
    ${r}
  </div>`}function zn(e){let t=(g.planner?.events||[]).find(t=>t.id===e);t&&(Object.values(g.budget.months||{}).forEach(t=>{t.expenses=(t.expenses||[]).filter(t=>t._plannerEventId!==e)}),g.budget.expenses=(g.budget.expenses||[]).filter(t=>t._plannerEventId!==e),g.budget.suggestions=(g.budget.suggestions||[]).filter(t=>t.eventId!==e),t.pushed=!1,window.saveData(g),R(),window.safeRender(renderBudget))}function Bn(e){confirm(`Delete this event and remove it from the budget?`)&&(zn(e),g.planner.events=g.planner.events.filter(t=>t.id!==e),_plannerExpanded.delete(e),window.saveData(g),window.closeModal(),R())}async function Vn(e){let t=I(`toto_ai_key`);if(!t){alert(`Add your AI API key in Settings to use cost estimation.`);return}let n=(g.planner?.events||[]).find(t=>t.id===e);if(!n)return;let r=document.getElementById(`ai-btn-${e}`);r&&(r.disabled=!0,r.textContent=`✦ Estimating…`);let i=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`).length||2,a=(g.householdProfile?.members||[]).filter(e=>e.role===`child`).length||0,o=new Date(n.date+`T12:00:00`).toLocaleDateString(`en-AU`,{day:`numeric`,month:`long`,year:`numeric`}),s=`You are a family finance assistant for an Australian family. Suggest realistic cost estimates for the following life event.

Event: ${n.title}
Category: ${(L[n.category]||L.other).label}
Date: ${o}
...
- Use ONLY these categories: Transport, Accommodation, Food & Dining, Entertainment, Gifts, Clothing, Health, Education, Shopping, Other`;try{let r=((await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:512,messages:[{role:`user`,content:s}]})})).json()).content?.[0]?.text||``).match(/\[[\s\S]*?\]/);if(!r)throw Error(`No JSON array in response`);n.estimates=JSON.parse(r[0]).map((e,t)=>({id:`est-${Date.now()}-${t}`,name:e.name,amount:Number(e.amount)||0,category:e.category||`Other`,accepted:!0})),_plannerExpanded.add(e),window.saveData(g),R()}catch(e){console.error(`Planner estimate error:`,e),r&&(r.disabled=!1,r.innerHTML=`✦ Try again`),alert(`Could not estimate costs. Check your AI API key in Settings.`)}}var Hn=new Set,Un=`start`,Wn=new Date().toISOString().slice(0,7);function Gn(e,t){let n=e?(g.planner?.events||[]).find(t=>t.id===e):null,r=t||_plannerSelectedDay||new Date().toISOString().slice(0,10);Hn=new Set,Un=`start`,Wn=(n?.date||r).slice(0,7),n?Wt(n).forEach(e=>Hn.add(e)):window._plannerFilterMembers.size>0&&window._plannerFilterMembers.forEach(e=>Hn.add(e)),document.getElementById(`modal-title`).textContent=n?`Edit Event`:`Add Event`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <div style="display:grid;grid-template-columns:minmax(0,1.15fr) minmax(0,0.85fr);gap:8px" class="form-group">
      <div>
        ...
        <button type="button" class="form-input" id="pm-start-trigger" onclick="_pmDpOpen('start')" style="text-align:left;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">
          <span id="pm-start-display">${qn(n?n.date:r)}</span>
        </button>
      </div>
    ...
    <div style="display:grid;grid-template-columns:minmax(0,1.15fr) minmax(0,0.85fr);gap:8px" class="form-group" id="pm-end-group">
      <div>
        ...
        <button type="button" class="form-input" id="pm-end-trigger" onclick="_pmDpOpen('end')" style="text-align:left;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:${n?.endDate?`var(--text)`:`var(--text-muted)`}">
          <span id="pm-end-display">${n?.endDate?qn(n.endDate):`Same day`}</span>
        </button>
      </div>
    ...
    <div class="form-group">
      ...
      <select class="form-input" id="pe-cat" style="max-width:240px">
        ${Object.entries(L).map(([e,t])=>`<option value="${e}" ${(n?.category||`other`)===e?`selected`:``}>${t.emoji} ${t.label}</option>`).join(``)}
      </select>
    </div>
    ...
    </div>`,document.getElementById(`modal-footer`).style.justifyContent=`space-between`,document.getElementById(`modal-overlay`).classList.remove(`hidden`),Jn(),Xn(),setTimeout(()=>{_routineRecurrenceSummaryUpdate()},100)}function Kn(e){return e?new Date(e+`T12:00:00`).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`}):``}function qn(e){return e?new Date(e+`T12:00:00`).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`}):``}function Jn(){let e=Ht(),t={id:`everyone`,name:`Everyone`,emoji:`👨‍👩‍👧`,dot:`#94a3b8`,bg:`#f1f5f9`,text:`#475569`},n=document.getElementById(`pm-member-picker`);if(!n)return;n.innerHTML=[t,...e].map(e=>`<button type="button" style="display:flex;align-items:center;gap:6px;padding:6px 12px;border-radius:99px;font-size:12px;font-weight:600;border:2px solid ${(e.id===`everyone`?Hn.size===0:Hn.has(e.id))?e.dot:`transparent`};background:${e.bg};color:${e.text};cursor:pointer;transition:all .15s" onclick="_pmToggleMember('${e.id}')">
      ${e.emoji} ${e.name}
    </button>`).join(``);let r=[...Hn][0],i=r?e.find(e=>e.id===r):null,a=document.getElementById(`pm-save-btn`);a&&(a.style.background=i?i.dot:``)}function Yn(e){e===`everyone`?Hn.clear():Hn.has(e)?Hn.delete(e):Hn.add(e),Jn()}function Xn(){let e=document.getElementById(`pe-allday`)?.checked,t=document.getElementById(`pm-start-time-col`),n=document.getElementById(`pm-end-time-col`);t&&(t.style.display=e?`none`:``),n&&(n.style.display=e?`none`:``)}function Zn(){}function Qn(e){Un=e;let t=e===`end`?`pm-end-trigger`:`pm-start-trigger`,n=document.getElementById(t);if(!n)return;let r=document.getElementById(`pm-dp-popover`);r||(r=document.createElement(`div`),r.id=`pm-dp-popover`,r.style.cssText=`display:none;position:fixed;width:260px;background:#fff;border:1.5px solid #e2e8f0;border-radius:14px;box-shadow:0 12px 40px rgba(0,0,0,.16);padding:14px;z-index:9999`,document.body.appendChild(r),document.addEventListener(`click`,$n)),Wn=(document.getElementById(`pe-date`)?.value||new Date().toISOString().slice(0,10)).slice(0,7),er(r);let i=n.getBoundingClientRect();r.style.top=i.bottom+6+`px`,r.style.left=Math.max(8,Math.min(i.left,window.innerWidth-272))+`px`,r.style.display=`block`}function $n(e){let t=document.getElementById(`pm-dp-popover`),n=document.getElementById(`pm-start-trigger`),r=document.getElementById(`pm-end-trigger`);t&&!t.contains(e.target)&&e.target!==n&&e.target!==r&&!n?.contains(e.target)&&!r?.contains(e.target)&&t&&(t.style.display=`none`)}function er(e){if(e||(e=document.getElementById(`pm-dp-popover`)),!e)return;let[t,n]=Wn.split(`-`).map(Number),r=new Date().toISOString().slice(0,10),i=Un===`end`?document.getElementById(`pe-end-date`)?.value||``:document.getElementById(`pe-date`)?.value||``,a=new Date(t,n-1,1).getDay(),o=a===0?6:a-1,s=new Date(t,n,0).getDate(),c=new Date(t,n-1,0).getDate(),l=new Date(t,n-1,15).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`}),u=[];for(let e=o-1;e>=0;e--)u.push({day:c-e,muted:!0,dateStr:null});for(let e=1;e<=s;e++){let r=`${t}-${String(n).padStart(2,`0`)}-${String(e).padStart(2,`0`)}`;u.push({day:e,muted:!1,dateStr:r})}let d=u.length%7==0?0:7-u.length%7;for(let e=1;e<=d;e++)u.push({day:e,muted:!0,dateStr:null});let f=u.map(e=>{let t=e.dateStr&&e.dateStr===i,n=e.dateStr===r,a=t?`background:#2563eb;color:#fff;border-radius:50%`:n?`color:#2563eb;font-weight:700`:e.muted?`color:#d1d5db`:``;return`<button type="button" onclick="_pmDpSelect('${e.dateStr}')" ${e.dateStr?``:`disabled`} style="aspect-ratio:1;display:flex;align-items:center;justify-content:center;font-size:12px;border:none;background:none;cursor:${e.dateStr?`pointer`:`default`};font-family:inherit;${a}">${e.day}</button>`}).join(``);e.innerHTML=`
    ...
    </div>`}function tr(e){if(!e)return;let t=Un===`end`?`pe-end-date`:`pe-date`,n=Un===`end`?`pm-end-display`:`pm-start-display`,r=document.getElementById(t),i=document.getElementById(n);r&&(r.value=e),i&&(i.textContent=qn(e),i.style.color=`#1e293b`),Wn=e.slice(0,7),document.getElementById(`pm-dp-popover`).style.display=`none`}function nr(){tr(``);let e=Un===`end`?`pm-end-display`:`pm-start-display`,t=document.getElementById(e);t&&(t.textContent=Un===`end`?`Same day`:``,t.style.color=`#94a3b8`)}function rr(){tr(new Date().toISOString().slice(0,10))}function ir(){let[e,t]=Wn.split(`-`).map(Number),n=t===1?e-1:e,r=t===1?12:t-1;Wn=`${n}-${String(r).padStart(2,`0`)}`,er()}function ar(){let[e,t]=Wn.split(`-`).map(Number),n=t===12?e+1:e,r=t===12?1:t+1;Wn=`${n}-${String(r).padStart(2,`0`)}`,er()}function or(e){let t=document.getElementById(`pe-title`).value.trim(),n=document.getElementById(`pe-cat`).value,r=document.getElementById(`pe-date`).value,i=document.getElementById(`pe-end-date`)?.value||``,a=document.getElementById(`pe-allday`)?.checked||!1,o=a?``:document.getElementById(`pe-time`)?.value||``,s=a?``:document.getElementById(`pe-end-time`)?.value||``,c=document.getElementById(`pe-notes`).value.trim(),l=document.getElementById(`pe-location`)?.value.trim()||``,u=_routineRecurrenceCollect(),d=(u.type,`none`),f=Hn.size>0?[...Hn]:[`everyone`];if(!t||!r){alert(`Title and date are required.`);return}if(g.planner||(g.planner={events:[]}),e){let p=g.planner.events.find(t=>t.id===e);p&&(p.title=t,p.category=n,p.date=r,p.endDate=i||r,p.allDay=a,p.time=o,p.endTime=s,p.notes=c,p.location=l,p.recurrence=u,p.recurring=d,p.memberIds=f)}else{let e=`ev-`+Date.now();g.planner.events.push({id:e,title:t,category:n,date:r,endDate:i||r,allDay:a,time:o,endTime:s,notes:c,location:l,recurrence:u,recurring:d,memberIds:f,estimates:[],pushed:!1}),_plannerExpanded.add(e),_plannerSelectedDay=r,_plannerMonth=r.slice(0,7)}window.saveData(g),window.closeModal(),R()}function sr(e,t){let n=(g.planner?.events||[]).filter(t=>t.date?.slice(0,7)===e&&(t.estimates||[]).some(e=>e.accepted));if(n.length===0)return``;let r=n.reduce((e,t)=>e+(t.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0),0),i=t-r,a=n.filter(e=>!e.pushed),o=n.map(e=>{let t=L[e.category]||L.other,n=(e.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0),r=new Date(e.date+`T12:00:00`).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`});return`<div class="forecast-row">
      <span class="forecast-ev-name">${t.emoji} ${T(e.title)}</span>
      <span class="forecast-ev-date">${r}</span>
      <span class="forecast-ev-cost">${O(n)}</span>
    ...
    <div class="forecast-header">
      <span class="forecast-header-title">📅 Planned Events — ${O(r)} this month</span>
    ...
    <div class="forecast-total">
      ...
      <span style="font-weight:800;font-size:15px;color:${i>=0?`#10b981`:`#ef4444`}">${O(Math.abs(i))} ${i>=0?`surplus`:`deficit`}</span>
    </div>
  </div>`}function cr(e){(g.planner?.events||[]).filter(t=>t.date?.slice(0,7)===e&&!t.pushed&&(t.estimates||[]).some(e=>e.accepted)).forEach(e=>Fn(e.id)),renderBudget()}function lr(e,t,n,r){let i=0;for(let a=1;a<=31;a++){let o=new Date(e,t,a);if(o.getMonth()!==t)break;if(o.getDay()===n&&(i++,i===r))return o}}function ur(){let e=new Date;e.setHours(0,0,0,0);let t=e.getFullYear(),n=t=>Math.ceil((t-e)/864e5);return[{d:new Date(t,3,25),emoji:`🌿`,title:`Anzac Day`,body:`Public holiday — any plans or travel?`},{d:new Date(t,5,30),emoji:`🧾`,title:`EOFY`,body:`Tax time — accountant fees, donations, prepayments`},{d:new Date(t,11,25),emoji:`🎄`,title:`Christmas`,body:`Gifts, travel, food — start budgeting early`},{d:new Date(t,11,26),emoji:`🛍️`,title:`Boxing Day`,body:`Sales, travel, family catch-ups`},{d:new Date(t+1,0,1),emoji:`🎆`,title:`New Year's`,body:`Celebrations, travel plans`},{d:lr(t,4,0,2),emoji:`💐`,title:`Mother's Day`,body:`Gift, brunch or dinner for Mum`},{d:lr(t,8,0,1),emoji:`👔`,title:`Father's Day`,body:`Gift or outing for Dad`},{d:lr(t,10,2,1),emoji:`🏆`,title:`Melbourne Cup`,body:`Event day — sweepstakes, lunch, outfits`},{d:new Date(t,3,6),emoji:`🎒`,title:`Term 1 Holidays`,body:`2 weeks — activities, childcare, day trips`},{d:new Date(t,6,5),emoji:`🎒`,title:`Term 2 Holidays`,body:`2 weeks — winter school holidays`},{d:new Date(t,8,19),emoji:`🎒`,title:`Term 3 Holidays`,body:`2 weeks — spring school holidays`},{d:new Date(t,11,18),emoji:`🎒`,title:`Summer Holidays`,body:`6 weeks — the big one, plan early`}].filter(e=>e.d).map(e=>({...e,days:n(e.d)})).filter(e=>e.days>=-3&&e.days<=45).sort((e,t)=>e.days-t.days).slice(0,4)}function dr(){let e=ur();return e.length===0?``:`<div class="nudge-section">
  ...
  </div>`}function fr(e,t){let n=new Date(e);switch(t){case`weekly`:n.setDate(n.getDate()+7);break;case`fortnightly`:n.setDate(n.getDate()+14);break;case`monthly`:n.setMonth(n.getMonth()+1);break;case`quarterly`:n.setMonth(n.getMonth()+3);break;case`yearly`:n.setFullYear(n.getFullYear()+1);break}return n}function pr(){if(!g.planner?.events)return;let e=g.planner.events,t=new Date;t.setHours(0,0,0,0);let n=!1,r={weekly:3,fortnightly:3,monthly:6,quarterly:12,yearly:24};e.filter(e=>e.recurring&&e.recurring!==`none`&&!e._recurringSourceId).forEach(i=>{let a=i.recurring,o=new Date(t);o.setMonth(o.getMonth()+(r[a]||12));let s=new Date(i.date+`T12:00:00`);for(;s<t;)s=fr(s,a);let c=0;for(;s<=o&&c++<200;){let t=s.toISOString().slice(0,10);e.some(e=>e.date===t&&(e.id===i.id||e._recurringSourceId===i.id))||(e.push({id:`ev-`+Date.now()+`-r`+Math.random().toString(36).slice(2,6),title:i.title,category:i.category,date:t,notes:i.notes||``,recurring:a,_recurringSourceId:i.id,estimates:(i.estimates||[]).map(e=>({...e,id:`est-`+Date.now()+Math.random(),accepted:!0})),pushed:!1}),n=!0),s=fr(s,a)}}),n&&window.saveData(g)}var mr=!1,hr=[],gr=!1,_r=[{icon:`📅`,text:`What should I plan for this month?`},{icon:`💸`,text:`Any upcoming events I should budget for?`},{icon:`🎒`,text:`Help me plan for school holidays`},{icon:`✈️`,text:`I have a trip coming up — what do I need to organise?`}];function vr(){mr?br():yr()}function yr(){mr=!0,document.getElementById(`toto-panel`).classList.add(`open`),hr.length===0&&xr()}function br(){mr=!1,document.getElementById(`toto-panel`).classList.remove(`open`)}function xr(){let e=new Date().toISOString().slice(0,10),t=new Date;t.setDate(t.getDate()+7);let n=t.toISOString().slice(0,10),r=(g.planner?.events||[]).filter(t=>t.date>=e&&t.date<=n),i=[];r.slice(0,2).forEach(t=>{let n=L[t.category]||L.other,r=new Date(t.date+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`short`,day:`numeric`,month:`short`});n.financial&&(!t.estimates||t.estimates.length===0)?i.push({icon:n.emoji,text:`${T(t.title)} is ${r} — want me to estimate costs?`}):t.date===e&&i.push({icon:n.emoji,text:`You have "${T(t.title)}" today — anything to prepare?`})});let a=getSeasonalNudges().slice(0,2).map(e=>({icon:e.emoji,text:`Help me plan for ${T(e.title)} (${e.days<=0?`now!`:`in ${e.days} days`})`})),o=[...i,...a,..._r].slice(0,4),s=document.getElementById(`toto-suggestions`);s.innerHTML=o.map(e=>`<button class="toto-suggestion" onclick="_totoSendSuggestion(this)">${e.icon} ${e.text}</button>`).join(``);let c=new Date().getHours(),l=c<12?`Good morning`:c<17?`Good afternoon`:`Good evening`,u=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`).length||2,d=(g.householdProfile?.members||[]).filter(e=>e.role===`child`).length||0,f=d>0?` and ${d} kid${d>1?`s`:``}`:``;Er(`toto`,`${l}! 👋 I'm Toto, your family planning assistant. You have ${u} adult${u>1?`s`:``}${f} in your household.\n\nI can help you plan events, estimate costs, and make sure nothing slips through the cracks. What would you like to work on?`)}function Sr(e){let t=e.textContent.trim();e.closest(`.toto-suggestions`).style.display=`none`,wr(t)}async function Cr(){let e=document.getElementById(`toto-input`),t=e.value.trim();!t||gr||(e.value=``,document.getElementById(`toto-suggestions`).style.display=`none`,wr(t))}async function wr(e){let t=I(`toto_ai_key`);if(!t){Er(`toto`,`To chat with me, you'll need to add your AI API key in Settings. It only takes a second! ⚙️`);return}Er(`user`,e),hr.push({role:`user`,content:e}),gr=!0,document.getElementById(`toto-send`).disabled=!0;let n=Dr();try{let e=Tr(),r=(await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:600,system:e,messages:hr})})).json()).content?.[0]?.text||`Sorry, I couldn't get a response. Try again?`;hr.push({role:`assistant`,content:r}),Or(n),Er(`toto`,r)}catch{Or(n),Er(`toto`,`Oops, something went wrong. Check your internet connection and try again.`)}finally{gr=!1,document.getElementById(`toto-send`).disabled=!1,document.getElementById(`toto-input`).focus()}}function Tr(){let e=new Date().toISOString().slice(0,10),t=new Date().toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`,year:`numeric`}),n=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`).length||2,r=(g.householdProfile?.members||[]).filter(e=>e.role===`child`).length||0,i=new Date;i.setDate(i.getDate()+60);let a=(g.planner?.events||[]).filter(t=>t.date>=e&&t.date<=i.toISOString().slice(0,10)).sort((e,t)=>e.date.localeCompare(t.date)).slice(0,15).map(e=>{let t=L[e.category]||L.other,n=new Date(e.date+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`short`,day:`numeric`,month:`short`}),r=(e.estimates||[]).filter(e=>e.accepted).reduce((e,t)=>e+(t.amount||0),0);return`- ${n}: ${e.title} (${t.label})${r>0?` — $`+r.toLocaleString(`en-AU`)+` budgeted`:``}${e.notes?` — Notes: `+e.notes:``}`}).join(`
...
- Keep responses to 3-5 sentences unless a list is genuinely helpful`}function Er(e,t){let n=document.getElementById(`toto-messages`),r=document.createElement(`div`);r.className=`toto-msg ${e}`;let i=t.replace(/\n/g,`<br>`);e===`toto`?r.innerHTML=`<div class="toto-msg-avatar">🐕</div><div class="toto-msg-bubble">${i}</div>`:r.innerHTML=`<div class="toto-msg-bubble">${i}</div>`,n.appendChild(r),n.scrollTop=n.scrollHeight}function Dr(){let e=document.getElementById(`toto-messages`),t=`toto-typing-`+Date.now(),n=document.createElement(`div`);return n.className=`toto-msg toto`,n.id=t,n.innerHTML=`<div class="toto-msg-avatar">🐕</div><div class="toto-msg-bubble"><div class="toto-typing"><span></span><span></span><span></span></div></div>`,e.appendChild(n),e.scrollTop=e.scrollHeight,t}function Or(e){document.getElementById(e)?.remove()}`serviceWorker`in navigator&&navigator.serviceWorker.register(`/home-budget/sw.js`,{scope:`/home-budget/`}).catch(e=>console.warn(`SW registration failed:`,e));var kr=[`Produce`,`Meat & Seafood`,`Dairy & Eggs`,`Pantry`,`Bakery`,`Frozen`,`Household`,`Other`],Ar={Produce:`🥦`,"Meat & Seafood":`🥩`,"Dairy & Eggs":`🥛`,Pantry:`🥫`,Bakery:`🍞`,Frozen:`🧊`,Household:`🏠`,Other:`🛒`},jr={food:{label:`Food`,emoji:`🛒`,color:`#dcfce7`,text:`#166534`,aisles:!0,priceEst:!0},clothes:{label:`Clothes`,emoji:`👕`,color:`#dbeafe`,text:`#1e40af`,aisles:!1,priceEst:!1},wishlist:{label:`Wishlist`,emoji:`🎁`,color:`#fce7f3`,text:`#9d174d`,aisles:!1,priceEst:!1},home:{label:`Home & Garden`,emoji:`🛠`,color:`#fef3c7`,text:`#92400e`,aisles:!0,priceEst:!1},pharmacy:{label:`Pharmacy`,emoji:`💊`,color:`#ede9fe`,text:`#5b21b6`,aisles:!0,priceEst:!1}},Mr={food:[{key:`produce`,emoji:`🥦`,label:`Produce`},{key:`dairy`,emoji:`🥛`,label:`Dairy & Eggs`},{key:`bakery`,emoji:`🍞`,label:`Bakery`},{key:`meat`,emoji:`🥩`,label:`Meat & Seafood`},{key:`pantry`,emoji:`🥫`,label:`Pantry`},{key:`frozen`,emoji:`🧊`,label:`Frozen`},{key:`health`,emoji:`🧴`,label:`Health & Beauty`},{key:`bathroom`,emoji:`🚿`,label:`Bathroom`},{key:`cleaning`,emoji:`🧹`,label:`Cleaning`},{key:`drinks`,emoji:`🍷`,label:`Drinks & Alcohol`},{key:`other`,emoji:`🛒`,label:`Uncategorised`}],home:[{key:`tools`,emoji:`🔨`,label:`Tools & Hardware`},{key:`garden`,emoji:`🌱`,label:`Garden`},{key:`cleaning`,emoji:`🧹`,label:`Cleaning`},{key:`other`,emoji:`🛒`,label:`Other`}],pharmacy:[{key:`medicine`,emoji:`💊`,label:`Medicine`},{key:`skincare`,emoji:`🧴`,label:`Skincare`},{key:`vitamins`,emoji:`💪`,label:`Vitamins`},{key:`other`,emoji:`🛒`,label:`Other`}]},Nr={milk:`dairy`,cheese:`dairy`,butter:`dairy`,eggs:`dairy`,yoghurt:`dairy`,cream:`dairy`,bread:`bakery`,rolls:`bakery`,muffin:`bakery`,croissant:`bakery`,baguette:`bakery`,apple:`produce`,banana:`produce`,orange:`produce`,strawberry:`produce`,tomato:`produce`,lettuce:`produce`,spinach:`produce`,carrot:`produce`,broccoli:`produce`,potato:`produce`,onion:`produce`,garlic:`produce`,cucumber:`produce`,capsicum:`produce`,avocado:`produce`,lemon:`produce`,lime:`produce`,grapes:`produce`,mango:`produce`,pineapple:`produce`,watermelon:`produce`,chicken:`meat`,beef:`meat`,mince:`meat`,steak:`meat`,pork:`meat`,lamb:`meat`,salmon:`meat`,fish:`meat`,tuna:`meat`,prawn:`meat`,sausage:`meat`,bacon:`meat`,rice:`pantry`,pasta:`pantry`,flour:`pantry`,sugar:`pantry`,oil:`pantry`,vinegar:`pantry`,salt:`pantry`,pepper:`pantry`,sauce:`pantry`,stock:`pantry`,beans:`pantry`,lentils:`pantry`,chickpeas:`pantry`,cereal:`pantry`,oats:`pantry`,honey:`pantry`,jam:`pantry`,peanut:`pantry`,coffee:`pantry`,tea:`pantry`,biscuit:`pantry`,cracker:`pantry`,chocolate:`pantry`,chips:`pantry`,nuts:`pantry`,icecream:`frozen`,peas:`frozen`,corn:`frozen`,pizza:`frozen`,shampoo:`health`,conditioner:`health`,deodorant:`health`,sunscreen:`health`,moisturiser:`health`,makeup:`health`,lipstick:`health`,mascara:`health`,toothpaste:`bathroom`,toothbrush:`bathroom`,soap:`bathroom`,toilet:`bathroom`,razors:`bathroom`,tampons:`bathroom`,pads:`bathroom`,detergent:`cleaning`,bleach:`cleaning`,sponge:`cleaning`,dishwashing:`cleaning`,bins:`cleaning`,mop:`cleaning`,water:`drinks`,juice:`drinks`,beer:`drinks`,wine:`drinks`,spirits:`drinks`,softdrink:`drinks`,soda:`drinks`,kombucha:`drinks`};function Pr(e){for(var t=e.toLowerCase(),n=Object.keys(Nr),r=0;r<n.length;r++)if(t.indexOf(n[r])!==-1)return Nr[n[r]];return`other`}function Fr(e){var t=e.trim(),n=1,r=`units`,i=t,a=t.match(/^(\d+(?:\.\d+)?)\s*(kg|g|L|l|ml|dozen|doz)\s+(.+)$/i);if(a)n=parseFloat(a[1]),r=a[2].toLowerCase()===`l`?`L`:a[2].toLowerCase()===`doz`?`dozen`:a[2],i=a[3];else{var o=t.match(/^(\d+(?:\.\d+)?)\s+(.+)$/);o?(n=parseFloat(o[1]),i=o[2]):/^dozen\s+/i.test(t)&&(n=1,r=`dozen`,i=t.replace(/^dozen\s+/i,``))}return i=i.charAt(0).toUpperCase()+i.slice(1),{qty:n,unit:r,name:i}}var Ir=`food`,Lr=`selector`;Object.defineProperty(window,`_listsActiveType`,{get(){return Ir},set(e){Ir=e},configurable:!0}),Object.defineProperty(window,`_listsView`,{get(){return Lr},set(e){Lr=e},configurable:!0});function Rr(e){let t=new Date,n=t.getDay()===0?-6:1-t.getDay(),r=new Date(t);return r.setDate(t.getDate()+n+(e||0)*7),r.toISOString().slice(0,10)}function zr(e){let t=new Date(e+`T00:00:00`);return Array.from({length:7},(e,n)=>{let r=new Date(t);return r.setDate(t.getDate()+n),r})}function Br(){window._mealView===`shopping`?Qr():Vr()}function Vr(){let e=Rr(0),t=zr(e),n=g.meals.plan[e]||{},r=new Date().toISOString().slice(0,10),i=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`,`Sun`],a=[{key:`b`,label:`Breakfast`},{key:`l`,label:`Lunch`},{key:`d`,label:`Dinner`}];t[0].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`}),t[6].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`});let o=[];for(let e=0;e<7;e++){let t=n[e]||{};[`b`,`l`,`d`].forEach(e=>{t[e]&&o.push(t[e])})}let s=``;a.forEach(i=>{s+=`<div class="meal-grid-label">${i.label}</div>`,t.forEach((t,a)=>{let o=(n[a]||{})[i.key]||``,c=t.toISOString().slice(0,10)===r;s+=`<div class="meal-cell${c?` today`:``}" onclick="openMealEdit('${e}',${a},'${i.key}')">
    ...
    <p style="font-size:12px;color:var(--text-muted);margin-top:6px">Tap any cell to add or change a meal.</p>`}var Hr={cuisine:`Any`,price:0,dietary:`Any`},Ur=[`Any`,`Italian`,`Asian`,`Mexican`,`Indian`,`Mediterranean`,`Thai`,`Japanese`,`Middle Eastern`,`Australian`],Wr=[`Any`,`Vegetarian`,`Vegan`,`Gluten-free`,`Quick (<30min)`,`Family-friendly`];function Gr(e,t,n){let r=[`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`,`Sunday`],i={b:`Breakfast`,l:`Lunch`,d:`Dinner`},a=((g.meals.plan[e]||{})[t]||{})[n]||``,o=!!I(`toto_ai_key`),s=new Set;Object.values(g.meals.plan).forEach(e=>Object.values(e).forEach(e=>{typeof e==`object`&&[`b`,`l`,`d`].forEach(t=>{e[t]&&s.add(e[t])})}));let c=[...s].filter(e=>e!==a).slice(0,16);document.getElementById(`modal-title`).textContent=`${r[t]} · ${i[n]}`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
    ...
    <div style="border:1px solid var(--border);border-radius:10px;padding:14px;margin-bottom:16px;background:var(--surface2)">
      ...
      <div style="margin-bottom:12px">
        <div class="form-label" style="display:flex;justify-content:space-between;margin-bottom:5px">
          ...
          <span id="meal-price-lbl" style="color:#0891b2;font-weight:700">${Hr.price>0?`$`+Hr.price:`Any`}</span>
        </div>
        <input type="range" min="0" max="200" step="5" value="${Hr.price}"
    ...
    style="padding:4px 10px;border-radius:99px;font-size:12px;cursor:pointer;white-space:nowrap;
      ...
      color:${n?`#0891b2`:`var(--text)`}">${t}</button>`}function qr(e,t){Hr[e]=t,document.querySelectorAll(`[data-filter="${e}"]`).forEach(e=>{let n=e.dataset.val===t;e.style.borderColor=n?`#0891b2`:`var(--border)`,e.style.background=n?`#ecfeff`:`var(--surface)`,e.style.color=n?`#0891b2`:`var(--text)`})}function Jr(e){Hr.price=e;let t=document.getElementById(`meal-price-lbl`);t&&(t.textContent=e>0?`$${e}`:`Any`)}async function Yr(e){let t=I(`toto_ai_key`);if(!t)return;let n=document.getElementById(`meal-suggest-btn`),r=document.getElementById(`meal-suggest-out`);n&&(n.textContent=`⏳ Thinking…`,n.disabled=!0),r&&(r.innerHTML=``);let i={b:`Breakfast`,l:`Lunch`,d:`Dinner`},a=[Hr.cuisine===`Any`?``:`Cuisine: ${Hr.cuisine}`,Hr.price>0?`Budget: up to $${Hr.price} per serve`:``,Hr.dietary===`Any`?``:`Style: ${Hr.dietary}`].filter(Boolean).join(`, `)||`No specific filters`,o=`Suggest 8 ${i[e]} meal ideas. Filters: ${a}.
Return ONLY a JSON array of meal names, no other text: ["Meal 1","Meal 2",...]`;try{let e=(await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:256,messages:[{role:`user`,content:o}]})})).json()).content[0].text.match(/\[[\s\S]*\]/);if(!e)throw Error(`No JSON`);let n=JSON.parse(e[0]);r&&(r.innerHTML=`<div style="display:flex;flex-wrap:wrap;gap:6px">
      ${n.map(e=>`<button style="padding:6px 12px;border-radius:99px;border:1px solid #0891b2;background:#ecfeff;color:#0891b2;font-size:12px;font-weight:500;cursor:pointer"
        onclick="document.getElementById('meal-input').value='${e.replace(/'/g,`\\'`)}'">${e}</button>`).join(``)}
    </div>`)}catch(e){r&&(r.innerHTML=`<span style="font-size:12px;color:var(--danger)">⚠ ${e.message}</span>`)}finally{n&&(n.textContent=`Get suggestions`,n.disabled=!1)}}function Xr(e,t,n,r){g.meals.plan[e]||(g.meals.plan[e]={}),g.meals.plan[e][t]||(g.meals.plan[e][t]={b:``,l:``,d:``}),g.meals.plan[e][t][n]=r,delete g.meals.plan[e][t][`cal_`+n],window.saveData(g),window.closeModal(),Vr(),r&&g.settings?.showCalories&&Zr(e,t,n,r)}async function Zr(e,t,n,r){let i=I(`toto_ai_key`);if(!(!i||!r))try{let a=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":i,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:50,messages:[{role:`user`,content:`Estimate the calories in this meal: "${r}". Return ONLY a number, nothing else. For example: 450`}]})});if(!a.ok)return;let o=await a.json(),s=parseInt(o.content[0].text.trim().replace(/[^0-9]/g,``));s>0&&s<5e3&&g.meals.plan[e]?.[t]&&(g.meals.plan[e][t][`cal_`+n]=s,window.saveData(g),Vr())}catch{}}function Qr(){let e=g.meals.shopping||[],t=e.filter(e=>e.checked).length,n=e.length-t,r={};kr.forEach(e=>r[e]=[]),e.forEach(e=>{r[kr.includes(e.cat)?e.cat:`Other`].push(e)});let i=``;kr.forEach(e=>{let t=r[e];t.length&&(i+=`
      ...
      <div style="padding:14px 20px;display:flex;gap:10px;flex-wrap:wrap;align-items:flex-end">
        ...
        <div style="flex:1;min-width:120px">
          ...
          <select class="form-select" id="shop-cat">
            ${kr.map(e=>`<option value="${e}">${Ar[e]} ${e}</option>`).join(``)}
          </select>
        </div>
...
Combine quantities where sensible. No duplicates. No other text.`,o={Produce:`produce`,"Meat & Seafood":`meat`,"Dairy & Eggs":`dairy`,Pantry:`pantry`,Bakery:`bakery`,Frozen:`frozen`,Household:`cleaning`,Other:`other`};try{let e=(await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":r,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:a}]})})).json()).content[0].text.match(/\[[\s\S]*\]/);if(!e)throw Error(`No JSON`);let t=JSON.parse(e[0]);g.lists||(g.lists={}),g.lists.food||(g.lists.food={items:[],weeklyBudget:200,budget:0,stores:[],favourites:[],history:[]});let n=g.lists.food.items,i=0;t.forEach(e=>{n.some(t=>t.name.toLowerCase()===e.name.toLowerCase()&&t.state===`active`)||n.push({id:`si-meal-`+Date.now()+`-`+ i++,name:e.name,quantity:1,unit:`units`,notes:e.qty||``,aisle:o[e.cat]||(Pr?Pr(e.name):`other`),state:`active`,addedBy:`meals`,addedAt:new Date().toISOString(),mealTag:`Meal plan`,manualPrice:null,barcodeId:null})}),window.saveData(g),Ir=`food`,Lr=`list`,activateTab(`lists`)}catch{i&&(i.textContent=`🛒 Generate shopping list`,i.disabled=!1)}}var xi=[`Living Room`,`Dining Room`,`Kitchen`,`Master Bedroom`,`Bedroom 2`,`Bedroom 3`,`Study / Office`,`Bathroom`,`Laundry`,`Outdoor / Alfresco`,`Other`];function Si(e={}){let t=e.deliveryDate?(()=>{let[t,n,r]=e.deliveryDate.split(`-`);return`${r}/${n}/${t}`})():``;return`
  ...
  `;if(f+=`<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(320px,1fr));gap:20px;margin-bottom:20px">`,f+=`
    <div class="section">
      <div class="section-header">
        ...
        <span style="font-size:15px;font-weight:700;color:var(--success)">${O(r)}</span>
      </div>
      <div class="table-wrap">
        <table>
          <thead><tr><th>Source</th><th>Frequency</th><th class="amount">Monthly</th></tr></thead>
          <tbody>
            ${t.length===0?`<tr><td colspan="3" style="text-align:center;color:var(--text-muted);padding:20px">No income added yet</td></tr>`:t.map(e=>{let t=r>0?Math.round(N(e)/r*100):0;return`<tr>
                    ...
                    <td class="amount">${O(N(e))} <span style="color:var(--text-muted);font-size:11px">${t}%</span></td>
                  </tr>`}).join(``)}
          </tbody>
        </table>
      </div>
  ...
  `,f+=`
    <div class="section">
      <div class="section-header">
        ...
        <span style="font-size:15px;font-weight:700;color:var(--danger)">${O(i)}</span>
      </div>
      <div style="padding:16px 20px">
        ${c.length===0?`<div style="color:var(--text-muted);text-align:center;padding:20px">No expenses added yet</div>`:c.map(([e,t])=>{let r=colors.expense[e]||`#94a3b8`,a=i>0?t/i*100:0,o=n.filter(t=>(t.category||`Other`)===e).reduce((e,t)=>e+(l[t.id]||0),0),s=n.some(t=>(t.category||`Other`)===e&&l[t.id]!==void 0);return`
                <div style="margin-bottom:16px">
                  <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:5px">
                    ...
                    <span style="font-size:13px;font-weight:600">${O(t)}
                  ...
                  ${s?`<div style="font-size:11px;color:var(--text-muted);margin-top:3px">Actual: ${O(o)}</div>`:``}
                </div>
              `}).join(``)}
      </div>
    </div>
  `,f+=`</div>`,d){let e=i-u;f+=`
      <div class="section" style="margin-bottom:20px">
        <div class="section-header">
          ...
          <div style="display:flex;gap:16px;align-items:center;font-size:13px;flex-wrap:wrap">
            <span>Budget: <strong>${O(i)}</strong></span>
            <span>Actual: <strong>${O(u)}</strong></span>
            <span style="font-weight:600;color:${e>=0?`var(--success)`:`var(--danger)`}">
              ${e>=0?`▼`:`▲`} ${O(Math.abs(e))} ${e>=0?`under`:`over`}
            </span>
          </div>
        </div>
        <div class="table-wrap">
          <table>
            ...
            <tbody>
              ${n.filter(e=>l[e.id]!==void 0).map(e=>{let t=N(e),n=l[e.id]||0,r=t-n,i=colors.expense[e.category||`Other`]||`#94a3b8`;return`<tr>
                    ...
                    <td class="amount">${O(t)}</td>
                    <td class="amount">${O(n)}</td>
    ...
    `}let p=window.getLast6Months().map(e=>{let t=window.getMonthData(e);return{label:window.monthShortLabel(e),income:P(t.income),expenses:P(t.expenses),actual:Object.values(g.budget.actuals[e]||{}).reduce((e,t)=>e+t,0)}}),m=Math.max(...p.flatMap(e=>[e.income,e.expenses,e.actual]),1),h=524/p.length,_=h*.22,v=[0,.25,.5,.75,1].map(e=>{let t=148-e*136;return`<line x1="64" y1="${t}" x2="588" y2="${t}" stroke="#e2e8f0" stroke-width="1"/>
      <text x="59" y="${t+4}" text-anchor="end" font-size="9" fill="#94a3b8">${O(e*m)}</text>`}).join(``),y=p.map((e,t)=>{let n=64+t*h+h*.05,r=e.income>0?e.income/m*136:0,i=e.expenses>0?e.expenses/m*136:0,a=e.actual>0?e.actual/m*136:0,o=n+_+_/2+h*.04;return`
  ...
  `,document.getElementById(`money-content`).innerHTML=f}function Fi(){if(g.setupProgressDismissed)return``;let e=window.setupProgressTasks(),t=e.filter(e=>e.done),n=e.filter(e=>!e.done),r=t.length,i=e.length,a=Math.round(r/i*100);if(r===i)return`<div class="td-card td-card-win" style="display:flex;align-items:center;gap:12px;margin-bottom:10px">
    ...
    <svg class="brief-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
      ...
      <div style="flex:1;min-width:0;background:#F0FDF4;border-radius:var(--r-lg);padding:16px;display:flex;flex-direction:column;justify-content:space-between;min-height:140px;border:1px solid rgba(16,185,129,.18);box-shadow:0 1px 0 rgba(255,255,255,.9) inset">
      ...
      </div>`;u.push({type:`priority`,urgency:d.length>0?3:m?2:0,html:`<div style="display:flex;gap:12px;margin-bottom:12px">${t}${n}</div>`})}let h=o===`evening`||o===`night`?new Date(t.getTime()+864e5).toISOString().slice(0,10):i,_=h===i?`Today`:`Tomorrow`,v=Yt?Yt(h):[];if(v.length>0){let e=t.getHours()*60+t.getMinutes(),n=v.slice(0,4).map((t,n,r)=>{let a=t.allDay||!t.time?`All day`:Xt?Xt(t.time):t.time,o=Kt?Kt(t):``,s=Gt?Gt(t):{dot:`var(--iris-2)`},c=L?L[t.category]||L.other:{emoji:`📅`,label:``},l=t.time?parseInt(t.time.split(`:`)[0])*60+parseInt(t.time.split(`:`)[1]):-1,u=h===i&&l>=0&&e>=l&&e<l+90,d=n===Math.min(v.length,4)-1,f=c.color||`#f1f5f9`,p=c.text||`#475569`;return p.replace(/^#/,``),`<div class="pl-agenda-ev" style="margin-bottom:${d?`0`:`8px`}">
        <div class="pl-agenda-time-col">
        ...
        ${e}
      </div>`})}let ne=new Date(t.getTime()+7*864e5).toISOString().slice(0,10),re=(g.planner?.events||[]).filter(e=>e.date>i&&e.date<=ne).sort((e,t)=>e.date.localeCompare(t.date)).slice(0,3),j=(g.bills||[]).map(e=>({...e,days:n(e)})).filter(e=>e.days!==null&&e.days>2&&e.days<=7);if(re.length+j.length>0){let e=[...re.map(e=>{let t=new Date(e.date+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`short`,day:`numeric`,month:`short`}),n=!e.allDay&&e.time?Xt?Xt(e.time):e.time:``;return`<div class="td-up-row td-clickable" onclick="activateTab('planner');setTimeout(()=>_plannerOpenDetail&&_plannerOpenDetail('${e.id}'),120)">
        ...
        <div class="td-card-meta"><span class="td-meta-label">Coming up</span><span class="td-meta-count">${re.length+j.length}</span></div>
        <div class="td-up-list">${e}</div>
      </div>`})}let M=(g.kids?.profiles||[]).map(e=>{let t=(g.routineAssignments||[]).filter(t=>t.childId===e.id),n=0;return t.forEach(e=>{let t=(g.routines||[]).find(t=>t.id===e.routineId);if(t){let r=_assignmentStreak?_assignmentStreak(e,t.steps.length):0;r>n&&(n=r)}}),{kid:e,streak:n}}).filter(e=>e.streak>=3);if(M.length>0){let e=M[0];u.push({type:`win`,urgency:0,html:`<div class="td-card td-card-win">
      ...
      </div>`:``;u.push({type:`lists`,urgency:+(i>0),html:`<div style="display:flex;gap:12px;margin-bottom:12px">${o}${s}</div>`})}function ie(){let e={overnight:`Quiet night.`,morning:`Quiet day ahead.`,afternoon:`Quiet afternoon.`,evening:`Quiet evening.`,night:`Nothing pressing tonight.`},t=[];if(v.length>=3?t.push(`${v.length} things on the calendar.`):v.length===0&&f.length===0&&d.length===0&&t.push(e[o]||`Quiet day ahead.`),d.length>0){let e=d[0];t.push(`${e.name} ${e.days===0?`is due today`:`is due tomorrow`}.`)}return t.length===0&&t.push(e[o]||`Quiet day ahead.`),t.slice(0,2).join(` `)}let N=ie(),F={priority:0,schedule:1,money:2,lists:3,kids:4,slipping:5,upcoming:6,win:7};u.sort((e,t)=>(F[e.type]??9)-(F[t.type]??9));let ae=u.map(e=>e.html).join(``),oe=u.length<=1?`<div class="td-calm">You're sorted.<br>See you tomorrow.</div>`:``,se=typeof Fi==`function`?`<div id="setup-progress-card">${Fi()}</div>`:``;if(e.innerHTML=`
    ...
    <div class="td-greeting">
      ...
      <div class="td-greeting-brief">${T(N)}</div>
    </div>
  ...
  </div>`).join(``);typeof window.openModal==`function`&&window.openModal(`💡 Insights`,`<div style="padding:0 4px">${i}</div>`,null)}var Zi=``,Qi=``;async function $i(e,t,n,r,i){let a=I(`toto_ai_key`);if(!a)return;let o=new Date().toISOString().slice(0,10);if(Zi===o&&Qi){let e=document.getElementById(`today-briefing-text`);e&&(e.textContent=Qi);return}let s=e.filter(e=>e.cls===`red`).map(e=>e.title),c=e.filter(e=>e.cls===`amber`).map(e=>e.title),l=`You are Toto, a friendly family personal assistant app. Write a 2-sentence daily briefing for the user based on this context:

${[`Budget: ${O(Math.abs(t))} ${t>=0?`surplus`:`over budget`}, ${n} days left in the month`,`Health score: ${i.total}/100 (${i.grade})`,s.length?`Urgent: ${s.join(`, `)}`:``,c.length?`Coming up: ${c.join(`, `)}`:``,r.d?`Dinner tonight: ${r.d}`:`No dinner planned`,`${(g.goals||[]).filter(e=>e.status!==`achieved`).length} active goals`].filter(Boolean).join(`. `)}
...
- Don't start with "Here's" or "Today"`;try{let e=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":a,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:100,messages:[{role:`user`,content:l}]})});if(!e.ok)return;let t=(await e.json()).content[0].text.trim().replace(/^["']|["']$/g,``);Qi=t,Zi=o;let n=document.getElementById(`today-briefing-text`);n&&(n.textContent=t)}catch{}}function ea(){let e=g,r=e.buildContract,i=(e.netWorth.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),a=(e.netWorth.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),o=i-a,s=e.netWorth.snapshots||[],c=``;if(s.length>=2){let e=o-s[s.length-2].netWorth;c=`<span class="${e>=0?`up`:`dn`}">${e>=0?`+`:``}${fmtNW(e)}</span> vs last snapshot`}let l=window.selectedBudgetMonth,u=window.getMonthData(l),d=P(u.income),f=P(u.expenses),p=d-f,m=(e.subscriptions||[]).reduce((e,t)=>e+subMonthlyAmount(t),0),h=(e.bills||[]).filter(e=>{let t=n(e);return t>=0&&t<=31}).reduce((e,t)=>e+(parseFloat(t.amount)||0),0),_=[...e.bills||[]].filter(e=>n(e)>=-1).sort((e,t)=>n(e)-n(t)).slice(0,5),v=(e.goals||[]).filter(e=>e.status!==`achieved`).slice(0,4),y=r.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0),b=(r.variations||[]).filter(e=>e.status===`approved`).reduce((e,t)=>e+(t.amount||0),0),x=r.total+b,S=Math.round(y/x*100),C=r.stages.find(e=>!e.paid),w=((e.kids||{}).completions||[]).filter(e=>e.status===`pending`).length+((e.kids||{}).redemptions||[]).filter(e=>e.status===`pending`).length,E=window.getLast6Months(),D=P(u.expenses),ee=E.map(e=>{let t=Object.values(g.budget.actuals[e]||{}).reduce((e,t)=>e+t,0);return{label:window.monthShortLabel(e),budget:D,actual:t}}),te=D>0||ee.some(e=>e.actual>0),k=window.calcFinancialHealth(),A=251.3,ne=(k.total/100*A).toFixed(1),re=k.dimensions.map(e=>{let t=Math.round(e.score/e.max*100),n=t>=75?`#10b981`:t>=50?`#f59e0b`:`#ef4444`;return`
    ...
    <div class="db-widget" style="margin:0 24px 20px">
    ...
    </div>`,M=``;if(te){let e=Math.max(...ee.flatMap(e=>[e.budget,e.actual]),1),t=532/ee.length,n=t*.28,r=t*.04;M=`<div class="db-widget">
      <div class="db-widget-header">
      ...
      <div style="padding:12px 16px 8px">
        ...
        <text x="53" y="${n+4}" text-anchor="end" font-size="9" fill="#94a3b8">${O(t*e)}</text>`}).join(``)}${ee.map((i,a)=>{let o=58+a*t+t*.08,s=i.budget>0?i.budget/e*140:0,c=i.actual>0?i.actual/e*140:0,l=i.actual>i.budget?`#ef4444`:`#10b981`;return`<rect x="${o}" y="${150-s}" width="${n}" height="${s}" fill="#2563eb" opacity="0.65" rx="2"/>
    ...
    <div class="db-hero-row">
      <div class="db-nw-card" onclick="activateTab('networth')" style="cursor:pointer">
        ...
        <div style="font-size:12px;opacity:0.6;margin-top:12px">${O(i)} assets · ${O(a)} liabilities</div>
      </div>
      <div class="db-stats-col">
        <div class="db-stat">
          <div class="db-stat-val ${p>=0?`green`:`red`}">${O(Math.abs(p))}</div>
      ...
      <div>
        ...
        <div class="db-widget">
          ...
          ${_.length?_.map(e=>{let r=n(e),i=r<0?`<span class="bill-due-badge overdue">Overdue</span>`:r===0?`<span class="bill-due-badge today">Today</span>`:r<=7?`<span class="bill-due-badge soon">${r}d</span>`:`<span class="bill-due-badge ok">${t(e).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}</span>`;return`<div class="db-bill-row">
              ...
              ${i}
              <div class="db-bill-amount">${O(parseFloat(e.amount)||0)}</div>
        ...
        <div class="db-widget">
          ...
          ${v.length?v.map(e=>{let t=Math.min(Math.round((e.saved||0)/(e.target||1)*100),100);return`<div class="db-goal-row">
              <div class="db-goal-top">
                ...
                <span class="db-goal-pct">${O(e.saved||0)} of ${O(e.target||0)} · ${t}%</span>
              </div>
      ...
      <div>
        ...
        <div class="db-widget">
          ...
          <div class="db-budget-row">
            ...
            <span class="db-budget-val" style="color:#10b981">${O(d)}</span>
          </div>
          <div class="db-budget-row">
            <span class="db-budget-label">Expenses</span>
            <span class="db-budget-val" style="color:#ef4444">${O(f)}</span>
          </div>
          <div class="db-budget-row" style="border-top:2px solid var(--border)">
            ...
            <span class="db-budget-val" style="color:${p>=0?`#10b981`:`#ef4444`}">${O(Math.abs(p))}</span>
          </div>
        </div>
        ...
        <div class="db-widget">
          ...
          <div style="padding:14px 18px">
            <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:8px">
              <span style="font-weight:600">${O(y)} paid</span>
              <span style="color:#94a3b8">${S}% of ${O(x)}</span>
            </div>
            <div class="db-build-bar" style="margin:0 0 10px">
              <div class="db-build-fill" style="width:${S}%"></div>
            </div>
            ${C?`<div style="font-size:12px;color:#64748b">Next: <strong>${T(C.name)}</strong> — ${O(C.amount)}</div>`:`<div style="font-size:12px;color:#10b981;font-weight:600">✓ All stages paid</div>`}
          </div>
        </div>
      </div>
    </div>
    ...
    ${M}
  `;document.getElementById(`dashboard-content`).innerHTML=ie}function ta(){function e(e){return e.replace(/[^a-z0-9]/gi,`_`)}function t(t,n,r,i){let a=`${t}_${e(n)}`;return`
      <div class="color-row">
...
This cannot be undone. Are you sure?`)&&confirm(`Last chance. All data will be gone. Continue?`)){if(window._currentUser&&fbStore){let e=window._getHouseholdDocRef();e&&e.delete().catch(()=>{})}rt(window.STORAGE_KEY),window._secureClear(HOUSEHOLD_OWNER_KEY),window._fsUnsubscribe&&(window._fsUnsubscribe(),window._fsUnsubscribe=null),fbAuth.signOut().then(()=>{window.location.reload()})}}function ra(){let e=new Blob([JSON.stringify(g,null,2)],{type:`application/json`}),t=document.createElement(`a`);t.href=URL.createObjectURL(e),t.download=`home-budget-backup-${new Date().toISOString().slice(0,10)}.json`,t.click(),URL.revokeObjectURL(t.href)}function ia(e){let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target.result);if(!t.budget){alert(`Invalid backup file — missing budget data.`);return}if(!confirm(`This will replace ALL current data with the backup. Continue?`))return;nt(window.STORAGE_KEY,JSON.stringify(t)),location.reload()}catch(e){alert(`Failed to read backup file: `+e.message)}},n.readAsText(t)}function aa(e){let t=document.getElementById(`grp-body-${e}`),n=document.getElementById(`grp-arrow-${e}`);if(!t)return;let r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n&&(n.textContent=r?`▼`:`▲`)}function oa(e){window.budgetViewMode=e,renderBudget()}function sa(){let e=g.buildContract,t=e.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0);e.total-t;let n=e.stages.filter(e=>e.paid).length,r=e.stages.length,i=e.variations||[],a=i.filter(e=>e.status===`approved`).reduce((e,t)=>e+(t.amount||0),0),o=i.filter(e=>e.status===`pending`).reduce((e,t)=>e+(t.amount||0),0),s=e.total+a,c=`
    <div class="section" style="border-left:4px solid ${colors.build.contract}">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:1px;background:var(--border);border-bottom:1px solid var(--border)">
        <div style="background:var(--surface);padding:14px 20px">
          ...
          <div style="font-size:18px;font-weight:700">${O(e.total)}</div>
        </div>
        ${a===0?``:`
        <div style="background:var(--surface);padding:14px 20px">
          ...
          <div style="font-size:18px;font-weight:700;color:${a>0?`var(--danger)`:`var(--success)`}">${a>0?`+`:``}${O(a)}</div>
        </div>
        <div style="background:var(--surface);padding:14px 20px">
          ...
          <div style="font-size:18px;font-weight:700;color:var(--primary)">${O(s)}</div>
        </div>`}
        <div style="background:var(--surface);padding:14px 20px">
          ...
          <div style="font-size:18px;font-weight:700;color:var(--success)">${O(t)}</div>
        </div>
        <div style="background:var(--surface);padding:14px 20px">
          ...
          <div style="font-size:18px;font-weight:700;color:var(--danger)">${O(s-t)}</div>
        </div>
        ${o>0?`
        <div style="background:#fffbeb;padding:14px 20px">
          ...
          <div style="font-size:18px;font-weight:700;color:#d97706">+${O(o)}</div>
        </div>`:``}
      </div>
        ...
        <div style="display:flex;gap:0;position:relative">
          ${e.stages.map((t,n)=>{let r=(t.amount/e.total*100).toFixed(0),i=!t.paid&&e.stages.slice(0,n).every(e=>e.paid),a=t.paid?`#dcfce7`:i?`#dbeafe`:`var(--surface2)`,o=t.paid?`#16a34a`:i?`var(--primary)`:`var(--border)`,s=t.paid?`#15803d`:i?`var(--primary)`:`var(--text-muted)`,c=t.paid?`✓`:i?`→`:`${n+1}`,l=t.paid&&t.paidDate?A(t.paidDate):t.expectedDate?`Exp. `+A(t.expectedDate):``,u=!t.paid&&t.expectedDate&&isOverdue(t.expectedDate);return`
            <div style="flex:1;min-width:0;border:1px solid ${u?`var(--danger)`:o};border-radius:8px;padding:10px 10px 8px;margin-right:${n<e.stages.length-1?`6px`:`0`};background:${u?`#fef2f2`:a};cursor:pointer;position:relative" onclick="openEditStage(${t.id})" title="Edit ${E(t.name)}">
              ...
              <div style="font-size:12px;font-weight:700;color:${t.paid?`#15803d`:`var(--text)`}">${O(t.amount)}</div>
      ...
      <div class="section-header">
        <div>
          ...
          <div class="section-subtitle">
            ${i.length===0?`No variations yet`:`${i.filter(e=>e.status===`approved`).length} approved · ${i.filter(e=>e.status===`pending`).length} pending · ${a>=0?`+`:``}${O(a)} net impact`}
          </div>
        </div>
            ...
            <table>
              ...
              <tbody>
                ${i.map(e=>`<tr>
                  ...
                  <td class="amount" style="color:${(e.amount||0)<0?`var(--success)`:`var(--danger)`};font-weight:600">${e.amount>0?`+`:``}${O(e.amount)}</td>
              ...
              <tfoot>
                <tr style="background:var(--surface2);border-top:2px solid var(--border)">
                  ...
                  <td class="amount" style="padding:11px 16px;font-weight:700;color:${a>=0?`var(--danger)`:`var(--success)`}">${a>0?`+`:``}${O(a)}</td>
                  <td colspan="6" style="padding:11px 16px;font-size:12px;color:var(--text-muted)">Revised contract: <strong>${O(s)}</strong>${o>0?` · <span style="color:#d97706">+${O(o)} pending</span>`:``}</td>
                </tr>
              </tfoot>
            </table>
          </div>`}
  ...
  `;let u=g.extras,d=u.reduce((e,t)=>e+(t.totalAmount||0),0),f=u.reduce((e,t)=>e+(t.amountPaid||0),0);c+=`
    <div class="section" style="border-left:4px solid ${colors.build.extras}">
      <div class="section-header">
        ...
        <div style="display:flex;align-items:center;gap:10px">
          ${d>0?`<span class="contract-total-badge">${O(f)} / ${O(d)}</span>`:``}
        ...
        <table>
          ...
          <tbody>
            ${u.length===0?`<tr><td colspan="8"><div class="empty"><div class="empty-icon">📋</div>No items yet. Add landscaping, solar, or other extras.</div></td></tr>`:u.map(e=>{let t=(e.totalAmount||0)-(e.amountPaid||0),n={"not-quoted":`<span class="badge unpaid">Not Quoted</span>`,quoted:`<span class="badge pending">Quoted</span>`,approved:`<span class="badge" style="background:#ede9fe;color:#5b21b6">Approved</span>`,partial:`<span class="badge partial">Partially Paid</span>`,paid:`<span class="badge paid">Paid</span>`},r=e.dueDate&&isOverdue(e.dueDate)&&e.status!==`paid`,i=n[e.status||`not-quoted`]+(r?` <span class="badge overdue">Overdue</span>`:``);return`<tr>
                ...
                <td class="amount">${e.totalAmount?O(e.totalAmount):`<span class="amount muted">TBC</span>`}</td>
                <td class="amount">${O(e.amountPaid)}</td>
                <td class="amount ${t>0?``:`muted`}">${t>0?O(t):`—`}</td>
                <td>${A(e.dueDate)}</td>
                <td>${i}</td>
                <td>${fundingBadge(e.funding||`loan`)}</td>
                <td class="actions">
    ...
    <div class="section" style="border-left:4px solid ${colors.build.furniture}">
      <div class="section-header">
        <div>
          ...
          <div class="section-subtitle">${p.length} items · ${O(v)} purchased · ${O(y)} remaining</div>
        </div>
        <div style="display:flex;align-items:center;gap:8px">
          ${p.length>0?`
          <div style="display:flex;gap:6px">
        ...
        <table>
          ...
          <tbody>
            ${p.length===0?`<tr><td colspan="8"><div class="empty"><div class="empty-icon">🛋️</div>No furniture items yet. Add sofas, beds, appliances and more.</div></td></tr>`:p.map(e=>{let t={"to-purchase":`<span class="badge unpaid">To Purchase</span>`,ordered:`<span class="badge partial">Ordered</span>`,delivered:`<span class="badge paid">Delivered</span>`},n=e.deliveryDate&&e.status!==`delivered`&&isOverdue(e.deliveryDate);return`<tr>
                    ...
                    <td>${e.vendor?T(e.vendor):`<span style="color:var(--text-muted)">—</span>`}</td>
                    <td class="amount">${e.price?O(e.price):`<span class="amount muted">TBC</span>`}</td>
          ...
          <tfoot>
            <tr style="background:var(--surface2);border-top:2px solid var(--border)">
              ...
              <td class="amount" style="padding:11px 16px;font-weight:700">${O(m)}</td>
              <td colspan="4" style="padding:11px 16px;font-size:12px;color:var(--text-muted)">
                ${O(v)} purchased · ${O(y)} still to buy
              </td>
            </tr>
          </tfoot>`:``}
        </table>
  ...
  `;let b=g.appliances,x=b.reduce((e,t)=>e+(t.price||0),0),S=b.filter(e=>e.status===`delivered`||e.status===`ordered`),C=b.filter(e=>e.status===`to-purchase`),w=S.reduce((e,t)=>e+(t.price||0),0),D=C.reduce((e,t)=>e+(t.price||0),0);c+=`
    <div class="section" style="border-left:4px solid ${colors.build.appliances}">
      <div class="section-header">
        <div>
          <div class="section-title">Appliances</div>
          <div class="section-subtitle">${b.length} items · ${O(w)} purchased · ${O(D)} remaining</div>
        </div>
        <div style="display:flex;align-items:center;gap:8px">
          ${b.length>0?`
          <div style="display:flex;gap:6px">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tfoot>
            <tr style="background:var(--surface2);border-top:2px solid var(--border)">
              <td colspan="3" style="padding:11px 16px;font-size:13px;color:var(--text-muted);font-style:italic">Total</td>
              <td class="amount" style="padding:11px 16px;font-weight:700">${O(x)}</td>
              <td colspan="4" style="padding:11px 16px;font-size:12px;color:var(--text-muted)">
                ${O(w)} purchased · ${O(D)} still to buy
              </td>
            </tr>
          </tfoot>`:``}
        </table>
  ...
  `,document.getElementById(`build-content`).innerHTML=c}function ca(){return g.expenseCategories||DEFAULT_DATA.expenseCategories}function la(){return g.incomeCategories||DEFAULT_DATA.incomeCategories}function ua(e){if(e.type===`spending`){let t=Object.keys(g.budget.actuals).sort().reverse(),n=null;for(let r of t){let t=(window.getMonthData(r).expenses||[]).filter(t=>(t.category||`Other`)===e.category).reduce((e,t)=>e+(g.budget.actuals[r]?.[t.id]||0),0);if(t>0){n=t;break}}let r=e.targetMonthly||0;if(n===null)return{pct:null,label:`No actuals yet`,actual:null,target:r};let i=r>0?Math.max(0,Math.min(100,n/r*100)):0,a=n<=r;return{pct:i,label:`${O(n)} actual vs ${O(r)} limit`,actual:n,target:r,ok:a}}if(e.type===`savings`){let t=e.currentSaved||0,n=e.targetTotal||1;return{pct:Math.min(100,t/n*100),label:`${O(t)} of ${O(n)} saved`,ok:t>=n}}if(e.type===`income`){let t=monthlyTotal(window.getMonthData(window.selectedBudgetMonth).income),n=e.targetMonthly||1;return{pct:Math.min(100,t/n*100),label:`${O(t)}/mo of ${O(n)}/mo target`,ok:t>=n}}return{pct:0,label:``,ok:!1}}function da(){let e=g.goals,t=e.filter(e=>e.status===`active`),n=e.filter(e=>e.status===`achieved`),r=``;e.length>0&&(r+=`
    ...
    <button class="btn btn-primary" onclick="openAddGoal()">+ New Goal</button>
  </div>`,i.length===0){let e=window.getMonthData(window.selectedBudgetMonth),t=P(e.income)-P(e.expenses),n=t>0?`<div style="font-size:14px;color:#64748b;margin-bottom:4px">You have <strong style="color:#16a34a">${O(t)}</strong> surplus each month.</div>
      ...
      <div style="background:#fff;border:2px dashed #cbd5e1;border-radius:16px;padding:36px 24px;text-align:center;margin-top:8px">
        ...
        </div>`});document.getElementById(`goals-content`).innerHTML=r}function fa(e={}){let t=e.type||`spending`;return`
    <div class="form-group">
  ...
  `}function pa(){let e=document.getElementById(`f-goal-type`).value;document.getElementById(`goal-spending-fields`).style.display=e===`spending`?``:`none`,document.getElementById(`goal-savings-fields`).style.display=e===`savings`?``:`none`,document.getElementById(`goal-income-fields`).style.display=e===`income`?``:`none`}function ma(e){let t=document.getElementById(`f-goal-type`).value,n={id:e,name:document.getElementById(`f-goal-name`).value.trim(),type:t,status:document.getElementById(`f-goal-status`).value,deadline:document.getElementById(`f-goal-deadline`).value||null,notes:document.getElementById(`f-goal-notes`).value.trim()};return t===`spending`&&(n.category=document.getElementById(`f-goal-category`).value,n.targetMonthly=parseFloat(document.getElementById(`f-goal-target-monthly`).value)||0),t===`savings`&&(n.targetTotal=parseFloat(document.getElementById(`f-goal-target-total`).value)||0,n.currentSaved=parseFloat(document.getElementById(`f-goal-current-saved`).value)||0),t===`income`&&(n.targetMonthly=parseFloat(document.getElementById(`f-goal-target-monthly-inc`).value)||0),n}function ha(){window.openModal(`New Goal`,fa(),()=>{let e=ma(F(g.goals));e.name&&(g.goals.push(e),window.saveData(g),window.closeModal(),da())})}function ga(e){let t=g.goals.find(t=>t.id===e);window.openModal(`Edit Goal`,fa(t),()=>{Object.assign(t,ma(e)),window.saveData(g),window.closeModal(),da()})}function _a(e){confirm(`Delete this goal?`)&&(g.goals=g.goals.filter(t=>t.id!==e),window.saveData(g),da())}function va(e){let t=g.goals.find(t=>t.id===e);t&&(t.status=`achieved`,window.saveData(g),da())}var ya=null,ba=[{value:`add-income`,label:`Add income source`,icon:`💰`},{value:`remove-income`,label:`Remove income source`,icon:`➖`},{value:`reduce-income`,label:`Reduce income amount`,icon:`📉`},{value:`add-expense`,label:`Add new expense`,icon:`➕`},{value:`remove-expense`,label:`Remove expense`,icon:`✂️`},{value:`reduce-expense`,label:`Reduce expense amount`,icon:`📉`}];function xa(e){let t=window.getMonthData(window.selectedBudgetMonth),n=JSON.parse(JSON.stringify(t.income)),r=JSON.parse(JSON.stringify(t.expenses));return(e.adjustments||[]).forEach(e=>{if(e.type===`add-income`)n.push({id:-(e.id||0),name:e.name,amount:e.amount||0,frequency:e.frequency||`monthly`});else if(e.type===`remove-income`)n=n.filter(t=>t.id!==e.itemId);else if(e.type===`reduce-income`){let t=n.find(t=>t.id===e.itemId);t&&(t.amount=e.changeType===`percent`?Math.max(0,t.amount*(1-e.changeAmount/100)):Math.max(0,t.amount-(e.changeAmount||0)))}else if(e.type===`add-expense`)r.push({id:-(e.id||0),name:e.name,amount:e.amount||0,frequency:e.frequency||`monthly`,category:e.category||`Other`});else if(e.type===`remove-expense`)r=r.filter(t=>t.id!==e.itemId);else if(e.type===`reduce-expense`){let t=r.find(t=>t.id===e.itemId);t&&(t.amount=e.changeType===`percent`?Math.max(0,t.amount*(1-e.changeAmount/100)):Math.max(0,t.amount-(e.changeAmount||0)))}}),{income:n,expenses:r,totalIncome:P(n),totalExpenses:P(r),surplus:P(n)-P(r)}}function Sa(){let e=g.scenarios,t=window.getMonthData(window.selectedBudgetMonth),n=P(t.income),r=P(t.expenses),i=n-r,a=`<div style="display:flex;justify-content:flex-end;margin-bottom:16px">
    <button class="btn btn-primary" onclick="openAddScenario()">+ New Scenario</button>
  </div>`;e.length===0?a+=`<div class="empty"><div class="empty-icon">🔬</div>No scenarios yet. Create one to model income changes, expense cuts, or lifestyle adjustments.</div>`:e.forEach(e=>{let t=xa(e),o=t.totalIncome-n,s=t.totalExpenses-r,c=t.surplus-i,l=ya===e.id;a+=`
        <div class="scenario-card">
          <div class="scenario-card-header" onclick="toggleScenario(${e.id})">
            ...
            <div style="display:flex;align-items:center;gap:12px;flex-shrink:0">
              <div style="text-align:right">
                ...
                <div style="font-size:14px;font-weight:700;color:${c>=0?`var(--success)`:`var(--danger)`}">${c>=0?`+`:``}${O(c)}/mo</div>
              </div>
          ...
          <div class="scenario-card-body${l?` open`:``}">
            ...
            <div class="adj-list">
              ${(e.adjustments||[]).length===0?`<div style="font-size:13px;color:var(--text-muted);padding:8px 0">No adjustments yet. Add income or expense changes.</div>`:(e.adjustments||[]).map(t=>{let n=ba.find(e=>e.value===t.type)||ba[0],r=``;return t.type===`add-income`||t.type===`add-expense`?r=`${T(t.name)} · ${O(t.amount||0)}/${t.frequency||`mo`}${t.category?` · `+t.category:``}`:t.type===`remove-income`||t.type===`remove-expense`?r=T(t.itemName||`—`):(t.type===`reduce-income`||t.type===`reduce-expense`)&&(r=`${T(t.itemName)} · reduce by ${t.changeType===`percent`?t.changeAmount+`%`:O(t.changeAmount||0)}`),`<div class="adj-item">
            ...
            <div class="scenario-compare">
              <div class="compare-col">
                ...
                <div class="compare-row"><span>Monthly Income</span><span class="amount" style="color:var(--success)">${O(n)}</span></div>
                <div class="compare-row"><span>Monthly Expenses</span><span class="amount" style="color:var(--danger)">${O(r)}</span></div>
                <div class="compare-row"><span>Monthly Surplus</span><span class="amount" style="color:${i>=0?`var(--success)`:`var(--danger)`}">${O(i)}</span></div>
                <div class="compare-row"><span style="color:var(--text-muted);font-size:12px">Annual surplus</span><span style="color:var(--text-muted);font-size:12px">${O(i*12)}</span></div>
              </div>
              <div class="compare-col" style="border:2px solid var(--primary)">
                ...
                <div class="compare-row">
                  ...
                  <span class="amount" style="color:var(--success)">${O(t.totalIncome)} ${o===0?``:`<small style="color:${o>0?`var(--success)`:`var(--danger)`}">(${o>0?`+`:``}${O(o)})</small>`}</span>
                </div>
                <div class="compare-row">
                  <span>Monthly Expenses</span>
                  <span class="amount" style="color:var(--danger)">${O(t.totalExpenses)} ${s===0?``:`<small style="color:${s<0?`var(--success)`:`var(--danger)`}">(${s>0?`+`:``}${O(s)})</small>`}</span>
                </div>
                <div class="compare-row">
                  <span>Monthly Surplus</span>
                  <span class="amount" style="color:${t.surplus>=0?`var(--success)`:`var(--danger)`};font-weight:700">${O(t.surplus)}</span>
                </div>
                <div class="compare-row">
                  <span style="font-size:12px">Annual surplus</span>
                  <span style="font-size:12px;font-weight:600;color:${t.surplus>=0?`var(--success)`:`var(--danger)`}">${O(t.surplus*12)} ${c===0?``:`<small>(${c>0?`+`:``}${O(c*12)}/yr)</small>`}</span>
                </div>
              </div>
            </div>
          </div>
        </div>`}),document.getElementById(`scenarios-content`).innerHTML=a}function Ca(e){ya=ya===e?null:e,Sa()}function wa(e={}){return`
    <div class="form-group">
  ...
  `}function Ta(e,t={}){return{id:e,name:document.getElementById(`f-sc-name`).value.trim(),description:document.getElementById(`f-sc-desc`).value.trim(),adjustments:t.adjustments||[]}}function Ea(){window.openModal(`New Scenario`,wa(),()=>{let e=Ta(F(g.scenarios));e.name&&(g.scenarios.push(e),window.saveData(g),window.closeModal(),Sa())})}function Da(e){let t=g.scenarios.find(t=>t.id===e);window.openModal(`Edit Scenario`,wa(t),()=>{let n=Ta(e,t);Object.assign(t,n),window.saveData(g),window.closeModal(),Sa()})}function Oa(e){confirm(`Delete this scenario?`)&&(g.scenarios=g.scenarios.filter(t=>t.id!==e),ya===e&&(ya=null),window.saveData(g),Sa())}function ka(e){let t=window.getMonthData(window.selectedBudgetMonth),n=t.income.map(e=>`<option value="${e.id}">${T(e.name)} (${O(N(e))}/mo)</option>`).join(``),r=t.expenses.map(e=>`<option value="${e.id}">${T(e.name)} (${O(N(e))}/mo)</option>`).join(``);return`
    <div class="form-group">
      <label class="form-label">Adjustment Type</label>
      <select class="form-select" id="f-adj-type" onchange="toggleAdjFields()">
        ${ba.map(e=>`<option value="${e.value}">${e.icon} ${e.label}</option>`).join(``)}
      </select>
    </div>
  ...
  `}function Aa(){let e=document.getElementById(`f-adj-type`).value;document.getElementById(`adj-add-income`).style.display=e===`add-income`||e===`add-expense`?``:`none`,document.getElementById(`adj-add-income-extra`).style.display=e===`add-income`||e===`add-expense`?``:`none`,document.getElementById(`adj-cat-wrap`).style.display=e===`add-expense`?``:`none`,document.getElementById(`adj-remove-income`).style.display=e===`remove-income`?``:`none`,document.getElementById(`adj-reduce-income`).style.display=e===`reduce-income`?``:`none`,document.getElementById(`adj-remove-expense`).style.display=e===`remove-expense`?``:`none`,document.getElementById(`adj-reduce-expense`).style.display=e===`reduce-expense`?``:`none`}function ja(e){let t=g.scenarios.find(t=>t.id===e);t&&window.openModal(`Add Adjustment`,ka(t),()=>{let e=document.getElementById(`f-adj-type`).value,n=window.getMonthData(window.selectedBudgetMonth),r={id:F(t.adjustments||[]),type:e};if(e===`add-income`){if(r.name=document.getElementById(`f-adj-name`).value.trim(),r.amount=parseFloat(document.getElementById(`f-adj-amount`).value)||0,r.frequency=document.getElementById(`f-adj-freq`).value,!r.name)return}else if(e===`add-expense`){if(r.name=document.getElementById(`f-adj-name`).value.trim(),r.amount=parseFloat(document.getElementById(`f-adj-amount`).value)||0,r.frequency=document.getElementById(`f-adj-freq`).value,r.category=document.getElementById(`f-adj-cat`).value,!r.name)return}else if(e===`remove-income`){let e=document.getElementById(`f-adj-inc-sel`);r.itemId=parseInt(e.value),r.itemName=e.options[e.selectedIndex]?.text||``}else if(e===`reduce-income`){let e=document.getElementById(`f-adj-inc-reduce-sel`);r.itemId=parseInt(e.value),r.itemName=n.income.find(e=>e.id===r.itemId)?.name||``,r.changeAmount=parseFloat(document.getElementById(`f-adj-change-amount`).value)||0,r.changeType=document.getElementById(`f-adj-change-type-inc`).value}else if(e===`remove-expense`){let e=document.getElementById(`f-adj-exp-sel`);r.itemId=parseInt(e.value),r.itemName=e.options[e.selectedIndex]?.text||``}else if(e===`reduce-expense`){let e=document.getElementById(`f-adj-exp-reduce-sel`);r.itemId=parseInt(e.value),r.itemName=n.expenses.find(e=>e.id===r.itemId)?.name||``,r.changeAmount=parseFloat(document.getElementById(`f-adj-change-amount-exp`).value)||0,r.changeType=document.getElementById(`f-adj-change-type-exp`).value}t.adjustments||(t.adjustments=[]),t.adjustments.push(r),window.saveData(g),window.closeModal(),Sa()})}function Ma(e,t){let n=g.scenarios.find(t=>t.id===e);n&&(n.adjustments=(n.adjustments||[]).filter(e=>e.id!==t),window.saveData(g),Sa())}var Na=`home_finance_colors_v1`,Pa={expense:{"Mortgage / Rent":`#6366f1`,Insurance:`#8b5cf6`,Utilities:`#06b6d4`,Groceries:`#10b981`,Transport:`#f59e0b`,"Childcare / Education":`#3b82f6`,Health:`#ef4444`,Entertainment:`#f97316`,Subscriptions:`#84cc16`,"Dining Out":`#14b8a6`,Clothing:`#ec4899`,"Personal Care":`#a855f7`,"Savings / Investment":`#22c55e`,Other:`#94a3b8`},income:`#10b981`,build:{contract:`#3b82f6`,extras:`#f59e0b`,furniture:`#8b5cf6`,appliances:`#ef4444`}};function Fa(){try{let e=I(Na);if(!e)return JSON.parse(JSON.stringify(Pa));let t=JSON.parse(e);return t.expense||(t.expense={}),t.build||(t.build={}),t.income||(t.income=Pa.income),ca().forEach(e=>{t.expense[e]||(t.expense[e]=Pa.expense[e]||`#94a3b8`)}),Object.keys(Pa.build).forEach(e=>{t.build[e]||(t.build[e]=Pa.build[e])}),t}catch{return JSON.parse(JSON.stringify(Pa))}}function Ia(e){nt(Na,JSON.stringify(e))}var La=Fa();Object.defineProperty(window,`colors`,{get(){return La},set(e){La=e},configurable:!0});function Ra(e,t,n){e===`expense`?La.expense[t]=n:e===`income`?La.income=n:e===`build`&&(La.build[t]=n),Ia(La),renderBudget(),renderBuild(),renderDashboard()}function za(){return(g.householdProfile.members||[]).filter(e=>e.role===`adult`).length||1}function Ba(){return(g.householdProfile.members||[]).filter(e=>e.role===`child`).length}function Va(e){g.householdProfile.members.push({role:e||`adult`,age:null}),wo(),renderSettings()}function Ha(e){let t=g.householdProfile.members[e];if(!t)return;let n=t.name||(t.role===`child`?`this child`:`this adult`);if(confirm(`Remove ${n} from the household?\n\nThis cannot be undone.`)){if(t.role===`child`&&t.name){let e=(g.kids?.profiles||[]).find(e=>e.name===t.name);e&&(g.kids.profiles=g.kids.profiles.filter(t=>t.id!==e.id),g.kids.chores=g.kids.chores.filter(t=>t.assignedTo!==e.id),g.kids.completions=g.kids.completions.filter(t=>t.kidId!==e.id),g.kids.redemptions=g.kids.redemptions.filter(t=>t.kidId!==e.id),g.meals?.lunchbox?.profiles&&(g.meals.lunchbox.profiles=g.meals.lunchbox.profiles.filter(t=>t.id!==e.id)),String(window.getDeviceProfile())===String(e.id)&&window.setDeviceProfile(`adult`))}g.householdProfile.members.splice(e,1),window.saveData(g),window.renderAll()}}function Ua(e,t,n){let r=g.householdProfile.members[e];r&&(r[t]=n,wo(),(t===`role`||t===`name`)&&renderSettings())}function Wa(e){g.householdProfile.pets.push({type:e||`dog`,name:``}),wo(),renderSettings()}function Ga(e){g.householdProfile.pets.splice(e,1),wo(),renderSettings()}function Ka(e,t,n){let r=g.householdProfile.pets[e];r&&(r[t]=n,wo())}function qa(e){g.householdProfile.cars=e,wo()}function Ja(e,t,n){let r=t+n;return[{category:`Mortgage / Rent`,min:e*.2,max:e*.3,label:`20–30% of income`,source:`ABS / MoneySmart`,needs:!0},{category:`Groceries`,min:380+(t-1)*260+n*160,max:560+(t-1)*360+n*220,label:`$${Math.round(380+(t-1)*260+n*160)}–$${Math.round(560+(t-1)*360+n*220)}/month for ${r} ${r===1?`person`:`people`}`,source:`ABS HES 2022`,needs:!0},{category:`Transport`,min:e*.08,max:e*.15,label:`8–15% of income`,source:`ABS HES 2022`,needs:!0},{category:`Utilities`,min:180+t*25+n*15,max:360+t*40+n*25,label:`$${Math.round(180+t*25+n*15)}–$${Math.round(360+t*40+n*25)}/month`,source:`AER / ABS`,needs:!0},{category:`Insurance`,min:180+t*40+n*20,max:420+t*60+n*30,label:`$${Math.round(180+t*40+n*20)}–$${Math.round(420+t*60+n*30)}/month`,source:`APRA industry avg`,needs:!0},{category:`Health`,min:60*t+30*n,max:180*t+60*n,label:`$${60*t+30*n}–$${180*t+60*n}/month`,source:`AIHW / ABS`,needs:!0},...n>0?[{category:`Childcare / Education`,min:700*n,max:2200*n,label:`$700–$2,200/month per child (before subsidies)`,source:`ACCC Childcare Report`,needs:!0}]:[],{category:`Dining Out`,min:e*.02,max:e*.05,label:`2–5% of income`,source:`MoneySmart`,needs:!1},{category:`Entertainment`,min:e*.02,max:e*.05,label:`2–5% of income`,source:`MoneySmart`,needs:!1},{category:`Subscriptions`,min:30,max:120,label:`$30–$120/month`,source:`Industry average`,needs:!1},{category:`Clothing`,min:50*t+30*n,max:150*t+80*n,label:`$${50*t+30*n}–$${150*t+80*n}/month`,source:`ABS HES 2022`,needs:!1},{category:`Savings / Investment`,min:e*.1,max:e*.2,label:`10–20% of income (aim for 20%)`,source:`50/30/20 rule`,needs:!1}]}function Ya(e,t,n){return e<t*.9?`under`:e>n*1.1?`over`:`within`}var Xa=`home_finance_ai_key`;function Za(){return I(`home_finance_ai_key`)||``}function Qa(e){nt(Xa,e)}function $a(){let e=window.getLast6Months(),t={};return e.forEach(e=>{let n=window.getMonthData(e),r={},i={};n.expenses.forEach(t=>{let n=t.category||`Other`;r[n]=(r[n]||0)+N(t);let a=window.getActual(t.id,e);a>0&&(i[n]=(i[n]||0)+a)}),new Set([...Object.keys(r),...Object.keys(i)]).forEach(n=>{t[n]||(t[n]=[]),t[n].push({mo:e,budget:r[n]||0,actual:i[n]||0,hasActual:(i[n]||0)>0})})}),t}function eo(e){let t=[];return Object.entries(e).forEach(([e,n])=>{let r=n.filter(e=>e.hasActual);if(r.length<2)return;let i=r.filter(e=>e.budget>0&&e.actual>e.budget*1.05).length,a=r.filter(e=>e.budget>0&&e.actual<e.budget*.92).length,o=r.reduce((e,t)=>e+(t.actual-t.budget),0)/r.length,s=n.slice(-3).filter(e=>e.hasActual),c=n.slice(0,3).filter(e=>e.hasActual),l=s.length?s.reduce((e,t)=>e+t.actual,0)/s.length:0,u=c.length?c.reduce((e,t)=>e+t.actual,0)/c.length:0,d=u>50?(l-u)/u:0;i>=3&&o>20?t.push({cat:e,level:`warning`,icon:`⚠️`,title:`Consistently over on ${e}`,body:`Over budget ${i}/${r.length} months, avg +${O(Math.abs(o))}/mo. Consider raising the budget or cutting back.`,months:r}):a>=4&&n[n.length-1]?.budget>0?t.push({cat:e,level:`good`,icon:`✅`,title:`Consistently under on ${e}`,body:`Under budget ${a}/${r.length} months, avg ${O(Math.abs(o))}/mo less. You may be able to reallocate this budget elsewhere.`,months:r}):d>.25&&l>50?t.push({cat:e,level:`warning`,icon:`📈`,title:`${e} trending up`,body:`Spending up ${Math.round(d*100)}% over recent months — now averaging ${O(l)}/mo. Worth keeping an eye on.`,months:r}):d<-.25&&u>50&&t.push({cat:e,level:`good`,icon:`📉`,title:`${e} trending down`,body:`Down ${Math.round(Math.abs(d)*100)}% recently — now ${O(l)}/mo. Nice improvement.`,months:r})}),t.sort((e,t)=>[`warning`,`alert`,`good`,`info`].indexOf(e.level)-[`warning`,`alert`,`good`,`info`].indexOf(t.level)).slice(0,6)}function to(){let e=window.getMonthData(window.selectedBudgetMonth);if(e.expenses.length===0)return``;let t={};e.expenses.forEach(e=>{let n=e.category||`Other`;t[n]||(t[n]={budget:0,actual:0}),t[n].budget+=N(e),t[n].actual+=window.getActual(e.id,window.selectedBudgetMonth)});let n=Object.entries(t).filter(([,e])=>e.budget>0||e.actual>0).sort((e,t)=>Math.max(t[1].budget,t[1].actual)-Math.max(e[1].budget,e[1].actual));if(!n.length)return``;let r=Math.max(...n.flatMap(([,e])=>[e.budget,e.actual]),1),i=n.map(([e,t])=>{let n=t.actual>0,i=(t.budget/r*100).toFixed(1),a=(t.actual/r*100).toFixed(1),o=t.actual-t.budget,s=n?o>5?`over`:o<-5?`under`:``:``,c=n?o>5?`<span class="spi-over">+${O(o)}</span>`:o<-5?`<span class="spi-under">${O(o)}</span>`:`<span class="spi-on">on track</span>`:`<span class="spi-no-actual">no actuals</span>`;return`<div class="spi-cat-row">
      ...
      <div class="spi-cat-amounts"><span>${O(t.budget)}</span>${c}</div>
    ...
    ${i}
  </div>`}function no(){let e=eo($a()),t=to(),n={warning:{bg:`#fffbeb`,border:`#fcd34d`,title:`#92400e`},good:{bg:`#ecfeff`,border:`#86efac`,title:`#166534`},alert:{bg:`#fef2f2`,border:`#fca5a5`,title:`#991b1b`},info:{bg:`#f8fafc`,border:`#cbd5e1`,title:`#475569`}};return`<div class="spi-section">
  ...
  </div>`}function ro(){let e=window.getMonthData(window.selectedBudgetMonth),t=P(e.income),n=P(e.expenses),r=t-n,i=t>0?r/t*100:0,a={};e.expenses.forEach(e=>{let t=e.category||`Other`;a[t]=(a[t]||0)+N(e)});let o=Object.entries(a).sort((e,t)=>t[1]-e[1]),s=window.getLast6Months(),c=s.reduce((e,t)=>e+P(window.getMonthData(t).expenses),0)/6;s.reduce((e,t)=>e+P(window.getMonthData(t).income),0)/6;let l=[];if(i>=20?l.push({level:`good`,icon:`🌟`,title:`Excellent savings rate`,body:`You're saving ${Math.round(i)}% of income — above the recommended 20%. Keep it up and consider putting the surplus toward your goals.`}):i>=10?l.push({level:`ok`,icon:`📈`,title:`Decent savings rate`,body:`You're saving ${Math.round(i)}% of income. Pushing to 20% would mean an extra ${O(t*.2-r)}/month going toward your future.`}):i>0?l.push({level:`warning`,icon:`⚠️`,title:`Low savings rate`,body:`Only ${Math.round(i)}% of income is being saved (${O(r)}/month). Look for the biggest discretionary expense you can reduce.`}):t>0&&l.push({level:`alert`,icon:`🚨`,title:`Spending exceeds income`,body:`You're spending ${O(Math.abs(r))} more than you earn each month. This requires urgent attention — identify what can be cut immediately.`}),c>0){let e=n-c,t=Math.round(Math.abs(e)/c*100);e>c*.1?l.push({level:`warning`,icon:`📊`,title:`Expenses above your average`,body:`This month's expenses are ${t}% above your 6-month average (${O(c)}). The extra ${O(e)} could be a one-off — worth reviewing.`}):e<-c*.08&&c>0&&l.push({level:`good`,icon:`📊`,title:`Expenses below your average`,body:`Nice — this month you spent ${t}% less than your 6-month average. That's ${O(Math.abs(e))} extra in your pocket.`})}if(o.length>0){let[e,t]=o[0],r=n>0?Math.round(t/n*100):0;r>45&&e!==`Mortgage / Rent`&&l.push({level:`warning`,icon:`💸`,title:`${e} is dominating your budget`,body:`${e} makes up ${r}% of your total expenses (${O(t)}/month). Reducing this by 20% would save ${O(t*.2)}/month.`})}let u=a[`Dining Out`]||0;u>0&&n>0&&u/n>.08&&l.push({level:`ok`,icon:`🍽️`,title:`Dining out is notable`,body:`You're spending ${O(u)}/month dining out. Cooking at home 2–3 more times a week could save ${O(u*.35)}/month.`}),e.income.length===1&&t>0&&l.push({level:`info`,icon:`💡`,title:`Single income source`,body:`You rely on one income stream. Even a small side income (freelance, rental, etc.) would significantly improve your financial resilience.`});let d=g.buildContract.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0),f=g.buildContract.total-d;if(f>0&&r>0){let e=Math.round(f/r);l.push({level:`info`,icon:`🏗️`,title:`Build payments still ahead`,body:`You have ${O(f)} left in contract payments. At your current savings rate that represents ${e} month${e===1?``:`s`} of surplus — plan accordingly.`})}let p=(g.goals||[]).filter(e=>!e.achieved);return p.length>0&&r>0&&l.push({level:`good`,icon:`🎯`,title:`${p.length} active goal${p.length>1?`s`:``}`,body:`Your ${O(r)}/month surplus can work toward your goals. Review the Goals page to see progress and adjust contributions.`}),e.expenses.length===0&&l.push({level:`info`,icon:`📝`,title:`Add your expenses`,body:`Head to Monthly Budget and add your regular expenses to unlock personalised insights.`}),l}var io=`https://home-finance-proxy.fuscocl.workers.dev`;async function ao(){let e=document.getElementById(`ai-run-btn`);e.disabled=!0,e.textContent=`Analysing…`;let t=window.getMonthData(window.selectedBudgetMonth),n=P(t.income),r=P(t.expenses),i=n-r,a=n>0?Math.round(i/n*100):0,o={};t.expenses.forEach(e=>{o[e.category||`Other`]=(o[e.category||`Other`]||0)+N(e)});let s=window.getLast6Months().map(e=>{let t=window.getMonthData(e);return{month:e,income:P(t.income),expenses:P(t.expenses)}}),c=Ja(n,za(),Ba()).filter(e=>o[e.category]!==void 0).map(e=>({category:e.category,yourSpend:Math.round(o[e.category]||0),benchmarkMin:Math.round(e.min),benchmarkMax:Math.round(e.max),benchmarkLabel:e.label,status:Ya(o[e.category]||0,e.min,e.max)})),l={month:window.monthLabel(window.selectedBudgetMonth),household:(function(){let e=g.householdProfile||{},t=e.members||[],n=t.filter(e=>e.role===`adult`),r=t.filter(e=>e.role===`child`);return{adults:n.length||2,children:r.length,totalPeople:t.length||2,memberAges:t.map(e=>({role:e.role,age:e.age})),pets:(e.pets||[]).map(e=>e.type),cars:e.cars||0}})(),monthlyIncome:n,monthlyExpenses:r,surplus:i,savingsRatePct:a,expensesByCategory:o,benchmarkComparisons:c,incomeStreams:t.income.map(e=>({name:e.name,monthlyAmount:N(e)})),last6MonthsTrend:s,activeGoals:(g.goals||[]).filter(e=>!e.achieved).map(e=>({name:e.name,type:e.type})),buildRemaining:g.buildContract.total-g.buildContract.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0),currency:`AUD`},u=`You are a friendly but direct personal finance advisor for an Australian family. Analyse their budget data and benchmark comparisons, then give 4-6 concise, specific, actionable insights.
...
Reply with ONLY the JSON array, no other text.`;try{let e=await fetch(io,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:u}]})});if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(t.error?.message||`API error ${e.status}`)}let t=(await e.json()).content[0].text.trim();t=t.replace(/^```[a-z]*\n?/i,``).replace(/\n?```$/,``).trim(),oo(JSON.parse(t),!0)}catch(e){let t=e.message;(t.includes(`Failed to fetch`)||t.includes(`NetworkError`)||t.includes(`CORS`))&&(t=`CORS blocked — the browser can't call the Anthropic API directly. We need a small proxy (Cloudflare Worker). Ask me to set it up — it takes 5 minutes and is free.`),document.getElementById(`ai-output`).innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:12px">
      ...
      </div>`}let h=i.filter(e=>r[e.category]!==void 0||e.category===`Savings / Investment`).map(e=>{let t=r[e.category]||0,n=Ya(t,e.min,e.max),i=n===`under`?`#3b82f6`:n===`within`?`#10b981`:`#ef4444`,a=n===`under`?`Below avg`:n===`within`?`On track`:`Above avg`,o=e.max>0?Math.min(t/(e.max*1.5)*100,100):0,s=e.max>0?Math.min(e.max/(e.max*1.5)*100,100):0;return`
      <tr>
        <td style="border-left:3px solid ${La.expense[e.category]||`#94a3b8`};font-weight:500">${e.category}</td>
        <td class="amount" style="font-weight:600">${t>0?O(t):`<span style="color:var(--text-muted)">—</span>`}</td>
          ...
          <div style="display:flex;gap:16px;flex-wrap:wrap">
            ${[{label:`Needs`,pct:d,target:50,amt:c,color:`#3b82f6`},{label:`Wants`,pct:f,target:30,amt:l,color:`#f59e0b`},{label:`Saving`,pct:p,target:20,amt:u,color:`#10b981`}].map(e=>`
              <div style="text-align:center;min-width:70px">
                ...
                <div style="font-size:11px;color:var(--text-muted)">${O(e.amt)}</div>
              </div>`).join(``)}
          </div>
        </div>
      </div>
    ...
    </div>`}function co(){Za();let e=ro(),t=window.getMonthData(window.selectedBudgetMonth),n=P(t.income),r=P(t.expenses),i=n-r,a=n>0?Math.round(i/n*100):0,o=za(),s=Ba(),c={};t.expenses.forEach(e=>{let t=e.category||`Other`;c[t]=(c[t]||0)+N(e)});let l=0;a>=20?l+=40:a>=10?l+=28:a>0&&(l+=14),t.income.length>1&&(l+=10),(g.goals||[]).some(e=>!e.achieved)&&(l+=15),g.buildContract.stages.filter(e=>e.paid).reduce((e,t)=>e+t.amount,0)>0&&(l+=10),r>0&&r<n&&(l+=25);let u=l>=70?`#10b981`:l>=45?`#f59e0b`:`#ef4444`,d=l>=70?`Great shape`:l>=45?`On track`:`Needs attention`;document.getElementById(`insights-content`).innerHTML=`
    ...
    <div class="cards" style="margin-bottom:24px">
      ...
      <div class="card">
        ...
        <div class="card-sub">${O(Math.max(i,0))}/month saved</div>
      </div>
      <div class="card">
        <div class="card-label">Monthly Surplus</div>
        <div class="card-value ${i>=0?`green`:`red`}">${O(Math.abs(i))}</div>
        <div class="card-sub">${i>=0?`available`:`overspending`}</div>
      </div>
      <div class="card">
        <div class="card-label">Income / Expenses</div>
        <div class="card-value">${O(n)}</div>
        <div class="card-sub">vs ${O(r)} out</div>
      </div>
    </div>
  ...
  `}function lo(e){let t={good:{bg:`#ecfeff`,border:`#86efac`,text:`#166534`},ok:{bg:`#eff6ff`,border:`#93c5fd`,text:`#1e40af`},warning:{bg:`#fffbeb`,border:`#fcd34d`,text:`#92400e`},alert:{bg:`#fef2f2`,border:`#fca5a5`,text:`#991b1b`},info:{bg:`#f8fafc`,border:`#cbd5e1`,text:`#475569`}};return e.map(e=>{let n=t[e.level]||t.info;return`
      ...
      </div>`}).join(``)}function uo(){let[e,t]=window.selectedBudgetMonth.split(`-`).map(Number),n=new Date(e,t-2,1);window.selectedBudgetMonth=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,window.safeRender(co),window.safeRender(renderMoneyDashboard),window.safeRender(renderBudget)}function fo(){let[e,t]=window.selectedBudgetMonth.split(`-`).map(Number),n=new Date(e,t,1);window.selectedBudgetMonth=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,window.safeRender(co),window.safeRender(renderMoneyDashboard),window.safeRender(renderBudget)}var po=`🏠.🏡.🏗️.🔑.💡.🔌.🚿.🛋️.🛏️.🪴.🍽️.🍕.🍔.🛒.🥗.🍷.☕.🍰.🥩.🧃.🚗.🚙.🚌.✈️.⛽.🚕.🏎️.🚲.🛵.🚂.👨‍👩‍👧.👶.📚.🏫.💊.🏥.💅.💆.🧴.👕.🎮.🎬.🎵.🏋️.📺.🎲.🏄.🎯.🎨.🎭.💰.💳.🏦.📈.💸.🪙.💎.📊.🏆.💼.📦.🛍️.🎁.🔧.🛠️.📱.💻.🧹.🧺.🖨️.🐕.🐈.🐠.🌱.☀️.❄️.🎄.🎂.⚽.🧸`.split(`.`);function mo(e,t){let n=document.createElement(`div`);n.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.45);z-index:9999;display:flex;align-items:center;justify-content:center`,n.innerHTML=`
  ...
  `,document.body.appendChild(n),n.querySelector(`#emoji-picker-close`).onclick=()=>document.body.removeChild(n),n.querySelectorAll(`[data-emoji]`).forEach(e=>{e.onclick=()=>{t(e.dataset.emoji),document.body.removeChild(n)}}),n.addEventListener(`click`,e=>{e.target===n&&document.body.removeChild(n)})}function ho(){window.openModal(`Add Category Group`,`
    <div class="form-row">
  ...
  `,()=>{let e=document.getElementById(`f-grp-icon`).value||`📦`,t=document.getElementById(`f-grp-name`).value.trim();if(!t)return;let n=F(g.categoryGroups);g.categoryGroups.push({id:n,name:t,icon:e,categories:[]}),window.logActivity(`Added category group`,t),window.saveData(g),window.closeModal(),renderSettings()}),document.getElementById(`f-grp-icon-btn`).addEventListener(`click`,()=>{let e=document.getElementById(`f-grp-icon`).value;mo(e,e=>{document.getElementById(`f-grp-icon`).value=e,document.getElementById(`f-grp-icon-btn`).textContent=e})})}function go(e){let t=g.categoryGroups.find(t=>t.id===e);t&&mo(t.icon,t=>{vo(e,`icon`,t);let n=document.getElementById(`grp-icon-btn-${e}`);n&&(n.textContent=t)})}function _o(e){let t=g.categoryGroups.find(t=>t.id===e);confirm(`Delete group "${t?t.name:``}"? Categories will become unassigned.`)&&(g.categoryGroups=g.categoryGroups.filter(t=>t.id!==e),window.logActivity(`Deleted category group`,t?t.name:``),window.saveData(g),renderSettings())}function vo(e,t,n){let r=g.categoryGroups.find(t=>t.id===e);r&&(r[t]=n,window.saveData(g))}function yo(e,t){if(!t)return;ca().includes(t)||(g.expenseCategories||(g.expenseCategories=ca().slice()),g.expenseCategories.push(t)),g.categoryGroups.forEach(e=>{e.categories=e.categories.filter(e=>e!==t)});let n=g.categoryGroups.find(t=>t.id===e);n&&n.categories.push(t),window.saveData(g),renderSettings()}function bo(e){let t=ca(),n=new Set((g.categoryGroups||[]).filter(t=>t.id!==e).flatMap(e=>e.categories)),r=g.categoryGroups.find(t=>t.id===e),i=new Set(r?r.categories:[]),a=t.filter(e=>!i.has(e)&&!n.has(e));window.openModal(`Add Category to Group`,`
    ${a.length>0?`
  ...
  `,()=>{let t=document.getElementById(`f-cat-selected`).value,n=document.getElementById(`f-cat-new`).value.trim()||t;n&&(yo(e,n),window.closeModal())})}function xo(e,t){let n=g.categoryGroups.find(t=>t.id===e);n&&(n.categories=n.categories.filter(e=>e!==t),window.saveData(g),renderSettings())}var So=!1,Co=null;function wo(){So||(Co=JSON.parse(JSON.stringify(g))),So=!0;let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`flex`)}function To(){So=!1,Co=null,window.saveData(g);let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`none`);let t=document.getElementById(`settings-save-btn`);if(t){let e=t.textContent;t.textContent=`Saved`,t.style.background=`#10b981`,setTimeout(()=>{t.textContent=e,t.style.background=``},1500)}window.renderAll()}function Eo(){Co&&Object.assign(g,Co),So=!1,Co=null;let e=document.getElementById(`settings-save-bar`);e&&(e.style.display=`none`),renderSettings()}function Do(e){So&&(confirm(`You have unsaved changes in Settings. Save before leaving?`)?To():Eo())}function Oo(e,t){g.settings||(g.settings={}),g.settings[e]=t,wo()}function ko(){let e=document.getElementById(`settings-api-key`)?.value.trim();if(!e)return;nt(`toto_ai_key`,e),nt(`toto_ai_key_meta`,JSON.stringify({addedAt:new Date().toISOString(),prefix:e.slice(0,10),suffix:e.slice(-4)}));let t=document.getElementById(`api-key-status`);t&&(t.textContent=`✓ Key saved!`,t.style.color=`var(--success)`,setTimeout(()=>{t.textContent=``,t.style.color=``},2e3));let n=document.getElementById(`api-key-summary`);n&&(n.outerHTML=jo())}function Ao(){confirm(`Remove saved API key? Toto and cost estimation will stop working.`)&&(rt(`toto_ai_key`),rt(`toto_ai_key_meta`),renderSettings())}function jo(){let e=I(`toto_ai_key`);if(!e)return`<div id="api-key-summary"></div>`;let t=JSON.parse(I(`toto_ai_key_meta`)||`{}`),n=t.addedAt?new Date(t.addedAt).toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`,year:`numeric`}):`Unknown date`;return`
    ...
    <div style="background:var(--surface);border:1px solid ${d?`var(--danger)`:`var(--border)`};border-radius:10px;overflow:hidden">
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;padding:11px 14px;cursor:pointer;user-select:none;background:${p}22;border-bottom:3px solid ${p}" onclick="toggleGroupExpand('${t.id}')">
        ...
        <div style="display:flex;align-items:center;gap:10px">
          <span style="font-weight:700;font-size:14px">${O(i)}<span style="font-size:11px;font-weight:400;color:var(--text-muted)">/mo</span></span>
      ...
      <div style="padding:12px 14px;background:var(--surface2);border-top:1px solid var(--border)">
        ...
        <div style="display:flex;justify-content:space-between;font-size:12px">
          <span style="color:${u?l:`var(--text-muted)`}">
            ${u?`${O(a)} spent · ${s}%${d?` — over budget!`:``}`:`No actuals entered yet`}
          </span>
          <span style="color:var(--text-muted)">${O(i)} budgeted</span>
        </div>
      </div>
      ...
      <div id="grp-body-${t.id}" style="border-top:1px solid var(--border)">
        ...
        ${r.map(e=>{let t=N(e),r=window.getActual(e.id,window.selectedBudgetMonth),i=t>0?Math.min(100,Math.round(r/t*100)):0,a=n[e.category||`Other`]||window.colors.expense[e.category||`Other`]||`#94a3b8`,o=r>t&&r>0,s=o?`var(--danger)`:i>=80?`var(--warning)`:r>0?a:`var(--border)`;return r>0?`${O(r)}${O(t)}${i}`:`${O(t)}`,`
          <div class="expense-row" style="--row-color:${a};display:flex;align-items:center;gap:10px;padding:10px 14px;border-bottom:1px solid var(--border)">
            ...
            <div style="flex:1;min-width:0;cursor:pointer" onclick="event.stopPropagation();openEditExpense(${e.id})">
              ...
              <div style="font-size:11px;color:var(--text-muted)">${e.category||`Other`}${e.vendor?` · ${T(e.vendor)}`:``} · ${M(e)}</div>
            </div>
            <div style="text-align:right;flex-shrink:0;margin-right:4px">
              <div style="font-size:13px;font-weight:600">${O(t)}/mo</div>
              ${r>0?`<div style="font-size:11px;font-weight:600;color:${o?`var(--danger)`:i>=80?`var(--warning)`:`var(--success)`}">${O(r)} actual${o?` ▲`:``}</div>`:`<div style="font-size:11px;color:var(--text-muted);cursor:pointer" onclick="event.stopPropagation();window.editActual(${e.id})">+ add actual</div>`}
            </div>
    ...
    <div class="summary-hero" onclick="toggleBudgetDetail()">
      ...
      <div class="summary-hero-num">${O(Math.abs(i))}</div>
      <div class="summary-hero-sub">${O(n)} income · ${O(r)} expenses</div>
      <div class="summary-hero-expand" id="budget-expand-label">${Ho?`Hide details ▲`:`See breakdown ▼`}</div>
    </div>`,d+=`
    <div class="summary-mini-grid">
      <div class="summary-mini">
        <div class="summary-mini-num" style="color:#10b981">${O(n)}</div>
        <div class="summary-mini-label">Income</div>
      </div>
      <div class="summary-mini">
        <div class="summary-mini-num">${O(r)}</div>
        <div class="summary-mini-label">Budgeted</div>
      </div>
      <div class="summary-mini">
        <div class="summary-mini-num" style="color:${a>r?`#ef4444`:`#18181b`}">${O(a)}</div>
    ...
    </div>`;let f=Lo({income:e,expenses:t});if(f.segments.length){let e=f.segments.map(e=>`<div style="background:${e.color};flex:${e.pct.toFixed(2)}"></div>`).join(``);f.segments.map(e=>`<div class="alloc-row">
        <div class="tdot" style="background:${e.color}"><svg viewBox="0 0 24 24"><use href="#${Bo(e.name)}"/></svg></div>
        <div class="body">
          <div class="ticker">${zo(e.name)}</div>
          <div class="name">${T(e.name)}</div>
        </div>
        <div>
          <div class="pct">${Math.round(e.pct)}%</div>
          <div class="amt">${O(e.amount)}</div>
        </div>
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;cursor:pointer;user-select:none;margin-bottom:${Ho?`16px`:`0`}" onclick="toggleBudgetDetail()">
    ...
    <div class="section" style="margin-bottom:20px">
      <div class="section-header">
        <div>
          <div class="section-title">Income</div>
          <div class="section-subtitle">${O(n)}/mo total</div>
        </div>
        ...
        <table>
          ...
          <tbody>
            ${e.length===0?`<tr><td colspan="6"><div class="empty"><div class="empty-icon">💵</div>Add your income sources</div></td></tr>`:e.map(e=>{let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():`<span style="color:var(--text-muted)">—</span>`,n=e.recurring===!1?`<span style="font-size:10px;font-weight:600;padding:1px 6px;border-radius:99px;background:#fef9c3;color:#854d0e;border:1px solid #fde047;margin-left:6px;white-space:nowrap">one-time</span>`:``;return`<tr>
              ...
              <td class="amount">${te(e.amount)}</td>
              <td>${t}</td>
              <td style="color:var(--text-muted)">${M(e)}</td>
              <td class="amount" style="color:var(--success)">${O(N(e))}/mo</td>
              <td class="actions">
  ...
  `;let p=[`all`,...Array.from(new Set(t.map(e=>e.category||`Other`))).sort()],m=window.expenseFilterCat===`all`?t:t.filter(e=>(e.category||`Other`)===window.expenseFilterCat),h=m.reduce((e,t)=>e+N(t),0),_=m.reduce((e,t)=>e+window.getActual(t.id,window.selectedBudgetMonth),0),v=h-_,y=window.expenseFilterCat!==`all`;d+=`
    <div class="section">
      <div class="section-header">
        <div>
          ...
          <div class="section-subtitle">
            Budget: ${O(r)}/mo
            ${a>0?` · Actual: ${O(a)} · <span class="${o>=0?`var-under`:`var-over`}">${o>=0?`▼`:`▲`} ${O(Math.abs(o))}</span>`:``}
          </div>
        </div>
      ...
      <div style="padding:16px 20px">
      ${window.budgetViewMode===`grouped`?Io(t):`
          ...
          <table>
            ...
            <tbody>
              ${m.length===0?`<tr><td colspan="8"><div class="empty"><div class="empty-icon">📋</div>${t.length===0?`Add your household expenses`:`No expenses in this category`}</div></td></tr>`:[...m].sort((e,t)=>{if(!window.expenseSortCol)return 0;let n,r;if(window.expenseSortCol===`name`)n=e.name.toLowerCase(),r=t.name.toLowerCase();else if(window.expenseSortCol===`category`)n=(e.category||`Other`).toLowerCase(),r=(t.category||`Other`).toLowerCase();else if(window.expenseSortCol===`frequency`)n=M(e),r=M(t);else if(window.expenseSortCol===`due`)n=e.dueDate||`￿`,r=t.dueDate||`￿`;else if(window.expenseSortCol===`budget`)n=N(e),r=N(t);else if(window.expenseSortCol===`actual`)n=window.getActual(e.id,window.selectedBudgetMonth),r=window.getActual(t.id,window.selectedBudgetMonth);else if(window.expenseSortCol===`variance`)n=N(e)-window.getActual(e.id,window.selectedBudgetMonth),r=N(t)-window.getActual(t.id,window.selectedBudgetMonth);else return 0;return n<r?window.expenseSortDir===`asc`?-1:1:n>r?window.expenseSortDir===`asc`?1:-1:0}).map(e=>{let t=N(e),n=window.getActual(e.id,window.selectedBudgetMonth),r=t-n,i=n>0,a;a=i?r>=0?`<span class="var-under">▼ ${O(r)}</span>`:`<span class="var-over">▲ ${O(Math.abs(r))}</span>`:`<span class="var-none">—</span>`;let o=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():`<span style="color:var(--text-muted)">—</span>`,s=window.colors.expense[e.category||`Other`]||`#94a3b8`,c=e.recurring===!1?`<span style="font-size:10px;font-weight:600;padding:1px 6px;border-radius:99px;background:#fef9c3;color:#854d0e;border:1px solid #fde047;margin-left:6px;white-space:nowrap">one-time</span>`:``;return`<tr>
                        ...
                        <td>${o}</td>
                        <td class="amount">${O(t)}</td>
                        <td class="actual-cell amount" id="actual-${e.id}" onclick="window.editActual(${e.id})">${i?O(n):`<span style="color:var(--text-muted);font-size:12px">+ add</span>`}</td>
                        <td>${a}</td>
                        <td class="actions">
            ...
            <tfoot>
              <tr style="background:var(--surface2);border-top:2px solid var(--border)">
                ...
                <td class="amount" style="padding:11px 16px;font-weight:700">${O(h)}/mo</td>
                <td class="amount" style="padding:11px 16px;font-weight:700">${_>0?O(_):`—`}</td>
                <td style="padding:11px 16px;font-weight:700">${_>0?`<span class="${v>=0?`var-under`:`var-over`}">${v>=0?`▼`:`▲`} ${O(Math.abs(v))}</span>`:`—`}</td>
                <td></td>
              </tr>
            </tfoot>`:``}
          </table>
  ...
  `,d+=`</div></div>`,document.getElementById(`budget-content`).innerHTML=d}catch(e){console.error(`renderBudget error:`,e);let t=document.getElementById(`budget-content`);t&&(t.innerHTML=`<div style="padding:24px;color:var(--alert);font-family:var(--mono);font-size:13px">Render error: ${T(e.message)}<br><small>${T(e.stack||``)}</small></div>`)}}var Ho=!1;function Uo(){Ho=!Ho;let e=document.getElementById(`budget-detail`),t=document.getElementById(`budget-expand-label`),n=document.getElementById(`budget-expand-chevron`),r=e&&e.parentElement;e&&(e.classList.toggle(`collapsed`,!Ho),e.classList.toggle(`expanded`,Ho)),r&&(r.style.marginBottom=Ho?`16px`:`0`),t&&(t.textContent=Ho?`Hide details ▲`:`See breakdown ▼`),n&&(n.textContent=Ho?`▲`:`▼`)}function z(e,t,n){document.getElementById(`modal-title`).textContent=e,document.getElementById(`modal-body`).innerHTML=t,document.getElementById(`modal-footer`).innerHTML=`
    <button class="btn btn-ghost" onclick="closeModal()">Cancel</button>
    <button class="btn btn-primary" id="modal-save-btn">Save</button>
  `,window._modalSaveHandler=n,document.getElementById(`modal-save-btn`).onclick=()=>window._modalSaveHandler?.(),document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Wo(){window._pendingLogEntry=null,window._actualEditorRefresh=null,window._csvSuggestions=null,window._csvSuggestNames=null,document.getElementById(`modal-body`).innerHTML=``,document.getElementById(`modal-footer`).innerHTML=``,document.getElementById(`modal-overlay`).classList.add(`hidden`)}document.getElementById(`modal-overlay`).addEventListener(`click`,e=>{e.target===document.getElementById(`modal-overlay`)&&Wo()});function Go(){z(`Edit Contract Total`,`
    <div class="form-group">
  ...
  `,()=>{let e=parseFloat(document.getElementById(`f-contract-total`).value);!isNaN(e)&&e>0&&(window.logActivity(`Updated contract total`,O(e)),g.buildContract.total=e,window.saveData(g),Wo(),window.renderAll())})}function Ko(e={}){return`
    <div class="form-row">
      <div class="form-group">
  ...
  `}function qo(e){return{id:e,name:document.getElementById(`f-stage-name`).value.trim(),amount:parseFloat(document.getElementById(`f-stage-amount`).value)||0,paid:document.getElementById(`f-stage-paid`).checked,expectedDate:document.getElementById(`f-stage-expected`).value,paidDate:document.getElementById(`f-stage-paiddate`).value,invoiceRef:document.getElementById(`f-stage-ref`).value.trim(),funding:document.getElementById(`f-stage-funding`).value,notes:document.getElementById(`f-stage-notes`).value.trim()}}function Jo(){z(`Add Contract Stage`,Ko(),()=>{let e=qo(F(g.buildContract.stages));e.name&&(window.logActivity(`Added build stage`,e.name),g.buildContract.stages.push(e),window.saveData(g),Wo(),window.renderAll())})}function Yo(e){let t=g.buildContract.stages.find(t=>t.id===e);z(`Edit Stage`,Ko(t),()=>{let n=qo(e);window.logActivity(`Edited build stage`,n.name||t.name),Object.assign(t,n),window.saveData(g),Wo(),window.renderAll()})}function Xo(e){if(!confirm(`Delete this stage?`))return;let t=g.buildContract.stages.find(t=>t.id===e);window.logActivity(`Deleted build stage`,t?t.name:``),g.buildContract.stages=g.buildContract.stages.filter(t=>t.id!==e),window.saveData(g),window.renderAll()}function Zo(e={}){return`
    <div class="form-row">
      <div class="form-group">
  ...
  `}function Qo(e){return{id:e,ref:document.getElementById(`f-var-ref`).value.trim(),name:document.getElementById(`f-var-name`).value.trim(),amount:parseFloat(document.getElementById(`f-var-amount`).value)||0,status:document.getElementById(`f-var-status`).value,funding:document.getElementById(`f-var-funding`).value,dateRaised:document.getElementById(`f-var-raised`).value,dateApproved:document.getElementById(`f-var-approved`).value,notes:document.getElementById(`f-var-notes`).value.trim()}}function $o(){z(`Add Variation`,Zo(),()=>{let e=Qo(F(g.buildContract.variations));e.name&&(window.logActivity(`Added variation`,`${e.ref?e.ref+` · `:``}${e.name}`),g.buildContract.variations.push(e),window.saveData(g),renderBuild())})}function es(e){z(`Edit Variation`,Zo(g.buildContract.variations.find(t=>t.id===e)),()=>{let t=Qo(e);if(!t.name)return;window.logActivity(`Edited variation`,`${t.ref?t.ref+` · `:``}${t.name}`);let n=g.buildContract.variations.findIndex(t=>t.id===e);n!==-1&&(g.buildContract.variations[n]=t),window.saveData(g),renderBuild()})}function ts(e){if(!confirm(`Delete this variation?`))return;let t=g.buildContract.variations.find(t=>t.id===e);window.logActivity(`Deleted variation`,t?t.name:``),g.buildContract.variations=g.buildContract.variations.filter(t=>t.id!==e),window.saveData(g),renderBuild()}var ns=[{value:`not-quoted`,label:`Not Quoted`},{value:`quoted`,label:`Quoted`},{value:`approved`,label:`Approved`},{value:`partial`,label:`Partially Paid`},{value:`paid`,label:`Paid`}];function rs(e={}){let t=e.status||(e.totalAmount?`approved`:`not-quoted`);return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Item Name</label>
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <select class="form-select" id="f-extra-status">
          ${ns.map(e=>`<option value="${e.value}" ${t===e.value?`selected`:``}>${e.label}</option>`).join(``)}
        </select>
      </div>
      <div class="form-group">
  ...
  `}function is(e){return{id:e,name:document.getElementById(`f-extra-name`).value.trim(),vendor:document.getElementById(`f-extra-vendor`).value.trim(),status:document.getElementById(`f-extra-status`).value,funding:document.getElementById(`f-extra-funding`).value,totalAmount:parseFloat(document.getElementById(`f-extra-total`).value)||0,amountPaid:parseFloat(document.getElementById(`f-extra-paid`).value)||0,dueDate:document.getElementById(`f-extra-due`).value,notes:document.getElementById(`f-extra-notes`).value.trim()}}function as(){z(`Add Outside Contract Item`,rs(),()=>{let e=is(F(g.extras));e.name&&(window.logActivity(`Added extra item`,e.name),g.extras.push(e),window.saveData(g),Wo(),window.renderAll())})}function os(e){let t=g.extras.find(t=>t.id===e);z(`Edit Item`,rs(t),()=>{let n=is(e);window.logActivity(`Edited extra item`,n.name||t.name),Object.assign(t,n),window.saveData(g),Wo(),window.renderAll()})}function ss(e){if(!confirm(`Delete this item?`))return;let t=g.extras.find(t=>t.id===e);window.logActivity(`Deleted extra item`,t?t.name:``),g.extras=g.extras.filter(t=>t.id!==e),window.saveData(g),window.renderAll()}function cs(e={}){let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():``,n=[`weekly`,`fortnightly`,`monthly`,`quarterly`,`annually`,`custom`],r=e.frequency===`custom`;return`
    <div class="form-group">
  ...
  `}function ls(e){let t=document.getElementById(`f-inc-freq`)?document.getElementById(`f-inc-freq`).value:`monthly`,n=document.getElementById(`f-inc-recurring`),r={id:e,name:document.getElementById(`f-inc-name`).value.trim(),amount:parseFloat(document.getElementById(`f-inc-amount`).value)||0,frequency:t,dueDate:document.getElementById(`f-inc-duedate`).value||null,recurring:n?n.checked:!0};return t===`custom`&&(r.customEvery=parseInt(document.getElementById(`f-inc-custom-n`).value)||1,r.customUnit=document.getElementById(`f-inc-custom-unit`).value),r}function us(){z(`Add Income`,cs(),()=>{let e=ls(F(window.getMonthData(window.selectedBudgetMonth).income));e.name&&(window.logActivity(`Added income`,e.name),window.confirmScope(()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth);e.id=F(t.income),t.income.push(e),window.saveData(g),window.renderAll()},()=>{e.id=F(g.budget.income),g.budget.income.push(e),window.saveData(g),window.renderAll()}))})}function ds(e){let t=window.getMonthData(window.selectedBudgetMonth).income.find(t=>t.id===e);z(`Edit Income`,cs(t),()=>{let n=ls(e);window.logActivity(`Edited income`,n.name||t&&t.name||``),window.confirmScope(()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth),r=t.income.find(t=>t.id===e);r?Object.assign(r,n):t.income.push(n),window.saveData(g),window.renderAll()},()=>{let t=g.budget.income.find(t=>t.id===e);t&&Object.assign(t,n),window.saveData(g),window.renderAll()})})}function fs(e){let t=window.getMonthData(window.selectedBudgetMonth).income.find(t=>t.id===e),n=t?t.name:`this income`;window.logActivity(`Deleted income`,n),window._scopePending=null,document.getElementById(`modal-title`).textContent=`Delete income`,document.getElementById(`modal-body`).innerHTML=`
  ...
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function ps(e={}){let t=e.dueDate?(()=>{let[t,n,r]=e.dueDate.split(`-`);return`${r}/${n}/${t}`})():``,n=[`weekly`,`fortnightly`,`monthly`,`quarterly`,`annually`,`custom`],r=e.frequency===`custom`;return`
    <div class="form-row">
      <div class="form-group">
        <label class="form-label">Description</label>
  ...
  `}function ms(e){let t=document.getElementById(`f-exp-freq`)?document.getElementById(`f-exp-freq`).value:`monthly`,n=document.getElementById(`f-exp-recurring`),r={id:e,name:document.getElementById(`f-exp-name`).value.trim(),category:document.getElementById(`f-exp-cat`).value,vendor:(document.getElementById(`f-exp-vendor`)?.value||``).trim()||null,amount:parseFloat(document.getElementById(`f-exp-amount`).value)||0,frequency:t,dueDate:document.getElementById(`f-exp-duedate`).value||null,recurring:n?n.checked:!0};return t===`custom`&&(r.customEvery=parseInt(document.getElementById(`f-exp-custom-n`).value)||1,r.customUnit=document.getElementById(`f-exp-custom-unit`).value),r}function hs(e){let t=document.getElementById(`f-${e}-freq`).value,n=document.getElementById(`f-${e}-custom-wrap`);n&&(n.style.display=t===`custom`?`flex`:`none`)}function gs(){z(`Add Expense`,ps(),()=>{let e=ms(F(window.getMonthData(window.selectedBudgetMonth).expenses));e.name&&(window.logActivity(`Added expense`,`${e.name} (${e.category||`Other`})`),window.confirmScope(()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth);e.id=F(t.expenses),t.expenses.push(e),window.saveData(g),window.renderAll()},()=>{if(e.id=F(g.budget.expenses),g.budget.expenses.push(e),window.isMonthCustomized(window.selectedBudgetMonth)){let t=g.budget.months[window.selectedBudgetMonth];t.expenses.push({...e,id:F(t.expenses)})}window.saveData(g),window.renderAll()}))})}function _s(e){let t=window.getMonthData(window.selectedBudgetMonth).expenses.find(t=>t.id===e);z(`Edit Expense`,ps(t),()=>{let n=ms(e);window.logActivity(`Edited expense`,`${n.name||t&&t.name||``} (${n.category||`Other`})`),window.confirmScope(()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth),r=t.expenses.find(t=>t.id===e);r?Object.assign(r,n):t.expenses.push(n),window.saveData(g),window.renderAll()},()=>{let t=g.budget.expenses.find(t=>t.id===e);if(t&&Object.assign(t,n),window.isMonthCustomized(window.selectedBudgetMonth)){let t=g.budget.months[window.selectedBudgetMonth].expenses.find(t=>t.id===e);t&&Object.assign(t,n)}window.saveData(g),window.renderAll()})});let n=document.createElement(`button`);n.className=`btn btn-danger`,n.textContent=`Delete`,n.style.marginRight=`auto`,n.onclick=()=>{Wo(),vs(e)};let r=document.getElementById(`modal-footer`);r.insertBefore(n,r.firstChild)}function vs(e){let t=window.getMonthData(window.selectedBudgetMonth).expenses.find(t=>t.id===e),n=t?t.name:`this expense`;window.logActivity(`Deleted expense`,n),window._scopePending={onThisMonth:()=>{let t=window.ensureMonthOverride(window.selectedBudgetMonth);t.expenses=t.expenses.filter(t=>t.id!==e),window.saveData(g),window.renderAll()},onAllMonths:()=>{g.budget.expenses=g.budget.expenses.filter(t=>t.id!==e),g.budget.months&&Object.values(g.budget.months).forEach(t=>{t.expenses=t.expenses.filter(t=>t.id!==e)}),window.saveData(g),window.renderAll()}},document.getElementById(`modal-title`).textContent=`Delete expense`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <button class="btn btn-secondary" onclick="window.doScopeAll()">Remove from all months</button>
    <button class="btn btn-danger" onclick="window.doScopeMonth()">Delete from ${window.monthLabel(window.selectedBudgetMonth)}</button>
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function ys(){return document.getElementById(`f-exp-duedate`)||document.getElementById(`f-inc-duedate`)}function bs(e){e.stopPropagation();let t=document.getElementById(`dp-popup`);if(!t)return;let n=(ys()||{}).value||``;if(n)[window.dpViewYear,window.dpViewMonth]=n.split(`-`).map(Number);else{let e=new Date;window.dpViewYear=e.getFullYear(),window.dpViewMonth=e.getMonth()+1}t.classList.remove(`hidden`),xs();function r(e){let n=document.getElementById(`dp-wrap`);n&&!n.contains(e.target)?t.classList.add(`hidden`):document.addEventListener(`click`,r,{once:!0})}document.addEventListener(`click`,r,{once:!0})}function xs(){let e=document.getElementById(`dp-popup`);if(!e)return;let t=window.dpViewYear,n=window.dpViewMonth,r=new Date(t,n-1,1).getDay(),i=new Date(t,n,0).getDate(),a=new Date,o=(ys()||{}).value||``,s=`
    <div class="dp-nav">
  ...
  `;for(let e=0;e<r;e++)s+=`<div class="dp-day dp-other"></div>`;for(let e=1;e<=i;e++){let r=`${t}-${String(n).padStart(2,`0`)}-${String(e).padStart(2,`0`)}`,i=[`dp-day`,a.getFullYear()===t&&a.getMonth()+1===n&&a.getDate()===e?`dp-today`:``,o===r?`dp-selected`:``].filter(Boolean).join(` `);s+=`<div class="${i}" onclick="dpSelectDate('${r}',event)">${e}</div>`}s+=`</div>`,o&&(s+=`<div class="dp-clear"><button class="dp-clear-btn" onclick="dpClearDate(event)">Clear date</button></div>`),e.innerHTML=s}function Ss(e){e.stopPropagation(),window.dpViewMonth===1?(window.dpViewMonth=12,window.dpViewYear--):window.dpViewMonth--,xs()}function Cs(e){e.stopPropagation(),window.dpViewMonth===12?(window.dpViewMonth=1,window.dpViewYear++):window.dpViewMonth++,xs()}function ws(e,t){t&&t.stopPropagation();let n=ys();n&&(n.value=e);let[r,i,a]=e.split(`-`);document.getElementById(`dp-display`).textContent=`${a}/${i}/${r}`,document.getElementById(`dp-trigger`).classList.add(`has-value`),document.getElementById(`dp-popup`).classList.add(`hidden`);let o=document.getElementById(`dp-repeats-wrap`);o&&(o.style.display=``)}function Ts(e){e.stopPropagation();let t=ys();t&&(t.value=``),document.getElementById(`dp-display`).textContent=`Select a date`,document.getElementById(`dp-trigger`).classList.remove(`has-value`),document.getElementById(`dp-popup`).classList.add(`hidden`);let n=document.getElementById(`dp-repeats-wrap`);n&&(n.style.display=`none`)}var B=[],V=[];function Es(){document.getElementById(`modal-title`).textContent=`Import Bank Transactions`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <div>
      <div style="background:var(--success-light);border:1px solid #6ee7b7;border-radius:8px;padding:10px 14px;margin-bottom:16px;font-size:13px;color:#155e75">
        Found <strong>${B.length} expense transactions</strong> in your CSV
      </div>
      <div class="table-wrap" style="margin-bottom:16px">
        <table>
          ...
          <tbody>
            ...
            ${B.length>5?`<tr><td colspan="3" style="text-align:center;color:var(--text-muted);font-size:12px;padding:8px">+ ${B.length-5} more rows…</td></tr>`:``}
          </tbody>
        </table>
      </div>
    ...
    <button class="btn" onclick="window.closeModal()">Cancel</button>
    ${e?`<button class="btn btn-primary" onclick="runCsvCategorise()">Categorise with AI →</button>`:`<button class="btn btn-primary" onclick="_renderCsvReview(null)">Assign Manually →</button>`}`}async function As(){let e=window._secureGet(`toto_ai_key`);if(!e){js(null);return}document.getElementById(`modal-body`).innerHTML=`
    <div style="text-align:center;padding:48px 16px">
      <div style="font-size:32px;margin-bottom:12px">🤖</div>
      <div style="font-weight:600;margin-bottom:6px">Categorising ${B.length} transactions…</div>
...
[{"idx":0,"expenseId":3},{"idx":1,"expenseId":-1,"suggest":"Dining Out"},{"idx":2,"expenseId":-1}]`;try{let t=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":e,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:4096,messages:[{role:`user`,content:o}]})});if(!t.ok)throw Error(`API error ${t.status}`);let n=(await t.json()).content[0].text.replace(/```[\w]*\n?/g,``).trim().match(/\[[\s\S]*\]/);if(!n)throw Error(`No JSON in response`);let r=JSON.parse(n[0]);js(i(r))}catch(e){document.getElementById(`modal-body`).innerHTML=`
      ...
      <td class="amount" style="white-space:nowrap;font-weight:600">${te(e.total)}</td>
    </tr>`}).join(``),u=e?`<div style="font-size:12px;color:var(--text-muted);margin-bottom:10px">🤖 Transactions grouped by category — review and adjust as needed.</div>`:``,d=V.filter(e=>e.checked&&e.expenseId!==-1).length,f=V.filter(e=>e.checked&&e.expenseId!==-1).reduce((e,t)=>e+t.count,0);document.getElementById(`modal-body`).innerHTML=`
    <div>
      ${u}
    ...
    </div>`;let p=V.filter(e=>e.checked&&e.expenseId===-1).length;document.getElementById(`modal-footer`).innerHTML=`
    ...
    <div style="height:max(12px,env(safe-area-inset-bottom))"></div>`,requestAnimationFrame(()=>document.getElementById(`qah-text`)?.focus())}function Bs(e){Rs(),setTimeout(()=>{if(e===`event`)activateTab(`planner`),setTimeout(()=>openPlannerModal(null,new Date().toISOString().slice(0,10)),300);else if(e===`expense`){let e=window.getMonthData(window.selectedBudgetMonth).expenses,t=parseInt(window._secureGet(`toto_qa_last`)||`0`);_qaExpenseId=e.find(e=>e.id===t)?.id??e[0]?.id??null,_qaAmount=``,Us(e),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>document.getElementById(`qa-sheet`).classList.add(`open`))}else e===`income`?(activateTab(`budget`),setTimeout(()=>openAddIncome(),300)):e===`bill`?(activateTab(`bills`),setTimeout(()=>openBillModal(),300)):e===`chore`?(activateTab(`kids`),setTimeout(()=>{typeof renderChoreMgmt==`function`&&renderChoreMgmt()},300)):e===`shopping`?(window._listsActiveType=`food`,window._listsView=`list`,activateTab(`lists`)):e===`ai`&&typeof toggleTotoAssistant==`function`&&toggleTotoAssistant()},320)}async function Vs(){let e=document.getElementById(`qah-text`)?.value.trim();if(!e){Bs(`ai`);return}let t=document.querySelector(`.qah-ai-send`);t&&(t.textContent=`…`,t.disabled=!0);let n=`Today is ${new Date().toISOString().slice(0,10)}. The user typed: "${e}"
...
- If genuinely unclear → unknown`;try{let t=g.settings?.claudeApiKey,r=(await(await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":t,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:150,messages:[{role:`user`,content:n}]})})).json()).content?.[0]?.text?.trim()||`{"type":"unknown"}`,i=JSON.parse(r.replace(/```[\w]*\n?/g,``).trim());Rs(),await Hs(i,e)}catch{Rs(),setTimeout(()=>{typeof toggleTotoAssistant==`function`&&toggleTotoAssistant(),setTimeout(()=>{let t=document.getElementById(`toto-input`)||document.querySelector(`.toto-msg-input`);t&&(t.value=e,t.focus())},400)},320)}}async function Hs(e,t){let n=e=>new Promise(t=>setTimeout(t,e));if(e.type===`event`){activateTab(`planner`),await n(320),openPlannerModal(null,e.date||new Date().toISOString().slice(0,10)),await n(200);let r=document.getElementById(`pe-title`),i=document.getElementById(`pe-time`);if(r&&(r.value=e.title||t),i&&e.time&&(i.value=e.time),e.date){let t=document.getElementById(`pe-date`),n=document.getElementById(`pm-start-display`);t&&(t.value=e.date),n&&typeof _pmFmtDateShort==`function`&&(n.textContent=_pmFmtDateShort(e.date))}}else if(e.type===`expense`){let t=window.getMonthData(window.selectedBudgetMonth).expenses,n=parseInt(window._secureGet(`toto_qa_last`)||`0`);_qaExpenseId=t.find(e=>e.id===n)?.id??t[0]?.id??null,_qaAmount=e.amount?String(e.amount):``,Us(t),document.getElementById(`qa-overlay`).classList.add(`open`),requestAnimationFrame(()=>{document.getElementById(`qa-sheet`).classList.add(`open`);let t=document.getElementById(`qa-note`);t&&e.note&&(t.value=e.note)})}else if(e.type===`income`){activateTab(`budget`),await n(320),openAddIncome(),await n(200);let t=document.getElementById(`inc-name`)||document.querySelector(`#modal-body [id*="name"]`),r=document.getElementById(`inc-amount`)||document.querySelector(`#modal-body [id*="amount"]`);t&&e.name&&(t.value=e.name),r&&e.amount&&(r.value=e.amount)}else if(e.type===`bill`){activateTab(`bills`),await n(320),openBillModal(),await n(200);let t=document.getElementById(`bill-name`),r=document.getElementById(`bill-amount`),i=document.getElementById(`bill-due`);t&&e.name&&(t.value=e.name),r&&e.amount&&(r.value=e.amount),i&&e.dueDate&&(i.value=e.dueDate)}else if(e.type===`chore`)activateTab(`kids`),await n(320);else if(e.type===`shopping`){window._listsActiveType=`food`,window._listsView=`list`,activateTab(`lists`),await n(320);let t=document.getElementById(`ls-quick-input`);t&&e.name&&(t.value=e.name,t.focus())}else{typeof toggleTotoAssistant==`function`&&toggleTotoAssistant(),await n(400);let e=document.getElementById(`toto-input`)||document.querySelector(`.toto-msg-input`);e&&(e.value=t,e.focus())}}function Us(e){let t=e||window.getMonthData(window.selectedBudgetMonth).expenses,n=_qaAmount?`$${_qaAmount}`:`$0`,r=!_qaAmount,i=t.length?t.map(e=>`<button class="qa-cat${e.id===_qaExpenseId?` selected`:``}" onclick="_qaSelectCat(${e.id})">${T(e.name)}</button>`).join(``):`<span style="color:var(--text-muted);font-size:13px;padding:6px 4px">Add budget expenses first</span>`,a=[`1`,`2`,`3`,`4`,`5`,`6`,`7`,`8`,`9`,`.`,`0`,`⌫`];document.getElementById(`qa-sheet`).innerHTML=`
    ...
    </div>`}function Ws(e){if(e===`⌫`)_qaAmount=_qaAmount.slice(0,-1);else if(e===`.`)_qaAmount.includes(`.`)||(_qaAmount+=(_qaAmount?``:`0`)+`.`);else{let t=_qaAmount.split(`.`);if(t[1]!==void 0&&t[1].length>=2||_qaAmount.replace(`.`,``).length>=6)return;_qaAmount===`0`&&e!==`.`?_qaAmount=e:_qaAmount+=e}let t=document.getElementById(`qa-display`);if(!t)return;let n=!_qaAmount;t.textContent=_qaAmount?`$${_qaAmount}`:`$0`,t.className=`qa-amount-display${n?` zero`:``}`}function Gs(e){_qaExpenseId=e,document.querySelectorAll(`.qa-cat`).forEach(t=>{t.classList.toggle(`selected`,parseInt(t.getAttribute(`onclick`).match(/\d+/)[0])===e)})}function Ks(){let e=parseFloat(_qaAmount);if(!e||e<=0){let e=document.getElementById(`qa-display`);e&&(e.style.color=`var(--danger)`,setTimeout(()=>e.style.color=``,600));return}if(!_qaExpenseId){let e=document.getElementById(`qa-cats`);e&&(e.style.outline=`2px solid var(--danger)`,e.style.borderRadius=`8px`,setTimeout(()=>{e.style.outline=``},600));return}let t=document.getElementById(`qa-note`)?.value.trim()||``,n=new Date().toISOString().slice(0,10);g.budget.actuals[window.selectedBudgetMonth]||(g.budget.actuals[window.selectedBudgetMonth]={});let r=window.getActualEntries(_qaExpenseId,window.selectedBudgetMonth),i=r.length?Math.max(...r.map(e=>e.id))+1:1;r.push({id:i,amount:e,date:n,note:t}),g.budget.actuals[window.selectedBudgetMonth][_qaExpenseId]=r,window._secureSet(`toto_qa_last`,String(_qaExpenseId)),window.saveData(g),Rs(),window.renderAll();let a=document.getElementById(`qa-fab`);a&&(a.textContent=`✓`,a.style.background=`#10b981`,setTimeout(()=>{a.textContent=`+`,a.style.background=``},1800))}window.addEventListener(`resize`,()=>{document.querySelectorAll(`.section-pills-wrap`).forEach(_updatePillsOverflow)}),document.querySelectorAll(`.nav-item, .nav-text-item`).forEach(e=>{e.addEventListener(`click`,()=>activateTab(e.dataset.tab))});function qs(){let e=window._activeProfile?.role===`child`;document.body.classList.toggle(`kid-mode`,e);let t=document.getElementById(`kid-banner-label`);t&&e&&(t.textContent=`${window._activeProfile.emoji||`😊`} ${window._activeProfile.name}'s view`);let n=window.getDeviceProfile(),r=document.getElementById(`header-switch-profile`);if(r){let t=n&&n!==`adult`;if(r.style.display=t?``:`none`,t)if(e)r.textContent=`👨‍👩‍👧 Parent`;else{let e=(g.kids?.profiles||[]).find(e=>e.id===n);r.textContent=e?`Back to ${e.name}`:`Switch`}}}function Js(){let e=window.getDeviceProfile();if(window._activeProfile?.role===`child`)window.clearKidSession(),window._activeProfile=null,qs(),window.renderAll();else if(e===`shared`)window.showProfileSelector();else if(e&&e!==`adult`){let t=(g.kids?.profiles||[]).find(t=>t.id===e);t&&(t.pinHash?(window._pinTargetId=t.id,window._pinBuffer=``,window._pinAttempts=0,window._showPinScreen(t)):(window._activeProfile={id:t.id,name:t.name,emoji:t.emoji,role:`child`},window.setKidSession(t.id),window._applyActiveProfile()))}}async function Ys(e,t){let n=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));!n||t.length!==4||(n.pinHash=await window._hashPin(t,window._getHouseholdOwnerUID()),window.saveData(g))}function Xs(e){let t=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(delete t.pinHash,window.saveData(g))}function Zs(e){(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[e]&&($s=e,tc=``,H=``,ec=`enter`,nc(),document.getElementById(`adult-pin-modal`).classList.remove(`hidden`))}function Qs(e){let t=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name);t[e]&&(delete t[e].pinHash,window.saveData(g),renderSettings())}var $s=0,ec=`enter`,tc=``,H=``;function nc(){let e=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[$s];if(!e)return;let t=ec===`enter`,n=t?e.pinHash?`Change your PIN 🔢`:`Set your PIN 🔢`:`Confirm your PIN ✅`,r=t?`Pick 4 numbers — used on shared devices`:`Enter it again to confirm`,i=[0,1,2,3].map(e=>{let t=e<H.length;return`<div style="width:52px;height:60px;border:2px solid ${t?`#0891b2`:`#e2e8f0`};border-radius:10px;background:${t?`#ecfeff`:`#f8fafc`};display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:700;color:#0891b2">${t?`●`:``}</div>`}).join(``),a=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div></div>`:`<div onclick="_adultPinKey('${e}')" style="height:52px;border:1.5px solid #e2e8f0;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:600;color:#374151;cursor:pointer;background:#fff;-webkit-tap-highlight-color:transparent;user-select:none">${e}</div>`).join(``);document.getElementById(`adult-pin-modal-body`).innerHTML=`
    ...
    <button onclick="document.getElementById('adult-pin-modal').classList.add('hidden')" style="font-size:13px;color:#94a3b8;background:none;border:none;cursor:pointer">Cancel</button>`}function rc(e){if(e===`⌫`){H=H.slice(0,-1),nc();return}H.length>=4||(H+=e,nc(),H.length===4&&ic())}async function ic(){if(ec===`enter`)tc=H,H=``,ec=`confirm`,nc();else{if(H!==tc){H=``,tc=``,ec=`enter`,nc();let e=document.getElementById(`adult-pin-error`);e&&(e.textContent=`Those didn't match — try again`);return}let e=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name);e[$s].pinHash=await window._hashPin(H,window._getHouseholdOwnerUID()),window.saveData(g),document.getElementById(`adult-pin-modal`).classList.add(`hidden`),renderSettings()}}function ac(e){let t=Number(e.age||0);return t<5?`tiny-tots`:t<8?`early-reader`:t<12?`independent`:`tween`}function oc(){let e=new Date().getHours();return e<12?`Good morning`:e<17?`Good afternoon`:`Good evening`}function sc(e){if(!e.triggerTime)return!0;let[t,n]=e.triggerTime.split(`:`).map(Number),r=new Date,i=r.getHours()*60+r.getMinutes(),a=t*60+(n||0),o=a+360;return i>=a&&i<o}function cc(e){if(!e.triggerTime)return``;let[t]=e.triggerTime.split(`:`).map(Number);return t<12?`Available this morning`:t<17?`Available this afternoon`:`Available tonight`}function lc(){let e=document.getElementById(`child-view-overlay`);if(!e)return;let t=document.getElementById(`cv-confetti-wrap`);t&&t.remove(),t=document.createElement(`div`),t.id=`cv-confetti-wrap`,t.className=`cv2-confetti-wrap`,e.appendChild(t);let n=[`#5B4CF5`,`#7C3AED`,`#F59E0B`,`#10B981`,`#F43F5E`,`#FBBF24`];for(let e=0;e<60;e++){let r=document.createElement(`div`);r.className=`cv2-confetti-particle`,r.style.cssText=`
    ...
    `,t.appendChild(r)}setTimeout(()=>{t.parentNode&&t.remove()},3500)}function uc(e){let t=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));if(!t)return;pc=e,mc=`today`;let n=g.kids,r=kidBalance(n,t.id),i=ac(t),a=i===`tiny-tots`,o=i===`tween`,s=_cvReadOnly,c=document.getElementById(`child-view-overlay`);document.getElementById(`cv-avatar`).textContent=t.emoji||`😊`,document.getElementById(`cv-name`).innerHTML=`<span class="ember-text">${T(t.name)}</span>`,document.getElementById(`cv-greeting`).textContent=oc()+`!`;let l=(n.completions||[]).filter(e=>e.kidId===t.id&&e.status===`approved`&&new Date(e.completedAt||e.ts).toDateString()===new Date().toDateString()).reduce((e,t)=>e+((n.chores||[]).find(e=>e.id===t.choreId)?.points||0),0),u=document.getElementById(`cv-nudge`);l>0&&!a&&!s?(u.textContent=`You've earned ⭐ ${l} points today — keep going!`,u.style.display=``):u.style.display=`none`,c.className=c.className.replace(/cv2-age-\S+/g,``).trim(),i===`early-reader`&&c.classList.add(`cv2-age-early`),a&&c.classList.add(`cv2-age-tiny`),o&&c.classList.add(`cv2-age-tween`);let d=document.getElementById(`cv-nav`);d&&(d.style.display=a?`none`:``),document.getElementById(`cv-nav-today`)?.classList.add(`active`),document.getElementById(`cv-nav-calendar`)?.classList.remove(`active`),document.getElementById(`cv-nav-prizes`)?.classList.remove(`active`),dc(t);let f=new Date().toISOString().slice(0,10),p=(g.routineAssignments||[]).filter(e=>{if(e.childId!==t.id)return!1;let n=(g.routines||[]).find(t=>t.id===e.routineId);return n&&_routineMatchesDate(n,f)}),m=_routineTodayKey(),h=``,_=0,v=0;p.length&&p.forEach(e=>{let n=(g.routines||[]).find(t=>t.id===e.routineId);if(!n)return;let r=e.completionState?.[m]||[],i=n.steps.length,o=i>0?Math.round(r.length/i*100):0,c=r.length===i&&i>0,l=sc(n);v+=i,_+=r.length;let u=l?``:cc(n),d=_assignmentStreak(e,i),f=_assignmentHistory(e,i,7).filter(e=>e.done===e.total&&e.total>0).length;if(h+=`<div class="cv2-card${l?``:` cv2-card--locked`}" style="margin-bottom:10px">
      ...
      </div>`});let S=_mealWeekKey(0),C=new Date().getDay()===0?6:new Date().getDay()-1,w=g.meals?.lunchbox?.plans?.[S]||{},E=w[w[t.id]===void 0?(g.meals?.lunchbox?.profiles||[]).find(e=>e.name?.toLowerCase()===t.name?.toLowerCase())?.id??t.id:t.id]?.[C]||{},D=[`main`,`snack`,`fruit`,`drink`],ee=D.map(e=>E[e]).filter(Boolean),O={main:`🥪`,snack:`🍪`,fruit:`🍎`,drink:`🥤`},te=``;if(ee.length){let e=``;D.forEach(t=>{E[t]&&(e+=`<div class="cv2-lb-chip">${O[t]}${a?``:` `+T(E[t])}</div>`)}),te=`<div class="cv2-group">
      <div class="cv2-group-heading">🥪 Lunchbox</div>
      <div class="cv2-card cv2-card--warm">
        <div class="cv2-lb-chips">${e}</div>
      </div>
    </div>`}let{events:k}=yc(t,f),A=[...k].sort((e,t)=>(e.time||`99:99`).localeCompare(t.time||`99:99`)),ne=``;A.length&&!a&&(ne=`<div class="cv2-group">
    ...
    </div>`);let re=(n.prizes||[]).filter(e=>r>=e.pointCost),j=``;if(!a){let e=re.length?`<div style="display:flex;align-items:center;gap:10px;padding:14px 15px">
      ...
      </div>`}).join(``));let N=v>0&&_===v,P;N&&!s?P=`<div class="cv2-celebration">
    ...
    ${ne}${te}${j}`:(P=ie,i!==`tiny-tots`&&!s&&(P+=`<button class="cv2-week-shortcut" onclick="_cvSwitchTab('calendar','${t.id}')">📅 See my week →</button>`),p.length&&(P+=`<div class="cv2-group">
        <div class="cv2-group-heading">📋 My Routines</div>
        ${h}
      </div>`),y.length&&(P+=`<div class="cv2-group">
        <div class="cv2-group-heading">🧹 Chores</div>
        <div class="cv2-card">${x}</div>
      </div>`),P+=ne,P+=te,P+=j),document.getElementById(`cv-content`).innerHTML=P,c.classList.remove(`hidden`),c.style.display=`flex`,N&&!s&&lc()}function dc(e){let t=document.getElementById(`cv-prizes-badge`);if(!t)return;let n=g.kids,r=kidBalance(n,e.id),i=(n.notifications||[]).filter(t=>t.kidId===e.id&&!t.read).length,a=(n.prizes||[]).filter(e=>r>=e.pointCost).length,o=i+(a>0&&i===0?a:0);o>0?(t.textContent=o>9?`9+`:String(o),t.style.display=``):t.style.display=`none`}function fc(e){let t=g.kids,n=kidBalance(t,e.id),r=ac(e)===`tiny-tots`,i=_cvReadOnly,a=t.prizes||[],o=!1;(t.notifications||[]).filter(t=>t.kidId===e.id&&!t.read).forEach(e=>{e.read=!0,o=!0}),o&&window.saveData(g),dc(e);let s=r?`${`⭐`.repeat(Math.min(n,10))}${n>10?`+`:``}`:`${n}`,c=`<div class="cv2-prizes-balance">
    ...
    <span class="cv2-prizes-balance-emoji">🏆</span>
      ...
      </div>`}),c+=`</div>`);let u=document.getElementById(`cv-content`);u&&(u.innerHTML=c)}var pc=null,mc=`today`,hc=`7day`,gc=null,_c=new Set;function vc(e,t){t&&(pc=t);let n=(g.kids?.profiles||[]).find(e=>String(e.id)===String(pc));if(!n)return;let r=ac(n),i=document.getElementById(`cv-nav`);i&&(i.style.display=r===`tiny-tots`?`none`:``),document.getElementById(`cv-nav-today`)?.classList.toggle(`active`,e===`today`),document.getElementById(`cv-nav-calendar`)?.classList.toggle(`active`,e===`calendar`),document.getElementById(`cv-nav-prizes`)?.classList.toggle(`active`,e===`prizes`),e===`today`?uc(pc):e===`prizes`?fc(n):(gc=null,Ec(n))}function yc(e,t){let n=(g.routineAssignments||[]).filter(t=>t.childId===e.id).map(e=>{let n=(g.routines||[]).find(t=>t.id===e.routineId);return n&&_routineMatchesDate(n,t)?{type:`routine`,routine:n,assignment:e,label:n.name,emoji:n.emoji,color:`#7C3AED`,tag:`Routine`,time:n.triggerTime||null}:null}).filter(Boolean),r=(g.childEvents||[]).filter(n=>{let r=Array.isArray(n.assignedTo)?n.assignedTo:[n.assignedTo];return r.includes(e.id)||r.includes(`all`)||n.isHouseholdWide?n.recurrence?Mt(n.recurrence,t):n.date===t:!1}).map(e=>({type:`event`,label:e.title,emoji:e.emoji||`📅`,color:`#10b981`,tag:`Event`,notes:e.notes,time:e.time||null})),i=(g.planner?.events||[]).filter(e=>Wt(e).includes(`everyone`)?e.recurrence&&e.recurrence.type!==`one_time`?Mt(e.recurrence,t):e.endDate&&e.endDate>e.date?t>=e.date&&t<=e.endDate:e.date===t:!1).map(e=>({type:`event`,label:e.title,emoji:L[e.category]?.emoji||`📅`,color:`#10b981`,tag:`Event`,notes:e.notes||``,time:e.time||null}));return{routines:n,events:[...r,...i],chores:(g.kids?.chores||[]).filter(t=>(t.assignedTo===e.id||t.assignedTo===`all`)&&!t._isRoutine).map(e=>({type:`chore`,label:e.name,emoji:e.emoji||`📋`,color:`#ec4899`,tag:`Chore`,time:null}))}}function bc(e){if(!e)return``;let[t,n]=e.split(`:`).map(Number);return`${t%12||12}:${String(n).padStart(2,`0`)} ${t>=12?`pm`:`am`}`}function xc(e){_c.has(e)?_c.delete(e):_c.add(e);let t=(g.kids?.profiles||[]).find(e=>String(e.id)===String(pc));t&&(hc===`7day`||ac(t)===`early-reader`?Cc(t,new Date().toISOString().slice(0,10)):Cc(t,gc))}function Sc(e,t,n){if(_cvReadOnly)return;let r=_routineGetAssignment(e,pc);if(!r)return;r.completionState||(r.completionState={});let i=n;r.completionState[i]||(r.completionState[i]=[]);let a=r.completionState[i].indexOf(t),o=a===-1;o?r.completionState[i].push(t):r.completionState[i].splice(a,1);let s=new Date().toISOString().slice(0,10);if(o&&n===s){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(n){let e=n.steps.find(e=>e.id===t);(e?.points||0)>0&&_routineAwardStepPoints(n,e,pc);let a=n.steps.length;r.completionState[i].length===a&&a>0&&(n.pointsPerCompletion||0)>0&&_routineAwardPoints(n,pc)}}window.saveData(g);let c=(g.kids?.profiles||[]).find(e=>String(e.id)===String(pc));c&&Cc(c,n)}function Cc(e,t){let n=hc===`month`?`cv-day-panel`:`cv-schedule-panel`,r=document.getElementById(n);r&&(r.innerHTML=wc(e,t))}function wc(e,t){if(!t)return``;let{routines:n,events:r,chores:i}=yc(e,t),a=t;if(!n.length&&!r.length&&!i.length)return`<div style="text-align:center;padding:28px 0;color:#A1A1AA;font-size:13px">Nothing scheduled</div>`;let o=[...n.map(e=>({...e,sortKey:e.time||`23:59`})),...r.map(e=>({...e,sortKey:e.time||`23:59`}))].sort((e,t)=>e.sortKey.localeCompare(t.sortKey)),s=``;return o.length&&(s+=`<div class="cv-sched-section-hdr">Schedule</div>`,o.forEach(e=>{e.type===`routine`?s+=Tc(e.routine,e.assignment,a):s+=`<div class="cv-sched-item">
      ...
      </div>`})),s}function Tc(e,t,n){let r=t.completionState?.[n]||[],i=e.steps.length,a=i>0?Math.round(r.length/i*100):0,o=r.length===i&&i>0,s=_c.has(e.id),c=i>0?`
    ...
    ${l}
  </div>`}function Ec(e){if(!e)return;let t=ac(e)===`early-reader`,n=t?`7day`:hc,r=new Date().toISOString().slice(0,10),i=document.getElementById(`cv-content`);if(!i)return;let a=``;t||(a+=`<div style="display:flex;gap:8px;margin-bottom:14px">
    ...
    </div>`),a+=n===`7day`?Oc(e,r):Ac(e,r),i.innerHTML=a}function Dc(e,t){hc=e,gc=null;let n=(g.kids?.profiles||[]).find(e=>String(e.id)===String(t));n&&Ec(n)}function Oc(e,t){let n=[`S`,`M`,`T`,`W`,`T`,`F`,`S`],r=new Date(t+`T12:00:00`),i=`<div class="cv-week-strip">`;for(let a=0;a<7;a++){let o=new Date(r);o.setDate(r.getDate()+a);let s=o.toISOString().slice(0,10),c=s===t,{routines:l,events:u,chores:d}=yc(e,s),f=[...l,...u,...d].slice(0,3).map(e=>`<div class="cv-cal-dot" style="background:${e.color}"></div>`).join(``);i+=`<div class="cv-week-cell ${c?`cv-today`:``}" onclick="_cvWeekDayTap('${s}','${e.id}')">
    ...
    </div>`}i+=`</div>`;let a=new Date(t+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`});return i+=`<div style="font-size:13px;font-weight:700;color:#1e293b;margin:10px 0 2px">${T(a)}</div>`,i+=`<div id="cv-schedule-panel">${wc(e,t)}</div>`,i}function kc(e,t){let n=(g.kids?.profiles||[]).find(e=>String(e.id)===String(t));if(!n)return;_c.clear(),document.querySelectorAll(`.cv-week-cell`).forEach(t=>{t.classList.toggle(`cv-today`,t.getAttribute(`onclick`)?.includes(`'${e}'`))});let r=new Date(e+`T12:00:00`).toLocaleDateString(`en-AU`,{weekday:`long`,day:`numeric`,month:`long`}),i=document.getElementById(`cv-schedule-panel`);i&&(i.previousElementSibling.textContent=r,i.innerHTML=wc(n,e))}function Ac(e,t){let n=new Date(t+`T12:00:00`),r=n.getFullYear(),i=n.getMonth(),a=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`],o=[`S`,`M`,`T`,`W`,`T`,`F`,`S`],s=new Date(r,i,1).getDay(),c=new Date(r,i+1,0).getDate(),l=gc||t,u=`<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
    <span style="font-size:14px;font-weight:800;color:#18181B">${a[i]} ${r}</span>
  </div>`;u+=`<div class="cv-cal-grid">`,o.forEach(e=>{u+=`<div class="cv-cal-day-hdr">${e}</div>`});for(let e=0;e<s;e++)u+=`<div class="cv-cal-cell cv-other"></div>`;for(let n=1;n<=c;n++){let a=`${r}-${String(i+1).padStart(2,`0`)}-${String(n).padStart(2,`0`)}`,o=a===t,s=a===l,{routines:c,events:d,chores:f}=yc(e,a),p=[...c,...d,...f].slice(0,3).map(e=>`<div class="cv-cal-dot" style="background:${e.color}"></div>`).join(``);u+=`<div class="cv-cal-cell ${o?`cv-today`:``} ${s&&!o?`cv-cal-cell--sel`:``}" onclick="_cvMonthDayTap('${a}','${e.id}')">
  ...
  </div>`,u}function jc(e,t){gc=e,_c.clear();let n=(g.kids?.profiles||[]).find(e=>String(e.id)===String(t));n&&Ec(n)}function Mc(e,t){jc(e,t)}function Nc(e,t){let n=(g.kids?.notifications||[]).find(t=>t.id===e);n&&(n.read=!0),window.saveData(g),uc(t)}function Pc(e,t){let n=(g.kids?.prizes||[]).find(e=>String(e.id)===String(t));if(!n)return;let r=`<div class="cv2-confirm">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 0;border-bottom:1px solid var(--hairline-soft)">
      ...
      </div>`;return}(!Jc||!n.find(e=>e.id===Jc))&&(Jc=n[0].id);let r=n.find(e=>e.id===Jc),i=_mealWeekKey(0),a=_mealWeekDates(i).slice(0,5),o=(t.plans[i]||{})[Jc]||{},s=new Date().toISOString().slice(0,10),c=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`],l=n.map(e=>`<button class="lb-kid-tab${e.id===Jc?` active`:``}" onclick="_lbActiveKid=${e.id};renderLunchbox()">${T(e.name)}</button>`).join(``);a[0].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`}),a[4].toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`});let u=``;Yc.forEach(e=>{u+=`<div class="lb-label">${e.label}</div>`,a.forEach((t,n)=>{let r=(o[n]||{})[e.key]||``,a=t.toISOString().slice(0,10)===s;u+=`<div class="lb-cell${a?` today`:``}" onclick="openLunchboxEdit('${i}',${Jc},${n},'${e.key}')">
    ...
    </div>`}function Qc(e){let t=e?(g.meals.lunchbox.profiles||[]).find(t=>t.id===e):null;document.getElementById(`modal-title`).textContent=t?`Edit ${T(t.name)}`:`Add Child`,document.getElementById(`modal-body`).innerHTML=`
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div id="lb-allergies" style="display:flex;flex-wrap:wrap;gap:6px">
        ${Xc.map(e=>{let n=t&&(t.allergies||[]).includes(e);return`<button type="button" class="lb-tag${n?` allergy`:``}" style="cursor:pointer;${n?``:`background:var(--surface2);color:var(--text-muted);border:1px solid var(--border)`}"
    ...
    <button class="btn btn-primary" onclick="_saveLbSlot('${e}',${t},${n},'${r}',document.getElementById('lb-input').value.trim())">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`),setTimeout(()=>{let e=document.getElementById(`lb-input`);e&&(e.focus(),e.select())},80)}function nl(e,t,n,r,i){g.meals.lunchbox.plans[e]||(g.meals.lunchbox.plans[e]={}),g.meals.lunchbox.plans[e][t]||(g.meals.lunchbox.plans[e][t]={}),g.meals.lunchbox.plans[e][t][n]||(g.meals.lunchbox.plans[e][t][n]={}),g.meals.lunchbox.plans[e][t][n][r]=i,delete g.meals.lunchbox.plans[e][t][n][`cal_`+r],window.saveData(g),window.closeModal(),Zc(),i&&g.settings?.showCalories&&rl(e,t,n,r,i)}async function rl(e,t,n,r,i){let a=localStorage.getItem(`toto_ai_key`);if(!(!a||!i))try{let o=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":a,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:50,messages:[{role:`user`,content:`Estimate the calories in this school lunch item: "${i}". Return ONLY a number, nothing else. For example: 250`}]})});if(!o.ok)return;let s=await o.json(),c=parseInt(s.content[0].text.trim().replace(/[^0-9]/g,``));c>0&&c<3e3&&g.meals.lunchbox.plans[e]?.[t]?.[n]&&(g.meals.lunchbox.plans[e][t][n][`cal_`+r]=c,window.saveData(g),Zc())}catch{}}async function il(e,t){let n=localStorage.getItem(`toto_ai_key`);if(!n)return;let r=(g.meals.lunchbox.profiles||[]).find(e=>e.id===t);if(!r)return;let i=document.getElementById(`lb-ai-btn`);i&&(i.textContent=`Planning...`,i.disabled=!0);let a=`Plan 5 days (Monday to Friday) of school lunches for a child:
...
No markdown, no code fences, just raw JSON.`;try{let r=await fetch(CLAUDE_API,{method:`POST`,headers:{"x-api-key":n,"anthropic-version":`2023-06-01`,"content-type":`application/json`},body:JSON.stringify({model:`claude-haiku-4-5-20251001`,max_tokens:1024,messages:[{role:`user`,content:a}]})});if(!r.ok)throw Error(`API ${r.status}`);let i=(await r.json()).content[0].text.replace(/```[\w]*\n?/g,``).trim().match(/\[[\s\S]*\]/);if(!i)throw Error(`No JSON`);let o=JSON.parse(i[0]);g.meals.lunchbox.plans[e]||(g.meals.lunchbox.plans[e]={}),g.meals.lunchbox.plans[e][t]||(g.meals.lunchbox.plans[e][t]={}),o.forEach(n=>{let r={main:n.main||``,snack:n.snack||``,fruit:n.fruit||``,drink:n.drink||``};n.cal_main&&(r.cal_main=n.cal_main),n.cal_snack&&(r.cal_snack=n.cal_snack),n.cal_fruit&&(r.cal_fruit=n.cal_fruit),n.cal_drink&&(r.cal_drink=n.cal_drink),g.meals.lunchbox.plans[e][t][n.day]=r}),window.saveData(g),Zc()}catch(e){console.error(`Lunchbox AI error:`,e),i&&(i.textContent=`Plan this week`,i.disabled=!1)}}function al(e,t){let n=(g.meals.lunchbox.plans[e]||{})[t]||{},r=new Set;Object.values(n).forEach(e=>{e.main&&r.add(e.main),e.snack&&r.add(e.snack),e.fruit&&r.add(e.fruit)}),g.lists||(g.lists={}),g.lists.food||(g.lists.food={items:[],weeklyBudget:200,budget:0,stores:[],favourites:[],history:[]});let i=g.lists.food.items,a=0;r.forEach(e=>{i.some(t=>t.name.toLowerCase()===e.toLowerCase()&&t.state===`active`)||(i.push({id:`si-lb-`+Date.now()+`-`+a,name:e,quantity:1,unit:`units`,notes:``,aisle:_inferAisle?_inferAisle(e):`other`,state:`active`,addedBy:`lunchbox`,addedAt:new Date().toISOString(),mealTag:`Lunchbox`,manualPrice:null,barcodeId:null}),a++)}),a>0&&(window.saveData(g),_listsActiveType=`food`,_listsView=`list`,activateTab(`lists`));let o=document.querySelector(`[onclick^="lbToShoppingList"]`);if(o){let e=o.textContent;o.textContent=`Added ${a} items`,o.style.color=`var(--success)`,setTimeout(()=>{o.textContent=e,o.style.color=``},2e3)}}function ol(e){let t=document.querySelector(`.health-popover`);if(t){t.remove();return}let n=window._lastHealth;if(!n)return;let r=window._lastHealthGuides||[`savings`,`tracking`,`netWorth`,`emergency`,`goals`],i={A:`#10b981`,B:`#0891b2`,C:`#f59e0b`,D:`#f97316`,F:`#ef4444`},a={A:`Excellent`,B:`Good`,C:`Fair — some areas need work`,D:`Needs attention`,F:`Critical — take action`},o={"Savings Rate":n.dimensions[0].score>=15?`Healthy savings rate`:n.dimensions[0].score>=8?`Could save more each month`:`Very little being saved`,"Budget Tracking":n.dimensions[1].score>=15?`Consistently logging actuals`:n.dimensions[1].score>=8?`Some months tracked`:`Not tracking actual spending`,"Net Worth":n.dimensions[2].score>=15?`Assets outweigh liabilities`:n.dimensions[2].score>=8?`Building slowly`:`Liabilities are high or no data`,"Emergency Buffer":n.dimensions[3].score>=15?`3+ months of expenses covered`:n.dimensions[3].score>=8?`Some buffer building`:`Less than 1 month covered`,Goals:n.dimensions[4].score>=15?`Goals set and progressing`:n.dimensions[4].score>=8?`Goals need more progress`:`No active goals set`},s=``;n.dimensions.forEach((e,t)=>{let n=Math.round(e.score/e.max*100),i=n>=75?`#10b981`:n>=50?`#f59e0b`:`#ef4444`,a=o[e.label]||``,c=r[t],l=e.score<15&&HEALTH_GUIDES[c];s+=`<div class="health-dim">
    ...
    ${s}`,document.body.appendChild(c);let l=e.getBoundingClientRect(),u=l.bottom+10,d=l.left+l.width/2-150;d<12&&(d=12),d+300>window.innerWidth-12&&(d=window.innerWidth-312),u+c.offsetHeight>window.innerHeight-12&&(u=l.top-c.offsetHeight-10),c.style.top=u+`px`,c.style.left=d+`px`,setTimeout(()=>{let t=n=>{!c.contains(n.target)&&n.target!==e&&(c.remove(),document.removeEventListener(`click`,t))};document.addEventListener(`click`,t)},10)}var sl=[],cl=0,ll=null;function ul(e){sl=e,cl=0,dl()}function dl(){if(hl(),cl>=sl.length){ml();return}let e=sl[cl];e.tab&&_activeTab()!==e.tab?(activateTab(e.tab),setTimeout(()=>fl(e),500)):setTimeout(()=>fl(e),100)}function fl(e){let t=e.el?typeof e.el==`string`?document.querySelector(e.el):e.el:null,n=document.createElement(`div`);n.className=`guide-overlay`,n.onclick=()=>ml(),document.body.appendChild(n);let r=null,i=null;t&&(t.scrollIntoView({behavior:`smooth`,block:`center`}),i=t.getBoundingClientRect(),r=document.createElement(`div`),r.className=`guide-spotlight guide-pulse`,r.style.cssText=`top:${i.top-6}px;left:${i.left-6}px;width:${i.width+12}px;height:${i.height+12}px;`,document.body.appendChild(r));let a=document.createElement(`div`);if(a.className=`guide-tooltip`,a.innerHTML=`
    <div class="guide-tooltip-step">Step ${cl+1} of ${sl.length}</div>
    ...
    <div class="guide-tooltip-actions">
      ...
      ${cl<sl.length-1?`<button class="guide-tooltip-btn" style="background:#0891b2;color:#fff" onclick="nextGuideStep()">Next</button>`:`<button class="guide-tooltip-btn" style="background:#0891b2;color:#fff" onclick="endGuide()">Done</button>`}
    </div>`,a.onclick=e=>e.stopPropagation(),document.body.appendChild(a),i){let e=a.offsetWidth,t=a.offsetHeight,n=i.bottom+14,r=i.left+i.width/2-e/2;r<12&&(r=12),r+e>window.innerWidth-12&&(r=window.innerWidth-e-12),n+t>window.innerHeight-12&&(n=i.top-t-14),a.style.top=n+`px`,a.style.left=r+`px`}else a.style.top=`50%`,a.style.left=`50%`,a.style.transform=`translate(-50%, -50%)`;if(ll=()=>{n.remove(),r&&r.remove(),a.remove()},e.watchClick&&t){let e=()=>{t.removeEventListener(`click`,e),setTimeout(()=>pl(),400)};t.addEventListener(`click`,e)}}function pl(){cl++,dl()}function ml(){hl(),sl=[],cl=0}function hl(){ll&&(ll(),ll=null)}var gl={emergency:[{tab:`goals`,title:`Create an Emergency Fund`,text:`An emergency fund covers 3-6 months of expenses. Let's set one up as a savings goal.`,el:null},{tab:`goals`,title:`Tap "+ New Goal"`,text:`This button creates a new savings goal. Set the name to "Emergency Fund" and the target to your 3-month expenses.`,el:`[onclick*="openAddGoal"]`,watchClick:!0}],savings:[{tab:`budget`,title:`Improve your savings rate`,text:`Your savings rate is the gap between income and expenses. To improve it, you can either reduce expenses or increase income.`,el:null},{tab:`budget`,title:`Review your expenses`,text:`Look through your expenses below. Are there any you could reduce? Tap any expense to edit it.`,el:`#budget-content`}],tracking:[{tab:`budget`,title:`Track your actual spending`,text:`Recording what you actually spend helps you stay on track. You can import your bank statement or log spends manually.`,el:null},{tab:`budget`,title:`Import transactions`,text:`Tap "Import Transactions" to upload a bank CSV, or use the + button to log individual spends.`,el:`[onclick*="openCsvImport"]`,watchClick:!0}],netWorth:[{tab:`networth`,title:`Build your net worth picture`,text:`Add what you own (property, savings, super) as assets. Add what you owe (mortgage, loans, credit cards) as liabilities.`,el:null},{tab:`networth`,title:`Start adding`,text:`Use the buttons below to add your first asset or liability. Even rough numbers help build the picture.`,el:`#networth-content`}],goals:[{tab:`goals`,title:`Set a financial goal`,text:`Goals keep you motivated — a holiday fund, debt payoff, or savings target. Let's create your first one.`,el:null},{tab:`goals`,title:`Tap "+ New Goal"`,text:`Choose a goal type, set a target amount, and start tracking your progress.`,el:`[onclick*="openAddGoal"]`,watchClick:!0}]};function _l(e){let t=gl[e];t&&ul(t)}var vl=!1;function yl(e){vl=!0;let t=document.getElementById(`cv-readonly-bar`),n=document.getElementById(`cv-signout-btn`);t&&(t.style.display=``),n&&(n.style.display=`none`),window.showChildView(e)}function bl(e){vl=!0;let t=document.getElementById(`cv-readonly-bar`),n=document.getElementById(`cv-signout-btn`);t&&(t.style.display=``),n&&(n.style.display=`none`),window.showChildView(e),setTimeout(()=>{_cvSwitchTab(`calendar`,e)},50)}function xl(){let e=document.getElementById(`child-view-overlay`);e.classList.add(`hidden`),e.style.display=``;let t=document.getElementById(`cv-readonly-bar`),n=document.getElementById(`cv-signout-btn`);t&&(t.style.display=`none`),n&&(n.style.display=``);let r=vl;vl=!1,r||(window._activeProfile=null,window.clearKidSession(),window.switchProfile())}function Sl(){let e=Number(g.settings?.routineResetHour??0),t=new Date,n=new Date(t);n.setHours(e,0,0,0),t<n&&n.setDate(n.getDate()-1),n.toISOString().slice(0,10);let r=!1;(g.routineAssignments||[]).forEach(e=>{e.completionState&&Object.keys(e.completionState).forEach(e=>{})});let i=t.toISOString().slice(0,10);if(g.settings?.lastRoutineResetCheck!==i){if(g.settings||(g.settings={}),g.settings.lastRoutineResetCheck=i,g.kids?.completions){let e=g.kids.completions.length;g.kids.completions=g.kids.completions.filter(e=>e.status===`pending`?new Date(e.completedAt||e.ts||0).toISOString().slice(0,10)>=i:!0),g.kids.completions.length!==e&&(r=!0)}r=!0}r&&window.saveData(g)}function Cl(e,t){return!e||(e.pausePeriods||[]).some(e=>t>=e.from&&(!e.to||t<=e.to))||(e.skippedDates||[]).includes(t)?!1:Mt(e.recurrence||null,t)}var wl={morning:[{label:`Make bed`,emoji:`🛏`,durationMin:2},{label:`Shower`,emoji:`🚿`,durationMin:10},{label:`Breakfast`,emoji:`🍳`,durationMin:15},{label:`Exercise`,emoji:`💪`,durationMin:20},{label:`Meditate`,emoji:`🧘`,durationMin:10},{label:`Plan the day`,emoji:`📋`,durationMin:5},{label:`Read`,emoji:`📚`,durationMin:15},{label:`Vitamins`,emoji:`💊`,durationMin:1},{label:`Walk`,emoji:`🚶`,durationMin:20},{label:`Journaling`,emoji:`✍️`,durationMin:10}],evening:[{label:`Tidy kitchen`,emoji:`🍽`,durationMin:10},{label:`Prep tomorrow`,emoji:`👔`,durationMin:5},{label:`Family time`,emoji:`👨‍👩‍👧`,durationMin:30},{label:`Read`,emoji:`📚`,durationMin:20},{label:`Lights out`,emoji:`💤`,durationMin:0},{label:`Stretch`,emoji:`🤸`,durationMin:10},{label:`Review the day`,emoji:`🪞`,durationMin:5},{label:`Skincare`,emoji:`🧴`,durationMin:5},{label:`No screens`,emoji:`📵`,durationMin:0},{label:`Brush teeth`,emoji:`🦷`,durationMin:3}],general:[{label:`Drink water`,emoji:`💧`,durationMin:1},{label:`Check messages`,emoji:`📱`,durationMin:5},{label:`Quick tidy`,emoji:`🧹`,durationMin:5},{label:`Gratitude`,emoji:`🙏`,durationMin:3}]};function Tl(e){let t=e||new Date;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`}function U(){return Tl(new Date)}function El(){return window._currentUser?.uid||`guest`}function Dl(){let e=El();return(g.routines||[]).filter(t=>t.ownerType===`adult`&&(t.ownerId===e||(t.sharedWith||[]).includes(e)))}function Ol(){return(g.routines||[]).filter(e=>e.ownerType===`household`)}function kl(e){return e.ownerId===El()}function Al(){return g.kids?.profiles||[]}function jl(){return Date.now().toString(36)+Math.random().toString(36).slice(2)}function Ml(){return El(),(g.householdProfile?.authorizedUsers||[]).filter(e=>e.uid!==window.uid)}function Nl(e,t){return(g.routineAssignments||[]).find(n=>n.routineId===e&&n.childId===t)}function Pl(e){return(e?.completionState?.[U()]||[]).length}function Fl(e,t){if(!e)return 0;let n=0,r=new Date;for(;(e.completionState?.[Tl(r)]||[]).length===t&&t>0;)n++,r.setDate(r.getDate()-1);return n}function Il(e,t,n){let r=[],i=new Date;for(let a=n-1;a>=0;a--){let n=new Date(i);n.setDate(i.getDate()-a);let o=Tl(n),s=(e?.completionState?.[o]||[]).length;r.push({key:o,label:n.getDate(),done:s,total:t})}return r}function Ll(e){return(e.completions?.[U()]||[]).length}function Rl(e){let t=0,n=new Date;for(;(e.completions?.[Tl(n)]||[]).length===e.steps.length&&e.steps.length>0;)t++,n.setDate(n.getDate()-1);return t}function zl(e,t){let n=[],r=new Date;for(let i=t-1;i>=0;i--){let t=new Date(r);t.setDate(r.getDate()-i);let a=Tl(t),o=(e.completions?.[a]||[]).length;n.push({key:a,label:t.getDate(),done:o,total:e.steps.length})}return n}function Bl(e){let t=new Set(e.steps.map(e=>e.label.toLowerCase())),n=e.name.toLowerCase(),r;return r=n.includes(`morning`)?[...wl.morning,...wl.general]:n.includes(`evening`)||n.includes(`night`)||n.includes(`bed`)?[...wl.evening,...wl.general]:[...wl.morning,...wl.evening,...wl.general],r.filter(e=>!t.has(e.label.toLowerCase()))}function Vl(e){if(e.ownerType===`household`){if(e.ownerId!==`household`)throw Error(`Scope violation: household routine has ownerId="${e.ownerId}"`)}else if(e.ownerType===`adult`){if(!e.ownerId||e.ownerId===`household`)throw Error(`Scope violation: adult routine has ownerId="${e.ownerId}"`)}else throw Error(`Scope violation: unknown ownerType="${e.ownerType}"`)}function Hl(e){(g.routines||[]).forEach(t=>{try{Vl(t)}catch(n){console.error(`[Routines] ${e}:`,n.message,t)}}),window.saveData(g)}function Ul(){let e=Dl(),t=new Date().getHours();for(let n of e){let e=Ll(n),r=n.steps.length;if(!r)continue;let[i]=(n.triggerTime||`00:00`).split(`:`).map(Number),a=Rl(n);if(t>=i+1&&e===0)return{icon:n.emoji,text:`Your ${n.name} routine hasn't been started yet.`};if(a>0&&a%7==0)return{icon:`🔥`,text:`${a}-day streak on your ${n.name} routine — keep it up!`};if(e>0&&e===r-1)return{icon:n.emoji,text:`One step left in your ${n.name} routine!`}}return null}function Wl(){let e=new Date().toISOString().slice(0,10),t=Dl().filter(t=>Cl(t,e));if(!t.length)return``;let n=new Date().getHours(),r=t.map(e=>{let t=Ll(e),r=e.steps.length,i=r>0?Math.round(t/r*100):0,[a]=(e.triggerTime||`00:00`).split(`:`).map(Number),o=n>=a+1&&t===0&&r>0;return`<div class="routine-today-row">
    ...
    </div>`}).join(``),i=Ul();return`${i?`<div class="routine-intel-nudge" onclick="activateTab('routines')" style="margin-bottom:8px">
  ...
  </div>`}var Gl=`mine`;Object.defineProperty(window,`_routineActiveTab`,{get(){return Gl},set(e){Gl=e},configurable:!0});function W(){let e=document.getElementById(`routines-content`);if(!e)return;let t=Al(),n=t.length>0,r=`<div class="page-header" style="margin-bottom:4px">
    <h1>Routines</h1>
  ...
  <div style="display:flex;justify-content:flex-end;margin-bottom:16px">
    <button class="btn btn-primary btn-sm" onclick="_routineCreate()">＋ New routine</button>
      ...
      <button class="routine-tab${Gl===`mine`?` active`:``}" onclick="_routineSetTab('mine')">My Routines</button>
      <button class="routine-tab${Gl===`children`?` active`:``}" onclick="_routineSetTab('children')">Children's Routines</button>
    </div>`),r+=Gl===`children`&&n?tu(t):ql(),e.innerHTML=r}function Kl(e){Gl=e,W()}function ql(){let e=El(),t=!1;(g.routines||[]).forEach(n=>{n.ownerType===`adult`&&(n.ownerId===`guest`||n.ownerId===`dev`)&&(n.ownerId=e,t=!0)}),t&&Hl(`lazy-uid-claim`);let n=new Date().toISOString().slice(0,10),r=Dl().filter(e=>Cl(e,n)),i=U(),a=``;return r.length?(r.forEach(e=>{let t=kl(e),n=e.linkedType===`join`,r=!t&&(e.sharedWith||[]).includes(window.uid),o=e.completions?.[i]||[],s=e.steps.length,c=s>0?Math.round(o.length/s*100):0,l=o.length===s&&s>0,u=Rl(e),d=e.steps.reduce((e,t)=>e+(t.durationMin||0),0),f=t&&!n,p=``;n?p=`<span class="routine-owner-badge routine-joined-badge">🔗 Joined</span>`:e.linkedType===`duplicate`?p=`<span class="routine-owner-badge">📋 Duplicated</span>`:r&&(p=`<span class="routine-owner-badge routine-shared-badge">👥 Shared with you</span>`);let m=e.steps.map((t,n)=>{let r=o.includes(t.id);return`<div class="routine-step"${f?` draggable="true" data-routine="'${e.id}'" data-step="'${t.id}'" data-idx="${n}"
    ...
    <div class="routine-new-card" onclick="_routineCreate()">
      <span style="font-size:22px">＋</span>
      <span class="routine-new-card-label">Create new routine</span>
    </div>`}var Jl={},Yl={};function Xl(e){Jl[e]=!Jl[e],W()}function Zl(e){Yl[e]=!0,W()}function Ql(e){let t=Bl(e);if(!t.length)return``;let n=!Jl[e.id],r=!!Yl[e.id],i=r?t:t.slice(0,3),a=t.length-3,o=e.ownerType===`household`,s=i.map(t=>`
  ...
  </div>`}function $l(e,t,n,r){window.openModal(`Add step`,`
  ...
  `,()=>{eu(e,document.getElementById(`rse-label`)?.value.trim()||t,document.getElementById(`rse-emoji`)?.value.trim()||n,parseInt(document.getElementById(`rse-dur`)?.value)||0,parseInt(document.getElementById(`rse-pts`)?.value)||0,document.getElementById(`rse-notes`)?.value.trim()||``)})}function eu(e,t,n,r,i,a){let o=(g.routines||[]).find(t=>String(t.id)===String(e));if(!o)return;let s=new Set([...o.steps.map(e=>e.id),...Object.values(o.completions||{}).flat(),...(g.routineAssignments||[]).filter(t=>t.routineId===e).flatMap(e=>Object.values(e.completionState||{}).flat())]),c=Math.max(0,...s)+1;for(;s.has(c);)c++;o.steps.push({id:c,label:t,emoji:n,durationMin:r||0,points:i||0,notes:a||``}),yu(o.id,o.steps[o.steps.length-1]),window.saveData(g),W()}function tu(e){let t=g.routineAssignments||[],n=Ol(),r=U();if(!n.length)return`<div style="text-align:center;padding:32px 20px;color:var(--text-muted)">
    ...
    <div class="routine-new-card" onclick="_routineCreate('child')">
      ...
      <span class="routine-new-card-label">Create children's routine</span>
        ...
        ${e.emoji||`👤`} ${T(e.name)}
      </span>`}).join(``),l=o.length?o.map(({kid:e,assignment:t})=>{let n=t.completionState?.[r]||[],i=s>0?Math.round(n.length/s*100):0,a=Fl(t,s),o=n.length===s&&s>0;return`<div style="display:flex;align-items:center;gap:8px;padding:4px 0">
  ...
  `,()=>{let e=document.getElementById(`rp-from`)?.value;if(!e)return;let n=document.getElementById(`rp-to`)?.value||void 0,r=document.getElementById(`rp-reason`)?.value.trim()||void 0;t.pausePeriods.push({from:e,to:n,reason:r}),window.saveData(g),window.closeModal(),W()})}function uu(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));!n||!n.pausePeriods||(n.pausePeriods.splice(t,1),window.saveData(g),window.closeModal(),W())}function du(e,t){let n=Nl(e,t);n&&(n.completionState&&delete n.completionState[U()],window.saveData(g),W())}function fu(e){let t=U();(g.routineAssignments||[]).filter(t=>t.routineId===e).forEach(e=>{e.completionState&&delete e.completionState[t]}),window.saveData(g),W()}var pu=null;Object.defineProperty(window,`_routineDragIdx`,{get(){return pu},set(e){pu=e},configurable:!0});function mu(e){pu=parseInt(e.currentTarget.dataset.idx),e.currentTarget.classList.add(`dragging`),e.dataTransfer.effectAllowed=`move`}function hu(e){e.preventDefault(),e.dataTransfer.dropEffect=`move`,document.querySelectorAll(`.routine-step.drag-over`).forEach(e=>e.classList.remove(`drag-over`)),e.currentTarget.classList.add(`drag-over`)}function gu(e,t){e.preventDefault();let n=parseInt(e.currentTarget.dataset.idx);if(pu===null||pu===n)return;let r=(g.routines||[]).find(e=>String(e.id)===String(t));if(!r)return;let i=r.steps.splice(pu,1)[0];r.steps.splice(n,0,i),pu=null,window.saveData(g),W()}function _u(e){e.currentTarget.classList.remove(`dragging`),document.querySelectorAll(`.routine-step.drag-over`).forEach(e=>e.classList.remove(`drag-over`)),pu=null}function vu(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=t.ownerType===`household`;window.openModal(`Add step`,`
    ...
    </div>`,()=>{let r=document.getElementById(`rs-label`)?.value.trim();if(!r)return;let i=new Set([...t.steps.map(e=>e.id),...Object.values(t.completions||{}).flat(),...(g.routineAssignments||[]).filter(t=>t.routineId===e).flatMap(e=>Object.values(e.completionState||{}).flat())]),a=Math.max(0,...i)+1;for(;i.has(a);)a++;let o={id:a,label:r,emoji:document.getElementById(`rs-emoji`)?.value.trim()||`✅`,durationMin:parseInt(document.getElementById(`rs-dur`)?.value)||0,points:n&&parseInt(document.getElementById(`rs-pts`)?.value)||0,notes:document.getElementById(`rs-notes`)?.value.trim()||``};t.steps.push(o),yu(t.id,o),window.saveData(g),window.closeModal(),W()}),setTimeout(()=>document.getElementById(`rs-label`)?.focus(),100)}function yu(e,t){(g.routines||[]).forEach(n=>{if(n.linkedType===`join`&&n.linkedFrom===e&&!n.steps.some(e=>e.label===t.label)){let e=Math.max(0,...n.steps.map(e=>e.id),0)+1;n.steps.push({...t,id:e})}})}function bu(e,t){(g.routines||[]).forEach(n=>{n.linkedType===`join`&&n.linkedFrom===e&&(n.steps=n.steps.filter(e=>e.label!==t))})}function xu(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=t.ownerType===`household`,r=t.steps.map(t=>`
  ...
  `,()=>{let e=document.getElementById(`re-name`)?.value.trim(),n=document.getElementById(`re-emoji`)?.value.trim(),r=document.getElementById(`re-time`)?.value;if(e&&(t.name=e),n&&(t.emoji=n),r&&(t.triggerTime=r),t.ownerType===`household`){let e=parseInt(document.getElementById(`re-pts`)?.value);isNaN(e)||(t.pointsPerCompletion=e)}t.recurrence=ku(),t.lastEditedBy=El(),t.lastEditedAt=new Date().toISOString(),window.saveData(g),window.closeModal(),W()}),setTimeout(()=>{Ou()},100)}function Su(e,t,n){let r=(g.routines||[]).find(t=>String(t.id)===String(e));if(!r)return;let i=r.steps.find(e=>e.id===t);r.steps=r.steps.filter(e=>e.id!==t),Object.keys(r.completions||{}).forEach(e=>{r.completions[e]=r.completions[e].filter(e=>e!==t)}),(g.routineAssignments||[]).filter(t=>t.routineId===e).forEach(e=>{Object.keys(e.completionState||{}).forEach(n=>{e.completionState[n]=e.completionState[n].filter(e=>e!==t)})}),i&&bu(r.id,i.label),window.saveData(g),n?(window.closeModal(),xu(e)):(window.closeModal(),W())}function Cu(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(!n)return;let r=n.steps.find(e=>e.id===t);if(!r)return;let i=n.ownerType===`household`;window.openModal(`Edit step`,`
    <div class="form-group" style="display:flex;gap:12px">
      <div style="flex:1"><label class="form-label">Label</label>
  ...
  `,()=>{let e=document.getElementById(`rst-label`)?.value.trim();e&&(r.label=e,r.emoji=document.getElementById(`rst-emoji`)?.value.trim()||r.emoji,r.durationMin=parseInt(document.getElementById(`rst-dur`)?.value)||0,r.notes=document.getElementById(`rst-notes`)?.value.trim()||``,i&&(r.points=parseInt(document.getElementById(`rst-pts`)?.value)||0),window.saveData(g),window.closeModal(),W())})}function wu(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=Al();if(!n.length){window.openModal(`Assign`,`<p style="color:var(--text-muted);font-size:13px">No children in this household yet.</p>`,()=>window.closeModal());return}let r=g.routineAssignments||[],i=n.map(t=>{let n=r.some(n=>n.routineId===e&&n.childId===t.id);return`<div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid var(--border)">
    ...
    ${i}
  `,()=>window.closeModal())}function Tu(e,t){g.routineAssignments||(g.routineAssignments=[]);let n=Nl(e,t);n?(n.archivedCompletionState=JSON.parse(JSON.stringify(n.completionState||{})),n.archivedAt=new Date().toISOString(),g.routineAssignments=g.routineAssignments.filter(n=>!(n.routineId===e&&n.childId===t))):g.routineAssignments.push({id:window.uid(),routineId:e,childId:t,assignedBy:El(),assignedAt:new Date().toISOString(),completionState:{},archivedCompletionState:null,childIds:[t]}),window.saveData(g),W()}function Eu(e){let t=e?.type||`daily`,n=e?.startDate||new Date().toISOString().slice(0,10),r=e?.endDate||``,i=e?.intervalDays||2,a=e?.days||[];return`
    <div class="form-group">
    ...
    <div id="rn-rec-summary" style="font-size:12px;color:var(--primary);font-weight:600;padding:8px 12px;background:var(--primary-light);border-radius:8px;margin-bottom:4px"></div>`}function Du(){let e=document.getElementById(`rn-rec-type`)?.value;e&&(document.getElementById(`rn-rec-days`).style.display=e===`specific_days`?`flex`:`none`,document.getElementById(`rn-rec-interval`).style.display=e===`interval`?`flex`:`none`,Ou())}function Ou(){let e=document.getElementById(`rn-rec-summary`);if(!e)return;let t=document.getElementById(`rn-rec-type`)?.value,n={daily:`Every day`,weekdays:`Mon – Fri`,weekends:`Sat & Sun`,one_time:`Once only`};if(n[t]){e.textContent=n[t];return}if(t===`specific_days`){let t=[...document.querySelectorAll(`input[name="rn-rec-dow"]:checked`)].map(e=>[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`][e.value]);e.textContent=t.length?t.join(`, `):`No days selected`}else t===`interval`&&(e.textContent=`Every ${document.getElementById(`rn-rec-interval-days`)?.value||2} days`)}function ku(){let e=document.getElementById(`rn-rec-type`)?.value||`daily`,t=document.getElementById(`rn-rec-start`)?.value||new Date().toISOString().slice(0,10),n=document.getElementById(`rn-rec-end`)?.value||void 0,r={type:e,startDate:t};return n&&(r.endDate=n),e===`specific_days`&&(r.days=[...document.querySelectorAll(`input[name="rn-rec-dow"]:checked`)].map(e=>e.value)),e===`interval`&&(r.intervalDays=parseInt(document.getElementById(`rn-rec-interval-days`)?.value)||2),r}function Au(e){let t=e===`child`;window.openModal(`New routine`,`
    <div class="form-group">
    ...
    ${Eu(null)}
  `,()=>{let e=document.getElementById(`rn-name`)?.value.trim();if(!e)return;let t=document.querySelector(`input[name="rn-type"]:checked`)?.value||`adult`,n=document.getElementById(`rn-emoji`)?.value.trim()||`📋`,r=document.getElementById(`rn-time`)?.value||(t===`child`?`19:30`:`08:00`),i=parseInt(document.getElementById(`rn-pts`)?.value)||0,a=El(),o=jl(),s=ku();if(t===`adult`){let t={id:o,name:e,emoji:n,triggerTime:r,steps:[],completions:{},assignedTo:[],ownerType:`adult`,ownerId:a,sharedWith:[],linkedFrom:null,linkedType:null,pointsPerCompletion:0,recurrence:s,skippedDates:[],pausePeriods:[]};Vl(t),g.routines.push(t),Hl(`create:adult`),window.closeModal(),Gl=`mine`}else{let t={id:o,name:e,emoji:n,triggerTime:r,steps:[],completions:{},assignedTo:[],ownerType:`household`,ownerId:`household`,sharedWith:[],linkedFrom:null,linkedType:null,pointsPerCompletion:i,createdBy:a,lastEditedBy:a,lastEditedAt:new Date().toISOString(),recurrence:s,skippedDates:[],pausePeriods:[]};Vl(t),g.routines.push(t),Hl(`create:child`),window.closeModal(),Gl=`children`}W()}),setTimeout(()=>{document.getElementById(`rn-name`)?.focus(),Ou()},100)}function ju(e){document.querySelectorAll(`input[name="rn-type"]`).forEach(t=>t.checked=t.value===e),document.getElementById(`rn-type-adult`)?.classList.toggle(`selected`,e===`adult`),document.getElementById(`rn-type-child`)?.classList.toggle(`selected`,e===`child`);let t=document.getElementById(`rn-time`);t&&(t.value=e===`child`?`19:30`:`08:00`);let n=document.getElementById(`rn-pts-group`);n&&(n.style.display=e===`child`?`block`:`none`)}function Mu(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));t&&confirm(`Delete "${t.name}"? This cannot be undone.`)&&(g.routines=g.routines.filter(t=>t.id!==e),g.routineAssignments=(g.routineAssignments||[]).filter(t=>t.routineId!==e),window.saveData(g),W())}function Nu(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));t&&confirm(`Leave "${t.name}"? Your completion history will be removed.`)&&(g.routines=g.routines.filter(t=>t.id!==e),window.saveData(g),W())}function Pu(e,t){if(!confirm(`Unassign this child? Their completion history will be archived.`))return;let n=Nl(e,t);n&&(n.archivedCompletionState=JSON.parse(JSON.stringify(n.completionState||{})),n.archivedAt=new Date().toISOString()),g.routineAssignments=(g.routineAssignments||[]).filter(n=>!(n.routineId===e&&n.childId===t)),(g.routineAssignments||[]).some(t=>t.routineId===e)||(g.routines=g.routines.filter(t=>t.id!==e)),window.saveData(g),W()}function Fu(e){let t=(g.routines||[]).find(t=>String(t.id)===String(e));if(!t)return;let n=Ml();if(!n.length){window.openModal(`Share routine`,`<p style="color:var(--text-muted);font-size:13px">No other adults have joined yet. Invite them via Settings → Household first.</p>`,()=>window.closeModal());return}let r=t.sharedWith||[],i=n.map(t=>{let n=r.includes(t.uid);return`<div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid var(--border)">
    ...
    ${i}
  `,()=>window.closeModal())}function Iu(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(!n)return;n.sharedWith||(n.sharedWith=[]);let r=n.sharedWith.indexOf(t);r===-1?n.sharedWith.push(t):n.sharedWith.splice(r,1),window.saveData(g),window.closeModal(),Fu(e)}function Lu(e){let t=(g.routines||[]).find(t=>t.id===e);if(!t)return;El();let n={...JSON.parse(JSON.stringify(t)),id:jl(),ownerId:window.uid,ownerType:`adult`,sharedWith:[],completions:{},linkedFrom:e,linkedType:`duplicate`};g.routines.push(n),window.saveData(g),window.closeModal(),W()}function Ru(e){let t=(g.routines||[]).find(t=>t.id===e);if(!t)return;if(El(),(g.routines||[]).some(t=>t.linkedFrom===e&&t.linkedType===`join`&&t.ownerId===window.uid)){alert(`You have already joined this routine.`);return}let n={...JSON.parse(JSON.stringify(t)),id:jl(),ownerId:window.uid,ownerType:`adult`,sharedWith:[],completions:{},linkedFrom:e,linkedType:`join`};g.routines.push(n),window.saveData(g),window.closeModal(),W()}function zu(e){let t=(g.routines||[]).find(t=>t.id===e);t?.linkedFrom&&Lu(t.linkedFrom)}function Bu(e,t){let n=(g.routines||[]).find(t=>String(t.id)===String(e));if(!n)return;let r=n.steps.length,i,a,o;if(t){let s=Nl(e,t),c=Al().find(e=>e.id===t);i=Il(s,r,90),a=Fl(s,r),o=`${n.emoji} ${n.name} — ${c?.name||`Child`}`}else i=zl(n,90),a=Rl(n),o=`${n.emoji} ${n.name} — History`;let s=i.filter(e=>e.done===e.total&&e.total>0).length,c=i.filter(e=>e.done>0&&e.done<e.total).length,l=i.map(e=>{let t=e.done===e.total&&e.total>0?`full`:e.done>0?`partial`:`empty`,n=e.done===e.total&&e.total>0?`✓`:e.done>0?`${e.done}`:``;return`<div class="routine-history-dot ${t}" title="${e.key}: ${e.done}/${e.total}">${n}</div>`}).join(``);window.openModal(o,`
  ...
  `,()=>window.closeModal())}var Vu=`parent`,Hu=`overview`;Object.defineProperty(window,`kidsView`,{get(){return Vu},set(e){Vu=e},configurable:!0}),Object.defineProperty(window,`kidsParentTab`,{get(){return Hu},set(e){Hu=e},configurable:!0});function Uu(){return Date.now().toString(36)+Math.random().toString(36).slice(2)}function G(){let e=document.getElementById(`kids-content`);if(!e)return;let t=g.kids;if(Vu===`parent`)Gu(e,t,t.completions.filter(e=>e.status===`pending`).length+t.redemptions.filter(e=>e.status===`pending`).length);else{let n=t.profiles.find(e=>e.id===Vu);n?Xu(e,t,n):(Vu=`parent`,G())}}function Wu(e,t){return e.completions.filter(e=>e.kidId===t&&e.status===`approved`).reduce((t,n)=>t+(e.chores.find(e=>e.id===n.choreId)?.points||0),0)-e.redemptions.filter(e=>e.kidId===t&&e.status===`approved`).reduce((t,n)=>t+(e.prizes.find(e=>e.id===n.prizeId)?.pointCost||0),0)}function Gu(e,t,n){let r=`
    <div style="display:flex;justify-content:flex-end;margin-bottom:16px">
    ...
    <div style="text-align:center;padding:60px 20px">
    ...
    </div>`;let t=`<div class="kids-grid">`;return e.profiles.forEach(n=>{let r=Wu(e,n.id),i=e.chores.filter(e=>e.assignedTo===n.id||e.assignedTo===`all`).length,a=e.completions.filter(e=>e.kidId===n.id&&e.status===`pending`).length;t+=`
      ...
      </div>`}),t+=`</div>`,t}function qu(e){let t=`<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
    ...
    </div>`}),t}function Ju(e){let t=`<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
    ...
    <button class="btn btn-primary btn-sm" onclick="openPrizeModal()">+ Add Prize</button>
      ...
      </div>`)})),r}function Xu(e,t,n){let r=Wu(t,n.id),i=t.chores.filter(e=>e.assignedTo===n.id||e.assignedTo===`all`),a=new Set(t.completions.filter(e=>e.kidId===n.id&&e.status===`pending`).map(e=>e.choreId)),o=new Date().toDateString(),s=new Set(t.completions.filter(e=>e.kidId===n.id&&e.status===`approved`&&new Date(e.completedAt).toDateString()===o).map(e=>e.choreId)),c=`
    ...
    <div style="font-size:15px;font-weight:700;margin-bottom:12px">Prize Shelf 🎁</div>`,t.prizes.length?t.prizes.forEach(e=>{let i=r>=e.pointCost,a=t.redemptions.some(t=>t.prizeId===e.id&&t.kidId===n.id&&t.status===`pending`);c+=`<div class="prize-card ${i&&!a?`can-afford`:``} ${a?`pending-redemption`:``}">
      ...
      </div>`}):c+=`<div style="color:#64748b;font-size:13px;padding:20px;text-align:center;background:#f8fafc;border-radius:10px">No prizes on the shelf yet!</div>`,c+=`</div></div>`,e.innerHTML=c}function Zu(){let e=g.childEvents||[],t=g.kids?.profiles||[],n=`<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
    ...
    </div>`}var Qu=[`📅`,`⚽`,`🏊`,`🎓`,`🎂`,`🎨`,`🏃`,`🎭`,`🚌`,`🎡`,`🏖`,`🎪`];function $u(e){let t=e?(g.childEvents||[]).find(t=>t.id===e):null,n=g.kids?.profiles||[];window.openModal(t?`Edit Event`:`Add Event`,`
  ...
  `,()=>{let e=document.getElementById(`ce-title`)?.value.trim();if(!e)return;let t=document.getElementById(`ce-emoji`)?.value.trim()||`📅`,n=document.getElementById(`ce-date`)?.value,r=document.getElementById(`ce-time`)?.value||void 0,i=document.getElementById(`ce-who`)?.value,a=document.getElementById(`ce-notes`)?.value.trim()||``,o=_routineRecurrenceCollect(),s=document.getElementById(`ce-id`)?.value;if(g.childEvents||(g.childEvents=[]),s){let c=g.childEvents.find(e=>e.id===s);c&&Object.assign(c,{title:e,emoji:t,date:n,time:r,notes:a,recurrence:o,isHouseholdWide:i===`all`,assignedTo:i===`all`?`all`:[i]})}else g.childEvents.push({id:Uu(),title:e,emoji:t,date:n,time:r,notes:a,recurrence:o,assignedTo:i===`all`?`all`:[i],isHouseholdWide:i===`all`,createdBy:_routineCurrentUserId()});window.saveData(g),window.closeModal(),G()}),setTimeout(()=>{_routineRecurrenceSummaryUpdate()},100)}function ed(e){confirm(`Delete this event?`)&&(g.childEvents=(g.childEvents||[]).filter(t=>t.id!==e),window.saveData(g),G())}function td(e,t){g.kids.completions.push({id:Uu(),choreId:e,kidId:t,completedAt:Date.now(),status:`pending`}),window.saveData(g),G()}function nd(e){let t=g.kids.completions.find(t=>t.id===e);t&&(t.status=`approved`,t.approvedAt=Date.now()),window.saveData(g),G()}function rd(e){let t=g.kids.completions.find(t=>t.id===e);t&&(t.status=`rejected`),window.saveData(g),G()}function id(e,t){g.kids.redemptions.push({id:Uu(),prizeId:e,kidId:t,requestedAt:Date.now(),status:`pending`}),window.saveData(g),G()}function ad(e){let t=g.kids.redemptions.find(t=>t.id===e);if(t){t.status=`approved`,t.approvedAt=Date.now();let e=(g.kids.prizes||[]).find(e=>e.id===t.prizeId);g.kids.notifications||(g.kids.notifications=[]),g.kids.notifications.push({id:Uu(),kidId:t.kidId,type:`prize_approved`,prizeId:t.prizeId,prizeName:e?.name||`Prize`,prizeEmoji:e?.emoji||`🎁`,ts:Date.now(),read:!1})}window.saveData(g),G()}function od(e){let t=g.kids.redemptions.find(t=>t.id===e);if(t){t.status=`rejected`;let e=(g.kids.prizes||[]).find(e=>e.id===t.prizeId);g.kids.notifications||(g.kids.notifications=[]),g.kids.notifications.push({id:Uu(),kidId:t.kidId,type:`prize_declined`,prizeId:t.prizeId,prizeName:e?.name||`Prize`,prizeEmoji:e?.emoji||`🎁`,ts:Date.now(),read:!1})}window.saveData(g),G()}function sd(e){g.kids.chores=g.kids.chores.filter(t=>t.id!==e),window.saveData(g),G()}function cd(e){g.kids.prizes=g.kids.prizes.filter(t=>t.id!==e),window.saveData(g),G()}var ld=[`😊`,`🦁`,`🐯`,`🐻`,`🦊`,`🐸`,`🐧`,`🦋`,`🌟`,`🎈`,`🚀`,`⚡`],ud=[`🧹`,`🍽`,`🐕`,`🛏`,`📚`,`🌿`,`🧺`,`🗑`,`🧽`,`🚿`,`🛒`,`🪴`],dd=[`🍦`,`🎬`,`🎮`,`🍕`,`🎁`,`💰`,`🏖`,`🎡`,`🎨`,`👟`,`📱`,`🎭`];function fd(e,t){return`<div style="display:flex;flex-wrap:wrap;gap:6px" id="emoji-pick">
  ...
  </div>`}function pd(e){e.closest(`#emoji-pick`).querySelectorAll(`button`).forEach(e=>{e.style.borderColor=`var(--border)`,e.style.background=`none`}),e.style.borderColor=`#0891b2`,e.style.background=`#ecfeff`}function md(e){let t=document.querySelector(`#emoji-pick button[style*="#0891b2"]`);return t?t.dataset.e:e}function hd(){gd(null)}function gd(e){let t=e?g.kids.profiles.find(t=>String(t.id)===String(e)):null;document.getElementById(`modal-title`).textContent=t?`Edit Kid`:`Add Kid`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <div class="form-group"><label class="form-label">Avatar</label>${fd(ld,t?.emoji||`😊`)}</div>
    <div class="form-group">
  ...
  `,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Cancel</button><button class="btn btn-primary" onclick="saveKid()">Save</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function _d(){let e=document.getElementById(`k-name`).value.trim();if(!e)return;let t=parseInt(document.getElementById(`k-age`).value)||null,n=md(`😊`),r=document.getElementById(`k-id`)?.value;if(r){let i=g.kids.profiles.find(e=>String(e.id)===String(r));i&&Object.assign(i,{name:e,emoji:n,age:t})}else g.kids.profiles.push({id:Uu(),name:e,emoji:n,age:t,savings:0});window.saveData(g),window.closeModal(),G()}function vd(e){let t=g.kids.profiles.find(t=>String(t.id)===String(e));t&&confirm(`Remove ${t.name} from this household?\n\nThis will permanently delete their chores, prizes and points history. This cannot be undone.`)&&(g.kids.profiles=g.kids.profiles.filter(t=>t.id!==e),g.kids.chores=g.kids.chores.filter(t=>t.assignedTo!==e),g.kids.completions=g.kids.completions.filter(t=>t.kidId!==e),g.kids.redemptions=g.kids.redemptions.filter(t=>t.kidId!==e),g.meals?.lunchbox?.profiles&&(g.meals.lunchbox.profiles=g.meals.lunchbox.profiles.filter(t=>t.id!==e)),g.childEvents&&(g.childEvents=g.childEvents.filter(t=>{if(t.isHouseholdWide)return!0;let n=(Array.isArray(t.assignedTo)?t.assignedTo:[t.assignedTo]).filter(t=>t!==e);return n.length?(t.assignedTo=n,!0):!1})),window.getDeviceProfile()===e&&window.setDeviceProfile(`adult`),window.saveData(g),window.closeModal(),Vu=`parent`,G())}function yd(e){let t=e?g.kids.chores.find(t=>t.id===e):null,n=g.kids.profiles;document.getElementById(`modal-title`).textContent=t?`Edit Chore`:`Add Chore`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <div class="form-group"><label class="form-label">Emoji</label>${fd(ud,t?.emoji||`🧹`)}</div>
    <div class="form-row">
  ...
  `,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Cancel</button><button class="btn btn-primary" onclick="saveChore()">Save Chore</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function bd(){let e=document.getElementById(`c-name`).value.trim();if(!e)return;let t=parseInt(document.getElementById(`c-pts`).value)||10,n=document.getElementById(`c-freq`).value,r=document.getElementById(`c-who`).value,i=md(`🧹`),a=document.getElementById(`c-id`)?.value;if(a){let o=g.kids.chores.find(e=>e.id===a);o&&Object.assign(o,{name:e,emoji:i,points:t,frequency:n,assignedTo:r})}else g.kids.chores.push({id:Uu(),name:e,emoji:i,points:t,frequency:n,assignedTo:r});window.saveData(g),window.closeModal(),G()}function xd(e){let t=e?g.kids.prizes.find(t=>String(t.id)===String(e)):null;document.getElementById(`modal-title`).textContent=t?`Edit Prize`:`Add Prize`,document.getElementById(`modal-body`).innerHTML=`
    ...
    <div class="form-group"><label class="form-label">Emoji</label>${fd(dd,t?.emoji||`🎁`)}</div>
    <div class="form-row">
  ...
  `,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Cancel</button><button class="btn btn-primary" onclick="savePrize()">Save Prize</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Sd(){let e=document.getElementById(`p-name`).value.trim();if(!e)return;let t=parseInt(document.getElementById(`p-cost`).value)||50,n=document.getElementById(`p-type`).value,r=document.getElementById(`p-desc`).value.trim(),i=md(`🎁`),a=document.getElementById(`p-id`)?.value;if(a){let o=g.kids.prizes.find(e=>e.id===a);o&&Object.assign(o,{name:e,emoji:i,pointCost:t,type:n,description:r})}else g.kids.prizes.push({id:Uu(),name:e,emoji:i,pointCost:t,type:n,description:r});window.saveData(g),window.closeModal(),G()}function Cd(e){let t=g.kids.profiles.find(t=>t.id===e);t&&(document.getElementById(`modal-title`).textContent=`${t.emoji} ${t.name}'s Savings Jar`,document.getElementById(`modal-body`).innerHTML=`
  ...
  `,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Cancel</button><button class="btn btn-primary" onclick="addSavings('${e}')">Add to Jar 💰</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`))}function wd(e){let t=parseFloat(document.getElementById(`s-amount`).value)||0;if(!t)return;let n=g.kids.profiles.find(t=>t.id===e);n&&(n.savings=(n.savings||0)+t),window.saveData(g),window.closeModal(),G()}var Td=null,Ed={};function Dd(){return Td?Promise.resolve(Td):new Promise((e,t)=>{let n=indexedDB.open(`home_finance_receipts`,1);n.onupgradeneeded=e=>{let t=e.target.result;t.objectStoreNames.contains(`receipts`)||t.createObjectStore(`receipts`,{keyPath:`id`,autoIncrement:!0}).createIndex(`itemKey`,`itemKey`,{unique:!1})},n.onsuccess=t=>{Td=t.target.result,e(Td)},n.onerror=()=>t(n.error)})}async function Od(){let e=await Dd();return new Promise(t=>{let n=e.transaction(`receipts`,`readonly`).objectStore(`receipts`).getAll();n.onsuccess=()=>{Ed={},n.result.forEach(e=>{Ed[e.itemKey]=(Ed[e.itemKey]||0)+1}),t()}})}async function kd(e){let t=await Dd();return new Promise(n=>{let r=t.transaction(`receipts`,`readonly`).objectStore(`receipts`).index(`itemKey`).getAll(e);r.onsuccess=()=>n(r.result)})}async function Ad(e,t){let n=await Dd();return new Promise((r,i)=>{let a=n.transaction(`receipts`,`readwrite`).objectStore(`receipts`).add({itemKey:e,fileName:t.name,fileType:t.type,fileSize:t.size,data:t,uploadedAt:new Date().toISOString()});a.onsuccess=()=>r(),a.onerror=()=>i(a.error)})}async function jd(e){let t=await Dd();return new Promise(n=>{let r=t.transaction(`receipts`,`readwrite`);r.objectStore(`receipts`).delete(e),r.oncomplete=n})}function Md(e){return e===`own-funds`?`<span class="badge" style="background:#ecfeff;color:#166534;border:1px solid #bbf7d0">Own Funds</span>`:`<span class="badge" style="background:#eff6ff;color:#1e40af;border:1px solid #bfdbfe">Loan</span>`}function Nd(e,t){let n=Ed[e]||0;return`<button class="attach-btn${n?` has-files`:``}" onclick="openReceiptsModal('${e}','${t.replace(/'/g,`\\'`)}')" title="${n?n+` receipt(s)`:`Add receipt`}">📎${n?` ${n}`:``}</button>`}function Pd(e){return e>1048576?`${(e/1048576).toFixed(1)} MB`:`${Math.round(e/1024)} KB`}function Fd(e){return e===`application/pdf`?`📄`:e.startsWith(`image/`)?`🖼️`:`📎`}async function Id(e,t){window.openModal(`Receipts — ${t}`,`<div style="padding:20px;text-align:center;color:var(--text-muted)">Loading…</div>`,()=>{}),document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-ghost" onclick="window.closeModal()">Close</button>`,await Ld(e,t)}async function Ld(e,t){let n=e,r=t.replace(/'/g,`\\'`),i=await kd(e),a=``;i.length?i.forEach(e=>{let t=e.type===`link`,i=t?`🔗`:Fd(e.fileType),o=t?e.linkName||e.url:e.fileName,s=t?`<span style="color:var(--text-muted);font-size:11px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:block;max-width:260px">${e.url}</span>`:`<span>${Pd(e.fileSize)} · ${new Date(e.uploadedAt).toLocaleDateString(`en-AU`)}</span>`,c=t?`<button class="btn btn-ghost btn-sm" onclick="window.open('${e.url.replace(/'/g,`\\'`).replace(/"/g,`&quot;`)}','_blank')">Open</button>`:`<button class="btn btn-ghost btn-sm" onclick="viewReceipt(${e.id})">View</button>`;a+=`
    ...
    <div class="drop-zone" id="drop-zone" onclick="document.getElementById('receipt-file-input').click()">
    ...
    </div>`,document.getElementById(`modal-body`).innerHTML=a;let o=document.getElementById(`drop-zone`);o.addEventListener(`dragover`,e=>{e.preventDefault(),o.classList.add(`drag-over`)}),o.addEventListener(`dragleave`,()=>o.classList.remove(`drag-over`)),o.addEventListener(`drop`,async n=>{n.preventDefault(),o.classList.remove(`drag-over`),await Bd(e,t,Array.from(n.dataTransfer.files))})}async function Rd(e,t){let n=document.getElementById(`link-url`).value.trim();if(!n){document.getElementById(`link-url`).focus();return}let r=document.getElementById(`link-name`).value.trim(),i=await Dd();await new Promise((t,a)=>{let o=i.transaction(`receipts`,`readwrite`).objectStore(`receipts`).add({itemKey:e,type:`link`,url:n,linkName:r,uploadedAt:new Date().toISOString()});o.onsuccess=t,o.onerror=()=>a(o.error)}),await Od(),renderBuild(),await Ld(e,t)}async function zd(e,t){let n=document.getElementById(`receipt-file-input`);await Bd(e,t,Array.from(n.files))}async function Bd(e,t,n){for(let t of n)await Ad(e,t);await Od(),renderBuild(),await Ld(e,t)}async function Vd(e){let t=await Dd(),n=await new Promise(n=>{let r=t.transaction(`receipts`,`readonly`).objectStore(`receipts`).get(e);r.onsuccess=()=>n(r.result)});if(n.type===`link`){window.open(n.url,`_blank`);return}let r=URL.createObjectURL(n.data);window.open(r,`_blank`),setTimeout(()=>URL.revokeObjectURL(r),15e3)}async function Hd(e,t,n){confirm(`Delete this receipt?`)&&(await jd(e),await Od(),renderBuild(),await Ld(t,n))}var Ud=null;window.addEventListener(`beforeinstallprompt`,e=>{e.preventDefault(),Ud=e;let t=document.getElementById(`install-btn`);t&&(t.style.display=`flex`)}),window.addEventListener(`appinstalled`,()=>{Ud=null;let e=document.getElementById(`install-btn`);e&&(e.style.display=`none`)});function Wd(){Ud&&(Ud.prompt(),Ud.userChoice.then(()=>{Ud=null}))}var Gd={building:[{name:`Mortgage / Rent`,category:`Mortgage / Rent`,amount:3e3},{name:`Groceries`,category:`Groceries`,amount:1200},{name:`Utilities`,category:`Utilities`,amount:400},{name:`Transport`,category:`Transport`,amount:500},{name:`Insurance`,category:`Insurance`,amount:350},{name:`Entertainment`,category:`Entertainment`,amount:200}],mortgage:[{name:`Mortgage`,category:`Mortgage / Rent`,amount:3500},{name:`Groceries`,category:`Groceries`,amount:1200},{name:`Utilities`,category:`Utilities`,amount:400},{name:`Transport`,category:`Transport`,amount:500},{name:`Insurance`,category:`Insurance`,amount:350},{name:`Entertainment`,category:`Entertainment`,amount:200}],renting:[{name:`Rent`,category:`Mortgage / Rent`,amount:2500},{name:`Groceries`,category:`Groceries`,amount:1200},{name:`Utilities`,category:`Utilities`,amount:300},{name:`Transport`,category:`Transport`,amount:500},{name:`Insurance`,category:`Insurance`,amount:250},{name:`Entertainment`,category:`Entertainment`,amount:200}],own:[{name:`Groceries`,category:`Groceries`,amount:1200},{name:`Utilities`,category:`Utilities`,amount:400},{name:`Transport`,category:`Transport`,amount:500},{name:`Insurance`,category:`Insurance`,amount:400},{name:`Health`,category:`Health`,amount:300},{name:`Entertainment`,category:`Entertainment`,amount:300}]},K={step:1,adults:2,adultNames:[``,``],adultAges:[``,``],kids:0,kidProfiles:[],homeType:`mortgage`,incomes:[{name:``,amount:``,frequency:`Monthly`}],expenses:[],_emojiPickerOpen:null};function Kd(){return K.kids>0?[1,2,3,4,5,6]:[1,2,4,5,6]}function qd(){return Kd().indexOf(K.step)}function Jd(){K={step:1,adults:2,adultNames:[``,``],adultAges:[``,``],kids:0,kidProfiles:[],homeType:`mortgage`,incomes:[{name:``,amount:``,frequency:`Monthly`}],expenses:[],_emojiPickerOpen:null},document.getElementById(`onboarding-overlay`).style.display=`flex`,tf()}function Yd(){document.getElementById(`onboarding-overlay`).style.display=`none`}function Xd(e){for(K.adults=e;K.adultNames.length<e;)K.adultNames.push(``);for(K.adultNames=K.adultNames.slice(0,e);K.adultAges.length<e;)K.adultAges.push(``);K.adultAges=K.adultAges.slice(0,e),tf()}function Zd(e){K.kids=e,K.kidProfiles.length>e&&(K.kidProfiles=K.kidProfiles.slice(0,e)),tf()}function Qd(e){K._emojiPickerOpen=K._emojiPickerOpen===e?null:e,tf()}function $d(e,t){K.kidProfiles[e].emoji=t,K._emojiPickerOpen=null,tf()}function ef(e){K.expenses[e].skipped=!K.expenses[e].skipped,tf()}function tf(){let e=document.getElementById(`onboarding-card`),t=Kd(),n=qd(),r=K.step,i=t.map((e,t)=>`<div class="ob-dot ${t<n?`done`:t===n?`active`:``}"></div>`).join(``),a=``,o=``,s=``;if(r===1)a=`
      ...
      <button class="ob-back" onclick="obBack()">← Back</button>
      <button class="ob-next" onclick="obNext()">Continue →</button>`}else if(r===5)K.expenses.length||(K.expenses=Gd[K.homeType].map(e=>({...e,skipped:!1})),K.kids>0&&K.expenses.push({name:`Kids activities / sport`,category:`Childcare / Education`,amount:300,skipped:!1})),a=`
      <div class="ob-step-dots">${i}</div>
    ...
    <div class="ob-footer">${s}</div>`}function nf(){let e=Kd(),t=qd();if(t>=e.length-1){sf();return}if(K.step===2){if(K.adultNames.some(e=>!e.trim())){K._nameError=!0,tf();return}K._nameError=!1}let n=e[t+1];n===3&&(K.kidProfiles=Array.from({length:K.kids},(e,t)=>K.kidProfiles[t]||{name:``,age:``,emoji:KID_EMOJIS[t%KID_EMOJIS.length]})),n===5&&!K.expenses.length&&(K.expenses=Gd[K.homeType].map(e=>({...e,skipped:!1})),K.kids>0&&K.expenses.push({name:`Kids activities / sport`,category:`Childcare / Education`,amount:300,skipped:!1})),K.step=n,tf()}function rf(){let e=Kd(),t=qd();t<=0||(K.step=e[t-1],tf())}function af(){g.onboarded=!0,window.saveData(g),Yd()}function of(){K.expenses=[];let e=Kd(),t=qd();K.step=e[t+1],tf()}function sf(){g.householdProfile.members=[];for(let e=0;e<K.adults;e++)g.householdProfile.members.push({role:`adult`,name:K.adultNames[e]||``,age:K.adultAges[e]?parseInt(K.adultAges[e]):null});g.kids||(g.kids={profiles:[],chores:[],prizes:[],completions:[],redemptions:[]}),g.meals||(g.meals={}),g.meals.lunchbox||(g.meals.lunchbox={profiles:[]}),g.meals.lunchbox.profiles||(g.meals.lunchbox.profiles=[]),g.kids.profiles=[],g.meals.lunchbox.profiles=[],K.kidProfiles.forEach(e=>{if(g.householdProfile.members.push({role:`child`,name:e.name,age:e.age?parseInt(e.age):null,emoji:e.emoji}),!e.name)return;let t=nextId(g.kids.profiles);g.kids.profiles.push({id:t,name:e.name,age:e.age?parseInt(e.age):null,emoji:e.emoji}),g.meals.lunchbox.profiles.push({id:t,name:e.name,emoji:e.emoji})}),g.householdProfile.homeType=K.homeType;let e=window.ensureMonthOverride(window.selectedBudgetMonth);K.incomes.forEach((t,n)=>{let r=parseFloat(t.amount);if(!r)return;let i=t.frequency===`Weekly`?r*52/12:t.frequency===`Fortnightly`?r*26/12:t.frequency===`Annual`?r/12:r,a=t.name||(K.adultNames[n]?`${K.adultNames[n]}'s salary`:`Income ${n+1}`);e.income.push({id:nextId(e.income),name:a,amount:i,frequency:`monthly`,category:`Salary`})}),K.expenses.forEach(t=>{t.skipped||!t.amount||e.expenses.push({id:nextId(e.expenses),name:t.name,amount:t.amount,frequency:`monthly`,category:t.category,recurring:!0})}),g.onboarded=!0,window.saveData(g),Yd(),window.renderAll()}document.getElementById(`btn-guest-mode`)?.addEventListener(`click`,()=>Sf()),document.getElementById(`btn-google-signin`)?.addEventListener(`click`,()=>xf());function cf(){document.getElementById(`sidebar`).classList.toggle(`collapsed`)}var lf={};function uf(e){let t=document.getElementById(`icon-group-${e}`),n=document.getElementById(`icon-group-${e}-children`),r=document.getElementById(`text-group-${e}`),i=document.getElementById(`text-group-${e}-children`),a=n&&n.classList.contains(`open`);t&&t.classList.toggle(`open`,!a),n&&n.classList.toggle(`open`,!a),r&&r.classList.toggle(`open`,!a),i&&i.classList.toggle(`open`,!a)}function df(e){for(let[t,n]of Object.entries(lf))if(n.includes(e)){let e=document.getElementById(`icon-group-${t}-children`);e&&!e.classList.contains(`open`)&&uf(t);return}}window.addEventListener(`unhandledrejection`,e=>{console.error(`[unhandledrejection]`,e.reason)}),window.addEventListener(`error`,e=>{console.error(`[uncaughtError]`,e.message,e.filename,e.lineno)});var ff=`toto_household_owner`,pf=`toto_pending_household`;function mf(){return sessionStorage.getItem(pf)||Uf(ff)||q?.uid||null}function hf(){let e=mf();return e?fbStore.collection(`families`).doc(e):null}function gf(e){Wf(ff,e),sessionStorage.removeItem(pf)}var q=null,_f=!1,vf=null;Object.defineProperty(window,`_fsUnsubscribe`,{get(){return vf},set(e){vf=e},configurable:!0});var yf=null;Object.defineProperty(window,`_pendingLogEntry`,{get(){return yf},set(e){yf=e},configurable:!0}),Object.defineProperty(window,`_currentUser`,{get(){return q},set(e){q=e},configurable:!0});function bf(e,t){yf={ts:new Date().toISOString(),name:q&&(q.displayName||q.email)||`Unknown`,photo:q&&q.photoURL||``,action:e,detail:t||``}}function xf(){let e=new fbAuth.GoogleAuthProvider;fbAuth.signInWithPopup(e).catch(e=>{let t=document.getElementById(`login-error`);t&&(t.textContent=e.message,t.style.display=``)})}async function Sf(){_f=!0;let e=document.getElementById(`login-overlay`);e&&e.classList.add(`hidden`),await Qf,g.onboarded||(g.onboarded=!0,J(g));let t=location.hash.slice(1);t&&document.getElementById(`tab-`+t)?(history.replaceState({tab:t},``,`#`+t),C(t)):Sm(),ep()}function Cf(){vf&&(vf(),vf=null),Lf=!1,Y=null,Zf(),fbAuth.signOut()}function wf(e){return e.budget||(e.budget={income:[],expenses:[],actuals:{},months:{}}),e.budget.actuals||(e.budget.actuals={}),e.budget.months||(e.budget.months={}),e.budget.suggestions||(e.budget.suggestions=[]),e.goals||(e.goals=[]),e.scenarios||(e.scenarios=[]),e.furniture||(e.furniture=[]),e.appliances||(e.appliances=[]),e.planner||(e.planner={events:[]}),e.lists||(e.lists={food:{items:[],budget:0,weeklyBudget:200,stores:[],favourites:[],history:[]},clothes:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},wishlist:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},home:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]},pharmacy:{items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]}},e.meals&&e.meals.shopping&&e.meals.shopping.length&&(e.lists.food.items=e.meals.shopping.map(function(e,t){return{id:`si-`+t,name:e.name,quantity:1,unit:`units`,notes:``,aisle:e.cat||`other`,state:e.checked?`got_it`:`active`,addedBy:`migration`,addedAt:new Date().toISOString(),mealTag:null,manualPrice:null,barcodeId:null}}))),[`food`,`clothes`,`wishlist`,`home`,`pharmacy`].forEach(function(t){e.lists[t]||(e.lists[t]={items:[],budget:0,weeklyBudget:0,stores:[],favourites:[],history:[]}),e.lists[t].items||(e.lists[t].items=[]),e.lists[t].stores||(e.lists[t].stores=[]),e.lists[t].favourites||(e.lists[t].favourites=[]),e.lists[t].history||(e.lists[t].history=[])}),e.routines&&e.routines.forEach(function(e){e.ownerType===`household`&&e.ownerId!==`household`&&(e.ownerId=`household`)}),e}function Tf(){vf&&vf(),!Uf(ff)&&!sessionStorage.getItem(pf)&&gf(q.uid);let e=hf();if(!e){console.error(`No household doc ref`);return}vf=e.onSnapshot(async t=>{if(t.exists){let e=wf(t.data());Object.assign(g,e),Wf(Df,JSON.stringify(g))}else{let t=await fbStore.collection(`family`).doc(`shared`).get().catch(()=>null);if(t&&t.exists){let n=wf(t.data());Object.assign(g,n),e.set(g).catch(()=>{}),Wf(Df,JSON.stringify(g))}else e.set(g).catch(()=>{})}Od().then(()=>{pr();let e=location.hash.slice(1);e&&document.getElementById(`tab-`+e)?(history.replaceState({tab:e},``,`#`+e),C(e)):Sm(),g.onboarded||(g.onboarded=!0,J(g));let t=sessionStorage.getItem(wp),n=sessionStorage.getItem(`toto_post_invite_action`);t||n?(sessionStorage.removeItem(`toto_post_invite_action`),Ep()):ep()})},e=>{console.error(`Firestore sync error:`,e),Sm()})}function Ef(){fbAuth.onAuthStateChanged(e=>{if(_f&&!e)return;q=e;let t=document.getElementById(`login-overlay`),n=document.getElementById(`header-avatar`),r=document.getElementById(`header-sign-out`);if(e)t&&t.classList.add(`hidden`),n&&(n.src=e.photoURL||``,n.style.display=`block`),r&&(r.style.display=`block`),Tf();else{t&&t.classList.remove(`hidden`),n&&(n.style.display=`none`),r&&(r.style.display=`none`),vf&&(vf(),vf=null);let e=sessionStorage.getItem(wp),i=document.getElementById(`login-invite-banner`),a=document.getElementById(`login-tagline`);e&&i&&(i.style.display=`block`,a&&(a.style.display=`none`))}})}Ef();var Df=`home_finance_v1`;window.STORAGE_KEY=Df;var Of=null,kf={};function Af(e,t,n,r){kf[e]={options:t,value:n,onChange:r};let i=t.find(e=>(e.value??e)===n)||t[0],a=i?.label??i?.value??i??``;return`<div class="cs-wrap">
  ...
  </div>`,document.getElementById(`profile-list`).innerHTML=n,document.getElementById(`profile-overlay-title`).textContent=`Who uses this device?`,document.getElementById(`profile-overlay-sub`).textContent=`Set it once — the app will open straight to the right view. You can change this any time in Settings.`,document.getElementById(`profile-overlay`).classList.remove(`hidden`)}function np(e){if(qf(e),Lf=!0,document.getElementById(`profile-overlay`).classList.add(`hidden`),e===`adult`)Y=null,up(),Sm();else if(e===`shared`)rp();else{let t=(g.kids?.profiles||[]).find(t=>t.id===e);if(!t){Y=null,qs(),Sm();return}t.pinHash?(zf=t.id,Z=``,X=0,op(t)):(Y={id:t.id,name:t.name,emoji:t.emoji,role:`child`},Xf(t.id),dp())}}function rp(){document.getElementById(`pin-overlay`).classList.add(`hidden`);let e=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name),t=g.kids?.profiles||[],n=``;e.forEach((e,t)=>{let r=!!e.pinHash;n+=`<div class="profile-card" onclick="_pickAdult(${t})">
      <div class="profile-avatar">🧑</div>
      <div style="flex:1">
        <div style="font-size:15px;font-weight:700;color:#1e293b">${T(e.name)}</div>
    ...
    </div>`}),document.getElementById(`profile-list`).innerHTML=n,document.getElementById(`profile-overlay-title`).textContent=`Who's using Toto?`,document.getElementById(`profile-overlay-sub`).textContent=`Tap your name to continue`,document.getElementById(`profile-overlay`).classList.remove(`hidden`)}function ip(e){let t=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[e??0];if(t?.pinHash){zf=`adult:`+(e??0),Z=``,X=0,Rf=0,op({emoji:`🧑`,name:t.name,_isAdult:!0,_memberIndex:e??0});return}Y=null,Zf(),document.getElementById(`profile-overlay`).classList.add(`hidden`),dp()}function ap(e){let t=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(t.pinHash?(zf=e,Z=``,X=0,op(t)):(Y={id:t.id,name:t.name,emoji:t.emoji,role:`child`},Xf(t.id),document.getElementById(`profile-overlay`).classList.add(`hidden`),dp()))}function op(e){document.getElementById(`profile-overlay`).classList.add(`hidden`),document.getElementById(`pin-avatar`).textContent=e.emoji||(e._isAdult?`🧑`:`😊`),document.getElementById(`pin-greeting`).textContent=`Hi ${e.name}! 👋`,document.getElementById(`pin-sub`).textContent=`Enter your PIN to continue`,document.getElementById(`pin-error`).textContent=``,sp(),cp(),document.getElementById(`pin-overlay`).classList.remove(`hidden`)}function sp(){let e=document.getElementById(`pin-dots`);e&&(e.innerHTML=[0,1,2,3].map(e=>`<div class="pin-dot ${e<Z.length?`filled`:``}">${e<Z.length?`●`:``}</div>`).join(``))}function cp(){let e=document.getElementById(`pin-pad`);if(!e)return;let t=Date.now();if(t<Rf){let n=Math.ceil((Rf-t)/1e3);document.getElementById(`pin-error`).textContent=`Too many attempts — try again in ${n}s`,e.innerHTML=``,setTimeout(cp,1e3);return}e.innerHTML=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div class="pin-key empty"></div>`:`<div class="pin-key" onclick="_pinKey('${e}')">${e}</div>`).join(``)}function lp(e){if(!(Date.now()<Rf)){if(e===`⌫`){Z=Z.slice(0,-1),sp();return}Z.length>=4||(Z+=e,sp(),Z.length===4&&sm())}}function up(){let e=document.getElementById(`header-switch-profile`);if(!e)return;let t=Kf();e.style.display=t&&t!==`adult`?``:`none`}function dp(){up(),qs(),Y?.role===`child`?(window.kidsView=Y.id,w(`kids`),uc(Y.id)):document.querySelectorAll(`.nav-item, .nav-text-item`).forEach(e=>e.style.display=``),Sm()}var fp=`member`,pp=null,mp=null;function hp(e){fp=e;let t=document.getElementById(`inv-role-member`),n=document.getElementById(`inv-role-owner`);!t||!n||(e===`member`?(t.style.borderColor=`#0d9488`,t.style.background=`#f0fdfa`,t.style.color=`#0d9488`,n.style.borderColor=`var(--border)`,n.style.background=`var(--surface)`,n.style.color=`var(--text-muted)`):(n.style.borderColor=`#0d9488`,n.style.background=`#f0fdfa`,n.style.color=`#0d9488`,t.style.borderColor=`var(--border)`,t.style.background=`var(--surface)`,t.style.color=`var(--text-muted)`))}function gp(e,t){let n=document.getElementById(`inv-email`),r=n?n.value.trim():``,i=(g.householdProfile.members||[]).find(e=>e.role===`adult`)?.name||`Someone`,a=new Date(Date.now()+10080*60*1e3).toISOString(),o={id:Cm(),email:r,role:fp,inviterName:i,memberName:t||null,memberIdx:e??null,createdAt:new Date().toISOString(),expiresAt:a,status:`pending`};g.householdProfile.invites||(g.householdProfile.invites=[]),g.householdProfile.invites.push(o),J(g),pp=o.id;let s=bp(o.id),c=document.getElementById(`invite-link-wrap`),l=document.getElementById(`invite-form-wrap`),u=document.getElementById(`invite-link-display`);c&&(c.dataset.invEmail=r,c.dataset.invToken=o.id,c.style.display=`block`),l&&(l.style.display=`none`),u&&(u.textContent=s)}function _p(e){let t=(g.householdProfile.members||[])[e];if(!t)return;let n=(g.householdProfile.members||[]).find((e,t)=>e.role===`adult`&&t===0)?.name||`Someone`,r=new Date(Date.now()+10080*60*1e3).toISOString(),i={id:Cm(),email:``,role:`member`,inviterName:n,memberName:t.name||null,memberIdx:e,createdAt:new Date().toISOString(),expiresAt:r,status:`pending`};g.householdProfile.invites||(g.householdProfile.invites=[]),g.householdProfile.invites.push(i),J(g);let a=bp(i.id),o=T(t.name||`this person`),s=document.createElement(`div`);s.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:24px`,s.innerHTML=`<div style="background:#fff;border-radius:16px;padding:24px;max-width:400px;width:100%">
  ...
  </div>`,document.body.appendChild(s),s.addEventListener(`click`,e=>{e.target===s&&(s.remove(),ta())})}function vp(e){if(!e)return;let t=(g.kids?.profiles||[]).find(t=>t.name&&t.name.toLowerCase()===e.toLowerCase());if(!t){g.kids||(g.kids={profiles:[],chores:[],prizes:[],completions:[],redemptions:[]});let n=(g.householdProfile.members||[]).find(t=>t.name&&t.name.toLowerCase()===e.toLowerCase()),r=F(g.kids.profiles);t={id:r,name:e,age:n?.age||null,emoji:n?.emoji||`🧒`},g.kids.profiles.push(t),g.meals?.lunchbox?.profiles||(g.meals||(g.meals={}),g.meals.lunchbox||(g.meals.lunchbox={profiles:[]})),g.meals.lunchbox.profiles.push({id:r,name:e,emoji:t.emoji}),J(g)}Jp(t.id)}function yp(e){navigator.clipboard.writeText(bp(e)).then(()=>{let e=event.target,t=e.textContent;e.textContent=`✓ Copied!`,setTimeout(()=>{e.textContent=t},2e3)})}function bp(e){let t=mf()||``;return window.location.origin+window.location.pathname+`?invite=`+e+`&h=`+t}function xp(){let e=document.getElementById(`invite-link-wrap`)?.dataset.invToken||pp;e&&navigator.clipboard.writeText(bp(e)).then(()=>{let e=event.target,t=e.textContent;e.textContent=`✓ Copied!`,setTimeout(()=>{e.textContent=t},2e3)})}function Sp(){let e=document.getElementById(`invite-link-wrap`),t=e?.dataset.invToken||pp,n=e?.dataset.invEmail||``;if(!t)return;let r=(g.householdProfile.invites||[]).find(e=>e.id===t)?.inviterName||`Your partner`,i=bp(t),a=encodeURIComponent(`${r} invited you to join their Toto household`),o=encodeURIComponent(`Hi,\n\n${r} has invited you to join their Toto household — a shared family finance and planning app.\n\nClick the link below to accept the invite (expires in 7 days):\n\n${i}\n\nSee you there!`);window.open(`mailto:${n}?subject=${a}&body=${o}`,`_blank`)}function Cp(e){if(!confirm(`Revoke this invite link?`))return;let t=(g.householdProfile.invites||[]).find(t=>t.id===e);t&&(t.status=`revoked`),J(g),ta()}var wp=`toto_pending_invite`;function Tp(){let e=new URLSearchParams(window.location.search),t=e.get(`invite`),n=e.get(`h`);t&&(sessionStorage.setItem(wp,t),n&&sessionStorage.setItem(pf,n),window.history.replaceState({},``,window.location.pathname+window.location.hash))}function Ep(){let e=sessionStorage.getItem(wp);if(!e)return;let t=(g.householdProfile.invites||[]).find(t=>t.id===e);if(!t){sessionStorage.removeItem(wp);return}if(t.status!==`pending`||new Date(t.expiresAt)<new Date){sessionStorage.removeItem(wp),Rp(t);return}sessionStorage.removeItem(wp),mp=t,Dp(t)}function Dp(t){let n=g.householdProfile.members||[],r=n.filter(e=>e.role===`adult`),i=n.filter(e=>e.role===`child`),a=(()=>{let t=new Date,n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}`,r=getOrCreateMonthData(n);return(r.income||[]).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)-(r.expenses||[]).filter(e=>!e.skipped).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)})(),o=[...r.map(e=>`
  ...
  `)}function Op(){let t=mp,n=q?.displayName?.split(` `)[0]||`there`,r=g.householdProfile.members||[],i=r.filter(e=>e.role===`adult`),a=r.filter(e=>e.role===`child`),o=(()=>{let t=new Date,n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}`,r=getOrCreateMonthData(n);return(r.income||[]).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)-(r.expenses||[]).filter(e=>!e.skipped).reduce((t,n)=>t+e(Number(n.amount)||0,n.frequency),0)})(),s=(g.goals||[]).length,c=[...i.map((e,t)=>`
      <div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid #f1f5f9">
        <div style="width:40px;height:40px;border-radius:50%;background:linear-gradient(135deg,#ecfeff,#ccfbf1);display:flex;align-items:center;justify-content:center;font-size:20px">👤</div>
        <div>
  ...
  `)}var kp=0,Ap=[{emoji:`💰`,title:`The Kitty`,desc:`Budget, bills, goals & net worth. See where the money goes each month.`},{emoji:`📅`,title:`Plan`,desc:`Weekly planner, meal plans & the kids' lunchboxes. One place for the week ahead.`},{emoji:`🏠`,title:`Home`,desc:`Documents, vehicles & maintenance reminders. Never miss a rego or warranty renewal.`}];function jp(){kp=0,Mp()}function Mp(){let e=Ap[kp],t=Ap.map((e,t)=>`<div style="width:${t===kp?20:8}px;height:8px;border-radius:99px;background:${t===kp?`#0d9488`:`#e2e8f0`};transition:all .2s"></div>`).join(``),n=kp===Ap.length-1;zp(`
  ...
  `)}function Pp(){let e=document.getElementById(`inv-inc-name`)?.value.trim()||``,t=parseFloat(document.getElementById(`inv-inc-amount`)?.value)||0,n=document.getElementById(`inv-inc-freq`)?.value||`Monthly`;(e||t)&&(g.budget.income||(g.budget.income=[]),g.budget.income.push({id:F(g.budget.income),name:e,amount:t,frequency:n}),J(g)),Lp()}function Fp(){let e=mp;if(!q){sessionStorage.setItem(`toto_post_invite_action`,e?.id||``),xf();return}Ip(e),Op()}function Ip(e){if(!e)return;e.status=`accepted`;let t=q,n=mf();n&&gf(n),g.householdProfile.authorizedUsers||(g.householdProfile.authorizedUsers=[]),g.householdProfile.authorizedUsers.some(e=>e.uid===t.uid)||g.householdProfile.authorizedUsers.push({uid:t.uid,name:t.displayName||``,email:t.email||``,role:e.role||`member`,joinedAt:new Date().toISOString()});let r=g.householdProfile.members||[],i=(t.displayName||``).split(` `)[0];i&&!r.some(e=>e.name===i)&&g.householdProfile.members.push({role:`adult`,name:i,age:null}),J(g)}function Lp(){mp=null,Bp(),Sm(),ep()}function Rp(e){zp(`
  ...
  `)}function zp(e){document.getElementById(`invite-flow-content`).innerHTML=e;let t=document.getElementById(`invite-flow-overlay`);t.classList.remove(`hidden`),t.style.display=`flex`,t.scrollTop=0}function Bp(){let e=document.getElementById(`invite-flow-overlay`);e.classList.add(`hidden`),e.style.display=``}var Vp=`toto_pin_hard_`,Hp=`toto_pin_att_`,Up=null,Q=`gate`,Wp=``,Gp=``,Kp=0,qp=null;function Jp(e){let t=(g.kids?.profiles||[]).find(t=>String(t.id)===String(e));t&&(Up=e,Gp=``,Wp=``,Q=t.pinHash?`enter`:`gate`,Xp(),document.getElementById(`pin-setup-overlay`).classList.remove(`hidden`))}function Yp(){qp&&(clearInterval(qp),qp=null),document.getElementById(`pin-setup-overlay`).classList.add(`hidden`),Up=null}function Xp(){let e=(g.kids?.profiles||[]).find(e=>String(e.id)===String(Up));if(!e)return;let t=document.getElementById(`pso-screen`);if(!t)return;let n=e.emoji||`🧒`,r=T(e.name),i={gate:`#f8fafc`,hello:`linear-gradient(160deg,#f0fdfa,#ecfeff)`,enter:`#f8fafc`,confirm:`#f8fafc`,tour:`#f8fafc`};if(document.getElementById(`pin-setup-overlay`).style.background=i[Q]||`#f8fafc`,Q===`gate`)t.innerHTML=`
      ...
      <button onclick="_psoStep='enter';_psoRender()"
        ...
        Let's go! →
      </button>`;else if(Q===`enter`||Q===`confirm`){let n=Q===`enter`,i=n?e.pinHash?`Change ${r}'s PIN`:`Choose your secret code 🔢`:`Type it again ✅`,a=n?`Pick 4 numbers only you know!`:`Just to make sure!`,o=[0,1,2,3].map(e=>{let t=e<Gp.length;return`<div style="width:52px;height:60px;border:2px solid ${t?`#0d9488`:`#e2e8f0`};border-radius:10px;background:${t?`#f0fdfa`:`#f8fafc`};display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:700;color:#0d9488">${t?`●`:``}</div>`}).join(``),s=[1,2,3,4,5,6,7,8,9,``,0,`⌫`].map(e=>e===``?`<div></div>`:`<div onclick="_psoKey('${e}')" style="height:52px;border:1.5px solid #e2e8f0;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:600;color:#374151;cursor:pointer;background:#fff;-webkit-tap-highlight-color:transparent;user-select:none">${e}</div>`).join(``);t.innerHTML=`
      ...
      ${r?``:`<button onclick="_psoTourDone()" style="font-size:13px;color:#94a3b8;background:none;border:none;cursor:pointer">Skip</button>`}`}}function Zp(){if(qp)return;let e=0,t=document.getElementById(`pso-hold-fill`);t&&(t.style.transition=`none`,t.style.transform=`scaleX(0)`),qp=setInterval(()=>{e+=50;let n=Math.min(e/2e3,1);t&&(t.style.transition=`none`,t.style.transform=`scaleX(${n})`),e>=2e3&&(clearInterval(qp),qp=null,Q=`hello`,Xp())},50)}function Qp(){qp&&(clearInterval(qp),qp=null);let e=document.getElementById(`pso-hold-fill`);e&&(e.style.transition=`transform .3s`,e.style.transform=`scaleX(0)`)}function $p(e){if(e===`⌫`){Gp=Gp.slice(0,-1),Xp();return}Gp.length>=4||(Gp+=e,Xp(),Gp.length===4&&em())}async function em(){if(Q===`enter`)Wp=Gp,Gp=``,Q=`confirm`,Xp();else if(Q===`confirm`){if(Gp!==Wp){Gp=``,Wp=``,Q=`enter`,Xp();let e=document.getElementById(`pso-error`);e&&(e.textContent=`Those didn't match — try again 🙈`);return}await Ys(Up,Gp);let e=(g.kids?.profiles||[]).find(e=>String(e.id)===String(Up));e&&!e._pinWasSet?(Kp=0,Q=`tour`,Xp()):(Yp(),G(),ta()),e._pinWasSet=!0}}function tm(){let e=(g.kids?.profiles||[]).find(e=>String(e.id)===String(Up));Yp(),e&&uc(e.id)}function nm(e){return parseInt(Uf(Hp+e)||`0`)}function rm(e){let t=nm(e)+1;return Wf(Hp+e,String(t)),t}function im(e){Gf(Hp+e),Gf(Vp+e)}function am(e){return Uf(Vp+e)===`1`}function om(e){Wf(Vp+e,`1`)}async function sm(){let e=await $f(Z,mf());if(typeof zf==`string`&&zf.startsWith(`adult:`)){let t=parseInt(zf.split(`:`)[1]),n=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`&&e.name)[t];if(!n)return;e===n.pinHash?(X=0,Y=null,Zf(),document.getElementById(`pin-overlay`).classList.add(`hidden`),dp()):(X++,Z=``,sp(),X>=3?(Rf=Date.now()+3e4,X=0,cp()):document.getElementById(`pin-error`).textContent=`Wrong PIN — ${3-X} tr${3-X==1?`y`:`ies`} left`);return}let t=(g.kids?.profiles||[]).find(e=>e.id===zf);if(t){if(am(t.id)){document.getElementById(`pin-error`).textContent=`PIN locked — ask mum or dad to reset it 🔒`,document.getElementById(`pin-pad`).innerHTML=``,cm(t);return}if(e===t.pinHash)im(t.id),X=0,Y={id:t.id,name:t.name,emoji:t.emoji,role:`child`},Xf(t.id),document.getElementById(`pin-overlay`).classList.add(`hidden`),dp();else if(Z=``,sp(),X++,rm(t.id)>=10)om(t.id),Rf=0,document.getElementById(`pin-error`).textContent=`PIN locked — ask mum or dad to reset it 🔒`,document.getElementById(`pin-pad`).innerHTML=``,cm(t);else if(X>=3)Rf=Date.now()+3e4,X=0,cp();else{let e=3-X;document.getElementById(`pin-error`).textContent=`Wrong PIN — ${e} try${e===1?``:`s`} left`}}}function cm(e){g.notifications||(g.notifications=[]),g.notifications.some(t=>t.type===`pin-lock`&&t.kidId===e.id)||(g.notifications.unshift({id:Cm(),type:`pin-lock`,kidId:e.id,msg:`${e.name}'s PIN has been locked after too many failed attempts. Reset it in Settings → Household.`,ts:new Date().toISOString(),read:!1}),J(g))}function lm(e){im(e),X=0,Rf=0,ta()}function um(e){return g.budget.months&&g.budget.months[e]||{income:g.budget.income,expenses:g.budget.expenses}}function dm(e){return!!(g.budget.months&&g.budget.months[e])}function fm(e){return g.budget.months||(g.budget.months={}),g.budget.months[e]||(g.budget.months[e]={income:JSON.parse(JSON.stringify(g.budget.income)),expenses:JSON.parse(JSON.stringify(g.budget.expenses))}),g.budget.months[e]}function pm(e){let[t,n]=e.split(`-`).map(Number),r=new Date(t,n-2,1);return`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}`}function mm(e){let t=pm(e),n=um(t);g.budget.months||(g.budget.months={}),g.budget.months[e]={income:JSON.parse(JSON.stringify(n.income.filter(e=>e.recurring!==!1))),expenses:JSON.parse(JSON.stringify(n.expenses.filter(e=>e.recurring!==!1)))},bf(`Auto-filled`,`${Am(e)} copied from ${Am(t)}`),J(g),ym(Vo),ym(Pi)}var hm=null;Object.defineProperty(window,`_scopePending`,{get(){return hm},set(e){hm=e},configurable:!0});function gm(e,t){hm={onThisMonth:e,onAllMonths:t};let n=Am($);document.getElementById(`modal-title`).textContent=`Apply changes`,document.getElementById(`modal-body`).innerHTML=`
    <p style="font-size:14px;line-height:1.6;margin:0;color:var(--text-muted)">
      Apply this change to <strong style="color:var(--text)">${n}</strong> only,
      or update the default for all months?
    </p>
    ${dm($)?`<p style="font-size:12px;color:var(--primary);margin-top:10px;margin-bottom:0">
  ...
  `,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function _m(){hm&&(hm.onThisMonth(),hm=null),Wo()}function vm(){hm&&(hm.onAllMonths(),hm=null),Wo()}function ym(e){try{e()}catch(t){let n=t?.message||String(t),r=t?.stack||``;console.error(`Render error in `+(e.name||`?`)+`: `+n+`
`+r),typeof Sentry<`u`&&Sentry.withScope(n=>{n.setTag(`renderer`,e.name||`anonymous`),Sentry.captureException(t)})}}var bm={today:[()=>Wi()],money:[()=>Pi()],dashboard:[()=>ea()],budget:[()=>Vo()],bills:[()=>St()],networth:[()=>He()],goals:[()=>da()],scenarios:[()=>Sa()],insights:[()=>co()],build:[()=>sa()],settings:[()=>ta()],kids:[()=>G()],planner:[()=>R()],forecast:[()=>en()],meals:[()=>Br()],lunchbox:[()=>Zc()],pantry:[()=>Ne()],vehicles:[()=>oe()],documents:[()=>_e()],maintenance:[()=>Te()],routines:[()=>W()],lists:[()=>gi()]},xm=!1;function Sm(){qs(),ym(Wi);let e=bm[x()];e&&e.forEach(e=>ym(e)),xm||(xm=!0,window.Capacitor?.Plugins?.SplashScreen?.hide().catch(()=>{}))}f(Sm),y(Sm),l(bm,Sm);function Cm(){return Date.now().toString(36)+Math.random().toString(36).slice(2)}h(Pf()),Tp(),setTimeout(()=>{try{Sl()}catch{}},0);var $=new Date().toISOString().slice(0,7),wm=`grouped`;Object.defineProperty(window,`budgetViewMode`,{get(){return wm},set(e){wm=e},configurable:!0}),Object.defineProperty(window,`selectedBudgetMonth`,{get(){return $},set(e){$=e},configurable:!0}),window._settingsOpen=new Set([`ai`,`household`]);var Tm=`all`;Object.defineProperty(window,`_billsSubsFilter`,{get(){return Tm},set(e){Tm=e},configurable:!0});var Em=new Date().getFullYear();Object.defineProperty(window,`dpViewYear`,{get(){return Em},set(e){Em=e},configurable:!0});var Dm=new Date().getMonth()+1;Object.defineProperty(window,`dpViewMonth`,{get(){return Dm},set(e){Dm=e},configurable:!0});function Om(){let[e,t]=$.split(`-`).map(Number),n=new Date(e,t-2,1);$=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,Vo()}function km(){let[e,t]=$.split(`-`).map(Number),n=new Date(e,t,1);if($=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`,g.settings&&g.settings.autoFillMonths&&!dm($)){mm($);return}Vo()}function Am(e){let[t,n]=e.split(`-`).map(Number);return new Date(t,n-1,1).toLocaleDateString(`en-AU`,{month:`long`,year:`numeric`})}function jm(e){let[t,n]=e.split(`-`).map(Number);return new Date(t,n-1,1).toLocaleDateString(`en-AU`,{month:`short`,year:`2-digit`})}function Mm(){let e=[],t=new Date;for(let n=5;n>=0;n--){let r=new Date(t.getFullYear(),t.getMonth()-n,1);e.push(`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}`)}return e}function Nm(e,t){let n=(g.budget.actuals[t]||{})[e];return n?typeof n==`number`?[{id:1,amount:n,date:``,note:``}]:Array.isArray(n)?n:[]:[]}function Pm(e,t){return Nm(e,t).reduce((e,t)=>e+(t.amount||0),0)}function Fm(e,t,n){g.budget.actuals[t]||(g.budget.actuals[t]={});let r=Nm(e,t);r.length===1&&!r[0].date&&!r[0].note?g.budget.actuals[t][e]=[{...r[0],amount:n}]:g.budget.actuals[t][e]=[{id:1,amount:n,date:``,note:``}],J(g)}function Im(e){let t=um($).expenses.find(t=>t.id===e);if(!t)return;let n=N(t);function r(){let t=Nm(e,$),r=t.reduce((e,t)=>e+(t.amount||0),0),i=n>0?Math.round(r/n*100):0,a=i>=100?`var(--danger)`:i>=80?`var(--warning)`:`var(--success)`;return`
      <div style="background:var(--surface2);border-radius:8px;padding:12px 14px;margin-bottom:16px">
        <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:8px">
          ...
          <span style="font-weight:700;font-size:15px">${O(n)}</span>
        </div>
        <div style="background:var(--border);border-radius:99px;height:8px;overflow:hidden;margin-bottom:6px">
          <div style="height:100%;width:${Math.min(100,i)}%;background:${a};border-radius:99px"></div>
        </div>
        <div style="display:flex;justify-content:space-between;font-size:12px">
          <span style="font-weight:600;color:${a}">${O(r)} spent · ${i}%</span>
          <span style="color:${i>=100?`var(--danger)`:`var(--text-muted)`}">${i>=100?`Over by `+O(r-n):O(n-r)+` remaining`}</span>
        </div>
      </div>
      ${t.length>0?`
      <div style="margin-bottom:14px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px">
          ...
          <div style="display:flex;align-items:center;gap:10px;background:var(--surface2);border:1px solid var(--border);border-radius:6px;padding:8px 12px">
            <div style="flex:1">
              <span style="font-weight:600;font-size:13px">${O(t.amount)}</span>
        ...
        <div style="display:flex;justify-content:space-between;padding:8px 12px 0;font-size:13px;font-weight:700;border-top:1px solid var(--border);margin-top:8px">
          <span>Total</span><span>${O(r)}</span>
        </div>
      </div>`:`<p style="font-size:13px;color:var(--text-muted);margin-bottom:14px">No entries yet for ${Am($)}.</p>`}
    ...
    `}document.getElementById(`modal-title`).textContent=`Actuals — ${t.name}`,document.getElementById(`modal-body`).innerHTML=`<div id="actual-editor-body">${r()}</div>`,document.getElementById(`modal-footer`).innerHTML=`<button class="btn btn-primary" onclick="closeModal();renderBudget()">Done</button>`,document.getElementById(`modal-overlay`).classList.remove(`hidden`)}function Lm(e){let t=parseFloat(document.getElementById(`ae-amount`).value);if(!t||t<=0)return;let n=document.getElementById(`ae-date`).value||``,r=document.getElementById(`ae-note`).value.trim();g.budget.actuals[$]||(g.budget.actuals[$]={});let i=Nm(e,$);i.push({id:i.length?Math.max(...i.map(e=>e.id))+1:1,amount:t,date:n,note:r}),g.budget.actuals[$][e]=i,J(g),window._actualEditorRefresh&&window._actualEditorRefresh()}function Rm(e,t){if(!g.budget.actuals[$])return;let n=Nm(e,$);n.splice(t,1),g.budget.actuals[$][e]=n,J(g),window._actualEditorRefresh&&window._actualEditorRefresh()}function zm(e){Im(e)}function Bm(){let e=um($),t=P(e.income),n=P(e.expenses),r=t-n,i=t>0?r/t:null,a;a=t===0?10:i>=.2?20:i>=0?Math.round(i/.2*20):0;let o=Mm().slice(3),s=0,c=0;o.forEach(e=>{let t=um(e);t.expenses.some(t=>Nm(t.id,e).length>0)&&(s++,t.expenses.reduce((t,n)=>t+Pm(n.id,e),0)<=P(t.expenses)&&c++)});let l=s===0?5:Math.round(s/3*10+c/s*10),u=(g.netWorth.assets||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),d=(g.netWorth.liabilities||[]).reduce((e,t)=>e+(parseFloat(t.value)||0),0),f=u-d,p;if(u===0&&d===0)p=10;else if(f<=0)p=3;else{let e=d>0?d/u:0;p=e<.3?20:e<.6?15:e<.8?10:6}let m;if(n===0)m=10;else{let e=u/n;m=e>=6?20:e>=3?15:e>=1?8:u===0?5:3}let h=(g.goals||[]).filter(e=>e.status!==`achieved`),_;if(h.length===0)_=8;else{let e=h.reduce((e,t)=>e+Math.min((t.saved||0)/(t.target||1),1),0)/h.length;_=10+Math.round(e*10)}let v=a+l+p+m+_,y=v>=85?`A`:v>=70?`B`:v>=55?`C`:v>=40?`D`:`F`,b=v>=80?`#10b981`:v>=60?`#f59e0b`:v>=40?`#f97316`:`#ef4444`,x=[...[{score:a,tip:`Boost your savings rate — aim for 20%+ of income (currently ${t>0?Math.round((i||0)*100):0}%)`},{score:l,tip:`Log actuals monthly in the Budget tab to stay on track`},{score:p,tip:`Reduce liabilities or grow assets to strengthen your net worth`},{score:m,tip:`Build an emergency fund of 3–6 months expenses (${O(n*3)}–${O(n*6)})`},{score:_,tip:`Set specific savings goals in the Goals tab to stay focused`}]].sort((e,t)=>e.score-t.score)[0];return{total:v,grade:y,color:b,insight:x.score<12?x.tip:`Great shape — stay consistent and keep building your financial cushion.`,dimensions:[{label:`Savings Rate`,score:a,max:20},{label:`Budget Tracking`,score:l,max:20},{label:`Net Worth`,score:p,max:20},{label:`Emergency Buffer`,score:m,max:20},{label:`Goals`,score:_,max:20}]}}var Vm={Wallet:`#059669`,Plan:`#0891b2`,Home:`#7c3aed`};function Hm(e){return e?`<span style="font-size:10px;font-weight:700;color:${Vm[e]||`#71717a`};margin-right:6px">${e}</span>`:``}function Um(e){let t={red:`#ef4444`,amber:`#f59e0b`,green:`#10b981`,blue:`#0891b2`}[e.cls]||`#a1a1aa`,n=e.onclick?e.onclick:e.tab?`activateTab('${e.tab}')`:``;return`<div class="notif-tl-item">
    <div class="notif-tl-dot" style="background:${t}"></div>
    <div class="notif-tl-body"><div class="notif-tl-title">${Hm(e.section)}${e.title}</div>${e.sub?`<div class="notif-tl-sub">${e.sub}</div>`:``}</div>
    <div class="notif-tl-action" onclick="${n}">${e.action.replace(` →`,``)}</div>
  </div>`}function Wm(e){let t=[];return e===`budget`&&um($).expenses.forEach(e=>{let n=N(e),r=Pm(e.id,$);n>0&&r/n>=.8&&r<n?t.push({cls:`amber`,text:`${T(e.name)} at ${Math.round(r/n*100)}% — ${O(n-r)} left`,tab:null}):n>0&&r>=n&&t.push({cls:`red`,text:`${T(e.name)} over budget by ${O(r-n)}`,tab:null})}),t.slice(0,2).map(e=>`<div class="notif-banner ${e.cls}">
    ...
    </div>`).join(``)}function Gm(){let e=[],t=new Date,r=$,i=(g.householdProfile?.members||[]).filter(e=>e.role===`adult`),a=g.kids?.profiles||[],o=a.length>0,s=Math.max(1,i.length)+a.length,c=um(r),l=c.income.length>0,u=c.expenses.length>0,d=c.expenses.some(e=>Nm(e.id,r).length>0),f=(l?30:0)+(u?30:0)+(d?40:0);e.push({key:`budget`,label:`Budget`,score:f,tip:l?u?d?`On track`:`Log actual spending this month`:`Add your expenses`:`Add your income sources`,tab:`budget`});let p=Rr(0),m=g.meals?.plan?.[p]||{},h=0,_=s===1?7:s<=3?14:21;for(let e=0;e<7;e++){let t=m[e]||{};s===1?t.d&&h++:s<=3?(t.l&&h++,t.d&&h++):(t.b&&h++,t.l&&h++,t.d&&h++)}let v=Math.round(h/_*80),y=g.lists?.food?.items||[],b=y.filter(e=>e.state===`active`).length,x=y.filter(e=>e.state===`got_it`).length,S=b>0||x>0,C=v+(S?20:0);e.push({key:`meals`,label:`Meals`,score:Math.min(100,C),tip:h===0?`Plan this week's meals`:h<_?`${h}/${_} meals planned`:S?`Meals sorted`:`Add items to your shopping list`,tab:`meals`});let w=g.maintenance||[],T=w.filter(e=>{let t=we(e);return t!==null&&t<0}).length,E=w.length===0?30:Math.max(0,100-T*25),D=g.vehicles||[],ee=D.filter(e=>!!(e.regoExpiry&&Math.ceil((new Date(e.regoExpiry)-t)/864e5)<30||e.insurance?.renewalDate&&Math.ceil((new Date(e.insurance.renewalDate)-t)/864e5)<30)).length,O=g.documents||[],te=O.filter(e=>e.expiryDate&&Math.ceil((new Date(e.expiryDate)-t)/864e5)<30).length,k=D.length>0?.3:0,A=.3,ne=1-k-A,re=Math.max(0,Math.min(100,Math.round(E*ne+(D.length>0?Math.max(0,100-ee*30)*k:0)+(O.length>0?Math.max(0,100-te*20):50)*A)));if(e.push({key:`home`,label:`Home`,score:re,tip:T>0?`${T} maintenance overdue`:ee>0?`Vehicle rego or insurance expiring`:te>0?`Documents expiring soon`:w.length===0?`Add maintenance items to track`:`Home is sorted`,tab:`maintenance`}),o){let t=g.meals?.lunchbox?.plans||{},n=Rr(0),r=0,i=a.length*20;a.forEach(e=>{let i=(t[n]||{})[e.id]||{};for(let e=0;e<5;e++){let t=i[e]||{};t.main&&r++,t.snack&&r++,t.fruit&&r++,t.drink&&r++}}),typeof U==`function`?U():new Date().toISOString().slice(0,10).replace(/-/g,``);let o=g.kids?.chores||[],s=g.kids?.completions||[],c=s.filter(e=>e.status===`pending`).length,l=s.filter(e=>e.status===`approved`&&e.completedAt?.startsWith(new Date().toISOString().slice(0,10))).length,u=o.length===0?50:Math.max(0,100-c*10+l*5),d=i>0?Math.round(r/i*100):50,f=Math.min(100,Math.round(d*.5+Math.min(100,u)*.5));e.push({key:`family`,label:`Family`,score:f,tip:r===0?`Plan school lunches this week`:c>0?`${c} chore approval${c===1?``:`s`} waiting`:`Family is sorted`,tab:`kids`})}let j=g.goals||[],M=j.filter(e=>e.status===`active`),ie=M.length>0?M.reduce((e,t)=>e+Math.min((t.saved||t.currentAmount||0)/(t.target||t.targetAmount||1),1),0)/M.length*100:0,N=j.length===0?20:Math.round(30+ie*.7);e.push({key:`goals`,label:`Goals`,score:Math.min(100,N),tip:j.length===0?`Set a savings or spending goal`:ie<30?`Make progress on your goals`:`Goals progressing well`,tab:`goals`});let P=typeof Dl==`function`?Dl():[];if(P.length>0){let t=typeof U==`function`?U():new Date().toISOString().slice(0,10).replace(/-/g,``),n=P.filter(e=>{let n=(e.completions?.[t]||[]).length;return e.steps.length>0&&n===e.steps.length}),r=Math.round(n.length/P.length*100),i=P.reduce((e,t)=>{let n=typeof Rl==`function`?Rl(t):0;return Math.max(e,n)},0),a=Math.min(40,Math.round(i/10*40)),o=Math.min(100,20+Math.round(r*.4)+a);e.push({key:`habits`,label:`Habits`,score:o,tip:n.length===0?`Complete a routine today`:i<3?`Keep your streak going`:`${i}-day streak — keep it up`,tab:`routines`})}let F=new Date().toISOString().slice(0,10),ae=new Date(Date.now()+7*864e5).toISOString().slice(0,10),oe=(g.planner?.events||[]).filter(e=>e.date>=F&&e.date<=ae).length,se=(g.bills||[]).filter(e=>{let t=n(e);return t!==null&&t<0}).length,ce=(g.documents||[]).filter(e=>e.expiryDate&&new Date(e.expiryDate)<t).length,le=Math.min(100,Math.round((oe>0?40:10)+Math.max(0,30-se*15)+Math.max(0,30-ce*15)));return e.push({key:`plan`,label:`Plan`,score:le,tip:se>0?`${se} bill${se===1?``:`s`} overdue`:ce>0?`${ce} document${ce===1?``:`s`} expired`:oe===0?`Add something to your calendar`:`Plan looks good`,tab:`planner`}),{total:Math.round(e.reduce((e,t)=>e+t.score,0)/e.length),dims:e}}function Km(){let e=Gm();new Date().toISOString().slice(0,10);let t=g.settings?.typeADismissedMission||``,n=[...e.dims].sort((e,t)=>e.score-t.score),r=[];return n.forEach(e=>{if(e.key===`budget`&&e.score<70&&(um($).income.length?um($).expenses.length?r.push({id:`log-actuals`,title:`Log this month's actual spending`,sub:`Import a bank statement or add manually`,tab:`budget`,impact:30}):r.push({id:`add-expenses`,title:`Set up your monthly expenses`,sub:`List your regular costs`,tab:`budget`,impact:35}):r.push({id:`add-income`,title:`Add your income sources`,sub:`Takes about 1 minute`,tab:`budget`,impact:40})),e.key===`meals`&&e.score<70){let e=Rr(0),t=g.meals?.plan?.[e]||{},n=Object.values(t).filter(e=>e.d).length,i=(g.lists?.food?.items||[]).filter(e=>e.state===`active`).length;n<3?r.push({id:`plan-dinners`,title:`Plan this week's dinners`,sub:`Just the evening meals — takes 2 minutes`,tab:`meals`,impact:25}):i===0&&r.push({id:`shopping-list`,title:`Add items to your shopping list`,sub:`Start with essentials you need this week`,tab:`lists`,impact:15})}if(e.key===`home`&&e.score<70){let e=(g.maintenance||[]).filter(e=>{let t=we(e);return t!==null&&t<0});e.length?r.push({id:`maint-overdue`,title:`Clear overdue: ${T(e[0].name)}`,sub:`Mark it done or reschedule`,tab:`maintenance`,impact:20}):(g.maintenance||[]).length||r.push({id:`setup-maint`,title:`Set up household maintenance`,sub:`Add items like gutters, pest control, smoke alarms`,tab:`maintenance`,impact:20})}if(e.key===`family`&&e.score<70){let e=(g.kids?.completions||[]).filter(e=>e.status===`pending`).length,t=g.kids?.profiles||[];e>0?r.push({id:`approve-chores`,title:`Review ${e} chore approval${e===1?``:`s`}`,sub:`Kids are waiting for your sign-off`,tab:`kids`,impact:20}):t.length>0&&r.push({id:`plan-lunchbox`,title:`Plan school lunches this week`,sub:`AI can do it in one tap`,tab:`lunchbox`,impact:18})}if(e.key===`goals`&&e.score<50&&((g.goals||[]).length||r.push({id:`add-goal`,title:`Set your first savings goal`,sub:`Holiday fund, emergency savings, or debt payoff`,tab:`goals`,impact:15})),e.key===`habits`&&e.score<70&&((typeof Dl==`function`?Dl():[]).length===0?r.push({id:`create-routine`,title:`Create your first daily routine`,sub:`Morning or evening — takes 2 minutes to set up`,tab:`routines`,impact:25}):r.push({id:`complete-routine`,title:`Complete a routine today`,sub:`Tap each step as you go`,tab:`today`,impact:20})),e.key===`plan`&&e.score<70){let e=new Date().toISOString().slice(0,10),t=new Date(Date.now()+7*864e5).toISOString().slice(0,10);(g.planner?.events||[]).filter(n=>n.date>=e&&n.date<=t).length===0?r.push({id:`add-event`,title:`Add something to your calendar`,sub:`Even one event this week helps keep life organised`,tab:`planner`,impact:15}):r.push({id:`review-bills`,title:`Review upcoming bills`,sub:`Make sure nothing catches you off guard`,tab:`bills`,impact:15})}}),r.filter(e=>e.id!==t).sort((e,t)=>t.impact-e.impact)[0]||null}function qm(e){g.settings||(g.settings={}),g.settings.typeADismissedMission=e,J(g);let t=document.querySelector(`.mission-lightbox`);t&&t.remove(),Wi()}function Jm(e){g.settings||(g.settings={}),g.settings.typeAMissionId=``,g.settings.typeAMissionShownDate=``,g.settings.typeADismissedMission=e,J(g);let t=document.querySelector(`.mission-lightbox`);t&&t.remove()}function Ym(){let e=g.settings?.typeAMissionShownDate;if(!e)return 0;let t=Math.floor((new Date-new Date(e))/864e5);return Math.max(0,t)}function Xm(e){if(document.querySelector(`.mission-lightbox`))return;let t=Ym(),n=e.onclick?e.onclick:e.tab?`activateTab('${e.tab}')`:``,r=document.createElement(`div`);r.className=`mission-lightbox`,r.innerHTML=`
    ...
    </div>`,r.addEventListener(`click`,t=>{t.target===r&&qm(e.id)}),document.body.appendChild(r)}function Zm(){if(!g.settings?.typeAMode)return;let e=Km();if(!e)return;let t=new Date().toISOString().slice(0,10);if(g.settings.typeAMissionId!==e.id){g.settings.typeAMissionId=e.id,g.settings.typeAMissionShownDate=t,J(g);return}Ym()>=1&&setTimeout(()=>Xm(e),1500)}function Qm(){Gm();let e=um($),t=e.expenses.reduce((e,t)=>e+Pm(t.id,$),0),r=P(e.expenses),i=Rr(1),a=g.meals?.plan?.[i]||{},o=Object.values(a).reduce((e,t)=>e+ +!!t.b+ +!!t.l+ +!!t.d,0),s=(g.maintenance||[]).filter(e=>{let t=we(e);return t!==null&&t<0}).length,c=(g.bills||[]).filter(e=>{let t=n(e);return t>=0&&t<=7}),l=(g.meals?.pantry||[]).filter(e=>e.status===`need`||e.status===`low`).length,u=document.createElement(`div`);u.className=`reset-overlay`,u.innerHTML=`
    <div class="reset-card">
      ...
      <div class="reset-step">
        ...
        <div class="reset-step-sub">${t>0?`You've spent ${O(t)} of ${O(r)} budgeted`:`No actuals logged yet this month`}</div>
      ...
      <div class="reset-step">
        ...
        <div class="reset-step-sub">${c.length>0?`${c.length} bill${c.length===1?``:`s`} due this week — ${O(c.reduce((e,t)=>e+(parseFloat(t.amount)||0),0))}`:`No bills due this week`}</div>
        <div class="reset-step-actions">
    ...
    </div>`,u.addEventListener(`click`,e=>{e.target===u&&u.remove()}),document.body.appendChild(u)}function $m(){let e=document.querySelector(`.reset-overlay`);e&&e.remove(),g.settings||(g.settings={});let t=new Date().toISOString().slice(0,10),n=g.settings.typeALastResetDate||``;n&&Math.floor((new Date-new Date(n))/864e5)<=9?g.settings.typeAStreak=(g.settings.typeAStreak||0)+1:g.settings.typeAStreak=1,g.settings.typeALastResetDate=t,J(g),Wi()}function eh(){let e=Gm(),t=2*Math.PI*22,n=(e.total/100*t).toFixed(1),r=e.total>=80?`var(--good,#10b981)`:e.total>=60?`var(--iris-2)`:e.total>=40?`var(--amber,#f59e0b)`:`var(--ember,#f97316)`,i=e.total>=80?`Crushing it — keep going`:e.total>=60?`Good shape — a few things to tidy`:e.total>=40?`Getting there — some gaps to fill`:`Just getting started`,a=zt?`▲`:`▼`,o=e.dims.map(e=>{let t=e.score>=75?`var(--good,#10b981)`:e.score>=50?`var(--iris-2)`:e.score>=30?`var(--amber,#f59e0b)`:`var(--ember,#f97316)`,n=e.score>=75?`var(--good,#10b981)`:e.score>=50?`var(--iris-1)`:e.score>=30?`var(--amber,#f59e0b)`:`var(--ember,#f97316)`;return`<div class="life-dim">
  ...
  </div>`}function th(){let e=Km();if(!e)return``;let t=Ym(),n=e.onclick?`onclick="${e.onclick}"`:e.tab?`onclick="activateTab('${e.tab}')"`:``;return`<div class="mission-card" ${n}>
  ...
  </div>`}function nh(){let e=um($),t=g.householdProfile?.members||[],n=t.filter(e=>e.role===`adult`),r=t.filter(e=>e.role===`child`),i=[];if(i.push({id:`members`,label:`Add your household members`,done:n.length>0,tab:null}),i.push({id:`income`,label:`Set up income sources`,done:(e.income||[]).length>0,tab:`budget`}),i.push({id:`expenses`,label:`Add monthly expenses`,done:(e.expenses||[]).length>0,tab:`budget`}),r.length>0&&i.push({id:`kids`,label:`Add kids to your household`,done:!0,tab:null}),n.length>=2){let e=n[1]?.name||`your partner`,t=(g.householdProfile.authorizedUsers||[]).length>0||(g.householdProfile.invites||[]).some(e=>e.status===`accepted`);i.push({id:`invite`,label:`Invite ${e} to your household`,done:t,tab:`settings`,settingsSection:`household-access`})}if(i.push({id:`goals`,label:`Set your first savings goal`,done:(g.goals||[]).length>0,tab:`goals`}),i.push({id:`networth`,label:`Add your net worth (assets & debts)`,done:(g.netWorth?.assets||[]).length>0||(g.netWorth?.liabilities||[]).length>0,tab:`networth`}),i.push({id:`vehicles`,label:`Add your vehicles`,done:(g.vehicles||[]).length>0,tab:`vehicles`}),r.length>0){let e=r[0]?.name||`your child`;i.push({id:`chores`,label:`Set up ${T(e)}'s first chores`,done:(g.kids?.chores||[]).length>0,tab:`kids`})}return i}var rh=!1;Object.defineProperty(window,`_spExpanded`,{get(){return rh},set(e){rh=e},configurable:!0});var ih=!1;Object.defineProperty(window,`_spDoneExpanded`,{get(){return ih},set(e){ih=e},configurable:!0});function ah(){let e=document.getElementById(`setup-progress-card`);e&&(e.innerHTML=Fi())}var oh=null;Object.defineProperty(window,`expenseSortCol`,{get(){return oh},set(e){oh=e},configurable:!0});var sh=`asc`;Object.defineProperty(window,`expenseSortDir`,{get(){return sh},set(e){sh=e},configurable:!0});var ch=`all`;Object.defineProperty(window,`expenseFilterCat`,{get(){return ch},set(e){ch=e},configurable:!0});function lh(e){ch=e,Vo()}function uh(e){sh=oh===e&&sh===`asc`?`desc`:`asc`,oh=e,Vo()}function dh(e,t,n=``){let r=oh===e;return`<th class="sortable${r?` sort-active`:``}" onclick="sortExpenses('${e}')">${t}${n}<span class="sort-icon">${r?sh===`asc`?`↑`:`↓`:`↕`}</span></th>`}function fh(e){let t=[`th`,`st`,`nd`,`rd`],n=e%100;return e+(t[(n-20)%10]||t[n]||t[0])}var ph=`plan`;Object.defineProperty(window,`_mealView`,{get(){return ph},set(e){ph=e},configurable:!0}),window._acceptInviteAndContinue=Fp,window._addRecurrenceToDate=fr,window._adultPinKey=rc,window._adultPinSubmit=ic,window._applyActiveProfile=dp,window._applyChildNav=qs,window._applyMigrations=wf,window._autoCreateRecurringEvents=pr,window._briefIcon=Ri,window._briefRow=Ui,window._budgetAllocByCategory=Lo,window._buildTotoContext=Tr,window._capacitorPrefs=Vf,window._categoryIcon=Bo,window._checkInviteOnLoad=Tp,window._checkMissionEscalation=Zm,window._checkSettingsUnsaved=Do,window._chipClassFor=zi,window._chipLabelFor=Bi,window._copyInviteLinkForMember=yp,window._csOpen=jf,window._csvSetExpense=Ps,window._csvToggle=Ms,window._csvToggleAll=Ns,window._csvUpdateApplyBtn=Fs,window._cvAgeBracket=ac,window._cvCalViewToggle=Dc,window._cvConfetti=lc,window._cvDismissNotif=Nc,window._cvEventsForDate=yc,window._cvFmt12h=bc,window._cvMonthDayTap=jc,window._cvRefreshSchedulePanel=Cc,window._cvRender7Day=Oc,window._cvRenderCalendar=Ec,window._cvRenderMonth=Ac,window._cvRenderPrizesTab=fc,window._cvRoutineAvailLabel=cc,window._cvRoutineIsActive=sc,window._cvRoutineSchedCard=Tc,window._cvScheduleHtml=wc,window._cvShowDayDetail=Mc,window._cvShowPrizeConfirm=Pc,window._cvSwitchTab=vc,window._cvTimeGreeting=oc,window._cvToggleRoutineExpand=xc,window._cvToggleStepFromCal=Sc,window._cvUpdatePrizesBadge=dc,window._cvWeekDayTap=kc,window._devLoadAll=Kc,window._devLoadHome=Wc,window._devLoadKids=Vc,window._devLoadMeals=Gc,window._devLoadPlanner=Uc,window._devLoadRoutines=Hc,window._devLoadWallet=Bc,window._devReset=qc,window._devToolsClose=zc,window._devToolsOpen=Rc,window._dismissInviteFlow=Bp,window._docCatMeta=ge,window._ensureKidProfileAndPin=vp,window._ensureNWModals=Xe,window._estimateMealCalories=Zr,window._fetchAIBriefing=$i,window._finishInviteJourney=Lp,window._getHouseholdDocRef=hf,window._getHouseholdOwnerUID=mf,window._getInviteUrl=bp,window._getNthDayOfMonth=lr,window._getPinTotalAttempts=nm,window._handlePendingInvite=Ep,window._hashPin=$f,window._incPinTotalAttempts=rm,window._inferAisle=Pr,window._initAuthListener=Ef,window._isPinHardLocked=am,window._listsAddFavourite=pi,window._listsAddItem=ii,window._listsAddUsual=mi,window._listsArchive=fi,window._listsClearTrolley=di,window._listsDeleteItem=oi,window._listsOpenAddForm=ci,window._listsQuickAdd=si,window._listsSaveForm=ui,window._listsSetState=ai,window._listsUpdateParsePreview=hi,window._maintDaysUntil=we,window._maintNextDue=Ce,window._markSettingsDirty=wo,window._mealGetSuggestions=Yr,window._mealPill=Kr,window._mealPriceSlide=Jr,window._mealToggleFilter=qr,window._mealWeekDates=zr,window._mealWeekKey=Rr,window._missionDaysIgnored=Ym,window._nextForecastMonth=$t,window._pantryToAisle=li,window._parseShopInput=Fr,window._pickAdult=ip,window._pickKid=ap,window._pinKey=lp,window._plannerCloseDaySheet=_n,window._plannerCloseDetail=wn,window._plannerCloseLifeSheet=xn,window._plannerCloseShare=On,window._plannerCopyShareUrl=An,window._plannerEditFromDetail=En,window._plannerEvMemberIds=Wt,window._plannerEvPrimaryMember=Gt,window._plannerEvWhoLabel=Kt,window._plannerEventsForDate=Yt,window._plannerFmt12h=Xt,window._plannerGoToday=dn,window._plannerHandleDaySheetClick=vn,window._plannerHandleDetailClick=Tn,window._plannerHandleLifeSheetClick=Sn,window._plannerHandleShareClick=kn,window._plannerMemberById=Ut,window._plannerMembers=Ht,window._plannerNextMonth=sn,window._plannerNudges=Mn,window._plannerOpenDaySheet=hn,window._plannerOpenDetail=Cn,window._plannerOpenLifeSheet=bn,window._plannerOpenModalFromSheet=yn,window._plannerOpenShare=Dn,window._plannerPrevMonth=on,window._plannerRecurrenceLabel=qt,window._plannerRenderDaySheetList=gn,window._plannerSelectDay=cn,window._plannerSetView=fn,window._plannerShareVia=jn,window._plannerToggleFilter=mn,window._plannerToggleSection=pn,window._plannerVisibleEvents=Jt,window._pmDpClear=nr,window._pmDpNext=ar,window._pmDpOpen=Qn,window._pmDpOutsideClick=$n,window._pmDpPrev=ir,window._pmDpRender=er,window._pmDpSelect=tr,window._pmDpToday=rr,window._pmFmtDate=Kn,window._pmFmtDateShort=qn,window._pmHandleCatChange=Zn,window._pmRenderMemberPicker=Jn,window._pmToggleAllDay=Xn,window._pmToggleMember=Yn,window._prevForecastMonth=Qt,window._psoHoldEnd=Qp,window._psoHoldStart=Zp,window._psoKey=$p,window._psoRender=Xp,window._psoSubmit=em,window._psoTourDone=tm,window._pushAllEventsToBudget=cr,window._qaKey=Ws,window._qaSelectCat=Gs,window._qahAction=Bs,window._qahApplyParsed=Hs,window._qahSendText=Vs,window._recordInviteAcceptance=Ip,window._refreshSetupProgress=ah,window._renderAdultPinModal=nc,window._renderApiKeySummary=jo,window._renderContextBanners=Wm,window._renderCsvPreview=ks,window._renderCsvReview=js,window._renderInviteFlow=zp,window._renderLifeAreas=Hi,window._renderLifeScore=eh,window._renderListItem=yi,window._renderListsDetail=vi,window._renderListsSelector=_i,window._renderMealPlan=Vr,window._renderMissionCard=th,window._renderNudgeSection=dr,window._renderPinDots=sp,window._renderPinPad=cp,window._renderPlannerAgenda=ln,window._renderPlannerEventRow=an,window._renderPlannerMonthGrid=nn,window._renderPlannerWeekStrip=rn,window._renderQAHub=zs,window._renderQASheet=Us,window._renderShoppingList=Qr,window._renderTourSlide=Mp,window._renderWeekStrip=Vi,window._resetPinAttempts=im,window._saveInviteIncome=Pp,window._sectionTag=Hm,window._secureClear=Gf,window._secureGet=Uf,window._securePrewarm=Hf,window._secureSet=Wf,window.prefsGet=Uf,window.prefsSet=Wf,window.prefsClear=Gf,window._setHouseholdOwner=gf,window._setInviteRole=hp,window._setPinHardLock=om,window._showInviteA1=Dp,window._showInviteA3=Op,window._showInviteA4=jp,window._showInviteExpired=Rp,window._showInviteIncomePrompt=Np,window._showMissionLightbox=Xm,window._showParentLockNotification=cm,window._showPinScreen=op,window._showToast=ri,window._startFirestoreSync=Tf,window._syncVehicleBill=le,window._tdCloseSheet=Ji,window._tdOpenHeadsUpSheet=Gi,window._tdOpenSheet=qi,window._tdOpenSlippingSheet=Ki,window._tdToggleStep=Yi,window._ticker=zo,window._tlItem=Um,window._todayAllocSegments=Li,window._totoAppendMessage=Er,window._totoInitPanel=xr,window._totoRemoveTyping=Or,window._totoSend=wr,window._totoSendSuggestion=Sr,window._totoShowTyping=Dr,window._updatePillsOverflow=S,window._updateSwitchBtn=up,window._verifyPin=sm,window.activateTab=w,window.addActualEntry=Lm,window.addCatToGroup=yo,window.addCategory=Po,window.addHouseholdMember=Va,window.addPet=Wa,window.addShopItem=$r,window.addSubFromImport=ht,window.adjForm=ka,window.applianceForm=Di,window.applianceFromForm=Oi,window.applyCsvImport=Is,window.approveSuggestion=In,window.assignDevice=np,window.aud=O,window.audD=te,window.billCatIcon=yt,window.billDueBadge=bt,window.billMonthlyEquiv=xt,window.billsModal=Tt,window.calcFinancialHealth=Bm,window.calcLifeScore=Gm,window.calcScenario=xa,window.cancelSettingsChanges=Eo,window.clearActivityLog=No,window.clearAdultPin=Qs,window.clearCheckedShopItems=ni,window.clearDeviceProfile=Jf,window.clearKidPin=Xs,window.clearKidSession=Zf,window.closeBillModal=Dt,window.closeModal=Wo,window.closeNWModal=Qe,window.closeNWTargetModal=qe,window.closePinSetupOverlay=Yp,window.closeQuickAdd=Rs,window.closeSubModal=dt,window.closeTotoAssistant=br,window.completeMission=Jm,window.completeWeeklyReset=$m,window.confirmScope=gm,window.copyInviteLink=xp,window.copyMonthFromPrevious=mm,window.customSelect=Af,window.cyclePantryStatus=Pe,window.deleteAdjustment=Ma,window.deleteAppliance=ji,window.deleteBill=At,window.deleteCategoryGroup=_o,window.deleteDoc=be,window.deleteExpense=vs,window.deleteExtra=ss,window.deleteFurniture=Ei,window.deleteGoal=_a,window.deleteIncome=fs,window.deleteMaint=Oe,window.deleteNWItem=et,window.deletePantryItem=Le,window.deletePlannerEvent=Bn,window.deleteScenario=Oa,window.deleteService=pe,window.deleteStage=Xo,window.deleteSub=pt,window.deleteVariation=ts,window.deleteVehicle=ue,window.detectSpendingPatterns=eo,window.dismissMission=qm,window.dismissSubResult=gt,window.dismissSuggestion=Ln,window.doScopeAll=vm,window.doScopeMonth=_m,window.dpClearDate=Ts,window.dpDateInput=ys,window.dpNextMonth=Cs,window.dpPrevMonth=Ss,window.dpSelectDate=ws,window.editActual=zm,window.ensureMonthOverride=fm,window.escAttr=E,window.escHtml=T,window.estimateAllEvents=tn,window.estimatePlannerEvent=Vn,window.expenseCategories=ca,window.expenseForm=ps,window.expenseFromForm=ms,window.exportData=ra,window.extraForm=rs,window.extraFromForm=is,window.fmtDate=A,window.fmtNW=k,window.freqDisplay=j,window.freqDisplayItem=M,window.freqLabel=re,window.freqLabelItem=ie,window.furnitureForm=Si,window.furnitureFromForm=Ci,window.generateInvite=gp,window.generateMission=Km,window.generateShoppingList=bi,window.generateSmartInsights=ro,window.generateSmartInsightsHTML=lo,window.getAIKey=Za,window.getActual=Pm,window.getActualEntries=Nm,window.getBenchmarkStatus=Ya,window.getBenchmarks=Ja,window.getCategoryHistoryData=$a,window.getDeviceProfile=Kf,window.getKidSession=Yf,window.getLast6Months=Mm,window.getMonthData=um,window.getSeasonalNudges=ur,window.goToPlannerDay=un,window.goalForm=fa,window.goalFromForm=ma,window.goalProgress=ua,window.guestMode=Sf,window.handleCsvFile=Os,window.handleDeviceRouting=ep,window.handleSubCSV=mt,window.importData=ia,window.incomeCategories=la,window.incomeForm=cs,window.incomeFromForm=ls,window.inviteMember=_p,window.isMonthCustomized=dm,window.isOverdue=ne,window.itemMonthly=N,window.loadColors=Fa,window.loadData=Pf,window.logActivity=bf,window.markBillPaid=jt,window.markChoreChildView=Fc,window.markGoalAchieved=va,window.markMaintDone=ke,window.monthLabel=Am,window.monthShortLabel=jm,window.monthlyTotal=P,window.nextId=F,window.nextInsightsMonth=fo,window.nextMoneyMonth=Ni,window.nextMonth=km,window.nwItemRow=Ue,window.openActualEditor=Im,window.openAddAdjustment=ja,window.openAddAppliance=ki,window.openAddCatToGroup=bo,window.openAddCategoryGroup=ho,window.openAddExpense=gs,window.openAddExtra=as,window.openAddFurniture=wi,window.openAddGoal=ha,window.openAddIncome=us,window.openAddScenario=Ea,window.openAddStage=Jo,window.openAddVariation=$o,window.openBillModal=Et,window.openCsvImport=Es,window.openDatePicker=bs,window.openDocForm=ve,window.openEditAppliance=Ai,window.openEditContractTotal=Go,window.openEditExpense=_s,window.openEditExtra=os,window.openEditFurniture=Ti,window.openEditGoal=ga,window.openEditIncome=ds,window.openEditScenario=Da,window.openEditStage=Yo,window.openEditVariation=es,window.openEmojiPickerModal=mo,window.openIconPickerForGroup=go,window.openMaintForm=Ee,window.openMealEdit=Gr,window.openModal=z,window.openNWModal=Ze,window.openNWTargetModal=Ke,window.openNavGroupFor=df,window.openPantryForm=Fe,window.openPinSetup=Jp,window.openPlannerModal=Gn,window.openQuickAdd=Ls,window.openServiceForm=de,window.openSubModal=ut,window.openTotoAssistant=yr,window.openVehicleForm=se,window.openWeeklyReset=Qm,window.ordinal=fh,window.pantryToShoppingList=ze,window.parseBankCSV=Ds,window.prevInsightsMonth=uo,window.prevMoneyMonth=Mi,window.prevMonth=Om,window.prevMonthStr=pm,window.profileAdults=za,window.profileChildren=Ba,window.quickAddMaint=Ae,window.quickAddPantry=Re,window.redeemPrizeChildView=Ic,window.removeActualEntry=Rm,window.removeApiKey=Ao,window.removeCatFromGroup=xo,window.removeCategory=Fo,window.removeHouseholdMember=Ha,window.removePet=Ga,window.removeShopItem=ti,window.renderAll=Sm,window.renderBenchmarksSection=so,window.renderBills=St,window.renderBudget=Vo,window.renderBudgetForecast=sr,window.renderBudgetSuggestions=Rn,window.renderBuild=sa,window.renderCategoryBreakdown=to,window.renderDashboard=ea,window.renderDocuments=_e,window.renderDpCalendar=xs,window.renderExpenseGroups=Io,window.renderForecast=en,window.renderGoals=da,window.renderInsightCards=oo,window.renderInsights=co,window.renderLists=gi,window.renderLunchbox=Zc,window.renderMaintenance=Te,window.renderMeals=Br,window.renderMoneyDashboard=Pi,window.renderNWDebtCard=Ge,window.renderNWTargetCard=We,window.renderNWTrend=Ye,window.renderNetWorth=He,window.renderPantry=Ne,window.renderPlanner=R,window.renderRoutines=W,window.renderScenarios=Sa,window.renderSettings=ta,window.renderSetupProgress=Fi,window.renderSpendingPatterns=no,window.renderSubImportResults=lt,window.renderSubscriptions=wt,window.renderToday=Wi,window.renderVehicles=oe,window.resetAllData=na,window.resetKidPinLock=lm,window.revokeInvite=Cp,window.runAIInsights=ao,window.runCsvCategorise=As,window.safeRender=ym,window.sanitiseState=ae,window.saveAIKey=Qa,window.saveApiKey=ko,window.saveBill=kt,window.saveColors=Ia,window.saveData=J,window.saveDoc=ye,window.saveMaint=De,window.saveMealSlot=Xr,window.saveNWItem=$e,window.saveNWSnapshot=tt,window.saveNWTarget=Je,window.savePantryItem=Ie,window.savePlannerEvent=or,window.saveQuickAdd=Ks,window.saveService=fe,window.saveSettingsChanges=To,window.saveSub=ft,window.saveVehicle=ce,window.scenarioForm=wa,window.scenarioFromForm=Ta,window.sendInviteEmail=Sp,window.sendTotoMessage=Cr,window.setActual=Fm,window.setAdultPin=Zs,window.setBillsFilter=Ct,window.setBudgetView=oa,window.setDeviceProfile=qf,window.setExpenseFilter=lh,window.setKidPin=Ys,window.setKidSession=Xf,window.setupProgressTasks=nh,window.showChildView=uc,window.showDeviceSetup=tp,window.showProfileSelector=rp,window.signInWithGoogle=xf,window.signOutUser=Cf,window.sortExpenses=uh,window.stageForm=Ko,window.stageFromForm=qo,window.subCatIcon=at,window.subMonthlyAmount=ot,window.suggestEventToBudget=Fn,window.switchProfile=Js,window.switchToKidMode=Lc,window.thSort=dh,window.toggleAdjFields=Aa,window.toggleBillDayField=Ot,window.toggleBudgetDetail=Uo,window.toggleCustomFreq=hs,window.toggleGoalFields=pa,window.toggleGroupExpand=aa,window.toggleInsightSheet=Xi,window.toggleNavGroup=uf,window.togglePlannerCard=Nn,window.togglePlannerEstimate=Pn,window.toggleScenario=Ca,window.toggleSettingsSection=Mo,window.toggleShopItem=ei,window.toggleSidebar=cf,window.toggleTotoAssistant=vr,window.uid=Cm,window.DEFAULT_DATA=Nf,window.unpushEventFromBudget=zn,window.updateCars=qa,window.updateCategoryGroup=vo,window.updateColor=Ra,window.updateMember=Ua,window.updatePet=Ka,window.updateSetting=Oo,window.upgradeSelects=Mf,window.variationForm=Zo,window.variationFromForm=Qo,window.LB_ALLERGIES=Xc,window.LB_SLOTS=Yc,window._estimateLbCalories=rl,window._lbActiveKid=Jc,window._lbWeekOffset=0,window._saveLbSlot=nl,window.aiPlanLunchbox=il,window.deleteLbProfile=el,window.lbToShoppingList=al,window.openLunchboxEdit=tl,window.openLunchboxProfile=Qc,window.saveLbProfile=$c,window.HEALTH_GUIDES=gl,window._cleanupGuide=hl,window._cvReadOnly=vl,window._cvViewCalendar=bl,window._guideCleanup=ll,window._guideIdx=cl,window._guideSteps=sl,window._highlightStep=fl,window._recurrenceMatchesDate=Mt,window._showGuideStep=dl,window.endGuide=ml,window.exitChildView=xl,window.nextGuideStep=pl,window.startGuide=ul,window.startHealthGuide=_l,window.toggleHealthPopover=ol,window.viewChildToday=yl,window.ROUTINE_SUGGESTIONS=wl,window.SUGG_PREVIEW=3,window._assignmentCompletedToday=Pl,window._assignmentHistory=Il,window._assignmentStreak=Fl,window._renderAdultRoutines=ql,window._renderChildRoutines=tu,window._renderRoutinesTodayCard=Wl,window._renderSuggestionsSection=Ql,window._routineActiveTab=Gl,window._routineAddStep=vu,window._routineAddSuggestion=eu,window._routineAssertScope=Vl,window._routineAvailableSuggestions=Bl,window._routineAwardPoints=ou,window._routineAwardStepPoints=au,window._routineCheckDailyReset=Sl,window._routineCompletedToday=Ll,window._routineCreate=Au,window._routineCurrentUserId=El,window._routineDateKey=Tl,window._routineDelete=Mu,window._routineDeleteChild=nu,window._routineDeleteStep=Su,window._routineDragEnd=_u,window._routineDragIdx=pu,window._routineDragOver=hu,window._routineDragStart=mu,window._routineDrop=gu,window._routineDuplicateFromJoined=zu,window._routineDuplicateTo=Lu,window._routineEdit=xu,window._routineEditStep=Cu,window._routineEditSuggestion=$l,window._routineExpandSugg=Zl,window._routineGetAssignment=Nl,window._routineHistory=zl,window._routineIntelNudge=Ul,window._routineIsOwner=kl,window._routineJoin=Ru,window._routineKids=Al,window._routineLeave=Nu,window._routineManageAssignments=wu,window._routineMatchesDate=Cl,window._routineNextId=jl,window._routineOtherAdults=Ml,window._routinePauseMenu=lu,window._routinePropagateStepAdd=yu,window._routinePropagateStepDelete=bu,window._routineRecurrenceCollect=ku,window._routineRecurrenceFormHtml=Eu,window._routineRecurrenceSummaryUpdate=Ou,window._routineRecurrenceTypeChange=Du,window._routineRemovePause=uu,window._routineResetToday=su,window._routineResetTodayAllKids=fu,window._routineResetTodayKid=du,window._routineSaveValidated=Hl,window._routineSetTab=Kl,window._routineShareMenu=Fu,window._routineShowHistory=Bu,window._routineSkipDay=cu,window._routineStreak=Rl,window._routineSuggCollapsed=Jl,window._routineSuggExpanded=Yl,window._routineTodayKey=U,window._routineToggleAssignment=Tu,window._routineToggleShare=Iu,window._routineToggleStep=ru,window._routineToggleStepKid=iu,window._routineToggleSugg=Xl,window._routineTypeSelect=ju,window._routineUnassign=Pu,window._routinesForCurrentUser=Dl,window._routinesForHousehold=Ol,window.CHILD_EVENT_EMOJIS=Qu,window.CHORE_EMOJIS=ud,window.KID_EMOJIS=ld,window.PRIZE_EMOJIS=dd,window._deleteChildEvent=ed,window._openChildEventModal=$u,window._renderChildEventsMgmt=Zu,window.addSavings=wd,window.approveCompletion=nd,window.approveRedemption=ad,window.deleteChore=sd,window.deleteKid=vd,window.deletePrize=cd,window.emojiPicker=fd,window.kidBalance=Wu,window.kidsParentTab=Hu,window.kidsView=Vu,window.markChoreDone=td,window.openAddKidModal=hd,window.openChoreModal=yd,window.openEditKidModal=gd,window.openPrizeModal=xd,window.openSavingsModal=Cd,window.pickEmoji=pd,window.pickedEmoji=md,window.rejectCompletion=rd,window.rejectRedemption=od,window.renderApprovals=Yu,window.renderChoreMgmt=qu,window.renderKidView=Xu,window.renderKids=G,window.renderKidsOverview=Ku,window.renderKidsParent=Gu,window.renderPrizeMgmt=Ju,window.requestRedemption=id,window.saveChore=bd,window.saveKid=_d,window.savePrize=Sd,window.addLink=Rd,window.attachBtn=Nd,window.deleteReceiptById=jd,window.fileIcon=Fd,window.fileSizeStr=Pd,window.fundingBadge=Md,window.getDB=Dd,window.getReceipts=kd,window.installApp=Wd,window.openReceiptsModal=Id,window.refreshReceiptCounts=Od,window.removeReceipt=Hd,window.renderReceiptsList=Ld,window.saveReceipt=Ad,window.uploadFiles=Bd,window.uploadReceiptFiles=zd,window.viewReceipt=Vd,window.OB_EXPENSE_PRESETS=Gd,window.hideOnboarding=Yd,window.obBack=rf,window.obFinish=sf,window.obNext=nf,window.obPickEmoji=$d,window.obSetAdults=Xd,window.obSetKids=Zd,window.obSkip=af,window.obSkipExpenses=of,window.obStepPosition=qd,window.obStepSequence=Kd,window.obToggleEmojiPicker=Qd,window.obToggleExpenseSkip=ef,window.renderObStep=tf,window.showOnboarding=Jd;
//# sourceMappingURL=index-CuQEYJF9.js.map