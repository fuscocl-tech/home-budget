// Goals, Scenarios, Colour Settings, Insights sections
...
export function saveColors(c) { localStorage.setItem(COLORS_KEY, JSON.stringify(c)); }
...
export function getAIKey() { return localStorage.getItem(INSIGHTS_KEY) || ''; }
export function saveAIKey(k) { localStorage.setItem(INSIGHTS_KEY, k); }
